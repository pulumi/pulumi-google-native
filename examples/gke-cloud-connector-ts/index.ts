...
// Create a ServiceAccount for the cloud connector.
const serviceAccount = new google.iam.v1.ServiceAccount("gkeCloudConnector", {
    accountId: pulumi.interpolate `gke-cloud-connector-${saSuffix}`
});
...
// Step 1
// On the first update, run this block:
