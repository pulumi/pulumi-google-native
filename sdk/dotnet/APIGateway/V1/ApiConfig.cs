...
namespace Pulumi.GoogleNative.APIGateway.V1
{
    ...
    public partial class ApiConfig : Pulumi.CustomResource
    {
        ...
        public ApiConfig(string name, ApiConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigateway/v1:ApiConfig", name, args ?? new ApiConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigateway/v1:ApiConfig", name, null, MakeResourceOptions(options, id))
        {
        }
