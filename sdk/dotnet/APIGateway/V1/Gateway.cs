...
namespace Pulumi.GoogleCloud.APIGateway.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:apigateway/v1:Gateway")]
    public partial class Gateway : Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigateway/v1:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigateway/v1:Gateway", name, null, MakeResourceOptions(options, id))
        {
        }
