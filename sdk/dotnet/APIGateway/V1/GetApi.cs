...
namespace Pulumi.GoogleNative.APIGateway.V1
{
    public static class GetApi
    {
        ...
        public static Task<GetApiResult> InvokeAsync(GetApiArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiResult>("google-native:apigateway/v1:getApi", args ?? new GetApiArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single Api.
        /// </summary>
        public static Output<GetApiResult> Invoke(GetApiInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiResult>("google-native:apigateway/v1:getApi", args ?? new GetApiInvokeArgs(), options.WithDefaults());
    }
