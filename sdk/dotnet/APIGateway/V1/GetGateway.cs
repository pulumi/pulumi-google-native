...
namespace Pulumi.GoogleNative.APIGateway.V1
{
    public static class GetGateway
    {
        ...
        public static Task<GetGatewayResult> InvokeAsync(GetGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayResult>("google-native:apigateway/v1:getGateway", args ?? new GetGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single Gateway.
        /// </summary>
        public static Output<GetGatewayResult> Invoke(GetGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGatewayResult>("google-native:apigateway/v1:getGateway", args ?? new GetGatewayInvokeArgs(), options.WithDefaults());
    }
