...
namespace Pulumi.GcpNative.APIGateway.V1Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:apigateway/v1beta:Api")]
    public partial class Api : Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:apigateway/v1beta:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:apigateway/v1beta:Api", name, null, MakeResourceOptions(options, id))
        {
        }
