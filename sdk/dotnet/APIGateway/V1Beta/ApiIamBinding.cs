...
namespace Pulumi.GoogleNative.APIGateway.V1Beta
{
    ...
    public partial class ApiIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ApiIamBinding(string name, ApiIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigateway/v1beta:ApiIamBinding", name, args ?? new ApiIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigateway/v1beta:ApiIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ApiIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ApiIamBinding(name, id, options);
        }
    }
