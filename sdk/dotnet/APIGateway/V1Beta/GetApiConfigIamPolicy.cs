...
namespace Pulumi.GoogleNative.APIGateway.V1Beta
{
    public static class GetApiConfigIamPolicy
    {
        ...
        public static Task<GetApiConfigIamPolicyResult> InvokeAsync(GetApiConfigIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiConfigIamPolicyResult>("google-native:apigateway/v1beta:getApiConfigIamPolicy", args ?? new GetApiConfigIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetApiConfigIamPolicyResult> Invoke(GetApiConfigIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiConfigIamPolicyResult>("google-native:apigateway/v1beta:getApiConfigIamPolicy", args ?? new GetApiConfigIamPolicyInvokeArgs(), options.WithDefaults());
    }
