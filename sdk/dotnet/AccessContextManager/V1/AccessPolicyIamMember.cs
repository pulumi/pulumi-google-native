...
namespace Pulumi.GoogleNative.AccessContextManager.V1
{
    ...
    public partial class AccessPolicyIamMember : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicyIamMember(string name, AccessPolicyIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:accesscontextmanager/v1:AccessPolicyIamMember", name, args ?? new AccessPolicyIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:accesscontextmanager/v1:AccessPolicyIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AccessPolicyIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new AccessPolicyIamMember(name, id, options);
        }
    }
