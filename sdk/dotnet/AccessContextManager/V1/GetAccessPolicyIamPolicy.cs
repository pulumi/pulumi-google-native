...
namespace Pulumi.GoogleNative.AccessContextManager.V1
{
    public static class GetAccessPolicyIamPolicy
    {
        ...
        public static Task<GetAccessPolicyIamPolicyResult> InvokeAsync(GetAccessPolicyIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccessPolicyIamPolicyResult>("google-native:accesscontextmanager/v1:getAccessPolicyIamPolicy", args ?? new GetAccessPolicyIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetAccessPolicyIamPolicyResult> Invoke(GetAccessPolicyIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccessPolicyIamPolicyResult>("google-native:accesscontextmanager/v1:getAccessPolicyIamPolicy", args ?? new GetAccessPolicyIamPolicyInvokeArgs(), options.WithDefaults());
    }
