...
namespace Pulumi.GoogleNative.AccessContextManager.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:accesscontextmanager/v1beta:AccessPolicyAccessLevel")]
    public partial class AccessPolicyAccessLevel : Pulumi.CustomResource
    {
        ...
        public AccessPolicyAccessLevel(string name, AccessPolicyAccessLevelArgs args, CustomResourceOptions? options = null)
            : base("google-native:accesscontextmanager/v1beta:AccessPolicyAccessLevel", name, args ?? new AccessPolicyAccessLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyAccessLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:accesscontextmanager/v1beta:AccessPolicyAccessLevel", name, null, MakeResourceOptions(options, id))
        {
        }
