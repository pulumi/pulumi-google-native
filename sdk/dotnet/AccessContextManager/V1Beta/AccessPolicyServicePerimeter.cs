...
namespace Pulumi.GoogleNative.AccessContextManager.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:accesscontextmanager/v1beta:AccessPolicyServicePerimeter")]
    public partial class AccessPolicyServicePerimeter : Pulumi.CustomResource
    {
        ...
        public AccessPolicyServicePerimeter(string name, AccessPolicyServicePerimeterArgs args, CustomResourceOptions? options = null)
            : base("google-native:accesscontextmanager/v1beta:AccessPolicyServicePerimeter", name, args ?? new AccessPolicyServicePerimeterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyServicePerimeter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:accesscontextmanager/v1beta:AccessPolicyServicePerimeter", name, null, MakeResourceOptions(options, id))
        {
        }
