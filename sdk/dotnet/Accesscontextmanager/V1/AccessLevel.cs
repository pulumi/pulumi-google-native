...
namespace Pulumi.GoogleCloud.Accesscontextmanager.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:accesscontextmanager/v1:AccessLevel")]
    public partial class AccessLevel : Pulumi.CustomResource
    {
        ...
        public AccessLevel(string name, AccessLevelArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:AccessLevel", name, args ?? new AccessLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:AccessLevel", name, null, MakeResourceOptions(options, id))
        {
        }
