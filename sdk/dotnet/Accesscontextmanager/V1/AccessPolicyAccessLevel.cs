...
namespace Pulumi.GoogleCloud.Accesscontextmanager.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:accesscontextmanager/v1:AccessPolicyAccessLevel")]
    public partial class AccessPolicyAccessLevel : Pulumi.CustomResource
    {
        ...
        public AccessPolicyAccessLevel(string name, AccessPolicyAccessLevelArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:AccessPolicyAccessLevel", name, args ?? new AccessPolicyAccessLevelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyAccessLevel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:AccessPolicyAccessLevel", name, null, MakeResourceOptions(options, id))
        {
        }
