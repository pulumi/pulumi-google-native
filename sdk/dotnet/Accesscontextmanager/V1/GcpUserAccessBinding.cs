...
namespace Pulumi.GoogleCloud.Accesscontextmanager.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:accesscontextmanager/v1:GcpUserAccessBinding")]
    public partial class GcpUserAccessBinding : Pulumi.CustomResource
    {
        ...
        public GcpUserAccessBinding(string name, GcpUserAccessBindingArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:GcpUserAccessBinding", name, args ?? new GcpUserAccessBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GcpUserAccessBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:GcpUserAccessBinding", name, null, MakeResourceOptions(options, id))
        {
        }
