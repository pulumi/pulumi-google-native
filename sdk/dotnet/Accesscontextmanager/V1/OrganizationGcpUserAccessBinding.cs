...
namespace Pulumi.GoogleCloud.Accesscontextmanager.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:accesscontextmanager/v1:OrganizationGcpUserAccessBinding")]
    public partial class OrganizationGcpUserAccessBinding : Pulumi.CustomResource
    {
        ...
        public OrganizationGcpUserAccessBinding(string name, OrganizationGcpUserAccessBindingArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:OrganizationGcpUserAccessBinding", name, args ?? new OrganizationGcpUserAccessBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationGcpUserAccessBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:OrganizationGcpUserAccessBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationGcpUserAccessBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new OrganizationGcpUserAccessBinding(name, id, options);
        }
    }

    public sealed class OrganizationGcpUserAccessBindingArgs : Pulumi.ResourceArgs
    {
        [Input("accessLevels")]
        ...
        [Input("gcpUserAccessBindingsId", required: true)]
        public Input<string> GcpUserAccessBindingsId { get; set; } = null!;
        ...
        public OrganizationGcpUserAccessBindingArgs()
        {
        }
    }
}
