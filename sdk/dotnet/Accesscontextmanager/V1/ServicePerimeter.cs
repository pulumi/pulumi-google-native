...
namespace Pulumi.GoogleCloud.Accesscontextmanager.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:accesscontextmanager/v1:ServicePerimeter")]
    public partial class ServicePerimeter : Pulumi.CustomResource
    {
        ...
        public ServicePerimeter(string name, ServicePerimeterArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:ServicePerimeter", name, args ?? new ServicePerimeterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServicePerimeter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1:ServicePerimeter", name, null, MakeResourceOptions(options, id))
        {
        }
