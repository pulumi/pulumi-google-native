...
namespace Pulumi.GoogleCloud.Accesscontextmanager.V1beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:accesscontextmanager/v1beta:AccessPolicy")]
    public partial class AccessPolicy : Pulumi.CustomResource
    {
        ...
        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:accesscontextmanager/v1beta:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
