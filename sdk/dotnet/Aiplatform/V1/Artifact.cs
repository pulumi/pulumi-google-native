...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:Artifact")]
    public partial class Artifact : global::Pulumi.CustomResource
    {
        ...
        public Artifact(string name, ArtifactArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Artifact", name, args ?? new ArtifactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Artifact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Artifact", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ArtifactArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.GoogleNative.Aiplatform.V1.ArtifactState>? State { get; set; }
