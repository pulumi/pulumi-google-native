...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:DatasetVersion")]
    public partial class DatasetVersion : global::Pulumi.CustomResource
    {
        ...
        public DatasetVersion(string name, DatasetVersionArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:DatasetVersion", name, args ?? new DatasetVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:DatasetVersion", name, null, MakeResourceOptions(options, id))
        {
        }
