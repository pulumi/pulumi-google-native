...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:DeploymentResourcePool")]
    public partial class DeploymentResourcePool : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudAiplatformV1DedicatedResourcesResponse> DedicatedResources { get; private set; } = null!;
        ...
        public DeploymentResourcePool(string name, DeploymentResourcePoolArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:DeploymentResourcePool", name, args ?? new DeploymentResourcePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentResourcePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:DeploymentResourcePool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeploymentResourcePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1DedicatedResourcesArgs> DedicatedResources { get; set; } = null!;
