...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:EntityType")]
    public partial class EntityType : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse> MonitoringConfig { get; private set; } = null!;
        ...
        public EntityType(string name, EntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:EntityType", name, args ?? new EntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:EntityType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EntityTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1FeaturestoreMonitoringConfigArgs>? MonitoringConfig { get; set; }
