...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType : IEquatable<GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType>
    {
        private readonly string _value;

        private GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Should not be set.
        /// </summary>
        public static GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType DistanceMeasureTypeUnspecified { get; } = new GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType("DISTANCE_MEASURE_TYPE_UNSPECIFIED");
        /// <summary>
        /// Euclidean (L_2) Distance.
        /// </summary>
        public static GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType SquaredL2Distance { get; } = new GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType("SQUARED_L2_DISTANCE");
        /// <summary>
        ...
        /// </summary>
        public static GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType CosineDistance { get; } = new GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType("COSINE_DISTANCE");
        /// <summary>
        /// Dot Product Distance. Defined as a negative of the dot product.
        /// </summary>
        public static GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType DotProductDistance { get; } = new GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType("DOT_PRODUCT_DISTANCE");

        public static bool operator ==(GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType left, GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType right) => left.Equals(right);
        public static bool operator !=(GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType left, GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType right) => !left.Equals(right);

        public static explicit operator string(GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType other && Equals(other);
        public bool Equals(GoogleCloudAiplatformV1FeatureViewIndexConfigDistanceMeasureType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct GoogleCloudAiplatformV1MachineSpecAcceleratorType : IEquatable<GoogleCloudAiplatformV1MachineSpecAcceleratorType>
    {
        ...
        /// </summary>
        public static GoogleCloudAiplatformV1MachineSpecAcceleratorType NvidiaH10080gb { get; } = new GoogleCloudAiplatformV1MachineSpecAcceleratorType("NVIDIA_H100_80GB");
        /// <summary>
        /// TPU v2.
        /// </summary>
    ...
    /// </summary>
    [EnumType]
    public readonly struct GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType : IEquatable<GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType>
    {
        private readonly string _value;

        private GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Default type.
        /// </summary>
        public static GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType ReservationAffinityTypeUnspecified { get; } = new GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType("RESERVATION_AFFINITY_TYPE_UNSPECIFIED");
        /// <summary>
        /// Do not consume from any allocated capacity.
        /// </summary>
        public static GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType ReservationNone { get; } = new GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType("RESERVATION_NONE");
        /// <summary>
        /// Consume any reservation available.
        /// </summary>
        public static GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType ReservationAny { get; } = new GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType("RESERVATION_ANY");
        /// <summary>
        /// Must consume from a specific reservation. Must specify key value fields for specifying the reservations.
        /// </summary>
        public static GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType ReservationSpecific { get; } = new GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType("RESERVATION_SPECIFIC");

        public static bool operator ==(GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType left, GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType right) => left.Equals(right);
        public static bool operator !=(GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType left, GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType right) => !left.Equals(right);

        public static explicit operator string(GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType other && Equals(other);
        public bool Equals(GoogleCloudAiplatformV1NotebookReservationAffinityConsumeReservationType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
