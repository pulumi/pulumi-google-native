...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:Execution")]
    public partial class Execution : global::Pulumi.CustomResource
    {
        ...
        public Execution(string name, ExecutionArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Execution", name, args ?? new ExecutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Execution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Execution", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExecutionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.GoogleNative.Aiplatform.V1.ExecutionState>? State { get; set; }
