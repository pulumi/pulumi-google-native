...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:Experiment")]
    public partial class Experiment : global::Pulumi.CustomResource
    {
        ...
        public Experiment(string name, ExperimentArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Experiment", name, args ?? new ExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Experiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Experiment", name, null, MakeResourceOptions(options, id))
        {
        }
