...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:FeatureGroup")]
    public partial class FeatureGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("bigQuery")]
        public Output<Outputs.GoogleCloudAiplatformV1FeatureGroupBigQueryResponse> BigQuery { get; private set; } = null!;
        ...
        public FeatureGroup(string name, FeatureGroupArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:FeatureGroup", name, args ?? new FeatureGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FeatureGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:FeatureGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FeatureGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bigQuery")]
        public Input<Inputs.GoogleCloudAiplatformV1FeatureGroupBigQueryArgs>? BigQuery { get; set; }
