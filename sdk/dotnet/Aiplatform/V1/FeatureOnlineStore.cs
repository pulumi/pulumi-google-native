...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    public partial class FeatureOnlineStore : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("bigtable")]
        public Output<Outputs.GoogleCloudAiplatformV1FeatureOnlineStoreBigtableResponse> Bigtable { get; private set; } = null!;
        ...
        public FeatureOnlineStore(string name, FeatureOnlineStoreArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:FeatureOnlineStore", name, args ?? new FeatureOnlineStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FeatureOnlineStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:FeatureOnlineStore", name, null, MakeResourceOptions(options, id))
        {
        }
