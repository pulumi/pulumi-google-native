...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:Featurestore")]
    public partial class Featurestore : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigResponse> OnlineServingConfig { get; private set; } = null!;
        ...
        public Featurestore(string name, FeaturestoreArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Featurestore", name, args ?? new FeaturestoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Featurestore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Featurestore", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FeaturestoreArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigArgs>? OnlineServingConfig { get; set; }
