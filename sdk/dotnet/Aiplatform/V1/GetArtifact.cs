...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetArtifact
    {
        ...
        public static Task<GetArtifactResult> InvokeAsync(GetArtifactArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetArtifactResult>("google-native:aiplatform/v1:getArtifact", args ?? new GetArtifactArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a specific Artifact.
        /// </summary>
        public static Output<GetArtifactResult> Invoke(GetArtifactInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetArtifactResult>("google-native:aiplatform/v1:getArtifact", args ?? new GetArtifactInvokeArgs(), options.WithDefaults());
    }
