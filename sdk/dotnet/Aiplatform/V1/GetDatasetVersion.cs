...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetDatasetVersion
    {
        ...
        public static Task<GetDatasetVersionResult> InvokeAsync(GetDatasetVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDatasetVersionResult>("google-native:aiplatform/v1:getDatasetVersion", args ?? new GetDatasetVersionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Dataset version.
        /// </summary>
        public static Output<GetDatasetVersionResult> Invoke(GetDatasetVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDatasetVersionResult>("google-native:aiplatform/v1:getDatasetVersion", args ?? new GetDatasetVersionInvokeArgs(), options.WithDefaults());
    }
