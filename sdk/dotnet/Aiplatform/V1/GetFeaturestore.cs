...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetFeaturestore
    {
        ...
        public static Task<GetFeaturestoreResult> InvokeAsync(GetFeaturestoreArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFeaturestoreResult>("google-native:aiplatform/v1:getFeaturestore", args ?? new GetFeaturestoreArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single Featurestore.
        /// </summary>
        public static Output<GetFeaturestoreResult> Invoke(GetFeaturestoreInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFeaturestoreResult>("google-native:aiplatform/v1:getFeaturestore", args ?? new GetFeaturestoreInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetFeaturestoreResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigResponse OnlineServingConfig;
        /// <summary>
        ...
        private GetFeaturestoreResult(
            ...
            Outputs.GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigResponse onlineServingConfig,
