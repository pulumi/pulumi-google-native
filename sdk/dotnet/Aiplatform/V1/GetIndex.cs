...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetIndex
    {
        ...
        public static Task<GetIndexResult> InvokeAsync(GetIndexArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIndexResult>("google-native:aiplatform/v1:getIndex", args ?? new GetIndexArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an Index.
        /// </summary>
        public static Output<GetIndexResult> Invoke(GetIndexInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIndexResult>("google-native:aiplatform/v1:getIndex", args ?? new GetIndexInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetIndexResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAiplatformV1DeployedIndexRefResponse> DeployedIndexes;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1IndexStatsResponse IndexStats;
        /// <summary>
        ...
        private GetIndexResult(
            ...
            ImmutableArray<Outputs.GoogleCloudAiplatformV1DeployedIndexRefResponse> deployedIndexes,
            ...
            Outputs.GoogleCloudAiplatformV1IndexStatsResponse indexStats,
