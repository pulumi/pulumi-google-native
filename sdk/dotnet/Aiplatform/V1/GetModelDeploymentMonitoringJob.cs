...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetModelDeploymentMonitoringJob
    {
        ...
        public static Task<GetModelDeploymentMonitoringJobResult> InvokeAsync(GetModelDeploymentMonitoringJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetModelDeploymentMonitoringJobResult>("google-native:aiplatform/v1:getModelDeploymentMonitoringJob", args ?? new GetModelDeploymentMonitoringJobArgs(), options.WithDefaults());
        ...
        public static Output<GetModelDeploymentMonitoringJobResult> Invoke(GetModelDeploymentMonitoringJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetModelDeploymentMonitoringJobResult>("google-native:aiplatform/v1:getModelDeploymentMonitoringJob", args ?? new GetModelDeploymentMonitoringJobInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetModelDeploymentMonitoringJobResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse> BigqueryTables;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse LatestMonitoringPipelineMetadata;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1SamplingStrategyResponse LoggingSamplingStrategy;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse> ModelDeploymentMonitoringObjectiveConfigs;
        /// <summary>
        /// Schedule config for running the monitoring job.
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse ModelDeploymentMonitoringScheduleConfig;
        /// <summary>
        /// Alert config for model monitoring.
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse ModelMonitoringAlertConfig;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1GcsDestinationResponse StatsAnomaliesBaseDirectory;
        /// <summary>
        ...
        private GetModelDeploymentMonitoringJobResult(
            ...
            ImmutableArray<Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse> bigqueryTables,
            ...
            Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse latestMonitoringPipelineMetadata,

            string logTtl,

            Outputs.GoogleCloudAiplatformV1SamplingStrategyResponse loggingSamplingStrategy,

            ImmutableArray<Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse> modelDeploymentMonitoringObjectiveConfigs,

            Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse modelDeploymentMonitoringScheduleConfig,

            Outputs.GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse modelMonitoringAlertConfig,
            ...
            Outputs.GoogleCloudAiplatformV1GcsDestinationResponse statsAnomaliesBaseDirectory,
