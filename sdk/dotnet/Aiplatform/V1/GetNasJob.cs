...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetNasJob
    {
        ...
        public static Task<GetNasJobResult> InvokeAsync(GetNasJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNasJobResult>("google-native:aiplatform/v1:getNasJob", args ?? new GetNasJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a NasJob
        /// </summary>
        public static Output<GetNasJobResult> Invoke(GetNasJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNasJobResult>("google-native:aiplatform/v1:getNasJob", args ?? new GetNasJobInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetNasJobResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1NasJobOutputResponse NasJobOutput;
        /// <summary>
        /// The specification of a NasJob.
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1NasJobSpecResponse NasJobSpec;
        /// <summary>
        ...
        private GetNasJobResult(
            ...
            Outputs.GoogleCloudAiplatformV1NasJobOutputResponse nasJobOutput,

            Outputs.GoogleCloudAiplatformV1NasJobSpecResponse nasJobSpec,
