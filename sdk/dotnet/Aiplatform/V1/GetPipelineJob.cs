...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetPipelineJob
    {
        ...
        public static Task<GetPipelineJobResult> InvokeAsync(GetPipelineJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPipelineJobResult>("google-native:aiplatform/v1:getPipelineJob", args ?? new GetPipelineJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a PipelineJob.
        /// </summary>
        public static Output<GetPipelineJobResult> Invoke(GetPipelineJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPipelineJobResult>("google-native:aiplatform/v1:getPipelineJob", args ?? new GetPipelineJobInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetPipelineJobArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("pipelineJobId", required: true)]
        public string PipelineJobId { get; set; } = null!;
    ...
    public sealed class GetPipelineJobInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("pipelineJobId", required: true)]
        public Input<string> PipelineJobId { get; set; } = null!;
    ...
    public sealed class GetPipelineJobResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1PipelineJobDetailResponse JobDetail;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse RuntimeConfig;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1PipelineTemplateMetadataResponse TemplateMetadata;
        /// <summary>
        ...
        private GetPipelineJobResult(
            ...
            Outputs.GoogleCloudAiplatformV1PipelineJobDetailResponse jobDetail,
            ...
            Outputs.GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse runtimeConfig,
            ...
            Outputs.GoogleCloudAiplatformV1PipelineTemplateMetadataResponse templateMetadata,
