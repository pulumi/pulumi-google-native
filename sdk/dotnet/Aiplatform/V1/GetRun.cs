...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetRun
    {
        ...
        public static Task<GetRunResult> InvokeAsync(GetRunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRunResult>("google-native:aiplatform/v1:getRun", args ?? new GetRunArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a TensorboardRun.
        /// </summary>
        public static Output<GetRunResult> Invoke(GetRunInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRunResult>("google-native:aiplatform/v1:getRun", args ?? new GetRunInvokeArgs(), options.WithDefaults());
    }
