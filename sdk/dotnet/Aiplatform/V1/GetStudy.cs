...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetStudy
    {
        ...
        public static Task<GetStudyResult> InvokeAsync(GetStudyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStudyResult>("google-native:aiplatform/v1:getStudy", args ?? new GetStudyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Study by name.
        /// </summary>
        public static Output<GetStudyResult> Invoke(GetStudyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStudyResult>("google-native:aiplatform/v1:getStudy", args ?? new GetStudyInvokeArgs(), options.WithDefaults());
    }
