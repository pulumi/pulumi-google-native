...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    public static class GetTensorboard
    {
        ...
        public static Task<GetTensorboardResult> InvokeAsync(GetTensorboardArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTensorboardResult>("google-native:aiplatform/v1:getTensorboard", args ?? new GetTensorboardArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Tensorboard.
        /// </summary>
        public static Output<GetTensorboardResult> Invoke(GetTensorboardInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTensorboardResult>("google-native:aiplatform/v1:getTensorboard", args ?? new GetTensorboardInvokeArgs(), options.WithDefaults());
    }
