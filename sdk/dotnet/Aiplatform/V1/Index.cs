...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:Index")]
    public partial class Index : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1DeployedIndexRefResponse>> DeployedIndexes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("indexStats")]
        public Output<Outputs.GoogleCloudAiplatformV1IndexStatsResponse> IndexStats { get; private set; } = null!;
        ...
        public Index(string name, IndexArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Index", name, args ?? new IndexArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Index(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Index", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IndexArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Aiplatform.V1.IndexIndexUpdateMethod>? IndexUpdateMethod { get; set; }
