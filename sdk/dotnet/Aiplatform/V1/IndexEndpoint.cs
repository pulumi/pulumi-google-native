...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:IndexEndpoint")]
    public partial class IndexEndpoint : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1DeployedIndexResponse>> DeployedIndexes { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1PrivateServiceConnectConfigResponse> PrivateServiceConnectConfig { get; private set; } = null!;
        ...
        public IndexEndpoint(string name, IndexEndpointArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:IndexEndpoint", name, args ?? new IndexEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IndexEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:IndexEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IndexEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1PrivateServiceConnectConfigArgs>? PrivateServiceConnectConfig { get; set; }
