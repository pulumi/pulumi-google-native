...
namespace Pulumi.GoogleNative.Aiplatform.V1.Inputs
{
    ...
    /// </summary>
    public sealed class GoogleCloudAiplatformV1PipelineJobRuntimeConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Represents the failure policy of a pipeline. Currently, the default of a pipeline is that the pipeline will continue to run until no more tasks can be executed, also known as PIPELINE_FAILURE_POLICY_FAIL_SLOW. However, if a pipeline is set to PIPELINE_FAILURE_POLICY_FAIL_FAST, it will stop scheduling any new tasks when a task has failed. Any scheduled tasks will continue to completion.
        /// </summary>
        [Input("failurePolicy")]
        public Input<Pulumi.GoogleNative.Aiplatform.V1.GoogleCloudAiplatformV1PipelineJobRuntimeConfigFailurePolicy>? FailurePolicy { get; set; }
        ...
        public static new GoogleCloudAiplatformV1PipelineJobRuntimeConfigArgs Empty => new GoogleCloudAiplatformV1PipelineJobRuntimeConfigArgs();
    }
}
