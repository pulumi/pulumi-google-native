...
namespace Pulumi.GoogleNative.Aiplatform.V1.Inputs
{
    ...
    /// </summary>
    public sealed class GoogleCloudAiplatformV1XraiAttributionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.GoogleCloudAiplatformV1BlurBaselineConfigArgs>? BlurBaselineConfig { get; set; }

        /// <summary>
        /// Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
        /// </summary>
        [Input("smoothGradConfig")]
        public Input<Inputs.GoogleCloudAiplatformV1SmoothGradConfigArgs>? SmoothGradConfig { get; set; }
        ...
        public GoogleCloudAiplatformV1XraiAttributionArgs()
        {
        }
        public static new GoogleCloudAiplatformV1XraiAttributionArgs Empty => new GoogleCloudAiplatformV1XraiAttributionArgs();
    }
}
