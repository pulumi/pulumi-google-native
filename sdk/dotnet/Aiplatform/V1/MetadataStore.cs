...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:MetadataStore")]
    public partial class MetadataStore : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("state")]
        public Output<Outputs.GoogleCloudAiplatformV1MetadataStoreMetadataStoreStateResponse> State { get; private set; } = null!;
        ...
        public MetadataStore(string name, MetadataStoreArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:MetadataStore", name, args ?? new MetadataStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetadataStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:MetadataStore", name, null, MakeResourceOptions(options, id))
        {
        }
