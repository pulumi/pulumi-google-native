...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    public partial class Model : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("baseModelSource")]
        public Output<Outputs.GoogleCloudAiplatformV1ModelBaseModelSourceResponse> BaseModelSource { get; private set; } = null!;
        ...
        /// </summary>
        [Output("dataStats")]
        public Output<Outputs.GoogleCloudAiplatformV1ModelDataStatsResponse> DataStats { get; private set; } = null!;
