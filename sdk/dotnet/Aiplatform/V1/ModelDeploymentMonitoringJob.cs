...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:ModelDeploymentMonitoringJob")]
    public partial class ModelDeploymentMonitoringJob : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse>> BigqueryTables { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse> LatestMonitoringPipelineMetadata { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1SamplingStrategyResponse> LoggingSamplingStrategy { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse>> ModelDeploymentMonitoringObjectiveConfigs { get; private set; } = null!;

        /// <summary>
        /// Schedule config for running the monitoring job.
        /// </summary>
        [Output("modelDeploymentMonitoringScheduleConfig")]
        public Output<Outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse> ModelDeploymentMonitoringScheduleConfig { get; private set; } = null!;

        /// <summary>
        /// Alert config for model monitoring.
        /// </summary>
        [Output("modelMonitoringAlertConfig")]
        public Output<Outputs.GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse> ModelMonitoringAlertConfig { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1GcsDestinationResponse> StatsAnomaliesBaseDirectory { get; private set; } = null!;
        ...
        public ModelDeploymentMonitoringJob(string name, ModelDeploymentMonitoringJobArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:ModelDeploymentMonitoringJob", name, args ?? new ModelDeploymentMonitoringJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ModelDeploymentMonitoringJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:ModelDeploymentMonitoringJob", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ModelDeploymentMonitoringJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1SamplingStrategyArgs> LoggingSamplingStrategy { get; set; } = null!;

        [Input("modelDeploymentMonitoringObjectiveConfigs", required: true)]
        private InputList<Inputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs>? _modelDeploymentMonitoringObjectiveConfigs;

        /// <summary>
        /// The config for monitoring objectives. This is a per DeployedModel config. Each DeployedModel needs to be configured separately.
        /// </summary>
        public InputList<Inputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs> ModelDeploymentMonitoringObjectiveConfigs
        {
            get => _modelDeploymentMonitoringObjectiveConfigs ?? (_modelDeploymentMonitoringObjectiveConfigs = new InputList<Inputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs>());
        ...
        public Input<Inputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgs> ModelDeploymentMonitoringScheduleConfig { get; set; } = null!;

        /// <summary>
        /// Alert config for model monitoring.
        /// </summary>
        [Input("modelMonitoringAlertConfig")]
        public Input<Inputs.GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgs>? ModelMonitoringAlertConfig { get; set; }
        ...
        public Input<Inputs.GoogleCloudAiplatformV1GcsDestinationArgs>? StatsAnomaliesBaseDirectory { get; set; }
