...
namespace Pulumi.GoogleNative.Aiplatform.V1.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudAiplatformV1BlurBaselineConfigResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly double MaxBlurSigma;

        [OutputConstructor]
        private GoogleCloudAiplatformV1BlurBaselineConfigResponse(double maxBlurSigma)
        {
