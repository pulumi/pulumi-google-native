...
namespace Pulumi.GoogleNative.Aiplatform.V1.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigScalingResponse Scaling;

        [OutputConstructor]
        private GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigResponse(
            int fixedNodeCount,

            Outputs.GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigScalingResponse scaling)
        {
