...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:PipelineJob")]
    public partial class PipelineJob : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("jobDetail")]
        public Output<Outputs.GoogleCloudAiplatformV1PipelineJobDetailResponse> JobDetail { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse> RuntimeConfig { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1PipelineTemplateMetadataResponse> TemplateMetadata { get; private set; } = null!;
        ...
        public PipelineJob(string name, PipelineJobArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:PipelineJob", name, args ?? new PipelineJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:PipelineJob", name, null, MakeResourceOptions(options, id))
        {
        }
