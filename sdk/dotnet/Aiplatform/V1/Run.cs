...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:Run")]
    public partial class Run : global::Pulumi.CustomResource
    {
        ...
        public Run(string name, RunArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Run", name, args ?? new RunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Run(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Run", name, null, MakeResourceOptions(options, id))
        {
        }
