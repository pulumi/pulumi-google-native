...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:TimeSeries")]
    public partial class TimeSeries : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("metadata")]
        public Output<Outputs.GoogleCloudAiplatformV1TensorboardTimeSeriesMetadataResponse> Metadata { get; private set; } = null!;
        ...
        public TimeSeries(string name, TimeSeriesArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:TimeSeries", name, args ?? new TimeSeriesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TimeSeries(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:TimeSeries", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TimeSeriesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Aiplatform.V1.TimeSeriesValueType> ValueType { get; set; } = null!;
