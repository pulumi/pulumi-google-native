...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:TrainingPipeline")]
    public partial class TrainingPipeline : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudAiplatformV1InputDataConfigResponse> InputDataConfig { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1ModelResponse> ModelToUpload { get; private set; } = null!;
        ...
        public TrainingPipeline(string name, TrainingPipelineArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:TrainingPipeline", name, args ?? new TrainingPipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TrainingPipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:TrainingPipeline", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TrainingPipelineArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1InputDataConfigArgs>? InputDataConfig { get; set; }
        ...
        /// </summary>
        [Input("modelToUpload")]
        public Input<Inputs.GoogleCloudAiplatformV1ModelArgs>? ModelToUpload { get; set; }
