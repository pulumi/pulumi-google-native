...
namespace Pulumi.GoogleNative.Aiplatform.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1:Trial")]
    public partial class Trial : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudAiplatformV1MeasurementResponse> FinalMeasurement { get; private set; } = null!;
        ...
        /// </summary>
        [Output("measurements")]
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1MeasurementResponse>> Measurements { get; private set; } = null!;
        ...
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1TrialParameterResponse>> Parameters { get; private set; } = null!;
        ...
        public Trial(string name, TrialArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Trial", name, args ?? new TrialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trial(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1:Trial", name, null, MakeResourceOptions(options, id))
        {
        }
