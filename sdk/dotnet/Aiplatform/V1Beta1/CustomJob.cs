...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:CustomJob")]
    public partial class CustomJob : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("jobSpec")]
        public Output<Outputs.GoogleCloudAiplatformV1beta1CustomJobSpecResponse> JobSpec { get; private set; } = null!;
        ...
        public CustomJob(string name, CustomJobArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:CustomJob", name, args ?? new CustomJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:CustomJob", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CustomJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1beta1CustomJobSpecArgs> JobSpec { get; set; } = null!;
