...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:DataLabelingJob")]
    public partial class DataLabelingJob : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudAiplatformV1beta1ActiveLearningConfigResponse> ActiveLearningConfig { get; private set; } = null!;
        ...
        public DataLabelingJob(string name, DataLabelingJobArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:DataLabelingJob", name, args ?? new DataLabelingJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataLabelingJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:DataLabelingJob", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataLabelingJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1beta1ActiveLearningConfigArgs>? ActiveLearningConfig { get; set; }
