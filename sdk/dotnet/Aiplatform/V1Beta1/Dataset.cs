...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:Dataset")]
    public partial class Dataset : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("savedQueries")]
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1SavedQueryResponse>> SavedQueries { get; private set; } = null!;
        ...
        public Dataset(string name, DatasetArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:Dataset", name, args ?? new DatasetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dataset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:Dataset", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatasetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("savedQueries")]
        private InputList<Inputs.GoogleCloudAiplatformV1beta1SavedQueryArgs>? _savedQueries;

        /// <summary>
        /// All SavedQueries belong to the Dataset will be returned in List/Get Dataset response. The annotation_specs field will not be populated except for UI cases which will only use annotation_spec_count. In CreateDataset request, a SavedQuery is created together if this field is set, up to one SavedQuery can be set in CreateDatasetRequest. The SavedQuery should not contain any AnnotationSpec.
        /// </summary>
        public InputList<Inputs.GoogleCloudAiplatformV1beta1SavedQueryArgs> SavedQueries
        {
            get => _savedQueries ?? (_savedQueries = new InputList<Inputs.GoogleCloudAiplatformV1beta1SavedQueryArgs>());
