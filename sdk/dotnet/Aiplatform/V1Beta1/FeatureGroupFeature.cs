...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:FeatureGroupFeature")]
    public partial class FeatureGroupFeature : global::Pulumi.CustomResource
    {
        ...
        public FeatureGroupFeature(string name, FeatureGroupFeatureArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:FeatureGroupFeature", name, args ?? new FeatureGroupFeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FeatureGroupFeature(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:FeatureGroupFeature", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FeatureGroupFeatureArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("valueType")]
        public Input<Pulumi.GoogleNative.Aiplatform.V1Beta1.FeatureGroupFeatureValueType>? ValueType { get; set; }
