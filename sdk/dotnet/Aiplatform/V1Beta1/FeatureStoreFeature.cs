...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:FeatureStoreFeature")]
    public partial class FeatureStoreFeature : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("monitoringStats")]
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse>> MonitoringStats { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse>> MonitoringStatsAnomalies { get; private set; } = null!;
        ...
        public FeatureStoreFeature(string name, FeatureStoreFeatureArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:FeatureStoreFeature", name, args ?? new FeatureStoreFeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FeatureStoreFeature(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:FeatureStoreFeature", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FeatureStoreFeatureArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("valueType")]
        public Input<Pulumi.GoogleNative.Aiplatform.V1Beta1.FeatureStoreFeatureValueType>? ValueType { get; set; }
