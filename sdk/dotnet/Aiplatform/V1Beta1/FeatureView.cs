...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    public partial class FeatureView : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceResponse> BigQuerySource { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceResponse> FeatureRegistrySource { get; private set; } = null!;
        ...
        /// </summary>
        [Output("syncConfig")]
        public Output<Outputs.GoogleCloudAiplatformV1beta1FeatureViewSyncConfigResponse> SyncConfig { get; private set; } = null!;
        ...
        public FeatureView(string name, FeatureViewArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:FeatureView", name, args ?? new FeatureViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FeatureView(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:FeatureView", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FeatureViewArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceArgs>? BigQuerySource { get; set; }
        ...
        public Input<Inputs.GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceArgs>? FeatureRegistrySource { get; set; }
