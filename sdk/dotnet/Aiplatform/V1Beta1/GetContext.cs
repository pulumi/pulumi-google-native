...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetContext
    {
        ...
        public static Task<GetContextResult> InvokeAsync(GetContextArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContextResult>("google-native:aiplatform/v1beta1:getContext", args ?? new GetContextArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a specific Context.
        /// </summary>
        public static Output<GetContextResult> Invoke(GetContextInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContextResult>("google-native:aiplatform/v1beta1:getContext", args ?? new GetContextInvokeArgs(), options.WithDefaults());
    }
