...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetDataLabelingJob
    {
        ...
        public static Task<GetDataLabelingJobResult> InvokeAsync(GetDataLabelingJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataLabelingJobResult>("google-native:aiplatform/v1beta1:getDataLabelingJob", args ?? new GetDataLabelingJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a DataLabelingJob.
        /// </summary>
        public static Output<GetDataLabelingJobResult> Invoke(GetDataLabelingJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataLabelingJobResult>("google-native:aiplatform/v1beta1:getDataLabelingJob", args ?? new GetDataLabelingJobInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetDataLabelingJobResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1beta1ActiveLearningConfigResponse ActiveLearningConfig;
        /// <summary>
        ...
        private GetDataLabelingJobResult(
            Outputs.GoogleCloudAiplatformV1beta1ActiveLearningConfigResponse activeLearningConfig,
