...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetDeploymentResourcePool
    {
        ...
        public static Task<GetDeploymentResourcePoolResult> InvokeAsync(GetDeploymentResourcePoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentResourcePoolResult>("google-native:aiplatform/v1beta1:getDeploymentResourcePool", args ?? new GetDeploymentResourcePoolArgs(), options.WithDefaults());
        ...
        public static Output<GetDeploymentResourcePoolResult> Invoke(GetDeploymentResourcePoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDeploymentResourcePoolResult>("google-native:aiplatform/v1beta1:getDeploymentResourcePool", args ?? new GetDeploymentResourcePoolInvokeArgs(), options.WithDefaults());
    }
