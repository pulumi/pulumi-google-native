...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetEndpointIamPolicy
    {
        ...
        public static Task<GetEndpointIamPolicyResult> InvokeAsync(GetEndpointIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEndpointIamPolicyResult>("google-native:aiplatform/v1beta1:getEndpointIamPolicy", args ?? new GetEndpointIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetEndpointIamPolicyResult> Invoke(GetEndpointIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEndpointIamPolicyResult>("google-native:aiplatform/v1beta1:getEndpointIamPolicy", args ?? new GetEndpointIamPolicyInvokeArgs(), options.WithDefaults());
    }
