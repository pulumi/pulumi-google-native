...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetExecution
    {
        ...
        public static Task<GetExecutionResult> InvokeAsync(GetExecutionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExecutionResult>("google-native:aiplatform/v1beta1:getExecution", args ?? new GetExecutionArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a specific Execution.
        /// </summary>
        public static Output<GetExecutionResult> Invoke(GetExecutionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExecutionResult>("google-native:aiplatform/v1beta1:getExecution", args ?? new GetExecutionInvokeArgs(), options.WithDefaults());
    }
