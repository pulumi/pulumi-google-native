...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetExperiment
    {
        ...
        public static Task<GetExperimentResult> InvokeAsync(GetExperimentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExperimentResult>("google-native:aiplatform/v1beta1:getExperiment", args ?? new GetExperimentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a TensorboardExperiment.
        /// </summary>
        public static Output<GetExperimentResult> Invoke(GetExperimentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExperimentResult>("google-native:aiplatform/v1beta1:getExperiment", args ?? new GetExperimentInvokeArgs(), options.WithDefaults());
    }
