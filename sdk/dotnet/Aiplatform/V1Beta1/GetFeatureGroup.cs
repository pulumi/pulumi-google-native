...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetFeatureGroup
    {
        ...
        public static Task<GetFeatureGroupResult> InvokeAsync(GetFeatureGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFeatureGroupResult>("google-native:aiplatform/v1beta1:getFeatureGroup", args ?? new GetFeatureGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single FeatureGroup.
        /// </summary>
        public static Output<GetFeatureGroupResult> Invoke(GetFeatureGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFeatureGroupResult>("google-native:aiplatform/v1beta1:getFeatureGroup", args ?? new GetFeatureGroupInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetFeatureGroupResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1beta1FeatureGroupBigQueryResponse BigQuery;
        /// <summary>
        ...
        private GetFeatureGroupResult(
            Outputs.GoogleCloudAiplatformV1beta1FeatureGroupBigQueryResponse bigQuery,
