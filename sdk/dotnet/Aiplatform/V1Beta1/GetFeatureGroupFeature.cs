...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetFeatureGroupFeature
    {
        ...
        public static Task<GetFeatureGroupFeatureResult> InvokeAsync(GetFeatureGroupFeatureArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFeatureGroupFeatureResult>("google-native:aiplatform/v1beta1:getFeatureGroupFeature", args ?? new GetFeatureGroupFeatureArgs(), options.WithDefaults());
        ...
        public static Output<GetFeatureGroupFeatureResult> Invoke(GetFeatureGroupFeatureInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFeatureGroupFeatureResult>("google-native:aiplatform/v1beta1:getFeatureGroupFeature", args ?? new GetFeatureGroupFeatureInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetFeatureGroupFeatureResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse> MonitoringStats;
        /// <summary>
        /// Only applicable for Vertex AI Feature Store (Legacy). The list of historical stats and anomalies with specified objectives.
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse> MonitoringStatsAnomalies;
        /// <summary>
        ...
        private GetFeatureGroupFeatureResult(
            ...
            ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse> monitoringStats,

            ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse> monitoringStatsAnomalies,
