...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetFeatureStoreFeature
    {
        ...
        public static Task<GetFeatureStoreFeatureResult> InvokeAsync(GetFeatureStoreFeatureArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFeatureStoreFeatureResult>("google-native:aiplatform/v1beta1:getFeatureStoreFeature", args ?? new GetFeatureStoreFeatureArgs(), options.WithDefaults());
        ...
        public static Output<GetFeatureStoreFeatureResult> Invoke(GetFeatureStoreFeatureInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFeatureStoreFeatureResult>("google-native:aiplatform/v1beta1:getFeatureStoreFeature", args ?? new GetFeatureStoreFeatureInvokeArgs(), options.WithDefaults());
    }
