...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetHyperparameterTuningJob
    {
        ...
        public static Task<GetHyperparameterTuningJobResult> InvokeAsync(GetHyperparameterTuningJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHyperparameterTuningJobResult>("google-native:aiplatform/v1beta1:getHyperparameterTuningJob", args ?? new GetHyperparameterTuningJobArgs(), options.WithDefaults());
        ...
        public static Output<GetHyperparameterTuningJobResult> Invoke(GetHyperparameterTuningJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHyperparameterTuningJobResult>("google-native:aiplatform/v1beta1:getHyperparameterTuningJob", args ?? new GetHyperparameterTuningJobInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetHyperparameterTuningJobResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1beta1CustomJobSpecResponse TrialJobSpec;
        /// <summary>
        /// Trials of the HyperparameterTuningJob.
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1TrialResponse> Trials;
        /// <summary>
        ...
        private GetHyperparameterTuningJobResult(
            ...
            Outputs.GoogleCloudAiplatformV1beta1CustomJobSpecResponse trialJobSpec,

            ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1TrialResponse> trials,
