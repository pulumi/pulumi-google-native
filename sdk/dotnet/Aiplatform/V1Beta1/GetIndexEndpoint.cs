...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetIndexEndpoint
    {
        ...
        public static Task<GetIndexEndpointResult> InvokeAsync(GetIndexEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIndexEndpointResult>("google-native:aiplatform/v1beta1:getIndexEndpoint", args ?? new GetIndexEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an IndexEndpoint.
        /// </summary>
        public static Output<GetIndexEndpointResult> Invoke(GetIndexEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIndexEndpointResult>("google-native:aiplatform/v1beta1:getIndexEndpoint", args ?? new GetIndexEndpointInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetIndexEndpointResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1DeployedIndexResponse> DeployedIndexes;
        /// <summary>
        ...
        private GetIndexEndpointResult(
            ...
            ImmutableArray<Outputs.GoogleCloudAiplatformV1beta1DeployedIndexResponse> deployedIndexes,
