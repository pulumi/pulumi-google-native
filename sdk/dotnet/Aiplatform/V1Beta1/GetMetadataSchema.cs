...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetMetadataSchema
    {
        ...
        public static Task<GetMetadataSchemaResult> InvokeAsync(GetMetadataSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetadataSchemaResult>("google-native:aiplatform/v1beta1:getMetadataSchema", args ?? new GetMetadataSchemaArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a specific MetadataSchema.
        /// </summary>
        public static Output<GetMetadataSchemaResult> Invoke(GetMetadataSchemaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMetadataSchemaResult>("google-native:aiplatform/v1beta1:getMetadataSchema", args ?? new GetMetadataSchemaInvokeArgs(), options.WithDefaults());
    }
