...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetModelIamPolicy
    {
        ...
        public static Task<GetModelIamPolicyResult> InvokeAsync(GetModelIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetModelIamPolicyResult>("google-native:aiplatform/v1beta1:getModelIamPolicy", args ?? new GetModelIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetModelIamPolicyResult> Invoke(GetModelIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetModelIamPolicyResult>("google-native:aiplatform/v1beta1:getModelIamPolicy", args ?? new GetModelIamPolicyInvokeArgs(), options.WithDefaults());
    }
