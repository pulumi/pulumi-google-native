...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetPipelineJob
    {
        ...
        public static Task<GetPipelineJobResult> InvokeAsync(GetPipelineJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPipelineJobResult>("google-native:aiplatform/v1beta1:getPipelineJob", args ?? new GetPipelineJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a PipelineJob.
        /// </summary>
        public static Output<GetPipelineJobResult> Invoke(GetPipelineJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPipelineJobResult>("google-native:aiplatform/v1beta1:getPipelineJob", args ?? new GetPipelineJobInvokeArgs(), options.WithDefaults());
    }
