...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetSpecialistPool
    {
        ...
        public static Task<GetSpecialistPoolResult> InvokeAsync(GetSpecialistPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSpecialistPoolResult>("google-native:aiplatform/v1beta1:getSpecialistPool", args ?? new GetSpecialistPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a SpecialistPool.
        /// </summary>
        public static Output<GetSpecialistPoolResult> Invoke(GetSpecialistPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSpecialistPoolResult>("google-native:aiplatform/v1beta1:getSpecialistPool", args ?? new GetSpecialistPoolInvokeArgs(), options.WithDefaults());
    }
