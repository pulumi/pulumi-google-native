...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetTrainingPipeline
    {
        ...
        public static Task<GetTrainingPipelineResult> InvokeAsync(GetTrainingPipelineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrainingPipelineResult>("google-native:aiplatform/v1beta1:getTrainingPipeline", args ?? new GetTrainingPipelineArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a TrainingPipeline.
        /// </summary>
        public static Output<GetTrainingPipelineResult> Invoke(GetTrainingPipelineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrainingPipelineResult>("google-native:aiplatform/v1beta1:getTrainingPipeline", args ?? new GetTrainingPipelineInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetTrainingPipelineResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1beta1InputDataConfigResponse InputDataConfig;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAiplatformV1beta1ModelResponse ModelToUpload;
        /// <summary>
        ...
        private GetTrainingPipelineResult(
            ...
            Outputs.GoogleCloudAiplatformV1beta1InputDataConfigResponse inputDataConfig,

            ImmutableDictionary<string, string> labels,

            string modelId,

            Outputs.GoogleCloudAiplatformV1beta1ModelResponse modelToUpload,
