...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    public static class GetTrial
    {
        ...
        public static Task<GetTrialResult> InvokeAsync(GetTrialArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrialResult>("google-native:aiplatform/v1beta1:getTrial", args ?? new GetTrialArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Trial.
        /// </summary>
        public static Output<GetTrialResult> Invoke(GetTrialInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrialResult>("google-native:aiplatform/v1beta1:getTrial", args ?? new GetTrialInvokeArgs(), options.WithDefaults());
    }
