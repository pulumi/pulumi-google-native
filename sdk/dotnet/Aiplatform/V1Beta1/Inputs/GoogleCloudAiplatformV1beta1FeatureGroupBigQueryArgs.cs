...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1.Inputs
{
    ...
    /// </summary>
    public sealed class GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Immutable. The BigQuery source URI that points to either a BigQuery Table or View.
        /// </summary>
        [Input("bigQuerySource", required: true)]
        public Input<Inputs.GoogleCloudAiplatformV1beta1BigQuerySourceArgs> BigQuerySource { get; set; } = null!;
        ...
        public GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs()
        {
        }
        public static new GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs Empty => new GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs();
    }
}
