...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1.Inputs
{
    ...
    /// </summary>
    public sealed class GoogleCloudAiplatformV1beta1FeatureViewIndexConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional. Configuration options for using brute force search, which simply implements the standard linear search in the database for each query. It is primarily meant for benchmarking and to generate the ground truth for approximate search.
        /// </summary>
        [Input("bruteForceConfig")]
        public Input<Inputs.GoogleCloudAiplatformV1beta1FeatureViewIndexConfigBruteForceConfigArgs>? BruteForceConfig { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Aiplatform.V1Beta1.GoogleCloudAiplatformV1beta1FeatureViewIndexConfigDistanceMeasureType>? DistanceMeasureType { get; set; }
        ...
        /// </summary>
        [Input("treeAhConfig")]
        public Input<Inputs.GoogleCloudAiplatformV1beta1FeatureViewIndexConfigTreeAHConfigArgs>? TreeAhConfig { get; set; }

        public GoogleCloudAiplatformV1beta1FeatureViewIndexConfigArgs()
        {
        }
        public static new GoogleCloudAiplatformV1beta1FeatureViewIndexConfigArgs Empty => new GoogleCloudAiplatformV1beta1FeatureViewIndexConfigArgs();
    }
}
