...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1.Inputs
{
    ...
    /// </summary>
    public sealed class GoogleCloudAiplatformV1beta1InputDataConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("filterSplit")]
        public Input<Inputs.GoogleCloudAiplatformV1beta1FilterSplitArgs>? FilterSplit { get; set; }

        /// <summary>
        /// Split based on fractions defining the size of each set.
        /// </summary>
        [Input("fractionSplit")]
        public Input<Inputs.GoogleCloudAiplatformV1beta1FractionSplitArgs>? FractionSplit { get; set; }
        ...
        public Input<Inputs.GoogleCloudAiplatformV1beta1PredefinedSplitArgs>? PredefinedSplit { get; set; }
        ...
        public Input<Inputs.GoogleCloudAiplatformV1beta1StratifiedSplitArgs>? StratifiedSplit { get; set; }

        /// <summary>
        /// Supported only for tabular Datasets. Split based on the timestamp of the input data pieces.
        /// </summary>
        [Input("timestampSplit")]
        public Input<Inputs.GoogleCloudAiplatformV1beta1TimestampSplitArgs>? TimestampSplit { get; set; }

        public GoogleCloudAiplatformV1beta1InputDataConfigArgs()
        {
        }
        public static new GoogleCloudAiplatformV1beta1InputDataConfigArgs Empty => new GoogleCloudAiplatformV1beta1InputDataConfigArgs();
    }
}
