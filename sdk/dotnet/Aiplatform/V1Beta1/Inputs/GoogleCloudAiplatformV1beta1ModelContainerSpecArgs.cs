...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1.Inputs
{
    ...
    /// </summary>
    public sealed class GoogleCloudAiplatformV1beta1ModelContainerSpecArgs : global::Pulumi.ResourceArgs
    {
        [Input("args")]
        ...
        [Input("grpcPorts")]
        private InputList<Inputs.GoogleCloudAiplatformV1beta1PortArgs>? _grpcPorts;
        ...
        /// </summary>
        public InputList<Inputs.GoogleCloudAiplatformV1beta1PortArgs> GrpcPorts
        {
            get => _grpcPorts ?? (_grpcPorts = new InputList<Inputs.GoogleCloudAiplatformV1beta1PortArgs>());
        ...
        /// </summary>
        [Input("healthProbe")]
        public Input<Inputs.GoogleCloudAiplatformV1beta1ProbeArgs>? HealthProbe { get; set; }
        ...
        [Input("ports")]
        private InputList<Inputs.GoogleCloudAiplatformV1beta1PortArgs>? _ports;

        /// <summary>
        /// Immutable. List of ports to expose from the container. Vertex AI sends any prediction requests that it receives to the first port on this list. Vertex AI also sends [liveness and health checks](https://cloud.google.com/vertex-ai/docs/predictions/custom-container-requirements#liveness) to this port. If you do not specify this field, it defaults to following value: ```json [ { "containerPort": 8080 } ] ``` Vertex AI does not use ports other than the first one listed. This field corresponds to the `ports` field of the Kubernetes Containers [v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core).
        /// </summary>
        public InputList<Inputs.GoogleCloudAiplatformV1beta1PortArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Inputs.GoogleCloudAiplatformV1beta1PortArgs>());
            set => _ports = value;
        }
        ...
        /// </summary>
        [Input("startupProbe")]
        public Input<Inputs.GoogleCloudAiplatformV1beta1ProbeArgs>? StartupProbe { get; set; }

        public GoogleCloudAiplatformV1beta1ModelContainerSpecArgs()
        {
        }
        public static new GoogleCloudAiplatformV1beta1ModelContainerSpecArgs Empty => new GoogleCloudAiplatformV1beta1ModelContainerSpecArgs();
    }
}
