...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:MetadataSchema")]
    public partial class MetadataSchema : global::Pulumi.CustomResource
    {
        ...
        public MetadataSchema(string name, MetadataSchemaArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:MetadataSchema", name, args ?? new MetadataSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetadataSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:MetadataSchema", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MetadataSchemaArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("schemaType")]
        public Input<Pulumi.GoogleNative.Aiplatform.V1Beta1.MetadataSchemaSchemaType>? SchemaType { get; set; }
