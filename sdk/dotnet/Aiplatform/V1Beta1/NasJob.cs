...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:NasJob")]
    public partial class NasJob : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("nasJobOutput")]
        public Output<Outputs.GoogleCloudAiplatformV1beta1NasJobOutputResponse> NasJobOutput { get; private set; } = null!;

        /// <summary>
        /// The specification of a NasJob.
        /// </summary>
        [Output("nasJobSpec")]
        public Output<Outputs.GoogleCloudAiplatformV1beta1NasJobSpecResponse> NasJobSpec { get; private set; } = null!;
        ...
        public NasJob(string name, NasJobArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:NasJob", name, args ?? new NasJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NasJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:NasJob", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NasJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1beta1NasJobSpecArgs> NasJobSpec { get; set; } = null!;
