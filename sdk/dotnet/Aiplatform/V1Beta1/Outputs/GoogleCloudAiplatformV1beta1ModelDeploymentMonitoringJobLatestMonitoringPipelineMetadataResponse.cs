...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse(
            string runTime,
