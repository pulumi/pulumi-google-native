...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudAiplatformV1beta1PipelineTemplateMetadataResponse
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GoogleCloudAiplatformV1beta1PipelineTemplateMetadataResponse(string version)
        {
            Version = version;
        }
    }
