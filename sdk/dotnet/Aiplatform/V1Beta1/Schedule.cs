...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// Creates a Schedule.
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:Schedule")]
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudAiplatformV1beta1CreatePipelineJobRequestResponse> CreatePipelineJobRequest { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAiplatformV1beta1ScheduleRunResponseResponse> LastScheduledRunResponse { get; private set; } = null!;
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudAiplatformV1beta1CreatePipelineJobRequestArgs>? CreatePipelineJobRequest { get; set; }
