...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:Study")]
    public partial class Study : global::Pulumi.CustomResource
    {
        ...
        public Study(string name, StudyArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:Study", name, args ?? new StudyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Study(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:Study", name, null, MakeResourceOptions(options, id))
        {
        }
