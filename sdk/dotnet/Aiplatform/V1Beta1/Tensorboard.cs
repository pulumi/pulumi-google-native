...
namespace Pulumi.GoogleNative.Aiplatform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:aiplatform/v1beta1:Tensorboard")]
    public partial class Tensorboard : global::Pulumi.CustomResource
    {
        ...
        public Tensorboard(string name, TensorboardArgs args, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:Tensorboard", name, args ?? new TensorboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tensorboard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:aiplatform/v1beta1:Tensorboard", name, null, MakeResourceOptions(options, id))
        {
        }
