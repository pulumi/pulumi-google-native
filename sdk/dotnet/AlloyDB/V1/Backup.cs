...
namespace Pulumi.GoogleNative.AlloyDB.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:alloydb/v1:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("google-native:alloydb/v1:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:alloydb/v1:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.AlloyDB.V1.BackupType>? Type { get; set; }
