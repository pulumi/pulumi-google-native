...
namespace Pulumi.GoogleNative.AlloyDB.V1Alpha.Inputs
{
    ...
    public sealed class SslConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caSource")]
        public Input<Pulumi.GoogleNative.AlloyDB.V1Alpha.SslConfigCaSource>? CaSource { get; set; }

        /// <summary>
        /// Optional. SSL mode. Specifies client-server SSL/TLS connection behavior.
        /// </summary>
        [Input("sslMode")]
        public Input<Pulumi.GoogleNative.AlloyDB.V1Alpha.SslConfigSslMode>? SslMode { get; set; }
