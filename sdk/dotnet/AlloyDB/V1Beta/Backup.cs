...
namespace Pulumi.GoogleNative.AlloyDB.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:alloydb/v1beta:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("google-native:alloydb/v1beta:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:alloydb/v1beta:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.AlloyDB.V1Beta.BackupType>? Type { get; set; }
