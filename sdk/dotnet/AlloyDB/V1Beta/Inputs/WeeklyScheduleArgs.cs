...
namespace Pulumi.GoogleNative.AlloyDB.V1Beta.Inputs
{
    ...
    {
        [Input("daysOfWeek")]
        private InputList<Pulumi.GoogleNative.AlloyDB.V1Beta.WeeklyScheduleDaysOfWeekItem>? _daysOfWeek;

        /// <summary>
        /// The days of the week to perform a backup. If this field is left empty, the default of every day of the week is used.
        /// </summary>
        public InputList<Pulumi.GoogleNative.AlloyDB.V1Beta.WeeklyScheduleDaysOfWeekItem> DaysOfWeek
        {
            get => _daysOfWeek ?? (_daysOfWeek = new InputList<Pulumi.GoogleNative.AlloyDB.V1Beta.WeeklyScheduleDaysOfWeekItem>());
