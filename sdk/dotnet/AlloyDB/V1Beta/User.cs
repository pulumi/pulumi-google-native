...
namespace Pulumi.GoogleNative.AlloyDB.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:alloydb/v1beta:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("google-native:alloydb/v1beta:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:alloydb/v1beta:User", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("userType")]
        public Input<Pulumi.GoogleNative.AlloyDB.V1Beta.UserUserType>? UserType { get; set; }
