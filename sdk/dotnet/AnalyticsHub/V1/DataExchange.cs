...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:analyticshub/v1:DataExchange")]
    public partial class DataExchange : global::Pulumi.CustomResource
    {
        ...
        public DataExchange(string name, DataExchangeArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:DataExchange", name, args ?? new DataExchangeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExchange(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:DataExchange", name, null, MakeResourceOptions(options, id))
        {
        }
