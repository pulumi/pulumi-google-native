...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:analyticshub/v1:DataExchangeIamPolicy")]
    public partial class DataExchangeIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public DataExchangeIamPolicy(string name, DataExchangeIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:DataExchangeIamPolicy", name, args ?? new DataExchangeIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExchangeIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:DataExchangeIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataExchangeIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DataExchangeIamPolicy(name, id, options);
        }
    }
