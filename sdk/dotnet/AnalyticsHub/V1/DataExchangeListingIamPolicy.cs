...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:analyticshub/v1:DataExchangeListingIamPolicy")]
    public partial class DataExchangeListingIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public DataExchangeListingIamPolicy(string name, DataExchangeListingIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:DataExchangeListingIamPolicy", name, args ?? new DataExchangeListingIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExchangeListingIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:DataExchangeListingIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataExchangeListingIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
