...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    public static class GetDataExchange
    {
        ...
        public static Task<GetDataExchangeResult> InvokeAsync(GetDataExchangeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataExchangeResult>("google-native:analyticshub/v1:getDataExchange", args ?? new GetDataExchangeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a data exchange.
        /// </summary>
        public static Output<GetDataExchangeResult> Invoke(GetDataExchangeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataExchangeResult>("google-native:analyticshub/v1:getDataExchange", args ?? new GetDataExchangeInvokeArgs(), options.WithDefaults());
    }
