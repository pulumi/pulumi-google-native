...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    public static class GetDataExchangeIamPolicy
    {
        ...
        public static Task<GetDataExchangeIamPolicyResult> InvokeAsync(GetDataExchangeIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataExchangeIamPolicyResult>("google-native:analyticshub/v1:getDataExchangeIamPolicy", args ?? new GetDataExchangeIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetDataExchangeIamPolicyResult> Invoke(GetDataExchangeIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataExchangeIamPolicyResult>("google-native:analyticshub/v1:getDataExchangeIamPolicy", args ?? new GetDataExchangeIamPolicyInvokeArgs(), options.WithDefaults());
    }
