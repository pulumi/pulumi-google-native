...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    public static class GetListing
    {
        ...
        public static Task<GetListingResult> InvokeAsync(GetListingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetListingResult>("google-native:analyticshub/v1:getListing", args ?? new GetListingArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a listing.
        /// </summary>
        public static Output<GetListingResult> Invoke(GetListingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetListingResult>("google-native:analyticshub/v1:getListing", args ?? new GetListingInvokeArgs(), options.WithDefaults());
    }
