...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    public static class GetSubscriptionIamPolicy
    {
        ...
        public static Task<GetSubscriptionIamPolicyResult> InvokeAsync(GetSubscriptionIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSubscriptionIamPolicyResult>("google-native:analyticshub/v1:getSubscriptionIamPolicy", args ?? new GetSubscriptionIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetSubscriptionIamPolicyResult> Invoke(GetSubscriptionIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSubscriptionIamPolicyResult>("google-native:analyticshub/v1:getSubscriptionIamPolicy", args ?? new GetSubscriptionIamPolicyInvokeArgs(), options.WithDefaults());
    }
