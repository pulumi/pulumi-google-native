...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:analyticshub/v1:Listing")]
    public partial class Listing : global::Pulumi.CustomResource
    {
        ...
        public Listing(string name, ListingArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:Listing", name, args ?? new ListingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Listing(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:Listing", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ListingArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("categories")]
        private InputList<Pulumi.GoogleNative.AnalyticsHub.V1.ListingCategoriesItem>? _categories;

        /// <summary>
        /// Optional. Categories of the listing. Up to two categories are allowed.
        /// </summary>
        public InputList<Pulumi.GoogleNative.AnalyticsHub.V1.ListingCategoriesItem> Categories
        {
            get => _categories ?? (_categories = new InputList<Pulumi.GoogleNative.AnalyticsHub.V1.ListingCategoriesItem>());
