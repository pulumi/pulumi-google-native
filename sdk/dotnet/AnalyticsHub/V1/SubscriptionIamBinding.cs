...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    ...
    /// Sets the IAM policy.
    /// </summary>
    [GoogleNativeResourceType("google-native:analyticshub/v1:SubscriptionIamBinding")]
    public partial class SubscriptionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionIamBinding(string name, SubscriptionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:SubscriptionIamBinding", name, args ?? new SubscriptionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:SubscriptionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SubscriptionIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SubscriptionIamBinding(name, id, options);
        }
    }
