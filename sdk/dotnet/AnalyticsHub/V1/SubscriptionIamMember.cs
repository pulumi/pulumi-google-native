...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    ...
    /// Sets the IAM policy.
    /// </summary>
    [GoogleNativeResourceType("google-native:analyticshub/v1:SubscriptionIamMember")]
    public partial class SubscriptionIamMember : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionIamMember(string name, SubscriptionIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:SubscriptionIamMember", name, args ?? new SubscriptionIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:SubscriptionIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
