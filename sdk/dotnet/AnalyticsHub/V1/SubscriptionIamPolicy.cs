...
namespace Pulumi.GoogleNative.AnalyticsHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:analyticshub/v1:SubscriptionIamPolicy")]
    public partial class SubscriptionIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionIamPolicy(string name, SubscriptionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:SubscriptionIamPolicy", name, args ?? new SubscriptionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1:SubscriptionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SubscriptionIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
