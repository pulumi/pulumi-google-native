...
namespace Pulumi.GoogleNative.AnalyticsHub.V1Beta1
{
    ...
    public partial class DataExchangeIamMember : global::Pulumi.CustomResource
    {
        ...
        public DataExchangeIamMember(string name, DataExchangeIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1beta1:DataExchangeIamMember", name, args ?? new DataExchangeIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExchangeIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1beta1:DataExchangeIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataExchangeIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DataExchangeIamMember(name, id, options);
        }
    }
