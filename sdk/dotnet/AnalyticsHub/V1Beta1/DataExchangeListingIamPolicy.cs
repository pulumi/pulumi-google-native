...
namespace Pulumi.GoogleNative.AnalyticsHub.V1Beta1
{
    ...
    public partial class DataExchangeListingIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public DataExchangeListingIamPolicy(string name, DataExchangeListingIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1beta1:DataExchangeListingIamPolicy", name, args ?? new DataExchangeListingIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExchangeListingIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:analyticshub/v1beta1:DataExchangeListingIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
