...
namespace Pulumi.GoogleCloud.Apigateway.V1beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:apigateway/v1beta:Api")]
    public partial class Api : Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigateway/v1beta:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigateway/v1beta:Api", name, null, MakeResourceOptions(options, id))
        {
        }
