...
namespace Pulumi.GoogleNative.Apigee.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apigee/v1:DeveloperApp")]
    public partial class DeveloperApp : global::Pulumi.CustomResource
    {
        ...
        public DeveloperApp(string name, DeveloperAppArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:DeveloperApp", name, args ?? new DeveloperAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeveloperApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:DeveloperApp", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DeveloperApp Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DeveloperApp(name, id, options);
        }
    }
