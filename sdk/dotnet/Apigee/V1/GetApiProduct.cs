...
namespace Pulumi.GoogleNative.Apigee.V1
{
    public static class GetApiProduct
    {
        ...
        public static Task<GetApiProductResult> InvokeAsync(GetApiProductArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiProductResult>("google-native:apigee/v1:getApiProduct", args ?? new GetApiProductArgs(), options.WithDefaults());

        /// <summary>
        /// Gets configuration details for an API product. The API product name required in the request URL is the internal name of the product, not the display name. While they may be the same, it depends on whether the API product was created via the UI or the API. View the list of API products to verify the internal name.
        /// </summary>
        public static Output<GetApiProductResult> Invoke(GetApiProductInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiProductResult>("google-native:apigee/v1:getApiProduct", args ?? new GetApiProductInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetApiProductResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<string> ApiResources;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudApigeeV1OperationGroupResponse OperationGroup;
        /// <summary>
        ...
        /// </summary>
        public readonly string QuotaTimeUnit;
        /// <summary>
        ...
        private GetApiProductResult(
            ImmutableArray<string> apiResources,
            ...
            Outputs.GoogleCloudApigeeV1OperationGroupResponse operationGroup,
