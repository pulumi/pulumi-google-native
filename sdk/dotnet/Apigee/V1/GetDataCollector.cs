...
namespace Pulumi.GoogleNative.Apigee.V1
{
    public static class GetDataCollector
    {
        ...
        public static Task<GetDataCollectorResult> InvokeAsync(GetDataCollectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataCollectorResult>("google-native:apigee/v1:getDataCollector", args ?? new GetDataCollectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a data collector.
        /// </summary>
        public static Output<GetDataCollectorResult> Invoke(GetDataCollectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataCollectorResult>("google-native:apigee/v1:getDataCollector", args ?? new GetDataCollectorInvokeArgs(), options.WithDefaults());
    }
