...
namespace Pulumi.GoogleNative.Apigee.V1
{
    public static class GetDebugSession
    {
        ...
        public static Task<GetDebugSessionResult> InvokeAsync(GetDebugSessionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDebugSessionResult>("google-native:apigee/v1:getDebugSession", args ?? new GetDebugSessionArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a debug session.
        /// </summary>
        public static Output<GetDebugSessionResult> Invoke(GetDebugSessionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDebugSessionResult>("google-native:apigee/v1:getDebugSession", args ?? new GetDebugSessionInvokeArgs(), options.WithDefaults());
    }
