...
namespace Pulumi.GoogleNative.Apigee.V1
{
    public static class GetQuery
    {
        ...
        public static Task<GetQueryResult> InvokeAsync(GetQueryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetQueryResult>("google-native:apigee/v1:getQuery", args ?? new GetQueryArgs(), options.WithDefaults());

        /// <summary>
        /// Get query status If the query is still in progress, the `state` is set to "running" After the query has completed successfully, `state` is set to "completed"
        /// </summary>
        public static Output<GetQueryResult> Invoke(GetQueryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetQueryResult>("google-native:apigee/v1:getQuery", args ?? new GetQueryInvokeArgs(), options.WithDefaults());
    }
