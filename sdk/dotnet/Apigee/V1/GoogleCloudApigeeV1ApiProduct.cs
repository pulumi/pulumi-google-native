...
namespace Pulumi.GoogleCloud.Apigee.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:apigee/v1:GoogleCloudApigeeV1ApiProduct")]
    public partial class GoogleCloudApigeeV1ApiProduct : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleCloudApigeeV1ApiProduct(string name, GoogleCloudApigeeV1ApiProductArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:GoogleCloudApigeeV1ApiProduct", name, args ?? new GoogleCloudApigeeV1ApiProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudApigeeV1ApiProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:GoogleCloudApigeeV1ApiProduct", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudApigeeV1ApiProduct Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudApigeeV1ApiProduct(name, id, options);
        }
    }

    public sealed class GoogleCloudApigeeV1ApiProductArgs : Pulumi.ResourceArgs
    {
        [Input("apiResources")]
        ...
        public GoogleCloudApigeeV1ApiProductArgs()
        {
        }
    }
}
