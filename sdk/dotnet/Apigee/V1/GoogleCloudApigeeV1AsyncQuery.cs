...
namespace Pulumi.GoogleCloud.Apigee.V1
{
    ...
    public partial class GoogleCloudApigeeV1AsyncQuery : Pulumi.CustomResource
    {
        ...
        public GoogleCloudApigeeV1AsyncQuery(string name, GoogleCloudApigeeV1AsyncQueryArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:GoogleCloudApigeeV1AsyncQuery", name, args ?? new GoogleCloudApigeeV1AsyncQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudApigeeV1AsyncQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:GoogleCloudApigeeV1AsyncQuery", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudApigeeV1AsyncQuery Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudApigeeV1AsyncQuery(name, id, options);
        }
    }

    public sealed class GoogleCloudApigeeV1AsyncQueryArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GoogleCloudApigeeV1AsyncQueryArgs()
        {
        }
    }
}
