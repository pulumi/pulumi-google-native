...
namespace Pulumi.GoogleCloud.Apigee.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:apigee/v1:GoogleCloudApigeeV1DeveloperAppKey")]
    public partial class GoogleCloudApigeeV1DeveloperAppKey : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleCloudApigeeV1DeveloperAppKey(string name, GoogleCloudApigeeV1DeveloperAppKeyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:GoogleCloudApigeeV1DeveloperAppKey", name, args ?? new GoogleCloudApigeeV1DeveloperAppKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudApigeeV1DeveloperAppKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:GoogleCloudApigeeV1DeveloperAppKey", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudApigeeV1DeveloperAppKey Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudApigeeV1DeveloperAppKey(name, id, options);
        }
    }

    public sealed class GoogleCloudApigeeV1DeveloperAppKeyArgs : Pulumi.ResourceArgs
    {
        [Input("apiProducts")]
        ...
        public GoogleCloudApigeeV1DeveloperAppKeyArgs()
        {
        }
    }
}
