...
namespace Pulumi.GoogleCloud.Apigee.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:apigee/v1:OrganizationApi")]
    public partial class OrganizationApi : Pulumi.CustomResource
    {
        ...
        public OrganizationApi(string name, OrganizationApiArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:OrganizationApi", name, args ?? new OrganizationApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:OrganizationApi", name, null, MakeResourceOptions(options, id))
        {
        }
