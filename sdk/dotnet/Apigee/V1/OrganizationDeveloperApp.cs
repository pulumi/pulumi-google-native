...
namespace Pulumi.GoogleNative.Apigee.V1
{
    ...
    public partial class OrganizationDeveloperApp : Pulumi.CustomResource
    {
        ...
        public OrganizationDeveloperApp(string name, OrganizationDeveloperAppArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:OrganizationDeveloperApp", name, args ?? new OrganizationDeveloperAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationDeveloperApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:OrganizationDeveloperApp", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationDeveloperApp Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new OrganizationDeveloperApp(name, id, options);
        }
    }

    public sealed class OrganizationDeveloperAppArgs : Pulumi.ResourceArgs
    {
        [Input("apiProducts")]
        ...
        public OrganizationDeveloperAppArgs()
        {
        }
    }
}
