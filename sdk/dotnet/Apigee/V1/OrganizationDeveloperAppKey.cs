...
namespace Pulumi.GoogleNative.Apigee.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apigee/v1:OrganizationDeveloperAppKey")]
    public partial class OrganizationDeveloperAppKey : Pulumi.CustomResource
    {
        ...
        public OrganizationDeveloperAppKey(string name, OrganizationDeveloperAppKeyArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:OrganizationDeveloperAppKey", name, args ?? new OrganizationDeveloperAppKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationDeveloperAppKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:OrganizationDeveloperAppKey", name, null, MakeResourceOptions(options, id))
        {
        }
