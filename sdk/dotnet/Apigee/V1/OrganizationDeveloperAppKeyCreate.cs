...
namespace Pulumi.GoogleCloud.Apigee.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:apigee/v1:OrganizationDeveloperAppKeyCreate")]
    public partial class OrganizationDeveloperAppKeyCreate : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OrganizationDeveloperAppKeyCreate(string name, OrganizationDeveloperAppKeyCreateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:OrganizationDeveloperAppKeyCreate", name, args ?? new OrganizationDeveloperAppKeyCreateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationDeveloperAppKeyCreate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:OrganizationDeveloperAppKeyCreate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationDeveloperAppKeyCreate Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new OrganizationDeveloperAppKeyCreate(name, id, options);
        }
    }

    public sealed class OrganizationDeveloperAppKeyCreateArgs : Pulumi.ResourceArgs
    {
        [Input("apiProducts")]
        ...
        public OrganizationDeveloperAppKeyCreateArgs()
        {
        }
    }
}
