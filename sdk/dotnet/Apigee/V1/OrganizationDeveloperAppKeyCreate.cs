...
namespace Pulumi.GcpNative.Apigee.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:apigee/v1:OrganizationDeveloperAppKeyCreate")]
    public partial class OrganizationDeveloperAppKeyCreate : Pulumi.CustomResource
    {
        ...
        public OrganizationDeveloperAppKeyCreate(string name, OrganizationDeveloperAppKeyCreateArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:apigee/v1:OrganizationDeveloperAppKeyCreate", name, args ?? new OrganizationDeveloperAppKeyCreateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationDeveloperAppKeyCreate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:apigee/v1:OrganizationDeveloperAppKeyCreate", name, null, MakeResourceOptions(options, id))
        {
        }
