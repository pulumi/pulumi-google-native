...
namespace Pulumi.GoogleCloud.Apigee.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:apigee/v1:OrganizationEnvironmentTraceConfigOverride")]
    public partial class OrganizationEnvironmentTraceConfigOverride : Pulumi.CustomResource
    {
        ...
        public OrganizationEnvironmentTraceConfigOverride(string name, OrganizationEnvironmentTraceConfigOverrideArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:OrganizationEnvironmentTraceConfigOverride", name, args ?? new OrganizationEnvironmentTraceConfigOverrideArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationEnvironmentTraceConfigOverride(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:OrganizationEnvironmentTraceConfigOverride", name, null, MakeResourceOptions(options, id))
        {
        }
