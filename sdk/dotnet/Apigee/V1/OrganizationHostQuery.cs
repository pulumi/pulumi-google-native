...
namespace Pulumi.GoogleCloud.Apigee.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:apigee/v1:OrganizationHostQuery")]
    public partial class OrganizationHostQuery : Pulumi.CustomResource
    {
        ...
        public OrganizationHostQuery(string name, OrganizationHostQueryArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:OrganizationHostQuery", name, args ?? new OrganizationHostQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationHostQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:apigee/v1:OrganizationHostQuery", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationHostQuery Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new OrganizationHostQuery(name, id, options);
        }
    }

    public sealed class OrganizationHostQueryArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public OrganizationHostQueryArgs()
        {
        }
    }
}
