...
namespace Pulumi.GoogleNative.Apigee.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apigee/v1:Query")]
    public partial class Query : Pulumi.CustomResource
    {
        ...
        public Query(string name, QueryArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:Query", name, args ?? new QueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Query(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:Query", name, null, MakeResourceOptions(options, id))
        {
        }
