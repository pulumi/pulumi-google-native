...
namespace Pulumi.GoogleNative.Apigee.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apigee/v1:SecurityReport")]
    public partial class SecurityReport : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SecurityReport(string name, SecurityReportArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:SecurityReport", name, args ?? new SecurityReportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityReport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigee/v1:SecurityReport", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecurityReport Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SecurityReport(name, id, options);
        }
    }

    public sealed class SecurityReportArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SecurityReportArgs()
        {
        }
        public static new SecurityReportArgs Empty => new SecurityReportArgs();
    }
}
