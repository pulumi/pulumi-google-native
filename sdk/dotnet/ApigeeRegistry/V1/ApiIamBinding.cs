...
namespace Pulumi.GoogleNative.ApigeeRegistry.V1
{
    ...
    public partial class ApiIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ApiIamBinding(string name, ApiIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:ApiIamBinding", name, args ?? new ApiIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:ApiIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
