...
namespace Pulumi.GoogleNative.ApigeeRegistry.V1
{
    ...
    public partial class ApiIamMember : global::Pulumi.CustomResource
    {
        ...
        public ApiIamMember(string name, ApiIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:ApiIamMember", name, args ?? new ApiIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:ApiIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ApiIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ApiIamMember(name, id, options);
        }
    }
