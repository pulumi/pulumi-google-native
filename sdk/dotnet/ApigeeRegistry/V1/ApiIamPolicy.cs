...
namespace Pulumi.GoogleNative.ApigeeRegistry.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apigeeregistry/v1:ApiIamPolicy")]
    public partial class ApiIamPolicy : Pulumi.CustomResource
    {
        ...
        public ApiIamPolicy(string name, ApiIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:ApiIamPolicy", name, args ?? new ApiIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:ApiIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ApiIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
