...
namespace Pulumi.GoogleNative.ApigeeRegistry.V1
{
    public static class GetApiIamPolicy
    {
        ...
        public static Task<GetApiIamPolicyResult> InvokeAsync(GetApiIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIamPolicyResult>("google-native:apigeeregistry/v1:getApiIamPolicy", args ?? new GetApiIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetApiIamPolicyResult> Invoke(GetApiIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiIamPolicyResult>("google-native:apigeeregistry/v1:getApiIamPolicy", args ?? new GetApiIamPolicyInvokeArgs(), options.WithDefaults());
    }
