...
namespace Pulumi.GoogleNative.ApigeeRegistry.V1
{
    public static class GetRuntimeIamPolicy
    {
        ...
        public static Task<GetRuntimeIamPolicyResult> InvokeAsync(GetRuntimeIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuntimeIamPolicyResult>("google-native:apigeeregistry/v1:getRuntimeIamPolicy", args ?? new GetRuntimeIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetRuntimeIamPolicyResult> Invoke(GetRuntimeIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuntimeIamPolicyResult>("google-native:apigeeregistry/v1:getRuntimeIamPolicy", args ?? new GetRuntimeIamPolicyInvokeArgs(), options.WithDefaults());
    }
