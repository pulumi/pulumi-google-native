...
namespace Pulumi.GoogleNative.ApigeeRegistry.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:apigeeregistry/v1:InstanceIamMember")]
    public partial class InstanceIamMember : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamMember(string name, InstanceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:InstanceIamMember", name, args ?? new InstanceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:InstanceIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
