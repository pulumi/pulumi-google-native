...
namespace Pulumi.GoogleNative.ApigeeRegistry.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apigeeregistry/v1:InstanceIamPolicy")]
    public partial class InstanceIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamPolicy(string name, InstanceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:InstanceIamPolicy", name, args ?? new InstanceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:InstanceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
