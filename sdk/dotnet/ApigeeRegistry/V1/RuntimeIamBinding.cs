...
namespace Pulumi.GoogleNative.ApigeeRegistry.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apigeeregistry/v1:RuntimeIamBinding")]
    public partial class RuntimeIamBinding : global::Pulumi.CustomResource
    {
        ...
        public RuntimeIamBinding(string name, RuntimeIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:RuntimeIamBinding", name, args ?? new RuntimeIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RuntimeIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apigeeregistry/v1:RuntimeIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RuntimeIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RuntimeIamBinding(name, id, options);
        }
    }
