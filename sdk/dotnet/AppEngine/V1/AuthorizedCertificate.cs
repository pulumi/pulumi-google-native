...
namespace Pulumi.GoogleNative.AppEngine.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:appengine/v1:AuthorizedCertificate")]
    public partial class AuthorizedCertificate : global::Pulumi.CustomResource
    {
        ...
        public AuthorizedCertificate(string name, AuthorizedCertificateArgs args, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1:AuthorizedCertificate", name, args ?? new AuthorizedCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizedCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1:AuthorizedCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
