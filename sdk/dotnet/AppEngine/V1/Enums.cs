...
namespace Pulumi.GoogleNative.AppEngine.V1
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct ApplicationDatabaseType : IEquatable<ApplicationDatabaseType>
    {
        private readonly string _value;

        private ApplicationDatabaseType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Database type is unspecified.
        /// </summary>
        public static ApplicationDatabaseType DatabaseTypeUnspecified { get; } = new ApplicationDatabaseType("DATABASE_TYPE_UNSPECIFIED");
        /// <summary>
        /// Cloud Datastore
        /// </summary>
        public static ApplicationDatabaseType CloudDatastore { get; } = new ApplicationDatabaseType("CLOUD_DATASTORE");
        /// <summary>
        /// Cloud Firestore Native
        /// </summary>
        public static ApplicationDatabaseType CloudFirestore { get; } = new ApplicationDatabaseType("CLOUD_FIRESTORE");
        /// <summary>
        /// Cloud Firestore in Datastore Mode
        /// </summary>
        public static ApplicationDatabaseType CloudDatastoreCompatibility { get; } = new ApplicationDatabaseType("CLOUD_DATASTORE_COMPATIBILITY");

        public static bool operator ==(ApplicationDatabaseType left, ApplicationDatabaseType right) => left.Equals(right);
        public static bool operator !=(ApplicationDatabaseType left, ApplicationDatabaseType right) => !left.Equals(right);

        public static explicit operator string(ApplicationDatabaseType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ApplicationDatabaseType other && Equals(other);
        public bool Equals(ApplicationDatabaseType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct ApplicationServingStatus : IEquatable<ApplicationServingStatus>
    {
        private readonly string _value;

        private ApplicationServingStatus(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Serving status is unspecified.
        /// </summary>
        public static ApplicationServingStatus Unspecified { get; } = new ApplicationServingStatus("UNSPECIFIED");
        /// <summary>
        /// Application is serving.
        /// </summary>
        public static ApplicationServingStatus Serving { get; } = new ApplicationServingStatus("SERVING");
        /// <summary>
        /// Application has been disabled by the user.
        /// </summary>
        public static ApplicationServingStatus UserDisabled { get; } = new ApplicationServingStatus("USER_DISABLED");
        /// <summary>
        /// Application has been disabled by the system.
        /// </summary>
        public static ApplicationServingStatus SystemDisabled { get; } = new ApplicationServingStatus("SYSTEM_DISABLED");

        public static bool operator ==(ApplicationServingStatus left, ApplicationServingStatus right) => left.Equals(right);
        public static bool operator !=(ApplicationServingStatus left, ApplicationServingStatus right) => !left.Equals(right);

        public static explicit operator string(ApplicationServingStatus value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ApplicationServingStatus other && Equals(other);
        public bool Equals(ApplicationServingStatus other) => string.Equals(_value, other._value, StringComparison.Ordinal);
