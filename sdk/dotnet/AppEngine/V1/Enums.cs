...
namespace Pulumi.GoogleNative.AppEngine.V1
{
    ...
    public readonly struct ManagedCertificateStatus : IEquatable<ManagedCertificateStatus>
    {
        ...
        public static ManagedCertificateStatus ManagementStatusUnspecified { get; } = new ManagedCertificateStatus("MANAGEMENT_STATUS_UNSPECIFIED");
        /// <summary>
        ...
        /// </summary>
        public static ManagedCertificateStatus FailedPermanent { get; } = new ManagedCertificateStatus("FAILED_PERMANENT");
        /// <summary>
