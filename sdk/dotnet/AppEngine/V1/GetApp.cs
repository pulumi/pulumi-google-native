...
namespace Pulumi.GoogleNative.AppEngine.V1
{
    public static class GetApp
    {
        ...
        public static Task<GetAppResult> InvokeAsync(GetAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppResult>("google-native:appengine/v1:getApp", args ?? new GetAppArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about an application.
        /// </summary>
        public static Output<GetAppResult> Invoke(GetAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppResult>("google-native:appengine/v1:getApp", args ?? new GetAppInvokeArgs(), options.WithDefaults());
    }
