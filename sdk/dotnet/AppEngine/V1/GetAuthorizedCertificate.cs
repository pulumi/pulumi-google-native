...
namespace Pulumi.GoogleNative.AppEngine.V1
{
    public static class GetAuthorizedCertificate
    {
        ...
        public static Task<GetAuthorizedCertificateResult> InvokeAsync(GetAuthorizedCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizedCertificateResult>("google-native:appengine/v1:getAuthorizedCertificate", args ?? new GetAuthorizedCertificateArgs(), options.WithDefaults());
        ...
        public static Output<GetAuthorizedCertificateResult> Invoke(GetAuthorizedCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthorizedCertificateResult>("google-native:appengine/v1:getAuthorizedCertificate", args ?? new GetAuthorizedCertificateInvokeArgs(), options.WithDefaults());
    }
