...
namespace Pulumi.GoogleNative.AppEngine.V1
{
    public static class GetDomainMapping
    {
        ...
        public static Task<GetDomainMappingResult> InvokeAsync(GetDomainMappingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainMappingResult>("google-native:appengine/v1:getDomainMapping", args ?? new GetDomainMappingArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified domain mapping.
        /// </summary>
        public static Output<GetDomainMappingResult> Invoke(GetDomainMappingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainMappingResult>("google-native:appengine/v1:getDomainMapping", args ?? new GetDomainMappingInvokeArgs(), options.WithDefaults());
    }
