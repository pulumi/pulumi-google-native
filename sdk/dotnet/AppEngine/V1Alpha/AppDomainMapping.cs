...
namespace Pulumi.GoogleCloud.AppEngine.V1Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:appengine/v1alpha:AppDomainMapping")]
    public partial class AppDomainMapping : Pulumi.CustomResource
    {
        ...
        public AppDomainMapping(string name, AppDomainMappingArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1alpha:AppDomainMapping", name, args ?? new AppDomainMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppDomainMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1alpha:AppDomainMapping", name, null, MakeResourceOptions(options, id))
        {
        }
