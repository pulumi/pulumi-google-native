...
namespace Pulumi.GcpNative.AppEngine.V1Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:appengine/v1alpha:AppDomainMapping")]
    public partial class AppDomainMapping : Pulumi.CustomResource
    {
        ...
        public AppDomainMapping(string name, AppDomainMappingArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:appengine/v1alpha:AppDomainMapping", name, args ?? new AppDomainMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppDomainMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:appengine/v1alpha:AppDomainMapping", name, null, MakeResourceOptions(options, id))
        {
        }
