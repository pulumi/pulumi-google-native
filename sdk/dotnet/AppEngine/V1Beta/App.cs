...
namespace Pulumi.GoogleNative.AppEngine.V1Beta
{
    ...
    public partial class App : global::Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:App", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("databaseType")]
        public Input<Pulumi.GoogleNative.AppEngine.V1Beta.AppDatabaseType>? DatabaseType { get; set; }
        ...
        /// </summary>
        [Input("servingStatus")]
        public Input<Pulumi.GoogleNative.AppEngine.V1Beta.AppServingStatus>? ServingStatus { get; set; }
