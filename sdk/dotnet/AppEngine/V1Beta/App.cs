...
namespace Pulumi.GcpNative.AppEngine.V1Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:appengine/v1beta:App")]
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:appengine/v1beta:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:appengine/v1beta:App", name, null, MakeResourceOptions(options, id))
        {
        }
