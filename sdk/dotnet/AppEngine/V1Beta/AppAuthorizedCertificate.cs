...
namespace Pulumi.GcpNative.AppEngine.V1Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:appengine/v1beta:AppAuthorizedCertificate")]
    public partial class AppAuthorizedCertificate : Pulumi.CustomResource
    {
        ...
        public AppAuthorizedCertificate(string name, AppAuthorizedCertificateArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:appengine/v1beta:AppAuthorizedCertificate", name, args ?? new AppAuthorizedCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppAuthorizedCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:appengine/v1beta:AppAuthorizedCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
