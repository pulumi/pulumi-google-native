...
namespace Pulumi.GoogleNative.AppEngine.V1Beta
{
    ...
    public partial class AppDomainMapping : Pulumi.CustomResource
    {
        ...
        public AppDomainMapping(string name, AppDomainMappingArgs args, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:AppDomainMapping", name, args ?? new AppDomainMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppDomainMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:AppDomainMapping", name, null, MakeResourceOptions(options, id))
        {
        }
