...
namespace Pulumi.GoogleNative.AppEngine.V1Beta
{
    ...
    public partial class AppServiceVersion : Pulumi.CustomResource
    {
        ...
        public AppServiceVersion(string name, AppServiceVersionArgs args, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:AppServiceVersion", name, args ?? new AppServiceVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:AppServiceVersion", name, null, MakeResourceOptions(options, id))
        {
        }
