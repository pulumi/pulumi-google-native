...
namespace Pulumi.GoogleNative.AppEngine.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:appengine/v1beta:AuthorizedCertificate")]
    public partial class AuthorizedCertificate : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("authorizedCertificateId")]
        public Output<string> AuthorizedCertificateId { get; private set; } = null!;
        ...
        public AuthorizedCertificate(string name, AuthorizedCertificateArgs args, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:AuthorizedCertificate", name, args ?? new AuthorizedCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizedCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:AuthorizedCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
