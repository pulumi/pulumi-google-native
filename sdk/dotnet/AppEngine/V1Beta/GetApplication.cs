...
namespace Pulumi.GoogleNative.AppEngine.V1Beta
{
    public static class GetApplication
    {
        ...
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("google-native:appengine/v1beta:getApplication", args ?? new GetApplicationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about an application.
        /// </summary>
        public static Output<GetApplicationResult> Invoke(GetApplicationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApplicationResult>("google-native:appengine/v1beta:getApplication", args ?? new GetApplicationInvokeArgs(), options.WithDefaults());
    }
