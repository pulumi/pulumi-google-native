...
namespace Pulumi.GoogleNative.AppEngine.V1Beta
{
    public static class GetAuthorizedCertificate
    {
        ...
        public static Task<GetAuthorizedCertificateResult> InvokeAsync(GetAuthorizedCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizedCertificateResult>("google-native:appengine/v1beta:getAuthorizedCertificate", args ?? new GetAuthorizedCertificateArgs(), options.WithVersion());
        ...
        public static Output<GetAuthorizedCertificateResult> Invoke(GetAuthorizedCertificateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAuthorizedCertificateResult>("google-native:appengine/v1beta:getAuthorizedCertificate", args ?? new GetAuthorizedCertificateInvokeArgs(), options.WithVersion());
    }
