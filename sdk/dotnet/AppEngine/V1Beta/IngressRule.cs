...
namespace Pulumi.GoogleNative.AppEngine.V1Beta
{
    ...
    public partial class IngressRule : Pulumi.CustomResource
    {
        ...
        public IngressRule(string name, IngressRuleArgs args, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:IngressRule", name, args ?? new IngressRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IngressRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:IngressRule", name, null, MakeResourceOptions(options, id))
        {
        }
