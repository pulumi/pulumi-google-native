...
namespace Pulumi.GoogleNative.AppEngine.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:appengine/v1beta:Version")]
    public partial class Version : global::Pulumi.CustomResource
    {
        ...
        public Version(string name, VersionArgs args, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:Version", name, args ?? new VersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Version(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:appengine/v1beta:Version", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VersionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// Before an application can receive email or XMPP messages, the application must be configured to enable the service.
        /// </summary>
        public InputList<Pulumi.GoogleNative.AppEngine.V1Beta.VersionInboundServicesItem> InboundServices
        {
            get => _inboundServices ?? (_inboundServices = new InputList<Pulumi.GoogleNative.AppEngine.V1Beta.VersionInboundServicesItem>());
        ...
        /// </summary>
        [Input("servingStatus")]
        public Input<Pulumi.GoogleNative.AppEngine.V1Beta.VersionServingStatus>? ServingStatus { get; set; }
