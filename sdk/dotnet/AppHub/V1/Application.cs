...
namespace Pulumi.GoogleNative.AppHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apphub/v1:Application")]
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1:Application", name, null, MakeResourceOptions(options, id))
        {
        }
