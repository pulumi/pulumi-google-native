...
namespace Pulumi.GoogleNative.AppHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apphub/v1:ApplicationIamPolicy")]
    public partial class ApplicationIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ApplicationIamPolicy(string name, ApplicationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1:ApplicationIamPolicy", name, args ?? new ApplicationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1:ApplicationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
