...
namespace Pulumi.GoogleNative.AppHub.V1
{
    public static class GetWorkload
    {
        ...
        public static Task<GetWorkloadResult> InvokeAsync(GetWorkloadArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkloadResult>("google-native:apphub/v1:getWorkload", args ?? new GetWorkloadArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Workload in an Application.
        /// </summary>
        public static Output<GetWorkloadResult> Invoke(GetWorkloadInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkloadResult>("google-native:apphub/v1:getWorkload", args ?? new GetWorkloadInvokeArgs(), options.WithDefaults());
    }
