...
namespace Pulumi.GoogleNative.AppHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apphub/v1:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1:Service", name, null, MakeResourceOptions(options, id))
        {
        }
