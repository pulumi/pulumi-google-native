...
namespace Pulumi.GoogleNative.AppHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apphub/v1:ServiceProjectAttachment")]
    public partial class ServiceProjectAttachment : global::Pulumi.CustomResource
    {
        ...
        public ServiceProjectAttachment(string name, ServiceProjectAttachmentArgs args, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1:ServiceProjectAttachment", name, args ?? new ServiceProjectAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceProjectAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1:ServiceProjectAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
