...
namespace Pulumi.GoogleNative.AppHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apphub/v1alpha:ApplicationIamPolicy")]
    public partial class ApplicationIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ApplicationIamPolicy(string name, ApplicationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1alpha:ApplicationIamPolicy", name, args ?? new ApplicationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1alpha:ApplicationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ApplicationIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
