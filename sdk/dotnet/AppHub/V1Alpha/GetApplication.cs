...
namespace Pulumi.GoogleNative.AppHub.V1Alpha
{
    public static class GetApplication
    {
        ...
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("google-native:apphub/v1alpha:getApplication", args ?? new GetApplicationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an Application in a host project and location.
        /// </summary>
        public static Output<GetApplicationResult> Invoke(GetApplicationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApplicationResult>("google-native:apphub/v1alpha:getApplication", args ?? new GetApplicationInvokeArgs(), options.WithDefaults());
    }
