...
namespace Pulumi.GoogleNative.AppHub.V1Alpha
{
    public static class GetService
    {
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("google-native:apphub/v1alpha:getService", args ?? new GetServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Service in an Application.
        /// </summary>
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServiceResult>("google-native:apphub/v1alpha:getService", args ?? new GetServiceInvokeArgs(), options.WithDefaults());
    }
