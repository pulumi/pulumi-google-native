...
namespace Pulumi.GoogleNative.AppHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:apphub/v1alpha:Workload")]
    public partial class Workload : global::Pulumi.CustomResource
    {
        ...
        public Workload(string name, WorkloadArgs args, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1alpha:Workload", name, args ?? new WorkloadArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workload(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:apphub/v1alpha:Workload", name, null, MakeResourceOptions(options, id))
        {
        }
