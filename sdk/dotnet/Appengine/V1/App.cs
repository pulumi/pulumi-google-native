...
namespace Pulumi.GoogleCloud.Appengine.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:appengine/v1:App")]
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1:App", name, null, MakeResourceOptions(options, id))
        {
        }
