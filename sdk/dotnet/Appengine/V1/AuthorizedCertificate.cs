...
namespace Pulumi.GoogleCloud.Appengine.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:appengine/v1:AuthorizedCertificate")]
    public partial class AuthorizedCertificate : Pulumi.CustomResource
    {
        ...
        public AuthorizedCertificate(string name, AuthorizedCertificateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1:AuthorizedCertificate", name, args ?? new AuthorizedCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizedCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1:AuthorizedCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
