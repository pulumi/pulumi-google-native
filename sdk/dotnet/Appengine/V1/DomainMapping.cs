...
namespace Pulumi.GoogleCloud.Appengine.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:appengine/v1:DomainMapping")]
    public partial class DomainMapping : Pulumi.CustomResource
    {
        ...
        public DomainMapping(string name, DomainMappingArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1:DomainMapping", name, args ?? new DomainMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1:DomainMapping", name, null, MakeResourceOptions(options, id))
        {
        }
