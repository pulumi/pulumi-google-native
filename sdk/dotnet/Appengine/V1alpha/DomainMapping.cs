...
namespace Pulumi.GoogleCloud.Appengine.V1alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:appengine/v1alpha:DomainMapping")]
    public partial class DomainMapping : Pulumi.CustomResource
    {
        ...
        public DomainMapping(string name, DomainMappingArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1alpha:DomainMapping", name, args ?? new DomainMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1alpha:DomainMapping", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainMappingArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<bool>? NoManagedCertificate { get; set; }
