...
namespace Pulumi.GoogleCloud.Appengine.V1beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:appengine/v1beta:Application")]
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs? args = null, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1beta:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1beta:Application", name, null, MakeResourceOptions(options, id))
        {
        }
