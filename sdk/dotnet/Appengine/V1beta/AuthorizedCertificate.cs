...
namespace Pulumi.GoogleCloud.Appengine.V1beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:appengine/v1beta:AuthorizedCertificate")]
    public partial class AuthorizedCertificate : Pulumi.CustomResource
    {
        ...
        public AuthorizedCertificate(string name, AuthorizedCertificateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1beta:AuthorizedCertificate", name, args ?? new AuthorizedCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizedCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:appengine/v1beta:AuthorizedCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
