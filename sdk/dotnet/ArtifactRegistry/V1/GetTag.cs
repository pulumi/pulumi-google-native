...
namespace Pulumi.GoogleNative.ArtifactRegistry.V1
{
    public static class GetTag
    {
        ...
        public static Task<GetTagResult> InvokeAsync(GetTagArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagResult>("google-native:artifactregistry/v1:getTag", args ?? new GetTagArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a tag.
        /// </summary>
        public static Output<GetTagResult> Invoke(GetTagInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagResult>("google-native:artifactregistry/v1:getTag", args ?? new GetTagInvokeArgs(), options.WithDefaults());
    }
