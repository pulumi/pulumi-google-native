...
namespace Pulumi.GoogleNative.ArtifactRegistry.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:artifactregistry/v1:RepositoryIamMember")]
    public partial class RepositoryIamMember : global::Pulumi.CustomResource
    {
        ...
        public RepositoryIamMember(string name, RepositoryIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1:RepositoryIamMember", name, args ?? new RepositoryIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RepositoryIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1:RepositoryIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
