...
namespace Pulumi.GoogleNative.ArtifactRegistry.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:artifactregistry/v1:RepositoryIamPolicy")]
    public partial class RepositoryIamPolicy : Pulumi.CustomResource
    {
        ...
        public RepositoryIamPolicy(string name, RepositoryIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1:RepositoryIamPolicy", name, args ?? new RepositoryIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RepositoryIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1:RepositoryIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
