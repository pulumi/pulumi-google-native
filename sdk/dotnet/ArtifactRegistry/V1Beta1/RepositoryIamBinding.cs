...
namespace Pulumi.GoogleNative.ArtifactRegistry.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:artifactregistry/v1beta1:RepositoryIamBinding")]
    public partial class RepositoryIamBinding : global::Pulumi.CustomResource
    {
        ...
        public RepositoryIamBinding(string name, RepositoryIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1beta1:RepositoryIamBinding", name, args ?? new RepositoryIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RepositoryIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1beta1:RepositoryIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
