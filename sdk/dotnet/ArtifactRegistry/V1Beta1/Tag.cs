...
namespace Pulumi.GoogleNative.ArtifactRegistry.V1Beta1
{
    ...
    /// Creates a tag.
    /// </summary>
    [GoogleNativeResourceType("google-native:artifactregistry/v1beta1:Tag")]
    public partial class Tag : Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1beta1:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1beta1:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
