...
namespace Pulumi.GoogleNative.ArtifactRegistry.V1Beta2
{
    public static class GetRepository
    {
        ...
        public static Task<GetRepositoryResult> InvokeAsync(GetRepositoryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRepositoryResult>("google-native:artifactregistry/v1beta2:getRepository", args ?? new GetRepositoryArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a repository.
        /// </summary>
        public static Output<GetRepositoryResult> Invoke(GetRepositoryInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRepositoryResult>("google-native:artifactregistry/v1beta2:getRepository", args ?? new GetRepositoryInvokeArgs(), options.WithDefaults());
    }
