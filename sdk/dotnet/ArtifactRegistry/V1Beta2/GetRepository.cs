...
namespace Pulumi.GoogleNative.ArtifactRegistry.V1Beta2
{
    public static class GetRepository
    {
        ...
        public static Output<GetRepositoryResult> Invoke(GetRepositoryInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRepositoryResult>("google-native:artifactregistry/v1beta2:getRepository", args ?? new GetRepositoryInvokeArgs(), options.WithVersion());
    }
