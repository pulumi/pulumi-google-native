...
namespace Pulumi.GoogleNative.ArtifactRegistry.V1Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:artifactregistry/v1beta2:RepositoryIamMember")]
    public partial class RepositoryIamMember : global::Pulumi.CustomResource
    {
        ...
        public RepositoryIamMember(string name, RepositoryIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1beta2:RepositoryIamMember", name, args ?? new RepositoryIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RepositoryIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:artifactregistry/v1beta2:RepositoryIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RepositoryIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RepositoryIamMember(name, id, options);
        }
    }
