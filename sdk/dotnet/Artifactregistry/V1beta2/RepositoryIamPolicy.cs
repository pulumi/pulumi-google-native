...
namespace Pulumi.GoogleCloud.Artifactregistry.V1beta2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:artifactregistry/v1beta2:RepositoryIamPolicy")]
    public partial class RepositoryIamPolicy : Pulumi.CustomResource
    {
        ...
        public RepositoryIamPolicy(string name, RepositoryIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:artifactregistry/v1beta2:RepositoryIamPolicy", name, args ?? new RepositoryIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RepositoryIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:artifactregistry/v1beta2:RepositoryIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RepositoryIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
