...
namespace Pulumi.GoogleCloud.Artifactregistry.V1beta2
{
    ...
    /// Creates a tag.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:artifactregistry/v1beta2:Tag")]
    public partial class Tag : Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:artifactregistry/v1beta2:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:artifactregistry/v1beta2:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
