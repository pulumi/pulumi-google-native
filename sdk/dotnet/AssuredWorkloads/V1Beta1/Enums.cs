...
namespace Pulumi.GoogleNative.AssuredWorkloads.V1Beta1
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType : IEquatable<GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType>
    {
        private readonly string _value;

        private GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Unknown resource type.
        /// </summary>
        public static GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType ResourceTypeUnspecified { get; } = new GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("RESOURCE_TYPE_UNSPECIFIED");
        /// <summary>
        /// Deprecated. Existing workloads will continue to support this, but new CreateWorkloadRequests should not specify this as an input value.
        /// </summary>
        public static GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType ConsumerProject { get; } = new GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("CONSUMER_PROJECT");
        /// <summary>
        /// Consumer Folder.
        /// </summary>
        public static GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType ConsumerFolder { get; } = new GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("CONSUMER_FOLDER");
        /// <summary>
        /// Consumer project containing encryption keys.
        /// </summary>
        public static GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType EncryptionKeysProject { get; } = new GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("ENCRYPTION_KEYS_PROJECT");
        /// <summary>
        /// Keyring resource that hosts encryption keys.
        /// </summary>
        public static GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType Keyring { get; } = new GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("KEYRING");

        public static bool operator ==(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType left, GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType right) => left.Equals(right);
        public static bool operator !=(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType left, GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType right) => !left.Equals(right);

        public static explicit operator string(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType other && Equals(other);
        public bool Equals(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
