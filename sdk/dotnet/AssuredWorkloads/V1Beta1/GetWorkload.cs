...
namespace Pulumi.GoogleNative.AssuredWorkloads.V1Beta1
{
    public static class GetWorkload
    {
        ...
        public static Task<GetWorkloadResult> InvokeAsync(GetWorkloadArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkloadResult>("google-native:assuredworkloads/v1beta1:getWorkload", args ?? new GetWorkloadArgs(), options.WithDefaults());

        /// <summary>
        /// Gets Assured Workload associated with a CRM Node
        /// </summary>
        public static Output<GetWorkloadResult> Invoke(GetWorkloadInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWorkloadResult>("google-native:assuredworkloads/v1beta1:getWorkload", args ?? new GetWorkloadInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetWorkloadResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettingsResponse CjisSettings;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatusResponse ComplianceStatus;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettingsResponse FedrampHighSettings;
        /// <summary>
        /// Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
        /// </summary>
        public readonly Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettingsResponse FedrampModerateSettings;
        /// <summary>
        /// Input only. Immutable. Settings specific to resources needed for IL4.
        /// </summary>
        public readonly Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4SettingsResponse Il4Settings;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettingsResponse KmsSettings;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResponse> ResourceSettings;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfoResponse> Resources;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponseResponse SaaEnrollmentResponse;

        [OutputConstructor]
        private GetWorkloadResult(
            string billingAccount,

            Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettingsResponse cjisSettings,

            string complianceRegime,

            Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatusResponse complianceStatus,
            ...
            Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettingsResponse fedrampHighSettings,

            Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettingsResponse fedrampModerateSettings,

            Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4SettingsResponse il4Settings,

            string kajEnrollmentState,

            Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettingsResponse kmsSettings,
            ...
            ImmutableArray<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResponse> resourceSettings,

            ImmutableArray<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfoResponse> resources,

            Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponseResponse saaEnrollmentResponse)
        {
