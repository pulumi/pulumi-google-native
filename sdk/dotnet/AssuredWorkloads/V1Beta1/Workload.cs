...
namespace Pulumi.GoogleNative.AssuredWorkloads.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:assuredworkloads/v1beta1:Workload")]
    public partial class Workload : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("cjisSettings")]
        public Output<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettingsResponse> CjisSettings { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatusResponse> ComplianceStatus { get; private set; } = null!;
        ...
        /// </summary>
        [Output("fedrampHighSettings")]
        public Output<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettingsResponse> FedrampHighSettings { get; private set; } = null!;

        /// <summary>
        /// Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
        /// </summary>
        [Output("fedrampModerateSettings")]
        public Output<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettingsResponse> FedrampModerateSettings { get; private set; } = null!;

        /// <summary>
        /// Input only. Immutable. Settings specific to resources needed for IL4.
        /// </summary>
        [Output("il4Settings")]
        public Output<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4SettingsResponse> Il4Settings { get; private set; } = null!;
        ...
        /// </summary>
        [Output("kmsSettings")]
        public Output<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettingsResponse> KmsSettings { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResponse>> ResourceSettings { get; private set; } = null!;
        ...
        /// </summary>
        [Output("resources")]
        public Output<ImmutableArray<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfoResponse>> Resources { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponseResponse> SaaEnrollmentResponse { get; private set; } = null!;
        ...
        public Workload(string name, WorkloadArgs args, CustomResourceOptions? options = null)
            : base("google-native:assuredworkloads/v1beta1:Workload", name, args ?? new WorkloadArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workload(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:assuredworkloads/v1beta1:Workload", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkloadArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cjisSettings")]
        public Input<Inputs.GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsArgs>? CjisSettings { get; set; }

        /// <summary>
        /// Immutable. Compliance Regime associated with this workload.
        /// </summary>
        [Input("complianceRegime", required: true)]
        public Input<Pulumi.GoogleNative.AssuredWorkloads.V1Beta1.WorkloadComplianceRegime> ComplianceRegime { get; set; } = null!;
        ...
        /// Input only. Immutable. Settings specific to resources needed for FedRAMP High.
        /// </summary>
        [Input("fedrampHighSettings")]
        public Input<Inputs.GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsArgs>? FedrampHighSettings { get; set; }

        /// <summary>
        /// Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
        /// </summary>
        [Input("fedrampModerateSettings")]
        public Input<Inputs.GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettingsArgs>? FedrampModerateSettings { get; set; }

        /// <summary>
        /// Input only. Immutable. Settings specific to resources needed for IL4.
        /// </summary>
        [Input("il4Settings")]
        public Input<Inputs.GoogleCloudAssuredworkloadsV1beta1WorkloadIL4SettingsArgs>? Il4Settings { get; set; }
        ...
        private InputList<Inputs.GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsArgs>? _resourceSettings;

        /// <summary>
        /// Input only. Resource properties that are used to customize workload resources. These properties (such as custom project id) will be used to create workload resources if possible. This field is optional.
        /// </summary>
        public InputList<Inputs.GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsArgs> ResourceSettings
        {
