...
namespace Pulumi.GoogleNative.Batch.V1
{
    public static class GetTaskIamPolicy
    {
        ...
        public static Task<GetTaskIamPolicyResult> InvokeAsync(GetTaskIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTaskIamPolicyResult>("google-native:batch/v1:getTaskIamPolicy", args ?? new GetTaskIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetTaskIamPolicyResult> Invoke(GetTaskIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTaskIamPolicyResult>("google-native:batch/v1:getTaskIamPolicy", args ?? new GetTaskIamPolicyInvokeArgs(), options.WithDefaults());
    }
