...
namespace Pulumi.GoogleNative.Batch.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:batch/v1:JobIamBinding")]
    public partial class JobIamBinding : global::Pulumi.CustomResource
    {
        ...
        public JobIamBinding(string name, JobIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:batch/v1:JobIamBinding", name, args ?? new JobIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:batch/v1:JobIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
