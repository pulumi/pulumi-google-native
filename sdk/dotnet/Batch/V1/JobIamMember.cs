...
namespace Pulumi.GoogleNative.Batch.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:batch/v1:JobIamMember")]
    public partial class JobIamMember : global::Pulumi.CustomResource
    {
        ...
        public JobIamMember(string name, JobIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:batch/v1:JobIamMember", name, args ?? new JobIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:batch/v1:JobIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
