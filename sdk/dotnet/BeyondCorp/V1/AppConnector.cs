...
namespace Pulumi.GoogleNative.BeyondCorp.V1
{
    ...
    public partial class AppConnector : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse> PrincipalInfo { get; private set; } = null!;
        ...
        /// </summary>
        [Output("resourceInfo")]
        public Output<Outputs.GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse> ResourceInfo { get; private set; } = null!;
        ...
        public AppConnector(string name, AppConnectorArgs args, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1:AppConnector", name, args ?? new AppConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1:AppConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoArgs> PrincipalInfo { get; set; } = null!;
