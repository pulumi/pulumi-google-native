...
namespace Pulumi.GoogleNative.BeyondCorp.V1
{
    ...
    public partial class AppGateway : global::Pulumi.CustomResource
    {
        ...
        public AppGateway(string name, AppGatewayArgs args, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1:AppGateway", name, args ?? new AppGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1:AppGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.BeyondCorp.V1.AppGatewayHostType> HostType { get; set; } = null!;
