...
namespace Pulumi.GoogleNative.BeyondCorp.V1
{
    public static class GetAppConnector
    {
        ...
        public static Task<GetAppConnectorResult> InvokeAsync(GetAppConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppConnectorResult>("google-native:beyondcorp/v1:getAppConnector", args ?? new GetAppConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single AppConnector.
        /// </summary>
        public static Output<GetAppConnectorResult> Invoke(GetAppConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppConnectorResult>("google-native:beyondcorp/v1:getAppConnector", args ?? new GetAppConnectorInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetAppConnectorResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse PrincipalInfo;
        /// <summary>
        /// Optional. Resource info of the connector.
        /// </summary>
        public readonly Outputs.GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse ResourceInfo;
        /// <summary>
        ...
        private GetAppConnectorResult(
            ...
            Outputs.GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse principalInfo,

            Outputs.GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse resourceInfo,
