...
namespace Pulumi.GoogleNative.BeyondCorp.V1
{
    public static class GetAppConnector
    {
        ...
        public static Task<GetAppConnectorResult> InvokeAsync(GetAppConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppConnectorResult>("google-native:beyondcorp/v1:getAppConnector", args ?? new GetAppConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single AppConnector.
        /// </summary>
        public static Output<GetAppConnectorResult> Invoke(GetAppConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAppConnectorResult>("google-native:beyondcorp/v1:getAppConnector", args ?? new GetAppConnectorInvokeArgs(), options.WithDefaults());
    }
