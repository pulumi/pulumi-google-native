...
namespace Pulumi.GoogleNative.BeyondCorp.V1
{
    public static class GetAppGateway
    {
        ...
        public static Task<GetAppGatewayResult> InvokeAsync(GetAppGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppGatewayResult>("google-native:beyondcorp/v1:getAppGateway", args ?? new GetAppGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single AppGateway.
        /// </summary>
        public static Output<GetAppGatewayResult> Invoke(GetAppGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAppGatewayResult>("google-native:beyondcorp/v1:getAppGateway", args ?? new GetAppGatewayInvokeArgs(), options.WithDefaults());
    }
