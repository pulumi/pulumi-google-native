...
namespace Pulumi.GoogleNative.BeyondCorp.V1
{
    public static class GetClientGatewayIamPolicy
    {
        ...
        public static Task<GetClientGatewayIamPolicyResult> InvokeAsync(GetClientGatewayIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClientGatewayIamPolicyResult>("google-native:beyondcorp/v1:getClientGatewayIamPolicy", args ?? new GetClientGatewayIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetClientGatewayIamPolicyResult> Invoke(GetClientGatewayIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetClientGatewayIamPolicyResult>("google-native:beyondcorp/v1:getClientGatewayIamPolicy", args ?? new GetClientGatewayIamPolicyInvokeArgs(), options.WithDefaults());
    }
