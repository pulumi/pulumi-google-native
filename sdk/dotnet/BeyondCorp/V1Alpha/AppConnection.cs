...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:beyondcorp/v1alpha:AppConnection")]
    public partial class AppConnection : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponse> ApplicationEndpoint { get; private set; } = null!;
        ...
        /// </summary>
        [Output("gateway")]
        public Output<Outputs.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse> Gateway { get; private set; } = null!;
        ...
        public AppConnection(string name, AppConnectionArgs args, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1alpha:AppConnection", name, args ?? new AppConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1alpha:AppConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppConnectionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional. User-settable AppConnection resource ID. * Must start with a letter. * Must contain between 4-63 characters from `/a-z-/`. * Must end with a number or a letter.
        /// </summary>
        ...
        public Input<Inputs.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointArgs> ApplicationEndpoint { get; set; } = null!;
        ...
        /// </summary>
        [Input("gateway")]
        public Input<Inputs.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayArgs>? Gateway { get; set; }
