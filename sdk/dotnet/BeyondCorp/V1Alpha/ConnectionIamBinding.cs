...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:beyondcorp/v1alpha:ConnectionIamBinding")]
    public partial class ConnectionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamBinding(string name, ConnectionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1alpha:ConnectionIamBinding", name, args ?? new ConnectionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1alpha:ConnectionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
