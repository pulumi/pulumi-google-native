...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:beyondcorp/v1alpha:ConnectionIamMember")]
    public partial class ConnectionIamMember : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamMember(string name, ConnectionIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1alpha:ConnectionIamMember", name, args ?? new ConnectionIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1alpha:ConnectionIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
