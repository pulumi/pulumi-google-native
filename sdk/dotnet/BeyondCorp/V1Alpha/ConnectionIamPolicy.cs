...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:beyondcorp/v1alpha:ConnectionIamPolicy")]
    public partial class ConnectionIamPolicy : Pulumi.CustomResource
    {
        ...
        public ConnectionIamPolicy(string name, ConnectionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1alpha:ConnectionIamPolicy", name, args ?? new ConnectionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:beyondcorp/v1alpha:ConnectionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
