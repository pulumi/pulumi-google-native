...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha
{
    public static class GetAppConnection
    {
        ...
        public static Task<GetAppConnectionResult> InvokeAsync(GetAppConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppConnectionResult>("google-native:beyondcorp/v1alpha:getAppConnection", args ?? new GetAppConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single AppConnection.
        /// </summary>
        public static Output<GetAppConnectionResult> Invoke(GetAppConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppConnectionResult>("google-native:beyondcorp/v1alpha:getAppConnection", args ?? new GetAppConnectionInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetAppConnectionResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponse ApplicationEndpoint;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse Gateway;
        /// <summary>
        ...
        private GetAppConnectionResult(
            Outputs.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponse applicationEndpoint,
            ...
            Outputs.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse gateway,
