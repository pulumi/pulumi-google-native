...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha
{
    public static class GetClientConnectorService
    {
        ...
        public static Task<GetClientConnectorServiceResult> InvokeAsync(GetClientConnectorServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClientConnectorServiceResult>("google-native:beyondcorp/v1alpha:getClientConnectorService", args ?? new GetClientConnectorServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetClientConnectorServiceResult> Invoke(GetClientConnectorServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetClientConnectorServiceResult>("google-native:beyondcorp/v1alpha:getClientConnectorService", args ?? new GetClientConnectorServiceInvokeArgs(), options.WithDefaults());
    }
