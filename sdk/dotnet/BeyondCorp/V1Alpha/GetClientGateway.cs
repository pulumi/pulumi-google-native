...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha
{
    public static class GetClientGateway
    {
        ...
        public static Task<GetClientGatewayResult> InvokeAsync(GetClientGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClientGatewayResult>("google-native:beyondcorp/v1alpha:getClientGateway", args ?? new GetClientGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single ClientGateway.
        /// </summary>
        public static Output<GetClientGatewayResult> Invoke(GetClientGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClientGatewayResult>("google-native:beyondcorp/v1alpha:getClientGateway", args ?? new GetClientGatewayInvokeArgs(), options.WithDefaults());
    }
