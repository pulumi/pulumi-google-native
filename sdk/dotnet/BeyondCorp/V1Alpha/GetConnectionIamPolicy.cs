...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha
{
    public static class GetConnectionIamPolicy
    {
        ...
        public static Task<GetConnectionIamPolicyResult> InvokeAsync(GetConnectionIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectionIamPolicyResult>("google-native:beyondcorp/v1alpha:getConnectionIamPolicy", args ?? new GetConnectionIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetConnectionIamPolicyResult> Invoke(GetConnectionIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectionIamPolicyResult>("google-native:beyondcorp/v1alpha:getConnectionIamPolicy", args ?? new GetConnectionIamPolicyInvokeArgs(), options.WithDefaults());
    }
