...
namespace Pulumi.GoogleNative.BeyondCorp.V1Alpha.Inputs
{
    ...
    public sealed class ResourceInfoArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.GoogleNative.BeyondCorp.V1Alpha.ResourceInfoStatus>? Status { get; set; }

        [Input("sub")]
        private InputList<Inputs.ResourceInfoArgs>? _sub;

        /// <summary>
        /// List of Info for the sub level resources.
        /// </summary>
        public InputList<Inputs.ResourceInfoArgs> Sub
        {
            get => _sub ?? (_sub = new InputList<Inputs.ResourceInfoArgs>());
            set => _sub = value;
        }
