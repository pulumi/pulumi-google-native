...
namespace Pulumi.GoogleNative.BigQuery.V2
{
    ...
    public sealed class RowAccessPolicyIamPolicyArgs : Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        [Input("rowAccessPoliciesId", required: true)]
        public Input<string> RowAccessPoliciesId { get; set; } = null!;
