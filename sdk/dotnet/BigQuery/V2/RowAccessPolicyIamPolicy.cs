...
namespace Pulumi.GoogleNative.BigQuery.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigquery/v2:RowAccessPolicyIamPolicy")]
    public partial class RowAccessPolicyIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        [Output("rowAccessPolicyId")]
        public Output<string> RowAccessPolicyId { get; private set; } = null!;
        ...
        public RowAccessPolicyIamPolicy(string name, RowAccessPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigquery/v2:RowAccessPolicyIamPolicy", name, args ?? new RowAccessPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RowAccessPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigquery/v2:RowAccessPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RowAccessPolicyIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RowAccessPolicyIamPolicy(name, id, options);
        }
    }

    public sealed class RowAccessPolicyIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new RowAccessPolicyIamPolicyArgs Empty => new RowAccessPolicyIamPolicyArgs();
    }
}
