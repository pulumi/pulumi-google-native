...
namespace Pulumi.GoogleNative.BigQuery.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigquery/v2:TableIamBinding")]
    public partial class TableIamBinding : global::Pulumi.CustomResource
    {
        ...
        public TableIamBinding(string name, TableIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigquery/v2:TableIamBinding", name, args ?? new TableIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigquery/v2:TableIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TableIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TableIamBinding(name, id, options);
        }
    }
