...
namespace Pulumi.GoogleNative.BigQuery.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigquery/v2:TableIamMember")]
    public partial class TableIamMember : global::Pulumi.CustomResource
    {
        ...
        public TableIamMember(string name, TableIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigquery/v2:TableIamMember", name, args ?? new TableIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigquery/v2:TableIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TableIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TableIamMember(name, id, options);
        }
    }
