...
namespace Pulumi.GoogleNative.BigQueryConnection.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigqueryconnection/v1:ConnectionIamBinding")]
    public partial class ConnectionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamBinding(string name, ConnectionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigqueryconnection/v1:ConnectionIamBinding", name, args ?? new ConnectionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigqueryconnection/v1:ConnectionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConnectionIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ConnectionIamBinding(name, id, options);
        }
    }
