...
namespace Pulumi.GoogleNative.BigQueryConnection.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigqueryconnection/v1:ConnectionIamPolicy")]
    public partial class ConnectionIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamPolicy(string name, ConnectionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigqueryconnection/v1:ConnectionIamPolicy", name, args ?? new ConnectionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigqueryconnection/v1:ConnectionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConnectionIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
