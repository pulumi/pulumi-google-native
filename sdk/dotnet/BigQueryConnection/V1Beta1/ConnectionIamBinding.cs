...
namespace Pulumi.GoogleNative.BigQueryConnection.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigqueryconnection/v1beta1:ConnectionIamBinding")]
    public partial class ConnectionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamBinding(string name, ConnectionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigqueryconnection/v1beta1:ConnectionIamBinding", name, args ?? new ConnectionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigqueryconnection/v1beta1:ConnectionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
