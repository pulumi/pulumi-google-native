...
namespace Pulumi.GoogleNative.BigQueryConnection.V1Beta1
{
    ...
    public partial class ConnectionIamPolicy : Pulumi.CustomResource
    {
        ...
        public ConnectionIamPolicy(string name, ConnectionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigqueryconnection/v1beta1:ConnectionIamPolicy", name, args ?? new ConnectionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigqueryconnection/v1beta1:ConnectionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
