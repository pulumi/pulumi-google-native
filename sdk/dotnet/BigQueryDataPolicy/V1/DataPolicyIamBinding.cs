...
namespace Pulumi.GoogleNative.BigQueryDataPolicy.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigquerydatapolicy/v1:DataPolicyIamBinding")]
    public partial class DataPolicyIamBinding : global::Pulumi.CustomResource
    {
        ...
        public DataPolicyIamBinding(string name, DataPolicyIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigquerydatapolicy/v1:DataPolicyIamBinding", name, args ?? new DataPolicyIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataPolicyIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigquerydatapolicy/v1:DataPolicyIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataPolicyIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DataPolicyIamBinding(name, id, options);
        }
    }
