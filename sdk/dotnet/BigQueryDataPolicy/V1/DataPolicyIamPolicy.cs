...
namespace Pulumi.GoogleNative.BigQueryDataPolicy.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigquerydatapolicy/v1:DataPolicyIamPolicy")]
    public partial class DataPolicyIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public DataPolicyIamPolicy(string name, DataPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigquerydatapolicy/v1:DataPolicyIamPolicy", name, args ?? new DataPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigquerydatapolicy/v1:DataPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataPolicyIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DataPolicyIamPolicy(name, id, options);
        }
    }
