...
namespace Pulumi.GoogleNative.BigQueryReservation.V1
{
    public static class GetCapacityCommitment
    {
        ...
        public static Task<GetCapacityCommitmentResult> InvokeAsync(GetCapacityCommitmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCapacityCommitmentResult>("google-native:bigqueryreservation/v1:getCapacityCommitment", args ?? new GetCapacityCommitmentArgs(), options.WithDefaults());

        /// <summary>
        /// Returns information about the capacity commitment.
        /// </summary>
        public static Output<GetCapacityCommitmentResult> Invoke(GetCapacityCommitmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCapacityCommitmentResult>("google-native:bigqueryreservation/v1:getCapacityCommitment", args ?? new GetCapacityCommitmentInvokeArgs(), options.WithDefaults());
    }
