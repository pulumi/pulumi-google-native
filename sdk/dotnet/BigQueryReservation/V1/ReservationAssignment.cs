...
namespace Pulumi.GoogleCloud.BigQueryReservation.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:bigqueryreservation/v1:ReservationAssignment")]
    public partial class ReservationAssignment : Pulumi.CustomResource
    {
        ...
        public ReservationAssignment(string name, ReservationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:bigqueryreservation/v1:ReservationAssignment", name, args ?? new ReservationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReservationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:bigqueryreservation/v1:ReservationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
