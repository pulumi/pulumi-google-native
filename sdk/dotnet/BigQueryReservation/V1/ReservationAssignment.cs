...
namespace Pulumi.GcpNative.BigQueryReservation.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:bigqueryreservation/v1:ReservationAssignment")]
    public partial class ReservationAssignment : Pulumi.CustomResource
    {
        ...
        public ReservationAssignment(string name, ReservationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:bigqueryreservation/v1:ReservationAssignment", name, args ?? new ReservationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReservationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:bigqueryreservation/v1:ReservationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
