...
namespace Pulumi.GcpNative.BigQueryReservation.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:bigqueryreservation/v1beta1:CapacityCommitment")]
    public partial class CapacityCommitment : Pulumi.CustomResource
    {
        ...
        public CapacityCommitment(string name, CapacityCommitmentArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:bigqueryreservation/v1beta1:CapacityCommitment", name, args ?? new CapacityCommitmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityCommitment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:bigqueryreservation/v1beta1:CapacityCommitment", name, null, MakeResourceOptions(options, id))
        {
        }
