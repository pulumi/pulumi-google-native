...
namespace Pulumi.GoogleNative.BigQueryReservation.V1Beta1
{
    public static class GetReservation
    {
        ...
        public static Task<GetReservationResult> InvokeAsync(GetReservationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReservationResult>("google-native:bigqueryreservation/v1beta1:getReservation", args ?? new GetReservationArgs(), options.WithDefaults());

        /// <summary>
        /// Returns information about the reservation.
        /// </summary>
        public static Output<GetReservationResult> Invoke(GetReservationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReservationResult>("google-native:bigqueryreservation/v1beta1:getReservation", args ?? new GetReservationInvokeArgs(), options.WithDefaults());
    }
