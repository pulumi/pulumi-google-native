...
namespace Pulumi.GcpNative.BigQuery.V2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:bigquery/v2:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:bigquery/v2:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:bigquery/v2:Job", name, null, MakeResourceOptions(options, id))
        {
        }
