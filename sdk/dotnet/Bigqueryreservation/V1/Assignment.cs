...
namespace Pulumi.GoogleCloud.Bigqueryreservation.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:bigqueryreservation/v1:Assignment")]
    public partial class Assignment : Pulumi.CustomResource
    {
        ...
        public Assignment(string name, AssignmentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:bigqueryreservation/v1:Assignment", name, args ?? new AssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Assignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:bigqueryreservation/v1:Assignment", name, null, MakeResourceOptions(options, id))
        {
        }
