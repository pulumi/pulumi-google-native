...
namespace Pulumi.GoogleCloud.Bigqueryreservation.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:bigqueryreservation/v1beta1:CapacityCommitment")]
    public partial class CapacityCommitment : Pulumi.CustomResource
    {
        ...
        public CapacityCommitment(string name, CapacityCommitmentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:bigqueryreservation/v1beta1:CapacityCommitment", name, args ?? new CapacityCommitmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityCommitment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:bigqueryreservation/v1beta1:CapacityCommitment", name, null, MakeResourceOptions(options, id))
        {
        }
