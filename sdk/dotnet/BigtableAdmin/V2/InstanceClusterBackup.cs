...
namespace Pulumi.GoogleNative.BigtableAdmin.V2
{
    ...
    public partial class InstanceClusterBackup : Pulumi.CustomResource
    {
        ...
        public InstanceClusterBackup(string name, InstanceClusterBackupArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigtableadmin/v2:InstanceClusterBackup", name, args ?? new InstanceClusterBackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceClusterBackup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigtableadmin/v2:InstanceClusterBackup", name, null, MakeResourceOptions(options, id))
        {
        }
