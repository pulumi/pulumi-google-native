...
namespace Pulumi.GoogleNative.BigtableAdmin.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigtableadmin/v2:InstanceIamBinding")]
    public partial class InstanceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamBinding(string name, InstanceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigtableadmin/v2:InstanceIamBinding", name, args ?? new InstanceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigtableadmin/v2:InstanceIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
