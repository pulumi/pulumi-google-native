...
namespace Pulumi.GoogleNative.BigtableAdmin.V2
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:bigtableadmin/v2:InstanceIamMember")]
    public partial class InstanceIamMember : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamMember(string name, InstanceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigtableadmin/v2:InstanceIamMember", name, args ?? new InstanceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigtableadmin/v2:InstanceIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
