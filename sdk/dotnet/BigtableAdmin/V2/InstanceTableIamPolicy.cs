...
namespace Pulumi.GoogleNative.BigtableAdmin.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:bigtableadmin/v2:InstanceTableIamPolicy")]
    public partial class InstanceTableIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a InstanceTableIamPolicy resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        ...
        public InstanceTableIamPolicy(string name, InstanceTableIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:bigtableadmin/v2:InstanceTableIamPolicy", name, args ?? new InstanceTableIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceTableIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:bigtableadmin/v2:InstanceTableIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InstanceTableIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new InstanceTableIamPolicy(name, id, options);
        }
    }

    public sealed class InstanceTableIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new InstanceTableIamPolicyArgs Empty => new InstanceTableIamPolicyArgs();
    }
}
