...
namespace Pulumi.GoogleCloud.Bigtableadmin.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:bigtableadmin/v2:AppProfile")]
    public partial class AppProfile : Pulumi.CustomResource
    {
        ...
        public AppProfile(string name, AppProfileArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:bigtableadmin/v2:AppProfile", name, args ?? new AppProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:bigtableadmin/v2:AppProfile", name, null, MakeResourceOptions(options, id))
        {
        }
