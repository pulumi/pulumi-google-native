...
namespace Pulumi.GoogleCloud.Bigtableadmin.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:bigtableadmin/v2:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:bigtableadmin/v2:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:bigtableadmin/v2:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
