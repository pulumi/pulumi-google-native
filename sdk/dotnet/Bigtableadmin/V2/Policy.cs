...
namespace Pulumi.GoogleCloud.Bigtableadmin.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:bigtableadmin/v2:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:bigtableadmin/v2:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:bigtableadmin/v2:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
