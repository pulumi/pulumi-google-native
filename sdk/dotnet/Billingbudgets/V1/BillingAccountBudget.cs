...
namespace Pulumi.GoogleCloud.Billingbudgets.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:billingbudgets/v1:BillingAccountBudget")]
    public partial class BillingAccountBudget : Pulumi.CustomResource
    {
        ...
        public BillingAccountBudget(string name, BillingAccountBudgetArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:billingbudgets/v1:BillingAccountBudget", name, args ?? new BillingAccountBudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingAccountBudget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:billingbudgets/v1:BillingAccountBudget", name, null, MakeResourceOptions(options, id))
        {
        }
