...
namespace Pulumi.GcpNative.Billingbudgets.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:billingbudgets/v1:BillingAccountBudget")]
    public partial class BillingAccountBudget : Pulumi.CustomResource
    {
        ...
        public BillingAccountBudget(string name, BillingAccountBudgetArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:billingbudgets/v1:BillingAccountBudget", name, args ?? new BillingAccountBudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingAccountBudget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:billingbudgets/v1:BillingAccountBudget", name, null, MakeResourceOptions(options, id))
        {
        }
