...
namespace Pulumi.GoogleNative.Billingbudgets.V1
{
    public static class GetBudget
    {
        ...
        public static Task<GetBudgetResult> InvokeAsync(GetBudgetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBudgetResult>("google-native:billingbudgets/v1:getBudget", args ?? new GetBudgetArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a budget. WARNING: There are some fields exposed on the Google Cloud Console that aren't available on this API. When reading from the API, you will not see these fields in the return value, though they may have been set in the Cloud Console.
        /// </summary>
        public static Output<GetBudgetResult> Invoke(GetBudgetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBudgetResult>("google-native:billingbudgets/v1:getBudget", args ?? new GetBudgetInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetBudgetResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudBillingBudgetsV1FilterResponse BudgetFilter;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudBillingBudgetsV1NotificationsRuleResponse NotificationsRule;
        /// <summary>
        /// Optional. Rules that trigger alerts (notifications of thresholds being crossed) when spend exceeds the specified percentages of the budget. Optional for `pubsubTopic` notifications. Required if using email notifications.
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudBillingBudgetsV1ThresholdRuleResponse> ThresholdRules;

        [OutputConstructor]
        private GetBudgetResult(
            Outputs.GoogleCloudBillingBudgetsV1BudgetAmountResponse amount,

            Outputs.GoogleCloudBillingBudgetsV1FilterResponse budgetFilter,
            ...
            Outputs.GoogleCloudBillingBudgetsV1NotificationsRuleResponse notificationsRule,

            ImmutableArray<Outputs.GoogleCloudBillingBudgetsV1ThresholdRuleResponse> thresholdRules)
        {
            Amount = amount;
