...
namespace Pulumi.GoogleNative.BinaryAuthorization.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:binaryauthorization/v1:AttestorIamBinding")]
    public partial class AttestorIamBinding : global::Pulumi.CustomResource
    {
        ...
        public AttestorIamBinding(string name, AttestorIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:binaryauthorization/v1:AttestorIamBinding", name, args ?? new AttestorIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestorIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:binaryauthorization/v1:AttestorIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AttestorIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new AttestorIamBinding(name, id, options);
        }
    }
