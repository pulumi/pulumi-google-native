...
namespace Pulumi.GoogleNative.BinaryAuthorization.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:binaryauthorization/v1:AttestorIamPolicy")]
    public partial class AttestorIamPolicy : Pulumi.CustomResource
    {
        ...
        public AttestorIamPolicy(string name, AttestorIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:binaryauthorization/v1:AttestorIamPolicy", name, args ?? new AttestorIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestorIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:binaryauthorization/v1:AttestorIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AttestorIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
