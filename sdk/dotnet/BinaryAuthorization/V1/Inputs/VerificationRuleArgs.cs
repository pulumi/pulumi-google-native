...
namespace Pulumi.GoogleNative.BinaryAuthorization.V1.Inputs
{
    ...
    /// </summary>
    public sealed class VerificationRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies where to fetch the provenances attestations generated by the builder (group).
        /// </summary>
        [Input("attestationSource")]
        public Input<Inputs.AttestationSourceArgs>? AttestationSource { get; set; }
        ...
        /// </summary>
        [Input("configBasedBuildRequired")]
        public Input<bool>? ConfigBasedBuildRequired { get; set; }
        ...
        /// </summary>
        [Input("trustedBuilder")]
        public Input<Pulumi.GoogleNative.BinaryAuthorization.V1.VerificationRuleTrustedBuilder>? TrustedBuilder { get; set; }

        [Input("trustedSourceRepoPatterns")]
        private InputList<string>? _trustedSourceRepoPatterns;
        ...
        /// </summary>
        public InputList<string> TrustedSourceRepoPatterns
        {
            get => _trustedSourceRepoPatterns ?? (_trustedSourceRepoPatterns = new InputList<string>());
            set => _trustedSourceRepoPatterns = value;
        }

        public VerificationRuleArgs()
        {
        }
        public static new VerificationRuleArgs Empty => new VerificationRuleArgs();
    }
}
