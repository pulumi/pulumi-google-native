...
namespace Pulumi.GcpNative.BinaryAuthorization.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:binaryauthorization/v1beta1:Attestor")]
    public partial class Attestor : Pulumi.CustomResource
    {
        ...
        public Attestor(string name, AttestorArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:binaryauthorization/v1beta1:Attestor", name, args ?? new AttestorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Attestor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:binaryauthorization/v1beta1:Attestor", name, null, MakeResourceOptions(options, id))
        {
        }
