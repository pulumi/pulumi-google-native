...
namespace Pulumi.GoogleNative.BinaryAuthorization.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:binaryauthorization/v1beta1:AttestorIamBinding")]
    public partial class AttestorIamBinding : global::Pulumi.CustomResource
    {
        ...
        public AttestorIamBinding(string name, AttestorIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:binaryauthorization/v1beta1:AttestorIamBinding", name, args ?? new AttestorIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestorIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:binaryauthorization/v1beta1:AttestorIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
