...
namespace Pulumi.GoogleNative.BinaryAuthorization.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:binaryauthorization/v1beta1:AttestorIamMember")]
    public partial class AttestorIamMember : global::Pulumi.CustomResource
    {
        ...
        public AttestorIamMember(string name, AttestorIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:binaryauthorization/v1beta1:AttestorIamMember", name, args ?? new AttestorIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestorIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:binaryauthorization/v1beta1:AttestorIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
