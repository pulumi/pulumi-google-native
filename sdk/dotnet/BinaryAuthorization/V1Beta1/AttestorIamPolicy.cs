...
namespace Pulumi.GcpNative.BinaryAuthorization.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:binaryauthorization/v1beta1:AttestorIamPolicy")]
    public partial class AttestorIamPolicy : Pulumi.CustomResource
    {
        ...
        public AttestorIamPolicy(string name, AttestorIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:binaryauthorization/v1beta1:AttestorIamPolicy", name, args ?? new AttestorIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestorIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:binaryauthorization/v1beta1:AttestorIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
