...
namespace Pulumi.GoogleNative.BinaryAuthorization.V1Beta1
{
    public static class GetPolicyIamPolicy
    {
        ...
        public static Output<GetPolicyIamPolicyResult> Invoke(GetPolicyIamPolicyInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPolicyIamPolicyResult>("google-native:binaryauthorization/v1beta1:getPolicyIamPolicy", args ?? new GetPolicyIamPolicyInvokeArgs(), options.WithVersion());
    }
