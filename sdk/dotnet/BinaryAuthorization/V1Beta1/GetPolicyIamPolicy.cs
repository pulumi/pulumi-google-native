...
{
    public static class GetPolicyIamPolicy
    {
        /// <summary>
        ...
        public static Task<GetPolicyIamPolicyResult> InvokeAsync(GetPolicyIamPolicyArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyIamPolicyResult>("google-native:binaryauthorization/v1beta1:getPolicyIamPolicy", args ?? new GetPolicyIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetPolicyIamPolicyResult> Invoke(GetPolicyIamPolicyInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicyIamPolicyResult>("google-native:binaryauthorization/v1beta1:getPolicyIamPolicy", args ?? new GetPolicyIamPolicyInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetPolicyIamPolicyResult
    {
        /// <summary>
