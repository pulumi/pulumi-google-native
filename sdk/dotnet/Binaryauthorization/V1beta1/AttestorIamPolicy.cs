...
namespace Pulumi.GoogleCloud.Binaryauthorization.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:binaryauthorization/v1beta1:AttestorIamPolicy")]
    public partial class AttestorIamPolicy : Pulumi.CustomResource
    {
        ...
        public AttestorIamPolicy(string name, AttestorIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:binaryauthorization/v1beta1:AttestorIamPolicy", name, args ?? new AttestorIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttestorIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:binaryauthorization/v1beta1:AttestorIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
