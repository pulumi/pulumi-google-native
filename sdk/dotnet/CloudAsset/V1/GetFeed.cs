...
namespace Pulumi.GoogleNative.CloudAsset.V1
{
    public static class GetFeed
    {
        ...
        public static Task<GetFeedResult> InvokeAsync(GetFeedArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFeedResult>("google-native:cloudasset/v1:getFeed", args ?? new GetFeedArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details about an asset feed.
        /// </summary>
        public static Output<GetFeedResult> Invoke(GetFeedInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFeedResult>("google-native:cloudasset/v1:getFeed", args ?? new GetFeedInvokeArgs(), options.WithDefaults());
    }
