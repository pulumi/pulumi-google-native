...
namespace Pulumi.GoogleNative.CloudBilling.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudbilling/v1:BillingAccountIamPolicy")]
    public partial class BillingAccountIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public BillingAccountIamPolicy(string name, BillingAccountIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudbilling/v1:BillingAccountIamPolicy", name, args ?? new BillingAccountIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingAccountIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudbilling/v1:BillingAccountIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BillingAccountIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new BillingAccountIamPolicy(name, id, options);
        }
    }

    public sealed class BillingAccountIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new BillingAccountIamPolicyArgs Empty => new BillingAccountIamPolicyArgs();
    }
}
