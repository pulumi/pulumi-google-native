...
namespace Pulumi.GoogleNative.CloudBuild.V1
{
    public static class GetBitbucketServerConfig
    {
        ...
        public static Task<GetBitbucketServerConfigResult> InvokeAsync(GetBitbucketServerConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBitbucketServerConfigResult>("google-native:cloudbuild/v1:getBitbucketServerConfig", args ?? new GetBitbucketServerConfigArgs(), options.WithVersion());
        ...
        public static Output<GetBitbucketServerConfigResult> Invoke(GetBitbucketServerConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBitbucketServerConfigResult>("google-native:cloudbuild/v1:getBitbucketServerConfig", args ?? new GetBitbucketServerConfigInvokeArgs(), options.WithVersion());
    }
