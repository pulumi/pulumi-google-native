...
namespace Pulumi.GoogleNative.CloudBuild.V1Alpha2
{
    public static class GetWorkerPool
    {
        ...
        public static Task<GetWorkerPoolResult> InvokeAsync(GetWorkerPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkerPoolResult>("google-native:cloudbuild/v1alpha2:getWorkerPool", args ?? new GetWorkerPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Returns details of a `WorkerPool`.
        /// </summary>
        public static Output<GetWorkerPoolResult> Invoke(GetWorkerPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkerPoolResult>("google-native:cloudbuild/v1alpha2:getWorkerPool", args ?? new GetWorkerPoolInvokeArgs(), options.WithDefaults());
    }
