...
namespace Pulumi.GoogleNative.CloudBuild.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudbuild/v2:ConnectionIamBinding")]
    public partial class ConnectionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamBinding(string name, ConnectionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudbuild/v2:ConnectionIamBinding", name, args ?? new ConnectionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudbuild/v2:ConnectionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
