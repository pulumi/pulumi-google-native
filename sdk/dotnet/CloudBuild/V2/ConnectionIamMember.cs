...
namespace Pulumi.GoogleNative.CloudBuild.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudbuild/v2:ConnectionIamMember")]
    public partial class ConnectionIamMember : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamMember(string name, ConnectionIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudbuild/v2:ConnectionIamMember", name, args ?? new ConnectionIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudbuild/v2:ConnectionIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
