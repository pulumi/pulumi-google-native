...
namespace Pulumi.GoogleNative.CloudBuild.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudbuild/v2:ConnectionIamPolicy")]
    public partial class ConnectionIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamPolicy(string name, ConnectionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudbuild/v2:ConnectionIamPolicy", name, args ?? new ConnectionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudbuild/v2:ConnectionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
