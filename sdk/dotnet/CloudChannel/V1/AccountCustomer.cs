...
namespace Pulumi.GcpNative.CloudChannel.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:cloudchannel/v1:AccountCustomer")]
    public partial class AccountCustomer : Pulumi.CustomResource
    {
        ...
        public AccountCustomer(string name, AccountCustomerArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:cloudchannel/v1:AccountCustomer", name, args ?? new AccountCustomerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccountCustomer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:cloudchannel/v1:AccountCustomer", name, null, MakeResourceOptions(options, id))
        {
        }
