...
namespace Pulumi.GoogleNative.CloudChannel.V1
{
    public static class GetCustomer
    {
        ...
        public static Task<GetCustomerResult> InvokeAsync(GetCustomerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomerResult>("google-native:cloudchannel/v1:getCustomer", args ?? new GetCustomerArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the requested Customer resource. Possible error codes: * PERMISSION_DENIED: The reseller account making the request is different from the reseller account in the API request. * INVALID_ARGUMENT: Required request parameters are missing or invalid. * NOT_FOUND: The customer resource doesn't exist. Usually the result of an invalid name parameter. Return value: The Customer resource.
        /// </summary>
        public static Output<GetCustomerResult> Invoke(GetCustomerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomerResult>("google-native:cloudchannel/v1:getCustomer", args ?? new GetCustomerInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetCustomerArgs : global::Pulumi.InvokeArgs
    {
        ...
        public static new GetCustomerArgs Empty => new GetCustomerArgs();
    }

    public sealed class GetCustomerInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("accountId", required: true)]
        ...
        public static new GetCustomerInvokeArgs Empty => new GetCustomerInvokeArgs();
    }
