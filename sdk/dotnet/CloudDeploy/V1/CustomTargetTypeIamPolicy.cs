...
namespace Pulumi.GoogleNative.CloudDeploy.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:clouddeploy/v1:CustomTargetTypeIamPolicy")]
    public partial class CustomTargetTypeIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public CustomTargetTypeIamPolicy(string name, CustomTargetTypeIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:clouddeploy/v1:CustomTargetTypeIamPolicy", name, args ?? new CustomTargetTypeIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomTargetTypeIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:clouddeploy/v1:CustomTargetTypeIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CustomTargetTypeIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new CustomTargetTypeIamPolicy(name, id, options);
        }
    }
