...
namespace Pulumi.GoogleNative.CloudDeploy.V1
{
    ...
    public partial class DeliveryPipelineIamPolicy : Pulumi.CustomResource
    {
        ...
        public DeliveryPipelineIamPolicy(string name, DeliveryPipelineIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:clouddeploy/v1:DeliveryPipelineIamPolicy", name, args ?? new DeliveryPipelineIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeliveryPipelineIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:clouddeploy/v1:DeliveryPipelineIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DeliveryPipelineIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DeliveryPipelineIamPolicy(name, id, options);
        }
    }
