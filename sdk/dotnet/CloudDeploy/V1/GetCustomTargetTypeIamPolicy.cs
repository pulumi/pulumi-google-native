...
namespace Pulumi.GoogleNative.CloudDeploy.V1
{
    public static class GetCustomTargetTypeIamPolicy
    {
        ...
        public static Task<GetCustomTargetTypeIamPolicyResult> InvokeAsync(GetCustomTargetTypeIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomTargetTypeIamPolicyResult>("google-native:clouddeploy/v1:getCustomTargetTypeIamPolicy", args ?? new GetCustomTargetTypeIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetCustomTargetTypeIamPolicyResult> Invoke(GetCustomTargetTypeIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomTargetTypeIamPolicyResult>("google-native:clouddeploy/v1:getCustomTargetTypeIamPolicy", args ?? new GetCustomTargetTypeIamPolicyInvokeArgs(), options.WithDefaults());
    }
