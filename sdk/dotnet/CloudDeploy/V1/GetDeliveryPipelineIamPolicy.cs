...
namespace Pulumi.GoogleNative.CloudDeploy.V1
{
    public static class GetDeliveryPipelineIamPolicy
    {
        ...
        public static Task<GetDeliveryPipelineIamPolicyResult> InvokeAsync(GetDeliveryPipelineIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeliveryPipelineIamPolicyResult>("google-native:clouddeploy/v1:getDeliveryPipelineIamPolicy", args ?? new GetDeliveryPipelineIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetDeliveryPipelineIamPolicyResult> Invoke(GetDeliveryPipelineIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDeliveryPipelineIamPolicyResult>("google-native:clouddeploy/v1:getDeliveryPipelineIamPolicy", args ?? new GetDeliveryPipelineIamPolicyInvokeArgs(), options.WithVersion());
    }


    public sealed class GetDeliveryPipelineIamPolicyArgs : Pulumi.InvokeArgs
    {
    ...
    public sealed class GetDeliveryPipelineIamPolicyInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("deliveryPipelineId", required: true)]
