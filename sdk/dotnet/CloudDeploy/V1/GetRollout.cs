...
namespace Pulumi.GoogleNative.CloudDeploy.V1
{
    public static class GetRollout
    {
        ...
        public static Task<GetRolloutResult> InvokeAsync(GetRolloutArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRolloutResult>("google-native:clouddeploy/v1:getRollout", args ?? new GetRolloutArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single Rollout.
        /// </summary>
        public static Output<GetRolloutResult> Invoke(GetRolloutInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRolloutResult>("google-native:clouddeploy/v1:getRollout", args ?? new GetRolloutInvokeArgs(), options.WithDefaults());
    }
