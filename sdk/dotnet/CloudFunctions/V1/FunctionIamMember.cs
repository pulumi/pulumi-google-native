...
namespace Pulumi.GoogleNative.CloudFunctions.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudfunctions/v1:FunctionIamMember")]
    public partial class FunctionIamMember : global::Pulumi.CustomResource
    {
        ...
        public FunctionIamMember(string name, FunctionIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v1:FunctionIamMember", name, args ?? new FunctionIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v1:FunctionIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
