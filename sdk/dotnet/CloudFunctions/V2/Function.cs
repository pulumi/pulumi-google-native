...
namespace Pulumi.GoogleNative.CloudFunctions.V2
{
    ...
    public partial class Function : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudFunctionsV2StateMessageResponse>> StateMessages { get; private set; } = null!;
        ...
        public Function(string name, FunctionArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2:Function", name, args ?? new FunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Function(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2:Function", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FunctionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("environment")]
        public Input<Pulumi.GoogleNative.CloudFunctions.V2.FunctionEnvironment>? Environment { get; set; }
