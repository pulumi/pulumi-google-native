...
namespace Pulumi.GoogleNative.CloudFunctions.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudfunctions/v2:FunctionIamPolicy")]
    public partial class FunctionIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public FunctionIamPolicy(string name, FunctionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2:FunctionIamPolicy", name, args ?? new FunctionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2:FunctionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
