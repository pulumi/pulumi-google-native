...
namespace Pulumi.GoogleNative.CloudFunctions.V2Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudfunctions/v2alpha:FunctionIamBinding")]
    public partial class FunctionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public FunctionIamBinding(string name, FunctionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2alpha:FunctionIamBinding", name, args ?? new FunctionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2alpha:FunctionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FunctionIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new FunctionIamBinding(name, id, options);
        }
    }
