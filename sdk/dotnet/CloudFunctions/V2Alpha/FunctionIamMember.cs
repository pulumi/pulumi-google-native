...
namespace Pulumi.GoogleNative.CloudFunctions.V2Alpha
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudfunctions/v2alpha:FunctionIamMember")]
    public partial class FunctionIamMember : global::Pulumi.CustomResource
    {
        ...
        public FunctionIamMember(string name, FunctionIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2alpha:FunctionIamMember", name, args ?? new FunctionIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2alpha:FunctionIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FunctionIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new FunctionIamMember(name, id, options);
        }
    }
