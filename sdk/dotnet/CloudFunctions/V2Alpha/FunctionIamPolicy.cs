...
namespace Pulumi.GoogleNative.CloudFunctions.V2Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudfunctions/v2alpha:FunctionIamPolicy")]
    public partial class FunctionIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public FunctionIamPolicy(string name, FunctionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2alpha:FunctionIamPolicy", name, args ?? new FunctionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2alpha:FunctionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
