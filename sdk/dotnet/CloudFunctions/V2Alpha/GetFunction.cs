...
namespace Pulumi.GoogleNative.CloudFunctions.V2Alpha
{
    public static class GetFunction
    {
        ...
        public static Task<GetFunctionResult> InvokeAsync(GetFunctionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFunctionResult>("google-native:cloudfunctions/v2alpha:getFunction", args ?? new GetFunctionArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a function with the given name from the requested project.
        /// </summary>
        public static Output<GetFunctionResult> Invoke(GetFunctionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFunctionResult>("google-native:cloudfunctions/v2alpha:getFunction", args ?? new GetFunctionInvokeArgs(), options.WithDefaults());
    }
