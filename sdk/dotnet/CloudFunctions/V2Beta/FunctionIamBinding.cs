...
namespace Pulumi.GoogleNative.CloudFunctions.V2Beta
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudfunctions/v2beta:FunctionIamBinding")]
    public partial class FunctionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public FunctionIamBinding(string name, FunctionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2beta:FunctionIamBinding", name, args ?? new FunctionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2beta:FunctionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
