...
namespace Pulumi.GoogleNative.CloudFunctions.V2Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudfunctions/v2beta:FunctionIamPolicy")]
    public partial class FunctionIamPolicy : Pulumi.CustomResource
    {
        ...
        public FunctionIamPolicy(string name, FunctionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2beta:FunctionIamPolicy", name, args ?? new FunctionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudfunctions/v2beta:FunctionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FunctionIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
