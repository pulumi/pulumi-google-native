...
namespace Pulumi.GcpNative.CloudIdentity.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:cloudidentity/v1:Device")]
    public partial class Device : Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:cloudidentity/v1:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:cloudidentity/v1:Device", name, null, MakeResourceOptions(options, id))
        {
        }
