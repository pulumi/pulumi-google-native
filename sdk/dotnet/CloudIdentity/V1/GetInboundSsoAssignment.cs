...
namespace Pulumi.GoogleNative.CloudIdentity.V1
{
    public static class GetInboundSsoAssignment
    {
        ...
        public static Task<GetInboundSsoAssignmentResult> InvokeAsync(GetInboundSsoAssignmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInboundSsoAssignmentResult>("google-native:cloudidentity/v1:getInboundSsoAssignment", args ?? new GetInboundSsoAssignmentArgs(), options.WithDefaults());
        ...
        public static Output<GetInboundSsoAssignmentResult> Invoke(GetInboundSsoAssignmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInboundSsoAssignmentResult>("google-native:cloudidentity/v1:getInboundSsoAssignment", args ?? new GetInboundSsoAssignmentInvokeArgs(), options.WithDefaults());
    }
