...
namespace Pulumi.GoogleNative.CloudIdentity.V1
{
    public static class GetMembership
    {
        ...
        public static Output<GetMembershipResult> Invoke(GetMembershipInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMembershipResult>("google-native:cloudidentity/v1:getMembership", args ?? new GetMembershipInvokeArgs(), options.WithVersion());
    }
