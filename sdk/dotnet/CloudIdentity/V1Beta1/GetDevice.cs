...
namespace Pulumi.GoogleNative.CloudIdentity.V1Beta1
{
    public static class GetDevice
    {
        ...
        public static Task<GetDeviceResult> InvokeAsync(GetDeviceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeviceResult>("google-native:cloudidentity/v1beta1:getDevice", args ?? new GetDeviceArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified device.
        /// </summary>
        public static Output<GetDeviceResult> Invoke(GetDeviceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDeviceResult>("google-native:cloudidentity/v1beta1:getDevice", args ?? new GetDeviceInvokeArgs(), options.WithDefaults());
    }
