...
namespace Pulumi.GoogleNative.CloudIoT.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudiot/v1:RegistryIamBinding")]
    public partial class RegistryIamBinding : global::Pulumi.CustomResource
    {
        ...
        public RegistryIamBinding(string name, RegistryIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudiot/v1:RegistryIamBinding", name, args ?? new RegistryIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistryIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudiot/v1:RegistryIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegistryIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RegistryIamBinding(name, id, options);
        }
    }
