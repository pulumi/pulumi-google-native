...
namespace Pulumi.GoogleCloud.CloudResourceManager.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudresourcemanager/v1:OrganizationIamPolicy")]
    public partial class OrganizationIamPolicy : Pulumi.CustomResource
    {
        ...
        public OrganizationIamPolicy(string name, OrganizationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v1:OrganizationIamPolicy", name, args ?? new OrganizationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v1:OrganizationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrganizationIamPolicyArgs : Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
