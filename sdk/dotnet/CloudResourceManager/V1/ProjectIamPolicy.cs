...
namespace Pulumi.GoogleNative.CloudResourceManager.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudresourcemanager/v1:ProjectIamPolicy")]
    public partial class ProjectIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ProjectIamPolicy(string name, ProjectIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v1:ProjectIamPolicy", name, args ?? new ProjectIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v1:ProjectIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new ProjectIamPolicyArgs Empty => new ProjectIamPolicyArgs();
    }
}
