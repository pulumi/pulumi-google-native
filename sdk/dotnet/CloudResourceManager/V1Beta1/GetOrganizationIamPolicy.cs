...
namespace Pulumi.GoogleNative.CloudResourceManager.V1Beta1
{
    public static class GetOrganizationIamPolicy
    {
        ...
        public static Task<GetOrganizationIamPolicyResult> InvokeAsync(GetOrganizationIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationIamPolicyResult>("google-native:cloudresourcemanager/v1beta1:getOrganizationIamPolicy", args ?? new GetOrganizationIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetOrganizationIamPolicyResult> Invoke(GetOrganizationIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOrganizationIamPolicyResult>("google-native:cloudresourcemanager/v1beta1:getOrganizationIamPolicy", args ?? new GetOrganizationIamPolicyInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetOrganizationIamPolicyArgs : Pulumi.InvokeArgs
    {
    ...
    public sealed class GetOrganizationIamPolicyInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("organizationId", required: true)]
