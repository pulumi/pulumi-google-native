...
namespace Pulumi.GcpNative.CloudResourceManager.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:cloudresourcemanager/v1beta1:OrganizationIamPolicy")]
    public partial class OrganizationIamPolicy : Pulumi.CustomResource
    {
        ...
        public OrganizationIamPolicy(string name, OrganizationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:cloudresourcemanager/v1beta1:OrganizationIamPolicy", name, args ?? new OrganizationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:cloudresourcemanager/v1beta1:OrganizationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
