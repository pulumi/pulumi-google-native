...
namespace Pulumi.GoogleNative.CloudResourceManager.V1Beta1
{
    ...
    public partial class OrganizationIamPolicy : Pulumi.CustomResource
    {
        ...
        public OrganizationIamPolicy(string name, OrganizationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v1beta1:OrganizationIamPolicy", name, args ?? new OrganizationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v1beta1:OrganizationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
