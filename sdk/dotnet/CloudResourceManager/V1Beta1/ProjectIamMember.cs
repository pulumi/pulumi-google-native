...
namespace Pulumi.GoogleNative.CloudResourceManager.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudresourcemanager/v1beta1:ProjectIamMember")]
    public partial class ProjectIamMember : global::Pulumi.CustomResource
    {
        ...
        public ProjectIamMember(string name, ProjectIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v1beta1:ProjectIamMember", name, args ?? new ProjectIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v1beta1:ProjectIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
