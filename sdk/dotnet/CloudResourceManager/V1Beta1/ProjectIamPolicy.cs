...
namespace Pulumi.GcpNative.CloudResourceManager.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:cloudresourcemanager/v1beta1:ProjectIamPolicy")]
    public partial class ProjectIamPolicy : Pulumi.CustomResource
    {
        ...
        public ProjectIamPolicy(string name, ProjectIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:cloudresourcemanager/v1beta1:ProjectIamPolicy", name, args ?? new ProjectIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:cloudresourcemanager/v1beta1:ProjectIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
