...
namespace Pulumi.GoogleNative.CloudResourceManager.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudresourcemanager/v2:FolderIamPolicy")]
    public partial class FolderIamPolicy : Pulumi.CustomResource
    {
        ...
        public FolderIamPolicy(string name, FolderIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v2:FolderIamPolicy", name, args ?? new FolderIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v2:FolderIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
