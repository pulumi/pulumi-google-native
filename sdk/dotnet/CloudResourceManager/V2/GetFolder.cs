...
namespace Pulumi.GoogleNative.CloudResourceManager.V2
{
    public static class GetFolder
    {
        ...
        public static Task<GetFolderResult> InvokeAsync(GetFolderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFolderResult>("google-native:cloudresourcemanager/v2:getFolder", args ?? new GetFolderArgs(), options.WithVersion());

        /// <summary>
        /// Retrieves a Folder identified by the supplied resource name. Valid Folder resource names have the format `folders/{folder_id}` (for example, `folders/1234`). The caller must have `resourcemanager.folders.get` permission on the identified folder.
        /// </summary>
        public static Output<GetFolderResult> Invoke(GetFolderInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFolderResult>("google-native:cloudresourcemanager/v2:getFolder", args ?? new GetFolderInvokeArgs(), options.WithVersion());
    }
