...
namespace Pulumi.GoogleNative.CloudResourceManager.V3
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudresourcemanager/v3:Folder")]
    public partial class Folder : global::Pulumi.CustomResource
    {
        ...
        private Folder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v3:Folder", name, null, MakeResourceOptions(options, id))
        {
        }
