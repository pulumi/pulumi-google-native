...
namespace Pulumi.GoogleNative.CloudResourceManager.V3
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudresourcemanager/v3:OrganizationIamPolicy")]
    public partial class OrganizationIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OrganizationIamPolicy(string name, OrganizationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v3:OrganizationIamPolicy", name, args ?? new OrganizationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudresourcemanager/v3:OrganizationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new OrganizationIamPolicy(name, id, options);
        }
    }

    public sealed class OrganizationIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new OrganizationIamPolicyArgs Empty => new OrganizationIamPolicyArgs();
    }
}
