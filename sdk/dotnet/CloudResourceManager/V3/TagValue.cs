...
namespace Pulumi.GcpNative.CloudResourceManager.V3
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:cloudresourcemanager/v3:TagValue")]
    public partial class TagValue : Pulumi.CustomResource
    {
        ...
        public TagValue(string name, TagValueArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:cloudresourcemanager/v3:TagValue", name, args ?? new TagValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:cloudresourcemanager/v3:TagValue", name, null, MakeResourceOptions(options, id))
        {
        }
