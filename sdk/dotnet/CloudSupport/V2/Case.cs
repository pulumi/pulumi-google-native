...
namespace Pulumi.GoogleNative.CloudSupport.V2
{
    /// <summary>
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudsupport/v2:Case")]
    public partial class Case : global::Pulumi.CustomResource
    {
        ...
        [Output("v2Id")]
        public Output<string> V2Id { get; private set; } = null!;

        [Output("v2Id1")]
        public Output<string> V2Id1 { get; private set; } = null!;
        ...
        public Case(string name, CaseArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudsupport/v2:Case", name, args ?? new CaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Case(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudsupport/v2:Case", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("priority")]
        public Input<Pulumi.GoogleNative.CloudSupport.V2.CasePriority>? Priority { get; set; }
