...
namespace Pulumi.GoogleNative.CloudSupport.V2
{
    public static class GetCase
    {
        ...
        public static Task<GetCaseResult> InvokeAsync(GetCaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCaseResult>("google-native:cloudsupport/v2:getCase", args ?? new GetCaseArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve the specified case.
        /// </summary>
        public static Output<GetCaseResult> Invoke(GetCaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCaseResult>("google-native:cloudsupport/v2:getCase", args ?? new GetCaseInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetCaseArgs : global::Pulumi.InvokeArgs
    {
        ...
        public string V2Id { get; set; } = null!;

        [Input("v2Id1", required: true)]
        public string V2Id1 { get; set; } = null!;
