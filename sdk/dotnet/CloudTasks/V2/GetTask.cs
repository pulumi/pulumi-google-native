...
namespace Pulumi.GoogleNative.CloudTasks.V2
{
    public static class GetTask
    {
        ...
        public static Task<GetTaskResult> InvokeAsync(GetTaskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTaskResult>("google-native:cloudtasks/v2:getTask", args ?? new GetTaskArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a task.
        /// </summary>
        public static Output<GetTaskResult> Invoke(GetTaskInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTaskResult>("google-native:cloudtasks/v2:getTask", args ?? new GetTaskInvokeArgs(), options.WithDefaults());
    }
