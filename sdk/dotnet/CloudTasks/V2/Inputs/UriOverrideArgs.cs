...
namespace Pulumi.GoogleNative.CloudTasks.V2.Inputs
{
    ...
    public sealed class UriOverrideArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("scheme")]
        public Input<Pulumi.GoogleNative.CloudTasks.V2.UriOverrideScheme>? Scheme { get; set; }

        /// <summary>
        /// URI Override Enforce Mode When specified, determines the Target UriOverride mode. If not specified, it defaults to ALWAYS.
        /// </summary>
        [Input("uriOverrideEnforceMode")]
        public Input<Pulumi.GoogleNative.CloudTasks.V2.UriOverrideUriOverrideEnforceMode>? UriOverrideEnforceMode { get; set; }
