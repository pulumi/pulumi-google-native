...
namespace Pulumi.GcpNative.CloudTasks.V2Beta2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:cloudtasks/v2beta2:Queue")]
    public partial class Queue : Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:cloudtasks/v2beta2:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:cloudtasks/v2beta2:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
