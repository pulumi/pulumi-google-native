...
namespace Pulumi.GoogleNative.CloudTasks.V2Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudtasks/v2beta2:QueueIamMember")]
    public partial class QueueIamMember : global::Pulumi.CustomResource
    {
        ...
        public QueueIamMember(string name, QueueIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudtasks/v2beta2:QueueIamMember", name, args ?? new QueueIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudtasks/v2beta2:QueueIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static QueueIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new QueueIamMember(name, id, options);
        }
    }
