...
namespace Pulumi.GoogleNative.CloudTasks.V2Beta3
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudtasks/v2beta3:Queue")]
    ...
    public sealed class QueueArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.GoogleNative.CloudTasks.V2Beta3.QueueState>? State { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.CloudTasks.V2Beta3.QueueType>? Type { get; set; }
