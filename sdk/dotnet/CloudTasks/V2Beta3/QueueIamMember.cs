...
namespace Pulumi.GoogleNative.CloudTasks.V2Beta3
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudtasks/v2beta3:QueueIamMember")]
    public partial class QueueIamMember : global::Pulumi.CustomResource
    {
        ...
        public QueueIamMember(string name, QueueIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudtasks/v2beta3:QueueIamMember", name, args ?? new QueueIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudtasks/v2beta3:QueueIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
