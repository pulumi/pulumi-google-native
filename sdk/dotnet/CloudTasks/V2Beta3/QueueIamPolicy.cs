...
namespace Pulumi.GcpNative.CloudTasks.V2Beta3
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:cloudtasks/v2beta3:QueueIamPolicy")]
    public partial class QueueIamPolicy : Pulumi.CustomResource
    {
        ...
        public QueueIamPolicy(string name, QueueIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:cloudtasks/v2beta3:QueueIamPolicy", name, args ?? new QueueIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:cloudtasks/v2beta3:QueueIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
