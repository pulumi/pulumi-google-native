...
namespace Pulumi.GoogleCloud.CloudTasks.V2Beta3
{
    /// <summary>
    /// Sets the access control policy for a Queue. Replaces any existing policy. Note: The Cloud Console does not check queue-level IAM permissions yet. Project-level permissions are required to use the Cloud Console. Authorization requires the following [Google IAM](https://cloud.google.com/iam) permission on the specified resource parent: * `cloudtasks.queues.setIamPolicy`
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudtasks/v2beta3:QueueIamPolicy")]
    public partial class QueueIamPolicy : Pulumi.CustomResource
    {
        ...
        public QueueIamPolicy(string name, QueueIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudtasks/v2beta3:QueueIamPolicy", name, args ?? new QueueIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudtasks/v2beta3:QueueIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
