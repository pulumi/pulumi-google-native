...
namespace Pulumi.GoogleCloud.Cloudfunctions.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudfunctions/v1:FunctionIamPolicy")]
    public partial class FunctionIamPolicy : Pulumi.CustomResource
    {
        ...
        public FunctionIamPolicy(string name, FunctionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudfunctions/v1:FunctionIamPolicy", name, args ?? new FunctionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudfunctions/v1:FunctionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
