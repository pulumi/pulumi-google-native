...
namespace Pulumi.GoogleCloud.Cloudidentity.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudidentity/v1:GoogleAppsCloudidentityDevicesV1Device")]
    public partial class GoogleAppsCloudidentityDevicesV1Device : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleAppsCloudidentityDevicesV1Device(string name, GoogleAppsCloudidentityDevicesV1DeviceArgs? args = null, CustomResourceOptions? options = null)
            : base("google-cloud:cloudidentity/v1:GoogleAppsCloudidentityDevicesV1Device", name, args ?? new GoogleAppsCloudidentityDevicesV1DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleAppsCloudidentityDevicesV1Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudidentity/v1:GoogleAppsCloudidentityDevicesV1Device", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleAppsCloudidentityDevicesV1Device Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleAppsCloudidentityDevicesV1Device(name, id, options);
        }
    }

    public sealed class GoogleAppsCloudidentityDevicesV1DeviceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GoogleAppsCloudidentityDevicesV1DeviceArgs()
        {
        }
    }
}
