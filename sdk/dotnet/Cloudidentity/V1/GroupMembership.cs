...
namespace Pulumi.GoogleCloud.Cloudidentity.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudidentity/v1:GroupMembership")]
    public partial class GroupMembership : Pulumi.CustomResource
    {
        ...
        public GroupMembership(string name, GroupMembershipArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudidentity/v1:GroupMembership", name, args ?? new GroupMembershipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupMembership(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudidentity/v1:GroupMembership", name, null, MakeResourceOptions(options, id))
        {
        }
