...
namespace Pulumi.GoogleCloud.Cloudidentity.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudidentity/v1beta1:Membership")]
    public partial class Membership : Pulumi.CustomResource
    {
        ...
        public Membership(string name, MembershipArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudidentity/v1beta1:Membership", name, args ?? new MembershipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Membership(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudidentity/v1beta1:Membership", name, null, MakeResourceOptions(options, id))
        {
        }
