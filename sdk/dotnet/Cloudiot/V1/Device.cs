...
namespace Pulumi.GoogleCloud.Cloudiot.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudiot/v1:Device")]
    public partial class Device : Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudiot/v1:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudiot/v1:Device", name, null, MakeResourceOptions(options, id))
        {
        }
