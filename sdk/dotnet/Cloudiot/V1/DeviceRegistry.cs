...
namespace Pulumi.GoogleCloud.Cloudiot.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudiot/v1:DeviceRegistry")]
    public partial class DeviceRegistry : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DeviceRegistry(string name, DeviceRegistryArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudiot/v1:DeviceRegistry", name, args ?? new DeviceRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeviceRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudiot/v1:DeviceRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DeviceRegistry Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DeviceRegistry(name, id, options);
        }
    }

    public sealed class DeviceRegistryArgs : Pulumi.ResourceArgs
    {
        [Input("credentials")]
