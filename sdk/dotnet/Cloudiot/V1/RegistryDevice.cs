...
namespace Pulumi.GoogleCloud.Cloudiot.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudiot/v1:RegistryDevice")]
    public partial class RegistryDevice : Pulumi.CustomResource
    {
        ...
        public RegistryDevice(string name, RegistryDeviceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudiot/v1:RegistryDevice", name, args ?? new RegistryDeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistryDevice(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudiot/v1:RegistryDevice", name, null, MakeResourceOptions(options, id))
        {
        }
