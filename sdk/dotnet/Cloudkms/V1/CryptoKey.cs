...
namespace Pulumi.GoogleCloud.Cloudkms.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudkms/v1:CryptoKey")]
    public partial class CryptoKey : Pulumi.CustomResource
    {
        ...
        public CryptoKey(string name, CryptoKeyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudkms/v1:CryptoKey", name, args ?? new CryptoKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CryptoKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudkms/v1:CryptoKey", name, null, MakeResourceOptions(options, id))
        {
        }
