...
namespace Pulumi.GoogleCloud.Cloudkms.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudkms/v1:CryptoKeyVersion")]
    public partial class CryptoKeyVersion : Pulumi.CustomResource
    {
        ...
        public CryptoKeyVersion(string name, CryptoKeyVersionArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudkms/v1:CryptoKeyVersion", name, args ?? new CryptoKeyVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CryptoKeyVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudkms/v1:CryptoKeyVersion", name, null, MakeResourceOptions(options, id))
        {
        }
