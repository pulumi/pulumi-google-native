...
namespace Pulumi.GoogleNative.Cloudkms.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudkms/v1:EkmConnectionIamPolicy")]
    public partial class EkmConnectionIamPolicy : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public EkmConnectionIamPolicy(string name, EkmConnectionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudkms/v1:EkmConnectionIamPolicy", name, args ?? new EkmConnectionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EkmConnectionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudkms/v1:EkmConnectionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EkmConnectionIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new EkmConnectionIamPolicy(name, id, options);
        }
    }

    public sealed class EkmConnectionIamPolicyArgs : Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
