...
{
    public static class GetKeyRingCryptoKeyIamPolicy
    {
        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Task<GetKeyRingCryptoKeyIamPolicyResult> InvokeAsync(GetKeyRingCryptoKeyIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyRingCryptoKeyIamPolicyResult>("google-native:cloudkms/v1:getKeyRingCryptoKeyIamPolicy", args ?? new GetKeyRingCryptoKeyIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetKeyRingCryptoKeyIamPolicyResult> Invoke(GetKeyRingCryptoKeyIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyRingCryptoKeyIamPolicyResult>("google-native:cloudkms/v1:getKeyRingCryptoKeyIamPolicy", args ?? new GetKeyRingCryptoKeyIamPolicyInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetKeyRingCryptoKeyIamPolicyResult
    {
        /// <summary>
