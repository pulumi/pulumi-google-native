...
namespace Pulumi.GoogleCloud.Cloudkms.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudkms/v1:ImportJob")]
    public partial class ImportJob : Pulumi.CustomResource
    {
        ...
        public ImportJob(string name, ImportJobArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudkms/v1:ImportJob", name, args ?? new ImportJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImportJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudkms/v1:ImportJob", name, null, MakeResourceOptions(options, id))
        {
        }
