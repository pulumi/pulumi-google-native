...
namespace Pulumi.GoogleNative.Cloudkms.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:cloudkms/v1:KeyRingIamBinding")]
    public partial class KeyRingIamBinding : global::Pulumi.CustomResource
    {
        ...
        public KeyRingIamBinding(string name, KeyRingIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudkms/v1:KeyRingIamBinding", name, args ?? new KeyRingIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyRingIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudkms/v1:KeyRingIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static KeyRingIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new KeyRingIamBinding(name, id, options);
        }
    }
