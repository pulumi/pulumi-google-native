...
namespace Pulumi.GoogleCloud.Cloudkms.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudkms/v1:KeyRingIamPolicy")]
    public partial class KeyRingIamPolicy : Pulumi.CustomResource
    {
        ...
        public KeyRingIamPolicy(string name, KeyRingIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudkms/v1:KeyRingIamPolicy", name, args ?? new KeyRingIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyRingIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudkms/v1:KeyRingIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
