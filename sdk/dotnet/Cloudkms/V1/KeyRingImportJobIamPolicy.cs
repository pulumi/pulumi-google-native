...
namespace Pulumi.GcpNative.Cloudkms.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("google-native:cloudkms/v1:KeyRingImportJobIamPolicy")]
    public partial class KeyRingImportJobIamPolicy : Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// Create a KeyRingImportJobIamPolicy resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public KeyRingImportJobIamPolicy(string name, KeyRingImportJobIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:cloudkms/v1:KeyRingImportJobIamPolicy", name, args ?? new KeyRingImportJobIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyRingImportJobIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:cloudkms/v1:KeyRingImportJobIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing KeyRingImportJobIamPolicy resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static KeyRingImportJobIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
