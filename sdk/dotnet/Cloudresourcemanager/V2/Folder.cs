...
namespace Pulumi.GoogleCloud.Cloudresourcemanager.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudresourcemanager/v2:Folder")]
    public partial class Folder : Pulumi.CustomResource
    {
        ...
        public Folder(string name, FolderArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v2:Folder", name, args ?? new FolderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Folder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v2:Folder", name, null, MakeResourceOptions(options, id))
        {
        }
