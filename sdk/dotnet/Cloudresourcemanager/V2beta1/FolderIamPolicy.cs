...
namespace Pulumi.GoogleCloud.Cloudresourcemanager.V2beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudresourcemanager/v2beta1:FolderIamPolicy")]
    public partial class FolderIamPolicy : Pulumi.CustomResource
    {
        ...
        public FolderIamPolicy(string name, FolderIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v2beta1:FolderIamPolicy", name, args ?? new FolderIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v2beta1:FolderIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
