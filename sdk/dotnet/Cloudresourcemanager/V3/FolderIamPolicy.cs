...
namespace Pulumi.GoogleCloud.Cloudresourcemanager.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudresourcemanager/v3:FolderIamPolicy")]
    public partial class FolderIamPolicy : Pulumi.CustomResource
    {
        ...
        public FolderIamPolicy(string name, FolderIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v3:FolderIamPolicy", name, args ?? new FolderIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v3:FolderIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
