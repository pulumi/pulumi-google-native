...
namespace Pulumi.GoogleCloud.Cloudresourcemanager.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudresourcemanager/v3:Lien")]
    public partial class Lien : Pulumi.CustomResource
    {
        ...
        public Lien(string name, LienArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v3:Lien", name, args ?? new LienArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Lien(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v3:Lien", name, null, MakeResourceOptions(options, id))
        {
        }
