...
namespace Pulumi.GoogleCloud.Cloudresourcemanager.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudresourcemanager/v3:TagKeyIamPolicy")]
    public partial class TagKeyIamPolicy : Pulumi.CustomResource
    {
        ...
        public TagKeyIamPolicy(string name, TagKeyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v3:TagKeyIamPolicy", name, args ?? new TagKeyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagKeyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudresourcemanager/v3:TagKeyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TagKeyIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
