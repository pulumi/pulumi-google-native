...
namespace Pulumi.GoogleCloud.Cloudsearch.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudsearch/v1:DataSource")]
    public partial class DataSource : Pulumi.CustomResource
    {
        ...
        public DataSource(string name, DataSourceArgs? args = null, CustomResourceOptions? options = null)
            : base("google-cloud:cloudsearch/v1:DataSource", name, args ?? new DataSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudsearch/v1:DataSource", name, null, MakeResourceOptions(options, id))
        {
        }
