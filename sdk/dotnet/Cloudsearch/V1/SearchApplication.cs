...
namespace Pulumi.GoogleCloud.Cloudsearch.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudsearch/v1:SearchApplication")]
    public partial class SearchApplication : Pulumi.CustomResource
    {
        ...
        public SearchApplication(string name, SearchApplicationArgs? args = null, CustomResourceOptions? options = null)
            : base("google-cloud:cloudsearch/v1:SearchApplication", name, args ?? new SearchApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SearchApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudsearch/v1:SearchApplication", name, null, MakeResourceOptions(options, id))
        {
        }
