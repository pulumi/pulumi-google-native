...
namespace Pulumi.GoogleCloud.Cloudtasks.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudtasks/v2:Task")]
    public partial class Task : Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudtasks/v2:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudtasks/v2:Task", name, null, MakeResourceOptions(options, id))
        {
        }
