...
namespace Pulumi.GoogleCloud.Cloudtasks.V2beta3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:cloudtasks/v2beta3:Queue")]
    public partial class Queue : Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:cloudtasks/v2beta3:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:cloudtasks/v2beta3:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
