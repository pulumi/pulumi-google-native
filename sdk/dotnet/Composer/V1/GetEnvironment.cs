...
namespace Pulumi.GoogleNative.Composer.V1
{
    public static class GetEnvironment
    {
        ...
        public static Task<GetEnvironmentResult> InvokeAsync(GetEnvironmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentResult>("google-native:composer/v1:getEnvironment", args ?? new GetEnvironmentArgs(), options.WithVersion());

        /// <summary>
        /// Get an existing environment.
        /// </summary>
        public static Output<GetEnvironmentResult> Invoke(GetEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEnvironmentResult>("google-native:composer/v1:getEnvironment", args ?? new GetEnvironmentInvokeArgs(), options.WithVersion());
    }
