...
namespace Pulumi.GoogleNative.Composer.V1
{
    public static class GetUserWorkloadsConfigMap
    {
        ...
        public static Task<GetUserWorkloadsConfigMapResult> InvokeAsync(GetUserWorkloadsConfigMapArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserWorkloadsConfigMapResult>("google-native:composer/v1:getUserWorkloadsConfigMap", args ?? new GetUserWorkloadsConfigMapArgs(), options.WithDefaults());
        ...
        public static Output<GetUserWorkloadsConfigMapResult> Invoke(GetUserWorkloadsConfigMapInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserWorkloadsConfigMapResult>("google-native:composer/v1:getUserWorkloadsConfigMap", args ?? new GetUserWorkloadsConfigMapInvokeArgs(), options.WithDefaults());
    }
