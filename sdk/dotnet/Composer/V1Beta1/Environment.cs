...
namespace Pulumi.GoogleCloud.Composer.V1Beta1
{
    /// <summary>
    /// Create a new environment.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:composer/v1beta1:Environment")]
    public partial class Environment : Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:composer/v1beta1:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:composer/v1beta1:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
