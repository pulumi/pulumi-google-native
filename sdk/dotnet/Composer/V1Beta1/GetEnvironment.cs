...
namespace Pulumi.GoogleNative.Composer.V1Beta1
{
    public static class GetEnvironment
    {
        ...
        public static Task<GetEnvironmentResult> InvokeAsync(GetEnvironmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentResult>("google-native:composer/v1beta1:getEnvironment", args ?? new GetEnvironmentArgs(), options.WithDefaults());

        /// <summary>
        /// Get an existing environment.
        /// </summary>
        public static Output<GetEnvironmentResult> Invoke(GetEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEnvironmentResult>("google-native:composer/v1beta1:getEnvironment", args ?? new GetEnvironmentInvokeArgs(), options.WithDefaults());
    }
