...
namespace Pulumi.GoogleNative.Composer.V1Beta1
{
    public static class GetUserWorkloadsSecret
    {
        ...
        public static Task<GetUserWorkloadsSecretResult> InvokeAsync(GetUserWorkloadsSecretArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserWorkloadsSecretResult>("google-native:composer/v1beta1:getUserWorkloadsSecret", args ?? new GetUserWorkloadsSecretArgs(), options.WithDefaults());
        ...
        public static Output<GetUserWorkloadsSecretResult> Invoke(GetUserWorkloadsSecretInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserWorkloadsSecretResult>("google-native:composer/v1beta1:getUserWorkloadsSecret", args ?? new GetUserWorkloadsSecretInvokeArgs(), options.WithDefaults());
    }
