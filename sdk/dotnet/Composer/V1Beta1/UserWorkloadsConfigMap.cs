...
namespace Pulumi.GoogleNative.Composer.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:composer/v1beta1:UserWorkloadsConfigMap")]
    public partial class UserWorkloadsConfigMap : global::Pulumi.CustomResource
    {
        ...
        public UserWorkloadsConfigMap(string name, UserWorkloadsConfigMapArgs args, CustomResourceOptions? options = null)
            : base("google-native:composer/v1beta1:UserWorkloadsConfigMap", name, args ?? new UserWorkloadsConfigMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserWorkloadsConfigMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:composer/v1beta1:UserWorkloadsConfigMap", name, null, MakeResourceOptions(options, id))
        {
        }
