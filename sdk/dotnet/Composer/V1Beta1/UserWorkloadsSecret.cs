...
namespace Pulumi.GoogleNative.Composer.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:composer/v1beta1:UserWorkloadsSecret")]
    public partial class UserWorkloadsSecret : global::Pulumi.CustomResource
    {
        ...
        public UserWorkloadsSecret(string name, UserWorkloadsSecretArgs args, CustomResourceOptions? options = null)
            : base("google-native:composer/v1beta1:UserWorkloadsSecret", name, args ?? new UserWorkloadsSecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserWorkloadsSecret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:composer/v1beta1:UserWorkloadsSecret", name, null, MakeResourceOptions(options, id))
        {
        }
