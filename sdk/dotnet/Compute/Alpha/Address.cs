...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:Address")]
    public partial class Address : Pulumi.CustomResource
    {
        ...
        public Address(string name, AddressArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:Address", name, args ?? new AddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Address(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:Address", name, null, MakeResourceOptions(options, id))
        {
        }
