...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:BackendBucketIamPolicy")]
    public partial class BackendBucketIamPolicy : Pulumi.CustomResource
    {
        ...
        public BackendBucketIamPolicy(string name, BackendBucketIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:BackendBucketIamPolicy", name, args ?? new BackendBucketIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendBucketIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:BackendBucketIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
