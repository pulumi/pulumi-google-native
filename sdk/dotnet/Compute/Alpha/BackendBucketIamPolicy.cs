...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:BackendBucketIamPolicy")]
    public partial class BackendBucketIamPolicy : Pulumi.CustomResource
    {
        ...
        public BackendBucketIamPolicy(string name, BackendBucketIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:BackendBucketIamPolicy", name, args ?? new BackendBucketIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendBucketIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:BackendBucketIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
