...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:BackendService")]
    public partial class BackendService : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("haPolicy")]
        public Output<Outputs.BackendServiceHAPolicyResponse> HaPolicy { get; private set; } = null!;
        ...
        /// </summary>
        [Output("metadatas")]
        public Output<ImmutableDictionary<string, string>> Metadatas { get; private set; } = null!;
        ...
        [Output("usedBy")]
        public Output<ImmutableArray<Outputs.BackendServiceUsedByResponse>> UsedBy { get; private set; } = null!;
        ...
        private BackendService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:BackendService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackendServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Alpha.BackendServiceCompressionMode>? CompressionMode { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Compute.Alpha.BackendServiceExternalManagedMigrationState>? ExternalManagedMigrationState { get; set; }
        ...
        /// </summary>
        [Input("haPolicy")]
        public Input<Inputs.BackendServiceHAPolicyArgs>? HaPolicy { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Compute.Alpha.BackendServiceIpAddressSelectionPolicy>? IpAddressSelectionPolicy { get; set; }

        /// <summary>
        /// Specifies the load balancer type. A backend service created for one type of load balancer cannot be used with another. For more information, refer to Choosing a load balancer.
        /// </summary>
        [Input("loadBalancingScheme")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.BackendServiceLoadBalancingScheme>? LoadBalancingScheme { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Compute.Alpha.BackendServiceLocalityLbPolicy>? LocalityLbPolicy { get; set; }
        ...
        /// </summary>
        [Input("protocol")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.BackendServiceProtocol>? Protocol { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Compute.Alpha.BackendServiceSessionAffinity>? SessionAffinity { get; set; }
        ...
        [Input("usedBy")]
        private InputList<Inputs.BackendServiceUsedByArgs>? _usedBy;
        public InputList<Inputs.BackendServiceUsedByArgs> UsedBy
        {
            get => _usedBy ?? (_usedBy = new InputList<Inputs.BackendServiceUsedByArgs>());
            set => _usedBy = value;
        }
