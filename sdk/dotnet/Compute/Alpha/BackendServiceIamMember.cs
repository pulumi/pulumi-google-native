...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:BackendServiceIamMember")]
    public partial class BackendServiceIamMember : global::Pulumi.CustomResource
    {
        ...
        public BackendServiceIamMember(string name, BackendServiceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:BackendServiceIamMember", name, args ?? new BackendServiceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendServiceIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:BackendServiceIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BackendServiceIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new BackendServiceIamMember(name, id, options);
        }
    }
