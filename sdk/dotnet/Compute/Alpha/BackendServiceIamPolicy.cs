...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:BackendServiceIamPolicy")]
    public partial class BackendServiceIamPolicy : Pulumi.CustomResource
    {
        ...
        public BackendServiceIamPolicy(string name, BackendServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:BackendServiceIamPolicy", name, args ?? new BackendServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:BackendServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BackendServiceIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
