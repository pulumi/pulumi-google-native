...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:Disk")]
    public partial class Disk : global::Pulumi.CustomResource
    {
        ...
        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessMode")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.DiskAccessMode>? AccessMode { get; set; }

        /// <summary>
        /// The architecture of the disk. Valid values are ARM64 or X86_64.
        /// </summary>
        [Input("architecture")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.DiskArchitecture>? Architecture { get; set; }
        ...
        /// </summary>
        [Input("interface")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.DiskInterface>? Interface { get; set; }
        ...
        /// </summary>
        [Input("storageType")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.DiskStorageType>? StorageType { get; set; }
