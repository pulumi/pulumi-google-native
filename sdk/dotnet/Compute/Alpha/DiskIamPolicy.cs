...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:DiskIamPolicy")]
    public partial class DiskIamPolicy : Pulumi.CustomResource
    {
        ...
        public DiskIamPolicy(string name, DiskIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:DiskIamPolicy", name, args ?? new DiskIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:DiskIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DiskIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
