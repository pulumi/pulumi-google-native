...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct BackendServiceExternalManagedMigrationState : IEquatable<BackendServiceExternalManagedMigrationState>
    {
        private readonly string _value;

        private BackendServiceExternalManagedMigrationState(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static BackendServiceExternalManagedMigrationState Finalize { get; } = new BackendServiceExternalManagedMigrationState("FINALIZE");
        public static BackendServiceExternalManagedMigrationState Prepare { get; } = new BackendServiceExternalManagedMigrationState("PREPARE");
        public static BackendServiceExternalManagedMigrationState Test { get; } = new BackendServiceExternalManagedMigrationState("TEST");

        public static bool operator ==(BackendServiceExternalManagedMigrationState left, BackendServiceExternalManagedMigrationState right) => left.Equals(right);
        public static bool operator !=(BackendServiceExternalManagedMigrationState left, BackendServiceExternalManagedMigrationState right) => !left.Equals(right);

        public static explicit operator string(BackendServiceExternalManagedMigrationState value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is BackendServiceExternalManagedMigrationState other && Equals(other);
        public bool Equals(BackendServiceExternalManagedMigrationState other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct BackendServiceHAPolicyFastIPMove : IEquatable<BackendServiceHAPolicyFastIPMove>
    {
        private readonly string _value;

        private BackendServiceHAPolicyFastIPMove(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static BackendServiceHAPolicyFastIPMove Disabled { get; } = new BackendServiceHAPolicyFastIPMove("DISABLED");
        public static BackendServiceHAPolicyFastIPMove GarpRa { get; } = new BackendServiceHAPolicyFastIPMove("GARP_RA");

        public static bool operator ==(BackendServiceHAPolicyFastIPMove left, BackendServiceHAPolicyFastIPMove right) => left.Equals(right);
        public static bool operator !=(BackendServiceHAPolicyFastIPMove left, BackendServiceHAPolicyFastIPMove right) => !left.Equals(right);

        public static explicit operator string(BackendServiceHAPolicyFastIPMove value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is BackendServiceHAPolicyFastIPMove other && Equals(other);
        public bool Equals(BackendServiceHAPolicyFastIPMove other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct BackendServiceLogConfigOptional : IEquatable<BackendServiceLogConfigOptional>
    {
        ...
        private BackendServiceLogConfigOptional(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static BackendServiceLogConfigOptional Custom { get; } = new BackendServiceLogConfigOptional("CUSTOM");
        /// <summary>
        /// None optional fields.
        /// </summary>
        public static BackendServiceLogConfigOptional ExcludeAllOptional { get; } = new BackendServiceLogConfigOptional("EXCLUDE_ALL_OPTIONAL");
        /// <summary>
        /// All optional fields.
        /// </summary>
        public static BackendServiceLogConfigOptional IncludeAllOptional { get; } = new BackendServiceLogConfigOptional("INCLUDE_ALL_OPTIONAL");
        public static BackendServiceLogConfigOptional UnspecifiedOptionalMode { get; } = new BackendServiceLogConfigOptional("UNSPECIFIED_OPTIONAL_MODE");

        public static bool operator ==(BackendServiceLogConfigOptional left, BackendServiceLogConfigOptional right) => left.Equals(right);
        public static bool operator !=(BackendServiceLogConfigOptional left, BackendServiceLogConfigOptional right) => !left.Equals(right);

        public static explicit operator string(BackendServiceLogConfigOptional value) => value._value;
    ...
    /// </summary>
    [EnumType]
    public readonly struct DiskAccessMode : IEquatable<DiskAccessMode>
    {
        private readonly string _value;

        private DiskAccessMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static DiskAccessMode ReadOnlyMany { get; } = new DiskAccessMode("READ_ONLY_MANY");
        /// <summary>
        /// The AccessMode means the disk can be attached to multiple instances in RW mode.
        /// </summary>
        public static DiskAccessMode ReadWriteMany { get; } = new DiskAccessMode("READ_WRITE_MANY");
        /// <summary>
        /// The default AccessMode, means the disk can be attached to single instance in RW mode.
        /// </summary>
        public static DiskAccessMode ReadWriteSingle { get; } = new DiskAccessMode("READ_WRITE_SINGLE");

        public static bool operator ==(DiskAccessMode left, DiskAccessMode right) => left.Equals(right);
        public static bool operator !=(DiskAccessMode left, DiskAccessMode right) => !left.Equals(right);

        public static explicit operator string(DiskAccessMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is DiskAccessMode other && Equals(other);
        public bool Equals(DiskAccessMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct ForwardingRuleExternalManagedBackendBucketMigrationState : IEquatable<ForwardingRuleExternalManagedBackendBucketMigrationState>
    {
        private readonly string _value;

        private ForwardingRuleExternalManagedBackendBucketMigrationState(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static ForwardingRuleExternalManagedBackendBucketMigrationState Finalize { get; } = new ForwardingRuleExternalManagedBackendBucketMigrationState("FINALIZE");
        public static ForwardingRuleExternalManagedBackendBucketMigrationState Prepare { get; } = new ForwardingRuleExternalManagedBackendBucketMigrationState("PREPARE");
        public static ForwardingRuleExternalManagedBackendBucketMigrationState Test { get; } = new ForwardingRuleExternalManagedBackendBucketMigrationState("TEST");

        public static bool operator ==(ForwardingRuleExternalManagedBackendBucketMigrationState left, ForwardingRuleExternalManagedBackendBucketMigrationState right) => left.Equals(right);
        public static bool operator !=(ForwardingRuleExternalManagedBackendBucketMigrationState left, ForwardingRuleExternalManagedBackendBucketMigrationState right) => !left.Equals(right);

        public static explicit operator string(ForwardingRuleExternalManagedBackendBucketMigrationState value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ForwardingRuleExternalManagedBackendBucketMigrationState other && Equals(other);
        public bool Equals(ForwardingRuleExternalManagedBackendBucketMigrationState other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct GRPCTLSHealthCheckPortSpecification : IEquatable<GRPCTLSHealthCheckPortSpecification>
    {
        private readonly string _value;

        private GRPCTLSHealthCheckPortSpecification(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// The port number in the health check's port is used for health checking. Applies to network endpoint group and instance group backends.
        /// </summary>
        public static GRPCTLSHealthCheckPortSpecification UseFixedPort { get; } = new GRPCTLSHealthCheckPortSpecification("USE_FIXED_PORT");
        /// <summary>
        /// Not supported.
        /// </summary>
        public static GRPCTLSHealthCheckPortSpecification UseNamedPort { get; } = new GRPCTLSHealthCheckPortSpecification("USE_NAMED_PORT");
        /// <summary>
        /// For network endpoint group backends, the health check uses the port number specified on each endpoint in the network endpoint group. For instance group backends, the health check uses the port number specified for the backend service's named port defined in the instance group's named ports.
        /// </summary>
        public static GRPCTLSHealthCheckPortSpecification UseServingPort { get; } = new GRPCTLSHealthCheckPortSpecification("USE_SERVING_PORT");

        public static bool operator ==(GRPCTLSHealthCheckPortSpecification left, GRPCTLSHealthCheckPortSpecification right) => left.Equals(right);
        public static bool operator !=(GRPCTLSHealthCheckPortSpecification left, GRPCTLSHealthCheckPortSpecification right) => !left.Equals(right);

        public static explicit operator string(GRPCTLSHealthCheckPortSpecification value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GRPCTLSHealthCheckPortSpecification other && Equals(other);
        public bool Equals(GRPCTLSHealthCheckPortSpecification other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct GlobalForwardingRuleExternalManagedBackendBucketMigrationState : IEquatable<GlobalForwardingRuleExternalManagedBackendBucketMigrationState>
    {
        private readonly string _value;

        private GlobalForwardingRuleExternalManagedBackendBucketMigrationState(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static GlobalForwardingRuleExternalManagedBackendBucketMigrationState Finalize { get; } = new GlobalForwardingRuleExternalManagedBackendBucketMigrationState("FINALIZE");
        public static GlobalForwardingRuleExternalManagedBackendBucketMigrationState Prepare { get; } = new GlobalForwardingRuleExternalManagedBackendBucketMigrationState("PREPARE");
        public static GlobalForwardingRuleExternalManagedBackendBucketMigrationState Test { get; } = new GlobalForwardingRuleExternalManagedBackendBucketMigrationState("TEST");

        public static bool operator ==(GlobalForwardingRuleExternalManagedBackendBucketMigrationState left, GlobalForwardingRuleExternalManagedBackendBucketMigrationState right) => left.Equals(right);
        public static bool operator !=(GlobalForwardingRuleExternalManagedBackendBucketMigrationState left, GlobalForwardingRuleExternalManagedBackendBucketMigrationState right) => !left.Equals(right);

        public static explicit operator string(GlobalForwardingRuleExternalManagedBackendBucketMigrationState value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GlobalForwardingRuleExternalManagedBackendBucketMigrationState other && Equals(other);
        public bool Equals(GlobalForwardingRuleExternalManagedBackendBucketMigrationState other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct GlobalPublicDelegatedPrefixMode : IEquatable<GlobalPublicDelegatedPrefixMode>
    {
        private readonly string _value;

        private GlobalPublicDelegatedPrefixMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static GlobalPublicDelegatedPrefixMode Delegation { get; } = new GlobalPublicDelegatedPrefixMode("DELEGATION");
        /// <summary>
        ...
        /// </summary>
        public static GlobalPublicDelegatedPrefixMode ExternalIpv6ForwardingRuleCreation { get; } = new GlobalPublicDelegatedPrefixMode("EXTERNAL_IPV6_FORWARDING_RULE_CREATION");

        public static bool operator ==(GlobalPublicDelegatedPrefixMode left, GlobalPublicDelegatedPrefixMode right) => left.Equals(right);
        public static bool operator !=(GlobalPublicDelegatedPrefixMode left, GlobalPublicDelegatedPrefixMode right) => !left.Equals(right);

        public static explicit operator string(GlobalPublicDelegatedPrefixMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GlobalPublicDelegatedPrefixMode other && Equals(other);
        public bool Equals(GlobalPublicDelegatedPrefixMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck : IEquatable<InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck>
    {
        private readonly string _value;

        private InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck Off { get; } = new InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck("OFF");
        /// <summary>
        /// (Default) The group recreates running VMs that fail the group's application-based health check.
        /// </summary>
        public static InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck On { get; } = new InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck("ON");

        public static bool operator ==(InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck left, InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck right) => left.Equals(right);
        public static bool operator !=(InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck left, InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck right) => !left.Equals(right);

        public static explicit operator string(InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck other && Equals(other);
        public bool Equals(InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure : IEquatable<InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure>
    {
        ...
        /// </summary>
        public static InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure Delete { get; } = new InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure("DELETE");
        /// <summary>
    ...
    public readonly struct InstanceGroupManagerStandbyPolicyMode : IEquatable<InstanceGroupManagerStandbyPolicyMode>
    {
        ...
        private InstanceGroupManagerStandbyPolicyMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        public static bool operator ==(InstanceGroupManagerStandbyPolicyMode left, InstanceGroupManagerStandbyPolicyMode right) => left.Equals(right);
        public static bool operator !=(InstanceGroupManagerStandbyPolicyMode left, InstanceGroupManagerStandbyPolicyMode right) => !left.Equals(right);

        public static explicit operator string(InstanceGroupManagerStandbyPolicyMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is InstanceGroupManagerStandbyPolicyMode other && Equals(other);
        public bool Equals(InstanceGroupManagerStandbyPolicyMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct InstanceGroupManagerTargetSizeUnit : IEquatable<InstanceGroupManagerTargetSizeUnit>
    {
        private readonly string _value;

        private InstanceGroupManagerTargetSizeUnit(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static InstanceGroupManagerTargetSizeUnit Instance { get; } = new InstanceGroupManagerTargetSizeUnit("INSTANCE");
        /// <summary>
        /// TargetSize is the target count of vCPUs of VMs.
        /// </summary>
        public static InstanceGroupManagerTargetSizeUnit Vcpu { get; } = new InstanceGroupManagerTargetSizeUnit("VCPU");

        public static bool operator ==(InstanceGroupManagerTargetSizeUnit left, InstanceGroupManagerTargetSizeUnit right) => left.Equals(right);
        public static bool operator !=(InstanceGroupManagerTargetSizeUnit left, InstanceGroupManagerTargetSizeUnit right) => !left.Equals(right);

        public static explicit operator string(InstanceGroupManagerTargetSizeUnit value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is InstanceGroupManagerTargetSizeUnit other && Equals(other);
        public bool Equals(InstanceGroupManagerTargetSizeUnit other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct NetworkInterfaceIgmpQuery : IEquatable<NetworkInterfaceIgmpQuery>
    {
        private readonly string _value;

        private NetworkInterfaceIgmpQuery(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static NetworkInterfaceIgmpQuery IgmpQueryDisabled { get; } = new NetworkInterfaceIgmpQuery("IGMP_QUERY_DISABLED");
        /// <summary>
        /// The network interface has enabled IGMP query - v2.
        /// </summary>
        public static NetworkInterfaceIgmpQuery IgmpQueryV2 { get; } = new NetworkInterfaceIgmpQuery("IGMP_QUERY_V2");

        public static bool operator ==(NetworkInterfaceIgmpQuery left, NetworkInterfaceIgmpQuery right) => left.Equals(right);
        public static bool operator !=(NetworkInterfaceIgmpQuery left, NetworkInterfaceIgmpQuery right) => !left.Equals(right);

        public static explicit operator string(NetworkInterfaceIgmpQuery value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is NetworkInterfaceIgmpQuery other && Equals(other);
        public bool Equals(NetworkInterfaceIgmpQuery other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct NetworkInterfaceNicType : IEquatable<NetworkInterfaceNicType>
    {
        ...
        /// IDPF
        /// </summary>
        public static NetworkInterfaceNicType Idpf { get; } = new NetworkInterfaceNicType("IDPF");
        /// <summary>
        /// No type specified.
        /// </summary>
    ...
    public readonly struct NetworkInterfaceStackType : IEquatable<NetworkInterfaceStackType>
    {
        ...
        /// </summary>
        public static NetworkInterfaceStackType Ipv6Only { get; } = new NetworkInterfaceStackType("IPV6_ONLY");
    ...
    [EnumType]
    public readonly struct NetworkInterfaceSubInterfaceIpAllocationMode : IEquatable<NetworkInterfaceSubInterfaceIpAllocationMode>
    {
        private readonly string _value;

        private NetworkInterfaceSubInterfaceIpAllocationMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static NetworkInterfaceSubInterfaceIpAllocationMode AllocateIp { get; } = new NetworkInterfaceSubInterfaceIpAllocationMode("ALLOCATE_IP");
        /// <summary>
        /// No IP allocation is done for the subinterface.
        /// </summary>
        public static NetworkInterfaceSubInterfaceIpAllocationMode DoNotAllocateIp { get; } = new NetworkInterfaceSubInterfaceIpAllocationMode("DO_NOT_ALLOCATE_IP");
        public static NetworkInterfaceSubInterfaceIpAllocationMode Unspecified { get; } = new NetworkInterfaceSubInterfaceIpAllocationMode("UNSPECIFIED");

        public static bool operator ==(NetworkInterfaceSubInterfaceIpAllocationMode left, NetworkInterfaceSubInterfaceIpAllocationMode right) => left.Equals(right);
        public static bool operator !=(NetworkInterfaceSubInterfaceIpAllocationMode left, NetworkInterfaceSubInterfaceIpAllocationMode right) => !left.Equals(right);

        public static explicit operator string(NetworkInterfaceSubInterfaceIpAllocationMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is NetworkInterfaceSubInterfaceIpAllocationMode other && Equals(other);
        public bool Equals(NetworkInterfaceSubInterfaceIpAllocationMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct NetworkRoutingConfigBgpBestPathSelectionMode : IEquatable<NetworkRoutingConfigBgpBestPathSelectionMode>
    {
        private readonly string _value;

        private NetworkRoutingConfigBgpBestPathSelectionMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static NetworkRoutingConfigBgpBestPathSelectionMode Legacy { get; } = new NetworkRoutingConfigBgpBestPathSelectionMode("LEGACY");
        public static NetworkRoutingConfigBgpBestPathSelectionMode Standard { get; } = new NetworkRoutingConfigBgpBestPathSelectionMode("STANDARD");

        public static bool operator ==(NetworkRoutingConfigBgpBestPathSelectionMode left, NetworkRoutingConfigBgpBestPathSelectionMode right) => left.Equals(right);
        public static bool operator !=(NetworkRoutingConfigBgpBestPathSelectionMode left, NetworkRoutingConfigBgpBestPathSelectionMode right) => !left.Equals(right);

        public static explicit operator string(NetworkRoutingConfigBgpBestPathSelectionMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is NetworkRoutingConfigBgpBestPathSelectionMode other && Equals(other);
        public bool Equals(NetworkRoutingConfigBgpBestPathSelectionMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct NetworkRoutingConfigBgpInterRegionCost : IEquatable<NetworkRoutingConfigBgpInterRegionCost>
    {
        private readonly string _value;

        private NetworkRoutingConfigBgpInterRegionCost(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static NetworkRoutingConfigBgpInterRegionCost AddCostToMed { get; } = new NetworkRoutingConfigBgpInterRegionCost("ADD_COST_TO_MED");
        public static NetworkRoutingConfigBgpInterRegionCost Default { get; } = new NetworkRoutingConfigBgpInterRegionCost("DEFAULT");

        public static bool operator ==(NetworkRoutingConfigBgpInterRegionCost left, NetworkRoutingConfigBgpInterRegionCost right) => left.Equals(right);
        public static bool operator !=(NetworkRoutingConfigBgpInterRegionCost left, NetworkRoutingConfigBgpInterRegionCost right) => !left.Equals(right);

        public static explicit operator string(NetworkRoutingConfigBgpInterRegionCost value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is NetworkRoutingConfigBgpInterRegionCost other && Equals(other);
        public bool Equals(NetworkRoutingConfigBgpInterRegionCost other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct PublicDelegatedPrefixMode : IEquatable<PublicDelegatedPrefixMode>
    {
        private readonly string _value;

        private PublicDelegatedPrefixMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// The public delegated prefix is used for further sub-delegation only. Such prefixes cannot set allocatablePrefixLength.
        /// </summary>
        public static PublicDelegatedPrefixMode Delegation { get; } = new PublicDelegatedPrefixMode("DELEGATION");
        /// <summary>
        /// The public delegated prefix is used for creating forwarding rules only. Such prefixes cannot set publicDelegatedSubPrefixes.
        /// </summary>
        public static PublicDelegatedPrefixMode ExternalIpv6ForwardingRuleCreation { get; } = new PublicDelegatedPrefixMode("EXTERNAL_IPV6_FORWARDING_RULE_CREATION");

        public static bool operator ==(PublicDelegatedPrefixMode left, PublicDelegatedPrefixMode right) => left.Equals(right);
        public static bool operator !=(PublicDelegatedPrefixMode left, PublicDelegatedPrefixMode right) => !left.Equals(right);

        public static explicit operator string(PublicDelegatedPrefixMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is PublicDelegatedPrefixMode other && Equals(other);
        public bool Equals(PublicDelegatedPrefixMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct PublicDelegatedPrefixPublicDelegatedSubPrefixMode : IEquatable<PublicDelegatedPrefixPublicDelegatedSubPrefixMode>
    {
        private readonly string _value;

        private PublicDelegatedPrefixPublicDelegatedSubPrefixMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// The public delegated prefix is used for further sub-delegation only. Such prefixes cannot set allocatablePrefixLength.
        /// </summary>
        public static PublicDelegatedPrefixPublicDelegatedSubPrefixMode Delegation { get; } = new PublicDelegatedPrefixPublicDelegatedSubPrefixMode("DELEGATION");
        /// <summary>
        /// The public delegated prefix is used for creating forwarding rules only. Such prefixes cannot set publicDelegatedSubPrefixes.
        /// </summary>
        public static PublicDelegatedPrefixPublicDelegatedSubPrefixMode ExternalIpv6ForwardingRuleCreation { get; } = new PublicDelegatedPrefixPublicDelegatedSubPrefixMode("EXTERNAL_IPV6_FORWARDING_RULE_CREATION");

        public static bool operator ==(PublicDelegatedPrefixPublicDelegatedSubPrefixMode left, PublicDelegatedPrefixPublicDelegatedSubPrefixMode right) => left.Equals(right);
        public static bool operator !=(PublicDelegatedPrefixPublicDelegatedSubPrefixMode left, PublicDelegatedPrefixPublicDelegatedSubPrefixMode right) => !left.Equals(right);

        public static explicit operator string(PublicDelegatedPrefixPublicDelegatedSubPrefixMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is PublicDelegatedPrefixPublicDelegatedSubPrefixMode other && Equals(other);
        public bool Equals(PublicDelegatedPrefixPublicDelegatedSubPrefixMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct RegionBackendServiceExternalManagedMigrationState : IEquatable<RegionBackendServiceExternalManagedMigrationState>
    {
        private readonly string _value;

        private RegionBackendServiceExternalManagedMigrationState(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static RegionBackendServiceExternalManagedMigrationState Finalize { get; } = new RegionBackendServiceExternalManagedMigrationState("FINALIZE");
        public static RegionBackendServiceExternalManagedMigrationState Prepare { get; } = new RegionBackendServiceExternalManagedMigrationState("PREPARE");
        public static RegionBackendServiceExternalManagedMigrationState Test { get; } = new RegionBackendServiceExternalManagedMigrationState("TEST");

        public static bool operator ==(RegionBackendServiceExternalManagedMigrationState left, RegionBackendServiceExternalManagedMigrationState right) => left.Equals(right);
        public static bool operator !=(RegionBackendServiceExternalManagedMigrationState left, RegionBackendServiceExternalManagedMigrationState right) => !left.Equals(right);

        public static explicit operator string(RegionBackendServiceExternalManagedMigrationState value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is RegionBackendServiceExternalManagedMigrationState other && Equals(other);
        public bool Equals(RegionBackendServiceExternalManagedMigrationState other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct RegionCommitmentType : IEquatable<RegionCommitmentType>
    {
        ...
        public static RegionCommitmentType AcceleratorOptimizedA3Mega { get; } = new RegionCommitmentType("ACCELERATOR_OPTIMIZED_A3_MEGA");
        ...
        public static RegionCommitmentType GeneralPurposeC4 { get; } = new RegionCommitmentType("GENERAL_PURPOSE_C4");
    ...
    /// </summary>
    [EnumType]
    public readonly struct RegionDiskAccessMode : IEquatable<RegionDiskAccessMode>
    {
        private readonly string _value;

        private RegionDiskAccessMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// The AccessMode means the disk can be attached to multiple instances in RO mode.
        /// </summary>
        public static RegionDiskAccessMode ReadOnlyMany { get; } = new RegionDiskAccessMode("READ_ONLY_MANY");
        /// <summary>
        /// The AccessMode means the disk can be attached to multiple instances in RW mode.
        /// </summary>
        public static RegionDiskAccessMode ReadWriteMany { get; } = new RegionDiskAccessMode("READ_WRITE_MANY");
        /// <summary>
        /// The default AccessMode, means the disk can be attached to single instance in RW mode.
        /// </summary>
        public static RegionDiskAccessMode ReadWriteSingle { get; } = new RegionDiskAccessMode("READ_WRITE_SINGLE");

        public static bool operator ==(RegionDiskAccessMode left, RegionDiskAccessMode right) => left.Equals(right);
        public static bool operator !=(RegionDiskAccessMode left, RegionDiskAccessMode right) => !left.Equals(right);

        public static explicit operator string(RegionDiskAccessMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is RegionDiskAccessMode other && Equals(other);
        public bool Equals(RegionDiskAccessMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct RegionInstanceGroupManagerTargetSizeUnit : IEquatable<RegionInstanceGroupManagerTargetSizeUnit>
    {
        private readonly string _value;

        private RegionInstanceGroupManagerTargetSizeUnit(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// [Default] TargetSize is the target number of instances.
        /// </summary>
        public static RegionInstanceGroupManagerTargetSizeUnit Instance { get; } = new RegionInstanceGroupManagerTargetSizeUnit("INSTANCE");
        /// <summary>
        /// TargetSize is the target count of vCPUs of VMs.
        /// </summary>
        public static RegionInstanceGroupManagerTargetSizeUnit Vcpu { get; } = new RegionInstanceGroupManagerTargetSizeUnit("VCPU");

        public static bool operator ==(RegionInstanceGroupManagerTargetSizeUnit left, RegionInstanceGroupManagerTargetSizeUnit right) => left.Equals(right);
        public static bool operator !=(RegionInstanceGroupManagerTargetSizeUnit left, RegionInstanceGroupManagerTargetSizeUnit right) => !left.Equals(right);

        public static explicit operator string(RegionInstanceGroupManagerTargetSizeUnit value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is RegionInstanceGroupManagerTargetSizeUnit other && Equals(other);
        public bool Equals(RegionInstanceGroupManagerTargetSizeUnit other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct RegionSnapshotSnapshotType : IEquatable<RegionSnapshotSnapshotType>
    {
        private readonly string _value;

        private RegionSnapshotSnapshotType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static RegionSnapshotSnapshotType Archive { get; } = new RegionSnapshotSnapshotType("ARCHIVE");
        public static RegionSnapshotSnapshotType Standard { get; } = new RegionSnapshotSnapshotType("STANDARD");

        public static bool operator ==(RegionSnapshotSnapshotType left, RegionSnapshotSnapshotType right) => left.Equals(right);
        public static bool operator !=(RegionSnapshotSnapshotType left, RegionSnapshotSnapshotType right) => !left.Equals(right);

        public static explicit operator string(RegionSnapshotSnapshotType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is RegionSnapshotSnapshotType other && Equals(other);
        public bool Equals(RegionSnapshotSnapshotType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct ReservationAffinityConsumeReservationType : IEquatable<ReservationAffinityConsumeReservationType>
    {
        ...
        /// </summary>
        public static ReservationAffinityConsumeReservationType SpecificThenNoReservation { get; } = new ReservationAffinityConsumeReservationType("SPECIFIC_THEN_NO_RESERVATION");
    ...
    /// </summary>
    [EnumType]
    public readonly struct RouteIlbRouteBehaviorOnUnhealthy : IEquatable<RouteIlbRouteBehaviorOnUnhealthy>
    {
        private readonly string _value;

        private RouteIlbRouteBehaviorOnUnhealthy(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static RouteIlbRouteBehaviorOnUnhealthy DoNotWithdrawRouteIfIlbUnhealthy { get; } = new RouteIlbRouteBehaviorOnUnhealthy("DO_NOT_WITHDRAW_ROUTE_IF_ILB_UNHEALTHY");
        /// <summary>
        ...
        /// </summary>
        public static RouteIlbRouteBehaviorOnUnhealthy WithdrawRouteIfIlbUnhealthy { get; } = new RouteIlbRouteBehaviorOnUnhealthy("WITHDRAW_ROUTE_IF_ILB_UNHEALTHY");

        public static bool operator ==(RouteIlbRouteBehaviorOnUnhealthy left, RouteIlbRouteBehaviorOnUnhealthy right) => left.Equals(right);
        public static bool operator !=(RouteIlbRouteBehaviorOnUnhealthy left, RouteIlbRouteBehaviorOnUnhealthy right) => !left.Equals(right);

        public static explicit operator string(RouteIlbRouteBehaviorOnUnhealthy value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is RouteIlbRouteBehaviorOnUnhealthy other && Equals(other);
        public bool Equals(RouteIlbRouteBehaviorOnUnhealthy other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct RouterInterfaceIpVersion : IEquatable<RouterInterfaceIpVersion>
    {
        private readonly string _value;

        private RouterInterfaceIpVersion(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static RouterInterfaceIpVersion Ipv4 { get; } = new RouterInterfaceIpVersion("IPV4");
        public static RouterInterfaceIpVersion Ipv6 { get; } = new RouterInterfaceIpVersion("IPV6");

        public static bool operator ==(RouterInterfaceIpVersion left, RouterInterfaceIpVersion right) => left.Equals(right);
        public static bool operator !=(RouterInterfaceIpVersion left, RouterInterfaceIpVersion right) => !left.Equals(right);

        public static explicit operator string(RouterInterfaceIpVersion value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is RouterInterfaceIpVersion other && Equals(other);
        public bool Equals(RouterInterfaceIpVersion other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct ServiceAttachmentTunnelingConfigEncapsulationProfile : IEquatable<ServiceAttachmentTunnelingConfigEncapsulationProfile>
    {
        private readonly string _value;

        private ServiceAttachmentTunnelingConfigEncapsulationProfile(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static ServiceAttachmentTunnelingConfigEncapsulationProfile GeneveSecurityV1 { get; } = new ServiceAttachmentTunnelingConfigEncapsulationProfile("GENEVE_SECURITY_V1");
        public static ServiceAttachmentTunnelingConfigEncapsulationProfile UnspecifiedEncapsulationProfile { get; } = new ServiceAttachmentTunnelingConfigEncapsulationProfile("UNSPECIFIED_ENCAPSULATION_PROFILE");

        public static bool operator ==(ServiceAttachmentTunnelingConfigEncapsulationProfile left, ServiceAttachmentTunnelingConfigEncapsulationProfile right) => left.Equals(right);
        public static bool operator !=(ServiceAttachmentTunnelingConfigEncapsulationProfile left, ServiceAttachmentTunnelingConfigEncapsulationProfile right) => !left.Equals(right);

        public static explicit operator string(ServiceAttachmentTunnelingConfigEncapsulationProfile value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ServiceAttachmentTunnelingConfigEncapsulationProfile other && Equals(other);
        public bool Equals(ServiceAttachmentTunnelingConfigEncapsulationProfile other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct ServiceAttachmentTunnelingConfigRoutingMode : IEquatable<ServiceAttachmentTunnelingConfigRoutingMode>
    {
        private readonly string _value;

        private ServiceAttachmentTunnelingConfigRoutingMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static ServiceAttachmentTunnelingConfigRoutingMode PacketInjection { get; } = new ServiceAttachmentTunnelingConfigRoutingMode("PACKET_INJECTION");
        /// <summary>
        /// Response traffic, after de-encapsulation, will be returned to the client.
        /// </summary>
        public static ServiceAttachmentTunnelingConfigRoutingMode StandardRouting { get; } = new ServiceAttachmentTunnelingConfigRoutingMode("STANDARD_ROUTING");
        public static ServiceAttachmentTunnelingConfigRoutingMode UnspecifiedRoutingMode { get; } = new ServiceAttachmentTunnelingConfigRoutingMode("UNSPECIFIED_ROUTING_MODE");

        public static bool operator ==(ServiceAttachmentTunnelingConfigRoutingMode left, ServiceAttachmentTunnelingConfigRoutingMode right) => left.Equals(right);
        public static bool operator !=(ServiceAttachmentTunnelingConfigRoutingMode left, ServiceAttachmentTunnelingConfigRoutingMode right) => !left.Equals(right);

        public static explicit operator string(ServiceAttachmentTunnelingConfigRoutingMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ServiceAttachmentTunnelingConfigRoutingMode other && Equals(other);
        public bool Equals(ServiceAttachmentTunnelingConfigRoutingMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct SubnetworkStackType : IEquatable<SubnetworkStackType>
    {
        ...
        /// </summary>
        public static SubnetworkStackType Ipv6Only { get; } = new SubnetworkStackType("IPV6_ONLY");
