...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:ExternalVpnGateway")]
    public partial class ExternalVpnGateway : Pulumi.CustomResource
    {
        ...
        public ExternalVpnGateway(string name, ExternalVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ExternalVpnGateway", name, args ?? new ExternalVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExternalVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ExternalVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
