...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:Firewall")]
    public partial class Firewall : Pulumi.CustomResource
    {
        ...
        public Firewall(string name, FirewallArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:Firewall", name, args ?? new FirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Firewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:Firewall", name, null, MakeResourceOptions(options, id))
        {
        }
