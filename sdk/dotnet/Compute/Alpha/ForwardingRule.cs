...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    public partial class ForwardingRule : global::Pulumi.CustomResource
    {
        ...
        public ForwardingRule(string name, ForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ForwardingRule", name, args ?? new ForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ForwardingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Alpha.ForwardingRuleExternalManagedBackendBucketMigrationState>? ExternalManagedBackendBucketMigrationState { get; set; }
