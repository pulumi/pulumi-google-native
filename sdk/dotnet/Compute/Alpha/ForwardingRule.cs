...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:ForwardingRule")]
    public partial class ForwardingRule : Pulumi.CustomResource
    {
        ...
        public ForwardingRule(string name, ForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:ForwardingRule", name, args ?? new ForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:ForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
