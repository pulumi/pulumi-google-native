...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetAddress
    {
        ...
        public static Task<GetAddressResult> InvokeAsync(GetAddressArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddressResult>("google-native:compute/alpha:getAddress", args ?? new GetAddressArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified address resource.
        /// </summary>
        public static Output<GetAddressResult> Invoke(GetAddressInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAddressResult>("google-native:compute/alpha:getAddress", args ?? new GetAddressInvokeArgs(), options.WithDefaults());
    }
