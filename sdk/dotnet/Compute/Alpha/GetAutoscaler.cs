...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetAutoscaler
    {
        ...
        public static Task<GetAutoscalerResult> InvokeAsync(GetAutoscalerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutoscalerResult>("google-native:compute/alpha:getAutoscaler", args ?? new GetAutoscalerArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified autoscaler resource.
        /// </summary>
        public static Output<GetAutoscalerResult> Invoke(GetAutoscalerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAutoscalerResult>("google-native:compute/alpha:getAutoscaler", args ?? new GetAutoscalerInvokeArgs(), options.WithDefaults());
    }
