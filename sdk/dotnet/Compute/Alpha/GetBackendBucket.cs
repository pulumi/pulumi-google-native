...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetBackendBucket
    {
        ...
        public static Task<GetBackendBucketResult> InvokeAsync(GetBackendBucketArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackendBucketResult>("google-native:compute/alpha:getBackendBucket", args ?? new GetBackendBucketArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified BackendBucket resource. Gets a list of available backend buckets by making a list() request.
        /// </summary>
        public static Output<GetBackendBucketResult> Invoke(GetBackendBucketInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackendBucketResult>("google-native:compute/alpha:getBackendBucket", args ?? new GetBackendBucketInvokeArgs(), options.WithDefaults());
    }
