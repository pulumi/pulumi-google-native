...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetExternalVpnGateway
    {
        ...
        public static Task<GetExternalVpnGatewayResult> InvokeAsync(GetExternalVpnGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExternalVpnGatewayResult>("google-native:compute/alpha:getExternalVpnGateway", args ?? new GetExternalVpnGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified externalVpnGateway. Get a list of available externalVpnGateways by making a list() request.
        /// </summary>
        public static Output<GetExternalVpnGatewayResult> Invoke(GetExternalVpnGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExternalVpnGatewayResult>("google-native:compute/alpha:getExternalVpnGateway", args ?? new GetExternalVpnGatewayInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetExternalVpnGatewayArgs : global::Pulumi.InvokeArgs
    {
        ...
        public static new GetExternalVpnGatewayArgs Empty => new GetExternalVpnGatewayArgs();
    }

    public sealed class GetExternalVpnGatewayInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("externalVpnGateway", required: true)]
        ...
        public static new GetExternalVpnGatewayInvokeArgs Empty => new GetExternalVpnGatewayInvokeArgs();
    }
