...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetGlobalAddress
    {
        ...
        public static Task<GetGlobalAddressResult> InvokeAsync(GetGlobalAddressArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGlobalAddressResult>("google-native:compute/alpha:getGlobalAddress", args ?? new GetGlobalAddressArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified address resource. Gets a list of available addresses by making a list() request.
        /// </summary>
        public static Output<GetGlobalAddressResult> Invoke(GetGlobalAddressInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGlobalAddressResult>("google-native:compute/alpha:getGlobalAddress", args ?? new GetGlobalAddressInvokeArgs(), options.WithVersion());
    }
