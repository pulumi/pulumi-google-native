...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetGlobalForwardingRule
    {
        ...
        public static Task<GetGlobalForwardingRuleResult> InvokeAsync(GetGlobalForwardingRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGlobalForwardingRuleResult>("google-native:compute/alpha:getGlobalForwardingRule", args ?? new GetGlobalForwardingRuleArgs(), options.WithVersion());
        ...
        public static Output<GetGlobalForwardingRuleResult> Invoke(GetGlobalForwardingRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGlobalForwardingRuleResult>("google-native:compute/alpha:getGlobalForwardingRule", args ?? new GetGlobalForwardingRuleInvokeArgs(), options.WithVersion());
    }
