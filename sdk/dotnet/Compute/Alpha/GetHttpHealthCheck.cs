...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetHttpHealthCheck
    {
        ...
        public static Task<GetHttpHealthCheckResult> InvokeAsync(GetHttpHealthCheckArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHttpHealthCheckResult>("google-native:compute/alpha:getHttpHealthCheck", args ?? new GetHttpHealthCheckArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified HttpHealthCheck resource. Gets a list of available HTTP health checks by making a list() request.
        /// </summary>
        public static Output<GetHttpHealthCheckResult> Invoke(GetHttpHealthCheckInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHttpHealthCheckResult>("google-native:compute/alpha:getHttpHealthCheck", args ?? new GetHttpHealthCheckInvokeArgs(), options.WithDefaults());
    }
