...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetInstanceTemplate
    {
        ...
        public static Task<GetInstanceTemplateResult> InvokeAsync(GetInstanceTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstanceTemplateResult>("google-native:compute/alpha:getInstanceTemplate", args ?? new GetInstanceTemplateArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified instance template. Gets a list of available instance templates by making a list() request.
        /// </summary>
        public static Output<GetInstanceTemplateResult> Invoke(GetInstanceTemplateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInstanceTemplateResult>("google-native:compute/alpha:getInstanceTemplate", args ?? new GetInstanceTemplateInvokeArgs(), options.WithVersion());
    }
