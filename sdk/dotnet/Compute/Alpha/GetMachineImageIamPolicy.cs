...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetMachineImageIamPolicy
    {
        ...
        public static Task<GetMachineImageIamPolicyResult> InvokeAsync(GetMachineImageIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineImageIamPolicyResult>("google-native:compute/alpha:getMachineImageIamPolicy", args ?? new GetMachineImageIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetMachineImageIamPolicyResult> Invoke(GetMachineImageIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMachineImageIamPolicyResult>("google-native:compute/alpha:getMachineImageIamPolicy", args ?? new GetMachineImageIamPolicyInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetMachineImageIamPolicyArgs : Pulumi.InvokeArgs
    {
    ...
    public sealed class GetMachineImageIamPolicyInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("optionsRequestedPolicyVersion")]
