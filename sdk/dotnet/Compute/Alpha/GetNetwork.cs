...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetNetwork
    {
        ...
        public static Task<GetNetworkResult> InvokeAsync(GetNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkResult>("google-native:compute/alpha:getNetwork", args ?? new GetNetworkArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified network. Gets a list of available networks by making a list() request.
        /// </summary>
        public static Output<GetNetworkResult> Invoke(GetNetworkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNetworkResult>("google-native:compute/alpha:getNetwork", args ?? new GetNetworkInvokeArgs(), options.WithDefaults());
    }
