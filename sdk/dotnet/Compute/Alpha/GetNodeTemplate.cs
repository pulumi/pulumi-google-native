...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetNodeTemplate
    {
        ...
        public static Output<GetNodeTemplateResult> Invoke(GetNodeTemplateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNodeTemplateResult>("google-native:compute/alpha:getNodeTemplate", args ?? new GetNodeTemplateInvokeArgs(), options.WithVersion());
    }
