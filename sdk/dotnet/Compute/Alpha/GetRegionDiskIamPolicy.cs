...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetRegionDiskIamPolicy
    {
        ...
        public static Task<GetRegionDiskIamPolicyResult> InvokeAsync(GetRegionDiskIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionDiskIamPolicyResult>("google-native:compute/alpha:getRegionDiskIamPolicy", args ?? new GetRegionDiskIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetRegionDiskIamPolicyResult> Invoke(GetRegionDiskIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionDiskIamPolicyResult>("google-native:compute/alpha:getRegionDiskIamPolicy", args ?? new GetRegionDiskIamPolicyInvokeArgs(), options.WithVersion());
    }
