...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetRegionHealthCheckService
    {
        ...
        public static Task<GetRegionHealthCheckServiceResult> InvokeAsync(GetRegionHealthCheckServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionHealthCheckServiceResult>("google-native:compute/alpha:getRegionHealthCheckService", args ?? new GetRegionHealthCheckServiceArgs(), options.WithVersion());
        ...
        public static Output<GetRegionHealthCheckServiceResult> Invoke(GetRegionHealthCheckServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionHealthCheckServiceResult>("google-native:compute/alpha:getRegionHealthCheckService", args ?? new GetRegionHealthCheckServiceInvokeArgs(), options.WithVersion());
    }
