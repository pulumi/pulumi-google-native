...
{
    public static class GetRegionInPlaceSnapshot
    {
        /// <summary>
        /// Returns the specified InPlaceSnapshot resource in the specified region.
        /// </summary>
        public static Task<GetRegionInPlaceSnapshotResult> InvokeAsync(GetRegionInPlaceSnapshotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionInPlaceSnapshotResult>("google-native:compute/alpha:getRegionInPlaceSnapshot", args ?? new GetRegionInPlaceSnapshotArgs(), options.WithVersion());
    }


    public sealed class GetRegionInPlaceSnapshotArgs : Pulumi.InvokeArgs
    {
        [Input("inPlaceSnapshot", required: true)]
        public string InPlaceSnapshot { get; set; } = null!;
        ...
        public GetRegionInPlaceSnapshotArgs()
        {
        }
    }
    ...
    public sealed class GetRegionInPlaceSnapshotResult
    {
        ...
        [OutputConstructor]
        private GetRegionInPlaceSnapshotResult(
