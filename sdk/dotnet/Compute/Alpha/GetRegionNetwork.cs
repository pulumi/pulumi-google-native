...
{
    public static class GetRegionNetwork
    {
        /// <summary>
        /// Returns the specified network.
        /// </summary>
        public static Task<GetRegionNetworkResult> InvokeAsync(GetRegionNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionNetworkResult>("google-native:compute/alpha:getRegionNetwork", args ?? new GetRegionNetworkArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified network.
        /// </summary>
        public static Output<GetRegionNetworkResult> Invoke(GetRegionNetworkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionNetworkResult>("google-native:compute/alpha:getRegionNetwork", args ?? new GetRegionNetworkInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetRegionNetworkResult
    {
        /// <summary>
