...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetRegionNotificationEndpoint
    {
        ...
        public static Task<GetRegionNotificationEndpointResult> InvokeAsync(GetRegionNotificationEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegionNotificationEndpointResult>("google-native:compute/alpha:getRegionNotificationEndpoint", args ?? new GetRegionNotificationEndpointArgs(), options.WithDefaults());
        ...
        public static Output<GetRegionNotificationEndpointResult> Invoke(GetRegionNotificationEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegionNotificationEndpointResult>("google-native:compute/alpha:getRegionNotificationEndpoint", args ?? new GetRegionNotificationEndpointInvokeArgs(), options.WithDefaults());
    }
