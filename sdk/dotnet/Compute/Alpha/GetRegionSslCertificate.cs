...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetRegionSslCertificate
    {
        ...
        public static Task<GetRegionSslCertificateResult> InvokeAsync(GetRegionSslCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionSslCertificateResult>("google-native:compute/alpha:getRegionSslCertificate", args ?? new GetRegionSslCertificateArgs(), options.WithVersion());
        ...
        public static Output<GetRegionSslCertificateResult> Invoke(GetRegionSslCertificateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionSslCertificateResult>("google-native:compute/alpha:getRegionSslCertificate", args ?? new GetRegionSslCertificateInvokeArgs(), options.WithVersion());
    }
