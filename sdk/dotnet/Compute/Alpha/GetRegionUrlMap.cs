...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetRegionUrlMap
    {
        ...
        public static Task<GetRegionUrlMapResult> InvokeAsync(GetRegionUrlMapArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionUrlMapResult>("google-native:compute/alpha:getRegionUrlMap", args ?? new GetRegionUrlMapArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified UrlMap resource. Gets a list of available URL maps by making a list() request.
        /// </summary>
        public static Output<GetRegionUrlMapResult> Invoke(GetRegionUrlMapInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionUrlMapResult>("google-native:compute/alpha:getRegionUrlMap", args ?? new GetRegionUrlMapInvokeArgs(), options.WithVersion());
    }
