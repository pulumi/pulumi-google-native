...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetReservation
    {
        ...
        public static Task<GetReservationResult> InvokeAsync(GetReservationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReservationResult>("google-native:compute/alpha:getReservation", args ?? new GetReservationArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about the specified reservation.
        /// </summary>
        public static Output<GetReservationResult> Invoke(GetReservationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReservationResult>("google-native:compute/alpha:getReservation", args ?? new GetReservationInvokeArgs(), options.WithDefaults());
    }
