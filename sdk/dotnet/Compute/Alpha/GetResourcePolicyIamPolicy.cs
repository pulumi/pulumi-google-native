...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetResourcePolicyIamPolicy
    {
        ...
        public static Task<GetResourcePolicyIamPolicyResult> InvokeAsync(GetResourcePolicyIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourcePolicyIamPolicyResult>("google-native:compute/alpha:getResourcePolicyIamPolicy", args ?? new GetResourcePolicyIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetResourcePolicyIamPolicyResult> Invoke(GetResourcePolicyIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetResourcePolicyIamPolicyResult>("google-native:compute/alpha:getResourcePolicyIamPolicy", args ?? new GetResourcePolicyIamPolicyInvokeArgs(), options.WithVersion());
    }


    public sealed class GetResourcePolicyIamPolicyArgs : Pulumi.InvokeArgs
    {
    ...
    public sealed class GetResourcePolicyIamPolicyInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("optionsRequestedPolicyVersion")]
