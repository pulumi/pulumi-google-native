...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetSslCertificate
    {
        ...
        public static Task<GetSslCertificateResult> InvokeAsync(GetSslCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSslCertificateResult>("google-native:compute/alpha:getSslCertificate", args ?? new GetSslCertificateArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified SslCertificate resource.
        /// </summary>
        public static Output<GetSslCertificateResult> Invoke(GetSslCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSslCertificateResult>("google-native:compute/alpha:getSslCertificate", args ?? new GetSslCertificateInvokeArgs(), options.WithDefaults());
    }
