...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetSslPolicy
    {
        ...
        public static Task<GetSslPolicyResult> InvokeAsync(GetSslPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSslPolicyResult>("google-native:compute/alpha:getSslPolicy", args ?? new GetSslPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Lists all of the ordered rules present in a single specified policy.
        /// </summary>
        public static Output<GetSslPolicyResult> Invoke(GetSslPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSslPolicyResult>("google-native:compute/alpha:getSslPolicy", args ?? new GetSslPolicyInvokeArgs(), options.WithDefaults());
    }
