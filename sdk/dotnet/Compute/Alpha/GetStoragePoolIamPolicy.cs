...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetStoragePoolIamPolicy
    {
        ...
        public static Task<GetStoragePoolIamPolicyResult> InvokeAsync(GetStoragePoolIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStoragePoolIamPolicyResult>("google-native:compute/alpha:getStoragePoolIamPolicy", args ?? new GetStoragePoolIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetStoragePoolIamPolicyResult> Invoke(GetStoragePoolIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStoragePoolIamPolicyResult>("google-native:compute/alpha:getStoragePoolIamPolicy", args ?? new GetStoragePoolIamPolicyInvokeArgs(), options.WithDefaults());
    }
