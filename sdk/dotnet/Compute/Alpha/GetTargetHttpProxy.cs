...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetTargetHttpProxy
    {
        ...
        public static Output<GetTargetHttpProxyResult> Invoke(GetTargetHttpProxyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTargetHttpProxyResult>("google-native:compute/alpha:getTargetHttpProxy", args ?? new GetTargetHttpProxyInvokeArgs(), options.WithVersion());
    }
