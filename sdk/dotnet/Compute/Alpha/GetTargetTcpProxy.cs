...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    public static class GetTargetTcpProxy
    {
        ...
        public static Output<GetTargetTcpProxyResult> Invoke(GetTargetTcpProxyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTargetTcpProxyResult>("google-native:compute/alpha:getTargetTcpProxy", args ?? new GetTargetTcpProxyInvokeArgs(), options.WithVersion());
    }
