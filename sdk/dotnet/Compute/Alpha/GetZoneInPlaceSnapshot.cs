...
{
    public static class GetZoneInPlaceSnapshot
    {
        /// <summary>
        /// Returns the specified InPlaceSnapshot resource in the specified zone.
        /// </summary>
        public static Task<GetZoneInPlaceSnapshotResult> InvokeAsync(GetZoneInPlaceSnapshotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetZoneInPlaceSnapshotResult>("google-native:compute/alpha:getZoneInPlaceSnapshot", args ?? new GetZoneInPlaceSnapshotArgs(), options.WithVersion());
    }


    public sealed class GetZoneInPlaceSnapshotArgs : Pulumi.InvokeArgs
    {
        ...
        public GetZoneInPlaceSnapshotArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetZoneInPlaceSnapshotResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetZoneInPlaceSnapshotResult(
