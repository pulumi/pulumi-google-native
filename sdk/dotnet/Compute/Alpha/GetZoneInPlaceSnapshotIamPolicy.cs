...
{
    public static class GetZoneInPlaceSnapshotIamPolicy
    {
        /// <summary>
        /// Gets the access control policy for a resource. May be empty if no such policy or resource exists.
        /// </summary>
        public static Task<GetZoneInPlaceSnapshotIamPolicyResult> InvokeAsync(GetZoneInPlaceSnapshotIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetZoneInPlaceSnapshotIamPolicyResult>("google-native:compute/alpha:getZoneInPlaceSnapshotIamPolicy", args ?? new GetZoneInPlaceSnapshotIamPolicyArgs(), options.WithVersion());
    }


    public sealed class GetZoneInPlaceSnapshotIamPolicyArgs : Pulumi.InvokeArgs
    {
        ...
        public GetZoneInPlaceSnapshotIamPolicyArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetZoneInPlaceSnapshotIamPolicyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetZoneInPlaceSnapshotIamPolicyResult(
