...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:GlobalNetworkEndpointGroup")]
    public partial class GlobalNetworkEndpointGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("loadBalancer")]
        public Output<Outputs.NetworkEndpointGroupLbNetworkEndpointGroupResponse> LoadBalancer { get; private set; } = null!;
        ...
        public GlobalNetworkEndpointGroup(string name, GlobalNetworkEndpointGroupArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:GlobalNetworkEndpointGroup", name, args ?? new GlobalNetworkEndpointGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalNetworkEndpointGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:GlobalNetworkEndpointGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GlobalNetworkEndpointGroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("loadBalancer")]
        public Input<Inputs.NetworkEndpointGroupLbNetworkEndpointGroupArgs>? LoadBalancer { get; set; }
