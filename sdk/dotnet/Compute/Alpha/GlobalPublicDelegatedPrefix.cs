...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    public partial class GlobalPublicDelegatedPrefix : Pulumi.CustomResource
    {
        ...
        private GlobalPublicDelegatedPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:GlobalPublicDelegatedPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GlobalPublicDelegatedPrefixArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.GlobalPublicDelegatedPrefixStatus>? Status { get; set; }
