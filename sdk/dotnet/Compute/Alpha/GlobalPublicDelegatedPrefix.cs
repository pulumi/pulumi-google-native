...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:GlobalPublicDelegatedPrefix")]
    public partial class GlobalPublicDelegatedPrefix : Pulumi.CustomResource
    {
        ...
        public GlobalPublicDelegatedPrefix(string name, GlobalPublicDelegatedPrefixArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:GlobalPublicDelegatedPrefix", name, args ?? new GlobalPublicDelegatedPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalPublicDelegatedPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:GlobalPublicDelegatedPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
