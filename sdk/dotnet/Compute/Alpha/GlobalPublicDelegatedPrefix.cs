...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:GlobalPublicDelegatedPrefix")]
    public partial class GlobalPublicDelegatedPrefix : Pulumi.CustomResource
    {
        ...
        public GlobalPublicDelegatedPrefix(string name, GlobalPublicDelegatedPrefixArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:GlobalPublicDelegatedPrefix", name, args ?? new GlobalPublicDelegatedPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalPublicDelegatedPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:GlobalPublicDelegatedPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
