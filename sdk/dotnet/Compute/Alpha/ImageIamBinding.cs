...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:ImageIamBinding")]
    public partial class ImageIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ImageIamBinding(string name, ImageIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ImageIamBinding", name, args ?? new ImageIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ImageIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ImageIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ImageIamBinding(name, id, options);
        }
    }
