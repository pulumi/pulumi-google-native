...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:ImageIamMember")]
    public partial class ImageIamMember : global::Pulumi.CustomResource
    {
        ...
        public ImageIamMember(string name, ImageIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ImageIamMember", name, args ?? new ImageIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ImageIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
