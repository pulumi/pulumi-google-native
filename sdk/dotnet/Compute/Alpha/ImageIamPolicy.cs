...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:ImageIamPolicy")]
    public partial class ImageIamPolicy : Pulumi.CustomResource
    {
        ...
        public ImageIamPolicy(string name, ImageIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ImageIamPolicy", name, args ?? new ImageIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ImageIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
