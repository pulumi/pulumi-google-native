...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:InPlaceSnapshot")]
    public partial class InPlaceSnapshot : Pulumi.CustomResource
    {
        /// <summary>
        /// Create a InPlaceSnapshot resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public InPlaceSnapshot(string name, InPlaceSnapshotArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:InPlaceSnapshot", name, args ?? new InPlaceSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InPlaceSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:InPlaceSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing InPlaceSnapshot resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InPlaceSnapshot Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new InPlaceSnapshot(name, id, options);
        }
    }

    public sealed class InPlaceSnapshotArgs : Pulumi.ResourceArgs
    {
        /// <summary>
