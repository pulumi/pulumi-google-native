...
namespace Pulumi.GoogleNative.Compute.Alpha.Inputs
{
    ...
    public sealed class BackendServiceCdnPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CacheKeyPolicyArgs>? CacheKeyPolicy { get; set; }
        ...
        /// </summary>
        [Input("cacheMode")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.BackendServiceCdnPolicyCacheMode>? CacheMode { get; set; }
        ...
        private InputList<Inputs.BackendServiceCdnPolicyNegativeCachingPolicyArgs>? _negativeCachingPolicy;

        /// <summary>
        /// Sets a cache TTL for the specified HTTP status code. negative_caching must be enabled to configure negative_caching_policy. Omitting the policy and leaving negative_caching enabled will use Cloud CDN's default cache TTLs. Note that when specifying an explicit negative_caching_policy, you should take care to specify a cache TTL for all response codes that you wish to cache. Cloud CDN will not apply any default negative caching when a policy exists.
        /// </summary>
        public InputList<Inputs.BackendServiceCdnPolicyNegativeCachingPolicyArgs> NegativeCachingPolicy
        {
        ...
        public static new BackendServiceCdnPolicyArgs Empty => new BackendServiceCdnPolicyArgs();
    }
}
