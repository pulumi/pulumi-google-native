...
namespace Pulumi.GoogleNative.Compute.Alpha.Inputs
{
    ...
    public sealed class SecurityPolicyRuleNetworkMatcherArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchArgs>? _userDefinedFields;

        /// <summary>
        /// User-defined fields. Each element names a defined field and lists the matching values for that field.
        /// </summary>
        public InputList<Inputs.SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchArgs> UserDefinedFields
        {
            get => _userDefinedFields ?? (_userDefinedFields = new InputList<Inputs.SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchArgs>());
            set => _userDefinedFields = value;
        }

        public SecurityPolicyRuleNetworkMatcherArgs()
        {
        }
        public static new SecurityPolicyRuleNetworkMatcherArgs Empty => new SecurityPolicyRuleNetworkMatcherArgs();
    }
}
