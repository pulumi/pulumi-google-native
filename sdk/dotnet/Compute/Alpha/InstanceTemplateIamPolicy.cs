...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:InstanceTemplateIamPolicy")]
    public partial class InstanceTemplateIamPolicy : Pulumi.CustomResource
    {
        ...
        public InstanceTemplateIamPolicy(string name, InstanceTemplateIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:InstanceTemplateIamPolicy", name, args ?? new InstanceTemplateIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceTemplateIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:InstanceTemplateIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
