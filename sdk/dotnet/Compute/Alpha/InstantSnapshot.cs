...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:InstantSnapshot")]
    public partial class InstantSnapshot : Pulumi.CustomResource
    {
        ...
        public InstantSnapshot(string name, InstantSnapshotArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:InstantSnapshot", name, args ?? new InstantSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstantSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:InstantSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
