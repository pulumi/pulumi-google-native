...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:Interconnect")]
    public partial class Interconnect : Pulumi.CustomResource
    {
        ...
        public Interconnect(string name, InterconnectArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:Interconnect", name, args ?? new InterconnectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Interconnect(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:Interconnect", name, null, MakeResourceOptions(options, id))
        {
        }
