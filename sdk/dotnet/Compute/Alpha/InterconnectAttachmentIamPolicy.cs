...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:InterconnectAttachmentIamPolicy")]
    public partial class InterconnectAttachmentIamPolicy : Pulumi.CustomResource
    {
        ...
        public InterconnectAttachmentIamPolicy(string name, InterconnectAttachmentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:InterconnectAttachmentIamPolicy", name, args ?? new InterconnectAttachmentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InterconnectAttachmentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:InterconnectAttachmentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
