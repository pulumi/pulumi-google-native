...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:InterconnectIamPolicy")]
    public partial class InterconnectIamPolicy : Pulumi.CustomResource
    {
        ...
        public InterconnectIamPolicy(string name, InterconnectIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:InterconnectIamPolicy", name, args ?? new InterconnectIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InterconnectIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:InterconnectIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InterconnectIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
