...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    public partial class LicenseCodeIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LicenseCodeIamPolicy(string name, LicenseCodeIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:LicenseCodeIamPolicy", name, args ?? new LicenseCodeIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseCodeIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:LicenseCodeIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LicenseCodeIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new LicenseCodeIamPolicy(name, id, options);
        }
    }

    public sealed class LicenseCodeIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new LicenseCodeIamPolicyArgs Empty => new LicenseCodeIamPolicyArgs();
    }
}
