...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:LicenseIamPolicy")]
    public partial class LicenseIamPolicy : Pulumi.CustomResource
    {
        ...
        public LicenseIamPolicy(string name, LicenseIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:LicenseIamPolicy", name, args ?? new LicenseIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:LicenseIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
