...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:LicenseIamPolicy")]
    public partial class LicenseIamPolicy : Pulumi.CustomResource
    {
        ...
        public LicenseIamPolicy(string name, LicenseIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:LicenseIamPolicy", name, args ?? new LicenseIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:LicenseIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
