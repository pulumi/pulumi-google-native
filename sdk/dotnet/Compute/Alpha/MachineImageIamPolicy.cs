...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:MachineImageIamPolicy")]
    public partial class MachineImageIamPolicy : Pulumi.CustomResource
    {
        ...
        public MachineImageIamPolicy(string name, MachineImageIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:MachineImageIamPolicy", name, args ?? new MachineImageIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineImageIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:MachineImageIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
