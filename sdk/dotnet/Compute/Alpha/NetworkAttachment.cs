...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:NetworkAttachment")]
    public partial class NetworkAttachment : global::Pulumi.CustomResource
    {
        ...
        public NetworkAttachment(string name, NetworkAttachmentArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:NetworkAttachment", name, args ?? new NetworkAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:NetworkAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkAttachmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Alpha.NetworkAttachmentConnectionPreference>? ConnectionPreference { get; set; }
