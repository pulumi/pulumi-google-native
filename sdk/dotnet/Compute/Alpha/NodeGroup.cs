...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:NodeGroup")]
    public partial class NodeGroup : Pulumi.CustomResource
    {
        ...
        public NodeGroup(string name, NodeGroupArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:NodeGroup", name, args ?? new NodeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:NodeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
