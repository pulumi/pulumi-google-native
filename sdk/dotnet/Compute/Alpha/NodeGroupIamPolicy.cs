...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:NodeGroupIamPolicy")]
    public partial class NodeGroupIamPolicy : Pulumi.CustomResource
    {
        ...
        public NodeGroupIamPolicy(string name, NodeGroupIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:NodeGroupIamPolicy", name, args ?? new NodeGroupIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeGroupIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:NodeGroupIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
