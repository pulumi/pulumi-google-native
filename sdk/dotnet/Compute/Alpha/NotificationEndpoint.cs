...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:NotificationEndpoint")]
    public partial class NotificationEndpoint : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public NotificationEndpoint(string name, NotificationEndpointArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:NotificationEndpoint", name, args ?? new NotificationEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:NotificationEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NotificationEndpoint Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NotificationEndpoint(name, id, options);
        }
    }
