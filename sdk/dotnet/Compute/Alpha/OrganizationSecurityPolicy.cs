...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:OrganizationSecurityPolicy")]
    public partial class OrganizationSecurityPolicy : Pulumi.CustomResource
    {
        ...
        public OrganizationSecurityPolicy(string name, OrganizationSecurityPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:OrganizationSecurityPolicy", name, args ?? new OrganizationSecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationSecurityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:OrganizationSecurityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
