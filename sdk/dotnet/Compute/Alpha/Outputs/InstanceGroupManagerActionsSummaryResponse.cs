...
namespace Pulumi.GoogleNative.Compute.Alpha.Outputs
{
    ...
    public sealed class InstanceGroupManagerActionsSummaryResponse
    {
        ...
        /// <summary>
        /// The number of instances that the managed instance group will attempt to create in bulk. If the desired count of instances cannot be created, entire batch will be deleted and the group will decrease its targetSize value accordingly.
        /// </summary>
        public readonly int CreatingInBulk;
        /// <summary>
