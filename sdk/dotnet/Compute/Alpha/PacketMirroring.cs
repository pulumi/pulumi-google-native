...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:PacketMirroring")]
    public partial class PacketMirroring : Pulumi.CustomResource
    {
        ...
        public PacketMirroring(string name, PacketMirroringArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:PacketMirroring", name, args ?? new PacketMirroringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketMirroring(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:PacketMirroring", name, null, MakeResourceOptions(options, id))
        {
        }
