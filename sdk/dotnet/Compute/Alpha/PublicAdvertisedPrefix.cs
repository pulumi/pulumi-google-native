...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:PublicAdvertisedPrefix")]
    public partial class PublicAdvertisedPrefix : Pulumi.CustomResource
    {
        ...
        public PublicAdvertisedPrefix(string name, PublicAdvertisedPrefixArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:PublicAdvertisedPrefix", name, args ?? new PublicAdvertisedPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicAdvertisedPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:PublicAdvertisedPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicAdvertisedPrefixArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.PublicAdvertisedPrefixPublicDelegatedPrefixArgs> PublicDelegatedPrefixs
        {
            get => _publicDelegatedPrefixs ?? (_publicDelegatedPrefixs = new InputList<Inputs.PublicAdvertisedPrefixPublicDelegatedPrefixArgs>());
