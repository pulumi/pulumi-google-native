...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:PublicDelegatedPrefix")]
    public partial class PublicDelegatedPrefix : global::Pulumi.CustomResource
    {
        ...
        public PublicDelegatedPrefix(string name, PublicDelegatedPrefixArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:PublicDelegatedPrefix", name, args ?? new PublicDelegatedPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicDelegatedPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:PublicDelegatedPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PublicDelegatedPrefixArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.PublicDelegatedPrefixMode>? Mode { get; set; }
