...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:RegionAutoscaler")]
    public partial class RegionAutoscaler : Pulumi.CustomResource
    {
        ...
        public RegionAutoscaler(string name, RegionAutoscalerArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionAutoscaler", name, args ?? new RegionAutoscalerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionAutoscaler(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionAutoscaler", name, null, MakeResourceOptions(options, id))
        {
        }
