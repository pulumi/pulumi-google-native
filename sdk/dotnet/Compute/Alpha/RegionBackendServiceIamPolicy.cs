...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:RegionBackendServiceIamPolicy")]
    public partial class RegionBackendServiceIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionBackendServiceIamPolicy(string name, RegionBackendServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionBackendServiceIamPolicy", name, args ?? new RegionBackendServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionBackendServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionBackendServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionBackendServiceIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
