...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    public partial class RegionDisk : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.DiskAsyncReplicationListResponse> AsyncSecondaryDisks { get; private set; } = null!;
        ...
        public RegionDisk(string name, RegionDiskArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionDisk", name, args ?? new RegionDiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionDisk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionDisk", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("architecture")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.RegionDiskArchitecture>? Architecture { get; set; }
        ...
        /// </summary>
        [Input("interface")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.RegionDiskInterface>? Interface { get; set; }
        ...
        /// </summary>
        [Input("storageType")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.RegionDiskStorageType>? StorageType { get; set; }
