...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:RegionDisk")]
    public partial class RegionDisk : Pulumi.CustomResource
    {
        ...
        public RegionDisk(string name, RegionDiskArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionDisk", name, args ?? new RegionDiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionDisk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionDisk", name, null, MakeResourceOptions(options, id))
        {
        }
