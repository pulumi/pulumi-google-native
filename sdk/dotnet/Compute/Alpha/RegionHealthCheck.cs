...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:RegionHealthCheck")]
    public partial class RegionHealthCheck : Pulumi.CustomResource
    {
        ...
        public RegionHealthCheck(string name, RegionHealthCheckArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionHealthCheck", name, args ?? new RegionHealthCheckArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionHealthCheck(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionHealthCheck", name, null, MakeResourceOptions(options, id))
        {
        }
