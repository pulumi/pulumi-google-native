...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:RegionHealthCheck")]
    public partial class RegionHealthCheck : Pulumi.CustomResource
    {
        ...
        public RegionHealthCheck(string name, RegionHealthCheckArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionHealthCheck", name, args ?? new RegionHealthCheckArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionHealthCheck(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionHealthCheck", name, null, MakeResourceOptions(options, id))
        {
        }
