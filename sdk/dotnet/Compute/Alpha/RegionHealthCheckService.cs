...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:RegionHealthCheckService")]
    public partial class RegionHealthCheckService : Pulumi.CustomResource
    {
        ...
        public RegionHealthCheckService(string name, RegionHealthCheckServiceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionHealthCheckService", name, args ?? new RegionHealthCheckServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionHealthCheckService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionHealthCheckService", name, null, MakeResourceOptions(options, id))
        {
        }
