...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:RegionInPlaceSnapshotIamPolicy")]
    public partial class RegionInPlaceSnapshotIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionInPlaceSnapshotIamPolicy(string name, RegionInPlaceSnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionInPlaceSnapshotIamPolicy", name, args ?? new RegionInPlaceSnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionInPlaceSnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionInPlaceSnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
