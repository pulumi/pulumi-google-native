...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:RegionInPlaceSnapshotIamPolicy")]
    public partial class RegionInPlaceSnapshotIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionInPlaceSnapshotIamPolicy(string name, RegionInPlaceSnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionInPlaceSnapshotIamPolicy", name, args ?? new RegionInPlaceSnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionInPlaceSnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionInPlaceSnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
