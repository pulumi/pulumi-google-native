...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    public partial class RegionInstanceGroupManager : global::Pulumi.CustomResource
    {
        ...
        public RegionInstanceGroupManager(string name, RegionInstanceGroupManagerArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionInstanceGroupManager", name, args ?? new RegionInstanceGroupManagerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionInstanceGroupManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionInstanceGroupManager", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionInstanceGroupManagerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Alpha.RegionInstanceGroupManagerListManagedInstancesResults>? ListManagedInstancesResults { get; set; }
