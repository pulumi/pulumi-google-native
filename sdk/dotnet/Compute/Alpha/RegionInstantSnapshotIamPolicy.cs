...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:RegionInstantSnapshotIamPolicy")]
    public partial class RegionInstantSnapshotIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionInstantSnapshotIamPolicy(string name, RegionInstantSnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionInstantSnapshotIamPolicy", name, args ?? new RegionInstantSnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionInstantSnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionInstantSnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
