...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:RegionNetworkEndpointGroup")]
    public partial class RegionNetworkEndpointGroup : Pulumi.CustomResource
    {
        ...
        public RegionNetworkEndpointGroup(string name, RegionNetworkEndpointGroupArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionNetworkEndpointGroup", name, args ?? new RegionNetworkEndpointGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkEndpointGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionNetworkEndpointGroup", name, null, MakeResourceOptions(options, id))
        {
        }
