...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:RegionNetworkFirewallPolicy")]
    public partial class RegionNetworkFirewallPolicy : Pulumi.CustomResource
    {
        ...
        public RegionNetworkFirewallPolicy(string name, RegionNetworkFirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionNetworkFirewallPolicy", name, args ?? new RegionNetworkFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkFirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionNetworkFirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
