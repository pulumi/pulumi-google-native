...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:RegionNetworkFirewallPolicyIamPolicy")]
    public partial class RegionNetworkFirewallPolicyIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionNetworkFirewallPolicyIamPolicy(string name, RegionNetworkFirewallPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionNetworkFirewallPolicyIamPolicy", name, args ?? new RegionNetworkFirewallPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkFirewallPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:RegionNetworkFirewallPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
