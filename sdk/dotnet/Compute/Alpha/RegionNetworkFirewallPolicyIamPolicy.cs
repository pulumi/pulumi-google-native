...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:RegionNetworkFirewallPolicyIamPolicy")]
    public partial class RegionNetworkFirewallPolicyIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionNetworkFirewallPolicyIamPolicy(string name, RegionNetworkFirewallPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionNetworkFirewallPolicyIamPolicy", name, args ?? new RegionNetworkFirewallPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkFirewallPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionNetworkFirewallPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
