...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:RegionSnapshot")]
    public partial class RegionSnapshot : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a RegionSnapshot resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public RegionSnapshot(string name, RegionSnapshotArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionSnapshot", name, args ?? new RegionSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing RegionSnapshot resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionSnapshot Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RegionSnapshot(name, id, options);
        }
    }

    public sealed class RegionSnapshotArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Creates the new snapshot in the snapshot chain labeled with the specified name. The chain name must be 1-63 characters long and comply with RFC1035. This is an uncommon option only for advanced service owners who needs to create separate snapshot chains, for example, for chargeback tracking. When you describe your snapshot resource, this field is visible only if it has a non-empty value.
        /// </summary>
        ...
        /// </summary>
        [Input("snapshotType")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.RegionSnapshotSnapshotType>? SnapshotType { get; set; }
        ...
        public RegionSnapshotArgs()
        {
        }
        public static new RegionSnapshotArgs Empty => new RegionSnapshotArgs();
    }
}
