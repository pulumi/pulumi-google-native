...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:RegionSslCertificate")]
    public partial class RegionSslCertificate : Pulumi.CustomResource
    {
        ...
        public RegionSslCertificate(string name, RegionSslCertificateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionSslCertificate", name, args ?? new RegionSslCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionSslCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionSslCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
