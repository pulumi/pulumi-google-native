...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    public partial class RegionSslPolicy : global::Pulumi.CustomResource
    {
        ...
        public RegionSslPolicy(string name, RegionSslPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionSslPolicy", name, args ?? new RegionSslPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionSslPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:RegionSslPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionSslPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("minTlsVersion")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.RegionSslPolicyMinTlsVersion>? MinTlsVersion { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.RegionSslPolicyProfile>? Profile { get; set; }
