...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:RegionUrlMap")]
    public partial class RegionUrlMap : Pulumi.CustomResource
    {
        ...
        public RegionUrlMap(string name, RegionUrlMapArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionUrlMap", name, args ?? new RegionUrlMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionUrlMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:RegionUrlMap", name, null, MakeResourceOptions(options, id))
        {
        }
