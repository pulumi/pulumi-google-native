...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:ReservationIamPolicy")]
    public partial class ReservationIamPolicy : Pulumi.CustomResource
    {
        ...
        public ReservationIamPolicy(string name, ReservationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ReservationIamPolicy", name, args ?? new ReservationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReservationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ReservationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
