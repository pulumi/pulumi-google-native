...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("google-native:compute/alpha:ResourcePolicyIamPolicy")]
    public partial class ResourcePolicyIamPolicy : Pulumi.CustomResource
    {
        ...
        public ResourcePolicyIamPolicy(string name, ResourcePolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ResourcePolicyIamPolicy", name, args ?? new ResourcePolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourcePolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ResourcePolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
