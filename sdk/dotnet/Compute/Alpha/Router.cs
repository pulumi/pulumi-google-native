...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:Router")]
    public partial class Router : Pulumi.CustomResource
    {
        ...
        public Router(string name, RouterArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:Router", name, args ?? new RouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Router(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:Router", name, null, MakeResourceOptions(options, id))
        {
        }
