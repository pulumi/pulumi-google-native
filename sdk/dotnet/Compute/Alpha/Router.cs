...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:Router")]
    public partial class Router : global::Pulumi.CustomResource
    {
        ...
        public Router(string name, RouterArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:Router", name, args ?? new RouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Router(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:Router", name, null, MakeResourceOptions(options, id))
        {
        }
