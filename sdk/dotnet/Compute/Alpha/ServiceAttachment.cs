...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:ServiceAttachment")]
    public partial class ServiceAttachment : Pulumi.CustomResource
    {
        ...
        public ServiceAttachment(string name, ServiceAttachmentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ServiceAttachment", name, args ?? new ServiceAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ServiceAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
