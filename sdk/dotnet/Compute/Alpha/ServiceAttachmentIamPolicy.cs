...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:ServiceAttachmentIamPolicy")]
    public partial class ServiceAttachmentIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceAttachmentIamPolicy(string name, ServiceAttachmentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ServiceAttachmentIamPolicy", name, args ?? new ServiceAttachmentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceAttachmentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ServiceAttachmentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceAttachmentIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ServiceAttachmentIamPolicy(name, id, options);
        }
    }

    public sealed class ServiceAttachmentIamPolicyArgs : Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public ServiceAttachmentIamPolicyArgs()
        {
        }
    }
}
