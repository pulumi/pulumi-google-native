...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:SslCertificate")]
    public partial class SslCertificate : Pulumi.CustomResource
    {
        ...
        public SslCertificate(string name, SslCertificateArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:SslCertificate", name, args ?? new SslCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SslCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:SslCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SslCertificateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.SslCertificateType>? Type { get; set; }
