...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:SubnetworkIamPolicy")]
    public partial class SubnetworkIamPolicy : Pulumi.CustomResource
    {
        ...
        public SubnetworkIamPolicy(string name, SubnetworkIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:SubnetworkIamPolicy", name, args ?? new SubnetworkIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubnetworkIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:SubnetworkIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
