...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:SubnetworkIamPolicy")]
    public partial class SubnetworkIamPolicy : Pulumi.CustomResource
    {
        ...
        public SubnetworkIamPolicy(string name, SubnetworkIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:SubnetworkIamPolicy", name, args ?? new SubnetworkIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubnetworkIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:SubnetworkIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
