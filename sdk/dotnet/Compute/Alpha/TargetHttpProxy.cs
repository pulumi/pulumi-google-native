...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:TargetHttpProxy")]
    public partial class TargetHttpProxy : Pulumi.CustomResource
    {
        ...
        public TargetHttpProxy(string name, TargetHttpProxyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:TargetHttpProxy", name, args ?? new TargetHttpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetHttpProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:TargetHttpProxy", name, null, MakeResourceOptions(options, id))
        {
        }
