...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:TargetTcpProxy")]
    public partial class TargetTcpProxy : Pulumi.CustomResource
    {
        ...
        public TargetTcpProxy(string name, TargetTcpProxyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:TargetTcpProxy", name, args ?? new TargetTcpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetTcpProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:TargetTcpProxy", name, null, MakeResourceOptions(options, id))
        {
        }
