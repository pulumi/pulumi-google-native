...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:VpnTunnel")]
    public partial class VpnTunnel : Pulumi.CustomResource
    {
        ...
        public VpnTunnel(string name, VpnTunnelArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:VpnTunnel", name, args ?? new VpnTunnelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnTunnel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:VpnTunnel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VpnTunnelArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.GoogleNative.Compute.Alpha.VpnTunnelStatus>? Status { get; set; }
