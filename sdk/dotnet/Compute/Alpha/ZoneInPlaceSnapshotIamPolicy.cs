...
namespace Pulumi.GoogleNative.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/alpha:ZoneInPlaceSnapshotIamPolicy")]
    public partial class ZoneInPlaceSnapshotIamPolicy : Pulumi.CustomResource
    {
        ...
        public ZoneInPlaceSnapshotIamPolicy(string name, ZoneInPlaceSnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ZoneInPlaceSnapshotIamPolicy", name, args ?? new ZoneInPlaceSnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZoneInPlaceSnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/alpha:ZoneInPlaceSnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ZoneInPlaceSnapshotIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ZoneInPlaceSnapshotIamPolicy(name, id, options);
        }
    }

    public sealed class ZoneInPlaceSnapshotIamPolicyArgs : Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public ZoneInPlaceSnapshotIamPolicyArgs()
        {
        }
    }
}
