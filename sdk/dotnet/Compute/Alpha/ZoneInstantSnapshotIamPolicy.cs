...
namespace Pulumi.GcpNative.Compute.Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/alpha:ZoneInstantSnapshotIamPolicy")]
    public partial class ZoneInstantSnapshotIamPolicy : Pulumi.CustomResource
    {
        ...
        public ZoneInstantSnapshotIamPolicy(string name, ZoneInstantSnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:ZoneInstantSnapshotIamPolicy", name, args ?? new ZoneInstantSnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZoneInstantSnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/alpha:ZoneInstantSnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
