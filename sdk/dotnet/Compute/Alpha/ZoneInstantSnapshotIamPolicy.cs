...
namespace Pulumi.GoogleCloud.Compute.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/alpha:ZoneInstantSnapshotIamPolicy")]
    public partial class ZoneInstantSnapshotIamPolicy : Pulumi.CustomResource
    {
        ...
        public ZoneInstantSnapshotIamPolicy(string name, ZoneInstantSnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ZoneInstantSnapshotIamPolicy", name, args ?? new ZoneInstantSnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZoneInstantSnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/alpha:ZoneInstantSnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
