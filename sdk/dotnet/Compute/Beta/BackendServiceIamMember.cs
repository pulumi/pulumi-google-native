...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:BackendServiceIamMember")]
    public partial class BackendServiceIamMember : global::Pulumi.CustomResource
    {
        ...
        public BackendServiceIamMember(string name, BackendServiceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:BackendServiceIamMember", name, args ?? new BackendServiceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendServiceIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:BackendServiceIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
