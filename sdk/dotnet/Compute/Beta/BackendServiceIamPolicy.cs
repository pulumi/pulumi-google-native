...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:BackendServiceIamPolicy")]
    public partial class BackendServiceIamPolicy : Pulumi.CustomResource
    {
        ...
        public BackendServiceIamPolicy(string name, BackendServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:BackendServiceIamPolicy", name, args ?? new BackendServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:BackendServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
