...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:DiskIamPolicy")]
    public partial class DiskIamPolicy : Pulumi.CustomResource
    {
        ...
        public DiskIamPolicy(string name, DiskIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:DiskIamPolicy", name, args ?? new DiskIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:DiskIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
