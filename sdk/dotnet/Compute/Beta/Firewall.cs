...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:Firewall")]
    public partial class Firewall : Pulumi.CustomResource
    {
        ...
        public Firewall(string name, FirewallArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:Firewall", name, args ?? new FirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Firewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:Firewall", name, null, MakeResourceOptions(options, id))
        {
        }
