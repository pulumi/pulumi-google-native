...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:FirewallPolicy")]
    public partial class FirewallPolicy : Pulumi.CustomResource
    {
        ...
        private FirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:FirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
