...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:FirewallPolicyIamPolicy")]
    public partial class FirewallPolicyIamPolicy : Pulumi.CustomResource
    {
        ...
        public FirewallPolicyIamPolicy(string name, FirewallPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:FirewallPolicyIamPolicy", name, args ?? new FirewallPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:FirewallPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
