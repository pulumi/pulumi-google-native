...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:FutureReservation")]
    public partial class FutureReservation : global::Pulumi.CustomResource
    {
        ...
        public FutureReservation(string name, FutureReservationArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:FutureReservation", name, args ?? new FutureReservationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FutureReservation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:FutureReservation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FutureReservationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.FutureReservationPlanningStatus>? PlanningStatus { get; set; }
