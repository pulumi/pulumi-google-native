...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetAddress
    {
        ...
        public static Task<GetAddressResult> InvokeAsync(GetAddressArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAddressResult>("google-native:compute/beta:getAddress", args ?? new GetAddressArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified address resource.
        /// </summary>
        public static Output<GetAddressResult> Invoke(GetAddressInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAddressResult>("google-native:compute/beta:getAddress", args ?? new GetAddressInvokeArgs(), options.WithVersion());
    }
