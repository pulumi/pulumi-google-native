...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetBackendService
    {
        ...
        public static Task<GetBackendServiceResult> InvokeAsync(GetBackendServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackendServiceResult>("google-native:compute/beta:getBackendService", args ?? new GetBackendServiceArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified BackendService resource. Gets a list of available backend services.
        /// </summary>
        public static Output<GetBackendServiceResult> Invoke(GetBackendServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackendServiceResult>("google-native:compute/beta:getBackendService", args ?? new GetBackendServiceInvokeArgs(), options.WithVersion());
    }
