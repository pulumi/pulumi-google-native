...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetBackendServiceIamPolicy
    {
        ...
        public static Task<GetBackendServiceIamPolicyResult> InvokeAsync(GetBackendServiceIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackendServiceIamPolicyResult>("google-native:compute/beta:getBackendServiceIamPolicy", args ?? new GetBackendServiceIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetBackendServiceIamPolicyResult> Invoke(GetBackendServiceIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackendServiceIamPolicyResult>("google-native:compute/beta:getBackendServiceIamPolicy", args ?? new GetBackendServiceIamPolicyInvokeArgs(), options.WithDefaults());
    }
