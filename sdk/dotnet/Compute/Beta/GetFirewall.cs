...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetFirewall
    {
        ...
        public static Task<GetFirewallResult> InvokeAsync(GetFirewallArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallResult>("google-native:compute/beta:getFirewall", args ?? new GetFirewallArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified firewall.
        /// </summary>
        public static Output<GetFirewallResult> Invoke(GetFirewallInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFirewallResult>("google-native:compute/beta:getFirewall", args ?? new GetFirewallInvokeArgs(), options.WithVersion());
    }
