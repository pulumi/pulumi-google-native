...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetForwardingRule
    {
        ...
        public static Task<GetForwardingRuleResult> InvokeAsync(GetForwardingRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetForwardingRuleResult>("google-native:compute/beta:getForwardingRule", args ?? new GetForwardingRuleArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified ForwardingRule resource.
        /// </summary>
        public static Output<GetForwardingRuleResult> Invoke(GetForwardingRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetForwardingRuleResult>("google-native:compute/beta:getForwardingRule", args ?? new GetForwardingRuleInvokeArgs(), options.WithVersion());
    }
