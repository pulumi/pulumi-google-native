...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetGlobalNetworkEndpointGroup
    {
        ...
        public static Task<GetGlobalNetworkEndpointGroupResult> InvokeAsync(GetGlobalNetworkEndpointGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGlobalNetworkEndpointGroupResult>("google-native:compute/beta:getGlobalNetworkEndpointGroup", args ?? new GetGlobalNetworkEndpointGroupArgs(), options.WithVersion());
        ...
        public static Output<GetGlobalNetworkEndpointGroupResult> Invoke(GetGlobalNetworkEndpointGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGlobalNetworkEndpointGroupResult>("google-native:compute/beta:getGlobalNetworkEndpointGroup", args ?? new GetGlobalNetworkEndpointGroupInvokeArgs(), options.WithVersion());
    }


    public sealed class GetGlobalNetworkEndpointGroupArgs : Pulumi.InvokeArgs
    {
    ...
    public sealed class GetGlobalNetworkEndpointGroupInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("networkEndpointGroup", required: true)]
