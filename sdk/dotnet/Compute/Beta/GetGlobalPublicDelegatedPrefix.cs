...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetGlobalPublicDelegatedPrefix
    {
        ...
        public static Task<GetGlobalPublicDelegatedPrefixResult> InvokeAsync(GetGlobalPublicDelegatedPrefixArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGlobalPublicDelegatedPrefixResult>("google-native:compute/beta:getGlobalPublicDelegatedPrefix", args ?? new GetGlobalPublicDelegatedPrefixArgs(), options.WithDefaults());
        ...
        public static Output<GetGlobalPublicDelegatedPrefixResult> Invoke(GetGlobalPublicDelegatedPrefixInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGlobalPublicDelegatedPrefixResult>("google-native:compute/beta:getGlobalPublicDelegatedPrefix", args ?? new GetGlobalPublicDelegatedPrefixInvokeArgs(), options.WithDefaults());
    }
