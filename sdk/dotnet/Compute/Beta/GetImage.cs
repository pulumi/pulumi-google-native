...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetImage
    {
        ...
        public static Task<GetImageResult> InvokeAsync(GetImageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetImageResult>("google-native:compute/beta:getImage", args ?? new GetImageArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified image. Gets a list of available images by making a list() request.
        /// </summary>
        public static Output<GetImageResult> Invoke(GetImageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetImageResult>("google-native:compute/beta:getImage", args ?? new GetImageInvokeArgs(), options.WithVersion());
    }
