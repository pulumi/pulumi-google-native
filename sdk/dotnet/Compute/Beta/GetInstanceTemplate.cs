...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetInstanceTemplate
    {
        ...
        public static Task<GetInstanceTemplateResult> InvokeAsync(GetInstanceTemplateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInstanceTemplateResult>("google-native:compute/beta:getInstanceTemplate", args ?? new GetInstanceTemplateArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified instance template.
        /// </summary>
        public static Output<GetInstanceTemplateResult> Invoke(GetInstanceTemplateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInstanceTemplateResult>("google-native:compute/beta:getInstanceTemplate", args ?? new GetInstanceTemplateInvokeArgs(), options.WithDefaults());
    }
