...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetNodeTemplate
    {
        ...
        public static Task<GetNodeTemplateResult> InvokeAsync(GetNodeTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNodeTemplateResult>("google-native:compute/beta:getNodeTemplate", args ?? new GetNodeTemplateArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified node template. Gets a list of available node templates by making a list() request.
        /// </summary>
        public static Output<GetNodeTemplateResult> Invoke(GetNodeTemplateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNodeTemplateResult>("google-native:compute/beta:getNodeTemplate", args ?? new GetNodeTemplateInvokeArgs(), options.WithVersion());
    }
