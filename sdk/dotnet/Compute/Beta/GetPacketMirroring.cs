...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetPacketMirroring
    {
        ...
        public static Task<GetPacketMirroringResult> InvokeAsync(GetPacketMirroringArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPacketMirroringResult>("google-native:compute/beta:getPacketMirroring", args ?? new GetPacketMirroringArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified PacketMirroring resource.
        /// </summary>
        public static Output<GetPacketMirroringResult> Invoke(GetPacketMirroringInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPacketMirroringResult>("google-native:compute/beta:getPacketMirroring", args ?? new GetPacketMirroringInvokeArgs(), options.WithDefaults());
    }
