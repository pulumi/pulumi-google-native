...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetRegionCommitment
    {
        ...
        public static Task<GetRegionCommitmentResult> InvokeAsync(GetRegionCommitmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionCommitmentResult>("google-native:compute/beta:getRegionCommitment", args ?? new GetRegionCommitmentArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified commitment resource. Gets a list of available commitments by making a list() request.
        /// </summary>
        public static Output<GetRegionCommitmentResult> Invoke(GetRegionCommitmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionCommitmentResult>("google-native:compute/beta:getRegionCommitment", args ?? new GetRegionCommitmentInvokeArgs(), options.WithVersion());
    }
