...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetRegionNetworkFirewallPolicy
    {
        ...
        public static Task<GetRegionNetworkFirewallPolicyResult> InvokeAsync(GetRegionNetworkFirewallPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionNetworkFirewallPolicyResult>("google-native:compute/beta:getRegionNetworkFirewallPolicy", args ?? new GetRegionNetworkFirewallPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetRegionNetworkFirewallPolicyResult> Invoke(GetRegionNetworkFirewallPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionNetworkFirewallPolicyResult>("google-native:compute/beta:getRegionNetworkFirewallPolicy", args ?? new GetRegionNetworkFirewallPolicyInvokeArgs(), options.WithDefaults());
    }
