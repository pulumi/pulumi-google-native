...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetRegionNetworkFirewallPolicyIamPolicy
    {
        ...
        public static Task<GetRegionNetworkFirewallPolicyIamPolicyResult> InvokeAsync(GetRegionNetworkFirewallPolicyIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionNetworkFirewallPolicyIamPolicyResult>("google-native:compute/beta:getRegionNetworkFirewallPolicyIamPolicy", args ?? new GetRegionNetworkFirewallPolicyIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetRegionNetworkFirewallPolicyIamPolicyResult> Invoke(GetRegionNetworkFirewallPolicyIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionNetworkFirewallPolicyIamPolicyResult>("google-native:compute/beta:getRegionNetworkFirewallPolicyIamPolicy", args ?? new GetRegionNetworkFirewallPolicyIamPolicyInvokeArgs(), options.WithDefaults());
    }
