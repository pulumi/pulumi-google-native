...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetRegionSslPolicy
    {
        ...
        public static Task<GetRegionSslPolicyResult> InvokeAsync(GetRegionSslPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegionSslPolicyResult>("google-native:compute/beta:getRegionSslPolicy", args ?? new GetRegionSslPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Lists all of the ordered rules present in a single specified policy.
        /// </summary>
        public static Output<GetRegionSslPolicyResult> Invoke(GetRegionSslPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegionSslPolicyResult>("google-native:compute/beta:getRegionSslPolicy", args ?? new GetRegionSslPolicyInvokeArgs(), options.WithDefaults());
    }
