...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetReservationIamPolicy
    {
        ...
        public static Task<GetReservationIamPolicyResult> InvokeAsync(GetReservationIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReservationIamPolicyResult>("google-native:compute/beta:getReservationIamPolicy", args ?? new GetReservationIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetReservationIamPolicyResult> Invoke(GetReservationIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReservationIamPolicyResult>("google-native:compute/beta:getReservationIamPolicy", args ?? new GetReservationIamPolicyInvokeArgs(), options.WithVersion());
    }
