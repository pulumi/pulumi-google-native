...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetServiceAttachment
    {
        ...
        public static Task<GetServiceAttachmentResult> InvokeAsync(GetServiceAttachmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServiceAttachmentResult>("google-native:compute/beta:getServiceAttachment", args ?? new GetServiceAttachmentArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified ServiceAttachment resource in the given scope.
        /// </summary>
        public static Output<GetServiceAttachmentResult> Invoke(GetServiceAttachmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServiceAttachmentResult>("google-native:compute/beta:getServiceAttachment", args ?? new GetServiceAttachmentInvokeArgs(), options.WithDefaults());
    }
