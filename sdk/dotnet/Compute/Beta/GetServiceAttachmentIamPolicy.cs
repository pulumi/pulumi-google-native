...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetServiceAttachmentIamPolicy
    {
        ...
        public static Task<GetServiceAttachmentIamPolicyResult> InvokeAsync(GetServiceAttachmentIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceAttachmentIamPolicyResult>("google-native:compute/beta:getServiceAttachmentIamPolicy", args ?? new GetServiceAttachmentIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetServiceAttachmentIamPolicyResult> Invoke(GetServiceAttachmentIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceAttachmentIamPolicyResult>("google-native:compute/beta:getServiceAttachmentIamPolicy", args ?? new GetServiceAttachmentIamPolicyInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetServiceAttachmentIamPolicyArgs : Pulumi.InvokeArgs
    {
    ...
    public sealed class GetServiceAttachmentIamPolicyInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("optionsRequestedPolicyVersion")]
