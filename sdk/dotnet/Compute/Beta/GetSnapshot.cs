...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetSnapshot
    {
        ...
        public static Task<GetSnapshotResult> InvokeAsync(GetSnapshotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotResult>("google-native:compute/beta:getSnapshot", args ?? new GetSnapshotArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified Snapshot resource. Gets a list of available snapshots by making a list() request.
        /// </summary>
        public static Output<GetSnapshotResult> Invoke(GetSnapshotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSnapshotResult>("google-native:compute/beta:getSnapshot", args ?? new GetSnapshotInvokeArgs(), options.WithVersion());
    }
