...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetSslPolicy
    {
        ...
        public static Task<GetSslPolicyResult> InvokeAsync(GetSslPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSslPolicyResult>("google-native:compute/beta:getSslPolicy", args ?? new GetSslPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Lists all of the ordered rules present in a single specified policy.
        /// </summary>
        public static Output<GetSslPolicyResult> Invoke(GetSslPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSslPolicyResult>("google-native:compute/beta:getSslPolicy", args ?? new GetSslPolicyInvokeArgs(), options.WithVersion());
    }
