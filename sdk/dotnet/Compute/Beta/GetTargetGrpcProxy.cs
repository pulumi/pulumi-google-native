...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetTargetGrpcProxy
    {
        ...
        public static Task<GetTargetGrpcProxyResult> InvokeAsync(GetTargetGrpcProxyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTargetGrpcProxyResult>("google-native:compute/beta:getTargetGrpcProxy", args ?? new GetTargetGrpcProxyArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified TargetGrpcProxy resource in the given scope.
        /// </summary>
        public static Output<GetTargetGrpcProxyResult> Invoke(GetTargetGrpcProxyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTargetGrpcProxyResult>("google-native:compute/beta:getTargetGrpcProxy", args ?? new GetTargetGrpcProxyInvokeArgs(), options.WithDefaults());
    }
