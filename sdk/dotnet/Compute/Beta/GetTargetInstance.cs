...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetTargetInstance
    {
        ...
        public static Task<GetTargetInstanceResult> InvokeAsync(GetTargetInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTargetInstanceResult>("google-native:compute/beta:getTargetInstance", args ?? new GetTargetInstanceArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified TargetInstance resource. Gets a list of available target instances by making a list() request.
        /// </summary>
        public static Output<GetTargetInstanceResult> Invoke(GetTargetInstanceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTargetInstanceResult>("google-native:compute/beta:getTargetInstance", args ?? new GetTargetInstanceInvokeArgs(), options.WithVersion());
    }
