...
namespace Pulumi.GoogleNative.Compute.Beta
{
    public static class GetTargetTcpProxy
    {
        ...
        public static Task<GetTargetTcpProxyResult> InvokeAsync(GetTargetTcpProxyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTargetTcpProxyResult>("google-native:compute/beta:getTargetTcpProxy", args ?? new GetTargetTcpProxyArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified TargetTcpProxy resource. Gets a list of available target TCP proxies by making a list() request.
        /// </summary>
        public static Output<GetTargetTcpProxyResult> Invoke(GetTargetTcpProxyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTargetTcpProxyResult>("google-native:compute/beta:getTargetTcpProxy", args ?? new GetTargetTcpProxyInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetTargetTcpProxyArgs : global::Pulumi.InvokeArgs
    {
        [Input("project")]
        ...
        public static new GetTargetTcpProxyArgs Empty => new GetTargetTcpProxyArgs();
    }

    public sealed class GetTargetTcpProxyInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("project")]
        ...
        public static new GetTargetTcpProxyInvokeArgs Empty => new GetTargetTcpProxyInvokeArgs();
    }
