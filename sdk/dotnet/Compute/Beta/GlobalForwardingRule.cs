...
namespace Pulumi.GcpNative.Compute.Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/beta:GlobalForwardingRule")]
    public partial class GlobalForwardingRule : Pulumi.CustomResource
    {
        ...
        public GlobalForwardingRule(string name, GlobalForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:GlobalForwardingRule", name, args ?? new GlobalForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:GlobalForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
