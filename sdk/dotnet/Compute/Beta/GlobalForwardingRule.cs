...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:GlobalForwardingRule")]
    public partial class GlobalForwardingRule : Pulumi.CustomResource
    {
        ...
        public GlobalForwardingRule(string name, GlobalForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:GlobalForwardingRule", name, args ?? new GlobalForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:GlobalForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
