...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:GlobalNetworkEndpointGroup")]
    public partial class GlobalNetworkEndpointGroup : Pulumi.CustomResource
    {
        ...
        public GlobalNetworkEndpointGroup(string name, GlobalNetworkEndpointGroupArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:GlobalNetworkEndpointGroup", name, args ?? new GlobalNetworkEndpointGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalNetworkEndpointGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:GlobalNetworkEndpointGroup", name, null, MakeResourceOptions(options, id))
        {
        }
