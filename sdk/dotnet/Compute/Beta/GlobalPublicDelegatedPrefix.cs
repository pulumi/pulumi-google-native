...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:GlobalPublicDelegatedPrefix")]
    public partial class GlobalPublicDelegatedPrefix : Pulumi.CustomResource
    {
        ...
        public GlobalPublicDelegatedPrefix(string name, GlobalPublicDelegatedPrefixArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:GlobalPublicDelegatedPrefix", name, args ?? new GlobalPublicDelegatedPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalPublicDelegatedPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:GlobalPublicDelegatedPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GlobalPublicDelegatedPrefixArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.GoogleNative.Compute.Beta.GlobalPublicDelegatedPrefixStatus>? Status { get; set; }
