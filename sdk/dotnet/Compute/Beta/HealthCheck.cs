...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:HealthCheck")]
    public partial class HealthCheck : global::Pulumi.CustomResource
    {
        ...
        public HealthCheck(string name, HealthCheckArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:HealthCheck", name, args ?? new HealthCheckArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthCheck(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:HealthCheck", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HealthCheckArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.Compute.Beta.HealthCheckType>? Type { get; set; }
