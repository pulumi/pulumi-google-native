...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:HealthCheckService")]
    public partial class HealthCheckService : Pulumi.CustomResource
    {
        ...
        public HealthCheckService(string name, HealthCheckServiceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:HealthCheckService", name, args ?? new HealthCheckServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthCheckService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:HealthCheckService", name, null, MakeResourceOptions(options, id))
        {
        }
