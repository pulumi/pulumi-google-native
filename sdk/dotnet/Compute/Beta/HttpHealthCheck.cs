...
namespace Pulumi.GcpNative.Compute.Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/beta:HttpHealthCheck")]
    public partial class HttpHealthCheck : Pulumi.CustomResource
    {
        ...
        public HttpHealthCheck(string name, HttpHealthCheckArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:HttpHealthCheck", name, args ?? new HttpHealthCheckArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HttpHealthCheck(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:HttpHealthCheck", name, null, MakeResourceOptions(options, id))
        {
        }
