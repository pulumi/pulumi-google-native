...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:HttpsHealthCheck")]
    public partial class HttpsHealthCheck : Pulumi.CustomResource
    {
        ...
        public HttpsHealthCheck(string name, HttpsHealthCheckArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:HttpsHealthCheck", name, args ?? new HttpsHealthCheckArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HttpsHealthCheck(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:HttpsHealthCheck", name, null, MakeResourceOptions(options, id))
        {
        }
