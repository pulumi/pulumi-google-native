...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:ImageIamBinding")]
    public partial class ImageIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ImageIamBinding(string name, ImageIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:ImageIamBinding", name, args ?? new ImageIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:ImageIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
