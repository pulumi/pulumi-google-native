...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:ImageIamMember")]
    public partial class ImageIamMember : global::Pulumi.CustomResource
    {
        ...
        public ImageIamMember(string name, ImageIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:ImageIamMember", name, args ?? new ImageIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:ImageIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ImageIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ImageIamMember(name, id, options);
        }
    }
