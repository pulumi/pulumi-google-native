...
namespace Pulumi.GoogleNative.Compute.Beta.Inputs
{
    ...
    public sealed class RouterBgpArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("advertiseMode")]
        public Input<Pulumi.GoogleNative.Compute.Beta.RouterBgpAdvertiseMode>? AdvertiseMode { get; set; }

        [Input("advertisedGroups")]
        private InputList<Pulumi.GoogleNative.Compute.Beta.RouterBgpAdvertisedGroupsItem>? _advertisedGroups;

        /// <summary>
        /// User-specified list of prefix groups to advertise in custom mode. This field can only be populated if advertise_mode is CUSTOM and is advertised to all peers of the router. These groups will be advertised in addition to any specified prefixes. Leave this field blank to advertise no custom groups.
        /// </summary>
        public InputList<Pulumi.GoogleNative.Compute.Beta.RouterBgpAdvertisedGroupsItem> AdvertisedGroups
        {
            get => _advertisedGroups ?? (_advertisedGroups = new InputList<Pulumi.GoogleNative.Compute.Beta.RouterBgpAdvertisedGroupsItem>());
