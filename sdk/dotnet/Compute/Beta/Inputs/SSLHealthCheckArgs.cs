...
namespace Pulumi.GoogleNative.Compute.Beta.Inputs
{
    ...
    public sealed class SSLHealthCheckArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.SSLHealthCheckPortSpecification>? PortSpecification { get; set; }

        /// <summary>
        /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
        /// </summary>
        [Input("proxyHeader")]
        public Input<Pulumi.GoogleNative.Compute.Beta.SSLHealthCheckProxyHeader>? ProxyHeader { get; set; }
