...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:InstanceGroupManager")]
    public partial class InstanceGroupManager : Pulumi.CustomResource
    {
        ...
        private InstanceGroupManager(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:InstanceGroupManager", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InstanceGroupManagerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.InstanceGroupManagerFailoverAction>? FailoverAction { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.InstanceGroupManagerListManagedInstancesResults>? ListManagedInstancesResults { get; set; }
