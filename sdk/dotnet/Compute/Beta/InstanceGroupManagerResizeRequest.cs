...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:InstanceGroupManagerResizeRequest")]
    public partial class InstanceGroupManagerResizeRequest : global::Pulumi.CustomResource
    {
        ...
        public InstanceGroupManagerResizeRequest(string name, InstanceGroupManagerResizeRequestArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:InstanceGroupManagerResizeRequest", name, args ?? new InstanceGroupManagerResizeRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceGroupManagerResizeRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:InstanceGroupManagerResizeRequest", name, null, MakeResourceOptions(options, id))
        {
        }
