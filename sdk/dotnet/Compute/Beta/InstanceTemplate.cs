...
namespace Pulumi.GcpNative.Compute.Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/beta:InstanceTemplate")]
    public partial class InstanceTemplate : Pulumi.CustomResource
    {
        ...
        public InstanceTemplate(string name, InstanceTemplateArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:InstanceTemplate", name, args ?? new InstanceTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:InstanceTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
