...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:InstantSnapshot")]
    public partial class InstantSnapshot : global::Pulumi.CustomResource
    {
        ...
        public InstantSnapshot(string name, InstantSnapshotArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:InstantSnapshot", name, args ?? new InstantSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstantSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:InstantSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
