...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:InstantSnapshotIamPolicy")]
    public partial class InstantSnapshotIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public InstantSnapshotIamPolicy(string name, InstantSnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:InstantSnapshotIamPolicy", name, args ?? new InstantSnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstantSnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:InstantSnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
