...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:LicenseIamPolicy")]
    public partial class LicenseIamPolicy : Pulumi.CustomResource
    {
        ...
        public LicenseIamPolicy(string name, LicenseIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:LicenseIamPolicy", name, args ?? new LicenseIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:LicenseIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
