...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:NetworkEdgeSecurityService")]
    public partial class NetworkEdgeSecurityService : global::Pulumi.CustomResource
    {
        ...
        public NetworkEdgeSecurityService(string name, NetworkEdgeSecurityServiceArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:NetworkEdgeSecurityService", name, args ?? new NetworkEdgeSecurityServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkEdgeSecurityService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:NetworkEdgeSecurityService", name, null, MakeResourceOptions(options, id))
        {
        }
