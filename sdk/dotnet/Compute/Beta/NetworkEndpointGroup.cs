...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:NetworkEndpointGroup")]
    public partial class NetworkEndpointGroup : Pulumi.CustomResource
    {
        ...
        public NetworkEndpointGroup(string name, NetworkEndpointGroupArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:NetworkEndpointGroup", name, args ?? new NetworkEndpointGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkEndpointGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:NetworkEndpointGroup", name, null, MakeResourceOptions(options, id))
        {
        }
