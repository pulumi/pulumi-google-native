...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:NodeGroup")]
    public partial class NodeGroup : global::Pulumi.CustomResource
    {
        ...
        public NodeGroup(string name, NodeGroupArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:NodeGroup", name, args ?? new NodeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:NodeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NodeGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.NodeGroupMaintenanceInterval>? MaintenanceInterval { get; set; }

        /// <summary>
        /// Specifies how to handle instances when a node in the group undergoes maintenance. Set to one of: DEFAULT, RESTART_IN_PLACE, or MIGRATE_WITHIN_NODE_GROUP. The default value is DEFAULT. For more information, see Maintenance policies.
        /// </summary>
        [Input("maintenancePolicy")]
        public Input<Pulumi.GoogleNative.Compute.Beta.NodeGroupMaintenancePolicy>? MaintenancePolicy { get; set; }
