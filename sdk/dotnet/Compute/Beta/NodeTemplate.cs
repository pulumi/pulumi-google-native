...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    public partial class NodeTemplate : Pulumi.CustomResource
    {
        ...
        public NodeTemplate(string name, NodeTemplateArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:NodeTemplate", name, args ?? new NodeTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:NodeTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NodeTemplateArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.NodeTemplateCpuOvercommitType>? CpuOvercommitType { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.GoogleNative.Compute.Beta.NodeTemplateStatus>? Status { get; set; }
