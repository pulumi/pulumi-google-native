...
namespace Pulumi.GcpNative.Compute.Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("google-native:compute/beta:NodeTemplateIamPolicy")]
    public partial class NodeTemplateIamPolicy : Pulumi.CustomResource
    {
        ...
        public NodeTemplateIamPolicy(string name, NodeTemplateIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:NodeTemplateIamPolicy", name, args ?? new NodeTemplateIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeTemplateIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:NodeTemplateIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NodeTemplateIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
