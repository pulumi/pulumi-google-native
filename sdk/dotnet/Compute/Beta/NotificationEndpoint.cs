...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:NotificationEndpoint")]
    public partial class NotificationEndpoint : Pulumi.CustomResource
    {
        ...
        public NotificationEndpoint(string name, NotificationEndpointArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:NotificationEndpoint", name, args ?? new NotificationEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:NotificationEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
