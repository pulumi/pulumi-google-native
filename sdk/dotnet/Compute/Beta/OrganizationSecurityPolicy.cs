...
namespace Pulumi.GcpNative.Compute.Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/beta:OrganizationSecurityPolicy")]
    public partial class OrganizationSecurityPolicy : Pulumi.CustomResource
    {
        ...
        public OrganizationSecurityPolicy(string name, OrganizationSecurityPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:OrganizationSecurityPolicy", name, args ?? new OrganizationSecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationSecurityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:OrganizationSecurityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
