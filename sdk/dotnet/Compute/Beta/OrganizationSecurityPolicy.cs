...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    public partial class OrganizationSecurityPolicy : Pulumi.CustomResource
    {
        ...
        public OrganizationSecurityPolicy(string name, OrganizationSecurityPolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:OrganizationSecurityPolicy", name, args ?? new OrganizationSecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationSecurityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:OrganizationSecurityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrganizationSecurityPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.Compute.Beta.OrganizationSecurityPolicyType>? Type { get; set; }
