...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:PublicAdvertisedPrefix")]
    public partial class PublicAdvertisedPrefix : Pulumi.CustomResource
    {
        ...
        public PublicAdvertisedPrefix(string name, PublicAdvertisedPrefixArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:PublicAdvertisedPrefix", name, args ?? new PublicAdvertisedPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicAdvertisedPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:PublicAdvertisedPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
