...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionBackendServiceIamPolicy")]
    public partial class RegionBackendServiceIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public RegionBackendServiceIamPolicy(string name, RegionBackendServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionBackendServiceIamPolicy", name, args ?? new RegionBackendServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionBackendServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionBackendServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
