...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionDiskIamPolicy")]
    public partial class RegionDiskIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionDiskIamPolicy(string name, RegionDiskIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionDiskIamPolicy", name, args ?? new RegionDiskIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionDiskIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionDiskIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionDiskIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
