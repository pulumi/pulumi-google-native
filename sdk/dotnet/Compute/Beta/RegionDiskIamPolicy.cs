...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:RegionDiskIamPolicy")]
    public partial class RegionDiskIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionDiskIamPolicy(string name, RegionDiskIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:RegionDiskIamPolicy", name, args ?? new RegionDiskIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionDiskIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:RegionDiskIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
