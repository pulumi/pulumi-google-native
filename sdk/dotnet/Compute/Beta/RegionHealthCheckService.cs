...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionHealthCheckService")]
    public partial class RegionHealthCheckService : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("regionHealthCheckServiceId")]
        public Output<string> RegionHealthCheckServiceId { get; private set; } = null!;
        ...
        public RegionHealthCheckService(string name, RegionHealthCheckServiceArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionHealthCheckService", name, args ?? new RegionHealthCheckServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionHealthCheckService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionHealthCheckService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionHealthCheckServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.RegionHealthCheckServiceHealthStatusAggregationStrategy>? HealthStatusAggregationStrategy { get; set; }
