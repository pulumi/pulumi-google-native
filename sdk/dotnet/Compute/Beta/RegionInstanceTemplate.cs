...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionInstanceTemplate")]
    public partial class RegionInstanceTemplate : global::Pulumi.CustomResource
    {
        ...
        public RegionInstanceTemplate(string name, RegionInstanceTemplateArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionInstanceTemplate", name, args ?? new RegionInstanceTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionInstanceTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionInstanceTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
