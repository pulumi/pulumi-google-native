...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionInstantSnapshot")]
    public partial class RegionInstantSnapshot : global::Pulumi.CustomResource
    {
        ...
        public RegionInstantSnapshot(string name, RegionInstantSnapshotArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionInstantSnapshot", name, args ?? new RegionInstantSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionInstantSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionInstantSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
