...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionNetworkEndpointGroup")]
    public partial class RegionNetworkEndpointGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("regionNetworkEndpointGroupId")]
        public Output<string> RegionNetworkEndpointGroupId { get; private set; } = null!;
        ...
        public RegionNetworkEndpointGroup(string name, RegionNetworkEndpointGroupArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionNetworkEndpointGroup", name, args ?? new RegionNetworkEndpointGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkEndpointGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionNetworkEndpointGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionNetworkEndpointGroup Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class RegionNetworkEndpointGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.RegionNetworkEndpointGroupNetworkEndpointType>? NetworkEndpointType { get; set; }
