...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionNetworkFirewallPolicy")]
    public partial class RegionNetworkFirewallPolicy : Pulumi.CustomResource
    {
        ...
        public RegionNetworkFirewallPolicy(string name, RegionNetworkFirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionNetworkFirewallPolicy", name, args ?? new RegionNetworkFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkFirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionNetworkFirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
