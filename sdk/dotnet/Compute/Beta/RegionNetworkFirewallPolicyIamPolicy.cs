...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    public partial class RegionNetworkFirewallPolicyIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public RegionNetworkFirewallPolicyIamPolicy(string name, RegionNetworkFirewallPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionNetworkFirewallPolicyIamPolicy", name, args ?? new RegionNetworkFirewallPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkFirewallPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionNetworkFirewallPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
