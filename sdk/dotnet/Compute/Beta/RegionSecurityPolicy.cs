...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionSecurityPolicy")]
    public partial class RegionSecurityPolicy : Pulumi.CustomResource
    {
        ...
        public RegionSecurityPolicy(string name, RegionSecurityPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionSecurityPolicy", name, args ?? new RegionSecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionSecurityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionSecurityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
