...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionSslCertificate")]
    public partial class RegionSslCertificate : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("regionSslCertificateId")]
        public Output<string> RegionSslCertificateId { get; private set; } = null!;
        ...
        public RegionSslCertificate(string name, RegionSslCertificateArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionSslCertificate", name, args ?? new RegionSslCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionSslCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionSslCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionSslCertificateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.Compute.Beta.RegionSslCertificateType>? Type { get; set; }
