...
namespace Pulumi.GcpNative.Compute.Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/beta:RegionTargetHttpProxy")]
    public partial class RegionTargetHttpProxy : Pulumi.CustomResource
    {
        ...
        public RegionTargetHttpProxy(string name, RegionTargetHttpProxyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:RegionTargetHttpProxy", name, args ?? new RegionTargetHttpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionTargetHttpProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:RegionTargetHttpProxy", name, null, MakeResourceOptions(options, id))
        {
        }
