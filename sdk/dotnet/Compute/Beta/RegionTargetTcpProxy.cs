...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:RegionTargetTcpProxy")]
    public partial class RegionTargetTcpProxy : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("regionTargetTcpProxyId")]
        public Output<string> RegionTargetTcpProxyId { get; private set; } = null!;
        ...
        public RegionTargetTcpProxy(string name, RegionTargetTcpProxyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionTargetTcpProxy", name, args ?? new RegionTargetTcpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionTargetTcpProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:RegionTargetTcpProxy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionTargetTcpProxy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class RegionTargetTcpProxyArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("proxyHeader")]
        public Input<Pulumi.GoogleNative.Compute.Beta.RegionTargetTcpProxyProxyHeader>? ProxyHeader { get; set; }
