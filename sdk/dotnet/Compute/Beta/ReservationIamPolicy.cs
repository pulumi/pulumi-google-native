...
namespace Pulumi.GcpNative.Compute.Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/beta:ReservationIamPolicy")]
    public partial class ReservationIamPolicy : Pulumi.CustomResource
    {
        ...
        public ReservationIamPolicy(string name, ReservationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:ReservationIamPolicy", name, args ?? new ReservationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReservationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:ReservationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
