...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:ServiceAttachmentIamPolicy")]
    public partial class ServiceAttachmentIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceAttachmentIamPolicy(string name, ServiceAttachmentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:ServiceAttachmentIamPolicy", name, args ?? new ServiceAttachmentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceAttachmentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:ServiceAttachmentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
