...
namespace Pulumi.GcpNative.Compute.Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/beta:ServiceAttachmentIamPolicy")]
    public partial class ServiceAttachmentIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceAttachmentIamPolicy(string name, ServiceAttachmentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:ServiceAttachmentIamPolicy", name, args ?? new ServiceAttachmentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceAttachmentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/beta:ServiceAttachmentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
