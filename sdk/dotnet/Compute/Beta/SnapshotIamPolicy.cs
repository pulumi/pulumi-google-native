...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:SnapshotIamPolicy")]
    public partial class SnapshotIamPolicy : Pulumi.CustomResource
    {
        ...
        public SnapshotIamPolicy(string name, SnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:SnapshotIamPolicy", name, args ?? new SnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:SnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
