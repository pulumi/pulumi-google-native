...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:StoragePool")]
    public partial class StoragePool : global::Pulumi.CustomResource
    {
        ...
        public StoragePool(string name, StoragePoolArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:StoragePool", name, args ?? new StoragePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StoragePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:StoragePool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StoragePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.StoragePoolCapacityProvisioningType>? CapacityProvisioningType { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Compute.Beta.StoragePoolPerformanceProvisioningType>? PerformanceProvisioningType { get; set; }
