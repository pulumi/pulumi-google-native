...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:SubnetworkIamPolicy")]
    public partial class SubnetworkIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public SubnetworkIamPolicy(string name, SubnetworkIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:SubnetworkIamPolicy", name, args ?? new SubnetworkIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubnetworkIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:SubnetworkIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SubnetworkIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SubnetworkIamPolicy(name, id, options);
        }
    }

    public sealed class SubnetworkIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new SubnetworkIamPolicyArgs Empty => new SubnetworkIamPolicyArgs();
    }
}
