...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:TargetSslProxy")]
    public partial class TargetSslProxy : Pulumi.CustomResource
    {
        ...
        public TargetSslProxy(string name, TargetSslProxyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:TargetSslProxy", name, args ?? new TargetSslProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetSslProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:TargetSslProxy", name, null, MakeResourceOptions(options, id))
        {
        }
