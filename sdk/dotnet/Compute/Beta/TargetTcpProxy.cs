...
namespace Pulumi.GoogleNative.Compute.Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/beta:TargetTcpProxy")]
    public partial class TargetTcpProxy : Pulumi.CustomResource
    {
        ...
        public TargetTcpProxy(string name, TargetTcpProxyArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:TargetTcpProxy", name, args ?? new TargetTcpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetTcpProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/beta:TargetTcpProxy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TargetTcpProxyArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("proxyHeader")]
        public Input<Pulumi.GoogleNative.Compute.Beta.TargetTcpProxyProxyHeader>? ProxyHeader { get; set; }
