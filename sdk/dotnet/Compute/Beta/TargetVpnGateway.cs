...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:TargetVpnGateway")]
    public partial class TargetVpnGateway : Pulumi.CustomResource
    {
        ...
        public TargetVpnGateway(string name, TargetVpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:TargetVpnGateway", name, args ?? new TargetVpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetVpnGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:TargetVpnGateway", name, null, MakeResourceOptions(options, id))
        {
        }
