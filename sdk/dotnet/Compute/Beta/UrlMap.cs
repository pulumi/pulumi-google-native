...
namespace Pulumi.GoogleCloud.Compute.Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/beta:UrlMap")]
    public partial class UrlMap : Pulumi.CustomResource
    {
        ...
        public UrlMap(string name, UrlMapArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:UrlMap", name, args ?? new UrlMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UrlMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/beta:UrlMap", name, null, MakeResourceOptions(options, id))
        {
        }
