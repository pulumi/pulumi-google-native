...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:Address")]
    public partial class Address : global::Pulumi.CustomResource
    {
        ...
        public Address(string name, AddressArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:Address", name, args ?? new AddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Address(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:Address", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.AddressIpv6EndpointType>? Ipv6EndpointType { get; set; }
