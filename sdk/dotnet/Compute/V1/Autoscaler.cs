...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:Autoscaler")]
    public partial class Autoscaler : Pulumi.CustomResource
    {
        ...
        public Autoscaler(string name, AutoscalerArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:Autoscaler", name, args ?? new AutoscalerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Autoscaler(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:Autoscaler", name, null, MakeResourceOptions(options, id))
        {
        }
