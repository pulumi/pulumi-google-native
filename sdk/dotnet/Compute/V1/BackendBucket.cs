...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:BackendBucket")]
    public partial class BackendBucket : Pulumi.CustomResource
    {
        ...
        public BackendBucket(string name, BackendBucketArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:BackendBucket", name, args ?? new BackendBucketArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendBucket(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:BackendBucket", name, null, MakeResourceOptions(options, id))
        {
        }
