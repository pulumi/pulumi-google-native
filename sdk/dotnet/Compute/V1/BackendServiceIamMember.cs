...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:BackendServiceIamMember")]
    public partial class BackendServiceIamMember : global::Pulumi.CustomResource
    {
        ...
        public BackendServiceIamMember(string name, BackendServiceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:BackendServiceIamMember", name, args ?? new BackendServiceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendServiceIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:BackendServiceIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
