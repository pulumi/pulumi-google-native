...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:BackendServiceIamPolicy")]
    public partial class BackendServiceIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public BackendServiceIamPolicy(string name, BackendServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:BackendServiceIamPolicy", name, args ?? new BackendServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:BackendServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
