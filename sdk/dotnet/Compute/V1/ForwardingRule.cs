...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:ForwardingRule")]
    public partial class ForwardingRule : Pulumi.CustomResource
    {
        ...
        public ForwardingRule(string name, ForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ForwardingRule", name, args ?? new ForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ForwardingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.ForwardingRuleLoadBalancingScheme>? LoadBalancingScheme { get; set; }
        ...
        /// </summary>
        [Input("networkTier")]
        public Input<Pulumi.GoogleNative.Compute.V1.ForwardingRuleNetworkTier>? NetworkTier { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.ForwardingRulePscConnectionStatus>? PscConnectionStatus { get; set; }
