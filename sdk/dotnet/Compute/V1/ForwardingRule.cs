...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:ForwardingRule")]
    public partial class ForwardingRule : Pulumi.CustomResource
    {
        ...
        public ForwardingRule(string name, ForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:ForwardingRule", name, args ?? new ForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:ForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
