...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetBackendBucket
    {
        ...
        public static Task<GetBackendBucketResult> InvokeAsync(GetBackendBucketArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackendBucketResult>("google-native:compute/v1:getBackendBucket", args ?? new GetBackendBucketArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified BackendBucket resource. Gets a list of available backend buckets by making a list() request.
        /// </summary>
        public static Output<GetBackendBucketResult> Invoke(GetBackendBucketInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackendBucketResult>("google-native:compute/v1:getBackendBucket", args ?? new GetBackendBucketInvokeArgs(), options.WithVersion());
    }
