...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetBackendService
    {
        ...
        public static Task<GetBackendServiceResult> InvokeAsync(GetBackendServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackendServiceResult>("google-native:compute/v1:getBackendService", args ?? new GetBackendServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified BackendService resource. Gets a list of available backend services.
        /// </summary>
        public static Output<GetBackendServiceResult> Invoke(GetBackendServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackendServiceResult>("google-native:compute/v1:getBackendService", args ?? new GetBackendServiceInvokeArgs(), options.WithDefaults());
    }
