...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetBackendServiceIamPolicy
    {
        ...
        public static Task<GetBackendServiceIamPolicyResult> InvokeAsync(GetBackendServiceIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackendServiceIamPolicyResult>("google-native:compute/v1:getBackendServiceIamPolicy", args ?? new GetBackendServiceIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetBackendServiceIamPolicyResult> Invoke(GetBackendServiceIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackendServiceIamPolicyResult>("google-native:compute/v1:getBackendServiceIamPolicy", args ?? new GetBackendServiceIamPolicyInvokeArgs(), options.WithDefaults());
    }
