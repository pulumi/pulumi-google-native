...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetDiskIamPolicy
    {
        ...
        public static Task<GetDiskIamPolicyResult> InvokeAsync(GetDiskIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiskIamPolicyResult>("google-native:compute/v1:getDiskIamPolicy", args ?? new GetDiskIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. May be empty if no such policy or resource exists.
        /// </summary>
        public static Output<GetDiskIamPolicyResult> Invoke(GetDiskIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiskIamPolicyResult>("google-native:compute/v1:getDiskIamPolicy", args ?? new GetDiskIamPolicyInvokeArgs(), options.WithDefaults());
    }
