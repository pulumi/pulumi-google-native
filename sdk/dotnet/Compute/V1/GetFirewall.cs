...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetFirewall
    {
        ...
        public static Task<GetFirewallResult> InvokeAsync(GetFirewallArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallResult>("google-native:compute/v1:getFirewall", args ?? new GetFirewallArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified firewall.
        /// </summary>
        public static Output<GetFirewallResult> Invoke(GetFirewallInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallResult>("google-native:compute/v1:getFirewall", args ?? new GetFirewallInvokeArgs(), options.WithDefaults());
    }
