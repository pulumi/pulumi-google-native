...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetFirewallPolicyIamPolicy
    {
        ...
        public static Task<GetFirewallPolicyIamPolicyResult> InvokeAsync(GetFirewallPolicyIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallPolicyIamPolicyResult>("google-native:compute/v1:getFirewallPolicyIamPolicy", args ?? new GetFirewallPolicyIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetFirewallPolicyIamPolicyResult> Invoke(GetFirewallPolicyIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFirewallPolicyIamPolicyResult>("google-native:compute/v1:getFirewallPolicyIamPolicy", args ?? new GetFirewallPolicyIamPolicyInvokeArgs(), options.WithDefaults());
    }
