...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetForwardingRule
    {
        ...
        public static Task<GetForwardingRuleResult> InvokeAsync(GetForwardingRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetForwardingRuleResult>("google-native:compute/v1:getForwardingRule", args ?? new GetForwardingRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified ForwardingRule resource.
        /// </summary>
        public static Output<GetForwardingRuleResult> Invoke(GetForwardingRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetForwardingRuleResult>("google-native:compute/v1:getForwardingRule", args ?? new GetForwardingRuleInvokeArgs(), options.WithDefaults());
    }
