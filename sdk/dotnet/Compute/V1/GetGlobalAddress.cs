...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetGlobalAddress
    {
        ...
        public static Output<GetGlobalAddressResult> Invoke(GetGlobalAddressInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGlobalAddressResult>("google-native:compute/v1:getGlobalAddress", args ?? new GetGlobalAddressInvokeArgs(), options.WithVersion());
    }
