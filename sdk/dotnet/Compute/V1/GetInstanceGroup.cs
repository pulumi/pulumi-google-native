...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetInstanceGroup
    {
        ...
        public static Output<GetInstanceGroupResult> Invoke(GetInstanceGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInstanceGroupResult>("google-native:compute/v1:getInstanceGroup", args ?? new GetInstanceGroupInvokeArgs(), options.WithVersion());
    }
