...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetInstanceGroup
    {
        ...
        public static Task<GetInstanceGroupResult> InvokeAsync(GetInstanceGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstanceGroupResult>("google-native:compute/v1:getInstanceGroup", args ?? new GetInstanceGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified zonal instance group. Get a list of available zonal instance groups by making a list() request. For managed instance groups, use the instanceGroupManagers or regionInstanceGroupManagers methods instead.
        /// </summary>
        public static Output<GetInstanceGroupResult> Invoke(GetInstanceGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInstanceGroupResult>("google-native:compute/v1:getInstanceGroup", args ?? new GetInstanceGroupInvokeArgs(), options.WithDefaults());
    }
