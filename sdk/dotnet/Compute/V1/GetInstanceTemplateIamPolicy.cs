...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetInstanceTemplateIamPolicy
    {
        ...
        public static Task<GetInstanceTemplateIamPolicyResult> InvokeAsync(GetInstanceTemplateIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstanceTemplateIamPolicyResult>("google-native:compute/v1:getInstanceTemplateIamPolicy", args ?? new GetInstanceTemplateIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetInstanceTemplateIamPolicyResult> Invoke(GetInstanceTemplateIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInstanceTemplateIamPolicyResult>("google-native:compute/v1:getInstanceTemplateIamPolicy", args ?? new GetInstanceTemplateIamPolicyInvokeArgs(), options.WithVersion());
    }
