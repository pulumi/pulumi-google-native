...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetInstantSnapshotIamPolicy
    {
        ...
        public static Task<GetInstantSnapshotIamPolicyResult> InvokeAsync(GetInstantSnapshotIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInstantSnapshotIamPolicyResult>("google-native:compute/v1:getInstantSnapshotIamPolicy", args ?? new GetInstantSnapshotIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetInstantSnapshotIamPolicyResult> Invoke(GetInstantSnapshotIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInstantSnapshotIamPolicyResult>("google-native:compute/v1:getInstantSnapshotIamPolicy", args ?? new GetInstantSnapshotIamPolicyInvokeArgs(), options.WithDefaults());
    }
