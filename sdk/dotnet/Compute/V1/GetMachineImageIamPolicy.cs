...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetMachineImageIamPolicy
    {
        ...
        public static Task<GetMachineImageIamPolicyResult> InvokeAsync(GetMachineImageIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineImageIamPolicyResult>("google-native:compute/v1:getMachineImageIamPolicy", args ?? new GetMachineImageIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetMachineImageIamPolicyResult> Invoke(GetMachineImageIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMachineImageIamPolicyResult>("google-native:compute/v1:getMachineImageIamPolicy", args ?? new GetMachineImageIamPolicyInvokeArgs(), options.WithVersion());
    }
