...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetNodeGroup
    {
        ...
        public static Task<GetNodeGroupResult> InvokeAsync(GetNodeGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNodeGroupResult>("google-native:compute/v1:getNodeGroup", args ?? new GetNodeGroupArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified NodeGroup. Get a list of available NodeGroups by making a list() request. Note: the "nodes" field should not be used. Use nodeGroups.listNodes instead.
        /// </summary>
        public static Output<GetNodeGroupResult> Invoke(GetNodeGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNodeGroupResult>("google-native:compute/v1:getNodeGroup", args ?? new GetNodeGroupInvokeArgs(), options.WithVersion());
    }
