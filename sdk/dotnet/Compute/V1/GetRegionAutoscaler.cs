...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetRegionAutoscaler
    {
        ...
        public static Task<GetRegionAutoscalerResult> InvokeAsync(GetRegionAutoscalerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegionAutoscalerResult>("google-native:compute/v1:getRegionAutoscaler", args ?? new GetRegionAutoscalerArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified autoscaler.
        /// </summary>
        public static Output<GetRegionAutoscalerResult> Invoke(GetRegionAutoscalerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegionAutoscalerResult>("google-native:compute/v1:getRegionAutoscaler", args ?? new GetRegionAutoscalerInvokeArgs(), options.WithDefaults());
    }
