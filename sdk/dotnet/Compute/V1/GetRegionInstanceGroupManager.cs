...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetRegionInstanceGroupManager
    {
        ...
        public static Task<GetRegionInstanceGroupManagerResult> InvokeAsync(GetRegionInstanceGroupManagerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionInstanceGroupManagerResult>("google-native:compute/v1:getRegionInstanceGroupManager", args ?? new GetRegionInstanceGroupManagerArgs(), options.WithDefaults());
        ...
        public static Output<GetRegionInstanceGroupManagerResult> Invoke(GetRegionInstanceGroupManagerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionInstanceGroupManagerResult>("google-native:compute/v1:getRegionInstanceGroupManager", args ?? new GetRegionInstanceGroupManagerInvokeArgs(), options.WithDefaults());
    }
