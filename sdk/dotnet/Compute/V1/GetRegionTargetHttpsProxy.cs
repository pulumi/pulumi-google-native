...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetRegionTargetHttpsProxy
    {
        ...
        public static Task<GetRegionTargetHttpsProxyResult> InvokeAsync(GetRegionTargetHttpsProxyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionTargetHttpsProxyResult>("google-native:compute/v1:getRegionTargetHttpsProxy", args ?? new GetRegionTargetHttpsProxyArgs(), options.WithVersion());
        ...
        public static Output<GetRegionTargetHttpsProxyResult> Invoke(GetRegionTargetHttpsProxyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionTargetHttpsProxyResult>("google-native:compute/v1:getRegionTargetHttpsProxy", args ?? new GetRegionTargetHttpsProxyInvokeArgs(), options.WithVersion());
    }
