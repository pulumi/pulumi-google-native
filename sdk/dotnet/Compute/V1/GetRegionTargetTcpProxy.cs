...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetRegionTargetTcpProxy
    {
        ...
        public static Task<GetRegionTargetTcpProxyResult> InvokeAsync(GetRegionTargetTcpProxyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegionTargetTcpProxyResult>("google-native:compute/v1:getRegionTargetTcpProxy", args ?? new GetRegionTargetTcpProxyArgs(), options.WithDefaults());
        ...
        public static Output<GetRegionTargetTcpProxyResult> Invoke(GetRegionTargetTcpProxyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegionTargetTcpProxyResult>("google-native:compute/v1:getRegionTargetTcpProxy", args ?? new GetRegionTargetTcpProxyInvokeArgs(), options.WithDefaults());
    }
