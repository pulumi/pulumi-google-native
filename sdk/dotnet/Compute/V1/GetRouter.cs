...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetRouter
    {
        ...
        public static Task<GetRouterResult> InvokeAsync(GetRouterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRouterResult>("google-native:compute/v1:getRouter", args ?? new GetRouterArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified Router resource. Gets a list of available routers by making a list() request.
        /// </summary>
        public static Output<GetRouterResult> Invoke(GetRouterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRouterResult>("google-native:compute/v1:getRouter", args ?? new GetRouterInvokeArgs(), options.WithVersion());
    }
