...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetServiceAttachmentIamPolicy
    {
        ...
        public static Task<GetServiceAttachmentIamPolicyResult> InvokeAsync(GetServiceAttachmentIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceAttachmentIamPolicyResult>("google-native:compute/v1:getServiceAttachmentIamPolicy", args ?? new GetServiceAttachmentIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetServiceAttachmentIamPolicyResult> Invoke(GetServiceAttachmentIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceAttachmentIamPolicyResult>("google-native:compute/v1:getServiceAttachmentIamPolicy", args ?? new GetServiceAttachmentIamPolicyInvokeArgs(), options.WithVersion());
    }
