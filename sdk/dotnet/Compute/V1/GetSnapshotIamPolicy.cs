...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetSnapshotIamPolicy
    {
        ...
        public static Task<GetSnapshotIamPolicyResult> InvokeAsync(GetSnapshotIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotIamPolicyResult>("google-native:compute/v1:getSnapshotIamPolicy", args ?? new GetSnapshotIamPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Gets the access control policy for a resource. May be empty if no such policy or resource exists.
        /// </summary>
        public static Output<GetSnapshotIamPolicyResult> Invoke(GetSnapshotIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSnapshotIamPolicyResult>("google-native:compute/v1:getSnapshotIamPolicy", args ?? new GetSnapshotIamPolicyInvokeArgs(), options.WithVersion());
    }
