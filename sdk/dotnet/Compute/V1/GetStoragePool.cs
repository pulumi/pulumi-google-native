...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetStoragePool
    {
        ...
        public static Task<GetStoragePoolResult> InvokeAsync(GetStoragePoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStoragePoolResult>("google-native:compute/v1:getStoragePool", args ?? new GetStoragePoolArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a specified storage pool. Gets a list of available storage pools by making a list() request.
        /// </summary>
        public static Output<GetStoragePoolResult> Invoke(GetStoragePoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStoragePoolResult>("google-native:compute/v1:getStoragePool", args ?? new GetStoragePoolInvokeArgs(), options.WithDefaults());
    }
