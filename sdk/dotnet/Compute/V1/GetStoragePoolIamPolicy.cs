...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetStoragePoolIamPolicy
    {
        ...
        public static Task<GetStoragePoolIamPolicyResult> InvokeAsync(GetStoragePoolIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStoragePoolIamPolicyResult>("google-native:compute/v1:getStoragePoolIamPolicy", args ?? new GetStoragePoolIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetStoragePoolIamPolicyResult> Invoke(GetStoragePoolIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStoragePoolIamPolicyResult>("google-native:compute/v1:getStoragePoolIamPolicy", args ?? new GetStoragePoolIamPolicyInvokeArgs(), options.WithDefaults());
    }
