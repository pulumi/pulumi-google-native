...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetTargetGrpcProxy
    {
        ...
        public static Task<GetTargetGrpcProxyResult> InvokeAsync(GetTargetGrpcProxyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTargetGrpcProxyResult>("google-native:compute/v1:getTargetGrpcProxy", args ?? new GetTargetGrpcProxyArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the specified TargetGrpcProxy resource in the given scope.
        /// </summary>
        public static Output<GetTargetGrpcProxyResult> Invoke(GetTargetGrpcProxyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTargetGrpcProxyResult>("google-native:compute/v1:getTargetGrpcProxy", args ?? new GetTargetGrpcProxyInvokeArgs(), options.WithDefaults());
    }
