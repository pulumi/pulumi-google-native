...
namespace Pulumi.GoogleNative.Compute.V1
{
    public static class GetVpnTunnel
    {
        ...
        public static Task<GetVpnTunnelResult> InvokeAsync(GetVpnTunnelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVpnTunnelResult>("google-native:compute/v1:getVpnTunnel", args ?? new GetVpnTunnelArgs(), options.WithVersion());

        /// <summary>
        /// Returns the specified VpnTunnel resource. Gets a list of available VPN tunnels by making a list() request.
        /// </summary>
        public static Output<GetVpnTunnelResult> Invoke(GetVpnTunnelInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVpnTunnelResult>("google-native:compute/v1:getVpnTunnel", args ?? new GetVpnTunnelInvokeArgs(), options.WithVersion());
    }
