...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:GlobalAddress")]
    public partial class GlobalAddress : Pulumi.CustomResource
    {
        ...
        public GlobalAddress(string name, GlobalAddressArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:GlobalAddress", name, args ?? new GlobalAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:GlobalAddress", name, null, MakeResourceOptions(options, id))
        {
        }
