...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:GlobalPublicDelegatedPrefix")]
    public partial class GlobalPublicDelegatedPrefix : Pulumi.CustomResource
    {
        ...
        public GlobalPublicDelegatedPrefix(string name, GlobalPublicDelegatedPrefixArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:GlobalPublicDelegatedPrefix", name, args ?? new GlobalPublicDelegatedPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalPublicDelegatedPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:GlobalPublicDelegatedPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
