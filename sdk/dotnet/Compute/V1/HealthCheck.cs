...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:HealthCheck")]
    public partial class HealthCheck : Pulumi.CustomResource
    {
        ...
        public HealthCheck(string name, HealthCheckArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:HealthCheck", name, args ?? new HealthCheckArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthCheck(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:HealthCheck", name, null, MakeResourceOptions(options, id))
        {
        }
