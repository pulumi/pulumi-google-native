...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:HealthCheckService")]
    public partial class HealthCheckService : Pulumi.CustomResource
    {
        ...
        public HealthCheckService(string name, HealthCheckServiceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:HealthCheckService", name, args ?? new HealthCheckServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthCheckService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:HealthCheckService", name, null, MakeResourceOptions(options, id))
        {
        }
