...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:HttpsHealthCheck")]
    public partial class HttpsHealthCheck : Pulumi.CustomResource
    {
        ...
        public HttpsHealthCheck(string name, HttpsHealthCheckArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:HttpsHealthCheck", name, args ?? new HttpsHealthCheckArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HttpsHealthCheck(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:HttpsHealthCheck", name, null, MakeResourceOptions(options, id))
        {
        }
