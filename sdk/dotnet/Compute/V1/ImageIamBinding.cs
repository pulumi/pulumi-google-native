...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:ImageIamBinding")]
    public partial class ImageIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ImageIamBinding(string name, ImageIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ImageIamBinding", name, args ?? new ImageIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ImageIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
