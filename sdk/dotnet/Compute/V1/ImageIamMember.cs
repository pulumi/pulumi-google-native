...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:ImageIamMember")]
    public partial class ImageIamMember : global::Pulumi.CustomResource
    {
        ...
        public ImageIamMember(string name, ImageIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ImageIamMember", name, args ?? new ImageIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ImageIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
