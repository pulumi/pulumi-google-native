...
namespace Pulumi.GoogleNative.Compute.V1.Inputs
{
    ...
    public sealed class AttachedDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("interface")]
        public Input<Pulumi.GoogleNative.Compute.V1.AttachedDiskInterface>? Interface { get; set; }

        /// <summary>
        /// The mode in which to attach this disk, either READ_WRITE or READ_ONLY. If not specified, the default is to attach the disk in READ_WRITE mode.
        /// </summary>
        [Input("mode")]
        public Input<Pulumi.GoogleNative.Compute.V1.AttachedDiskMode>? Mode { get; set; }

        /// <summary>
        /// For LocalSSD disks on VM Instances in STOPPED or SUSPENDED state, this field is set to PRESERVED if the LocalSSD data has been saved to a persistent location by customer request. (see the discard_local_ssd option on Stop/Suspend). Read-only in the api.
        /// </summary>
        [Input("savedState")]
        public Input<Pulumi.GoogleNative.Compute.V1.AttachedDiskSavedState>? SavedState { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.Compute.V1.AttachedDiskType>? Type { get; set; }
