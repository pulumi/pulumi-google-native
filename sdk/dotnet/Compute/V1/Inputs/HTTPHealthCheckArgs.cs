...
namespace Pulumi.GoogleNative.Compute.V1.Inputs
{
    ...
    public sealed class HTTPHealthCheckArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.HTTPHealthCheckPortSpecification>? PortSpecification { get; set; }

        /// <summary>
        /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
        /// </summary>
        [Input("proxyHeader")]
        public Input<Pulumi.GoogleNative.Compute.V1.HTTPHealthCheckProxyHeader>? ProxyHeader { get; set; }
