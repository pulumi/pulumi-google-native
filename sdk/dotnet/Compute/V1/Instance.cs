...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:Instance")]
    public partial class Instance : Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InstanceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.InstancePostKeyRevocationActionType>? PostKeyRevocationActionType { get; set; }

        /// <summary>
        /// The private IPv6 google access type for the VM. If not specified, use  INHERIT_FROM_SUBNETWORK as default.
        /// </summary>
        [Input("privateIpv6GoogleAccess")]
        public Input<Pulumi.GoogleNative.Compute.V1.InstancePrivateIpv6GoogleAccess>? PrivateIpv6GoogleAccess { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.GoogleNative.Compute.V1.InstanceStatus>? Status { get; set; }
