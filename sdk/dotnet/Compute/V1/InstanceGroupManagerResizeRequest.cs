...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:InstanceGroupManagerResizeRequest")]
    public partial class InstanceGroupManagerResizeRequest : global::Pulumi.CustomResource
    {
        ...
        public InstanceGroupManagerResizeRequest(string name, InstanceGroupManagerResizeRequestArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:InstanceGroupManagerResizeRequest", name, args ?? new InstanceGroupManagerResizeRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceGroupManagerResizeRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:InstanceGroupManagerResizeRequest", name, null, MakeResourceOptions(options, id))
        {
        }
