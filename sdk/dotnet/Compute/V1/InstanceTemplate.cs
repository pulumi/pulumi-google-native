...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:InstanceTemplate")]
    public partial class InstanceTemplate : Pulumi.CustomResource
    {
        ...
        public InstanceTemplate(string name, InstanceTemplateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:InstanceTemplate", name, args ?? new InstanceTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:InstanceTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
