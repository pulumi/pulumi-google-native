...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:InstantSnapshot")]
    public partial class InstantSnapshot : global::Pulumi.CustomResource
    {
        ...
        public InstantSnapshot(string name, InstantSnapshotArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:InstantSnapshot", name, args ?? new InstantSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstantSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:InstantSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
