...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:InstantSnapshotIamPolicy")]
    public partial class InstantSnapshotIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public InstantSnapshotIamPolicy(string name, InstantSnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:InstantSnapshotIamPolicy", name, args ?? new InstantSnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstantSnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:InstantSnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InstantSnapshotIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
