...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:LicenseIamPolicy")]
    public partial class LicenseIamPolicy : Pulumi.CustomResource
    {
        ...
        public LicenseIamPolicy(string name, LicenseIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:LicenseIamPolicy", name, args ?? new LicenseIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:LicenseIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
