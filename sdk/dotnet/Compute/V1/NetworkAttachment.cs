...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:NetworkAttachment")]
    public partial class NetworkAttachment : global::Pulumi.CustomResource
    {
        ...
        public NetworkAttachment(string name, NetworkAttachmentArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:NetworkAttachment", name, args ?? new NetworkAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:NetworkAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkAttachmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.NetworkAttachmentConnectionPreference>? ConnectionPreference { get; set; }
