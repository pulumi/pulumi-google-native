...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:NetworkEndpointGroup")]
    public partial class NetworkEndpointGroup : Pulumi.CustomResource
    {
        ...
        public NetworkEndpointGroup(string name, NetworkEndpointGroupArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:NetworkEndpointGroup", name, args ?? new NetworkEndpointGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkEndpointGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:NetworkEndpointGroup", name, null, MakeResourceOptions(options, id))
        {
        }
