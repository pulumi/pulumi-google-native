...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    public partial class NetworkEndpointGroup : Pulumi.CustomResource
    {
        ...
        public NetworkEndpointGroup(string name, NetworkEndpointGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:NetworkEndpointGroup", name, args ?? new NetworkEndpointGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkEndpointGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:NetworkEndpointGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkEndpointGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.NetworkEndpointGroupNetworkEndpointType>? NetworkEndpointType { get; set; }
