...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:NodeGroup")]
    public partial class NodeGroup : Pulumi.CustomResource
    {
        ...
        public NodeGroup(string name, NodeGroupArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:NodeGroup", name, args ?? new NodeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:NodeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
