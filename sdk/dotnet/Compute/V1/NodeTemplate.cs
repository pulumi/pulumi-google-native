...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:NodeTemplate")]
    public partial class NodeTemplate : Pulumi.CustomResource
    {
        ...
        public NodeTemplate(string name, NodeTemplateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:NodeTemplate", name, args ?? new NodeTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:NodeTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
