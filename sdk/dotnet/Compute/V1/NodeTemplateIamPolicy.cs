...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:NodeTemplateIamPolicy")]
    public partial class NodeTemplateIamPolicy : Pulumi.CustomResource
    {
        ...
        public NodeTemplateIamPolicy(string name, NodeTemplateIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:NodeTemplateIamPolicy", name, args ?? new NodeTemplateIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeTemplateIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:NodeTemplateIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
