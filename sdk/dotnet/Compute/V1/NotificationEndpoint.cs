...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:NotificationEndpoint")]
    public partial class NotificationEndpoint : Pulumi.CustomResource
    {
        ...
        public NotificationEndpoint(string name, NotificationEndpointArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:NotificationEndpoint", name, args ?? new NotificationEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:NotificationEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
