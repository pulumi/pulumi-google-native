...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:PacketMirroring")]
    public partial class PacketMirroring : Pulumi.CustomResource
    {
        ...
        public PacketMirroring(string name, PacketMirroringArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:PacketMirroring", name, args ?? new PacketMirroringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketMirroring(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:PacketMirroring", name, null, MakeResourceOptions(options, id))
        {
        }
