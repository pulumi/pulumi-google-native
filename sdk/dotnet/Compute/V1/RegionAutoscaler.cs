...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionAutoscaler")]
    public partial class RegionAutoscaler : global::Pulumi.CustomResource
    {
        ...
        public RegionAutoscaler(string name, RegionAutoscalerArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionAutoscaler", name, args ?? new RegionAutoscalerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionAutoscaler(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionAutoscaler", name, null, MakeResourceOptions(options, id))
        {
        }
