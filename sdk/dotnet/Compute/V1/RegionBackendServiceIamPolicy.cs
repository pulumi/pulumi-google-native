...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionBackendServiceIamPolicy")]
    public partial class RegionBackendServiceIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public RegionBackendServiceIamPolicy(string name, RegionBackendServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionBackendServiceIamPolicy", name, args ?? new RegionBackendServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionBackendServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionBackendServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
