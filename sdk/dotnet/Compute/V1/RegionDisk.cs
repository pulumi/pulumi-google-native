...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionDisk")]
    public partial class RegionDisk : global::Pulumi.CustomResource
    {
        ...
        public RegionDisk(string name, RegionDiskArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionDisk", name, args ?? new RegionDiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionDisk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionDisk", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("architecture")]
        public Input<Pulumi.GoogleNative.Compute.V1.RegionDiskArchitecture>? Architecture { get; set; }
