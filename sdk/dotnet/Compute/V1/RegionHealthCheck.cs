...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:RegionHealthCheck")]
    public partial class RegionHealthCheck : Pulumi.CustomResource
    {
        ...
        public RegionHealthCheck(string name, RegionHealthCheckArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:RegionHealthCheck", name, args ?? new RegionHealthCheckArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionHealthCheck(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:RegionHealthCheck", name, null, MakeResourceOptions(options, id))
        {
        }
