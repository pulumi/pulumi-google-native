...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionInstanceTemplate")]
    public partial class RegionInstanceTemplate : global::Pulumi.CustomResource
    {
        ...
        public RegionInstanceTemplate(string name, RegionInstanceTemplateArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionInstanceTemplate", name, args ?? new RegionInstanceTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionInstanceTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionInstanceTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
