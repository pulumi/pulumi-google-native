...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionInstantSnapshot")]
    public partial class RegionInstantSnapshot : global::Pulumi.CustomResource
    {
        ...
        public RegionInstantSnapshot(string name, RegionInstantSnapshotArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionInstantSnapshot", name, args ?? new RegionInstantSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionInstantSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionInstantSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionInstantSnapshot Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
