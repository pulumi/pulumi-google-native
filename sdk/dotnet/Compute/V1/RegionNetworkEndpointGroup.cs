...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionNetworkEndpointGroup")]
    public partial class RegionNetworkEndpointGroup : global::Pulumi.CustomResource
    {
        ...
        public RegionNetworkEndpointGroup(string name, RegionNetworkEndpointGroupArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionNetworkEndpointGroup", name, args ?? new RegionNetworkEndpointGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkEndpointGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionNetworkEndpointGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionNetworkEndpointGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.RegionNetworkEndpointGroupNetworkEndpointType>? NetworkEndpointType { get; set; }
