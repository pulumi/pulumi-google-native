...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionNetworkFirewallPolicy")]
    public partial class RegionNetworkFirewallPolicy : Pulumi.CustomResource
    {
        ...
        public RegionNetworkFirewallPolicy(string name, RegionNetworkFirewallPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionNetworkFirewallPolicy", name, args ?? new RegionNetworkFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkFirewallPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionNetworkFirewallPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
