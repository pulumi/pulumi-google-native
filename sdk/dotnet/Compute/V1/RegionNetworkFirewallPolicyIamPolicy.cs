...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionNetworkFirewallPolicyIamPolicy")]
    public partial class RegionNetworkFirewallPolicyIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegionNetworkFirewallPolicyIamPolicy(string name, RegionNetworkFirewallPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionNetworkFirewallPolicyIamPolicy", name, args ?? new RegionNetworkFirewallPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkFirewallPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionNetworkFirewallPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionNetworkFirewallPolicyIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
