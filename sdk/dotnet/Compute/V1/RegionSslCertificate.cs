...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:RegionSslCertificate")]
    public partial class RegionSslCertificate : Pulumi.CustomResource
    {
        ...
        public RegionSslCertificate(string name, RegionSslCertificateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:RegionSslCertificate", name, args ?? new RegionSslCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionSslCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:RegionSslCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
