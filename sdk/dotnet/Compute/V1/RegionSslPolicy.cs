...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionSslPolicy")]
    public partial class RegionSslPolicy : global::Pulumi.CustomResource
    {
        ...
        public RegionSslPolicy(string name, RegionSslPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionSslPolicy", name, args ?? new RegionSslPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionSslPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionSslPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionSslPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("minTlsVersion")]
        public Input<Pulumi.GoogleNative.Compute.V1.RegionSslPolicyMinTlsVersion>? MinTlsVersion { get; set; }
        ...
        /// </summary>
        [Input("profile")]
        public Input<Pulumi.GoogleNative.Compute.V1.RegionSslPolicyProfile>? Profile { get; set; }
