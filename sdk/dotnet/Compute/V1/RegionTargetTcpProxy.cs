...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:RegionTargetTcpProxy")]
    public partial class RegionTargetTcpProxy : global::Pulumi.CustomResource
    {
        ...
        public RegionTargetTcpProxy(string name, RegionTargetTcpProxyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionTargetTcpProxy", name, args ?? new RegionTargetTcpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionTargetTcpProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:RegionTargetTcpProxy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegionTargetTcpProxyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("proxyHeader")]
        public Input<Pulumi.GoogleNative.Compute.V1.RegionTargetTcpProxyProxyHeader>? ProxyHeader { get; set; }
