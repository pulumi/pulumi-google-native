...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:RegionUrlMap")]
    public partial class RegionUrlMap : Pulumi.CustomResource
    {
        ...
        public RegionUrlMap(string name, RegionUrlMapArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:RegionUrlMap", name, args ?? new RegionUrlMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionUrlMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:RegionUrlMap", name, null, MakeResourceOptions(options, id))
        {
        }
