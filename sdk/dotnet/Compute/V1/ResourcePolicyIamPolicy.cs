...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:ResourcePolicyIamPolicy")]
    public partial class ResourcePolicyIamPolicy : Pulumi.CustomResource
    {
        ...
        public ResourcePolicyIamPolicy(string name, ResourcePolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:ResourcePolicyIamPolicy", name, args ?? new ResourcePolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourcePolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:ResourcePolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
