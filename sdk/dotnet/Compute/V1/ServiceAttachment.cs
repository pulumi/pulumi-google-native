...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    public partial class ServiceAttachment : Pulumi.CustomResource
    {
        ...
        public ServiceAttachment(string name, ServiceAttachmentArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ServiceAttachment", name, args ?? new ServiceAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ServiceAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceAttachmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.ServiceAttachmentConnectionPreference>? ConnectionPreference { get; set; }
