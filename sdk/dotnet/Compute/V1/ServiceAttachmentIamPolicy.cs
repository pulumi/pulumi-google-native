...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:ServiceAttachmentIamPolicy")]
    public partial class ServiceAttachmentIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceAttachmentIamPolicy(string name, ServiceAttachmentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ServiceAttachmentIamPolicy", name, args ?? new ServiceAttachmentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceAttachmentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:ServiceAttachmentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
