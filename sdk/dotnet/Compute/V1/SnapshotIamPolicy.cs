...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:SnapshotIamPolicy")]
    public partial class SnapshotIamPolicy : Pulumi.CustomResource
    {
        ...
        public SnapshotIamPolicy(string name, SnapshotIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:SnapshotIamPolicy", name, args ?? new SnapshotIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:SnapshotIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
