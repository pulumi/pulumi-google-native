...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:SslCertificate")]
    public partial class SslCertificate : Pulumi.CustomResource
    {
        ...
        public SslCertificate(string name, SslCertificateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:SslCertificate", name, args ?? new SslCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SslCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:SslCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SslCertificate Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
