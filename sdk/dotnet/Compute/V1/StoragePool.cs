...
namespace Pulumi.GoogleNative.Compute.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:compute/v1:StoragePool")]
    public partial class StoragePool : global::Pulumi.CustomResource
    {
        ...
        public StoragePool(string name, StoragePoolArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:StoragePool", name, args ?? new StoragePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StoragePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:compute/v1:StoragePool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StoragePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.StoragePoolCapacityProvisioningType>? CapacityProvisioningType { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Compute.V1.StoragePoolPerformanceProvisioningType>? PerformanceProvisioningType { get; set; }
