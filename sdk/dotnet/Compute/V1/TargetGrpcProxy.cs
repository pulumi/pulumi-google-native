...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:TargetGrpcProxy")]
    public partial class TargetGrpcProxy : Pulumi.CustomResource
    {
        ...
        public TargetGrpcProxy(string name, TargetGrpcProxyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:TargetGrpcProxy", name, args ?? new TargetGrpcProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetGrpcProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:TargetGrpcProxy", name, null, MakeResourceOptions(options, id))
        {
        }
