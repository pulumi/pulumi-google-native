...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:TargetHttpsProxy")]
    public partial class TargetHttpsProxy : Pulumi.CustomResource
    {
        ...
        public TargetHttpsProxy(string name, TargetHttpsProxyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:TargetHttpsProxy", name, args ?? new TargetHttpsProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetHttpsProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:TargetHttpsProxy", name, null, MakeResourceOptions(options, id))
        {
        }
