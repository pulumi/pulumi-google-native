...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:TargetInstance")]
    public partial class TargetInstance : Pulumi.CustomResource
    {
        ...
        public TargetInstance(string name, TargetInstanceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:TargetInstance", name, args ?? new TargetInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:TargetInstance", name, null, MakeResourceOptions(options, id))
        {
        }
