...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:TargetPool")]
    public partial class TargetPool : Pulumi.CustomResource
    {
        ...
        public TargetPool(string name, TargetPoolArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:TargetPool", name, args ?? new TargetPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:TargetPool", name, null, MakeResourceOptions(options, id))
        {
        }
