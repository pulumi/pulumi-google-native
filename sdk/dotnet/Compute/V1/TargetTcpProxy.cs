...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:TargetTcpProxy")]
    public partial class TargetTcpProxy : Pulumi.CustomResource
    {
        ...
        public TargetTcpProxy(string name, TargetTcpProxyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:TargetTcpProxy", name, args ?? new TargetTcpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetTcpProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:TargetTcpProxy", name, null, MakeResourceOptions(options, id))
        {
        }
