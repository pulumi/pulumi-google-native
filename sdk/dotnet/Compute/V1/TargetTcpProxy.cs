...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:TargetTcpProxy")]
    public partial class TargetTcpProxy : Pulumi.CustomResource
    {
        ...
        public TargetTcpProxy(string name, TargetTcpProxyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:TargetTcpProxy", name, args ?? new TargetTcpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetTcpProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:TargetTcpProxy", name, null, MakeResourceOptions(options, id))
        {
        }
