...
namespace Pulumi.GoogleCloud.Compute.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:compute/v1:UrlMap")]
    public partial class UrlMap : Pulumi.CustomResource
    {
        ...
        public UrlMap(string name, UrlMapArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:UrlMap", name, args ?? new UrlMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UrlMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:compute/v1:UrlMap", name, null, MakeResourceOptions(options, id))
        {
        }
