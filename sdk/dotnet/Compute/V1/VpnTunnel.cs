...
namespace Pulumi.GcpNative.Compute.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:compute/v1:VpnTunnel")]
    public partial class VpnTunnel : Pulumi.CustomResource
    {
        ...
        public VpnTunnel(string name, VpnTunnelArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:VpnTunnel", name, args ?? new VpnTunnelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnTunnel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:compute/v1:VpnTunnel", name, null, MakeResourceOptions(options, id))
        {
        }
