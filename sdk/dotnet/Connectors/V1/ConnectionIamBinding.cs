...
namespace Pulumi.GoogleNative.Connectors.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:connectors/v1:ConnectionIamBinding")]
    public partial class ConnectionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamBinding(string name, ConnectionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:connectors/v1:ConnectionIamBinding", name, args ?? new ConnectionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:connectors/v1:ConnectionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
