...
namespace Pulumi.GoogleNative.Connectors.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:connectors/v1:ConnectionIamMember")]
    public partial class ConnectionIamMember : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIamMember(string name, ConnectionIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:connectors/v1:ConnectionIamMember", name, args ?? new ConnectionIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:connectors/v1:ConnectionIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
