...
namespace Pulumi.GoogleNative.Connectors.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:connectors/v1:ConnectionIamPolicy")]
    public partial class ConnectionIamPolicy : Pulumi.CustomResource
    {
        ...
        public ConnectionIamPolicy(string name, ConnectionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:connectors/v1:ConnectionIamPolicy", name, args ?? new ConnectionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:connectors/v1:ConnectionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
