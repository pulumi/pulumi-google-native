...
namespace Pulumi.GoogleNative.Container.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:container/v1:ClusterNodePool")]
    public partial class ClusterNodePool : Pulumi.CustomResource
    {
        ...
        public ClusterNodePool(string name, ClusterNodePoolArgs args, CustomResourceOptions? options = null)
            : base("google-native:container/v1:ClusterNodePool", name, args ?? new ClusterNodePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterNodePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:container/v1:ClusterNodePool", name, null, MakeResourceOptions(options, id))
        {
        }
