...
namespace Pulumi.GoogleNative.Container.V1.Inputs
{
    ...
    public sealed class FilterArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Pulumi.GoogleNative.Container.V1.FilterEventTypeItem> EventType
        {
            get => _eventType ?? (_eventType = new InputList<Pulumi.GoogleNative.Container.V1.FilterEventTypeItem>());
