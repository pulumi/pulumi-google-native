...
namespace Pulumi.GoogleNative.Container.V1.Inputs
{
    ...
    public sealed class LoggingComponentConfigArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Pulumi.GoogleNative.Container.V1.LoggingComponentConfigEnableComponentsItem> EnableComponents
        {
            get => _enableComponents ?? (_enableComponents = new InputList<Pulumi.GoogleNative.Container.V1.LoggingComponentConfigEnableComponentsItem>());
