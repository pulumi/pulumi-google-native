...
namespace Pulumi.GcpNative.Container.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:container/v1beta1:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:container/v1beta1:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:container/v1beta1:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
