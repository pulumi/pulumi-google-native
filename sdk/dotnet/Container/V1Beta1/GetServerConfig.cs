...
namespace Pulumi.GoogleNative.Container.V1Beta1
{
    public static class GetServerConfig
    {
        ...
        public static Task<GetServerConfigResult> InvokeAsync(GetServerConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerConfigResult>("google-native:container/v1beta1:getServerConfig", args ?? new GetServerConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Returns configuration info about the Google Kubernetes Engine service.
        /// </summary>
        public static Output<GetServerConfigResult> Invoke(GetServerConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServerConfigResult>("google-native:container/v1beta1:getServerConfig", args ?? new GetServerConfigInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetServerConfigResult
    {
        ...
        /// </summary>
        public readonly ImmutableDictionary<string, string> WindowsVersionMaps;
        ...
        private GetServerConfigResult(
            ...
            ImmutableDictionary<string, string> windowsVersionMaps)
        {
            Channels = channels;
