...
namespace Pulumi.GoogleNative.Container.V1Beta1.Inputs
{
    ...
    public sealed class DNSConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("clusterDns")]
        public Input<Pulumi.GoogleNative.Container.V1Beta1.DNSConfigClusterDns>? ClusterDns { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Container.V1Beta1.DNSConfigClusterDnsScope>? ClusterDnsScope { get; set; }
