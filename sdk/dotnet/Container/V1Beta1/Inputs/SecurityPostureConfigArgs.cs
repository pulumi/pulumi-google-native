...
namespace Pulumi.GoogleNative.Container.V1Beta1.Inputs
{
    ...
    public sealed class SecurityPostureConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public Input<Pulumi.GoogleNative.Container.V1Beta1.SecurityPostureConfigMode>? Mode { get; set; }

        /// <summary>
        /// Sets which mode to use for vulnerability scanning.
        /// </summary>
        [Input("vulnerabilityMode")]
        public Input<Pulumi.GoogleNative.Container.V1Beta1.SecurityPostureConfigVulnerabilityMode>? VulnerabilityMode { get; set; }
