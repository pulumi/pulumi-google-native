...
namespace Pulumi.GoogleNative.Container.V1Beta1.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class OpportunisticMaintenanceStrategyResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly string MinNodesPerPool;
        /// <summary>
        ...
        [OutputConstructor]
        private OpportunisticMaintenanceStrategyResponse(
            string maintenanceAvailabilityWindow,

            string minNodesPerPool,
