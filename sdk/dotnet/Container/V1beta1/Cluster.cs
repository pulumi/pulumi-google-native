...
namespace Pulumi.GoogleCloud.Container.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:container/v1beta1:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:container/v1beta1:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:container/v1beta1:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
