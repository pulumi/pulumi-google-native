...
namespace Pulumi.GoogleNative.ContainerAnalysis.V1
{
    public static class GetOccurrenceIamPolicy
    {
        ...
        public static Task<GetOccurrenceIamPolicyResult> InvokeAsync(GetOccurrenceIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOccurrenceIamPolicyResult>("google-native:containeranalysis/v1:getOccurrenceIamPolicy", args ?? new GetOccurrenceIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetOccurrenceIamPolicyResult> Invoke(GetOccurrenceIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOccurrenceIamPolicyResult>("google-native:containeranalysis/v1:getOccurrenceIamPolicy", args ?? new GetOccurrenceIamPolicyInvokeArgs(), options.WithDefaults());
    }
