...
namespace Pulumi.GoogleNative.ContainerAnalysis.V1
{
    public static class GetOccurrenceIamPolicy
    {
        ...
        public static Task<GetOccurrenceIamPolicyResult> InvokeAsync(GetOccurrenceIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOccurrenceIamPolicyResult>("google-native:containeranalysis/v1:getOccurrenceIamPolicy", args ?? new GetOccurrenceIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetOccurrenceIamPolicyResult> Invoke(GetOccurrenceIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOccurrenceIamPolicyResult>("google-native:containeranalysis/v1:getOccurrenceIamPolicy", args ?? new GetOccurrenceIamPolicyInvokeArgs(), options.WithVersion());
    }
