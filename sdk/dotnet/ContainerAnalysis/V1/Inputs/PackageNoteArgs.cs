...
namespace Pulumi.GoogleNative.ContainerAnalysis.V1.Inputs
{
    ...
    public sealed class PackageNoteArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("architecture")]
        public Input<Pulumi.GoogleNative.ContainerAnalysis.V1.PackageNoteArchitecture>? Architecture { get; set; }
        ...
        /// </summary>
        [Obsolete(@"Deprecated. The various channels by which a package is distributed.")]
