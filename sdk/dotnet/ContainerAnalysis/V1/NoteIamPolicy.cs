...
namespace Pulumi.GoogleNative.ContainerAnalysis.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:containeranalysis/v1:NoteIamPolicy")]
    public partial class NoteIamPolicy : Pulumi.CustomResource
    {
        ...
        public NoteIamPolicy(string name, NoteIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:containeranalysis/v1:NoteIamPolicy", name, args ?? new NoteIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NoteIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:containeranalysis/v1:NoteIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
