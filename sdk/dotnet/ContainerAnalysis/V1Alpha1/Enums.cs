...
namespace Pulumi.GoogleNative.ContainerAnalysis.V1Alpha1
{
    ...
    public readonly struct NoteKind : IEquatable<NoteKind>
    {
        ...
        /// Unknown
        /// </summary>
        public static NoteKind KindUnspecified { get; } = new NoteKind("KIND_UNSPECIFIED");
        /// <summary>
        /// The note and occurrence represent a package vulnerability.
        /// </summary>
        public static NoteKind PackageVulnerability { get; } = new NoteKind("PACKAGE_VULNERABILITY");
        /// <summary>
        /// The note and occurrence assert build provenance.
        /// </summary>
        public static NoteKind BuildDetails { get; } = new NoteKind("BUILD_DETAILS");
        /// <summary>
        /// This represents an image basis relationship.
        /// </summary>
        public static NoteKind ImageBasis { get; } = new NoteKind("IMAGE_BASIS");
        /// <summary>
        /// This represents a package installed via a package manager.
        /// </summary>
        public static NoteKind PackageManager { get; } = new NoteKind("PACKAGE_MANAGER");
        /// <summary>
        /// The note and occurrence track deployment events.
        /// </summary>
        public static NoteKind Deployable { get; } = new NoteKind("DEPLOYABLE");
        /// <summary>
        /// The note and occurrence track the initial discovery status of a resource.
        /// </summary>
        ...
        /// This represents a logical "role" that can attest to artifacts.
        /// </summary>
        public static NoteKind AttestationAuthority { get; } = new NoteKind("ATTESTATION_AUTHORITY");
        /// <summary>
        /// This represents an available software upgrade.
        /// </summary>
        public static NoteKind Upgrade { get; } = new NoteKind("UPGRADE");
        /// <summary>
        /// This represents a compliance check that can be applied to a resource.
        /// </summary>
        public static NoteKind Compliance { get; } = new NoteKind("COMPLIANCE");
    ...
    public readonly struct OccurrenceKind : IEquatable<OccurrenceKind>
    {
        ...
        /// Unknown
        /// </summary>
        public static OccurrenceKind KindUnspecified { get; } = new OccurrenceKind("KIND_UNSPECIFIED");
        /// <summary>
        /// The note and occurrence represent a package vulnerability.
        /// </summary>
        public static OccurrenceKind PackageVulnerability { get; } = new OccurrenceKind("PACKAGE_VULNERABILITY");
        /// <summary>
        /// The note and occurrence assert build provenance.
        /// </summary>
        public static OccurrenceKind BuildDetails { get; } = new OccurrenceKind("BUILD_DETAILS");
        /// <summary>
        /// This represents an image basis relationship.
        /// </summary>
        public static OccurrenceKind ImageBasis { get; } = new OccurrenceKind("IMAGE_BASIS");
        /// <summary>
        /// This represents a package installed via a package manager.
        /// </summary>
        public static OccurrenceKind PackageManager { get; } = new OccurrenceKind("PACKAGE_MANAGER");
        /// <summary>
        /// The note and occurrence track deployment events.
        /// </summary>
        public static OccurrenceKind Deployable { get; } = new OccurrenceKind("DEPLOYABLE");
        /// <summary>
        /// The note and occurrence track the initial discovery status of a resource.
        /// </summary>
        ...
        /// This represents a logical "role" that can attest to artifacts.
        /// </summary>
        public static OccurrenceKind AttestationAuthority { get; } = new OccurrenceKind("ATTESTATION_AUTHORITY");
        /// <summary>
        /// This represents an available software upgrade.
        /// </summary>
        public static OccurrenceKind Upgrade { get; } = new OccurrenceKind("UPGRADE");
        /// <summary>
        /// This represents a compliance check that can be applied to a resource.
        /// </summary>
        public static OccurrenceKind Compliance { get; } = new OccurrenceKind("COMPLIANCE");
    ...
    /// </summary>
    [EnumType]
    public readonly struct VulnerabilityDetailsSeverity : IEquatable<VulnerabilityDetailsSeverity>
    {
        private readonly string _value;

        private VulnerabilityDetailsSeverity(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Unknown Impact
        /// </summary>
        public static VulnerabilityDetailsSeverity SeverityUnspecified { get; } = new VulnerabilityDetailsSeverity("SEVERITY_UNSPECIFIED");
        /// <summary>
        /// Minimal Impact
        /// </summary>
        public static VulnerabilityDetailsSeverity Minimal { get; } = new VulnerabilityDetailsSeverity("MINIMAL");
        /// <summary>
        /// Low Impact
        /// </summary>
        public static VulnerabilityDetailsSeverity Low { get; } = new VulnerabilityDetailsSeverity("LOW");
        /// <summary>
        /// Medium Impact
        /// </summary>
        public static VulnerabilityDetailsSeverity Medium { get; } = new VulnerabilityDetailsSeverity("MEDIUM");
        /// <summary>
        /// High Impact
        /// </summary>
        public static VulnerabilityDetailsSeverity High { get; } = new VulnerabilityDetailsSeverity("HIGH");
        /// <summary>
        /// Critical Impact
        /// </summary>
        public static VulnerabilityDetailsSeverity Critical { get; } = new VulnerabilityDetailsSeverity("CRITICAL");

        public static bool operator ==(VulnerabilityDetailsSeverity left, VulnerabilityDetailsSeverity right) => left.Equals(right);
        public static bool operator !=(VulnerabilityDetailsSeverity left, VulnerabilityDetailsSeverity right) => !left.Equals(right);

        public static explicit operator string(VulnerabilityDetailsSeverity value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is VulnerabilityDetailsSeverity other && Equals(other);
        public bool Equals(VulnerabilityDetailsSeverity other) => string.Equals(_value, other._value, StringComparison.Ordinal);
