...
namespace Pulumi.GoogleNative.ContainerAnalysis.V1Alpha1
{
    public static class GetNote
    {
        ...
        public static Task<GetNoteResult> InvokeAsync(GetNoteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNoteResult>("google-native:containeranalysis/v1alpha1:getNote", args ?? new GetNoteArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the requested `Note`.
        /// </summary>
        public static Output<GetNoteResult> Invoke(GetNoteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNoteResult>("google-native:containeranalysis/v1alpha1:getNote", args ?? new GetNoteInvokeArgs(), options.WithDefaults());
    }
