...
namespace Pulumi.GoogleNative.ContainerAnalysis.V1Alpha1.Inputs
{
    ...
    public sealed class RemediationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.ContainerAnalysis.V1Alpha1.RemediationRemediationType>? RemediationType { get; set; }

        /// <summary>
        /// Contains the URL where to obtain the remediation.
        /// </summary>
        [Input("remediationUri")]
        public Input<Inputs.URIArgs>? RemediationUri { get; set; }
