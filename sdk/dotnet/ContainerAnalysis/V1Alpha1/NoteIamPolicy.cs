...
namespace Pulumi.GcpNative.ContainerAnalysis.V1Alpha1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:containeranalysis/v1alpha1:NoteIamPolicy")]
    public partial class NoteIamPolicy : Pulumi.CustomResource
    {
        ...
        public NoteIamPolicy(string name, NoteIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:containeranalysis/v1alpha1:NoteIamPolicy", name, args ?? new NoteIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NoteIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:containeranalysis/v1alpha1:NoteIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
