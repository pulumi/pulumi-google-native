...
namespace Pulumi.GoogleNative.ContainerAnalysis.V1Beta1
{
    public static class GetOccurrence
    {
        ...
        public static Task<GetOccurrenceResult> InvokeAsync(GetOccurrenceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOccurrenceResult>("google-native:containeranalysis/v1beta1:getOccurrence", args ?? new GetOccurrenceArgs(), options.WithVersion());

        /// <summary>
        /// Gets the specified occurrence.
        /// </summary>
        public static Output<GetOccurrenceResult> Invoke(GetOccurrenceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOccurrenceResult>("google-native:containeranalysis/v1beta1:getOccurrence", args ?? new GetOccurrenceInvokeArgs(), options.WithVersion());
    }
