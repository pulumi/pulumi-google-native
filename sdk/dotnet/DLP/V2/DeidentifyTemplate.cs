...
namespace Pulumi.GoogleNative.DLP.V2
{
    ...
    public partial class DeidentifyTemplate : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DeidentifyTemplate(string name, DeidentifyTemplateArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:dlp/v2:DeidentifyTemplate", name, args ?? new DeidentifyTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeidentifyTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dlp/v2:DeidentifyTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeidentifyTemplateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The core content of the template.
        /// </summary>
        ...
        public static new DeidentifyTemplateArgs Empty => new DeidentifyTemplateArgs();
    }
}
