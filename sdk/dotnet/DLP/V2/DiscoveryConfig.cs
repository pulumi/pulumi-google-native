...
namespace Pulumi.GoogleNative.DLP.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dlp/v2:DiscoveryConfig")]
    public partial class DiscoveryConfig : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DiscoveryConfig(string name, DiscoveryConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:dlp/v2:DiscoveryConfig", name, args ?? new DiscoveryConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiscoveryConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dlp/v2:DiscoveryConfig", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DiscoveryConfig Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DiscoveryConfig(name, id, options);
        }
    }

    public sealed class DiscoveryConfigArgs : global::Pulumi.ResourceArgs
    {
        [Input("actions")]
        ...
        public Input<Pulumi.GoogleNative.DLP.V2.DiscoveryConfigStatus> Status { get; set; } = null!;
        ...
        public DiscoveryConfigArgs()
        {
        }
        public static new DiscoveryConfigArgs Empty => new DiscoveryConfigArgs();
    }
}
