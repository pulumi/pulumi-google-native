...
namespace Pulumi.GoogleNative.DLP.V2
{
    public static class GetDiscoveryConfig
    {
        ...
        /// </summary>
        public static Task<GetDiscoveryConfigResult> InvokeAsync(GetDiscoveryConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiscoveryConfigResult>("google-native:dlp/v2:getDiscoveryConfig", args ?? new GetDiscoveryConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a discovery configuration.
        /// </summary>
        public static Output<GetDiscoveryConfigResult> Invoke(GetDiscoveryConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiscoveryConfigResult>("google-native:dlp/v2:getDiscoveryConfig", args ?? new GetDiscoveryConfigInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetDiscoveryConfigArgs : global::Pulumi.InvokeArgs
    {
        ...
        public GetDiscoveryConfigArgs()
        {
        }
        public static new GetDiscoveryConfigArgs Empty => new GetDiscoveryConfigArgs();
    }

    public sealed class GetDiscoveryConfigInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("discoveryConfigId", required: true)]
        ...
        public GetDiscoveryConfigInvokeArgs()
        {
        }
        public static new GetDiscoveryConfigInvokeArgs Empty => new GetDiscoveryConfigInvokeArgs();
    }


    [OutputType]
    public sealed class GetDiscoveryConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDiscoveryConfigResult(
