...
namespace Pulumi.GoogleNative.DLP.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dlp/v2:InspectTemplate")]
    public partial class InspectTemplate : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public InspectTemplate(string name, InspectTemplateArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:dlp/v2:InspectTemplate", name, args ?? new InspectTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InspectTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dlp/v2:InspectTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InspectTemplateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Short description (max 256 chars).
        /// </summary>
        ...
        public static new InspectTemplateArgs Empty => new InspectTemplateArgs();
    }
}
