...
namespace Pulumi.GoogleNative.DNS.V1
{
    public static class GetResourceRecordSet
    {
        ...
        public static Task<GetResourceRecordSetResult> InvokeAsync(GetResourceRecordSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResourceRecordSetResult>("google-native:dns/v1:getResourceRecordSet", args ?? new GetResourceRecordSetArgs(), options.WithDefaults());

        /// <summary>
        /// Fetches the representation of an existing ResourceRecordSet.
        /// </summary>
        public static Output<GetResourceRecordSetResult> Invoke(GetResourceRecordSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetResourceRecordSetResult>("google-native:dns/v1:getResourceRecordSet", args ?? new GetResourceRecordSetInvokeArgs(), options.WithDefaults());
    }
