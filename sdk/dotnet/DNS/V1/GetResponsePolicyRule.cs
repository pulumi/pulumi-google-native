...
namespace Pulumi.GoogleNative.DNS.V1
{
    public static class GetResponsePolicyRule
    {
        ...
        public static Task<GetResponsePolicyRuleResult> InvokeAsync(GetResponsePolicyRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResponsePolicyRuleResult>("google-native:dns/v1:getResponsePolicyRule", args ?? new GetResponsePolicyRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Fetches the representation of an existing Response Policy Rule.
        /// </summary>
        public static Output<GetResponsePolicyRuleResult> Invoke(GetResponsePolicyRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetResponsePolicyRuleResult>("google-native:dns/v1:getResponsePolicyRule", args ?? new GetResponsePolicyRuleInvokeArgs(), options.WithDefaults());
    }
