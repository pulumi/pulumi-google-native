...
namespace Pulumi.GcpNative.DNS.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dns/v1:ManagedZone")]
    public partial class ManagedZone : Pulumi.CustomResource
    {
        ...
        public ManagedZone(string name, ManagedZoneArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dns/v1:ManagedZone", name, args ?? new ManagedZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dns/v1:ManagedZone", name, null, MakeResourceOptions(options, id))
        {
        }
