...
namespace Pulumi.GoogleNative.DNS.V1
{
    ...
    public partial class ManagedZone : Pulumi.CustomResource
    {
        ...
        public ManagedZone(string name, ManagedZoneArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:dns/v1:ManagedZone", name, args ?? new ManagedZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dns/v1:ManagedZone", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedZoneArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("visibility")]
        public Input<Pulumi.GoogleNative.DNS.V1.ManagedZoneVisibility>? Visibility { get; set; }
