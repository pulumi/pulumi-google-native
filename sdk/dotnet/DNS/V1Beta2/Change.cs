...
namespace Pulumi.GcpNative.DNS.V1Beta2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dns/v1beta2:Change")]
    public partial class Change : Pulumi.CustomResource
    {
        ...
        public Change(string name, ChangeArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dns/v1beta2:Change", name, args ?? new ChangeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Change(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dns/v1beta2:Change", name, null, MakeResourceOptions(options, id))
        {
        }
