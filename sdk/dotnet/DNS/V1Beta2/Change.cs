...
namespace Pulumi.GoogleCloud.DNS.V1Beta2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dns/v1beta2:Change")]
    public partial class Change : Pulumi.CustomResource
    {
        ...
        public Change(string name, ChangeArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dns/v1beta2:Change", name, args ?? new ChangeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Change(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dns/v1beta2:Change", name, null, MakeResourceOptions(options, id))
        {
        }
