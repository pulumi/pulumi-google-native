...
namespace Pulumi.GoogleNative.DNS.V1Beta2
{
    public static class GetManagedZoneIamPolicy
    {
        ...
        public static Task<GetManagedZoneIamPolicyResult> InvokeAsync(GetManagedZoneIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedZoneIamPolicyResult>("google-native:dns/v1beta2:getManagedZoneIamPolicy", args ?? new GetManagedZoneIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetManagedZoneIamPolicyResult> Invoke(GetManagedZoneIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetManagedZoneIamPolicyResult>("google-native:dns/v1beta2:getManagedZoneIamPolicy", args ?? new GetManagedZoneIamPolicyInvokeArgs(), options.WithDefaults());
    }
