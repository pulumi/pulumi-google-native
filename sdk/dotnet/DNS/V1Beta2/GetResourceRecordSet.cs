...
namespace Pulumi.GoogleNative.DNS.V1Beta2
{
    public static class GetResourceRecordSet
    {
        ...
        public static Output<GetResourceRecordSetResult> Invoke(GetResourceRecordSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetResourceRecordSetResult>("google-native:dns/v1beta2:getResourceRecordSet", args ?? new GetResourceRecordSetInvokeArgs(), options.WithVersion());
    }
