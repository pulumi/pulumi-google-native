...
namespace Pulumi.GoogleNative.DNS.V1Beta2.Inputs
{
    ...
    public sealed class DnsKeySpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("algorithm")]
        public Input<Pulumi.GoogleNative.DNS.V1Beta2.DnsKeySpecAlgorithm>? Algorithm { get; set; }
        ...
        /// </summary>
        [Input("keyType")]
        public Input<Pulumi.GoogleNative.DNS.V1Beta2.DnsKeySpecKeyType>? KeyType { get; set; }
