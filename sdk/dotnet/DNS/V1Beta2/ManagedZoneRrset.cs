...
namespace Pulumi.GoogleCloud.DNS.V1Beta2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dns/v1beta2:ManagedZoneRrset")]
    public partial class ManagedZoneRrset : Pulumi.CustomResource
    {
        ...
        public ManagedZoneRrset(string name, ManagedZoneRrsetArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dns/v1beta2:ManagedZoneRrset", name, args ?? new ManagedZoneRrsetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedZoneRrset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dns/v1beta2:ManagedZoneRrset", name, null, MakeResourceOptions(options, id))
        {
        }
