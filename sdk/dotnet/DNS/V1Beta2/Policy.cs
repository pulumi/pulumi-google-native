...
namespace Pulumi.GcpNative.DNS.V1Beta2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dns/v1beta2:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dns/v1beta2:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dns/v1beta2:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
