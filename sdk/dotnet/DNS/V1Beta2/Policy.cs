...
namespace Pulumi.GoogleCloud.DNS.V1Beta2
{
    ...
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dns/v1beta2:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dns/v1beta2:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
