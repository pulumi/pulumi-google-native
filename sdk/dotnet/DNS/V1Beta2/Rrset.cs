...
namespace Pulumi.GoogleNative.DNS.V1Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dns/v1beta2:Rrset")]
    public partial class Rrset : Pulumi.CustomResource
    {
        ...
        public Rrset(string name, RrsetArgs args, CustomResourceOptions? options = null)
            : base("google-native:dns/v1beta2:Rrset", name, args ?? new RrsetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rrset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dns/v1beta2:Rrset", name, null, MakeResourceOptions(options, id))
        {
        }
