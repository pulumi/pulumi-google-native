...
namespace Pulumi.GoogleNative.DNS.V2
{
    public static class GetChange
    {
        ...
        public static Task<GetChangeResult> InvokeAsync(GetChangeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetChangeResult>("google-native:dns/v2:getChange", args ?? new GetChangeArgs(), options.WithDefaults());

        /// <summary>
        /// Fetches the representation of an existing Change.
        /// </summary>
        public static Output<GetChangeResult> Invoke(GetChangeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetChangeResult>("google-native:dns/v2:getChange", args ?? new GetChangeInvokeArgs(), options.WithDefaults());
    }
