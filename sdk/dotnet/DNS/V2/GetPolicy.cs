...
namespace Pulumi.GoogleNative.DNS.V2
{
    public static class GetPolicy
    {
        ...
        public static Task<GetPolicyResult> InvokeAsync(GetPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyResult>("google-native:dns/v2:getPolicy", args ?? new GetPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Fetches the representation of an existing Policy.
        /// </summary>
        public static Output<GetPolicyResult> Invoke(GetPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPolicyResult>("google-native:dns/v2:getPolicy", args ?? new GetPolicyInvokeArgs(), options.WithDefaults());
    }
