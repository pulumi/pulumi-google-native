...
namespace Pulumi.GoogleNative.DNS.V2.Inputs
{
    ...
    public sealed class ManagedZoneDnsSecConfigArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("nonExistence")]
        public Input<Pulumi.GoogleNative.DNS.V2.ManagedZoneDnsSecConfigNonExistence>? NonExistence { get; set; }

        /// <summary>
        /// Specifies whether DNSSEC is enabled, and what mode it is in.
        /// </summary>
        [Input("state")]
        public Input<Pulumi.GoogleNative.DNS.V2.ManagedZoneDnsSecConfigState>? State { get; set; }
