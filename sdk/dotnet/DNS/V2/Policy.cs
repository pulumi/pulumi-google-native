...
namespace Pulumi.GoogleNative.DNS.V2
{
    ...
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:dns/v2:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dns/v2:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
