...
namespace Pulumi.GoogleNative.DataCatalog.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:datacatalog/v1:EntryGroupIamMember")]
    public partial class EntryGroupIamMember : global::Pulumi.CustomResource
    {
        ...
        public EntryGroupIamMember(string name, EntryGroupIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:EntryGroupIamMember", name, args ?? new EntryGroupIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntryGroupIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:EntryGroupIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
