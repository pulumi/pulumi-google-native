...
namespace Pulumi.GoogleNative.DataCatalog.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:datacatalog/v1:EntryGroupIamPolicy")]
    public partial class EntryGroupIamPolicy : Pulumi.CustomResource
    {
        ...
        public EntryGroupIamPolicy(string name, EntryGroupIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:EntryGroupIamPolicy", name, args ?? new EntryGroupIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntryGroupIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:EntryGroupIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
