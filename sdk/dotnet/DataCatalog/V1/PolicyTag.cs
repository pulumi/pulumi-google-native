...
namespace Pulumi.GoogleNative.DataCatalog.V1
{
    ...
    public partial class PolicyTag : global::Pulumi.CustomResource
    {
        ...
        public PolicyTag(string name, PolicyTagArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:PolicyTag", name, args ?? new PolicyTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:PolicyTag", name, null, MakeResourceOptions(options, id))
        {
        }
