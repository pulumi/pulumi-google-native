...
namespace Pulumi.GoogleNative.DataCatalog.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:datacatalog/v1:TagTemplateIamBinding")]
    public partial class TagTemplateIamBinding : global::Pulumi.CustomResource
    {
        ...
        public TagTemplateIamBinding(string name, TagTemplateIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:TagTemplateIamBinding", name, args ?? new TagTemplateIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagTemplateIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:TagTemplateIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TagTemplateIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TagTemplateIamBinding(name, id, options);
        }
    }
