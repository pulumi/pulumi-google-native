...
namespace Pulumi.GoogleNative.DataCatalog.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:datacatalog/v1:TagTemplateIamPolicy")]
    public partial class TagTemplateIamPolicy : Pulumi.CustomResource
    {
        ...
        public TagTemplateIamPolicy(string name, TagTemplateIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:TagTemplateIamPolicy", name, args ?? new TagTemplateIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagTemplateIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:TagTemplateIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
