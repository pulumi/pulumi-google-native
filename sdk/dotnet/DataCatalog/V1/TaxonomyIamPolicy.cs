...
namespace Pulumi.GoogleNative.DataCatalog.V1
{
    ...
    public partial class TaxonomyIamPolicy : Pulumi.CustomResource
    {
        ...
        public TaxonomyIamPolicy(string name, TaxonomyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:TaxonomyIamPolicy", name, args ?? new TaxonomyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TaxonomyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1:TaxonomyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
