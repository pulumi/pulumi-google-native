...
namespace Pulumi.GoogleNative.DataCatalog.V1Beta1
{
    ...
    public partial class EntryGroupEntry : Pulumi.CustomResource
    {
        ...
        public EntryGroupEntry(string name, EntryGroupEntryArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1beta1:EntryGroupEntry", name, args ?? new EntryGroupEntryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntryGroupEntry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1beta1:EntryGroupEntry", name, null, MakeResourceOptions(options, id))
        {
        }
