...
namespace Pulumi.GoogleNative.DataCatalog.V1Beta1
{
    ...
    public partial class EntryGroupIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public EntryGroupIamPolicy(string name, EntryGroupIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1beta1:EntryGroupIamPolicy", name, args ?? new EntryGroupIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntryGroupIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1beta1:EntryGroupIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
