...
namespace Pulumi.GcpNative.DataCatalog.V1Beta1
{
    ...
    public partial class EntryGroupTag : Pulumi.CustomResource
    {
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EntryGroupTag Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new EntryGroupTag(name, id, options);
        }
    }

    public sealed class EntryGroupTagArgs : Pulumi.ResourceArgs
    {
        /// <summary>
