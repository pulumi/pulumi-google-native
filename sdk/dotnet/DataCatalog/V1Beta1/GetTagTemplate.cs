...
namespace Pulumi.GoogleNative.DataCatalog.V1Beta1
{
    public static class GetTagTemplate
    {
        ...
        public static Task<GetTagTemplateResult> InvokeAsync(GetTagTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagTemplateResult>("google-native:datacatalog/v1beta1:getTagTemplate", args ?? new GetTagTemplateArgs(), options.WithVersion());

        /// <summary>
        /// Gets a tag template.
        /// </summary>
        public static Output<GetTagTemplateResult> Invoke(GetTagTemplateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagTemplateResult>("google-native:datacatalog/v1beta1:getTagTemplate", args ?? new GetTagTemplateInvokeArgs(), options.WithVersion());
    }
