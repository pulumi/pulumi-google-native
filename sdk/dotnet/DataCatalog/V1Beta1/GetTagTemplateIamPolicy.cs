...
namespace Pulumi.GoogleNative.DataCatalog.V1Beta1
{
    public static class GetTagTemplateIamPolicy
    {
        ...
        public static Task<GetTagTemplateIamPolicyResult> InvokeAsync(GetTagTemplateIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagTemplateIamPolicyResult>("google-native:datacatalog/v1beta1:getTagTemplateIamPolicy", args ?? new GetTagTemplateIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetTagTemplateIamPolicyResult> Invoke(GetTagTemplateIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagTemplateIamPolicyResult>("google-native:datacatalog/v1beta1:getTagTemplateIamPolicy", args ?? new GetTagTemplateIamPolicyInvokeArgs(), options.WithDefaults());
    }
