...
{
    public static class GetTaxonomyPolicyTagIamPolicy
    {
        /// <summary>
        ...
        public static Task<GetTaxonomyPolicyTagIamPolicyResult> InvokeAsync(GetTaxonomyPolicyTagIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTaxonomyPolicyTagIamPolicyResult>("google-native:datacatalog/v1beta1:getTaxonomyPolicyTagIamPolicy", args ?? new GetTaxonomyPolicyTagIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetTaxonomyPolicyTagIamPolicyResult> Invoke(GetTaxonomyPolicyTagIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTaxonomyPolicyTagIamPolicyResult>("google-native:datacatalog/v1beta1:getTaxonomyPolicyTagIamPolicy", args ?? new GetTaxonomyPolicyTagIamPolicyInvokeArgs(), options.WithVersion());
    }
    ...
    [OutputType]
    public sealed class GetTaxonomyPolicyTagIamPolicyResult
    {
        /// <summary>
