...
namespace Pulumi.GoogleNative.DataCatalog.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:datacatalog/v1beta1:TagTemplateIamBinding")]
    public partial class TagTemplateIamBinding : global::Pulumi.CustomResource
    {
        ...
        public TagTemplateIamBinding(string name, TagTemplateIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1beta1:TagTemplateIamBinding", name, args ?? new TagTemplateIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagTemplateIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datacatalog/v1beta1:TagTemplateIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
