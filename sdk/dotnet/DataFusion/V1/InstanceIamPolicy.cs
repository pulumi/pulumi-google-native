...
namespace Pulumi.GcpNative.DataFusion.V1
{
    /// <summary>
    /// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
    /// </summary>
    [GcpNativeResourceType("google-native:datafusion/v1:InstanceIamPolicy")]
    public partial class InstanceIamPolicy : Pulumi.CustomResource
    {
        ...
        public InstanceIamPolicy(string name, InstanceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:datafusion/v1:InstanceIamPolicy", name, args ?? new InstanceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datafusion/v1:InstanceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
