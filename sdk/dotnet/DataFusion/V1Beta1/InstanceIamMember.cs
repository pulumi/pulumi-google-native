...
namespace Pulumi.GoogleNative.DataFusion.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:datafusion/v1beta1:InstanceIamMember")]
    public partial class InstanceIamMember : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamMember(string name, InstanceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:datafusion/v1beta1:InstanceIamMember", name, args ?? new InstanceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datafusion/v1beta1:InstanceIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
