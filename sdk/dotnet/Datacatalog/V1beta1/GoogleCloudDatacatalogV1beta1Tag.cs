...
namespace Pulumi.GoogleCloud.Datacatalog.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:datacatalog/v1beta1:GoogleCloudDatacatalogV1beta1Tag")]
    public partial class GoogleCloudDatacatalogV1beta1Tag : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleCloudDatacatalogV1beta1Tag(string name, GoogleCloudDatacatalogV1beta1TagArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:datacatalog/v1beta1:GoogleCloudDatacatalogV1beta1Tag", name, args ?? new GoogleCloudDatacatalogV1beta1TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudDatacatalogV1beta1Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:datacatalog/v1beta1:GoogleCloudDatacatalogV1beta1Tag", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudDatacatalogV1beta1Tag Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudDatacatalogV1beta1Tag(name, id, options);
        }
    }

    public sealed class GoogleCloudDatacatalogV1beta1TagArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GoogleCloudDatacatalogV1beta1TagArgs()
        {
        }
    }
}
