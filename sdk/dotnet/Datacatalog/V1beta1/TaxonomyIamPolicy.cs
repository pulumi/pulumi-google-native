...
namespace Pulumi.GoogleCloud.Datacatalog.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:datacatalog/v1beta1:TaxonomyIamPolicy")]
    public partial class TaxonomyIamPolicy : Pulumi.CustomResource
    {
        ...
        public TaxonomyIamPolicy(string name, TaxonomyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:datacatalog/v1beta1:TaxonomyIamPolicy", name, args ?? new TaxonomyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TaxonomyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:datacatalog/v1beta1:TaxonomyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TaxonomyIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
