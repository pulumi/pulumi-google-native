...
namespace Pulumi.GoogleCloud.Datacatalog.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:datacatalog/v1beta1:TaxonomyPolicyTag")]
    public partial class TaxonomyPolicyTag : Pulumi.CustomResource
    {
        ...
        public TaxonomyPolicyTag(string name, TaxonomyPolicyTagArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:datacatalog/v1beta1:TaxonomyPolicyTag", name, args ?? new TaxonomyPolicyTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TaxonomyPolicyTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:datacatalog/v1beta1:TaxonomyPolicyTag", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TaxonomyPolicyTag Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TaxonomyPolicyTag(name, id, options);
        }
    }
