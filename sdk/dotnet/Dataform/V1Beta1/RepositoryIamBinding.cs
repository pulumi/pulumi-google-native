...
namespace Pulumi.GoogleNative.Dataform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dataform/v1beta1:RepositoryIamBinding")]
    public partial class RepositoryIamBinding : global::Pulumi.CustomResource
    {
        ...
        public RepositoryIamBinding(string name, RepositoryIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataform/v1beta1:RepositoryIamBinding", name, args ?? new RepositoryIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RepositoryIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataform/v1beta1:RepositoryIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RepositoryIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RepositoryIamBinding(name, id, options);
        }
    }
