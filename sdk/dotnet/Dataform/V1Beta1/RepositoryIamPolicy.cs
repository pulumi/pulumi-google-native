...
namespace Pulumi.GoogleNative.Dataform.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dataform/v1beta1:RepositoryIamPolicy")]
    public partial class RepositoryIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public RepositoryIamPolicy(string name, RepositoryIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataform/v1beta1:RepositoryIamPolicy", name, args ?? new RepositoryIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RepositoryIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataform/v1beta1:RepositoryIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
