...
namespace Pulumi.GoogleCloud.Datalabeling.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:datalabeling/v1beta1:DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage")]
    public partial class DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage : Pulumi.CustomResource
    {
        ...
        public DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage(string name, DatasetAnnotatedDatasetFeedbackThreadFeedbackMessageArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:datalabeling/v1beta1:DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage", name, args ?? new DatasetAnnotatedDatasetFeedbackThreadFeedbackMessageArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:datalabeling/v1beta1:DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage", name, null, MakeResourceOptions(options, id))
        {
        }
