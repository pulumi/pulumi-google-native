...
namespace Pulumi.GoogleNative.Datamigration.V1
{
    public static class GetConnectionProfileIamPolicy
    {
        ...
        public static Task<GetConnectionProfileIamPolicyResult> InvokeAsync(GetConnectionProfileIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectionProfileIamPolicyResult>("google-native:datamigration/v1:getConnectionProfileIamPolicy", args ?? new GetConnectionProfileIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetConnectionProfileIamPolicyResult> Invoke(GetConnectionProfileIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectionProfileIamPolicyResult>("google-native:datamigration/v1:getConnectionProfileIamPolicy", args ?? new GetConnectionProfileIamPolicyInvokeArgs(), options.WithDefaults());
    }
