...
namespace Pulumi.GoogleCloud.Datamigration.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:datamigration/v1:MigrationJobIamPolicy")]
    public partial class MigrationJobIamPolicy : Pulumi.CustomResource
    {
        ...
        public MigrationJobIamPolicy(string name, MigrationJobIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:datamigration/v1:MigrationJobIamPolicy", name, args ?? new MigrationJobIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MigrationJobIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:datamigration/v1:MigrationJobIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
