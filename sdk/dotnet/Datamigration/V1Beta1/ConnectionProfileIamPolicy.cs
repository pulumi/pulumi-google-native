...
namespace Pulumi.GoogleCloud.Datamigration.V1Beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:datamigration/v1beta1:ConnectionProfileIamPolicy")]
    public partial class ConnectionProfileIamPolicy : Pulumi.CustomResource
    {
        ...
        public ConnectionProfileIamPolicy(string name, ConnectionProfileIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:datamigration/v1beta1:ConnectionProfileIamPolicy", name, args ?? new ConnectionProfileIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionProfileIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:datamigration/v1beta1:ConnectionProfileIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
