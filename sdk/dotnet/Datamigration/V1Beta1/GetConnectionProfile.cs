...
namespace Pulumi.GoogleNative.Datamigration.V1Beta1
{
    public static class GetConnectionProfile
    {
        ...
        public static Task<GetConnectionProfileResult> InvokeAsync(GetConnectionProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectionProfileResult>("google-native:datamigration/v1beta1:getConnectionProfile", args ?? new GetConnectionProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single connection profile.
        /// </summary>
        public static Output<GetConnectionProfileResult> Invoke(GetConnectionProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectionProfileResult>("google-native:datamigration/v1beta1:getConnectionProfile", args ?? new GetConnectionProfileInvokeArgs(), options.WithDefaults());
    }
