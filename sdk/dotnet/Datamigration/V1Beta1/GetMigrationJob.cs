...
namespace Pulumi.GoogleNative.Datamigration.V1Beta1
{
    public static class GetMigrationJob
    {
        ...
        public static Task<GetMigrationJobResult> InvokeAsync(GetMigrationJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMigrationJobResult>("google-native:datamigration/v1beta1:getMigrationJob", args ?? new GetMigrationJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single migration job.
        /// </summary>
        public static Output<GetMigrationJobResult> Invoke(GetMigrationJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMigrationJobResult>("google-native:datamigration/v1beta1:getMigrationJob", args ?? new GetMigrationJobInvokeArgs(), options.WithDefaults());
    }
