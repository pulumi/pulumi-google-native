...
namespace Pulumi.GoogleNative.Dataplex.V1
{
    ...
    public partial class Content : global::Pulumi.CustomResource
    {
        ...
        public Content(string name, ContentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:Content", name, args ?? new ContentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Content(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:Content", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Content Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
