...
namespace Pulumi.GoogleNative.Dataplex.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dataplex/v1:DataScanIamMember")]
    public partial class DataScanIamMember : global::Pulumi.CustomResource
    {
        ...
        public DataScanIamMember(string name, DataScanIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:DataScanIamMember", name, args ?? new DataScanIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataScanIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:DataScanIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataScanIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DataScanIamMember(name, id, options);
        }
    }
