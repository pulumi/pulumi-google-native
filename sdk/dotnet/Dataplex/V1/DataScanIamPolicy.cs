...
namespace Pulumi.GoogleNative.Dataplex.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dataplex/v1:DataScanIamPolicy")]
    public partial class DataScanIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public DataScanIamPolicy(string name, DataScanIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:DataScanIamPolicy", name, args ?? new DataScanIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataScanIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:DataScanIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataScanIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DataScanIamPolicy(name, id, options);
        }
    }
