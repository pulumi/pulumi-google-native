...
namespace Pulumi.GoogleNative.Dataplex.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dataplex/v1:EntryGroupIamMember")]
    public partial class EntryGroupIamMember : global::Pulumi.CustomResource
    {
        ...
        public EntryGroupIamMember(string name, EntryGroupIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:EntryGroupIamMember", name, args ?? new EntryGroupIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntryGroupIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:EntryGroupIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
