...
namespace Pulumi.GoogleNative.Dataplex.V1
{
    public static class GetAspectTypeIamPolicy
    {
        ...
        public static Task<GetAspectTypeIamPolicyResult> InvokeAsync(GetAspectTypeIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAspectTypeIamPolicyResult>("google-native:dataplex/v1:getAspectTypeIamPolicy", args ?? new GetAspectTypeIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetAspectTypeIamPolicyResult> Invoke(GetAspectTypeIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAspectTypeIamPolicyResult>("google-native:dataplex/v1:getAspectTypeIamPolicy", args ?? new GetAspectTypeIamPolicyInvokeArgs(), options.WithDefaults());
    }
