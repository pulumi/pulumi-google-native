...
namespace Pulumi.GoogleNative.Dataplex.V1
{
    public static class GetEntryTypeIamPolicy
    {
        ...
        public static Task<GetEntryTypeIamPolicyResult> InvokeAsync(GetEntryTypeIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEntryTypeIamPolicyResult>("google-native:dataplex/v1:getEntryTypeIamPolicy", args ?? new GetEntryTypeIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetEntryTypeIamPolicyResult> Invoke(GetEntryTypeIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEntryTypeIamPolicyResult>("google-native:dataplex/v1:getEntryTypeIamPolicy", args ?? new GetEntryTypeIamPolicyInvokeArgs(), options.WithDefaults());
    }
