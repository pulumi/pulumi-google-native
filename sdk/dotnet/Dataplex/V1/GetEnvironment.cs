...
namespace Pulumi.GoogleNative.Dataplex.V1
{
    public static class GetEnvironment
    {
        ...
        public static Task<GetEnvironmentResult> InvokeAsync(GetEnvironmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentResult>("google-native:dataplex/v1:getEnvironment", args ?? new GetEnvironmentArgs(), options.WithDefaults());

        /// <summary>
        /// Get environment resource.
        /// </summary>
        public static Output<GetEnvironmentResult> Invoke(GetEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEnvironmentResult>("google-native:dataplex/v1:getEnvironment", args ?? new GetEnvironmentInvokeArgs(), options.WithDefaults());
    }
