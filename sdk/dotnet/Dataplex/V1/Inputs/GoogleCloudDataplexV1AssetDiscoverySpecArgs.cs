...
namespace Pulumi.GoogleNative.Dataplex.V1.Inputs
{
    ...
    public sealed class GoogleCloudDataplexV1AssetDiscoverySpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("csvOptions")]
        public Input<Inputs.GoogleCloudDataplexV1AssetDiscoverySpecCsvOptionsArgs>? CsvOptions { get; set; }
        ...
        /// </summary>
        [Input("jsonOptions")]
        public Input<Inputs.GoogleCloudDataplexV1AssetDiscoverySpecJsonOptionsArgs>? JsonOptions { get; set; }
