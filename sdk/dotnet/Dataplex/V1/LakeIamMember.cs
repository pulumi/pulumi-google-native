...
namespace Pulumi.GoogleNative.Dataplex.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:dataplex/v1:LakeIamMember")]
    public partial class LakeIamMember : global::Pulumi.CustomResource
    {
        ...
        public LakeIamMember(string name, LakeIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:LakeIamMember", name, args ?? new LakeIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LakeIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataplex/v1:LakeIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LakeIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new LakeIamMember(name, id, options);
        }
    }
