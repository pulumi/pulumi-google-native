...
namespace Pulumi.GoogleNative.Dataplex.V1.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudDataplexV1DataQualitySpecPostScanActionsBigQueryExportResponse
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GoogleCloudDataplexV1DataQualitySpecPostScanActionsBigQueryExportResponse(string resultsTable)
        {
