...
namespace Pulumi.GcpNative.Dataproc.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dataproc/v1:AutoscalingPolicy")]
    public partial class AutoscalingPolicy : Pulumi.CustomResource
    {
        ...
        public AutoscalingPolicy(string name, AutoscalingPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dataproc/v1:AutoscalingPolicy", name, args ?? new AutoscalingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoscalingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dataproc/v1:AutoscalingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
