...
namespace Pulumi.GoogleNative.Dataproc.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dataproc/v1:AutoscalingPolicyIamMember")]
    public partial class AutoscalingPolicyIamMember : global::Pulumi.CustomResource
    {
        ...
        public AutoscalingPolicyIamMember(string name, AutoscalingPolicyIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataproc/v1:AutoscalingPolicyIamMember", name, args ?? new AutoscalingPolicyIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoscalingPolicyIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataproc/v1:AutoscalingPolicyIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AutoscalingPolicyIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new AutoscalingPolicyIamMember(name, id, options);
        }
    }
