...
namespace Pulumi.GoogleNative.Dataproc.V1
{
    public static class GetAutoscalingPolicy
    {
        ...
        public static Task<GetAutoscalingPolicyResult> InvokeAsync(GetAutoscalingPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutoscalingPolicyResult>("google-native:dataproc/v1:getAutoscalingPolicy", args ?? new GetAutoscalingPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves autoscaling policy.
        /// </summary>
        public static Output<GetAutoscalingPolicyResult> Invoke(GetAutoscalingPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAutoscalingPolicyResult>("google-native:dataproc/v1:getAutoscalingPolicy", args ?? new GetAutoscalingPolicyInvokeArgs(), options.WithDefaults());
    }
