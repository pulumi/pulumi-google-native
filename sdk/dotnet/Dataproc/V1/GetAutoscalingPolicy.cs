...
namespace Pulumi.GoogleNative.Dataproc.V1
{
    public static class GetAutoscalingPolicy
    {
        ...
        public static Output<GetAutoscalingPolicyResult> Invoke(GetAutoscalingPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAutoscalingPolicyResult>("google-native:dataproc/v1:getAutoscalingPolicy", args ?? new GetAutoscalingPolicyInvokeArgs(), options.WithVersion());
    }
