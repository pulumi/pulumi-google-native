...
namespace Pulumi.GoogleNative.Dataproc.V1
{
    public static class GetRegionClusterIamPolicy
    {
        ...
        public static Task<GetRegionClusterIamPolicyResult> InvokeAsync(GetRegionClusterIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionClusterIamPolicyResult>("google-native:dataproc/v1:getRegionClusterIamPolicy", args ?? new GetRegionClusterIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetRegionClusterIamPolicyResult> Invoke(GetRegionClusterIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionClusterIamPolicyResult>("google-native:dataproc/v1:getRegionClusterIamPolicy", args ?? new GetRegionClusterIamPolicyInvokeArgs(), options.WithVersion());
    }
