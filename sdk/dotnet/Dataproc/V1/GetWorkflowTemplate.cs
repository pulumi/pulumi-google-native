...
namespace Pulumi.GoogleNative.Dataproc.V1
{
    public static class GetWorkflowTemplate
    {
        ...
        public static Task<GetWorkflowTemplateResult> InvokeAsync(GetWorkflowTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkflowTemplateResult>("google-native:dataproc/v1:getWorkflowTemplate", args ?? new GetWorkflowTemplateArgs(), options.WithVersion());

        /// <summary>
        /// Retrieves the latest workflow template.Can retrieve previously instantiated template by specifying optional version parameter.
        /// </summary>
        public static Output<GetWorkflowTemplateResult> Invoke(GetWorkflowTemplateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWorkflowTemplateResult>("google-native:dataproc/v1:getWorkflowTemplate", args ?? new GetWorkflowTemplateInvokeArgs(), options.WithVersion());
    }
