...
namespace Pulumi.GoogleNative.Dataproc.V1
{
    public static class GetWorkflowTemplateIamPolicy
    {
        ...
        public static Task<GetWorkflowTemplateIamPolicyResult> InvokeAsync(GetWorkflowTemplateIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkflowTemplateIamPolicyResult>("google-native:dataproc/v1:getWorkflowTemplateIamPolicy", args ?? new GetWorkflowTemplateIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkflowTemplateIamPolicyResult> Invoke(GetWorkflowTemplateIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkflowTemplateIamPolicyResult>("google-native:dataproc/v1:getWorkflowTemplateIamPolicy", args ?? new GetWorkflowTemplateIamPolicyInvokeArgs(), options.WithDefaults());
    }
