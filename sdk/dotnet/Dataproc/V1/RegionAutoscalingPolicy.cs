...
namespace Pulumi.GoogleCloud.Dataproc.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dataproc/v1:RegionAutoscalingPolicy")]
    public partial class RegionAutoscalingPolicy : Pulumi.CustomResource
    {
        ...
        public RegionAutoscalingPolicy(string name, RegionAutoscalingPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1:RegionAutoscalingPolicy", name, args ?? new RegionAutoscalingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionAutoscalingPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1:RegionAutoscalingPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
