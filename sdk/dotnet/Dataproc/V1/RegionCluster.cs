...
namespace Pulumi.GcpNative.Dataproc.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dataproc/v1:RegionCluster")]
    public partial class RegionCluster : Pulumi.CustomResource
    {
        ...
        public RegionCluster(string name, RegionClusterArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dataproc/v1:RegionCluster", name, args ?? new RegionClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dataproc/v1:RegionCluster", name, null, MakeResourceOptions(options, id))
        {
        }
