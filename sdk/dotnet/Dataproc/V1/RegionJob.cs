...
namespace Pulumi.GcpNative.Dataproc.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dataproc/v1:RegionJob")]
    public partial class RegionJob : Pulumi.CustomResource
    {
        ...
        public RegionJob(string name, RegionJobArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dataproc/v1:RegionJob", name, args ?? new RegionJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dataproc/v1:RegionJob", name, null, MakeResourceOptions(options, id))
        {
        }
