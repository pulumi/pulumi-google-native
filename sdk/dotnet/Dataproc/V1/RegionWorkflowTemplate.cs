...
namespace Pulumi.GoogleNative.Dataproc.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dataproc/v1:RegionWorkflowTemplate")]
    public partial class RegionWorkflowTemplate : Pulumi.CustomResource
    {
        ...
        public RegionWorkflowTemplate(string name, RegionWorkflowTemplateArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataproc/v1:RegionWorkflowTemplate", name, args ?? new RegionWorkflowTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionWorkflowTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataproc/v1:RegionWorkflowTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
