...
namespace Pulumi.GcpNative.Dataproc.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dataproc/v1:RegionWorkflowTemplate")]
    public partial class RegionWorkflowTemplate : Pulumi.CustomResource
    {
        ...
        public RegionWorkflowTemplate(string name, RegionWorkflowTemplateArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dataproc/v1:RegionWorkflowTemplate", name, args ?? new RegionWorkflowTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionWorkflowTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dataproc/v1:RegionWorkflowTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
