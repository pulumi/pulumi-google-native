...
namespace Pulumi.GoogleCloud.Dataproc.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dataproc/v1:WorkflowTemplate")]
    public partial class WorkflowTemplate : Pulumi.CustomResource
    {
        ...
        public WorkflowTemplate(string name, WorkflowTemplateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1:WorkflowTemplate", name, args ?? new WorkflowTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkflowTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1:WorkflowTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
