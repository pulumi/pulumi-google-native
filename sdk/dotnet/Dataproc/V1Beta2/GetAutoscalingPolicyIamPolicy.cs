...
namespace Pulumi.GoogleNative.Dataproc.V1Beta2
{
    public static class GetAutoscalingPolicyIamPolicy
    {
        ...
        public static Task<GetAutoscalingPolicyIamPolicyResult> InvokeAsync(GetAutoscalingPolicyIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutoscalingPolicyIamPolicyResult>("google-native:dataproc/v1beta2:getAutoscalingPolicyIamPolicy", args ?? new GetAutoscalingPolicyIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetAutoscalingPolicyIamPolicyResult> Invoke(GetAutoscalingPolicyIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAutoscalingPolicyIamPolicyResult>("google-native:dataproc/v1beta2:getAutoscalingPolicyIamPolicy", args ?? new GetAutoscalingPolicyIamPolicyInvokeArgs(), options.WithVersion());
    }


    public sealed class GetAutoscalingPolicyIamPolicyArgs : Pulumi.InvokeArgs
    {
    ...
    public sealed class GetAutoscalingPolicyIamPolicyInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("autoscalingPolicyId", required: true)]
