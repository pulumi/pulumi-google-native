...
namespace Pulumi.GoogleNative.Dataproc.V1Beta2
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("google-native:dataproc/v1beta2:getJob", args ?? new GetJobArgs(), options.WithVersion());

        /// <summary>
        /// Gets the resource representation for a job in a project.
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetJobResult>("google-native:dataproc/v1beta2:getJob", args ?? new GetJobInvokeArgs(), options.WithVersion());
    }
