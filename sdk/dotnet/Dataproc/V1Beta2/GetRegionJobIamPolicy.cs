...
{
    public static class GetRegionJobIamPolicy
    {
        /// <summary>
        ...
        public static Task<GetRegionJobIamPolicyResult> InvokeAsync(GetRegionJobIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegionJobIamPolicyResult>("google-native:dataproc/v1beta2:getRegionJobIamPolicy", args ?? new GetRegionJobIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetRegionJobIamPolicyResult> Invoke(GetRegionJobIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegionJobIamPolicyResult>("google-native:dataproc/v1beta2:getRegionJobIamPolicy", args ?? new GetRegionJobIamPolicyInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetRegionJobIamPolicyResult
    {
        /// <summary>
