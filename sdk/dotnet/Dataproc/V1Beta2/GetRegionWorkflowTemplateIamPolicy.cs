...
namespace Pulumi.GoogleNative.Dataproc.V1Beta2
{
    public static class GetRegionWorkflowTemplateIamPolicy
    {
        ...
        public static Task<GetRegionWorkflowTemplateIamPolicyResult> InvokeAsync(GetRegionWorkflowTemplateIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionWorkflowTemplateIamPolicyResult>("google-native:dataproc/v1beta2:getRegionWorkflowTemplateIamPolicy", args ?? new GetRegionWorkflowTemplateIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetRegionWorkflowTemplateIamPolicyResult> Invoke(GetRegionWorkflowTemplateIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegionWorkflowTemplateIamPolicyResult>("google-native:dataproc/v1beta2:getRegionWorkflowTemplateIamPolicy", args ?? new GetRegionWorkflowTemplateIamPolicyInvokeArgs(), options.WithDefaults());
    }
