...
namespace Pulumi.GoogleNative.Dataproc.V1Beta2
{
    ...
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("google-native:dataproc/v1beta2:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dataproc/v1beta2:Job", name, null, MakeResourceOptions(options, id))
        {
        }
