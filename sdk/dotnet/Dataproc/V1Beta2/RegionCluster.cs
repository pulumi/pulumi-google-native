...
namespace Pulumi.GoogleCloud.Dataproc.V1Beta2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dataproc/v1beta2:RegionCluster")]
    public partial class RegionCluster : Pulumi.CustomResource
    {
        ...
        public RegionCluster(string name, RegionClusterArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1beta2:RegionCluster", name, args ?? new RegionClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1beta2:RegionCluster", name, null, MakeResourceOptions(options, id))
        {
        }
