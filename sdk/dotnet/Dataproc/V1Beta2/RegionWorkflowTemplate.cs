...
namespace Pulumi.GoogleCloud.Dataproc.V1Beta2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dataproc/v1beta2:RegionWorkflowTemplate")]
    public partial class RegionWorkflowTemplate : Pulumi.CustomResource
    {
        ...
        public RegionWorkflowTemplate(string name, RegionWorkflowTemplateArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1beta2:RegionWorkflowTemplate", name, args ?? new RegionWorkflowTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionWorkflowTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1beta2:RegionWorkflowTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
