...
namespace Pulumi.GoogleCloud.Dataproc.V1beta2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dataproc/v1beta2:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1beta2:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dataproc/v1beta2:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
