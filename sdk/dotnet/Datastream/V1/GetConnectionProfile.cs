...
namespace Pulumi.GoogleNative.Datastream.V1
{
    public static class GetConnectionProfile
    {
        ...
        public static Task<GetConnectionProfileResult> InvokeAsync(GetConnectionProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectionProfileResult>("google-native:datastream/v1:getConnectionProfile", args ?? new GetConnectionProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Use this method to get details about a connection profile.
        /// </summary>
        public static Output<GetConnectionProfileResult> Invoke(GetConnectionProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectionProfileResult>("google-native:datastream/v1:getConnectionProfile", args ?? new GetConnectionProfileInvokeArgs(), options.WithDefaults());
    }
