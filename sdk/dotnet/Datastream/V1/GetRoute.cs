...
namespace Pulumi.GoogleNative.Datastream.V1
{
    public static class GetRoute
    {
        ...
        public static Task<GetRouteResult> InvokeAsync(GetRouteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRouteResult>("google-native:datastream/v1:getRoute", args ?? new GetRouteArgs(), options.WithDefaults());

        /// <summary>
        /// Use this method to get details about a route.
        /// </summary>
        public static Output<GetRouteResult> Invoke(GetRouteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRouteResult>("google-native:datastream/v1:getRoute", args ?? new GetRouteInvokeArgs(), options.WithDefaults());
    }
