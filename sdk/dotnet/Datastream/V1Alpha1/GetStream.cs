...
namespace Pulumi.GoogleNative.Datastream.V1Alpha1
{
    public static class GetStream
    {
        ...
        public static Task<GetStreamResult> InvokeAsync(GetStreamArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamResult>("google-native:datastream/v1alpha1:getStream", args ?? new GetStreamArgs(), options.WithVersion());

        /// <summary>
        /// Use this method to get details about a stream.
        /// </summary>
        public static Output<GetStreamResult> Invoke(GetStreamInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStreamResult>("google-native:datastream/v1alpha1:getStream", args ?? new GetStreamInvokeArgs(), options.WithVersion());
    }
