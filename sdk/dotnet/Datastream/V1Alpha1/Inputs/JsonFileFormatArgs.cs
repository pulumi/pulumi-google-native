...
namespace Pulumi.GoogleNative.Datastream.V1Alpha1.Inputs
{
    ...
    public sealed class JsonFileFormatArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("compression")]
        public Input<Pulumi.GoogleNative.Datastream.V1Alpha1.JsonFileFormatCompression>? Compression { get; set; }

        /// <summary>
        /// The schema file format along JSON data files.
        /// </summary>
        [Input("schemaFileFormat")]
        public Input<Pulumi.GoogleNative.Datastream.V1Alpha1.JsonFileFormatSchemaFileFormat>? SchemaFileFormat { get; set; }
