...
namespace Pulumi.GoogleNative.Datastream.V1Alpha1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:datastream/v1alpha1:Stream")]
    public partial class Stream : global::Pulumi.CustomResource
    {
        ...
        public Stream(string name, StreamArgs args, CustomResourceOptions? options = null)
            : base("google-native:datastream/v1alpha1:Stream", name, args ?? new StreamArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Stream(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:datastream/v1alpha1:Stream", name, null, MakeResourceOptions(options, id))
        {
        }
