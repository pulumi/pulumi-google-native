...
namespace Pulumi.GoogleNative.DeploymentManager.Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:deploymentmanager/alpha:DeploymentIamPolicy")]
    public partial class DeploymentIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DeploymentIamPolicy(string name, DeploymentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:deploymentmanager/alpha:DeploymentIamPolicy", name, args ?? new DeploymentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:deploymentmanager/alpha:DeploymentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DeploymentIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DeploymentIamPolicy(name, id, options);
        }
    }

    public sealed class DeploymentIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new DeploymentIamPolicyArgs Empty => new DeploymentIamPolicyArgs();
    }
}
