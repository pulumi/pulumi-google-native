...
namespace Pulumi.GoogleNative.DeploymentManager.Alpha
{
    public static class GetDeployment
    {
        ...
        public static Task<GetDeploymentResult> InvokeAsync(GetDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentResult>("google-native:deploymentmanager/alpha:getDeployment", args ?? new GetDeploymentArgs(), options.WithVersion());

        /// <summary>
        /// Gets information about a specific deployment.
        /// </summary>
        public static Output<GetDeploymentResult> Invoke(GetDeploymentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDeploymentResult>("google-native:deploymentmanager/alpha:getDeployment", args ?? new GetDeploymentInvokeArgs(), options.WithVersion());
    }
