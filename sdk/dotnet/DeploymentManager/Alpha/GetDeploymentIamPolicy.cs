...
namespace Pulumi.GoogleNative.DeploymentManager.Alpha
{
    public static class GetDeploymentIamPolicy
    {
        ...
        public static Task<GetDeploymentIamPolicyResult> InvokeAsync(GetDeploymentIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentIamPolicyResult>("google-native:deploymentmanager/alpha:getDeploymentIamPolicy", args ?? new GetDeploymentIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetDeploymentIamPolicyResult> Invoke(GetDeploymentIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDeploymentIamPolicyResult>("google-native:deploymentmanager/alpha:getDeploymentIamPolicy", args ?? new GetDeploymentIamPolicyInvokeArgs(), options.WithVersion());
    }
