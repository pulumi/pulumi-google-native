...
namespace Pulumi.GoogleNative.DeploymentManager.V2
{
    ...
    public partial class DeploymentIamPolicy : Pulumi.CustomResource
    {
        ...
        public DeploymentIamPolicy(string name, DeploymentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:deploymentmanager/v2:DeploymentIamPolicy", name, args ?? new DeploymentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:deploymentmanager/v2:DeploymentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
