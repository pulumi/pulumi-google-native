...
namespace Pulumi.GcpNative.DeploymentManager.V2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:deploymentmanager/v2:DeploymentIamPolicy")]
    public partial class DeploymentIamPolicy : Pulumi.CustomResource
    {
        ...
        public DeploymentIamPolicy(string name, DeploymentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:deploymentmanager/v2:DeploymentIamPolicy", name, args ?? new DeploymentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:deploymentmanager/v2:DeploymentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
