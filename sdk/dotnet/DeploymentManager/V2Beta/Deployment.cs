...
namespace Pulumi.GcpNative.DeploymentManager.V2Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:deploymentmanager/v2beta:Deployment")]
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:deploymentmanager/v2beta:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:deploymentmanager/v2beta:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
