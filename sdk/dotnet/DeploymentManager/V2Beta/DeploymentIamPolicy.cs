...
namespace Pulumi.GoogleNative.DeploymentManager.V2Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:deploymentmanager/v2beta:DeploymentIamPolicy")]
    public partial class DeploymentIamPolicy : Pulumi.CustomResource
    {
        ...
        public DeploymentIamPolicy(string name, DeploymentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:deploymentmanager/v2beta:DeploymentIamPolicy", name, args ?? new DeploymentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:deploymentmanager/v2beta:DeploymentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
