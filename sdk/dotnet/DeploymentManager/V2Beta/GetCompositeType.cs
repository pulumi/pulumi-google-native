...
namespace Pulumi.GoogleNative.DeploymentManager.V2Beta
{
    public static class GetCompositeType
    {
        ...
        public static Task<GetCompositeTypeResult> InvokeAsync(GetCompositeTypeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCompositeTypeResult>("google-native:deploymentmanager/v2beta:getCompositeType", args ?? new GetCompositeTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a specific composite type.
        /// </summary>
        public static Output<GetCompositeTypeResult> Invoke(GetCompositeTypeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCompositeTypeResult>("google-native:deploymentmanager/v2beta:getCompositeType", args ?? new GetCompositeTypeInvokeArgs(), options.WithDefaults());
    }
