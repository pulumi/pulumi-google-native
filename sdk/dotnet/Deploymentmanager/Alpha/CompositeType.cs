...
namespace Pulumi.GoogleCloud.Deploymentmanager.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:deploymentmanager/alpha:CompositeType")]
    public partial class CompositeType : Pulumi.CustomResource
    {
        ...
        public CompositeType(string name, CompositeTypeArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/alpha:CompositeType", name, args ?? new CompositeTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CompositeType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/alpha:CompositeType", name, null, MakeResourceOptions(options, id))
        {
        }
