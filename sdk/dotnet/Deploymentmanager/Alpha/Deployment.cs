...
namespace Pulumi.GoogleCloud.Deploymentmanager.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:deploymentmanager/alpha:Deployment")]
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/alpha:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/alpha:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeploymentArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("outputs")]
        private InputList<Inputs.DeploymentOutputEntryArgs>? _outputs;

        /// <summary>
        /// List of outputs from the last manifest that deployed successfully.
        /// </summary>
        public InputList<Inputs.DeploymentOutputEntryArgs> Outputs
        {
