...
namespace Pulumi.GoogleCloud.Deploymentmanager.Alpha
{
    /// <summary>
    /// Sets the access control policy on the specified resource. Replaces any existing policy.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:deploymentmanager/alpha:DeploymentIamPolicy")]
    public partial class DeploymentIamPolicy : Pulumi.CustomResource
    {
        ...
        public DeploymentIamPolicy(string name, DeploymentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/alpha:DeploymentIamPolicy", name, args ?? new DeploymentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/alpha:DeploymentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeploymentIamPolicyArgs : Pulumi.ResourceArgs
    {
        [Input("bindings")]
