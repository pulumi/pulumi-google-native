...
namespace Pulumi.GoogleCloud.Deploymentmanager.Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:deploymentmanager/alpha:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/alpha:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/alpha:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
