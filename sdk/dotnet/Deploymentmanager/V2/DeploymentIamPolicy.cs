...
namespace Pulumi.GoogleCloud.Deploymentmanager.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:deploymentmanager/v2:DeploymentIamPolicy")]
    public partial class DeploymentIamPolicy : Pulumi.CustomResource
    {
        ...
        public DeploymentIamPolicy(string name, DeploymentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/v2:DeploymentIamPolicy", name, args ?? new DeploymentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/v2:DeploymentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
