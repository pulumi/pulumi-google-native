...
namespace Pulumi.GoogleCloud.Deploymentmanager.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:deploymentmanager/v2:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/v2:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/v2:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
