...
namespace Pulumi.GoogleCloud.Deploymentmanager.V2beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:deploymentmanager/v2beta:Deployment")]
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/v2beta:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/v2beta:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
