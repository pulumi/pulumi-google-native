...
namespace Pulumi.GoogleCloud.Deploymentmanager.V2beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:deploymentmanager/v2beta:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/v2beta:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:deploymentmanager/v2beta:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
