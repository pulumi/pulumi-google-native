...
namespace Pulumi.GoogleNative.Dialogflow.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dialogflow/v2:AgentEnvironment")]
    public partial class AgentEnvironment : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudDialogflowV2TextToSpeechSettingsResponse> TextToSpeechSettings { get; private set; } = null!;
        ...
        public AgentEnvironment(string name, AgentEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:AgentEnvironment", name, args ?? new AgentEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:AgentEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AgentEnvironmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudDialogflowV2TextToSpeechSettingsArgs>? TextToSpeechSettings { get; set; }
