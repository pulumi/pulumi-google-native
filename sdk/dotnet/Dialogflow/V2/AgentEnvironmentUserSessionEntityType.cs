...
namespace Pulumi.GcpNative.Dialogflow.V2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dialogflow/v2:AgentEnvironmentUserSessionEntityType")]
    public partial class AgentEnvironmentUserSessionEntityType : Pulumi.CustomResource
    {
        ...
        public AgentEnvironmentUserSessionEntityType(string name, AgentEnvironmentUserSessionEntityTypeArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v2:AgentEnvironmentUserSessionEntityType", name, args ?? new AgentEnvironmentUserSessionEntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironmentUserSessionEntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v2:AgentEnvironmentUserSessionEntityType", name, null, MakeResourceOptions(options, id))
        {
        }
