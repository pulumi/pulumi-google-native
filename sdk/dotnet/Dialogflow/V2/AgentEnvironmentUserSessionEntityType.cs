...
namespace Pulumi.GoogleCloud.Dialogflow.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v2:AgentEnvironmentUserSessionEntityType")]
    public partial class AgentEnvironmentUserSessionEntityType : Pulumi.CustomResource
    {
        ...
        public AgentEnvironmentUserSessionEntityType(string name, AgentEnvironmentUserSessionEntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:AgentEnvironmentUserSessionEntityType", name, args ?? new AgentEnvironmentUserSessionEntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironmentUserSessionEntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:AgentEnvironmentUserSessionEntityType", name, null, MakeResourceOptions(options, id))
        {
        }
