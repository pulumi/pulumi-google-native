...
namespace Pulumi.GoogleCloud.Dialogflow.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v2:AgentIntent")]
    public partial class AgentIntent : Pulumi.CustomResource
    {
        ...
        public AgentIntent(string name, AgentIntentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:AgentIntent", name, args ?? new AgentIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:AgentIntent", name, null, MakeResourceOptions(options, id))
        {
        }
