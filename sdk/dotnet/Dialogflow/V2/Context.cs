...
namespace Pulumi.GoogleNative.Dialogflow.V2
{
    ...
    public partial class Context : global::Pulumi.CustomResource
    {
        ...
        public Context(string name, ContextArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:Context", name, args ?? new ContextArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Context(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:Context", name, null, MakeResourceOptions(options, id))
        {
        }
