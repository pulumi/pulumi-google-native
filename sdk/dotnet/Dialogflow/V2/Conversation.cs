...
namespace Pulumi.GcpNative.Dialogflow.V2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dialogflow/v2:Conversation")]
    public partial class Conversation : Pulumi.CustomResource
    {
        ...
        public Conversation(string name, ConversationArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v2:Conversation", name, args ?? new ConversationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Conversation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v2:Conversation", name, null, MakeResourceOptions(options, id))
        {
        }
