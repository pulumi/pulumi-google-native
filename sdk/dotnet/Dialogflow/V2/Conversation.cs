...
namespace Pulumi.GoogleCloud.Dialogflow.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v2:Conversation")]
    public partial class Conversation : Pulumi.CustomResource
    {
        ...
        public Conversation(string name, ConversationArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:Conversation", name, args ?? new ConversationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Conversation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:Conversation", name, null, MakeResourceOptions(options, id))
        {
        }
