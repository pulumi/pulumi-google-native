...
namespace Pulumi.GoogleNative.Dialogflow.V2
{
    ...
    public partial class ConversationProfile : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("ttsConfig")]
        public Output<Outputs.GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse> TtsConfig { get; private set; } = null!;
    ...
    public sealed class ConversationProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ttsConfig")]
        public Input<Inputs.GoogleCloudDialogflowV2SynthesizeSpeechConfigArgs>? TtsConfig { get; set; }
