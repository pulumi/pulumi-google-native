...
namespace Pulumi.GoogleNative.Dialogflow.V2
{
    ...
    public partial class Document : Pulumi.CustomResource
    {
        ...
        public Document(string name, DocumentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:Document", name, args ?? new DocumentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Document(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:Document", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DocumentArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.GoogleNative.Dialogflow.V2.DocumentKnowledgeTypesItem>? _knowledgeTypes;

        /// <summary>
        /// The knowledge type of document content.
        /// </summary>
        public InputList<Pulumi.GoogleNative.Dialogflow.V2.DocumentKnowledgeTypesItem> KnowledgeTypes
        {
            get => _knowledgeTypes ?? (_knowledgeTypes = new InputList<Pulumi.GoogleNative.Dialogflow.V2.DocumentKnowledgeTypesItem>());
