...
namespace Pulumi.GoogleNative.Dialogflow.V2
{
    ...
    public partial class EntityType : Pulumi.CustomResource
    {
        ...
        public EntityType(string name, EntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:EntityType", name, args ?? new EntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:EntityType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EntityTypeArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Dialogflow.V2.EntityTypeAutoExpansionMode>? AutoExpansionMode { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Dialogflow.V2.EntityTypeKind> Kind { get; set; } = null!;
