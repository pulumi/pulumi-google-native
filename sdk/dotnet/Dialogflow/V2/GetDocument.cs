...
namespace Pulumi.GoogleNative.Dialogflow.V2
{
    public static class GetDocument
    {
        ...
        public static Task<GetDocumentResult> InvokeAsync(GetDocumentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDocumentResult>("google-native:dialogflow/v2:getDocument", args ?? new GetDocumentArgs(), options.WithVersion());

        /// <summary>
        /// Retrieves the specified document.
        /// </summary>
        public static Output<GetDocumentResult> Invoke(GetDocumentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDocumentResult>("google-native:dialogflow/v2:getDocument", args ?? new GetDocumentInvokeArgs(), options.WithVersion());
    }
    ...
    public sealed class GetDocumentResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowV2DocumentReloadStatusResponse LatestReloadStatus;
        /// <summary>
        ...
        private GetDocumentResult(
            ...
            Outputs.GoogleCloudDialogflowV2DocumentReloadStatusResponse latestReloadStatus,
