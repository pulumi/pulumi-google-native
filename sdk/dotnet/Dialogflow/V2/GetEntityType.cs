...
namespace Pulumi.GoogleNative.Dialogflow.V2
{
    public static class GetEntityType
    {
        ...
        public static Task<GetEntityTypeResult> InvokeAsync(GetEntityTypeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEntityTypeResult>("google-native:dialogflow/v2:getEntityType", args ?? new GetEntityTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified entity type.
        /// </summary>
        public static Output<GetEntityTypeResult> Invoke(GetEntityTypeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEntityTypeResult>("google-native:dialogflow/v2:getEntityType", args ?? new GetEntityTypeInvokeArgs(), options.WithDefaults());
    }
