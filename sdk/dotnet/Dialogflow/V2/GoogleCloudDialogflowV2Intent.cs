...
namespace Pulumi.GoogleCloud.Dialogflow.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v2:GoogleCloudDialogflowV2Intent")]
    public partial class GoogleCloudDialogflowV2Intent : Pulumi.CustomResource
    {
        /// <summary>
        /// Create a GoogleCloudDialogflowV2Intent resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public GoogleCloudDialogflowV2Intent(string name, GoogleCloudDialogflowV2IntentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:GoogleCloudDialogflowV2Intent", name, args ?? new GoogleCloudDialogflowV2IntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudDialogflowV2Intent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:GoogleCloudDialogflowV2Intent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudDialogflowV2Intent Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudDialogflowV2Intent(name, id, options);
        }
    }

    public sealed class GoogleCloudDialogflowV2IntentArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GoogleCloudDialogflowV2IntentArgs()
        {
        }
    }
}
