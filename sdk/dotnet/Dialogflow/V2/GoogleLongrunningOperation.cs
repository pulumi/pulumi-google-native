...
namespace Pulumi.GoogleCloud.Dialogflow.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v2:GoogleLongrunningOperation")]
    public partial class GoogleLongrunningOperation : Pulumi.CustomResource
    {
        ...
        public GoogleLongrunningOperation(string name, GoogleLongrunningOperationArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:GoogleLongrunningOperation", name, args ?? new GoogleLongrunningOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleLongrunningOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2:GoogleLongrunningOperation", name, null, MakeResourceOptions(options, id))
        {
        }
