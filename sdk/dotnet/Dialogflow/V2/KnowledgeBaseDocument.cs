...
namespace Pulumi.GoogleNative.Dialogflow.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dialogflow/v2:KnowledgeBaseDocument")]
    public partial class KnowledgeBaseDocument : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public KnowledgeBaseDocument(string name, KnowledgeBaseDocumentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:KnowledgeBaseDocument", name, args ?? new KnowledgeBaseDocumentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KnowledgeBaseDocument(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2:KnowledgeBaseDocument", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static KnowledgeBaseDocument Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new KnowledgeBaseDocument(name, id, options);
        }
    }

    public sealed class KnowledgeBaseDocumentArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The URI where the file content is located. For documents stored in Google Cloud Storage, these URIs must have the form `gs:///`. NOTE: External URLs must correspond to public webpages, i.e., they must be indexed by Google Search. In particular, URLs for showing documents in Google Cloud Storage (i.e. the URL in your browser) are not supported. Instead use the `gs://` format URI described above.
        /// </summary>
        ...
        public KnowledgeBaseDocumentArgs()
        {
        }
    }
}
