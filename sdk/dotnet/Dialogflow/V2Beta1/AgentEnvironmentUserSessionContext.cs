...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dialogflow/v2beta1:AgentEnvironmentUserSessionContext")]
    public partial class AgentEnvironmentUserSessionContext : Pulumi.CustomResource
    {
        ...
        public AgentEnvironmentUserSessionContext(string name, AgentEnvironmentUserSessionContextArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:AgentEnvironmentUserSessionContext", name, args ?? new AgentEnvironmentUserSessionContextArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironmentUserSessionContext(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:AgentEnvironmentUserSessionContext", name, null, MakeResourceOptions(options, id))
        {
        }
