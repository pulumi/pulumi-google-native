...
namespace Pulumi.GcpNative.Dialogflow.V2Beta1
{
    ...
    public partial class AgentIntent : Pulumi.CustomResource
    {
        ...
        public AgentIntent(string name, AgentIntentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:AgentIntent", name, args ?? new AgentIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:AgentIntent", name, null, MakeResourceOptions(options, id))
        {
        }
