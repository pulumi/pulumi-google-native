...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    ...
    public partial class ConversationProfile : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("ttsConfig")]
        public Output<Outputs.GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse> TtsConfig { get; private set; } = null!;
        ...
        public ConversationProfile(string name, ConversationProfileArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:ConversationProfile", name, args ?? new ConversationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConversationProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:ConversationProfile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConversationProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ttsConfig")]
        public Input<Inputs.GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgs>? TtsConfig { get; set; }
