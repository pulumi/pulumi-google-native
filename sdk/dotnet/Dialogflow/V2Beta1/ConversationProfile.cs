...
namespace Pulumi.GcpNative.Dialogflow.V2Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dialogflow/v2beta1:ConversationProfile")]
    public partial class ConversationProfile : Pulumi.CustomResource
    {
        ...
        public ConversationProfile(string name, ConversationProfileArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v2beta1:ConversationProfile", name, args ?? new ConversationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConversationProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v2beta1:ConversationProfile", name, null, MakeResourceOptions(options, id))
        {
        }
