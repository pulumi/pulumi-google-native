...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    ...
    public partial class EntityType : Pulumi.CustomResource
    {
        ...
        public EntityType(string name, EntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:EntityType", name, args ?? new EntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:EntityType", name, null, MakeResourceOptions(options, id))
        {
        }
