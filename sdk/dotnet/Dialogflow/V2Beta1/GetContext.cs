...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    public static class GetContext
    {
        ...
        public static Task<GetContextResult> InvokeAsync(GetContextArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContextResult>("google-native:dialogflow/v2beta1:getContext", args ?? new GetContextArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified context.
        /// </summary>
        public static Output<GetContextResult> Invoke(GetContextInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContextResult>("google-native:dialogflow/v2beta1:getContext", args ?? new GetContextInvokeArgs(), options.WithDefaults());
    }
