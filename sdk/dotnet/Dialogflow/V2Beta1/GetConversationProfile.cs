...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    public static class GetConversationProfile
    {
        ...
        public static Task<GetConversationProfileResult> InvokeAsync(GetConversationProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConversationProfileResult>("google-native:dialogflow/v2beta1:getConversationProfile", args ?? new GetConversationProfileArgs(), options.WithDefaults());
        ...
        public static Output<GetConversationProfileResult> Invoke(GetConversationProfileInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConversationProfileResult>("google-native:dialogflow/v2beta1:getConversationProfile", args ?? new GetConversationProfileInvokeArgs(), options.WithDefaults());
    }
