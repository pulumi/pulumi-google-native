...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    public static class GetEnvironment
    {
        ...
        public static Output<GetEnvironmentResult> Invoke(GetEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEnvironmentResult>("google-native:dialogflow/v2beta1:getEnvironment", args ?? new GetEnvironmentInvokeArgs(), options.WithVersion());
    }
