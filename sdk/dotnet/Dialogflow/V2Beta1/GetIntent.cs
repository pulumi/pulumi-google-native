...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    public static class GetIntent
    {
        ...
        public static Task<GetIntentResult> InvokeAsync(GetIntentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIntentResult>("google-native:dialogflow/v2beta1:getIntent", args ?? new GetIntentArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified intent.
        /// </summary>
        public static Output<GetIntentResult> Invoke(GetIntentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIntentResult>("google-native:dialogflow/v2beta1:getIntent", args ?? new GetIntentInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetIntentResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoResponse> FollowupIntentInfo;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentMessageResponse> Messages;
        /// <summary>
        ...
        /// </summary>
        public readonly bool MlEnabled;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1ContextResponse> OutputContexts;
        /// <summary>
        /// Optional. The collection of parameters associated with the intent.
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentParameterResponse> Parameters;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentTrainingPhraseResponse> TrainingPhrases;
        /// <summary>
        ...
        private GetIntentResult(
            ...
            ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoResponse> followupIntentInfo,
            ...
            ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentMessageResponse> messages,
            ...
            ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1ContextResponse> outputContexts,

            ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentParameterResponse> parameters,
            ...
            ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentTrainingPhraseResponse> trainingPhrases,
