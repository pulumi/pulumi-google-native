...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    public static class GetKnowledgeBase
    {
        ...
        public static Output<GetKnowledgeBaseResult> Invoke(GetKnowledgeBaseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKnowledgeBaseResult>("google-native:dialogflow/v2beta1:getKnowledgeBase", args ?? new GetKnowledgeBaseInvokeArgs(), options.WithVersion());
    }
