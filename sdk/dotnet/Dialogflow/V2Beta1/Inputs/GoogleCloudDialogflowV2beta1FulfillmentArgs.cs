...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1.Inputs
{
    ...
    public sealed class GoogleCloudDialogflowV2beta1FulfillmentArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("features")]
        private InputList<Inputs.GoogleCloudDialogflowV2beta1FulfillmentFeatureArgs>? _features;

        /// <summary>
        /// The field defines whether the fulfillment is enabled for certain features.
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowV2beta1FulfillmentFeatureArgs> Features
        {
            get => _features ?? (_features = new InputList<Inputs.GoogleCloudDialogflowV2beta1FulfillmentFeatureArgs>());
            set => _features = value;
        }
