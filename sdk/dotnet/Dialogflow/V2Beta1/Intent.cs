...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    ...
    public partial class Intent : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoResponse>> FollowupIntentInfo { get; private set; } = null!;
        ...
        /// </summary>
        [Output("messages")]
        public Output<ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentMessageResponse>> Messages { get; private set; } = null!;
        ...
        /// </summary>
        [Output("mlEnabled")]
        public Output<bool> MlEnabled { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1ContextResponse>> OutputContexts { get; private set; } = null!;

        /// <summary>
        /// Optional. The collection of parameters associated with the intent.
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentParameterResponse>> Parameters { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudDialogflowV2beta1IntentTrainingPhraseResponse>> TrainingPhrases { get; private set; } = null!;
        ...
        public Intent(string name, IntentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:Intent", name, args ?? new IntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Intent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:Intent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IntentArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.GoogleNative.Dialogflow.V2Beta1.IntentDefaultResponsePlatformsItem>? _defaultResponsePlatforms;

        /// <summary>
        /// Optional. The list of platforms for which the first responses will be copied from the messages in PLATFORM_UNSPECIFIED (i.e. default platform).
        /// </summary>
        public InputList<Pulumi.GoogleNative.Dialogflow.V2Beta1.IntentDefaultResponsePlatformsItem> DefaultResponsePlatforms
        {
            get => _defaultResponsePlatforms ?? (_defaultResponsePlatforms = new InputList<Pulumi.GoogleNative.Dialogflow.V2Beta1.IntentDefaultResponsePlatformsItem>());
        ...
        /// Optional. The collection of rich messages corresponding to the `Response` field in the Dialogflow console.
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowV2beta1IntentMessageArgs> Messages
        {
            get => _messages ?? (_messages = new InputList<Inputs.GoogleCloudDialogflowV2beta1IntentMessageArgs>());
            set => _messages = value;
        }
        ...
        /// </summary>
        [Input("mlEnabled")]
        public Input<bool>? MlEnabled { get; set; }
        ...
        private InputList<Inputs.GoogleCloudDialogflowV2beta1ContextArgs>? _outputContexts;

        /// <summary>
        /// Optional. The collection of contexts that are activated when the intent is matched. Context messages in this collection should not set the parameters field. Setting the `lifespan_count` to 0 will reset the context when the intent is matched. Format: `projects//agent/sessions/-/contexts/`.
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowV2beta1ContextArgs> OutputContexts
        {
            get => _outputContexts ?? (_outputContexts = new InputList<Inputs.GoogleCloudDialogflowV2beta1ContextArgs>());
            set => _outputContexts = value;
        }

        [Input("parameters")]
        private InputList<Inputs.GoogleCloudDialogflowV2beta1IntentParameterArgs>? _parameters;

        /// <summary>
        /// Optional. The collection of parameters associated with the intent.
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowV2beta1IntentParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.GoogleCloudDialogflowV2beta1IntentParameterArgs>());
        ...
        private InputList<Inputs.GoogleCloudDialogflowV2beta1IntentTrainingPhraseArgs>? _trainingPhrases;

        /// <summary>
        /// Optional. The collection of examples that the agent is trained on.
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowV2beta1IntentTrainingPhraseArgs> TrainingPhrases
        {
            get => _trainingPhrases ?? (_trainingPhrases = new InputList<Inputs.GoogleCloudDialogflowV2beta1IntentTrainingPhraseArgs>());
        ...
        /// </summary>
        [Input("webhookState")]
        public Input<Pulumi.GoogleNative.Dialogflow.V2Beta1.IntentWebhookState>? WebhookState { get; set; }
