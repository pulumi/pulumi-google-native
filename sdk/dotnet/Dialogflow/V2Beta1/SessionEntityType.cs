...
namespace Pulumi.GoogleNative.Dialogflow.V2Beta1
{
    ...
    public partial class SessionEntityType : Pulumi.CustomResource
    {
        ...
        public SessionEntityType(string name, SessionEntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:SessionEntityType", name, args ?? new SessionEntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SessionEntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v2beta1:SessionEntityType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SessionEntityTypeArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Dialogflow.V2Beta1.SessionEntityTypeEntityOverrideMode> EntityOverrideMode { get; set; } = null!;
