...
namespace Pulumi.GoogleCloud.Dialogflow.V2beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v2beta1:AgentKnowledgeBaseDocument")]
    public partial class AgentKnowledgeBaseDocument : Pulumi.CustomResource
    {
        ...
        public AgentKnowledgeBaseDocument(string name, AgentKnowledgeBaseDocumentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2beta1:AgentKnowledgeBaseDocument", name, args ?? new AgentKnowledgeBaseDocumentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentKnowledgeBaseDocument(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2beta1:AgentKnowledgeBaseDocument", name, null, MakeResourceOptions(options, id))
        {
        }
