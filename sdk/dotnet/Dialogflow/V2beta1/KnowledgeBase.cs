...
namespace Pulumi.GoogleCloud.Dialogflow.V2beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v2beta1:KnowledgeBase")]
    public partial class KnowledgeBase : Pulumi.CustomResource
    {
        ...
        public KnowledgeBase(string name, KnowledgeBaseArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2beta1:KnowledgeBase", name, args ?? new KnowledgeBaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KnowledgeBase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v2beta1:KnowledgeBase", name, null, MakeResourceOptions(options, id))
        {
        }
