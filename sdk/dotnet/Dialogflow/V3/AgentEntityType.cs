...
namespace Pulumi.GoogleNative.Dialogflow.V3
{
    ...
    public partial class AgentEntityType : Pulumi.CustomResource
    {
        ...
        public AgentEntityType(string name, AgentEntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3:AgentEntityType", name, args ?? new AgentEntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3:AgentEntityType", name, null, MakeResourceOptions(options, id))
        {
        }
