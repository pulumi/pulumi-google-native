...
namespace Pulumi.GoogleNative.Dialogflow.V3
{
    ...
    public partial class AgentEnvironment : Pulumi.CustomResource
    {
        ...
        public AgentEnvironment(string name, AgentEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3:AgentEnvironment", name, args ?? new AgentEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3:AgentEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
