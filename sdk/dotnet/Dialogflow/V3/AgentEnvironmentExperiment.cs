...
namespace Pulumi.GoogleCloud.Dialogflow.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3:AgentEnvironmentExperiment")]
    public partial class AgentEnvironmentExperiment : Pulumi.CustomResource
    {
        ...
        public AgentEnvironmentExperiment(string name, AgentEnvironmentExperimentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:AgentEnvironmentExperiment", name, args ?? new AgentEnvironmentExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironmentExperiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:AgentEnvironmentExperiment", name, null, MakeResourceOptions(options, id))
        {
        }
