...
namespace Pulumi.GcpNative.Dialogflow.V3
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dialogflow/v3:AgentFlowPage")]
    public partial class AgentFlowPage : Pulumi.CustomResource
    {
        ...
        public AgentFlowPage(string name, AgentFlowPageArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v3:AgentFlowPage", name, args ?? new AgentFlowPageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentFlowPage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v3:AgentFlowPage", name, null, MakeResourceOptions(options, id))
        {
        }
