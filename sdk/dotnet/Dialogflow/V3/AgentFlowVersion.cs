...
namespace Pulumi.GoogleCloud.Dialogflow.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3:AgentFlowVersion")]
    public partial class AgentFlowVersion : Pulumi.CustomResource
    {
        ...
        public AgentFlowVersion(string name, AgentFlowVersionArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:AgentFlowVersion", name, args ?? new AgentFlowVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentFlowVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:AgentFlowVersion", name, null, MakeResourceOptions(options, id))
        {
        }
