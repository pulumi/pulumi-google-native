...
namespace Pulumi.GoogleCloud.Dialogflow.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3:AgentSessionEntityType")]
    public partial class AgentSessionEntityType : Pulumi.CustomResource
    {
        ...
        public AgentSessionEntityType(string name, AgentSessionEntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:AgentSessionEntityType", name, args ?? new AgentSessionEntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentSessionEntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:AgentSessionEntityType", name, null, MakeResourceOptions(options, id))
        {
        }
