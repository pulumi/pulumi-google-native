...
namespace Pulumi.GoogleNative.Dialogflow.V3
{
    ...
    public partial class EntityType : Pulumi.CustomResource
    {
        ...
        public EntityType(string name, EntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3:EntityType", name, args ?? new EntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3:EntityType", name, null, MakeResourceOptions(options, id))
        {
        }
