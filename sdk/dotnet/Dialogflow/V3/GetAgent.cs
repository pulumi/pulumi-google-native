...
namespace Pulumi.GoogleNative.Dialogflow.V3
{
    public static class GetAgent
    {
        ...
        public static Task<GetAgentResult> InvokeAsync(GetAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAgentResult>("google-native:dialogflow/v3:getAgent", args ?? new GetAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified agent.
        /// </summary>
        public static Output<GetAgentResult> Invoke(GetAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAgentResult>("google-native:dialogflow/v3:getAgent", args ?? new GetAgentInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetAgentResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsResponse AnswerFeedbackSettings;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsResponse GenAppBuilderSettings;
        /// <summary>
        /// Git integration settings for this agent.
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsResponse GitIntegrationSettings;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowCxV3AgentPersonalizationSettingsResponse PersonalizationSettings;
        /// <summary>
        ...
        private GetAgentResult(
            ...
            Outputs.GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsResponse answerFeedbackSettings,
            ...
            Outputs.GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsResponse genAppBuilderSettings,

            Outputs.GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsResponse gitIntegrationSettings,

            bool locked,

            string name,

            Outputs.GoogleCloudDialogflowCxV3AgentPersonalizationSettingsResponse personalizationSettings,
