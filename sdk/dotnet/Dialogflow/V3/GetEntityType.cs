...
namespace Pulumi.GoogleNative.Dialogflow.V3
{
    public static class GetEntityType
    {
        ...
        public static Task<GetEntityTypeResult> InvokeAsync(GetEntityTypeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEntityTypeResult>("google-native:dialogflow/v3:getEntityType", args ?? new GetEntityTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified entity type.
        /// </summary>
        public static Output<GetEntityTypeResult> Invoke(GetEntityTypeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEntityTypeResult>("google-native:dialogflow/v3:getEntityType", args ?? new GetEntityTypeInvokeArgs(), options.WithDefaults());
    }
