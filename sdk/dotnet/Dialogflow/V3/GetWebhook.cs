...
namespace Pulumi.GoogleNative.Dialogflow.V3
{
    public static class GetWebhook
    {
        ...
        public static Task<GetWebhookResult> InvokeAsync(GetWebhookArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebhookResult>("google-native:dialogflow/v3:getWebhook", args ?? new GetWebhookArgs(), options.WithVersion());

        /// <summary>
        /// Retrieves the specified webhook.
        /// </summary>
        public static Output<GetWebhookResult> Invoke(GetWebhookInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebhookResult>("google-native:dialogflow/v3:getWebhook", args ?? new GetWebhookInvokeArgs(), options.WithVersion());
    }
