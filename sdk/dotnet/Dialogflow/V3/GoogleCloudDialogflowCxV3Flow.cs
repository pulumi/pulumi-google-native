...
namespace Pulumi.GoogleCloud.Dialogflow.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Flow")]
    public partial class GoogleCloudDialogflowCxV3Flow : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleCloudDialogflowCxV3Flow(string name, GoogleCloudDialogflowCxV3FlowArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Flow", name, args ?? new GoogleCloudDialogflowCxV3FlowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudDialogflowCxV3Flow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Flow", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudDialogflowCxV3Flow Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudDialogflowCxV3Flow(name, id, options);
        }
    }

    public sealed class GoogleCloudDialogflowCxV3FlowArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GoogleCloudDialogflowCxV3FlowArgs()
        {
        }
    }
}
