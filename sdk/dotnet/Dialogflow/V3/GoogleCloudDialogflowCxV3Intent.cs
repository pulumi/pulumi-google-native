...
namespace Pulumi.GoogleCloud.Dialogflow.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Intent")]
    public partial class GoogleCloudDialogflowCxV3Intent : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleCloudDialogflowCxV3Intent(string name, GoogleCloudDialogflowCxV3IntentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Intent", name, args ?? new GoogleCloudDialogflowCxV3IntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudDialogflowCxV3Intent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Intent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudDialogflowCxV3Intent Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudDialogflowCxV3Intent(name, id, options);
        }
    }
