...
namespace Pulumi.GoogleNative.Dialogflow.V3.Inputs
{
    ...
    public sealed class GoogleCloudDialogflowCxV3AdvancedSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudDialogflowCxV3GcsDestinationArgs>? AudioExportGcsDestination { get; set; }

        /// <summary>
        /// Settings for DTMF. Exposed at the following levels: - Agent level - Flow level - Page level - Parameter level.
        /// </summary>
        [Input("dtmfSettings")]
        public Input<Inputs.GoogleCloudDialogflowCxV3AdvancedSettingsDtmfSettingsArgs>? DtmfSettings { get; set; }
