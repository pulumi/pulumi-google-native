...
namespace Pulumi.GoogleNative.Dialogflow.V3.Inputs
{
    ...
    public sealed class GoogleCloudDialogflowCxV3RolloutConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("rolloutSteps")]
        private InputList<Inputs.GoogleCloudDialogflowCxV3RolloutConfigRolloutStepArgs>? _rolloutSteps;

        /// <summary>
        /// Steps to roll out a flow version. Steps should be sorted by percentage in ascending order.
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowCxV3RolloutConfigRolloutStepArgs> RolloutSteps
        {
            get => _rolloutSteps ?? (_rolloutSteps = new InputList<Inputs.GoogleCloudDialogflowCxV3RolloutConfigRolloutStepArgs>());
