...
namespace Pulumi.GoogleCloud.Dialogflow.V3.Inputs
{
    ...
    public sealed class GoogleCloudDialogflowCxV3TestCaseResultArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowCxV3ConversationTurnArgs> ConversationTurns
        {
            get => _conversationTurns ?? (_conversationTurns = new InputList<Inputs.GoogleCloudDialogflowCxV3ConversationTurnArgs>());
