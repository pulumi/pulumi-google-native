...
namespace Pulumi.GcpNative.Dialogflow.V3.Inputs
{
    ...
    public sealed class GoogleCloudDialogflowCxV3VersionVariantsArgs : Pulumi.ResourceArgs
    {
        ...
        /// A list of flow version variants.
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowCxV3VersionVariantsVariantArgs> Variants
        {
            get => _variants ?? (_variants = new InputList<Inputs.GoogleCloudDialogflowCxV3VersionVariantsVariantArgs>());
            set => _variants = value;
        }
