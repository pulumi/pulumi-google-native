...
namespace Pulumi.GoogleNative.Dialogflow.V3.Inputs
{
    ...
    public sealed class GoogleCloudDialogflowCxV3WebhookGenericWebServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("oauthConfig")]
        public Input<Inputs.GoogleCloudDialogflowCxV3WebhookGenericWebServiceOAuthConfigArgs>? OauthConfig { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Dialogflow.V3.GoogleCloudDialogflowCxV3WebhookGenericWebServiceServiceAgentAuth>? ServiceAgentAuth { get; set; }
