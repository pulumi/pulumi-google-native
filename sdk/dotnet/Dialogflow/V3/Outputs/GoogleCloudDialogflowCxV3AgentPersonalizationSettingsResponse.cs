...
namespace Pulumi.GoogleNative.Dialogflow.V3.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudDialogflowCxV3AgentPersonalizationSettingsResponse
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GoogleCloudDialogflowCxV3AgentPersonalizationSettingsResponse(ImmutableDictionary<string, string> defaultEndUserMetadata)
        {
