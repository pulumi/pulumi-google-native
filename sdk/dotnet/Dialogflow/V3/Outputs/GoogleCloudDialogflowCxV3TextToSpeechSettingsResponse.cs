...
namespace Pulumi.GoogleNative.Dialogflow.V3.Outputs
{
    ...
    public sealed class GoogleCloudDialogflowCxV3TextToSpeechSettingsResponse
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowCxV3SynthesizeSpeechConfigResponse SynthesizeSpeechConfigs;

        [OutputConstructor]
        private GoogleCloudDialogflowCxV3TextToSpeechSettingsResponse(Outputs.GoogleCloudDialogflowCxV3SynthesizeSpeechConfigResponse synthesizeSpeechConfigs)
        {
