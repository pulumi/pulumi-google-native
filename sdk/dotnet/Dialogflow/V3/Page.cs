...
namespace Pulumi.GoogleNative.Dialogflow.V3
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dialogflow/v3:Page")]
    public partial class Page : global::Pulumi.CustomResource
    {
        ...
        public Page(string name, PageArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3:Page", name, args ?? new PageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Page(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3:Page", name, null, MakeResourceOptions(options, id))
        {
        }
