...
namespace Pulumi.GcpNative.Dialogflow.V3Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dialogflow/v3beta1:AgentEntityType")]
    public partial class AgentEntityType : Pulumi.CustomResource
    {
        ...
        public AgentEntityType(string name, AgentEntityTypeArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v3beta1:AgentEntityType", name, args ?? new AgentEntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v3beta1:AgentEntityType", name, null, MakeResourceOptions(options, id))
        {
        }
