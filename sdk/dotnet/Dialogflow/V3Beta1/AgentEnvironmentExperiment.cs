...
namespace Pulumi.GcpNative.Dialogflow.V3Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dialogflow/v3beta1:AgentEnvironmentExperiment")]
    public partial class AgentEnvironmentExperiment : Pulumi.CustomResource
    {
        ...
        public AgentEnvironmentExperiment(string name, AgentEnvironmentExperimentArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v3beta1:AgentEnvironmentExperiment", name, args ?? new AgentEnvironmentExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironmentExperiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v3beta1:AgentEnvironmentExperiment", name, null, MakeResourceOptions(options, id))
        {
        }
