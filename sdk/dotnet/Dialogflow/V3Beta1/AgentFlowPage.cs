...
namespace Pulumi.GoogleCloud.Dialogflow.V3Beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3beta1:AgentFlowPage")]
    public partial class AgentFlowPage : Pulumi.CustomResource
    {
        ...
        public AgentFlowPage(string name, AgentFlowPageArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:AgentFlowPage", name, args ?? new AgentFlowPageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentFlowPage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:AgentFlowPage", name, null, MakeResourceOptions(options, id))
        {
        }
