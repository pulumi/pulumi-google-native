...
namespace Pulumi.GcpNative.Dialogflow.V3Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:dialogflow/v3beta1:AgentFlowVersion")]
    public partial class AgentFlowVersion : Pulumi.CustomResource
    {
        ...
        public AgentFlowVersion(string name, AgentFlowVersionArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v3beta1:AgentFlowVersion", name, args ?? new AgentFlowVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentFlowVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:dialogflow/v3beta1:AgentFlowVersion", name, null, MakeResourceOptions(options, id))
        {
        }
