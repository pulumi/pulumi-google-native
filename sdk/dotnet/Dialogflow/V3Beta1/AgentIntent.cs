...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dialogflow/v3beta1:AgentIntent")]
    public partial class AgentIntent : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.GoogleCloudDialogflowCxV3beta1IntentParameterResponse>> Parameters { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse>> TrainingPhrases { get; private set; } = null!;
        ...
        public AgentIntent(string name, AgentIntentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:AgentIntent", name, args ?? new AgentIntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentIntent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:AgentIntent", name, null, MakeResourceOptions(options, id))
        {
        }
