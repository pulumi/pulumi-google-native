...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dialogflow/v3beta1:AgentSessionEntityType")]
    public partial class AgentSessionEntityType : Pulumi.CustomResource
    {
        ...
        public AgentSessionEntityType(string name, AgentSessionEntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:AgentSessionEntityType", name, args ?? new AgentSessionEntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentSessionEntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:AgentSessionEntityType", name, null, MakeResourceOptions(options, id))
        {
        }
