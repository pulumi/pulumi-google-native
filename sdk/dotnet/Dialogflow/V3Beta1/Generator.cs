...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dialogflow/v3beta1:Generator")]
    public partial class Generator : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("placeholders")]
        public Output<ImmutableArray<Outputs.GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponse>> Placeholders { get; private set; } = null!;
        ...
        /// </summary>
        [Output("promptText")]
        public Output<Outputs.GoogleCloudDialogflowCxV3beta1PhraseResponse> PromptText { get; private set; } = null!;
        ...
        public Generator(string name, GeneratorArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:Generator", name, args ?? new GeneratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Generator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:Generator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GeneratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("placeholders")]
        private InputList<Inputs.GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs>? _placeholders;

        /// <summary>
        /// Optional. List of custom placeholders in the prompt text.
        /// </summary>
        public InputList<Inputs.GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs> Placeholders
        {
            get => _placeholders ?? (_placeholders = new InputList<Inputs.GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs>());
        ...
        public Input<Inputs.GoogleCloudDialogflowCxV3beta1PhraseArgs> PromptText { get; set; } = null!;
