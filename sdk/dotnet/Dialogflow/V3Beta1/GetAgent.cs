...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    public static class GetAgent
    {
        ...
        public static Task<GetAgentResult> InvokeAsync(GetAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAgentResult>("google-native:dialogflow/v3beta1:getAgent", args ?? new GetAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified agent.
        /// </summary>
        public static Output<GetAgentResult> Invoke(GetAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAgentResult>("google-native:dialogflow/v3beta1:getAgent", args ?? new GetAgentInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetAgentResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse TextToSpeechSettings;
        /// <summary>
        ...
        private GetAgentResult(
            ...
            Outputs.GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse textToSpeechSettings,
