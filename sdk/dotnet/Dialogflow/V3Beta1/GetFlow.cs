...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    public static class GetFlow
    {
        ...
        public static Task<GetFlowResult> InvokeAsync(GetFlowArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFlowResult>("google-native:dialogflow/v3beta1:getFlow", args ?? new GetFlowArgs(), options.WithVersion());

        /// <summary>
        /// Retrieves the specified flow.
        /// </summary>
        public static Output<GetFlowResult> Invoke(GetFlowInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFlowResult>("google-native:dialogflow/v3beta1:getFlow", args ?? new GetFlowInvokeArgs(), options.WithVersion());
    }
