...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    public static class GetGenerator
    {
        ...
        public static Task<GetGeneratorResult> InvokeAsync(GetGeneratorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGeneratorResult>("google-native:dialogflow/v3beta1:getGenerator", args ?? new GetGeneratorArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified generator.
        /// </summary>
        public static Output<GetGeneratorResult> Invoke(GetGeneratorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGeneratorResult>("google-native:dialogflow/v3beta1:getGenerator", args ?? new GetGeneratorInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetGeneratorResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponse> Placeholders;
        /// <summary>
        /// Prompt for the LLM model.
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowCxV3beta1PhraseResponse PromptText;
        ...
        private GetGeneratorResult(
            ...
            ImmutableArray<Outputs.GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponse> placeholders,

            Outputs.GoogleCloudDialogflowCxV3beta1PhraseResponse promptText)
        {
