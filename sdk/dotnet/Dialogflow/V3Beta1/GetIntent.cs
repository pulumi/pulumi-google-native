...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    public static class GetIntent
    {
        ...
        public static Task<GetIntentResult> InvokeAsync(GetIntentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIntentResult>("google-native:dialogflow/v3beta1:getIntent", args ?? new GetIntentArgs(), options.WithVersion());

        /// <summary>
        /// Retrieves the specified intent.
        /// </summary>
        public static Output<GetIntentResult> Invoke(GetIntentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIntentResult>("google-native:dialogflow/v3beta1:getIntent", args ?? new GetIntentInvokeArgs(), options.WithVersion());
    }
