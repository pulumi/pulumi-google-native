...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    public static class GetPage
    {
        ...
        public static Task<GetPageResult> InvokeAsync(GetPageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPageResult>("google-native:dialogflow/v3beta1:getPage", args ?? new GetPageArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified page.
        /// </summary>
        public static Output<GetPageResult> Invoke(GetPageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPageResult>("google-native:dialogflow/v3beta1:getPage", args ?? new GetPageInvokeArgs(), options.WithDefaults());
    }
