...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    public static class GetWebhook
    {
        ...
        public static Task<GetWebhookResult> InvokeAsync(GetWebhookArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebhookResult>("google-native:dialogflow/v3beta1:getWebhook", args ?? new GetWebhookArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the specified webhook.
        /// </summary>
        public static Output<GetWebhookResult> Invoke(GetWebhookInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebhookResult>("google-native:dialogflow/v3beta1:getWebhook", args ?? new GetWebhookInvokeArgs(), options.WithDefaults());
    }
