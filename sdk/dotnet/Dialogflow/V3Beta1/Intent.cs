...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    ...
    public partial class Intent : Pulumi.CustomResource
    {
        ...
        public Intent(string name, IntentArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:Intent", name, args ?? new IntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Intent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:Intent", name, null, MakeResourceOptions(options, id))
        {
        }
