...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1.Outputs
{
    ...
    public sealed class GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudDialogflowCxV3beta1SynthesizeSpeechConfigResponse SynthesizeSpeechConfigs;

        [OutputConstructor]
        private GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse(Outputs.GoogleCloudDialogflowCxV3beta1SynthesizeSpeechConfigResponse synthesizeSpeechConfigs)
        {
