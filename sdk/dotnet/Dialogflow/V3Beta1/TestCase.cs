...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    ...
    public partial class TestCase : Pulumi.CustomResource
    {
        ...
        public TestCase(string name, TestCaseArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:TestCase", name, args ?? new TestCaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TestCase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:TestCase", name, null, MakeResourceOptions(options, id))
        {
        }
