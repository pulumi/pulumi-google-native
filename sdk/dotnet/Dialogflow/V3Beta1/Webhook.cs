...
namespace Pulumi.GoogleNative.Dialogflow.V3Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:dialogflow/v3beta1:Webhook")]
    public partial class Webhook : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudDialogflowCxV3beta1WebhookServiceDirectoryConfigResponse> ServiceDirectory { get; private set; } = null!;
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:dialogflow/v3beta1:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
