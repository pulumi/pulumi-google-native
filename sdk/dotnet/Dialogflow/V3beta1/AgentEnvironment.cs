...
namespace Pulumi.GoogleCloud.Dialogflow.V3beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3beta1:AgentEnvironment")]
    public partial class AgentEnvironment : Pulumi.CustomResource
    {
        ...
        public AgentEnvironment(string name, AgentEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:AgentEnvironment", name, args ?? new AgentEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:AgentEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
