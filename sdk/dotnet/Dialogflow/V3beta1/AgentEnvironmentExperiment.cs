...
namespace Pulumi.GoogleCloud.Dialogflow.V3beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3beta1:AgentEnvironmentExperiment")]
    public partial class AgentEnvironmentExperiment : Pulumi.CustomResource
    {
        ...
        public AgentEnvironmentExperiment(string name, AgentEnvironmentExperimentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:AgentEnvironmentExperiment", name, args ?? new AgentEnvironmentExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentEnvironmentExperiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:AgentEnvironmentExperiment", name, null, MakeResourceOptions(options, id))
        {
        }
