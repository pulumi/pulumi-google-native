...
namespace Pulumi.GoogleCloud.Dialogflow.V3beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1EntityType")]
    public partial class GoogleCloudDialogflowCxV3beta1EntityType : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleCloudDialogflowCxV3beta1EntityType(string name, GoogleCloudDialogflowCxV3beta1EntityTypeArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1EntityType", name, args ?? new GoogleCloudDialogflowCxV3beta1EntityTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudDialogflowCxV3beta1EntityType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1EntityType", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudDialogflowCxV3beta1EntityType Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudDialogflowCxV3beta1EntityType(name, id, options);
        }
    }

    public sealed class GoogleCloudDialogflowCxV3beta1EntityTypeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GoogleCloudDialogflowCxV3beta1EntityTypeArgs()
        {
        }
    }
}
