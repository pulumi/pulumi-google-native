...
namespace Pulumi.GoogleCloud.Dialogflow.V3beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Experiment")]
    public partial class GoogleCloudDialogflowCxV3beta1Experiment : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleCloudDialogflowCxV3beta1Experiment(string name, GoogleCloudDialogflowCxV3beta1ExperimentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Experiment", name, args ?? new GoogleCloudDialogflowCxV3beta1ExperimentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudDialogflowCxV3beta1Experiment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Experiment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudDialogflowCxV3beta1Experiment Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudDialogflowCxV3beta1Experiment(name, id, options);
        }
    }

    public sealed class GoogleCloudDialogflowCxV3beta1ExperimentArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GoogleCloudDialogflowCxV3beta1ExperimentArgs()
        {
        }
    }
}
