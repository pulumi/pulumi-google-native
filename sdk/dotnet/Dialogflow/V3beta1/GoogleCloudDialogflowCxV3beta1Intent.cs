...
namespace Pulumi.GoogleCloud.Dialogflow.V3beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Intent")]
    public partial class GoogleCloudDialogflowCxV3beta1Intent : Pulumi.CustomResource
    {
        /// <summary>
        /// Create a GoogleCloudDialogflowCxV3beta1Intent resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public GoogleCloudDialogflowCxV3beta1Intent(string name, GoogleCloudDialogflowCxV3beta1IntentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Intent", name, args ?? new GoogleCloudDialogflowCxV3beta1IntentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudDialogflowCxV3beta1Intent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Intent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing GoogleCloudDialogflowCxV3beta1Intent resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudDialogflowCxV3beta1Intent Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudDialogflowCxV3beta1Intent(name, id, options);
        }
    }
