...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Alpha
{
    ...
    public partial class Conversation : global::Pulumi.CustomResource
    {
        ...
        public Conversation(string name, ConversationArgs args, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1alpha:Conversation", name, args ?? new ConversationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Conversation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1alpha:Conversation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConversationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.GoogleNative.DiscoveryEngine.V1Alpha.ConversationState>? State { get; set; }
