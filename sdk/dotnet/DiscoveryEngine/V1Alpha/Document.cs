...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Alpha
{
    ...
    public partial class Document : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("content")]
        public Output<Outputs.GoogleCloudDiscoveryengineV1alphaDocumentContentResponse> Content { get; private set; } = null!;
        ...
        public Document(string name, DocumentArgs args, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1alpha:Document", name, args ?? new DocumentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Document(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1alpha:Document", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DocumentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("content")]
        public Input<Inputs.GoogleCloudDiscoveryengineV1alphaDocumentContentArgs>? Content { get; set; }
