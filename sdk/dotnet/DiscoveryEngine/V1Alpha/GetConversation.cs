...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Alpha
{
    public static class GetConversation
    {
        ...
        public static Task<GetConversationResult> InvokeAsync(GetConversationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConversationResult>("google-native:discoveryengine/v1alpha:getConversation", args ?? new GetConversationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Conversation.
        /// </summary>
        public static Output<GetConversationResult> Invoke(GetConversationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConversationResult>("google-native:discoveryengine/v1alpha:getConversation", args ?? new GetConversationInvokeArgs(), options.WithDefaults());
    }
