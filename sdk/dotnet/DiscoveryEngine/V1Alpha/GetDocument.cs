...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Alpha
{
    public static class GetDocument
    {
        ...
        public static Task<GetDocumentResult> InvokeAsync(GetDocumentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDocumentResult>("google-native:discoveryengine/v1alpha:getDocument", args ?? new GetDocumentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Document.
        /// </summary>
        public static Output<GetDocumentResult> Invoke(GetDocumentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDocumentResult>("google-native:discoveryengine/v1alpha:getDocument", args ?? new GetDocumentInvokeArgs(), options.WithDefaults());
    }
