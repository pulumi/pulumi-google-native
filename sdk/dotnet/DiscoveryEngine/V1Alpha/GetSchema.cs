...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Alpha
{
    public static class GetSchema
    {
        ...
        public static Task<GetSchemaResult> InvokeAsync(GetSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSchemaResult>("google-native:discoveryengine/v1alpha:getSchema", args ?? new GetSchemaArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Schema.
        /// </summary>
        public static Output<GetSchemaResult> Invoke(GetSchemaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSchemaResult>("google-native:discoveryengine/v1alpha:getSchema", args ?? new GetSchemaInvokeArgs(), options.WithDefaults());
    }
