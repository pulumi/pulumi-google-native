...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Alpha.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudDiscoveryengineV1alphaDocumentAclInfoAccessRestrictionResponse
    {
        /// <summary>
        /// List of principals.
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleCloudDiscoveryengineV1alphaPrincipalResponse> Principals;

        [OutputConstructor]
        private GoogleCloudDiscoveryengineV1alphaDocumentAclInfoAccessRestrictionResponse(ImmutableArray<Outputs.GoogleCloudDiscoveryengineV1alphaPrincipalResponse> principals)
        {
