...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Alpha
{
    ...
    /// Creates a Schema.
    /// </summary>
    [GoogleNativeResourceType("google-native:discoveryengine/v1alpha:Schema")]
    public partial class Schema : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("fieldConfigs")]
        public Output<ImmutableArray<Outputs.GoogleCloudDiscoveryengineV1alphaFieldConfigResponse>> FieldConfigs { get; private set; } = null!;
        ...
        public Schema(string name, SchemaArgs args, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1alpha:Schema", name, args ?? new SchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1alpha:Schema", name, null, MakeResourceOptions(options, id))
        {
        }
