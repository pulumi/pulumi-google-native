...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Beta
{
    ...
    /// Creates a Engine.
    /// </summary>
    [GoogleNativeResourceType("google-native:discoveryengine/v1beta:Engine")]
    public partial class Engine : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigResponse> ChatEngineConfig { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadataResponse> ChatEngineMetadata { get; private set; } = null!;
        ...
        /// </summary>
        [Output("commonConfig")]
        public Output<Outputs.GoogleCloudDiscoveryengineV1betaEngineCommonConfigResponse> CommonConfig { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigResponse> SearchEngineConfig { get; private set; } = null!;
        ...
        public Engine(string name, EngineArgs args, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1beta:Engine", name, args ?? new EngineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Engine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1beta:Engine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EngineArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigArgs>? ChatEngineConfig { get; set; }
        ...
        /// </summary>
        [Input("commonConfig")]
        public Input<Inputs.GoogleCloudDiscoveryengineV1betaEngineCommonConfigArgs>? CommonConfig { get; set; }
        ...
        public Input<Pulumi.GoogleNative.DiscoveryEngine.V1Beta.EngineIndustryVertical>? IndustryVertical { get; set; }
        ...
        public Input<Inputs.GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigArgs>? SearchEngineConfig { get; set; }

        /// <summary>
        /// The solutions of the engine.
        /// </summary>
        [Input("solutionType", required: true)]
        public Input<Pulumi.GoogleNative.DiscoveryEngine.V1Beta.EngineSolutionType> SolutionType { get; set; } = null!;
