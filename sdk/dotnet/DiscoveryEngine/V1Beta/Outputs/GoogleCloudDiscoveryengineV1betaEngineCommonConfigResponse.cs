...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Beta.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudDiscoveryengineV1betaEngineCommonConfigResponse
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GoogleCloudDiscoveryengineV1betaEngineCommonConfigResponse(string companyName)
        {
