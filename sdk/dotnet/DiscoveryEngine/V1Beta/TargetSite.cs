...
namespace Pulumi.GoogleNative.DiscoveryEngine.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:discoveryengine/v1beta:TargetSite")]
    public partial class TargetSite : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudDiscoveryengineV1betaTargetSiteFailureReasonResponse> FailureReason { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudDiscoveryengineV1betaSiteVerificationInfoResponse> SiteVerificationInfo { get; private set; } = null!;
        ...
        public TargetSite(string name, TargetSiteArgs args, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1beta:TargetSite", name, args ?? new TargetSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:discoveryengine/v1beta:TargetSite", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TargetSiteArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.DiscoveryEngine.V1Beta.TargetSiteType>? Type { get; set; }
