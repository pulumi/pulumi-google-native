...
namespace Pulumi.GoogleCloud.Dlp.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dlp/v2:OrganizationJobTrigger")]
    public partial class OrganizationJobTrigger : Pulumi.CustomResource
    {
        ...
        public OrganizationJobTrigger(string name, OrganizationJobTriggerArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dlp/v2:OrganizationJobTrigger", name, args ?? new OrganizationJobTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationJobTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dlp/v2:OrganizationJobTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
