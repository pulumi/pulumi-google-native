...
namespace Pulumi.GoogleCloud.Dns.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:dns/v1:ResourceRecordSet")]
    public partial class ResourceRecordSet : Pulumi.CustomResource
    {
        ...
        public ResourceRecordSet(string name, ResourceRecordSetArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:dns/v1:ResourceRecordSet", name, args ?? new ResourceRecordSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceRecordSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:dns/v1:ResourceRecordSet", name, null, MakeResourceOptions(options, id))
        {
        }
