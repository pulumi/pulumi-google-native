...
namespace Pulumi.GoogleNative.Domains.V1
{
    public static class GetRegistration
    {
        ...
        public static Task<GetRegistrationResult> InvokeAsync(GetRegistrationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegistrationResult>("google-native:domains/v1:getRegistration", args ?? new GetRegistrationArgs(), options.WithVersion());

        /// <summary>
        /// Gets the details of a `Registration` resource.
        /// </summary>
        public static Output<GetRegistrationResult> Invoke(GetRegistrationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegistrationResult>("google-native:domains/v1:getRegistration", args ?? new GetRegistrationInvokeArgs(), options.WithVersion());
    }
