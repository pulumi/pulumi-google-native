...
namespace Pulumi.GoogleNative.Domains.V1.Inputs
{
    ...
    public sealed class DsRecordArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("algorithm")]
        public Input<Pulumi.GoogleNative.Domains.V1.DsRecordAlgorithm>? Algorithm { get; set; }
        ...
        /// </summary>
        [Input("digestType")]
        public Input<Pulumi.GoogleNative.Domains.V1.DsRecordDigestType>? DigestType { get; set; }
