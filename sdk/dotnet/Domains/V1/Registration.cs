...
namespace Pulumi.GoogleNative.Domains.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:domains/v1:Registration")]
    public partial class Registration : global::Pulumi.CustomResource
    {
        ...
        public Registration(string name, RegistrationArgs args, CustomResourceOptions? options = null)
            : base("google-native:domains/v1:Registration", name, args ?? new RegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:domains/v1:Registration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegistrationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.GoogleNative.Domains.V1.RegistrationContactNoticesItem>? _contactNotices;

        /// <summary>
        /// The list of contact notices that the caller acknowledges. The notices needed here depend on the values specified in `registration.contact_settings`.
        /// </summary>
        public InputList<Pulumi.GoogleNative.Domains.V1.RegistrationContactNoticesItem> ContactNotices
        {
            get => _contactNotices ?? (_contactNotices = new InputList<Pulumi.GoogleNative.Domains.V1.RegistrationContactNoticesItem>());
        ...
        [Input("domainNotices")]
        private InputList<Pulumi.GoogleNative.Domains.V1.RegistrationDomainNoticesItem>? _domainNotices;

        /// <summary>
        /// The list of domain notices that you acknowledge. Call `RetrieveRegisterParameters` to see the notices that need acknowledgement.
        /// </summary>
        public InputList<Pulumi.GoogleNative.Domains.V1.RegistrationDomainNoticesItem> DomainNotices
        {
            get => _domainNotices ?? (_domainNotices = new InputList<Pulumi.GoogleNative.Domains.V1.RegistrationDomainNoticesItem>());
