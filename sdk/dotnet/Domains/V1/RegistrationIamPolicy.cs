...
namespace Pulumi.GoogleNative.Domains.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:domains/v1:RegistrationIamPolicy")]
    public partial class RegistrationIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a RegistrationIamPolicy resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        ...
        public RegistrationIamPolicy(string name, RegistrationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:domains/v1:RegistrationIamPolicy", name, args ?? new RegistrationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:domains/v1:RegistrationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing RegistrationIamPolicy resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegistrationIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RegistrationIamPolicy(name, id, options);
        }
    }

    public sealed class RegistrationIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new RegistrationIamPolicyArgs Empty => new RegistrationIamPolicyArgs();
    }
}
