...
namespace Pulumi.GoogleNative.Domains.V1Alpha2
{
    public static class GetRegistration
    {
        ...
        public static Task<GetRegistrationResult> InvokeAsync(GetRegistrationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegistrationResult>("google-native:domains/v1alpha2:getRegistration", args ?? new GetRegistrationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a `Registration` resource.
        /// </summary>
        public static Output<GetRegistrationResult> Invoke(GetRegistrationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegistrationResult>("google-native:domains/v1alpha2:getRegistration", args ?? new GetRegistrationInvokeArgs(), options.WithDefaults());
    }
