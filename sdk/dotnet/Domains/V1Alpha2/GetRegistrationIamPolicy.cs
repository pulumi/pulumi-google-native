...
namespace Pulumi.GoogleNative.Domains.V1Alpha2
{
    public static class GetRegistrationIamPolicy
    {
        ...
        public static Task<GetRegistrationIamPolicyResult> InvokeAsync(GetRegistrationIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegistrationIamPolicyResult>("google-native:domains/v1alpha2:getRegistrationIamPolicy", args ?? new GetRegistrationIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetRegistrationIamPolicyResult> Invoke(GetRegistrationIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegistrationIamPolicyResult>("google-native:domains/v1alpha2:getRegistrationIamPolicy", args ?? new GetRegistrationIamPolicyInvokeArgs(), options.WithVersion());
    }


    public sealed class GetRegistrationIamPolicyArgs : Pulumi.InvokeArgs
    {
