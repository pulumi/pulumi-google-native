...
namespace Pulumi.GcpNative.Domains.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:domains/v1beta1:Registration")]
    public partial class Registration : Pulumi.CustomResource
    {
        ...
        public Registration(string name, RegistrationArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:domains/v1beta1:Registration", name, args ?? new RegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:domains/v1beta1:Registration", name, null, MakeResourceOptions(options, id))
        {
        }
