...
namespace Pulumi.GoogleNative.Domains.V1Beta1
{
    ...
    public partial class RegistrationIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegistrationIamPolicy(string name, RegistrationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:domains/v1beta1:RegistrationIamPolicy", name, args ?? new RegistrationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:domains/v1beta1:RegistrationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
