...
namespace Pulumi.GoogleCloud.Domains.V1alpha2
{
    /// <summary>
    /// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:domains/v1alpha2:RegistrationIamPolicy")]
    public partial class RegistrationIamPolicy : Pulumi.CustomResource
    {
        ...
        public RegistrationIamPolicy(string name, RegistrationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:domains/v1alpha2:RegistrationIamPolicy", name, args ?? new RegistrationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistrationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:domains/v1alpha2:RegistrationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
