...
namespace Pulumi.GoogleNative.Eventarc.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:eventarc/v1:TriggerIamPolicy")]
    public partial class TriggerIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public TriggerIamPolicy(string name, TriggerIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:eventarc/v1:TriggerIamPolicy", name, args ?? new TriggerIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TriggerIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:eventarc/v1:TriggerIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
