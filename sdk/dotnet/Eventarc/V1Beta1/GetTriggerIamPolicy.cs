...
{
    public static class GetTriggerIamPolicy
    {
        /// <summary>
        ...
        public static Task<GetTriggerIamPolicyResult> InvokeAsync(GetTriggerIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTriggerIamPolicyResult>("google-native:eventarc/v1beta1:getTriggerIamPolicy", args ?? new GetTriggerIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetTriggerIamPolicyResult> Invoke(GetTriggerIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTriggerIamPolicyResult>("google-native:eventarc/v1beta1:getTriggerIamPolicy", args ?? new GetTriggerIamPolicyInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetTriggerIamPolicyResult
    {
        /// <summary>
