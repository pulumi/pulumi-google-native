...
namespace Pulumi.GoogleNative.File.V1
{
    public static class GetSnapshot
    {
        ...
        public static Task<GetSnapshotResult> InvokeAsync(GetSnapshotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotResult>("google-native:file/v1:getSnapshot", args ?? new GetSnapshotArgs(), options.WithVersion());

        /// <summary>
        /// Gets the details of a specific snapshot.
        /// </summary>
        public static Output<GetSnapshotResult> Invoke(GetSnapshotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSnapshotResult>("google-native:file/v1:getSnapshot", args ?? new GetSnapshotInvokeArgs(), options.WithVersion());
    }
