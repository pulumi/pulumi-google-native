...
namespace Pulumi.GoogleNative.File.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:file/v1beta1:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("google-native:file/v1beta1:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:file/v1beta1:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
