...
namespace Pulumi.GcpNative.Firebase.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:firebase/v1beta1:AndroidApp")]
    public partial class AndroidApp : Pulumi.CustomResource
    {
        ...
        public AndroidApp(string name, AndroidAppArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:firebase/v1beta1:AndroidApp", name, args ?? new AndroidAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AndroidApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:firebase/v1beta1:AndroidApp", name, null, MakeResourceOptions(options, id))
        {
        }
