...
namespace Pulumi.GoogleNative.FirebaseAppCheck.V1Beta
{
    ...
    public partial class DebugToken : Pulumi.CustomResource
    {
        ...
        public DebugToken(string name, DebugTokenArgs args, CustomResourceOptions? options = null)
            : base("google-native:firebaseappcheck/v1beta:DebugToken", name, args ?? new DebugTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DebugToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:firebaseappcheck/v1beta:DebugToken", name, null, MakeResourceOptions(options, id))
        {
        }
