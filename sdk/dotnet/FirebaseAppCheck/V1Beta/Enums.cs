...
namespace Pulumi.GoogleNative.FirebaseAppCheck.V1Beta
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct ResourcePolicyEnforcementMode : IEquatable<ResourcePolicyEnforcementMode>
    {
        private readonly string _value;

        private ResourcePolicyEnforcementMode(string value)
        {
        ...
        /// </summary>
        public static ResourcePolicyEnforcementMode Off { get; } = new ResourcePolicyEnforcementMode("OFF");
        /// <summary>
        ...
        /// </summary>
        public static ResourcePolicyEnforcementMode Unenforced { get; } = new ResourcePolicyEnforcementMode("UNENFORCED");
        /// <summary>
        ...
        /// </summary>
        public static ResourcePolicyEnforcementMode Enforced { get; } = new ResourcePolicyEnforcementMode("ENFORCED");

        public static bool operator ==(ResourcePolicyEnforcementMode left, ResourcePolicyEnforcementMode right) => left.Equals(right);
        public static bool operator !=(ResourcePolicyEnforcementMode left, ResourcePolicyEnforcementMode right) => !left.Equals(right);

        public static explicit operator string(ResourcePolicyEnforcementMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ResourcePolicyEnforcementMode other && Equals(other);
        public bool Equals(ResourcePolicyEnforcementMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
