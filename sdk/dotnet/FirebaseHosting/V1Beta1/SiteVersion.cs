...
namespace Pulumi.GcpNative.FirebaseHosting.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:firebasehosting/v1beta1:SiteVersion")]
    public partial class SiteVersion : Pulumi.CustomResource
    {
        ...
        public SiteVersion(string name, SiteVersionArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:firebasehosting/v1beta1:SiteVersion", name, args ?? new SiteVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SiteVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:firebasehosting/v1beta1:SiteVersion", name, null, MakeResourceOptions(options, id))
        {
        }
