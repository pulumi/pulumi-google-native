...
namespace Pulumi.GoogleNative.Firestore.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:firestore/v1:DatabaseCollectionGroupIndex")]
    public partial class DatabaseCollectionGroupIndex : Pulumi.CustomResource
    {
        ...
        public DatabaseCollectionGroupIndex(string name, DatabaseCollectionGroupIndexArgs args, CustomResourceOptions? options = null)
            : base("google-native:firestore/v1:DatabaseCollectionGroupIndex", name, args ?? new DatabaseCollectionGroupIndexArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseCollectionGroupIndex(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:firestore/v1:DatabaseCollectionGroupIndex", name, null, MakeResourceOptions(options, id))
        {
        }
