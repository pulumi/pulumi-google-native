...
namespace Pulumi.GoogleNative.Firestore.V1
{
    ...
    public partial class Index : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("fields")]
        public Output<ImmutableArray<Outputs.GoogleFirestoreAdminV1IndexFieldResponse>> Fields { get; private set; } = null!;
        ...
        public Index(string name, IndexArgs args, CustomResourceOptions? options = null)
            : base("google-native:firestore/v1:Index", name, args ?? new IndexArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Index(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:firestore/v1:Index", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IndexArgs : Pulumi.ResourceArgs
    {
        ...
        /// The fields supported by this index. For composite indexes, this is always 2 or more fields. The last field entry is always for the field path `__name__`. If, on creation, `__name__` was not specified as the last field, it will be added automatically with the same direction as that of the last field defined. If the final field in a composite index is not directional, the `__name__` will be ordered ASCENDING (unless explicitly specified). For single field indexes, this will always be exactly one entry with a field path equal to the field path of the associated field.
        /// </summary>
        public InputList<Inputs.GoogleFirestoreAdminV1IndexFieldArgs> Fields
        {
            get => _fields ?? (_fields = new InputList<Inputs.GoogleFirestoreAdminV1IndexFieldArgs>());
            set => _fields = value;
        }
        ...
        /// </summary>
        [Input("queryScope")]
        public Input<Pulumi.GoogleNative.Firestore.V1.IndexQueryScope>? QueryScope { get; set; }

        /// <summary>
        /// The serving state of the index.
        /// </summary>
        [Input("state")]
        public Input<Pulumi.GoogleNative.Firestore.V1.IndexState>? State { get; set; }
