...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1:FeatureIamPolicy")]
    public partial class FeatureIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public FeatureIamPolicy(string name, FeatureIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:FeatureIamPolicy", name, args ?? new FeatureIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FeatureIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:FeatureIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
