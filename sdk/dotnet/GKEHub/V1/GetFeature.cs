...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    public static class GetFeature
    {
        ...
        public static Task<GetFeatureResult> InvokeAsync(GetFeatureArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFeatureResult>("google-native:gkehub/v1:getFeature", args ?? new GetFeatureArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single Feature.
        /// </summary>
        public static Output<GetFeatureResult> Invoke(GetFeatureInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFeatureResult>("google-native:gkehub/v1:getFeature", args ?? new GetFeatureInvokeArgs(), options.WithDefaults());
    }
