...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    public static class GetFeatureIamPolicy
    {
        ...
        public static Task<GetFeatureIamPolicyResult> InvokeAsync(GetFeatureIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFeatureIamPolicyResult>("google-native:gkehub/v1:getFeatureIamPolicy", args ?? new GetFeatureIamPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetFeatureIamPolicyResult> Invoke(GetFeatureIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFeatureIamPolicyResult>("google-native:gkehub/v1:getFeatureIamPolicy", args ?? new GetFeatureIamPolicyInvokeArgs(), options.WithVersion());
    }
