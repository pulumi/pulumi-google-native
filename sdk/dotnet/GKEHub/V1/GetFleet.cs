...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    public static class GetFleet
    {
        ...
        public static Task<GetFleetResult> InvokeAsync(GetFleetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFleetResult>("google-native:gkehub/v1:getFleet", args ?? new GetFleetArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the details of a fleet.
        /// </summary>
        public static Output<GetFleetResult> Invoke(GetFleetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFleetResult>("google-native:gkehub/v1:getFleet", args ?? new GetFleetInvokeArgs(), options.WithDefaults());
    }
