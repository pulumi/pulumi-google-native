...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    public static class GetNamespace
    {
        ...
        public static Task<GetNamespaceResult> InvokeAsync(GetNamespaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNamespaceResult>("google-native:gkehub/v1:getNamespace", args ?? new GetNamespaceArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the details of a fleet namespace.
        /// </summary>
        public static Output<GetNamespaceResult> Invoke(GetNamespaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNamespaceResult>("google-native:gkehub/v1:getNamespace", args ?? new GetNamespaceInvokeArgs(), options.WithDefaults());
    }
