...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    public static class GetScope
    {
        ...
        public static Task<GetScopeResult> InvokeAsync(GetScopeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScopeResult>("google-native:gkehub/v1:getScope", args ?? new GetScopeArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the details of a Scope.
        /// </summary>
        public static Output<GetScopeResult> Invoke(GetScopeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScopeResult>("google-native:gkehub/v1:getScope", args ?? new GetScopeInvokeArgs(), options.WithDefaults());
    }
