...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1:MembershipIamBinding")]
    public partial class MembershipIamBinding : global::Pulumi.CustomResource
    {
        ...
        public MembershipIamBinding(string name, MembershipIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:MembershipIamBinding", name, args ?? new MembershipIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MembershipIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:MembershipIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
