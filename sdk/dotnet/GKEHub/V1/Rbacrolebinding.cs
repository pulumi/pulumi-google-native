...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1:Rbacrolebinding")]
    public partial class Rbacrolebinding : global::Pulumi.CustomResource
    {
        ...
        public Rbacrolebinding(string name, RbacrolebindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:Rbacrolebinding", name, args ?? new RbacrolebindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rbacrolebinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:Rbacrolebinding", name, null, MakeResourceOptions(options, id))
        {
        }
