...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1:Scope")]
    public partial class Scope : global::Pulumi.CustomResource
    {
        ...
        public Scope(string name, ScopeArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:Scope", name, args ?? new ScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Scope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:Scope", name, null, MakeResourceOptions(options, id))
        {
        }
