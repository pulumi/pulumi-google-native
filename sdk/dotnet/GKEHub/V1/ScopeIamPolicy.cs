...
namespace Pulumi.GoogleNative.GKEHub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1:ScopeIamPolicy")]
    public partial class ScopeIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ScopeIamPolicy(string name, ScopeIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:ScopeIamPolicy", name, args ?? new ScopeIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1:ScopeIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
