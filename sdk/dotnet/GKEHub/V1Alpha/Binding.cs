...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha:Binding")]
    public partial class Binding : global::Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
