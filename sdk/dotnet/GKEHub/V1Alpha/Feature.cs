...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    ...
    public partial class Feature : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.MembershipFeatureSpecResponse> MembershipSpecs { get; private set; } = null!;

        /// <summary>
        /// Membership-specific Feature status. If this Feature does report any per-Membership status, this field may be unused. The keys indicate which Membership the state is for, in the form: `projects/{p}/locations/{l}/memberships/{m}` Where {p} is the project number, {l} is a valid location and {m} is a valid Membership in this project at that location. {p} MUST match the Feature's project number.
        /// </summary>
        [Output("membershipStates")]
        public Output<Outputs.MembershipFeatureStateResponse> MembershipStates { get; private set; } = null!;
        ...
        /// </summary>
        [Output("scopeSpecs")]
        public Output<Outputs.ScopeFeatureSpecResponse> ScopeSpecs { get; private set; } = null!;
        ...
        /// </summary>
        [Output("scopeStates")]
        public Output<Outputs.ScopeFeatureStateResponse> ScopeStates { get; private set; } = null!;
        ...
        private Feature(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Feature", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FeatureArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MembershipFeatureSpecArgs>? MembershipSpecs { get; set; }
        ...
        /// </summary>
        [Input("scopeSpecs")]
        public Input<Inputs.ScopeFeatureSpecArgs>? ScopeSpecs { get; set; }
