...
namespace Pulumi.GcpNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:gkehub/v1alpha:FeatureIamPolicy")]
    public partial class FeatureIamPolicy : Pulumi.CustomResource
    {
        ...
        public FeatureIamPolicy(string name, FeatureIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:gkehub/v1alpha:FeatureIamPolicy", name, args ?? new FeatureIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FeatureIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:gkehub/v1alpha:FeatureIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
