...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    public static class GetRbacrolebinding
    {
        ...
        public static Task<GetRbacrolebindingResult> InvokeAsync(GetRbacrolebindingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRbacrolebindingResult>("google-native:gkehub/v1alpha:getRbacrolebinding", args ?? new GetRbacrolebindingArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the details of a RBACRoleBinding.
        /// </summary>
        public static Output<GetRbacrolebindingResult> Invoke(GetRbacrolebindingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRbacrolebindingResult>("google-native:gkehub/v1alpha:getRbacrolebinding", args ?? new GetRbacrolebindingInvokeArgs(), options.WithDefaults());
    }
