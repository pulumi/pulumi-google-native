...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha.Inputs
{
    ...
    public sealed class SecurityPostureConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public Input<Pulumi.GoogleNative.GKEHub.V1Alpha.SecurityPostureConfigMode>? Mode { get; set; }

        /// <summary>
        /// Sets which mode to use for vulnerability scanning.
        /// </summary>
        [Input("vulnerabilityMode")]
        public Input<Pulumi.GoogleNative.GKEHub.V1Alpha.SecurityPostureConfigVulnerabilityMode>? VulnerabilityMode { get; set; }
