...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha:Membership")]
    public partial class Membership : global::Pulumi.CustomResource
    {
        ...
        public Membership(string name, MembershipArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Membership", name, args ?? new MembershipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Membership(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Membership", name, null, MakeResourceOptions(options, id))
        {
        }
