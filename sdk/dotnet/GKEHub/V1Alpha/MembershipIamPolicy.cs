...
namespace Pulumi.GcpNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:gkehub/v1alpha:MembershipIamPolicy")]
    public partial class MembershipIamPolicy : Pulumi.CustomResource
    {
        ...
        public MembershipIamPolicy(string name, MembershipIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:gkehub/v1alpha:MembershipIamPolicy", name, args ?? new MembershipIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MembershipIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:gkehub/v1alpha:MembershipIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
