...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha:MembershipRbacRoleBinding")]
    public partial class MembershipRbacRoleBinding : global::Pulumi.CustomResource
    {
        ...
        public MembershipRbacRoleBinding(string name, MembershipRbacRoleBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:MembershipRbacRoleBinding", name, args ?? new MembershipRbacRoleBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MembershipRbacRoleBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:MembershipRbacRoleBinding", name, null, MakeResourceOptions(options, id))
        {
        }
