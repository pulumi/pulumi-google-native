...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
