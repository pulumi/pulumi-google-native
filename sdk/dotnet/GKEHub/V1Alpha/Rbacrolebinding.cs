...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha:Rbacrolebinding")]
    public partial class Rbacrolebinding : global::Pulumi.CustomResource
    {
        ...
        public Rbacrolebinding(string name, RbacrolebindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Rbacrolebinding", name, args ?? new RbacrolebindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rbacrolebinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:Rbacrolebinding", name, null, MakeResourceOptions(options, id))
        {
        }
