...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha:ScopeIamPolicy")]
    public partial class ScopeIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ScopeIamPolicy(string name, ScopeIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:ScopeIamPolicy", name, args ?? new ScopeIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:ScopeIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ScopeIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ScopeIamPolicy(name, id, options);
        }
    }
