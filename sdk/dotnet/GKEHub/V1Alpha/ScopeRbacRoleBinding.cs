...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha:ScopeRbacRoleBinding")]
    public partial class ScopeRbacRoleBinding : global::Pulumi.CustomResource
    {
        ...
        public ScopeRbacRoleBinding(string name, ScopeRbacRoleBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:ScopeRbacRoleBinding", name, args ?? new ScopeRbacRoleBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeRbacRoleBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha:ScopeRbacRoleBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ScopeRbacRoleBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ScopeRbacRoleBinding(name, id, options);
        }
    }
