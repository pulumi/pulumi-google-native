...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha2
{
    public static class GetMembershipIamPolicy
    {
        ...
        public static Task<GetMembershipIamPolicyResult> InvokeAsync(GetMembershipIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMembershipIamPolicyResult>("google-native:gkehub/v1alpha2:getMembershipIamPolicy", args ?? new GetMembershipIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetMembershipIamPolicyResult> Invoke(GetMembershipIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMembershipIamPolicyResult>("google-native:gkehub/v1alpha2:getMembershipIamPolicy", args ?? new GetMembershipIamPolicyInvokeArgs(), options.WithDefaults());
    }
