...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha2
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha2:MembershipIamBinding")]
    public partial class MembershipIamBinding : global::Pulumi.CustomResource
    {
        ...
        public MembershipIamBinding(string name, MembershipIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha2:MembershipIamBinding", name, args ?? new MembershipIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MembershipIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha2:MembershipIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
