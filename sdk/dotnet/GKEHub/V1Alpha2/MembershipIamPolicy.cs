...
namespace Pulumi.GoogleNative.GKEHub.V1Alpha2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1alpha2:MembershipIamPolicy")]
    public partial class MembershipIamPolicy : Pulumi.CustomResource
    {
        ...
        public MembershipIamPolicy(string name, MembershipIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha2:MembershipIamPolicy", name, args ?? new MembershipIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MembershipIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1alpha2:MembershipIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
