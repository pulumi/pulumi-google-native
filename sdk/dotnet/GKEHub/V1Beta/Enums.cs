...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct MembershipSpecSecurityPolicy : IEquatable<MembershipSpecSecurityPolicy>
    {
        private readonly string _value;

        private MembershipSpecSecurityPolicy(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Unspecified policy
        /// </summary>
        public static MembershipSpecSecurityPolicy SecurityPolicyUnspecified { get; } = new MembershipSpecSecurityPolicy("SECURITY_POLICY_UNSPECIFIED");
        /// <summary>
        /// Privileged build pods are disallowed
        /// </summary>
        public static MembershipSpecSecurityPolicy NonPrivileged { get; } = new MembershipSpecSecurityPolicy("NON_PRIVILEGED");
        /// <summary>
        /// Privileged build pods are allowed
        /// </summary>
        public static MembershipSpecSecurityPolicy Privileged { get; } = new MembershipSpecSecurityPolicy("PRIVILEGED");

        public static bool operator ==(MembershipSpecSecurityPolicy left, MembershipSpecSecurityPolicy right) => left.Equals(right);
        public static bool operator !=(MembershipSpecSecurityPolicy left, MembershipSpecSecurityPolicy right) => !left.Equals(right);

        public static explicit operator string(MembershipSpecSecurityPolicy value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is MembershipSpecSecurityPolicy other && Equals(other);
        public bool Equals(MembershipSpecSecurityPolicy other) => string.Equals(_value, other._value, StringComparison.Ordinal);
