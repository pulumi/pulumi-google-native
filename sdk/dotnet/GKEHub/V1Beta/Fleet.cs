...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1beta:Fleet")]
    public partial class Fleet : global::Pulumi.CustomResource
    {
        ...
        public Fleet(string name, FleetArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:Fleet", name, args ?? new FleetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
