...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    public static class GetBinding
    {
        ...
        public static Task<GetBindingResult> InvokeAsync(GetBindingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBindingResult>("google-native:gkehub/v1beta:getBinding", args ?? new GetBindingArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the details of a MembershipBinding.
        /// </summary>
        public static Output<GetBindingResult> Invoke(GetBindingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBindingResult>("google-native:gkehub/v1beta:getBinding", args ?? new GetBindingInvokeArgs(), options.WithDefaults());
    }
