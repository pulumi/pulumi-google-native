...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    public static class GetMembershipIamPolicy
    {
        ...
        public static Task<GetMembershipIamPolicyResult> InvokeAsync(GetMembershipIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMembershipIamPolicyResult>("google-native:gkehub/v1beta:getMembershipIamPolicy", args ?? new GetMembershipIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetMembershipIamPolicyResult> Invoke(GetMembershipIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMembershipIamPolicyResult>("google-native:gkehub/v1beta:getMembershipIamPolicy", args ?? new GetMembershipIamPolicyInvokeArgs(), options.WithVersion());
    }
