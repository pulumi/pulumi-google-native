...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    public static class GetScopeIamPolicy
    {
        ...
        public static Task<GetScopeIamPolicyResult> InvokeAsync(GetScopeIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScopeIamPolicyResult>("google-native:gkehub/v1beta:getScopeIamPolicy", args ?? new GetScopeIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetScopeIamPolicyResult> Invoke(GetScopeIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScopeIamPolicyResult>("google-native:gkehub/v1beta:getScopeIamPolicy", args ?? new GetScopeIamPolicyInvokeArgs(), options.WithDefaults());
    }
