...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1beta:MembershipIamBinding")]
    public partial class MembershipIamBinding : global::Pulumi.CustomResource
    {
        ...
        public MembershipIamBinding(string name, MembershipIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:MembershipIamBinding", name, args ?? new MembershipIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MembershipIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:MembershipIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
