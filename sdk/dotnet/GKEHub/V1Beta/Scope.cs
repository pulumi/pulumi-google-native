...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1beta:Scope")]
    public partial class Scope : global::Pulumi.CustomResource
    {
        ...
        public Scope(string name, ScopeArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:Scope", name, args ?? new ScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Scope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:Scope", name, null, MakeResourceOptions(options, id))
        {
        }
