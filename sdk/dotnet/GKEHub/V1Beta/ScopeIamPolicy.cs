...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1beta:ScopeIamPolicy")]
    public partial class ScopeIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ScopeIamPolicy(string name, ScopeIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:ScopeIamPolicy", name, args ?? new ScopeIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:ScopeIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
