...
namespace Pulumi.GoogleNative.GKEHub.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkehub/v1beta:ScopeRbacRoleBinding")]
    public partial class ScopeRbacRoleBinding : global::Pulumi.CustomResource
    {
        ...
        public ScopeRbacRoleBinding(string name, ScopeRbacRoleBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:ScopeRbacRoleBinding", name, args ?? new ScopeRbacRoleBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeRbacRoleBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta:ScopeRbacRoleBinding", name, null, MakeResourceOptions(options, id))
        {
        }
