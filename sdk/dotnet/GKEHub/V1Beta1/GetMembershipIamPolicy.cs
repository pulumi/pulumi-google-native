...
namespace Pulumi.GoogleNative.GKEHub.V1Beta1
{
    public static class GetMembershipIamPolicy
    {
        ...
        public static Task<GetMembershipIamPolicyResult> InvokeAsync(GetMembershipIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMembershipIamPolicyResult>("google-native:gkehub/v1beta1:getMembershipIamPolicy", args ?? new GetMembershipIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetMembershipIamPolicyResult> Invoke(GetMembershipIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMembershipIamPolicyResult>("google-native:gkehub/v1beta1:getMembershipIamPolicy", args ?? new GetMembershipIamPolicyInvokeArgs(), options.WithDefaults());
    }
