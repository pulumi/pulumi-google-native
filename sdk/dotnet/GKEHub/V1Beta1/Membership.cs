...
namespace Pulumi.GcpNative.GKEHub.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:gkehub/v1beta1:Membership")]
    public partial class Membership : Pulumi.CustomResource
    {
        ...
        public Membership(string name, MembershipArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:gkehub/v1beta1:Membership", name, args ?? new MembershipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Membership(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:gkehub/v1beta1:Membership", name, null, MakeResourceOptions(options, id))
        {
        }
