...
namespace Pulumi.GoogleNative.GKEHub.V1Beta1
{
    ...
    public partial class Membership : Pulumi.CustomResource
    {
        ...
        public Membership(string name, MembershipArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta1:Membership", name, args ?? new MembershipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Membership(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkehub/v1beta1:Membership", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MembershipArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.GKEHub.V1Beta1.MembershipInfrastructureType>? InfrastructureType { get; set; }
