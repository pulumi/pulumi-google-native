...
namespace Pulumi.GoogleNative.GameServices.V1
{
    ...
    public partial class Config : Pulumi.CustomResource
    {
        ...
        public Config(string name, ConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:gameservices/v1:Config", name, args ?? new ConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Config(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gameservices/v1:Config", name, null, MakeResourceOptions(options, id))
        {
        }
