...
namespace Pulumi.GcpNative.GameServices.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:gameservices/v1:GameServerDeployment")]
    public partial class GameServerDeployment : Pulumi.CustomResource
    {
        ...
        public GameServerDeployment(string name, GameServerDeploymentArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:gameservices/v1:GameServerDeployment", name, args ?? new GameServerDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GameServerDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:gameservices/v1:GameServerDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
