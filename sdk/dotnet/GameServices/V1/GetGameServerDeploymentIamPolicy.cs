...
namespace Pulumi.GoogleNative.GameServices.V1
{
    public static class GetGameServerDeploymentIamPolicy
    {
        ...
        public static Task<GetGameServerDeploymentIamPolicyResult> InvokeAsync(GetGameServerDeploymentIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGameServerDeploymentIamPolicyResult>("google-native:gameservices/v1:getGameServerDeploymentIamPolicy", args ?? new GetGameServerDeploymentIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetGameServerDeploymentIamPolicyResult> Invoke(GetGameServerDeploymentIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGameServerDeploymentIamPolicyResult>("google-native:gameservices/v1:getGameServerDeploymentIamPolicy", args ?? new GetGameServerDeploymentIamPolicyInvokeArgs(), options.WithDefaults());
    }
