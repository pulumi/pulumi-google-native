...
namespace Pulumi.GoogleCloud.GameServices.V1Beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:gameservices/v1beta:GameServerDeploymentIamPolicy")]
    public partial class GameServerDeploymentIamPolicy : Pulumi.CustomResource
    {
        ...
        public GameServerDeploymentIamPolicy(string name, GameServerDeploymentIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:gameservices/v1beta:GameServerDeploymentIamPolicy", name, args ?? new GameServerDeploymentIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GameServerDeploymentIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:gameservices/v1beta:GameServerDeploymentIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
