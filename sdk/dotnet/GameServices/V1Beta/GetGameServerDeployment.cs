...
namespace Pulumi.GoogleNative.GameServices.V1Beta
{
    public static class GetGameServerDeployment
    {
        ...
        public static Task<GetGameServerDeploymentResult> InvokeAsync(GetGameServerDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGameServerDeploymentResult>("google-native:gameservices/v1beta:getGameServerDeployment", args ?? new GetGameServerDeploymentArgs(), options.WithVersion());
        ...
        public static Output<GetGameServerDeploymentResult> Invoke(GetGameServerDeploymentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGameServerDeploymentResult>("google-native:gameservices/v1beta:getGameServerDeployment", args ?? new GetGameServerDeploymentInvokeArgs(), options.WithVersion());
    }
