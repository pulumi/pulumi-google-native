...
namespace Pulumi.GoogleCloud.Gameservices.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:gameservices/v1:GameServerCluster")]
    public partial class GameServerCluster : Pulumi.CustomResource
    {
        ...
        public GameServerCluster(string name, GameServerClusterArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:gameservices/v1:GameServerCluster", name, args ?? new GameServerClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GameServerCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:gameservices/v1:GameServerCluster", name, null, MakeResourceOptions(options, id))
        {
        }
