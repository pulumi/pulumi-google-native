...
namespace Pulumi.GoogleCloud.Gameservices.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:gameservices/v1:Realm")]
    public partial class Realm : Pulumi.CustomResource
    {
        ...
        public Realm(string name, RealmArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:gameservices/v1:Realm", name, args ?? new RealmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Realm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:gameservices/v1:Realm", name, null, MakeResourceOptions(options, id))
        {
        }
