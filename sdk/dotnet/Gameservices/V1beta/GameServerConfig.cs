...
namespace Pulumi.GoogleCloud.Gameservices.V1beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:gameservices/v1beta:GameServerConfig")]
    public partial class GameServerConfig : Pulumi.CustomResource
    {
        ...
        public GameServerConfig(string name, GameServerConfigArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:gameservices/v1beta:GameServerConfig", name, args ?? new GameServerConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GameServerConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:gameservices/v1beta:GameServerConfig", name, null, MakeResourceOptions(options, id))
        {
        }
