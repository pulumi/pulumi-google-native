...
namespace Pulumi.GoogleNative.Gkebackup.V1
{
    ...
    public partial class BackupPlanBackupIamPolicy : Pulumi.CustomResource
    {
        ...
        public BackupPlanBackupIamPolicy(string name, BackupPlanBackupIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkebackup/v1:BackupPlanBackupIamPolicy", name, args ?? new BackupPlanBackupIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPlanBackupIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkebackup/v1:BackupPlanBackupIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BackupPlanBackupIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
