...
namespace Pulumi.GoogleNative.Gkebackup.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:gkebackup/v1:RestorePlanIamBinding")]
    public partial class RestorePlanIamBinding : global::Pulumi.CustomResource
    {
        ...
        public RestorePlanIamBinding(string name, RestorePlanIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkebackup/v1:RestorePlanIamBinding", name, args ?? new RestorePlanIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePlanIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkebackup/v1:RestorePlanIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RestorePlanIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new RestorePlanIamBinding(name, id, options);
        }
    }
