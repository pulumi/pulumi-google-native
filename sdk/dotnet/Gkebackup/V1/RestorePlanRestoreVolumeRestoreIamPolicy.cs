...
namespace Pulumi.GoogleNative.Gkebackup.V1
{
    ...
    public partial class RestorePlanRestoreVolumeRestoreIamPolicy : global::Pulumi.CustomResource
    {
        ...
        [Output("volumeRestoreId")]
        public Output<string> VolumeRestoreId { get; private set; } = null!;
        ...
        public RestorePlanRestoreVolumeRestoreIamPolicy(string name, RestorePlanRestoreVolumeRestoreIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:gkebackup/v1:RestorePlanRestoreVolumeRestoreIamPolicy", name, args ?? new RestorePlanRestoreVolumeRestoreIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePlanRestoreVolumeRestoreIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:gkebackup/v1:RestorePlanRestoreVolumeRestoreIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RestorePlanRestoreVolumeRestoreIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
