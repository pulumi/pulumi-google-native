...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:AttributeDefinition")]
    public partial class AttributeDefinition : Pulumi.CustomResource
    {
        ...
        public AttributeDefinition(string name, AttributeDefinitionArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:AttributeDefinition", name, args ?? new AttributeDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttributeDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:AttributeDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
