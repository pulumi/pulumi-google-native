...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1:ConsentStore")]
    public partial class ConsentStore : Pulumi.CustomResource
    {
        ...
        public ConsentStore(string name, ConsentStoreArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:ConsentStore", name, args ?? new ConsentStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsentStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:ConsentStore", name, null, MakeResourceOptions(options, id))
        {
        }
