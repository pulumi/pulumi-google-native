...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:DatasetConsentStore")]
    public partial class DatasetConsentStore : Pulumi.CustomResource
    {
        ...
        public DatasetConsentStore(string name, DatasetConsentStoreArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetConsentStore", name, args ?? new DatasetConsentStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetConsentStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetConsentStore", name, null, MakeResourceOptions(options, id))
        {
        }
