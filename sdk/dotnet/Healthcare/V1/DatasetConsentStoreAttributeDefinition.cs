...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:DatasetConsentStoreAttributeDefinition")]
    public partial class DatasetConsentStoreAttributeDefinition : Pulumi.CustomResource
    {
        ...
        public DatasetConsentStoreAttributeDefinition(string name, DatasetConsentStoreAttributeDefinitionArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetConsentStoreAttributeDefinition", name, args ?? new DatasetConsentStoreAttributeDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetConsentStoreAttributeDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetConsentStoreAttributeDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
