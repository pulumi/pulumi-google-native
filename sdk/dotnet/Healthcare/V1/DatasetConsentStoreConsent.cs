...
namespace Pulumi.GcpNative.Healthcare.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:healthcare/v1:DatasetConsentStoreConsent")]
    public partial class DatasetConsentStoreConsent : Pulumi.CustomResource
    {
        ...
        public DatasetConsentStoreConsent(string name, DatasetConsentStoreConsentArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:healthcare/v1:DatasetConsentStoreConsent", name, args ?? new DatasetConsentStoreConsentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetConsentStoreConsent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:healthcare/v1:DatasetConsentStoreConsent", name, null, MakeResourceOptions(options, id))
        {
        }
