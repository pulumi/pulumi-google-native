...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1:DatasetConsentStoreConsent")]
    public partial class DatasetConsentStoreConsent : Pulumi.CustomResource
    {
        ...
        public DatasetConsentStoreConsent(string name, DatasetConsentStoreConsentArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetConsentStoreConsent", name, args ?? new DatasetConsentStoreConsentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetConsentStoreConsent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetConsentStoreConsent", name, null, MakeResourceOptions(options, id))
        {
        }
