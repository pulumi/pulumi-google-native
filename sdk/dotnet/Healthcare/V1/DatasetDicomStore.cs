...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1:DatasetDicomStore")]
    public partial class DatasetDicomStore : Pulumi.CustomResource
    {
        ...
        public DatasetDicomStore(string name, DatasetDicomStoreArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetDicomStore", name, args ?? new DatasetDicomStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetDicomStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetDicomStore", name, null, MakeResourceOptions(options, id))
        {
        }
