...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:DatasetDicomStoreIamPolicy")]
    public partial class DatasetDicomStoreIamPolicy : Pulumi.CustomResource
    {
        ...
        public DatasetDicomStoreIamPolicy(string name, DatasetDicomStoreIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetDicomStoreIamPolicy", name, args ?? new DatasetDicomStoreIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetDicomStoreIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetDicomStoreIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
