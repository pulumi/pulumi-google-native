...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    ...
    public partial class DatasetFhirStore : Pulumi.CustomResource
    {
        ...
        public DatasetFhirStore(string name, DatasetFhirStoreArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetFhirStore", name, args ?? new DatasetFhirStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetFhirStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetFhirStore", name, null, MakeResourceOptions(options, id))
        {
        }
