...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1:DatasetFhirStoreFhir")]
    public partial class DatasetFhirStoreFhir : Pulumi.CustomResource
    {
        ...
        public DatasetFhirStoreFhir(string name, DatasetFhirStoreFhirArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetFhirStoreFhir", name, args ?? new DatasetFhirStoreFhirArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetFhirStoreFhir(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetFhirStoreFhir", name, null, MakeResourceOptions(options, id))
        {
        }
