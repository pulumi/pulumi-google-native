...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:DatasetFhirStoreIamPolicy")]
    public partial class DatasetFhirStoreIamPolicy : Pulumi.CustomResource
    {
        ...
        public DatasetFhirStoreIamPolicy(string name, DatasetFhirStoreIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetFhirStoreIamPolicy", name, args ?? new DatasetFhirStoreIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetFhirStoreIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetFhirStoreIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
