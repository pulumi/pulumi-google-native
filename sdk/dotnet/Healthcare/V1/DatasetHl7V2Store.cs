...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:DatasetHl7V2Store")]
    public partial class DatasetHl7V2Store : Pulumi.CustomResource
    {
        ...
        public DatasetHl7V2Store(string name, DatasetHl7V2StoreArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetHl7V2Store", name, args ?? new DatasetHl7V2StoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetHl7V2Store(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DatasetHl7V2Store", name, null, MakeResourceOptions(options, id))
        {
        }
