...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1:DatasetIamBinding")]
    public partial class DatasetIamBinding : global::Pulumi.CustomResource
    {
        ...
        public DatasetIamBinding(string name, DatasetIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetIamBinding", name, args ?? new DatasetIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatasetIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DatasetIamBinding(name, id, options);
        }
    }
