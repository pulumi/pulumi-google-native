...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1:DatasetIamMember")]
    public partial class DatasetIamMember : global::Pulumi.CustomResource
    {
        ...
        public DatasetIamMember(string name, DatasetIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetIamMember", name, args ?? new DatasetIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:DatasetIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
