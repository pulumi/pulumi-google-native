...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:DicomStore")]
    public partial class DicomStore : Pulumi.CustomResource
    {
        ...
        public DicomStore(string name, DicomStoreArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DicomStore", name, args ?? new DicomStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DicomStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:DicomStore", name, null, MakeResourceOptions(options, id))
        {
        }
