...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    ...
    public partial class FhirStore : Pulumi.CustomResource
    {
        ...
        public FhirStore(string name, FhirStoreArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:FhirStore", name, args ?? new FhirStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FhirStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1:FhirStore", name, null, MakeResourceOptions(options, id))
        {
        }
