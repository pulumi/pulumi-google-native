...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    public static class GetAttributeDefinition
    {
        ...
        public static Task<GetAttributeDefinitionResult> InvokeAsync(GetAttributeDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAttributeDefinitionResult>("google-native:healthcare/v1:getAttributeDefinition", args ?? new GetAttributeDefinitionArgs(), options.WithDefaults());
        ...
        public static Output<GetAttributeDefinitionResult> Invoke(GetAttributeDefinitionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAttributeDefinitionResult>("google-native:healthcare/v1:getAttributeDefinition", args ?? new GetAttributeDefinitionInvokeArgs(), options.WithDefaults());
    }
