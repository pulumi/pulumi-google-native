...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    public static class GetDatasetDicomStoreIamPolicy
    {
        ...
        public static Task<GetDatasetDicomStoreIamPolicyResult> InvokeAsync(GetDatasetDicomStoreIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatasetDicomStoreIamPolicyResult>("google-native:healthcare/v1:getDatasetDicomStoreIamPolicy", args ?? new GetDatasetDicomStoreIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetDatasetDicomStoreIamPolicyResult> Invoke(GetDatasetDicomStoreIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatasetDicomStoreIamPolicyResult>("google-native:healthcare/v1:getDatasetDicomStoreIamPolicy", args ?? new GetDatasetDicomStoreIamPolicyInvokeArgs(), options.WithVersion());
    }
