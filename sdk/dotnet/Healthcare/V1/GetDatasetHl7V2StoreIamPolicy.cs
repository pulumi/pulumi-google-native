...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    public static class GetDatasetHl7V2StoreIamPolicy
    {
        ...
        public static Task<GetDatasetHl7V2StoreIamPolicyResult> InvokeAsync(GetDatasetHl7V2StoreIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatasetHl7V2StoreIamPolicyResult>("google-native:healthcare/v1:getDatasetHl7V2StoreIamPolicy", args ?? new GetDatasetHl7V2StoreIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetDatasetHl7V2StoreIamPolicyResult> Invoke(GetDatasetHl7V2StoreIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatasetHl7V2StoreIamPolicyResult>("google-native:healthcare/v1:getDatasetHl7V2StoreIamPolicy", args ?? new GetDatasetHl7V2StoreIamPolicyInvokeArgs(), options.WithVersion());
    }
