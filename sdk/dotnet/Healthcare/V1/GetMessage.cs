...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    public static class GetMessage
    {
        ...
        public static Task<GetMessageResult> InvokeAsync(GetMessageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMessageResult>("google-native:healthcare/v1:getMessage", args ?? new GetMessageArgs(), options.WithVersion());

        /// <summary>
        /// Gets an HL7v2 message.
        /// </summary>
        public static Output<GetMessageResult> Invoke(GetMessageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMessageResult>("google-native:healthcare/v1:getMessage", args ?? new GetMessageInvokeArgs(), options.WithVersion());
    }
