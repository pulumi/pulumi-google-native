...
namespace Pulumi.GoogleNative.Healthcare.V1
{
    public static class GetUserDataMapping
    {
        ...
        public static Task<GetUserDataMappingResult> InvokeAsync(GetUserDataMappingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserDataMappingResult>("google-native:healthcare/v1:getUserDataMapping", args ?? new GetUserDataMappingArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified User data mapping.
        /// </summary>
        public static Output<GetUserDataMappingResult> Invoke(GetUserDataMappingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserDataMappingResult>("google-native:healthcare/v1:getUserDataMapping", args ?? new GetUserDataMappingInvokeArgs(), options.WithDefaults());
    }
