...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:Hl7V2Store")]
    public partial class Hl7V2Store : Pulumi.CustomResource
    {
        ...
        public Hl7V2Store(string name, Hl7V2StoreArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:Hl7V2Store", name, args ?? new Hl7V2StoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Hl7V2Store(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:Hl7V2Store", name, null, MakeResourceOptions(options, id))
        {
        }
