...
namespace Pulumi.GoogleNative.Healthcare.V1.Inputs
{
    ...
    /// </summary>
    public sealed class GoogleCloudHealthcareV1DicomStreamConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.GoogleCloudHealthcareV1DicomBigQueryDestinationArgs>? BigqueryDestination { get; set; }

        public GoogleCloudHealthcareV1DicomStreamConfigArgs()
        {
        }
        public static new GoogleCloudHealthcareV1DicomStreamConfigArgs Empty => new GoogleCloudHealthcareV1DicomStreamConfigArgs();
    }
}
