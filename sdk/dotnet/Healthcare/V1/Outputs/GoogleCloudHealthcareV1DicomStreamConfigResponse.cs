...
namespace Pulumi.GoogleNative.Healthcare.V1.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudHealthcareV1DicomStreamConfigResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudHealthcareV1DicomBigQueryDestinationResponse BigqueryDestination;

        [OutputConstructor]
        private GoogleCloudHealthcareV1DicomStreamConfigResponse(Outputs.GoogleCloudHealthcareV1DicomBigQueryDestinationResponse bigqueryDestination)
        {
