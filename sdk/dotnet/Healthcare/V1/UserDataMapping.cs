...
namespace Pulumi.GoogleCloud.Healthcare.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1:UserDataMapping")]
    public partial class UserDataMapping : Pulumi.CustomResource
    {
        ...
        public UserDataMapping(string name, UserDataMappingArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:UserDataMapping", name, args ?? new UserDataMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserDataMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1:UserDataMapping", name, null, MakeResourceOptions(options, id))
        {
        }
