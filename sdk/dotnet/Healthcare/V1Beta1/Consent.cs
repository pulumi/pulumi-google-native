...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    public partial class Consent : global::Pulumi.CustomResource
    {
        ...
        public Consent(string name, ConsentArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:Consent", name, args ?? new ConsentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Consent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:Consent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConsentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Healthcare.V1Beta1.ConsentState> State { get; set; } = null!;
