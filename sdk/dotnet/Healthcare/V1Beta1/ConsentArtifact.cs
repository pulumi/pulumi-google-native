...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1beta1:ConsentArtifact")]
    public partial class ConsentArtifact : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ConsentArtifact(string name, ConsentArtifactArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:ConsentArtifact", name, args ?? new ConsentArtifactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsentArtifact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:ConsentArtifact", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConsentArtifactArgs : global::Pulumi.ResourceArgs
    {
        ...
        public static new ConsentArtifactArgs Empty => new ConsentArtifactArgs();
    }
}
