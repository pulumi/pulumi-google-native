...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1beta1:DatasetConsentStore")]
    public partial class DatasetConsentStore : Pulumi.CustomResource
    {
        ...
        public DatasetConsentStore(string name, DatasetConsentStoreArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetConsentStore", name, args ?? new DatasetConsentStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetConsentStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetConsentStore", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatasetConsentStore Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DatasetConsentStore(name, id, options);
        }
    }
