...
namespace Pulumi.GcpNative.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:healthcare/v1beta1:DatasetConsentStore")]
    public partial class DatasetConsentStore : Pulumi.CustomResource
    {
        ...
        public DatasetConsentStore(string name, DatasetConsentStoreArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:healthcare/v1beta1:DatasetConsentStore", name, args ?? new DatasetConsentStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetConsentStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:healthcare/v1beta1:DatasetConsentStore", name, null, MakeResourceOptions(options, id))
        {
        }
