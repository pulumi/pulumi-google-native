...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1beta1:DatasetDicomStoreIamPolicy")]
    public partial class DatasetDicomStoreIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DatasetDicomStoreIamPolicy(string name, DatasetDicomStoreIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetDicomStoreIamPolicy", name, args ?? new DatasetDicomStoreIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetDicomStoreIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetDicomStoreIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatasetDicomStoreIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DatasetDicomStoreIamPolicy(name, id, options);
        }
    }

    public sealed class DatasetDicomStoreIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new DatasetDicomStoreIamPolicyArgs Empty => new DatasetDicomStoreIamPolicyArgs();
    }
}
