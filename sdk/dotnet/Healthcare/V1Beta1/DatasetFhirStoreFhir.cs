...
namespace Pulumi.GoogleCloud.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1beta1:DatasetFhirStoreFhir")]
    public partial class DatasetFhirStoreFhir : Pulumi.CustomResource
    {
        ...
        public DatasetFhirStoreFhir(string name, DatasetFhirStoreFhirArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:DatasetFhirStoreFhir", name, args ?? new DatasetFhirStoreFhirArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetFhirStoreFhir(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:DatasetFhirStoreFhir", name, null, MakeResourceOptions(options, id))
        {
        }
