...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1beta1:DatasetFhirStoreIamPolicy")]
    public partial class DatasetFhirStoreIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DatasetFhirStoreIamPolicy(string name, DatasetFhirStoreIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetFhirStoreIamPolicy", name, args ?? new DatasetFhirStoreIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetFhirStoreIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetFhirStoreIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatasetFhirStoreIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DatasetFhirStoreIamPolicy(name, id, options);
        }
    }

    public sealed class DatasetFhirStoreIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new DatasetFhirStoreIamPolicyArgs Empty => new DatasetFhirStoreIamPolicyArgs();
    }
}
