...
namespace Pulumi.GoogleCloud.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1beta1:DatasetHl7V2StoreIamPolicy")]
    public partial class DatasetHl7V2StoreIamPolicy : Pulumi.CustomResource
    {
        ...
        public DatasetHl7V2StoreIamPolicy(string name, DatasetHl7V2StoreIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:DatasetHl7V2StoreIamPolicy", name, args ?? new DatasetHl7V2StoreIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetHl7V2StoreIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:DatasetHl7V2StoreIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
