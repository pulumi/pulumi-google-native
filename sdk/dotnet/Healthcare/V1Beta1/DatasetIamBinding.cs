...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1beta1:DatasetIamBinding")]
    public partial class DatasetIamBinding : global::Pulumi.CustomResource
    {
        ...
        public DatasetIamBinding(string name, DatasetIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetIamBinding", name, args ?? new DatasetIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
