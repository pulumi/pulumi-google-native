...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1beta1:DatasetIamMember")]
    public partial class DatasetIamMember : global::Pulumi.CustomResource
    {
        ...
        public DatasetIamMember(string name, DatasetIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetIamMember", name, args ?? new DatasetIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatasetIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DatasetIamMember(name, id, options);
        }
    }
