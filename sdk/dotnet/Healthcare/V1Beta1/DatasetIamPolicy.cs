...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:healthcare/v1beta1:DatasetIamPolicy")]
    public partial class DatasetIamPolicy : Pulumi.CustomResource
    {
        ...
        public DatasetIamPolicy(string name, DatasetIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetIamPolicy", name, args ?? new DatasetIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DatasetIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatasetIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
