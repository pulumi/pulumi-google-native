...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    public partial class DicomStore : Pulumi.CustomResource
    {
        ...
        public DicomStore(string name, DicomStoreArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DicomStore", name, args ?? new DicomStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DicomStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:DicomStore", name, null, MakeResourceOptions(options, id))
        {
        }
