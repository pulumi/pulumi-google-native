...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    public static class GetConsent
    {
        ...
        public static Task<GetConsentResult> InvokeAsync(GetConsentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConsentResult>("google-native:healthcare/v1beta1:getConsent", args ?? new GetConsentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified revision of a Consent, or the latest revision if `revision_id` is not specified in the resource name.
        /// </summary>
        public static Output<GetConsentResult> Invoke(GetConsentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConsentResult>("google-native:healthcare/v1beta1:getConsent", args ?? new GetConsentInvokeArgs(), options.WithDefaults());
    }
