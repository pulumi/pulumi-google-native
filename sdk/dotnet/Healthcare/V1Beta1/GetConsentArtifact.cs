...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    public static class GetConsentArtifact
    {
        ...
        public static Output<GetConsentArtifactResult> Invoke(GetConsentArtifactInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConsentArtifactResult>("google-native:healthcare/v1beta1:getConsentArtifact", args ?? new GetConsentArtifactInvokeArgs(), options.WithVersion());
    }
