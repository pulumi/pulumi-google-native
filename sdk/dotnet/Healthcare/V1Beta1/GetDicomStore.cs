...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    public static class GetDicomStore
    {
        ...
        public static Task<GetDicomStoreResult> InvokeAsync(GetDicomStoreArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDicomStoreResult>("google-native:healthcare/v1beta1:getDicomStore", args ?? new GetDicomStoreArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified DICOM store.
        /// </summary>
        public static Output<GetDicomStoreResult> Invoke(GetDicomStoreInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDicomStoreResult>("google-native:healthcare/v1beta1:getDicomStore", args ?? new GetDicomStoreInvokeArgs(), options.WithDefaults());
    }
