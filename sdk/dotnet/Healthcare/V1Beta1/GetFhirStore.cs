...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    public static class GetFhirStore
    {
        ...
        public static Task<GetFhirStoreResult> InvokeAsync(GetFhirStoreArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFhirStoreResult>("google-native:healthcare/v1beta1:getFhirStore", args ?? new GetFhirStoreArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the configuration of the specified FHIR store.
        /// </summary>
        public static Output<GetFhirStoreResult> Invoke(GetFhirStoreInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFhirStoreResult>("google-native:healthcare/v1beta1:getFhirStore", args ?? new GetFhirStoreInvokeArgs(), options.WithDefaults());
    }
