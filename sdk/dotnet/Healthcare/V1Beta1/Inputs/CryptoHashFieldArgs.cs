...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1.Inputs
{
    ...
    /// </summary>
    public sealed class CryptoHashFieldArgs : global::Pulumi.ResourceArgs
    {
        public CryptoHashFieldArgs()
        {
        }
        public static new CryptoHashFieldArgs Empty => new CryptoHashFieldArgs();
    }
}
