...
namespace Pulumi.GoogleNative.Healthcare.V1Beta1
{
    ...
    public partial class Message : Pulumi.CustomResource
    {
        ...
        public Message(string name, MessageArgs args, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:Message", name, args ?? new MessageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Message(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:healthcare/v1beta1:Message", name, null, MakeResourceOptions(options, id))
        {
        }
