...
namespace Pulumi.GoogleCloud.Healthcare.V1Beta1.Outputs
{
    ...
    [OutputType]
    public sealed class GoogleCloudHealthcareV1beta1DicomStreamConfigResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudHealthcareV1beta1DicomBigQueryDestinationResponse BigqueryDestination;

        [OutputConstructor]
        private GoogleCloudHealthcareV1beta1DicomStreamConfigResponse(Outputs.GoogleCloudHealthcareV1beta1DicomBigQueryDestinationResponse bigqueryDestination)
        {
