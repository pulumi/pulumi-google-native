...
namespace Pulumi.GoogleCloud.Healthcare.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1beta1:AnnotationStore")]
    public partial class AnnotationStore : Pulumi.CustomResource
    {
        ...
        public AnnotationStore(string name, AnnotationStoreArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:AnnotationStore", name, args ?? new AnnotationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AnnotationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:AnnotationStore", name, null, MakeResourceOptions(options, id))
        {
        }
