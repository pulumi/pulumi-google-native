...
namespace Pulumi.GoogleCloud.Healthcare.V1beta1
{
    ...
    public partial class Consent : Pulumi.CustomResource
    {
        ...
        public Consent(string name, ConsentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:Consent", name, args ?? new ConsentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Consent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:Consent", name, null, MakeResourceOptions(options, id))
        {
        }
