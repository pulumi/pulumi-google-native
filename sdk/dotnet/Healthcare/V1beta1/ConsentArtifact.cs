...
namespace Pulumi.GoogleCloud.Healthcare.V1beta1
{
    ...
    public partial class ConsentArtifact : Pulumi.CustomResource
    {
        ...
        public ConsentArtifact(string name, ConsentArtifactArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:ConsentArtifact", name, args ?? new ConsentArtifactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsentArtifact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:ConsentArtifact", name, null, MakeResourceOptions(options, id))
        {
        }
