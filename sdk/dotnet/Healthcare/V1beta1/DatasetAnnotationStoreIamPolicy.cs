...
namespace Pulumi.GoogleCloud.Healthcare.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1beta1:DatasetAnnotationStoreIamPolicy")]
    public partial class DatasetAnnotationStoreIamPolicy : Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// Create a DatasetAnnotationStoreIamPolicy resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        ...
        public DatasetAnnotationStoreIamPolicy(string name, DatasetAnnotationStoreIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:DatasetAnnotationStoreIamPolicy", name, args ?? new DatasetAnnotationStoreIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetAnnotationStoreIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:DatasetAnnotationStoreIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing DatasetAnnotationStoreIamPolicy resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatasetAnnotationStoreIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
