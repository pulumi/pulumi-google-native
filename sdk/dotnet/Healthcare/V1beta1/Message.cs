...
namespace Pulumi.GoogleCloud.Healthcare.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:healthcare/v1beta1:Message")]
    public partial class Message : Pulumi.CustomResource
    {
        ...
        public Message(string name, MessageArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:Message", name, args ?? new MessageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Message(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:healthcare/v1beta1:Message", name, null, MakeResourceOptions(options, id))
        {
        }
