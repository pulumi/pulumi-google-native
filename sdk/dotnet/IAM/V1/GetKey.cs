...
namespace Pulumi.GoogleNative.IAM.V1
{
    public static class GetKey
    {
        ...
        public static Task<GetKeyResult> InvokeAsync(GetKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyResult>("google-native:iam/v1:getKey", args ?? new GetKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a ServiceAccountKey.
        /// </summary>
        public static Output<GetKeyResult> Invoke(GetKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyResult>("google-native:iam/v1:getKey", args ?? new GetKeyInvokeArgs(), options.WithDefaults());
    }
