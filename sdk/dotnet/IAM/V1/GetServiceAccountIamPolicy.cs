...
namespace Pulumi.GoogleNative.IAM.V1
{
    public static class GetServiceAccountIamPolicy
    {
        ...
        public static Task<GetServiceAccountIamPolicyResult> InvokeAsync(GetServiceAccountIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServiceAccountIamPolicyResult>("google-native:iam/v1:getServiceAccountIamPolicy", args ?? new GetServiceAccountIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetServiceAccountIamPolicyResult> Invoke(GetServiceAccountIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServiceAccountIamPolicyResult>("google-native:iam/v1:getServiceAccountIamPolicy", args ?? new GetServiceAccountIamPolicyInvokeArgs(), options.WithDefaults());
    }
