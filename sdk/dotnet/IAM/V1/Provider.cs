...
namespace Pulumi.GoogleNative.IAM.V1
{
    ...
    public partial class Provider : Pulumi.CustomResource
    {
        ...
        public Provider(string name, ProviderArgs args, CustomResourceOptions? options = null)
            : base("google-native:iam/v1:Provider", name, args ?? new ProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Provider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:iam/v1:Provider", name, null, MakeResourceOptions(options, id))
        {
        }
