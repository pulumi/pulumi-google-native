...
namespace Pulumi.GoogleNative.IAM.V1
{
    ...
    public partial class ServiceAccountIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ServiceAccountIamPolicy(string name, ServiceAccountIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:iam/v1:ServiceAccountIamPolicy", name, args ?? new ServiceAccountIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceAccountIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:iam/v1:ServiceAccountIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceAccountIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new ServiceAccountIamPolicyArgs Empty => new ServiceAccountIamPolicyArgs();
    }
}
