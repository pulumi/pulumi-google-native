...
namespace Pulumi.GoogleNative.IAM.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:iam/v1:WorkforcePool")]
    public partial class WorkforcePool : global::Pulumi.CustomResource
    {
        ...
        public WorkforcePool(string name, WorkforcePoolArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:iam/v1:WorkforcePool", name, args ?? new WorkforcePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkforcePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:iam/v1:WorkforcePool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkforcePool Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new WorkforcePool(name, id, options);
        }
    }
