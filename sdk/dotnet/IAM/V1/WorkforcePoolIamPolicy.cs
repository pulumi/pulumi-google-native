...
namespace Pulumi.GoogleNative.IAM.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:iam/v1:WorkforcePoolIamPolicy")]
    public partial class WorkforcePoolIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public WorkforcePoolIamPolicy(string name, WorkforcePoolIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:iam/v1:WorkforcePoolIamPolicy", name, args ?? new WorkforcePoolIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkforcePoolIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:iam/v1:WorkforcePoolIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkforcePoolIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new WorkforcePoolIamPolicy(name, id, options);
        }
    }
