...
{
    public static class GetEndpointIamPolicy
    {
        /// <summary>
        ...
        public static Task<GetEndpointIamPolicyResult> InvokeAsync(GetEndpointIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEndpointIamPolicyResult>("google-native:ids/v1:getEndpointIamPolicy", args ?? new GetEndpointIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetEndpointIamPolicyResult> Invoke(GetEndpointIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEndpointIamPolicyResult>("google-native:ids/v1:getEndpointIamPolicy", args ?? new GetEndpointIamPolicyInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetEndpointIamPolicyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetEndpointIamPolicyResult(
