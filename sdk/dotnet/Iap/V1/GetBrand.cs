...
namespace Pulumi.GoogleNative.Iap.V1
{
    public static class GetBrand
    {
        ...
        public static Task<GetBrandResult> InvokeAsync(GetBrandArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBrandResult>("google-native:iap/v1:getBrand", args ?? new GetBrandArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the OAuth brand of the project.
        /// </summary>
        public static Output<GetBrandResult> Invoke(GetBrandInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBrandResult>("google-native:iap/v1:getBrand", args ?? new GetBrandInvokeArgs(), options.WithDefaults());
    }
