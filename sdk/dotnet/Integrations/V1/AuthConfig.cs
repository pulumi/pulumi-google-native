...
namespace Pulumi.GoogleNative.Integrations.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:integrations/v1:AuthConfig")]
    public partial class AuthConfig : global::Pulumi.CustomResource
    {
        ...
        public AuthConfig(string name, AuthConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1:AuthConfig", name, args ?? new AuthConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1:AuthConfig", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AuthConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.AuthConfigCredentialType>? CredentialType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.GoogleNative.Integrations.V1.AuthConfigState>? State { get; set; }
        ...
        /// </summary>
        [Input("visibility")]
        public Input<Pulumi.GoogleNative.Integrations.V1.AuthConfigVisibility>? Visibility { get; set; }
