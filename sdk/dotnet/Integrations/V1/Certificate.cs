...
namespace Pulumi.GoogleNative.Integrations.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:integrations/v1:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CertificateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.CertificateCertificateStatus>? CertificateStatus { get; set; }
