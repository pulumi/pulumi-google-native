...
namespace Pulumi.GoogleNative.Integrations.V1
{
    public static class GetCertificate
    {
        ...
        public static Task<GetCertificateResult> InvokeAsync(GetCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateResult>("google-native:integrations/v1:getCertificate", args ?? new GetCertificateArgs(), options.WithDefaults());

        /// <summary>
        /// Get a certificates in the specified project.
        /// </summary>
        public static Output<GetCertificateResult> Invoke(GetCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCertificateResult>("google-native:integrations/v1:getCertificate", args ?? new GetCertificateInvokeArgs(), options.WithDefaults());
    }
