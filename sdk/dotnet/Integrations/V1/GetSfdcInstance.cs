...
namespace Pulumi.GoogleNative.Integrations.V1
{
    public static class GetSfdcInstance
    {
        ...
        public static Task<GetSfdcInstanceResult> InvokeAsync(GetSfdcInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSfdcInstanceResult>("google-native:integrations/v1:getSfdcInstance", args ?? new GetSfdcInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an sfdc instance. If the instance doesn't exist, Code.NOT_FOUND exception will be thrown.
        /// </summary>
        public static Output<GetSfdcInstanceResult> Invoke(GetSfdcInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSfdcInstanceResult>("google-native:integrations/v1:getSfdcInstance", args ?? new GetSfdcInstanceInvokeArgs(), options.WithDefaults());
    }
