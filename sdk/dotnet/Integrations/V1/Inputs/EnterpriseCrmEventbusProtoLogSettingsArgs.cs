...
namespace Pulumi.GoogleNative.Integrations.V1.Inputs
{
    ...
    public sealed class EnterpriseCrmEventbusProtoLogSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("seedPeriod")]
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusProtoLogSettingsSeedPeriod>? SeedPeriod { get; set; }

        [Input("seedScope")]
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusProtoLogSettingsSeedScope>? SeedScope { get; set; }
