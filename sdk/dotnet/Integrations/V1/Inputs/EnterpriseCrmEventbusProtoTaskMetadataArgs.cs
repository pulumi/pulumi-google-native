...
namespace Pulumi.GoogleNative.Integrations.V1.Inputs
{
    ...
    public sealed class EnterpriseCrmEventbusProtoTaskMetadataArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("category")]
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusProtoTaskMetadataCategory>? Category { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusProtoTaskMetadataDefaultJsonValidationOption>? DefaultJsonValidationOption { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusProtoTaskMetadataExternalCategory>? ExternalCategory { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusProtoTaskMetadataStatus>? Status { get; set; }

        [Input("system")]
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusProtoTaskMetadataSystem>? System { get; set; }
