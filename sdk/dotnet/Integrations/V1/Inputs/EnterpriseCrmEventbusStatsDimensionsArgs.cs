...
namespace Pulumi.GoogleNative.Integrations.V1.Inputs
{
    ...
    public sealed class EnterpriseCrmEventbusStatsDimensionsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusStatsDimensionsEnumFilterType>? EnumFilterType { get; set; }

        [Input("errorEnumString")]
        public Input<string>? ErrorEnumString { get; set; }

        [Input("retryAttempt")]
        public Input<Pulumi.GoogleNative.Integrations.V1.EnterpriseCrmEventbusStatsDimensionsRetryAttempt>? RetryAttempt { get; set; }
