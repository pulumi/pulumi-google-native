...
namespace Pulumi.GoogleNative.Integrations.V1.Inputs
{
    ...
    public sealed class GoogleCloudIntegrationsV1alphaTaskConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.GoogleCloudIntegrationsV1alphaTaskConfigJsonValidationOption>? JsonValidationOption { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.GoogleCloudIntegrationsV1alphaTaskConfigNextTasksExecutionPolicy>? NextTasksExecutionPolicy { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.GoogleCloudIntegrationsV1alphaTaskConfigTaskExecutionStrategy>? TaskExecutionStrategy { get; set; }
