...
namespace Pulumi.GoogleNative.Integrations.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:integrations/v1:Version")]
    public partial class Version : global::Pulumi.CustomResource
    {
        ...
        public Version(string name, VersionArgs args, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1:Version", name, args ?? new VersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Version(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1:Version", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VersionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Integrations.V1.VersionDatabasePersistencePolicy>? DatabasePersistencePolicy { get; set; }
        ...
        /// </summary>
        [Input("origin")]
        public Input<Pulumi.GoogleNative.Integrations.V1.VersionOrigin>? Origin { get; set; }
