...
namespace Pulumi.GoogleNative.Integrations.V1Alpha
{
    ...
    public readonly struct EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType : IEquatable<EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType>
    {
        ...
        public static EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType IntegrationConnectorTrigger { get; } = new EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType("INTEGRATION_CONNECTOR_TRIGGER");
        public static EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType PrivateTrigger { get; } = new EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType("PRIVATE_TRIGGER");
    ...
    /// </summary>
    [EnumType]
    public readonly struct GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity : IEquatable<GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity>
    {
        private readonly string _value;

        private GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        public static bool operator ==(GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity left, GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity right) => left.Equals(right);
        public static bool operator !=(GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity left, GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity right) => !left.Equals(right);

        public static explicit operator string(GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity other && Equals(other);
        public bool Equals(GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType : IEquatable<GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType>
    {
        ...
        /// </summary>
        public static GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType IntegrationConnectorTrigger { get; } = new GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType("INTEGRATION_CONNECTOR_TRIGGER");
        /// <summary>
        /// Trigger for private workflow
        /// </summary>
        public static GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType PrivateTrigger { get; } = new GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType("PRIVATE_TRIGGER");
    ...
    public readonly struct TemplatesVersionDatabasePersistencePolicy : IEquatable<TemplatesVersionDatabasePersistencePolicy>
    {
        ...
        /// </summary>
        public static TemplatesVersionDatabasePersistencePolicy DatabasePersistenceAsync { get; } = new TemplatesVersionDatabasePersistencePolicy("DATABASE_PERSISTENCE_ASYNC");
    ...
    public readonly struct VersionDatabasePersistencePolicy : IEquatable<VersionDatabasePersistencePolicy>
    {
        ...
        /// Asynchronously persist all execution data.
        /// </summary>
        public static VersionDatabasePersistencePolicy DatabasePersistenceAsync { get; } = new VersionDatabasePersistencePolicy("DATABASE_PERSISTENCE_ASYNC");
    ...
    public readonly struct VersionOrigin : IEquatable<VersionOrigin>
    {
        ...
        /// </summary>
        public static VersionOrigin TestCase { get; } = new VersionOrigin("TEST_CASE");
