...
namespace Pulumi.GoogleNative.Integrations.V1Alpha
{
    public static class GetAuthConfig
    {
        ...
        public static Task<GetAuthConfigResult> InvokeAsync(GetAuthConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthConfigResult>("google-native:integrations/v1alpha:getAuthConfig", args ?? new GetAuthConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a complete auth config. If the auth config doesn't exist, Code.NOT_FOUND exception will be thrown. Returns the decrypted auth config.
        /// </summary>
        public static Output<GetAuthConfigResult> Invoke(GetAuthConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthConfigResult>("google-native:integrations/v1alpha:getAuthConfig", args ?? new GetAuthConfigInvokeArgs(), options.WithDefaults());
    }
