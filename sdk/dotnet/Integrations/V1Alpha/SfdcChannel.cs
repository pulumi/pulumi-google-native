...
namespace Pulumi.GoogleNative.Integrations.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:integrations/v1alpha:SfdcChannel")]
    public partial class SfdcChannel : global::Pulumi.CustomResource
    {
        ...
        public SfdcChannel(string name, SfdcChannelArgs args, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1alpha:SfdcChannel", name, args ?? new SfdcChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SfdcChannel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1alpha:SfdcChannel", name, null, MakeResourceOptions(options, id))
        {
        }
