...
namespace Pulumi.GoogleNative.Integrations.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:integrations/v1alpha:SfdcInstance")]
    public partial class SfdcInstance : global::Pulumi.CustomResource
    {
        ...
        public SfdcInstance(string name, SfdcInstanceArgs args, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1alpha:SfdcInstance", name, args ?? new SfdcInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SfdcInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:integrations/v1alpha:SfdcInstance", name, null, MakeResourceOptions(options, id))
        {
        }
