...
namespace Pulumi.GoogleCloud.Jobs.V3p1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:jobs/v3p1beta1:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:jobs/v3p1beta1:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:jobs/v3p1beta1:Job", name, null, MakeResourceOptions(options, id))
        {
        }
