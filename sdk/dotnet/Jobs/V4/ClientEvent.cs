...
namespace Pulumi.GoogleCloud.Jobs.V4
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:jobs/v4:ClientEvent")]
    public partial class ClientEvent : Pulumi.CustomResource
    {
        ...
        public ClientEvent(string name, ClientEventArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:jobs/v4:ClientEvent", name, args ?? new ClientEventArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClientEvent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:jobs/v4:ClientEvent", name, null, MakeResourceOptions(options, id))
        {
        }
