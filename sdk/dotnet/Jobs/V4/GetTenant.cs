...
namespace Pulumi.GoogleNative.Jobs.V4
{
    public static class GetTenant
    {
        ...
        public static Task<GetTenantResult> InvokeAsync(GetTenantArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTenantResult>("google-native:jobs/v4:getTenant", args ?? new GetTenantArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves specified tenant.
        /// </summary>
        public static Output<GetTenantResult> Invoke(GetTenantInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTenantResult>("google-native:jobs/v4:getTenant", args ?? new GetTenantInvokeArgs(), options.WithDefaults());
    }
