...
namespace Pulumi.GoogleCloud.Jobs.V4
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:jobs/v4:TenantJob")]
    public partial class TenantJob : Pulumi.CustomResource
    {
        ...
        public TenantJob(string name, TenantJobArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:jobs/v4:TenantJob", name, args ?? new TenantJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TenantJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:jobs/v4:TenantJob", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TenantJob Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TenantJob(name, id, options);
        }
    }

    public sealed class TenantJobArgs : Pulumi.ResourceArgs
    {
        [Input("addresses")]
