...
namespace Pulumi.GoogleNative.Logging.V2
{
    ...
    public partial class BillingAccountBucket : global::Pulumi.CustomResource
    {
        ...
        public BillingAccountBucket(string name, BillingAccountBucketArgs args, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:BillingAccountBucket", name, args ?? new BillingAccountBucketArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingAccountBucket(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:BillingAccountBucket", name, null, MakeResourceOptions(options, id))
        {
        }
