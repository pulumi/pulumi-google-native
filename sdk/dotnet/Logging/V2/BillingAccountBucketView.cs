...
namespace Pulumi.GoogleNative.Logging.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:logging/v2:BillingAccountBucketView")]
    public partial class BillingAccountBucketView : global::Pulumi.CustomResource
    {
        ...
        public BillingAccountBucketView(string name, BillingAccountBucketViewArgs args, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:BillingAccountBucketView", name, args ?? new BillingAccountBucketViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingAccountBucketView(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:BillingAccountBucketView", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BillingAccountBucketView Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new BillingAccountBucketView(name, id, options);
        }
    }

    public sealed class BillingAccountBucketViewArgs : global::Pulumi.ResourceArgs
    {
        ...
        public BillingAccountBucketViewArgs()
        {
        }
        public static new BillingAccountBucketViewArgs Empty => new BillingAccountBucketViewArgs();
    }
}
