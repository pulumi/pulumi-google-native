...
namespace Pulumi.GcpNative.Logging.V2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:logging/v2:BillingAccountSink")]
    public partial class BillingAccountSink : Pulumi.CustomResource
    {
        ...
        public BillingAccountSink(string name, BillingAccountSinkArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:logging/v2:BillingAccountSink", name, args ?? new BillingAccountSinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingAccountSink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:logging/v2:BillingAccountSink", name, null, MakeResourceOptions(options, id))
        {
        }
