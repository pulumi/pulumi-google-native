...
namespace Pulumi.GoogleCloud.Logging.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:logging/v2:BillingAccountSink")]
    public partial class BillingAccountSink : Pulumi.CustomResource
    {
        ...
        public BillingAccountSink(string name, BillingAccountSinkArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:BillingAccountSink", name, args ?? new BillingAccountSinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingAccountSink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:BillingAccountSink", name, null, MakeResourceOptions(options, id))
        {
        }
