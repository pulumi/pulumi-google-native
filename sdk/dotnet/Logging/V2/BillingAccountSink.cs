...
namespace Pulumi.GoogleNative.Logging.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:logging/v2:BillingAccountSink")]
    public partial class BillingAccountSink : Pulumi.CustomResource
    {
        ...
        public BillingAccountSink(string name, BillingAccountSinkArgs args, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:BillingAccountSink", name, args ?? new BillingAccountSinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingAccountSink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:BillingAccountSink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BillingAccountSink Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
