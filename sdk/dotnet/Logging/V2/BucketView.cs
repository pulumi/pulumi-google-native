...
namespace Pulumi.GoogleCloud.Logging.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:logging/v2:BucketView")]
    public partial class BucketView : Pulumi.CustomResource
    {
        ...
        public BucketView(string name, BucketViewArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:BucketView", name, args ?? new BucketViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BucketView(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:BucketView", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BucketView Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
