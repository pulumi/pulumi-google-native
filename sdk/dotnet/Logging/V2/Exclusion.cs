...
namespace Pulumi.GcpNative.Logging.V2
{
    ...
    /// </summary>
    [GcpNativeResourceType("google-native:logging/v2:Exclusion")]
    public partial class Exclusion : Pulumi.CustomResource
    {
        ...
        public Exclusion(string name, ExclusionArgs args, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:Exclusion", name, args ?? new ExclusionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Exclusion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:Exclusion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Exclusion Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
