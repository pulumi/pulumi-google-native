...
namespace Pulumi.GoogleNative.Logging.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:logging/v2:FolderBucketLink")]
    public partial class FolderBucketLink : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FolderBucketLink(string name, FolderBucketLinkArgs args, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:FolderBucketLink", name, args ?? new FolderBucketLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderBucketLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:FolderBucketLink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FolderBucketLink Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new FolderBucketLink(name, id, options);
        }
    }

    public sealed class FolderBucketLinkArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional. The information of a BigQuery Dataset. When a link is created, a BigQuery dataset is created along with it, in the same project as the LogBucket it's linked to. This dataset will also have BigQuery Views corresponding to the LogViews in the bucket.
        /// </summary>
        ...
        public FolderBucketLinkArgs()
        {
        }
        public static new FolderBucketLinkArgs Empty => new FolderBucketLinkArgs();
    }
}
