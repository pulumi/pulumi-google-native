...
namespace Pulumi.GoogleCloud.Logging.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:logging/v2:FolderSink")]
    public partial class FolderSink : Pulumi.CustomResource
    {
        ...
        public FolderSink(string name, FolderSinkArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:FolderSink", name, args ?? new FolderSinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderSink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:FolderSink", name, null, MakeResourceOptions(options, id))
        {
        }
