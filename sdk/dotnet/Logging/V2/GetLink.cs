...
namespace Pulumi.GoogleNative.Logging.V2
{
    public static class GetLink
    {
        ...
        public static Task<GetLinkResult> InvokeAsync(GetLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLinkResult>("google-native:logging/v2:getLink", args ?? new GetLinkArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a link.
        /// </summary>
        public static Output<GetLinkResult> Invoke(GetLinkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLinkResult>("google-native:logging/v2:getLink", args ?? new GetLinkInvokeArgs(), options.WithDefaults());
    }
