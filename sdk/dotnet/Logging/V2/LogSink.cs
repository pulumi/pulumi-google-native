...
namespace Pulumi.GoogleCloud.Logging.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:logging/v2:LogSink")]
    public partial class LogSink : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LogSink(string name, LogSinkArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:LogSink", name, args ?? new LogSinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogSink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:LogSink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogSink Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new LogSink(name, id, options);
        }
    }

    public sealed class LogSinkArgs : Pulumi.ResourceArgs
    {
        /// <summary>
