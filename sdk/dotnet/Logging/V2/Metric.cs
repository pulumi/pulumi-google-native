...
namespace Pulumi.GoogleCloud.Logging.V2
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:logging/v2:Metric")]
    public partial class Metric : Pulumi.CustomResource
    {
        ...
        public Metric(string name, MetricArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:Metric", name, args ?? new MetricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Metric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:logging/v2:Metric", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MetricArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("metricsId", required: true)]
        public Input<string> MetricsId { get; set; } = null!;
