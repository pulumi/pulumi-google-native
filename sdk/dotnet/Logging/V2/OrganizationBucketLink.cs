...
namespace Pulumi.GoogleNative.Logging.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:logging/v2:OrganizationBucketLink")]
    public partial class OrganizationBucketLink : global::Pulumi.CustomResource
    {
        ...
        public OrganizationBucketLink(string name, OrganizationBucketLinkArgs args, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:OrganizationBucketLink", name, args ?? new OrganizationBucketLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationBucketLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:OrganizationBucketLink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationBucketLink Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new OrganizationBucketLink(name, id, options);
        }
    }
    ...
    public sealed class OrganizationBucketLinkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public OrganizationBucketLinkArgs()
        {
        }
        public static new OrganizationBucketLinkArgs Empty => new OrganizationBucketLinkArgs();
    }
}
