...
namespace Pulumi.GoogleNative.Logging.V2
{
    ...
    public partial class Sink : Pulumi.CustomResource
    {
        ...
        public Sink(string name, SinkArgs args, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:Sink", name, args ?? new SinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Sink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:logging/v2:Sink", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SinkArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Logging.V2.SinkOutputVersionFormat>? OutputVersionFormat { get; set; }
