...
namespace Pulumi.GoogleNative.Looker.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:looker/v1:InstanceBackupIamPolicy")]
    public partial class InstanceBackupIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public InstanceBackupIamPolicy(string name, InstanceBackupIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:looker/v1:InstanceBackupIamPolicy", name, args ?? new InstanceBackupIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceBackupIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:looker/v1:InstanceBackupIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InstanceBackupIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
