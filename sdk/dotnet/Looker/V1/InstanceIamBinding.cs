...
namespace Pulumi.GoogleNative.Looker.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:looker/v1:InstanceIamBinding")]
    public partial class InstanceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamBinding(string name, InstanceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:looker/v1:InstanceIamBinding", name, args ?? new InstanceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:looker/v1:InstanceIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
