...
namespace Pulumi.GoogleNative.Managedidentities.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:managedidentities/v1:Backup")]
    public partial class Backup : Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("google-native:managedidentities/v1:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:managedidentities/v1:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
