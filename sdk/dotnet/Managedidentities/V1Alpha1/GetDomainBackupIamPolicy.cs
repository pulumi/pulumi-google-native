...
namespace Pulumi.GoogleNative.Managedidentities.V1Alpha1
{
    public static class GetDomainBackupIamPolicy
    {
        ...
        public static Task<GetDomainBackupIamPolicyResult> InvokeAsync(GetDomainBackupIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainBackupIamPolicyResult>("google-native:managedidentities/v1alpha1:getDomainBackupIamPolicy", args ?? new GetDomainBackupIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetDomainBackupIamPolicyResult> Invoke(GetDomainBackupIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainBackupIamPolicyResult>("google-native:managedidentities/v1alpha1:getDomainBackupIamPolicy", args ?? new GetDomainBackupIamPolicyInvokeArgs(), options.WithDefaults());
    }
