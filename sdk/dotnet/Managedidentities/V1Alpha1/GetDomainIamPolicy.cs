...
namespace Pulumi.GoogleNative.Managedidentities.V1Alpha1
{
    public static class GetDomainIamPolicy
    {
        ...
        public static Task<GetDomainIamPolicyResult> InvokeAsync(GetDomainIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainIamPolicyResult>("google-native:managedidentities/v1alpha1:getDomainIamPolicy", args ?? new GetDomainIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetDomainIamPolicyResult> Invoke(GetDomainIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDomainIamPolicyResult>("google-native:managedidentities/v1alpha1:getDomainIamPolicy", args ?? new GetDomainIamPolicyInvokeArgs(), options.WithDefaults());
    }
