...
namespace Pulumi.GoogleNative.Managedidentities.V1Alpha1
{
    public static class GetPeeringIamPolicy
    {
        ...
        public static Task<GetPeeringIamPolicyResult> InvokeAsync(GetPeeringIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPeeringIamPolicyResult>("google-native:managedidentities/v1alpha1:getPeeringIamPolicy", args ?? new GetPeeringIamPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetPeeringIamPolicyResult> Invoke(GetPeeringIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPeeringIamPolicyResult>("google-native:managedidentities/v1alpha1:getPeeringIamPolicy", args ?? new GetPeeringIamPolicyInvokeArgs(), options.WithVersion());
    }
