...
namespace Pulumi.GoogleNative.Managedidentities.V1Alpha1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:managedidentities/v1alpha1:Peering")]
    public partial class Peering : global::Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("google-native:managedidentities/v1alpha1:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:managedidentities/v1alpha1:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
