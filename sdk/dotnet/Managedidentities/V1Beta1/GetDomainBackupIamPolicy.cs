...
namespace Pulumi.GoogleNative.Managedidentities.V1Beta1
{
    public static class GetDomainBackupIamPolicy
    {
        ...
        public static Task<GetDomainBackupIamPolicyResult> InvokeAsync(GetDomainBackupIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainBackupIamPolicyResult>("google-native:managedidentities/v1beta1:getDomainBackupIamPolicy", args ?? new GetDomainBackupIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetDomainBackupIamPolicyResult> Invoke(GetDomainBackupIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDomainBackupIamPolicyResult>("google-native:managedidentities/v1beta1:getDomainBackupIamPolicy", args ?? new GetDomainBackupIamPolicyInvokeArgs(), options.WithVersion());
    }
