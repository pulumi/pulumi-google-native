...
namespace Pulumi.GoogleNative.Managedidentities.V1Beta1
{
    public static class GetPeering
    {
        ...
        public static Task<GetPeeringResult> InvokeAsync(GetPeeringArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPeeringResult>("google-native:managedidentities/v1beta1:getPeering", args ?? new GetPeeringArgs(), options.WithVersion());

        /// <summary>
        /// Gets details of a single Peering.
        /// </summary>
        public static Output<GetPeeringResult> Invoke(GetPeeringInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPeeringResult>("google-native:managedidentities/v1beta1:getPeering", args ?? new GetPeeringInvokeArgs(), options.WithVersion());
    }
