...
namespace Pulumi.GoogleNative.Managedidentities.V1Beta1
{
    ...
    public partial class Peering : Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("google-native:managedidentities/v1beta1:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:managedidentities/v1beta1:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
