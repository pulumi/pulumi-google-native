...
namespace Pulumi.GcpNative.Memcache.V1Beta2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:memcache/v1beta2:Instance")]
    public partial class Instance : Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:memcache/v1beta2:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:memcache/v1beta2:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
