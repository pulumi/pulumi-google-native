...
namespace Pulumi.GoogleCloud.Memcache.V1beta2
{
    /// <summary>
    /// Creates a new Instance in a given location.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:memcache/v1beta2:Instance")]
    public partial class Instance : Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:memcache/v1beta2:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:memcache/v1beta2:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
