...
namespace Pulumi.GoogleNative.Metastore.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1:FederationIamPolicy")]
    public partial class FederationIamPolicy : global::Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// Create a FederationIamPolicy resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public FederationIamPolicy(string name, FederationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1:FederationIamPolicy", name, args ?? new FederationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1:FederationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FederationIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new FederationIamPolicy(name, id, options);
        }
    }
