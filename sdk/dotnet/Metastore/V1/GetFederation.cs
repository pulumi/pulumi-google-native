...
namespace Pulumi.GoogleNative.Metastore.V1
{
    public static class GetFederation
    {
        ...
        public static Task<GetFederationResult> InvokeAsync(GetFederationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFederationResult>("google-native:metastore/v1:getFederation", args ?? new GetFederationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a single federation.
        /// </summary>
        public static Output<GetFederationResult> Invoke(GetFederationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFederationResult>("google-native:metastore/v1:getFederation", args ?? new GetFederationInvokeArgs(), options.WithDefaults());
    }
