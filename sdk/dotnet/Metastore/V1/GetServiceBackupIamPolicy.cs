...
namespace Pulumi.GoogleNative.Metastore.V1
{
    public static class GetServiceBackupIamPolicy
    {
        ...
        public static Task<GetServiceBackupIamPolicyResult> InvokeAsync(GetServiceBackupIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServiceBackupIamPolicyResult>("google-native:metastore/v1:getServiceBackupIamPolicy", args ?? new GetServiceBackupIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetServiceBackupIamPolicyResult> Invoke(GetServiceBackupIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServiceBackupIamPolicyResult>("google-native:metastore/v1:getServiceBackupIamPolicy", args ?? new GetServiceBackupIamPolicyInvokeArgs(), options.WithDefaults());
    }
