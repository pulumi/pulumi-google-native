...
namespace Pulumi.GoogleNative.Metastore.V1.Inputs
{
    ...
    public sealed class DatabaseDumpArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("databaseType")]
        public Input<Pulumi.GoogleNative.Metastore.V1.DatabaseDumpDatabaseType>? DatabaseType { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.Metastore.V1.DatabaseDumpType>? Type { get; set; }
