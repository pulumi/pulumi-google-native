...
namespace Pulumi.GoogleNative.Metastore.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1:MetadataImport")]
    public partial class MetadataImport : global::Pulumi.CustomResource
    {
        ...
        public MetadataImport(string name, MetadataImportArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1:MetadataImport", name, args ?? new MetadataImportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetadataImport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1:MetadataImport", name, null, MakeResourceOptions(options, id))
        {
        }
