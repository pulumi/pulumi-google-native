...
namespace Pulumi.GoogleNative.Metastore.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1:ServiceIamBinding")]
    public partial class ServiceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ServiceIamBinding(string name, ServiceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1:ServiceIamBinding", name, args ?? new ServiceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1:ServiceIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
