...
namespace Pulumi.GoogleNative.Metastore.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1alpha:Federation")]
    public partial class Federation : global::Pulumi.CustomResource
    {
        ...
        public Federation(string name, FederationArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:Federation", name, args ?? new FederationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Federation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:Federation", name, null, MakeResourceOptions(options, id))
        {
        }
