...
namespace Pulumi.GoogleNative.Metastore.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1alpha:FederationIamPolicy")]
    public partial class FederationIamPolicy : Pulumi.CustomResource
    {
        ...
        public FederationIamPolicy(string name, FederationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:FederationIamPolicy", name, args ?? new FederationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:FederationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
