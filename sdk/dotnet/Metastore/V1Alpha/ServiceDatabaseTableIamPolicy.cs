...
namespace Pulumi.GoogleNative.Metastore.V1Alpha
{
    ...
    public partial class ServiceDatabaseTableIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServiceDatabaseTableIamPolicy(string name, ServiceDatabaseTableIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:ServiceDatabaseTableIamPolicy", name, args ?? new ServiceDatabaseTableIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceDatabaseTableIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:ServiceDatabaseTableIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
