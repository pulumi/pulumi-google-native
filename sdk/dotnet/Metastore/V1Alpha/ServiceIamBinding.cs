...
namespace Pulumi.GoogleNative.Metastore.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1alpha:ServiceIamBinding")]
    public partial class ServiceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ServiceIamBinding(string name, ServiceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:ServiceIamBinding", name, args ?? new ServiceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:ServiceIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ServiceIamBinding(name, id, options);
        }
    }
