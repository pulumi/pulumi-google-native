...
namespace Pulumi.GoogleNative.Metastore.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1alpha:ServiceIamMember")]
    public partial class ServiceIamMember : global::Pulumi.CustomResource
    {
        ...
        public ServiceIamMember(string name, ServiceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:ServiceIamMember", name, args ?? new ServiceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1alpha:ServiceIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
