...
namespace Pulumi.GoogleCloud.Metastore.V1Alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:metastore/v1alpha:ServiceMetadataImport")]
    public partial class ServiceMetadataImport : Pulumi.CustomResource
    {
        ...
        public ServiceMetadataImport(string name, ServiceMetadataImportArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1alpha:ServiceMetadataImport", name, args ?? new ServiceMetadataImportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceMetadataImport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1alpha:ServiceMetadataImport", name, null, MakeResourceOptions(options, id))
        {
        }
