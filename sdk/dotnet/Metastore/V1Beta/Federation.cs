...
namespace Pulumi.GoogleNative.Metastore.V1Beta
{
    ...
    public partial class Federation : global::Pulumi.CustomResource
    {
        ...
        public Federation(string name, FederationArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:Federation", name, args ?? new FederationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Federation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:Federation", name, null, MakeResourceOptions(options, id))
        {
        }
