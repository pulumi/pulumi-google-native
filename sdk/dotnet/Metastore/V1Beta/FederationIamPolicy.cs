...
namespace Pulumi.GoogleNative.Metastore.V1Beta
{
    ...
    public partial class FederationIamPolicy : Pulumi.CustomResource
    {
        ...
        public FederationIamPolicy(string name, FederationIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:FederationIamPolicy", name, args ?? new FederationIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederationIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:FederationIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
