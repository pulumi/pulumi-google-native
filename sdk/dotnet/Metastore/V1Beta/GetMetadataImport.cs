...
namespace Pulumi.GoogleNative.Metastore.V1Beta
{
    public static class GetMetadataImport
    {
        ...
        public static Task<GetMetadataImportResult> InvokeAsync(GetMetadataImportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetadataImportResult>("google-native:metastore/v1beta:getMetadataImport", args ?? new GetMetadataImportArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single import.
        /// </summary>
        public static Output<GetMetadataImportResult> Invoke(GetMetadataImportInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMetadataImportResult>("google-native:metastore/v1beta:getMetadataImport", args ?? new GetMetadataImportInvokeArgs(), options.WithDefaults());
    }
