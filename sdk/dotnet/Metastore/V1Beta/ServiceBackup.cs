...
namespace Pulumi.GoogleNative.Metastore.V1Beta
{
    ...
    public partial class ServiceBackup : Pulumi.CustomResource
    {
        ...
        public ServiceBackup(string name, ServiceBackupArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceBackup", name, args ?? new ServiceBackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceBackup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceBackup", name, null, MakeResourceOptions(options, id))
        {
        }
