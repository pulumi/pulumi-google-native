...
namespace Pulumi.GoogleNative.Metastore.V1Beta
{
    ...
    public partial class ServiceBackupIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceBackupIamPolicy(string name, ServiceBackupIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceBackupIamPolicy", name, args ?? new ServiceBackupIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceBackupIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceBackupIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
