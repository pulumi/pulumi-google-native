...
namespace Pulumi.GoogleNative.Metastore.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1beta:ServiceDatabaseTableIamPolicy")]
    public partial class ServiceDatabaseTableIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceDatabaseTableIamPolicy(string name, ServiceDatabaseTableIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceDatabaseTableIamPolicy", name, args ?? new ServiceDatabaseTableIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceDatabaseTableIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceDatabaseTableIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceDatabaseTableIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
