...
namespace Pulumi.GoogleNative.Metastore.V1Beta
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1beta:ServiceIamBinding")]
    public partial class ServiceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ServiceIamBinding(string name, ServiceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceIamBinding", name, args ?? new ServiceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
