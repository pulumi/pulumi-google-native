...
namespace Pulumi.GoogleNative.Metastore.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:metastore/v1beta:ServiceMetadataImport")]
    public partial class ServiceMetadataImport : Pulumi.CustomResource
    {
        ...
        public ServiceMetadataImport(string name, ServiceMetadataImportArgs args, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceMetadataImport", name, args ?? new ServiceMetadataImportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceMetadataImport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:metastore/v1beta:ServiceMetadataImport", name, null, MakeResourceOptions(options, id))
        {
        }
