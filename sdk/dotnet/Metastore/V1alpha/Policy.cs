...
namespace Pulumi.GoogleCloud.Metastore.V1alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:metastore/v1alpha:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1alpha:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1alpha:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
