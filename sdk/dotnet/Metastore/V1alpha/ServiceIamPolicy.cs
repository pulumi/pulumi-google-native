...
namespace Pulumi.GoogleCloud.Metastore.V1alpha
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:metastore/v1alpha:ServiceIamPolicy")]
    public partial class ServiceIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceIamPolicy(string name, ServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1alpha:ServiceIamPolicy", name, args ?? new ServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1alpha:ServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
