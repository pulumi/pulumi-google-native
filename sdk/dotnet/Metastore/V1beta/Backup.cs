...
namespace Pulumi.GoogleCloud.Metastore.V1beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:metastore/v1beta:Backup")]
    public partial class Backup : Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1beta:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1beta:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
