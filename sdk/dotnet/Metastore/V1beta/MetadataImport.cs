...
namespace Pulumi.GoogleCloud.Metastore.V1beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:metastore/v1beta:MetadataImport")]
    public partial class MetadataImport : Pulumi.CustomResource
    {
        ...
        public MetadataImport(string name, MetadataImportArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1beta:MetadataImport", name, args ?? new MetadataImportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetadataImport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:metastore/v1beta:MetadataImport", name, null, MakeResourceOptions(options, id))
        {
        }
