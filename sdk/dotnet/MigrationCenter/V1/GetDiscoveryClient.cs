...
namespace Pulumi.GoogleNative.MigrationCenter.V1
{
    public static class GetDiscoveryClient
    {
        ...
        public static Task<GetDiscoveryClientResult> InvokeAsync(GetDiscoveryClientArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiscoveryClientResult>("google-native:migrationcenter/v1:getDiscoveryClient", args ?? new GetDiscoveryClientArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a discovery client.
        /// </summary>
        public static Output<GetDiscoveryClientResult> Invoke(GetDiscoveryClientInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiscoveryClientResult>("google-native:migrationcenter/v1:getDiscoveryClient", args ?? new GetDiscoveryClientInvokeArgs(), options.WithDefaults());
    }
