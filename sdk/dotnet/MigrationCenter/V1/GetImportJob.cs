...
namespace Pulumi.GoogleNative.MigrationCenter.V1
{
    public static class GetImportJob
    {
        ...
        public static Task<GetImportJobResult> InvokeAsync(GetImportJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetImportJobResult>("google-native:migrationcenter/v1:getImportJob", args ?? new GetImportJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of an import job.
        /// </summary>
        public static Output<GetImportJobResult> Invoke(GetImportJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetImportJobResult>("google-native:migrationcenter/v1:getImportJob", args ?? new GetImportJobInvokeArgs(), options.WithDefaults());
    }
