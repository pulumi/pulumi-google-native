...
namespace Pulumi.GoogleNative.MigrationCenter.V1
{
    public static class GetPreferenceSet
    {
        ...
        public static Task<GetPreferenceSetResult> InvokeAsync(GetPreferenceSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPreferenceSetResult>("google-native:migrationcenter/v1:getPreferenceSet", args ?? new GetPreferenceSetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a preference set.
        /// </summary>
        public static Output<GetPreferenceSetResult> Invoke(GetPreferenceSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPreferenceSetResult>("google-native:migrationcenter/v1:getPreferenceSet", args ?? new GetPreferenceSetInvokeArgs(), options.WithDefaults());
    }
