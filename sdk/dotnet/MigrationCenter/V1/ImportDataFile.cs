...
namespace Pulumi.GoogleNative.MigrationCenter.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:migrationcenter/v1:ImportDataFile")]
    public partial class ImportDataFile : global::Pulumi.CustomResource
    {
        ...
        public ImportDataFile(string name, ImportDataFileArgs args, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1:ImportDataFile", name, args ?? new ImportDataFileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImportDataFile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1:ImportDataFile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ImportDataFileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.MigrationCenter.V1.ImportDataFileFormat> Format { get; set; } = null!;
