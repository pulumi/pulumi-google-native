...
namespace Pulumi.GoogleNative.MigrationCenter.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:migrationcenter/v1:ReportConfig")]
    public partial class ReportConfig : global::Pulumi.CustomResource
    {
        ...
        public ReportConfig(string name, ReportConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1:ReportConfig", name, args ?? new ReportConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1:ReportConfig", name, null, MakeResourceOptions(options, id))
        {
        }
