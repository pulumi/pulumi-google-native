...
namespace Pulumi.GoogleNative.MigrationCenter.V1Alpha1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:migrationcenter/v1alpha1:DiscoveryClient")]
    public partial class DiscoveryClient : global::Pulumi.CustomResource
    {
        ...
        public DiscoveryClient(string name, DiscoveryClientArgs args, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1alpha1:DiscoveryClient", name, args ?? new DiscoveryClientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiscoveryClient(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1alpha1:DiscoveryClient", name, null, MakeResourceOptions(options, id))
        {
        }
