...
namespace Pulumi.GoogleNative.MigrationCenter.V1Alpha1
{
    public static class GetReport
    {
        ...
        public static Task<GetReportResult> InvokeAsync(GetReportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReportResult>("google-native:migrationcenter/v1alpha1:getReport", args ?? new GetReportArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single Report.
        /// </summary>
        public static Output<GetReportResult> Invoke(GetReportInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReportResult>("google-native:migrationcenter/v1alpha1:getReport", args ?? new GetReportInvokeArgs(), options.WithDefaults());
    }
