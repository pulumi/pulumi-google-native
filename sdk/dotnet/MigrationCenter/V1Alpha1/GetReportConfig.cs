...
namespace Pulumi.GoogleNative.MigrationCenter.V1Alpha1
{
    public static class GetReportConfig
    {
        ...
        public static Task<GetReportConfigResult> InvokeAsync(GetReportConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReportConfigResult>("google-native:migrationcenter/v1alpha1:getReportConfig", args ?? new GetReportConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single ReportConfig.
        /// </summary>
        public static Output<GetReportConfigResult> Invoke(GetReportConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReportConfigResult>("google-native:migrationcenter/v1alpha1:getReportConfig", args ?? new GetReportConfigInvokeArgs(), options.WithDefaults());
    }
