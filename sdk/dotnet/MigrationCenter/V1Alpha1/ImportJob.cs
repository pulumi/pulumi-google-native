...
namespace Pulumi.GoogleNative.MigrationCenter.V1Alpha1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:migrationcenter/v1alpha1:ImportJob")]
    public partial class ImportJob : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("gcsPayload")]
        public Output<Outputs.GCSPayloadInfoResponse> GcsPayload { get; private set; } = null!;
        ...
        public Output<Outputs.InlinePayloadInfoResponse> InlinePayload { get; private set; } = null!;
        ...
        public ImportJob(string name, ImportJobArgs args, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1alpha1:ImportJob", name, args ?? new ImportJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImportJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1alpha1:ImportJob", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ImportJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gcsPayload")]
        public Input<Inputs.GCSPayloadInfoArgs>? GcsPayload { get; set; }
        ...
        /// </summary>
        [Input("inlinePayload")]
        public Input<Inputs.InlinePayloadInfoArgs>? InlinePayload { get; set; }
