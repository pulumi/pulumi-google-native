...
namespace Pulumi.GoogleNative.MigrationCenter.V1Alpha1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:migrationcenter/v1alpha1:Report")]
    public partial class Report : global::Pulumi.CustomResource
    {
        ...
        public Report(string name, ReportArgs args, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1alpha1:Report", name, args ?? new ReportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Report(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:migrationcenter/v1alpha1:Report", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReportArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.GoogleNative.MigrationCenter.V1Alpha1.ReportState>? State { get; set; }

        /// <summary>
        /// Report type.
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.MigrationCenter.V1Alpha1.ReportType>? Type { get; set; }
