...
{
    public static class GetModelIamPolicy
    {
        /// <summary>
        ...
        public static Task<GetModelIamPolicyResult> InvokeAsync(GetModelIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetModelIamPolicyResult>("google-native:ml/v1:getModelIamPolicy", args ?? new GetModelIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetModelIamPolicyResult> Invoke(GetModelIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetModelIamPolicyResult>("google-native:ml/v1:getModelIamPolicy", args ?? new GetModelIamPolicyInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetModelIamPolicyResult
    {
        /// <summary>
        /// Specifies cloud audit logging configuration for this policy.
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleIamV1__AuditConfigResponse> AuditConfigs;
        /// <summary>
        /// Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
        /// </summary>
        public readonly ImmutableArray<Outputs.GoogleIamV1__BindingResponse> Bindings;
        /// <summary>
        ...
        private GetModelIamPolicyResult(
            ImmutableArray<Outputs.GoogleIamV1__AuditConfigResponse> auditConfigs,

            ImmutableArray<Outputs.GoogleIamV1__BindingResponse> bindings,
