...
namespace Pulumi.GoogleCloud.Ml.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:ml/v1:GoogleLongrunning__Operation")]
    public partial class GoogleLongrunning__Operation : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleLongrunning__Operation(string name, GoogleLongrunning__OperationArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:ml/v1:GoogleLongrunning__Operation", name, args ?? new GoogleLongrunning__OperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleLongrunning__Operation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:ml/v1:GoogleLongrunning__Operation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleLongrunning__Operation Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleLongrunning__Operation(name, id, options);
        }
    }

    public sealed class GoogleLongrunning__OperationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GoogleLongrunning__OperationArgs()
        {
        }
    }
}
