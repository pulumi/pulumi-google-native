...
namespace Pulumi.GcpNative.Ml.V1.Inputs
{
    ...
    public sealed class GoogleCloudMlV1__ContainerSpecArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("env")]
        private InputList<Inputs.GoogleCloudMlV1__EnvVarArgs>? _env;
        ...
        /// </summary>
        public InputList<Inputs.GoogleCloudMlV1__EnvVarArgs> Env
        {
            get => _env ?? (_env = new InputList<Inputs.GoogleCloudMlV1__EnvVarArgs>());
            set => _env = value;
        }
        ...
        [Input("ports")]
        private InputList<Inputs.GoogleCloudMlV1__ContainerPortArgs>? _ports;
        ...
        /// </summary>
        public InputList<Inputs.GoogleCloudMlV1__ContainerPortArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Inputs.GoogleCloudMlV1__ContainerPortArgs>());
            set => _ports = value;
        }
