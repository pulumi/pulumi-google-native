...
namespace Pulumi.GoogleCloud.Ml.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:ml/v1:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:ml/v1:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:ml/v1:Job", name, null, MakeResourceOptions(options, id))
        {
        }
