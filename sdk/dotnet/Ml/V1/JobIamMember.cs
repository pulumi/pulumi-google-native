...
namespace Pulumi.GoogleNative.Ml.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:ml/v1:JobIamMember")]
    public partial class JobIamMember : global::Pulumi.CustomResource
    {
        ...
        public JobIamMember(string name, JobIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:ml/v1:JobIamMember", name, args ?? new JobIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:ml/v1:JobIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static JobIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new JobIamMember(name, id, options);
        }
    }
