...
namespace Pulumi.GoogleCloud.Monitoring.V3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:monitoring/v3:AlertPolicy")]
    public partial class AlertPolicy : Pulumi.CustomResource
    {
        ...
        public AlertPolicy(string name, AlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:monitoring/v3:AlertPolicy", name, args ?? new AlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:monitoring/v3:AlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
