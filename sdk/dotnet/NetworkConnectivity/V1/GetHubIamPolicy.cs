...
namespace Pulumi.GoogleNative.NetworkConnectivity.V1
{
    public static class GetHubIamPolicy
    {
        ...
        public static Task<GetHubIamPolicyResult> InvokeAsync(GetHubIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHubIamPolicyResult>("google-native:networkconnectivity/v1:getHubIamPolicy", args ?? new GetHubIamPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetHubIamPolicyResult> Invoke(GetHubIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetHubIamPolicyResult>("google-native:networkconnectivity/v1:getHubIamPolicy", args ?? new GetHubIamPolicyInvokeArgs(), options.WithVersion());
    }
