...
namespace Pulumi.GoogleNative.NetworkConnectivity.V1
{
    public static class GetPolicyBasedRouteIamPolicy
    {
        ...
        public static Task<GetPolicyBasedRouteIamPolicyResult> InvokeAsync(GetPolicyBasedRouteIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyBasedRouteIamPolicyResult>("google-native:networkconnectivity/v1:getPolicyBasedRouteIamPolicy", args ?? new GetPolicyBasedRouteIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetPolicyBasedRouteIamPolicyResult> Invoke(GetPolicyBasedRouteIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicyBasedRouteIamPolicyResult>("google-native:networkconnectivity/v1:getPolicyBasedRouteIamPolicy", args ?? new GetPolicyBasedRouteIamPolicyInvokeArgs(), options.WithDefaults());
    }
