...
namespace Pulumi.GoogleNative.NetworkConnectivity.V1
{
    public static class GetSpokeIamPolicy
    {
        ...
        public static Task<GetSpokeIamPolicyResult> InvokeAsync(GetSpokeIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSpokeIamPolicyResult>("google-native:networkconnectivity/v1:getSpokeIamPolicy", args ?? new GetSpokeIamPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetSpokeIamPolicyResult> Invoke(GetSpokeIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSpokeIamPolicyResult>("google-native:networkconnectivity/v1:getSpokeIamPolicy", args ?? new GetSpokeIamPolicyInvokeArgs(), options.WithVersion());
    }
