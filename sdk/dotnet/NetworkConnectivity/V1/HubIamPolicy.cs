...
namespace Pulumi.GoogleNative.NetworkConnectivity.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkconnectivity/v1:HubIamPolicy")]
    public partial class HubIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public HubIamPolicy(string name, HubIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkconnectivity/v1:HubIamPolicy", name, args ?? new HubIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkconnectivity/v1:HubIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
