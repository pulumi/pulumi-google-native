...
namespace Pulumi.GoogleNative.NetworkConnectivity.V1
{
    ...
    public partial class InternalRange : global::Pulumi.CustomResource
    {
        ...
        public InternalRange(string name, InternalRangeArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:networkconnectivity/v1:InternalRange", name, args ?? new InternalRangeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InternalRange(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkconnectivity/v1:InternalRange", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InternalRangeArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _overlaps ?? (_overlaps = new InputList<Pulumi.GoogleNative.NetworkConnectivity.V1.InternalRangeOverlapsItem>());
            set => _overlaps = value;
        }
        ...
        /// </summary>
        [Input("usage")]
        public Input<Pulumi.GoogleNative.NetworkConnectivity.V1.InternalRangeUsage>? Usage { get; set; }
