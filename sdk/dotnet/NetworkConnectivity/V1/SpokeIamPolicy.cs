...
namespace Pulumi.GoogleNative.NetworkConnectivity.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkconnectivity/v1:SpokeIamPolicy")]
    public partial class SpokeIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a SpokeIamPolicy resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        ...
        public SpokeIamPolicy(string name, SpokeIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkconnectivity/v1:SpokeIamPolicy", name, args ?? new SpokeIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SpokeIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkconnectivity/v1:SpokeIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing SpokeIamPolicy resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SpokeIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SpokeIamPolicy(name, id, options);
        }
    }

    public sealed class SpokeIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new SpokeIamPolicyArgs Empty => new SpokeIamPolicyArgs();
    }
}
