...
namespace Pulumi.GoogleNative.NetworkConnectivity.V1Alpha1
{
    public static class GetInternalRange
    {
        ...
        public static Task<GetInternalRangeResult> InvokeAsync(GetInternalRangeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInternalRangeResult>("google-native:networkconnectivity/v1alpha1:getInternalRange", args ?? new GetInternalRangeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single InternalRange.
        /// </summary>
        public static Output<GetInternalRangeResult> Invoke(GetInternalRangeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInternalRangeResult>("google-native:networkconnectivity/v1alpha1:getInternalRange", args ?? new GetInternalRangeInvokeArgs(), options.WithDefaults());
    }
