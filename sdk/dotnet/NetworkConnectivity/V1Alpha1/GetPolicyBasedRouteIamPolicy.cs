...
{
    public static class GetPolicyBasedRouteIamPolicy
    {
        /// <summary>
        ...
        public static Task<GetPolicyBasedRouteIamPolicyResult> InvokeAsync(GetPolicyBasedRouteIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyBasedRouteIamPolicyResult>("google-native:networkconnectivity/v1alpha1:getPolicyBasedRouteIamPolicy", args ?? new GetPolicyBasedRouteIamPolicyArgs(), options.WithVersion());
    }
    ...
    [OutputType]
    public sealed class GetPolicyBasedRouteIamPolicyResult
    {
        /// <summary>
