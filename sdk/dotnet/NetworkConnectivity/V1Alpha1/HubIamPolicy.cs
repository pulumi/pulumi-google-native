...
namespace Pulumi.GoogleNative.NetworkConnectivity.V1Alpha1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkconnectivity/v1alpha1:HubIamPolicy")]
    public partial class HubIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public HubIamPolicy(string name, HubIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkconnectivity/v1alpha1:HubIamPolicy", name, args ?? new HubIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkconnectivity/v1alpha1:HubIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HubIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new HubIamPolicy(name, id, options);
        }
    }

    public sealed class HubIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new HubIamPolicyArgs Empty => new HubIamPolicyArgs();
    }
}
