...
namespace Pulumi.GoogleNative.NetworkManagement.V1Beta1
{
    public static class GetConnectivityTest
    {
        ...
        public static Task<GetConnectivityTestResult> InvokeAsync(GetConnectivityTestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectivityTestResult>("google-native:networkmanagement/v1beta1:getConnectivityTest", args ?? new GetConnectivityTestArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a specific Connectivity Test.
        /// </summary>
        public static Output<GetConnectivityTestResult> Invoke(GetConnectivityTestInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectivityTestResult>("google-native:networkmanagement/v1beta1:getConnectivityTest", args ?? new GetConnectivityTestInvokeArgs(), options.WithDefaults());
    }
