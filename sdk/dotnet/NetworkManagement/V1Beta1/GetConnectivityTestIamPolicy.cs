...
namespace Pulumi.GoogleNative.NetworkManagement.V1Beta1
{
    public static class GetConnectivityTestIamPolicy
    {
        ...
        public static Task<GetConnectivityTestIamPolicyResult> InvokeAsync(GetConnectivityTestIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConnectivityTestIamPolicyResult>("google-native:networkmanagement/v1beta1:getConnectivityTestIamPolicy", args ?? new GetConnectivityTestIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetConnectivityTestIamPolicyResult> Invoke(GetConnectivityTestIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConnectivityTestIamPolicyResult>("google-native:networkmanagement/v1beta1:getConnectivityTestIamPolicy", args ?? new GetConnectivityTestIamPolicyInvokeArgs(), options.WithDefaults());
    }
