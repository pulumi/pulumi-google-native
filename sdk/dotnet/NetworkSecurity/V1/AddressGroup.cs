...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1:AddressGroup")]
    public partial class AddressGroup : global::Pulumi.CustomResource
    {
        ...
        public AddressGroup(string name, AddressGroupArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:AddressGroup", name, args ?? new AddressGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AddressGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:AddressGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AddressGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.NetworkSecurity.V1.AddressGroupType> Type { get; set; } = null!;
