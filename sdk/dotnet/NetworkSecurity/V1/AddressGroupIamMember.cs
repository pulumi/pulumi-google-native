...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1:AddressGroupIamMember")]
    public partial class AddressGroupIamMember : global::Pulumi.CustomResource
    {
        ...
        public AddressGroupIamMember(string name, AddressGroupIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:AddressGroupIamMember", name, args ?? new AddressGroupIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AddressGroupIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:AddressGroupIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AddressGroupIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new AddressGroupIamMember(name, id, options);
        }
    }
