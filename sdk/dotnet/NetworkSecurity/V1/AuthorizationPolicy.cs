...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    ...
    public partial class AuthorizationPolicy : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationPolicy(string name, AuthorizationPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:AuthorizationPolicy", name, args ?? new AuthorizationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:AuthorizationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AuthorizationPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.NetworkSecurity.V1.AuthorizationPolicyAction> Action { get; set; } = null!;
