...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1:ClientTlsPolicyIamPolicy")]
    public partial class ClientTlsPolicyIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ClientTlsPolicyIamPolicy(string name, ClientTlsPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:ClientTlsPolicyIamPolicy", name, args ?? new ClientTlsPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClientTlsPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:ClientTlsPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
