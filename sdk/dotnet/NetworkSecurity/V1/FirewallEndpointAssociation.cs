...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1:FirewallEndpointAssociation")]
    public partial class FirewallEndpointAssociation : global::Pulumi.CustomResource
    {
        ...
        public FirewallEndpointAssociation(string name, FirewallEndpointAssociationArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:FirewallEndpointAssociation", name, args ?? new FirewallEndpointAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallEndpointAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:FirewallEndpointAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
