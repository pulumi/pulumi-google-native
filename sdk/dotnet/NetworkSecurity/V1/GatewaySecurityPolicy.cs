...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1:GatewaySecurityPolicy")]
    public partial class GatewaySecurityPolicy : global::Pulumi.CustomResource
    {
        ...
        public GatewaySecurityPolicy(string name, GatewaySecurityPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:GatewaySecurityPolicy", name, args ?? new GatewaySecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewaySecurityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:GatewaySecurityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
