...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    public static class GetAddressGroup
    {
        ...
        public static Task<GetAddressGroupResult> InvokeAsync(GetAddressGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddressGroupResult>("google-native:networksecurity/v1:getAddressGroup", args ?? new GetAddressGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single address group.
        /// </summary>
        public static Output<GetAddressGroupResult> Invoke(GetAddressGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAddressGroupResult>("google-native:networksecurity/v1:getAddressGroup", args ?? new GetAddressGroupInvokeArgs(), options.WithDefaults());
    }
