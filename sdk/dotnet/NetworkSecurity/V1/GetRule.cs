...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("google-native:networksecurity/v1:getRule", args ?? new GetRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single GatewaySecurityPolicyRule.
        /// </summary>
        public static Output<GetRuleResult> Invoke(GetRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuleResult>("google-native:networksecurity/v1:getRule", args ?? new GetRuleInvokeArgs(), options.WithDefaults());
    }
