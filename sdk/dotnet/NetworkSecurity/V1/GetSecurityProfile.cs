...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    public static class GetSecurityProfile
    {
        ...
        public static Task<GetSecurityProfileResult> InvokeAsync(GetSecurityProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityProfileResult>("google-native:networksecurity/v1:getSecurityProfile", args ?? new GetSecurityProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single SecurityProfile.
        /// </summary>
        public static Output<GetSecurityProfileResult> Invoke(GetSecurityProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecurityProfileResult>("google-native:networksecurity/v1:getSecurityProfile", args ?? new GetSecurityProfileInvokeArgs(), options.WithDefaults());
    }
