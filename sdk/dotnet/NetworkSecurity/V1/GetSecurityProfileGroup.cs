...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    public static class GetSecurityProfileGroup
    {
        ...
        public static Task<GetSecurityProfileGroupResult> InvokeAsync(GetSecurityProfileGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityProfileGroupResult>("google-native:networksecurity/v1:getSecurityProfileGroup", args ?? new GetSecurityProfileGroupArgs(), options.WithDefaults());
        ...
        public static Output<GetSecurityProfileGroupResult> Invoke(GetSecurityProfileGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecurityProfileGroupResult>("google-native:networksecurity/v1:getSecurityProfileGroup", args ?? new GetSecurityProfileGroupInvokeArgs(), options.WithDefaults());
    }
