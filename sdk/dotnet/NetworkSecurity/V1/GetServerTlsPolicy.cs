...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    public static class GetServerTlsPolicy
    {
        ...
        public static Task<GetServerTlsPolicyResult> InvokeAsync(GetServerTlsPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerTlsPolicyResult>("google-native:networksecurity/v1:getServerTlsPolicy", args ?? new GetServerTlsPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single ServerTlsPolicy.
        /// </summary>
        public static Output<GetServerTlsPolicyResult> Invoke(GetServerTlsPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerTlsPolicyResult>("google-native:networksecurity/v1:getServerTlsPolicy", args ?? new GetServerTlsPolicyInvokeArgs(), options.WithDefaults());
    }
