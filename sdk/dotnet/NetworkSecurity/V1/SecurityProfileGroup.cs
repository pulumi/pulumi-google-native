...
namespace Pulumi.GoogleNative.NetworkSecurity.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1:SecurityProfileGroup")]
    public partial class SecurityProfileGroup : global::Pulumi.CustomResource
    {
        ...
        public SecurityProfileGroup(string name, SecurityProfileGroupArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:SecurityProfileGroup", name, args ?? new SecurityProfileGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityProfileGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1:SecurityProfileGroup", name, null, MakeResourceOptions(options, id))
        {
        }
