...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1beta1:AddressGroupIamMember")]
    public partial class AddressGroupIamMember : global::Pulumi.CustomResource
    {
        ...
        public AddressGroupIamMember(string name, AddressGroupIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:AddressGroupIamMember", name, args ?? new AddressGroupIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AddressGroupIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:AddressGroupIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
