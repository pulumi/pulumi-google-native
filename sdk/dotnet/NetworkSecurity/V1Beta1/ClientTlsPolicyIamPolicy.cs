...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    public partial class ClientTlsPolicyIamPolicy : Pulumi.CustomResource
    {
        ...
        public ClientTlsPolicyIamPolicy(string name, ClientTlsPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:ClientTlsPolicyIamPolicy", name, args ?? new ClientTlsPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClientTlsPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:ClientTlsPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ClientTlsPolicyIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
