...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    public partial class FirewallEndpoint : global::Pulumi.CustomResource
    {
        ...
        public FirewallEndpoint(string name, FirewallEndpointArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:FirewallEndpoint", name, args ?? new FirewallEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:FirewallEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
