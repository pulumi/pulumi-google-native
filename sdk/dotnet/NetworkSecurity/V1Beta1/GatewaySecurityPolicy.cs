...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1beta1:GatewaySecurityPolicy")]
    public partial class GatewaySecurityPolicy : global::Pulumi.CustomResource
    {
        ...
        public GatewaySecurityPolicy(string name, GatewaySecurityPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:GatewaySecurityPolicy", name, args ?? new GatewaySecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewaySecurityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:GatewaySecurityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GatewaySecurityPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GatewaySecurityPolicy(name, id, options);
        }
    }
