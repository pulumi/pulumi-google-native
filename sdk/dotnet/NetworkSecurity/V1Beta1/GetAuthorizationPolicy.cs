...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    public static class GetAuthorizationPolicy
    {
        ...
        public static Task<GetAuthorizationPolicyResult> InvokeAsync(GetAuthorizationPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationPolicyResult>("google-native:networksecurity/v1beta1:getAuthorizationPolicy", args ?? new GetAuthorizationPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetAuthorizationPolicyResult> Invoke(GetAuthorizationPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAuthorizationPolicyResult>("google-native:networksecurity/v1beta1:getAuthorizationPolicy", args ?? new GetAuthorizationPolicyInvokeArgs(), options.WithDefaults());
    }
