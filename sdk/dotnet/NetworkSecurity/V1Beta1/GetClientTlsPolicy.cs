...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    public static class GetClientTlsPolicy
    {
        ...
        public static Task<GetClientTlsPolicyResult> InvokeAsync(GetClientTlsPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClientTlsPolicyResult>("google-native:networksecurity/v1beta1:getClientTlsPolicy", args ?? new GetClientTlsPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single ClientTlsPolicy.
        /// </summary>
        public static Output<GetClientTlsPolicyResult> Invoke(GetClientTlsPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClientTlsPolicyResult>("google-native:networksecurity/v1beta1:getClientTlsPolicy", args ?? new GetClientTlsPolicyInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetClientTlsPolicyArgs : global::Pulumi.InvokeArgs
    {
        ...
        public static new GetClientTlsPolicyArgs Empty => new GetClientTlsPolicyArgs();
    }

    public sealed class GetClientTlsPolicyInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("clientTlsPolicyId", required: true)]
        ...
        public static new GetClientTlsPolicyInvokeArgs Empty => new GetClientTlsPolicyInvokeArgs();
    }
