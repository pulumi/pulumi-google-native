...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    public static class GetGatewaySecurityPolicy
    {
        ...
        public static Task<GetGatewaySecurityPolicyResult> InvokeAsync(GetGatewaySecurityPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewaySecurityPolicyResult>("google-native:networksecurity/v1beta1:getGatewaySecurityPolicy", args ?? new GetGatewaySecurityPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetGatewaySecurityPolicyResult> Invoke(GetGatewaySecurityPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGatewaySecurityPolicyResult>("google-native:networksecurity/v1beta1:getGatewaySecurityPolicy", args ?? new GetGatewaySecurityPolicyInvokeArgs(), options.WithDefaults());
    }
