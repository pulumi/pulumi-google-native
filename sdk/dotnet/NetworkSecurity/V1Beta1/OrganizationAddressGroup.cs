...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1beta1:OrganizationAddressGroup")]
    public partial class OrganizationAddressGroup : global::Pulumi.CustomResource
    {
        ...
        public OrganizationAddressGroup(string name, OrganizationAddressGroupArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:OrganizationAddressGroup", name, args ?? new OrganizationAddressGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationAddressGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:OrganizationAddressGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrganizationAddressGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.NetworkSecurity.V1Beta1.OrganizationAddressGroupType> Type { get; set; } = null!;
