...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1beta1:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.NetworkSecurity.V1Beta1.RuleBasicProfile> BasicProfile { get; set; } = null!;
