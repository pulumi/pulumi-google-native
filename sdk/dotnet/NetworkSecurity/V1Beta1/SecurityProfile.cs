...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1beta1:SecurityProfile")]
    public partial class SecurityProfile : global::Pulumi.CustomResource
    {
        ...
        public SecurityProfile(string name, SecurityProfileArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:SecurityProfile", name, args ?? new SecurityProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:SecurityProfile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.GoogleNative.NetworkSecurity.V1Beta1.SecurityProfileType>? Type { get; set; }
