...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1beta1:ServerTlsPolicyIamBinding")]
    public partial class ServerTlsPolicyIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ServerTlsPolicyIamBinding(string name, ServerTlsPolicyIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:ServerTlsPolicyIamBinding", name, args ?? new ServerTlsPolicyIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerTlsPolicyIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:ServerTlsPolicyIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
