...
namespace Pulumi.GoogleNative.NetworkSecurity.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networksecurity/v1beta1:UrlList")]
    public partial class UrlList : global::Pulumi.CustomResource
    {
        ...
        public UrlList(string name, UrlListArgs args, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:UrlList", name, args ?? new UrlListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UrlList(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networksecurity/v1beta1:UrlList", name, null, MakeResourceOptions(options, id))
        {
        }
