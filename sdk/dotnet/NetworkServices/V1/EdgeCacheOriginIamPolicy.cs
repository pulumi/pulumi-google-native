...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    public partial class EdgeCacheOriginIamPolicy : Pulumi.CustomResource
    {
        ...
        [Output("edgeCacheOriginId")]
        public Output<string> EdgeCacheOriginId { get; private set; } = null!;
        ...
        public EdgeCacheOriginIamPolicy(string name, EdgeCacheOriginIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:EdgeCacheOriginIamPolicy", name, args ?? new EdgeCacheOriginIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EdgeCacheOriginIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:EdgeCacheOriginIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EdgeCacheOriginIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
