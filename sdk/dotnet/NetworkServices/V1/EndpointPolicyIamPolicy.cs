...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkservices/v1:EndpointPolicyIamPolicy")]
    public partial class EndpointPolicyIamPolicy : Pulumi.CustomResource
    {
        ...
        public EndpointPolicyIamPolicy(string name, EndpointPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:EndpointPolicyIamPolicy", name, args ?? new EndpointPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EndpointPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:EndpointPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
