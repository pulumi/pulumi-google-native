...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    public readonly struct EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria : IEquatable<EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria>
    {
        ...
        private EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria MetadataLabelMatchCriteriaUnspecified { get; } = new EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria("METADATA_LABEL_MATCH_CRITERIA_UNSPECIFIED");
        /// <summary>
        /// At least one of the Labels specified in the matcher should match the metadata presented by xDS client.
        /// </summary>
        public static EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria MatchAny { get; } = new EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria("MATCH_ANY");
        /// <summary>
        /// The metadata presented by the xDS client should contain all of the labels specified here.
        /// </summary>
        public static EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria MatchAll { get; } = new EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria("MATCH_ALL");

        public static bool operator ==(EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria left, EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria right) => left.Equals(right);
        public static bool operator !=(EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria left, EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria right) => !left.Equals(right);

        public static explicit operator string(EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria other && Equals(other);
        public bool Equals(EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria other) => string.Equals(_value, other._value, StringComparison.Ordinal);
