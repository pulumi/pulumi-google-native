...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    public partial class Gateway : global::Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:Gateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("envoyHeaders")]
        public Input<Pulumi.GoogleNative.NetworkServices.V1.GatewayEnvoyHeaders>? EnvoyHeaders { get; set; }
        ...
        /// </summary>
        [Input("ipVersion")]
        public Input<Pulumi.GoogleNative.NetworkServices.V1.GatewayIpVersion>? IpVersion { get; set; }
