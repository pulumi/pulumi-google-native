...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    public static class GetServiceBinding
    {
        ...
        public static Task<GetServiceBindingResult> InvokeAsync(GetServiceBindingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceBindingResult>("google-native:networkservices/v1:getServiceBinding", args ?? new GetServiceBindingArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single ServiceBinding.
        /// </summary>
        public static Output<GetServiceBindingResult> Invoke(GetServiceBindingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceBindingResult>("google-native:networkservices/v1:getServiceBinding", args ?? new GetServiceBindingInvokeArgs(), options.WithDefaults());
    }
