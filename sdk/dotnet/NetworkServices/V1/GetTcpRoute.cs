...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    public static class GetTcpRoute
    {
        ...
        public static Task<GetTcpRouteResult> InvokeAsync(GetTcpRouteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTcpRouteResult>("google-native:networkservices/v1:getTcpRoute", args ?? new GetTcpRouteArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single TcpRoute.
        /// </summary>
        public static Output<GetTcpRouteResult> Invoke(GetTcpRouteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTcpRouteResult>("google-native:networkservices/v1:getTcpRoute", args ?? new GetTcpRouteInvokeArgs(), options.WithDefaults());
    }
