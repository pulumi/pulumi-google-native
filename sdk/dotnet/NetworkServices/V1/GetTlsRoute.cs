...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    public static class GetTlsRoute
    {
        ...
        public static Task<GetTlsRouteResult> InvokeAsync(GetTlsRouteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTlsRouteResult>("google-native:networkservices/v1:getTlsRoute", args ?? new GetTlsRouteArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single TlsRoute.
        /// </summary>
        public static Output<GetTlsRouteResult> Invoke(GetTlsRouteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTlsRouteResult>("google-native:networkservices/v1:getTlsRoute", args ?? new GetTlsRouteInvokeArgs(), options.WithDefaults());
    }
