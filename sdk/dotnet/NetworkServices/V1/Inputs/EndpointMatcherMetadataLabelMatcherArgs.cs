...
namespace Pulumi.GoogleNative.NetworkServices.V1.Inputs
{
    ...
    /// </summary>
    public sealed class EndpointMatcherMetadataLabelMatcherArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.GoogleNative.NetworkServices.V1.EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria>? MetadataLabelMatchCriteria { get; set; }

        [Input("metadataLabels")]
        private InputList<Inputs.EndpointMatcherMetadataLabelMatcherMetadataLabelsArgs>? _metadataLabels;

        /// <summary>
        /// The list of label value pairs that must match labels in the provided metadata based on filterMatchCriteria This list can have at most 64 entries. The list can be empty if the match criteria is MATCH_ANY, to specify a wildcard match (i.e this matches any client).
        /// </summary>
        public InputList<Inputs.EndpointMatcherMetadataLabelMatcherMetadataLabelsArgs> MetadataLabels
        {
            get => _metadataLabels ?? (_metadataLabels = new InputList<Inputs.EndpointMatcherMetadataLabelMatcherMetadataLabelsArgs>());
        ...
        public static new EndpointMatcherMetadataLabelMatcherArgs Empty => new EndpointMatcherMetadataLabelMatcherArgs();
    }
}
