...
namespace Pulumi.GoogleNative.NetworkServices.V1.Inputs
{
    ...
    public sealed class ExtensionChainExtensionArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.GoogleNative.NetworkServices.V1.ExtensionChainExtensionSupportedEventsItem>? _supportedEvents;
        ...
        /// </summary>
        public InputList<Pulumi.GoogleNative.NetworkServices.V1.ExtensionChainExtensionSupportedEventsItem> SupportedEvents
        {
            get => _supportedEvents ?? (_supportedEvents = new InputList<Pulumi.GoogleNative.NetworkServices.V1.ExtensionChainExtensionSupportedEventsItem>());
