...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkservices/v1:LbRouteExtension")]
    public partial class LbRouteExtension : global::Pulumi.CustomResource
    {
        ...
        public LbRouteExtension(string name, LbRouteExtensionArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:LbRouteExtension", name, args ?? new LbRouteExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LbRouteExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:LbRouteExtension", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LbRouteExtensionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.NetworkServices.V1.LbRouteExtensionLoadBalancingScheme> LoadBalancingScheme { get; set; } = null!;
