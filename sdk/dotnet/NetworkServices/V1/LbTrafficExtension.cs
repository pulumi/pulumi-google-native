...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkservices/v1:LbTrafficExtension")]
    public partial class LbTrafficExtension : global::Pulumi.CustomResource
    {
        ...
        public LbTrafficExtension(string name, LbTrafficExtensionArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:LbTrafficExtension", name, args ?? new LbTrafficExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LbTrafficExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:LbTrafficExtension", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LbTrafficExtensionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.NetworkServices.V1.LbTrafficExtensionLoadBalancingScheme> LoadBalancingScheme { get; set; } = null!;
