...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkservices/v1:MeshIamPolicy")]
    public partial class MeshIamPolicy : Pulumi.CustomResource
    {
        ...
        public MeshIamPolicy(string name, MeshIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:MeshIamPolicy", name, args ?? new MeshIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MeshIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:MeshIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MeshIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
