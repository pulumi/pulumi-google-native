...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    public partial class ServiceBinding : Pulumi.CustomResource
    {
        ...
        public ServiceBinding(string name, ServiceBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:ServiceBinding", name, args ?? new ServiceBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:ServiceBinding", name, null, MakeResourceOptions(options, id))
        {
        }
