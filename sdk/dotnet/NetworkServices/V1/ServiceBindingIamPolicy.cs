...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    public partial class ServiceBindingIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceBindingIamPolicy(string name, ServiceBindingIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:ServiceBindingIamPolicy", name, args ?? new ServiceBindingIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceBindingIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:ServiceBindingIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
