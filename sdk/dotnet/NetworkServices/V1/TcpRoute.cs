...
namespace Pulumi.GoogleNative.NetworkServices.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkservices/v1:TcpRoute")]
    public partial class TcpRoute : Pulumi.CustomResource
    {
        ...
        public TcpRoute(string name, TcpRouteArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:TcpRoute", name, args ?? new TcpRouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TcpRoute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1:TcpRoute", name, null, MakeResourceOptions(options, id))
        {
        }
