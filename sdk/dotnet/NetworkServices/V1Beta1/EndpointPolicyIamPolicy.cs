...
namespace Pulumi.GoogleNative.NetworkServices.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkservices/v1beta1:EndpointPolicyIamPolicy")]
    public partial class EndpointPolicyIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public EndpointPolicyIamPolicy(string name, EndpointPolicyIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:EndpointPolicyIamPolicy", name, args ?? new EndpointPolicyIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EndpointPolicyIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:EndpointPolicyIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EndpointPolicyIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new EndpointPolicyIamPolicy(name, id, options);
        }
    }

    public sealed class EndpointPolicyIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new EndpointPolicyIamPolicyArgs Empty => new EndpointPolicyIamPolicyArgs();
    }
}
