...
namespace Pulumi.GoogleNative.NetworkServices.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkservices/v1beta1:GatewayIamPolicy")]
    public partial class GatewayIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public GatewayIamPolicy(string name, GatewayIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:GatewayIamPolicy", name, args ?? new GatewayIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:GatewayIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
