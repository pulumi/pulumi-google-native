...
namespace Pulumi.GoogleNative.NetworkServices.V1Beta1
{
    public static class GetEndpointPolicy
    {
        ...
        public static Task<GetEndpointPolicyResult> InvokeAsync(GetEndpointPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEndpointPolicyResult>("google-native:networkservices/v1beta1:getEndpointPolicy", args ?? new GetEndpointPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single EndpointPolicy.
        /// </summary>
        public static Output<GetEndpointPolicyResult> Invoke(GetEndpointPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEndpointPolicyResult>("google-native:networkservices/v1beta1:getEndpointPolicy", args ?? new GetEndpointPolicyInvokeArgs(), options.WithDefaults());
    }
