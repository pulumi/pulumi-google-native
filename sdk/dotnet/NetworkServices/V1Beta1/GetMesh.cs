...
namespace Pulumi.GoogleNative.NetworkServices.V1Beta1
{
    public static class GetMesh
    {
        ...
        public static Task<GetMeshResult> InvokeAsync(GetMeshArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMeshResult>("google-native:networkservices/v1beta1:getMesh", args ?? new GetMeshArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single Mesh.
        /// </summary>
        public static Output<GetMeshResult> Invoke(GetMeshInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMeshResult>("google-native:networkservices/v1beta1:getMesh", args ?? new GetMeshInvokeArgs(), options.WithDefaults());
    }
