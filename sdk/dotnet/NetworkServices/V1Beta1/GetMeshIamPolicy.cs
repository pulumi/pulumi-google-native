...
{
    public static class GetMeshIamPolicy
    {
        /// <summary>
        ...
        public static Task<GetMeshIamPolicyResult> InvokeAsync(GetMeshIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMeshIamPolicyResult>("google-native:networkservices/v1beta1:getMeshIamPolicy", args ?? new GetMeshIamPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
        /// </summary>
        public static Output<GetMeshIamPolicyResult> Invoke(GetMeshIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMeshIamPolicyResult>("google-native:networkservices/v1beta1:getMeshIamPolicy", args ?? new GetMeshIamPolicyInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetMeshIamPolicyResult
    {
        /// <summary>
