...
namespace Pulumi.GoogleNative.NetworkServices.V1Beta1
{
    public static class GetServiceBindingIamPolicy
    {
        ...
        public static Task<GetServiceBindingIamPolicyResult> InvokeAsync(GetServiceBindingIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceBindingIamPolicyResult>("google-native:networkservices/v1beta1:getServiceBindingIamPolicy", args ?? new GetServiceBindingIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetServiceBindingIamPolicyResult> Invoke(GetServiceBindingIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceBindingIamPolicyResult>("google-native:networkservices/v1beta1:getServiceBindingIamPolicy", args ?? new GetServiceBindingIamPolicyInvokeArgs(), options.WithVersion());
    }
