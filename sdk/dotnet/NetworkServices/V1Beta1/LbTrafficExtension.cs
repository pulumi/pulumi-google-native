...
namespace Pulumi.GoogleNative.NetworkServices.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:networkservices/v1beta1:LbTrafficExtension")]
    public partial class LbTrafficExtension : global::Pulumi.CustomResource
    {
        ...
        public Output<string> LbTrafficExtensionId { get; private set; } = null!;
        ...
        public LbTrafficExtension(string name, LbTrafficExtensionArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:LbTrafficExtension", name, args ?? new LbTrafficExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LbTrafficExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:LbTrafficExtension", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LbTrafficExtension Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new LbTrafficExtension(name, id, options);
        }
    }
    ...
    public sealed class LbTrafficExtensionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.NetworkServices.V1Beta1.LbTrafficExtensionLoadBalancingScheme> LoadBalancingScheme { get; set; } = null!;
