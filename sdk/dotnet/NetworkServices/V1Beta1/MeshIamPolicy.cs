...
namespace Pulumi.GoogleNative.NetworkServices.V1Beta1
{
    ...
    public partial class MeshIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public MeshIamPolicy(string name, MeshIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:MeshIamPolicy", name, args ?? new MeshIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MeshIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:MeshIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
