...
namespace Pulumi.GoogleNative.NetworkServices.V1Beta1
{
    ...
    public partial class TlsRoute : global::Pulumi.CustomResource
    {
        ...
        public TlsRoute(string name, TlsRouteArgs args, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:TlsRoute", name, args ?? new TlsRouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TlsRoute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:networkservices/v1beta1:TlsRoute", name, null, MakeResourceOptions(options, id))
        {
        }
