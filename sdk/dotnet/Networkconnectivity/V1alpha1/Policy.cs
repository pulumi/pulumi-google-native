...
namespace Pulumi.GoogleCloud.Networkconnectivity.V1alpha1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:networkconnectivity/v1alpha1:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:networkconnectivity/v1alpha1:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:networkconnectivity/v1alpha1:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
