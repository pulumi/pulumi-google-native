...
namespace Pulumi.GoogleNative.Notebooks.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:notebooks/v1:RuntimeIamBinding")]
    public partial class RuntimeIamBinding : global::Pulumi.CustomResource
    {
        ...
        public RuntimeIamBinding(string name, RuntimeIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:notebooks/v1:RuntimeIamBinding", name, args ?? new RuntimeIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RuntimeIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:notebooks/v1:RuntimeIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
