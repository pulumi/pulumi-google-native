...
namespace Pulumi.GoogleNative.Notebooks.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:notebooks/v1:RuntimeIamPolicy")]
    public partial class RuntimeIamPolicy : Pulumi.CustomResource
    {
        ...
        public RuntimeIamPolicy(string name, RuntimeIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:notebooks/v1:RuntimeIamPolicy", name, args ?? new RuntimeIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RuntimeIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:notebooks/v1:RuntimeIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RuntimeIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
