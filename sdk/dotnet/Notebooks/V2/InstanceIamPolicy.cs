...
namespace Pulumi.GoogleNative.Notebooks.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:notebooks/v2:InstanceIamPolicy")]
    public partial class InstanceIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamPolicy(string name, InstanceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:notebooks/v2:InstanceIamPolicy", name, args ?? new InstanceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:notebooks/v2:InstanceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
