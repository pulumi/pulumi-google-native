...
namespace Pulumi.GoogleNative.OSConfig.V1
{
    public static class GetOsPolicyAssignment
    {
        ...
        public static Task<GetOsPolicyAssignmentResult> InvokeAsync(GetOsPolicyAssignmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOsPolicyAssignmentResult>("google-native:osconfig/v1:getOsPolicyAssignment", args ?? new GetOsPolicyAssignmentArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve an existing OS policy assignment. This method always returns the latest revision. In order to retrieve a previous revision of the assignment, also provide the revision ID in the `name` parameter.
        /// </summary>
        public static Output<GetOsPolicyAssignmentResult> Invoke(GetOsPolicyAssignmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOsPolicyAssignmentResult>("google-native:osconfig/v1:getOsPolicyAssignment", args ?? new GetOsPolicyAssignmentInvokeArgs(), options.WithDefaults());
    }
