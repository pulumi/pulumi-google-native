...
namespace Pulumi.GoogleNative.OSConfig.V1
{
    public static class GetPatchDeployment
    {
        ...
        public static Output<GetPatchDeploymentResult> Invoke(GetPatchDeploymentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPatchDeploymentResult>("google-native:osconfig/v1:getPatchDeployment", args ?? new GetPatchDeploymentInvokeArgs(), options.WithVersion());
    }
