...
namespace Pulumi.GoogleNative.OSConfig.V1Alpha
{
    public static class GetOsPolicyAssignment
    {
        ...
        public static Output<GetOsPolicyAssignmentResult> Invoke(GetOsPolicyAssignmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOsPolicyAssignmentResult>("google-native:osconfig/v1alpha:getOsPolicyAssignment", args ?? new GetOsPolicyAssignmentInvokeArgs(), options.WithVersion());
    }
