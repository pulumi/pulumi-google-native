...
namespace Pulumi.GoogleNative.OSConfig.V1Alpha
{
    ...
    public partial class OsPolicyAssignment : Pulumi.CustomResource
    {
        ...
        public OsPolicyAssignment(string name, OsPolicyAssignmentArgs args, CustomResourceOptions? options = null)
            : base("google-native:osconfig/v1alpha:OsPolicyAssignment", name, args ?? new OsPolicyAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OsPolicyAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:osconfig/v1alpha:OsPolicyAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OsPolicyAssignmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.OSPolicyAssignmentInstanceFilterArgs>? InstanceFilter { get; set; }
        ...
        /// </summary>
        [Input("rollout")]
        public Input<Inputs.OSPolicyAssignmentRolloutArgs>? Rollout { get; set; }
