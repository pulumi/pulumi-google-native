...
namespace Pulumi.GoogleNative.OSLogin.V1
{
    public static class GetSshPublicKey
    {
        ...
        public static Task<GetSshPublicKeyResult> InvokeAsync(GetSshPublicKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSshPublicKeyResult>("google-native:oslogin/v1:getSshPublicKey", args ?? new GetSshPublicKeyArgs(), options.WithVersion());

        /// <summary>
        /// Retrieves an SSH public key.
        /// </summary>
        public static Output<GetSshPublicKeyResult> Invoke(GetSshPublicKeyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSshPublicKeyResult>("google-native:oslogin/v1:getSshPublicKey", args ?? new GetSshPublicKeyInvokeArgs(), options.WithVersion());
    }
