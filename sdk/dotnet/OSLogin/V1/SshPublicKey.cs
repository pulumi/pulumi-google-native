...
namespace Pulumi.GoogleNative.OSLogin.V1
{
    /// <summary>
    /// Create an SSH public key
    /// Auto-naming is currently not supported for this resource.
    /// </summary>
    [GoogleNativeResourceType("google-native:oslogin/v1:SshPublicKey")]
    public partial class SshPublicKey : Pulumi.CustomResource
    {
        ...
        public SshPublicKey(string name, SshPublicKeyArgs args, CustomResourceOptions? options = null)
            : base("google-native:oslogin/v1:SshPublicKey", name, args ?? new SshPublicKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SshPublicKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:oslogin/v1:SshPublicKey", name, null, MakeResourceOptions(options, id))
        {
        }
