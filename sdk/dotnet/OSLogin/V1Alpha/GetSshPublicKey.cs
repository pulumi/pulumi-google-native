...
namespace Pulumi.GoogleNative.OSLogin.V1Alpha
{
    public static class GetSshPublicKey
    {
        ...
        public static Task<GetSshPublicKeyResult> InvokeAsync(GetSshPublicKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSshPublicKeyResult>("google-native:oslogin/v1alpha:getSshPublicKey", args ?? new GetSshPublicKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves an SSH public key.
        /// </summary>
        public static Output<GetSshPublicKeyResult> Invoke(GetSshPublicKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSshPublicKeyResult>("google-native:oslogin/v1alpha:getSshPublicKey", args ?? new GetSshPublicKeyInvokeArgs(), options.WithDefaults());
    }
