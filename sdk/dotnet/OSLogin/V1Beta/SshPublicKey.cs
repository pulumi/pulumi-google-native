...
namespace Pulumi.GoogleNative.OSLogin.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:oslogin/v1beta:SshPublicKey")]
    public partial class SshPublicKey : Pulumi.CustomResource
    {
        ...
        public SshPublicKey(string name, SshPublicKeyArgs args, CustomResourceOptions? options = null)
            : base("google-native:oslogin/v1beta:SshPublicKey", name, args ?? new SshPublicKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SshPublicKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:oslogin/v1beta:SshPublicKey", name, null, MakeResourceOptions(options, id))
        {
        }
