...
namespace Pulumi.GoogleCloud.Osconfig.V1
{
    /// <summary>
    /// Create an OS Config patch deployment.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:osconfig/v1:PatchDeployment")]
    public partial class PatchDeployment : Pulumi.CustomResource
    {
        ...
        public PatchDeployment(string name, PatchDeploymentArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:osconfig/v1:PatchDeployment", name, args ?? new PatchDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PatchDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:osconfig/v1:PatchDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
