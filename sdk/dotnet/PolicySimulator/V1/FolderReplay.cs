...
namespace Pulumi.GcpNative.PolicySimulator.V1
{
    /// <summary>
    /// Creates and starts a Replay using the given ReplayConfig.
    /// </summary>
    [GcpNativeResourceType("gcp-native:policysimulator/v1:FolderReplay")]
    public partial class FolderReplay : Pulumi.CustomResource
    {
        ...
        public FolderReplay(string name, FolderReplayArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:policysimulator/v1:FolderReplay", name, args ?? new FolderReplayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderReplay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:policysimulator/v1:FolderReplay", name, null, MakeResourceOptions(options, id))
        {
        }
