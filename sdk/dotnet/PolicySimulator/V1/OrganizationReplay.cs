...
namespace Pulumi.GcpNative.PolicySimulator.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("google-native:policysimulator/v1:OrganizationReplay")]
    public partial class OrganizationReplay : Pulumi.CustomResource
    {
        ...
        public OrganizationReplay(string name, OrganizationReplayArgs args, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1:OrganizationReplay", name, args ?? new OrganizationReplayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationReplay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1:OrganizationReplay", name, null, MakeResourceOptions(options, id))
        {
        }
