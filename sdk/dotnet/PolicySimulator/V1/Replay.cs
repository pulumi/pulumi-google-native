...
namespace Pulumi.GcpNative.PolicySimulator.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:policysimulator/v1:Replay")]
    public partial class Replay : Pulumi.CustomResource
    {
        ...
        public Replay(string name, ReplayArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:policysimulator/v1:Replay", name, args ?? new ReplayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:policysimulator/v1:Replay", name, null, MakeResourceOptions(options, id))
        {
        }
