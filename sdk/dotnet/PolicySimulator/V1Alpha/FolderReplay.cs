...
namespace Pulumi.GoogleNative.PolicySimulator.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:policysimulator/v1alpha:FolderReplay")]
    public partial class FolderReplay : global::Pulumi.CustomResource
    {
        ...
        public FolderReplay(string name, FolderReplayArgs args, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1alpha:FolderReplay", name, args ?? new FolderReplayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderReplay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1alpha:FolderReplay", name, null, MakeResourceOptions(options, id))
        {
        }
