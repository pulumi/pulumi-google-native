...
namespace Pulumi.GoogleNative.PolicySimulator.V1Alpha
{
    public static class GetOrgPolicyViolationsPreview
    {
        ...
        public static Task<GetOrgPolicyViolationsPreviewResult> InvokeAsync(GetOrgPolicyViolationsPreviewArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrgPolicyViolationsPreviewResult>("google-native:policysimulator/v1alpha:getOrgPolicyViolationsPreview", args ?? new GetOrgPolicyViolationsPreviewArgs(), options.WithDefaults());
        ...
        public static Output<GetOrgPolicyViolationsPreviewResult> Invoke(GetOrgPolicyViolationsPreviewInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrgPolicyViolationsPreviewResult>("google-native:policysimulator/v1alpha:getOrgPolicyViolationsPreview", args ?? new GetOrgPolicyViolationsPreviewInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetOrgPolicyViolationsPreviewResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponse Overlay;
        /// <summary>
        /// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
        /// </summary>
        public readonly Outputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponse ResourceCounts;
        /// <summary>
        ...
        private GetOrgPolicyViolationsPreviewResult(
            ...
            Outputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponse overlay,

            Outputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponse resourceCounts,
