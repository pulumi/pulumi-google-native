...
namespace Pulumi.GoogleNative.PolicySimulator.V1Alpha
{
    public static class GetOrganizationReplay
    {
        ...
        public static Task<GetOrganizationReplayResult> InvokeAsync(GetOrganizationReplayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationReplayResult>("google-native:policysimulator/v1alpha:getOrganizationReplay", args ?? new GetOrganizationReplayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Replay. Each `Replay` is available for at least 7 days.
        /// </summary>
        public static Output<GetOrganizationReplayResult> Invoke(GetOrganizationReplayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrganizationReplayResult>("google-native:policysimulator/v1alpha:getOrganizationReplay", args ?? new GetOrganizationReplayInvokeArgs(), options.WithDefaults());
    }
