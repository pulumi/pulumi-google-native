...
namespace Pulumi.GoogleNative.PolicySimulator.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:policysimulator/v1alpha:OrgPolicyViolationsPreview")]
    public partial class OrgPolicyViolationsPreview : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("overlay")]
        public Output<Outputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponse> Overlay { get; private set; } = null!;

        /// <summary>
        /// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
        /// </summary>
        [Output("resourceCounts")]
        public Output<Outputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponse> ResourceCounts { get; private set; } = null!;
        ...
        public OrgPolicyViolationsPreview(string name, OrgPolicyViolationsPreviewArgs args, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1alpha:OrgPolicyViolationsPreview", name, args ?? new OrgPolicyViolationsPreviewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrgPolicyViolationsPreview(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1alpha:OrgPolicyViolationsPreview", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrgPolicyViolationsPreviewArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayArgs> Overlay { get; set; } = null!;
