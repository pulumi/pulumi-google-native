...
namespace Pulumi.GoogleNative.PolicySimulator.V1Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:policysimulator/v1alpha:Replay")]
    public partial class Replay : global::Pulumi.CustomResource
    {
        ...
        public Replay(string name, ReplayArgs args, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1alpha:Replay", name, args ?? new ReplayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1alpha:Replay", name, null, MakeResourceOptions(options, id))
        {
        }
