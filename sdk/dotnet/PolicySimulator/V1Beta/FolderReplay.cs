...
namespace Pulumi.GoogleNative.PolicySimulator.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:policysimulator/v1beta:FolderReplay")]
    public partial class FolderReplay : global::Pulumi.CustomResource
    {
        ...
        public FolderReplay(string name, FolderReplayArgs args, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1beta:FolderReplay", name, args ?? new FolderReplayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderReplay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1beta:FolderReplay", name, null, MakeResourceOptions(options, id))
        {
        }
