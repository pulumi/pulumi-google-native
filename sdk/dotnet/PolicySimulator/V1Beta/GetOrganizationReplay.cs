...
namespace Pulumi.GoogleNative.PolicySimulator.V1Beta
{
    public static class GetOrganizationReplay
    {
        ...
        public static Task<GetOrganizationReplayResult> InvokeAsync(GetOrganizationReplayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationReplayResult>("google-native:policysimulator/v1beta:getOrganizationReplay", args ?? new GetOrganizationReplayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Replay. Each `Replay` is available for at least 7 days.
        /// </summary>
        public static Output<GetOrganizationReplayResult> Invoke(GetOrganizationReplayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrganizationReplayResult>("google-native:policysimulator/v1beta:getOrganizationReplay", args ?? new GetOrganizationReplayInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetOrganizationReplayResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudPolicysimulatorV1betaReplayConfigResponse Config;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse ResultsSummary;
        /// <summary>
        ...
        private GetOrganizationReplayResult(
            Outputs.GoogleCloudPolicysimulatorV1betaReplayConfigResponse config,

            string name,

            Outputs.GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse resultsSummary,
