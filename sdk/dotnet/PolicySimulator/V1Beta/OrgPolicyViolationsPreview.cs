...
namespace Pulumi.GoogleNative.PolicySimulator.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:policysimulator/v1beta:OrgPolicyViolationsPreview")]
    public partial class OrgPolicyViolationsPreview : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("overlay")]
        public Output<Outputs.GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponse> Overlay { get; private set; } = null!;

        /// <summary>
        /// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
        /// </summary>
        [Output("resourceCounts")]
        public Output<Outputs.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponse> ResourceCounts { get; private set; } = null!;
        ...
        public OrgPolicyViolationsPreview(string name, OrgPolicyViolationsPreviewArgs args, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1beta:OrgPolicyViolationsPreview", name, args ?? new OrgPolicyViolationsPreviewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrgPolicyViolationsPreview(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1beta:OrgPolicyViolationsPreview", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrgPolicyViolationsPreviewArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs> Overlay { get; set; } = null!;
