...
namespace Pulumi.GoogleNative.PolicySimulator.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:policysimulator/v1beta:Replay")]
    public partial class Replay : global::Pulumi.CustomResource
    {
        ...
        public Replay(string name, ReplayArgs args, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1beta:Replay", name, args ?? new ReplayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replay(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:policysimulator/v1beta:Replay", name, null, MakeResourceOptions(options, id))
        {
        }
