...
namespace Pulumi.GoogleNative.Privateca.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:privateca/v1:CaPoolIamPolicy")]
    public partial class CaPoolIamPolicy : Pulumi.CustomResource
    {
        ...
        public CaPoolIamPolicy(string name, CaPoolIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:privateca/v1:CaPoolIamPolicy", name, args ?? new CaPoolIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CaPoolIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:privateca/v1:CaPoolIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CaPoolIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
