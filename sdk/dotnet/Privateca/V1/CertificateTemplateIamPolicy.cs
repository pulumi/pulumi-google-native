...
namespace Pulumi.GoogleNative.Privateca.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:privateca/v1:CertificateTemplateIamPolicy")]
    public partial class CertificateTemplateIamPolicy : Pulumi.CustomResource
    {
        ...
        public CertificateTemplateIamPolicy(string name, CertificateTemplateIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:privateca/v1:CertificateTemplateIamPolicy", name, args ?? new CertificateTemplateIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CertificateTemplateIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:privateca/v1:CertificateTemplateIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CertificateTemplateIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
