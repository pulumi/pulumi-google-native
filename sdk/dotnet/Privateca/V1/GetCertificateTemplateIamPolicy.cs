...
namespace Pulumi.GoogleNative.Privateca.V1
{
    public static class GetCertificateTemplateIamPolicy
    {
        ...
        public static Task<GetCertificateTemplateIamPolicyResult> InvokeAsync(GetCertificateTemplateIamPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateTemplateIamPolicyResult>("google-native:privateca/v1:getCertificateTemplateIamPolicy", args ?? new GetCertificateTemplateIamPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetCertificateTemplateIamPolicyResult> Invoke(GetCertificateTemplateIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCertificateTemplateIamPolicyResult>("google-native:privateca/v1:getCertificateTemplateIamPolicy", args ?? new GetCertificateTemplateIamPolicyInvokeArgs(), options.WithDefaults());
    }
