...
namespace Pulumi.GoogleNative.Pubsub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:pubsub/v1:SubscriptionIamBinding")]
    public partial class SubscriptionIamBinding : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionIamBinding(string name, SubscriptionIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1:SubscriptionIamBinding", name, args ?? new SubscriptionIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1:SubscriptionIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
