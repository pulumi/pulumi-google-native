...
namespace Pulumi.GoogleNative.Pubsub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:pubsub/v1:SubscriptionIamMember")]
    public partial class SubscriptionIamMember : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionIamMember(string name, SubscriptionIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1:SubscriptionIamMember", name, args ?? new SubscriptionIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1:SubscriptionIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
