...
namespace Pulumi.GoogleCloud.Pubsub.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:pubsub/v1:SubscriptionIamPolicy")]
    public partial class SubscriptionIamPolicy : Pulumi.CustomResource
    {
        ...
        public SubscriptionIamPolicy(string name, SubscriptionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:pubsub/v1:SubscriptionIamPolicy", name, args ?? new SubscriptionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:pubsub/v1:SubscriptionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
