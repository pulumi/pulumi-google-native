...
namespace Pulumi.GoogleNative.Pubsub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:pubsub/v1:TopicIamBinding")]
    public partial class TopicIamBinding : global::Pulumi.CustomResource
    {
        ...
        public TopicIamBinding(string name, TopicIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1:TopicIamBinding", name, args ?? new TopicIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1:TopicIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TopicIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TopicIamBinding(name, id, options);
        }
    }
