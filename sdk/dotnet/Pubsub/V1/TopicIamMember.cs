...
namespace Pulumi.GoogleNative.Pubsub.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:pubsub/v1:TopicIamMember")]
    public partial class TopicIamMember : global::Pulumi.CustomResource
    {
        ...
        public TopicIamMember(string name, TopicIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1:TopicIamMember", name, args ?? new TopicIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1:TopicIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
