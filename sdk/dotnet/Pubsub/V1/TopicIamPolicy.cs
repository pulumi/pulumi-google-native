...
namespace Pulumi.GcpNative.Pubsub.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:pubsub/v1:TopicIamPolicy")]
    public partial class TopicIamPolicy : Pulumi.CustomResource
    {
        ...
        public TopicIamPolicy(string name, TopicIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:pubsub/v1:TopicIamPolicy", name, args ?? new TopicIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:pubsub/v1:TopicIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
