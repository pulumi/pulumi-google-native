...
namespace Pulumi.GoogleNative.Pubsub.V1Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:pubsub/v1beta2:SubscriptionIamMember")]
    public partial class SubscriptionIamMember : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionIamMember(string name, SubscriptionIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:SubscriptionIamMember", name, args ?? new SubscriptionIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:SubscriptionIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SubscriptionIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SubscriptionIamMember(name, id, options);
        }
    }
