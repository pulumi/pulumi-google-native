...
namespace Pulumi.GcpNative.Pubsub.V1Beta2
{
    ...
    /// </summary>
    [GcpNativeResourceType("google-native:pubsub/v1beta2:SubscriptionIamPolicy")]
    public partial class SubscriptionIamPolicy : Pulumi.CustomResource
    {
        ...
        public SubscriptionIamPolicy(string name, SubscriptionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:SubscriptionIamPolicy", name, args ?? new SubscriptionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:SubscriptionIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
