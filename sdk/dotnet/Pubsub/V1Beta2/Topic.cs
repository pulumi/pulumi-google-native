...
namespace Pulumi.GcpNative.Pubsub.V1Beta2
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:pubsub/v1beta2:Topic")]
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:pubsub/v1beta2:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:pubsub/v1beta2:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
