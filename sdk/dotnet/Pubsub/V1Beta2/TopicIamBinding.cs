...
namespace Pulumi.GoogleNative.Pubsub.V1Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:pubsub/v1beta2:TopicIamBinding")]
    public partial class TopicIamBinding : global::Pulumi.CustomResource
    {
        ...
        public TopicIamBinding(string name, TopicIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:TopicIamBinding", name, args ?? new TopicIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:TopicIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
