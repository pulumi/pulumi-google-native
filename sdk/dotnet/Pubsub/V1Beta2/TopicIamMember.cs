...
namespace Pulumi.GoogleNative.Pubsub.V1Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:pubsub/v1beta2:TopicIamMember")]
    public partial class TopicIamMember : global::Pulumi.CustomResource
    {
        ...
        public TopicIamMember(string name, TopicIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:TopicIamMember", name, args ?? new TopicIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:TopicIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TopicIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TopicIamMember(name, id, options);
        }
    }
