...
namespace Pulumi.GoogleNative.Pubsub.V1Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:pubsub/v1beta2:TopicIamPolicy")]
    public partial class TopicIamPolicy : Pulumi.CustomResource
    {
        ...
        public TopicIamPolicy(string name, TopicIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:TopicIamPolicy", name, args ?? new TopicIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:pubsub/v1beta2:TopicIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
