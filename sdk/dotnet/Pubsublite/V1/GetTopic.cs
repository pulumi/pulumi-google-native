...
namespace Pulumi.GoogleNative.Pubsublite.V1
{
    public static class GetTopic
    {
        ...
        public static Task<GetTopicResult> InvokeAsync(GetTopicArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTopicResult>("google-native:pubsublite/v1:getTopic", args ?? new GetTopicArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the topic configuration.
        /// </summary>
        public static Output<GetTopicResult> Invoke(GetTopicInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTopicResult>("google-native:pubsublite/v1:getTopic", args ?? new GetTopicInvokeArgs(), options.WithDefaults());
    }
