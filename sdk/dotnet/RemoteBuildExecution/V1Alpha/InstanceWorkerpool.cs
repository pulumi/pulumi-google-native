...
namespace Pulumi.GoogleNative.RemoteBuildExecution.V1Alpha
{
    ...
    public partial class InstanceWorkerpool : Pulumi.CustomResource
    {
        ...
        public InstanceWorkerpool(string name, InstanceWorkerpoolArgs args, CustomResourceOptions? options = null)
            : base("google-native:remotebuildexecution/v1alpha:InstanceWorkerpool", name, args ?? new InstanceWorkerpoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceWorkerpool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:remotebuildexecution/v1alpha:InstanceWorkerpool", name, null, MakeResourceOptions(options, id))
        {
        }
