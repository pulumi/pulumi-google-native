...
namespace Pulumi.GcpNative.Retail.V2
{
    ...
    /// Creates a Product.
    /// </summary>
    [GcpNativeResourceType("gcp-native:retail/v2:CatalogBranchProduct")]
    public partial class CatalogBranchProduct : Pulumi.CustomResource
    {
        ...
        public CatalogBranchProduct(string name, CatalogBranchProductArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:retail/v2:CatalogBranchProduct", name, args ?? new CatalogBranchProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CatalogBranchProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:retail/v2:CatalogBranchProduct", name, null, MakeResourceOptions(options, id))
        {
        }
