...
namespace Pulumi.GoogleNative.Retail.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:retail/v2:Control")]
    public partial class Control : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rule")]
        public Output<Outputs.GoogleCloudRetailV2RuleResponse> Rule { get; private set; } = null!;
        ...
        public Control(string name, ControlArgs args, CustomResourceOptions? options = null)
            : base("google-native:retail/v2:Control", name, args ?? new ControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Control(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:retail/v2:Control", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ControlArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("rule")]
        public Input<Inputs.GoogleCloudRetailV2RuleArgs>? Rule { get; set; }

        [Input("searchSolutionUseCase")]
        private InputList<Pulumi.GoogleNative.Retail.V2.ControlSearchSolutionUseCaseItem>? _searchSolutionUseCase;

        /// <summary>
        /// Specifies the use case for the control. Affects what condition fields can be set. Only settable by search controls. Will default to SEARCH_SOLUTION_USE_CASE_SEARCH if not specified. Currently only allow one search_solution_use_case per control.
        /// </summary>
        public InputList<Pulumi.GoogleNative.Retail.V2.ControlSearchSolutionUseCaseItem> SearchSolutionUseCase
        {
            get => _searchSolutionUseCase ?? (_searchSolutionUseCase = new InputList<Pulumi.GoogleNative.Retail.V2.ControlSearchSolutionUseCaseItem>());
            set => _searchSolutionUseCase = value;
        }

        [Input("solutionTypes", required: true)]
        private InputList<Pulumi.GoogleNative.Retail.V2.ControlSolutionTypesItem>? _solutionTypes;

        /// <summary>
        /// Immutable. The solution types that the control is used for. Currently we support setting only one type of solution at creation time. Only `SOLUTION_TYPE_SEARCH` value is supported at the moment. If no solution type is provided at creation time, will default to SOLUTION_TYPE_SEARCH.
        /// </summary>
        public InputList<Pulumi.GoogleNative.Retail.V2.ControlSolutionTypesItem> SolutionTypes
        {
            get => _solutionTypes ?? (_solutionTypes = new InputList<Pulumi.GoogleNative.Retail.V2.ControlSolutionTypesItem>());
