...
namespace Pulumi.GoogleNative.Retail.V2
{
    public static class GetControl
    {
        ...
        public static Task<GetControlResult> InvokeAsync(GetControlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetControlResult>("google-native:retail/v2:getControl", args ?? new GetControlArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Control.
        /// </summary>
        public static Output<GetControlResult> Invoke(GetControlInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetControlResult>("google-native:retail/v2:getControl", args ?? new GetControlInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetControlResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudRetailV2RuleResponse Rule;
        /// <summary>
        ...
        private GetControlResult(
            ...
            Outputs.GoogleCloudRetailV2RuleResponse rule,
