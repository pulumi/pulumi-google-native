...
namespace Pulumi.GoogleNative.Retail.V2
{
    public static class GetProduct
    {
        ...
        public static Task<GetProductResult> InvokeAsync(GetProductArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductResult>("google-native:retail/v2:getProduct", args ?? new GetProductArgs(), options.WithVersion());

        /// <summary>
        /// Gets a Product.
        /// </summary>
        public static Output<GetProductResult> Invoke(GetProductInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProductResult>("google-native:retail/v2:getProduct", args ?? new GetProductInvokeArgs(), options.WithVersion());
    }
