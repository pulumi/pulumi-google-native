...
namespace Pulumi.GoogleCloud.Retail.V2
{
    /// <summary>
    /// Creates a Product.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:retail/v2:GoogleCloudRetailV2Product")]
    public partial class GoogleCloudRetailV2Product : Pulumi.CustomResource
    {
        /// <summary>
        /// Create a GoogleCloudRetailV2Product resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public GoogleCloudRetailV2Product(string name, GoogleCloudRetailV2ProductArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:retail/v2:GoogleCloudRetailV2Product", name, args ?? new GoogleCloudRetailV2ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudRetailV2Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:retail/v2:GoogleCloudRetailV2Product", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing GoogleCloudRetailV2Product resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudRetailV2Product Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudRetailV2Product(name, id, options);
        }
    }

    public sealed class GoogleCloudRetailV2ProductArgs : Pulumi.ResourceArgs
    {
        [Input("attributes")]
        ...
        public GoogleCloudRetailV2ProductArgs()
        {
        }
    }
}
