...
namespace Pulumi.GoogleNative.Retail.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:retail/v2:ServingConfig")]
    public partial class ServingConfig : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudRetailV2SearchRequestDynamicFacetSpecResponse> DynamicFacetSpec { get; private set; } = null!;
        ...
        public Output<Outputs.GoogleCloudRetailV2SearchRequestPersonalizationSpecResponse> PersonalizationSpec { get; private set; } = null!;
        ...
        public ServingConfig(string name, ServingConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:retail/v2:ServingConfig", name, args ?? new ServingConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServingConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:retail/v2:ServingConfig", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServingConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("diversityType")]
        public Input<Pulumi.GoogleNative.Retail.V2.ServingConfigDiversityType>? DiversityType { get; set; }
        ...
        public Input<Inputs.GoogleCloudRetailV2SearchRequestDynamicFacetSpecArgs>? DynamicFacetSpec { get; set; }
        ...
        public Input<Inputs.GoogleCloudRetailV2SearchRequestPersonalizationSpecArgs>? PersonalizationSpec { get; set; }
        ...
        private InputList<Pulumi.GoogleNative.Retail.V2.ServingConfigSolutionTypesItem>? _solutionTypes;

        /// <summary>
        /// Immutable. Specifies the solution types that a serving config can be associated with. Currently we support setting only one type of solution.
        /// </summary>
        public InputList<Pulumi.GoogleNative.Retail.V2.ServingConfigSolutionTypesItem> SolutionTypes
        {
            get => _solutionTypes ?? (_solutionTypes = new InputList<Pulumi.GoogleNative.Retail.V2.ServingConfigSolutionTypesItem>());
