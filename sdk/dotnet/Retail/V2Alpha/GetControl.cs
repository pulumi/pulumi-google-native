...
namespace Pulumi.GoogleNative.Retail.V2Alpha
{
    public static class GetControl
    {
        ...
        public static Task<GetControlResult> InvokeAsync(GetControlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetControlResult>("google-native:retail/v2alpha:getControl", args ?? new GetControlArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Control.
        /// </summary>
        public static Output<GetControlResult> Invoke(GetControlInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetControlResult>("google-native:retail/v2alpha:getControl", args ?? new GetControlInvokeArgs(), options.WithDefaults());
    }
