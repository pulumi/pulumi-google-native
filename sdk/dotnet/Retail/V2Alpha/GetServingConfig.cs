...
namespace Pulumi.GoogleNative.Retail.V2Alpha
{
    public static class GetServingConfig
    {
        ...
        public static Task<GetServingConfigResult> InvokeAsync(GetServingConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServingConfigResult>("google-native:retail/v2alpha:getServingConfig", args ?? new GetServingConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a ServingConfig. Returns a NotFound error if the ServingConfig does not exist.
        /// </summary>
        public static Output<GetServingConfigResult> Invoke(GetServingConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServingConfigResult>("google-native:retail/v2alpha:getServingConfig", args ?? new GetServingConfigInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetServingConfigResult
    {
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse DynamicFacetSpec;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse PersonalizationSpec;
        /// <summary>
        ...
        private GetServingConfigResult(
            ...
            Outputs.GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse dynamicFacetSpec,
            ...
            Outputs.GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse personalizationSpec,
