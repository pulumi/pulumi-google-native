...
namespace Pulumi.GoogleNative.Retail.V2Alpha
{
    public static class GetServingConfig
    {
        ...
        public static Task<GetServingConfigResult> InvokeAsync(GetServingConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServingConfigResult>("google-native:retail/v2alpha:getServingConfig", args ?? new GetServingConfigArgs(), options.WithVersion());

        /// <summary>
        /// Gets a ServingConfig. Returns a NotFound error if the ServingConfig does not exist.
        /// </summary>
        public static Output<GetServingConfigResult> Invoke(GetServingConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServingConfigResult>("google-native:retail/v2alpha:getServingConfig", args ?? new GetServingConfigInvokeArgs(), options.WithVersion());
    }
