...
namespace Pulumi.GoogleNative.Retail.V2Alpha
{
    ...
    /// Creates a new model.
    /// </summary>
    [GoogleNativeResourceType("google-native:retail/v2alpha:Model")]
    public partial class Model : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudRetailV2alphaModelModelFeaturesConfigResponse> ModelFeaturesConfig { get; private set; } = null!;
        ...
        /// </summary>
        [Output("pageOptimizationConfig")]
        public Output<Outputs.GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse> PageOptimizationConfig { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudRetailV2alphaModelServingConfigListResponse>> ServingConfigLists { get; private set; } = null!;
        ...
        public Model(string name, ModelArgs args, CustomResourceOptions? options = null)
            : base("google-native:retail/v2alpha:Model", name, args ?? new ModelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Model(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:retail/v2alpha:Model", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ModelArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Retail.V2Alpha.ModelFilteringOption>? FilteringOption { get; set; }
        ...
        public Input<Inputs.GoogleCloudRetailV2alphaModelModelFeaturesConfigArgs>? ModelFeaturesConfig { get; set; }
        ...
        /// Optional. The page optimization config.
        /// </summary>
        [Input("pageOptimizationConfig")]
        public Input<Inputs.GoogleCloudRetailV2alphaModelPageOptimizationConfigArgs>? PageOptimizationConfig { get; set; }

        /// <summary>
        /// Optional. The state of periodic tuning. The period we use is 3 months - to do a one-off tune earlier use the `TuneModel` method. Default value is `PERIODIC_TUNING_ENABLED`.
        /// </summary>
        [Input("periodicTuningState")]
        public Input<Pulumi.GoogleNative.Retail.V2Alpha.ModelPeriodicTuningState>? PeriodicTuningState { get; set; }
        ...
        /// </summary>
        [Input("trainingState")]
        public Input<Pulumi.GoogleNative.Retail.V2Alpha.ModelTrainingState>? TrainingState { get; set; }
