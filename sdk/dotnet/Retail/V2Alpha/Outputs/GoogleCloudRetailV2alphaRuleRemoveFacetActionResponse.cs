...
namespace Pulumi.GoogleNative.Retail.V2Alpha.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudRetailV2alphaRuleRemoveFacetActionResponse
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GoogleCloudRetailV2alphaRuleRemoveFacetActionResponse(ImmutableArray<string> attributeNames)
        {
