...
namespace Pulumi.GoogleNative.Retail.V2Alpha
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:retail/v2alpha:ServingConfig")]
    public partial class ServingConfig : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse> DynamicFacetSpec { get; private set; } = null!;
        ...
        public ServingConfig(string name, ServingConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:retail/v2alpha:ServingConfig", name, args ?? new ServingConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServingConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:retail/v2alpha:ServingConfig", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServingConfigArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecArgs>? DynamicFacetSpec { get; set; }
        ...
        private InputList<Pulumi.GoogleNative.Retail.V2Alpha.ServingConfigSolutionTypesItem>? _solutionTypes;

        /// <summary>
        /// Immutable. Specifies the solution types that a serving config can be associated with. Currently we support setting only one type of solution.
        /// </summary>
        public InputList<Pulumi.GoogleNative.Retail.V2Alpha.ServingConfigSolutionTypesItem> SolutionTypes
        {
            get => _solutionTypes ?? (_solutionTypes = new InputList<Pulumi.GoogleNative.Retail.V2Alpha.ServingConfigSolutionTypesItem>());
