...
namespace Pulumi.GoogleNative.Retail.V2Beta
{
    ...
    public partial class Control : Pulumi.CustomResource
    {
        ...
        public Control(string name, ControlArgs args, CustomResourceOptions? options = null)
            : base("google-native:retail/v2beta:Control", name, args ?? new ControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Control(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:retail/v2beta:Control", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ControlArgs : Pulumi.ResourceArgs
    {
        ...
        {
            get => _solutionTypes ?? (_solutionTypes = new InputList<Pulumi.GoogleNative.Retail.V2Beta.ControlSolutionTypesItem>());
