...
namespace Pulumi.GoogleNative.Retail.V2Beta
{
    ...
    /// Creates a new model.
    /// </summary>
    [GoogleNativeResourceType("google-native:retail/v2beta:Model")]
    public partial class Model : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GoogleCloudRetailV2betaModelModelFeaturesConfigResponse> ModelFeaturesConfig { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudRetailV2betaModelServingConfigListResponse>> ServingConfigLists { get; private set; } = null!;
        ...
        public Model(string name, ModelArgs args, CustomResourceOptions? options = null)
            : base("google-native:retail/v2beta:Model", name, args ?? new ModelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Model(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:retail/v2beta:Model", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ModelArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Retail.V2Beta.ModelFilteringOption>? FilteringOption { get; set; }
        ...
        public Input<Inputs.GoogleCloudRetailV2betaModelModelFeaturesConfigArgs>? ModelFeaturesConfig { get; set; }
        ...
        public Input<Pulumi.GoogleNative.Retail.V2Beta.ModelPeriodicTuningState>? PeriodicTuningState { get; set; }
        ...
        /// </summary>
        [Input("trainingState")]
        public Input<Pulumi.GoogleNative.Retail.V2Beta.ModelTrainingState>? TrainingState { get; set; }
