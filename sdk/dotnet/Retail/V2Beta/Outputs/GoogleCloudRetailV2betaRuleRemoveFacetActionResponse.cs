...
namespace Pulumi.GoogleNative.Retail.V2Beta.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GoogleCloudRetailV2betaRuleRemoveFacetActionResponse
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GoogleCloudRetailV2betaRuleRemoveFacetActionResponse(ImmutableArray<string> attributeNames)
        {
