...
namespace Pulumi.GoogleNative.Retail.V2Beta
{
    ...
    /// Creates a Product.
    /// </summary>
    [GoogleNativeResourceType("google-native:retail/v2beta:Product")]
    public partial class Product : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("audience")]
        public Output<Outputs.GoogleCloudRetailV2betaAudienceResponse> Audience { get; private set; } = null!;
        ...
        /// </summary>
        [Output("colorInfo")]
        public Output<Outputs.GoogleCloudRetailV2betaColorInfoResponse> ColorInfo { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudRetailV2betaFulfillmentInfoResponse>> FulfillmentInfo { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.GoogleCloudRetailV2betaLocalInventoryResponse>> LocalInventories { get; private set; } = null!;
        ...
        /// </summary>
        [Output("rating")]
        public Output<Outputs.GoogleCloudRetailV2betaRatingResponse> Rating { get; private set; } = null!;
        ...
        /// </summary>
        [Output("variants")]
        public Output<ImmutableArray<Outputs.GoogleCloudRetailV2betaProductResponse>> Variants { get; private set; } = null!;
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("google-native:retail/v2beta:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:retail/v2beta:Product", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProductArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("audience")]
        public Input<Inputs.GoogleCloudRetailV2betaAudienceArgs>? Audience { get; set; }
        ...
        /// </summary>
        [Input("colorInfo")]
        public Input<Inputs.GoogleCloudRetailV2betaColorInfoArgs>? ColorInfo { get; set; }
        ...
        private InputList<Inputs.GoogleCloudRetailV2betaFulfillmentInfoArgs>? _fulfillmentInfo;

        /// <summary>
        /// Fulfillment information, such as the store IDs for in-store pickup or region IDs for different shipping methods. All the elements must have distinct FulfillmentInfo.type. Otherwise, an INVALID_ARGUMENT error is returned.
        /// </summary>
        public InputList<Inputs.GoogleCloudRetailV2betaFulfillmentInfoArgs> FulfillmentInfo
        {
            get => _fulfillmentInfo ?? (_fulfillmentInfo = new InputList<Inputs.GoogleCloudRetailV2betaFulfillmentInfoArgs>());
        ...
        {
            get => _promotions ?? (_promotions = new InputList<Inputs.GoogleCloudRetailV2betaPromotionArgs>());
        ...
        /// </summary>
        [Input("rating")]
        public Input<Inputs.GoogleCloudRetailV2betaRatingArgs>? Rating { get; set; }
