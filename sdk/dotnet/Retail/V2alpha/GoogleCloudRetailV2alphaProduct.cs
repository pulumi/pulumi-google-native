...
namespace Pulumi.GoogleCloud.Retail.V2alpha
{
    /// <summary>
    /// Creates a Product.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:retail/v2alpha:GoogleCloudRetailV2alphaProduct")]
    public partial class GoogleCloudRetailV2alphaProduct : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GoogleCloudRetailV2alphaProduct(string name, GoogleCloudRetailV2alphaProductArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:retail/v2alpha:GoogleCloudRetailV2alphaProduct", name, args ?? new GoogleCloudRetailV2alphaProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudRetailV2alphaProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:retail/v2alpha:GoogleCloudRetailV2alphaProduct", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudRetailV2alphaProduct Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudRetailV2alphaProduct(name, id, options);
        }
    }

    public sealed class GoogleCloudRetailV2alphaProductArgs : Pulumi.ResourceArgs
    {
        [Input("attributes")]
        ...
        [Input("images")]
        private InputList<Inputs.GoogleCloudRetailV2alphaImageArgs>? _images;
        ...
        /// </summary>
        public InputList<Inputs.GoogleCloudRetailV2alphaImageArgs> Images
        {
            get => _images ?? (_images = new InputList<Inputs.GoogleCloudRetailV2alphaImageArgs>());
            set => _images = value;
        }
        ...
        /// </summary>
        [Input("priceInfo")]
        public Input<Inputs.GoogleCloudRetailV2alphaPriceInfoArgs>? PriceInfo { get; set; }
        ...
        public GoogleCloudRetailV2alphaProductArgs()
        {
        }
    }
}
