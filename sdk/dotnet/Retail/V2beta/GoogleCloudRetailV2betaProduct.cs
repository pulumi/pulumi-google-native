...
namespace Pulumi.GoogleCloud.Retail.V2beta
{
    ...
    /// Creates a Product.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:retail/v2beta:GoogleCloudRetailV2betaProduct")]
    public partial class GoogleCloudRetailV2betaProduct : Pulumi.CustomResource
    {
        /// <summary>
        /// Create a GoogleCloudRetailV2betaProduct resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public GoogleCloudRetailV2betaProduct(string name, GoogleCloudRetailV2betaProductArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:retail/v2beta:GoogleCloudRetailV2betaProduct", name, args ?? new GoogleCloudRetailV2betaProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GoogleCloudRetailV2betaProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:retail/v2beta:GoogleCloudRetailV2betaProduct", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GoogleCloudRetailV2betaProduct Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GoogleCloudRetailV2betaProduct(name, id, options);
        }
    }

    public sealed class GoogleCloudRetailV2betaProductArgs : Pulumi.ResourceArgs
    {
        [Input("attributes")]
        ...
        [Input("images")]
        private InputList<Inputs.GoogleCloudRetailV2betaImageArgs>? _images;
        ...
        /// </summary>
        public InputList<Inputs.GoogleCloudRetailV2betaImageArgs> Images
        {
            get => _images ?? (_images = new InputList<Inputs.GoogleCloudRetailV2betaImageArgs>());
            set => _images = value;
        }
        ...
        /// </summary>
        [Input("priceInfo")]
        public Input<Inputs.GoogleCloudRetailV2betaPriceInfoArgs>? PriceInfo { get; set; }
        ...
        public GoogleCloudRetailV2betaProductArgs()
        {
        }
    }
}
