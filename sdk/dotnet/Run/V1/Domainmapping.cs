...
namespace Pulumi.GcpNative.Run.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:run/v1:Domainmapping")]
    public partial class Domainmapping : Pulumi.CustomResource
    {
        ...
        public Domainmapping(string name, DomainmappingArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:run/v1:Domainmapping", name, args ?? new DomainmappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domainmapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:run/v1:Domainmapping", name, null, MakeResourceOptions(options, id))
        {
        }
