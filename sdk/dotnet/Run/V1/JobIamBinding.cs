...
namespace Pulumi.GoogleNative.Run.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:run/v1:JobIamBinding")]
    public partial class JobIamBinding : global::Pulumi.CustomResource
    {
        ...
        public JobIamBinding(string name, JobIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:run/v1:JobIamBinding", name, args ?? new JobIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:run/v1:JobIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
