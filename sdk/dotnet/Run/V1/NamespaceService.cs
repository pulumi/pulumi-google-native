...
namespace Pulumi.GoogleNative.Run.V1
{
    ...
    /// Create a service.
    /// </summary>
    [GoogleNativeResourceType("google-native:run/v1:NamespaceService")]
    public partial class NamespaceService : Pulumi.CustomResource
    {
        ...
        public NamespaceService(string name, NamespaceServiceArgs args, CustomResourceOptions? options = null)
            : base("google-native:run/v1:NamespaceService", name, args ?? new NamespaceServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:run/v1:NamespaceService", name, null, MakeResourceOptions(options, id))
        {
        }
