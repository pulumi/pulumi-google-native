...
namespace Pulumi.GoogleNative.Run.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:run/v1:ServiceIamBinding")]
    public partial class ServiceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ServiceIamBinding(string name, ServiceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:run/v1:ServiceIamBinding", name, args ?? new ServiceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:run/v1:ServiceIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
