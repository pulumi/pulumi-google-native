...
namespace Pulumi.GoogleNative.Run.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:run/v1:ServiceIamMember")]
    public partial class ServiceIamMember : global::Pulumi.CustomResource
    {
        ...
        public ServiceIamMember(string name, ServiceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:run/v1:ServiceIamMember", name, args ?? new ServiceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:run/v1:ServiceIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
