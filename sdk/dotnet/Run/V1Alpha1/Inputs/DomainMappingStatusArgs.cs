...
namespace Pulumi.GcpNative.Run.V1Alpha1.Inputs
{
    ...
    {
        [Input("conditions")]
        private InputList<Inputs.DomainMappingConditionArgs>? _conditions;

        /// <summary>
        /// Array of observed DomainMappingConditions, indicating the current state of the DomainMapping.
        /// </summary>
        public InputList<Inputs.DomainMappingConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.DomainMappingConditionArgs>());
