...
namespace Pulumi.GoogleCloud.Run.V1alpha1
{
    ...
    /// Create a job.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:run/v1alpha1:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:run/v1alpha1:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:run/v1alpha1:Job", name, null, MakeResourceOptions(options, id))
        {
        }
