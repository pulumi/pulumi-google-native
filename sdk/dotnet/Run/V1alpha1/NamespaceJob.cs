...
namespace Pulumi.GoogleCloud.Run.V1alpha1
{
    ...
    /// Create a job.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:run/v1alpha1:NamespaceJob")]
    public partial class NamespaceJob : Pulumi.CustomResource
    {
        ...
        public NamespaceJob(string name, NamespaceJobArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:run/v1alpha1:NamespaceJob", name, args ?? new NamespaceJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:run/v1alpha1:NamespaceJob", name, null, MakeResourceOptions(options, id))
        {
        }
