...
namespace Pulumi.GoogleCloud.Run.V1alpha1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:run/v1alpha1:Trigger")]
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:run/v1alpha1:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:run/v1alpha1:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TriggerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("spec")]
        public Input<Inputs.TriggerSpecArgs>? Spec { get; set; }

        /// <summary>
        /// Optional. Status represents the current state of the Trigger. This data may be out of date.
        /// </summary>
        [Input("status")]
        public Input<Inputs.TriggerStatusArgs>? Status { get; set; }
