...
namespace Pulumi.GoogleNative.Run.V2
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("google-native:run/v2:getJob", args ?? new GetJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a Job.
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobResult>("google-native:run/v2:getJob", args ?? new GetJobInvokeArgs(), options.WithDefaults());
    }
