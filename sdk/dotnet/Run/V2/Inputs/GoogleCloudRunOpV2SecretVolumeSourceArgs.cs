...
namespace Pulumi.GoogleNative.Run.V2.Inputs
{
    ...
    /// </summary>
    public sealed class GoogleCloudRunOpV2SecretVolumeSourceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("items")]
        private InputList<Inputs.GoogleCloudRunOpV2VersionToPathArgs>? _items;

        /// <summary>
        /// If unspecified, the volume will expose a file whose name is the secret, relative to VolumeMount.mount_path. If specified, the key will be used as the version to fetch from Cloud Secret Manager and the path will be the name of the file exposed in the volume. When items are defined, they must specify a path and a version.
        /// </summary>
        public InputList<Inputs.GoogleCloudRunOpV2VersionToPathArgs> Items
        {
            get => _items ?? (_items = new InputList<Inputs.GoogleCloudRunOpV2VersionToPathArgs>());
            set => _items = value;
        }
