...
namespace Pulumi.GoogleNative.Run.V2
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:run/v2:JobIamBinding")]
    public partial class JobIamBinding : global::Pulumi.CustomResource
    {
        ...
        public JobIamBinding(string name, JobIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:run/v2:JobIamBinding", name, args ?? new JobIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:run/v2:JobIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static JobIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new JobIamBinding(name, id, options);
        }
    }
