...
namespace Pulumi.GoogleNative.Run.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:run/v2:JobIamPolicy")]
    public partial class JobIamPolicy : Pulumi.CustomResource
    {
        ...
        public JobIamPolicy(string name, JobIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:run/v2:JobIamPolicy", name, args ?? new JobIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:run/v2:JobIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
