...
namespace Pulumi.GoogleNative.Run.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:run/v2:ServiceIamPolicy")]
    public partial class ServiceIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServiceIamPolicy(string name, ServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:run/v2:ServiceIamPolicy", name, args ?? new ServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:run/v2:ServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
