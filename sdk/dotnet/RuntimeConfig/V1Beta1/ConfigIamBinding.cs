...
namespace Pulumi.GoogleNative.RuntimeConfig.V1Beta1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:runtimeconfig/v1beta1:ConfigIamBinding")]
    public partial class ConfigIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ConfigIamBinding(string name, ConfigIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:runtimeconfig/v1beta1:ConfigIamBinding", name, args ?? new ConfigIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:runtimeconfig/v1beta1:ConfigIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConfigIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ConfigIamBinding(name, id, options);
        }
    }
