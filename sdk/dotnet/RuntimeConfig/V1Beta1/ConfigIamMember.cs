...
namespace Pulumi.GoogleNative.RuntimeConfig.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:runtimeconfig/v1beta1:ConfigIamMember")]
    public partial class ConfigIamMember : global::Pulumi.CustomResource
    {
        ...
        public ConfigIamMember(string name, ConfigIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:runtimeconfig/v1beta1:ConfigIamMember", name, args ?? new ConfigIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:runtimeconfig/v1beta1:ConfigIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConfigIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ConfigIamMember(name, id, options);
        }
    }
