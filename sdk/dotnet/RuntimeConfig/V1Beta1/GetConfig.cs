...
namespace Pulumi.GoogleNative.RuntimeConfig.V1Beta1
{
    public static class GetConfig
    {
        ...
        public static Task<GetConfigResult> InvokeAsync(GetConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConfigResult>("google-native:runtimeconfig/v1beta1:getConfig", args ?? new GetConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a RuntimeConfig resource.
        /// </summary>
        public static Output<GetConfigResult> Invoke(GetConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConfigResult>("google-native:runtimeconfig/v1beta1:getConfig", args ?? new GetConfigInvokeArgs(), options.WithDefaults());
    }
