...
namespace Pulumi.GoogleCloud.Runtimeconfig.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:runtimeconfig/v1beta1:ConfigVariable")]
    public partial class ConfigVariable : Pulumi.CustomResource
    {
        ...
        public ConfigVariable(string name, ConfigVariableArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:runtimeconfig/v1beta1:ConfigVariable", name, args ?? new ConfigVariableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigVariable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:runtimeconfig/v1beta1:ConfigVariable", name, null, MakeResourceOptions(options, id))
        {
        }
