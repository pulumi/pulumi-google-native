...
namespace Pulumi.GoogleCloud.Runtimeconfig.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:runtimeconfig/v1beta1:Variable")]
    public partial class Variable : Pulumi.CustomResource
    {
        ...
        public Variable(string name, VariableArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:runtimeconfig/v1beta1:Variable", name, args ?? new VariableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Variable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:runtimeconfig/v1beta1:Variable", name, null, MakeResourceOptions(options, id))
        {
        }
