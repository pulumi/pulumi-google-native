...
namespace Pulumi.GoogleCloud.Runtimeconfig.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:runtimeconfig/v1beta1:Waiter")]
    public partial class Waiter : Pulumi.CustomResource
    {
        ...
        public Waiter(string name, WaiterArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:runtimeconfig/v1beta1:Waiter", name, args ?? new WaiterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Waiter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:runtimeconfig/v1beta1:Waiter", name, null, MakeResourceOptions(options, id))
        {
        }
