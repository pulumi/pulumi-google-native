...
namespace Pulumi.GoogleNative.SQLAdmin.V1
{
    public static class GetUser
    {
        ...
        public static Task<GetUserResult> InvokeAsync(GetUserArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetUserResult>("google-native:sqladmin/v1:getUser", args ?? new GetUserArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a resource containing information about a user.
        /// </summary>
        public static Output<GetUserResult> Invoke(GetUserInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetUserResult>("google-native:sqladmin/v1:getUser", args ?? new GetUserInvokeArgs(), options.WithDefaults());
    }
