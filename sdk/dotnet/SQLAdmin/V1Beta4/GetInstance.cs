...
namespace Pulumi.GoogleNative.SQLAdmin.V1Beta4
{
    public static class GetInstance
    {
        ...
        public static Task<GetInstanceResult> InvokeAsync(GetInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstanceResult>("google-native:sqladmin/v1beta4:getInstance", args ?? new GetInstanceArgs(), options.WithVersion());

        /// <summary>
        /// Retrieves a resource containing information about a Cloud SQL instance.
        /// </summary>
        public static Output<GetInstanceResult> Invoke(GetInstanceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInstanceResult>("google-native:sqladmin/v1beta4:getInstance", args ?? new GetInstanceInvokeArgs(), options.WithVersion());
    }
