...
namespace Pulumi.GoogleNative.SecretManager.V1
{
    ...
    public partial class SecretIamBinding : global::Pulumi.CustomResource
    {
        ...
        public SecretIamBinding(string name, SecretIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1:SecretIamBinding", name, args ?? new SecretIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1:SecretIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
