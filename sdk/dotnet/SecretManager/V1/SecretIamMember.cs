...
namespace Pulumi.GoogleNative.SecretManager.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:secretmanager/v1:SecretIamMember")]
    public partial class SecretIamMember : global::Pulumi.CustomResource
    {
        ...
        public SecretIamMember(string name, SecretIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1:SecretIamMember", name, args ?? new SecretIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1:SecretIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
