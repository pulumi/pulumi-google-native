...
namespace Pulumi.GoogleNative.SecretManager.V1Beta1
{
    public static class GetSecret
    {
        ...
        public static Task<GetSecretResult> InvokeAsync(GetSecretArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecretResult>("google-native:secretmanager/v1beta1:getSecret", args ?? new GetSecretArgs(), options.WithDefaults());

        /// <summary>
        /// Gets metadata for a given Secret.
        /// </summary>
        public static Output<GetSecretResult> Invoke(GetSecretInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecretResult>("google-native:secretmanager/v1beta1:getSecret", args ?? new GetSecretInvokeArgs(), options.WithDefaults());
    }
