...
namespace Pulumi.GcpNative.SecretManager.V1Beta1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:secretmanager/v1beta1:Secret")]
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:secretmanager/v1beta1:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:secretmanager/v1beta1:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
