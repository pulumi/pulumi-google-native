...
namespace Pulumi.GoogleNative.SecretManager.V1Beta1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:secretmanager/v1beta1:SecretIamMember")]
    public partial class SecretIamMember : global::Pulumi.CustomResource
    {
        ...
        public SecretIamMember(string name, SecretIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1beta1:SecretIamMember", name, args ?? new SecretIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1beta1:SecretIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecretIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SecretIamMember(name, id, options);
        }
    }
