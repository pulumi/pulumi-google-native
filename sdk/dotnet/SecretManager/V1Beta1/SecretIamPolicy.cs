...
namespace Pulumi.GoogleNative.SecretManager.V1Beta1
{
    ...
    public partial class SecretIamPolicy : Pulumi.CustomResource
    {
        ...
        public SecretIamPolicy(string name, SecretIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1beta1:SecretIamPolicy", name, args ?? new SecretIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1beta1:SecretIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
