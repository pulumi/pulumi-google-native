...
namespace Pulumi.GoogleNative.SecretManager.V1Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:secretmanager/v1beta2:Secret")]
    public partial class Secret : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.CustomerManagedEncryptionResponse> CustomerManagedEncryption { get; private set; } = null!;
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1beta2:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1beta2:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
