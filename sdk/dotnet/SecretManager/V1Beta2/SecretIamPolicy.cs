...
namespace Pulumi.GoogleNative.SecretManager.V1Beta2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:secretmanager/v1beta2:SecretIamPolicy")]
    public partial class SecretIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public SecretIamPolicy(string name, SecretIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1beta2:SecretIamPolicy", name, args ?? new SecretIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:secretmanager/v1beta2:SecretIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
