...
namespace Pulumi.GoogleCloud.Secretmanager.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:secretmanager/v1:SecretIamPolicy")]
    public partial class SecretIamPolicy : Pulumi.CustomResource
    {
        ...
        public SecretIamPolicy(string name, SecretIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:secretmanager/v1:SecretIamPolicy", name, args ?? new SecretIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:secretmanager/v1:SecretIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecretIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
