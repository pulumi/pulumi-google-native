...
namespace Pulumi.GoogleCloud.Secretmanager.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:secretmanager/v1beta1:Secret")]
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:secretmanager/v1beta1:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:secretmanager/v1beta1:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
