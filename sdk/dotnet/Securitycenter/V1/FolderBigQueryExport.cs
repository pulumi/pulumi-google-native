...
namespace Pulumi.GoogleNative.Securitycenter.V1
{
    ...
    public partial class FolderBigQueryExport : Pulumi.CustomResource
    {
        ...
        public FolderBigQueryExport(string name, FolderBigQueryExportArgs args, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1:FolderBigQueryExport", name, args ?? new FolderBigQueryExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FolderBigQueryExport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1:FolderBigQueryExport", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FolderBigQueryExport Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
