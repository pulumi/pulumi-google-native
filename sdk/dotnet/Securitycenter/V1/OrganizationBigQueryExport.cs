...
namespace Pulumi.GoogleNative.Securitycenter.V1
{
    ...
    public partial class OrganizationBigQueryExport : Pulumi.CustomResource
    {
        ...
        public OrganizationBigQueryExport(string name, OrganizationBigQueryExportArgs args, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1:OrganizationBigQueryExport", name, args ?? new OrganizationBigQueryExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationBigQueryExport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1:OrganizationBigQueryExport", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationBigQueryExport Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
