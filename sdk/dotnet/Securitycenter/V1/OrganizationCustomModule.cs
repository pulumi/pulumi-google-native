...
namespace Pulumi.GoogleNative.Securitycenter.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:securitycenter/v1:OrganizationCustomModule")]
    public partial class OrganizationCustomModule : global::Pulumi.CustomResource
    {
        ...
        public OrganizationCustomModule(string name, OrganizationCustomModuleArgs args, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1:OrganizationCustomModule", name, args ?? new OrganizationCustomModuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationCustomModule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1:OrganizationCustomModule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationCustomModule Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new OrganizationCustomModule(name, id, options);
        }
    }
    ...
    public sealed class OrganizationCustomModuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Securitycenter.V1.OrganizationCustomModuleEnablementState>? EnablementState { get; set; }
