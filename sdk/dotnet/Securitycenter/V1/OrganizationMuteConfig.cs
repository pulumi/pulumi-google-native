...
namespace Pulumi.GoogleNative.Securitycenter.V1
{
    ...
    public partial class OrganizationMuteConfig : Pulumi.CustomResource
    {
        ...
        public OrganizationMuteConfig(string name, OrganizationMuteConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1:OrganizationMuteConfig", name, args ?? new OrganizationMuteConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationMuteConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1:OrganizationMuteConfig", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationMuteConfig Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
