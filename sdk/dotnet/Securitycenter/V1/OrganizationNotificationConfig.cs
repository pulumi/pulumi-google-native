...
namespace Pulumi.GoogleNative.Securitycenter.V1
{
    ...
    public partial class OrganizationNotificationConfig : global::Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class OrganizationNotificationConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Required. Unique identifier provided by the client within the parent scope. It must be between 1 and 128 characters and contain alphanumeric characters, underscores, or hyphens only.
        /// </summary>
        ...
        public static new OrganizationNotificationConfigArgs Empty => new OrganizationNotificationConfigArgs();
    }
}
