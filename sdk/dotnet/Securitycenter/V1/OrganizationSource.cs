...
namespace Pulumi.GoogleCloud.Securitycenter.V1
{
    ...
    /// Creates a source.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:securitycenter/v1:OrganizationSource")]
    public partial class OrganizationSource : Pulumi.CustomResource
    {
        ...
        public OrganizationSource(string name, OrganizationSourceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:securitycenter/v1:OrganizationSource", name, args ?? new OrganizationSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:securitycenter/v1:OrganizationSource", name, null, MakeResourceOptions(options, id))
        {
        }
