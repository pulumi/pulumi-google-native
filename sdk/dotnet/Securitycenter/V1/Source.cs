...
namespace Pulumi.GoogleCloud.Securitycenter.V1
{
    ...
    /// Creates a source.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:securitycenter/v1:Source")]
    public partial class Source : Pulumi.CustomResource
    {
        ...
        public Source(string name, SourceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:securitycenter/v1:Source", name, args ?? new SourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Source(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:securitycenter/v1:Source", name, null, MakeResourceOptions(options, id))
        {
        }
