...
namespace Pulumi.GoogleNative.Securitycenter.V1Beta1
{
    public static class GetOrganizationSourceIamPolicy
    {
        ...
        public static Task<GetOrganizationSourceIamPolicyResult> InvokeAsync(GetOrganizationSourceIamPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationSourceIamPolicyResult>("google-native:securitycenter/v1beta1:getOrganizationSourceIamPolicy", args ?? new GetOrganizationSourceIamPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetOrganizationSourceIamPolicyResult> Invoke(GetOrganizationSourceIamPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOrganizationSourceIamPolicyResult>("google-native:securitycenter/v1beta1:getOrganizationSourceIamPolicy", args ?? new GetOrganizationSourceIamPolicyInvokeArgs(), options.WithVersion());
    }
