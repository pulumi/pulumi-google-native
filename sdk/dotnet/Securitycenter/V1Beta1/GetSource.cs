...
namespace Pulumi.GoogleNative.Securitycenter.V1Beta1
{
    public static class GetSource
    {
        ...
        public static Task<GetSourceResult> InvokeAsync(GetSourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSourceResult>("google-native:securitycenter/v1beta1:getSource", args ?? new GetSourceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a source.
        /// </summary>
        public static Output<GetSourceResult> Invoke(GetSourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSourceResult>("google-native:securitycenter/v1beta1:getSource", args ?? new GetSourceInvokeArgs(), options.WithDefaults());
    }
