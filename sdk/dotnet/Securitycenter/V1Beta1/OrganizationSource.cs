...
namespace Pulumi.GoogleNative.Securitycenter.V1Beta1
{
    ...
    /// Creates a source.
    /// </summary>
    [GoogleNativeResourceType("google-native:securitycenter/v1beta1:OrganizationSource")]
    public partial class OrganizationSource : Pulumi.CustomResource
    {
        ...
        public OrganizationSource(string name, OrganizationSourceArgs args, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1beta1:OrganizationSource", name, args ?? new OrganizationSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1beta1:OrganizationSource", name, null, MakeResourceOptions(options, id))
        {
        }
