...
namespace Pulumi.GoogleNative.Securitycenter.V1Beta1
{
    ...
    public partial class Source : global::Pulumi.CustomResource
    {
        ...
        public Source(string name, SourceArgs args, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1beta1:Source", name, args ?? new SourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Source(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:securitycenter/v1beta1:Source", name, null, MakeResourceOptions(options, id))
        {
        }
