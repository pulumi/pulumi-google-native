...
namespace Pulumi.GoogleNative.ServiceDirectory.V1
{
    public static class GetEndpoint
    {
        ...
        public static Task<GetEndpointResult> InvokeAsync(GetEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEndpointResult>("google-native:servicedirectory/v1:getEndpoint", args ?? new GetEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an endpoint.
        /// </summary>
        public static Output<GetEndpointResult> Invoke(GetEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEndpointResult>("google-native:servicedirectory/v1:getEndpoint", args ?? new GetEndpointInvokeArgs(), options.WithDefaults());
    }
