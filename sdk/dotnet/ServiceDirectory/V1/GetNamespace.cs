...
namespace Pulumi.GoogleNative.ServiceDirectory.V1
{
    public static class GetNamespace
    {
        ...
        public static Task<GetNamespaceResult> InvokeAsync(GetNamespaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNamespaceResult>("google-native:servicedirectory/v1:getNamespace", args ?? new GetNamespaceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a namespace.
        /// </summary>
        public static Output<GetNamespaceResult> Invoke(GetNamespaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNamespaceResult>("google-native:servicedirectory/v1:getNamespace", args ?? new GetNamespaceInvokeArgs(), options.WithDefaults());
    }
