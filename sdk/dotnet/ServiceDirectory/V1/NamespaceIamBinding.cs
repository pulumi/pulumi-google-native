...
namespace Pulumi.GoogleNative.ServiceDirectory.V1
{
    ...
    /// TODO
    /// </summary>
    [GoogleNativeResourceType("google-native:servicedirectory/v1:NamespaceIamBinding")]
    public partial class NamespaceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public NamespaceIamBinding(string name, NamespaceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:servicedirectory/v1:NamespaceIamBinding", name, args ?? new NamespaceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:servicedirectory/v1:NamespaceIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
