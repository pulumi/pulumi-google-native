...
namespace Pulumi.GoogleNative.ServiceDirectory.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:servicedirectory/v1:NamespaceIamPolicy")]
    public partial class NamespaceIamPolicy : Pulumi.CustomResource
    {
        ...
        public NamespaceIamPolicy(string name, NamespaceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:servicedirectory/v1:NamespaceIamPolicy", name, args ?? new NamespaceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:servicedirectory/v1:NamespaceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
