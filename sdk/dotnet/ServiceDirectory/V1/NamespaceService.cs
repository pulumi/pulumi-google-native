...
namespace Pulumi.GcpNative.ServiceDirectory.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:servicedirectory/v1:NamespaceService")]
    public partial class NamespaceService : Pulumi.CustomResource
    {
        ...
        public NamespaceService(string name, NamespaceServiceArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:servicedirectory/v1:NamespaceService", name, args ?? new NamespaceServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:servicedirectory/v1:NamespaceService", name, null, MakeResourceOptions(options, id))
        {
        }
