...
namespace Pulumi.GoogleNative.ServiceDirectory.V1Beta1
{
    public static class GetNamespace
    {
        ...
        public static Task<GetNamespaceResult> InvokeAsync(GetNamespaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNamespaceResult>("google-native:servicedirectory/v1beta1:getNamespace", args ?? new GetNamespaceArgs(), options.WithVersion());

        /// <summary>
        /// Gets a namespace.
        /// </summary>
        public static Output<GetNamespaceResult> Invoke(GetNamespaceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNamespaceResult>("google-native:servicedirectory/v1beta1:getNamespace", args ?? new GetNamespaceInvokeArgs(), options.WithVersion());
    }
