...
{
    public static class GetRegistrationPolicyIamPolicy
    {
        /// <summary>
    ...
    public sealed class GetRegistrationPolicyIamPolicyArgs : global::Pulumi.InvokeArgs
    {
        ...
        public string RegistrationPolicyId { get; set; } = null!;

        public GetRegistrationPolicyIamPolicyArgs()
        {
        }
        public static new GetRegistrationPolicyIamPolicyArgs Empty => new GetRegistrationPolicyIamPolicyArgs();
    }

    public sealed class GetRegistrationPolicyIamPolicyInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("location", required: true)]
        ...
        public GetRegistrationPolicyIamPolicyInvokeArgs()
        {
        }
        public static new GetRegistrationPolicyIamPolicyInvokeArgs Empty => new GetRegistrationPolicyIamPolicyInvokeArgs();
    }


    [OutputType]
    public sealed class GetRegistrationPolicyIamPolicyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetRegistrationPolicyIamPolicyResult(
