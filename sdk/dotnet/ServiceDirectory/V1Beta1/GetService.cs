...
namespace Pulumi.GoogleNative.ServiceDirectory.V1Beta1
{
    public static class GetService
    {
        ...
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceResult>("google-native:servicedirectory/v1beta1:getService", args ?? new GetServiceInvokeArgs(), options.WithVersion());
    }
