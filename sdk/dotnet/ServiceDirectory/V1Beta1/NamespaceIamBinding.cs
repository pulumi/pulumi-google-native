...
namespace Pulumi.GoogleNative.ServiceDirectory.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:servicedirectory/v1beta1:NamespaceIamBinding")]
    public partial class NamespaceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public NamespaceIamBinding(string name, NamespaceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:servicedirectory/v1beta1:NamespaceIamBinding", name, args ?? new NamespaceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:servicedirectory/v1beta1:NamespaceIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NamespaceIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NamespaceIamBinding(name, id, options);
        }
    }
