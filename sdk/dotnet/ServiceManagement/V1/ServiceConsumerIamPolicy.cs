...
namespace Pulumi.GoogleNative.ServiceManagement.V1
{
    ...
    public partial class ServiceConsumerIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a ServiceConsumerIamPolicy resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        ...
        public ServiceConsumerIamPolicy(string name, ServiceConsumerIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-native:servicemanagement/v1:ServiceConsumerIamPolicy", name, args ?? new ServiceConsumerIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceConsumerIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:servicemanagement/v1:ServiceConsumerIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing ServiceConsumerIamPolicy resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceConsumerIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ServiceConsumerIamPolicy(name, id, options);
        }
    }

    public sealed class ServiceConsumerIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        ...
        public static new ServiceConsumerIamPolicyArgs Empty => new ServiceConsumerIamPolicyArgs();
    }
}
