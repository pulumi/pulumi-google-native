...
namespace Pulumi.GcpNative.ServiceManagement.V1
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:servicemanagement/v1:ServiceIamPolicy")]
    public partial class ServiceIamPolicy : Pulumi.CustomResource
    {
        ...
        public ServiceIamPolicy(string name, ServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:servicemanagement/v1:ServiceIamPolicy", name, args ?? new ServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:servicemanagement/v1:ServiceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
