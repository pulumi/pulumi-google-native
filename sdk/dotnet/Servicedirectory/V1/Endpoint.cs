...
namespace Pulumi.GoogleCloud.Servicedirectory.V1
{
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
