...
namespace Pulumi.GoogleCloud.Servicedirectory.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:servicedirectory/v1:NamespaceService")]
    public partial class NamespaceService : Pulumi.CustomResource
    {
        ...
        public NamespaceService(string name, NamespaceServiceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1:NamespaceService", name, args ?? new NamespaceServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1:NamespaceService", name, null, MakeResourceOptions(options, id))
        {
        }
