...
namespace Pulumi.GoogleCloud.Servicedirectory.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:servicedirectory/v1beta1:NamespaceIamPolicy")]
    public partial class NamespaceIamPolicy : Pulumi.CustomResource
    {
        ...
        public NamespaceIamPolicy(string name, NamespaceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1beta1:NamespaceIamPolicy", name, args ?? new NamespaceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1beta1:NamespaceIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NamespaceIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
