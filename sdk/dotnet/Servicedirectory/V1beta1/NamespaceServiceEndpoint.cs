...
namespace Pulumi.GoogleCloud.Servicedirectory.V1beta1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:servicedirectory/v1beta1:NamespaceServiceEndpoint")]
    public partial class NamespaceServiceEndpoint : Pulumi.CustomResource
    {
        ...
        public NamespaceServiceEndpoint(string name, NamespaceServiceEndpointArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1beta1:NamespaceServiceEndpoint", name, args ?? new NamespaceServiceEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceServiceEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1beta1:NamespaceServiceEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
