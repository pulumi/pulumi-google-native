...
namespace Pulumi.GoogleCloud.Servicedirectory.V1beta1
{
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1beta1:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:servicedirectory/v1beta1:Service", name, null, MakeResourceOptions(options, id))
        {
        }
