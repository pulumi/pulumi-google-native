...
namespace Pulumi.GoogleCloud.Servicemanagement.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:servicemanagement/v1:Service")]
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:servicemanagement/v1:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:servicemanagement/v1:Service", name, null, MakeResourceOptions(options, id))
        {
        }
