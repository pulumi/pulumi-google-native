...
namespace Pulumi.GoogleCloud.Servicenetworking.V1beta
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:servicenetworking/v1beta:Connection")]
    public partial class Connection : Pulumi.CustomResource
    {
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:servicenetworking/v1beta:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:servicenetworking/v1beta:Connection", name, null, MakeResourceOptions(options, id))
        {
        }
