...
namespace Pulumi.GoogleCloud.Spanner.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:spanner/v1:InstanceBackup")]
    public partial class InstanceBackup : Pulumi.CustomResource
    {
        ...
        public InstanceBackup(string name, InstanceBackupArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:spanner/v1:InstanceBackup", name, args ?? new InstanceBackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceBackup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:spanner/v1:InstanceBackup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InstanceBackup Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new InstanceBackup(name, id, options);
        }
    }
