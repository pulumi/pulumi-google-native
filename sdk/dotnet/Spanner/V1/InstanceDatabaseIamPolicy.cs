...
namespace Pulumi.GoogleCloud.Spanner.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:spanner/v1:InstanceDatabaseIamPolicy")]
    public partial class InstanceDatabaseIamPolicy : Pulumi.CustomResource
    {
        ...
        public InstanceDatabaseIamPolicy(string name, InstanceDatabaseIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:spanner/v1:InstanceDatabaseIamPolicy", name, args ?? new InstanceDatabaseIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceDatabaseIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:spanner/v1:InstanceDatabaseIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InstanceDatabaseIamPolicy Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new InstanceDatabaseIamPolicy(name, id, options);
        }
    }

    public sealed class InstanceDatabaseIamPolicyArgs : Pulumi.ResourceArgs
    {
        [Input("bindings")]
