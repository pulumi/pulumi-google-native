...
namespace Pulumi.GoogleCloud.Sqladmin.V1beta4
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:sqladmin/v1beta4:Database")]
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:sqladmin/v1beta4:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:sqladmin/v1beta4:Database", name, null, MakeResourceOptions(options, id))
        {
        }
