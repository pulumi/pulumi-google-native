...
namespace Pulumi.GoogleCloud.Sqladmin.V1beta4
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:sqladmin/v1beta4:DatabaseInstance")]
    public partial class DatabaseInstance : Pulumi.CustomResource
    {
        ...
        public DatabaseInstance(string name, DatabaseInstanceArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:sqladmin/v1beta4:DatabaseInstance", name, args ?? new DatabaseInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:sqladmin/v1beta4:DatabaseInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseInstance Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DatabaseInstance(name, id, options);
        }
    }
