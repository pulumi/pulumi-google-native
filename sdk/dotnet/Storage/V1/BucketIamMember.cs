...
namespace Pulumi.GoogleNative.Storage.V1
{
    ...
    public partial class BucketIamMember : global::Pulumi.CustomResource
    {
        ...
        public BucketIamMember(string name, BucketIamMemberArgs args, CustomResourceOptions? options = null)
            : base("google-native:storage/v1:BucketIamMember", name, args ?? new BucketIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BucketIamMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:storage/v1:BucketIamMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BucketIamMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new BucketIamMember(name, id, options);
        }
    }
