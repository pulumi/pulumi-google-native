...
namespace Pulumi.GoogleNative.Storage.V1
{
    public static class GetObjectAccessControl
    {
        ...
        public static Task<GetObjectAccessControlResult> InvokeAsync(GetObjectAccessControlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetObjectAccessControlResult>("google-native:storage/v1:getObjectAccessControl", args ?? new GetObjectAccessControlArgs(), options.WithDefaults());
        ...
        public static Output<GetObjectAccessControlResult> Invoke(GetObjectAccessControlInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetObjectAccessControlResult>("google-native:storage/v1:getObjectAccessControl", args ?? new GetObjectAccessControlInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetObjectAccessControlArgs : global::Pulumi.InvokeArgs
    {
        ...
        public static new GetObjectAccessControlArgs Empty => new GetObjectAccessControlArgs();
    }

    public sealed class GetObjectAccessControlInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("bucket", required: true)]
        ...
        public static new GetObjectAccessControlInvokeArgs Empty => new GetObjectAccessControlInvokeArgs();
    }
