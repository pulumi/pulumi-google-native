...
namespace Pulumi.GoogleNative.Storage.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:storage/v1:ManagedFolderIamBinding")]
    public partial class ManagedFolderIamBinding : global::Pulumi.CustomResource
    {
        ...
        public ManagedFolderIamBinding(string name, ManagedFolderIamBindingArgs args, CustomResourceOptions? options = null)
            : base("google-native:storage/v1:ManagedFolderIamBinding", name, args ?? new ManagedFolderIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedFolderIamBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:storage/v1:ManagedFolderIamBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ManagedFolderIamBinding Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ManagedFolderIamBinding(name, id, options);
        }
    }
