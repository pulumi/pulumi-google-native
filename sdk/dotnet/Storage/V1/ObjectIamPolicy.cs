...
namespace Pulumi.GoogleCloud.Storage.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:storage/v1:ObjectIamPolicy")]
    public partial class ObjectIamPolicy : Pulumi.CustomResource
    {
        ...
        public ObjectIamPolicy(string name, ObjectIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:storage/v1:ObjectIamPolicy", name, args ?? new ObjectIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ObjectIamPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:storage/v1:ObjectIamPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
