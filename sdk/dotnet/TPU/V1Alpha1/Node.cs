...
namespace Pulumi.GoogleNative.TPU.V1Alpha1
{
    ...
    public partial class Node : Pulumi.CustomResource
    {
        ...
        public Node(string name, NodeArgs args, CustomResourceOptions? options = null)
            : base("google-native:tpu/v1alpha1:Node", name, args ?? new NodeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Node(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:tpu/v1alpha1:Node", name, null, MakeResourceOptions(options, id))
        {
        }
