...
namespace Pulumi.GoogleNative.TPU.V2
{
    public static class GetQueuedResource
    {
        ...
        public static Task<GetQueuedResourceResult> InvokeAsync(GetQueuedResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetQueuedResourceResult>("google-native:tpu/v2:getQueuedResource", args ?? new GetQueuedResourceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a queued resource.
        /// </summary>
        public static Output<GetQueuedResourceResult> Invoke(GetQueuedResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetQueuedResourceResult>("google-native:tpu/v2:getQueuedResource", args ?? new GetQueuedResourceInvokeArgs(), options.WithDefaults());
    }
