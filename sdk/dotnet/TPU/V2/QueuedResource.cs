...
namespace Pulumi.GoogleNative.TPU.V2
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:tpu/v2:QueuedResource")]
    public partial class QueuedResource : global::Pulumi.CustomResource
    {
        ...
        public QueuedResource(string name, QueuedResourceArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:tpu/v2:QueuedResource", name, args ?? new QueuedResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueuedResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:tpu/v2:QueuedResource", name, null, MakeResourceOptions(options, id))
        {
        }
