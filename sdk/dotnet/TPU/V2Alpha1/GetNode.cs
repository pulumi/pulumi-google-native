...
namespace Pulumi.GoogleNative.TPU.V2Alpha1
{
    public static class GetNode
    {
        ...
        public static Task<GetNodeResult> InvokeAsync(GetNodeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNodeResult>("google-native:tpu/v2alpha1:getNode", args ?? new GetNodeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a node.
        /// </summary>
        public static Output<GetNodeResult> Invoke(GetNodeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNodeResult>("google-native:tpu/v2alpha1:getNode", args ?? new GetNodeInvokeArgs(), options.WithDefaults());
    }
