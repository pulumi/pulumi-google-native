...
namespace Pulumi.GoogleNative.ToolResults.V1Beta3
{
    public static class GetPerfSampleSeries
    {
        ...
        public static Output<GetPerfSampleSeriesResult> Invoke(GetPerfSampleSeriesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPerfSampleSeriesResult>("google-native:toolresults/v1beta3:getPerfSampleSeries", args ?? new GetPerfSampleSeriesInvokeArgs(), options.WithVersion());
    }
