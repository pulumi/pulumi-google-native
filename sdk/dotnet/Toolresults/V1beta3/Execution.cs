...
namespace Pulumi.GoogleCloud.Toolresults.V1beta3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:toolresults/v1beta3:Execution")]
    public partial class Execution : Pulumi.CustomResource
    {
        ...
        public Execution(string name, ExecutionArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:toolresults/v1beta3:Execution", name, args ?? new ExecutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Execution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:toolresults/v1beta3:Execution", name, null, MakeResourceOptions(options, id))
        {
        }
