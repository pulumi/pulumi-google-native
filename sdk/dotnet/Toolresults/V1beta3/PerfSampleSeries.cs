...
namespace Pulumi.GoogleCloud.Toolresults.V1beta3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:toolresults/v1beta3:PerfSampleSeries")]
    public partial class PerfSampleSeries : Pulumi.CustomResource
    {
        ...
        public PerfSampleSeries(string name, PerfSampleSeriesArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:toolresults/v1beta3:PerfSampleSeries", name, args ?? new PerfSampleSeriesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PerfSampleSeries(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:toolresults/v1beta3:PerfSampleSeries", name, null, MakeResourceOptions(options, id))
        {
        }
