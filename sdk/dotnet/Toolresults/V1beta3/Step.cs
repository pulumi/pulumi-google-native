...
namespace Pulumi.GoogleCloud.Toolresults.V1beta3
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:toolresults/v1beta3:Step")]
    public partial class Step : Pulumi.CustomResource
    {
        ...
        public Step(string name, StepArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:toolresults/v1beta3:Step", name, args ?? new StepArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Step(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:toolresults/v1beta3:Step", name, null, MakeResourceOptions(options, id))
        {
        }
