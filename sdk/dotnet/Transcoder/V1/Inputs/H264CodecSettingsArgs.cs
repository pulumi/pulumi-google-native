...
namespace Pulumi.GoogleNative.Transcoder.V1.Inputs
{
    ...
    public sealed class H264CodecSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.GoogleNative.Transcoder.V1.H264CodecSettingsFrameRateConversionStrategy>? FrameRateConversionStrategy { get; set; }
        ...
        /// </summary>
        [Input("hlg")]
        public Input<Inputs.H264ColorFormatHLGArgs>? Hlg { get; set; }
        ...
        /// </summary>
        [Input("sdr")]
        public Input<Inputs.H264ColorFormatSDRArgs>? Sdr { get; set; }
