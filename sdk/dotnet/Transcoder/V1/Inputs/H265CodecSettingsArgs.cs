...
namespace Pulumi.GoogleNative.Transcoder.V1.Inputs
{
    ...
    /// H265 codec settings.
    /// </summary>
    public sealed class H265CodecSettingsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.GoogleNative.Transcoder.V1.H265CodecSettingsFrameRateConversionStrategy>? FrameRateConversionStrategy { get; set; }
        ...
        /// </summary>
        [Input("hdr10")]
        public Input<Inputs.H265ColorFormatHDR10Args>? Hdr10 { get; set; }
        ...
        /// </summary>
        [Input("hlg")]
        public Input<Inputs.H265ColorFormatHLGArgs>? Hlg { get; set; }
        ...
        /// </summary>
        [Input("sdr")]
        public Input<Inputs.H265ColorFormatSDRArgs>? Sdr { get; set; }
        ...
        public static new H265CodecSettingsArgs Empty => new H265CodecSettingsArgs();
    }
}
