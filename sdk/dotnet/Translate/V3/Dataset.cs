...
namespace Pulumi.GoogleNative.Translate.V3
{
    ...
    /// Creates a Dataset.
    /// </summary>
    [GoogleNativeResourceType("google-native:translate/v3:Dataset")]
    public partial class Dataset : global::Pulumi.CustomResource
    {
        ...
        public Dataset(string name, DatasetArgs? args = null, CustomResourceOptions? options = null)
            : base("google-native:translate/v3:Dataset", name, args ?? new DatasetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dataset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:translate/v3:Dataset", name, null, MakeResourceOptions(options, id))
        {
        }
