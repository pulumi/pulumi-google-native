...
namespace Pulumi.GoogleCloud.Translate.V3
{
    /// <summary>
    /// Creates a glossary and returns the long-running operation. Returns NOT_FOUND, if the project doesn't exist.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:translate/v3:Glossary")]
    public partial class Glossary : Pulumi.CustomResource
    {
        ...
        public Glossary(string name, GlossaryArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:translate/v3:Glossary", name, args ?? new GlossaryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Glossary(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:translate/v3:Glossary", name, null, MakeResourceOptions(options, id))
        {
        }
