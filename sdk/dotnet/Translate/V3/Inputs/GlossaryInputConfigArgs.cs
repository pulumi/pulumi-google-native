...
namespace Pulumi.GoogleNative.Translate.V3.Inputs
{
    ...
    /// </summary>
    public sealed class GlossaryInputConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("gcsSource", required: true)]
        public Input<Inputs.GcsSourceArgs> GcsSource { get; set; } = null!;

        public GlossaryInputConfigArgs()
        {
        }
        public static new GlossaryInputConfigArgs Empty => new GlossaryInputConfigArgs();
    }
}
