...
namespace Pulumi.GoogleNative.VMMigration.V1
{
    ...
    public partial class CutoverJob : Pulumi.CustomResource
    {
        ...
        public CutoverJob(string name, CutoverJobArgs args, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:CutoverJob", name, args ?? new CutoverJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CutoverJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:CutoverJob", name, null, MakeResourceOptions(options, id))
        {
        }
