...
namespace Pulumi.GoogleNative.VMMigration.V1
{
    public static class GetCloneJob
    {
        ...
        public static Task<GetCloneJobResult> InvokeAsync(GetCloneJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloneJobResult>("google-native:vmmigration/v1:getCloneJob", args ?? new GetCloneJobArgs(), options.WithVersion());

        /// <summary>
        /// Gets details of a single CloneJob.
        /// </summary>
        public static Output<GetCloneJobResult> Invoke(GetCloneJobInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCloneJobResult>("google-native:vmmigration/v1:getCloneJob", args ?? new GetCloneJobInvokeArgs(), options.WithVersion());
    }
