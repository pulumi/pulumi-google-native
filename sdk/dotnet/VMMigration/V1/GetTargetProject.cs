...
namespace Pulumi.GoogleNative.VMMigration.V1
{
    public static class GetTargetProject
    {
        ...
        public static Task<GetTargetProjectResult> InvokeAsync(GetTargetProjectArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTargetProjectResult>("google-native:vmmigration/v1:getTargetProject", args ?? new GetTargetProjectArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single TargetProject. NOTE: TargetProject is a global resource; hence the only supported value for location is `global`.
        /// </summary>
        public static Output<GetTargetProjectResult> Invoke(GetTargetProjectInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTargetProjectResult>("google-native:vmmigration/v1:getTargetProject", args ?? new GetTargetProjectInvokeArgs(), options.WithDefaults());
    }
