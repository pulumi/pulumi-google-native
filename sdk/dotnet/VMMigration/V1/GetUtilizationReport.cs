...
namespace Pulumi.GoogleNative.VMMigration.V1
{
    public static class GetUtilizationReport
    {
        ...
        public static Task<GetUtilizationReportResult> InvokeAsync(GetUtilizationReportArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetUtilizationReportResult>("google-native:vmmigration/v1:getUtilizationReport", args ?? new GetUtilizationReportArgs(), options.WithVersion());

        /// <summary>
        /// Gets a single Utilization Report.
        /// </summary>
        public static Output<GetUtilizationReportResult> Invoke(GetUtilizationReportInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetUtilizationReportResult>("google-native:vmmigration/v1:getUtilizationReport", args ?? new GetUtilizationReportInvokeArgs(), options.WithVersion());
    }
