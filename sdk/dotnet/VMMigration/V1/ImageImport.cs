...
namespace Pulumi.GoogleNative.VMMigration.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:vmmigration/v1:ImageImport")]
    public partial class ImageImport : global::Pulumi.CustomResource
    {
        ...
        public ImageImport(string name, ImageImportArgs args, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:ImageImport", name, args ?? new ImageImportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImageImport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:ImageImport", name, null, MakeResourceOptions(options, id))
        {
        }
