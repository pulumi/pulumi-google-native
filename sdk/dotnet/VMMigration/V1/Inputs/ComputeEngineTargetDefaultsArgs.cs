...
namespace Pulumi.GoogleNative.VMMigration.V1.Inputs
{
    ...
    public sealed class ComputeEngineTargetDefaultsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("diskType")]
        public Input<Pulumi.GoogleNative.VMMigration.V1.ComputeEngineTargetDefaultsDiskType>? DiskType { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public Input<Pulumi.GoogleNative.VMMigration.V1.ComputeEngineTargetDefaultsLicenseType>? LicenseType { get; set; }
