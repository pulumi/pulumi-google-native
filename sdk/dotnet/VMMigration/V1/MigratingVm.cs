...
namespace Pulumi.GoogleNative.VMMigration.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:vmmigration/v1:MigratingVm")]
    public partial class MigratingVm : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("lastReplicationCycle")]
        public Output<Outputs.ReplicationCycleResponse> LastReplicationCycle { get; private set; } = null!;
        ...
        public MigratingVm(string name, MigratingVmArgs args, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:MigratingVm", name, args ?? new MigratingVmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MigratingVm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:MigratingVm", name, null, MakeResourceOptions(options, id))
        {
        }
