...
namespace Pulumi.GoogleNative.VMMigration.V1
{
    ...
    public partial class Source : Pulumi.CustomResource
    {
        ...
        public Source(string name, SourceArgs args, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:Source", name, args ?? new SourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Source(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:Source", name, null, MakeResourceOptions(options, id))
        {
        }
