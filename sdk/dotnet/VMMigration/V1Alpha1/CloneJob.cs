...
namespace Pulumi.GoogleNative.VMMigration.V1Alpha1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:vmmigration/v1alpha1:CloneJob")]
    public partial class CloneJob : global::Pulumi.CustomResource
    {
        ...
        public CloneJob(string name, CloneJobArgs args, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1alpha1:CloneJob", name, args ?? new CloneJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloneJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1alpha1:CloneJob", name, null, MakeResourceOptions(options, id))
        {
        }
