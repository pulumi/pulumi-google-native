...
namespace Pulumi.GoogleNative.VMMigration.V1Alpha1
{
    public static class GetCutoverJob
    {
        ...
        public static Task<GetCutoverJobResult> InvokeAsync(GetCutoverJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCutoverJobResult>("google-native:vmmigration/v1alpha1:getCutoverJob", args ?? new GetCutoverJobArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single CutoverJob.
        /// </summary>
        public static Output<GetCutoverJobResult> Invoke(GetCutoverJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCutoverJobResult>("google-native:vmmigration/v1alpha1:getCutoverJob", args ?? new GetCutoverJobInvokeArgs(), options.WithDefaults());
    }
