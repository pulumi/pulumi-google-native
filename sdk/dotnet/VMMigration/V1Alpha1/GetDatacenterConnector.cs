...
namespace Pulumi.GoogleNative.VMMigration.V1Alpha1
{
    public static class GetDatacenterConnector
    {
        ...
        public static Task<GetDatacenterConnectorResult> InvokeAsync(GetDatacenterConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatacenterConnectorResult>("google-native:vmmigration/v1alpha1:getDatacenterConnector", args ?? new GetDatacenterConnectorArgs(), options.WithVersion());
        ...
        public static Output<GetDatacenterConnectorResult> Invoke(GetDatacenterConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatacenterConnectorResult>("google-native:vmmigration/v1alpha1:getDatacenterConnector", args ?? new GetDatacenterConnectorInvokeArgs(), options.WithVersion());
    }
