...
namespace Pulumi.GoogleNative.VMMigration.V1Alpha1
{
    public static class GetImageImport
    {
        ...
        public static Task<GetImageImportResult> InvokeAsync(GetImageImportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetImageImportResult>("google-native:vmmigration/v1alpha1:getImageImport", args ?? new GetImageImportArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of a single ImageImport.
        /// </summary>
        public static Output<GetImageImportResult> Invoke(GetImageImportInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetImageImportResult>("google-native:vmmigration/v1alpha1:getImageImport", args ?? new GetImageImportInvokeArgs(), options.WithDefaults());
    }
