...
namespace Pulumi.GoogleNative.VMMigration.V1Alpha1
{
    public static class GetMigratingVm
    {
        ...
        public static Task<GetMigratingVmResult> InvokeAsync(GetMigratingVmArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMigratingVmResult>("google-native:vmmigration/v1alpha1:getMigratingVm", args ?? new GetMigratingVmArgs(), options.WithVersion());

        /// <summary>
        /// Gets details of a single MigratingVm.
        /// </summary>
        public static Output<GetMigratingVmResult> Invoke(GetMigratingVmInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMigratingVmResult>("google-native:vmmigration/v1alpha1:getMigratingVm", args ?? new GetMigratingVmInvokeArgs(), options.WithVersion());
    }
