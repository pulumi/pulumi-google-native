...
namespace Pulumi.GoogleNative.VMMigration.V1Alpha1
{
    ...
    public partial class Group : Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1alpha1:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1alpha1:Group", name, null, MakeResourceOptions(options, id))
        {
        }
