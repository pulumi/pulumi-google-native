...
namespace Pulumi.GoogleNative.VPCAccess.V1
{
    public static class GetConnector
    {
        ...
        public static Task<GetConnectorResult> InvokeAsync(GetConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectorResult>("google-native:vpcaccess/v1:getConnector", args ?? new GetConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Serverless VPC Access connector. Returns NOT_FOUND if the resource does not exist.
        /// </summary>
        public static Output<GetConnectorResult> Invoke(GetConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectorResult>("google-native:vpcaccess/v1:getConnector", args ?? new GetConnectorInvokeArgs(), options.WithDefaults());
    }
