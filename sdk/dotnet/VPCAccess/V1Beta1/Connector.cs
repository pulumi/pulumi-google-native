...
namespace Pulumi.GoogleNative.VPCAccess.V1Beta1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:vpcaccess/v1beta1:Connector")]
    public partial class Connector : global::Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("google-native:vpcaccess/v1beta1:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vpcaccess/v1beta1:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
