...
namespace Pulumi.GoogleNative.Vmmigration.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:vmmigration/v1:UtilizationReport")]
    public partial class UtilizationReport : global::Pulumi.CustomResource
    {
        ...
        public UtilizationReport(string name, UtilizationReportArgs args, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:UtilizationReport", name, args ?? new UtilizationReportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UtilizationReport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vmmigration/v1:UtilizationReport", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UtilizationReportArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("timeFrame")]
        public Input<Pulumi.GoogleNative.Vmmigration.V1.UtilizationReportTimeFrame>? TimeFrame { get; set; }
