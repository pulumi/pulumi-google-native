...
namespace Pulumi.GoogleNative.WebSecurityScanner.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:websecurityscanner/v1:ScanConfig")]
    public partial class ScanConfig : Pulumi.CustomResource
    {
        ...
        public ScanConfig(string name, ScanConfigArgs args, CustomResourceOptions? options = null)
            : base("google-native:websecurityscanner/v1:ScanConfig", name, args ?? new ScanConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScanConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:websecurityscanner/v1:ScanConfig", name, null, MakeResourceOptions(options, id))
        {
        }
