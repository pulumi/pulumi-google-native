...
namespace Pulumi.GoogleNative.WebSecurityScanner.V1Alpha
{
    public static class GetScanConfig
    {
        ...
        public static Task<GetScanConfigResult> InvokeAsync(GetScanConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScanConfigResult>("google-native:websecurityscanner/v1alpha:getScanConfig", args ?? new GetScanConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a ScanConfig.
        /// </summary>
        public static Output<GetScanConfigResult> Invoke(GetScanConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScanConfigResult>("google-native:websecurityscanner/v1alpha:getScanConfig", args ?? new GetScanConfigInvokeArgs(), options.WithDefaults());
    }
