...
namespace Pulumi.GcpNative.WebSecurityScanner.V1Alpha
{
    /// <summary>
    /// Creates a new ScanConfig.
    /// </summary>
    [GcpNativeResourceType("gcp-native:websecurityscanner/v1alpha:ScanConfig")]
    public partial class ScanConfig : Pulumi.CustomResource
    {
        ...
        public ScanConfig(string name, ScanConfigArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:websecurityscanner/v1alpha:ScanConfig", name, args ?? new ScanConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScanConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:websecurityscanner/v1alpha:ScanConfig", name, null, MakeResourceOptions(options, id))
        {
        }
