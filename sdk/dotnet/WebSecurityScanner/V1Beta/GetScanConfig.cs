...
namespace Pulumi.GoogleNative.WebSecurityScanner.V1Beta
{
    public static class GetScanConfig
    {
        ...
        public static Task<GetScanConfigResult> InvokeAsync(GetScanConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScanConfigResult>("google-native:websecurityscanner/v1beta:getScanConfig", args ?? new GetScanConfigArgs(), options.WithVersion());

        /// <summary>
        /// Gets a ScanConfig.
        /// </summary>
        public static Output<GetScanConfigResult> Invoke(GetScanConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScanConfigResult>("google-native:websecurityscanner/v1beta:getScanConfig", args ?? new GetScanConfigInvokeArgs(), options.WithVersion());
    }
