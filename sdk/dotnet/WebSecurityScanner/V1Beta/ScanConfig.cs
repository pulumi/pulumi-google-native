...
namespace Pulumi.GcpNative.WebSecurityScanner.V1Beta
{
    ...
    /// </summary>
    [GcpNativeResourceType("gcp-native:websecurityscanner/v1beta:ScanConfig")]
    public partial class ScanConfig : Pulumi.CustomResource
    {
        ...
        public ScanConfig(string name, ScanConfigArgs args, CustomResourceOptions? options = null)
            : base("gcp-native:websecurityscanner/v1beta:ScanConfig", name, args ?? new ScanConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScanConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("gcp-native:websecurityscanner/v1beta:ScanConfig", name, null, MakeResourceOptions(options, id))
        {
        }
