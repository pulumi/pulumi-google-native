...
namespace Pulumi.GoogleCloud.Websecurityscanner.V1alpha
{
    /// <summary>
    /// Creates a new ScanConfig.
    /// </summary>
    [GoogleCloudResourceType("google-cloud:websecurityscanner/v1alpha:ScanConfig")]
    public partial class ScanConfig : Pulumi.CustomResource
    {
        ...
        public ScanConfig(string name, ScanConfigArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:websecurityscanner/v1alpha:ScanConfig", name, args ?? new ScanConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScanConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:websecurityscanner/v1alpha:ScanConfig", name, null, MakeResourceOptions(options, id))
        {
        }
