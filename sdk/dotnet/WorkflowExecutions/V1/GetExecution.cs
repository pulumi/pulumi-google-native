...
namespace Pulumi.GoogleNative.WorkflowExecutions.V1
{
    public static class GetExecution
    {
        ...
        public static Task<GetExecutionResult> InvokeAsync(GetExecutionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExecutionResult>("google-native:workflowexecutions/v1:getExecution", args ?? new GetExecutionArgs(), options.WithDefaults());

        /// <summary>
        /// Returns an execution of the given name.
        /// </summary>
        public static Output<GetExecutionResult> Invoke(GetExecutionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExecutionResult>("google-native:workflowexecutions/v1:getExecution", args ?? new GetExecutionInvokeArgs(), options.WithDefaults());
    }
