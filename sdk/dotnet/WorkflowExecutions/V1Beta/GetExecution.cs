...
namespace Pulumi.GoogleNative.WorkflowExecutions.V1Beta
{
    public static class GetExecution
    {
        ...
        public static Task<GetExecutionResult> InvokeAsync(GetExecutionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExecutionResult>("google-native:workflowexecutions/v1beta:getExecution", args ?? new GetExecutionArgs(), options.WithDefaults());

        /// <summary>
        /// Returns an execution of the given name.
        /// </summary>
        public static Output<GetExecutionResult> Invoke(GetExecutionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetExecutionResult>("google-native:workflowexecutions/v1beta:getExecution", args ?? new GetExecutionInvokeArgs(), options.WithDefaults());
    }
