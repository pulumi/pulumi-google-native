...
namespace Pulumi.GoogleNative.WorkflowExecutions.V1Beta
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:workflowexecutions/v1beta:WorkflowExecution")]
    public partial class WorkflowExecution : Pulumi.CustomResource
    {
        ...
        public WorkflowExecution(string name, WorkflowExecutionArgs args, CustomResourceOptions? options = null)
            : base("google-native:workflowexecutions/v1beta:WorkflowExecution", name, args ?? new WorkflowExecutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkflowExecution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:workflowexecutions/v1beta:WorkflowExecution", name, null, MakeResourceOptions(options, id))
        {
        }
