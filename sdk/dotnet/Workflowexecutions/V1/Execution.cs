...
namespace Pulumi.GoogleCloud.Workflowexecutions.V1
{
    ...
    /// </summary>
    [GoogleCloudResourceType("google-cloud:workflowexecutions/v1:Execution")]
    public partial class Execution : Pulumi.CustomResource
    {
        ...
        public Execution(string name, ExecutionArgs args, CustomResourceOptions? options = null)
            : base("google-cloud:workflowexecutions/v1:Execution", name, args ?? new ExecutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Execution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-cloud:workflowexecutions/v1:Execution", name, null, MakeResourceOptions(options, id))
        {
        }
