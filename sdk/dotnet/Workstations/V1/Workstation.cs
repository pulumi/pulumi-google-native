...
namespace Pulumi.GoogleNative.Workstations.V1
{
    ...
    /// </summary>
    [GoogleNativeResourceType("google-native:workstations/v1:Workstation")]
    public partial class Workstation : global::Pulumi.CustomResource
    {
        ...
        public Workstation(string name, WorkstationArgs args, CustomResourceOptions? options = null)
            : base("google-native:workstations/v1:Workstation", name, args ?? new WorkstationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workstation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:workstations/v1:Workstation", name, null, MakeResourceOptions(options, id))
        {
        }
