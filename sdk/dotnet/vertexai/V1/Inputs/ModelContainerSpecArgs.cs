...
namespace Pulumi.GoogleNative.vertexai.V1.Inputs
{
    ...
    /// </summary>
    public sealed class ModelContainerSpecArgs : global::Pulumi.ResourceArgs
    {
        [Input("args")]
        ...
        [Input("env")]
        private InputList<Inputs.ModelContainerSpecEnvArgs>? _env;
        ...
        /// </summary>
        public InputList<Inputs.ModelContainerSpecEnvArgs> Env
        {
            get => _env ?? (_env = new InputList<Inputs.ModelContainerSpecEnvArgs>());
            set => _env = value;
        }
        ...
        [Input("ports")]
        private InputList<Inputs.ModelContainerSpecPortsArgs>? _ports;

        /// <summary>
        /// Immutable. List of ports to expose from the container. Vertex AI sends any prediction requests that it receives to the first port on this list. Vertex AI also sends [liveness and health checks](https://cloud.google.com/vertex-ai/docs/predictions/custom-container-requirements#liveness) to this port. If you do not specify this field, it defaults to following value: ```json [ { "containerPort": 8080 } ] ``` Vertex AI does not use ports other than the first one listed. This field corresponds to the `ports` field of the Kubernetes Containers [v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core).
        /// </summary>
        public InputList<Inputs.ModelContainerSpecPortsArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Inputs.ModelContainerSpecPortsArgs>());
            set => _ports = value;
        }
        ...
        public ModelContainerSpecArgs()
        {
        }
        public static new ModelContainerSpecArgs Empty => new ModelContainerSpecArgs();
    }
}
