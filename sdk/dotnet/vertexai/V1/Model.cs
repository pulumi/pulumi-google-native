...
{
    [GoogleNativeResourceType("google-native:vertexai/v1:Model")]
    public partial class Model : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.ModelContainerSpec?> ContainerSpec { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ModelDeployedModels>> DeployedModels { get; private set; } = null!;
        ...
        public Output<Outputs.ModelEncryptionSpec?> EncryptionSpec { get; private set; } = null!;
        ...
        public Output<Outputs.ModelOriginalModelInfo?> OriginalModelInfo { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Pulumi.GoogleNative.vertexai.V1.ModelSupportedDeploymentResourcesTypesEnum>> SupportedDeploymentResourcesTypes { get; private set; } = null!;

        /// <summary>
        /// Output only. The formats in which this Model may be exported. If empty, this Model is not available for export.
        /// </summary>
        [Output("supportedExportFormats")]
        public Output<ImmutableArray<Outputs.ModelSupportedExportFormats>> SupportedExportFormats { get; private set; } = null!;
        ...
        public Model(string name, ModelArgs args, CustomResourceOptions? options = null)
            : base("google-native:vertexai/v1:Model", name, args ?? new ModelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Model(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("google-native:vertexai/v1:Model", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ModelArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ModelContainerSpecArgs> ContainerSpec { get; set; } = null!;
        ...
        public Input<Inputs.ModelEncryptionSpecArgs>? EncryptionSpec { get; set; }
