...
func NewAccessPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:accesscontextmanager/v1:AccessPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessPolicy(ctx *pulumi.Context,
	...
	var resource AccessPolicy
	err := ctx.ReadResource("gcp-native:accesscontextmanager/v1:AccessPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
