...
func NewOrganizationGcpUserAccessBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:accesscontextmanager/v1:OrganizationGcpUserAccessBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationGcpUserAccessBinding(ctx *pulumi.Context,
	...
	var resource OrganizationGcpUserAccessBinding
	err := ctx.ReadResource("gcp-native:accesscontextmanager/v1:OrganizationGcpUserAccessBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
