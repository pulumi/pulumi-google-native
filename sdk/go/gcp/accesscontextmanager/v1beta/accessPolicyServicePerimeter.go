...
func NewAccessPolicyServicePerimeter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:accesscontextmanager/v1beta:AccessPolicyServicePerimeter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessPolicyServicePerimeter(ctx *pulumi.Context,
	...
	var resource AccessPolicyServicePerimeter
	err := ctx.ReadResource("gcp-native:accesscontextmanager/v1beta:AccessPolicyServicePerimeter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
