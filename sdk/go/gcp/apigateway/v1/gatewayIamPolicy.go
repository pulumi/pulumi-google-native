...
func NewGatewayIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigateway/v1:GatewayIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayIamPolicy(ctx *pulumi.Context,
	...
	var resource GatewayIamPolicy
	err := ctx.ReadResource("gcp-native:apigateway/v1:GatewayIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
