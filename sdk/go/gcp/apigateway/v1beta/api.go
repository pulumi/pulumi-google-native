...
func NewApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.RegisterResource("gcp-native:apigateway/v1beta:Api", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.ReadResource("gcp-native:apigateway/v1beta:Api", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
