...
func NewApiConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigateway/v1beta:ApiConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiConfig(ctx *pulumi.Context,
	...
	var resource ApiConfig
	err := ctx.ReadResource("gcp-native:apigateway/v1beta:ApiConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
