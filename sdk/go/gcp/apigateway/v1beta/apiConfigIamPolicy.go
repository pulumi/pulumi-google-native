...
func NewApiConfigIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigateway/v1beta:ApiConfigIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiConfigIamPolicy(ctx *pulumi.Context,
	...
	var resource ApiConfigIamPolicy
	err := ctx.ReadResource("gcp-native:apigateway/v1beta:ApiConfigIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
