...
func NewApiIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigateway/v1beta:ApiIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIamPolicy(ctx *pulumi.Context,
	...
	var resource ApiIamPolicy
	err := ctx.ReadResource("gcp-native:apigateway/v1beta:ApiIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
