...
func NewGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigateway/v1beta:Gateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGateway(ctx *pulumi.Context,
	...
	var resource Gateway
	err := ctx.ReadResource("gcp-native:apigateway/v1beta:Gateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
