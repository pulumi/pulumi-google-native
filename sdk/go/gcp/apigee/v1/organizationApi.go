...
func NewOrganizationApi(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationApi", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationApi(ctx *pulumi.Context,
	...
	var resource OrganizationApi
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationApi", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
