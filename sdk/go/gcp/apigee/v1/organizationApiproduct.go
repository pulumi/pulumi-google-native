...
func NewOrganizationApiproduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationApiproduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationApiproduct(ctx *pulumi.Context,
	...
	var resource OrganizationApiproduct
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationApiproduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
