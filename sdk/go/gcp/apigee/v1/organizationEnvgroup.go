...
func NewOrganizationEnvgroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvgroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvgroup(ctx *pulumi.Context,
	...
	var resource OrganizationEnvgroup
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvgroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
