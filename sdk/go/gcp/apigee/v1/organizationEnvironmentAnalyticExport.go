...
func NewOrganizationEnvironmentAnalyticExport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentAnalyticExport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentAnalyticExport(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentAnalyticExport
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentAnalyticExport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
