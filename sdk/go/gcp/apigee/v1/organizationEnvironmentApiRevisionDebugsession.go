...
func NewOrganizationEnvironmentApiRevisionDebugsession(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentApiRevisionDebugsession", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentApiRevisionDebugsession(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentApiRevisionDebugsession
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentApiRevisionDebugsession", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
