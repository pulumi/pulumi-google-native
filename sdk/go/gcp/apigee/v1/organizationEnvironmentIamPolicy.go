...
func NewOrganizationEnvironmentIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentIamPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentIamPolicy
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
