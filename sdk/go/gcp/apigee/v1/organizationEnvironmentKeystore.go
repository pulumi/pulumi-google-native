...
func NewOrganizationEnvironmentKeystore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentKeystore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentKeystore(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentKeystore
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentKeystore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
