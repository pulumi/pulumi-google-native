...
func NewOrganizationEnvironmentKeystoreAlias(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentKeystoreAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentKeystoreAlias(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentKeystoreAlias
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentKeystoreAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
