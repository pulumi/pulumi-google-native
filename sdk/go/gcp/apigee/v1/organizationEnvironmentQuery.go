...
func NewOrganizationEnvironmentQuery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentQuery(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentQuery
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
