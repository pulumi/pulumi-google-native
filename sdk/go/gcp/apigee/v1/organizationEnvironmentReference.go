...
func NewOrganizationEnvironmentReference(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentReference", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentReference(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentReference
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentReference", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
