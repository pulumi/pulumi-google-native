...
func NewOrganizationEnvironmentResourcefile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentResourcefile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentResourcefile(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentResourcefile
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentResourcefile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
