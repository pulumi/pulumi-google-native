...
func NewOrganizationEnvironmentTargetserver(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationEnvironmentTargetserver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentTargetserver(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentTargetserver
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationEnvironmentTargetserver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
