...
func NewOrganizationHostQuery(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationHostQuery", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationHostQuery(ctx *pulumi.Context,
	...
	var resource OrganizationHostQuery
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationHostQuery", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
