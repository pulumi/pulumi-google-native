...
func NewOrganizationSharedflow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationSharedflow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSharedflow(ctx *pulumi.Context,
	...
	var resource OrganizationSharedflow
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationSharedflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
