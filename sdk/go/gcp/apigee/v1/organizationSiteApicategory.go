...
func NewOrganizationSiteApicategory(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:apigee/v1:OrganizationSiteApicategory", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSiteApicategory(ctx *pulumi.Context,
	...
	var resource OrganizationSiteApicategory
	err := ctx.ReadResource("gcp-native:apigee/v1:OrganizationSiteApicategory", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
