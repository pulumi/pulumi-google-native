...
func NewApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.RegisterResource("gcp-native:appengine/v1:App", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.ReadResource("gcp-native:appengine/v1:App", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
