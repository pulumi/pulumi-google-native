...
func NewAppAuthorizedCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:appengine/v1:AppAuthorizedCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppAuthorizedCertificate(ctx *pulumi.Context,
	...
	var resource AppAuthorizedCertificate
	err := ctx.ReadResource("gcp-native:appengine/v1:AppAuthorizedCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
