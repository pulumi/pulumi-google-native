...
func NewAppFirewallIngressRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:appengine/v1:AppFirewallIngressRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppFirewallIngressRule(ctx *pulumi.Context,
	...
	var resource AppFirewallIngressRule
	err := ctx.ReadResource("gcp-native:appengine/v1:AppFirewallIngressRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
