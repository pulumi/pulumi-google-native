...
func NewAppDomainMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:appengine/v1beta:AppDomainMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppDomainMapping(ctx *pulumi.Context,
	...
	var resource AppDomainMapping
	err := ctx.ReadResource("gcp-native:appengine/v1beta:AppDomainMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
