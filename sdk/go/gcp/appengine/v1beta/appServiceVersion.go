...
func NewAppServiceVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:appengine/v1beta:AppServiceVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppServiceVersion(ctx *pulumi.Context,
	...
	var resource AppServiceVersion
	err := ctx.ReadResource("gcp-native:appengine/v1beta:AppServiceVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
