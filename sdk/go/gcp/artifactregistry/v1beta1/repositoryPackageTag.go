...
func NewRepositoryPackageTag(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:artifactregistry/v1beta1:RepositoryPackageTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepositoryPackageTag(ctx *pulumi.Context,
	...
	var resource RepositoryPackageTag
	err := ctx.ReadResource("gcp-native:artifactregistry/v1beta1:RepositoryPackageTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
