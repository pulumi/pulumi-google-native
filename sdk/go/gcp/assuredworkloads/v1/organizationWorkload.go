...
func NewOrganizationWorkload(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:assuredworkloads/v1:OrganizationWorkload", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationWorkload(ctx *pulumi.Context,
	...
	var resource OrganizationWorkload
	err := ctx.ReadResource("gcp-native:assuredworkloads/v1:OrganizationWorkload", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
