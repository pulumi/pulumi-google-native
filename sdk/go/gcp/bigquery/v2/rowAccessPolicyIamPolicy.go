...
func NewRowAccessPolicyIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:bigquery/v2:RowAccessPolicyIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRowAccessPolicyIamPolicy(ctx *pulumi.Context,
	...
	var resource RowAccessPolicyIamPolicy
	err := ctx.ReadResource("gcp-native:bigquery/v2:RowAccessPolicyIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
