...
func NewTableIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:bigquery/v2:TableIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableIamPolicy(ctx *pulumi.Context,
	...
	var resource TableIamPolicy
	err := ctx.ReadResource("gcp-native:bigquery/v2:TableIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
