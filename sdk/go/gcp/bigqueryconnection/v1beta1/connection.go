...
func NewConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:bigqueryconnection/v1beta1:Connection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnection(ctx *pulumi.Context,
	...
	var resource Connection
	err := ctx.ReadResource("gcp-native:bigqueryconnection/v1beta1:Connection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
