...
func NewCapacityCommitment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:bigqueryreservation/v1:CapacityCommitment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapacityCommitment(ctx *pulumi.Context,
	...
	var resource CapacityCommitment
	err := ctx.ReadResource("gcp-native:bigqueryreservation/v1:CapacityCommitment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
