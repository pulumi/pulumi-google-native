...
func NewReservationAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:bigqueryreservation/v1:ReservationAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReservationAssignment(ctx *pulumi.Context,
	...
	var resource ReservationAssignment
	err := ctx.ReadResource("gcp-native:bigqueryreservation/v1:ReservationAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
