...
func NewInstanceAppProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:bigtableadmin/v2:InstanceAppProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceAppProfile(ctx *pulumi.Context,
	...
	var resource InstanceAppProfile
	err := ctx.ReadResource("gcp-native:bigtableadmin/v2:InstanceAppProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
