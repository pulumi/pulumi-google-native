...
func NewInstanceClusterBackupIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:bigtableadmin/v2:InstanceClusterBackupIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceClusterBackupIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceClusterBackupIamPolicy
	err := ctx.ReadResource("gcp-native:bigtableadmin/v2:InstanceClusterBackupIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
