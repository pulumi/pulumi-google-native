...
func NewInstanceTableIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:bigtableadmin/v2:InstanceTableIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceTableIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceTableIamPolicy
	err := ctx.ReadResource("gcp-native:bigtableadmin/v2:InstanceTableIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
