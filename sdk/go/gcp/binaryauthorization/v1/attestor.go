...
func NewAttestor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:binaryauthorization/v1:Attestor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestor(ctx *pulumi.Context,
	...
	var resource Attestor
	err := ctx.ReadResource("gcp-native:binaryauthorization/v1:Attestor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
