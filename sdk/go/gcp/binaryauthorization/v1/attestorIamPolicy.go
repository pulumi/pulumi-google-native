...
func NewAttestorIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:binaryauthorization/v1:AttestorIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestorIamPolicy(ctx *pulumi.Context,
	...
	var resource AttestorIamPolicy
	err := ctx.ReadResource("gcp-native:binaryauthorization/v1:AttestorIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
