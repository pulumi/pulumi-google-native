...
func NewBillingAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudbilling/v1:BillingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingAccount(ctx *pulumi.Context,
	...
	var resource BillingAccount
	err := ctx.ReadResource("gcp-native:cloudbilling/v1:BillingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
