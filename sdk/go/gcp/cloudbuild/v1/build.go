...
func NewBuild(ctx *pulumi.Context,
	...
	var resource Build
	err := ctx.RegisterResource("gcp-native:cloudbuild/v1:Build", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBuild(ctx *pulumi.Context,
	...
	var resource Build
	err := ctx.ReadResource("gcp-native:cloudbuild/v1:Build", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
