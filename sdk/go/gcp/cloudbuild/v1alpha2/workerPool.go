...
func NewWorkerPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudbuild/v1alpha2:WorkerPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkerPool(ctx *pulumi.Context,
	...
	var resource WorkerPool
	err := ctx.ReadResource("gcp-native:cloudbuild/v1alpha2:WorkerPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
