...
func NewAccountChannelPartnerLinkCustomer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudchannel/v1:AccountChannelPartnerLinkCustomer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountChannelPartnerLinkCustomer(ctx *pulumi.Context,
	...
	var resource AccountChannelPartnerLinkCustomer
	err := ctx.ReadResource("gcp-native:cloudchannel/v1:AccountChannelPartnerLinkCustomer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
