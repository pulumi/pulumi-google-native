...
func NewAccountCustomer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudchannel/v1:AccountCustomer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountCustomer(ctx *pulumi.Context,
	...
	var resource AccountCustomer
	err := ctx.ReadResource("gcp-native:cloudchannel/v1:AccountCustomer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
