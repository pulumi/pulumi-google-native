...
func NewAccountCustomerEntitlement(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudchannel/v1:AccountCustomerEntitlement", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountCustomerEntitlement(ctx *pulumi.Context,
	...
	var resource AccountCustomerEntitlement
	err := ctx.ReadResource("gcp-native:cloudchannel/v1:AccountCustomerEntitlement", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
