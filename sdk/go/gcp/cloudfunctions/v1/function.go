...
func NewFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudfunctions/v1:Function", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunction(ctx *pulumi.Context,
	...
	var resource Function
	err := ctx.ReadResource("gcp-native:cloudfunctions/v1:Function", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
