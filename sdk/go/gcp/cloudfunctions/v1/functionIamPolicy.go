...
func NewFunctionIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudfunctions/v1:FunctionIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionIamPolicy(ctx *pulumi.Context,
	...
	var resource FunctionIamPolicy
	err := ctx.ReadResource("gcp-native:cloudfunctions/v1:FunctionIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
