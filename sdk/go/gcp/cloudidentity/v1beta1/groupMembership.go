...
func NewGroupMembership(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudidentity/v1beta1:GroupMembership", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupMembership(ctx *pulumi.Context,
	...
	var resource GroupMembership
	err := ctx.ReadResource("gcp-native:cloudidentity/v1beta1:GroupMembership", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
