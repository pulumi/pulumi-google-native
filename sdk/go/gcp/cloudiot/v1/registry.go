...
func NewRegistry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudiot/v1:Registry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistry(ctx *pulumi.Context,
	...
	var resource Registry
	err := ctx.ReadResource("gcp-native:cloudiot/v1:Registry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
