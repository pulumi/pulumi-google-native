...
func NewRegistryGroupIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudiot/v1:RegistryGroupIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryGroupIamPolicy(ctx *pulumi.Context,
	...
	var resource RegistryGroupIamPolicy
	err := ctx.ReadResource("gcp-native:cloudiot/v1:RegistryGroupIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
