...
func NewKeyRing(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudkms/v1:KeyRing", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRing(ctx *pulumi.Context,
	...
	var resource KeyRing
	err := ctx.ReadResource("gcp-native:cloudkms/v1:KeyRing", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
