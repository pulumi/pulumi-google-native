...
func NewKeyRingCryptoKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudkms/v1:KeyRingCryptoKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRingCryptoKey(ctx *pulumi.Context,
	...
	var resource KeyRingCryptoKey
	err := ctx.ReadResource("gcp-native:cloudkms/v1:KeyRingCryptoKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
