...
func NewKeyRingCryptoKeyCryptoKeyVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudkms/v1:KeyRingCryptoKeyCryptoKeyVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRingCryptoKeyCryptoKeyVersion(ctx *pulumi.Context,
	...
	var resource KeyRingCryptoKeyCryptoKeyVersion
	err := ctx.ReadResource("gcp-native:cloudkms/v1:KeyRingCryptoKeyCryptoKeyVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
