...
func NewKeyRingCryptoKeyIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudkms/v1:KeyRingCryptoKeyIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRingCryptoKeyIamPolicy(ctx *pulumi.Context,
	...
	var resource KeyRingCryptoKeyIamPolicy
	err := ctx.ReadResource("gcp-native:cloudkms/v1:KeyRingCryptoKeyIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
