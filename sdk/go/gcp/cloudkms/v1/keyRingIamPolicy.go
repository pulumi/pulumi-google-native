...
func NewKeyRingIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudkms/v1:KeyRingIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRingIamPolicy(ctx *pulumi.Context,
	...
	var resource KeyRingIamPolicy
	err := ctx.ReadResource("gcp-native:cloudkms/v1:KeyRingIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
