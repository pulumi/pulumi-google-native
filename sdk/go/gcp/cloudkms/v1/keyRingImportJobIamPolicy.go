...
func NewKeyRingImportJobIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudkms/v1:KeyRingImportJobIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRingImportJobIamPolicy(ctx *pulumi.Context,
	...
	var resource KeyRingImportJobIamPolicy
	err := ctx.ReadResource("gcp-native:cloudkms/v1:KeyRingImportJobIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
