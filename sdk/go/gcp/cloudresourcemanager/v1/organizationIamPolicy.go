...
func NewOrganizationIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudresourcemanager/v1:OrganizationIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationIamPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationIamPolicy
	err := ctx.ReadResource("gcp-native:cloudresourcemanager/v1:OrganizationIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
