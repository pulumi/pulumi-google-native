...
func NewFolderIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudresourcemanager/v2:FolderIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderIamPolicy(ctx *pulumi.Context,
	...
	var resource FolderIamPolicy
	err := ctx.ReadResource("gcp-native:cloudresourcemanager/v2:FolderIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
