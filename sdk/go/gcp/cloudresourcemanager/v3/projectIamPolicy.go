...
func NewProjectIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudresourcemanager/v3:ProjectIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectIamPolicy(ctx *pulumi.Context,
	...
	var resource ProjectIamPolicy
	err := ctx.ReadResource("gcp-native:cloudresourcemanager/v3:ProjectIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
