...
func NewTagKey(ctx *pulumi.Context,
	...
	var resource TagKey
	err := ctx.RegisterResource("gcp-native:cloudresourcemanager/v3:TagKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagKey(ctx *pulumi.Context,
	...
	var resource TagKey
	err := ctx.ReadResource("gcp-native:cloudresourcemanager/v3:TagKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
