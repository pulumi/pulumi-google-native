...
func NewTagKeyIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudresourcemanager/v3:TagKeyIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagKeyIamPolicy(ctx *pulumi.Context,
	...
	var resource TagKeyIamPolicy
	err := ctx.ReadResource("gcp-native:cloudresourcemanager/v3:TagKeyIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
