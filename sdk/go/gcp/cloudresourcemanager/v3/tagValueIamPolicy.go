...
func NewTagValueIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudresourcemanager/v3:TagValueIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagValueIamPolicy(ctx *pulumi.Context,
	...
	var resource TagValueIamPolicy
	err := ctx.ReadResource("gcp-native:cloudresourcemanager/v3:TagValueIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
