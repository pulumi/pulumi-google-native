...
func NewSettingDatasource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudsearch/v1:SettingDatasource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSettingDatasource(ctx *pulumi.Context,
	...
	var resource SettingDatasource
	err := ctx.ReadResource("gcp-native:cloudsearch/v1:SettingDatasource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
