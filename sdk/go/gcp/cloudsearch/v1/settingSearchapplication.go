...
func NewSettingSearchapplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudsearch/v1:SettingSearchapplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSettingSearchapplication(ctx *pulumi.Context,
	...
	var resource SettingSearchapplication
	err := ctx.ReadResource("gcp-native:cloudsearch/v1:SettingSearchapplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
