...
func NewQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.RegisterResource("gcp-native:cloudtasks/v2beta2:Queue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueue(ctx *pulumi.Context,
	...
	var resource Queue
	err := ctx.ReadResource("gcp-native:cloudtasks/v2beta2:Queue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
