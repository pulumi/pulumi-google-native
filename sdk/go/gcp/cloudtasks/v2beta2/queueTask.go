...
func NewQueueTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudtasks/v2beta2:QueueTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueTask(ctx *pulumi.Context,
	...
	var resource QueueTask
	err := ctx.ReadResource("gcp-native:cloudtasks/v2beta2:QueueTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
