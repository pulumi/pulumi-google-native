...
func NewQueueIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudtasks/v2beta3:QueueIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueIamPolicy(ctx *pulumi.Context,
	...
	var resource QueueIamPolicy
	err := ctx.ReadResource("gcp-native:cloudtasks/v2beta3:QueueIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
