...
func NewTraceSink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:cloudtrace/v2beta1:TraceSink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTraceSink(ctx *pulumi.Context,
	...
	var resource TraceSink
	err := ctx.ReadResource("gcp-native:cloudtrace/v2beta1:TraceSink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
