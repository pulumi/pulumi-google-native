...
func NewEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:composer/v1:Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironment(ctx *pulumi.Context,
	...
	var resource Environment
	err := ctx.ReadResource("gcp-native:composer/v1:Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
