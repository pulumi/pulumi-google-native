...
func NewBackendBucket(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:BackendBucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendBucket(ctx *pulumi.Context,
	...
	var resource BackendBucket
	err := ctx.ReadResource("gcp-native:compute/alpha:BackendBucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
