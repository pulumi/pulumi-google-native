...
func NewBackendBucketIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:BackendBucketIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendBucketIamPolicy(ctx *pulumi.Context,
	...
	var resource BackendBucketIamPolicy
	err := ctx.ReadResource("gcp-native:compute/alpha:BackendBucketIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
