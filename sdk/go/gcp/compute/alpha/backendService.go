...
func NewBackendService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:BackendService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendService(ctx *pulumi.Context,
	...
	var resource BackendService
	err := ctx.ReadResource("gcp-native:compute/alpha:BackendService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
