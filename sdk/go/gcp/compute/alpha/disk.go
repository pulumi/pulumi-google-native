...
func NewDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.RegisterResource("gcp-native:compute/alpha:Disk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.ReadResource("gcp-native:compute/alpha:Disk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
