...
func NewExternalVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:ExternalVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExternalVpnGateway(ctx *pulumi.Context,
	...
	var resource ExternalVpnGateway
	err := ctx.ReadResource("gcp-native:compute/alpha:ExternalVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
