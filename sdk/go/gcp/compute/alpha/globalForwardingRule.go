...
func NewGlobalForwardingRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:GlobalForwardingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalForwardingRule(ctx *pulumi.Context,
	...
	var resource GlobalForwardingRule
	err := ctx.ReadResource("gcp-native:compute/alpha:GlobalForwardingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
