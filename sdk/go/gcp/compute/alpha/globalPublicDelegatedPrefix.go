...
func NewGlobalPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:GlobalPublicDelegatedPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	var resource GlobalPublicDelegatedPrefix
	err := ctx.ReadResource("gcp-native:compute/alpha:GlobalPublicDelegatedPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
