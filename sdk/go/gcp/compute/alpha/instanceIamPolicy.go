...
func NewInstanceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:InstanceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceIamPolicy
	err := ctx.ReadResource("gcp-native:compute/alpha:InstanceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
