...
func NewInstanceTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:InstanceTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceTemplateIamPolicy
	err := ctx.ReadResource("gcp-native:compute/alpha:InstanceTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
