...
func NewLicenseCodeIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:LicenseCodeIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLicenseCodeIamPolicy(ctx *pulumi.Context,
	...
	var resource LicenseCodeIamPolicy
	err := ctx.ReadResource("gcp-native:compute/alpha:LicenseCodeIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
