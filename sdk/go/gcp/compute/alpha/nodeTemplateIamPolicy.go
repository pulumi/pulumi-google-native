...
func NewNodeTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:NodeTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource NodeTemplateIamPolicy
	err := ctx.ReadResource("gcp-native:compute/alpha:NodeTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
