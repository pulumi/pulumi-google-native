...
func NewPublicAdvertisedPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:PublicAdvertisedPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicAdvertisedPrefix(ctx *pulumi.Context,
	...
	var resource PublicAdvertisedPrefix
	err := ctx.ReadResource("gcp-native:compute/alpha:PublicAdvertisedPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
