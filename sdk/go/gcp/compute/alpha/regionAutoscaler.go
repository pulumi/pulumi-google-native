...
func NewRegionAutoscaler(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionAutoscaler", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionAutoscaler(ctx *pulumi.Context,
	...
	var resource RegionAutoscaler
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionAutoscaler", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
