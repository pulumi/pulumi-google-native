...
func NewRegionCommitment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionCommitment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionCommitment(ctx *pulumi.Context,
	...
	var resource RegionCommitment
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionCommitment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
