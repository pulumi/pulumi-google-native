...
func NewRegionDisk(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDisk(ctx *pulumi.Context,
	...
	var resource RegionDisk
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
