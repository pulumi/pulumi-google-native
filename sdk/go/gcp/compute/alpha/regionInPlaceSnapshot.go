...
func NewRegionInPlaceSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionInPlaceSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionInPlaceSnapshot(ctx *pulumi.Context,
	...
	var resource RegionInPlaceSnapshot
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionInPlaceSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
