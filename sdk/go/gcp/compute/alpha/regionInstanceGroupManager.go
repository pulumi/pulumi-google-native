...
func NewRegionInstanceGroupManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionInstanceGroupManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionInstanceGroupManager(ctx *pulumi.Context,
	...
	var resource RegionInstanceGroupManager
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionInstanceGroupManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
