...
func NewRegionInstantSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionInstantSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionInstantSnapshot(ctx *pulumi.Context,
	...
	var resource RegionInstantSnapshot
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionInstantSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
