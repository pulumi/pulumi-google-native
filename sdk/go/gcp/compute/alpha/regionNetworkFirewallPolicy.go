...
func NewRegionNetworkFirewallPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionNetworkFirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionNetworkFirewallPolicy(ctx *pulumi.Context,
	...
	var resource RegionNetworkFirewallPolicy
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionNetworkFirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
