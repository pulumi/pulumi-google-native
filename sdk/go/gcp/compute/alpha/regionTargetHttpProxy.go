...
func NewRegionTargetHttpProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionTargetHttpProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionTargetHttpProxy(ctx *pulumi.Context,
	...
	var resource RegionTargetHttpProxy
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionTargetHttpProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
