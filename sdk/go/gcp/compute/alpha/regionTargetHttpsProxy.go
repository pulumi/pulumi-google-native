...
func NewRegionTargetHttpsProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:RegionTargetHttpsProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionTargetHttpsProxy(ctx *pulumi.Context,
	...
	var resource RegionTargetHttpsProxy
	err := ctx.ReadResource("gcp-native:compute/alpha:RegionTargetHttpsProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
