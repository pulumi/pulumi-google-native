...
func NewResourcePolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:ResourcePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourcePolicy(ctx *pulumi.Context,
	...
	var resource ResourcePolicy
	err := ctx.ReadResource("gcp-native:compute/alpha:ResourcePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type resourcePolicyState struct {
	...
	// Resource policy applicable to VMs for infrastructure maintenance.
	VmMaintenancePolicy *ResourcePolicyVmMaintenancePolicyResponse `pulumi:"vmMaintenancePolicy"`
}
...
type ResourcePolicyState struct {
	...
	// Resource policy applicable to VMs for infrastructure maintenance.
	VmMaintenancePolicy ResourcePolicyVmMaintenancePolicyResponsePtrInput
}
