...
func NewServiceAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:ServiceAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAttachment(ctx *pulumi.Context,
	...
	var resource ServiceAttachment
	err := ctx.ReadResource("gcp-native:compute/alpha:ServiceAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
