...
func NewSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:Snapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshot(ctx *pulumi.Context,
	...
	var resource Snapshot
	err := ctx.ReadResource("gcp-native:compute/alpha:Snapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
