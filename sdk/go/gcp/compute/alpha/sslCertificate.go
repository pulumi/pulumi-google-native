...
func NewSslCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:SslCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslCertificate(ctx *pulumi.Context,
	...
	var resource SslCertificate
	err := ctx.ReadResource("gcp-native:compute/alpha:SslCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
