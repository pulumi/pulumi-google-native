...
func NewSslPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:SslPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslPolicy(ctx *pulumi.Context,
	...
	var resource SslPolicy
	err := ctx.ReadResource("gcp-native:compute/alpha:SslPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
