...
func NewTargetHttpProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:TargetHttpProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetHttpProxy(ctx *pulumi.Context,
	...
	var resource TargetHttpProxy
	err := ctx.ReadResource("gcp-native:compute/alpha:TargetHttpProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
