...
func NewTargetPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:TargetPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetPool(ctx *pulumi.Context,
	...
	var resource TargetPool
	err := ctx.ReadResource("gcp-native:compute/alpha:TargetPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
