...
func NewZoneInPlaceSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:ZoneInPlaceSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZoneInPlaceSnapshot(ctx *pulumi.Context,
	...
	var resource ZoneInPlaceSnapshot
	err := ctx.ReadResource("gcp-native:compute/alpha:ZoneInPlaceSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
