...
func NewZoneInstantSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/alpha:ZoneInstantSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZoneInstantSnapshot(ctx *pulumi.Context,
	...
	var resource ZoneInstantSnapshot
	err := ctx.ReadResource("gcp-native:compute/alpha:ZoneInstantSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
