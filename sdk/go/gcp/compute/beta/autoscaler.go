...
func NewAutoscaler(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:Autoscaler", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoscaler(ctx *pulumi.Context,
	...
	var resource Autoscaler
	err := ctx.ReadResource("gcp-native:compute/beta:Autoscaler", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
