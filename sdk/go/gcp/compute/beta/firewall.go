...
func NewFirewall(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:Firewall", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewall(ctx *pulumi.Context,
	...
	var resource Firewall
	err := ctx.ReadResource("gcp-native:compute/beta:Firewall", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
