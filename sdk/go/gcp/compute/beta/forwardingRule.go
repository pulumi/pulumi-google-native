...
func NewForwardingRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:ForwardingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetForwardingRule(ctx *pulumi.Context,
	...
	var resource ForwardingRule
	err := ctx.ReadResource("gcp-native:compute/beta:ForwardingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
