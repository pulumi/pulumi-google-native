...
func NewHttpHealthCheck(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:HttpHealthCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHttpHealthCheck(ctx *pulumi.Context,
	...
	var resource HttpHealthCheck
	err := ctx.ReadResource("gcp-native:compute/beta:HttpHealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
