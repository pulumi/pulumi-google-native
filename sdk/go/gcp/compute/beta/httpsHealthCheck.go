...
func NewHttpsHealthCheck(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:HttpsHealthCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHttpsHealthCheck(ctx *pulumi.Context,
	...
	var resource HttpsHealthCheck
	err := ctx.ReadResource("gcp-native:compute/beta:HttpsHealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
