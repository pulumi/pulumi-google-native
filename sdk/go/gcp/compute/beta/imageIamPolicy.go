...
func NewImageIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:ImageIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageIamPolicy(ctx *pulumi.Context,
	...
	var resource ImageIamPolicy
	err := ctx.ReadResource("gcp-native:compute/beta:ImageIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
