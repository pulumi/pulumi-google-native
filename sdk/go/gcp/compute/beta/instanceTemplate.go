...
func NewInstanceTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:InstanceTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceTemplate(ctx *pulumi.Context,
	...
	var resource InstanceTemplate
	err := ctx.ReadResource("gcp-native:compute/beta:InstanceTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
