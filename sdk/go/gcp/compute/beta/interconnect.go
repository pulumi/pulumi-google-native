...
func NewInterconnect(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:Interconnect", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterconnect(ctx *pulumi.Context,
	...
	var resource Interconnect
	err := ctx.ReadResource("gcp-native:compute/beta:Interconnect", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
