...
func NewLicense(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:License", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLicense(ctx *pulumi.Context,
	...
	var resource License
	err := ctx.ReadResource("gcp-native:compute/beta:License", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
