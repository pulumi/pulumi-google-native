...
func NewMachineImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:MachineImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineImage(ctx *pulumi.Context,
	...
	var resource MachineImage
	err := ctx.ReadResource("gcp-native:compute/beta:MachineImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
