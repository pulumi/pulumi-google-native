...
func NewMachineImageIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:MachineImageIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineImageIamPolicy(ctx *pulumi.Context,
	...
	var resource MachineImageIamPolicy
	err := ctx.ReadResource("gcp-native:compute/beta:MachineImageIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
