...
func NewNodeTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:NodeTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeTemplate(ctx *pulumi.Context,
	...
	var resource NodeTemplate
	err := ctx.ReadResource("gcp-native:compute/beta:NodeTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
