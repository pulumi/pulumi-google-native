...
func NewOrganizationSecurityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:OrganizationSecurityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSecurityPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationSecurityPolicy
	err := ctx.ReadResource("gcp-native:compute/beta:OrganizationSecurityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
