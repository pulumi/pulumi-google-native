...
func NewPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:PublicDelegatedPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	var resource PublicDelegatedPrefix
	err := ctx.ReadResource("gcp-native:compute/beta:PublicDelegatedPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
