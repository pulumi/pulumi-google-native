...
func NewRegionBackendService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:RegionBackendService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionBackendService(ctx *pulumi.Context,
	...
	var resource RegionBackendService
	err := ctx.ReadResource("gcp-native:compute/beta:RegionBackendService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
