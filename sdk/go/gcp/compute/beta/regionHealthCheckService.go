...
func NewRegionHealthCheckService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:RegionHealthCheckService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionHealthCheckService(ctx *pulumi.Context,
	...
	var resource RegionHealthCheckService
	err := ctx.ReadResource("gcp-native:compute/beta:RegionHealthCheckService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
