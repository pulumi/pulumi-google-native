...
func NewRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.RegisterResource("gcp-native:compute/beta:Route", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoute(ctx *pulumi.Context,
	...
	var resource Route
	err := ctx.ReadResource("gcp-native:compute/beta:Route", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
