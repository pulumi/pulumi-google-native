...
func NewServiceAttachmentIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:ServiceAttachmentIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAttachmentIamPolicy(ctx *pulumi.Context,
	...
	var resource ServiceAttachmentIamPolicy
	err := ctx.ReadResource("gcp-native:compute/beta:ServiceAttachmentIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
