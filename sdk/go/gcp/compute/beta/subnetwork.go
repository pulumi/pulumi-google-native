...
func NewSubnetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:Subnetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnetwork(ctx *pulumi.Context,
	...
	var resource Subnetwork
	err := ctx.ReadResource("gcp-native:compute/beta:Subnetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
