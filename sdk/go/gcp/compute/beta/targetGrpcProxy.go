...
func NewTargetGrpcProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:TargetGrpcProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetGrpcProxy(ctx *pulumi.Context,
	...
	var resource TargetGrpcProxy
	err := ctx.ReadResource("gcp-native:compute/beta:TargetGrpcProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
