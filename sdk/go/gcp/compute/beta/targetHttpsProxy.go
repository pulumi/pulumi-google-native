...
func NewTargetHttpsProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:TargetHttpsProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetHttpsProxy(ctx *pulumi.Context,
	...
	var resource TargetHttpsProxy
	err := ctx.ReadResource("gcp-native:compute/beta:TargetHttpsProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
