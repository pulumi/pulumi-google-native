...
func NewTargetTcpProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:TargetTcpProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetTcpProxy(ctx *pulumi.Context,
	...
	var resource TargetTcpProxy
	err := ctx.ReadResource("gcp-native:compute/beta:TargetTcpProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
