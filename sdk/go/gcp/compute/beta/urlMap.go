...
func NewUrlMap(ctx *pulumi.Context,
	...
	var resource UrlMap
	err := ctx.RegisterResource("gcp-native:compute/beta:UrlMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUrlMap(ctx *pulumi.Context,
	...
	var resource UrlMap
	err := ctx.ReadResource("gcp-native:compute/beta:UrlMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
