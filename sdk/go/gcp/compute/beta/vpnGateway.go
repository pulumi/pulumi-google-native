...
func NewVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:VpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnGateway(ctx *pulumi.Context,
	...
	var resource VpnGateway
	err := ctx.ReadResource("gcp-native:compute/beta:VpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
