...
func NewVpnTunnel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/beta:VpnTunnel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnTunnel(ctx *pulumi.Context,
	...
	var resource VpnTunnel
	err := ctx.ReadResource("gcp-native:compute/beta:VpnTunnel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
