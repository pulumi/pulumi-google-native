...
func NewAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:Address", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddress(ctx *pulumi.Context,
	...
	var resource Address
	err := ctx.ReadResource("gcp-native:compute/v1:Address", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
