...
func NewGlobalNetworkEndpointGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:GlobalNetworkEndpointGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalNetworkEndpointGroup(ctx *pulumi.Context,
	...
	var resource GlobalNetworkEndpointGroup
	err := ctx.ReadResource("gcp-native:compute/v1:GlobalNetworkEndpointGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
