...
func NewHealthCheck(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:HealthCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthCheck(ctx *pulumi.Context,
	...
	var resource HealthCheck
	err := ctx.ReadResource("gcp-native:compute/v1:HealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
