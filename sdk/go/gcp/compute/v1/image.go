...
func NewImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.RegisterResource("gcp-native:compute/v1:Image", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImage(ctx *pulumi.Context,
	...
	var resource Image
	err := ctx.ReadResource("gcp-native:compute/v1:Image", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
