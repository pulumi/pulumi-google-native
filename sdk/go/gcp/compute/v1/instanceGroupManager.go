...
func NewInstanceGroupManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:InstanceGroupManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceGroupManager(ctx *pulumi.Context,
	...
	var resource InstanceGroupManager
	err := ctx.ReadResource("gcp-native:compute/v1:InstanceGroupManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
