...
func NewInterconnectAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:InterconnectAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterconnectAttachment(ctx *pulumi.Context,
	...
	var resource InterconnectAttachment
	err := ctx.ReadResource("gcp-native:compute/v1:InterconnectAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
