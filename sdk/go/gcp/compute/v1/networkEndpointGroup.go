...
func NewNetworkEndpointGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:NetworkEndpointGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkEndpointGroup(ctx *pulumi.Context,
	...
	var resource NetworkEndpointGroup
	err := ctx.ReadResource("gcp-native:compute/v1:NetworkEndpointGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
