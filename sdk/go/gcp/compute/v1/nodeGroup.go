...
func NewNodeGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:NodeGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeGroup(ctx *pulumi.Context,
	...
	var resource NodeGroup
	err := ctx.ReadResource("gcp-native:compute/v1:NodeGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
