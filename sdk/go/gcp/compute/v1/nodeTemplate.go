...
func NewNodeTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:NodeTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeTemplate(ctx *pulumi.Context,
	...
	var resource NodeTemplate
	err := ctx.ReadResource("gcp-native:compute/v1:NodeTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
