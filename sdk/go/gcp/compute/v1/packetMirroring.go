...
func NewPacketMirroring(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:PacketMirroring", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPacketMirroring(ctx *pulumi.Context,
	...
	var resource PacketMirroring
	err := ctx.ReadResource("gcp-native:compute/v1:PacketMirroring", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
