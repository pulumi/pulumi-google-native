...
func NewPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:PublicDelegatedPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	var resource PublicDelegatedPrefix
	err := ctx.ReadResource("gcp-native:compute/v1:PublicDelegatedPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
