...
func NewRegionHealthCheck(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:RegionHealthCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionHealthCheck(ctx *pulumi.Context,
	...
	var resource RegionHealthCheck
	err := ctx.ReadResource("gcp-native:compute/v1:RegionHealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
