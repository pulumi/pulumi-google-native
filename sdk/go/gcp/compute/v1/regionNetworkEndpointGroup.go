...
func NewRegionNetworkEndpointGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:RegionNetworkEndpointGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionNetworkEndpointGroup(ctx *pulumi.Context,
	...
	var resource RegionNetworkEndpointGroup
	err := ctx.ReadResource("gcp-native:compute/v1:RegionNetworkEndpointGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
