...
func NewRegionNotificationEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:RegionNotificationEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionNotificationEndpoint(ctx *pulumi.Context,
	...
	var resource RegionNotificationEndpoint
	err := ctx.ReadResource("gcp-native:compute/v1:RegionNotificationEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
