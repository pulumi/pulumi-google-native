...
func NewRegionSslCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:RegionSslCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionSslCertificate(ctx *pulumi.Context,
	...
	var resource RegionSslCertificate
	err := ctx.ReadResource("gcp-native:compute/v1:RegionSslCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
