...
func NewRegionUrlMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:RegionUrlMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionUrlMap(ctx *pulumi.Context,
	...
	var resource RegionUrlMap
	err := ctx.ReadResource("gcp-native:compute/v1:RegionUrlMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
