...
func NewReservation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:Reservation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReservation(ctx *pulumi.Context,
	...
	var resource Reservation
	err := ctx.ReadResource("gcp-native:compute/v1:Reservation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
