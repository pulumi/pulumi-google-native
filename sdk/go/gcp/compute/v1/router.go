...
func NewRouter(ctx *pulumi.Context,
	...
	var resource Router
	err := ctx.RegisterResource("gcp-native:compute/v1:Router", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouter(ctx *pulumi.Context,
	...
	var resource Router
	err := ctx.ReadResource("gcp-native:compute/v1:Router", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
