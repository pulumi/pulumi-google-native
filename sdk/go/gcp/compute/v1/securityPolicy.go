...
func NewSecurityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:SecurityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPolicy(ctx *pulumi.Context,
	...
	var resource SecurityPolicy
	err := ctx.ReadResource("gcp-native:compute/v1:SecurityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
