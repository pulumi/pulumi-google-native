...
func NewSnapshotIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:SnapshotIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotIamPolicy(ctx *pulumi.Context,
	...
	var resource SnapshotIamPolicy
	err := ctx.ReadResource("gcp-native:compute/v1:SnapshotIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
