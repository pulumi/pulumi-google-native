...
func NewTargetInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:TargetInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetInstance(ctx *pulumi.Context,
	...
	var resource TargetInstance
	err := ctx.ReadResource("gcp-native:compute/v1:TargetInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
