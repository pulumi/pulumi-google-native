...
func NewTargetSslProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:TargetSslProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetSslProxy(ctx *pulumi.Context,
	...
	var resource TargetSslProxy
	err := ctx.ReadResource("gcp-native:compute/v1:TargetSslProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
