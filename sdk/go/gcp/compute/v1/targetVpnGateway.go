...
func NewTargetVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:compute/v1:TargetVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetVpnGateway(ctx *pulumi.Context,
	...
	var resource TargetVpnGateway
	err := ctx.ReadResource("gcp-native:compute/v1:TargetVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
