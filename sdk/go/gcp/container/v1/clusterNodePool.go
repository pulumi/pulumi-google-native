...
func NewClusterNodePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:container/v1:ClusterNodePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterNodePool(ctx *pulumi.Context,
	...
	var resource ClusterNodePool
	err := ctx.ReadResource("gcp-native:container/v1:ClusterNodePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
