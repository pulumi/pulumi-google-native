...
func NewNote(ctx *pulumi.Context,
	...
	var resource Note
	err := ctx.RegisterResource("gcp-native:containeranalysis/v1alpha1:Note", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNote(ctx *pulumi.Context,
	...
	var resource Note
	err := ctx.ReadResource("gcp-native:containeranalysis/v1alpha1:Note", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
