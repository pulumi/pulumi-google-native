...
func NewNoteIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:containeranalysis/v1alpha1:NoteIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNoteIamPolicy(ctx *pulumi.Context,
	...
	var resource NoteIamPolicy
	err := ctx.ReadResource("gcp-native:containeranalysis/v1alpha1:NoteIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
