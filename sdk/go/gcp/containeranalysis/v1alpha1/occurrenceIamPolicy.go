...
func NewOccurrenceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:containeranalysis/v1alpha1:OccurrenceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOccurrenceIamPolicy(ctx *pulumi.Context,
	...
	var resource OccurrenceIamPolicy
	err := ctx.ReadResource("gcp-native:containeranalysis/v1alpha1:OccurrenceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
