...
func NewProviderNoteIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:containeranalysis/v1alpha1:ProviderNoteIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProviderNoteIamPolicy(ctx *pulumi.Context,
	...
	var resource ProviderNoteIamPolicy
	err := ctx.ReadResource("gcp-native:containeranalysis/v1alpha1:ProviderNoteIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
