...
func NewNote(ctx *pulumi.Context,
	...
	var resource Note
	err := ctx.RegisterResource("gcp-native:containeranalysis/v1beta1:Note", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNote(ctx *pulumi.Context,
	...
	var resource Note
	err := ctx.ReadResource("gcp-native:containeranalysis/v1beta1:Note", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type NoteState struct {
	// A note describing an attestation role.
	AttestationAuthority AuthorityResponsePtrInput
	// A note describing a base image.
	...
	// A note describing a package vulnerability.
	Vulnerability VulnerabilityResponsePtrInput
}
