...
func NewOccurrence(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:containeranalysis/v1beta1:Occurrence", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOccurrence(ctx *pulumi.Context,
	...
	var resource Occurrence
	err := ctx.ReadResource("gcp-native:containeranalysis/v1beta1:Occurrence", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
