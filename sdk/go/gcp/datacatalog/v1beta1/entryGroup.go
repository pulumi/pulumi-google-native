...
func NewEntryGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datacatalog/v1beta1:EntryGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroup(ctx *pulumi.Context,
	...
	var resource EntryGroup
	err := ctx.ReadResource("gcp-native:datacatalog/v1beta1:EntryGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
