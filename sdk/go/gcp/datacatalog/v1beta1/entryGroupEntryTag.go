...
func NewEntryGroupEntryTag(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datacatalog/v1beta1:EntryGroupEntryTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroupEntryTag(ctx *pulumi.Context,
	...
	var resource EntryGroupEntryTag
	err := ctx.ReadResource("gcp-native:datacatalog/v1beta1:EntryGroupEntryTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
