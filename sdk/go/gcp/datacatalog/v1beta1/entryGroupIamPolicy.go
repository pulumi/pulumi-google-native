...
func NewEntryGroupIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datacatalog/v1beta1:EntryGroupIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroupIamPolicy(ctx *pulumi.Context,
	...
	var resource EntryGroupIamPolicy
	err := ctx.ReadResource("gcp-native:datacatalog/v1beta1:EntryGroupIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
