...
func NewTaxonomy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datacatalog/v1beta1:Taxonomy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaxonomy(ctx *pulumi.Context,
	...
	var resource Taxonomy
	err := ctx.ReadResource("gcp-native:datacatalog/v1beta1:Taxonomy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
