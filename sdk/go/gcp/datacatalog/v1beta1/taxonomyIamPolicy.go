...
func NewTaxonomyIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datacatalog/v1beta1:TaxonomyIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaxonomyIamPolicy(ctx *pulumi.Context,
	...
	var resource TaxonomyIamPolicy
	err := ctx.ReadResource("gcp-native:datacatalog/v1beta1:TaxonomyIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
