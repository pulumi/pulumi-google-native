...
func NewTaxonomyPolicyTag(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datacatalog/v1beta1:TaxonomyPolicyTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaxonomyPolicyTag(ctx *pulumi.Context,
	...
	var resource TaxonomyPolicyTag
	err := ctx.ReadResource("gcp-native:datacatalog/v1beta1:TaxonomyPolicyTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
