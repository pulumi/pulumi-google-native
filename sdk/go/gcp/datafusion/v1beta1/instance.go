...
func NewInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datafusion/v1beta1:Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstance(ctx *pulumi.Context,
	...
	var resource Instance
	err := ctx.ReadResource("gcp-native:datafusion/v1beta1:Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
