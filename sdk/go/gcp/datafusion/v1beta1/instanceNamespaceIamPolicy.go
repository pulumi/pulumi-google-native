...
func NewInstanceNamespaceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datafusion/v1beta1:InstanceNamespaceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceNamespaceIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceNamespaceIamPolicy
	err := ctx.ReadResource("gcp-native:datafusion/v1beta1:InstanceNamespaceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
