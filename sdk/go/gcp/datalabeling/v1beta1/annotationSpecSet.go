...
func NewAnnotationSpecSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datalabeling/v1beta1:AnnotationSpecSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnnotationSpecSet(ctx *pulumi.Context,
	...
	var resource AnnotationSpecSet
	err := ctx.ReadResource("gcp-native:datalabeling/v1beta1:AnnotationSpecSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
