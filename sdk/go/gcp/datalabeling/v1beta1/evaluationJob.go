...
func NewEvaluationJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datalabeling/v1beta1:EvaluationJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEvaluationJob(ctx *pulumi.Context,
	...
	var resource EvaluationJob
	err := ctx.ReadResource("gcp-native:datalabeling/v1beta1:EvaluationJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
