...
func NewMigrationJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datamigration/v1:MigrationJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigrationJob(ctx *pulumi.Context,
	...
	var resource MigrationJob
	err := ctx.ReadResource("gcp-native:datamigration/v1:MigrationJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
