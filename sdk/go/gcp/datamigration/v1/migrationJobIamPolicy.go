...
func NewMigrationJobIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:datamigration/v1:MigrationJobIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigrationJobIamPolicy(ctx *pulumi.Context,
	...
	var resource MigrationJobIamPolicy
	err := ctx.ReadResource("gcp-native:datamigration/v1:MigrationJobIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
