...
func NewAutoscalingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1:AutoscalingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoscalingPolicy(ctx *pulumi.Context,
	...
	var resource AutoscalingPolicy
	err := ctx.ReadResource("gcp-native:dataproc/v1:AutoscalingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
