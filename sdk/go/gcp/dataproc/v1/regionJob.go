...
func NewRegionJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1:RegionJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionJob(ctx *pulumi.Context,
	...
	var resource RegionJob
	err := ctx.ReadResource("gcp-native:dataproc/v1:RegionJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
