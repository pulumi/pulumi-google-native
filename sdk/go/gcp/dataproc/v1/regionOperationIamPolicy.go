...
func NewRegionOperationIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1:RegionOperationIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionOperationIamPolicy(ctx *pulumi.Context,
	...
	var resource RegionOperationIamPolicy
	err := ctx.ReadResource("gcp-native:dataproc/v1:RegionOperationIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
