...
func NewWorkflowTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1:WorkflowTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflowTemplate(ctx *pulumi.Context,
	...
	var resource WorkflowTemplate
	err := ctx.ReadResource("gcp-native:dataproc/v1:WorkflowTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
