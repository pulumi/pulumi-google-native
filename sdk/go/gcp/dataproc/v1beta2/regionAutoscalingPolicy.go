...
func NewRegionAutoscalingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1beta2:RegionAutoscalingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionAutoscalingPolicy(ctx *pulumi.Context,
	...
	var resource RegionAutoscalingPolicy
	err := ctx.ReadResource("gcp-native:dataproc/v1beta2:RegionAutoscalingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
