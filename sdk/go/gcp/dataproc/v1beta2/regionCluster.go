...
func NewRegionCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1beta2:RegionCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionCluster(ctx *pulumi.Context,
	...
	var resource RegionCluster
	err := ctx.ReadResource("gcp-native:dataproc/v1beta2:RegionCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
