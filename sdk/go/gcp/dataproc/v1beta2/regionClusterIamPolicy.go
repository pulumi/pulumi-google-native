...
func NewRegionClusterIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1beta2:RegionClusterIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionClusterIamPolicy(ctx *pulumi.Context,
	...
	var resource RegionClusterIamPolicy
	err := ctx.ReadResource("gcp-native:dataproc/v1beta2:RegionClusterIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
