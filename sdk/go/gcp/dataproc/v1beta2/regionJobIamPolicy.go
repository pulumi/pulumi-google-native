...
func NewRegionJobIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1beta2:RegionJobIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionJobIamPolicy(ctx *pulumi.Context,
	...
	var resource RegionJobIamPolicy
	err := ctx.ReadResource("gcp-native:dataproc/v1beta2:RegionJobIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
