...
func NewWorkflowTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dataproc/v1beta2:WorkflowTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflowTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource WorkflowTemplateIamPolicy
	err := ctx.ReadResource("gcp-native:dataproc/v1beta2:WorkflowTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
