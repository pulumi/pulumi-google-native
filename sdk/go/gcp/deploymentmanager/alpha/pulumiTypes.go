...
// DeploymentOutputEntryInput is an input type that accepts DeploymentOutputEntryArgs and DeploymentOutputEntryOutput values.
// You can construct a concrete instance of `DeploymentOutputEntryInput` via:
//
//          DeploymentOutputEntryArgs{...}
type DeploymentOutputEntryInput interface {
	pulumi.Input

	ToDeploymentOutputEntryOutput() DeploymentOutputEntryOutput
	ToDeploymentOutputEntryOutputWithContext(context.Context) DeploymentOutputEntryOutput
}

// Output object for Deployments
type DeploymentOutputEntryArgs struct {
	// Key of the output
	Key pulumi.StringPtrInput `pulumi:"key"`
	// Value of the label
	Value pulumi.StringPtrInput `pulumi:"value"`
...
func (DeploymentOutputEntryArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DeploymentOutputEntry)(nil)).Elem()
}

func (i DeploymentOutputEntryArgs) ToDeploymentOutputEntryOutput() DeploymentOutputEntryOutput {
	return i.ToDeploymentOutputEntryOutputWithContext(context.Background())
}

func (i DeploymentOutputEntryArgs) ToDeploymentOutputEntryOutputWithContext(ctx context.Context) DeploymentOutputEntryOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DeploymentOutputEntryOutput)
}

// DeploymentOutputEntryArrayInput is an input type that accepts DeploymentOutputEntryArray and DeploymentOutputEntryArrayOutput values.
// You can construct a concrete instance of `DeploymentOutputEntryArrayInput` via:
//
//          DeploymentOutputEntryArray{ DeploymentOutputEntryArgs{...} }
type DeploymentOutputEntryArrayInput interface {
	pulumi.Input

	ToDeploymentOutputEntryArrayOutput() DeploymentOutputEntryArrayOutput
	ToDeploymentOutputEntryArrayOutputWithContext(context.Context) DeploymentOutputEntryArrayOutput
}

type DeploymentOutputEntryArray []DeploymentOutputEntryInput

func (DeploymentOutputEntryArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]DeploymentOutputEntry)(nil)).Elem()
}

func (i DeploymentOutputEntryArray) ToDeploymentOutputEntryArrayOutput() DeploymentOutputEntryArrayOutput {
	return i.ToDeploymentOutputEntryArrayOutputWithContext(context.Background())
}

func (i DeploymentOutputEntryArray) ToDeploymentOutputEntryArrayOutputWithContext(ctx context.Context) DeploymentOutputEntryArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DeploymentOutputEntryArrayOutput)
}

// Output object for Deployments
type DeploymentOutputEntryOutput struct{ *pulumi.OutputState }

func (DeploymentOutputEntryOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DeploymentOutputEntry)(nil)).Elem()
}

func (o DeploymentOutputEntryOutput) ToDeploymentOutputEntryOutput() DeploymentOutputEntryOutput {
	return o
}

func (o DeploymentOutputEntryOutput) ToDeploymentOutputEntryOutputWithContext(ctx context.Context) DeploymentOutputEntryOutput {
	return o
}

// Key of the output
func (o DeploymentOutputEntryOutput) Key() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DeploymentOutputEntry) *string { return v.Key }).(pulumi.StringPtrOutput)
}

// Value of the label
func (o DeploymentOutputEntryOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DeploymentOutputEntry) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type DeploymentOutputEntryArrayOutput struct{ *pulumi.OutputState }

func (DeploymentOutputEntryArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]DeploymentOutputEntry)(nil)).Elem()
}

func (o DeploymentOutputEntryArrayOutput) ToDeploymentOutputEntryArrayOutput() DeploymentOutputEntryArrayOutput {
	return o
}

func (o DeploymentOutputEntryArrayOutput) ToDeploymentOutputEntryArrayOutputWithContext(ctx context.Context) DeploymentOutputEntryArrayOutput {
	return o
}

func (o DeploymentOutputEntryArrayOutput) Index(i pulumi.IntInput) DeploymentOutputEntryOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) DeploymentOutputEntry {
		return vs[0].([]DeploymentOutputEntry)[vs[1].(int)]
	}).(DeploymentOutputEntryOutput)
}
...
type DeploymentUpdateArgs struct {
	// The user-provided default credential to use when deploying this preview.
	Credential CredentialPtrInput `pulumi:"credential"`
	// An optional user-provided description of the deployment after the current update has been applied.
...
// The user-provided default credential to use when deploying this preview.
func (o DeploymentUpdateOutput) Credential() CredentialPtrOutput {
	return o.ApplyT(func(v DeploymentUpdate) *Credential { return v.Credential }).(CredentialPtrOutput)
}
...
// The user-provided default credential to use when deploying this preview.
func (o DeploymentUpdatePtrOutput) Credential() CredentialPtrOutput {
	return o.ApplyT(func(v *DeploymentUpdate) *Credential {
		if v == nil {
			return nil
		}
		return v.Credential
...
func init() {
	...
	pulumi.RegisterOutputType(DeploymentOutputEntryOutput{})
	pulumi.RegisterOutputType(DeploymentOutputEntryArrayOutput{})
