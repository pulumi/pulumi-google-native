...
func NewTypeProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:deploymentmanager/alpha:TypeProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTypeProvider(ctx *pulumi.Context,
	...
	var resource TypeProvider
	err := ctx.ReadResource("gcp-native:deploymentmanager/alpha:TypeProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
