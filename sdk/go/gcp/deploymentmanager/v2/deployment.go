...
func NewDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:deploymentmanager/v2:Deployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeployment(ctx *pulumi.Context,
	...
	var resource Deployment
	err := ctx.ReadResource("gcp-native:deploymentmanager/v2:Deployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
