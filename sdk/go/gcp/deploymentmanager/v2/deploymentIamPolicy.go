...
func NewDeploymentIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:deploymentmanager/v2:DeploymentIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentIamPolicy(ctx *pulumi.Context,
	...
	var resource DeploymentIamPolicy
	err := ctx.ReadResource("gcp-native:deploymentmanager/v2:DeploymentIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
