...
func NewCompositeType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:deploymentmanager/v2beta:CompositeType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCompositeType(ctx *pulumi.Context,
	...
	var resource CompositeType
	err := ctx.ReadResource("gcp-native:deploymentmanager/v2beta:CompositeType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
