...
func NewAgentEnvironmentUserSessionEntityType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v2:AgentEnvironmentUserSessionEntityType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEnvironmentUserSessionEntityType(ctx *pulumi.Context,
	...
	var resource AgentEnvironmentUserSessionEntityType
	err := ctx.ReadResource("gcp-native:dialogflow/v2:AgentEnvironmentUserSessionEntityType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
