...
func NewAgentKnowledgeBase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v2:AgentKnowledgeBase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentKnowledgeBase(ctx *pulumi.Context,
	...
	var resource AgentKnowledgeBase
	err := ctx.ReadResource("gcp-native:dialogflow/v2:AgentKnowledgeBase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
