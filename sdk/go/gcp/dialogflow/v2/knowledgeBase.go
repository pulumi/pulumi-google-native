...
func NewKnowledgeBase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v2:KnowledgeBase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKnowledgeBase(ctx *pulumi.Context,
	...
	var resource KnowledgeBase
	err := ctx.ReadResource("gcp-native:dialogflow/v2:KnowledgeBase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
