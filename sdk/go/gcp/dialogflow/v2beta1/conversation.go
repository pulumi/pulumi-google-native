...
func NewConversation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v2beta1:Conversation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConversation(ctx *pulumi.Context,
	...
	var resource Conversation
	err := ctx.ReadResource("gcp-native:dialogflow/v2beta1:Conversation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
