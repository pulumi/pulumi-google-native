...
func NewConversationProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v2beta1:ConversationProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConversationProfile(ctx *pulumi.Context,
	...
	var resource ConversationProfile
	err := ctx.ReadResource("gcp-native:dialogflow/v2beta1:ConversationProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
