...
func NewAgentEntityType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3:AgentEntityType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEntityType(ctx *pulumi.Context,
	...
	var resource AgentEntityType
	err := ctx.ReadResource("gcp-native:dialogflow/v3:AgentEntityType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
