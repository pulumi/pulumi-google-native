...
func NewAgentSessionEntityType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3:AgentSessionEntityType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentSessionEntityType(ctx *pulumi.Context,
	...
	var resource AgentSessionEntityType
	err := ctx.ReadResource("gcp-native:dialogflow/v3:AgentSessionEntityType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
