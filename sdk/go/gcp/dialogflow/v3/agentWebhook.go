...
func NewAgentWebhook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3:AgentWebhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentWebhook(ctx *pulumi.Context,
	...
	var resource AgentWebhook
	err := ctx.ReadResource("gcp-native:dialogflow/v3:AgentWebhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
