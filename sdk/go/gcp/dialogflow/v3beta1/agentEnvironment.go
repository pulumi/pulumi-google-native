...
func NewAgentEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3beta1:AgentEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEnvironment(ctx *pulumi.Context,
	...
	var resource AgentEnvironment
	err := ctx.ReadResource("gcp-native:dialogflow/v3beta1:AgentEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
