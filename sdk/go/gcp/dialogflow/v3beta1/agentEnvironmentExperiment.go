...
func NewAgentEnvironmentExperiment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3beta1:AgentEnvironmentExperiment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEnvironmentExperiment(ctx *pulumi.Context,
	...
	var resource AgentEnvironmentExperiment
	err := ctx.ReadResource("gcp-native:dialogflow/v3beta1:AgentEnvironmentExperiment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
