...
func NewAgentEnvironmentSessionEntityType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3beta1:AgentEnvironmentSessionEntityType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEnvironmentSessionEntityType(ctx *pulumi.Context,
	...
	var resource AgentEnvironmentSessionEntityType
	err := ctx.ReadResource("gcp-native:dialogflow/v3beta1:AgentEnvironmentSessionEntityType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
