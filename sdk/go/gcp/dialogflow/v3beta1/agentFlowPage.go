...
func NewAgentFlowPage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3beta1:AgentFlowPage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentFlowPage(ctx *pulumi.Context,
	...
	var resource AgentFlowPage
	err := ctx.ReadResource("gcp-native:dialogflow/v3beta1:AgentFlowPage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
