...
func NewAgentFlowVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3beta1:AgentFlowVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentFlowVersion(ctx *pulumi.Context,
	...
	var resource AgentFlowVersion
	err := ctx.ReadResource("gcp-native:dialogflow/v3beta1:AgentFlowVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
