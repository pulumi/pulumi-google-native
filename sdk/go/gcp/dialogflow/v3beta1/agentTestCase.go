...
func NewAgentTestCase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3beta1:AgentTestCase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentTestCase(ctx *pulumi.Context,
	...
	var resource AgentTestCase
	err := ctx.ReadResource("gcp-native:dialogflow/v3beta1:AgentTestCase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
