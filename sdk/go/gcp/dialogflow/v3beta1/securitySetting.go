...
func NewSecuritySetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dialogflow/v3beta1:SecuritySetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecuritySetting(ctx *pulumi.Context,
	...
	var resource SecuritySetting
	err := ctx.ReadResource("gcp-native:dialogflow/v3beta1:SecuritySetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
