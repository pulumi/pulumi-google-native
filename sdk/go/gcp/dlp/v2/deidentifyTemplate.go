...
func NewDeidentifyTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dlp/v2:DeidentifyTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeidentifyTemplate(ctx *pulumi.Context,
	...
	var resource DeidentifyTemplate
	err := ctx.ReadResource("gcp-native:dlp/v2:DeidentifyTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
