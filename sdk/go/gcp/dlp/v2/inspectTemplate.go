...
func NewInspectTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dlp/v2:InspectTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInspectTemplate(ctx *pulumi.Context,
	...
	var resource InspectTemplate
	err := ctx.ReadResource("gcp-native:dlp/v2:InspectTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
