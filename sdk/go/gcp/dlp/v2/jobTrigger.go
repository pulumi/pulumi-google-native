...
func NewJobTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dlp/v2:JobTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobTrigger(ctx *pulumi.Context,
	...
	var resource JobTrigger
	err := ctx.ReadResource("gcp-native:dlp/v2:JobTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
