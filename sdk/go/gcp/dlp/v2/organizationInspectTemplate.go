...
func NewOrganizationInspectTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dlp/v2:OrganizationInspectTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationInspectTemplate(ctx *pulumi.Context,
	...
	var resource OrganizationInspectTemplate
	err := ctx.ReadResource("gcp-native:dlp/v2:OrganizationInspectTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
