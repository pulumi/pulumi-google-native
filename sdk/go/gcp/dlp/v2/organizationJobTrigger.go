...
func NewOrganizationJobTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dlp/v2:OrganizationJobTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationJobTrigger(ctx *pulumi.Context,
	...
	var resource OrganizationJobTrigger
	err := ctx.ReadResource("gcp-native:dlp/v2:OrganizationJobTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
