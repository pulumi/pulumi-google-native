...
func NewResponsePolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:dns/v1beta2:ResponsePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResponsePolicy(ctx *pulumi.Context,
	...
	var resource ResponsePolicy
	err := ctx.ReadResource("gcp-native:dns/v1beta2:ResponsePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
