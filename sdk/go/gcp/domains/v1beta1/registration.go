...
func NewRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:domains/v1beta1:Registration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistration(ctx *pulumi.Context,
	...
	var resource Registration
	err := ctx.ReadResource("gcp-native:domains/v1beta1:Registration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
