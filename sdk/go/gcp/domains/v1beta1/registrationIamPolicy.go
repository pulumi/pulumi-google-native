...
func NewRegistrationIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:domains/v1beta1:RegistrationIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistrationIamPolicy(ctx *pulumi.Context,
	...
	var resource RegistrationIamPolicy
	err := ctx.ReadResource("gcp-native:domains/v1beta1:RegistrationIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
