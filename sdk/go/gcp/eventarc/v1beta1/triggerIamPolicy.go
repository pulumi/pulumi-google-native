...
func NewTriggerIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:eventarc/v1beta1:TriggerIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTriggerIamPolicy(ctx *pulumi.Context,
	...
	var resource TriggerIamPolicy
	err := ctx.ReadResource("gcp-native:eventarc/v1beta1:TriggerIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
