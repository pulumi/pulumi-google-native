...
func NewBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.RegisterResource("gcp-native:file/v1beta1:Backup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackup(ctx *pulumi.Context,
	...
	var resource Backup
	err := ctx.ReadResource("gcp-native:file/v1beta1:Backup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
