...
func NewAndroidApp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:firebase/v1beta1:AndroidApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAndroidApp(ctx *pulumi.Context,
	...
	var resource AndroidApp
	err := ctx.ReadResource("gcp-native:firebase/v1beta1:AndroidApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
