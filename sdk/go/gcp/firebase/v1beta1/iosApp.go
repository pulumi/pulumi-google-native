...
func NewIosApp(ctx *pulumi.Context,
	...
	var resource IosApp
	err := ctx.RegisterResource("gcp-native:firebase/v1beta1:IosApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIosApp(ctx *pulumi.Context,
	...
	var resource IosApp
	err := ctx.ReadResource("gcp-native:firebase/v1beta1:IosApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
