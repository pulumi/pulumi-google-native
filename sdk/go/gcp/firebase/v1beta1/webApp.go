...
func NewWebApp(ctx *pulumi.Context,
	...
	var resource WebApp
	err := ctx.RegisterResource("gcp-native:firebase/v1beta1:WebApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebApp(ctx *pulumi.Context,
	...
	var resource WebApp
	err := ctx.ReadResource("gcp-native:firebase/v1beta1:WebApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
