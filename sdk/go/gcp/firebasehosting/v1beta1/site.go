...
func NewSite(ctx *pulumi.Context,
	...
	var resource Site
	err := ctx.RegisterResource("gcp-native:firebasehosting/v1beta1:Site", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSite(ctx *pulumi.Context,
	...
	var resource Site
	err := ctx.ReadResource("gcp-native:firebasehosting/v1beta1:Site", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
