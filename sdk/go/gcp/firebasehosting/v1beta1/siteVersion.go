...
func NewSiteVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:firebasehosting/v1beta1:SiteVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSiteVersion(ctx *pulumi.Context,
	...
	var resource SiteVersion
	err := ctx.ReadResource("gcp-native:firebasehosting/v1beta1:SiteVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
