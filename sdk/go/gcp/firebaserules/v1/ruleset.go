...
func NewRuleset(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:firebaserules/v1:Ruleset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuleset(ctx *pulumi.Context,
	...
	var resource Ruleset
	err := ctx.ReadResource("gcp-native:firebaserules/v1:Ruleset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
