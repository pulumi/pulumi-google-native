...
func NewRealm(ctx *pulumi.Context,
	...
	var resource Realm
	err := ctx.RegisterResource("gcp-native:gameservices/v1:Realm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRealm(ctx *pulumi.Context,
	...
	var resource Realm
	err := ctx.ReadResource("gcp-native:gameservices/v1:Realm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
