...
func NewRealmGameServerCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:gameservices/v1:RealmGameServerCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRealmGameServerCluster(ctx *pulumi.Context,
	...
	var resource RealmGameServerCluster
	err := ctx.ReadResource("gcp-native:gameservices/v1:RealmGameServerCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
