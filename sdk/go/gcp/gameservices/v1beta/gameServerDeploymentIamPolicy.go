...
func NewGameServerDeploymentIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:gameservices/v1beta:GameServerDeploymentIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGameServerDeploymentIamPolicy(ctx *pulumi.Context,
	...
	var resource GameServerDeploymentIamPolicy
	err := ctx.ReadResource("gcp-native:gameservices/v1beta:GameServerDeploymentIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
