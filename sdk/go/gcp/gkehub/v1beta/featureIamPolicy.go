...
func NewFeatureIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:gkehub/v1beta:FeatureIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureIamPolicy(ctx *pulumi.Context,
	...
	var resource FeatureIamPolicy
	err := ctx.ReadResource("gcp-native:gkehub/v1beta:FeatureIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
