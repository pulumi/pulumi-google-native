...
func NewDataset(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1:Dataset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataset(ctx *pulumi.Context,
	...
	var resource Dataset
	err := ctx.ReadResource("gcp-native:healthcare/v1:Dataset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
