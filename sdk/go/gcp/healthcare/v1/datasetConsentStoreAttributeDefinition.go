...
func NewDatasetConsentStoreAttributeDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1:DatasetConsentStoreAttributeDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreAttributeDefinition(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreAttributeDefinition
	err := ctx.ReadResource("gcp-native:healthcare/v1:DatasetConsentStoreAttributeDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
