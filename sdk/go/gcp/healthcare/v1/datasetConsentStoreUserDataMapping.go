...
func NewDatasetConsentStoreUserDataMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1:DatasetConsentStoreUserDataMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreUserDataMapping(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreUserDataMapping
	err := ctx.ReadResource("gcp-native:healthcare/v1:DatasetConsentStoreUserDataMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
