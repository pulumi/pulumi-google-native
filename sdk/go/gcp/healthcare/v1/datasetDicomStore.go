...
func NewDatasetDicomStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1:DatasetDicomStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetDicomStore(ctx *pulumi.Context,
	...
	var resource DatasetDicomStore
	err := ctx.ReadResource("gcp-native:healthcare/v1:DatasetDicomStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
