...
func NewDatasetDicomStoreIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1:DatasetDicomStoreIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetDicomStoreIamPolicy(ctx *pulumi.Context,
	...
	var resource DatasetDicomStoreIamPolicy
	err := ctx.ReadResource("gcp-native:healthcare/v1:DatasetDicomStoreIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
