...
func NewDatasetAnnotationStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1beta1:DatasetAnnotationStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetAnnotationStore(ctx *pulumi.Context,
	...
	var resource DatasetAnnotationStore
	err := ctx.ReadResource("gcp-native:healthcare/v1beta1:DatasetAnnotationStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
