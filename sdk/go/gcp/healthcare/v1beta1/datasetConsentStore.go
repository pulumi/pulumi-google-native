...
func NewDatasetConsentStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1beta1:DatasetConsentStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStore(ctx *pulumi.Context,
	...
	var resource DatasetConsentStore
	err := ctx.ReadResource("gcp-native:healthcare/v1beta1:DatasetConsentStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
