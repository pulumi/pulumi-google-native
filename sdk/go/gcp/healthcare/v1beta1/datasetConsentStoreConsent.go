...
func NewDatasetConsentStoreConsent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1beta1:DatasetConsentStoreConsent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreConsent(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreConsent
	err := ctx.ReadResource("gcp-native:healthcare/v1beta1:DatasetConsentStoreConsent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
