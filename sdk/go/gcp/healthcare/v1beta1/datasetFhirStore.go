...
func NewDatasetFhirStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:healthcare/v1beta1:DatasetFhirStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetFhirStore(ctx *pulumi.Context,
	...
	var resource DatasetFhirStore
	err := ctx.ReadResource("gcp-native:healthcare/v1beta1:DatasetFhirStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
