...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	...
	case "gcp-native:healthcare/v1beta1:DatasetAnnotationStore":
		r, err = NewDatasetAnnotationStore(ctx, name, nil, pulumi.URN_(urn))
	case "gcp-native:healthcare/v1beta1:DatasetAnnotationStoreAnnotation":
		r, err = NewDatasetAnnotationStoreAnnotation(ctx, name, nil, pulumi.URN_(urn))
	case "gcp-native:healthcare/v1beta1:DatasetAnnotationStoreIamPolicy":
		r, err = NewDatasetAnnotationStoreIamPolicy(ctx, name, nil, pulumi.URN_(urn))
