...
func NewOrganizationRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:iam/v1:OrganizationRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationRole(ctx *pulumi.Context,
	...
	var resource OrganizationRole
	err := ctx.ReadResource("gcp-native:iam/v1:OrganizationRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
