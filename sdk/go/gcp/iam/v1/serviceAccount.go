...
func NewServiceAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:iam/v1:ServiceAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccount(ctx *pulumi.Context,
	...
	var resource ServiceAccount
	err := ctx.ReadResource("gcp-native:iam/v1:ServiceAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
