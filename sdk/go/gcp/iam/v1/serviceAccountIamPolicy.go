...
func NewServiceAccountIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:iam/v1:ServiceAccountIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccountIamPolicy(ctx *pulumi.Context,
	...
	var resource ServiceAccountIamPolicy
	err := ctx.ReadResource("gcp-native:iam/v1:ServiceAccountIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
