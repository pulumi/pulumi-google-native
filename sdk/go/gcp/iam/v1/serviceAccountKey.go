...
func NewServiceAccountKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:iam/v1:ServiceAccountKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccountKey(ctx *pulumi.Context,
	...
	var resource ServiceAccountKey
	err := ctx.ReadResource("gcp-native:iam/v1:ServiceAccountKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
