...
func NewWorkloadIdentityPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:iam/v1:WorkloadIdentityPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadIdentityPool(ctx *pulumi.Context,
	...
	var resource WorkloadIdentityPool
	err := ctx.ReadResource("gcp-native:iam/v1:WorkloadIdentityPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
