...
func NewWorkloadIdentityPoolProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:iam/v1:WorkloadIdentityPoolProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadIdentityPoolProvider(ctx *pulumi.Context,
	...
	var resource WorkloadIdentityPoolProvider
	err := ctx.ReadResource("gcp-native:iam/v1:WorkloadIdentityPoolProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
