...
func NewV1IamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:iap/v1:V1IamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetV1IamPolicy(ctx *pulumi.Context,
	...
	var resource V1IamPolicy
	err := ctx.ReadResource("gcp-native:iap/v1:V1IamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
