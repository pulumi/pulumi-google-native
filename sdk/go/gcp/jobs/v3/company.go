...
func NewCompany(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:jobs/v3:Company", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCompany(ctx *pulumi.Context,
	...
	var resource Company
	err := ctx.ReadResource("gcp-native:jobs/v3:Company", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
