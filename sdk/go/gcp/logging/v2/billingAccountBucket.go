...
func NewBillingAccountBucket(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:logging/v2:BillingAccountBucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingAccountBucket(ctx *pulumi.Context,
	...
	var resource BillingAccountBucket
	err := ctx.ReadResource("gcp-native:logging/v2:BillingAccountBucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
