...
func NewBillingAccountBucketView(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:logging/v2:BillingAccountBucketView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingAccountBucketView(ctx *pulumi.Context,
	...
	var resource BillingAccountBucketView
	err := ctx.ReadResource("gcp-native:logging/v2:BillingAccountBucketView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
