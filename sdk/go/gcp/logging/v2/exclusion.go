...
func NewExclusion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:logging/v2:Exclusion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExclusion(ctx *pulumi.Context,
	...
	var resource Exclusion
	err := ctx.ReadResource("gcp-native:logging/v2:Exclusion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
