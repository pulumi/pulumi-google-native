...
func NewMetric(ctx *pulumi.Context,
	...
	var resource Metric
	err := ctx.RegisterResource("gcp-native:logging/v2:Metric", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetric(ctx *pulumi.Context,
	...
	var resource Metric
	err := ctx.ReadResource("gcp-native:logging/v2:Metric", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
