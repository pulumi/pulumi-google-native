...
func NewOrganizationBucket(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:logging/v2:OrganizationBucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationBucket(ctx *pulumi.Context,
	...
	var resource OrganizationBucket
	err := ctx.ReadResource("gcp-native:logging/v2:OrganizationBucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
