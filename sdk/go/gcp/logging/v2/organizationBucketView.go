...
func NewOrganizationBucketView(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:logging/v2:OrganizationBucketView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationBucketView(ctx *pulumi.Context,
	...
	var resource OrganizationBucketView
	err := ctx.ReadResource("gcp-native:logging/v2:OrganizationBucketView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
