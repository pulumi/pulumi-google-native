...
func NewOrganizationSink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:logging/v2:OrganizationSink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSink(ctx *pulumi.Context,
	...
	var resource OrganizationSink
	err := ctx.ReadResource("gcp-native:logging/v2:OrganizationSink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
