...
func NewSink(ctx *pulumi.Context,
	...
	var resource Sink
	err := ctx.RegisterResource("gcp-native:logging/v2:Sink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSink(ctx *pulumi.Context,
	...
	var resource Sink
	err := ctx.ReadResource("gcp-native:logging/v2:Sink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (*Sink) ElementType() reflect.Type {
	return reflect.TypeOf((*Sink)(nil))
}
