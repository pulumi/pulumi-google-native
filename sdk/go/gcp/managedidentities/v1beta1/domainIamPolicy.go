...
func NewDomainIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:managedidentities/v1beta1:DomainIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainIamPolicy(ctx *pulumi.Context,
	...
	var resource DomainIamPolicy
	err := ctx.ReadResource("gcp-native:managedidentities/v1beta1:DomainIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
