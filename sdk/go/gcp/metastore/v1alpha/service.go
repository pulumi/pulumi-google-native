...
func NewService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:metastore/v1alpha:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetService(ctx *pulumi.Context,
	...
	var resource Service
	err := ctx.ReadResource("gcp-native:metastore/v1alpha:Service", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
