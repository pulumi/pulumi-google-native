...
func NewServiceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:metastore/v1alpha:ServiceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceIamPolicy(ctx *pulumi.Context,
	...
	var resource ServiceIamPolicy
	err := ctx.ReadResource("gcp-native:metastore/v1alpha:ServiceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
