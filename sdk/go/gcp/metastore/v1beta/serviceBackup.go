...
func NewServiceBackup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:metastore/v1beta:ServiceBackup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceBackup(ctx *pulumi.Context,
	...
	var resource ServiceBackup
	err := ctx.ReadResource("gcp-native:metastore/v1beta:ServiceBackup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
