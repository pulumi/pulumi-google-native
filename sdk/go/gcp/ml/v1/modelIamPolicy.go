...
func NewModelIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:ml/v1:ModelIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModelIamPolicy(ctx *pulumi.Context,
	...
	var resource ModelIamPolicy
	err := ctx.ReadResource("gcp-native:ml/v1:ModelIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
