...
func NewStudyTrial(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:ml/v1:StudyTrial", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStudyTrial(ctx *pulumi.Context,
	...
	var resource StudyTrial
	err := ctx.ReadResource("gcp-native:ml/v1:StudyTrial", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
