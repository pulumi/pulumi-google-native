...
func NewDashboard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:monitoring/v1:Dashboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("gcp-native:monitoring/v1:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type DashboardState struct {
	...
	// Content is arranged with a basic layout that re-flows a simple list of informational elements like widgets or tiles.
	GridLayout GridLayoutResponsePtrInput
	// The content is arranged as a grid of tiles, with each content widget occupying one or more grid blocks.
	MosaicLayout MosaicLayoutResponsePtrInput
	// Immutable. The resource name of the dashboard.
	Name pulumi.StringPtrInput
	// The content is divided into equally spaced rows and the widgets are arranged horizontally.
	RowLayout RowLayoutResponsePtrInput
}
