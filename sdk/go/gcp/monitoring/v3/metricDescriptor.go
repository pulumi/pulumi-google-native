...
func NewMetricDescriptor(ctx *pulumi.Context,
	...
	if args.MetricDescriptorsId == nil {
		return nil, errors.New("invalid value for required argument 'MetricDescriptorsId'")
	}
	if args.ProjectsId == nil {
		return nil, errors.New("invalid value for required argument 'ProjectsId'")
	}
	var resource MetricDescriptor
	err := ctx.RegisterResource("gcp-native:monitoring/v3:MetricDescriptor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetricDescriptor(ctx *pulumi.Context,
	...
	var resource MetricDescriptor
	err := ctx.ReadResource("gcp-native:monitoring/v3:MetricDescriptor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type metricDescriptorArgs struct {
	...
	MetricDescriptorsId string                    `pulumi:"metricDescriptorsId"`
	// Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metric_kind and value_type might not be supported.
	MetricKind *string `pulumi:"metricKind"`
	// Read-only. If present, then a time series, which is identified partially by a metric type and a MonitoredResourceDescriptor, that is associated with this metric type can only be associated with one of the monitored resource types listed here.
	MonitoredResourceTypes []string `pulumi:"monitoredResourceTypes"`
...
type MetricDescriptorArgs struct {
	...
	MetricDescriptorsId pulumi.StringInput
	// Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metric_kind and value_type might not be supported.
	MetricKind pulumi.StringPtrInput
	// Read-only. If present, then a time series, which is identified partially by a metric type and a MonitoredResourceDescriptor, that is associated with this metric type can only be associated with one of the monitored resource types listed here.
	MonitoredResourceTypes pulumi.StringArrayInput
