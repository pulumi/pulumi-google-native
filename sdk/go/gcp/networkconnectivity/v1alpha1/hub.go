...
func NewHub(ctx *pulumi.Context,
	...
	var resource Hub
	err := ctx.RegisterResource("gcp-native:networkconnectivity/v1alpha1:Hub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHub(ctx *pulumi.Context,
	...
	var resource Hub
	err := ctx.ReadResource("gcp-native:networkconnectivity/v1alpha1:Hub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
