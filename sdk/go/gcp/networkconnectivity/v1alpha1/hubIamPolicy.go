...
func NewHubIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:networkconnectivity/v1alpha1:HubIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHubIamPolicy(ctx *pulumi.Context,
	...
	var resource HubIamPolicy
	err := ctx.ReadResource("gcp-native:networkconnectivity/v1alpha1:HubIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
