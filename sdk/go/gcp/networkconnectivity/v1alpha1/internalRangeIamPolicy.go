...
func NewInternalRangeIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:networkconnectivity/v1alpha1:InternalRangeIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInternalRangeIamPolicy(ctx *pulumi.Context,
	...
	var resource InternalRangeIamPolicy
	err := ctx.ReadResource("gcp-native:networkconnectivity/v1alpha1:InternalRangeIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
