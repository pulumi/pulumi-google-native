...
func NewPolicyBasedRouteIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:networkconnectivity/v1alpha1:PolicyBasedRouteIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyBasedRouteIamPolicy(ctx *pulumi.Context,
	...
	var resource PolicyBasedRouteIamPolicy
	err := ctx.ReadResource("gcp-native:networkconnectivity/v1alpha1:PolicyBasedRouteIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
