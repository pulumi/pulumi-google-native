...
func NewSpoke(ctx *pulumi.Context,
	...
	var resource Spoke
	err := ctx.RegisterResource("gcp-native:networkconnectivity/v1alpha1:Spoke", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpoke(ctx *pulumi.Context,
	...
	var resource Spoke
	err := ctx.ReadResource("gcp-native:networkconnectivity/v1alpha1:Spoke", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
