...
func NewSpokeIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:networkconnectivity/v1alpha1:SpokeIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpokeIamPolicy(ctx *pulumi.Context,
	...
	var resource SpokeIamPolicy
	err := ctx.ReadResource("gcp-native:networkconnectivity/v1alpha1:SpokeIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
