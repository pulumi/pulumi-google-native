...
func NewConnectivityTestIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:networkmanagement/v1:ConnectivityTestIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectivityTestIamPolicy(ctx *pulumi.Context,
	...
	var resource ConnectivityTestIamPolicy
	err := ctx.ReadResource("gcp-native:networkmanagement/v1:ConnectivityTestIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
