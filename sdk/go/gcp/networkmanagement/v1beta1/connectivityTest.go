...
func NewConnectivityTest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:networkmanagement/v1beta1:ConnectivityTest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectivityTest(ctx *pulumi.Context,
	...
	var resource ConnectivityTest
	err := ctx.ReadResource("gcp-native:networkmanagement/v1beta1:ConnectivityTest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
