...
func NewExecution(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:notebooks/v1:Execution", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExecution(ctx *pulumi.Context,
	...
	var resource Execution
	err := ctx.ReadResource("gcp-native:notebooks/v1:Execution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
