...
func NewSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:notebooks/v1:Schedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchedule(ctx *pulumi.Context,
	...
	var resource Schedule
	err := ctx.ReadResource("gcp-native:notebooks/v1:Schedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
