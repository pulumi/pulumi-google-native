...
func NewFolderPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:orgpolicy/v2:FolderPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderPolicy(ctx *pulumi.Context,
	...
	var resource FolderPolicy
	err := ctx.ReadResource("gcp-native:orgpolicy/v2:FolderPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
