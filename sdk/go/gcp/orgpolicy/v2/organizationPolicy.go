...
func NewOrganizationPolicy(ctx *pulumi.Context,
	...
	if args.PoliciesId == nil {
		return nil, errors.New("invalid value for required argument 'PoliciesId'")
	}
	var resource OrganizationPolicy
	err := ctx.RegisterResource("gcp-native:orgpolicy/v2:OrganizationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationPolicy
	err := ctx.ReadResource("gcp-native:orgpolicy/v2:OrganizationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type organizationPolicyArgs struct {
	...
	PoliciesId      string  `pulumi:"policiesId"`
	// Basic information about the Organization Policy.
