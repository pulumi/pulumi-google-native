...
func NewPatchDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:osconfig/v1:PatchDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPatchDeployment(ctx *pulumi.Context,
	...
	var resource PatchDeployment
	err := ctx.ReadResource("gcp-native:osconfig/v1:PatchDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
