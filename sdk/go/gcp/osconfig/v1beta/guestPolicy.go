...
func NewGuestPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:osconfig/v1beta:GuestPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGuestPolicy(ctx *pulumi.Context,
	...
	var resource GuestPolicy
	err := ctx.ReadResource("gcp-native:osconfig/v1beta:GuestPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
