...
func NewFolderReplay(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:policysimulator/v1:FolderReplay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderReplay(ctx *pulumi.Context,
	...
	var resource FolderReplay
	err := ctx.ReadResource("gcp-native:policysimulator/v1:FolderReplay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
