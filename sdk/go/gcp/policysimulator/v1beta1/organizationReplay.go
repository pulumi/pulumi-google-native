...
func NewOrganizationReplay(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:policysimulator/v1beta1:OrganizationReplay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationReplay(ctx *pulumi.Context,
	...
	var resource OrganizationReplay
	err := ctx.ReadResource("gcp-native:policysimulator/v1beta1:OrganizationReplay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
