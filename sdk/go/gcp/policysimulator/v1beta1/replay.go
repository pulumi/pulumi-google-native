...
func NewReplay(ctx *pulumi.Context,
	...
	var resource Replay
	err := ctx.RegisterResource("gcp-native:policysimulator/v1beta1:Replay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplay(ctx *pulumi.Context,
	...
	var resource Replay
	err := ctx.ReadResource("gcp-native:policysimulator/v1beta1:Replay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
