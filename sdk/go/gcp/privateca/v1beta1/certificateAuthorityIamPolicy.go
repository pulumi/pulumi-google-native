...
func NewCertificateAuthorityIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:privateca/v1beta1:CertificateAuthorityIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateAuthorityIamPolicy(ctx *pulumi.Context,
	...
	var resource CertificateAuthorityIamPolicy
	err := ctx.ReadResource("gcp-native:privateca/v1beta1:CertificateAuthorityIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
