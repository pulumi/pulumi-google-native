...
func NewSchema(ctx *pulumi.Context,
	...
	var resource Schema
	err := ctx.RegisterResource("gcp-native:pubsub/v1:Schema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchema(ctx *pulumi.Context,
	...
	var resource Schema
	err := ctx.ReadResource("gcp-native:pubsub/v1:Schema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
