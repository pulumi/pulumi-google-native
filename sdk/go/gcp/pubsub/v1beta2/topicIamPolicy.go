...
func NewTopicIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:pubsub/v1beta2:TopicIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicIamPolicy(ctx *pulumi.Context,
	...
	var resource TopicIamPolicy
	err := ctx.ReadResource("gcp-native:pubsub/v1beta2:TopicIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
