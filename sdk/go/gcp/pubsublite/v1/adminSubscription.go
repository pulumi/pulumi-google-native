...
func NewAdminSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:pubsublite/v1:AdminSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdminSubscription(ctx *pulumi.Context,
	...
	var resource AdminSubscription
	err := ctx.ReadResource("gcp-native:pubsublite/v1:AdminSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
