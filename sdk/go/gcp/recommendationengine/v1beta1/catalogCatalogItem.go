...
func NewCatalogCatalogItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:recommendationengine/v1beta1:CatalogCatalogItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCatalogCatalogItem(ctx *pulumi.Context,
	...
	var resource CatalogCatalogItem
	err := ctx.ReadResource("gcp-native:recommendationengine/v1beta1:CatalogCatalogItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
