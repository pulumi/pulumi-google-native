...
func NewCatalogEventStorePredictionApiKeyRegistration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:recommendationengine/v1beta1:CatalogEventStorePredictionApiKeyRegistration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCatalogEventStorePredictionApiKeyRegistration(ctx *pulumi.Context,
	...
	var resource CatalogEventStorePredictionApiKeyRegistration
	err := ctx.ReadResource("gcp-native:recommendationengine/v1beta1:CatalogEventStorePredictionApiKeyRegistration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
