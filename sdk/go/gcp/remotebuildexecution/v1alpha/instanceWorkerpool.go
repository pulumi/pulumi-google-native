...
func NewInstanceWorkerpool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:remotebuildexecution/v1alpha:InstanceWorkerpool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceWorkerpool(ctx *pulumi.Context,
	...
	var resource InstanceWorkerpool
	err := ctx.ReadResource("gcp-native:remotebuildexecution/v1alpha:InstanceWorkerpool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
