...
func NewCatalogBranchProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:retail/v2beta:CatalogBranchProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCatalogBranchProduct(ctx *pulumi.Context,
	...
	var resource CatalogBranchProduct
	err := ctx.ReadResource("gcp-native:retail/v2beta:CatalogBranchProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
