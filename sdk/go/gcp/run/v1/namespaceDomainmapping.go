...
func NewNamespaceDomainmapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:run/v1:NamespaceDomainmapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceDomainmapping(ctx *pulumi.Context,
	...
	var resource NamespaceDomainmapping
	err := ctx.ReadResource("gcp-native:run/v1:NamespaceDomainmapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
