...
func NewDomainmapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:run/v1alpha1:Domainmapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainmapping(ctx *pulumi.Context,
	...
	var resource Domainmapping
	err := ctx.ReadResource("gcp-native:run/v1alpha1:Domainmapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
