...
func NewConfigIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:runtimeconfig/v1beta1:ConfigIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigIamPolicy(ctx *pulumi.Context,
	...
	var resource ConfigIamPolicy
	err := ctx.ReadResource("gcp-native:runtimeconfig/v1beta1:ConfigIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
