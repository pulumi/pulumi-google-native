...
func NewConfigVariable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:runtimeconfig/v1beta1:ConfigVariable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigVariable(ctx *pulumi.Context,
	...
	var resource ConfigVariable
	err := ctx.ReadResource("gcp-native:runtimeconfig/v1beta1:ConfigVariable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
