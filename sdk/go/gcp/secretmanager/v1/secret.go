...
func NewSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.RegisterResource("gcp-native:secretmanager/v1:Secret", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.ReadResource("gcp-native:secretmanager/v1:Secret", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
