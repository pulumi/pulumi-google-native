...
func NewSecretIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:secretmanager/v1beta1:SecretIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretIamPolicy(ctx *pulumi.Context,
	...
	var resource SecretIamPolicy
	err := ctx.ReadResource("gcp-native:secretmanager/v1beta1:SecretIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
