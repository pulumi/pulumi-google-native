...
func NewOrganizationNotificationConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:securitycenter/v1:OrganizationNotificationConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationNotificationConfig(ctx *pulumi.Context,
	...
	var resource OrganizationNotificationConfig
	err := ctx.ReadResource("gcp-native:securitycenter/v1:OrganizationNotificationConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
