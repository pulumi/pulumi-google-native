...
func NewOrganizationSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:securitycenter/v1:OrganizationSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSource(ctx *pulumi.Context,
	...
	var resource OrganizationSource
	err := ctx.ReadResource("gcp-native:securitycenter/v1:OrganizationSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
