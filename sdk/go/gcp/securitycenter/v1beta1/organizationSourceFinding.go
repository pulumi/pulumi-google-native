...
func NewOrganizationSourceFinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:securitycenter/v1beta1:OrganizationSourceFinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSourceFinding(ctx *pulumi.Context,
	...
	var resource OrganizationSourceFinding
	err := ctx.ReadResource("gcp-native:securitycenter/v1beta1:OrganizationSourceFinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
