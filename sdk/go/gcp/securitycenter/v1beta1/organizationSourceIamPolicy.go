...
func NewOrganizationSourceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:securitycenter/v1beta1:OrganizationSourceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSourceIamPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationSourceIamPolicy
	err := ctx.ReadResource("gcp-native:securitycenter/v1beta1:OrganizationSourceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
