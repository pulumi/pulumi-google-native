...
func NewServiceTenancyUnit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:serviceconsumermanagement/v1:ServiceTenancyUnit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceTenancyUnit(ctx *pulumi.Context,
	...
	var resource ServiceTenancyUnit
	err := ctx.ReadResource("gcp-native:serviceconsumermanagement/v1:ServiceTenancyUnit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
