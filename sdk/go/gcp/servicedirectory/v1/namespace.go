...
func NewNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:servicedirectory/v1:Namespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespace(ctx *pulumi.Context,
	...
	var resource Namespace
	err := ctx.ReadResource("gcp-native:servicedirectory/v1:Namespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
