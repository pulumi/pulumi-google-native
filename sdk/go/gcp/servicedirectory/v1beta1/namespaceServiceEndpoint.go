...
func NewNamespaceServiceEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:servicedirectory/v1beta1:NamespaceServiceEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceServiceEndpoint(ctx *pulumi.Context,
	...
	var resource NamespaceServiceEndpoint
	err := ctx.ReadResource("gcp-native:servicedirectory/v1beta1:NamespaceServiceEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
