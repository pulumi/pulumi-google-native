...
func NewNamespaceServiceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:servicedirectory/v1beta1:NamespaceServiceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceServiceIamPolicy(ctx *pulumi.Context,
	...
	var resource NamespaceServiceIamPolicy
	err := ctx.ReadResource("gcp-native:servicedirectory/v1beta1:NamespaceServiceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
