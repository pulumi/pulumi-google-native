...
func NewServiceConsumerIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:servicemanagement/v1:ServiceConsumerIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceConsumerIamPolicy(ctx *pulumi.Context,
	...
	var resource ServiceConsumerIamPolicy
	err := ctx.ReadResource("gcp-native:servicemanagement/v1:ServiceConsumerIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
