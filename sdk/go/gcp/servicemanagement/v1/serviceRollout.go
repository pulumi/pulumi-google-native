...
func NewServiceRollout(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:servicemanagement/v1:ServiceRollout", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceRollout(ctx *pulumi.Context,
	...
	var resource ServiceRollout
	err := ctx.ReadResource("gcp-native:servicemanagement/v1:ServiceRollout", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
