...
func NewServiceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:servicenetworking/v1beta:ServiceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceConnection(ctx *pulumi.Context,
	...
	var resource ServiceConnection
	err := ctx.ReadResource("gcp-native:servicenetworking/v1beta:ServiceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
