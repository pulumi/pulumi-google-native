...
func NewRepo(ctx *pulumi.Context,
	...
	var resource Repo
	err := ctx.RegisterResource("gcp-native:sourcerepo/v1:Repo", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepo(ctx *pulumi.Context,
	...
	var resource Repo
	err := ctx.ReadResource("gcp-native:sourcerepo/v1:Repo", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
