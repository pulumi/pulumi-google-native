...
func NewRepoIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:sourcerepo/v1:RepoIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepoIamPolicy(ctx *pulumi.Context,
	...
	var resource RepoIamPolicy
	err := ctx.ReadResource("gcp-native:sourcerepo/v1:RepoIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
