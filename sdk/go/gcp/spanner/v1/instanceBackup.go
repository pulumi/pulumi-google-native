...
func NewInstanceBackup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:spanner/v1:InstanceBackup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceBackup(ctx *pulumi.Context,
	...
	var resource InstanceBackup
	err := ctx.ReadResource("gcp-native:spanner/v1:InstanceBackup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
