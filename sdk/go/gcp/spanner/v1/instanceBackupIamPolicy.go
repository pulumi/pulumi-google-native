...
func NewInstanceBackupIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:spanner/v1:InstanceBackupIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceBackupIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceBackupIamPolicy
	err := ctx.ReadResource("gcp-native:spanner/v1:InstanceBackupIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
