...
func NewInstanceDatabaseIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:spanner/v1:InstanceDatabaseIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceDatabaseIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceDatabaseIamPolicy
	err := ctx.ReadResource("gcp-native:spanner/v1:InstanceDatabaseIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
