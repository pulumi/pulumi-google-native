...
func NewInstanceDatabaseSession(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:spanner/v1:InstanceDatabaseSession", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceDatabaseSession(ctx *pulumi.Context,
	...
	var resource InstanceDatabaseSession
	err := ctx.ReadResource("gcp-native:spanner/v1:InstanceDatabaseSession", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
