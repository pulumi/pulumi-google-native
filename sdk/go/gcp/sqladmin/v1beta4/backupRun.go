...
func NewBackupRun(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:sqladmin/v1beta4:BackupRun", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupRun(ctx *pulumi.Context,
	...
	var resource BackupRun
	err := ctx.ReadResource("gcp-native:sqladmin/v1beta4:BackupRun", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
