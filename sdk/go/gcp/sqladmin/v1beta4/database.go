...
func NewDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:sqladmin/v1beta4:Database", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabase(ctx *pulumi.Context,
	...
	var resource Database
	err := ctx.ReadResource("gcp-native:sqladmin/v1beta4:Database", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
