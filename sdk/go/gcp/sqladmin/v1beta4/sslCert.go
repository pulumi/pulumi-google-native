...
func NewSslCert(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:sqladmin/v1beta4:SslCert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslCert(ctx *pulumi.Context,
	...
	var resource SslCert
	err := ctx.ReadResource("gcp-native:sqladmin/v1beta4:SslCert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
