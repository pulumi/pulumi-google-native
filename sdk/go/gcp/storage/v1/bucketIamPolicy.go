...
func NewBucketIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:storage/v1:BucketIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketIamPolicy(ctx *pulumi.Context,
	...
	var resource BucketIamPolicy
	err := ctx.ReadResource("gcp-native:storage/v1:BucketIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
