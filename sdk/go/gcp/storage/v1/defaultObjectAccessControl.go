...
func NewDefaultObjectAccessControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:storage/v1:DefaultObjectAccessControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultObjectAccessControl(ctx *pulumi.Context,
	...
	var resource DefaultObjectAccessControl
	err := ctx.ReadResource("gcp-native:storage/v1:DefaultObjectAccessControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
