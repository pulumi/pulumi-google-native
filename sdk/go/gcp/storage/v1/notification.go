...
func NewNotification(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:storage/v1:Notification", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotification(ctx *pulumi.Context,
	...
	var resource Notification
	err := ctx.ReadResource("gcp-native:storage/v1:Notification", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
