...
func NewObjectAccessControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:storage/v1:ObjectAccessControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetObjectAccessControl(ctx *pulumi.Context,
	...
	var resource ObjectAccessControl
	err := ctx.ReadResource("gcp-native:storage/v1:ObjectAccessControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
