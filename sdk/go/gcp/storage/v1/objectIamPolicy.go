...
func NewObjectIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:storage/v1:ObjectIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetObjectIamPolicy(ctx *pulumi.Context,
	...
	var resource ObjectIamPolicy
	err := ctx.ReadResource("gcp-native:storage/v1:ObjectIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
