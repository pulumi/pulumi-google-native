...
func NewTransferJob(ctx *pulumi.Context,
	...
	if args.TransferJobsId == nil {
		return nil, errors.New("invalid value for required argument 'TransferJobsId'")
	}
	var resource TransferJob
	err := ctx.RegisterResource("gcp-native:storagetransfer/v1:TransferJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransferJob(ctx *pulumi.Context,
	...
	var resource TransferJob
	err := ctx.ReadResource("gcp-native:storagetransfer/v1:TransferJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type transferJobArgs struct {
	...
	// Status of the job. This value MUST be specified for `CreateTransferJobRequests`. **Note:** The effect of the new job status takes place during a subsequent job run. For example, if you change the job status from ENABLED to DISABLED, and an operation spawned by the transfer is running, the status change would not affect the current operation.
	Status         *string `pulumi:"status"`
	TransferJobsId string  `pulumi:"transferJobsId"`
	// Transfer specification.
...
type TransferJobArgs struct {
	...
	// Status of the job. This value MUST be specified for `CreateTransferJobRequests`. **Note:** The effect of the new job status takes place during a subsequent job run. For example, if you change the job status from ENABLED to DISABLED, and an operation spawned by the transfer is running, the status change would not affect the current operation.
	Status         pulumi.StringPtrInput
	TransferJobsId pulumi.StringInput
	// Transfer specification.
