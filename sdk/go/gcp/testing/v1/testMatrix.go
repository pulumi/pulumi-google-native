...
func NewTestMatrix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:testing/v1:TestMatrix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTestMatrix(ctx *pulumi.Context,
	...
	var resource TestMatrix
	err := ctx.ReadResource("gcp-native:testing/v1:TestMatrix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
