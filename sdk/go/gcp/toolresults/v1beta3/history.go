...
func NewHistory(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:toolresults/v1beta3:History", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHistory(ctx *pulumi.Context,
	...
	var resource History
	err := ctx.ReadResource("gcp-native:toolresults/v1beta3:History", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
