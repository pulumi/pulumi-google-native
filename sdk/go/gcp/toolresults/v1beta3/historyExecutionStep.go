...
func NewHistoryExecutionStep(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:toolresults/v1beta3:HistoryExecutionStep", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHistoryExecutionStep(ctx *pulumi.Context,
	...
	var resource HistoryExecutionStep
	err := ctx.ReadResource("gcp-native:toolresults/v1beta3:HistoryExecutionStep", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
