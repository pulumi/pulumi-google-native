...
func NewHistoryExecutionStepPerfSampleSeries(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:toolresults/v1beta3:HistoryExecutionStepPerfSampleSeries", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHistoryExecutionStepPerfSampleSeries(ctx *pulumi.Context,
	...
	var resource HistoryExecutionStepPerfSampleSeries
	err := ctx.ReadResource("gcp-native:toolresults/v1beta3:HistoryExecutionStepPerfSampleSeries", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
