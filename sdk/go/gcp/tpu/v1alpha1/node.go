...
func NewNode(ctx *pulumi.Context,
	...
	var resource Node
	err := ctx.RegisterResource("gcp-native:tpu/v1alpha1:Node", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNode(ctx *pulumi.Context,
	...
	var resource Node
	err := ctx.ReadResource("gcp-native:tpu/v1alpha1:Node", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
