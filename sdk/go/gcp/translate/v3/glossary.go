...
func NewGlossary(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:translate/v3:Glossary", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlossary(ctx *pulumi.Context,
	...
	var resource Glossary
	err := ctx.ReadResource("gcp-native:translate/v3:Glossary", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
