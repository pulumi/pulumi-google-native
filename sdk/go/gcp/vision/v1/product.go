...
func NewProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:vision/v1:Product", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProduct(ctx *pulumi.Context,
	...
	var resource Product
	err := ctx.ReadResource("gcp-native:vision/v1:Product", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
