...
func NewProductSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:vision/v1:ProductSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductSet(ctx *pulumi.Context,
	...
	var resource ProductSet
	err := ctx.ReadResource("gcp-native:vision/v1:ProductSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
