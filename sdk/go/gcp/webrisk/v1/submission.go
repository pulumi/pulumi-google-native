...
func NewSubmission(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:webrisk/v1:Submission", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubmission(ctx *pulumi.Context,
	...
	var resource Submission
	err := ctx.ReadResource("gcp-native:webrisk/v1:Submission", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
