...
func NewScanConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:websecurityscanner/v1beta:ScanConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScanConfig(ctx *pulumi.Context,
	...
	var resource ScanConfig
	err := ctx.ReadResource("gcp-native:websecurityscanner/v1beta:ScanConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
