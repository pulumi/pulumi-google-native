...
func NewWorkflow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp-native:workflows/v1beta:Workflow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflow(ctx *pulumi.Context,
	...
	var resource Workflow
	err := ctx.ReadResource("gcp-native:workflows/v1beta:Workflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
