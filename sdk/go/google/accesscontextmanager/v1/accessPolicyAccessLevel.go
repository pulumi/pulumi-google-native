...
func NewAccessPolicyAccessLevel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:accesscontextmanager/v1:AccessPolicyAccessLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessPolicyAccessLevel(ctx *pulumi.Context,
	...
	var resource AccessPolicyAccessLevel
	err := ctx.ReadResource("google-cloud:accesscontextmanager/v1:AccessPolicyAccessLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
