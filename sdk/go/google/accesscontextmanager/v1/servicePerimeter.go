...
func NewServicePerimeter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:accesscontextmanager/v1:ServicePerimeter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServicePerimeter(ctx *pulumi.Context,
	...
	var resource ServicePerimeter
	err := ctx.ReadResource("google-cloud:accesscontextmanager/v1:ServicePerimeter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
