...
func NewAccessLevel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:accesscontextmanager/v1beta:AccessLevel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessLevel(ctx *pulumi.Context,
	...
	var resource AccessLevel
	err := ctx.ReadResource("google-cloud:accesscontextmanager/v1beta:AccessLevel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
