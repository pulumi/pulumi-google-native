...
func NewArtifact(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:Artifact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifact(ctx *pulumi.Context,
	...
	var resource Artifact
	err := ctx.ReadResource("google-native:aiplatform/v1:Artifact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
