...
func NewContext(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:Context", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContext(ctx *pulumi.Context,
	...
	var resource Context
	err := ctx.ReadResource("google-native:aiplatform/v1:Context", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
