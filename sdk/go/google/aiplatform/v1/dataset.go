...
func NewDataset(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:Dataset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataset(ctx *pulumi.Context,
	...
	var resource Dataset
	err := ctx.ReadResource("google-native:aiplatform/v1:Dataset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type datasetArgs struct {
	...
	// All SavedQueries belong to the Dataset will be returned in List/Get Dataset response. The annotation_specs field will not be populated except for UI cases which will only use annotation_spec_count. In CreateDataset request, a SavedQuery is created together if this field is set, up to one SavedQuery can be set in CreateDatasetRequest. The SavedQuery should not contain any AnnotationSpec.
	SavedQueries []GoogleCloudAiplatformV1SavedQuery `pulumi:"savedQueries"`
}
...
// Customer-managed encryption key spec for a Dataset. If set, this Dataset and all sub-resources of this Dataset will be secured by this key.
func (o DatasetOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *Dataset) GoogleCloudAiplatformV1EncryptionSpecResponseOutput { return v.EncryptionSpec }).(GoogleCloudAiplatformV1EncryptionSpecResponseOutput)
}
...
// All SavedQueries belong to the Dataset will be returned in List/Get Dataset response. The annotation_specs field will not be populated except for UI cases which will only use annotation_spec_count. In CreateDataset request, a SavedQuery is created together if this field is set, up to one SavedQuery can be set in CreateDatasetRequest. The SavedQuery should not contain any AnnotationSpec.
func (o DatasetOutput) SavedQueries() GoogleCloudAiplatformV1SavedQueryResponseArrayOutput {
	return o.ApplyT(func(v *Dataset) GoogleCloudAiplatformV1SavedQueryResponseArrayOutput { return v.SavedQueries }).(GoogleCloudAiplatformV1SavedQueryResponseArrayOutput)
}
