...
func NewDatasetVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:DatasetVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetVersion(ctx *pulumi.Context,
	...
	var resource DatasetVersion
	err := ctx.ReadResource("google-native:aiplatform/v1:DatasetVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
