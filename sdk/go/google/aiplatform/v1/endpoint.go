...
func NewEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:Endpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpoint(ctx *pulumi.Context,
	...
	var resource Endpoint
	err := ctx.ReadResource("google-native:aiplatform/v1:Endpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The models deployed in this Endpoint. To add or remove DeployedModels use EndpointService.DeployModel and EndpointService.UndeployModel respectively.
func (o EndpointOutput) DeployedModels() GoogleCloudAiplatformV1DeployedModelResponseArrayOutput {
	return o.ApplyT(func(v *Endpoint) GoogleCloudAiplatformV1DeployedModelResponseArrayOutput { return v.DeployedModels }).(GoogleCloudAiplatformV1DeployedModelResponseArrayOutput)
}
...
// Customer-managed encryption key spec for an Endpoint. If set, this Endpoint and all sub-resources of this Endpoint will be secured by this key.
func (o EndpointOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *Endpoint) GoogleCloudAiplatformV1EncryptionSpecResponseOutput { return v.EncryptionSpec }).(GoogleCloudAiplatformV1EncryptionSpecResponseOutput)
}
...
// Configures the request-response logging for online prediction.
func (o EndpointOutput) PredictRequestResponseLoggingConfig() GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponseOutput {
	return o.ApplyT(func(v *Endpoint) GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponseOutput {
