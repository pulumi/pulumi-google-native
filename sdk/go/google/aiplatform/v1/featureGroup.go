...
func NewFeatureGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:FeatureGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureGroup(ctx *pulumi.Context,
	...
	var resource FeatureGroup
	err := ctx.ReadResource("google-native:aiplatform/v1:FeatureGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type featureGroupArgs struct {
	// Indicates that features for this group come from BigQuery Table/View. By default treats the source as a sparse time series source, which is required to have an entity_id and a feature_timestamp column in the source.
	BigQuery *GoogleCloudAiplatformV1FeatureGroupBigQuery `pulumi:"bigQuery"`
	// Optional. Description of the FeatureGroup.
...
// Indicates that features for this group come from BigQuery Table/View. By default treats the source as a sparse time series source, which is required to have an entity_id and a feature_timestamp column in the source.
func (o FeatureGroupOutput) BigQuery() GoogleCloudAiplatformV1FeatureGroupBigQueryResponseOutput {
	return o.ApplyT(func(v *FeatureGroup) GoogleCloudAiplatformV1FeatureGroupBigQueryResponseOutput { return v.BigQuery }).(GoogleCloudAiplatformV1FeatureGroupBigQueryResponseOutput)
}
