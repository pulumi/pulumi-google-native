...
func NewFeatureOnlineStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:FeatureOnlineStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureOnlineStore(ctx *pulumi.Context,
	...
	var resource FeatureOnlineStore
	err := ctx.ReadResource("google-native:aiplatform/v1:FeatureOnlineStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Contains settings for the Cloud Bigtable instance that will be created to serve featureValues for all FeatureViews under this FeatureOnlineStore.
func (o FeatureOnlineStoreOutput) Bigtable() GoogleCloudAiplatformV1FeatureOnlineStoreBigtableResponseOutput {
	return o.ApplyT(func(v *FeatureOnlineStore) GoogleCloudAiplatformV1FeatureOnlineStoreBigtableResponseOutput {
		return v.Bigtable
