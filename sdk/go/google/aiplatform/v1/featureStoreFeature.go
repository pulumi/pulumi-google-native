...
func NewFeatureStoreFeature(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:FeatureStoreFeature", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureStoreFeature(ctx *pulumi.Context,
	...
	var resource FeatureStoreFeature
	err := ctx.ReadResource("google-native:aiplatform/v1:FeatureStoreFeature", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *FeatureStoreFeature) ToOutput(ctx context.Context) pulumix.Output[*FeatureStoreFeature] {
	return pulumix.Output[*FeatureStoreFeature]{
		OutputState: i.ToFeatureStoreFeatureOutputWithContext(ctx).OutputState,
	}
}
...
func (o FeatureStoreFeatureOutput) ToOutput(ctx context.Context) pulumix.Output[*FeatureStoreFeature] {
	return pulumix.Output[*FeatureStoreFeature]{
...
// Only applicable for Vertex AI Feature Store (Legacy). The list of historical stats and anomalies with specified objectives.
func (o FeatureStoreFeatureOutput) MonitoringStatsAnomalies() GoogleCloudAiplatformV1FeatureMonitoringStatsAnomalyResponseArrayOutput {
	return o.ApplyT(func(v *FeatureStoreFeature) GoogleCloudAiplatformV1FeatureMonitoringStatsAnomalyResponseArrayOutput {
