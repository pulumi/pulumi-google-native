...
func LookupDataLabelingJob(ctx *pulumi.Context, args *LookupDataLabelingJobArgs, opts ...pulumi.InvokeOption) (*LookupDataLabelingJobResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getDataLabelingJob", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupDataLabelingJobResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDataLabelingJobResult] {
	return pulumix.Output[LookupDataLabelingJobResult]{
		OutputState: o.OutputState,
	}
}

// Parameters that configure the active learning pipeline. Active learning will label the data incrementally via several iterations. For every iteration, it will select a batch of data based on the sampling strategy.
func (o LookupDataLabelingJobResultOutput) ActiveLearningConfig() GoogleCloudAiplatformV1ActiveLearningConfigResponseOutput {
	return o.ApplyT(func(v LookupDataLabelingJobResult) GoogleCloudAiplatformV1ActiveLearningConfigResponse {
...
// Customer-managed encryption key spec for a DataLabelingJob. If set, this DataLabelingJob will be secured by this key. Note: Annotations created in the DataLabelingJob are associated with the EncryptionSpec of the Dataset they are exported to.
func (o LookupDataLabelingJobResultOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupDataLabelingJobResult) GoogleCloudAiplatformV1EncryptionSpecResponse {
