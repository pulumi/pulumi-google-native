...
func LookupDataset(ctx *pulumi.Context, args *LookupDatasetArgs, opts ...pulumi.InvokeOption) (*LookupDatasetResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getDataset", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Customer-managed encryption key spec for a Dataset. If set, this Dataset and all sub-resources of this Dataset will be secured by this key.
func (o LookupDatasetResultOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupDatasetResult) GoogleCloudAiplatformV1EncryptionSpecResponse { return v.EncryptionSpec }).(GoogleCloudAiplatformV1EncryptionSpecResponseOutput)
}
...
// All SavedQueries belong to the Dataset will be returned in List/Get Dataset response. The annotation_specs field will not be populated except for UI cases which will only use annotation_spec_count. In CreateDataset request, a SavedQuery is created together if this field is set, up to one SavedQuery can be set in CreateDatasetRequest. The SavedQuery should not contain any AnnotationSpec.
func (o LookupDatasetResultOutput) SavedQueries() GoogleCloudAiplatformV1SavedQueryResponseArrayOutput {
	return o.ApplyT(func(v LookupDatasetResult) []GoogleCloudAiplatformV1SavedQueryResponse { return v.SavedQueries }).(GoogleCloudAiplatformV1SavedQueryResponseArrayOutput)
}
