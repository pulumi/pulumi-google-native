...
func LookupEndpoint(ctx *pulumi.Context, args *LookupEndpointArgs, opts ...pulumi.InvokeOption) (*LookupEndpointResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The models deployed in this Endpoint. To add or remove DeployedModels use EndpointService.DeployModel and EndpointService.UndeployModel respectively.
func (o LookupEndpointResultOutput) DeployedModels() GoogleCloudAiplatformV1DeployedModelResponseArrayOutput {
	return o.ApplyT(func(v LookupEndpointResult) []GoogleCloudAiplatformV1DeployedModelResponse { return v.DeployedModels }).(GoogleCloudAiplatformV1DeployedModelResponseArrayOutput)
}
...
// Customer-managed encryption key spec for an Endpoint. If set, this Endpoint and all sub-resources of this Endpoint will be secured by this key.
func (o LookupEndpointResultOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupEndpointResult) GoogleCloudAiplatformV1EncryptionSpecResponse { return v.EncryptionSpec }).(GoogleCloudAiplatformV1EncryptionSpecResponseOutput)
}
...
// Configures the request-response logging for online prediction.
func (o LookupEndpointResultOutput) PredictRequestResponseLoggingConfig() GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponseOutput {
	return o.ApplyT(func(v LookupEndpointResult) GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponse {
		return v.PredictRequestResponseLoggingConfig
	}).(GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponseOutput)
}
