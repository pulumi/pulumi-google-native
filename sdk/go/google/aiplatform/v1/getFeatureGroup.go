...
func LookupFeatureGroup(ctx *pulumi.Context, args *LookupFeatureGroupArgs, opts ...pulumi.InvokeOption) (*LookupFeatureGroupResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getFeatureGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Indicates that features for this group come from BigQuery Table/View. By default treats the source as a sparse time series source, which is required to have an entity_id and a feature_timestamp column in the source.
func (o LookupFeatureGroupResultOutput) BigQuery() GoogleCloudAiplatformV1FeatureGroupBigQueryResponseOutput {
	return o.ApplyT(func(v LookupFeatureGroupResult) GoogleCloudAiplatformV1FeatureGroupBigQueryResponse {
		return v.BigQuery
	}).(GoogleCloudAiplatformV1FeatureGroupBigQueryResponseOutput)
}
