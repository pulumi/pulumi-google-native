...
func LookupFeaturestore(ctx *pulumi.Context, args *LookupFeaturestoreArgs, opts ...pulumi.InvokeOption) (*LookupFeaturestoreResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getFeaturestore", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Optional. Customer-managed encryption key spec for data storage. If set, both of the online and offline data storage will be secured by this key.
func (o LookupFeaturestoreResultOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupFeaturestoreResult) GoogleCloudAiplatformV1EncryptionSpecResponse {
...
// Optional. Config for online storage resources. The field should not co-exist with the field of `OnlineStoreReplicationConfig`. If both of it and OnlineStoreReplicationConfig are unset, the feature store will not have an online store and cannot be used for online serving.
func (o LookupFeaturestoreResultOutput) OnlineServingConfig() GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigResponseOutput {
	return o.ApplyT(func(v LookupFeaturestoreResult) GoogleCloudAiplatformV1FeaturestoreOnlineServingConfigResponse {
