...
func LookupHyperparameterTuningJob(ctx *pulumi.Context, args *LookupHyperparameterTuningJobArgs, opts ...pulumi.InvokeOption) (*LookupHyperparameterTuningJobResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getHyperparameterTuningJob", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Customer-managed encryption key options for a HyperparameterTuningJob. If this is set, then all resources created by the HyperparameterTuningJob will be encrypted with the provided encryption key.
func (o LookupHyperparameterTuningJobResultOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupHyperparameterTuningJobResult) GoogleCloudAiplatformV1EncryptionSpecResponse {
...
// Study configuration of the HyperparameterTuningJob.
func (o LookupHyperparameterTuningJobResultOutput) StudySpec() GoogleCloudAiplatformV1StudySpecResponseOutput {
	return o.ApplyT(func(v LookupHyperparameterTuningJobResult) GoogleCloudAiplatformV1StudySpecResponse {
		return v.StudySpec
	}).(GoogleCloudAiplatformV1StudySpecResponseOutput)
}

// The spec of a trial job. The same spec applies to the CustomJobs created in all the trials.
func (o LookupHyperparameterTuningJobResultOutput) TrialJobSpec() GoogleCloudAiplatformV1CustomJobSpecResponseOutput {
	return o.ApplyT(func(v LookupHyperparameterTuningJobResult) GoogleCloudAiplatformV1CustomJobSpecResponse {
		return v.TrialJobSpec
	}).(GoogleCloudAiplatformV1CustomJobSpecResponseOutput)
}

// Trials of the HyperparameterTuningJob.
func (o LookupHyperparameterTuningJobResultOutput) Trials() GoogleCloudAiplatformV1TrialResponseArrayOutput {
	return o.ApplyT(func(v LookupHyperparameterTuningJobResult) []GoogleCloudAiplatformV1TrialResponse { return v.Trials }).(GoogleCloudAiplatformV1TrialResponseArrayOutput)
}
