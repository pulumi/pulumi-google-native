...
func LookupIndex(ctx *pulumi.Context, args *LookupIndexArgs, opts ...pulumi.InvokeOption) (*LookupIndexResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getIndex", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The pointers to DeployedIndexes created from this Index. An Index can be only deleted if all its DeployedIndexes had been undeployed first.
func (o LookupIndexResultOutput) DeployedIndexes() GoogleCloudAiplatformV1DeployedIndexRefResponseArrayOutput {
	return o.ApplyT(func(v LookupIndexResult) []GoogleCloudAiplatformV1DeployedIndexRefResponse { return v.DeployedIndexes }).(GoogleCloudAiplatformV1DeployedIndexRefResponseArrayOutput)
}
...
// Immutable. Customer-managed encryption key spec for an Index. If set, this Index and all sub-resources of this Index will be secured by this key.
func (o LookupIndexResultOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupIndexResult) GoogleCloudAiplatformV1EncryptionSpecResponse { return v.EncryptionSpec }).(GoogleCloudAiplatformV1EncryptionSpecResponseOutput)
}
...
// Stats of the index resource.
func (o LookupIndexResultOutput) IndexStats() GoogleCloudAiplatformV1IndexStatsResponseOutput {
	return o.ApplyT(func(v LookupIndexResult) GoogleCloudAiplatformV1IndexStatsResponse { return v.IndexStats }).(GoogleCloudAiplatformV1IndexStatsResponseOutput)
}
