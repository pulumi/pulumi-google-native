...
func LookupModelDeploymentMonitoringJob(ctx *pulumi.Context, args *LookupModelDeploymentMonitoringJobArgs, opts ...pulumi.InvokeOption) (*LookupModelDeploymentMonitoringJobResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getModelDeploymentMonitoringJob", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The created bigquery tables for the job under customer project. Customer could do their own query & analysis. There could be 4 log tables in maximum: 1. Training data logging predict request/response 2. Serving data logging predict request/response
func (o LookupModelDeploymentMonitoringJobResultOutput) BigqueryTables() GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponseArrayOutput {
	return o.ApplyT(func(v LookupModelDeploymentMonitoringJobResult) []GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse {
...
// Customer-managed encryption key spec for a ModelDeploymentMonitoringJob. If set, this ModelDeploymentMonitoringJob and all sub-resources of this ModelDeploymentMonitoringJob will be secured by this key.
func (o LookupModelDeploymentMonitoringJobResultOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupModelDeploymentMonitoringJobResult) GoogleCloudAiplatformV1EncryptionSpecResponse {
...
// Latest triggered monitoring pipeline metadata.
func (o LookupModelDeploymentMonitoringJobResultOutput) LatestMonitoringPipelineMetadata() GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponseOutput {
	return o.ApplyT(func(v LookupModelDeploymentMonitoringJobResult) GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse {
...
// Sample Strategy for logging.
func (o LookupModelDeploymentMonitoringJobResultOutput) LoggingSamplingStrategy() GoogleCloudAiplatformV1SamplingStrategyResponseOutput {
	return o.ApplyT(func(v LookupModelDeploymentMonitoringJobResult) GoogleCloudAiplatformV1SamplingStrategyResponse {
		return v.LoggingSamplingStrategy
	}).(GoogleCloudAiplatformV1SamplingStrategyResponseOutput)
}

// The config for monitoring objectives. This is a per DeployedModel config. Each DeployedModel needs to be configured separately.
func (o LookupModelDeploymentMonitoringJobResultOutput) ModelDeploymentMonitoringObjectiveConfigs() GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponseArrayOutput {
	return o.ApplyT(func(v LookupModelDeploymentMonitoringJobResult) []GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse {
...
// Schedule config for running the monitoring job.
func (o LookupModelDeploymentMonitoringJobResultOutput) ModelDeploymentMonitoringScheduleConfig() GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponseOutput {
	return o.ApplyT(func(v LookupModelDeploymentMonitoringJobResult) GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse {
...
// Alert config for model monitoring.
func (o LookupModelDeploymentMonitoringJobResultOutput) ModelMonitoringAlertConfig() GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponseOutput {
	return o.ApplyT(func(v LookupModelDeploymentMonitoringJobResult) GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse {
...
// Stats anomalies base folder path.
func (o LookupModelDeploymentMonitoringJobResultOutput) StatsAnomaliesBaseDirectory() GoogleCloudAiplatformV1GcsDestinationResponseOutput {
	return o.ApplyT(func(v LookupModelDeploymentMonitoringJobResult) GoogleCloudAiplatformV1GcsDestinationResponse {
