...
func LookupPersistentResource(ctx *pulumi.Context, args *LookupPersistentResourceArgs, opts ...pulumi.InvokeOption) (*LookupPersistentResourceResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getPersistentResource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupPersistentResourceResult struct {
	...
	ResourcePools []GoogleCloudAiplatformV1ResourcePoolResponse `pulumi:"resourcePools"`
	// Runtime information of the Persistent Resource.
	ResourceRuntime GoogleCloudAiplatformV1ResourceRuntimeResponse `pulumi:"resourceRuntime"`
	// Optional. Persistent Resource runtime spec. For example, used for Ray cluster configuration.
	ResourceRuntimeSpec GoogleCloudAiplatformV1ResourceRuntimeSpecResponse `pulumi:"resourceRuntimeSpec"`
...
// Optional. Customer-managed encryption key spec for a PersistentResource. If set, this PersistentResource and all sub-resources of this PersistentResource will be secured by this key.
func (o LookupPersistentResourceResultOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupPersistentResourceResult) GoogleCloudAiplatformV1EncryptionSpecResponse {
...
// The spec of the pools of different resources.
func (o LookupPersistentResourceResultOutput) ResourcePools() GoogleCloudAiplatformV1ResourcePoolResponseArrayOutput {
	return o.ApplyT(func(v LookupPersistentResourceResult) []GoogleCloudAiplatformV1ResourcePoolResponse {
		return v.ResourcePools
	}).(GoogleCloudAiplatformV1ResourcePoolResponseArrayOutput)
}

// Runtime information of the Persistent Resource.
func (o LookupPersistentResourceResultOutput) ResourceRuntime() GoogleCloudAiplatformV1ResourceRuntimeResponseOutput {
	return o.ApplyT(func(v LookupPersistentResourceResult) GoogleCloudAiplatformV1ResourceRuntimeResponse {
		return v.ResourceRuntime
	}).(GoogleCloudAiplatformV1ResourceRuntimeResponseOutput)
}

// Optional. Persistent Resource runtime spec. For example, used for Ray cluster configuration.
func (o LookupPersistentResourceResultOutput) ResourceRuntimeSpec() GoogleCloudAiplatformV1ResourceRuntimeSpecResponseOutput {
	return o.ApplyT(func(v LookupPersistentResourceResult) GoogleCloudAiplatformV1ResourceRuntimeSpecResponse {
		return v.ResourceRuntimeSpec
	}).(GoogleCloudAiplatformV1ResourceRuntimeSpecResponseOutput)
}
