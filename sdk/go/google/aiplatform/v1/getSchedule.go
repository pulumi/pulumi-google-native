...
func LookupSchedule(ctx *pulumi.Context, args *LookupScheduleArgs, opts ...pulumi.InvokeOption) (*LookupScheduleResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1:getSchedule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Request for PipelineService.CreatePipelineJob. CreatePipelineJobRequest.parent field is required (format: projects/{project}/locations/{location}).
func (o LookupScheduleResultOutput) CreatePipelineJobRequest() GoogleCloudAiplatformV1CreatePipelineJobRequestResponseOutput {
	return o.ApplyT(func(v LookupScheduleResult) GoogleCloudAiplatformV1CreatePipelineJobRequestResponse {
...
// Response of the last scheduled run. This is the response for starting the scheduled requests and not the execution of the operations/jobs created by the requests (if applicable). Unset if no run has been scheduled yet.
func (o LookupScheduleResultOutput) LastScheduledRunResponse() GoogleCloudAiplatformV1ScheduleRunResponseResponseOutput {
	return o.ApplyT(func(v LookupScheduleResult) GoogleCloudAiplatformV1ScheduleRunResponseResponse {
