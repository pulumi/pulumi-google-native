...
func NewHyperparameterTuningJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:HyperparameterTuningJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHyperparameterTuningJob(ctx *pulumi.Context,
	...
	var resource HyperparameterTuningJob
	err := ctx.ReadResource("google-native:aiplatform/v1:HyperparameterTuningJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type hyperparameterTuningJobArgs struct {
	...
	// The spec of a trial job. The same spec applies to the CustomJobs created in all the trials.
	TrialJobSpec GoogleCloudAiplatformV1CustomJobSpec `pulumi:"trialJobSpec"`
}
...
// Customer-managed encryption key options for a HyperparameterTuningJob. If this is set, then all resources created by the HyperparameterTuningJob will be encrypted with the provided encryption key.
func (o HyperparameterTuningJobOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *HyperparameterTuningJob) GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
...
// Study configuration of the HyperparameterTuningJob.
func (o HyperparameterTuningJobOutput) StudySpec() GoogleCloudAiplatformV1StudySpecResponseOutput {
	return o.ApplyT(func(v *HyperparameterTuningJob) GoogleCloudAiplatformV1StudySpecResponseOutput { return v.StudySpec }).(GoogleCloudAiplatformV1StudySpecResponseOutput)
}

// The spec of a trial job. The same spec applies to the CustomJobs created in all the trials.
func (o HyperparameterTuningJobOutput) TrialJobSpec() GoogleCloudAiplatformV1CustomJobSpecResponseOutput {
	return o.ApplyT(func(v *HyperparameterTuningJob) GoogleCloudAiplatformV1CustomJobSpecResponseOutput {
		return v.TrialJobSpec
	}).(GoogleCloudAiplatformV1CustomJobSpecResponseOutput)
}

// Trials of the HyperparameterTuningJob.
func (o HyperparameterTuningJobOutput) Trials() GoogleCloudAiplatformV1TrialResponseArrayOutput {
	return o.ApplyT(func(v *HyperparameterTuningJob) GoogleCloudAiplatformV1TrialResponseArrayOutput { return v.Trials }).(GoogleCloudAiplatformV1TrialResponseArrayOutput)
}
