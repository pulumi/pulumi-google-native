...
func NewIndex(ctx *pulumi.Context,
	...
	var resource Index
	err := ctx.RegisterResource("google-native:aiplatform/v1:Index", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIndex(ctx *pulumi.Context,
	...
	var resource Index
	err := ctx.ReadResource("google-native:aiplatform/v1:Index", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The pointers to DeployedIndexes created from this Index. An Index can be only deleted if all its DeployedIndexes had been undeployed first.
func (o IndexOutput) DeployedIndexes() GoogleCloudAiplatformV1DeployedIndexRefResponseArrayOutput {
	return o.ApplyT(func(v *Index) GoogleCloudAiplatformV1DeployedIndexRefResponseArrayOutput { return v.DeployedIndexes }).(GoogleCloudAiplatformV1DeployedIndexRefResponseArrayOutput)
}
...
// Immutable. Customer-managed encryption key spec for an Index. If set, this Index and all sub-resources of this Index will be secured by this key.
func (o IndexOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *Index) GoogleCloudAiplatformV1EncryptionSpecResponseOutput { return v.EncryptionSpec }).(GoogleCloudAiplatformV1EncryptionSpecResponseOutput)
}
...
// Stats of the index resource.
func (o IndexOutput) IndexStats() GoogleCloudAiplatformV1IndexStatsResponseOutput {
	return o.ApplyT(func(v *Index) GoogleCloudAiplatformV1IndexStatsResponseOutput { return v.IndexStats }).(GoogleCloudAiplatformV1IndexStatsResponseOutput)
}
