...
func NewMetadataSchema(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:MetadataSchema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetadataSchema(ctx *pulumi.Context,
	...
	var resource MetadataSchema
	err := ctx.ReadResource("google-native:aiplatform/v1:MetadataSchema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
