...
type Model struct {
	...
	BaseModelSource GoogleCloudAiplatformV1ModelBaseModelSourceResponseOutput `pulumi:"baseModelSource"`
	...
	ContainerSpec GoogleCloudAiplatformV1ModelContainerSpecResponseOutput `pulumi:"containerSpec"`
	...
	DataStats GoogleCloudAiplatformV1ModelDataStatsResponseOutput `pulumi:"dataStats"`
	...
	DeployedModels GoogleCloudAiplatformV1DeployedModelRefResponseArrayOutput `pulumi:"deployedModels"`
	...
	ModelSourceInfo GoogleCloudAiplatformV1ModelSourceInfoResponseOutput `pulumi:"modelSourceInfo"`
	// The resource name of the Model.
	Name pulumi.StringOutput `pulumi:"name"`
	// If this Model is a copy of another Model, this contains info about the original.
	OriginalModelInfo GoogleCloudAiplatformV1ModelOriginalModelInfoResponseOutput `pulumi:"originalModelInfo"`
	// Optional. This field is populated if the model is produced by a pipeline job.
	PipelineJob pulumi.StringOutput `pulumi:"pipelineJob"`
	// The schemata that describe formats of the Model's predictions and explanations as given and returned via PredictionService.Predict and PredictionService.Explain.
	PredictSchemata GoogleCloudAiplatformV1PredictSchemataResponseOutput `pulumi:"predictSchemata"`
	...
	SupportedExportFormats GoogleCloudAiplatformV1ModelExportFormatResponseArrayOutput `pulumi:"supportedExportFormats"`
...
func NewModel(ctx *pulumi.Context,
	...
	var resource Model
	err := ctx.RegisterResource("google-native:aiplatform/v1:Model", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModel(ctx *pulumi.Context,
	...
	var resource Model
	err := ctx.ReadResource("google-native:aiplatform/v1:Model", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type modelArgs struct {
	...
	// Optional. User input field to specify the base model source. Currently it only supports specifing the Model Garden models and Genie models.
	BaseModelSource *GoogleCloudAiplatformV1ModelBaseModelSource `pulumi:"baseModelSource"`
	// Input only. The specification of the container that is to be used when deploying this Model. The specification is ingested upon ModelService.UploadModel, and all binaries it contains are copied and stored internally by Vertex AI. Not required for AutoML Models.
	ContainerSpec *GoogleCloudAiplatformV1ModelContainerSpec `pulumi:"containerSpec"`
	// Stats of data used for training or evaluating the Model. Only populated when the Model is trained by a TrainingPipeline with data_input_config.
	DataStats *GoogleCloudAiplatformV1ModelDataStats `pulumi:"dataStats"`
	// The description of the Model.
...
type ModelArgs struct {
	...
	// Optional. User input field to specify the base model source. Currently it only supports specifing the Model Garden models and Genie models.
	BaseModelSource GoogleCloudAiplatformV1ModelBaseModelSourcePtrInput
	// Input only. The specification of the container that is to be used when deploying this Model. The specification is ingested upon ModelService.UploadModel, and all binaries it contains are copied and stored internally by Vertex AI. Not required for AutoML Models.
	ContainerSpec GoogleCloudAiplatformV1ModelContainerSpecPtrInput
	// Stats of data used for training or evaluating the Model. Only populated when the Model is trained by a TrainingPipeline with data_input_config.
	DataStats GoogleCloudAiplatformV1ModelDataStatsPtrInput
	// The description of the Model.
	...
	// Optional. This field is populated if the model is produced by a pipeline job.
	PipelineJob pulumi.StringPtrInput
	// The schemata that describe formats of the Model's predictions and explanations as given and returned via PredictionService.Predict and PredictionService.Explain.
	PredictSchemata GoogleCloudAiplatformV1PredictSchemataPtrInput
...
// Optional. User input field to specify the base model source. Currently it only supports specifing the Model Garden models and Genie models.
func (o ModelOutput) BaseModelSource() GoogleCloudAiplatformV1ModelBaseModelSourceResponseOutput {
	return o.ApplyT(func(v *Model) GoogleCloudAiplatformV1ModelBaseModelSourceResponseOutput { return v.BaseModelSource }).(GoogleCloudAiplatformV1ModelBaseModelSourceResponseOutput)
}

// Input only. The specification of the container that is to be used when deploying this Model. The specification is ingested upon ModelService.UploadModel, and all binaries it contains are copied and stored internally by Vertex AI. Not required for AutoML Models.
func (o ModelOutput) ContainerSpec() GoogleCloudAiplatformV1ModelContainerSpecResponseOutput {
	return o.ApplyT(func(v *Model) GoogleCloudAiplatformV1ModelContainerSpecResponseOutput { return v.ContainerSpec }).(GoogleCloudAiplatformV1ModelContainerSpecResponseOutput)
}
...
// Stats of data used for training or evaluating the Model. Only populated when the Model is trained by a TrainingPipeline with data_input_config.
func (o ModelOutput) DataStats() GoogleCloudAiplatformV1ModelDataStatsResponseOutput {
	return o.ApplyT(func(v *Model) GoogleCloudAiplatformV1ModelDataStatsResponseOutput { return v.DataStats }).(GoogleCloudAiplatformV1ModelDataStatsResponseOutput)
}

// The pointers to DeployedModels created from this Model. Note that Model could have been deployed to Endpoints in different Locations.
func (o ModelOutput) DeployedModels() GoogleCloudAiplatformV1DeployedModelRefResponseArrayOutput {
...
// Customer-managed encryption key spec for a Model. If set, this Model and all sub-resources of this Model will be secured by this key.
func (o ModelOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *Model) GoogleCloudAiplatformV1EncryptionSpecResponseOutput { return v.EncryptionSpec }).(GoogleCloudAiplatformV1EncryptionSpecResponseOutput)
}
...
// The default explanation specification for this Model. The Model can be used for requesting explanation after being deployed if it is populated. The Model can be used for batch explanation if it is populated. All fields of the explanation_spec can be overridden by explanation_spec of DeployModelRequest.deployed_model, or explanation_spec of BatchPredictionJob. If the default explanation specification is not set for this Model, this Model can still be used for requesting explanation by setting explanation_spec of DeployModelRequest.deployed_model and for batch explanation by setting explanation_spec of BatchPredictionJob.
func (o ModelOutput) ExplanationSpec() GoogleCloudAiplatformV1ExplanationSpecResponseOutput {
...
// Source of a model. It can either be automl training pipeline, custom training pipeline, BigQuery ML, or saved and tuned from Genie or Model Garden.
func (o ModelOutput) ModelSourceInfo() GoogleCloudAiplatformV1ModelSourceInfoResponseOutput {
	return o.ApplyT(func(v *Model) GoogleCloudAiplatformV1ModelSourceInfoResponseOutput { return v.ModelSourceInfo }).(GoogleCloudAiplatformV1ModelSourceInfoResponseOutput)
}
...
// If this Model is a copy of another Model, this contains info about the original.
func (o ModelOutput) OriginalModelInfo() GoogleCloudAiplatformV1ModelOriginalModelInfoResponseOutput {
	return o.ApplyT(func(v *Model) GoogleCloudAiplatformV1ModelOriginalModelInfoResponseOutput { return v.OriginalModelInfo }).(GoogleCloudAiplatformV1ModelOriginalModelInfoResponseOutput)
}

// Optional. This field is populated if the model is produced by a pipeline job.
func (o ModelOutput) PipelineJob() pulumi.StringOutput {
	return o.ApplyT(func(v *Model) pulumi.StringOutput { return v.PipelineJob }).(pulumi.StringOutput)
}

// The schemata that describe formats of the Model's predictions and explanations as given and returned via PredictionService.Predict and PredictionService.Explain.
func (o ModelOutput) PredictSchemata() GoogleCloudAiplatformV1PredictSchemataResponseOutput {
...
// The formats in which this Model may be exported. If empty, this Model is not available for export.
func (o ModelOutput) SupportedExportFormats() GoogleCloudAiplatformV1ModelExportFormatResponseArrayOutput {
	return o.ApplyT(func(v *Model) GoogleCloudAiplatformV1ModelExportFormatResponseArrayOutput {
