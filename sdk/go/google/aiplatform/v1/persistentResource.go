...
type PersistentResource struct {
	...
	ResourcePools GoogleCloudAiplatformV1ResourcePoolResponseArrayOutput `pulumi:"resourcePools"`
	// Runtime information of the Persistent Resource.
	ResourceRuntime GoogleCloudAiplatformV1ResourceRuntimeResponseOutput `pulumi:"resourceRuntime"`
	// Optional. Persistent Resource runtime spec. For example, used for Ray cluster configuration.
	ResourceRuntimeSpec GoogleCloudAiplatformV1ResourceRuntimeSpecResponseOutput `pulumi:"resourceRuntimeSpec"`
...
func NewPersistentResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:PersistentResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPersistentResource(ctx *pulumi.Context,
	...
	var resource PersistentResource
	err := ctx.ReadResource("google-native:aiplatform/v1:PersistentResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type persistentResourceArgs struct {
	...
	// The spec of the pools of different resources.
	ResourcePools []GoogleCloudAiplatformV1ResourcePool `pulumi:"resourcePools"`
	// Optional. Persistent Resource runtime spec. For example, used for Ray cluster configuration.
	ResourceRuntimeSpec *GoogleCloudAiplatformV1ResourceRuntimeSpec `pulumi:"resourceRuntimeSpec"`
}
...
type PersistentResourceArgs struct {
	...
	// The spec of the pools of different resources.
	ResourcePools GoogleCloudAiplatformV1ResourcePoolArrayInput
	// Optional. Persistent Resource runtime spec. For example, used for Ray cluster configuration.
	ResourceRuntimeSpec GoogleCloudAiplatformV1ResourceRuntimeSpecPtrInput
}
...
// Optional. Customer-managed encryption key spec for a PersistentResource. If set, this PersistentResource and all sub-resources of this PersistentResource will be secured by this key.
func (o PersistentResourceOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *PersistentResource) GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
...
// The spec of the pools of different resources.
func (o PersistentResourceOutput) ResourcePools() GoogleCloudAiplatformV1ResourcePoolResponseArrayOutput {
	return o.ApplyT(func(v *PersistentResource) GoogleCloudAiplatformV1ResourcePoolResponseArrayOutput {
		return v.ResourcePools
	}).(GoogleCloudAiplatformV1ResourcePoolResponseArrayOutput)
}

// Runtime information of the Persistent Resource.
func (o PersistentResourceOutput) ResourceRuntime() GoogleCloudAiplatformV1ResourceRuntimeResponseOutput {
	return o.ApplyT(func(v *PersistentResource) GoogleCloudAiplatformV1ResourceRuntimeResponseOutput {
		return v.ResourceRuntime
	}).(GoogleCloudAiplatformV1ResourceRuntimeResponseOutput)
}

// Optional. Persistent Resource runtime spec. For example, used for Ray cluster configuration.
func (o PersistentResourceOutput) ResourceRuntimeSpec() GoogleCloudAiplatformV1ResourceRuntimeSpecResponseOutput {
	return o.ApplyT(func(v *PersistentResource) GoogleCloudAiplatformV1ResourceRuntimeSpecResponseOutput {
