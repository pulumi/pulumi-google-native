...
func NewPipelineJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:PipelineJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipelineJob(ctx *pulumi.Context,
	...
	var resource PipelineJob
	err := ctx.ReadResource("google-native:aiplatform/v1:PipelineJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Customer-managed encryption key spec for a pipelineJob. If set, this PipelineJob and all of its sub-resources will be secured by this key.
func (o PipelineJobOutput) EncryptionSpec() GoogleCloudAiplatformV1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *PipelineJob) GoogleCloudAiplatformV1EncryptionSpecResponseOutput { return v.EncryptionSpec }).(GoogleCloudAiplatformV1EncryptionSpecResponseOutput)
}
...
// The details of pipeline run. Not available in the list view.
func (o PipelineJobOutput) JobDetail() GoogleCloudAiplatformV1PipelineJobDetailResponseOutput {
	return o.ApplyT(func(v *PipelineJob) GoogleCloudAiplatformV1PipelineJobDetailResponseOutput { return v.JobDetail }).(GoogleCloudAiplatformV1PipelineJobDetailResponseOutput)
}
...
// Runtime config of the pipeline.
func (o PipelineJobOutput) RuntimeConfig() GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponseOutput {
	return o.ApplyT(func(v *PipelineJob) GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponseOutput {
...
// Pipeline template metadata. Will fill up fields if PipelineJob.template_uri is from supported template registry.
func (o PipelineJobOutput) TemplateMetadata() GoogleCloudAiplatformV1PipelineTemplateMetadataResponseOutput {
	return o.ApplyT(func(v *PipelineJob) GoogleCloudAiplatformV1PipelineTemplateMetadataResponseOutput {
