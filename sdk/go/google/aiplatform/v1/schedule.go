...
func NewSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:Schedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchedule(ctx *pulumi.Context,
	...
	var resource Schedule
	err := ctx.ReadResource("google-native:aiplatform/v1:Schedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type scheduleArgs struct {
	...
	// Request for PipelineService.CreatePipelineJob. CreatePipelineJobRequest.parent field is required (format: projects/{project}/locations/{location}).
	CreatePipelineJobRequest *GoogleCloudAiplatformV1CreatePipelineJobRequest `pulumi:"createPipelineJobRequest"`
	// Cron schedule (https://en.wikipedia.org/wiki/Cron) to launch scheduled runs. To explicitly set a timezone to the cron tab, apply a prefix in the cron tab: "CRON_TZ=${IANA_TIME_ZONE}" or "TZ=${IANA_TIME_ZONE}". The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, "CRON_TZ=America/New_York 1 * * * *", or "TZ=America/New_York 1 * * * *".
...
// Request for PipelineService.CreatePipelineJob. CreatePipelineJobRequest.parent field is required (format: projects/{project}/locations/{location}).
func (o ScheduleOutput) CreatePipelineJobRequest() GoogleCloudAiplatformV1CreatePipelineJobRequestResponseOutput {
	return o.ApplyT(func(v *Schedule) GoogleCloudAiplatformV1CreatePipelineJobRequestResponseOutput {
		return v.CreatePipelineJobRequest
	}).(GoogleCloudAiplatformV1CreatePipelineJobRequestResponseOutput)
}
...
// Response of the last scheduled run. This is the response for starting the scheduled requests and not the execution of the operations/jobs created by the requests (if applicable). Unset if no run has been scheduled yet.
func (o ScheduleOutput) LastScheduledRunResponse() GoogleCloudAiplatformV1ScheduleRunResponseResponseOutput {
	return o.ApplyT(func(v *Schedule) GoogleCloudAiplatformV1ScheduleRunResponseResponseOutput {
		return v.LastScheduledRunResponse
	}).(GoogleCloudAiplatformV1ScheduleRunResponseResponseOutput)
}
