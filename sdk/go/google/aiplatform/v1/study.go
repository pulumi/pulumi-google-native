...
func NewStudy(ctx *pulumi.Context,
	...
	var resource Study
	err := ctx.RegisterResource("google-native:aiplatform/v1:Study", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStudy(ctx *pulumi.Context,
	...
	var resource Study
	err := ctx.ReadResource("google-native:aiplatform/v1:Study", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type studyArgs struct {
	...
	// Configuration of the Study.
	StudySpec GoogleCloudAiplatformV1StudySpec `pulumi:"studySpec"`
}
...
// Configuration of the Study.
func (o StudyOutput) StudySpec() GoogleCloudAiplatformV1StudySpecResponseOutput {
	return o.ApplyT(func(v *Study) GoogleCloudAiplatformV1StudySpecResponseOutput { return v.StudySpec }).(GoogleCloudAiplatformV1StudySpecResponseOutput)
}
