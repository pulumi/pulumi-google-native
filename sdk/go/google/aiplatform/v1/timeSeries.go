...
func NewTimeSeries(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1:TimeSeries", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTimeSeries(ctx *pulumi.Context,
	...
	var resource TimeSeries
	err := ctx.ReadResource("google-native:aiplatform/v1:TimeSeries", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Scalar, Tensor, or Blob metadata for this TensorboardTimeSeries.
func (o TimeSeriesOutput) Metadata() GoogleCloudAiplatformV1TensorboardTimeSeriesMetadataResponseOutput {
	return o.ApplyT(func(v *TimeSeries) GoogleCloudAiplatformV1TensorboardTimeSeriesMetadataResponseOutput {
		return v.Metadata
