...
func NewFeaturestoreIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1beta1:FeaturestoreIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeaturestoreIamMember(ctx *pulumi.Context,
	...
	var resource FeaturestoreIamMember
	err := ctx.ReadResource("google-native:aiplatform/v1beta1:FeaturestoreIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
