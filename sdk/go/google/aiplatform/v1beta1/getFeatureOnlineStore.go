...
func LookupFeatureOnlineStore(ctx *pulumi.Context, args *LookupFeatureOnlineStoreArgs, opts ...pulumi.InvokeOption) (*LookupFeatureOnlineStoreResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1beta1:getFeatureOnlineStore", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupFeatureOnlineStoreResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFeatureOnlineStoreResult] {
	return pulumix.Output[LookupFeatureOnlineStoreResult]{
		OutputState: o.OutputState,
	}
}

// Contains settings for the Cloud Bigtable instance that will be created to serve featureValues for all FeatureViews under this FeatureOnlineStore.
func (o LookupFeatureOnlineStoreResultOutput) Bigtable() GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableResponseOutput {
	return o.ApplyT(func(v LookupFeatureOnlineStoreResult) GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableResponse {
		return v.Bigtable
...
// Optional. The dedicated serving endpoint for this FeatureOnlineStore, which is different from common Vertex service endpoint.
func (o LookupFeatureOnlineStoreResultOutput) DedicatedServingEndpoint() GoogleCloudAiplatformV1beta1FeatureOnlineStoreDedicatedServingEndpointResponseOutput {
	return o.ApplyT(func(v LookupFeatureOnlineStoreResult) GoogleCloudAiplatformV1beta1FeatureOnlineStoreDedicatedServingEndpointResponse {
		return v.DedicatedServingEndpoint
	}).(GoogleCloudAiplatformV1beta1FeatureOnlineStoreDedicatedServingEndpointResponseOutput)
}

// Optional. The settings for embedding management in FeatureOnlineStore.
func (o LookupFeatureOnlineStoreResultOutput) EmbeddingManagement() GoogleCloudAiplatformV1beta1FeatureOnlineStoreEmbeddingManagementResponseOutput {
	return o.ApplyT(func(v LookupFeatureOnlineStoreResult) GoogleCloudAiplatformV1beta1FeatureOnlineStoreEmbeddingManagementResponse {
...
// Contains settings for the Optimized store that will be created to serve featureValues for all FeatureViews under this FeatureOnlineStore. When choose Optimized storage type, need to set PrivateServiceConnectConfig.enable_private_service_connect to use private endpoint. Otherwise will use public endpoint by default.
func (o LookupFeatureOnlineStoreResultOutput) Optimized() GoogleCloudAiplatformV1beta1FeatureOnlineStoreOptimizedResponseOutput {
	return o.ApplyT(func(v LookupFeatureOnlineStoreResult) GoogleCloudAiplatformV1beta1FeatureOnlineStoreOptimizedResponse {
		return v.Optimized
