...
// Optional. User input field to specify the base model source. Currently it only supports specifing the Model Garden models and Genie models.
func (o LookupModelResultOutput) BaseModelSource() GoogleCloudAiplatformV1beta1ModelBaseModelSourceResponseOutput {
	return o.ApplyT(func(v LookupModelResult) GoogleCloudAiplatformV1beta1ModelBaseModelSourceResponse {
