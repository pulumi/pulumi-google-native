...
func LookupNasJob(ctx *pulumi.Context, args *LookupNasJobArgs, opts ...pulumi.InvokeOption) (*LookupNasJobResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1beta1:getNasJob", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Customer-managed encryption key options for a NasJob. If this is set, then all resources created by the NasJob will be encrypted with the provided encryption key.
func (o LookupNasJobResultOutput) EncryptionSpec() GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupNasJobResult) GoogleCloudAiplatformV1beta1EncryptionSpecResponse { return v.EncryptionSpec }).(GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput)
}
...
// Output of the NasJob.
func (o LookupNasJobResultOutput) NasJobOutput() GoogleCloudAiplatformV1beta1NasJobOutputResponseOutput {
	return o.ApplyT(func(v LookupNasJobResult) GoogleCloudAiplatformV1beta1NasJobOutputResponse { return v.NasJobOutput }).(GoogleCloudAiplatformV1beta1NasJobOutputResponseOutput)
}

// The specification of a NasJob.
func (o LookupNasJobResultOutput) NasJobSpec() GoogleCloudAiplatformV1beta1NasJobSpecResponseOutput {
	return o.ApplyT(func(v LookupNasJobResult) GoogleCloudAiplatformV1beta1NasJobSpecResponse { return v.NasJobSpec }).(GoogleCloudAiplatformV1beta1NasJobSpecResponseOutput)
}
