...
type LookupNotebookRuntimeTemplateResult struct {
	...
	ReservationAffinity GoogleCloudAiplatformV1beta1NotebookReservationAffinityResponse `pulumi:"reservationAffinity"`
	// The service account that the runtime workload runs as. You can use any service account within the same project, but you must have the service account user permission to use the instance. If not specified, the [Compute Engine default service account](https://cloud.google.com/compute/docs/access/service-accounts#default_service_account) is used.
	ServiceAccount string `pulumi:"serviceAccount"`
	// Optional. Immutable. Runtime Shielded VM spec.
	ShieldedVmConfig GoogleCloudAiplatformV1beta1ShieldedVmConfigResponse `pulumi:"shieldedVmConfig"`
...
// Optional. Reservation Affinity of the notebook runtime template.
func (o LookupNotebookRuntimeTemplateResultOutput) ReservationAffinity() GoogleCloudAiplatformV1beta1NotebookReservationAffinityResponseOutput {
	return o.ApplyT(func(v LookupNotebookRuntimeTemplateResult) GoogleCloudAiplatformV1beta1NotebookReservationAffinityResponse {
...
// Optional. Immutable. Runtime Shielded VM spec.
func (o LookupNotebookRuntimeTemplateResultOutput) ShieldedVmConfig() GoogleCloudAiplatformV1beta1ShieldedVmConfigResponseOutput {
	return o.ApplyT(func(v LookupNotebookRuntimeTemplateResult) GoogleCloudAiplatformV1beta1ShieldedVmConfigResponse {
