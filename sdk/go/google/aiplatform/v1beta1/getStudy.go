...
func LookupStudy(ctx *pulumi.Context, args *LookupStudyArgs, opts ...pulumi.InvokeOption) (*LookupStudyResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1beta1:getStudy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Configuration of the Study.
func (o LookupStudyResultOutput) StudySpec() GoogleCloudAiplatformV1beta1StudySpecResponseOutput {
	return o.ApplyT(func(v LookupStudyResult) GoogleCloudAiplatformV1beta1StudySpecResponse { return v.StudySpec }).(GoogleCloudAiplatformV1beta1StudySpecResponseOutput)
}
