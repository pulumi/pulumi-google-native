...
func LookupTensorboard(ctx *pulumi.Context, args *LookupTensorboardArgs, opts ...pulumi.InvokeOption) (*LookupTensorboardResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1beta1:getTensorboard", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key.
func (o LookupTensorboardResultOutput) EncryptionSpec() GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v LookupTensorboardResult) GoogleCloudAiplatformV1beta1EncryptionSpecResponse {
