...
func LookupTrial(ctx *pulumi.Context, args *LookupTrialArgs, opts ...pulumi.InvokeOption) (*LookupTrialResult, error) {
	...
	err := ctx.Invoke("google-native:aiplatform/v1beta1:getTrial", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The final measurement containing the objective value.
func (o LookupTrialResultOutput) FinalMeasurement() GoogleCloudAiplatformV1beta1MeasurementResponseOutput {
	return o.ApplyT(func(v LookupTrialResult) GoogleCloudAiplatformV1beta1MeasurementResponse { return v.FinalMeasurement }).(GoogleCloudAiplatformV1beta1MeasurementResponseOutput)
}
...
// A list of measurements that are strictly lexicographically ordered by their induced tuples (steps, elapsed_duration). These are used for early stopping computations.
func (o LookupTrialResultOutput) Measurements() GoogleCloudAiplatformV1beta1MeasurementResponseArrayOutput {
	return o.ApplyT(func(v LookupTrialResult) []GoogleCloudAiplatformV1beta1MeasurementResponse { return v.Measurements }).(GoogleCloudAiplatformV1beta1MeasurementResponseArrayOutput)
}
...
// The parameters of the Trial.
func (o LookupTrialResultOutput) Parameters() GoogleCloudAiplatformV1beta1TrialParameterResponseArrayOutput {
	return o.ApplyT(func(v LookupTrialResult) []GoogleCloudAiplatformV1beta1TrialParameterResponse { return v.Parameters }).(GoogleCloudAiplatformV1beta1TrialParameterResponseArrayOutput)
}
