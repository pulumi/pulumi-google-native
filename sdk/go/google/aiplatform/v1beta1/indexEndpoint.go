...
func NewIndexEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1beta1:IndexEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIndexEndpoint(ctx *pulumi.Context,
	...
	var resource IndexEndpoint
	err := ctx.ReadResource("google-native:aiplatform/v1beta1:IndexEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The indexes deployed in this endpoint.
func (o IndexEndpointOutput) DeployedIndexes() GoogleCloudAiplatformV1beta1DeployedIndexResponseArrayOutput {
	return o.ApplyT(func(v *IndexEndpoint) GoogleCloudAiplatformV1beta1DeployedIndexResponseArrayOutput {
...
// Immutable. Customer-managed encryption key spec for an IndexEndpoint. If set, this IndexEndpoint and all sub-resources of this IndexEndpoint will be secured by this key.
func (o IndexEndpointOutput) EncryptionSpec() GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *IndexEndpoint) GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput {
...
// Optional. Configuration for private service connect. network and private_service_connect_config are mutually exclusive.
func (o IndexEndpointOutput) PrivateServiceConnectConfig() GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigResponseOutput {
	return o.ApplyT(func(v *IndexEndpoint) GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigResponseOutput {
