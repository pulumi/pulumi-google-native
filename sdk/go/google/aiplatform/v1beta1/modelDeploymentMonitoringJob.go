...
func NewModelDeploymentMonitoringJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1beta1:ModelDeploymentMonitoringJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModelDeploymentMonitoringJob(ctx *pulumi.Context,
	...
	var resource ModelDeploymentMonitoringJob
	err := ctx.ReadResource("google-native:aiplatform/v1beta1:ModelDeploymentMonitoringJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type modelDeploymentMonitoringJobArgs struct {
	...
	// The config for monitoring objectives. This is a per DeployedModel config. Each DeployedModel needs to be configured separately.
	ModelDeploymentMonitoringObjectiveConfigs []GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig `pulumi:"modelDeploymentMonitoringObjectiveConfigs"`
	// Schedule config for running the monitoring job.
	ModelDeploymentMonitoringScheduleConfig GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfig `pulumi:"modelDeploymentMonitoringScheduleConfig"`
	// Alert config for model monitoring.
	ModelMonitoringAlertConfig *GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfig `pulumi:"modelMonitoringAlertConfig"`
	// YAML schema file uri describing the format of a single instance, which are given to format this Endpoint's prediction (and explanation). If not set, we will generate predict schema from collected predict requests.
...
// The created bigquery tables for the job under customer project. Customer could do their own query & analysis. There could be 4 log tables in maximum: 1. Training data logging predict request/response 2. Serving data logging predict request/response
func (o ModelDeploymentMonitoringJobOutput) BigqueryTables() GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponseArrayOutput {
	return o.ApplyT(func(v *ModelDeploymentMonitoringJob) GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponseArrayOutput {
...
// Customer-managed encryption key spec for a ModelDeploymentMonitoringJob. If set, this ModelDeploymentMonitoringJob and all sub-resources of this ModelDeploymentMonitoringJob will be secured by this key.
func (o ModelDeploymentMonitoringJobOutput) EncryptionSpec() GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *ModelDeploymentMonitoringJob) GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput {
...
// Latest triggered monitoring pipeline metadata.
func (o ModelDeploymentMonitoringJobOutput) LatestMonitoringPipelineMetadata() GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponseOutput {
	return o.ApplyT(func(v *ModelDeploymentMonitoringJob) GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponseOutput {
...
// Sample Strategy for logging.
func (o ModelDeploymentMonitoringJobOutput) LoggingSamplingStrategy() GoogleCloudAiplatformV1beta1SamplingStrategyResponseOutput {
	return o.ApplyT(func(v *ModelDeploymentMonitoringJob) GoogleCloudAiplatformV1beta1SamplingStrategyResponseOutput {
		return v.LoggingSamplingStrategy
	}).(GoogleCloudAiplatformV1beta1SamplingStrategyResponseOutput)
}

// The config for monitoring objectives. This is a per DeployedModel config. Each DeployedModel needs to be configured separately.
func (o ModelDeploymentMonitoringJobOutput) ModelDeploymentMonitoringObjectiveConfigs() GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponseArrayOutput {
	return o.ApplyT(func(v *ModelDeploymentMonitoringJob) GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponseArrayOutput {
...
// Schedule config for running the monitoring job.
func (o ModelDeploymentMonitoringJobOutput) ModelDeploymentMonitoringScheduleConfig() GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfigResponseOutput {
	return o.ApplyT(func(v *ModelDeploymentMonitoringJob) GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfigResponseOutput {
...
// Alert config for model monitoring.
func (o ModelDeploymentMonitoringJobOutput) ModelMonitoringAlertConfig() GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponseOutput {
	return o.ApplyT(func(v *ModelDeploymentMonitoringJob) GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponseOutput {
...
// Stats anomalies base folder path.
func (o ModelDeploymentMonitoringJobOutput) StatsAnomaliesBaseDirectory() GoogleCloudAiplatformV1beta1GcsDestinationResponseOutput {
	return o.ApplyT(func(v *ModelDeploymentMonitoringJob) GoogleCloudAiplatformV1beta1GcsDestinationResponseOutput {
