...
func NewNotebookRuntimeTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1beta1:NotebookRuntimeTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebookRuntimeTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource NotebookRuntimeTemplateIamPolicy
	err := ctx.ReadResource("google-native:aiplatform/v1beta1:NotebookRuntimeTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
