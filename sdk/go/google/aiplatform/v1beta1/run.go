...
func NewRun(ctx *pulumi.Context,
	...
	var resource Run
	err := ctx.RegisterResource("google-native:aiplatform/v1beta1:Run", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRun(ctx *pulumi.Context,
	...
	var resource Run
	err := ctx.ReadResource("google-native:aiplatform/v1beta1:Run", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
