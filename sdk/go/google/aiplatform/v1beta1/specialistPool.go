...
func NewSpecialistPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1beta1:SpecialistPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpecialistPool(ctx *pulumi.Context,
	...
	var resource SpecialistPool
	err := ctx.ReadResource("google-native:aiplatform/v1beta1:SpecialistPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
