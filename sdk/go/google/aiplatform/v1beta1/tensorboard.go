...
func NewTensorboard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:aiplatform/v1beta1:Tensorboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTensorboard(ctx *pulumi.Context,
	...
	var resource Tensorboard
	err := ctx.ReadResource("google-native:aiplatform/v1beta1:Tensorboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key.
func (o TensorboardOutput) EncryptionSpec() GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput {
	return o.ApplyT(func(v *Tensorboard) GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput { return v.EncryptionSpec }).(GoogleCloudAiplatformV1beta1EncryptionSpecResponseOutput)
}
