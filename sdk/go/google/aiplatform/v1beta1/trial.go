...
func NewTrial(ctx *pulumi.Context,
	...
	var resource Trial
	err := ctx.RegisterResource("google-native:aiplatform/v1beta1:Trial", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrial(ctx *pulumi.Context,
	...
	var resource Trial
	err := ctx.ReadResource("google-native:aiplatform/v1beta1:Trial", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The final measurement containing the objective value.
func (o TrialOutput) FinalMeasurement() GoogleCloudAiplatformV1beta1MeasurementResponseOutput {
	return o.ApplyT(func(v *Trial) GoogleCloudAiplatformV1beta1MeasurementResponseOutput { return v.FinalMeasurement }).(GoogleCloudAiplatformV1beta1MeasurementResponseOutput)
}
...
// A list of measurements that are strictly lexicographically ordered by their induced tuples (steps, elapsed_duration). These are used for early stopping computations.
func (o TrialOutput) Measurements() GoogleCloudAiplatformV1beta1MeasurementResponseArrayOutput {
	return o.ApplyT(func(v *Trial) GoogleCloudAiplatformV1beta1MeasurementResponseArrayOutput { return v.Measurements }).(GoogleCloudAiplatformV1beta1MeasurementResponseArrayOutput)
}
...
// The parameters of the Trial.
func (o TrialOutput) Parameters() GoogleCloudAiplatformV1beta1TrialParameterResponseArrayOutput {
	return o.ApplyT(func(v *Trial) GoogleCloudAiplatformV1beta1TrialParameterResponseArrayOutput { return v.Parameters }).(GoogleCloudAiplatformV1beta1TrialParameterResponseArrayOutput)
}
