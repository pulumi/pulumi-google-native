...
func NewUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.RegisterResource("google-native:alloydb/v1alpha:User", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.ReadResource("google-native:alloydb/v1alpha:User", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
