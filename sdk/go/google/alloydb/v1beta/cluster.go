...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:alloydb/v1beta:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("google-native:alloydb/v1beta:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
