...
func NewDataExchangeIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:analyticshub/v1:DataExchangeIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataExchangeIamBinding(ctx *pulumi.Context,
	...
	var resource DataExchangeIamBinding
	err := ctx.ReadResource("google-native:analyticshub/v1:DataExchangeIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
