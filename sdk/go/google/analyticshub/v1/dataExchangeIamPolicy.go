...
func NewDataExchangeIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:analyticshub/v1:DataExchangeIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataExchangeIamPolicy(ctx *pulumi.Context,
	...
	var resource DataExchangeIamPolicy
	err := ctx.ReadResource("google-native:analyticshub/v1:DataExchangeIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o DataExchangeIamPolicyOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v *DataExchangeIamPolicy) AuditConfigResponseArrayOutput { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}

// Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
func (o DataExchangeIamPolicyOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v *DataExchangeIamPolicy) BindingResponseArrayOutput { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o DataExchangeIamPolicyOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v *DataExchangeIamPolicy) pulumi.IntOutput { return v.Version }).(pulumi.IntOutput)
}
