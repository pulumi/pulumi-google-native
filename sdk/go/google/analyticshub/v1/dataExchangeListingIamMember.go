...
func NewDataExchangeListingIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:analyticshub/v1:DataExchangeListingIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataExchangeListingIamMember(ctx *pulumi.Context,
	...
	var resource DataExchangeListingIamMember
	err := ctx.ReadResource("google-native:analyticshub/v1:DataExchangeListingIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *DataExchangeListingIamMember) ToOutput(ctx context.Context) pulumix.Output[*DataExchangeListingIamMember] {
	return pulumix.Output[*DataExchangeListingIamMember]{
		OutputState: i.ToDataExchangeListingIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o DataExchangeListingIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*DataExchangeListingIamMember] {
	return pulumix.Output[*DataExchangeListingIamMember]{
