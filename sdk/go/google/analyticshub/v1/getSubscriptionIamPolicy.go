...
func LookupSubscriptionIamPolicy(ctx *pulumi.Context, args *LookupSubscriptionIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupSubscriptionIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:analyticshub/v1:getSubscriptionIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupSubscriptionIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSubscriptionIamPolicyResult] {
	return pulumix.Output[LookupSubscriptionIamPolicyResult]{
...
func (o LookupSubscriptionIamPolicyResultOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v LookupSubscriptionIamPolicyResult) []AuditConfigResponse { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}

// Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
func (o LookupSubscriptionIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupSubscriptionIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupSubscriptionIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupSubscriptionIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
