...
func NewSubscriptionIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:analyticshub/v1:SubscriptionIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionIamPolicy(ctx *pulumi.Context,
	...
	var resource SubscriptionIamPolicy
	err := ctx.ReadResource("google-native:analyticshub/v1:SubscriptionIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o SubscriptionIamPolicyOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v *SubscriptionIamPolicy) AuditConfigResponseArrayOutput { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}
...
func (o SubscriptionIamPolicyOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *SubscriptionIamPolicy) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}
