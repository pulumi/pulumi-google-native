...
func NewDataExchangeIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:analyticshub/v1beta1:DataExchangeIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataExchangeIamBinding(ctx *pulumi.Context,
	...
	var resource DataExchangeIamBinding
	err := ctx.ReadResource("google-native:analyticshub/v1beta1:DataExchangeIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o DataExchangeIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *DataExchangeIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
func (o DataExchangeIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *DataExchangeIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
