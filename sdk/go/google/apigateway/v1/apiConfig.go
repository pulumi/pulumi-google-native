...
func NewApiConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigateway/v1:ApiConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiConfig(ctx *pulumi.Context,
	...
	var resource ApiConfig
	err := ctx.ReadResource("google-cloud:apigateway/v1:ApiConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
