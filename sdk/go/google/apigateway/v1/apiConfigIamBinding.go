...
func NewApiConfigIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apigateway/v1:ApiConfigIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiConfigIamBinding(ctx *pulumi.Context,
	...
	var resource ApiConfigIamBinding
	err := ctx.ReadResource("google-native:apigateway/v1:ApiConfigIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ApiConfigIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ApiConfigIamBinding] {
	return pulumix.Output[*ApiConfigIamBinding]{
		OutputState: i.ToApiConfigIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ApiConfigIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ApiConfigIamBinding] {
	return pulumix.Output[*ApiConfigIamBinding]{
