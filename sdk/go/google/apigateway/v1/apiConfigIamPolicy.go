...
func NewApiConfigIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigateway/v1:ApiConfigIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiConfigIamPolicy(ctx *pulumi.Context,
	...
	var resource ApiConfigIamPolicy
	err := ctx.ReadResource("google-cloud:apigateway/v1:ApiConfigIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
