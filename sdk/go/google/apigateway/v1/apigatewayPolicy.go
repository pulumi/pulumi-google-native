...
func NewApigatewayPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigateway/v1:ApigatewayPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigatewayPolicy(ctx *pulumi.Context,
	...
	var resource ApigatewayPolicy
	err := ctx.ReadResource("google-cloud:apigateway/v1:ApigatewayPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
