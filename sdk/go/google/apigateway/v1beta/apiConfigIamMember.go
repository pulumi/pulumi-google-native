...
func NewApiConfigIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apigateway/v1beta:ApiConfigIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiConfigIamMember(ctx *pulumi.Context,
	...
	var resource ApiConfigIamMember
	err := ctx.ReadResource("google-native:apigateway/v1beta:ApiConfigIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
