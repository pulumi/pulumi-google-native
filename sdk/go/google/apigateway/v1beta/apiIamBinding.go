...
func NewApiIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apigateway/v1beta:ApiIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIamBinding(ctx *pulumi.Context,
	...
	var resource ApiIamBinding
	err := ctx.ReadResource("google-native:apigateway/v1beta:ApiIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ApiIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ApiIamBinding] {
	return pulumix.Output[*ApiIamBinding]{
		OutputState: i.ToApiIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ApiIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ApiIamBinding] {
	return pulumix.Output[*ApiIamBinding]{
