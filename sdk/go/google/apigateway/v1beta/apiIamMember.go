...
func NewApiIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apigateway/v1beta:ApiIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIamMember(ctx *pulumi.Context,
	...
	var resource ApiIamMember
	err := ctx.ReadResource("google-native:apigateway/v1beta:ApiIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
