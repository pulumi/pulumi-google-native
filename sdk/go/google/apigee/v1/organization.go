...
type Organization struct {
	...
	ApiConsumerDataLocation pulumi.StringOutput `pulumi:"apiConsumerDataLocation"`
	...
	ControlPlaneEncryptionKeyName pulumi.StringOutput `pulumi:"controlPlaneEncryptionKeyName"`
...
// Addon configurations of the Apigee organization.
func (o OrganizationOutput) AddonsConfig() GoogleCloudApigeeV1AddonsConfigResponseOutput {
...
// Cloud KMS key name used for encrypting API consumer data. Required for US/EU regions when [BillingType](#BillingType) is `SUBSCRIPTION`. When [BillingType](#BillingType) is `EVALUATION` or the region is not US/EU, a Google-Managed encryption key will be used. Format: `projects/*/locations/*/keyRings/*/cryptoKeys/*`
func (o OrganizationOutput) ApiConsumerDataEncryptionKeyName() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.ApiConsumerDataEncryptionKeyName }).(pulumi.StringOutput)
}

// This field is needed only for customers with control plane in US or EU. Apigee stores some control plane data only in single region. This field determines which single region Apigee should use. For example: "us-west1" when control plane is in US or "europe-west2" when control plane is in EU.
func (o OrganizationOutput) ApiConsumerDataLocation() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.ApiConsumerDataLocation }).(pulumi.StringOutput)
}
...
// Not used by Apigee.
func (o OrganizationOutput) Attributes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringArrayOutput { return v.Attributes }).(pulumi.StringArrayOutput)
}

// Compute Engine network used for Service Networking to be peered with Apigee runtime instances. See [Getting started with the Service Networking API](https://cloud.google.com/service-infrastructure/docs/service-networking/getting-started). Valid only when [RuntimeType](#RuntimeType) is set to `CLOUD`. The value must be set before the creation of a runtime instance and can be updated only when there are no runtime instances. For example: `default`. Apigee also supports shared VPC (that is, the host network project is not the same as the one that is peering with Apigee). See [Shared VPC overview](https://cloud.google.com/vpc/docs/shared-vpc). To use a shared VPC network, use the following format: `projects/{host-project-id}/{region}/networks/{network-name}`. For example: `projects/my-sharedvpc-host/global/networks/mynetwork` **Note:** Not supported for Apigee hybrid.
func (o OrganizationOutput) AuthorizedNetwork() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.AuthorizedNetwork }).(pulumi.StringOutput)
}
...
// Cloud KMS key name used for encrypting control plane data that is stored in a multi region. Required when [BillingType](#BillingType) is `SUBSCRIPTION`. When [BillingType](#BillingType) is `EVALUATION`, a Google-Managed encryption key will be used. Format: `projects/*/locations/*/keyRings/*/cryptoKeys/*`
func (o OrganizationOutput) ControlPlaneEncryptionKeyName() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.ControlPlaneEncryptionKeyName }).(pulumi.StringOutput)
}
...
// Not used by Apigee.
func (o OrganizationOutput) CustomerName() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.CustomerName }).(pulumi.StringOutput)
}
...
// List of environments in the Apigee organization.
func (o OrganizationOutput) Environments() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringArrayOutput { return v.Environments }).(pulumi.StringArrayOutput)
}

// Time that the Apigee organization is scheduled for deletion.
func (o OrganizationOutput) ExpiresAt() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.ExpiresAt }).(pulumi.StringOutput)
}

// Time that the Apigee organization was last modified in milliseconds since epoch.
func (o OrganizationOutput) LastModifiedAt() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.LastModifiedAt }).(pulumi.StringOutput)
}
...
// Configuration for the Portals settings.
func (o OrganizationOutput) PortalDisabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *Organization) pulumi.BoolOutput { return v.PortalDisabled }).(pulumi.BoolOutput)
}

// Project ID associated with the Apigee organization.
func (o OrganizationOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}

// Properties defined in the Apigee organization profile.
func (o OrganizationOutput) Properties() GoogleCloudApigeeV1PropertiesResponseOutput {
	return o.ApplyT(func(v *Organization) GoogleCloudApigeeV1PropertiesResponseOutput { return v.Properties }).(GoogleCloudApigeeV1PropertiesResponseOutput)
}

// Cloud KMS key name used for encrypting the data that is stored and replicated across runtime instances. Update is not allowed after the organization is created. Required when [RuntimeType](#RuntimeType) is `CLOUD`. If not specified when [RuntimeType](#RuntimeType) is `TRIAL`, a Google-Managed encryption key will be used. For example: "projects/foo/locations/us/keyRings/bar/cryptoKeys/baz". **Note:** Not supported for Apigee hybrid.
func (o OrganizationOutput) RuntimeDatabaseEncryptionKeyName() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.RuntimeDatabaseEncryptionKeyName }).(pulumi.StringOutput)
}

// Runtime type of the Apigee organization based on the Apigee subscription purchased.
func (o OrganizationOutput) RuntimeType() pulumi.StringOutput {
	return o.ApplyT(func(v *Organization) pulumi.StringOutput { return v.RuntimeType }).(pulumi.StringOutput)
}
