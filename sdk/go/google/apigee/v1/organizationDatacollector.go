...
func NewOrganizationDatacollector(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationDatacollector", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationDatacollector(ctx *pulumi.Context,
	...
	var resource OrganizationDatacollector
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationDatacollector", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
