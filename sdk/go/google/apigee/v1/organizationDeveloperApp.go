...
func NewOrganizationDeveloperApp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationDeveloperApp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationDeveloperApp(ctx *pulumi.Context,
	...
	var resource OrganizationDeveloperApp
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationDeveloperApp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
