...
func NewOrganizationDeveloperAppKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationDeveloperAppKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationDeveloperAppKey(ctx *pulumi.Context,
	...
	var resource OrganizationDeveloperAppKey
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationDeveloperAppKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
