...
func NewOrganizationDeveloperAppKeyCreate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationDeveloperAppKeyCreate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationDeveloperAppKeyCreate(ctx *pulumi.Context,
	...
	var resource OrganizationDeveloperAppKeyCreate
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationDeveloperAppKeyCreate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
