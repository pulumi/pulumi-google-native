...
func NewOrganizationEnvgroupAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationEnvgroupAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvgroupAttachment(ctx *pulumi.Context,
	...
	var resource OrganizationEnvgroupAttachment
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationEnvgroupAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
