...
func NewOrganizationEnvironmentApiRevisionDebugsession(ctx *pulumi.Context,
	...
	if args.DebugsessionsId == nil {
		return nil, errors.New("invalid value for required argument 'DebugsessionsId'")
	}
	...
	if args.RevisionsId == nil {
		return nil, errors.New("invalid value for required argument 'RevisionsId'")
	}
	var resource OrganizationEnvironmentApiRevisionDebugsession
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationEnvironmentApiRevisionDebugsession", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentApiRevisionDebugsession(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentApiRevisionDebugsession
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationEnvironmentApiRevisionDebugsession", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type organizationEnvironmentApiRevisionDebugsessionArgs struct {
	...
	// Optional. The number of request to be traced. Min = 1, Max = 15, Default = 10.
	Count           *int   `pulumi:"count"`
	DebugsessionsId string `pulumi:"debugsessionsId"`
	...
	RevisionsId     string  `pulumi:"revisionsId"`
	// Optional. The time in seconds after which this DebugSession should end. This value will override the value in query param, if both are provided.
	Timeout *string `pulumi:"timeout"`
	// Optional. The maximum number of bytes captured from the response payload. Min = 0, Max = 5120, Default = 5120.
	Tracesize *int `pulumi:"tracesize"`
...
type OrganizationEnvironmentApiRevisionDebugsessionArgs struct {
	...
	// Optional. The number of request to be traced. Min = 1, Max = 15, Default = 10.
	Count           pulumi.IntPtrInput
	DebugsessionsId pulumi.StringInput
	...
	RevisionsId     pulumi.StringInput
	// Optional. The time in seconds after which this DebugSession should end. This value will override the value in query param, if both are provided.
	Timeout pulumi.StringPtrInput
	// Optional. The maximum number of bytes captured from the response payload. Min = 0, Max = 5120, Default = 5120.
	Tracesize pulumi.IntPtrInput
