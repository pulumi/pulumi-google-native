...
func NewOrganizationEnvironmentKeystore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationEnvironmentKeystore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationEnvironmentKeystore(ctx *pulumi.Context,
	...
	var resource OrganizationEnvironmentKeystore
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationEnvironmentKeystore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
