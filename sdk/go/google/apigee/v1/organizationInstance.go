...
func NewOrganizationInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationInstance(ctx *pulumi.Context,
	...
	var resource OrganizationInstance
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
