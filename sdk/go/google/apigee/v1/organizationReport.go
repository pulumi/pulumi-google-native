...
func NewOrganizationReport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:apigee/v1:OrganizationReport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationReport(ctx *pulumi.Context,
	...
	var resource OrganizationReport
	err := ctx.ReadResource("google-cloud:apigee/v1:OrganizationReport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
