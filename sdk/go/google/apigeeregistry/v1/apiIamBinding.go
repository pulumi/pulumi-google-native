...
func NewApiIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apigeeregistry/v1:ApiIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApiIamBinding(ctx *pulumi.Context,
	...
	var resource ApiIamBinding
	err := ctx.ReadResource("google-native:apigeeregistry/v1:ApiIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
