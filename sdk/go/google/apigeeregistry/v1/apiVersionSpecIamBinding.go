...
func (i *ApiVersionSpecIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ApiVersionSpecIamBinding] {
	return pulumix.Output[*ApiVersionSpecIamBinding]{
		OutputState: i.ToApiVersionSpecIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ApiVersionSpecIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ApiVersionSpecIamBinding] {
	return pulumix.Output[*ApiVersionSpecIamBinding]{
