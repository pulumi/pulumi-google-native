...
func LookupApiIamPolicy(ctx *pulumi.Context, args *LookupApiIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupApiIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:apigeeregistry/v1:getApiIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupApiIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupApiIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
