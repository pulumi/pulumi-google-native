...
func (o LookupApiVersionSpecIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupApiVersionSpecIamPolicyResult] {
	return pulumix.Output[LookupApiVersionSpecIamPolicyResult]{
