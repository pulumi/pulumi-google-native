...
func (o LookupDeploymentArtifactResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDeploymentArtifactResult] {
	return pulumix.Output[LookupDeploymentArtifactResult]{
