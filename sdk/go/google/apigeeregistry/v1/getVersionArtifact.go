...
func (o LookupVersionArtifactResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVersionArtifactResult] {
	return pulumix.Output[LookupVersionArtifactResult]{
...
func (o LookupVersionArtifactResultOutput) Annotations() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupVersionArtifactResult) map[string]string { return v.Annotations }).(pulumi.StringMapOutput)
}
