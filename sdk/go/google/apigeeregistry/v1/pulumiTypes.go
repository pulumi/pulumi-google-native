...
func (o BuildResponseOutput) CommitId() pulumi.StringOutput {
	return o.ApplyT(func(v BuildResponse) string { return v.CommitId }).(pulumi.StringOutput)
}

// Commit time of the latest commit in the build.
func (o BuildResponseOutput) CommitTime() pulumi.StringOutput {
	return o.ApplyT(func(v BuildResponse) string { return v.CommitTime }).(pulumi.StringOutput)
}

// Path of the open source repository: github.com/apigee/registry.
func (o BuildResponseOutput) Repo() pulumi.StringOutput {
	return o.ApplyT(func(v BuildResponse) string { return v.Repo }).(pulumi.StringOutput)
}
...
func (o ConfigOutput) CmekKeyName() pulumi.StringOutput {
	return o.ApplyT(func(v Config) string { return v.CmekKeyName }).(pulumi.StringOutput)
}
...
func (o ConfigResponseOutput) CmekKeyName() pulumi.StringOutput {
	return o.ApplyT(func(v ConfigResponse) string { return v.CmekKeyName }).(pulumi.StringOutput)
}

// The GCP location where the Instance resides.
func (o ConfigResponseOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v ConfigResponse) string { return v.Location }).(pulumi.StringOutput)
}
