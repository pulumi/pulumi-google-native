...
func NewRuntimeIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apigeeregistry/v1:RuntimeIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuntimeIamBinding(ctx *pulumi.Context,
	...
	var resource RuntimeIamBinding
	err := ctx.ReadResource("google-native:apigeeregistry/v1:RuntimeIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RuntimeIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *RuntimeIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
func (o RuntimeIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *RuntimeIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
