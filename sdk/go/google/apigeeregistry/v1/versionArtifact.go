...
func (i *VersionArtifact) ToOutput(ctx context.Context) pulumix.Output[*VersionArtifact] {
	return pulumix.Output[*VersionArtifact]{
		OutputState: i.ToVersionArtifactOutputWithContext(ctx).OutputState,
	}
}
...
func (o VersionArtifactOutput) ToOutput(ctx context.Context) pulumix.Output[*VersionArtifact] {
	return pulumix.Output[*VersionArtifact]{
...
func (o VersionArtifactOutput) Annotations() pulumi.StringMapOutput {
	return o.ApplyT(func(v *VersionArtifact) pulumi.StringMapOutput { return v.Annotations }).(pulumi.StringMapOutput)
}
...
func (o VersionArtifactOutput) Labels() pulumi.StringMapOutput {
	return o.ApplyT(func(v *VersionArtifact) pulumi.StringMapOutput { return v.Labels }).(pulumi.StringMapOutput)
}
