...
func NewAppDomainMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:appengine/v1alpha:AppDomainMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppDomainMapping(ctx *pulumi.Context,
	...
	var resource AppDomainMapping
	err := ctx.ReadResource("google-cloud:appengine/v1alpha:AppDomainMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
