...
// Relative name of the certificate. This is a unique value autogenerated on AuthorizedCertificate resource creation. Example: 12345.
func (o LookupAuthorizedCertificateResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAuthorizedCertificateResult) string { return v.Id }).(pulumi.StringOutput)
}
