...
func NewAppAuthorizedCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:appengine/v1beta:AppAuthorizedCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppAuthorizedCertificate(ctx *pulumi.Context,
	...
	var resource AppAuthorizedCertificate
	err := ctx.ReadResource("google-native:appengine/v1beta:AppAuthorizedCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
