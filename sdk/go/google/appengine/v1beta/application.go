...
func NewApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:appengine/v1beta:Application", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplication(ctx *pulumi.Context,
	...
	var resource Application
	err := ctx.ReadResource("google-cloud:appengine/v1beta:Application", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
