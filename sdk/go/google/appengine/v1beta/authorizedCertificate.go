...
func NewAuthorizedCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:appengine/v1beta:AuthorizedCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizedCertificate(ctx *pulumi.Context,
	...
	var resource AuthorizedCertificate
	err := ctx.ReadResource("google-cloud:appengine/v1beta:AuthorizedCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
