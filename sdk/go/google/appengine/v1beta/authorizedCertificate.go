...
type AuthorizedCertificate struct {
	...
	AuthorizedCertificateId pulumi.StringOutput `pulumi:"authorizedCertificateId"`
...
func NewAuthorizedCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:appengine/v1beta:AuthorizedCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizedCertificate(ctx *pulumi.Context,
	...
	var resource AuthorizedCertificate
	err := ctx.ReadResource("google-native:appengine/v1beta:AuthorizedCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Relative name of the certificate. This is a unique value autogenerated on AuthorizedCertificate resource creation. Example: 12345.
func (o AuthorizedCertificateOutput) AuthorizedCertificateId() pulumi.StringOutput {
	return o.ApplyT(func(v *AuthorizedCertificate) pulumi.StringOutput { return v.AuthorizedCertificateId }).(pulumi.StringOutput)
}
