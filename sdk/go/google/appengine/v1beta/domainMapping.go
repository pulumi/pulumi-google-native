...
func NewDomainMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:appengine/v1beta:DomainMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainMapping(ctx *pulumi.Context,
	...
	var resource DomainMapping
	err := ctx.ReadResource("google-cloud:appengine/v1beta:DomainMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
