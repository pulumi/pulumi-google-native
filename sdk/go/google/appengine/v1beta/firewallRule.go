...
func NewFirewallRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:appengine/v1beta:FirewallRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallRule(ctx *pulumi.Context,
	...
	var resource FirewallRule
	err := ctx.ReadResource("google-cloud:appengine/v1beta:FirewallRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
