...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SslSettingsSslManagementTypeInput)(nil)).Elem(), SslSettingsSslManagementType("AUTOMATIC"))
	pulumi.RegisterInputType(reflect.TypeOf((*SslSettingsSslManagementTypePtrInput)(nil)).Elem(), SslSettingsSslManagementType("AUTOMATIC"))
