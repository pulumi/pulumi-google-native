...
func NewVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:appengine/v1beta:Version", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVersion(ctx *pulumi.Context,
	...
	var resource Version
	err := ctx.ReadResource("google-cloud:appengine/v1beta:Version", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
