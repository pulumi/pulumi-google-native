...
func NewApplicationIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apphub/v1:ApplicationIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationIamPolicy(ctx *pulumi.Context,
	...
	var resource ApplicationIamPolicy
	err := ctx.ReadResource("google-native:apphub/v1:ApplicationIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
