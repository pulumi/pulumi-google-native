...
func NewServiceProjectAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apphub/v1:ServiceProjectAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceProjectAttachment(ctx *pulumi.Context,
	...
	var resource ServiceProjectAttachment
	err := ctx.ReadResource("google-native:apphub/v1:ServiceProjectAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
