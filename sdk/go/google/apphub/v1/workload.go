...
func NewWorkload(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apphub/v1:Workload", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkload(ctx *pulumi.Context,
	...
	var resource Workload
	err := ctx.ReadResource("google-native:apphub/v1:Workload", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
