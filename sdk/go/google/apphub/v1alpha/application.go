...
func NewApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:apphub/v1alpha:Application", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplication(ctx *pulumi.Context,
	...
	var resource Application
	err := ctx.ReadResource("google-native:apphub/v1alpha:Application", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
