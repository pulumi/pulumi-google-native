...
func (in *cleanupPolicyActionPtr) ToOutput(ctx context.Context) pulumix.Output[*CleanupPolicyAction] {
	return pulumix.Output[*CleanupPolicyAction]{
		OutputState: in.ToCleanupPolicyActionPtrOutputWithContext(ctx).OutputState,
	}
}
...
func (in *cleanupPolicyConditionTagStatePtr) ToOutput(ctx context.Context) pulumix.Output[*CleanupPolicyConditionTagState] {
	return pulumix.Output[*CleanupPolicyConditionTagState]{
		OutputState: in.ToCleanupPolicyConditionTagStatePtrOutputWithContext(ctx).OutputState,
	}
}
