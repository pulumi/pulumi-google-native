...
func NewRepository(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:artifactregistry/v1beta2:Repository", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepository(ctx *pulumi.Context,
	...
	var resource Repository
	err := ctx.ReadResource("google-cloud:artifactregistry/v1beta2:Repository", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
