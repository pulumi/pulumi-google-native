...
func NewRepositoryIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:artifactregistry/v1beta2:RepositoryIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepositoryIamBinding(ctx *pulumi.Context,
	...
	var resource RepositoryIamBinding
	err := ctx.ReadResource("google-native:artifactregistry/v1beta2:RepositoryIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
