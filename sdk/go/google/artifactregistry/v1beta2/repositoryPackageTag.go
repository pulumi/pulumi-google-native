...
func NewRepositoryPackageTag(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:artifactregistry/v1beta2:RepositoryPackageTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepositoryPackageTag(ctx *pulumi.Context,
	...
	var resource RepositoryPackageTag
	err := ctx.ReadResource("google-cloud:artifactregistry/v1beta2:RepositoryPackageTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
