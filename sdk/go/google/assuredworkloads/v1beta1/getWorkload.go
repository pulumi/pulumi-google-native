...
type LookupWorkloadResult struct {
	...
	CjisSettings GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsResponse `pulumi:"cjisSettings"`
	...
	ComplianceStatus GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatusResponse `pulumi:"complianceStatus"`
	...
	Controls GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceControlsResponse `pulumi:"controls"`
	...
	FedrampHighSettings GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsResponse `pulumi:"fedrampHighSettings"`
	// Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
	FedrampModerateSettings GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettingsResponse `pulumi:"fedrampModerateSettings"`
	// Input only. Immutable. Settings specific to resources needed for IL4.
	Il4Settings GoogleCloudAssuredworkloadsV1beta1WorkloadIL4SettingsResponse `pulumi:"il4Settings"`
	...
	ResourceSettings []GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResponse `pulumi:"resourceSettings"`
	...
	Resources []GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfoResponse `pulumi:"resources"`
	...
	SaaEnrollmentResponse GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseResponse `pulumi:"saaEnrollmentResponse"`
...
// Input only. Immutable. Settings specific to resources needed for CJIS.
func (o LookupWorkloadResultOutput) CjisSettings() GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsResponseOutput {
	return o.ApplyT(func(v LookupWorkloadResult) GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsResponse {
...
// Count of active Violations in the Workload.
func (o LookupWorkloadResultOutput) ComplianceStatus() GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatusResponseOutput {
	return o.ApplyT(func(v LookupWorkloadResult) GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatusResponse {
...
// Controls associated with the customer workload
func (o LookupWorkloadResultOutput) Controls() GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceControlsResponseOutput {
	return o.ApplyT(func(v LookupWorkloadResult) GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceControlsResponse {
		return v.Controls
...
// Input only. Immutable. Settings specific to resources needed for FedRAMP High.
func (o LookupWorkloadResultOutput) FedrampHighSettings() GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsResponseOutput {
	return o.ApplyT(func(v LookupWorkloadResult) GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsResponse {
		return v.FedrampHighSettings
	}).(GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsResponseOutput)
}

// Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
func (o LookupWorkloadResultOutput) FedrampModerateSettings() GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettingsResponseOutput {
	return o.ApplyT(func(v LookupWorkloadResult) GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettingsResponse {
		return v.FedrampModerateSettings
	}).(GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettingsResponseOutput)
}

// Input only. Immutable. Settings specific to resources needed for IL4.
func (o LookupWorkloadResultOutput) Il4Settings() GoogleCloudAssuredworkloadsV1beta1WorkloadIL4SettingsResponseOutput {
	return o.ApplyT(func(v LookupWorkloadResult) GoogleCloudAssuredworkloadsV1beta1WorkloadIL4SettingsResponse {
...
//
// Deprecated: Input only. Settings used to create a CMEK crypto key. When set, a project with a KMS CMEK key is provisioned. This field is deprecated as of Feb 28, 2022. In order to create a Keyring, callers should specify, ENCRYPTION_KEYS_PROJECT or KEYRING in ResourceSettings.resource_type field.
func (o LookupWorkloadResultOutput) KmsSettings() GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettingsResponseOutput {
	return o.ApplyT(func(v LookupWorkloadResult) GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettingsResponse {
...
// Input only. Resource properties that are used to customize workload resources. These properties (such as custom project id) will be used to create workload resources if possible. This field is optional.
func (o LookupWorkloadResultOutput) ResourceSettings() GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResponseArrayOutput {
	return o.ApplyT(func(v LookupWorkloadResult) []GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResponse {
		return v.ResourceSettings
	}).(GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResponseArrayOutput)
}

// The resources associated with this workload. These resources will be created when creating the workload. If any of the projects already exist, the workload creation will fail. Always read only.
func (o LookupWorkloadResultOutput) Resources() GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfoResponseArrayOutput {
	return o.ApplyT(func(v LookupWorkloadResult) []GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfoResponse {
		return v.Resources
	}).(GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfoResponseArrayOutput)
}

// Represents the SAA enrollment response of the given workload. SAA enrollment response is queried during GetWorkload call. In failure cases, user friendly error message is shown in SAA details page.
func (o LookupWorkloadResultOutput) SaaEnrollmentResponse() GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseResponseOutput {
	return o.ApplyT(func(v LookupWorkloadResult) GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseResponse {
