...
// Indicates the type of resource. This field should be specified to correspond the id to the right project type (CONSUMER_PROJECT or ENCRYPTION_KEYS_PROJECT)
type GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType string

const (
	// Unknown resource type.
	GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceTypeResourceTypeUnspecified = GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("RESOURCE_TYPE_UNSPECIFIED")
	// Deprecated. Existing workloads will continue to support this, but new CreateWorkloadRequests should not specify this as an input value.
	GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceTypeConsumerProject = GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("CONSUMER_PROJECT")
	// Consumer Folder.
	GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceTypeConsumerFolder = GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("CONSUMER_FOLDER")
	// Consumer project containing encryption keys.
	GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceTypeEncryptionKeysProject = GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("ENCRYPTION_KEYS_PROJECT")
	// Keyring resource that hosts encryption keys.
	GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceTypeKeyring = GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResourceType("KEYRING")
)
