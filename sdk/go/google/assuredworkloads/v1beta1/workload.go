...
type Workload struct {
	...
	CjisSettings GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettingsResponseOutput `pulumi:"cjisSettings"`
	...
	ComplianceStatus GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatusResponseOutput `pulumi:"complianceStatus"`
	...
	FedrampHighSettings GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettingsResponseOutput `pulumi:"fedrampHighSettings"`
	// Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
	FedrampModerateSettings GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettingsResponseOutput `pulumi:"fedrampModerateSettings"`
	// Input only. Immutable. Settings specific to resources needed for IL4.
	Il4Settings GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4SettingsResponseOutput `pulumi:"il4Settings"`
	...
	KmsSettings GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettingsResponseOutput `pulumi:"kmsSettings"`
	...
	ResourceSettings GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResponseArrayOutput `pulumi:"resourceSettings"`
	...
	Resources GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfoResponseArrayOutput `pulumi:"resources"`
	...
	SaaEnrollmentResponse GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponseResponseOutput `pulumi:"saaEnrollmentResponse"`
}
...
// Input only. Immutable. Settings specific to resources needed for CJIS.
func (o WorkloadOutput) CjisSettings() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettingsResponseOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettingsResponseOutput {
		return v.CjisSettings
	}).(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettingsResponseOutput)
}
...
// Count of active Violations in the Workload.
func (o WorkloadOutput) ComplianceStatus() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatusResponseOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatusResponseOutput {
		return v.ComplianceStatus
	}).(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatusResponseOutput)
}
...
// Input only. Immutable. Settings specific to resources needed for FedRAMP High.
func (o WorkloadOutput) FedrampHighSettings() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettingsResponseOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettingsResponseOutput {
		return v.FedrampHighSettings
	}).(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettingsResponseOutput)
}

// Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
func (o WorkloadOutput) FedrampModerateSettings() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettingsResponseOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettingsResponseOutput {
		return v.FedrampModerateSettings
	}).(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettingsResponseOutput)
}

// Input only. Immutable. Settings specific to resources needed for IL4.
func (o WorkloadOutput) Il4Settings() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4SettingsResponseOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4SettingsResponseOutput {
		return v.Il4Settings
	}).(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4SettingsResponseOutput)
}
...
//
// Deprecated: Input only. Settings used to create a CMEK crypto key. When set, a project with a KMS CMEK key is provisioned. This field is deprecated as of Feb 28, 2022. In order to create a Keyring, callers should specify, ENCRYPTION_KEYS_PROJECT or KEYRING in ResourceSettings.resource_type field.
func (o WorkloadOutput) KmsSettings() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettingsResponseOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettingsResponseOutput {
...
// Input only. Resource properties that are used to customize workload resources. These properties (such as custom project id) will be used to create workload resources if possible. This field is optional.
func (o WorkloadOutput) ResourceSettings() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResponseArrayOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResponseArrayOutput {
		return v.ResourceSettings
	}).(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResponseArrayOutput)
}

// The resources associated with this workload. These resources will be created when creating the workload. If any of the projects already exist, the workload creation will fail. Always read only.
func (o WorkloadOutput) Resources() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfoResponseArrayOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfoResponseArrayOutput {
		return v.Resources
	}).(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfoResponseArrayOutput)
}

// Represents the SAA enrollment response of the given workload. SAA enrollment response is queried during GetWorkload call. In failure cases, user friendly error message is shown in SAA details page.
func (o WorkloadOutput) SaaEnrollmentResponse() GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponseResponseOutput {
	return o.ApplyT(func(v *Workload) GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponseResponseOutput {
		return v.SaaEnrollmentResponse
	}).(GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponseResponseOutput)
}
