...
func (ManagementURIResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ManagementURIResponse)(nil)).Elem()
}
...
func (o ManagementURIResponseOutput) ToOutput(ctx context.Context) pulumix.Output[ManagementURIResponse] {
	return pulumix.Output[ManagementURIResponse]{
		OutputState: o.OutputState,
	}
}

// The ManagementServer AGM/RD API URL.
func (o ManagementURIResponseOutput) Api() pulumi.StringOutput {
	return o.ApplyT(func(v ManagementURIResponse) string { return v.Api }).(pulumi.StringOutput)
}

// The ManagementServer AGM/RD WebUI URL.
func (o ManagementURIResponseOutput) WebUi() pulumi.StringOutput {
	return o.ApplyT(func(v ManagementURIResponse) string { return v.WebUi }).(pulumi.StringOutput)
}
...
// Optional. The network connect mode of the ManagementServer instance. For this version, only PRIVATE_SERVICE_ACCESS is supported.
func (o NetworkConfigOutput) PeeringMode() NetworkConfigPeeringModePtrOutput {
	return o.ApplyT(func(v NetworkConfig) *NetworkConfigPeeringMode { return v.PeeringMode }).(NetworkConfigPeeringModePtrOutput)
}
...
// Optional. The network connect mode of the ManagementServer instance. For this version, only PRIVATE_SERVICE_ACCESS is supported.
func (o NetworkConfigResponseOutput) PeeringMode() pulumi.StringOutput {
	return o.ApplyT(func(v NetworkConfigResponse) string { return v.PeeringMode }).(pulumi.StringOutput)
}
...
func (WorkforceIdentityBasedManagementURIResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkforceIdentityBasedManagementURIResponse)(nil)).Elem()
}
...
func (o WorkforceIdentityBasedManagementURIResponseOutput) ToOutput(ctx context.Context) pulumix.Output[WorkforceIdentityBasedManagementURIResponse] {
	return pulumix.Output[WorkforceIdentityBasedManagementURIResponse]{
		OutputState: o.OutputState,
	}
}

// First party Management URI for Google Identities.
func (o WorkforceIdentityBasedManagementURIResponseOutput) FirstPartyManagementUri() pulumi.StringOutput {
	return o.ApplyT(func(v WorkforceIdentityBasedManagementURIResponse) string { return v.FirstPartyManagementUri }).(pulumi.StringOutput)
}

// Third party Management URI for External Identity Providers.
func (o WorkforceIdentityBasedManagementURIResponseOutput) ThirdPartyManagementUri() pulumi.StringOutput {
	return o.ApplyT(func(v WorkforceIdentityBasedManagementURIResponse) string { return v.ThirdPartyManagementUri }).(pulumi.StringOutput)
}
...
func (WorkforceIdentityBasedOAuth2ClientIDResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*WorkforceIdentityBasedOAuth2ClientIDResponse)(nil)).Elem()
}
...
func (o WorkforceIdentityBasedOAuth2ClientIDResponseOutput) ToOutput(ctx context.Context) pulumix.Output[WorkforceIdentityBasedOAuth2ClientIDResponse] {
	return pulumix.Output[WorkforceIdentityBasedOAuth2ClientIDResponse]{
		OutputState: o.OutputState,
	}
}

// First party OAuth Client ID for Google Identities.
func (o WorkforceIdentityBasedOAuth2ClientIDResponseOutput) FirstPartyOauth2ClientId() pulumi.StringOutput {
	return o.ApplyT(func(v WorkforceIdentityBasedOAuth2ClientIDResponse) string { return v.FirstPartyOauth2ClientId }).(pulumi.StringOutput)
}

// Third party OAuth Client ID for External Identity Providers.
func (o WorkforceIdentityBasedOAuth2ClientIDResponseOutput) ThirdPartyOauth2ClientId() pulumi.StringOutput {
	return o.ApplyT(func(v WorkforceIdentityBasedOAuth2ClientIDResponse) string { return v.ThirdPartyOauth2ClientId }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ManagementURIResponseOutput{})
	...
	pulumi.RegisterOutputType(WorkforceIdentityBasedManagementURIResponseOutput{})
	pulumi.RegisterOutputType(WorkforceIdentityBasedOAuth2ClientIDResponseOutput{})
}
