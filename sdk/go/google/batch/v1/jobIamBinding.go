...
func NewJobIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:batch/v1:JobIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobIamBinding(ctx *pulumi.Context,
	...
	var resource JobIamBinding
	err := ctx.ReadResource("google-native:batch/v1:JobIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
