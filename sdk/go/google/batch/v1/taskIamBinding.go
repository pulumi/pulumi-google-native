...
func NewTaskIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:batch/v1:TaskIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaskIamBinding(ctx *pulumi.Context,
	...
	var resource TaskIamBinding
	err := ctx.ReadResource("google-native:batch/v1:TaskIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o TaskIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TaskIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o TaskIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TaskIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
