...
func NewTaskIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:batch/v1:TaskIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaskIamMember(ctx *pulumi.Context,
	...
	var resource TaskIamMember
	err := ctx.ReadResource("google-native:batch/v1:TaskIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o TaskIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TaskIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o TaskIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TaskIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
