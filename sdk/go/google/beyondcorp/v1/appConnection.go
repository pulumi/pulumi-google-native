...
func NewAppConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:beyondcorp/v1:AppConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppConnection(ctx *pulumi.Context,
	...
	var resource AppConnection
	err := ctx.ReadResource("google-native:beyondcorp/v1:AppConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type appConnectionArgs struct {
	...
	// Address of the remote application endpoint for the BeyondCorp AppConnection.
	ApplicationEndpoint GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpoint `pulumi:"applicationEndpoint"`
	// Optional. List of [google.cloud.beyondcorp.v1main.Connector.name] that are authorised to be associated with this AppConnection.
	Connectors []string `pulumi:"connectors"`
	// Optional. An arbitrary user-provided name for the AppConnection. Cannot exceed 64 characters.
	DisplayName *string `pulumi:"displayName"`
	// Optional. Gateway used by the AppConnection.
	Gateway *GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway `pulumi:"gateway"`
	// Optional. Resource labels to represent user provided metadata.
...
// Address of the remote application endpoint for the BeyondCorp AppConnection.
func (o AppConnectionOutput) ApplicationEndpoint() GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponseOutput {
	return o.ApplyT(func(v *AppConnection) GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponseOutput {
...
// Optional. Gateway used by the AppConnection.
func (o AppConnectionOutput) Gateway() GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponseOutput {
	return o.ApplyT(func(v *AppConnection) GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponseOutput {
		return v.Gateway
