...
func NewAppConnectionIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:beyondcorp/v1:AppConnectionIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppConnectionIamBinding(ctx *pulumi.Context,
	...
	var resource AppConnectionIamBinding
	err := ctx.ReadResource("google-native:beyondcorp/v1:AppConnectionIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *AppConnectionIamBinding) ToOutput(ctx context.Context) pulumix.Output[*AppConnectionIamBinding] {
	return pulumix.Output[*AppConnectionIamBinding]{
		OutputState: i.ToAppConnectionIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o AppConnectionIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*AppConnectionIamBinding] {
	return pulumix.Output[*AppConnectionIamBinding]{
