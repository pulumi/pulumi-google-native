...
func (i *AppConnectionIamMember) ToOutput(ctx context.Context) pulumix.Output[*AppConnectionIamMember] {
	return pulumix.Output[*AppConnectionIamMember]{
		OutputState: i.ToAppConnectionIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o AppConnectionIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*AppConnectionIamMember] {
	return pulumix.Output[*AppConnectionIamMember]{
