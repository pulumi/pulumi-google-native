...
func NewAppGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:beyondcorp/v1:AppGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppGateway(ctx *pulumi.Context,
	...
	var resource AppGateway
	err := ctx.ReadResource("google-native:beyondcorp/v1:AppGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
