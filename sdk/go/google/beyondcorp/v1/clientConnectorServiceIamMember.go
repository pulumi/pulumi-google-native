...
func NewClientConnectorServiceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:beyondcorp/v1:ClientConnectorServiceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClientConnectorServiceIamMember(ctx *pulumi.Context,
	...
	var resource ClientConnectorServiceIamMember
	err := ctx.ReadResource("google-native:beyondcorp/v1:ClientConnectorServiceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ClientConnectorServiceIamMember) ToOutput(ctx context.Context) pulumix.Output[*ClientConnectorServiceIamMember] {
	return pulumix.Output[*ClientConnectorServiceIamMember]{
		OutputState: i.ToClientConnectorServiceIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o ClientConnectorServiceIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*ClientConnectorServiceIamMember] {
	return pulumix.Output[*ClientConnectorServiceIamMember]{
