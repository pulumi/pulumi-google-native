...
func NewClientGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:beyondcorp/v1:ClientGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClientGateway(ctx *pulumi.Context,
	...
	var resource ClientGateway
	err := ctx.ReadResource("google-native:beyondcorp/v1:ClientGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
