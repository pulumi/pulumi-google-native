...
func LookupAppConnector(ctx *pulumi.Context, args *LookupAppConnectorArgs, opts ...pulumi.InvokeOption) (*LookupAppConnectorResult, error) {
	...
	err := ctx.Invoke("google-native:beyondcorp/v1:getAppConnector", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Principal information about the Identity of the AppConnector.
func (o LookupAppConnectorResultOutput) PrincipalInfo() GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponseOutput {
	return o.ApplyT(func(v LookupAppConnectorResult) GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse {
		return v.PrincipalInfo
	}).(GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponseOutput)
}

// Optional. Resource info of the connector.
func (o LookupAppConnectorResultOutput) ResourceInfo() GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponseOutput {
	return o.ApplyT(func(v LookupAppConnectorResult) GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse {
