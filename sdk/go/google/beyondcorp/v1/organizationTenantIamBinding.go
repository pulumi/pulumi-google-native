...
func (i *OrganizationTenantIamBinding) ToOutput(ctx context.Context) pulumix.Output[*OrganizationTenantIamBinding] {
	return pulumix.Output[*OrganizationTenantIamBinding]{
		OutputState: i.ToOrganizationTenantIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o OrganizationTenantIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*OrganizationTenantIamBinding] {
	return pulumix.Output[*OrganizationTenantIamBinding]{
