...
func NewClientGatewayIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:beyondcorp/v1alpha:ClientGatewayIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClientGatewayIamPolicy(ctx *pulumi.Context,
	...
	var resource ClientGatewayIamPolicy
	err := ctx.ReadResource("google-native:beyondcorp/v1alpha:ClientGatewayIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
