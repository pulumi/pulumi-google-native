...
func NewConnectionIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:beyondcorp/v1alpha:ConnectionIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionIamBinding(ctx *pulumi.Context,
	...
	var resource ConnectionIamBinding
	err := ctx.ReadResource("google-native:beyondcorp/v1alpha:ConnectionIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
