...
// Address of the remote application endpoint for the BeyondCorp AppConnection.
func (o LookupAppConnectionResultOutput) ApplicationEndpoint() GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponseOutput {
...
// Optional. Gateway used by the AppConnection.
func (o LookupAppConnectionResultOutput) Gateway() GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponseOutput {
	return o.ApplyT(func(v LookupAppConnectionResult) GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse {
		return v.Gateway
