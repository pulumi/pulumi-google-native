...
func LookupAppConnectionIamPolicy(ctx *pulumi.Context, args *LookupAppConnectionIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupAppConnectionIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:beyondcorp/v1alpha:getAppConnectionIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupAppConnectionIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAppConnectionIamPolicyResult] {
	return pulumix.Output[LookupAppConnectionIamPolicyResult]{
