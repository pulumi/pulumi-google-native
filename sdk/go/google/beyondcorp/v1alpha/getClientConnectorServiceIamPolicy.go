...
func LookupClientConnectorServiceIamPolicy(ctx *pulumi.Context, args *LookupClientConnectorServiceIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupClientConnectorServiceIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:beyondcorp/v1alpha:getClientConnectorServiceIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupClientConnectorServiceIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupClientConnectorServiceIamPolicyResult] {
	return pulumix.Output[LookupClientConnectorServiceIamPolicyResult]{
