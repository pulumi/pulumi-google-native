...
func (i *NetConnectionIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*NetConnectionIamPolicy] {
	return pulumix.Output[*NetConnectionIamPolicy]{
		OutputState: i.ToNetConnectionIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o NetConnectionIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*NetConnectionIamPolicy] {
	return pulumix.Output[*NetConnectionIamPolicy]{
