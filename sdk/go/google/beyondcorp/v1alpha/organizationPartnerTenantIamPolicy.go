...
func NewOrganizationPartnerTenantIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:beyondcorp/v1alpha:OrganizationPartnerTenantIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationPartnerTenantIamPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationPartnerTenantIamPolicy
	err := ctx.ReadResource("google-native:beyondcorp/v1alpha:OrganizationPartnerTenantIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
