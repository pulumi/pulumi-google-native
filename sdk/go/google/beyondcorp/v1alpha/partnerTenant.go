...
// Optional. Google group email to which the PartnerTenant is enabled.
func (o PartnerTenantOutput) GoogleGroupEmail() pulumi.StringOutput {
	return o.ApplyT(func(v *PartnerTenant) pulumi.StringOutput { return v.GoogleGroupEmail }).(pulumi.StringOutput)
}

// Optional. Google group ID to which the PartnerTenant is enabled.
func (o PartnerTenantOutput) GoogleGroupId() pulumi.StringOutput {
	return o.ApplyT(func(v *PartnerTenant) pulumi.StringOutput { return v.GoogleGroupId }).(pulumi.StringOutput)
}
