...
func NewTableIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:bigquery/v2:TableIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableIamBinding(ctx *pulumi.Context,
	...
	var resource TableIamBinding
	err := ctx.ReadResource("google-native:bigquery/v2:TableIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o TableIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TableIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o TableIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TableIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
