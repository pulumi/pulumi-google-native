...
func NewTableIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:bigquery/v2:TableIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableIamMember(ctx *pulumi.Context,
	...
	var resource TableIamMember
	err := ctx.ReadResource("google-native:bigquery/v2:TableIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o TableIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TableIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o TableIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TableIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
