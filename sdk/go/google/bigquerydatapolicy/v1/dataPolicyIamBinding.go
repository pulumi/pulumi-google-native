...
func NewDataPolicyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:bigquerydatapolicy/v1:DataPolicyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataPolicyIamBinding(ctx *pulumi.Context,
	...
	var resource DataPolicyIamBinding
	err := ctx.ReadResource("google-native:bigquerydatapolicy/v1:DataPolicyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o DataPolicyIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *DataPolicyIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
func (o DataPolicyIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *DataPolicyIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
