...
func NewDataPolicyIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:bigquerydatapolicy/v1:DataPolicyIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataPolicyIamMember(ctx *pulumi.Context,
	...
	var resource DataPolicyIamMember
	err := ctx.ReadResource("google-native:bigquerydatapolicy/v1:DataPolicyIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o DataPolicyIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *DataPolicyIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
func (o DataPolicyIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *DataPolicyIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
