...
func NewTransferConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:bigquerydatatransfer/v1:TransferConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransferConfig(ctx *pulumi.Context,
	...
	var resource TransferConfig
	err := ctx.ReadResource("google-cloud:bigquerydatatransfer/v1:TransferConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
