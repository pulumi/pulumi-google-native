...
func NewAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:bigqueryreservation/v1:Assignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssignment(ctx *pulumi.Context,
	...
	var resource Assignment
	err := ctx.ReadResource("google-cloud:bigqueryreservation/v1:Assignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
