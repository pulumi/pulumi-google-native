...
func NewCapacityCommitment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:bigqueryreservation/v1beta1:CapacityCommitment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCapacityCommitment(ctx *pulumi.Context,
	...
	var resource CapacityCommitment
	err := ctx.ReadResource("google-cloud:bigqueryreservation/v1beta1:CapacityCommitment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
