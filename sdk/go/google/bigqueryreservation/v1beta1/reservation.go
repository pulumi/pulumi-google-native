...
func NewReservation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:bigqueryreservation/v1beta1:Reservation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReservation(ctx *pulumi.Context,
	...
	var resource Reservation
	err := ctx.ReadResource("google-cloud:bigqueryreservation/v1beta1:Reservation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
