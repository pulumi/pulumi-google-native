...
func NewInstanceCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:bigtableadmin/v2:InstanceCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceCluster(ctx *pulumi.Context,
	...
	var resource InstanceCluster
	err := ctx.ReadResource("google-cloud:bigtableadmin/v2:InstanceCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
