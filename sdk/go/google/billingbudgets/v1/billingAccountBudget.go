...
func NewBillingAccountBudget(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:billingbudgets/v1:BillingAccountBudget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingAccountBudget(ctx *pulumi.Context,
	...
	var resource BillingAccountBudget
	err := ctx.ReadResource("google-cloud:billingbudgets/v1:BillingAccountBudget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
