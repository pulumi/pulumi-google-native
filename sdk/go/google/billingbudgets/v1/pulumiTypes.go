...
// Optional. A single label and value pair specifying that usage from only this set of labeled resources should be included in the budget. If omitted, the report includes all labeled and unlabeled usage. An object containing a single `"key": value` pair. Example: `{ "name": "wrench" }`. _Currently, multiple entries or multiple values per entry are not allowed._
func (o GoogleCloudBillingBudgetsV1FilterOutput) Labels() pulumi.MapOutput {
	return o.ApplyT(func(v GoogleCloudBillingBudgetsV1Filter) map[string]interface{} { return v.Labels }).(pulumi.MapOutput)
}
...
// Optional. A single label and value pair specifying that usage from only this set of labeled resources should be included in the budget. If omitted, the report includes all labeled and unlabeled usage. An object containing a single `"key": value` pair. Example: `{ "name": "wrench" }`. _Currently, multiple entries or multiple values per entry are not allowed._
func (o GoogleCloudBillingBudgetsV1FilterPtrOutput) Labels() pulumi.MapOutput {
...
// Optional. A single label and value pair specifying that usage from only this set of labeled resources should be included in the budget. If omitted, the report includes all labeled and unlabeled usage. An object containing a single `"key": value` pair. Example: `{ "name": "wrench" }`. _Currently, multiple entries or multiple values per entry are not allowed._
func (o GoogleCloudBillingBudgetsV1FilterResponseOutput) Labels() pulumi.MapOutput {
	return o.ApplyT(func(v GoogleCloudBillingBudgetsV1FilterResponse) map[string]interface{} { return v.Labels }).(pulumi.MapOutput)
}
