...
func NewAttestorIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:binaryauthorization/v1:AttestorIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestorIamBinding(ctx *pulumi.Context,
	...
	var resource AttestorIamBinding
	err := ctx.ReadResource("google-native:binaryauthorization/v1:AttestorIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
