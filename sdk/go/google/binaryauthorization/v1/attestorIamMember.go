...
func NewAttestorIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:binaryauthorization/v1:AttestorIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestorIamMember(ctx *pulumi.Context,
	...
	var resource AttestorIamMember
	err := ctx.ReadResource("google-native:binaryauthorization/v1:AttestorIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
