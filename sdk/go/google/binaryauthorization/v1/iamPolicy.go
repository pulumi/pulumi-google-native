...
func NewIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:binaryauthorization/v1:IamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIamPolicy(ctx *pulumi.Context,
	...
	var resource IamPolicy
	err := ctx.ReadResource("google-cloud:binaryauthorization/v1:IamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
