...
func NewPolicyIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:binaryauthorization/v1:PolicyIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyIamMember(ctx *pulumi.Context,
	...
	var resource PolicyIamMember
	err := ctx.ReadResource("google-native:binaryauthorization/v1:PolicyIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
