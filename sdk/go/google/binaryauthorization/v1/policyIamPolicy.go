...
func NewPolicyIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:binaryauthorization/v1:PolicyIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyIamPolicy(ctx *pulumi.Context,
	...
	var resource PolicyIamPolicy
	err := ctx.ReadResource("google-cloud:binaryauthorization/v1:PolicyIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
