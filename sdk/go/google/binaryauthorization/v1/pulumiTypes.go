...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*UserOwnedGrafeasNoteResponseInput)(nil)).Elem(), UserOwnedGrafeasNoteResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserOwnedGrafeasNoteResponsePtrInput)(nil)).Elem(), UserOwnedGrafeasNoteResponseArgs{})
