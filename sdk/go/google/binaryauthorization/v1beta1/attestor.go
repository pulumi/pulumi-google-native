...
func NewAttestor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:binaryauthorization/v1beta1:Attestor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttestor(ctx *pulumi.Context,
	...
	var resource Attestor
	err := ctx.ReadResource("google-cloud:binaryauthorization/v1beta1:Attestor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
