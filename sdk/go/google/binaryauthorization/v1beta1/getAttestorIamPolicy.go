...
func LookupAttestorIamPolicy(ctx *pulumi.Context, args *LookupAttestorIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupAttestorIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:binaryauthorization/v1beta1:getAttestorIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupAttestorIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupAttestorIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupAttestorIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupAttestorIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
