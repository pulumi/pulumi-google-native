...
func NewBillingAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudbilling/v1:BillingAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingAccount(ctx *pulumi.Context,
	...
	var resource BillingAccount
	err := ctx.ReadResource("google-cloud:cloudbilling/v1:BillingAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
