...
// GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigInput is an input type that accepts GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs and GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput values.
// You can construct a concrete instance of `GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigInput` via:
//
//          GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs{...}
type GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigInput interface {
	pulumi.Input

	ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput
	ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutputWithContext(context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput
}

// Configuration per workload for both Private Pools and Hybrid Pools.
type GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs struct {
	// The disk size (in GB) which is requested for the build container. If unset, a value of 10 GB will be used.
	DiskSizeGb pulumi.StringPtrInput `pulumi:"diskSizeGb"`
	// The memory (in GB) which is requested for the build container. If unset, a value of 4 GB will be used.
	MemoryGb pulumi.Float64PtrInput `pulumi:"memoryGb"`
	// The number of vCPUs which are requested for the build container. If unset, a value of 1 will be used.
	VcpuCount pulumi.Float64PtrInput `pulumi:"vcpuCount"`
}

func (GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig)(nil)).Elem()
}

func (i GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput {
	return i.ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutputWithContext(context.Background())
}

func (i GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutputWithContext(ctx context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput)
}

func (i GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return i.ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(context.Background())
}

func (i GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(ctx context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput).ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(ctx)
}

// GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrInput is an input type that accepts GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs, GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtr and GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput values.
// You can construct a concrete instance of `GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrInput` via:
//
//          GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs{...}
//
//  or:
//
//          nil
type GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrInput interface {
	pulumi.Input

	ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput
	ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput
}

type googleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrType GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs

func GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtr(v *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrInput {
	return (*googleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrType)(v)
}

func (*googleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig)(nil)).Elem()
}

func (i *googleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrType) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return i.ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(context.Background())
}

func (i *googleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrType) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(ctx context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput)
}

// Configuration per workload for both Private Pools and Hybrid Pools.
type GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput struct{ *pulumi.OutputState }

func (GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig)(nil)).Elem()
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput {
	return o
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutputWithContext(ctx context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput {
	return o
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return o.ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(context.Background())
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(ctx context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig) *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig {
		return &v
	}).(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput)
}

// The disk size (in GB) which is requested for the build container. If unset, a value of 10 GB will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput) DiskSizeGb() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig) *string { return v.DiskSizeGb }).(pulumi.StringPtrOutput)
}

// The memory (in GB) which is requested for the build container. If unset, a value of 4 GB will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput) MemoryGb() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig) *float64 { return v.MemoryGb }).(pulumi.Float64PtrOutput)
}

// The number of vCPUs which are requested for the build container. If unset, a value of 1 will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput) VcpuCount() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig) *float64 { return v.VcpuCount }).(pulumi.Float64PtrOutput)
}

type GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput struct{ *pulumi.OutputState }

func (GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig)(nil)).Elem()
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return o
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutputWithContext(ctx context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return o
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput) Elem() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput {
	return o.ApplyT(func(v *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig {
		if v != nil {
			return *v
		}
		var ret GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig
		return ret
	}).(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput)
}

// The disk size (in GB) which is requested for the build container. If unset, a value of 10 GB will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput) DiskSizeGb() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig) *string {
		if v == nil {
			return nil
		}
		return v.DiskSizeGb
...
// The memory (in GB) which is requested for the build container. If unset, a value of 4 GB will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput) MemoryGb() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig) *float64 {
		if v == nil {
			return nil
		}
		return v.MemoryGb
...
// The number of vCPUs which are requested for the build container. If unset, a value of 1 will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput) VcpuCount() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig) *float64 {
		if v == nil {
			return nil
		}
...
// Configuration per workload for both Private Pools and Hybrid Pools.
type GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponse struct {
	// The disk size (in GB) which is requested for the build container. If unset, a value of 10 GB will be used.
	DiskSizeGb string `pulumi:"diskSizeGb"`
	// The memory (in GB) which is requested for the build container. If unset, a value of 4 GB will be used.
	MemoryGb float64 `pulumi:"memoryGb"`
...
// Configuration per workload for both Private Pools and Hybrid Pools.
type GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput struct{ *pulumi.OutputState }

func (GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponse)(nil)).Elem()
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput {
	return o
}

func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput) ToGoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutputWithContext(ctx context.Context) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput {
	return o
}

// The disk size (in GB) which is requested for the build container. If unset, a value of 10 GB will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput) DiskSizeGb() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponse) string {
		return v.DiskSizeGb
	}).(pulumi.StringOutput)
}

// The memory (in GB) which is requested for the build container. If unset, a value of 4 GB will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput) MemoryGb() pulumi.Float64Output {
	return o.ApplyT(func(v GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponse) float64 {
		return v.MemoryGb
	}).(pulumi.Float64Output)
}

// The number of vCPUs which are requested for the build container. If unset, a value of 1 will be used.
func (o GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput) VcpuCount() pulumi.Float64Output {
	return o.ApplyT(func(v GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponse) float64 {
		return v.VcpuCount
	}).(pulumi.Float64Output)
}
...
type HybridPoolConfig struct {
	...
	DefaultWorkerConfig *HybridWorkerConfig `pulumi:"defaultWorkerConfig"`
...
// HybridPoolConfigInput is an input type that accepts HybridPoolConfigArgs and HybridPoolConfigOutput values.
// You can construct a concrete instance of `HybridPoolConfigInput` via:
//
//          HybridPoolConfigArgs{...}
type HybridPoolConfigInput interface {
	pulumi.Input

	ToHybridPoolConfigOutput() HybridPoolConfigOutput
	ToHybridPoolConfigOutputWithContext(context.Context) HybridPoolConfigOutput
}

// Configuration for a Hybrid Worker Pool Next ID: 6
type HybridPoolConfigArgs struct {
	// Default settings which will be applied to builds on this worker pool if they are not specified in the build request.
	DefaultWorkerConfig HybridWorkerConfigPtrInput `pulumi:"defaultWorkerConfig"`
	// Immutable. The Anthos/GKE Hub membership of the cluster which will run the actual build operations. Example: projects/{project}/locations/{location}/memberships/{cluster_name}
	Membership pulumi.StringInput `pulumi:"membership"`
}

func (HybridPoolConfigArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HybridPoolConfig)(nil)).Elem()
}

func (i HybridPoolConfigArgs) ToHybridPoolConfigOutput() HybridPoolConfigOutput {
	return i.ToHybridPoolConfigOutputWithContext(context.Background())
}

func (i HybridPoolConfigArgs) ToHybridPoolConfigOutputWithContext(ctx context.Context) HybridPoolConfigOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HybridPoolConfigOutput)
}

func (i HybridPoolConfigArgs) ToHybridPoolConfigPtrOutput() HybridPoolConfigPtrOutput {
	return i.ToHybridPoolConfigPtrOutputWithContext(context.Background())
}

func (i HybridPoolConfigArgs) ToHybridPoolConfigPtrOutputWithContext(ctx context.Context) HybridPoolConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HybridPoolConfigOutput).ToHybridPoolConfigPtrOutputWithContext(ctx)
}

// HybridPoolConfigPtrInput is an input type that accepts HybridPoolConfigArgs, HybridPoolConfigPtr and HybridPoolConfigPtrOutput values.
// You can construct a concrete instance of `HybridPoolConfigPtrInput` via:
//
//          HybridPoolConfigArgs{...}
//
//  or:
//
//          nil
type HybridPoolConfigPtrInput interface {
	pulumi.Input

	ToHybridPoolConfigPtrOutput() HybridPoolConfigPtrOutput
	ToHybridPoolConfigPtrOutputWithContext(context.Context) HybridPoolConfigPtrOutput
}

type hybridPoolConfigPtrType HybridPoolConfigArgs

func HybridPoolConfigPtr(v *HybridPoolConfigArgs) HybridPoolConfigPtrInput {
	return (*hybridPoolConfigPtrType)(v)
}

func (*hybridPoolConfigPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**HybridPoolConfig)(nil)).Elem()
}

func (i *hybridPoolConfigPtrType) ToHybridPoolConfigPtrOutput() HybridPoolConfigPtrOutput {
	return i.ToHybridPoolConfigPtrOutputWithContext(context.Background())
}

func (i *hybridPoolConfigPtrType) ToHybridPoolConfigPtrOutputWithContext(ctx context.Context) HybridPoolConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HybridPoolConfigPtrOutput)
}

// Configuration for a Hybrid Worker Pool Next ID: 6
type HybridPoolConfigOutput struct{ *pulumi.OutputState }

func (HybridPoolConfigOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HybridPoolConfig)(nil)).Elem()
}

func (o HybridPoolConfigOutput) ToHybridPoolConfigOutput() HybridPoolConfigOutput {
	return o
}

func (o HybridPoolConfigOutput) ToHybridPoolConfigOutputWithContext(ctx context.Context) HybridPoolConfigOutput {
	return o
}

func (o HybridPoolConfigOutput) ToHybridPoolConfigPtrOutput() HybridPoolConfigPtrOutput {
	return o.ToHybridPoolConfigPtrOutputWithContext(context.Background())
}

func (o HybridPoolConfigOutput) ToHybridPoolConfigPtrOutputWithContext(ctx context.Context) HybridPoolConfigPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v HybridPoolConfig) *HybridPoolConfig {
		return &v
	}).(HybridPoolConfigPtrOutput)
}

// Default settings which will be applied to builds on this worker pool if they are not specified in the build request.
func (o HybridPoolConfigOutput) DefaultWorkerConfig() HybridWorkerConfigPtrOutput {
	return o.ApplyT(func(v HybridPoolConfig) *HybridWorkerConfig { return v.DefaultWorkerConfig }).(HybridWorkerConfigPtrOutput)
}

// Immutable. The Anthos/GKE Hub membership of the cluster which will run the actual build operations. Example: projects/{project}/locations/{location}/memberships/{cluster_name}
func (o HybridPoolConfigOutput) Membership() pulumi.StringOutput {
	return o.ApplyT(func(v HybridPoolConfig) string { return v.Membership }).(pulumi.StringOutput)
}

type HybridPoolConfigPtrOutput struct{ *pulumi.OutputState }

func (HybridPoolConfigPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**HybridPoolConfig)(nil)).Elem()
}

func (o HybridPoolConfigPtrOutput) ToHybridPoolConfigPtrOutput() HybridPoolConfigPtrOutput {
	return o
}

func (o HybridPoolConfigPtrOutput) ToHybridPoolConfigPtrOutputWithContext(ctx context.Context) HybridPoolConfigPtrOutput {
	return o
}

func (o HybridPoolConfigPtrOutput) Elem() HybridPoolConfigOutput {
	return o.ApplyT(func(v *HybridPoolConfig) HybridPoolConfig {
		if v != nil {
			return *v
		}
		var ret HybridPoolConfig
		return ret
	}).(HybridPoolConfigOutput)
}

// Default settings which will be applied to builds on this worker pool if they are not specified in the build request.
func (o HybridPoolConfigPtrOutput) DefaultWorkerConfig() HybridWorkerConfigPtrOutput {
	return o.ApplyT(func(v *HybridPoolConfig) *HybridWorkerConfig {
		if v == nil {
			return nil
		}
		return v.DefaultWorkerConfig
	}).(HybridWorkerConfigPtrOutput)
}

// Immutable. The Anthos/GKE Hub membership of the cluster which will run the actual build operations. Example: projects/{project}/locations/{location}/memberships/{cluster_name}
func (o HybridPoolConfigPtrOutput) Membership() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *HybridPoolConfig) *string {
		if v == nil {
			return nil
		}
		return &v.Membership
...
// Configuration for a Hybrid Worker Pool Next ID: 6
type HybridPoolConfigResponse struct {
	// Default settings which will be applied to builds on this worker pool if they are not specified in the build request.
	DefaultWorkerConfig HybridWorkerConfigResponse `pulumi:"defaultWorkerConfig"`
	// Immutable. The Anthos/GKE Hub membership of the cluster which will run the actual build operations. Example: projects/{project}/locations/{location}/memberships/{cluster_name}
	Membership string `pulumi:"membership"`
}

// Configuration for a Hybrid Worker Pool Next ID: 6
type HybridPoolConfigResponseOutput struct{ *pulumi.OutputState }

func (HybridPoolConfigResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HybridPoolConfigResponse)(nil)).Elem()
}

func (o HybridPoolConfigResponseOutput) ToHybridPoolConfigResponseOutput() HybridPoolConfigResponseOutput {
	return o
}

func (o HybridPoolConfigResponseOutput) ToHybridPoolConfigResponseOutputWithContext(ctx context.Context) HybridPoolConfigResponseOutput {
	return o
}

// Default settings which will be applied to builds on this worker pool if they are not specified in the build request.
func (o HybridPoolConfigResponseOutput) DefaultWorkerConfig() HybridWorkerConfigResponseOutput {
	return o.ApplyT(func(v HybridPoolConfigResponse) HybridWorkerConfigResponse { return v.DefaultWorkerConfig }).(HybridWorkerConfigResponseOutput)
}

// Immutable. The Anthos/GKE Hub membership of the cluster which will run the actual build operations. Example: projects/{project}/locations/{location}/memberships/{cluster_name}
func (o HybridPoolConfigResponseOutput) Membership() pulumi.StringOutput {
	return o.ApplyT(func(v HybridPoolConfigResponse) string { return v.Membership }).(pulumi.StringOutput)
}
...
// HybridWorkerConfigInput is an input type that accepts HybridWorkerConfigArgs and HybridWorkerConfigOutput values.
// You can construct a concrete instance of `HybridWorkerConfigInput` via:
//
//          HybridWorkerConfigArgs{...}
type HybridWorkerConfigInput interface {
	pulumi.Input

	ToHybridWorkerConfigOutput() HybridWorkerConfigOutput
	ToHybridWorkerConfigOutputWithContext(context.Context) HybridWorkerConfigOutput
}

// These settings can be applied to a user's build operations. Next ID: 4
type HybridWorkerConfigArgs struct {
	// The disk size (in GB) which is requested for the build container. Defaults to 10 GB.
	DiskSizeGb pulumi.StringPtrInput `pulumi:"diskSizeGb"`
	// The memory (in GB) which is requested for the build container. Defaults to 4 GB.
	MemoryGb pulumi.Float64PtrInput `pulumi:"memoryGb"`
...
func (HybridWorkerConfigArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HybridWorkerConfig)(nil)).Elem()
}

func (i HybridWorkerConfigArgs) ToHybridWorkerConfigOutput() HybridWorkerConfigOutput {
	return i.ToHybridWorkerConfigOutputWithContext(context.Background())
}

func (i HybridWorkerConfigArgs) ToHybridWorkerConfigOutputWithContext(ctx context.Context) HybridWorkerConfigOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HybridWorkerConfigOutput)
}

func (i HybridWorkerConfigArgs) ToHybridWorkerConfigPtrOutput() HybridWorkerConfigPtrOutput {
	return i.ToHybridWorkerConfigPtrOutputWithContext(context.Background())
}

func (i HybridWorkerConfigArgs) ToHybridWorkerConfigPtrOutputWithContext(ctx context.Context) HybridWorkerConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HybridWorkerConfigOutput).ToHybridWorkerConfigPtrOutputWithContext(ctx)
}

// HybridWorkerConfigPtrInput is an input type that accepts HybridWorkerConfigArgs, HybridWorkerConfigPtr and HybridWorkerConfigPtrOutput values.
// You can construct a concrete instance of `HybridWorkerConfigPtrInput` via:
//
//          HybridWorkerConfigArgs{...}
//
//  or:
//
//          nil
type HybridWorkerConfigPtrInput interface {
	pulumi.Input

	ToHybridWorkerConfigPtrOutput() HybridWorkerConfigPtrOutput
	ToHybridWorkerConfigPtrOutputWithContext(context.Context) HybridWorkerConfigPtrOutput
}

type hybridWorkerConfigPtrType HybridWorkerConfigArgs

func HybridWorkerConfigPtr(v *HybridWorkerConfigArgs) HybridWorkerConfigPtrInput {
	return (*hybridWorkerConfigPtrType)(v)
}

func (*hybridWorkerConfigPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**HybridWorkerConfig)(nil)).Elem()
}

func (i *hybridWorkerConfigPtrType) ToHybridWorkerConfigPtrOutput() HybridWorkerConfigPtrOutput {
	return i.ToHybridWorkerConfigPtrOutputWithContext(context.Background())
}

func (i *hybridWorkerConfigPtrType) ToHybridWorkerConfigPtrOutputWithContext(ctx context.Context) HybridWorkerConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HybridWorkerConfigPtrOutput)
}

// These settings can be applied to a user's build operations. Next ID: 4
type HybridWorkerConfigOutput struct{ *pulumi.OutputState }

func (HybridWorkerConfigOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HybridWorkerConfig)(nil)).Elem()
}

func (o HybridWorkerConfigOutput) ToHybridWorkerConfigOutput() HybridWorkerConfigOutput {
	return o
}

func (o HybridWorkerConfigOutput) ToHybridWorkerConfigOutputWithContext(ctx context.Context) HybridWorkerConfigOutput {
	return o
}

func (o HybridWorkerConfigOutput) ToHybridWorkerConfigPtrOutput() HybridWorkerConfigPtrOutput {
	return o.ToHybridWorkerConfigPtrOutputWithContext(context.Background())
}

func (o HybridWorkerConfigOutput) ToHybridWorkerConfigPtrOutputWithContext(ctx context.Context) HybridWorkerConfigPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v HybridWorkerConfig) *HybridWorkerConfig {
		return &v
	}).(HybridWorkerConfigPtrOutput)
}

// The disk size (in GB) which is requested for the build container. Defaults to 10 GB.
func (o HybridWorkerConfigOutput) DiskSizeGb() pulumi.StringPtrOutput {
	return o.ApplyT(func(v HybridWorkerConfig) *string { return v.DiskSizeGb }).(pulumi.StringPtrOutput)
}

// The memory (in GB) which is requested for the build container. Defaults to 4 GB.
func (o HybridWorkerConfigOutput) MemoryGb() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v HybridWorkerConfig) *float64 { return v.MemoryGb }).(pulumi.Float64PtrOutput)
}

// The number of vCPUs which are requested for the build container. Defaults to 1.
func (o HybridWorkerConfigOutput) VcpuCount() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v HybridWorkerConfig) *float64 { return v.VcpuCount }).(pulumi.Float64PtrOutput)
}

type HybridWorkerConfigPtrOutput struct{ *pulumi.OutputState }

func (HybridWorkerConfigPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**HybridWorkerConfig)(nil)).Elem()
}

func (o HybridWorkerConfigPtrOutput) ToHybridWorkerConfigPtrOutput() HybridWorkerConfigPtrOutput {
	return o
}

func (o HybridWorkerConfigPtrOutput) ToHybridWorkerConfigPtrOutputWithContext(ctx context.Context) HybridWorkerConfigPtrOutput {
	return o
}

func (o HybridWorkerConfigPtrOutput) Elem() HybridWorkerConfigOutput {
	return o.ApplyT(func(v *HybridWorkerConfig) HybridWorkerConfig {
		if v != nil {
			return *v
		}
		var ret HybridWorkerConfig
		return ret
	}).(HybridWorkerConfigOutput)
}

// The disk size (in GB) which is requested for the build container. Defaults to 10 GB.
func (o HybridWorkerConfigPtrOutput) DiskSizeGb() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *HybridWorkerConfig) *string {
		if v == nil {
			return nil
		}
		return v.DiskSizeGb
...
// The memory (in GB) which is requested for the build container. Defaults to 4 GB.
func (o HybridWorkerConfigPtrOutput) MemoryGb() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *HybridWorkerConfig) *float64 {
		if v == nil {
			return nil
		}
		return v.MemoryGb
...
// The number of vCPUs which are requested for the build container. Defaults to 1.
func (o HybridWorkerConfigPtrOutput) VcpuCount() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *HybridWorkerConfig) *float64 {
		if v == nil {
			return nil
		}
...
// These settings can be applied to a user's build operations. Next ID: 4
type HybridWorkerConfigResponse struct {
	// The disk size (in GB) which is requested for the build container. Defaults to 10 GB.
	DiskSizeGb string `pulumi:"diskSizeGb"`
	// The memory (in GB) which is requested for the build container. Defaults to 4 GB.
	MemoryGb float64 `pulumi:"memoryGb"`
...
// These settings can be applied to a user's build operations. Next ID: 4
type HybridWorkerConfigResponseOutput struct{ *pulumi.OutputState }

func (HybridWorkerConfigResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HybridWorkerConfigResponse)(nil)).Elem()
}

func (o HybridWorkerConfigResponseOutput) ToHybridWorkerConfigResponseOutput() HybridWorkerConfigResponseOutput {
	return o
}

func (o HybridWorkerConfigResponseOutput) ToHybridWorkerConfigResponseOutputWithContext(ctx context.Context) HybridWorkerConfigResponseOutput {
	return o
}

// The disk size (in GB) which is requested for the build container. Defaults to 10 GB.
func (o HybridWorkerConfigResponseOutput) DiskSizeGb() pulumi.StringOutput {
	return o.ApplyT(func(v HybridWorkerConfigResponse) string { return v.DiskSizeGb }).(pulumi.StringOutput)
}

// The memory (in GB) which is requested for the build container. Defaults to 4 GB.
func (o HybridWorkerConfigResponseOutput) MemoryGb() pulumi.Float64Output {
	return o.ApplyT(func(v HybridWorkerConfigResponse) float64 { return v.MemoryGb }).(pulumi.Float64Output)
}

// The number of vCPUs which are requested for the build container. Defaults to 1.
func (o HybridWorkerConfigResponseOutput) VcpuCount() pulumi.Float64Output {
	return o.ApplyT(func(v HybridWorkerConfigResponse) float64 { return v.VcpuCount }).(pulumi.Float64Output)
}
...
type PoolOption struct {
	...
	WorkerConfig *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig `pulumi:"workerConfig"`
}
...
type PoolOptionArgs struct {
	...
	Name pulumi.StringPtrInput `pulumi:"name"`
	// Configuration per workload.
	WorkerConfig GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrInput `pulumi:"workerConfig"`
}
...
// Configuration per workload.
func (o PoolOptionOutput) WorkerConfig() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return o.ApplyT(func(v PoolOption) *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig {
...
// Configuration per workload.
func (o PoolOptionPtrOutput) WorkerConfig() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput {
	return o.ApplyT(func(v *PoolOption) *GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig {
		if v == nil {
			return nil
		}
...
type PoolOptionResponse struct {
	...
	Name string `pulumi:"name"`
	// Configuration per workload.
	WorkerConfig GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponse `pulumi:"workerConfig"`
}
...
// Configuration per workload.
func (o PoolOptionResponseOutput) WorkerConfig() GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput {
	return o.ApplyT(func(v PoolOptionResponse) GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponse {
		return v.WorkerConfig
	}).(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigInput)(nil)).Elem(), GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrInput)(nil)).Elem(), GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridPoolConfigInput)(nil)).Elem(), HybridPoolConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridPoolConfigPtrInput)(nil)).Elem(), HybridPoolConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridWorkerConfigInput)(nil)).Elem(), HybridWorkerConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HybridWorkerConfigPtrInput)(nil)).Elem(), HybridWorkerConfigArgs{})
	...
	pulumi.RegisterOutputType(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigOutput{})
	pulumi.RegisterOutputType(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigPtrOutput{})
	pulumi.RegisterOutputType(GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfigResponseOutput{})
	pulumi.RegisterOutputType(HybridPoolConfigOutput{})
	pulumi.RegisterOutputType(HybridPoolConfigPtrOutput{})
	pulumi.RegisterOutputType(HybridPoolConfigResponseOutput{})
	pulumi.RegisterOutputType(HybridWorkerConfigOutput{})
	pulumi.RegisterOutputType(HybridWorkerConfigPtrOutput{})
	pulumi.RegisterOutputType(HybridWorkerConfigResponseOutput{})
