...
func NewAccountCustomer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudchannel/v1:AccountCustomer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountCustomer(ctx *pulumi.Context,
	...
	var resource AccountCustomer
	err := ctx.ReadResource("google-native:cloudchannel/v1:AccountCustomer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
