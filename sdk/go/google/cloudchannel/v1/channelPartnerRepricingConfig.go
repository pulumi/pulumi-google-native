...
func (i *ChannelPartnerRepricingConfig) ToOutput(ctx context.Context) pulumix.Output[*ChannelPartnerRepricingConfig] {
	return pulumix.Output[*ChannelPartnerRepricingConfig]{
		OutputState: i.ToChannelPartnerRepricingConfigOutputWithContext(ctx).OutputState,
	}
}
...
func (o ChannelPartnerRepricingConfigOutput) ToOutput(ctx context.Context) pulumix.Output[*ChannelPartnerRepricingConfig] {
	return pulumix.Output[*ChannelPartnerRepricingConfig]{
