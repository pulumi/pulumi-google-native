...
type GoogleCloudChannelV1RenewalSettingsResponse struct {
	...
	ScheduledRenewalOffer string `pulumi:"scheduledRenewalOffer"`
}
...
// The renewal offer resource name for which the entitlement is to be renewed. Takes the form: accounts/{account_id}/offers/{offer_id}.
func (o GoogleCloudChannelV1RenewalSettingsResponseOutput) ScheduledRenewalOffer() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleCloudChannelV1RenewalSettingsResponse) string { return v.ScheduledRenewalOffer }).(pulumi.StringOutput)
}
