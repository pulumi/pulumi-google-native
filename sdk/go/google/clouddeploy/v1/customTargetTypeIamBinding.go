...
func NewCustomTargetTypeIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:clouddeploy/v1:CustomTargetTypeIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomTargetTypeIamBinding(ctx *pulumi.Context,
	...
	var resource CustomTargetTypeIamBinding
	err := ctx.ReadResource("google-native:clouddeploy/v1:CustomTargetTypeIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o CustomTargetTypeIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *CustomTargetTypeIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
