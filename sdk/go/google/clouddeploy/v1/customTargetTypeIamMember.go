...
func NewCustomTargetTypeIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:clouddeploy/v1:CustomTargetTypeIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomTargetTypeIamMember(ctx *pulumi.Context,
	...
	var resource CustomTargetTypeIamMember
	err := ctx.ReadResource("google-native:clouddeploy/v1:CustomTargetTypeIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o CustomTargetTypeIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *CustomTargetTypeIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
