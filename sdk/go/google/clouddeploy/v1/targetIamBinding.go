...
func (i *TargetIamBinding) ToOutput(ctx context.Context) pulumix.Output[*TargetIamBinding] {
	return pulumix.Output[*TargetIamBinding]{
		OutputState: i.ToTargetIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o TargetIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*TargetIamBinding] {
	return pulumix.Output[*TargetIamBinding]{
