...
func NewTargetIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:clouddeploy/v1:TargetIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetIamMember(ctx *pulumi.Context,
	...
	var resource TargetIamMember
	err := ctx.ReadResource("google-native:clouddeploy/v1:TargetIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *TargetIamMember) ToOutput(ctx context.Context) pulumix.Output[*TargetIamMember] {
	return pulumix.Output[*TargetIamMember]{
		OutputState: i.ToTargetIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o TargetIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*TargetIamMember] {
	return pulumix.Output[*TargetIamMember]{
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o TargetIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TargetIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
