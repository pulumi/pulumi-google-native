...
// State Messages for this Cloud Function.
func (o FunctionOutput) StateMessages() GoogleCloudFunctionsV2alphaStateMessageResponseArrayOutput {
	return o.ApplyT(func(v *Function) GoogleCloudFunctionsV2alphaStateMessageResponseArrayOutput { return v.StateMessages }).(GoogleCloudFunctionsV2alphaStateMessageResponseArrayOutput)
}
