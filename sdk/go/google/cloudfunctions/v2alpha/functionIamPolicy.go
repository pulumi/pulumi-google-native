...
func NewFunctionIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudfunctions/v2alpha:FunctionIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionIamPolicy(ctx *pulumi.Context,
	...
	var resource FunctionIamPolicy
	err := ctx.ReadResource("google-native:cloudfunctions/v2alpha:FunctionIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
