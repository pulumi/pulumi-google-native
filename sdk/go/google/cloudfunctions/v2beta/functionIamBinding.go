...
func NewFunctionIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudfunctions/v2beta:FunctionIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionIamBinding(ctx *pulumi.Context,
	...
	var resource FunctionIamBinding
	err := ctx.ReadResource("google-native:cloudfunctions/v2beta:FunctionIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
