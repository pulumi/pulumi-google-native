...
func NewFunctionIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudfunctions/v2beta:FunctionIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionIamMember(ctx *pulumi.Context,
	...
	var resource FunctionIamMember
	err := ctx.ReadResource("google-native:cloudfunctions/v2beta:FunctionIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
