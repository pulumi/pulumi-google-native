...
func (GoogleCloudFunctionsV2betaStateMessageResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudFunctionsV2betaStateMessageResponse)(nil)).Elem()
}

func (o GoogleCloudFunctionsV2betaStateMessageResponseOutput) ToGoogleCloudFunctionsV2betaStateMessageResponseOutput() GoogleCloudFunctionsV2betaStateMessageResponseOutput {
	return o
}
...
func (o GoogleCloudFunctionsV2betaStateMessageResponseOutput) ToOutput(ctx context.Context) pulumix.Output[GoogleCloudFunctionsV2betaStateMessageResponse] {
	return pulumix.Output[GoogleCloudFunctionsV2betaStateMessageResponse]{
		OutputState: o.OutputState,
	}
}

// The message.
func (o GoogleCloudFunctionsV2betaStateMessageResponseOutput) Message() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleCloudFunctionsV2betaStateMessageResponse) string { return v.Message }).(pulumi.StringOutput)
}

// Severity of the state message.
func (o GoogleCloudFunctionsV2betaStateMessageResponseOutput) Severity() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleCloudFunctionsV2betaStateMessageResponse) string { return v.Severity }).(pulumi.StringOutput)
}

// One-word CamelCase type of the state message.
func (o GoogleCloudFunctionsV2betaStateMessageResponseOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleCloudFunctionsV2betaStateMessageResponse) string { return v.Type }).(pulumi.StringOutput)
}

type GoogleCloudFunctionsV2betaStateMessageResponseArrayOutput struct{ *pulumi.OutputState }

func (GoogleCloudFunctionsV2betaStateMessageResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GoogleCloudFunctionsV2betaStateMessageResponse)(nil)).Elem()
}

func (o GoogleCloudFunctionsV2betaStateMessageResponseArrayOutput) ToGoogleCloudFunctionsV2betaStateMessageResponseArrayOutput() GoogleCloudFunctionsV2betaStateMessageResponseArrayOutput {
	return o
}
...
func (o GoogleCloudFunctionsV2betaStateMessageResponseArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]GoogleCloudFunctionsV2betaStateMessageResponse] {
	return pulumix.Output[[]GoogleCloudFunctionsV2betaStateMessageResponse]{
		OutputState: o.OutputState,
	}
}

func (o GoogleCloudFunctionsV2betaStateMessageResponseArrayOutput) Index(i pulumi.IntInput) GoogleCloudFunctionsV2betaStateMessageResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GoogleCloudFunctionsV2betaStateMessageResponse {
		return vs[0].([]GoogleCloudFunctionsV2betaStateMessageResponse)[vs[1].(int)]
	}).(GoogleCloudFunctionsV2betaStateMessageResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(GoogleCloudFunctionsV2betaStateMessageResponseOutput{})
	pulumi.RegisterOutputType(GoogleCloudFunctionsV2betaStateMessageResponseArrayOutput{})
