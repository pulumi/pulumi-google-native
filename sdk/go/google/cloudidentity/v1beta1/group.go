...
func NewGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.RegisterResource("google-cloud:cloudidentity/v1beta1:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("google-cloud:cloudidentity/v1beta1:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type GroupState struct {
	// Additional entity key aliases for a Group.
	AdditionalGroupKeys EntityKeyResponseArrayInput
	// The time when the `Group` was created.
