...
func NewInboundSamlSsoProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudidentity/v1beta1:InboundSamlSsoProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInboundSamlSsoProfile(ctx *pulumi.Context,
	...
	var resource InboundSamlSsoProfile
	err := ctx.ReadResource("google-native:cloudidentity/v1beta1:InboundSamlSsoProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
