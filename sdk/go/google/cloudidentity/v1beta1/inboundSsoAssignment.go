...
func NewInboundSsoAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudidentity/v1beta1:InboundSsoAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInboundSsoAssignment(ctx *pulumi.Context,
	...
	var resource InboundSsoAssignment
	err := ctx.ReadResource("google-native:cloudidentity/v1beta1:InboundSsoAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
