...
func NewMembership(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudidentity/v1beta1:Membership", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMembership(ctx *pulumi.Context,
	...
	var resource Membership
	err := ctx.ReadResource("google-cloud:cloudidentity/v1beta1:Membership", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
