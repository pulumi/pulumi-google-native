...
func (o DeviceOutput) Blocked() pulumi.BoolOutput {
	return o.ApplyT(func(v *Device) pulumi.BoolOutput { return v.Blocked }).(pulumi.BoolOutput)
}

// The most recent device configuration, which is eventually sent from Cloud IoT Core to the device. If not present on creation, the configuration will be initialized with an empty payload and version value of `1`. To update this field after creation, use the `DeviceManager.ModifyCloudToDeviceConfig` method.
func (o DeviceOutput) Config() DeviceConfigResponseOutput {
	return o.ApplyT(func(v *Device) DeviceConfigResponseOutput { return v.Config }).(DeviceConfigResponseOutput)
}
...
func (o DeviceOutput) GatewayConfig() GatewayConfigResponseOutput {
	return o.ApplyT(func(v *Device) GatewayConfigResponseOutput { return v.GatewayConfig }).(GatewayConfigResponseOutput)
}
...
func (o DeviceOutput) LastErrorStatus() StatusResponseOutput {
	return o.ApplyT(func(v *Device) StatusResponseOutput { return v.LastErrorStatus }).(StatusResponseOutput)
}
...
// [Output only] The state most recently received from the device. If no state has been reported, this field is not present.
func (o DeviceOutput) State() DeviceStateResponseOutput {
	return o.ApplyT(func(v *Device) DeviceStateResponseOutput { return v.State }).(DeviceStateResponseOutput)
}
