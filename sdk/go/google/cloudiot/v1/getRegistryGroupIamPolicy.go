...
func (o LookupRegistryGroupIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRegistryGroupIamPolicyResult] {
	return pulumix.Output[LookupRegistryGroupIamPolicyResult]{
