...
func LookupRegistryIamPolicy(ctx *pulumi.Context, args *LookupRegistryIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupRegistryIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:cloudiot/v1:getRegistryIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupRegistryIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupRegistryIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupRegistryIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupRegistryIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
