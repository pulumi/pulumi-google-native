...
func NewRegistryDevice(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudiot/v1:RegistryDevice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryDevice(ctx *pulumi.Context,
	...
	var resource RegistryDevice
	err := ctx.ReadResource("google-cloud:cloudiot/v1:RegistryDevice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
