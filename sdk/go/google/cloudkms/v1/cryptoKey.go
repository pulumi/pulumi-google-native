...
func NewCryptoKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudkms/v1:CryptoKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCryptoKey(ctx *pulumi.Context,
	...
	var resource CryptoKey
	err := ctx.ReadResource("google-cloud:cloudkms/v1:CryptoKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type cryptoKeyArgs struct {
	...
	Primary *CryptoKeyVersionType `pulumi:"primary"`
...
type CryptoKeyArgs struct {
	...
	// Output only. A copy of the "primary" CryptoKeyVersion that will be used by Encrypt when this CryptoKey is given in EncryptRequest.name. The CryptoKey's primary version can be updated via UpdateCryptoKeyPrimaryVersion. Keys with purpose ENCRYPT_DECRYPT may have a primary. For other keys, this field will be omitted.
	Primary CryptoKeyVersionTypePtrInput
	// Immutable. The immutable purpose of this CryptoKey.
