...
func NewEkmConnectionIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudkms/v1:EkmConnectionIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEkmConnectionIamBinding(ctx *pulumi.Context,
	...
	var resource EkmConnectionIamBinding
	err := ctx.ReadResource("google-native:cloudkms/v1:EkmConnectionIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o EkmConnectionIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *EkmConnectionIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
