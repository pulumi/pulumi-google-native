...
func NewKeyRingIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudkms/v1:KeyRingIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRingIamBinding(ctx *pulumi.Context,
	...
	var resource KeyRingIamBinding
	err := ctx.ReadResource("google-native:cloudkms/v1:KeyRingIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o KeyRingIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *KeyRingIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o KeyRingIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *KeyRingIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}

// The project in which the resource belongs. If it is not provided, a default will be supplied.
func (o KeyRingIamBindingOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *KeyRingIamBinding) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}
