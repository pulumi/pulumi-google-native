...
func NewKeyRingIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudkms/v1:KeyRingIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRingIamMember(ctx *pulumi.Context,
	...
	var resource KeyRingIamMember
	err := ctx.ReadResource("google-native:cloudkms/v1:KeyRingIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o KeyRingIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *KeyRingIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o KeyRingIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *KeyRingIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}

// The project in which the resource belongs. If it is not provided, a default will be supplied.
func (o KeyRingIamMemberOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *KeyRingIamMember) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}
