...
func NewOrganizationIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudresourcemanager/v1:OrganizationIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationIamMember(ctx *pulumi.Context,
	...
	var resource OrganizationIamMember
	err := ctx.ReadResource("google-native:cloudresourcemanager/v1:OrganizationIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
