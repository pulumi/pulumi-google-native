...
func NewOrganizationIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudresourcemanager/v1:OrganizationIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationIamPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationIamPolicy
	err := ctx.ReadResource("google-cloud:cloudresourcemanager/v1:OrganizationIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
