...
func NewProjectIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudresourcemanager/v1:ProjectIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectIamMember(ctx *pulumi.Context,
	...
	var resource ProjectIamMember
	err := ctx.ReadResource("google-native:cloudresourcemanager/v1:ProjectIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
