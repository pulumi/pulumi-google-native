...
func LookupProjectIamPolicy(ctx *pulumi.Context, args *LookupProjectIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupProjectIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:cloudresourcemanager/v1beta1:getProjectIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupProjectIamPolicyOutput(ctx *pulumi.Context, args LookupProjectIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupProjectIamPolicyResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupProjectIamPolicyResult, error) {
			args := v.(LookupProjectIamPolicyArgs)
			r, err := LookupProjectIamPolicy(ctx, &args, opts...)
			var s LookupProjectIamPolicyResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o LookupProjectIamPolicyResultOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v LookupProjectIamPolicyResult) []AuditConfigResponse { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}

// Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
func (o LookupProjectIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupProjectIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupProjectIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupProjectIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
