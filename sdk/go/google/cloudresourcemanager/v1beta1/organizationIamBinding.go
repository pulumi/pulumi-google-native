...
func NewOrganizationIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudresourcemanager/v1beta1:OrganizationIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationIamBinding(ctx *pulumi.Context,
	...
	var resource OrganizationIamBinding
	err := ctx.ReadResource("google-native:cloudresourcemanager/v1beta1:OrganizationIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *OrganizationIamBinding) ToOutput(ctx context.Context) pulumix.Output[*OrganizationIamBinding] {
	return pulumix.Output[*OrganizationIamBinding]{
		OutputState: i.ToOrganizationIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o OrganizationIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*OrganizationIamBinding] {
	return pulumix.Output[*OrganizationIamBinding]{
