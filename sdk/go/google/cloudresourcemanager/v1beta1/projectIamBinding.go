...
func NewProjectIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudresourcemanager/v1beta1:ProjectIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectIamBinding(ctx *pulumi.Context,
	...
	var resource ProjectIamBinding
	err := ctx.ReadResource("google-native:cloudresourcemanager/v1beta1:ProjectIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ProjectIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ProjectIamBinding] {
	return pulumix.Output[*ProjectIamBinding]{
		OutputState: i.ToProjectIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ProjectIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ProjectIamBinding] {
	return pulumix.Output[*ProjectIamBinding]{
