...
func (o LookupFolderIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFolderIamPolicyResult] {
	return pulumix.Output[LookupFolderIamPolicyResult]{
