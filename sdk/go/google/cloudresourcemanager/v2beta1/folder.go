...
func NewFolder(ctx *pulumi.Context,
	...
	var resource Folder
	err := ctx.RegisterResource("google-cloud:cloudresourcemanager/v2beta1:Folder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolder(ctx *pulumi.Context,
	...
	var resource Folder
	err := ctx.ReadResource("google-cloud:cloudresourcemanager/v2beta1:Folder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
