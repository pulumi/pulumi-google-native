...
func NewFolderIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudresourcemanager/v3:FolderIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderIamBinding(ctx *pulumi.Context,
	...
	var resource FolderIamBinding
	err := ctx.ReadResource("google-native:cloudresourcemanager/v3:FolderIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *FolderIamBinding) ToOutput(ctx context.Context) pulumix.Output[*FolderIamBinding] {
	return pulumix.Output[*FolderIamBinding]{
		OutputState: i.ToFolderIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o FolderIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*FolderIamBinding] {
	return pulumix.Output[*FolderIamBinding]{
