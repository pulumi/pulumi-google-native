...
func NewFolderIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudresourcemanager/v3:FolderIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderIamMember(ctx *pulumi.Context,
	...
	var resource FolderIamMember
	err := ctx.ReadResource("google-native:cloudresourcemanager/v3:FolderIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
