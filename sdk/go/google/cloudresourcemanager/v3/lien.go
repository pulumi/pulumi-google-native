...
func NewLien(ctx *pulumi.Context,
	...
	var resource Lien
	err := ctx.RegisterResource("google-cloud:cloudresourcemanager/v3:Lien", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLien(ctx *pulumi.Context,
	...
	var resource Lien
	err := ctx.ReadResource("google-cloud:cloudresourcemanager/v3:Lien", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
