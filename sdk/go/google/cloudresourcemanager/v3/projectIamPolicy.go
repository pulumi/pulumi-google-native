...
func (i *ProjectIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*ProjectIamPolicy] {
	return pulumix.Output[*ProjectIamPolicy]{
		OutputState: i.ToProjectIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o ProjectIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*ProjectIamPolicy] {
	return pulumix.Output[*ProjectIamPolicy]{
