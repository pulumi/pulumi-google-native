...
func NewTagKeyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudresourcemanager/v3:TagKeyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagKeyIamBinding(ctx *pulumi.Context,
	...
	var resource TagKeyIamBinding
	err := ctx.ReadResource("google-native:cloudresourcemanager/v3:TagKeyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o TagKeyIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TagKeyIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
func (o TagKeyIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TagKeyIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}

// The project in which the resource belongs. If it is not provided, a default will be supplied.
func (o TagKeyIamBindingOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *TagKeyIamBinding) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}
