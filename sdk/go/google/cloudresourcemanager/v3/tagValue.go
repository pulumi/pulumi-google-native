...
func NewTagValue(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudresourcemanager/v3:TagValue", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagValue(ctx *pulumi.Context,
	...
	var resource TagValue
	err := ctx.ReadResource("google-cloud:cloudresourcemanager/v3:TagValue", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
