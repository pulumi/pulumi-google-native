...
func LookupJob(ctx *pulumi.Context, args *LookupJobArgs, opts ...pulumi.InvokeOption) (*LookupJobResult, error) {
	...
	err := ctx.Invoke("google-native:cloudscheduler/v1beta1:getJob", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupJobResultOutput) LegacyAppEngineCron() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupJobResult) bool { return v.LegacyAppEngineCron }).(pulumi.BoolOutput)
}
