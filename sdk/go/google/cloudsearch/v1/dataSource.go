...
func NewDataSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudsearch/v1:DataSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSource(ctx *pulumi.Context,
	...
	var resource DataSource
	err := ctx.ReadResource("google-cloud:cloudsearch/v1:DataSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
