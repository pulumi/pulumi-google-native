...
func NewSearchApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudsearch/v1:SearchApplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSearchApplication(ctx *pulumi.Context,
	...
	var resource SearchApplication
	err := ctx.ReadResource("google-cloud:cloudsearch/v1:SearchApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
