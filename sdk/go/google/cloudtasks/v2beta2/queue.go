...
// Pull target. A pull queue is a queue that has a PullTarget.
func (o QueueOutput) PullTarget() PullTargetResponseOutput {
	return o.ApplyT(func(v *Queue) PullTargetResponseOutput { return v.PullTarget }).(PullTargetResponseOutput)
}
