...
func NewQueueIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudtasks/v2beta2:QueueIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueIamBinding(ctx *pulumi.Context,
	...
	var resource QueueIamBinding
	err := ctx.ReadResource("google-native:cloudtasks/v2beta2:QueueIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
