...
func (e QueueType) ToQueueTypeOutput() QueueTypeOutput {
	return pulumi.ToOutput(e).(QueueTypeOutput)
}

func (e QueueType) ToQueueTypeOutputWithContext(ctx context.Context) QueueTypeOutput {
	return pulumi.ToOutputWithContext(ctx, e).(QueueTypeOutput)
}

func (e QueueType) ToQueueTypePtrOutput() QueueTypePtrOutput {
	return e.ToQueueTypePtrOutputWithContext(context.Background())
}

func (e QueueType) ToQueueTypePtrOutputWithContext(ctx context.Context) QueueTypePtrOutput {
	return QueueType(e).ToQueueTypeOutputWithContext(ctx).ToQueueTypePtrOutputWithContext(ctx)
}
...
var queueTypePtrType = reflect.TypeOf((**QueueType)(nil)).Elem()
...
type queueTypePtr string

func QueueTypePtr(v string) QueueTypePtrInput {
	return (*queueTypePtr)(&v)
}

func (*queueTypePtr) ElementType() reflect.Type {
	return queueTypePtrType
}

func (in *queueTypePtr) ToQueueTypePtrOutput() QueueTypePtrOutput {
	return pulumi.ToOutput(in).(QueueTypePtrOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*QueueTypeInput)(nil)).Elem(), QueueType("TYPE_UNSPECIFIED"))
	pulumi.RegisterInputType(reflect.TypeOf((*QueueTypePtrInput)(nil)).Elem(), QueueType("TYPE_UNSPECIFIED"))
