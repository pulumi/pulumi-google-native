...
func NewQueueIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:cloudtasks/v2beta3:QueueIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueIamMember(ctx *pulumi.Context,
	...
	var resource QueueIamMember
	err := ctx.ReadResource("google-native:cloudtasks/v2beta3:QueueIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
