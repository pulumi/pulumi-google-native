...
func NewQueueTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:cloudtasks/v2beta3:QueueTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueueTask(ctx *pulumi.Context,
	...
	var resource QueueTask
	err := ctx.ReadResource("google-cloud:cloudtasks/v2beta3:QueueTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
