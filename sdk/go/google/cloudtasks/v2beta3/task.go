...
func NewTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.RegisterResource("google-cloud:cloudtasks/v2beta3:Task", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.ReadResource("google-cloud:cloudtasks/v2beta3:Task", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
