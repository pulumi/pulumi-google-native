...
func NewUserWorkloadsConfigMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:composer/v1:UserWorkloadsConfigMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserWorkloadsConfigMap(ctx *pulumi.Context,
	...
	var resource UserWorkloadsConfigMap
	err := ctx.ReadResource("google-native:composer/v1:UserWorkloadsConfigMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
