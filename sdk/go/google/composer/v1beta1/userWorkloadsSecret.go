...
func NewUserWorkloadsSecret(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:composer/v1beta1:UserWorkloadsSecret", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserWorkloadsSecret(ctx *pulumi.Context,
	...
	var resource UserWorkloadsSecret
	err := ctx.ReadResource("google-native:composer/v1beta1:UserWorkloadsSecret", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
