...
func NewAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:Address", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddress(ctx *pulumi.Context,
	...
	var resource Address
	err := ctx.ReadResource("google-native:compute/alpha:Address", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Server-defined URL for this resource with the resource id.
func (o AddressOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *Address) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
