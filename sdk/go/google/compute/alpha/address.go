...
func NewAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:Address", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddress(ctx *pulumi.Context,
	...
	var resource Address
	err := ctx.ReadResource("google-cloud:compute/alpha:Address", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
