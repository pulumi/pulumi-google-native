...
// Server-defined URL for this resource with the resource id.
func (o BackendBucketOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *BackendBucket) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
