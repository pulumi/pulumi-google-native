...
func NewBackendServiceIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:BackendServiceIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendServiceIamBinding(ctx *pulumi.Context,
	...
	var resource BackendServiceIamBinding
	err := ctx.ReadResource("google-native:compute/alpha:BackendServiceIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
