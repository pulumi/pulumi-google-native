...
func NewBackendServiceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:BackendServiceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendServiceIamMember(ctx *pulumi.Context,
	...
	var resource BackendServiceIamMember
	err := ctx.ReadResource("google-native:compute/alpha:BackendServiceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *BackendServiceIamMember) ToOutput(ctx context.Context) pulumix.Output[*BackendServiceIamMember] {
	return pulumix.Output[*BackendServiceIamMember]{
		OutputState: i.ToBackendServiceIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o BackendServiceIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*BackendServiceIamMember] {
	return pulumix.Output[*BackendServiceIamMember]{
