...
func GetBackendServiceIamPolicy(ctx *pulumi.Context,
	...
	var resource BackendServiceIamPolicy
	err := ctx.ReadResource("google-native:compute/alpha:BackendServiceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (*BackendServiceIamPolicy) ElementType() reflect.Type {
	return reflect.TypeOf((*BackendServiceIamPolicy)(nil))
}
...
type BackendServiceIamPolicyOutput struct {
	*pulumi.OutputState
}
