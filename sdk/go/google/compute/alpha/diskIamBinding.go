...
func NewDiskIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:DiskIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskIamBinding(ctx *pulumi.Context,
	...
	var resource DiskIamBinding
	err := ctx.ReadResource("google-native:compute/alpha:DiskIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o DiskIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *DiskIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
