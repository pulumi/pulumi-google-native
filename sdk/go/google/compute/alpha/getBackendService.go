...
// Configuring haPolicy is not supported.
func (o LookupBackendServiceResultOutput) HaPolicy() BackendServiceHAPolicyResponseOutput {
	return o.ApplyT(func(v LookupBackendServiceResult) BackendServiceHAPolicyResponse { return v.HaPolicy }).(BackendServiceHAPolicyResponseOutput)
}
...
func (o LookupBackendServiceResultOutput) UsedBy() BackendServiceUsedByResponseArrayOutput {
	return o.ApplyT(func(v LookupBackendServiceResult) []BackendServiceUsedByResponse { return v.UsedBy }).(BackendServiceUsedByResponseArrayOutput)
}
