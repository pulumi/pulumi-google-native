...
// Server-defined URL for this resource's resource id.
func (o LookupImageResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupImageResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
