...
// Instance flexibility allowing MIG to create VMs from multiple types of machines. Instance flexibility configuration on MIG overrides instance template configuration.
func (o LookupInstanceGroupManagerResultOutput) InstanceFlexibilityPolicy() InstanceGroupManagerInstanceFlexibilityPolicyResponseOutput {
	return o.ApplyT(func(v LookupInstanceGroupManagerResult) InstanceGroupManagerInstanceFlexibilityPolicyResponse {
...
// Input only. Additional params passed with the request, but not persisted as part of resource payload.
func (o LookupInstanceGroupManagerResultOutput) Params() InstanceGroupManagerParamsResponseOutput {
	return o.ApplyT(func(v LookupInstanceGroupManagerResult) InstanceGroupManagerParamsResponse { return v.Params }).(InstanceGroupManagerParamsResponseOutput)
}
...
// Server-defined URL for this resource with the resource id.
func (o LookupInstanceGroupManagerResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupInstanceGroupManagerResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
...
// Standby policy for stopped and suspended instances.
func (o LookupInstanceGroupManagerResultOutput) StandbyPolicy() InstanceGroupManagerStandbyPolicyResponseOutput {
	return o.ApplyT(func(v LookupInstanceGroupManagerResult) InstanceGroupManagerStandbyPolicyResponse {
...
// The unit of measure for the target size.
func (o LookupInstanceGroupManagerResultOutput) TargetSizeUnit() pulumi.StringOutput {
	return o.ApplyT(func(v LookupInstanceGroupManagerResult) string { return v.TargetSizeUnit }).(pulumi.StringOutput)
}
