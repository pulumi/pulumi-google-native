...
func LookupInstanceTemplate(ctx *pulumi.Context, args *LookupInstanceTemplateArgs, opts ...pulumi.InvokeOption) (*LookupInstanceTemplateResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getInstanceTemplate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Server-defined URL for this resource with the resource id.
func (o LookupInstanceTemplateResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupInstanceTemplateResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
