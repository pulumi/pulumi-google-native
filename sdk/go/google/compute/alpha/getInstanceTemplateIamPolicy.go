...
// This is deprecated and has no effect. Do not use.
func (o LookupInstanceTemplateIamPolicyResultOutput) IamOwned() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupInstanceTemplateIamPolicyResult) bool { return v.IamOwned }).(pulumi.BoolOutput)
}
