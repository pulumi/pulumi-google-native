...
// The unique identifier for the resource. This identifier is defined by the server.
func (o LookupInstantSnapshotResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v LookupInstantSnapshotResult) string { return v.Id }).(pulumi.StringOutput)
}
