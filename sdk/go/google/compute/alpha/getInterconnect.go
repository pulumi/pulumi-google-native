...
// Server-defined URL for this resource with the resource id.
func (o LookupInterconnectResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupInterconnectResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
