...
// Only valid when networkEndpointType is "GCE_VM_IP_PORT" and the NEG is regional.
func (o LookupNetworkEndpointGroupResultOutput) ClientPortMappingMode() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNetworkEndpointGroupResult) string { return v.ClientPortMappingMode }).(pulumi.StringOutput)
}
...
// Server-defined URL for this resource with the resource id.
func (o LookupNetworkEndpointGroupResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNetworkEndpointGroupResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}

// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine, cloudFunction or serverlessDeployment may be set.
func (o LookupNetworkEndpointGroupResultOutput) ServerlessDeployment() NetworkEndpointGroupServerlessDeploymentResponseOutput {
	return o.ApplyT(func(v LookupNetworkEndpointGroupResult) NetworkEndpointGroupServerlessDeploymentResponse {
...
// Specify the type of this network endpoint group. Only LOAD_BALANCING is valid for now.
func (o LookupNetworkEndpointGroupResultOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNetworkEndpointGroupResult) string { return v.Type }).(pulumi.StringOutput)
}
