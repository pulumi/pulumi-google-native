...
func LookupNodeGroup(ctx *pulumi.Context, args *LookupNodeGroupArgs, opts ...pulumi.InvokeOption) (*LookupNodeGroupResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getNodeGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Server-defined URL for this resource with the resource id.
func (o LookupNodeGroupResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNodeGroupResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
