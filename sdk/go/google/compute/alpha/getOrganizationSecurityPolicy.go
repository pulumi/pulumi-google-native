...
func LookupOrganizationSecurityPolicy(ctx *pulumi.Context, args *LookupOrganizationSecurityPolicyArgs, opts ...pulumi.InvokeOption) (*LookupOrganizationSecurityPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getOrganizationSecurityPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupOrganizationSecurityPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOrganizationSecurityPolicyResult] {
	return pulumix.Output[LookupOrganizationSecurityPolicyResult]{
...
func (o LookupOrganizationSecurityPolicyResultOutput) CloudArmorConfig() SecurityPolicyCloudArmorConfigResponseOutput {
	return o.ApplyT(func(v LookupOrganizationSecurityPolicyResult) SecurityPolicyCloudArmorConfigResponse {
...
// Definitions of user-defined fields for CLOUD_ARMOR_NETWORK policies. A user-defined field consists of up to 4 bytes extracted from a fixed offset in the packet, relative to the IPv4, IPv6, TCP, or UDP header, with an optional mask to select certain bits. Rules may then specify matching values for these fields. Example: userDefinedFields: - name: "ipv4_fragment_offset" base: IPV4 offset: 6 size: 2 mask: "0x1fff"
func (o LookupOrganizationSecurityPolicyResultOutput) UserDefinedFields() SecurityPolicyUserDefinedFieldResponseArrayOutput {
	return o.ApplyT(func(v LookupOrganizationSecurityPolicyResult) []SecurityPolicyUserDefinedFieldResponse {
