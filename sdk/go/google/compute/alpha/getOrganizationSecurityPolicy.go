...
// The unique identifier for the resource. This identifier is defined by the server.
func (o LookupOrganizationSecurityPolicyResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v LookupOrganizationSecurityPolicyResult) string { return v.Id }).(pulumi.StringOutput)
}
