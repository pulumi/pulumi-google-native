...
func LookupRegionDisk(ctx *pulumi.Context, args *LookupRegionDiskArgs, opts ...pulumi.InvokeOption) (*LookupRegionDiskResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getRegionDisk", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The field indicates if the disk is created from a locked source image. Attachment of a disk created from a locked source image will cause the following operations to become irreversibly prohibited: - R/W or R/O disk attachment to any other instance - Disk detachment. And the disk can only be deleted when the instance is deleted - Creation of images or snapshots - Disk cloning Furthermore, the instance with at least one disk with locked flag set to true will be prohibited from performing the operations below: - Further attachment of secondary disks. - Detachment of any disks - Create machine images - Create instance template - Delete the instance with --keep-disk parameter set to true for locked disks - Attach a locked disk with --auto-delete parameter set to false
func (o LookupRegionDiskResultOutput) Locked() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupRegionDiskResult) bool { return v.Locked }).(pulumi.BoolOutput)
}

// Indicates whether or not the disk can be read/write attached to more than one instance.
func (o LookupRegionDiskResultOutput) MultiWriter() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupRegionDiskResult) bool { return v.MultiWriter }).(pulumi.BoolOutput)
}
...
// Server-defined URL for this resource's resource id.
func (o LookupRegionDiskResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegionDiskResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
...
//
// Deprecated: [Deprecated] Storage type of the persistent disk.
func (o LookupRegionDiskResultOutput) StorageType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegionDiskResult) string { return v.StorageType }).(pulumi.StringOutput)
}
...
// A list of publicly visible user-licenses. Unlike regular licenses, user provided licenses can be modified after the disk is created. This includes a list of URLs to the license resource. For example, to provide a debian license: https://www.googleapis.com/compute/v1/projects/debian-cloud/global/licenses/debian-9-stretch
func (o LookupRegionDiskResultOutput) UserLicenses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupRegionDiskResult) []string { return v.UserLicenses }).(pulumi.StringArrayOutput)
}
