...
func LookupRegionDiskIamPolicy(ctx *pulumi.Context, args *LookupRegionDiskIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupRegionDiskIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getRegionDiskIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// This is deprecated and has no effect. Do not use.
func (o LookupRegionDiskIamPolicyResultOutput) IamOwned() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupRegionDiskIamPolicyResult) bool { return v.IamOwned }).(pulumi.BoolOutput)
}
