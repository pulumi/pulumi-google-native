...
func (o LookupRegionHealthCheckResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRegionHealthCheckResult] {
	return pulumix.Output[LookupRegionHealthCheckResult]{
