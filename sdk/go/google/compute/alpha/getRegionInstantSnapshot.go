...
// The unique identifier for the resource. This identifier is defined by the server.
func (o LookupRegionInstantSnapshotResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegionInstantSnapshotResult) string { return v.Id }).(pulumi.StringOutput)
}
