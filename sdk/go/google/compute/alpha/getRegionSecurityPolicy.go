...
func LookupRegionSecurityPolicy(ctx *pulumi.Context, args *LookupRegionSecurityPolicyArgs, opts ...pulumi.InvokeOption) (*LookupRegionSecurityPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getRegionSecurityPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupRegionSecurityPolicyResultOutput) CloudArmorConfig() SecurityPolicyCloudArmorConfigResponseOutput {
	return o.ApplyT(func(v LookupRegionSecurityPolicyResult) SecurityPolicyCloudArmorConfigResponse {
