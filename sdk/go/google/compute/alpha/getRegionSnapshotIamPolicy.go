...
func (o LookupRegionSnapshotIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRegionSnapshotIamPolicyResult] {
	return pulumix.Output[LookupRegionSnapshotIamPolicyResult]{
