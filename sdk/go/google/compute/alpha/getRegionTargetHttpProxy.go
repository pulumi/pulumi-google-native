...
func LookupRegionTargetHttpProxy(ctx *pulumi.Context, args *LookupRegionTargetHttpProxyArgs, opts ...pulumi.InvokeOption) (*LookupRegionTargetHttpProxyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getRegionTargetHttpProxy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupRegionTargetHttpProxyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRegionTargetHttpProxyResult] {
	return pulumix.Output[LookupRegionTargetHttpProxyResult]{
...
// Server-defined URL for this resource with the resource id.
func (o LookupRegionTargetHttpProxyResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegionTargetHttpProxyResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
