...
func LookupResourcePolicy(ctx *pulumi.Context, args *LookupResourcePolicyArgs, opts ...pulumi.InvokeOption) (*LookupResourcePolicyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getResourcePolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Server-defined URL for this resource with the resource id.
func (o LookupResourcePolicyResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupResourcePolicyResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
...
// Resource policy applicable to VMs for infrastructure maintenance.
func (o LookupResourcePolicyResultOutput) VmMaintenancePolicy() ResourcePolicyVmMaintenancePolicyResponseOutput {
	return o.ApplyT(func(v LookupResourcePolicyResult) ResourcePolicyVmMaintenancePolicyResponse {
		return v.VmMaintenancePolicy
	}).(ResourcePolicyVmMaintenancePolicyResponseOutput)
}
