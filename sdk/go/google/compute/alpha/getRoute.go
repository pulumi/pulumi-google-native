...
func LookupRoute(ctx *pulumi.Context, args *LookupRouteArgs, opts ...pulumi.InvokeOption) (*LookupRouteResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getRoute", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupRouteResult struct {
	...
	NextHopInterRegionCost int `pulumi:"nextHopInterRegionCost"`
	...
	NextHopMed int `pulumi:"nextHopMed"`
...
// Whether this route can conflict with existing subnetworks. Setting this to true allows this route to conflict with subnetworks that have already been configured on the corresponding network.
func (o LookupRouteResultOutput) AllowConflictingSubnetworks() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupRouteResult) bool { return v.AllowConflictingSubnetworks }).(pulumi.BoolOutput)
}
...
// ILB route behavior when ILB is deemed unhealthy based on user specified threshold on the Backend Service of the internal load balancing.
func (o LookupRouteResultOutput) IlbRouteBehaviorOnUnhealthy() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRouteResult) string { return v.IlbRouteBehaviorOnUnhealthy }).(pulumi.StringOutput)
}
...
// The full resource name of the Network Connectivity Center hub that will handle matching packets.
func (o LookupRouteResultOutput) NextHopHub() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRouteResult) string { return v.NextHopHub }).(pulumi.StringOutput)
}
...
// [Output only] Internal fixed region-to-region cost that Google Cloud calculates based on factors such as network performance, distance, and available bandwidth between regions.
func (o LookupRouteResultOutput) NextHopInterRegionCost() pulumi.IntOutput {
	return o.ApplyT(func(v LookupRouteResult) int { return v.NextHopInterRegionCost }).(pulumi.IntOutput)
}
...
// Multi-Exit Discriminator, a BGP route metric that indicates the desirability of a particular route in a network.
func (o LookupRouteResultOutput) NextHopMed() pulumi.IntOutput {
	return o.ApplyT(func(v LookupRouteResult) int { return v.NextHopMed }).(pulumi.IntOutput)
}
...
// Indicates the origin of the route. Can be IGP (Interior Gateway Protocol), EGP (Exterior Gateway Protocol), or INCOMPLETE.
func (o LookupRouteResultOutput) NextHopOrigin() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRouteResult) string { return v.NextHopOrigin }).(pulumi.StringOutput)
}
...
// Server-defined URL for this resource with the resource id.
func (o LookupRouteResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRouteResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
