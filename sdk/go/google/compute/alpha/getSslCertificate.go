...
// Server-defined URL for this resource with the resource id.
func (o LookupSslCertificateResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSslCertificateResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
