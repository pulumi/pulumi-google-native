...
func LookupTargetInstance(ctx *pulumi.Context, args *LookupTargetInstanceArgs, opts ...pulumi.InvokeOption) (*LookupTargetInstanceResult, error) {
	...
	err := ctx.Invoke("google-native:compute/alpha:getTargetInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Server-defined URL for this resource with the resource id.
func (o LookupTargetInstanceResultOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupTargetInstanceResult) string { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
