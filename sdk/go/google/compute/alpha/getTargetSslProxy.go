...
// The unique identifier for the resource. This identifier is defined by the server.
func (o LookupTargetSslProxyResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v LookupTargetSslProxyResult) string { return v.Id }).(pulumi.StringOutput)
}
