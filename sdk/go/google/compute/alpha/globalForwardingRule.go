...
type GlobalForwardingRule struct {
	...
	GlobalForwardingRuleId pulumi.StringOutput `pulumi:"globalForwardingRuleId"`
...
// The unique identifier for the resource. This identifier is defined by the server.
func (o GlobalForwardingRuleOutput) GlobalForwardingRuleId() pulumi.StringOutput {
	return o.ApplyT(func(v *GlobalForwardingRule) pulumi.StringOutput { return v.GlobalForwardingRuleId }).(pulumi.StringOutput)
}
