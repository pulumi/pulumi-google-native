...
type GlobalForwardingRule struct {
	...
	ExternalManagedBackendBucketMigrationState pulumi.StringOutput `pulumi:"externalManagedBackendBucketMigrationState"`
	...
	ExternalManagedBackendBucketMigrationTestingPercentage pulumi.Float64Output `pulumi:"externalManagedBackendBucketMigrationTestingPercentage"`
	...
	IpCollection pulumi.StringOutput `pulumi:"ipCollection"`
...
func GetGlobalForwardingRule(ctx *pulumi.Context,
	...
	var resource GlobalForwardingRule
	err := ctx.ReadResource("google-native:compute/alpha:GlobalForwardingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type globalForwardingRuleArgs struct {
	...
	// Specifies the canary migration state for the backend buckets attached to this forwarding rule. Possible values are PREPARE, TEST, and FINALIZE. To begin the migration from EXTERNAL to EXTERNAL_MANAGED, the state must be changed to PREPARE. The state must be changed to FINALIZE before the loadBalancingScheme can be changed to EXTERNAL_MANAGED. Optionally, the TEST state can be used to migrate traffic to backend buckets attached to this forwarding rule by percentage using externalManagedBackendBucketMigrationTestingPercentage. Rolling back a migration requires the states to be set in reverse order. So changing the scheme from EXTERNAL_MANAGED to EXTERNAL requires the state to be set to FINALIZE at the same time. Optionally, the TEST state can be used to migrate some traffic back to EXTERNAL or PREPARE can be used to migrate all traffic back to EXTERNAL.
	ExternalManagedBackendBucketMigrationState *GlobalForwardingRuleExternalManagedBackendBucketMigrationState `pulumi:"externalManagedBackendBucketMigrationState"`
	// Determines the fraction of requests to backend buckets that should be processed by the Global external Application Load Balancer. The value of this field must be in the range [0, 100]. This value is only used if the loadBalancingScheme is set to EXTERNAL (when using the Classic ALB).
...
type GlobalForwardingRuleArgs struct {
	...
	// Specifies the canary migration state for the backend buckets attached to this forwarding rule. Possible values are PREPARE, TEST, and FINALIZE. To begin the migration from EXTERNAL to EXTERNAL_MANAGED, the state must be changed to PREPARE. The state must be changed to FINALIZE before the loadBalancingScheme can be changed to EXTERNAL_MANAGED. Optionally, the TEST state can be used to migrate traffic to backend buckets attached to this forwarding rule by percentage using externalManagedBackendBucketMigrationTestingPercentage. Rolling back a migration requires the states to be set in reverse order. So changing the scheme from EXTERNAL_MANAGED to EXTERNAL requires the state to be set to FINALIZE at the same time. Optionally, the TEST state can be used to migrate some traffic back to EXTERNAL or PREPARE can be used to migrate all traffic back to EXTERNAL.
	ExternalManagedBackendBucketMigrationState GlobalForwardingRuleExternalManagedBackendBucketMigrationStatePtrInput
	// Determines the fraction of requests to backend buckets that should be processed by the Global external Application Load Balancer. The value of this field must be in the range [0, 100]. This value is only used if the loadBalancingScheme is set to EXTERNAL (when using the Classic ALB).
...
// Specifies the canary migration state for the backend buckets attached to this forwarding rule. Possible values are PREPARE, TEST, and FINALIZE. To begin the migration from EXTERNAL to EXTERNAL_MANAGED, the state must be changed to PREPARE. The state must be changed to FINALIZE before the loadBalancingScheme can be changed to EXTERNAL_MANAGED. Optionally, the TEST state can be used to migrate traffic to backend buckets attached to this forwarding rule by percentage using externalManagedBackendBucketMigrationTestingPercentage. Rolling back a migration requires the states to be set in reverse order. So changing the scheme from EXTERNAL_MANAGED to EXTERNAL requires the state to be set to FINALIZE at the same time. Optionally, the TEST state can be used to migrate some traffic back to EXTERNAL or PREPARE can be used to migrate all traffic back to EXTERNAL.
func (o GlobalForwardingRuleOutput) ExternalManagedBackendBucketMigrationState() pulumi.StringOutput {
	return o.ApplyT(func(v *GlobalForwardingRule) pulumi.StringOutput { return v.ExternalManagedBackendBucketMigrationState }).(pulumi.StringOutput)
}

// Determines the fraction of requests to backend buckets that should be processed by the Global external Application Load Balancer. The value of this field must be in the range [0, 100]. This value is only used if the loadBalancingScheme is set to EXTERNAL (when using the Classic ALB).
func (o GlobalForwardingRuleOutput) ExternalManagedBackendBucketMigrationTestingPercentage() pulumi.Float64Output {
	return o.ApplyT(func(v *GlobalForwardingRule) pulumi.Float64Output {
...
// Resource reference of a PublicDelegatedPrefix. The PDP must be a sub-PDP in EXTERNAL_IPV6_FORWARDING_RULE_CREATION mode. Use one of the following formats to specify a sub-PDP when creating an IPv6 NetLB forwarding rule using BYOIP: Full resource URL, as in https://www.googleapis.com/compute/v1/projects/project_id/regions/region /publicDelegatedPrefixes/sub-pdp-name Partial URL, as in: - projects/project_id/regions/region/publicDelegatedPrefixes/sub-pdp-name - regions/region/publicDelegatedPrefixes/sub-pdp-name
func (o GlobalForwardingRuleOutput) IpCollection() pulumi.StringOutput {
	return o.ApplyT(func(v *GlobalForwardingRule) pulumi.StringOutput { return v.IpCollection }).(pulumi.StringOutput)
}
...
// Server-defined URL for this resource with the resource id.
func (o GlobalForwardingRuleOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *GlobalForwardingRule) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
