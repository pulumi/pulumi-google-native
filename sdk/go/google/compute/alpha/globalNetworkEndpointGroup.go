...
func NewGlobalNetworkEndpointGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:GlobalNetworkEndpointGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalNetworkEndpointGroup(ctx *pulumi.Context,
	...
	var resource GlobalNetworkEndpointGroup
	err := ctx.ReadResource("google-cloud:compute/alpha:GlobalNetworkEndpointGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
