...
// Server-defined URL for this resource with the resource id.
func (o HealthCheckOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *HealthCheck) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
...
func (o HealthCheckOutput) UdpHealthCheck() UDPHealthCheckResponseOutput {
	return o.ApplyT(func(v *HealthCheck) UDPHealthCheckResponseOutput { return v.UdpHealthCheck }).(UDPHealthCheckResponseOutput)
}
