...
func NewHealthCheck(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:HealthCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthCheck(ctx *pulumi.Context,
	...
	var resource HealthCheck
	err := ctx.ReadResource("google-cloud:compute/alpha:HealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
