...
func GetHttpHealthCheck(ctx *pulumi.Context,
	...
	var resource HttpHealthCheck
	err := ctx.ReadResource("google-native:compute/alpha:HttpHealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Server-defined URL for this resource with the resource id.
func (o HttpHealthCheckOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *HttpHealthCheck) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
