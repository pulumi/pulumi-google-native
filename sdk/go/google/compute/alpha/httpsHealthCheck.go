...
type HttpsHealthCheck struct {
	...
	HttpsHealthCheckId pulumi.StringOutput `pulumi:"httpsHealthCheckId"`
...
func NewHttpsHealthCheck(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:HttpsHealthCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHttpsHealthCheck(ctx *pulumi.Context,
	...
	var resource HttpsHealthCheck
	err := ctx.ReadResource("google-native:compute/alpha:HttpsHealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The unique identifier for the resource. This identifier is defined by the server.
func (o HttpsHealthCheckOutput) HttpsHealthCheckId() pulumi.StringOutput {
	return o.ApplyT(func(v *HttpsHealthCheck) pulumi.StringOutput { return v.HttpsHealthCheckId }).(pulumi.StringOutput)
}
