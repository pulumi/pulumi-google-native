...
func NewImageIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:ImageIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageIamMember(ctx *pulumi.Context,
	...
	var resource ImageIamMember
	err := ctx.ReadResource("google-native:compute/alpha:ImageIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
