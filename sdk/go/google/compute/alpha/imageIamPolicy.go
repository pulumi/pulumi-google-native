...
func NewImageIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:ImageIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageIamPolicy(ctx *pulumi.Context,
	...
	var resource ImageIamPolicy
	err := ctx.ReadResource("google-cloud:compute/alpha:ImageIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
