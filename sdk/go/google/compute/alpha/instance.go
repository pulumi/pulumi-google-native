...
type Instance struct {
	...
	SecureLabels pulumi.StringArrayOutput `pulumi:"secureLabels"`
...
func NewInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstance(ctx *pulumi.Context,
	...
	var resource Instance
	err := ctx.ReadResource("google-cloud:compute/alpha:Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type InstanceState struct {
	// Controls for advanced machine-related behavior features.
	AdvancedMachineFeatures AdvancedMachineFeaturesResponsePtrInput
	// Allows this instance to send and receive packets with non-matching destination or source IPs. This is required if you plan to use this instance to forward routes. For more information, see Enabling IP Forwarding.
	CanIpForward               pulumi.BoolPtrInput
	ConfidentialInstanceConfig ConfidentialInstanceConfigResponsePtrInput
	// [Output Only] The CPU platform used by this instance.
	...
	// Array of disks associated with this instance. Persistent disks must be created before you can assign them.
	Disks AttachedDiskResponseArrayInput
	// Enables display device for the instance.
	DisplayDevice DisplayDeviceResponsePtrInput
	// Specifies whether the disks restored from source snapshots or source machine image should erase Windows specific VSS signature.
	...
	// A list of the type and count of accelerator cards attached to the instance.
	GuestAccelerators AcceleratorConfigResponseArrayInput
	// Specifies the hostname of the instance. The specified hostname must be RFC1035 compliant. If hostname is not specified, the default hostname is [INSTANCE_NAME].c.[PROJECT_ID].internal when using the global DNS, and [INSTANCE_NAME].[ZONE].c.[PROJECT_ID].internal when using zonal DNS.
	...
	//
	// Instance templates do not store customer-supplied encryption keys, so you cannot use your own keys to encrypt local SSDs and in-memory content in a managed instance group.
	InstanceEncryptionKey CustomerEncryptionKeyResponsePtrInput
	// [Output Only] Type of the resource. Always compute#instance for instances.
	...
	// [Output Only] Last start timestamp in RFC3339 text format.
	LastStartTimestamp pulumi.StringPtrInput
	// [Output Only] Last stop timestamp in RFC3339 text format.
	LastStopTimestamp pulumi.StringPtrInput
	// [Output Only] Last suspended timestamp in RFC3339 text format.
	LastSuspendedTimestamp pulumi.StringPtrInput
	// Full or partial URL of the machine type resource to use for this instance, in the format: zones/zone/machineTypes/machine-type. This is provided by the client when the instance is created. For example, the following is a valid partial url to a predefined machine type:
	// zones/us-central1-f/machineTypes/n1-standard-1
	//
	// To create a custom machine type, provide a URL to a machine type in the following format, where CPUS is 1 or an even number up to 32 (2, 4, 6, ... 24, etc), and MEMORY is the total memory for this instance. Memory must be a multiple of 256 MB and must be supplied in MB (e.g. 5 GB of memory is 5120 MB):
	...
	NetworkPerformanceConfig NetworkPerformanceConfigResponsePtrInput
	// PostKeyRevocationActionType of the instance.
	...
	// Specifies the reservations that this instance can consume from.
	ReservationAffinity ReservationAffinityResponsePtrInput
	// Resource policies applied to this instance.
	ResourcePolicies pulumi.StringArrayInput
	// [Output Only] Specifies values set for instance attributes as compared to the values requested by user in the corresponding input only field.
	ResourceStatus ResourceStatusResponsePtrInput
	// [Output Only] Reserved for future use.
	SatisfiesPzs pulumi.BoolPtrInput
	// Sets the scheduling options for this instance.
	Scheduling SchedulingResponsePtrInput
	// Secure labels to apply to this instance. These can be later modified by the update method. Maximum number of secure labels allowed is 300.
	SecureLabels pulumi.StringArrayInput
	// Secure tags to apply to this instance. These can be later modified by the update method. Maximum number of secure tags allowed is 300.
	...
	//
	// Service accounts generate access tokens that can be accessed through the metadata server and used to authenticate applications on the instance. See Service Accounts for more information.
	ServiceAccounts                 ServiceAccountResponseArrayInput
	ShieldedInstanceConfig          ShieldedInstanceConfigResponsePtrInput
	ShieldedInstanceIntegrityPolicy ShieldedInstanceIntegrityPolicyResponsePtrInput
	// Deprecating, please use shielded_instance_config.
	ShieldedVmConfig ShieldedVmConfigResponsePtrInput
	// Deprecating, please use shielded_instance_integrity_policy.
	ShieldedVmIntegrityPolicy ShieldedVmIntegrityPolicyResponsePtrInput
	// Source machine image
	SourceMachineImage pulumi.StringPtrInput
	// Source machine image encryption key when creating an instance from a machine image.
	SourceMachineImageEncryptionKey CustomerEncryptionKeyResponsePtrInput
	// [Output Only] Whether a VM has been restricted for start because Compute Engine has detected suspicious activity.
	...
	// [Output Only] Specifies upcoming maintenance for the instance.
	UpcomingMaintenance UpcomingMaintenanceResponsePtrInput
	// [Output Only] URL of the zone where the instance resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.
...
type instanceArgs struct {
	...
	// [Output Only] Specifies upcoming maintenance for the instance.
	UpcomingMaintenance *UpcomingMaintenance `pulumi:"upcomingMaintenance"`
	// [Output Only] URL of the zone where the instance resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.
	Zone string `pulumi:"zone"`
}
...
type InstanceArgs struct {
	...
	Tags TagsPtrInput
	// [Output Only] Specifies upcoming maintenance for the instance.
	UpcomingMaintenance UpcomingMaintenancePtrInput
	// [Output Only] URL of the zone where the instance resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.
