...
func NewInstanceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:InstanceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceGroup(ctx *pulumi.Context,
	...
	var resource InstanceGroup
	err := ctx.ReadResource("google-cloud:compute/alpha:InstanceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
