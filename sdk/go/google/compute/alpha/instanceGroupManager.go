...
// Input only. Additional params passed with the request, but not persisted as part of resource payload.
func (o InstanceGroupManagerOutput) Params() InstanceGroupManagerParamsResponseOutput {
	return o.ApplyT(func(v *InstanceGroupManager) InstanceGroupManagerParamsResponseOutput { return v.Params }).(InstanceGroupManagerParamsResponseOutput)
}
