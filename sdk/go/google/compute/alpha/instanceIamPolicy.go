...
func NewInstanceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:InstanceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceIamPolicy
	err := ctx.ReadResource("google-cloud:compute/alpha:InstanceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
