...
// Server-defined URL for this resource with the resource id.
func (o InstanceTemplateOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *InstanceTemplate) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
