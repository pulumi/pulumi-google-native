...
func NewInstanceTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:InstanceTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceTemplateIamPolicy
	err := ctx.ReadResource("google-cloud:compute/alpha:InstanceTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
