...
type InstantSnapshot struct {
	...
	InstantSnapshotId pulumi.StringOutput `pulumi:"instantSnapshotId"`
...
// Whether to attempt an application consistent instant snapshot by informing the OS to prepare for the snapshot process.
func (o InstantSnapshotOutput) GuestFlush() pulumi.BoolOutput {
	return o.ApplyT(func(v *InstantSnapshot) pulumi.BoolOutput { return v.GuestFlush }).(pulumi.BoolOutput)
}

// The unique identifier for the resource. This identifier is defined by the server.
func (o InstantSnapshotOutput) InstantSnapshotId() pulumi.StringOutput {
	return o.ApplyT(func(v *InstantSnapshot) pulumi.StringOutput { return v.InstantSnapshotId }).(pulumi.StringOutput)
}
