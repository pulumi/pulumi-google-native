...
func NewInterconnectAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:InterconnectAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterconnectAttachment(ctx *pulumi.Context,
	...
	var resource InterconnectAttachment
	err := ctx.ReadResource("google-cloud:compute/alpha:InterconnectAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
