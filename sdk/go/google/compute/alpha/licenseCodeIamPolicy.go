...
func (i *LicenseCodeIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*LicenseCodeIamPolicy] {
	return pulumix.Output[*LicenseCodeIamPolicy]{
		OutputState: i.ToLicenseCodeIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o LicenseCodeIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*LicenseCodeIamPolicy] {
	return pulumix.Output[*LicenseCodeIamPolicy]{
...
func (o LicenseCodeIamPolicyOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *LicenseCodeIamPolicy) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}

func (o LicenseCodeIamPolicyOutput) Resource() pulumi.StringOutput {
	return o.ApplyT(func(v *LicenseCodeIamPolicy) pulumi.StringOutput { return v.Resource }).(pulumi.StringOutput)
}
