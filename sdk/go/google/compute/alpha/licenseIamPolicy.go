...
func NewLicenseIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:LicenseIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLicenseIamPolicy(ctx *pulumi.Context,
	...
	var resource LicenseIamPolicy
	err := ctx.ReadResource("google-cloud:compute/alpha:LicenseIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
