...
func NewMachineImageIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:MachineImageIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineImageIamMember(ctx *pulumi.Context,
	...
	var resource MachineImageIamMember
	err := ctx.ReadResource("google-native:compute/alpha:MachineImageIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
