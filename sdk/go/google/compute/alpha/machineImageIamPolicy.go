...
func NewMachineImageIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:MachineImageIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineImageIamPolicy(ctx *pulumi.Context,
	...
	var resource MachineImageIamPolicy
	err := ctx.ReadResource("google-native:compute/alpha:MachineImageIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
