...
func NewNetworkAttachmentIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:NetworkAttachmentIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkAttachmentIamPolicy(ctx *pulumi.Context,
	...
	var resource NetworkAttachmentIamPolicy
	err := ctx.ReadResource("google-native:compute/alpha:NetworkAttachmentIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
