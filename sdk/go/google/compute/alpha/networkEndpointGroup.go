...
// Server-defined URL for this resource with the resource id.
func (o NetworkEndpointGroupOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *NetworkEndpointGroup) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
...
// Specify the type of this network endpoint group. Only LOAD_BALANCING is valid for now.
func (o NetworkEndpointGroupOutput) Type() pulumi.StringOutput {
