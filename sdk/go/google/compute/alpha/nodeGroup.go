...
// Server-defined URL for this resource with the resource id.
func (o NodeGroupOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *NodeGroup) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
