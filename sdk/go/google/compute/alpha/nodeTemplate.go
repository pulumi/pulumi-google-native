...
func NewNodeTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:NodeTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeTemplate(ctx *pulumi.Context,
	...
	var resource NodeTemplate
	err := ctx.ReadResource("google-cloud:compute/alpha:NodeTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
