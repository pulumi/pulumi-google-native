...
func NewOrganizationSecurityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:OrganizationSecurityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSecurityPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationSecurityPolicy
	err := ctx.ReadResource("google-cloud:compute/alpha:OrganizationSecurityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
