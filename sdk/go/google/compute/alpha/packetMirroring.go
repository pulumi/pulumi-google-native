...
func NewPacketMirroring(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:PacketMirroring", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPacketMirroring(ctx *pulumi.Context,
	...
	var resource PacketMirroring
	err := ctx.ReadResource("google-cloud:compute/alpha:PacketMirroring", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
