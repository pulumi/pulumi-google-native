...
// Server-defined URL with id for the resource.
func (o PublicDelegatedPrefixOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *PublicDelegatedPrefix) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
