...
func NewRegionAutoscaler(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:RegionAutoscaler", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionAutoscaler(ctx *pulumi.Context,
	...
	var resource RegionAutoscaler
	err := ctx.ReadResource("google-native:compute/alpha:RegionAutoscaler", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Server-defined URL for this resource with the resource id.
func (o RegionAutoscalerOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *RegionAutoscaler) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
