...
func NewRegionBackendServiceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:RegionBackendServiceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionBackendServiceIamPolicy(ctx *pulumi.Context,
	...
	var resource RegionBackendServiceIamPolicy
	err := ctx.ReadResource("google-native:compute/alpha:RegionBackendServiceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
