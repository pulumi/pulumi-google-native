...
func NewRegionDiskIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:RegionDiskIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDiskIamBinding(ctx *pulumi.Context,
	...
	var resource RegionDiskIamBinding
	err := ctx.ReadResource("google-native:compute/alpha:RegionDiskIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o RegionDiskIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *RegionDiskIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
