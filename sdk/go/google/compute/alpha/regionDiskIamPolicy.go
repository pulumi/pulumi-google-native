...
func NewRegionDiskIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:RegionDiskIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDiskIamPolicy(ctx *pulumi.Context,
	...
	var resource RegionDiskIamPolicy
	err := ctx.ReadResource("google-cloud:compute/alpha:RegionDiskIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
