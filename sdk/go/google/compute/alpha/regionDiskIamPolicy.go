...
func NewRegionDiskIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:RegionDiskIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDiskIamPolicy(ctx *pulumi.Context,
	...
	var resource RegionDiskIamPolicy
	err := ctx.ReadResource("google-native:compute/alpha:RegionDiskIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *RegionDiskIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*RegionDiskIamPolicy] {
	return pulumix.Output[*RegionDiskIamPolicy]{
		OutputState: i.ToRegionDiskIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o RegionDiskIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*RegionDiskIamPolicy] {
	return pulumix.Output[*RegionDiskIamPolicy]{
