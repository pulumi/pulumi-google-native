...
func NewRegionHealthCheck(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:RegionHealthCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionHealthCheck(ctx *pulumi.Context,
	...
	var resource RegionHealthCheck
	err := ctx.ReadResource("google-cloud:compute/alpha:RegionHealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
