...
// Server-defined URL with id for the resource.
func (o RegionHealthCheckServiceOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *RegionHealthCheckService) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
