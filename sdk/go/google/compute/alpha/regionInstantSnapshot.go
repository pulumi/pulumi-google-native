...
// Whether to attempt an application consistent instant snapshot by informing the OS to prepare for the snapshot process.
func (o RegionInstantSnapshotOutput) GuestFlush() pulumi.BoolOutput {
	return o.ApplyT(func(v *RegionInstantSnapshot) pulumi.BoolOutput { return v.GuestFlush }).(pulumi.BoolOutput)
}
