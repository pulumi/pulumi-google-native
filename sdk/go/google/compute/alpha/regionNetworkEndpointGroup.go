...
func (o RegionNetworkEndpointGroupOutput) PscData() NetworkEndpointGroupPscDataResponseOutput {
	return o.ApplyT(func(v *RegionNetworkEndpointGroup) NetworkEndpointGroupPscDataResponseOutput { return v.PscData }).(NetworkEndpointGroupPscDataResponseOutput)
}
...
// Server-defined URL for this resource with the resource id.
func (o RegionNetworkEndpointGroupOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *RegionNetworkEndpointGroup) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
...
// Specify the type of this network endpoint group. Only LOAD_BALANCING is valid for now.
func (o RegionNetworkEndpointGroupOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v *RegionNetworkEndpointGroup) pulumi.StringOutput { return v.Type }).(pulumi.StringOutput)
}
