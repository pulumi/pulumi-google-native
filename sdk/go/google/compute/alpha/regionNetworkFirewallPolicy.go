...
type regionNetworkFirewallPolicyArgs struct {
	...
	// The scope of networks allowed to be associated with the firewall policy. This field can be either GLOBAL_VPC_NETWORK or REGIONAL_VPC_NETWORK. A firewall policy with the VPC scope set to GLOBAL_VPC_NETWORK is allowed to be attached only to global networks. When the VPC scope is set to REGIONAL_VPC_NETWORK the firewall policy is allowed to be attached only to regional networks in the same scope as the firewall policy. Note: if not specified then GLOBAL_VPC_NETWORK will be used.
	VpcNetworkScope *RegionNetworkFirewallPolicyVpcNetworkScope `pulumi:"vpcNetworkScope"`
}
...
type RegionNetworkFirewallPolicyArgs struct {
	...
	// The scope of networks allowed to be associated with the firewall policy. This field can be either GLOBAL_VPC_NETWORK or REGIONAL_VPC_NETWORK. A firewall policy with the VPC scope set to GLOBAL_VPC_NETWORK is allowed to be attached only to global networks. When the VPC scope is set to REGIONAL_VPC_NETWORK the firewall policy is allowed to be attached only to regional networks in the same scope as the firewall policy. Note: if not specified then GLOBAL_VPC_NETWORK will be used.
	VpcNetworkScope RegionNetworkFirewallPolicyVpcNetworkScopePtrInput
}
...
// A list of packet mirroring rules that belong to this policy.
func (o RegionNetworkFirewallPolicyOutput) PacketMirroringRules() FirewallPolicyRuleResponseArrayOutput {
	return o.ApplyT(func(v *RegionNetworkFirewallPolicy) FirewallPolicyRuleResponseArrayOutput {
...
// The scope of networks allowed to be associated with the firewall policy. This field can be either GLOBAL_VPC_NETWORK or REGIONAL_VPC_NETWORK. A firewall policy with the VPC scope set to GLOBAL_VPC_NETWORK is allowed to be attached only to global networks. When the VPC scope is set to REGIONAL_VPC_NETWORK the firewall policy is allowed to be attached only to regional networks in the same scope as the firewall policy. Note: if not specified then GLOBAL_VPC_NETWORK will be used.
func (o RegionNetworkFirewallPolicyOutput) VpcNetworkScope() pulumi.StringOutput {
	return o.ApplyT(func(v *RegionNetworkFirewallPolicy) pulumi.StringOutput { return v.VpcNetworkScope }).(pulumi.StringOutput)
}
