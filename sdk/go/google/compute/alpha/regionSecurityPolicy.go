...
type RegionSecurityPolicy struct {
	...
	RegionSecurityPolicyId pulumi.StringOutput `pulumi:"regionSecurityPolicyId"`
...
func (o RegionSecurityPolicyOutput) CloudArmorConfig() SecurityPolicyCloudArmorConfigResponseOutput {
	return o.ApplyT(func(v *RegionSecurityPolicy) SecurityPolicyCloudArmorConfigResponseOutput { return v.CloudArmorConfig }).(SecurityPolicyCloudArmorConfigResponseOutput)
}
...
// The unique identifier for the resource. This identifier is defined by the server.
func (o RegionSecurityPolicyOutput) RegionSecurityPolicyId() pulumi.StringOutput {
	return o.ApplyT(func(v *RegionSecurityPolicy) pulumi.StringOutput { return v.RegionSecurityPolicyId }).(pulumi.StringOutput)
}
