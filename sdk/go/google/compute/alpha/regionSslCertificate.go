...
func NewRegionSslCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:RegionSslCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionSslCertificate(ctx *pulumi.Context,
	...
	var resource RegionSslCertificate
	err := ctx.ReadResource("google-cloud:compute/alpha:RegionSslCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
