...
func NewRegionUrlMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:RegionUrlMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionUrlMap(ctx *pulumi.Context,
	...
	var resource RegionUrlMap
	err := ctx.ReadResource("google-cloud:compute/alpha:RegionUrlMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
