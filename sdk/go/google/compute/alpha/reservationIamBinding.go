...
func NewReservationIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:ReservationIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReservationIamBinding(ctx *pulumi.Context,
	...
	var resource ReservationIamBinding
	err := ctx.ReadResource("google-native:compute/alpha:ReservationIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
