...
func NewReservationIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:ReservationIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReservationIamMember(ctx *pulumi.Context,
	...
	var resource ReservationIamMember
	err := ctx.ReadResource("google-native:compute/alpha:ReservationIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
