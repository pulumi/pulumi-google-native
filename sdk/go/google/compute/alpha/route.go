...
type Route struct {
	...
	NextHopInterRegionCost pulumi.IntOutput `pulumi:"nextHopInterRegionCost"`
	...
	NextHopMed pulumi.IntOutput `pulumi:"nextHopMed"`
...
// [Output only] Internal fixed region-to-region cost that Google Cloud calculates based on factors such as network performance, distance, and available bandwidth between regions.
func (o RouteOutput) NextHopInterRegionCost() pulumi.IntOutput {
	return o.ApplyT(func(v *Route) pulumi.IntOutput { return v.NextHopInterRegionCost }).(pulumi.IntOutput)
}
...
// Multi-Exit Discriminator, a BGP route metric that indicates the desirability of a particular route in a network.
func (o RouteOutput) NextHopMed() pulumi.IntOutput {
	return o.ApplyT(func(v *Route) pulumi.IntOutput { return v.NextHopMed }).(pulumi.IntOutput)
}
