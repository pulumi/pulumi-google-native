...
// A list of associations that belong to this policy.
func (o SecurityPolicyOutput) Associations() SecurityPolicyAssociationResponseArrayOutput {
	return o.ApplyT(func(v *SecurityPolicy) SecurityPolicyAssociationResponseArrayOutput { return v.Associations }).(SecurityPolicyAssociationResponseArrayOutput)
}

func (o SecurityPolicyOutput) CloudArmorConfig() SecurityPolicyCloudArmorConfigResponseOutput {
	return o.ApplyT(func(v *SecurityPolicy) SecurityPolicyCloudArmorConfigResponseOutput { return v.CloudArmorConfig }).(SecurityPolicyCloudArmorConfigResponseOutput)
}
...
// The parent of the security policy.
func (o SecurityPolicyOutput) Parent() pulumi.StringOutput {
	return o.ApplyT(func(v *SecurityPolicy) pulumi.StringOutput { return v.Parent }).(pulumi.StringOutput)
}
...
// Total count of all security policy rule tuples. A security policy can not exceed a set number of tuples.
func (o SecurityPolicyOutput) RuleTupleCount() pulumi.IntOutput {
	return o.ApplyT(func(v *SecurityPolicy) pulumi.IntOutput { return v.RuleTupleCount }).(pulumi.IntOutput)
}
...
// Server-defined URL for this resource with the resource id.
func (o SecurityPolicyOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *SecurityPolicy) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
...
// If true, the request will not be committed.
func (o SecurityPolicyOutput) ValidateOnly() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SecurityPolicy) pulumi.StringPtrOutput { return v.ValidateOnly }).(pulumi.StringPtrOutput)
}
