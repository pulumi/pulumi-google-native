...
func NewServiceAttachmentIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:ServiceAttachmentIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAttachmentIamBinding(ctx *pulumi.Context,
	...
	var resource ServiceAttachmentIamBinding
	err := ctx.ReadResource("google-native:compute/alpha:ServiceAttachmentIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
