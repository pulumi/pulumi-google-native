...
func NewSslCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:SslCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslCertificate(ctx *pulumi.Context,
	...
	var resource SslCertificate
	err := ctx.ReadResource("google-native:compute/alpha:SslCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Server-defined URL for this resource with the resource id.
func (o SslCertificateOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *SslCertificate) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
