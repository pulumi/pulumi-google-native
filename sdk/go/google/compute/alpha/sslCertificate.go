...
func NewSslCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:SslCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslCertificate(ctx *pulumi.Context,
	...
	var resource SslCertificate
	err := ctx.ReadResource("google-cloud:compute/alpha:SslCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
