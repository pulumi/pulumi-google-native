...
func GetSslPolicy(ctx *pulumi.Context,
	...
	var resource SslPolicy
	err := ctx.ReadResource("google-native:compute/alpha:SslPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Security settings for the proxy. This field is only applicable to a global backend service with the loadBalancingScheme set to INTERNAL_SELF_MANAGED.
func (o SslPolicyOutput) TlsSettings() ServerTlsSettingsResponseOutput {
	return o.ApplyT(func(v *SslPolicy) ServerTlsSettingsResponseOutput { return v.TlsSettings }).(ServerTlsSettingsResponseOutput)
}
