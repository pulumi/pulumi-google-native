...
func NewSslPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:SslPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslPolicy(ctx *pulumi.Context,
	...
	var resource SslPolicy
	err := ctx.ReadResource("google-cloud:compute/alpha:SslPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
