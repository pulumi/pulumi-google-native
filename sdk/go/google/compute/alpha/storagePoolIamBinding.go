...
func NewStoragePoolIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:StoragePoolIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStoragePoolIamBinding(ctx *pulumi.Context,
	...
	var resource StoragePoolIamBinding
	err := ctx.ReadResource("google-native:compute/alpha:StoragePoolIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *StoragePoolIamBinding) ToOutput(ctx context.Context) pulumix.Output[*StoragePoolIamBinding] {
	return pulumix.Output[*StoragePoolIamBinding]{
		OutputState: i.ToStoragePoolIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o StoragePoolIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*StoragePoolIamBinding] {
	return pulumix.Output[*StoragePoolIamBinding]{
