...
func NewSubnetworkIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/alpha:SubnetworkIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnetworkIamMember(ctx *pulumi.Context,
	...
	var resource SubnetworkIamMember
	err := ctx.ReadResource("google-native:compute/alpha:SubnetworkIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
