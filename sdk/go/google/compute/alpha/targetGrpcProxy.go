...
func NewTargetGrpcProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:TargetGrpcProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetGrpcProxy(ctx *pulumi.Context,
	...
	var resource TargetGrpcProxy
	err := ctx.ReadResource("google-cloud:compute/alpha:TargetGrpcProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
