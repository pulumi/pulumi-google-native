...
func NewTargetHttpProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:TargetHttpProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetHttpProxy(ctx *pulumi.Context,
	...
	var resource TargetHttpProxy
	err := ctx.ReadResource("google-cloud:compute/alpha:TargetHttpProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
