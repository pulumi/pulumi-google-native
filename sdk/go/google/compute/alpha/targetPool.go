...
// Server-defined URL for this resource with the resource id.
func (o TargetPoolOutput) SelfLinkWithId() pulumi.StringOutput {
	return o.ApplyT(func(v *TargetPool) pulumi.StringOutput { return v.SelfLinkWithId }).(pulumi.StringOutput)
}
