...
func NewTargetTcpProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:TargetTcpProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetTcpProxy(ctx *pulumi.Context,
	...
	var resource TargetTcpProxy
	err := ctx.ReadResource("google-cloud:compute/alpha:TargetTcpProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
