...
func NewTargetVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:TargetVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetVpnGateway(ctx *pulumi.Context,
	...
	var resource TargetVpnGateway
	err := ctx.ReadResource("google-cloud:compute/alpha:TargetVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
