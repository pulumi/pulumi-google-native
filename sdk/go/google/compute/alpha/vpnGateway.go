...
func NewVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:VpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnGateway(ctx *pulumi.Context,
	...
	var resource VpnGateway
	err := ctx.ReadResource("google-cloud:compute/alpha:VpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
