...
func NewVpnTunnel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:VpnTunnel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpnTunnel(ctx *pulumi.Context,
	...
	var resource VpnTunnel
	err := ctx.ReadResource("google-cloud:compute/alpha:VpnTunnel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
