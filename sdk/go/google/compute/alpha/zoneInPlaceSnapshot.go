...
type ZoneInPlaceSnapshot struct {
	pulumi.CustomResourceState
}

// NewZoneInPlaceSnapshot registers a new resource with the given unique name, arguments, and options.
func NewZoneInPlaceSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/alpha:ZoneInPlaceSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetZoneInPlaceSnapshot gets an existing ZoneInPlaceSnapshot resource's state with the given name, ID, and optional
// state properties that are used to uniquely qualify the lookup (nil if not required).
func GetZoneInPlaceSnapshot(ctx *pulumi.Context,
	name string, id pulumi.IDInput, state *ZoneInPlaceSnapshotState, opts ...pulumi.ResourceOption) (*ZoneInPlaceSnapshot, error) {
	var resource ZoneInPlaceSnapshot
	err := ctx.ReadResource("google-cloud:compute/alpha:ZoneInPlaceSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering ZoneInPlaceSnapshot resources.
type zoneInPlaceSnapshotState struct {
}

type ZoneInPlaceSnapshotState struct {
}

func (ZoneInPlaceSnapshotState) ElementType() reflect.Type {
	return reflect.TypeOf((*zoneInPlaceSnapshotState)(nil)).Elem()
}

type zoneInPlaceSnapshotArgs struct {
...
func (ZoneInPlaceSnapshotArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*zoneInPlaceSnapshotArgs)(nil)).Elem()
}

type ZoneInPlaceSnapshotInput interface {
	pulumi.Input

	ToZoneInPlaceSnapshotOutput() ZoneInPlaceSnapshotOutput
	ToZoneInPlaceSnapshotOutputWithContext(ctx context.Context) ZoneInPlaceSnapshotOutput
}

func (*ZoneInPlaceSnapshot) ElementType() reflect.Type {
	return reflect.TypeOf((*ZoneInPlaceSnapshot)(nil))
}

func (i *ZoneInPlaceSnapshot) ToZoneInPlaceSnapshotOutput() ZoneInPlaceSnapshotOutput {
	return i.ToZoneInPlaceSnapshotOutputWithContext(context.Background())
}

func (i *ZoneInPlaceSnapshot) ToZoneInPlaceSnapshotOutputWithContext(ctx context.Context) ZoneInPlaceSnapshotOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ZoneInPlaceSnapshotOutput)
}

type ZoneInPlaceSnapshotOutput struct {
	*pulumi.OutputState
}

func (ZoneInPlaceSnapshotOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ZoneInPlaceSnapshot)(nil))
}

func (o ZoneInPlaceSnapshotOutput) ToZoneInPlaceSnapshotOutput() ZoneInPlaceSnapshotOutput {
	return o
}

func (o ZoneInPlaceSnapshotOutput) ToZoneInPlaceSnapshotOutputWithContext(ctx context.Context) ZoneInPlaceSnapshotOutput {
	return o
}

func init() {
	pulumi.RegisterOutputType(ZoneInPlaceSnapshotOutput{})
}
