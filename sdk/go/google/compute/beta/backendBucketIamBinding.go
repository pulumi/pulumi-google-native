...
func NewBackendBucketIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:BackendBucketIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendBucketIamBinding(ctx *pulumi.Context,
	...
	var resource BackendBucketIamBinding
	err := ctx.ReadResource("google-native:compute/beta:BackendBucketIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
