...
func NewBackendBucketIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:BackendBucketIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendBucketIamMember(ctx *pulumi.Context,
	...
	var resource BackendBucketIamMember
	err := ctx.ReadResource("google-native:compute/beta:BackendBucketIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
