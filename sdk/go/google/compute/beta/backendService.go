...
func NewBackendService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:BackendService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendService(ctx *pulumi.Context,
	...
	var resource BackendService
	err := ctx.ReadResource("google-cloud:compute/beta:BackendService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
