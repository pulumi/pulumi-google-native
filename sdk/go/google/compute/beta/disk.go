...
func NewDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.RegisterResource("google-cloud:compute/beta:Disk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDisk(ctx *pulumi.Context,
	...
	var resource Disk
	err := ctx.ReadResource("google-cloud:compute/beta:Disk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type DiskState struct {
	...
	//
	// If you do not provide an encryption key when creating the disk, then the disk will be encrypted using an automatically generated key and you do not need to provide a key to use the disk later.
	DiskEncryptionKey CustomerEncryptionKeyResponsePtrInput
	// Specifies whether the disk restored from a source snapshot should erase Windows specific VSS signature.
