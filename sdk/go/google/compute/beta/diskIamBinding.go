...
func NewDiskIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:DiskIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskIamBinding(ctx *pulumi.Context,
	...
	var resource DiskIamBinding
	err := ctx.ReadResource("google-native:compute/beta:DiskIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
