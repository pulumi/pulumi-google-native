...
func NewFirewallPolicyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:FirewallPolicyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyIamBinding(ctx *pulumi.Context,
	...
	var resource FirewallPolicyIamBinding
	err := ctx.ReadResource("google-native:compute/beta:FirewallPolicyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *FirewallPolicyIamBinding) ToOutput(ctx context.Context) pulumix.Output[*FirewallPolicyIamBinding] {
	return pulumix.Output[*FirewallPolicyIamBinding]{
		OutputState: i.ToFirewallPolicyIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o FirewallPolicyIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*FirewallPolicyIamBinding] {
	return pulumix.Output[*FirewallPolicyIamBinding]{
