...
func NewForwardingRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:ForwardingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetForwardingRule(ctx *pulumi.Context,
	...
	var resource ForwardingRule
	err := ctx.ReadResource("google-cloud:compute/beta:ForwardingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
