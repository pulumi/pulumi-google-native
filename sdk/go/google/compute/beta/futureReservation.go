...
func NewFutureReservation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:FutureReservation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFutureReservation(ctx *pulumi.Context,
	...
	var resource FutureReservation
	err := ctx.ReadResource("google-native:compute/beta:FutureReservation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
