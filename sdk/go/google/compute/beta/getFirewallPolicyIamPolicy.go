...
// This is deprecated and has no effect. Do not use.
func (o LookupFirewallPolicyIamPolicyResultOutput) IamOwned() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupFirewallPolicyIamPolicyResult) bool { return v.IamOwned }).(pulumi.BoolOutput)
}
