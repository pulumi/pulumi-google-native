...
func LookupFirewallPolicyIamPolicy(ctx *pulumi.Context, args *LookupFirewallPolicyIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupFirewallPolicyIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/beta:getFirewallPolicyIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupFirewallPolicyIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallPolicyIamPolicyResult] {
	return pulumix.Output[LookupFirewallPolicyIamPolicyResult]{
