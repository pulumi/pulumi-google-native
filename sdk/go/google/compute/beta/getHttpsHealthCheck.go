...
func LookupHttpsHealthCheck(ctx *pulumi.Context, args *LookupHttpsHealthCheckArgs, opts ...pulumi.InvokeOption) (*LookupHttpsHealthCheckResult, error) {
	...
	err := ctx.Invoke("google-native:compute/beta:getHttpsHealthCheck", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupHttpsHealthCheckResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupHttpsHealthCheckResult] {
	return pulumix.Output[LookupHttpsHealthCheckResult]{
