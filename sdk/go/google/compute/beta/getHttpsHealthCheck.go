...
// The unique identifier for the resource. This identifier is defined by the server.
func (o LookupHttpsHealthCheckResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v LookupHttpsHealthCheckResult) string { return v.Id }).(pulumi.StringOutput)
}
