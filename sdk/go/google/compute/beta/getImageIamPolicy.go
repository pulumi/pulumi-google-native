...
// This is deprecated and has no effect. Do not use.
func (o LookupImageIamPolicyResultOutput) IamOwned() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupImageIamPolicyResult) bool { return v.IamOwned }).(pulumi.BoolOutput)
}
