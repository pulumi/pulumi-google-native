...
func LookupInstanceIamPolicy(ctx *pulumi.Context, args *LookupInstanceIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupInstanceIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/beta:getInstanceIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// This is deprecated and has no effect. Do not use.
func (o LookupInstanceIamPolicyResultOutput) IamOwned() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupInstanceIamPolicyResult) bool { return v.IamOwned }).(pulumi.BoolOutput)
}
