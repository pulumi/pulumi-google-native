...
func LookupMachineImageIamPolicy(ctx *pulumi.Context, args *LookupMachineImageIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupMachineImageIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/beta:getMachineImageIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// This is deprecated and has no effect. Do not use.
func (o LookupMachineImageIamPolicyResultOutput) IamOwned() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupMachineImageIamPolicyResult) bool { return v.IamOwned }).(pulumi.BoolOutput)
}
