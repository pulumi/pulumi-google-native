...
func LookupNodeGroup(ctx *pulumi.Context, args *LookupNodeGroupArgs, opts ...pulumi.InvokeOption) (*LookupNodeGroupResult, error) {
	...
	err := ctx.Invoke("google-native:compute/beta:getNodeGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Specifies the frequency of planned maintenance events. The accepted values are: `AS_NEEDED` and `RECURRENT`.
func (o LookupNodeGroupResultOutput) MaintenanceInterval() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNodeGroupResult) string { return v.MaintenanceInterval }).(pulumi.StringOutput)
}
