...
func LookupPublicDelegatedPrefix(ctx *pulumi.Context, args *LookupPublicDelegatedPrefixArgs, opts ...pulumi.InvokeOption) (*LookupPublicDelegatedPrefixResult, error) {
	...
	err := ctx.Invoke("google-native:compute/beta:getPublicDelegatedPrefix", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The version of BYOIP API.
func (o LookupPublicDelegatedPrefixResultOutput) ByoipApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPublicDelegatedPrefixResult) string { return v.ByoipApiVersion }).(pulumi.StringOutput)
}
