...
func LookupRegionNetworkEndpointGroup(ctx *pulumi.Context, args *LookupRegionNetworkEndpointGroupArgs, opts ...pulumi.InvokeOption) (*LookupRegionNetworkEndpointGroupResult, error) {
	...
	err := ctx.Invoke("google-native:compute/beta:getRegionNetworkEndpointGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Only valid when networkEndpointType is GCE_VM_IP_PORT and the NEG is regional.
func (o LookupRegionNetworkEndpointGroupResultOutput) ClientPortMappingMode() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegionNetworkEndpointGroupResult) string { return v.ClientPortMappingMode }).(pulumi.StringOutput)
}
...
func (o LookupRegionNetworkEndpointGroupResultOutput) PscData() NetworkEndpointGroupPscDataResponseOutput {
	return o.ApplyT(func(v LookupRegionNetworkEndpointGroupResult) NetworkEndpointGroupPscDataResponse { return v.PscData }).(NetworkEndpointGroupPscDataResponseOutput)
}
