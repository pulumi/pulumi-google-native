...
func (o LookupSslCertificateResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSslCertificateResult] {
	return pulumix.Output[LookupSslCertificateResult]{
