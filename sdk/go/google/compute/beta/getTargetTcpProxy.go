...
// The unique identifier for the resource. This identifier is defined by the server.
func (o LookupTargetTcpProxyResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v LookupTargetTcpProxyResult) string { return v.Id }).(pulumi.StringOutput)
}
