...
func NewGlobalAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:GlobalAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalAddress(ctx *pulumi.Context,
	...
	var resource GlobalAddress
	err := ctx.ReadResource("google-cloud:compute/beta:GlobalAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
