...
func NewImageIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:ImageIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageIamBinding(ctx *pulumi.Context,
	...
	var resource ImageIamBinding
	err := ctx.ReadResource("google-native:compute/beta:ImageIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
