...
func NewInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstance(ctx *pulumi.Context,
	...
	var resource Instance
	err := ctx.ReadResource("google-cloud:compute/beta:Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
