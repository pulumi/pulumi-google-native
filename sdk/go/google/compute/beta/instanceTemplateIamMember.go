...
func NewInstanceTemplateIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:InstanceTemplateIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceTemplateIamMember(ctx *pulumi.Context,
	...
	var resource InstanceTemplateIamMember
	err := ctx.ReadResource("google-native:compute/beta:InstanceTemplateIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
