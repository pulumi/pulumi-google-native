...
func NewInstanceTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:InstanceTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceTemplateIamPolicy
	err := ctx.ReadResource("google-native:compute/beta:InstanceTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
