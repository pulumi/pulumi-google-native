...
func NewInstantSnapshotIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:InstantSnapshotIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstantSnapshotIamMember(ctx *pulumi.Context,
	...
	var resource InstantSnapshotIamMember
	err := ctx.ReadResource("google-native:compute/beta:InstantSnapshotIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
