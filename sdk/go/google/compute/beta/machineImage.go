...
func NewMachineImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:MachineImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineImage(ctx *pulumi.Context,
	...
	var resource MachineImage
	err := ctx.ReadResource("google-cloud:compute/beta:MachineImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
