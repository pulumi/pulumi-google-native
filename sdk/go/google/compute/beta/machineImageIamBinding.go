...
func NewMachineImageIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:MachineImageIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineImageIamBinding(ctx *pulumi.Context,
	...
	var resource MachineImageIamBinding
	err := ctx.ReadResource("google-native:compute/beta:MachineImageIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
