...
func NewNetworkAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:NetworkAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkAttachment(ctx *pulumi.Context,
	...
	var resource NetworkAttachment
	err := ctx.ReadResource("google-native:compute/beta:NetworkAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
