...
func NewNetworkEndpointGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:NetworkEndpointGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkEndpointGroup(ctx *pulumi.Context,
	...
	var resource NetworkEndpointGroup
	err := ctx.ReadResource("google-cloud:compute/beta:NetworkEndpointGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
