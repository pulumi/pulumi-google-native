...
func NewNetworkFirewallPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:NetworkFirewallPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFirewallPolicy(ctx *pulumi.Context,
	...
	var resource NetworkFirewallPolicy
	err := ctx.ReadResource("google-native:compute/beta:NetworkFirewallPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
