...
func NewNetworkFirewallPolicyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:NetworkFirewallPolicyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFirewallPolicyIamBinding(ctx *pulumi.Context,
	...
	var resource NetworkFirewallPolicyIamBinding
	err := ctx.ReadResource("google-native:compute/beta:NetworkFirewallPolicyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
