...
func NewNotificationEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:NotificationEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationEndpoint(ctx *pulumi.Context,
	...
	var resource NotificationEndpoint
	err := ctx.ReadResource("google-cloud:compute/beta:NotificationEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
