...
func NewRegionAutoscaler(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:RegionAutoscaler", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionAutoscaler(ctx *pulumi.Context,
	...
	var resource RegionAutoscaler
	err := ctx.ReadResource("google-cloud:compute/beta:RegionAutoscaler", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
