...
func NewRegionBackendServiceIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:RegionBackendServiceIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionBackendServiceIamBinding(ctx *pulumi.Context,
	...
	var resource RegionBackendServiceIamBinding
	err := ctx.ReadResource("google-native:compute/beta:RegionBackendServiceIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o RegionBackendServiceIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *RegionBackendServiceIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
