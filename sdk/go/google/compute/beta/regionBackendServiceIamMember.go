...
func NewRegionBackendServiceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:RegionBackendServiceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionBackendServiceIamMember(ctx *pulumi.Context,
	...
	var resource RegionBackendServiceIamMember
	err := ctx.ReadResource("google-native:compute/beta:RegionBackendServiceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *RegionBackendServiceIamMember) ToOutput(ctx context.Context) pulumix.Output[*RegionBackendServiceIamMember] {
	return pulumix.Output[*RegionBackendServiceIamMember]{
		OutputState: i.ToRegionBackendServiceIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o RegionBackendServiceIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*RegionBackendServiceIamMember] {
	return pulumix.Output[*RegionBackendServiceIamMember]{
