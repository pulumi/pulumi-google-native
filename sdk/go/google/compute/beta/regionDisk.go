...
func NewRegionDisk(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:RegionDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDisk(ctx *pulumi.Context,
	...
	var resource RegionDisk
	err := ctx.ReadResource("google-cloud:compute/beta:RegionDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
