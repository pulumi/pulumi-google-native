...
func NewRegionDiskIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:RegionDiskIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDiskIamMember(ctx *pulumi.Context,
	...
	var resource RegionDiskIamMember
	err := ctx.ReadResource("google-native:compute/beta:RegionDiskIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
