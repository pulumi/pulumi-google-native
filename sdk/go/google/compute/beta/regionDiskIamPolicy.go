...
func NewRegionDiskIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:RegionDiskIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDiskIamPolicy(ctx *pulumi.Context,
	...
	var resource RegionDiskIamPolicy
	err := ctx.ReadResource("google-native:compute/beta:RegionDiskIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
