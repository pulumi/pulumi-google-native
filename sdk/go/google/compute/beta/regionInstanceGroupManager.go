...
func NewRegionInstanceGroupManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:RegionInstanceGroupManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionInstanceGroupManager(ctx *pulumi.Context,
	...
	var resource RegionInstanceGroupManager
	err := ctx.ReadResource("google-cloud:compute/beta:RegionInstanceGroupManager", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
