...
func NewRegionInstanceTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:RegionInstanceTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionInstanceTemplate(ctx *pulumi.Context,
	...
	var resource RegionInstanceTemplate
	err := ctx.ReadResource("google-native:compute/beta:RegionInstanceTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
