...
func NewRegionNotificationEndpoint(ctx *pulumi.Context,
	...
	if args.NotificationEndpoint == nil {
		return nil, errors.New("invalid value for required argument 'NotificationEndpoint'")
	}
	if args.Project == nil {
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:RegionNotificationEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionNotificationEndpoint(ctx *pulumi.Context,
	...
	var resource RegionNotificationEndpoint
	err := ctx.ReadResource("google-cloud:compute/beta:RegionNotificationEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
