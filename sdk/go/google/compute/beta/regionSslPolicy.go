...
func NewRegionSslPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:RegionSslPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionSslPolicy(ctx *pulumi.Context,
	...
	var resource RegionSslPolicy
	err := ctx.ReadResource("google-native:compute/beta:RegionSslPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
