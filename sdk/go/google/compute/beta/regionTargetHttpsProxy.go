...
func NewRegionTargetHttpsProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:RegionTargetHttpsProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionTargetHttpsProxy(ctx *pulumi.Context,
	...
	var resource RegionTargetHttpsProxy
	err := ctx.ReadResource("google-cloud:compute/beta:RegionTargetHttpsProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
