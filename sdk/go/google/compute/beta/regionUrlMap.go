...
func NewRegionUrlMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:RegionUrlMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionUrlMap(ctx *pulumi.Context,
	...
	var resource RegionUrlMap
	err := ctx.ReadResource("google-cloud:compute/beta:RegionUrlMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
