...
func NewResourcePolicyIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:ResourcePolicyIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourcePolicyIamMember(ctx *pulumi.Context,
	...
	var resource ResourcePolicyIamMember
	err := ctx.ReadResource("google-native:compute/beta:ResourcePolicyIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
