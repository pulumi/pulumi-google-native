...
func NewStoragePoolIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:StoragePoolIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStoragePoolIamBinding(ctx *pulumi.Context,
	...
	var resource StoragePoolIamBinding
	err := ctx.ReadResource("google-native:compute/beta:StoragePoolIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o StoragePoolIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *StoragePoolIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
