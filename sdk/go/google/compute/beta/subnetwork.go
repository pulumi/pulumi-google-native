...
func NewSubnetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:Subnetwork", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnetwork(ctx *pulumi.Context,
	...
	var resource Subnetwork
	err := ctx.ReadResource("google-cloud:compute/beta:Subnetwork", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
