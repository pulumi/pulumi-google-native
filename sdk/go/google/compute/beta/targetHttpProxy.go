...
func NewTargetHttpProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/beta:TargetHttpProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetHttpProxy(ctx *pulumi.Context,
	...
	var resource TargetHttpProxy
	err := ctx.ReadResource("google-native:compute/beta:TargetHttpProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
