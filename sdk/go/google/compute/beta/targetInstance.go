...
func NewTargetInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/beta:TargetInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetInstance(ctx *pulumi.Context,
	...
	var resource TargetInstance
	err := ctx.ReadResource("google-cloud:compute/beta:TargetInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
