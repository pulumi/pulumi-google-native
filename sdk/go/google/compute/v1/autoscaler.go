...
func GetAutoscaler(ctx *pulumi.Context,
	...
	var resource Autoscaler
	err := ctx.ReadResource("google-native:compute/v1:Autoscaler", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Status information of existing scaling schedules.
func (o AutoscalerOutput) ScalingScheduleStatus() ScalingScheduleStatusResponseOutput {
	return o.ApplyT(func(v *Autoscaler) ScalingScheduleStatusResponseOutput { return v.ScalingScheduleStatus }).(ScalingScheduleStatusResponseOutput)
}
