...
func NewBackendBucketIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:BackendBucketIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendBucketIamPolicy(ctx *pulumi.Context,
	...
	var resource BackendBucketIamPolicy
	err := ctx.ReadResource("google-native:compute/v1:BackendBucketIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
