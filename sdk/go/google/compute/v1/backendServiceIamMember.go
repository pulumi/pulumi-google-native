...
func NewBackendServiceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:BackendServiceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendServiceIamMember(ctx *pulumi.Context,
	...
	var resource BackendServiceIamMember
	err := ctx.ReadResource("google-native:compute/v1:BackendServiceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
