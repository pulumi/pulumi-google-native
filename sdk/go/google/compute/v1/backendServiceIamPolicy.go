...
func NewBackendServiceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:BackendServiceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendServiceIamPolicy(ctx *pulumi.Context,
	...
	var resource BackendServiceIamPolicy
	err := ctx.ReadResource("google-native:compute/v1:BackendServiceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
