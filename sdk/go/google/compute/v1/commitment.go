...
func NewCommitment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:Commitment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCommitment(ctx *pulumi.Context,
	...
	var resource Commitment
	err := ctx.ReadResource("google-cloud:compute/v1:Commitment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
