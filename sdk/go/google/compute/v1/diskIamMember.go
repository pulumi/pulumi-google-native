...
func NewDiskIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:DiskIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskIamMember(ctx *pulumi.Context,
	...
	var resource DiskIamMember
	err := ctx.ReadResource("google-native:compute/v1:DiskIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
