...
func NewDiskIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:DiskIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiskIamPolicy(ctx *pulumi.Context,
	...
	var resource DiskIamPolicy
	err := ctx.ReadResource("google-cloud:compute/v1:DiskIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
