...
func NewExternalVpnGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:ExternalVpnGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExternalVpnGateway(ctx *pulumi.Context,
	...
	var resource ExternalVpnGateway
	err := ctx.ReadResource("google-cloud:compute/v1:ExternalVpnGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
