...
func NewFirewallPolicyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:FirewallPolicyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyIamBinding(ctx *pulumi.Context,
	...
	var resource FirewallPolicyIamBinding
	err := ctx.ReadResource("google-native:compute/v1:FirewallPolicyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
