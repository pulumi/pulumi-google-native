...
func NewFirewallPolicyIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:FirewallPolicyIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallPolicyIamPolicy(ctx *pulumi.Context,
	...
	var resource FirewallPolicyIamPolicy
	err := ctx.ReadResource("google-cloud:compute/v1:FirewallPolicyIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
