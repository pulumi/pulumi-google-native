...
func LookupRegionTargetTcpProxy(ctx *pulumi.Context, args *LookupRegionTargetTcpProxyArgs, opts ...pulumi.InvokeOption) (*LookupRegionTargetTcpProxyResult, error) {
	...
	err := ctx.Invoke("google-native:compute/v1:getRegionTargetTcpProxy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupRegionTargetTcpProxyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRegionTargetTcpProxyResult] {
	return pulumix.Output[LookupRegionTargetTcpProxyResult]{
