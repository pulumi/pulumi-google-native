...
func (o LookupTargetHttpProxyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTargetHttpProxyResult] {
	return pulumix.Output[LookupTargetHttpProxyResult]{
