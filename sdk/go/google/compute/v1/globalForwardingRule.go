...
func NewGlobalForwardingRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:GlobalForwardingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalForwardingRule(ctx *pulumi.Context,
	...
	var resource GlobalForwardingRule
	err := ctx.ReadResource("google-cloud:compute/v1:GlobalForwardingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
