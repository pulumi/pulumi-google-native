...
func NewGlobalPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:GlobalPublicDelegatedPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	var resource GlobalPublicDelegatedPrefix
	err := ctx.ReadResource("google-cloud:compute/v1:GlobalPublicDelegatedPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
