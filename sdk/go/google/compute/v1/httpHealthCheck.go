...
func NewHttpHealthCheck(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:HttpHealthCheck", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHttpHealthCheck(ctx *pulumi.Context,
	...
	var resource HttpHealthCheck
	err := ctx.ReadResource("google-cloud:compute/v1:HttpHealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
