...
// A unique identifier for this instance group, generated by the server.
func (o InstanceGroupOutput) InstanceGroupId() pulumi.StringOutput {
	return o.ApplyT(func(v *InstanceGroup) pulumi.StringOutput { return v.InstanceGroupId }).(pulumi.StringOutput)
}
