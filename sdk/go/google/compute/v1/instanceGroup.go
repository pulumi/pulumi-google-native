...
func NewInstanceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:InstanceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceGroup(ctx *pulumi.Context,
	...
	var resource InstanceGroup
	err := ctx.ReadResource("google-cloud:compute/v1:InstanceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
