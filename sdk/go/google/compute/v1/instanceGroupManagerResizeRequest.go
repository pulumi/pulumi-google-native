...
func NewInstanceGroupManagerResizeRequest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:InstanceGroupManagerResizeRequest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceGroupManagerResizeRequest(ctx *pulumi.Context,
	...
	var resource InstanceGroupManagerResizeRequest
	err := ctx.ReadResource("google-native:compute/v1:InstanceGroupManagerResizeRequest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
