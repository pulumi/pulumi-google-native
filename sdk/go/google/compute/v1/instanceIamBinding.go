...
func NewInstanceIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:InstanceIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceIamBinding(ctx *pulumi.Context,
	...
	var resource InstanceIamBinding
	err := ctx.ReadResource("google-native:compute/v1:InstanceIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
