...
type InstanceTemplate struct {
	...
	InstanceTemplateId pulumi.StringOutput `pulumi:"instanceTemplateId"`
...
func NewInstanceTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:InstanceTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceTemplate(ctx *pulumi.Context,
	...
	var resource InstanceTemplate
	err := ctx.ReadResource("google-native:compute/v1:InstanceTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// A unique identifier for this instance template. The server defines this identifier.
func (o InstanceTemplateOutput) InstanceTemplateId() pulumi.StringOutput {
	return o.ApplyT(func(v *InstanceTemplate) pulumi.StringOutput { return v.InstanceTemplateId }).(pulumi.StringOutput)
}
