...
func NewInstantSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:InstantSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstantSnapshot(ctx *pulumi.Context,
	...
	var resource InstantSnapshot
	err := ctx.ReadResource("google-native:compute/v1:InstantSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
