...
func NewInterconnect(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:Interconnect", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterconnect(ctx *pulumi.Context,
	...
	var resource Interconnect
	err := ctx.ReadResource("google-cloud:compute/v1:Interconnect", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
