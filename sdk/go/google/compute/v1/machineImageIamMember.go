...
func NewMachineImageIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:MachineImageIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineImageIamMember(ctx *pulumi.Context,
	...
	var resource MachineImageIamMember
	err := ctx.ReadResource("google-native:compute/v1:MachineImageIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o MachineImageIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *MachineImageIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o MachineImageIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *MachineImageIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
