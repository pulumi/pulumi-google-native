...
func NewNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:Network", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetwork(ctx *pulumi.Context,
	...
	var resource Network
	err := ctx.ReadResource("google-cloud:compute/v1:Network", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
