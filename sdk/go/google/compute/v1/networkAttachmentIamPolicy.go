...
func NewNetworkAttachmentIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:NetworkAttachmentIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkAttachmentIamPolicy(ctx *pulumi.Context,
	...
	var resource NetworkAttachmentIamPolicy
	err := ctx.ReadResource("google-native:compute/v1:NetworkAttachmentIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
