...
func NewNetworkFirewallPolicyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:NetworkFirewallPolicyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkFirewallPolicyIamBinding(ctx *pulumi.Context,
	...
	var resource NetworkFirewallPolicyIamBinding
	err := ctx.ReadResource("google-native:compute/v1:NetworkFirewallPolicyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *NetworkFirewallPolicyIamBinding) ToOutput(ctx context.Context) pulumix.Output[*NetworkFirewallPolicyIamBinding] {
	return pulumix.Output[*NetworkFirewallPolicyIamBinding]{
		OutputState: i.ToNetworkFirewallPolicyIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o NetworkFirewallPolicyIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*NetworkFirewallPolicyIamBinding] {
	return pulumix.Output[*NetworkFirewallPolicyIamBinding]{
