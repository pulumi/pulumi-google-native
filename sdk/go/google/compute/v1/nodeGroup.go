...
func NewNodeGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:NodeGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeGroup(ctx *pulumi.Context,
	...
	var resource NodeGroup
	err := ctx.ReadResource("google-cloud:compute/v1:NodeGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
