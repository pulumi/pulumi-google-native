...
func NewNodeTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:NodeTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource NodeTemplateIamPolicy
	err := ctx.ReadResource("google-native:compute/v1:NodeTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
