...
func NewPublicAdvertisedPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:PublicAdvertisedPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicAdvertisedPrefix(ctx *pulumi.Context,
	...
	var resource PublicAdvertisedPrefix
	err := ctx.ReadResource("google-native:compute/v1:PublicAdvertisedPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
