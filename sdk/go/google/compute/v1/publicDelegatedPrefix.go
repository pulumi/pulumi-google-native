...
func NewPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:PublicDelegatedPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicDelegatedPrefix(ctx *pulumi.Context,
	...
	var resource PublicDelegatedPrefix
	err := ctx.ReadResource("google-native:compute/v1:PublicDelegatedPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
