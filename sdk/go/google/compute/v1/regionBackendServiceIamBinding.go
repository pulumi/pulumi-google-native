...
func NewRegionBackendServiceIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:RegionBackendServiceIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionBackendServiceIamBinding(ctx *pulumi.Context,
	...
	var resource RegionBackendServiceIamBinding
	err := ctx.ReadResource("google-native:compute/v1:RegionBackendServiceIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
