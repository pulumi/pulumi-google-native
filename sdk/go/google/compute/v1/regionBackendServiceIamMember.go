...
func NewRegionBackendServiceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:RegionBackendServiceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionBackendServiceIamMember(ctx *pulumi.Context,
	...
	var resource RegionBackendServiceIamMember
	err := ctx.ReadResource("google-native:compute/v1:RegionBackendServiceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
