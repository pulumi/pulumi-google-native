...
func NewRegionCommitment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:RegionCommitment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionCommitment(ctx *pulumi.Context,
	...
	var resource RegionCommitment
	err := ctx.ReadResource("google-cloud:compute/v1:RegionCommitment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
