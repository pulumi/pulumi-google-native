...
func NewRegionDisk(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:RegionDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDisk(ctx *pulumi.Context,
	...
	var resource RegionDisk
	err := ctx.ReadResource("google-cloud:compute/v1:RegionDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
