...
func GetRegionDisk(ctx *pulumi.Context,
	...
	var resource RegionDisk
	err := ctx.ReadResource("google-native:compute/v1:RegionDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// A list of disks this disk is asynchronously replicated to.
func (o RegionDiskOutput) AsyncSecondaryDisks() DiskAsyncReplicationListResponseOutput {
	return o.ApplyT(func(v *RegionDisk) DiskAsyncReplicationListResponseOutput { return v.AsyncSecondaryDisks }).(DiskAsyncReplicationListResponseOutput)
}
