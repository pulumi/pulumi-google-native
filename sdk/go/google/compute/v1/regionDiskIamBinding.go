...
func NewRegionDiskIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:RegionDiskIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionDiskIamBinding(ctx *pulumi.Context,
	...
	var resource RegionDiskIamBinding
	err := ctx.ReadResource("google-native:compute/v1:RegionDiskIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
