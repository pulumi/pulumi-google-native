...
func NewRegionHealthCheckService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:RegionHealthCheckService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionHealthCheckService(ctx *pulumi.Context,
	...
	var resource RegionHealthCheckService
	err := ctx.ReadResource("google-native:compute/v1:RegionHealthCheckService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
