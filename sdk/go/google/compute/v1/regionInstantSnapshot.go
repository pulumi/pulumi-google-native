...
func NewRegionInstantSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:RegionInstantSnapshot", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionInstantSnapshot(ctx *pulumi.Context,
	...
	var resource RegionInstantSnapshot
	err := ctx.ReadResource("google-native:compute/v1:RegionInstantSnapshot", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Reserved for future use.
func (o RegionInstantSnapshotOutput) SatisfiesPzi() pulumi.BoolOutput {
	return o.ApplyT(func(v *RegionInstantSnapshot) pulumi.BoolOutput { return v.SatisfiesPzi }).(pulumi.BoolOutput)
}
