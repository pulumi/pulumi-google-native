...
func NewRegionNetworkEndpointGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:RegionNetworkEndpointGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionNetworkEndpointGroup(ctx *pulumi.Context,
	...
	var resource RegionNetworkEndpointGroup
	err := ctx.ReadResource("google-cloud:compute/v1:RegionNetworkEndpointGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
