...
func NewRegionNotificationEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:RegionNotificationEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionNotificationEndpoint(ctx *pulumi.Context,
	...
	var resource RegionNotificationEndpoint
	err := ctx.ReadResource("google-cloud:compute/v1:RegionNotificationEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
