...
func NewRegionTargetHttpProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:RegionTargetHttpProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionTargetHttpProxy(ctx *pulumi.Context,
	...
	var resource RegionTargetHttpProxy
	err := ctx.ReadResource("google-cloud:compute/v1:RegionTargetHttpProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
