...
func NewRegionTargetTcpProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:RegionTargetTcpProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionTargetTcpProxy(ctx *pulumi.Context,
	...
	var resource RegionTargetTcpProxy
	err := ctx.ReadResource("google-native:compute/v1:RegionTargetTcpProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
