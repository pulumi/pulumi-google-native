...
func NewReservationIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:ReservationIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReservationIamBinding(ctx *pulumi.Context,
	...
	var resource ReservationIamBinding
	err := ctx.ReadResource("google-native:compute/v1:ReservationIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ReservationIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ReservationIamBinding] {
	return pulumix.Output[*ReservationIamBinding]{
		OutputState: i.ToReservationIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ReservationIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ReservationIamBinding] {
	return pulumix.Output[*ReservationIamBinding]{
