...
func NewRouter(ctx *pulumi.Context,
	...
	var resource Router
	err := ctx.RegisterResource("google-cloud:compute/v1:Router", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouter(ctx *pulumi.Context,
	...
	var resource Router
	err := ctx.ReadResource("google-cloud:compute/v1:Router", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
