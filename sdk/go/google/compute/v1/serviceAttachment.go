...
func NewServiceAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:ServiceAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAttachment(ctx *pulumi.Context,
	...
	var resource ServiceAttachment
	err := ctx.ReadResource("google-native:compute/v1:ServiceAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
