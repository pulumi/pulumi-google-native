...
func NewServiceAttachmentIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:ServiceAttachmentIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAttachmentIamBinding(ctx *pulumi.Context,
	...
	var resource ServiceAttachmentIamBinding
	err := ctx.ReadResource("google-native:compute/v1:ServiceAttachmentIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ServiceAttachmentIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ServiceAttachmentIamBinding] {
	return pulumix.Output[*ServiceAttachmentIamBinding]{
		OutputState: i.ToServiceAttachmentIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ServiceAttachmentIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ServiceAttachmentIamBinding] {
	return pulumix.Output[*ServiceAttachmentIamBinding]{
