...
func NewServiceAttachmentIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:ServiceAttachmentIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAttachmentIamPolicy(ctx *pulumi.Context,
	...
	var resource ServiceAttachmentIamPolicy
	err := ctx.ReadResource("google-native:compute/v1:ServiceAttachmentIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
