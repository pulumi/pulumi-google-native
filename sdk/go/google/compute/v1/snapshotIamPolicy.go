...
func NewSnapshotIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:SnapshotIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotIamPolicy(ctx *pulumi.Context,
	...
	var resource SnapshotIamPolicy
	err := ctx.ReadResource("google-native:compute/v1:SnapshotIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies cloud audit logging configuration for this policy.
func (o SnapshotIamPolicyOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v *SnapshotIamPolicy) AuditConfigResponseArrayOutput { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}
...
func (o SnapshotIamPolicyOutput) Resource() pulumi.StringOutput {
	return o.ApplyT(func(v *SnapshotIamPolicy) pulumi.StringOutput { return v.Resource }).(pulumi.StringOutput)
}

// This is deprecated and has no effect. Do not use.
func (o SnapshotIamPolicyOutput) Rules() RuleResponseArrayOutput {
	return o.ApplyT(func(v *SnapshotIamPolicy) RuleResponseArrayOutput { return v.Rules }).(RuleResponseArrayOutput)
}
