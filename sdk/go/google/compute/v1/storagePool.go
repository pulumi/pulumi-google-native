...
func NewStoragePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:StoragePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStoragePool(ctx *pulumi.Context,
	...
	var resource StoragePool
	err := ctx.ReadResource("google-native:compute/v1:StoragePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
