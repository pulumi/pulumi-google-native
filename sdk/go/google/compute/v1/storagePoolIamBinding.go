...
func NewStoragePoolIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:StoragePoolIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStoragePoolIamBinding(ctx *pulumi.Context,
	...
	var resource StoragePoolIamBinding
	err := ctx.ReadResource("google-native:compute/v1:StoragePoolIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
