...
func NewStoragePoolIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:StoragePoolIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStoragePoolIamPolicy(ctx *pulumi.Context,
	...
	var resource StoragePoolIamPolicy
	err := ctx.ReadResource("google-native:compute/v1:StoragePoolIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
