...
func NewSubnetworkIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:SubnetworkIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnetworkIamBinding(ctx *pulumi.Context,
	...
	var resource SubnetworkIamBinding
	err := ctx.ReadResource("google-native:compute/v1:SubnetworkIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
