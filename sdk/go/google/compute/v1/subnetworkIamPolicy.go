...
func NewSubnetworkIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:compute/v1:SubnetworkIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnetworkIamPolicy(ctx *pulumi.Context,
	...
	var resource SubnetworkIamPolicy
	err := ctx.ReadResource("google-native:compute/v1:SubnetworkIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
