...
// The resource URL for the security policy associated with this target instance.
func (o TargetInstanceOutput) SecurityPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v *TargetInstance) pulumi.StringOutput { return v.SecurityPolicy }).(pulumi.StringOutput)
}
