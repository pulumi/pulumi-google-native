...
func NewTargetPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:compute/v1:TargetPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetPool(ctx *pulumi.Context,
	...
	var resource TargetPool
	err := ctx.ReadResource("google-cloud:compute/v1:TargetPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
