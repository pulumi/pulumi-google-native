...
func NewUrlMap(ctx *pulumi.Context,
	...
	var resource UrlMap
	err := ctx.RegisterResource("google-cloud:compute/v1:UrlMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUrlMap(ctx *pulumi.Context,
	...
	var resource UrlMap
	err := ctx.ReadResource("google-cloud:compute/v1:UrlMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
