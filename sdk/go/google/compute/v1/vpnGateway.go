...
type VpnGateway struct {
	...
	GatewayIpVersion pulumi.StringOutput `pulumi:"gatewayIpVersion"`
...
type vpnGatewayArgs struct {
	...
	// The IP family of the gateway IPs for the HA-VPN gateway interfaces. If not specified, IPV4 will be used.
	GatewayIpVersion *VpnGatewayGatewayIpVersion `pulumi:"gatewayIpVersion"`
	// Labels for this resource. These can only be added or modified by the setLabels method. Each label key/value pair must comply with RFC1035. Label values may be empty.
...
type VpnGatewayArgs struct {
	...
	// The IP family of the gateway IPs for the HA-VPN gateway interfaces. If not specified, IPV4 will be used.
	GatewayIpVersion VpnGatewayGatewayIpVersionPtrInput
	// Labels for this resource. These can only be added or modified by the setLabels method. Each label key/value pair must comply with RFC1035. Label values may be empty.
...
// The IP family of the gateway IPs for the HA-VPN gateway interfaces. If not specified, IPV4 will be used.
func (o VpnGatewayOutput) GatewayIpVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *VpnGateway) pulumi.StringOutput { return v.GatewayIpVersion }).(pulumi.StringOutput)
}
