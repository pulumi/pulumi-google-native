...
func NewConnectionIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:connectors/v1:ConnectionIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionIamMember(ctx *pulumi.Context,
	...
	var resource ConnectionIamMember
	err := ctx.ReadResource("google-native:connectors/v1:ConnectionIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
