...
func NewConnectionIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:connectors/v1:ConnectionIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionIamPolicy(ctx *pulumi.Context,
	...
	var resource ConnectionIamPolicy
	err := ctx.ReadResource("google-native:connectors/v1:ConnectionIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
