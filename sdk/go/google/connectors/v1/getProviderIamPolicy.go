...
func (o LookupProviderIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupProviderIamPolicyResult] {
	return pulumix.Output[LookupProviderIamPolicyResult]{
