...
type Conversation struct {
	...
	DialogflowIntents GoogleCloudContactcenterinsightsV1DialogflowIntentResponseOutput `pulumi:"dialogflowIntents"`
...
// All the matched Dialogflow intents in the call. The key corresponds to a Dialogflow intent, format: projects/{project}/agent/{agent}/intents/{intent}
func (o ConversationOutput) DialogflowIntents() GoogleCloudContactcenterinsightsV1DialogflowIntentResponseOutput {
	return o.ApplyT(func(v *Conversation) GoogleCloudContactcenterinsightsV1DialogflowIntentResponseOutput {
