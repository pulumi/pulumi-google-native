...
func LookupNodePool(ctx *pulumi.Context, args *LookupNodePoolArgs, opts ...pulumi.InvokeOption) (*LookupNodePoolResult, error) {
	...
	err := ctx.Invoke("google-native:container/v1:getNodePool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// This checksum is computed by the server based on the value of node pool fields, and may be sent on update requests to ensure the client has an up-to-date value before proceeding.
func (o LookupNodePoolResultOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNodePoolResult) string { return v.Etag }).(pulumi.StringOutput)
}
