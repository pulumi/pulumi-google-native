...
func (o ClusterOutput) ClusterTelemetry() ClusterTelemetryResponseOutput {
	return o.ApplyT(func(v *Cluster) ClusterTelemetryResponseOutput { return v.ClusterTelemetry }).(ClusterTelemetryResponseOutput)
}
...
// Configuration for master components.
func (o ClusterOutput) Master() MasterResponseOutput {
	return o.ApplyT(func(v *Cluster) MasterResponseOutput { return v.Master }).(MasterResponseOutput)
}
...
func (o ClusterOutput) MasterIpv4CidrBlock() pulumi.StringOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringOutput { return v.MasterIpv4CidrBlock }).(pulumi.StringOutput)
}
...
func (o ClusterOutput) PrivateCluster() pulumi.BoolOutput {
	return o.ApplyT(func(v *Cluster) pulumi.BoolOutput { return v.PrivateCluster }).(pulumi.BoolOutput)
}
...
func (o ClusterOutput) TpuConfig() TpuConfigResponseOutput {
	return o.ApplyT(func(v *Cluster) TpuConfigResponseOutput { return v.TpuConfig }).(TpuConfigResponseOutput)
}
...
func (o ClusterOutput) WorkloadAltsConfig() WorkloadALTSConfigResponseOutput {
	return o.ApplyT(func(v *Cluster) WorkloadALTSConfigResponseOutput { return v.WorkloadAltsConfig }).(WorkloadALTSConfigResponseOutput)
}

// Configuration for issuance of mTLS keys and certificates to Kubernetes pods.
func (o ClusterOutput) WorkloadCertificates() WorkloadCertificatesResponseOutput {
	return o.ApplyT(func(v *Cluster) WorkloadCertificatesResponseOutput { return v.WorkloadCertificates }).(WorkloadCertificatesResponseOutput)
}
