...
func NewClusterNodePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:container/v1beta1:ClusterNodePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterNodePool(ctx *pulumi.Context,
	...
	var resource ClusterNodePool
	err := ctx.ReadResource("google-cloud:container/v1beta1:ClusterNodePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
