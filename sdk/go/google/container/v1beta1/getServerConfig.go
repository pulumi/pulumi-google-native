...
type GetServerConfigResult struct {
	...
	WindowsVersionMaps WindowsVersionsResponse `pulumi:"windowsVersionMaps"`
}
...
// Maps of Kubernetes version and supported Windows server versions.
func (o GetServerConfigResultOutput) WindowsVersionMaps() WindowsVersionsResponseOutput {
	return o.ApplyT(func(v GetServerConfigResult) WindowsVersionsResponse { return v.WindowsVersionMaps }).(WindowsVersionsResponseOutput)
}
