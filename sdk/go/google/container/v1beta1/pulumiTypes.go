...
type ClusterTypeArgs struct {
	...
	// Telemetry integration for the cluster.
	ClusterTelemetry ClusterTelemetryPtrInput `pulumi:"clusterTelemetry"`
	// Which conditions caused the current cluster state.
	...
	// Configuration for master components.
	Master MasterPtrInput `pulumi:"master"`
	// The authentication information for accessing the master endpoint. If unspecified, the defaults are used: For clusters before v1.12, if master_auth is unspecified, `username` will be set to "admin", a random password will be generated, and a client certificate will be issued.
	...
	// The node pools associated with this cluster. This field should not be set if "node_config" or "initial_node_count" are specified.
	NodePools NodePoolArrayInput `pulumi:"nodePools"`
	// Notification configuration of the cluster.
	NotificationConfig NotificationConfigPtrInput `pulumi:"notificationConfig"`
	// Configuration for the PodSecurityPolicy feature.
	PodSecurityPolicyConfig PodSecurityPolicyConfigPtrInput `pulumi:"podSecurityPolicyConfig"`
	// If this is a private cluster setup. Private clusters are clusters that, by default have no external IP addresses on the nodes and where nodes and the master communicate over private IP addresses. This field is deprecated, use private_cluster_config.enable_private_nodes instead.
	PrivateCluster pulumi.BoolPtrInput `pulumi:"privateCluster"`
	// Configuration for private cluster.
	...
	// Configuration for Cloud TPU support;
	TpuConfig TpuConfigPtrInput `pulumi:"tpuConfig"`
	// [Output only] The IP address range of the Cloud TPUs in this cluster, in [CIDR](http://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) notation (e.g. `1.2.3.4/29`).
...
// Telemetry integration for the cluster.
func (o ClusterTypeOutput) ClusterTelemetry() ClusterTelemetryPtrOutput {
	return o.ApplyT(func(v ClusterType) *ClusterTelemetry { return v.ClusterTelemetry }).(ClusterTelemetryPtrOutput)
}
...
// Configuration of Confidential Nodes
func (o ClusterTypeOutput) ConfidentialNodes() ConfidentialNodesPtrOutput {
	return o.ApplyT(func(v ClusterType) *ConfidentialNodes { return v.ConfidentialNodes }).(ConfidentialNodesPtrOutput)
}
...
// Configuration for master components.
func (o ClusterTypeOutput) Master() MasterPtrOutput {
	return o.ApplyT(func(v ClusterType) *Master { return v.Master }).(MasterPtrOutput)
}
...
// The IP prefix in CIDR notation to use for the hosted master network. This prefix will be used for assigning private IP addresses to the master or set of masters, as well as the ILB VIP. This field is deprecated, use private_cluster_config.master_ipv4_cidr_block instead.
func (o ClusterTypeOutput) MasterIpv4CidrBlock() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ClusterType) *string { return v.MasterIpv4CidrBlock }).(pulumi.StringPtrOutput)
}
...
// The node pools associated with this cluster. This field should not be set if "node_config" or "initial_node_count" are specified.
func (o ClusterTypeOutput) NodePools() NodePoolArrayOutput {
	return o.ApplyT(func(v ClusterType) []NodePool { return v.NodePools }).(NodePoolArrayOutput)
}
...
// Configuration for the PodSecurityPolicy feature.
func (o ClusterTypeOutput) PodSecurityPolicyConfig() PodSecurityPolicyConfigPtrOutput {
	return o.ApplyT(func(v ClusterType) *PodSecurityPolicyConfig { return v.PodSecurityPolicyConfig }).(PodSecurityPolicyConfigPtrOutput)
}

// If this is a private cluster setup. Private clusters are clusters that, by default have no external IP addresses on the nodes and where nodes and the master communicate over private IP addresses. This field is deprecated, use private_cluster_config.enable_private_nodes instead.
func (o ClusterTypeOutput) PrivateCluster() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v ClusterType) *bool { return v.PrivateCluster }).(pulumi.BoolPtrOutput)
}
...
// Configuration for Cloud TPU support;
func (o ClusterTypeOutput) TpuConfig() TpuConfigPtrOutput {
	return o.ApplyT(func(v ClusterType) *TpuConfig { return v.TpuConfig }).(TpuConfigPtrOutput)
}
...
// Telemetry integration for the cluster.
func (o ClusterTypePtrOutput) ClusterTelemetry() ClusterTelemetryPtrOutput {
	return o.ApplyT(func(v *ClusterType) *ClusterTelemetry {
		if v == nil {
			return nil
		}
		return v.ClusterTelemetry
...
// Configuration of Confidential Nodes
func (o ClusterTypePtrOutput) ConfidentialNodes() ConfidentialNodesPtrOutput {
	return o.ApplyT(func(v *ClusterType) *ConfidentialNodes {
		if v == nil {
			return nil
		}
...
// Configuration for master components.
func (o ClusterTypePtrOutput) Master() MasterPtrOutput {
	return o.ApplyT(func(v *ClusterType) *Master {
		if v == nil {
			return nil
		}
		return v.Master
...
// The IP prefix in CIDR notation to use for the hosted master network. This prefix will be used for assigning private IP addresses to the master or set of masters, as well as the ILB VIP. This field is deprecated, use private_cluster_config.master_ipv4_cidr_block instead.
func (o ClusterTypePtrOutput) MasterIpv4CidrBlock() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ClusterType) *string {
		if v == nil {
			return nil
		}
...
// The node pools associated with this cluster. This field should not be set if "node_config" or "initial_node_count" are specified.
func (o ClusterTypePtrOutput) NodePools() NodePoolArrayOutput {
	return o.ApplyT(func(v *ClusterType) []NodePool {
		if v == nil {
			return nil
		}
		return v.NodePools
...
// Configuration for the PodSecurityPolicy feature.
func (o ClusterTypePtrOutput) PodSecurityPolicyConfig() PodSecurityPolicyConfigPtrOutput {
	return o.ApplyT(func(v *ClusterType) *PodSecurityPolicyConfig {
		if v == nil {
			return nil
		}
		return v.PodSecurityPolicyConfig
	}).(PodSecurityPolicyConfigPtrOutput)
}

// If this is a private cluster setup. Private clusters are clusters that, by default have no external IP addresses on the nodes and where nodes and the master communicate over private IP addresses. This field is deprecated, use private_cluster_config.enable_private_nodes instead.
func (o ClusterTypePtrOutput) PrivateCluster() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *ClusterType) *bool {
		if v == nil {
			return nil
		}
		return v.PrivateCluster
	}).(pulumi.BoolPtrOutput)
}
...
// Configuration for Cloud TPU support;
func (o ClusterTypePtrOutput) TpuConfig() TpuConfigPtrOutput {
	return o.ApplyT(func(v *ClusterType) *TpuConfig {
		if v == nil {
			return nil
		}
		return v.TpuConfig
...
func (o ClusterTelemetryPtrOutput) Elem() ClusterTelemetryOutput {
	return o.ApplyT(func(v *ClusterTelemetry) ClusterTelemetry { return *v }).(ClusterTelemetryOutput)
}
...
func (o EphemeralStorageConfigPtrOutput) Elem() EphemeralStorageConfigOutput {
	return o.ApplyT(func(v *EphemeralStorageConfig) EphemeralStorageConfig { return *v }).(EphemeralStorageConfigOutput)
}
...
func (o IstioConfigPtrOutput) Elem() IstioConfigOutput {
	return o.ApplyT(func(v *IstioConfig) IstioConfig { return *v }).(IstioConfigOutput)
}
...
func (o KalmConfigPtrOutput) Elem() KalmConfigOutput {
	return o.ApplyT(func(v *KalmConfig) KalmConfig { return *v }).(KalmConfigOutput)
}
...
func (o MasterPtrOutput) Elem() MasterOutput {
	return o.ApplyT(func(v *Master) Master { return *v }).(MasterOutput)
}
...
func (i NodePoolArgs) ToNodePoolPtrOutput() NodePoolPtrOutput {
	return i.ToNodePoolPtrOutputWithContext(context.Background())
}

func (i NodePoolArgs) ToNodePoolPtrOutputWithContext(ctx context.Context) NodePoolPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(NodePoolOutput).ToNodePoolPtrOutputWithContext(ctx)
}

// NodePoolPtrInput is an input type that accepts NodePoolArgs, NodePoolPtr and NodePoolPtrOutput values.
// You can construct a concrete instance of `NodePoolPtrInput` via:
//
//          NodePoolArgs{...}
//
//  or:
...
type NodePoolPtrInput interface {
	...
	ToNodePoolPtrOutputWithContext(context.Context) NodePoolPtrOutput
}

type nodePoolPtrType NodePoolArgs

func NodePoolPtr(v *NodePoolArgs) NodePoolPtrInput {
	return (*nodePoolPtrType)(v)
}
...
// Networking configuration for this NodePool. If specified, it overrides the cluster-level defaults.
func (o NodePoolOutput) NetworkConfig() NodeNetworkConfigPtrOutput {
	return o.ApplyT(func(v NodePool) *NodeNetworkConfig { return v.NetworkConfig }).(NodeNetworkConfigPtrOutput)
}
...
func (o NodePoolPtrOutput) Elem() NodePoolOutput {
	return o.ApplyT(func(v *NodePool) NodePool { return *v }).(NodePoolOutput)
}

// Autoscaler configuration for this NodePool. Autoscaler is enabled only if a valid configuration is present.
func (o NodePoolPtrOutput) Autoscaling() NodePoolAutoscalingPtrOutput {
	return o.ApplyT(func(v *NodePool) *NodePoolAutoscaling {
		if v == nil {
			return nil
		}
		return v.Autoscaling
...
// Which conditions caused the current node pool state.
func (o NodePoolPtrOutput) Conditions() StatusConditionArrayOutput {
	return o.ApplyT(func(v *NodePool) []StatusCondition {
		if v == nil {
			return nil
		}
		return v.Conditions
...
// The node configuration of the pool.
func (o NodePoolPtrOutput) Config() NodeConfigPtrOutput {
	return o.ApplyT(func(v *NodePool) *NodeConfig {
		if v == nil {
			return nil
		}
		return v.Config
...
// The initial node count for the pool. You must ensure that your Compute Engine [resource quota](https://cloud.google.com/compute/quotas) is sufficient for this number of instances. You must also have available firewall and routes quota.
func (o NodePoolPtrOutput) InitialNodeCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *NodePool) *int {
		if v == nil {
			return nil
		}
		return v.InitialNodeCount
...
// [Output only] The resource URLs of the [managed instance groups](https://cloud.google.com/compute/docs/instance-groups/creating-groups-of-managed-instances) associated with this node pool.
func (o NodePoolPtrOutput) InstanceGroupUrls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *NodePool) []string {
		if v == nil {
			return nil
		}
		return v.InstanceGroupUrls
...
// The list of Google Compute Engine [zones](https://cloud.google.com/compute/docs/zones#available) in which the NodePool's nodes should be located. If this value is unspecified during node pool creation, the [Cluster.Locations](https://cloud.google.com/kubernetes-engine/docs/reference/rest/v1/projects.locations.clusters#Cluster.FIELDS.locations) value will be used, instead. Warning: changing node pool locations will result in nodes being added and/or removed.
func (o NodePoolPtrOutput) Locations() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *NodePool) []string {
		if v == nil {
			return nil
		}
...
// NodeManagement configuration for this NodePool.
func (o NodePoolPtrOutput) Management() NodeManagementPtrOutput {
	return o.ApplyT(func(v *NodePool) *NodeManagement {
		if v == nil {
			return nil
		}
		return v.Management
...
// The constraint on the maximum number of pods that can be run simultaneously on a node in the node pool.
func (o NodePoolPtrOutput) MaxPodsConstraint() MaxPodsConstraintPtrOutput {
	return o.ApplyT(func(v *NodePool) *MaxPodsConstraint {
		if v == nil {
			return nil
		}
...
// The name of the node pool.
func (o NodePoolPtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NodePool) *string {
		if v == nil {
			return nil
		}
...
// Networking configuration for this NodePool. If specified, it overrides the cluster-level defaults.
func (o NodePoolPtrOutput) NetworkConfig() NodeNetworkConfigPtrOutput {
	return o.ApplyT(func(v *NodePool) *NodeNetworkConfig {
		if v == nil {
			return nil
		}
		return v.NetworkConfig
...
// [Output only] The pod CIDR block size per node in this node pool.
func (o NodePoolPtrOutput) PodIpv4CidrSize() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *NodePool) *int {
		if v == nil {
			return nil
		}
...
// [Output only] Server-defined URL for the resource.
func (o NodePoolPtrOutput) SelfLink() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NodePool) *string {
		if v == nil {
			return nil
		}
...
// [Output only] The status of the nodes in this pool instance.
func (o NodePoolPtrOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NodePool) *string {
		if v == nil {
			return nil
		}
...
// [Output only] Deprecated. Use conditions instead. Additional information about the current status of this node pool instance, if available.
func (o NodePoolPtrOutput) StatusMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NodePool) *string {
		if v == nil {
			return nil
		}
...
// Upgrade settings control disruption and speed of the upgrade.
func (o NodePoolPtrOutput) UpgradeSettings() UpgradeSettingsPtrOutput {
	return o.ApplyT(func(v *NodePool) *UpgradeSettings {
		if v == nil {
			return nil
		}
		return v.UpgradeSettings
...
// The version of the Kubernetes of this node.
func (o NodePoolPtrOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NodePool) *string {
		if v == nil {
			return nil
		}
...
func (o PodSecurityPolicyConfigPtrOutput) Elem() PodSecurityPolicyConfigOutput {
	return o.ApplyT(func(v *PodSecurityPolicyConfig) PodSecurityPolicyConfig { return *v }).(PodSecurityPolicyConfigOutput)
}
...
func (o TpuConfigPtrOutput) Elem() TpuConfigOutput {
	return o.ApplyT(func(v *TpuConfig) TpuConfig { return *v }).(TpuConfigOutput)
}
