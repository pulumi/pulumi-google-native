...
func LookupOccurrenceIamPolicy(ctx *pulumi.Context, args *LookupOccurrenceIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupOccurrenceIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:containeranalysis/v1:getOccurrenceIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupOccurrenceIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOccurrenceIamPolicyResult] {
	return pulumix.Output[LookupOccurrenceIamPolicyResult]{
