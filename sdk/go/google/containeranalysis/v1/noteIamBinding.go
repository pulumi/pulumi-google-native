...
func NewNoteIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:containeranalysis/v1:NoteIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNoteIamBinding(ctx *pulumi.Context,
	...
	var resource NoteIamBinding
	err := ctx.ReadResource("google-native:containeranalysis/v1:NoteIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
