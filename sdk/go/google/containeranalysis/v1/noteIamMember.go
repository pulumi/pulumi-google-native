...
func NewNoteIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:containeranalysis/v1:NoteIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNoteIamMember(ctx *pulumi.Context,
	...
	var resource NoteIamMember
	err := ctx.ReadResource("google-native:containeranalysis/v1:NoteIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
