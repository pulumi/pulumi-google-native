...
func NewNoteIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:containeranalysis/v1:NoteIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNoteIamPolicy(ctx *pulumi.Context,
	...
	var resource NoteIamPolicy
	err := ctx.ReadResource("google-native:containeranalysis/v1:NoteIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o NoteIamPolicyOutput) NoteId() pulumi.StringOutput {
	return o.ApplyT(func(v *NoteIamPolicy) pulumi.StringOutput { return v.NoteId }).(pulumi.StringOutput)
}
