...
func (o LookupNoteIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupNoteIamPolicyResult] {
	return pulumix.Output[LookupNoteIamPolicyResult]{
