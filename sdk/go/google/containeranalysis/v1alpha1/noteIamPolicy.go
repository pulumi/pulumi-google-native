...
func NewNoteIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:containeranalysis/v1alpha1:NoteIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNoteIamPolicy(ctx *pulumi.Context,
	...
	var resource NoteIamPolicy
	err := ctx.ReadResource("google-cloud:containeranalysis/v1alpha1:NoteIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
