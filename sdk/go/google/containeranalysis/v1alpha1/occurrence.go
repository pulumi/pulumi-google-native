...
func NewOccurrence(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:containeranalysis/v1alpha1:Occurrence", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOccurrence(ctx *pulumi.Context,
	...
	var resource Occurrence
	err := ctx.ReadResource("google-cloud:containeranalysis/v1alpha1:Occurrence", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
