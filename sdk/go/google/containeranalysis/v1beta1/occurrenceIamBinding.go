...
func NewOccurrenceIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:containeranalysis/v1beta1:OccurrenceIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOccurrenceIamBinding(ctx *pulumi.Context,
	...
	var resource OccurrenceIamBinding
	err := ctx.ReadResource("google-native:containeranalysis/v1beta1:OccurrenceIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
