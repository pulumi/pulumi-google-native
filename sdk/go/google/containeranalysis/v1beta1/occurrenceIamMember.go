...
func NewOccurrenceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:containeranalysis/v1beta1:OccurrenceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOccurrenceIamMember(ctx *pulumi.Context,
	...
	var resource OccurrenceIamMember
	err := ctx.ReadResource("google-native:containeranalysis/v1beta1:OccurrenceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
