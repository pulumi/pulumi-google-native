...
func LookupEntryGroupIamPolicy(ctx *pulumi.Context, args *LookupEntryGroupIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupEntryGroupIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:datacatalog/v1:getEntryGroupIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupEntryGroupIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupEntryGroupIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupEntryGroupIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupEntryGroupIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
