...
func NewTagTemplateIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datacatalog/v1:TagTemplateIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagTemplateIamBinding(ctx *pulumi.Context,
	...
	var resource TagTemplateIamBinding
	err := ctx.ReadResource("google-native:datacatalog/v1:TagTemplateIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
