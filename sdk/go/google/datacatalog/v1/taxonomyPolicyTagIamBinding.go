...
func NewTaxonomyPolicyTagIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datacatalog/v1:TaxonomyPolicyTagIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaxonomyPolicyTagIamBinding(ctx *pulumi.Context,
	...
	var resource TaxonomyPolicyTagIamBinding
	err := ctx.ReadResource("google-native:datacatalog/v1:TaxonomyPolicyTagIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
