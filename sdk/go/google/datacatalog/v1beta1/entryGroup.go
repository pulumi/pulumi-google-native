...
func NewEntryGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:datacatalog/v1beta1:EntryGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroup(ctx *pulumi.Context,
	...
	var resource EntryGroup
	err := ctx.ReadResource("google-cloud:datacatalog/v1beta1:EntryGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
