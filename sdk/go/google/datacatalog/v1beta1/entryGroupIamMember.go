...
func NewEntryGroupIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datacatalog/v1beta1:EntryGroupIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroupIamMember(ctx *pulumi.Context,
	...
	var resource EntryGroupIamMember
	err := ctx.ReadResource("google-native:datacatalog/v1beta1:EntryGroupIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
