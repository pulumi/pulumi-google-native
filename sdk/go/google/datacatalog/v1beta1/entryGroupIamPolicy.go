...
func NewEntryGroupIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datacatalog/v1beta1:EntryGroupIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroupIamPolicy(ctx *pulumi.Context,
	...
	var resource EntryGroupIamPolicy
	err := ctx.ReadResource("google-native:datacatalog/v1beta1:EntryGroupIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
