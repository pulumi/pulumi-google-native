...
func (in *googleCloudDatacatalogV1beta1FieldTypePrimitiveTypePtr) ToOutput(ctx context.Context) pulumix.Output[*GoogleCloudDatacatalogV1beta1FieldTypePrimitiveType] {
	return pulumix.Output[*GoogleCloudDatacatalogV1beta1FieldTypePrimitiveType]{
		OutputState: in.ToGoogleCloudDatacatalogV1beta1FieldTypePrimitiveTypePtrOutputWithContext(ctx).OutputState,
	}
}
