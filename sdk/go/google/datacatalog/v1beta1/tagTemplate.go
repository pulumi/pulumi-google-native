...
func NewTagTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:datacatalog/v1beta1:TagTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagTemplate(ctx *pulumi.Context,
	...
	var resource TagTemplate
	err := ctx.ReadResource("google-cloud:datacatalog/v1beta1:TagTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
