...
func NewTagTemplateIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datacatalog/v1beta1:TagTemplateIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagTemplateIamBinding(ctx *pulumi.Context,
	...
	var resource TagTemplateIamBinding
	err := ctx.ReadResource("google-native:datacatalog/v1beta1:TagTemplateIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o TagTemplateIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TagTemplateIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
func (o TagTemplateIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TagTemplateIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
