...
func NewTagTemplateIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datacatalog/v1beta1:TagTemplateIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagTemplateIamMember(ctx *pulumi.Context,
	...
	var resource TagTemplateIamMember
	err := ctx.ReadResource("google-native:datacatalog/v1beta1:TagTemplateIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
