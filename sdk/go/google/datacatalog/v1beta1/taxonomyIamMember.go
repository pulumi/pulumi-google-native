...
func NewTaxonomyIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datacatalog/v1beta1:TaxonomyIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaxonomyIamMember(ctx *pulumi.Context,
	...
	var resource TaxonomyIamMember
	err := ctx.ReadResource("google-native:datacatalog/v1beta1:TaxonomyIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
