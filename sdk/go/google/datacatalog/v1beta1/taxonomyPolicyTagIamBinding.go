...
func NewTaxonomyPolicyTagIamBinding(ctx *pulumi.Context,
	...
	var resource TaxonomyPolicyTagIamBinding
	err := ctx.RegisterResource("google-native:datacatalog/v1beta1:TaxonomyPolicyTagIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetTaxonomyPolicyTagIamBinding gets an existing TaxonomyPolicyTagIamBinding resource's state with the given name, ID, and optional
...
func GetTaxonomyPolicyTagIamBinding(ctx *pulumi.Context,
	...
	var resource TaxonomyPolicyTagIamBinding
	err := ctx.ReadResource("google-native:datacatalog/v1beta1:TaxonomyPolicyTagIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering TaxonomyPolicyTagIamBinding resources.
...
func (TaxonomyPolicyTagIamBindingState) ElementType() reflect.Type {
	return reflect.TypeOf((*taxonomyPolicyTagIamBindingState)(nil)).Elem()
}
...
func (TaxonomyPolicyTagIamBindingArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*taxonomyPolicyTagIamBindingArgs)(nil)).Elem()
}
...
func (*TaxonomyPolicyTagIamBinding) ElementType() reflect.Type {
	return reflect.TypeOf((**TaxonomyPolicyTagIamBinding)(nil)).Elem()
}

func (i *TaxonomyPolicyTagIamBinding) ToTaxonomyPolicyTagIamBindingOutput() TaxonomyPolicyTagIamBindingOutput {
	return i.ToTaxonomyPolicyTagIamBindingOutputWithContext(context.Background())
}
...
func (o TaxonomyPolicyTagIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TaxonomyPolicyTagIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}

// The etag of the resource's IAM policy.
func (o TaxonomyPolicyTagIamBindingOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v *TaxonomyPolicyTagIamBinding) pulumi.StringOutput { return v.Etag }).(pulumi.StringOutput)
}

// Specifies the principals requesting access for a Google Cloud resource. `members` can have the following values: * `allUsers`: A special identifier that represents anyone who is on the internet; with or without a Google account. * `allAuthenticatedUsers`: A special identifier that represents anyone who is authenticated with a Google account or a service account. Does not include identities that come from external identity providers (IdPs) through identity federation. * `user:{emailid}`: An email address that represents a specific Google account. For example, `alice@example.com` . * `serviceAccount:{emailid}`: An email address that represents a Google service account. For example, `my-other-app@appspot.gserviceaccount.com`. * `serviceAccount:{projectid}.svc.id.goog[{namespace}/{kubernetes-sa}]`: An identifier for a [Kubernetes service account](https://cloud.google.com/kubernetes-engine/docs/how-to/kubernetes-service-accounts). For example, `my-project.svc.id.goog[my-namespace/my-kubernetes-sa]`. * `group:{emailid}`: An email address that represents a Google group. For example, `admins@example.com`. * `domain:{domain}`: The G Suite domain (primary) that represents all the users of that domain. For example, `google.com` or `example.com`. * `deleted:user:{emailid}?uid={uniqueid}`: An email address (plus unique identifier) representing a user that has been recently deleted. For example, `alice@example.com?uid=123456789012345678901`. If the user is recovered, this value reverts to `user:{emailid}` and the recovered user retains the role in the binding. * `deleted:serviceAccount:{emailid}?uid={uniqueid}`: An email address (plus unique identifier) representing a service account that has been recently deleted. For example, `my-other-app@appspot.gserviceaccount.com?uid=123456789012345678901`. If the service account is undeleted, this value reverts to `serviceAccount:{emailid}` and the undeleted service account retains the role in the binding. * `deleted:group:{emailid}?uid={uniqueid}`: An email address (plus unique identifier) representing a Google group that has been recently deleted. For example, `admins@example.com?uid=123456789012345678901`. If the group is recovered, this value reverts to `group:{emailid}` and the recovered group retains the role in the binding.
func (o TaxonomyPolicyTagIamBindingOutput) Members() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *TaxonomyPolicyTagIamBinding) pulumi.StringArrayOutput { return v.Members }).(pulumi.StringArrayOutput)
}

// The name of the resource to manage IAM policies for.
func (o TaxonomyPolicyTagIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TaxonomyPolicyTagIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}

// The project in which the resource belongs. If it is not provided, a default will be supplied.
func (o TaxonomyPolicyTagIamBindingOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *TaxonomyPolicyTagIamBinding) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}

// Role that is assigned to the list of `members`, or principals. For example, `roles/viewer`, `roles/editor`, or `roles/owner`.
func (o TaxonomyPolicyTagIamBindingOutput) Role() pulumi.StringOutput {
	return o.ApplyT(func(v *TaxonomyPolicyTagIamBinding) pulumi.StringOutput { return v.Role }).(pulumi.StringOutput)
}

func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*TaxonomyPolicyTagIamBindingInput)(nil)).Elem(), &TaxonomyPolicyTagIamBinding{})
	pulumi.RegisterOutputType(TaxonomyPolicyTagIamBindingOutput{})
}
