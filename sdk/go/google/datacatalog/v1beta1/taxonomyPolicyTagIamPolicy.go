...
func NewTaxonomyPolicyTagIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datacatalog/v1beta1:TaxonomyPolicyTagIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTaxonomyPolicyTagIamPolicy(ctx *pulumi.Context,
	...
	var resource TaxonomyPolicyTagIamPolicy
	err := ctx.ReadResource("google-native:datacatalog/v1beta1:TaxonomyPolicyTagIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
