...
func NewTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dataflow/v1b3:Template", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTemplate(ctx *pulumi.Context,
	...
	var resource Template
	err := ctx.ReadResource("google-cloud:dataflow/v1b3:Template", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
