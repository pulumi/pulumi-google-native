...
// CommitAuthorInput is an input type that accepts CommitAuthorArgs and CommitAuthorOutput values.
// You can construct a concrete instance of `CommitAuthorInput` via:
//
//	CommitAuthorArgs{...}
type CommitAuthorInput interface {
	pulumi.Input

	ToCommitAuthorOutput() CommitAuthorOutput
	ToCommitAuthorOutputWithContext(context.Context) CommitAuthorOutput
}

// Represents the author of a Git commit.
type CommitAuthorArgs struct {
	// The commit author's email address.
...
func (CommitAuthorArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*CommitAuthor)(nil)).Elem()
}

func (i CommitAuthorArgs) ToCommitAuthorOutput() CommitAuthorOutput {
	return i.ToCommitAuthorOutputWithContext(context.Background())
}

func (i CommitAuthorArgs) ToCommitAuthorOutputWithContext(ctx context.Context) CommitAuthorOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CommitAuthorOutput)
}

func (i CommitAuthorArgs) ToCommitAuthorPtrOutput() CommitAuthorPtrOutput {
	return i.ToCommitAuthorPtrOutputWithContext(context.Background())
}

func (i CommitAuthorArgs) ToCommitAuthorPtrOutputWithContext(ctx context.Context) CommitAuthorPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CommitAuthorOutput).ToCommitAuthorPtrOutputWithContext(ctx)
}

// CommitAuthorPtrInput is an input type that accepts CommitAuthorArgs, CommitAuthorPtr and CommitAuthorPtrOutput values.
// You can construct a concrete instance of `CommitAuthorPtrInput` via:
//
//	        CommitAuthorArgs{...}
//
//	or:
//
//	        nil
type CommitAuthorPtrInput interface {
	pulumi.Input

	ToCommitAuthorPtrOutput() CommitAuthorPtrOutput
	ToCommitAuthorPtrOutputWithContext(context.Context) CommitAuthorPtrOutput
}

type commitAuthorPtrType CommitAuthorArgs

func CommitAuthorPtr(v *CommitAuthorArgs) CommitAuthorPtrInput {
	return (*commitAuthorPtrType)(v)
}

func (*commitAuthorPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**CommitAuthor)(nil)).Elem()
}

func (i *commitAuthorPtrType) ToCommitAuthorPtrOutput() CommitAuthorPtrOutput {
	return i.ToCommitAuthorPtrOutputWithContext(context.Background())
}

func (i *commitAuthorPtrType) ToCommitAuthorPtrOutputWithContext(ctx context.Context) CommitAuthorPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CommitAuthorPtrOutput)
}

// Represents the author of a Git commit.
type CommitAuthorOutput struct{ *pulumi.OutputState }

func (CommitAuthorOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CommitAuthor)(nil)).Elem()
}

func (o CommitAuthorOutput) ToCommitAuthorOutput() CommitAuthorOutput {
	return o
}

func (o CommitAuthorOutput) ToCommitAuthorOutputWithContext(ctx context.Context) CommitAuthorOutput {
	return o
}

func (o CommitAuthorOutput) ToCommitAuthorPtrOutput() CommitAuthorPtrOutput {
	return o.ToCommitAuthorPtrOutputWithContext(context.Background())
}

func (o CommitAuthorOutput) ToCommitAuthorPtrOutputWithContext(ctx context.Context) CommitAuthorPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v CommitAuthor) *CommitAuthor {
		return &v
	}).(CommitAuthorPtrOutput)
}

// The commit author's email address.
func (o CommitAuthorOutput) EmailAddress() pulumi.StringOutput {
	return o.ApplyT(func(v CommitAuthor) string { return v.EmailAddress }).(pulumi.StringOutput)
}

// The commit author's name.
func (o CommitAuthorOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v CommitAuthor) string { return v.Name }).(pulumi.StringOutput)
}

type CommitAuthorPtrOutput struct{ *pulumi.OutputState }

func (CommitAuthorPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**CommitAuthor)(nil)).Elem()
}

func (o CommitAuthorPtrOutput) ToCommitAuthorPtrOutput() CommitAuthorPtrOutput {
	return o
}

func (o CommitAuthorPtrOutput) ToCommitAuthorPtrOutputWithContext(ctx context.Context) CommitAuthorPtrOutput {
	return o
}

func (o CommitAuthorPtrOutput) Elem() CommitAuthorOutput {
	return o.ApplyT(func(v *CommitAuthor) CommitAuthor {
		if v != nil {
			return *v
		}
...
// The commit author's email address.
func (o CommitAuthorPtrOutput) EmailAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CommitAuthor) *string {
		if v == nil {
			return nil
		}
...
// The commit author's name.
func (o CommitAuthorPtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CommitAuthor) *string {
		if v == nil {
			return nil
		}
...
// Represents the author of a Git commit.
type CommitAuthorResponseOutput struct{ *pulumi.OutputState }

func (CommitAuthorResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CommitAuthorResponse)(nil)).Elem()
}

func (o CommitAuthorResponseOutput) ToCommitAuthorResponseOutput() CommitAuthorResponseOutput {
	return o
}

func (o CommitAuthorResponseOutput) ToCommitAuthorResponseOutputWithContext(ctx context.Context) CommitAuthorResponseOutput {
	return o
}

// The commit author's email address.
func (o CommitAuthorResponseOutput) EmailAddress() pulumi.StringOutput {
	return o.ApplyT(func(v CommitAuthorResponse) string { return v.EmailAddress }).(pulumi.StringOutput)
}

// The commit author's name.
func (o CommitAuthorResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v CommitAuthorResponse) string { return v.Name }).(pulumi.StringOutput)
}

// Represents a Dataform Git commit.
type CommitMetadata struct {
	// The commit's author.
	Author CommitAuthor `pulumi:"author"`
	// Optional. The commit's message.
	CommitMessage *string `pulumi:"commitMessage"`
}

// CommitMetadataInput is an input type that accepts CommitMetadataArgs and CommitMetadataOutput values.
// You can construct a concrete instance of `CommitMetadataInput` via:
//
//	CommitMetadataArgs{...}
type CommitMetadataInput interface {
	pulumi.Input

	ToCommitMetadataOutput() CommitMetadataOutput
	ToCommitMetadataOutputWithContext(context.Context) CommitMetadataOutput
}

// Represents a Dataform Git commit.
type CommitMetadataArgs struct {
	// The commit's author.
	Author CommitAuthorInput `pulumi:"author"`
	// Optional. The commit's message.
	CommitMessage pulumi.StringPtrInput `pulumi:"commitMessage"`
}

func (CommitMetadataArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*CommitMetadata)(nil)).Elem()
}

func (i CommitMetadataArgs) ToCommitMetadataOutput() CommitMetadataOutput {
	return i.ToCommitMetadataOutputWithContext(context.Background())
}

func (i CommitMetadataArgs) ToCommitMetadataOutputWithContext(ctx context.Context) CommitMetadataOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CommitMetadataOutput)
}

func (i CommitMetadataArgs) ToCommitMetadataPtrOutput() CommitMetadataPtrOutput {
	return i.ToCommitMetadataPtrOutputWithContext(context.Background())
}

func (i CommitMetadataArgs) ToCommitMetadataPtrOutputWithContext(ctx context.Context) CommitMetadataPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CommitMetadataOutput).ToCommitMetadataPtrOutputWithContext(ctx)
}

// CommitMetadataPtrInput is an input type that accepts CommitMetadataArgs, CommitMetadataPtr and CommitMetadataPtrOutput values.
// You can construct a concrete instance of `CommitMetadataPtrInput` via:
//
//	        CommitMetadataArgs{...}
//
//	or:
//
//	        nil
type CommitMetadataPtrInput interface {
	pulumi.Input

	ToCommitMetadataPtrOutput() CommitMetadataPtrOutput
	ToCommitMetadataPtrOutputWithContext(context.Context) CommitMetadataPtrOutput
}

type commitMetadataPtrType CommitMetadataArgs

func CommitMetadataPtr(v *CommitMetadataArgs) CommitMetadataPtrInput {
	return (*commitMetadataPtrType)(v)
}

func (*commitMetadataPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**CommitMetadata)(nil)).Elem()
}

func (i *commitMetadataPtrType) ToCommitMetadataPtrOutput() CommitMetadataPtrOutput {
	return i.ToCommitMetadataPtrOutputWithContext(context.Background())
}

func (i *commitMetadataPtrType) ToCommitMetadataPtrOutputWithContext(ctx context.Context) CommitMetadataPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CommitMetadataPtrOutput)
}

// Represents a Dataform Git commit.
type CommitMetadataOutput struct{ *pulumi.OutputState }

func (CommitMetadataOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CommitMetadata)(nil)).Elem()
}

func (o CommitMetadataOutput) ToCommitMetadataOutput() CommitMetadataOutput {
	return o
}

func (o CommitMetadataOutput) ToCommitMetadataOutputWithContext(ctx context.Context) CommitMetadataOutput {
	return o
}

func (o CommitMetadataOutput) ToCommitMetadataPtrOutput() CommitMetadataPtrOutput {
	return o.ToCommitMetadataPtrOutputWithContext(context.Background())
}

func (o CommitMetadataOutput) ToCommitMetadataPtrOutputWithContext(ctx context.Context) CommitMetadataPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v CommitMetadata) *CommitMetadata {
		return &v
	}).(CommitMetadataPtrOutput)
}

// The commit's author.
func (o CommitMetadataOutput) Author() CommitAuthorOutput {
	return o.ApplyT(func(v CommitMetadata) CommitAuthor { return v.Author }).(CommitAuthorOutput)
}

// Optional. The commit's message.
func (o CommitMetadataOutput) CommitMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CommitMetadata) *string { return v.CommitMessage }).(pulumi.StringPtrOutput)
}

type CommitMetadataPtrOutput struct{ *pulumi.OutputState }

func (CommitMetadataPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**CommitMetadata)(nil)).Elem()
}

func (o CommitMetadataPtrOutput) ToCommitMetadataPtrOutput() CommitMetadataPtrOutput {
	return o
}

func (o CommitMetadataPtrOutput) ToCommitMetadataPtrOutputWithContext(ctx context.Context) CommitMetadataPtrOutput {
	return o
}

func (o CommitMetadataPtrOutput) Elem() CommitMetadataOutput {
	return o.ApplyT(func(v *CommitMetadata) CommitMetadata {
		if v != nil {
			return *v
		}
		var ret CommitMetadata
		return ret
	}).(CommitMetadataOutput)
}

// The commit's author.
func (o CommitMetadataPtrOutput) Author() CommitAuthorPtrOutput {
	return o.ApplyT(func(v *CommitMetadata) *CommitAuthor {
		if v == nil {
			return nil
		}
		return &v.Author
...
// Optional. The commit's message.
func (o CommitMetadataPtrOutput) CommitMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CommitMetadata) *string {
		if v == nil {
			return nil
		}
...
// Represents a Dataform Git commit.
type CommitMetadataResponse struct {
	// The commit's author.
	Author CommitAuthorResponse `pulumi:"author"`
	// Optional. The commit's message.
	CommitMessage string `pulumi:"commitMessage"`
}

// Represents a Dataform Git commit.
type CommitMetadataResponseOutput struct{ *pulumi.OutputState }

func (CommitMetadataResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*CommitMetadataResponse)(nil)).Elem()
}

func (o CommitMetadataResponseOutput) ToCommitMetadataResponseOutput() CommitMetadataResponseOutput {
	return o
}

func (o CommitMetadataResponseOutput) ToCommitMetadataResponseOutputWithContext(ctx context.Context) CommitMetadataResponseOutput {
	return o
}

// The commit's author.
func (o CommitMetadataResponseOutput) Author() CommitAuthorResponseOutput {
	return o.ApplyT(func(v CommitMetadataResponse) CommitAuthorResponse { return v.Author }).(CommitAuthorResponseOutput)
}

// Optional. The commit's message.
func (o CommitMetadataResponseOutput) CommitMessage() pulumi.StringOutput {
	return o.ApplyT(func(v CommitMetadataResponse) string { return v.CommitMessage }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CommitAuthorInput)(nil)).Elem(), CommitAuthorArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CommitAuthorPtrInput)(nil)).Elem(), CommitAuthorArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CommitMetadataInput)(nil)).Elem(), CommitMetadataArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CommitMetadataPtrInput)(nil)).Elem(), CommitMetadataArgs{})
	...
	pulumi.RegisterOutputType(CommitAuthorOutput{})
	pulumi.RegisterOutputType(CommitAuthorPtrOutput{})
	pulumi.RegisterOutputType(CommitAuthorResponseOutput{})
	pulumi.RegisterOutputType(CommitMetadataOutput{})
	pulumi.RegisterOutputType(CommitMetadataPtrOutput{})
	pulumi.RegisterOutputType(CommitMetadataResponseOutput{})
