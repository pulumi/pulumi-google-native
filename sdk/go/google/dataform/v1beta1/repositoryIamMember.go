...
func NewRepositoryIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataform/v1beta1:RepositoryIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepositoryIamMember(ctx *pulumi.Context,
	...
	var resource RepositoryIamMember
	err := ctx.ReadResource("google-native:dataform/v1beta1:RepositoryIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
