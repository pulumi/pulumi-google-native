...
func NewRepositoryIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataform/v1beta1:RepositoryIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepositoryIamPolicy(ctx *pulumi.Context,
	...
	var resource RepositoryIamPolicy
	err := ctx.ReadResource("google-native:dataform/v1beta1:RepositoryIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
