...
func NewInstanceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datafusion/v1beta1:InstanceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceIamPolicy
	err := ctx.ReadResource("google-native:datafusion/v1beta1:InstanceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies cloud audit logging configuration for this policy.
func (o InstanceIamPolicyOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v *InstanceIamPolicy) AuditConfigResponseArrayOutput { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}
