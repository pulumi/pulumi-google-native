...
func (o NetworkConfigConnectionTypeOutput) ToOutput(ctx context.Context) pulumix.Output[NetworkConfigConnectionType] {
...
func (o NetworkConfigConnectionTypePtrOutput) ToOutput(ctx context.Context) pulumix.Output[*NetworkConfigConnectionType] {
	return pulumix.Output[*NetworkConfigConnectionType]{
		OutputState: o.OutputState,
	}
}
