...
func NewDatasetAnnotatedDatasetFeedbackThreadFeedbackMessage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:datalabeling/v1beta1:DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetAnnotatedDatasetFeedbackThreadFeedbackMessage(ctx *pulumi.Context,
	...
	var resource DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage
	err := ctx.ReadResource("google-cloud:datalabeling/v1beta1:DatasetAnnotatedDatasetFeedbackThreadFeedbackMessage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
