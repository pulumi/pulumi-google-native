...
func NewConnectionProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:datamigration/v1:ConnectionProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionProfile(ctx *pulumi.Context,
	...
	var resource ConnectionProfile
	err := ctx.ReadResource("google-cloud:datamigration/v1:ConnectionProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
