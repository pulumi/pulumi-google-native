...
// Required. The IP or hostname of the source PostgreSQL database.
func (o PostgreSqlConnectionProfileOutput) Host() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PostgreSqlConnectionProfile) *string { return v.Host }).(pulumi.StringPtrOutput)
}

// Required. Input only. The password for the user that Database Migration Service will be using to connect to the database. This field is not returned on request, and the value is encrypted when stored in Database Migration Service.
func (o PostgreSqlConnectionProfileOutput) Password() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PostgreSqlConnectionProfile) *string { return v.Password }).(pulumi.StringPtrOutput)
}

// Output only. Indicates If this connection profile password is stored.
func (o PostgreSqlConnectionProfileOutput) PasswordSet() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v PostgreSqlConnectionProfile) *bool { return v.PasswordSet }).(pulumi.BoolPtrOutput)
}

// Required. The network port of the source PostgreSQL database.
func (o PostgreSqlConnectionProfileOutput) Port() pulumi.IntPtrOutput {
	return o.ApplyT(func(v PostgreSqlConnectionProfile) *int { return v.Port }).(pulumi.IntPtrOutput)
}
...
// Required. The username that Database Migration Service will use to connect to the database. The value is encrypted when stored in Database Migration Service.
func (o PostgreSqlConnectionProfileOutput) Username() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PostgreSqlConnectionProfile) *string { return v.Username }).(pulumi.StringPtrOutput)
}
...
// Output only. Indicates If this connection profile password is stored.
func (o PostgreSqlConnectionProfilePtrOutput) PasswordSet() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *PostgreSqlConnectionProfile) *bool {
		if v == nil {
			return nil
		}
		return v.PasswordSet
