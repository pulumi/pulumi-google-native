...
func NewConnectionProfileIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:datamigration/v1beta1:ConnectionProfileIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionProfileIamPolicy(ctx *pulumi.Context,
	...
	var resource ConnectionProfileIamPolicy
	err := ctx.ReadResource("google-cloud:datamigration/v1beta1:ConnectionProfileIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
