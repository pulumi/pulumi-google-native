...
func NewConnectionProfileIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datamigration/v1beta1:ConnectionProfileIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionProfileIamPolicy(ctx *pulumi.Context,
	...
	var resource ConnectionProfileIamPolicy
	err := ctx.ReadResource("google-native:datamigration/v1beta1:ConnectionProfileIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
