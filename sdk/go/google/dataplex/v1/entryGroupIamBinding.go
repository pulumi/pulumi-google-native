...
func NewEntryGroupIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataplex/v1:EntryGroupIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroupIamBinding(ctx *pulumi.Context,
	...
	var resource EntryGroupIamBinding
	err := ctx.ReadResource("google-native:dataplex/v1:EntryGroupIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
