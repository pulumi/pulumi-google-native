...
func (i *EntryTypeIamBinding) ToOutput(ctx context.Context) pulumix.Output[*EntryTypeIamBinding] {
	return pulumix.Output[*EntryTypeIamBinding]{
		OutputState: i.ToEntryTypeIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o EntryTypeIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*EntryTypeIamBinding] {
	return pulumix.Output[*EntryTypeIamBinding]{
