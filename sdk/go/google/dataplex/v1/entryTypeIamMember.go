...
func NewEntryTypeIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataplex/v1:EntryTypeIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryTypeIamMember(ctx *pulumi.Context,
	...
	var resource EntryTypeIamMember
	err := ctx.ReadResource("google-native:dataplex/v1:EntryTypeIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *EntryTypeIamMember) ToOutput(ctx context.Context) pulumix.Output[*EntryTypeIamMember] {
	return pulumix.Output[*EntryTypeIamMember]{
		OutputState: i.ToEntryTypeIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o EntryTypeIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*EntryTypeIamMember] {
	return pulumix.Output[*EntryTypeIamMember]{
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o EntryTypeIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *EntryTypeIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o EntryTypeIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *EntryTypeIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
