...
func (i *EntryTypeIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*EntryTypeIamPolicy] {
	return pulumix.Output[*EntryTypeIamPolicy]{
		OutputState: i.ToEntryTypeIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o EntryTypeIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*EntryTypeIamPolicy] {
	return pulumix.Output[*EntryTypeIamPolicy]{
