...
func (o LookupLakeAssetIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLakeAssetIamPolicyResult] {
	return pulumix.Output[LookupLakeAssetIamPolicyResult]{
