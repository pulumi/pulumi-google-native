...
func LookupLakeIamPolicy(ctx *pulumi.Context, args *LookupLakeIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupLakeIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:dataplex/v1:getLakeIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupLakeIamPolicyResultOutput) Bindings() GoogleIamV1BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupLakeIamPolicyResult) []GoogleIamV1BindingResponse { return v.Bindings }).(GoogleIamV1BindingResponseArrayOutput)
}
...
func (o LookupLakeIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupLakeIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
