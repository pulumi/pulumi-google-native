...
func (o LookupLakeTaskIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLakeTaskIamPolicyResult] {
	return pulumix.Output[LookupLakeTaskIamPolicyResult]{
