...
func NewAutoscalingPolicyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataproc/v1:AutoscalingPolicyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoscalingPolicyIamBinding(ctx *pulumi.Context,
	...
	var resource AutoscalingPolicyIamBinding
	err := ctx.ReadResource("google-native:dataproc/v1:AutoscalingPolicyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
