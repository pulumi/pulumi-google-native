...
func NewAutoscalingPolicyIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataproc/v1:AutoscalingPolicyIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoscalingPolicyIamMember(ctx *pulumi.Context,
	...
	var resource AutoscalingPolicyIamMember
	err := ctx.ReadResource("google-native:dataproc/v1:AutoscalingPolicyIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
