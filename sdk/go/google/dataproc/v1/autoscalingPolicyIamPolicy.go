...
func NewAutoscalingPolicyIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataproc/v1:AutoscalingPolicyIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAutoscalingPolicyIamPolicy(ctx *pulumi.Context,
	...
	var resource AutoscalingPolicyIamPolicy
	err := ctx.ReadResource("google-native:dataproc/v1:AutoscalingPolicyIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
