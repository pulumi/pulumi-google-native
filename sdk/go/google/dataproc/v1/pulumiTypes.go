...
type AuxiliaryNodeGroup struct {
	...
	NodeGroup NodeGroup `pulumi:"nodeGroup"`
...
type AuxiliaryNodeGroupArgs struct {
	// Node group configuration.
	NodeGroup NodeGroupInput `pulumi:"nodeGroup"`
	// Optional. A node group ID. Generated if not specified.The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot begin or end with underscore or hyphen. Must consist of from 3 to 33 characters.
...
// Node group configuration.
func (o AuxiliaryNodeGroupOutput) NodeGroup() NodeGroupOutput {
	return o.ApplyT(func(v AuxiliaryNodeGroup) NodeGroup { return v.NodeGroup }).(NodeGroupOutput)
}
...
// NodeGroupInput is an input type that accepts NodeGroupArgs and NodeGroupOutput values.
// You can construct a concrete instance of `NodeGroupInput` via:
//
//	NodeGroupArgs{...}
type NodeGroupInput interface {
	...
	ToNodeGroupOutputWithContext(context.Context) NodeGroupOutput
}
...
func (i NodeGroupArgs) ToNodeGroupOutput() NodeGroupOutput {
	return i.ToNodeGroupOutputWithContext(context.Background())
}

func (i NodeGroupArgs) ToNodeGroupOutputWithContext(ctx context.Context) NodeGroupOutput {
...
func (o NodeGroupOutput) Labels() pulumi.StringMapOutput {
	return o.ApplyT(func(v NodeGroup) map[string]string { return v.Labels }).(pulumi.StringMapOutput)
}

// The Node group resource name (https://aip.dev/122).
func (o NodeGroupOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NodeGroup) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Optional. The node group instance group configuration.
func (o NodeGroupOutput) NodeGroupConfig() InstanceGroupConfigPtrOutput {
	return o.ApplyT(func(v NodeGroup) *InstanceGroupConfig { return v.NodeGroupConfig }).(InstanceGroupConfigPtrOutput)
}

// Node group roles.
func (o NodeGroupOutput) Roles() NodeGroupRolesItemArrayOutput {
	return o.ApplyT(func(v NodeGroup) []NodeGroupRolesItem { return v.Roles }).(NodeGroupRolesItemArrayOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*NodeGroupInput)(nil)).Elem(), NodeGroupArgs{})
