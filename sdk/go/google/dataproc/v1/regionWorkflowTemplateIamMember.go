...
func NewRegionWorkflowTemplateIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataproc/v1:RegionWorkflowTemplateIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionWorkflowTemplateIamMember(ctx *pulumi.Context,
	...
	var resource RegionWorkflowTemplateIamMember
	err := ctx.ReadResource("google-native:dataproc/v1:RegionWorkflowTemplateIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *RegionWorkflowTemplateIamMember) ToOutput(ctx context.Context) pulumix.Output[*RegionWorkflowTemplateIamMember] {
	return pulumix.Output[*RegionWorkflowTemplateIamMember]{
		OutputState: i.ToRegionWorkflowTemplateIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o RegionWorkflowTemplateIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*RegionWorkflowTemplateIamMember] {
	return pulumix.Output[*RegionWorkflowTemplateIamMember]{
