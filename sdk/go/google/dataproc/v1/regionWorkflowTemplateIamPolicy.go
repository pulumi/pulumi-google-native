...
func NewRegionWorkflowTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dataproc/v1:RegionWorkflowTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegionWorkflowTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource RegionWorkflowTemplateIamPolicy
	err := ctx.ReadResource("google-cloud:dataproc/v1:RegionWorkflowTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
