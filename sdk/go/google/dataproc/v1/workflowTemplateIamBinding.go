...
func NewWorkflowTemplateIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dataproc/v1:WorkflowTemplateIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflowTemplateIamBinding(ctx *pulumi.Context,
	...
	var resource WorkflowTemplateIamBinding
	err := ctx.ReadResource("google-native:dataproc/v1:WorkflowTemplateIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
