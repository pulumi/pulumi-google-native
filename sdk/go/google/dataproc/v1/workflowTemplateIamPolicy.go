...
func NewWorkflowTemplateIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dataproc/v1:WorkflowTemplateIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflowTemplateIamPolicy(ctx *pulumi.Context,
	...
	var resource WorkflowTemplateIamPolicy
	err := ctx.ReadResource("google-cloud:dataproc/v1:WorkflowTemplateIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
