...
func LookupAutoscalingPolicyIamPolicy(ctx *pulumi.Context, args *LookupAutoscalingPolicyIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupAutoscalingPolicyIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:dataproc/v1beta2:getAutoscalingPolicyIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupAutoscalingPolicyIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupAutoscalingPolicyIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupAutoscalingPolicyIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupAutoscalingPolicyIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
