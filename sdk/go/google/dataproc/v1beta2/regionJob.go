...
// NewRegionJob registers a new resource with the given unique name, arguments, and options.
func NewRegionJob(ctx *pulumi.Context,
	name string, args *RegionJobArgs, opts ...pulumi.ResourceOption) (*RegionJob, error) {
	if args == nil {
	...
	var resource RegionJob
	err := ctx.RegisterResource("google-native:dataproc/v1beta2:RegionJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetRegionJob gets an existing RegionJob resource's state with the given name, ID, and optional
// state properties that are used to uniquely qualify the lookup (nil if not required).
func GetRegionJob(ctx *pulumi.Context,
	name string, id pulumi.IDInput, state *RegionJobState, opts ...pulumi.ResourceOption) (*RegionJob, error) {
	var resource RegionJob
	err := ctx.ReadResource("google-native:dataproc/v1beta2:RegionJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering RegionJob resources.
type regionJobState struct {
	// Indicates whether the job is completed. If the value is false, the job is still in progress. If true, the job is completed, and status.state field will indicate if it was successful, failed, or cancelled.
...
func (RegionJobState) ElementType() reflect.Type {
	return reflect.TypeOf((*regionJobState)(nil)).Elem()
}

type regionJobArgs struct {
	// Optional. Job is a Hadoop job.
...
func (RegionJobArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*regionJobArgs)(nil)).Elem()
}

type RegionJobInput interface {
	pulumi.Input

	ToRegionJobOutput() RegionJobOutput
	ToRegionJobOutputWithContext(ctx context.Context) RegionJobOutput
}

func (*RegionJob) ElementType() reflect.Type {
	return reflect.TypeOf((*RegionJob)(nil))
}

func (i *RegionJob) ToRegionJobOutput() RegionJobOutput {
	return i.ToRegionJobOutputWithContext(context.Background())
}

func (i *RegionJob) ToRegionJobOutputWithContext(ctx context.Context) RegionJobOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RegionJobOutput)
}

type RegionJobOutput struct {
	*pulumi.OutputState
}

func (RegionJobOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RegionJob)(nil))
}

func (o RegionJobOutput) ToRegionJobOutput() RegionJobOutput {
	return o
}

func (o RegionJobOutput) ToRegionJobOutputWithContext(ctx context.Context) RegionJobOutput {
	return o
}

func init() {
	pulumi.RegisterOutputType(RegionJobOutput{})
}
