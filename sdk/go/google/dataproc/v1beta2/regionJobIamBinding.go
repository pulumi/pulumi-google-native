...
func (i *RegionJobIamBinding) ToOutput(ctx context.Context) pulumix.Output[*RegionJobIamBinding] {
	return pulumix.Output[*RegionJobIamBinding]{
		OutputState: i.ToRegionJobIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o RegionJobIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*RegionJobIamBinding] {
	return pulumix.Output[*RegionJobIamBinding]{
