...
func (i *WorkflowTemplateIamBinding) ToOutput(ctx context.Context) pulumix.Output[*WorkflowTemplateIamBinding] {
	return pulumix.Output[*WorkflowTemplateIamBinding]{
		OutputState: i.ToWorkflowTemplateIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o WorkflowTemplateIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*WorkflowTemplateIamBinding] {
	return pulumix.Output[*WorkflowTemplateIamBinding]{
