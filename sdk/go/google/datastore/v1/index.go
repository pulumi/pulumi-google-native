...
func NewIndex(ctx *pulumi.Context,
	...
	var resource Index
	err := ctx.RegisterResource("google-cloud:datastore/v1:Index", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIndex(ctx *pulumi.Context,
	...
	var resource Index
	err := ctx.ReadResource("google-cloud:datastore/v1:Index", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
