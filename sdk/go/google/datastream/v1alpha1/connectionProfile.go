...
func NewConnectionProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:datastream/v1alpha1:ConnectionProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectionProfile(ctx *pulumi.Context,
	...
	var resource ConnectionProfile
	err := ctx.ReadResource("google-native:datastream/v1alpha1:ConnectionProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type connectionProfileArgs struct {
	...
	// No connectivity option chosen.
	NoConnectivity *NoConnectivitySettings `pulumi:"noConnectivity"`
	// Oracle ConnectionProfile configuration.
