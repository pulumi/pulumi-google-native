...
func (o GcsDestinationConfigGcsFileFormatOutput) ToOutput(ctx context.Context) pulumix.Output[GcsDestinationConfigGcsFileFormat] {
...
func (o GcsDestinationConfigGcsFileFormatPtrOutput) ToOutput(ctx context.Context) pulumix.Output[*GcsDestinationConfigGcsFileFormat] {
	return pulumix.Output[*GcsDestinationConfigGcsFileFormat]{
		OutputState: o.OutputState,
	}
}
