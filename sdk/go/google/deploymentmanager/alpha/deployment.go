...
func NewDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:deploymentmanager/alpha:Deployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeployment(ctx *pulumi.Context,
	...
	var resource Deployment
	err := ctx.ReadResource("google-cloud:deploymentmanager/alpha:Deployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type DeploymentState struct {
	...
	// List of outputs from the last manifest that deployed successfully.
	Outputs DeploymentOutputEntryResponseArrayInput
	// Server defined URL for the resource.
