...
func NewDeploymentIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:deploymentmanager/alpha:DeploymentIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentIamPolicy(ctx *pulumi.Context,
	...
	var resource DeploymentIamPolicy
	err := ctx.ReadResource("google-native:deploymentmanager/alpha:DeploymentIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
