...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DeploymentOutputEntryResponseInput)(nil)).Elem(), DeploymentOutputEntryResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DeploymentOutputEntryResponseArrayInput)(nil)).Elem(), DeploymentOutputEntryResponseArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MethodMapResponseInput)(nil)).Elem(), MethodMapResponseArgs{})
