...
func NewDeploymentIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:deploymentmanager/v2:DeploymentIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentIamBinding(ctx *pulumi.Context,
	...
	var resource DeploymentIamBinding
	err := ctx.ReadResource("google-native:deploymentmanager/v2:DeploymentIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
