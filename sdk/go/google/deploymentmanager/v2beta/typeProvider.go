...
func NewTypeProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:deploymentmanager/v2beta:TypeProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTypeProvider(ctx *pulumi.Context,
	...
	var resource TypeProvider
	err := ctx.ReadResource("google-cloud:deploymentmanager/v2beta:TypeProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
