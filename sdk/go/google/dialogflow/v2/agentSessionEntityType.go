...
func NewAgentSessionEntityType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v2:AgentSessionEntityType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentSessionEntityType(ctx *pulumi.Context,
	...
	var resource AgentSessionEntityType
	err := ctx.ReadResource("google-cloud:dialogflow/v2:AgentSessionEntityType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
