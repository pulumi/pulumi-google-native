...
func NewAgentVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dialogflow/v2:AgentVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentVersion(ctx *pulumi.Context,
	...
	var resource AgentVersion
	err := ctx.ReadResource("google-native:dialogflow/v2:AgentVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
