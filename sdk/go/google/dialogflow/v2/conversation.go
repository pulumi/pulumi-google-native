...
func NewConversation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v2:Conversation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConversation(ctx *pulumi.Context,
	...
	var resource Conversation
	err := ctx.ReadResource("google-cloud:dialogflow/v2:Conversation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
