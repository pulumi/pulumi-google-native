...
type conversationProfileArgs struct {
	...
	// Configuration for Text-to-Speech synthesization. Used by Phone Gateway to specify synthesization options. If agent defines synthesization options as well, agent settings overrides the option here.
	TtsConfig *GoogleCloudDialogflowV2SynthesizeSpeechConfig `pulumi:"ttsConfig"`
}
...
// Configuration for Text-to-Speech synthesization. Used by Phone Gateway to specify synthesization options. If agent defines synthesization options as well, agent settings overrides the option here.
func (o ConversationProfileOutput) TtsConfig() GoogleCloudDialogflowV2SynthesizeSpeechConfigResponseOutput {
	return o.ApplyT(func(v *ConversationProfile) GoogleCloudDialogflowV2SynthesizeSpeechConfigResponseOutput {
		return v.TtsConfig
