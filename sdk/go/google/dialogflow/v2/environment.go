...
// Optional. The fulfillment settings to use for this environment.
func (o EnvironmentOutput) Fulfillment() GoogleCloudDialogflowV2FulfillmentResponseOutput {
	return o.ApplyT(func(v *Environment) GoogleCloudDialogflowV2FulfillmentResponseOutput { return v.Fulfillment }).(GoogleCloudDialogflowV2FulfillmentResponseOutput)
}
...
// Optional. Text to speech settings for this environment.
func (o EnvironmentOutput) TextToSpeechSettings() GoogleCloudDialogflowV2TextToSpeechSettingsResponseOutput {
	return o.ApplyT(func(v *Environment) GoogleCloudDialogflowV2TextToSpeechSettingsResponseOutput {
