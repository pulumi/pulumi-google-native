...
// Configuration for Text-to-Speech synthesization. Used by Phone Gateway to specify synthesization options. If agent defines synthesization options as well, agent settings overrides the option here.
func (o LookupConversationProfileResultOutput) TtsConfig() GoogleCloudDialogflowV2SynthesizeSpeechConfigResponseOutput {
	return o.ApplyT(func(v LookupConversationProfileResult) GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse {
		return v.TtsConfig
