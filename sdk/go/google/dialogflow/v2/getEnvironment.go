...
// Optional. The fulfillment settings to use for this environment.
func (o LookupEnvironmentResultOutput) Fulfillment() GoogleCloudDialogflowV2FulfillmentResponseOutput {
	return o.ApplyT(func(v LookupEnvironmentResult) GoogleCloudDialogflowV2FulfillmentResponse { return v.Fulfillment }).(GoogleCloudDialogflowV2FulfillmentResponseOutput)
}
...
// Optional. Text to speech settings for this environment.
func (o LookupEnvironmentResultOutput) TextToSpeechSettings() GoogleCloudDialogflowV2TextToSpeechSettingsResponseOutput {
	return o.ApplyT(func(v LookupEnvironmentResult) GoogleCloudDialogflowV2TextToSpeechSettingsResponse {
