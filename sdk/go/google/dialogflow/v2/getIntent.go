...
func LookupIntent(ctx *pulumi.Context, args *LookupIntentArgs, opts ...pulumi.InvokeOption) (*LookupIntentResult, error) {
	...
	err := ctx.Invoke("google-native:dialogflow/v2:getIntent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Read-only. Information about all followup intents that have this intent as a direct or indirect parent. We populate this field only in the output.
func (o LookupIntentResultOutput) FollowupIntentInfo() GoogleCloudDialogflowV2IntentFollowupIntentInfoResponseArrayOutput {
	return o.ApplyT(func(v LookupIntentResult) []GoogleCloudDialogflowV2IntentFollowupIntentInfoResponse {
		return v.FollowupIntentInfo
	}).(GoogleCloudDialogflowV2IntentFollowupIntentInfoResponseArrayOutput)
}
...
// Optional. The collection of rich messages corresponding to the `Response` field in the Dialogflow console.
func (o LookupIntentResultOutput) Messages() GoogleCloudDialogflowV2IntentMessageResponseArrayOutput {
	return o.ApplyT(func(v LookupIntentResult) []GoogleCloudDialogflowV2IntentMessageResponse { return v.Messages }).(GoogleCloudDialogflowV2IntentMessageResponseArrayOutput)
}
...
// Optional. The collection of contexts that are activated when the intent is matched. Context messages in this collection should not set the parameters field. Setting the `lifespan_count` to 0 will reset the context when the intent is matched. Format: `projects//agent/sessions/-/contexts/`.
func (o LookupIntentResultOutput) OutputContexts() GoogleCloudDialogflowV2ContextResponseArrayOutput {
	return o.ApplyT(func(v LookupIntentResult) []GoogleCloudDialogflowV2ContextResponse { return v.OutputContexts }).(GoogleCloudDialogflowV2ContextResponseArrayOutput)
}

// Optional. The collection of parameters associated with the intent.
func (o LookupIntentResultOutput) Parameters() GoogleCloudDialogflowV2IntentParameterResponseArrayOutput {
	return o.ApplyT(func(v LookupIntentResult) []GoogleCloudDialogflowV2IntentParameterResponse { return v.Parameters }).(GoogleCloudDialogflowV2IntentParameterResponseArrayOutput)
}
...
// Optional. The collection of examples that the agent is trained on.
func (o LookupIntentResultOutput) TrainingPhrases() GoogleCloudDialogflowV2IntentTrainingPhraseResponseArrayOutput {
	return o.ApplyT(func(v LookupIntentResult) []GoogleCloudDialogflowV2IntentTrainingPhraseResponse {
		return v.TrainingPhrases
	}).(GoogleCloudDialogflowV2IntentTrainingPhraseResponseArrayOutput)
}
