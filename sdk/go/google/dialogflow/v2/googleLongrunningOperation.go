...
func NewGoogleLongrunningOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v2:GoogleLongrunningOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGoogleLongrunningOperation(ctx *pulumi.Context,
	...
	var resource GoogleLongrunningOperation
	err := ctx.ReadResource("google-cloud:dialogflow/v2:GoogleLongrunningOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
