...
func NewIntent(ctx *pulumi.Context,
	...
	var resource Intent
	err := ctx.RegisterResource("google-native:dialogflow/v2:Intent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntent(ctx *pulumi.Context,
	...
	var resource Intent
	err := ctx.ReadResource("google-native:dialogflow/v2:Intent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Read-only. Information about all followup intents that have this intent as a direct or indirect parent. We populate this field only in the output.
func (o IntentOutput) FollowupIntentInfo() GoogleCloudDialogflowV2IntentFollowupIntentInfoResponseArrayOutput {
	return o.ApplyT(func(v *Intent) GoogleCloudDialogflowV2IntentFollowupIntentInfoResponseArrayOutput {
...
// Optional. The collection of rich messages corresponding to the `Response` field in the Dialogflow console.
func (o IntentOutput) Messages() GoogleCloudDialogflowV2IntentMessageResponseArrayOutput {
	return o.ApplyT(func(v *Intent) GoogleCloudDialogflowV2IntentMessageResponseArrayOutput { return v.Messages }).(GoogleCloudDialogflowV2IntentMessageResponseArrayOutput)
}
...
// Optional. The collection of contexts that are activated when the intent is matched. Context messages in this collection should not set the parameters field. Setting the `lifespan_count` to 0 will reset the context when the intent is matched. Format: `projects//agent/sessions/-/contexts/`.
func (o IntentOutput) OutputContexts() GoogleCloudDialogflowV2ContextResponseArrayOutput {
	return o.ApplyT(func(v *Intent) GoogleCloudDialogflowV2ContextResponseArrayOutput { return v.OutputContexts }).(GoogleCloudDialogflowV2ContextResponseArrayOutput)
}

// Optional. The collection of parameters associated with the intent.
func (o IntentOutput) Parameters() GoogleCloudDialogflowV2IntentParameterResponseArrayOutput {
	return o.ApplyT(func(v *Intent) GoogleCloudDialogflowV2IntentParameterResponseArrayOutput { return v.Parameters }).(GoogleCloudDialogflowV2IntentParameterResponseArrayOutput)
}
...
// Optional. The collection of examples that the agent is trained on.
func (o IntentOutput) TrainingPhrases() GoogleCloudDialogflowV2IntentTrainingPhraseResponseArrayOutput {
	return o.ApplyT(func(v *Intent) GoogleCloudDialogflowV2IntentTrainingPhraseResponseArrayOutput {
