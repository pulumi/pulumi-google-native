...
func NewKnowledgeBaseDocument(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dialogflow/v2:KnowledgeBaseDocument", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKnowledgeBaseDocument(ctx *pulumi.Context,
	...
	var resource KnowledgeBaseDocument
	err := ctx.ReadResource("google-native:dialogflow/v2:KnowledgeBaseDocument", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
