...
func NewKnowledgeBaseDocument(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v2:KnowledgeBaseDocument", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKnowledgeBaseDocument(ctx *pulumi.Context,
	...
	var resource KnowledgeBaseDocument
	err := ctx.ReadResource("google-cloud:dialogflow/v2:KnowledgeBaseDocument", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type knowledgeBaseDocumentArgs struct {
	...
	LatestReloadStatus *GoogleCloudDialogflowV2DocumentReloadStatus `pulumi:"latestReloadStatus"`
...
type KnowledgeBaseDocumentArgs struct {
	...
	// Output only. The time and status of the latest reload. This reload may have been triggered automatically or manually and may not have succeeded.
	LatestReloadStatus GoogleCloudDialogflowV2DocumentReloadStatusPtrInput
