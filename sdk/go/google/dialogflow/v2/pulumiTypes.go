...
// Optional. Enable including conversation context during query answer generation. Supported features: KNOWLEDGE_SEARCH.
func (o GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigOutput) EnableConversationAugmentedQuery() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig) *bool {
...
// Optional. Enable including conversation context during query answer generation. Supported features: KNOWLEDGE_SEARCH.
func (o GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponseOutput) EnableConversationAugmentedQuery() pulumi.BoolOutput {
	return o.ApplyT(func(v GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse) bool {
		return v.EnableConversationAugmentedQuery
	}).(pulumi.BoolOutput)
}
