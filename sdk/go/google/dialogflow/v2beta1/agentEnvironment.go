...
func NewAgentEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dialogflow/v2beta1:AgentEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEnvironment(ctx *pulumi.Context,
	...
	var resource AgentEnvironment
	err := ctx.ReadResource("google-native:dialogflow/v2beta1:AgentEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type AgentEnvironmentState struct {
	...
	// Optional. The fulfillment settings to use for this environment.
	Fulfillment GoogleCloudDialogflowV2beta1FulfillmentResponsePtrInput
	// The unique identifier of this agent environment. Supported formats: - `projects//agent/environments/` - `projects//locations//agent/environments/`
	Name pulumi.StringPtrInput
	// The state of this environment. This field is read-only, i.e., it cannot be set by create and update methods.
	State pulumi.StringPtrInput
	// Optional. Text to speech settings for this environment.
	TextToSpeechSettings GoogleCloudDialogflowV2beta1TextToSpeechSettingsResponsePtrInput
	// The last update time of this environment. This field is read-only, i.e., it cannot be set by create and update methods.
