...
func NewAgentEnvironmentUserSessionContext(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v2beta1:AgentEnvironmentUserSessionContext", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEnvironmentUserSessionContext(ctx *pulumi.Context,
	...
	var resource AgentEnvironmentUserSessionContext
	err := ctx.ReadResource("google-cloud:dialogflow/v2beta1:AgentEnvironmentUserSessionContext", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
