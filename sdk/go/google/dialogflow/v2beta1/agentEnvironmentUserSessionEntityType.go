...
func NewAgentEnvironmentUserSessionEntityType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dialogflow/v2beta1:AgentEnvironmentUserSessionEntityType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEnvironmentUserSessionEntityType(ctx *pulumi.Context,
	...
	var resource AgentEnvironmentUserSessionEntityType
	err := ctx.ReadResource("google-native:dialogflow/v2beta1:AgentEnvironmentUserSessionEntityType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
