...
func NewAgentKnowledgeBase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v2beta1:AgentKnowledgeBase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentKnowledgeBase(ctx *pulumi.Context,
	...
	var resource AgentKnowledgeBase
	err := ctx.ReadResource("google-cloud:dialogflow/v2beta1:AgentKnowledgeBase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
