...
func NewConversationParticipant(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v2beta1:ConversationParticipant", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConversationParticipant(ctx *pulumi.Context,
	...
	var resource ConversationParticipant
	err := ctx.ReadResource("google-cloud:dialogflow/v2beta1:ConversationParticipant", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
