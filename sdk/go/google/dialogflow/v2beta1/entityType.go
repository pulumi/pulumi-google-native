...
// Optional. The collection of entity entries associated with the entity type.
func (o EntityTypeOutput) Entities() GoogleCloudDialogflowV2beta1EntityTypeEntityResponseArrayOutput {
	return o.ApplyT(func(v *EntityType) GoogleCloudDialogflowV2beta1EntityTypeEntityResponseArrayOutput { return v.Entities }).(GoogleCloudDialogflowV2beta1EntityTypeEntityResponseArrayOutput)
}
