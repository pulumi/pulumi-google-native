...
// Optional. The collection of entity entries associated with the entity type.
func (o LookupEntityTypeResultOutput) Entities() GoogleCloudDialogflowV2beta1EntityTypeEntityResponseArrayOutput {
	return o.ApplyT(func(v LookupEntityTypeResult) []GoogleCloudDialogflowV2beta1EntityTypeEntityResponse {
		return v.Entities
