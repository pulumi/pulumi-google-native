...
// The collection of entities associated with this session entity type.
func (o LookupSessionEntityTypeResultOutput) Entities() GoogleCloudDialogflowV2beta1EntityTypeEntityResponseArrayOutput {
	return o.ApplyT(func(v LookupSessionEntityTypeResult) []GoogleCloudDialogflowV2beta1EntityTypeEntityResponse {
		return v.Entities
