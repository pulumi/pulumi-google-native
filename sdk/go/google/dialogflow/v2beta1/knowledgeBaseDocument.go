...
func NewKnowledgeBaseDocument(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v2beta1:KnowledgeBaseDocument", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKnowledgeBaseDocument(ctx *pulumi.Context,
	...
	var resource KnowledgeBaseDocument
	err := ctx.ReadResource("google-cloud:dialogflow/v2beta1:KnowledgeBaseDocument", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
