...
func GetSessionEntityType(ctx *pulumi.Context,
	...
	var resource SessionEntityType
	err := ctx.ReadResource("google-native:dialogflow/v2beta1:SessionEntityType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The collection of entities associated with this session entity type.
func (o SessionEntityTypeOutput) Entities() GoogleCloudDialogflowV2beta1EntityTypeEntityResponseArrayOutput {
	return o.ApplyT(func(v *SessionEntityType) GoogleCloudDialogflowV2beta1EntityTypeEntityResponseArrayOutput {
		return v.Entities
	}).(GoogleCloudDialogflowV2beta1EntityTypeEntityResponseArrayOutput)
}
