...
func NewAgentEntityType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dialogflow/v3:AgentEntityType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEntityType(ctx *pulumi.Context,
	...
	var resource AgentEntityType
	err := ctx.ReadResource("google-native:dialogflow/v3:AgentEntityType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type AgentEntityTypeState struct {
	...
	// Collection of exceptional words and phrases that shouldn't be matched. For example, if you have a size entity type with entry `giant`(an adjective), you might consider adding `giants`(a noun) as an exclusion. If the kind of entity type is `KIND_MAP`, then the phrases specified by entities and excluded phrases should be mutually exclusive.
	ExcludedPhrases GoogleCloudDialogflowCxV3EntityTypeExcludedPhraseResponseArrayInput
	// Required. Indicates the kind of entity type.
