...
func NewAgentEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v3:AgentEnvironment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentEnvironment(ctx *pulumi.Context,
	...
	var resource AgentEnvironment
	err := ctx.ReadResource("google-cloud:dialogflow/v3:AgentEnvironment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
