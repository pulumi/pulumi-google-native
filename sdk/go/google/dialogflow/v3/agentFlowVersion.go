...
func NewAgentFlowVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v3:AgentFlowVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentFlowVersion(ctx *pulumi.Context,
	...
	var resource AgentFlowVersion
	err := ctx.ReadResource("google-cloud:dialogflow/v3:AgentFlowVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
