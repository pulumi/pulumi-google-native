...
func NewAgentIntent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dialogflow/v3:AgentIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentIntent(ctx *pulumi.Context,
	...
	var resource AgentIntent
	err := ctx.ReadResource("google-native:dialogflow/v3:AgentIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type AgentIntentState struct {
	...
	// The collection of parameters associated with the intent.
	Parameters GoogleCloudDialogflowCxV3IntentParameterResponseArrayInput
	// The priority of this intent. Higher numbers represent higher priorities. - If the supplied value is unspecified or 0, the service translates the value to 500,000, which corresponds to the `Normal` priority in the console. - If the supplied value is negative, the intent is ignored in runtime detect intent requests.
	Priority pulumi.IntPtrInput
	// The collection of training phrases the agent is trained on to identify the intent.
	TrainingPhrases GoogleCloudDialogflowCxV3IntentTrainingPhraseResponseArrayInput
}
