...
func LookupAgent(ctx *pulumi.Context, args *LookupAgentArgs, opts ...pulumi.InvokeOption) (*LookupAgentResult, error) {
	...
	err := ctx.Invoke("google-native:dialogflow/v3:getAgent", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupAgentResult struct {
	...
	PersonalizationSettings GoogleCloudDialogflowCxV3AgentPersonalizationSettingsResponse `pulumi:"personalizationSettings"`
...
// Hierarchical advanced settings for this agent. The settings exposed at the lower level overrides the settings exposed at the higher level.
func (o LookupAgentResultOutput) AdvancedSettings() GoogleCloudDialogflowCxV3AdvancedSettingsResponseOutput {
	return o.ApplyT(func(v LookupAgentResult) GoogleCloudDialogflowCxV3AdvancedSettingsResponse { return v.AdvancedSettings }).(GoogleCloudDialogflowCxV3AdvancedSettingsResponseOutput)
}

// Optional. Answer feedback collection settings.
func (o LookupAgentResultOutput) AnswerFeedbackSettings() GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsResponseOutput {
	return o.ApplyT(func(v LookupAgentResult) GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsResponse {
...
// Gen App Builder-related agent-level settings.
func (o LookupAgentResultOutput) GenAppBuilderSettings() GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsResponseOutput {
	return o.ApplyT(func(v LookupAgentResult) GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsResponse {
		return v.GenAppBuilderSettings
	}).(GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsResponseOutput)
}

// Git integration settings for this agent.
func (o LookupAgentResultOutput) GitIntegrationSettings() GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsResponseOutput {
	return o.ApplyT(func(v LookupAgentResult) GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsResponse {
...
// Optional. Settings for end user personalization.
func (o LookupAgentResultOutput) PersonalizationSettings() GoogleCloudDialogflowCxV3AgentPersonalizationSettingsResponseOutput {
	return o.ApplyT(func(v LookupAgentResult) GoogleCloudDialogflowCxV3AgentPersonalizationSettingsResponse {
...
// Speech recognition related settings.
func (o LookupAgentResultOutput) SpeechToTextSettings() GoogleCloudDialogflowCxV3SpeechToTextSettingsResponseOutput {
	return o.ApplyT(func(v LookupAgentResult) GoogleCloudDialogflowCxV3SpeechToTextSettingsResponse {
...
// Settings on instructing the speech synthesizer on how to generate the output audio content.
func (o LookupAgentResultOutput) TextToSpeechSettings() GoogleCloudDialogflowCxV3TextToSpeechSettingsResponseOutput {
	return o.ApplyT(func(v LookupAgentResult) GoogleCloudDialogflowCxV3TextToSpeechSettingsResponse {
