...
// The collection of parameters associated with the intent.
func (o LookupIntentResultOutput) Parameters() GoogleCloudDialogflowCxV3IntentParameterResponseArrayOutput {
	return o.ApplyT(func(v LookupIntentResult) []GoogleCloudDialogflowCxV3IntentParameterResponse { return v.Parameters }).(GoogleCloudDialogflowCxV3IntentParameterResponseArrayOutput)
}
...
// The collection of training phrases the agent is trained on to identify the intent.
func (o LookupIntentResultOutput) TrainingPhrases() GoogleCloudDialogflowCxV3IntentTrainingPhraseResponseArrayOutput {
	return o.ApplyT(func(v LookupIntentResult) []GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse {
