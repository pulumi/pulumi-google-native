...
// The latest test result.
func (o LookupTestCaseResultOutput) LastTestResult() GoogleCloudDialogflowCxV3TestCaseResultResponseOutput {
	return o.ApplyT(func(v LookupTestCaseResult) GoogleCloudDialogflowCxV3TestCaseResultResponse { return v.LastTestResult }).(GoogleCloudDialogflowCxV3TestCaseResultResponseOutput)
}
...
// The conversation turns uttered when the test case was created, in chronological order. These include the canonical set of agent utterances that should occur when the agent is working properly.
func (o LookupTestCaseResultOutput) TestCaseConversationTurns() GoogleCloudDialogflowCxV3ConversationTurnResponseArrayOutput {
	return o.ApplyT(func(v LookupTestCaseResult) []GoogleCloudDialogflowCxV3ConversationTurnResponse {
		return v.TestCaseConversationTurns
	}).(GoogleCloudDialogflowCxV3ConversationTurnResponseArrayOutput)
}

// Config for the test case.
func (o LookupTestCaseResultOutput) TestConfig() GoogleCloudDialogflowCxV3TestConfigResponseOutput {
	return o.ApplyT(func(v LookupTestCaseResult) GoogleCloudDialogflowCxV3TestConfigResponse { return v.TestConfig }).(GoogleCloudDialogflowCxV3TestConfigResponseOutput)
}
