...
func LookupTransitionRouteGroup(ctx *pulumi.Context, args *LookupTransitionRouteGroupArgs, opts ...pulumi.InvokeOption) (*LookupTransitionRouteGroupResult, error) {
	...
	err := ctx.Invoke("google-native:dialogflow/v3:getTransitionRouteGroup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Transition routes associated with the TransitionRouteGroup.
func (o LookupTransitionRouteGroupResultOutput) TransitionRoutes() GoogleCloudDialogflowCxV3TransitionRouteResponseArrayOutput {
	return o.ApplyT(func(v LookupTransitionRouteGroupResult) []GoogleCloudDialogflowCxV3TransitionRouteResponse {
