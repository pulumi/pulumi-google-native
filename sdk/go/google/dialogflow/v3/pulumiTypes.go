...
// Required. The name of [Service Directory](https://cloud.google.com/service-directory) service. Format: `projects//locations//namespaces//services/`. `Location ID` of the service directory must be the same as the location of the agent.
func (o GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfigOutput) Service() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfig) *string { return v.Service }).(pulumi.StringPtrOutput)
}
