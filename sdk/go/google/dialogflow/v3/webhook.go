...
// Configuration for a generic web service.
func (o WebhookOutput) GenericWebService() GoogleCloudDialogflowCxV3WebhookGenericWebServiceResponseOutput {
	return o.ApplyT(func(v *Webhook) GoogleCloudDialogflowCxV3WebhookGenericWebServiceResponseOutput {
...
// Configuration for a [Service Directory](https://cloud.google.com/service-directory) service.
func (o WebhookOutput) ServiceDirectory() GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfigResponseOutput {
	return o.ApplyT(func(v *Webhook) GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfigResponseOutput {
