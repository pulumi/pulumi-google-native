...
func NewAgent(ctx *pulumi.Context,
	...
	var resource Agent
	err := ctx.RegisterResource("google-cloud:dialogflow/v3beta1:Agent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgent(ctx *pulumi.Context,
	...
	var resource Agent
	err := ctx.ReadResource("google-cloud:dialogflow/v3beta1:Agent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
