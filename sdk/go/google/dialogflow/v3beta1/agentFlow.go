...
func NewAgentFlow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v3beta1:AgentFlow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentFlow(ctx *pulumi.Context,
	...
	var resource AgentFlow
	err := ctx.ReadResource("google-cloud:dialogflow/v3beta1:AgentFlow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
