...
func NewAgentIntent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v3beta1:AgentIntent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentIntent(ctx *pulumi.Context,
	...
	var resource AgentIntent
	err := ctx.ReadResource("google-cloud:dialogflow/v3beta1:AgentIntent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
