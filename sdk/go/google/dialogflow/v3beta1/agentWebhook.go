...
func NewAgentWebhook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dialogflow/v3beta1:AgentWebhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentWebhook(ctx *pulumi.Context,
	...
	var resource AgentWebhook
	err := ctx.ReadResource("google-cloud:dialogflow/v3beta1:AgentWebhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
