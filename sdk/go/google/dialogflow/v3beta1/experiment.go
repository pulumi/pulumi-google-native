...
// The definition of the experiment.
func (o ExperimentOutput) Definition() GoogleCloudDialogflowCxV3beta1ExperimentDefinitionResponseOutput {
	return o.ApplyT(func(v *Experiment) GoogleCloudDialogflowCxV3beta1ExperimentDefinitionResponseOutput {
		return v.Definition
...
// Inference result of the experiment.
func (o ExperimentOutput) Result() GoogleCloudDialogflowCxV3beta1ExperimentResultResponseOutput {
	return o.ApplyT(func(v *Experiment) GoogleCloudDialogflowCxV3beta1ExperimentResultResponseOutput { return v.Result }).(GoogleCloudDialogflowCxV3beta1ExperimentResultResponseOutput)
}

// The configuration for auto rollout. If set, there should be exactly two variants in the experiment (control variant being the default version of the flow), the traffic allocation for the non-control variant will gradually increase to 100% when conditions are met, and eventually replace the control variant to become the default version of the flow.
func (o ExperimentOutput) RolloutConfig() GoogleCloudDialogflowCxV3beta1RolloutConfigResponseOutput {
	return o.ApplyT(func(v *Experiment) GoogleCloudDialogflowCxV3beta1RolloutConfigResponseOutput { return v.RolloutConfig }).(GoogleCloudDialogflowCxV3beta1RolloutConfigResponseOutput)
}
...
// State of the auto rollout process.
func (o ExperimentOutput) RolloutState() GoogleCloudDialogflowCxV3beta1RolloutStateResponseOutput {
	return o.ApplyT(func(v *Experiment) GoogleCloudDialogflowCxV3beta1RolloutStateResponseOutput { return v.RolloutState }).(GoogleCloudDialogflowCxV3beta1RolloutStateResponseOutput)
}
...
// The history of updates to the experiment variants.
func (o ExperimentOutput) VariantsHistory() GoogleCloudDialogflowCxV3beta1VariantsHistoryResponseArrayOutput {
	return o.ApplyT(func(v *Experiment) GoogleCloudDialogflowCxV3beta1VariantsHistoryResponseArrayOutput {
