...
// Hierarchical advanced settings for this flow. The settings exposed at the lower level overrides the settings exposed at the higher level.
func (o FlowOutput) AdvancedSettings() GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponseOutput {
	return o.ApplyT(func(v *Flow) GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponseOutput { return v.AdvancedSettings }).(GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponseOutput)
}
...
// Optional. Knowledge connector configuration.
func (o FlowOutput) KnowledgeConnectorSettings() GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponseOutput {
	return o.ApplyT(func(v *Flow) GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponseOutput {
