...
type Generator struct {
	...
	Placeholders GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponseArrayOutput `pulumi:"placeholders"`
	Project      pulumi.StringOutput                                                   `pulumi:"project"`
	// Prompt for the LLM model.
	PromptText GoogleCloudDialogflowCxV3beta1PhraseResponseOutput `pulumi:"promptText"`
}
...
func NewGenerator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dialogflow/v3beta1:Generator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGenerator(ctx *pulumi.Context,
	...
	var resource Generator
	err := ctx.ReadResource("google-native:dialogflow/v3beta1:Generator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type generatorArgs struct {
	...
	// Optional. List of custom placeholders in the prompt text.
	Placeholders []GoogleCloudDialogflowCxV3beta1GeneratorPlaceholder `pulumi:"placeholders"`
	Project      *string                                              `pulumi:"project"`
	// Prompt for the LLM model.
	PromptText GoogleCloudDialogflowCxV3beta1Phrase `pulumi:"promptText"`
}
...
type GeneratorArgs struct {
	...
	// Optional. List of custom placeholders in the prompt text.
	Placeholders GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArrayInput
	Project      pulumi.StringPtrInput
	// Prompt for the LLM model.
	PromptText GoogleCloudDialogflowCxV3beta1PhraseInput
}
...
// Optional. List of custom placeholders in the prompt text.
func (o GeneratorOutput) Placeholders() GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponseArrayOutput {
	return o.ApplyT(func(v *Generator) GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponseArrayOutput {
		return v.Placeholders
	}).(GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponseArrayOutput)
}
...
// Prompt for the LLM model.
func (o GeneratorOutput) PromptText() GoogleCloudDialogflowCxV3beta1PhraseResponseOutput {
	return o.ApplyT(func(v *Generator) GoogleCloudDialogflowCxV3beta1PhraseResponseOutput { return v.PromptText }).(GoogleCloudDialogflowCxV3beta1PhraseResponseOutput)
}
