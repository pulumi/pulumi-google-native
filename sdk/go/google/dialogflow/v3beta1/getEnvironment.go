...
// The test cases config for continuous tests of this environment.
func (o LookupEnvironmentResultOutput) TestCasesConfig() GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigResponseOutput {
	return o.ApplyT(func(v LookupEnvironmentResult) GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigResponse {
...
// A list of configurations for flow versions. You should include version configs for all flows that are reachable from `Start Flow` in the agent. Otherwise, an error will be returned.
func (o LookupEnvironmentResultOutput) VersionConfigs() GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigResponseArrayOutput {
