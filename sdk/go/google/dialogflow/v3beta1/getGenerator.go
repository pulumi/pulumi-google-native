...
func LookupGenerator(ctx *pulumi.Context, args *LookupGeneratorArgs, opts ...pulumi.InvokeOption) (*LookupGeneratorResult, error) {
	...
	err := ctx.Invoke("google-native:dialogflow/v3beta1:getGenerator", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupGeneratorResult struct {
	...
	Placeholders []GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponse `pulumi:"placeholders"`
	// Prompt for the LLM model.
	PromptText GoogleCloudDialogflowCxV3beta1PhraseResponse `pulumi:"promptText"`
}
...
// Optional. List of custom placeholders in the prompt text.
func (o LookupGeneratorResultOutput) Placeholders() GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponseArrayOutput {
	return o.ApplyT(func(v LookupGeneratorResult) []GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponse {
		return v.Placeholders
	}).(GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponseArrayOutput)
}

// Prompt for the LLM model.
func (o LookupGeneratorResultOutput) PromptText() GoogleCloudDialogflowCxV3beta1PhraseResponseOutput {
	return o.ApplyT(func(v LookupGeneratorResult) GoogleCloudDialogflowCxV3beta1PhraseResponse { return v.PromptText }).(GoogleCloudDialogflowCxV3beta1PhraseResponseOutput)
}
