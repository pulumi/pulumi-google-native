...
func LookupSessionEntityType(ctx *pulumi.Context, args *LookupSessionEntityTypeArgs, opts ...pulumi.InvokeOption) (*LookupSessionEntityTypeResult, error) {
	...
	err := ctx.Invoke("google-native:dialogflow/v3beta1:getSessionEntityType", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The collection of entities to override or supplement the custom entity type.
func (o LookupSessionEntityTypeResultOutput) Entities() GoogleCloudDialogflowCxV3beta1EntityTypeEntityResponseArrayOutput {
	return o.ApplyT(func(v LookupSessionEntityTypeResult) []GoogleCloudDialogflowCxV3beta1EntityTypeEntityResponse {
		return v.Entities
