...
// The NLU settings of the flow at version creation.
func (o VersionOutput) NluSettings() GoogleCloudDialogflowCxV3beta1NluSettingsResponseOutput {
	return o.ApplyT(func(v *Version) GoogleCloudDialogflowCxV3beta1NluSettingsResponseOutput { return v.NluSettings }).(GoogleCloudDialogflowCxV3beta1NluSettingsResponseOutput)
}
