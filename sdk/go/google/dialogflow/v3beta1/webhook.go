...
func NewWebhook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dialogflow/v3beta1:Webhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebhook(ctx *pulumi.Context,
	...
	var resource Webhook
	err := ctx.ReadResource("google-native:dialogflow/v3beta1:Webhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type WebhookState struct {
	...
	// Configuration for a [Service Directory](https://cloud.google.com/service-directory) service.
	ServiceDirectory GoogleCloudDialogflowCxV3beta1WebhookServiceDirectoryConfigResponsePtrInput
	// Webhook execution timeout. Execution is considered failed if Dialogflow doesn't receive a response from webhook at the end of the timeout period. Defaults to 5 seconds, maximum allowed timeout is 30 seconds.
