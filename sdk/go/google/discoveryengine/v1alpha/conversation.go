...
func NewConversation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:discoveryengine/v1alpha:Conversation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConversation(ctx *pulumi.Context,
	...
	var resource Conversation
	err := ctx.ReadResource("google-native:discoveryengine/v1alpha:Conversation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Conversation messages.
func (o ConversationOutput) Messages() GoogleCloudDiscoveryengineV1alphaConversationMessageResponseArrayOutput {
	return o.ApplyT(func(v *Conversation) GoogleCloudDiscoveryengineV1alphaConversationMessageResponseArrayOutput {
		return v.Messages
