...
func NewEngineConversation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:discoveryengine/v1alpha:EngineConversation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEngineConversation(ctx *pulumi.Context,
	...
	var resource EngineConversation
	err := ctx.ReadResource("google-native:discoveryengine/v1alpha:EngineConversation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Conversation messages.
func (o EngineConversationOutput) Messages() GoogleCloudDiscoveryengineV1alphaConversationMessageResponseArrayOutput {
	return o.ApplyT(func(v *EngineConversation) GoogleCloudDiscoveryengineV1alphaConversationMessageResponseArrayOutput {
		return v.Messages
