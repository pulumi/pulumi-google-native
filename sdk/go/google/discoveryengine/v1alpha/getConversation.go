...
func LookupConversation(ctx *pulumi.Context, args *LookupConversationArgs, opts ...pulumi.InvokeOption) (*LookupConversationResult, error) {
	...
	err := ctx.Invoke("google-native:discoveryengine/v1alpha:getConversation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Conversation messages.
func (o LookupConversationResultOutput) Messages() GoogleCloudDiscoveryengineV1alphaConversationMessageResponseArrayOutput {
	return o.ApplyT(func(v LookupConversationResult) []GoogleCloudDiscoveryengineV1alphaConversationMessageResponse {
		return v.Messages
