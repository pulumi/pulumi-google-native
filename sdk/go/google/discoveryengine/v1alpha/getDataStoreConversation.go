...
func LookupDataStoreConversation(ctx *pulumi.Context, args *LookupDataStoreConversationArgs, opts ...pulumi.InvokeOption) (*LookupDataStoreConversationResult, error) {
	...
	err := ctx.Invoke("google-native:discoveryengine/v1alpha:getDataStoreConversation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Conversation messages.
func (o LookupDataStoreConversationResultOutput) Messages() GoogleCloudDiscoveryengineV1alphaConversationMessageResponseArrayOutput {
	return o.ApplyT(func(v LookupDataStoreConversationResult) []GoogleCloudDiscoveryengineV1alphaConversationMessageResponse {
		return v.Messages
