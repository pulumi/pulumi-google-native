...
type DataStore struct {
	...
	DocumentProcessingConfig GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigResponseOutput `pulumi:"documentProcessingConfig"`
	...
	StartingSchema GoogleCloudDiscoveryengineV1betaSchemaResponseOutput `pulumi:"startingSchema"`
}
...
func NewDataStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:discoveryengine/v1beta:DataStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataStore(ctx *pulumi.Context,
	...
	var resource DataStore
	err := ctx.ReadResource("google-native:discoveryengine/v1beta:DataStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type dataStoreArgs struct {
	...
	// Configuration for Document understanding and enrichment.
	DocumentProcessingConfig *GoogleCloudDiscoveryengineV1betaDocumentProcessingConfig `pulumi:"documentProcessingConfig"`
	// Immutable. The industry vertical that the data store registers.
	...
	// The start schema to use for this DataStore when provisioning it. If unset, a default vertical specialized schema will be used. This field is only used by CreateDataStore API, and will be ignored if used in other APIs. This field will be omitted from all API responses including CreateDataStore API. To retrieve a schema of a DataStore, use SchemaService.GetSchema API instead. The provided schema will be validated against certain rules on schema. Learn more from [this doc](https://cloud.google.com/generative-ai-app-builder/docs/provide-schema).
	StartingSchema *GoogleCloudDiscoveryengineV1betaSchema `pulumi:"startingSchema"`
}
...
type DataStoreArgs struct {
	...
	// Configuration for Document understanding and enrichment.
	DocumentProcessingConfig GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigPtrInput
	// Immutable. The industry vertical that the data store registers.
	...
	// The start schema to use for this DataStore when provisioning it. If unset, a default vertical specialized schema will be used. This field is only used by CreateDataStore API, and will be ignored if used in other APIs. This field will be omitted from all API responses including CreateDataStore API. To retrieve a schema of a DataStore, use SchemaService.GetSchema API instead. The provided schema will be validated against certain rules on schema. Learn more from [this doc](https://cloud.google.com/generative-ai-app-builder/docs/provide-schema).
	StartingSchema GoogleCloudDiscoveryengineV1betaSchemaPtrInput
}
...
// Configuration for Document understanding and enrichment.
func (o DataStoreOutput) DocumentProcessingConfig() GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigResponseOutput {
	return o.ApplyT(func(v *DataStore) GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigResponseOutput {
...
// The start schema to use for this DataStore when provisioning it. If unset, a default vertical specialized schema will be used. This field is only used by CreateDataStore API, and will be ignored if used in other APIs. This field will be omitted from all API responses including CreateDataStore API. To retrieve a schema of a DataStore, use SchemaService.GetSchema API instead. The provided schema will be validated against certain rules on schema. Learn more from [this doc](https://cloud.google.com/generative-ai-app-builder/docs/provide-schema).
func (o DataStoreOutput) StartingSchema() GoogleCloudDiscoveryengineV1betaSchemaResponseOutput {
	return o.ApplyT(func(v *DataStore) GoogleCloudDiscoveryengineV1betaSchemaResponseOutput { return v.StartingSchema }).(GoogleCloudDiscoveryengineV1betaSchemaResponseOutput)
}
