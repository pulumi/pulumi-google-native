...
func NewDataStoreConversation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:discoveryengine/v1beta:DataStoreConversation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataStoreConversation(ctx *pulumi.Context,
	...
	var resource DataStoreConversation
	err := ctx.ReadResource("google-native:discoveryengine/v1beta:DataStoreConversation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Conversation messages.
func (o DataStoreConversationOutput) Messages() GoogleCloudDiscoveryengineV1betaConversationMessageResponseArrayOutput {
	return o.ApplyT(func(v *DataStoreConversation) GoogleCloudDiscoveryengineV1betaConversationMessageResponseArrayOutput {
		return v.Messages
