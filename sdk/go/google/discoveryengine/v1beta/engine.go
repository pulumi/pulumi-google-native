...
type Engine struct {
	...
	ChatEngineConfig GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigResponseOutput `pulumi:"chatEngineConfig"`
	// Additional information of the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
	ChatEngineMetadata GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadataResponseOutput `pulumi:"chatEngineMetadata"`
	CollectionId       pulumi.StringOutput                                                    `pulumi:"collectionId"`
	// Common config spec that specifies the metadata of the engine.
	CommonConfig GoogleCloudDiscoveryengineV1betaEngineCommonConfigResponseOutput `pulumi:"commonConfig"`
	...
	SearchEngineConfig GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigResponseOutput `pulumi:"searchEngineConfig"`
...
func NewEngine(ctx *pulumi.Context,
	...
	var resource Engine
	err := ctx.RegisterResource("google-native:discoveryengine/v1beta:Engine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEngine(ctx *pulumi.Context,
	...
	var resource Engine
	err := ctx.ReadResource("google-native:discoveryengine/v1beta:Engine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type engineArgs struct {
	// Configurations for the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
	ChatEngineConfig *GoogleCloudDiscoveryengineV1betaEngineChatEngineConfig `pulumi:"chatEngineConfig"`
	CollectionId     string                                                  `pulumi:"collectionId"`
	// Common config spec that specifies the metadata of the engine.
	CommonConfig *GoogleCloudDiscoveryengineV1betaEngineCommonConfig `pulumi:"commonConfig"`
	// The data stores associated with this engine. For SOLUTION_TYPE_SEARCH and SOLUTION_TYPE_RECOMMENDATION type of engines, they can only associate with at most one data store. If solution_type is SOLUTION_TYPE_CHAT, multiple DataStores in the same Collection can be associated here. Note that when used in CreateEngineRequest, one DataStore id must be provided as the system will use it for necessary initializations.
	...
	// Configurations for the Search Engine. Only applicable if solution_type is SOLUTION_TYPE_SEARCH.
	SearchEngineConfig *GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfig `pulumi:"searchEngineConfig"`
	// The solutions of the engine.
...
type EngineArgs struct {
	// Configurations for the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
	ChatEngineConfig GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigPtrInput
	CollectionId     pulumi.StringInput
	// Common config spec that specifies the metadata of the engine.
	CommonConfig GoogleCloudDiscoveryengineV1betaEngineCommonConfigPtrInput
	// The data stores associated with this engine. For SOLUTION_TYPE_SEARCH and SOLUTION_TYPE_RECOMMENDATION type of engines, they can only associate with at most one data store. If solution_type is SOLUTION_TYPE_CHAT, multiple DataStores in the same Collection can be associated here. Note that when used in CreateEngineRequest, one DataStore id must be provided as the system will use it for necessary initializations.
	...
	// Configurations for the Search Engine. Only applicable if solution_type is SOLUTION_TYPE_SEARCH.
	SearchEngineConfig GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigPtrInput
	// The solutions of the engine.
...
// Configurations for the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
func (o EngineOutput) ChatEngineConfig() GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigResponseOutput {
	return o.ApplyT(func(v *Engine) GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigResponseOutput {
		return v.ChatEngineConfig
	}).(GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigResponseOutput)
}

// Additional information of the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
func (o EngineOutput) ChatEngineMetadata() GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadataResponseOutput {
	return o.ApplyT(func(v *Engine) GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadataResponseOutput {
...
// Common config spec that specifies the metadata of the engine.
func (o EngineOutput) CommonConfig() GoogleCloudDiscoveryengineV1betaEngineCommonConfigResponseOutput {
	return o.ApplyT(func(v *Engine) GoogleCloudDiscoveryengineV1betaEngineCommonConfigResponseOutput {
...
// Configurations for the Search Engine. Only applicable if solution_type is SOLUTION_TYPE_SEARCH.
func (o EngineOutput) SearchEngineConfig() GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigResponseOutput {
	return o.ApplyT(func(v *Engine) GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigResponseOutput {
