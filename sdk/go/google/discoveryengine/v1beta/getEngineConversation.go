...
func LookupEngineConversation(ctx *pulumi.Context, args *LookupEngineConversationArgs, opts ...pulumi.InvokeOption) (*LookupEngineConversationResult, error) {
	...
	err := ctx.Invoke("google-native:discoveryengine/v1beta:getEngineConversation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Conversation messages.
func (o LookupEngineConversationResultOutput) Messages() GoogleCloudDiscoveryengineV1betaConversationMessageResponseArrayOutput {
	return o.ApplyT(func(v LookupEngineConversationResult) []GoogleCloudDiscoveryengineV1betaConversationMessageResponse {
		return v.Messages
