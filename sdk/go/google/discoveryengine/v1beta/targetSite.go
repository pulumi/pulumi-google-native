...
type TargetSite struct {
	...
	// Failure reason.
	FailureReason GoogleCloudDiscoveryengineV1betaTargetSiteFailureReasonResponseOutput `pulumi:"failureReason"`
	...
	SiteVerificationInfo GoogleCloudDiscoveryengineV1betaSiteVerificationInfoResponseOutput `pulumi:"siteVerificationInfo"`
...
func NewTargetSite(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:discoveryengine/v1beta:TargetSite", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetSite(ctx *pulumi.Context,
	...
	var resource TargetSite
	err := ctx.ReadResource("google-native:discoveryengine/v1beta:TargetSite", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Failure reason.
func (o TargetSiteOutput) FailureReason() GoogleCloudDiscoveryengineV1betaTargetSiteFailureReasonResponseOutput {
	return o.ApplyT(func(v *TargetSite) GoogleCloudDiscoveryengineV1betaTargetSiteFailureReasonResponseOutput {
...
// Site ownership and validity verification status.
func (o TargetSiteOutput) SiteVerificationInfo() GoogleCloudDiscoveryengineV1betaSiteVerificationInfoResponseOutput {
	return o.ApplyT(func(v *TargetSite) GoogleCloudDiscoveryengineV1betaSiteVerificationInfoResponseOutput {
