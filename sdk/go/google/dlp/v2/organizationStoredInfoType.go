...
func NewOrganizationStoredInfoType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dlp/v2:OrganizationStoredInfoType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationStoredInfoType(ctx *pulumi.Context,
	...
	var resource OrganizationStoredInfoType
	err := ctx.ReadResource("google-cloud:dlp/v2:OrganizationStoredInfoType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
