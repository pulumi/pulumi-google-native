...
func NewStoredInfoType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dlp/v2:StoredInfoType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStoredInfoType(ctx *pulumi.Context,
	...
	var resource StoredInfoType
	err := ctx.ReadResource("google-cloud:dlp/v2:StoredInfoType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
