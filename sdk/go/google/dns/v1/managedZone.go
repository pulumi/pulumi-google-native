...
func NewManagedZone(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dns/v1:ManagedZone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedZone(ctx *pulumi.Context,
	...
	var resource ManagedZone
	err := ctx.ReadResource("google-cloud:dns/v1:ManagedZone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
