...
func NewManagedZoneRrset(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dns/v1:ManagedZoneRrset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedZoneRrset(ctx *pulumi.Context,
	...
	var resource ManagedZoneRrset
	err := ctx.ReadResource("google-cloud:dns/v1:ManagedZoneRrset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
