...
func NewResourceRecordSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:dns/v1:ResourceRecordSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceRecordSet(ctx *pulumi.Context,
	...
	var resource ResourceRecordSet
	err := ctx.ReadResource("google-cloud:dns/v1:ResourceRecordSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
