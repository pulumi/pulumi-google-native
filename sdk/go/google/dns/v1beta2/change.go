...
func NewChange(ctx *pulumi.Context,
	...
	var resource Change
	err := ctx.RegisterResource("google-cloud:dns/v1beta2:Change", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetChange(ctx *pulumi.Context,
	...
	var resource Change
	err := ctx.ReadResource("google-cloud:dns/v1beta2:Change", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
