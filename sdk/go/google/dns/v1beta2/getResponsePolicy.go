...
func (o LookupResponsePolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupResponsePolicyResult] {
	return pulumix.Output[LookupResponsePolicyResult]{
...
// User labels.
func (o LookupResponsePolicyResultOutput) Labels() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupResponsePolicyResult) map[string]string { return v.Labels }).(pulumi.StringMapOutput)
}
