...
func NewManagedZoneIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:dns/v1beta2:ManagedZoneIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedZoneIamBinding(ctx *pulumi.Context,
	...
	var resource ManagedZoneIamBinding
	err := ctx.ReadResource("google-native:dns/v1beta2:ManagedZoneIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ManagedZoneIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ManagedZoneIamBinding] {
	return pulumix.Output[*ManagedZoneIamBinding]{
		OutputState: i.ToManagedZoneIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ManagedZoneIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ManagedZoneIamBinding] {
	return pulumix.Output[*ManagedZoneIamBinding]{
