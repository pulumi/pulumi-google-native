...
const (
	DnsKeySpecKeyTypeKeySigning  = DnsKeySpecKeyType("KEY_SIGNING")
	DnsKeySpecKeyTypeZoneSigning = DnsKeySpecKeyType("ZONE_SIGNING")
)
...
const (
	ResponsePolicyRuleBehaviorBehaviorUnspecified = ResponsePolicyRuleBehavior("BEHAVIOR_UNSPECIFIED")
	...
	ResponsePolicyRuleBehaviorBypassResponsePolicy = ResponsePolicyRuleBehavior("BYPASS_RESPONSE_POLICY")
)
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DnsKeySpecKeyTypeInput)(nil)).Elem(), DnsKeySpecKeyType("KEY_SIGNING"))
	pulumi.RegisterInputType(reflect.TypeOf((*DnsKeySpecKeyTypePtrInput)(nil)).Elem(), DnsKeySpecKeyType("KEY_SIGNING"))
