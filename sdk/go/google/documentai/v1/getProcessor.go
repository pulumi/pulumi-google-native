...
func LookupProcessor(ctx *pulumi.Context, args *LookupProcessorArgs, opts ...pulumi.InvokeOption) (*LookupProcessorResult, error) {
	...
	err := ctx.Invoke("google-native:documentai/v1:getProcessor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The processor version aliases.
func (o LookupProcessorResultOutput) ProcessorVersionAliases() GoogleCloudDocumentaiV1ProcessorVersionAliasResponseArrayOutput {
	return o.ApplyT(func(v LookupProcessorResult) []GoogleCloudDocumentaiV1ProcessorVersionAliasResponse {
