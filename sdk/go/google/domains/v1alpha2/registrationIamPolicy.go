...
func NewRegistrationIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:domains/v1alpha2:RegistrationIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistrationIamPolicy(ctx *pulumi.Context,
	...
	var resource RegistrationIamPolicy
	err := ctx.ReadResource("google-native:domains/v1alpha2:RegistrationIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
