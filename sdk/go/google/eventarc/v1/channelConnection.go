...
func (o ChannelConnectionOutput) ChannelConnectionId() pulumi.StringOutput {
	return o.ApplyT(func(v *ChannelConnection) pulumi.StringOutput { return v.ChannelConnectionId }).(pulumi.StringOutput)
}
...
func (o ChannelConnectionOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *ChannelConnection) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}
...
func (o ChannelConnectionOutput) Project() pulumi.StringOutput {
