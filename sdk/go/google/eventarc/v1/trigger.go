...
type Trigger struct {
	...
	Conditions StateConditionResponseOutput `pulumi:"conditions"`
	// The creation time.
...
// The reason(s) why a trigger is in FAILED state.
func (o TriggerOutput) Conditions() StateConditionResponseOutput {
	return o.ApplyT(func(v *Trigger) StateConditionResponseOutput { return v.Conditions }).(StateConditionResponseOutput)
}
