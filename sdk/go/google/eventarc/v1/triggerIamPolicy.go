...
func NewTriggerIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:eventarc/v1:TriggerIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTriggerIamPolicy(ctx *pulumi.Context,
	...
	var resource TriggerIamPolicy
	err := ctx.ReadResource("google-cloud:eventarc/v1:TriggerIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
