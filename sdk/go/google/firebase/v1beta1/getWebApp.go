...
// This checksum is computed by the server based on the value of other fields, and it may be sent with update requests to ensure the client has an up-to-date value before proceeding. Learn more about `etag` in Google's [AIP-154 standard](https://google.aip.dev/154#declarative-friendly-resources). This etag is strongly validated.
func (o LookupWebAppResultOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWebAppResult) string { return v.Etag }).(pulumi.StringOutput)
}

// Timestamp of when the App will be considered expired and cannot be undeleted. This value is only provided if the App is in the `DELETED` state.
func (o LookupWebAppResultOutput) ExpireTime() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWebAppResult) string { return v.ExpireTime }).(pulumi.StringOutput)
}
