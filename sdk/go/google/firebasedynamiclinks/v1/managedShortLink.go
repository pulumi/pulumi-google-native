...
func NewManagedShortLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:firebasedynamiclinks/v1:ManagedShortLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedShortLink(ctx *pulumi.Context,
	...
	var resource ManagedShortLink
	err := ctx.ReadResource("google-cloud:firebasedynamiclinks/v1:ManagedShortLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
