...
func NewShortLink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:firebasedynamiclinks/v1:ShortLink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShortLink(ctx *pulumi.Context,
	...
	var resource ShortLink
	err := ctx.ReadResource("google-cloud:firebasedynamiclinks/v1:ShortLink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
