...
func NewSite(ctx *pulumi.Context,
	...
	var resource Site
	err := ctx.RegisterResource("google-cloud:firebasehosting/v1beta1:Site", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSite(ctx *pulumi.Context,
	...
	var resource Site
	err := ctx.ReadResource("google-cloud:firebasehosting/v1beta1:Site", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
