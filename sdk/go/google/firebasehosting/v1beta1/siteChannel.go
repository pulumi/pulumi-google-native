...
func NewSiteChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:firebasehosting/v1beta1:SiteChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSiteChannel(ctx *pulumi.Context,
	...
	var resource SiteChannel
	err := ctx.ReadResource("google-cloud:firebasehosting/v1beta1:SiteChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
