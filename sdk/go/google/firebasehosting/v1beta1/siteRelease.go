...
func NewSiteRelease(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:firebasehosting/v1beta1:SiteRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSiteRelease(ctx *pulumi.Context,
	...
	var resource SiteRelease
	err := ctx.ReadResource("google-cloud:firebasehosting/v1beta1:SiteRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
