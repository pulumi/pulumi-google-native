...
func NewDatabaseIndex(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:firestore/v1beta1:DatabaseIndex", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseIndex(ctx *pulumi.Context,
	...
	var resource DatabaseIndex
	err := ctx.ReadResource("google-cloud:firestore/v1beta1:DatabaseIndex", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
