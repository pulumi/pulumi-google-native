...
func NewDatabaseCollectionGroupIndex(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:firestore/v1beta2:DatabaseCollectionGroupIndex", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseCollectionGroupIndex(ctx *pulumi.Context,
	...
	var resource DatabaseCollectionGroupIndex
	err := ctx.ReadResource("google-cloud:firestore/v1beta2:DatabaseCollectionGroupIndex", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
