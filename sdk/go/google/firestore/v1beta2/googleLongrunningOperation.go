...
func NewGoogleLongrunningOperation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:firestore/v1beta2:GoogleLongrunningOperation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGoogleLongrunningOperation(ctx *pulumi.Context,
	...
	var resource GoogleLongrunningOperation
	err := ctx.ReadResource("google-cloud:firestore/v1beta2:GoogleLongrunningOperation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
