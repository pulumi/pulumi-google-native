...
func NewGameServerCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:gameservices/v1:GameServerCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGameServerCluster(ctx *pulumi.Context,
	...
	var resource GameServerCluster
	err := ctx.ReadResource("google-cloud:gameservices/v1:GameServerCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
