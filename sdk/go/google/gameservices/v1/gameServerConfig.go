...
func NewGameServerConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:gameservices/v1:GameServerConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGameServerConfig(ctx *pulumi.Context,
	...
	var resource GameServerConfig
	err := ctx.ReadResource("google-cloud:gameservices/v1:GameServerConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
