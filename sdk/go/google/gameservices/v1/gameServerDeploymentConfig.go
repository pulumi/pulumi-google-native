...
func NewGameServerDeploymentConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:gameservices/v1:GameServerDeploymentConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGameServerDeploymentConfig(ctx *pulumi.Context,
	...
	var resource GameServerDeploymentConfig
	err := ctx.ReadResource("google-cloud:gameservices/v1:GameServerDeploymentConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
