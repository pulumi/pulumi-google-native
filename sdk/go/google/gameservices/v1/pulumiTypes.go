...
func (o PolicyOutput) IamOwned() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v Policy) *bool { return v.IamOwned }).(pulumi.BoolPtrOutput)
}

// If more than one rule is specified, the rules are applied in the following manner: - All matching LOG rules are always applied. - If any DENY/DENY_WITH_LOG rule matches, permission is denied. Logging will be applied if one or more matching rule requires logging. - Otherwise, if any ALLOW/ALLOW_WITH_LOG rule matches, permission is granted. Logging will be applied if one or more matching rule requires logging. - Otherwise, if no rule applies, permission is denied.
func (o PolicyOutput) Rules() RuleArrayOutput {
	return o.ApplyT(func(v Policy) []Rule { return v.Rules }).(RuleArrayOutput)
}
...
func (o PolicyPtrOutput) IamOwned() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Policy) *bool {
		if v == nil {
			return nil
		}
		return v.IamOwned
...
// If more than one rule is specified, the rules are applied in the following manner: - All matching LOG rules are always applied. - If any DENY/DENY_WITH_LOG rule matches, permission is denied. Logging will be applied if one or more matching rule requires logging. - Otherwise, if any ALLOW/ALLOW_WITH_LOG rule matches, permission is granted. Logging will be applied if one or more matching rule requires logging. - Otherwise, if no rule applies, permission is denied.
func (o PolicyPtrOutput) Rules() RuleArrayOutput {
	return o.ApplyT(func(v *Policy) []Rule {
		if v == nil {
			return nil
		}
		return v.Rules
