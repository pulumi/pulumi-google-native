...
func NewGameServerDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:gameservices/v1beta:GameServerDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGameServerDeployment(ctx *pulumi.Context,
	...
	var resource GameServerDeployment
	err := ctx.ReadResource("google-cloud:gameservices/v1beta:GameServerDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
