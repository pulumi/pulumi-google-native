...
func NewGameServerDeploymentConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gameservices/v1beta:GameServerDeploymentConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGameServerDeploymentConfig(ctx *pulumi.Context,
	...
	var resource GameServerDeploymentConfig
	err := ctx.ReadResource("google-native:gameservices/v1beta:GameServerDeploymentConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
