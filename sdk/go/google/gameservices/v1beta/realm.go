...
func NewRealm(ctx *pulumi.Context,
	...
	var resource Realm
	err := ctx.RegisterResource("google-cloud:gameservices/v1beta:Realm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRealm(ctx *pulumi.Context,
	...
	var resource Realm
	err := ctx.ReadResource("google-cloud:gameservices/v1beta:Realm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
