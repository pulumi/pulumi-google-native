...
func NewRealmGameServerCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:gameservices/v1beta:RealmGameServerCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRealmGameServerCluster(ctx *pulumi.Context,
	...
	var resource RealmGameServerCluster
	err := ctx.ReadResource("google-cloud:gameservices/v1beta:RealmGameServerCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
