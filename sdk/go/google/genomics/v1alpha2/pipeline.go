...
func NewPipeline(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:genomics/v1alpha2:Pipeline", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPipeline(ctx *pulumi.Context,
	...
	var resource Pipeline
	err := ctx.ReadResource("google-cloud:genomics/v1alpha2:Pipeline", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
