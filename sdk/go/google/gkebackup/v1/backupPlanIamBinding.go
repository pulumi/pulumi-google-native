...
func NewBackupPlanIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkebackup/v1:BackupPlanIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPlanIamBinding(ctx *pulumi.Context,
	...
	var resource BackupPlanIamBinding
	err := ctx.ReadResource("google-native:gkebackup/v1:BackupPlanIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o BackupPlanIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *BackupPlanIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
