...
func NewRestorePlanIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkebackup/v1:RestorePlanIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRestorePlanIamMember(ctx *pulumi.Context,
	...
	var resource RestorePlanIamMember
	err := ctx.ReadResource("google-native:gkebackup/v1:RestorePlanIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o RestorePlanIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *RestorePlanIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
