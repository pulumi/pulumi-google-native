...
func NewFeatureIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1:FeatureIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureIamMember(ctx *pulumi.Context,
	...
	var resource FeatureIamMember
	err := ctx.ReadResource("google-native:gkehub/v1:FeatureIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
