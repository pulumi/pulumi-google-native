...
func NewFeatureIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1:FeatureIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureIamPolicy(ctx *pulumi.Context,
	...
	var resource FeatureIamPolicy
	err := ctx.ReadResource("google-native:gkehub/v1:FeatureIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
