...
func NewMembershipIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1:MembershipIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMembershipIamMember(ctx *pulumi.Context,
	...
	var resource MembershipIamMember
	err := ctx.ReadResource("google-native:gkehub/v1:MembershipIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
