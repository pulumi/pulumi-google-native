...
func NewMembershipIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1:MembershipIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMembershipIamPolicy(ctx *pulumi.Context,
	...
	var resource MembershipIamPolicy
	err := ctx.ReadResource("google-native:gkehub/v1:MembershipIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
