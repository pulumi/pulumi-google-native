...
func NewScope(ctx *pulumi.Context,
	...
	var resource Scope
	err := ctx.RegisterResource("google-native:gkehub/v1:Scope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScope(ctx *pulumi.Context,
	...
	var resource Scope
	err := ctx.ReadResource("google-native:gkehub/v1:Scope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
