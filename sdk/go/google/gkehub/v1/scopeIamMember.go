...
func NewScopeIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1:ScopeIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeIamMember(ctx *pulumi.Context,
	...
	var resource ScopeIamMember
	err := ctx.ReadResource("google-native:gkehub/v1:ScopeIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
