...
func NewBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1alpha:Binding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBinding(ctx *pulumi.Context,
	...
	var resource Binding
	err := ctx.ReadResource("google-native:gkehub/v1alpha:Binding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
