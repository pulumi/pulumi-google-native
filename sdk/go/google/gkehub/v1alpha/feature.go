...
func NewFeature(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:gkehub/v1alpha:Feature", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeature(ctx *pulumi.Context,
	...
	var resource Feature
	err := ctx.ReadResource("google-cloud:gkehub/v1alpha:Feature", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
