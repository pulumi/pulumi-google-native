...
func NewFeatureIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1alpha:FeatureIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureIamBinding(ctx *pulumi.Context,
	...
	var resource FeatureIamBinding
	err := ctx.ReadResource("google-native:gkehub/v1alpha:FeatureIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
