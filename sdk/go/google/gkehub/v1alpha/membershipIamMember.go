...
func NewMembershipIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1alpha:MembershipIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMembershipIamMember(ctx *pulumi.Context,
	...
	var resource MembershipIamMember
	err := ctx.ReadResource("google-native:gkehub/v1alpha:MembershipIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *MembershipIamMember) ToOutput(ctx context.Context) pulumix.Output[*MembershipIamMember] {
	return pulumix.Output[*MembershipIamMember]{
		OutputState: i.ToMembershipIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o MembershipIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*MembershipIamMember] {
	return pulumix.Output[*MembershipIamMember]{
