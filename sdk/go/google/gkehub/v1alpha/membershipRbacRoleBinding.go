...
func NewMembershipRbacRoleBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1alpha:MembershipRbacRoleBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMembershipRbacRoleBinding(ctx *pulumi.Context,
	...
	var resource MembershipRbacRoleBinding
	err := ctx.ReadResource("google-native:gkehub/v1alpha:MembershipRbacRoleBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
