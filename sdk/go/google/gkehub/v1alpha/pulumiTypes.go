...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CloudAuditLoggingFeatureSpecResponseInput)(nil)).Elem(), CloudAuditLoggingFeatureSpecResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CloudAuditLoggingFeatureSpecResponsePtrInput)(nil)).Elem(), CloudAuditLoggingFeatureSpecResponseArgs{})
