...
func NewScopeIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1alpha:ScopeIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeIamBinding(ctx *pulumi.Context,
	...
	var resource ScopeIamBinding
	err := ctx.ReadResource("google-native:gkehub/v1alpha:ScopeIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
