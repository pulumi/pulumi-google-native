...
func NewScopeRbacRoleBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1alpha:ScopeRbacRoleBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeRbacRoleBinding(ctx *pulumi.Context,
	...
	var resource ScopeRbacRoleBinding
	err := ctx.ReadResource("google-native:gkehub/v1alpha:ScopeRbacRoleBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
