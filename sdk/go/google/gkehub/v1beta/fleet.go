...
func NewFleet(ctx *pulumi.Context,
	...
	var resource Fleet
	err := ctx.RegisterResource("google-native:gkehub/v1beta:Fleet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleet(ctx *pulumi.Context,
	...
	var resource Fleet
	err := ctx.ReadResource("google-native:gkehub/v1beta:Fleet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
