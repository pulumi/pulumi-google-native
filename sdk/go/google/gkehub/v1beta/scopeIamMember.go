...
func NewScopeIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1beta:ScopeIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeIamMember(ctx *pulumi.Context,
	...
	var resource ScopeIamMember
	err := ctx.ReadResource("google-native:gkehub/v1beta:ScopeIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o ScopeIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *ScopeIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o ScopeIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *ScopeIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
