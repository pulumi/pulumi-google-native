...
func NewScopeIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1beta:ScopeIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScopeIamPolicy(ctx *pulumi.Context,
	...
	var resource ScopeIamPolicy
	err := ctx.ReadResource("google-native:gkehub/v1beta:ScopeIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
