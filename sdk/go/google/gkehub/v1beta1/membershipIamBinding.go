...
func NewMembershipIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:gkehub/v1beta1:MembershipIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMembershipIamBinding(ctx *pulumi.Context,
	...
	var resource MembershipIamBinding
	err := ctx.ReadResource("google-native:gkehub/v1beta1:MembershipIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
