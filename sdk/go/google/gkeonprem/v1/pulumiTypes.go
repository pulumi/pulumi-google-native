...
type BareMetalParallelUpgradeConfigArgs struct {
	// The maximum number of nodes that can be upgraded at once. Defaults to 1.
	ConcurrentNodes pulumi.IntInput `pulumi:"concurrentNodes"`
	// The minimum number of nodes that should be healthy and available during an upgrade. If set to the default value of 0, it is possible that none of the nodes will be available during an upgrade.
...
// The maximum number of nodes that can be upgraded at once. Defaults to 1.
func (o BareMetalParallelUpgradeConfigOutput) ConcurrentNodes() pulumi.IntOutput {
	return o.ApplyT(func(v BareMetalParallelUpgradeConfig) int { return v.ConcurrentNodes }).(pulumi.IntOutput)
}
