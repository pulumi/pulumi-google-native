...
func (i *VmwareClusterIamBinding) ToOutput(ctx context.Context) pulumix.Output[*VmwareClusterIamBinding] {
	return pulumix.Output[*VmwareClusterIamBinding]{
		OutputState: i.ToVmwareClusterIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o VmwareClusterIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*VmwareClusterIamBinding] {
	return pulumix.Output[*VmwareClusterIamBinding]{
