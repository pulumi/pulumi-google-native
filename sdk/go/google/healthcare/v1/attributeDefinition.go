...
func NewAttributeDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:AttributeDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttributeDefinition(ctx *pulumi.Context,
	...
	var resource AttributeDefinition
	err := ctx.ReadResource("google-cloud:healthcare/v1:AttributeDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
