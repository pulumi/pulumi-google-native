...
func NewConsent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:Consent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsent(ctx *pulumi.Context,
	...
	var resource Consent
	err := ctx.ReadResource("google-cloud:healthcare/v1:Consent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
