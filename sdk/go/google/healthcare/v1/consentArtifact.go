...
func NewConsentArtifact(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:ConsentArtifact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsentArtifact(ctx *pulumi.Context,
	...
	var resource ConsentArtifact
	err := ctx.ReadResource("google-cloud:healthcare/v1:ConsentArtifact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
