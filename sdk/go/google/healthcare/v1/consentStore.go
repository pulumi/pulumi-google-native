...
func NewConsentStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:ConsentStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsentStore(ctx *pulumi.Context,
	...
	var resource ConsentStore
	err := ctx.ReadResource("google-cloud:healthcare/v1:ConsentStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
