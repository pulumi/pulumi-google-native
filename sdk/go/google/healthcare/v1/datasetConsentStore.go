...
func NewDatasetConsentStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1:DatasetConsentStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStore(ctx *pulumi.Context,
	...
	var resource DatasetConsentStore
	err := ctx.ReadResource("google-native:healthcare/v1:DatasetConsentStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
