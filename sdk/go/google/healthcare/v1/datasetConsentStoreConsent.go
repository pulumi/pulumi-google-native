...
func NewDatasetConsentStoreConsent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:DatasetConsentStoreConsent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreConsent(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreConsent
	err := ctx.ReadResource("google-cloud:healthcare/v1:DatasetConsentStoreConsent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
