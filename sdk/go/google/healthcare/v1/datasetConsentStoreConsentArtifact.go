...
func NewDatasetConsentStoreConsentArtifact(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1:DatasetConsentStoreConsentArtifact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreConsentArtifact(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreConsentArtifact
	err := ctx.ReadResource("google-native:healthcare/v1:DatasetConsentStoreConsentArtifact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
