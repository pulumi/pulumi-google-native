...
func NewDatasetConsentStoreConsentArtifact(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:DatasetConsentStoreConsentArtifact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreConsentArtifact(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreConsentArtifact
	err := ctx.ReadResource("google-cloud:healthcare/v1:DatasetConsentStoreConsentArtifact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
