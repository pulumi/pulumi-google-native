...
func NewDatasetConsentStoreIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:DatasetConsentStoreIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreIamPolicy(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreIamPolicy
	err := ctx.ReadResource("google-cloud:healthcare/v1:DatasetConsentStoreIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
