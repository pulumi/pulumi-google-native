...
func NewDatasetFhirStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1:DatasetFhirStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetFhirStore(ctx *pulumi.Context,
	...
	var resource DatasetFhirStore
	err := ctx.ReadResource("google-native:healthcare/v1:DatasetFhirStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
