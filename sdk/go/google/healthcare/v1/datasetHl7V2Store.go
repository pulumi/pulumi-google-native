...
func NewDatasetHl7V2Store(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1:DatasetHl7V2Store", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetHl7V2Store(ctx *pulumi.Context,
	...
	var resource DatasetHl7V2Store
	err := ctx.ReadResource("google-native:healthcare/v1:DatasetHl7V2Store", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
