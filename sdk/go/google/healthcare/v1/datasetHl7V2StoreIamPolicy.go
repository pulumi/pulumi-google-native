...
func NewDatasetHl7V2StoreIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:DatasetHl7V2StoreIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetHl7V2StoreIamPolicy(ctx *pulumi.Context,
	...
	var resource DatasetHl7V2StoreIamPolicy
	err := ctx.ReadResource("google-cloud:healthcare/v1:DatasetHl7V2StoreIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
