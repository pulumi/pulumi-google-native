...
func NewDatasetHl7V2StoreMessage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:DatasetHl7V2StoreMessage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetHl7V2StoreMessage(ctx *pulumi.Context,
	...
	var resource DatasetHl7V2StoreMessage
	err := ctx.ReadResource("google-cloud:healthcare/v1:DatasetHl7V2StoreMessage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
