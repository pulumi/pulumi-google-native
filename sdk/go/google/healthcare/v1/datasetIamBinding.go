...
func NewDatasetIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1:DatasetIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetIamBinding(ctx *pulumi.Context,
	...
	var resource DatasetIamBinding
	err := ctx.ReadResource("google-native:healthcare/v1:DatasetIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o DatasetIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *DatasetIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o DatasetIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *DatasetIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
