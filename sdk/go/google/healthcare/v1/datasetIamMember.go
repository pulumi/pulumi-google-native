...
func NewDatasetIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1:DatasetIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetIamMember(ctx *pulumi.Context,
	...
	var resource DatasetIamMember
	err := ctx.ReadResource("google-native:healthcare/v1:DatasetIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o DatasetIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *DatasetIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o DatasetIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *DatasetIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
