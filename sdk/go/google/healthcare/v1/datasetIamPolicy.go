...
func NewDatasetIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1:DatasetIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetIamPolicy(ctx *pulumi.Context,
	...
	var resource DatasetIamPolicy
	err := ctx.ReadResource("google-native:healthcare/v1:DatasetIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
