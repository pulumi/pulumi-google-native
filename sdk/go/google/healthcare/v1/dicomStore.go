...
func NewDicomStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:DicomStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDicomStore(ctx *pulumi.Context,
	...
	var resource DicomStore
	err := ctx.ReadResource("google-cloud:healthcare/v1:DicomStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
