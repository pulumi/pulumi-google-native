...
// Optional. Represents a user's consent in terms of the resources that can be accessed and under what conditions.
func (o LookupConsentResultOutput) Policies() GoogleCloudHealthcareV1ConsentPolicyResponseArrayOutput {
	return o.ApplyT(func(v LookupConsentResult) []GoogleCloudHealthcareV1ConsentPolicyResponse { return v.Policies }).(GoogleCloudHealthcareV1ConsentPolicyResponseArrayOutput)
}
