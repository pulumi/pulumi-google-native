...
func (o LookupDatasetConsentStoreIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDatasetConsentStoreIamPolicyResult] {
	return pulumix.Output[LookupDatasetConsentStoreIamPolicyResult]{
