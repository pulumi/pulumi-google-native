...
func LookupDatasetFhirStoreIamPolicy(ctx *pulumi.Context, args *LookupDatasetFhirStoreIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupDatasetFhirStoreIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:healthcare/v1:getDatasetFhirStoreIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupDatasetFhirStoreIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDatasetFhirStoreIamPolicyResult] {
	return pulumix.Output[LookupDatasetFhirStoreIamPolicyResult]{
