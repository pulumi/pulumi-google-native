...
func (o LookupDatasetHl7V2StoreIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDatasetHl7V2StoreIamPolicyResult] {
	return pulumix.Output[LookupDatasetHl7V2StoreIamPolicyResult]{
