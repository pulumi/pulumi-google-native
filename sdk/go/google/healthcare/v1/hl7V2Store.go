...
func NewHl7V2Store(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1:Hl7V2Store", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHl7V2Store(ctx *pulumi.Context,
	...
	var resource Hl7V2Store
	err := ctx.ReadResource("google-cloud:healthcare/v1:Hl7V2Store", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
