...
func NewAnnotation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:Annotation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnnotation(ctx *pulumi.Context,
	...
	var resource Annotation
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:Annotation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
