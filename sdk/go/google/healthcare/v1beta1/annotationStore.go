...
func NewAnnotationStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:AnnotationStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnnotationStore(ctx *pulumi.Context,
	...
	var resource AnnotationStore
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:AnnotationStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
