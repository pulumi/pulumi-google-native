...
func GetConsent(ctx *pulumi.Context,
	...
	var resource Consent
	err := ctx.ReadResource("google-native:healthcare/v1beta1:Consent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Optional. Represents a user's consent in terms of the resources that can be accessed and under what conditions.
func (o ConsentOutput) Policies() GoogleCloudHealthcareV1beta1ConsentPolicyResponseArrayOutput {
	return o.ApplyT(func(v *Consent) GoogleCloudHealthcareV1beta1ConsentPolicyResponseArrayOutput { return v.Policies }).(GoogleCloudHealthcareV1beta1ConsentPolicyResponseArrayOutput)
}
