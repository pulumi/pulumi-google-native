...
func NewDatasetAnnotationStoreIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:DatasetAnnotationStoreIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetAnnotationStoreIamPolicy(ctx *pulumi.Context,
	...
	var resource DatasetAnnotationStoreIamPolicy
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:DatasetAnnotationStoreIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
