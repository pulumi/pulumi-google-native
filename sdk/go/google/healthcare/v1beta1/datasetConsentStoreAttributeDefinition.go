...
func NewDatasetConsentStoreAttributeDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1beta1:DatasetConsentStoreAttributeDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreAttributeDefinition(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreAttributeDefinition
	err := ctx.ReadResource("google-native:healthcare/v1beta1:DatasetConsentStoreAttributeDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
