...
func GetDatasetConsentStoreConsent(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreConsent
	err := ctx.ReadResource("google-native:healthcare/v1beta1:DatasetConsentStoreConsent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type DatasetConsentStoreConsentState struct {
	...
	// Optional. Represents a user's consent in terms of the resources that can be accessed and under what conditions.
	Policies GoogleCloudHealthcareV1beta1ConsentPolicyResponseArrayInput
	// The timestamp that the revision was created.
