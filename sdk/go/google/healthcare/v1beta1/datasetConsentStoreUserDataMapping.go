...
func NewDatasetConsentStoreUserDataMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:DatasetConsentStoreUserDataMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetConsentStoreUserDataMapping(ctx *pulumi.Context,
	...
	var resource DatasetConsentStoreUserDataMapping
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:DatasetConsentStoreUserDataMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
