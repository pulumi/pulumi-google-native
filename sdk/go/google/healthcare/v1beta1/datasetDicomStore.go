...
func NewDatasetDicomStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:DatasetDicomStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetDicomStore(ctx *pulumi.Context,
	...
	var resource DatasetDicomStore
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:DatasetDicomStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
