...
func NewDatasetDicomStoreIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:DatasetDicomStoreIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetDicomStoreIamPolicy(ctx *pulumi.Context,
	...
	var resource DatasetDicomStoreIamPolicy
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:DatasetDicomStoreIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
