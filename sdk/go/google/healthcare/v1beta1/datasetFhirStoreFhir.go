...
func NewDatasetFhirStoreFhir(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1beta1:DatasetFhirStoreFhir", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetFhirStoreFhir(ctx *pulumi.Context,
	...
	var resource DatasetFhirStoreFhir
	err := ctx.ReadResource("google-native:healthcare/v1beta1:DatasetFhirStoreFhir", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
