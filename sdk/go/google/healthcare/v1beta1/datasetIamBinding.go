...
func NewDatasetIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1beta1:DatasetIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetIamBinding(ctx *pulumi.Context,
	...
	var resource DatasetIamBinding
	err := ctx.ReadResource("google-native:healthcare/v1beta1:DatasetIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
