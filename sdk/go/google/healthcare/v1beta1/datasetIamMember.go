...
func NewDatasetIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:healthcare/v1beta1:DatasetIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatasetIamMember(ctx *pulumi.Context,
	...
	var resource DatasetIamMember
	err := ctx.ReadResource("google-native:healthcare/v1beta1:DatasetIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
