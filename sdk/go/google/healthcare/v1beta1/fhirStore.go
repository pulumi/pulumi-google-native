...
func NewFhirStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:FhirStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFhirStore(ctx *pulumi.Context,
	...
	var resource FhirStore
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:FhirStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
