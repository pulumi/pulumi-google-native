...
func (o LookupFhirStoreResultOutput) ComplexDataTypeReferenceParsing() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFhirStoreResult) string { return v.ComplexDataTypeReferenceParsing }).(pulumi.StringOutput)
}

// Optional. Specifies whether this store has consent enforcement. Not available for DSTU2 FHIR version due to absence of Consent resources.
func (o LookupFhirStoreResultOutput) ConsentConfig() ConsentConfigResponseOutput {
	return o.ApplyT(func(v LookupFhirStoreResult) ConsentConfigResponse { return v.ConsentConfig }).(ConsentConfigResponseOutput)
}
...
// Optional. Whether to allow ExecuteBundle to accept history bundles, and directly insert and overwrite historical resource versions into the FHIR store. If set to false, using history bundles fails with an error.
func (o LookupFhirStoreResultOutput) EnableHistoryModifications() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupFhirStoreResult) bool { return v.EnableHistoryModifications }).(pulumi.BoolOutput)
}
...
// Specifies where and whether to send notifications upon changes to a Fhir store.
func (o LookupFhirStoreResultOutput) NotificationConfigs() FhirNotificationConfigResponseArrayOutput {
	return o.ApplyT(func(v LookupFhirStoreResult) []FhirNotificationConfigResponse { return v.NotificationConfigs }).(FhirNotificationConfigResponseArrayOutput)
}

// Configuration for how FHIR resources can be searched.
func (o LookupFhirStoreResultOutput) SearchConfig() SearchConfigResponseOutput {
	return o.ApplyT(func(v LookupFhirStoreResult) SearchConfigResponse { return v.SearchConfig }).(SearchConfigResponseOutput)
}
