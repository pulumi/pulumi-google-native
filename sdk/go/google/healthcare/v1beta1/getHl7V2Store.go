...
func LookupHl7V2Store(ctx *pulumi.Context, args *LookupHl7V2StoreArgs, opts ...pulumi.InvokeOption) (*LookupHl7V2StoreResult, error) {
	...
	err := ctx.Invoke("google-native:healthcare/v1beta1:getHl7V2Store", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The notification destination all messages (both Ingest & Create) are published on. Only the message name is sent as part of the notification. If this is unset, no notifications are sent. Supplied by the client.
func (o LookupHl7V2StoreResultOutput) NotificationConfig() NotificationConfigResponseOutput {
	return o.ApplyT(func(v LookupHl7V2StoreResult) NotificationConfigResponse { return v.NotificationConfig }).(NotificationConfigResponseOutput)
}
