...
func GetHl7V2Store(ctx *pulumi.Context,
	...
	var resource Hl7V2Store
	err := ctx.ReadResource("google-native:healthcare/v1beta1:Hl7V2Store", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o Hl7V2StoreOutput) NotificationConfig() NotificationConfigResponseOutput {
	return o.ApplyT(func(v *Hl7V2Store) NotificationConfigResponseOutput { return v.NotificationConfig }).(NotificationConfigResponseOutput)
}
