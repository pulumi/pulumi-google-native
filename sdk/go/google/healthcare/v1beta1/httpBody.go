...
func NewHttpBody(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:HttpBody", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHttpBody(ctx *pulumi.Context,
	...
	var resource HttpBody
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:HttpBody", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
