...
func NewMessage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:Message", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMessage(ctx *pulumi.Context,
	...
	var resource Message
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:Message", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
