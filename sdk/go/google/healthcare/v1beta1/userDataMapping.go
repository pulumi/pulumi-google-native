...
func NewUserDataMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:healthcare/v1beta1:UserDataMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserDataMapping(ctx *pulumi.Context,
	...
	var resource UserDataMapping
	err := ctx.ReadResource("google-cloud:healthcare/v1beta1:UserDataMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
