...
func LookupServiceAccountIamPolicyOutput(ctx *pulumi.Context, args LookupServiceAccountIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupServiceAccountIamPolicyResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupServiceAccountIamPolicyResult, error) {
			args := v.(LookupServiceAccountIamPolicyArgs)
			r, err := LookupServiceAccountIamPolicy(ctx, &args, opts...)
			var s LookupServiceAccountIamPolicyResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o LookupServiceAccountIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupServiceAccountIamPolicyResult] {
	return pulumix.Output[LookupServiceAccountIamPolicyResult]{
...
func (o LookupServiceAccountIamPolicyResultOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v LookupServiceAccountIamPolicyResult) []AuditConfigResponse { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}

// Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
func (o LookupServiceAccountIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupServiceAccountIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupServiceAccountIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupServiceAccountIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
