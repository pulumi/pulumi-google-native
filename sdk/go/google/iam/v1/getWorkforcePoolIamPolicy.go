...
func LookupWorkforcePoolIamPolicyOutput(ctx *pulumi.Context, args LookupWorkforcePoolIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupWorkforcePoolIamPolicyResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupWorkforcePoolIamPolicyResult, error) {
			args := v.(LookupWorkforcePoolIamPolicyArgs)
			r, err := LookupWorkforcePoolIamPolicy(ctx, &args, opts...)
			var s LookupWorkforcePoolIamPolicyResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o LookupWorkforcePoolIamPolicyResultOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v LookupWorkforcePoolIamPolicyResult) []AuditConfigResponse { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}

// Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
func (o LookupWorkforcePoolIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupWorkforcePoolIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupWorkforcePoolIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupWorkforcePoolIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
