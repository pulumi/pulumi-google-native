...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AwsResponseInput)(nil)).Elem(), AwsResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AwsResponsePtrInput)(nil)).Elem(), AwsResponseArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OidcResponseInput)(nil)).Elem(), OidcResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*OidcResponsePtrInput)(nil)).Elem(), OidcResponseArgs{})
