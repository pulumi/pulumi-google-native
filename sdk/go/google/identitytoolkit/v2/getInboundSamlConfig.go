...
func (o LookupInboundSamlConfigResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupInboundSamlConfigResult] {
	return pulumix.Output[LookupInboundSamlConfigResult]{
