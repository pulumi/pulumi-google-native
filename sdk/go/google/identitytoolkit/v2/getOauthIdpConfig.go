...
func (o LookupOauthIdpConfigResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOauthIdpConfigResult] {
	return pulumix.Output[LookupOauthIdpConfigResult]{
