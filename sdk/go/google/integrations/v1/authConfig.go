...
func NewAuthConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:integrations/v1:AuthConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthConfig(ctx *pulumi.Context,
	...
	var resource AuthConfig
	err := ctx.ReadResource("google-native:integrations/v1:AuthConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
