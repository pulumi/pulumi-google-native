...
func NewCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:integrations/v1:Certificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificate(ctx *pulumi.Context,
	...
	var resource Certificate
	err := ctx.ReadResource("google-native:integrations/v1:Certificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
