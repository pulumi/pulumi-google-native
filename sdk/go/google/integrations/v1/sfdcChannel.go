...
func NewSfdcChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:integrations/v1:SfdcChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSfdcChannel(ctx *pulumi.Context,
	...
	var resource SfdcChannel
	err := ctx.ReadResource("google-native:integrations/v1:SfdcChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
