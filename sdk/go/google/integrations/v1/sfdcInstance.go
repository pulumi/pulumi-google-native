...
func NewSfdcInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:integrations/v1:SfdcInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSfdcInstance(ctx *pulumi.Context,
	...
	var resource SfdcInstance
	err := ctx.ReadResource("google-native:integrations/v1:SfdcInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
