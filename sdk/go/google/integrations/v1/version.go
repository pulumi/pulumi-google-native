...
func NewVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:integrations/v1:Version", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVersion(ctx *pulumi.Context,
	...
	var resource Version
	err := ctx.ReadResource("google-native:integrations/v1:Version", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
