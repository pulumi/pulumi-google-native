...
func NewCompany(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:jobs/v4:Company", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCompany(ctx *pulumi.Context,
	...
	var resource Company
	err := ctx.ReadResource("google-cloud:jobs/v4:Company", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
