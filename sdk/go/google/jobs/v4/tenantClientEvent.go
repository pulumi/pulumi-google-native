...
func NewTenantClientEvent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:jobs/v4:TenantClientEvent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTenantClientEvent(ctx *pulumi.Context,
	...
	var resource TenantClientEvent
	err := ctx.ReadResource("google-cloud:jobs/v4:TenantClientEvent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
