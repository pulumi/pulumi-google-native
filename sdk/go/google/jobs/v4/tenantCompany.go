...
func NewTenantCompany(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:jobs/v4:TenantCompany", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTenantCompany(ctx *pulumi.Context,
	...
	var resource TenantCompany
	err := ctx.ReadResource("google-native:jobs/v4:TenantCompany", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
