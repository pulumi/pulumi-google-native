...
func NewTenantJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:jobs/v4:TenantJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTenantJob(ctx *pulumi.Context,
	...
	var resource TenantJob
	err := ctx.ReadResource("google-cloud:jobs/v4:TenantJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
