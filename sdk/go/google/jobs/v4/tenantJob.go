...
// NewTenantJob registers a new resource with the given unique name, arguments, and options.
func NewTenantJob(ctx *pulumi.Context,
	name string, args *TenantJobArgs, opts ...pulumi.ResourceOption) (*TenantJob, error) {
	if args == nil {
	...
	var resource TenantJob
	err := ctx.RegisterResource("google-native:jobs/v4:TenantJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetTenantJob gets an existing TenantJob resource's state with the given name, ID, and optional
// state properties that are used to uniquely qualify the lookup (nil if not required).
func GetTenantJob(ctx *pulumi.Context,
	name string, id pulumi.IDInput, state *TenantJobState, opts ...pulumi.ResourceOption) (*TenantJob, error) {
	var resource TenantJob
	err := ctx.ReadResource("google-native:jobs/v4:TenantJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering TenantJob resources.
...
func (TenantJobState) ElementType() reflect.Type {
	return reflect.TypeOf((*tenantJobState)(nil)).Elem()
}
...
func (TenantJobArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*tenantJobArgs)(nil)).Elem()
}

type TenantJobInput interface {
	pulumi.Input

	ToTenantJobOutput() TenantJobOutput
	ToTenantJobOutputWithContext(ctx context.Context) TenantJobOutput
}

func (*TenantJob) ElementType() reflect.Type {
	return reflect.TypeOf((*TenantJob)(nil))
}

func (i *TenantJob) ToTenantJobOutput() TenantJobOutput {
	return i.ToTenantJobOutputWithContext(context.Background())
}

func (i *TenantJob) ToTenantJobOutputWithContext(ctx context.Context) TenantJobOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TenantJobOutput)
}

type TenantJobOutput struct {
	*pulumi.OutputState
}

func (TenantJobOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*TenantJob)(nil))
}

func (o TenantJobOutput) ToTenantJobOutput() TenantJobOutput {
	return o
}

func (o TenantJobOutput) ToTenantJobOutputWithContext(ctx context.Context) TenantJobOutput {
	return o
}

func init() {
	pulumi.RegisterOutputType(TenantJobOutput{})
}
