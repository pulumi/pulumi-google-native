...
func (i *BillingAccountBucketLink) ToOutput(ctx context.Context) pulumix.Output[*BillingAccountBucketLink] {
	return pulumix.Output[*BillingAccountBucketLink]{
		OutputState: i.ToBillingAccountBucketLinkOutputWithContext(ctx).OutputState,
	}
}
...
func (o BillingAccountBucketLinkOutput) ToOutput(ctx context.Context) pulumix.Output[*BillingAccountBucketLink] {
	return pulumix.Output[*BillingAccountBucketLink]{
