...
func NewBillingAccountExclusion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:BillingAccountExclusion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingAccountExclusion(ctx *pulumi.Context,
	...
	var resource BillingAccountExclusion
	err := ctx.ReadResource("google-cloud:logging/v2:BillingAccountExclusion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
