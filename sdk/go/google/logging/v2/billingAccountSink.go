...
func NewBillingAccountSink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:BillingAccountSink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingAccountSink(ctx *pulumi.Context,
	...
	var resource BillingAccountSink
	err := ctx.ReadResource("google-cloud:logging/v2:BillingAccountSink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
