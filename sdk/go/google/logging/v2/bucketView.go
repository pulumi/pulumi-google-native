...
func NewBucketView(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:BucketView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketView(ctx *pulumi.Context,
	...
	var resource BucketView
	err := ctx.ReadResource("google-cloud:logging/v2:BucketView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
