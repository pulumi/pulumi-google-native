...
func NewFolderBucket(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:FolderBucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderBucket(ctx *pulumi.Context,
	...
	var resource FolderBucket
	err := ctx.ReadResource("google-cloud:logging/v2:FolderBucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
