...
func NewFolderBucketView(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:FolderBucketView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderBucketView(ctx *pulumi.Context,
	...
	var resource FolderBucketView
	err := ctx.ReadResource("google-cloud:logging/v2:FolderBucketView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
