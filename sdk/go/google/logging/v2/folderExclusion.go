...
func NewFolderExclusion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:FolderExclusion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderExclusion(ctx *pulumi.Context,
	...
	var resource FolderExclusion
	err := ctx.ReadResource("google-cloud:logging/v2:FolderExclusion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
