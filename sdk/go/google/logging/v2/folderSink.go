...
func NewFolderSink(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:FolderSink", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderSink(ctx *pulumi.Context,
	...
	var resource FolderSink
	err := ctx.ReadResource("google-cloud:logging/v2:FolderSink", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
