...
func (o LookupFolderBucketViewResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFolderBucketViewResult] {
	return pulumix.Output[LookupFolderBucketViewResult]{
