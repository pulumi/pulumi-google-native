...
func (o LookupOrganizationBucketResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOrganizationBucketResult] {
	return pulumix.Output[LookupOrganizationBucketResult]{
