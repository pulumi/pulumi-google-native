...
func (o LookupOrganizationExclusionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOrganizationExclusionResult] {
	return pulumix.Output[LookupOrganizationExclusionResult]{
