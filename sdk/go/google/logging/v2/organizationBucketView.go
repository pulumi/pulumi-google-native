...
func NewOrganizationBucketView(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:OrganizationBucketView", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationBucketView(ctx *pulumi.Context,
	...
	var resource OrganizationBucketView
	err := ctx.ReadResource("google-cloud:logging/v2:OrganizationBucketView", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
