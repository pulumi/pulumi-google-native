...
func NewOrganizationExclusion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:logging/v2:OrganizationExclusion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationExclusion(ctx *pulumi.Context,
	...
	var resource OrganizationExclusion
	err := ctx.ReadResource("google-cloud:logging/v2:OrganizationExclusion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
