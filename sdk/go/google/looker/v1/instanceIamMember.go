...
func NewInstanceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:looker/v1:InstanceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceIamMember(ctx *pulumi.Context,
	...
	var resource InstanceIamMember
	err := ctx.ReadResource("google-native:looker/v1:InstanceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
