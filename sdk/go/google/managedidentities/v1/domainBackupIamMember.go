...
func NewDomainBackupIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:managedidentities/v1:DomainBackupIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainBackupIamMember(ctx *pulumi.Context,
	...
	var resource DomainBackupIamMember
	err := ctx.ReadResource("google-native:managedidentities/v1:DomainBackupIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
