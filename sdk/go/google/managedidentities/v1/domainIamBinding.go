...
func (i *DomainIamBinding) ToOutput(ctx context.Context) pulumix.Output[*DomainIamBinding] {
	return pulumix.Output[*DomainIamBinding]{
		OutputState: i.ToDomainIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o DomainIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*DomainIamBinding] {
	return pulumix.Output[*DomainIamBinding]{
