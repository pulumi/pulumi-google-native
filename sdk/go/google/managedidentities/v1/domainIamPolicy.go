...
func (i *DomainIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*DomainIamPolicy] {
	return pulumix.Output[*DomainIamPolicy]{
		OutputState: i.ToDomainIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o DomainIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*DomainIamPolicy] {
	return pulumix.Output[*DomainIamPolicy]{
...
func (o DomainIamPolicyOutput) DomainId() pulumi.StringOutput {
	return o.ApplyT(func(v *DomainIamPolicy) pulumi.StringOutput { return v.DomainId }).(pulumi.StringOutput)
}
...
func (o DomainIamPolicyOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *DomainIamPolicy) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}
