...
func NewPeering(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:managedidentities/v1:Peering", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeering(ctx *pulumi.Context,
	...
	var resource Peering
	err := ctx.ReadResource("google-native:managedidentities/v1:Peering", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
