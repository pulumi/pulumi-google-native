...
func NewPeeringIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:managedidentities/v1alpha1:PeeringIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeeringIamPolicy(ctx *pulumi.Context,
	...
	var resource PeeringIamPolicy
	err := ctx.ReadResource("google-native:managedidentities/v1alpha1:PeeringIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
