...
func (o TrustResponseOutput) ToOutput(ctx context.Context) pulumix.Output[TrustResponse] {
	return pulumix.Output[TrustResponse]{
		OutputState: o.OutputState,
	}
}
...
func (o TrustResponseArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]TrustResponse] {
	return pulumix.Output[[]TrustResponse]{
		OutputState: o.OutputState,
	}
}
