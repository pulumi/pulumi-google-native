...
func NewDomainIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:managedidentities/v1beta1:DomainIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainIamBinding(ctx *pulumi.Context,
	...
	var resource DomainIamBinding
	err := ctx.ReadResource("google-native:managedidentities/v1beta1:DomainIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
