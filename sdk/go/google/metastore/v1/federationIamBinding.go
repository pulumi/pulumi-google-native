...
func NewFederationIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1:FederationIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFederationIamBinding(ctx *pulumi.Context,
	...
	var resource FederationIamBinding
	err := ctx.ReadResource("google-native:metastore/v1:FederationIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *FederationIamBinding) ToOutput(ctx context.Context) pulumix.Output[*FederationIamBinding] {
	return pulumix.Output[*FederationIamBinding]{
		OutputState: i.ToFederationIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o FederationIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*FederationIamBinding] {
	return pulumix.Output[*FederationIamBinding]{
