...
func NewFederationIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1:FederationIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFederationIamMember(ctx *pulumi.Context,
	...
	var resource FederationIamMember
	err := ctx.ReadResource("google-native:metastore/v1:FederationIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
