...
func NewMetadataImport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1:MetadataImport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetadataImport(ctx *pulumi.Context,
	...
	var resource MetadataImport
	err := ctx.ReadResource("google-native:metastore/v1:MetadataImport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
