...
func NewServiceBackupIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1:ServiceBackupIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceBackupIamBinding(ctx *pulumi.Context,
	...
	var resource ServiceBackupIamBinding
	err := ctx.ReadResource("google-native:metastore/v1:ServiceBackupIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
