...
func NewFederation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1alpha:Federation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFederation(ctx *pulumi.Context,
	...
	var resource Federation
	err := ctx.ReadResource("google-native:metastore/v1alpha:Federation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
