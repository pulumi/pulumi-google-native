...
func NewFederationIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1alpha:FederationIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFederationIamBinding(ctx *pulumi.Context,
	...
	var resource FederationIamBinding
	err := ctx.ReadResource("google-native:metastore/v1alpha:FederationIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
