...
func (o LookupServiceDatabaseIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupServiceDatabaseIamPolicyResult] {
	return pulumix.Output[LookupServiceDatabaseIamPolicyResult]{
