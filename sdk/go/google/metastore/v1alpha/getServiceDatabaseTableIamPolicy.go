...
func (o LookupServiceDatabaseTableIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupServiceDatabaseTableIamPolicyResult] {
	return pulumix.Output[LookupServiceDatabaseTableIamPolicyResult]{
