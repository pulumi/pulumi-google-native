...
func NewMetadataImport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:metastore/v1alpha:MetadataImport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetadataImport(ctx *pulumi.Context,
	...
	var resource MetadataImport
	err := ctx.ReadResource("google-cloud:metastore/v1alpha:MetadataImport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
