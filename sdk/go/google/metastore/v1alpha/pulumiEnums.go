...
func (in *backendMetastoreMetastoreTypePtr) ToOutput(ctx context.Context) pulumix.Output[*BackendMetastoreMetastoreType] {
	return pulumix.Output[*BackendMetastoreMetastoreType]{
		OutputState: in.ToBackendMetastoreMetastoreTypePtrOutputWithContext(ctx).OutputState,
	}
}
