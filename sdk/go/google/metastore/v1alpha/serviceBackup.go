...
func NewServiceBackup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:metastore/v1alpha:ServiceBackup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceBackup(ctx *pulumi.Context,
	...
	var resource ServiceBackup
	err := ctx.ReadResource("google-cloud:metastore/v1alpha:ServiceBackup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
