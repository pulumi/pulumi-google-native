...
func (i *ServiceBackupIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ServiceBackupIamBinding] {
	return pulumix.Output[*ServiceBackupIamBinding]{
		OutputState: i.ToServiceBackupIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ServiceBackupIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ServiceBackupIamBinding] {
	return pulumix.Output[*ServiceBackupIamBinding]{
