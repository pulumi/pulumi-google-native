...
func NewServiceIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1alpha:ServiceIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceIamBinding(ctx *pulumi.Context,
	...
	var resource ServiceIamBinding
	err := ctx.ReadResource("google-native:metastore/v1alpha:ServiceIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
