...
func NewServiceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:metastore/v1alpha:ServiceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceIamPolicy(ctx *pulumi.Context,
	...
	var resource ServiceIamPolicy
	err := ctx.ReadResource("google-cloud:metastore/v1alpha:ServiceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
