...
func NewServiceMetadataImport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:metastore/v1alpha:ServiceMetadataImport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceMetadataImport(ctx *pulumi.Context,
	...
	var resource ServiceMetadataImport
	err := ctx.ReadResource("google-cloud:metastore/v1alpha:ServiceMetadataImport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
