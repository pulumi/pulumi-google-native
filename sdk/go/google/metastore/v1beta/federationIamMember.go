...
func (i *FederationIamMember) ToOutput(ctx context.Context) pulumix.Output[*FederationIamMember] {
	return pulumix.Output[*FederationIamMember]{
		OutputState: i.ToFederationIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o FederationIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*FederationIamMember] {
	return pulumix.Output[*FederationIamMember]{
