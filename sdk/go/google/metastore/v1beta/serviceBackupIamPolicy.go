...
func NewServiceBackupIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1beta:ServiceBackupIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceBackupIamPolicy(ctx *pulumi.Context,
	...
	var resource ServiceBackupIamPolicy
	err := ctx.ReadResource("google-native:metastore/v1beta:ServiceBackupIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
