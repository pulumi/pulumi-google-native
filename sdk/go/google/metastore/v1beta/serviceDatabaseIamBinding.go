...
func NewServiceDatabaseIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1beta:ServiceDatabaseIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceDatabaseIamBinding(ctx *pulumi.Context,
	...
	var resource ServiceDatabaseIamBinding
	err := ctx.ReadResource("google-native:metastore/v1beta:ServiceDatabaseIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ServiceDatabaseIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ServiceDatabaseIamBinding] {
	return pulumix.Output[*ServiceDatabaseIamBinding]{
		OutputState: i.ToServiceDatabaseIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ServiceDatabaseIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ServiceDatabaseIamBinding] {
	return pulumix.Output[*ServiceDatabaseIamBinding]{
