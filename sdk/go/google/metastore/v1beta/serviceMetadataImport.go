...
func NewServiceMetadataImport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:metastore/v1beta:ServiceMetadataImport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceMetadataImport(ctx *pulumi.Context,
	...
	var resource ServiceMetadataImport
	err := ctx.ReadResource("google-native:metastore/v1beta:ServiceMetadataImport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
