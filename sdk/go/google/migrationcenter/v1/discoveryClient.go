...
func NewDiscoveryClient(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:migrationcenter/v1:DiscoveryClient", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveryClient(ctx *pulumi.Context,
	...
	var resource DiscoveryClient
	err := ctx.ReadResource("google-native:migrationcenter/v1:DiscoveryClient", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
