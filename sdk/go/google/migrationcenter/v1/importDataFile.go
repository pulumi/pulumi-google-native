...
func NewImportDataFile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:migrationcenter/v1:ImportDataFile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportDataFile(ctx *pulumi.Context,
	...
	var resource ImportDataFile
	err := ctx.ReadResource("google-native:migrationcenter/v1:ImportDataFile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
