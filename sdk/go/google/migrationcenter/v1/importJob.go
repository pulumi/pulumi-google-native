...
func NewImportJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:migrationcenter/v1:ImportJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportJob(ctx *pulumi.Context,
	...
	var resource ImportJob
	err := ctx.ReadResource("google-native:migrationcenter/v1:ImportJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
