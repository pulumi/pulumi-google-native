...
func NewPreferenceSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:migrationcenter/v1:PreferenceSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPreferenceSet(ctx *pulumi.Context,
	...
	var resource PreferenceSet
	err := ctx.ReadResource("google-native:migrationcenter/v1:PreferenceSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
