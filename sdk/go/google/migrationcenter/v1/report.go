...
func NewReport(ctx *pulumi.Context,
	...
	var resource Report
	err := ctx.RegisterResource("google-native:migrationcenter/v1:Report", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReport(ctx *pulumi.Context,
	...
	var resource Report
	err := ctx.ReadResource("google-native:migrationcenter/v1:Report", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
