...
func NewReportConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:migrationcenter/v1:ReportConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReportConfig(ctx *pulumi.Context,
	...
	var resource ReportConfig
	err := ctx.ReadResource("google-native:migrationcenter/v1:ReportConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ReportConfig) ToOutput(ctx context.Context) pulumix.Output[*ReportConfig] {
	return pulumix.Output[*ReportConfig]{
		OutputState: i.ToReportConfigOutputWithContext(ctx).OutputState,
	}
}
...
func (o ReportConfigOutput) ToOutput(ctx context.Context) pulumix.Output[*ReportConfig] {
	return pulumix.Output[*ReportConfig]{
