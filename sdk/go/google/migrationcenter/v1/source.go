...
func NewSource(ctx *pulumi.Context,
	...
	var resource Source
	err := ctx.RegisterResource("google-native:migrationcenter/v1:Source", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSource(ctx *pulumi.Context,
	...
	var resource Source
	err := ctx.ReadResource("google-native:migrationcenter/v1:Source", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o SourceOutput) Managed() pulumi.BoolOutput {
	return o.ApplyT(func(v *Source) pulumi.BoolOutput { return v.Managed }).(pulumi.BoolOutput)
}
