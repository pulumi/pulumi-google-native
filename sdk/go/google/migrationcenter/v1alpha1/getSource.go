...
func LookupSource(ctx *pulumi.Context, args *LookupSourceArgs, opts ...pulumi.InvokeOption) (*LookupSourceResult, error) {
	...
	err := ctx.Invoke("google-native:migrationcenter/v1alpha1:getSource", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// If `true`, the source is managed by other service(s).
func (o LookupSourceResultOutput) IsManaged() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupSourceResult) bool { return v.IsManaged }).(pulumi.BoolOutput)
}
