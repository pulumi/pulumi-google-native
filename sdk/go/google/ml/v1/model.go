...
func NewModel(ctx *pulumi.Context,
	...
	var resource Model
	err := ctx.RegisterResource("google-cloud:ml/v1:Model", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModel(ctx *pulumi.Context,
	...
	var resource Model
	err := ctx.ReadResource("google-cloud:ml/v1:Model", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ModelState struct {
	// The default version of the model. This version will be used to handle prediction requests that do not specify a version. You can change the default version by calling projects.models.versions.setDefault.
	DefaultVersion GoogleCloudMlV1__VersionResponsePtrInput
	// Optional. The description specified for the model when it was created.
