...
func NewModelVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:ml/v1:ModelVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModelVersion(ctx *pulumi.Context,
	...
	var resource ModelVersion
	err := ctx.ReadResource("google-cloud:ml/v1:ModelVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
