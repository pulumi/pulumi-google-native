...
func NewAlertPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:monitoring/v3:AlertPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertPolicy(ctx *pulumi.Context,
	...
	var resource AlertPolicy
	err := ctx.ReadResource("google-cloud:monitoring/v3:AlertPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
