...
func NewCollectdTimeSeries(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:monitoring/v3:CollectdTimeSeries", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCollectdTimeSeries(ctx *pulumi.Context,
	...
	var resource CollectdTimeSeries
	err := ctx.ReadResource("google-cloud:monitoring/v3:CollectdTimeSeries", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
