...
func NewMetricDescriptor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:monitoring/v3:MetricDescriptor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMetricDescriptor(ctx *pulumi.Context,
	...
	var resource MetricDescriptor
	err := ctx.ReadResource("google-cloud:monitoring/v3:MetricDescriptor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
