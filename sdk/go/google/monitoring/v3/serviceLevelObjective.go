...
func NewServiceLevelObjective(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:monitoring/v3:ServiceLevelObjective", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceLevelObjective(ctx *pulumi.Context,
	...
	var resource ServiceLevelObjective
	err := ctx.ReadResource("google-cloud:monitoring/v3:ServiceLevelObjective", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
