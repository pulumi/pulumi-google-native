...
func NewServiceServiceLevelObjective(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:monitoring/v3:ServiceServiceLevelObjective", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceServiceLevelObjective(ctx *pulumi.Context,
	...
	var resource ServiceServiceLevelObjective
	err := ctx.ReadResource("google-cloud:monitoring/v3:ServiceServiceLevelObjective", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
