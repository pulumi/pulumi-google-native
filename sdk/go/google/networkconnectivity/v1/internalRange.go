...
func NewInternalRange(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networkconnectivity/v1:InternalRange", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInternalRange(ctx *pulumi.Context,
	...
	var resource InternalRange
	err := ctx.ReadResource("google-native:networkconnectivity/v1:InternalRange", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
