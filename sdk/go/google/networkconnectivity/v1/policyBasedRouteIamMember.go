...
func (i *PolicyBasedRouteIamMember) ToOutput(ctx context.Context) pulumix.Output[*PolicyBasedRouteIamMember] {
	return pulumix.Output[*PolicyBasedRouteIamMember]{
		OutputState: i.ToPolicyBasedRouteIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o PolicyBasedRouteIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*PolicyBasedRouteIamMember] {
	return pulumix.Output[*PolicyBasedRouteIamMember]{
