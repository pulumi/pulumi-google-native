...
type ConsumerPscConnectionResponse struct {
	...
	SelectedSubnetwork string `pulumi:"selectedSubnetwork"`
...
// The URI of the selected subnetwork selected to allocate IP address for this connection.
func (o ConsumerPscConnectionResponseOutput) SelectedSubnetwork() pulumi.StringOutput {
	return o.ApplyT(func(v ConsumerPscConnectionResponse) string { return v.SelectedSubnetwork }).(pulumi.StringOutput)
}
...
// The URI of the subnetwork selected to allocate IP address for this connection.
func (o PscConnectionResponseOutput) SelectedSubnetwork() pulumi.StringOutput {
	return o.ApplyT(func(v PscConnectionResponse) string { return v.SelectedSubnetwork }).(pulumi.StringOutput)
}
