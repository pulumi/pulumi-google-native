...
func LookupHubIamPolicy(ctx *pulumi.Context, args *LookupHubIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupHubIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:networkconnectivity/v1alpha1:getHubIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHubIamPolicyOutput(ctx *pulumi.Context, args LookupHubIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupHubIamPolicyResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupHubIamPolicyResult, error) {
			...
			var s LookupHubIamPolicyResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o LookupHubIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupHubIamPolicyResult] {
	return pulumix.Output[LookupHubIamPolicyResult]{
