...
func (i *InternalRangeIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*InternalRangeIamPolicy] {
	return pulumix.Output[*InternalRangeIamPolicy]{
		OutputState: i.ToInternalRangeIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o InternalRangeIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*InternalRangeIamPolicy] {
	return pulumix.Output[*InternalRangeIamPolicy]{
