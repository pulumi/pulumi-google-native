...
func NewServiceConnectionMapIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networkconnectivity/v1alpha1:ServiceConnectionMapIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceConnectionMapIamPolicy(ctx *pulumi.Context,
	...
	var resource ServiceConnectionMapIamPolicy
	err := ctx.ReadResource("google-native:networkconnectivity/v1alpha1:ServiceConnectionMapIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
