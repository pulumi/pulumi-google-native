...
func NewSpokeIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networkconnectivity/v1alpha1:SpokeIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpokeIamPolicy(ctx *pulumi.Context,
	...
	var resource SpokeIamPolicy
	err := ctx.ReadResource("google-native:networkconnectivity/v1alpha1:SpokeIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *SpokeIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*SpokeIamPolicy] {
	return pulumix.Output[*SpokeIamPolicy]{
		OutputState: i.ToSpokeIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o SpokeIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*SpokeIamPolicy] {
	return pulumix.Output[*SpokeIamPolicy]{
