...
func NewConnectivityTest(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:networkmanagement/v1:ConnectivityTest", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnectivityTest(ctx *pulumi.Context,
	...
	var resource ConnectivityTest
	err := ctx.ReadResource("google-cloud:networkmanagement/v1:ConnectivityTest", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
