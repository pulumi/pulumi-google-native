...
func LookupConnectivityTestIamPolicy(ctx *pulumi.Context, args *LookupConnectivityTestIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupConnectivityTestIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:networkmanagement/v1:getConnectivityTestIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupConnectivityTestIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupConnectivityTestIamPolicyResult] {
	return pulumix.Output[LookupConnectivityTestIamPolicyResult]{
