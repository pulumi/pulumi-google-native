...
func NewAddressGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:AddressGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddressGroup(ctx *pulumi.Context,
	...
	var resource AddressGroup
	err := ctx.ReadResource("google-native:networksecurity/v1:AddressGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
