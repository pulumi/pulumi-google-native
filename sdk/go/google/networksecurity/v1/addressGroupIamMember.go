...
func NewAddressGroupIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:AddressGroupIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddressGroupIamMember(ctx *pulumi.Context,
	...
	var resource AddressGroupIamMember
	err := ctx.ReadResource("google-native:networksecurity/v1:AddressGroupIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
