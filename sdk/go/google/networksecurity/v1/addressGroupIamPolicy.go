...
func NewAddressGroupIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:AddressGroupIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddressGroupIamPolicy(ctx *pulumi.Context,
	...
	var resource AddressGroupIamPolicy
	err := ctx.ReadResource("google-native:networksecurity/v1:AddressGroupIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
