...
func NewAuthorizationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:AuthorizationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationPolicy(ctx *pulumi.Context,
	...
	var resource AuthorizationPolicy
	err := ctx.ReadResource("google-native:networksecurity/v1:AuthorizationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
