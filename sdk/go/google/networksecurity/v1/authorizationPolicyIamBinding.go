...
func NewAuthorizationPolicyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:AuthorizationPolicyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationPolicyIamBinding(ctx *pulumi.Context,
	...
	var resource AuthorizationPolicyIamBinding
	err := ctx.ReadResource("google-native:networksecurity/v1:AuthorizationPolicyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *AuthorizationPolicyIamBinding) ToOutput(ctx context.Context) pulumix.Output[*AuthorizationPolicyIamBinding] {
	return pulumix.Output[*AuthorizationPolicyIamBinding]{
		OutputState: i.ToAuthorizationPolicyIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o AuthorizationPolicyIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*AuthorizationPolicyIamBinding] {
	return pulumix.Output[*AuthorizationPolicyIamBinding]{
