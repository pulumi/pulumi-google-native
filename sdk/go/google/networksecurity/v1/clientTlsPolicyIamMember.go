...
func NewClientTlsPolicyIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:ClientTlsPolicyIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClientTlsPolicyIamMember(ctx *pulumi.Context,
	...
	var resource ClientTlsPolicyIamMember
	err := ctx.ReadResource("google-native:networksecurity/v1:ClientTlsPolicyIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ClientTlsPolicyIamMember) ToOutput(ctx context.Context) pulumix.Output[*ClientTlsPolicyIamMember] {
	return pulumix.Output[*ClientTlsPolicyIamMember]{
		OutputState: i.ToClientTlsPolicyIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o ClientTlsPolicyIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*ClientTlsPolicyIamMember] {
	return pulumix.Output[*ClientTlsPolicyIamMember]{
