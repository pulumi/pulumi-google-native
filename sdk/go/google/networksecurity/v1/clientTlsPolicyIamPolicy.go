...
func (i *ClientTlsPolicyIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*ClientTlsPolicyIamPolicy] {
	return pulumix.Output[*ClientTlsPolicyIamPolicy]{
		OutputState: i.ToClientTlsPolicyIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o ClientTlsPolicyIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*ClientTlsPolicyIamPolicy] {
	return pulumix.Output[*ClientTlsPolicyIamPolicy]{
