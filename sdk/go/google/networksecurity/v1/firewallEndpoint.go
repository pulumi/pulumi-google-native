...
func NewFirewallEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:FirewallEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallEndpoint(ctx *pulumi.Context,
	...
	var resource FirewallEndpoint
	err := ctx.ReadResource("google-native:networksecurity/v1:FirewallEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
