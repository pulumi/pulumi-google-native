...
func NewFirewallEndpointAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:FirewallEndpointAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallEndpointAssociation(ctx *pulumi.Context,
	...
	var resource FirewallEndpointAssociation
	err := ctx.ReadResource("google-native:networksecurity/v1:FirewallEndpointAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
