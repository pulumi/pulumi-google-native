...
func NewGatewaySecurityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:GatewaySecurityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewaySecurityPolicy(ctx *pulumi.Context,
	...
	var resource GatewaySecurityPolicy
	err := ctx.ReadResource("google-native:networksecurity/v1:GatewaySecurityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
