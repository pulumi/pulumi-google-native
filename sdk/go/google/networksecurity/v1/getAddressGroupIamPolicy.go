...
func LookupAddressGroupIamPolicy(ctx *pulumi.Context, args *LookupAddressGroupIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupAddressGroupIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:networksecurity/v1:getAddressGroupIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupAddressGroupIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAddressGroupIamPolicyResult] {
	return pulumix.Output[LookupAddressGroupIamPolicyResult]{
...
func (o LookupAddressGroupIamPolicyResultOutput) Bindings() GoogleIamV1BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupAddressGroupIamPolicyResult) []GoogleIamV1BindingResponse { return v.Bindings }).(GoogleIamV1BindingResponseArrayOutput)
}
...
func (o LookupAddressGroupIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupAddressGroupIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
