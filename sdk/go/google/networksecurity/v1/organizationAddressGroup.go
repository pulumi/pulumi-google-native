...
func NewOrganizationAddressGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:OrganizationAddressGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationAddressGroup(ctx *pulumi.Context,
	...
	var resource OrganizationAddressGroup
	err := ctx.ReadResource("google-native:networksecurity/v1:OrganizationAddressGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
