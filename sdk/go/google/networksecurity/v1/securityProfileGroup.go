...
func NewSecurityProfileGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:SecurityProfileGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityProfileGroup(ctx *pulumi.Context,
	...
	var resource SecurityProfileGroup
	err := ctx.ReadResource("google-native:networksecurity/v1:SecurityProfileGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
