...
func NewServerTlsPolicyIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1:ServerTlsPolicyIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerTlsPolicyIamBinding(ctx *pulumi.Context,
	...
	var resource ServerTlsPolicyIamBinding
	err := ctx.ReadResource("google-native:networksecurity/v1:ServerTlsPolicyIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *ServerTlsPolicyIamBinding) ToOutput(ctx context.Context) pulumix.Output[*ServerTlsPolicyIamBinding] {
	return pulumix.Output[*ServerTlsPolicyIamBinding]{
		OutputState: i.ToServerTlsPolicyIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o ServerTlsPolicyIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*ServerTlsPolicyIamBinding] {
	return pulumix.Output[*ServerTlsPolicyIamBinding]{
