...
func NewAddressGroupIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1beta1:AddressGroupIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddressGroupIamBinding(ctx *pulumi.Context,
	...
	var resource AddressGroupIamBinding
	err := ctx.ReadResource("google-native:networksecurity/v1beta1:AddressGroupIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
