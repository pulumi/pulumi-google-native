...
func (i *AddressGroupIamMember) ToOutput(ctx context.Context) pulumix.Output[*AddressGroupIamMember] {
	return pulumix.Output[*AddressGroupIamMember]{
		OutputState: i.ToAddressGroupIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o AddressGroupIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*AddressGroupIamMember] {
	return pulumix.Output[*AddressGroupIamMember]{
