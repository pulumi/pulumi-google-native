...
func NewAuthorizationPolicyIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1beta1:AuthorizationPolicyIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationPolicyIamMember(ctx *pulumi.Context,
	...
	var resource AuthorizationPolicyIamMember
	err := ctx.ReadResource("google-native:networksecurity/v1beta1:AuthorizationPolicyIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
