...
type FirewallEndpointAssociation struct {
	...
	FirewallEndpointAssociationId pulumi.StringOutput `pulumi:"firewallEndpointAssociationId"`
...
func NewFirewallEndpointAssociation(ctx *pulumi.Context,
	...
	if args.FirewallEndpointAssociationId == nil {
		return nil, errors.New("invalid value for required argument 'FirewallEndpointAssociationId'")
	}
	if args.Network == nil {
...
type FirewallEndpointAssociationArgs struct {
	...
	// Required. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpoint_association_id from the method_signature of Create RPC.
	FirewallEndpointAssociationId pulumi.StringInput
	// Labels as key value pairs
...
// Required. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpoint_association_id from the method_signature of Create RPC.
func (o FirewallEndpointAssociationOutput) FirewallEndpointAssociationId() pulumi.StringOutput {
	return o.ApplyT(func(v *FirewallEndpointAssociation) pulumi.StringOutput { return v.FirewallEndpointAssociationId }).(pulumi.StringOutput)
}
