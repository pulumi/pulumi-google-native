...
func LookupClientTlsPolicyIamPolicy(ctx *pulumi.Context, args *LookupClientTlsPolicyIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupClientTlsPolicyIamPolicyResult, error) {
	...
	var rv LookupClientTlsPolicyIamPolicyResult
	err := ctx.Invoke("google-native:networksecurity/v1beta1:getClientTlsPolicyIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupClientTlsPolicyIamPolicyOutput(ctx *pulumi.Context, args LookupClientTlsPolicyIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupClientTlsPolicyIamPolicyResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupClientTlsPolicyIamPolicyResult, error) {
			args := v.(LookupClientTlsPolicyIamPolicyArgs)
			r, err := LookupClientTlsPolicyIamPolicy(ctx, &args, opts...)
			var s LookupClientTlsPolicyIamPolicyResult
			if r != nil {
				s = *r
			}
			return s, err
		}).(LookupClientTlsPolicyIamPolicyResultOutput)
}
...
func (LookupClientTlsPolicyIamPolicyOutputArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupClientTlsPolicyIamPolicyArgs)(nil)).Elem()
}
...
func (LookupClientTlsPolicyIamPolicyResultOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupClientTlsPolicyIamPolicyResult)(nil)).Elem()
}
...
func (o LookupClientTlsPolicyIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupClientTlsPolicyIamPolicyResult] {
	return pulumix.Output[LookupClientTlsPolicyIamPolicyResult]{
...
func (o LookupClientTlsPolicyIamPolicyResultOutput) Bindings() GoogleIamV1BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupClientTlsPolicyIamPolicyResult) []GoogleIamV1BindingResponse { return v.Bindings }).(GoogleIamV1BindingResponseArrayOutput)
}

// `etag` is used for optimistic concurrency control as a way to help prevent simultaneous updates of a policy from overwriting each other. It is strongly suggested that systems make use of the `etag` in the read-modify-write cycle to perform policy updates in order to avoid race conditions: An `etag` is returned in the response to `getIamPolicy`, and systems are expected to put that etag in the request to `setIamPolicy` to ensure that their change will be applied to the same version of the policy. **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost.
func (o LookupClientTlsPolicyIamPolicyResultOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v LookupClientTlsPolicyIamPolicyResult) string { return v.Etag }).(pulumi.StringOutput)
}

// Specifies the format of the policy. Valid values are `0`, `1`, and `3`. Requests that specify an invalid value are rejected. Any operation that affects conditional role bindings must specify version `3`. This requirement applies to the following operations: * Getting a policy that includes a conditional role binding * Adding a conditional role binding to a policy * Changing a conditional role binding in a policy * Removing any role binding, with or without a condition, from a policy that includes conditions **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost. If a policy does not include any conditions, operations on that policy may specify any valid version or leave the field unset. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
func (o LookupClientTlsPolicyIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupClientTlsPolicyIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}

func init() {
	pulumi.RegisterOutputType(LookupClientTlsPolicyIamPolicyResultOutput{})
}
