...
func NewRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.RegisterResource("google-native:networksecurity/v1beta1:Rule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRule(ctx *pulumi.Context,
	...
	var resource Rule
	err := ctx.ReadResource("google-native:networksecurity/v1beta1:Rule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
