...
func NewSecurityProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1beta1:SecurityProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityProfile(ctx *pulumi.Context,
	...
	var resource SecurityProfile
	err := ctx.ReadResource("google-native:networksecurity/v1beta1:SecurityProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
