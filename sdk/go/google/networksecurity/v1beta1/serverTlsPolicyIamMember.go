...
func NewServerTlsPolicyIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networksecurity/v1beta1:ServerTlsPolicyIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerTlsPolicyIamMember(ctx *pulumi.Context,
	...
	var resource ServerTlsPolicyIamMember
	err := ctx.ReadResource("google-native:networksecurity/v1beta1:ServerTlsPolicyIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
