...
// GetEdgeCacheServiceIamPolicy gets an existing EdgeCacheServiceIamPolicy resource's state with the given name, ID, and optional
...
func GetEdgeCacheServiceIamPolicy(ctx *pulumi.Context,
	...
	var resource EdgeCacheServiceIamPolicy
	err := ctx.ReadResource("google-native:networkservices/v1:EdgeCacheServiceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering EdgeCacheServiceIamPolicy resources.
...
func (EdgeCacheServiceIamPolicyState) ElementType() reflect.Type {
	return reflect.TypeOf((*edgeCacheServiceIamPolicyState)(nil)).Elem()
}
...
func (EdgeCacheServiceIamPolicyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*edgeCacheServiceIamPolicyArgs)(nil)).Elem()
}
...
func (*EdgeCacheServiceIamPolicy) ElementType() reflect.Type {
	return reflect.TypeOf((**EdgeCacheServiceIamPolicy)(nil)).Elem()
}

func (i *EdgeCacheServiceIamPolicy) ToEdgeCacheServiceIamPolicyOutput() EdgeCacheServiceIamPolicyOutput {
	return i.ToEdgeCacheServiceIamPolicyOutputWithContext(context.Background())
}
...
func (i *EdgeCacheServiceIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*EdgeCacheServiceIamPolicy] {
	return pulumix.Output[*EdgeCacheServiceIamPolicy]{
		OutputState: i.ToEdgeCacheServiceIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o EdgeCacheServiceIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*EdgeCacheServiceIamPolicy] {
	return pulumix.Output[*EdgeCacheServiceIamPolicy]{
...
// Specifies cloud audit logging configuration for this policy.
func (o EdgeCacheServiceIamPolicyOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v *EdgeCacheServiceIamPolicy) AuditConfigResponseArrayOutput { return v.AuditConfigs }).(AuditConfigResponseArrayOutput)
}

// Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
func (o EdgeCacheServiceIamPolicyOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v *EdgeCacheServiceIamPolicy) BindingResponseArrayOutput { return v.Bindings }).(BindingResponseArrayOutput)
}

func (o EdgeCacheServiceIamPolicyOutput) EdgeCacheServiceId() pulumi.StringOutput {
	return o.ApplyT(func(v *EdgeCacheServiceIamPolicy) pulumi.StringOutput { return v.EdgeCacheServiceId }).(pulumi.StringOutput)
}

// `etag` is used for optimistic concurrency control as a way to help prevent simultaneous updates of a policy from overwriting each other. It is strongly suggested that systems make use of the `etag` in the read-modify-write cycle to perform policy updates in order to avoid race conditions: An `etag` is returned in the response to `getIamPolicy`, and systems are expected to put that etag in the request to `setIamPolicy` to ensure that their change will be applied to the same version of the policy. **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost.
func (o EdgeCacheServiceIamPolicyOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v *EdgeCacheServiceIamPolicy) pulumi.StringOutput { return v.Etag }).(pulumi.StringOutput)
}

func (o EdgeCacheServiceIamPolicyOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *EdgeCacheServiceIamPolicy) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}

func (o EdgeCacheServiceIamPolicyOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *EdgeCacheServiceIamPolicy) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}

// Specifies the format of the policy. Valid values are `0`, `1`, and `3`. Requests that specify an invalid value are rejected. Any operation that affects conditional role bindings must specify version `3`. This requirement applies to the following operations: * Getting a policy that includes a conditional role binding * Adding a conditional role binding to a policy * Changing a conditional role binding in a policy * Removing any role binding, with or without a condition, from a policy that includes conditions **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost. If a policy does not include any conditions, operations on that policy may specify any valid version or leave the field unset. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
func (o EdgeCacheServiceIamPolicyOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v *EdgeCacheServiceIamPolicy) pulumi.IntOutput { return v.Version }).(pulumi.IntOutput)
}
