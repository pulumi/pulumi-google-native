...
func LookupServiceBindingIamPolicy(ctx *pulumi.Context, args *LookupServiceBindingIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupServiceBindingIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:networkservices/v1:getServiceBindingIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupServiceBindingIamPolicyOutput(ctx *pulumi.Context, args LookupServiceBindingIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupServiceBindingIamPolicyResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupServiceBindingIamPolicyResult, error) {
			...
			var s LookupServiceBindingIamPolicyResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o LookupServiceBindingIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupServiceBindingIamPolicyResult] {
	return pulumix.Output[LookupServiceBindingIamPolicyResult]{
