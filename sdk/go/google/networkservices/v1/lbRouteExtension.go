...
func NewLbRouteExtension(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networkservices/v1:LbRouteExtension", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLbRouteExtension(ctx *pulumi.Context,
	...
	var resource LbRouteExtension
	err := ctx.ReadResource("google-native:networkservices/v1:LbRouteExtension", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
