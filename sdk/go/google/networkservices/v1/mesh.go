...
func NewMesh(ctx *pulumi.Context,
	...
	var resource Mesh
	err := ctx.RegisterResource("google-native:networkservices/v1:Mesh", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMesh(ctx *pulumi.Context,
	...
	var resource Mesh
	err := ctx.ReadResource("google-native:networkservices/v1:Mesh", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
