...
func NewTcpRoute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networkservices/v1:TcpRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTcpRoute(ctx *pulumi.Context,
	...
	var resource TcpRoute
	err := ctx.ReadResource("google-native:networkservices/v1:TcpRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
