...
func (i *EndpointPolicyIamBinding) ToOutput(ctx context.Context) pulumix.Output[*EndpointPolicyIamBinding] {
	return pulumix.Output[*EndpointPolicyIamBinding]{
		OutputState: i.ToEndpointPolicyIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o EndpointPolicyIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*EndpointPolicyIamBinding] {
	return pulumix.Output[*EndpointPolicyIamBinding]{
