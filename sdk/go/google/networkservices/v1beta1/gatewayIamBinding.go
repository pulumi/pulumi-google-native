...
func NewGatewayIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networkservices/v1beta1:GatewayIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayIamBinding(ctx *pulumi.Context,
	...
	var resource GatewayIamBinding
	err := ctx.ReadResource("google-native:networkservices/v1beta1:GatewayIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
