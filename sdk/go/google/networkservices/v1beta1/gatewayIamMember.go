...
func NewGatewayIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:networkservices/v1beta1:GatewayIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayIamMember(ctx *pulumi.Context,
	...
	var resource GatewayIamMember
	err := ctx.ReadResource("google-native:networkservices/v1beta1:GatewayIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
