...
func (o LookupEndpointPolicyIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupEndpointPolicyIamPolicyResult] {
	return pulumix.Output[LookupEndpointPolicyIamPolicyResult]{
