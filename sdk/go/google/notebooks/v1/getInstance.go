...
type LookupInstanceResult struct {
	...
	PreMigrationCheck PreMigrationCheckResponse `pulumi:"preMigrationCheck"`
...
// Check how possible a migration from UmN to WbI is.
func (o LookupInstanceResultOutput) PreMigrationCheck() PreMigrationCheckResponseOutput {
	return o.ApplyT(func(v LookupInstanceResult) PreMigrationCheckResponse { return v.PreMigrationCheck }).(PreMigrationCheckResponseOutput)
}
