...
func LookupRuntimeIamPolicy(ctx *pulumi.Context, args *LookupRuntimeIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupRuntimeIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:notebooks/v1:getRuntimeIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupRuntimeIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupRuntimeIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupRuntimeIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupRuntimeIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
