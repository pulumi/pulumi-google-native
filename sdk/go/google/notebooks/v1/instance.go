...
type Instance struct {
	...
	PreMigrationCheck PreMigrationCheckResponseOutput `pulumi:"preMigrationCheck"`
...
// Check how possible a migration from UmN to WbI is.
func (o InstanceOutput) PreMigrationCheck() PreMigrationCheckResponseOutput {
	return o.ApplyT(func(v *Instance) PreMigrationCheckResponseOutput { return v.PreMigrationCheck }).(PreMigrationCheckResponseOutput)
}
