...
type PreMigrationCheckResponse struct {
...
// PreMigrationCheck checks how feasible a migration from UmN is.
type PreMigrationCheckResponseOutput struct{ *pulumi.OutputState }

func (PreMigrationCheckResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PreMigrationCheckResponse)(nil)).Elem()
}

func (o PreMigrationCheckResponseOutput) ToPreMigrationCheckResponseOutput() PreMigrationCheckResponseOutput {
	return o
}

func (o PreMigrationCheckResponseOutput) ToPreMigrationCheckResponseOutputWithContext(ctx context.Context) PreMigrationCheckResponseOutput {
	return o
}

// Message provides a summary or workaround.
func (o PreMigrationCheckResponseOutput) Message() pulumi.StringOutput {
	return o.ApplyT(func(v PreMigrationCheckResponse) string { return v.Message }).(pulumi.StringOutput)
}

// Result returns the result of the check.
func (o PreMigrationCheckResponseOutput) Result() pulumi.StringOutput {
	return o.ApplyT(func(v PreMigrationCheckResponse) string { return v.Result }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(PreMigrationCheckResponseOutput{})
