...
func NewRuntime(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:notebooks/v1:Runtime", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuntime(ctx *pulumi.Context,
	...
	var resource Runtime
	err := ctx.ReadResource("google-cloud:notebooks/v1:Runtime", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
