...
func NewRuntimeIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:notebooks/v1:RuntimeIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuntimeIamBinding(ctx *pulumi.Context,
	...
	var resource RuntimeIamBinding
	err := ctx.ReadResource("google-native:notebooks/v1:RuntimeIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
