...
func NewRuntimeIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:notebooks/v1:RuntimeIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuntimeIamMember(ctx *pulumi.Context,
	...
	var resource RuntimeIamMember
	err := ctx.ReadResource("google-native:notebooks/v1:RuntimeIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
