...
func NewOrganizationPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:orgpolicy/v2:OrganizationPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationPolicy
	err := ctx.ReadResource("google-cloud:orgpolicy/v2:OrganizationPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
