...
func NewOsPolicyAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:osconfig/v1:OsPolicyAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOsPolicyAssignment(ctx *pulumi.Context,
	...
	var resource OsPolicyAssignment
	err := ctx.ReadResource("google-native:osconfig/v1:OsPolicyAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
