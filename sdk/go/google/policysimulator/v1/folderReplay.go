...
// The configuration used for the `Replay`.
func (o FolderReplayOutput) Config() GoogleCloudPolicysimulatorV1ReplayConfigResponseOutput {
	return o.ApplyT(func(v *FolderReplay) GoogleCloudPolicysimulatorV1ReplayConfigResponseOutput { return v.Config }).(GoogleCloudPolicysimulatorV1ReplayConfigResponseOutput)
}
...
// Summary statistics about the replayed log entries.
func (o FolderReplayOutput) ResultsSummary() GoogleCloudPolicysimulatorV1ReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v *FolderReplay) GoogleCloudPolicysimulatorV1ReplayResultsSummaryResponseOutput {
