...
func LookupOrgPolicyViolationsPreview(ctx *pulumi.Context, args *LookupOrgPolicyViolationsPreviewArgs, opts ...pulumi.InvokeOption) (*LookupOrgPolicyViolationsPreviewResult, error) {
	...
	err := ctx.Invoke("google-native:policysimulator/v1:getOrgPolicyViolationsPreview", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupOrgPolicyViolationsPreviewResult struct {
	...
	Overlay GoogleCloudPolicysimulatorV1OrgPolicyOverlayResponse `pulumi:"overlay"`
	// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
	ResourceCounts GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreviewResourceCountsResponse `pulumi:"resourceCounts"`
...
// The proposed changes we are previewing violations for.
func (o LookupOrgPolicyViolationsPreviewResultOutput) Overlay() GoogleCloudPolicysimulatorV1OrgPolicyOverlayResponseOutput {
	return o.ApplyT(func(v LookupOrgPolicyViolationsPreviewResult) GoogleCloudPolicysimulatorV1OrgPolicyOverlayResponse {
		return v.Overlay
	}).(GoogleCloudPolicysimulatorV1OrgPolicyOverlayResponseOutput)
}

// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
func (o LookupOrgPolicyViolationsPreviewResultOutput) ResourceCounts() GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreviewResourceCountsResponseOutput {
	return o.ApplyT(func(v LookupOrgPolicyViolationsPreviewResult) GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreviewResourceCountsResponse {
