...
// The configuration used for the `Replay`.
func (o ReplayOutput) Config() GoogleCloudPolicysimulatorV1ReplayConfigResponseOutput {
...
// Summary statistics about the replayed log entries.
func (o ReplayOutput) ResultsSummary() GoogleCloudPolicysimulatorV1ReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v *Replay) GoogleCloudPolicysimulatorV1ReplayResultsSummaryResponseOutput {
