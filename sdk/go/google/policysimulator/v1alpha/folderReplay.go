...
func NewFolderReplay(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:policysimulator/v1alpha:FolderReplay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderReplay(ctx *pulumi.Context,
	...
	var resource FolderReplay
	err := ctx.ReadResource("google-native:policysimulator/v1alpha:FolderReplay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o FolderReplayOutput) Config() GoogleCloudPolicysimulatorV1alphaReplayConfigResponseOutput {
	return o.ApplyT(func(v *FolderReplay) GoogleCloudPolicysimulatorV1alphaReplayConfigResponseOutput { return v.Config }).(GoogleCloudPolicysimulatorV1alphaReplayConfigResponseOutput)
}
...
func (o FolderReplayOutput) ResultsSummary() GoogleCloudPolicysimulatorV1alphaReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v *FolderReplay) GoogleCloudPolicysimulatorV1alphaReplayResultsSummaryResponseOutput {
