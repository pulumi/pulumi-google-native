...
func LookupFolderReplay(ctx *pulumi.Context, args *LookupFolderReplayArgs, opts ...pulumi.InvokeOption) (*LookupFolderReplayResult, error) {
	...
	err := ctx.Invoke("google-native:policysimulator/v1alpha:getFolderReplay", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupFolderReplayResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFolderReplayResult] {
	return pulumix.Output[LookupFolderReplayResult]{
...
func (o LookupFolderReplayResultOutput) Config() GoogleCloudPolicysimulatorV1alphaReplayConfigResponseOutput {
	return o.ApplyT(func(v LookupFolderReplayResult) GoogleCloudPolicysimulatorV1alphaReplayConfigResponse {
		return v.Config
...
func (o LookupFolderReplayResultOutput) ResultsSummary() GoogleCloudPolicysimulatorV1alphaReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v LookupFolderReplayResult) GoogleCloudPolicysimulatorV1alphaReplayResultsSummaryResponse {
