...
func LookupOrgPolicyViolationsPreview(ctx *pulumi.Context, args *LookupOrgPolicyViolationsPreviewArgs, opts ...pulumi.InvokeOption) (*LookupOrgPolicyViolationsPreviewResult, error) {
	...
	err := ctx.Invoke("google-native:policysimulator/v1alpha:getOrgPolicyViolationsPreview", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupOrgPolicyViolationsPreviewResult struct {
	...
	Overlay GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponse `pulumi:"overlay"`
	// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
	ResourceCounts GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponse `pulumi:"resourceCounts"`
...
// The proposed changes we are previewing violations for.
func (o LookupOrgPolicyViolationsPreviewResultOutput) Overlay() GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponseOutput {
	return o.ApplyT(func(v LookupOrgPolicyViolationsPreviewResult) GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponse {
		return v.Overlay
	}).(GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponseOutput)
}

// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
func (o LookupOrgPolicyViolationsPreviewResultOutput) ResourceCounts() GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponseOutput {
	return o.ApplyT(func(v LookupOrgPolicyViolationsPreviewResult) GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponse {
		return v.ResourceCounts
	}).(GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponseOutput)
}
