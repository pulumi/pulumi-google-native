...
type OrgPolicyViolationsPreview struct {
	...
	Overlay GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponseOutput `pulumi:"overlay"`
	// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
	ResourceCounts GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponseOutput `pulumi:"resourceCounts"`
...
func NewOrgPolicyViolationsPreview(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:policysimulator/v1alpha:OrgPolicyViolationsPreview", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrgPolicyViolationsPreview(ctx *pulumi.Context,
	...
	var resource OrgPolicyViolationsPreview
	err := ctx.ReadResource("google-native:policysimulator/v1alpha:OrgPolicyViolationsPreview", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type orgPolicyViolationsPreviewArgs struct {
	...
	// The proposed changes we are previewing violations for.
	Overlay GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlay `pulumi:"overlay"`
}
...
type OrgPolicyViolationsPreviewArgs struct {
	...
	// The proposed changes we are previewing violations for.
	Overlay GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayInput
}
...
// The proposed changes we are previewing violations for.
func (o OrgPolicyViolationsPreviewOutput) Overlay() GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponseOutput {
	return o.ApplyT(func(v *OrgPolicyViolationsPreview) GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponseOutput {
		return v.Overlay
	}).(GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponseOutput)
}

// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
func (o OrgPolicyViolationsPreviewOutput) ResourceCounts() GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponseOutput {
	return o.ApplyT(func(v *OrgPolicyViolationsPreview) GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponseOutput {
