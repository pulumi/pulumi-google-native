...
func NewFolderReplay(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:policysimulator/v1beta:FolderReplay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderReplay(ctx *pulumi.Context,
	...
	var resource FolderReplay
	err := ctx.ReadResource("google-native:policysimulator/v1beta:FolderReplay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The configuration used for the `Replay`.
func (o FolderReplayOutput) Config() GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput {
	return o.ApplyT(func(v *FolderReplay) GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput { return v.Config }).(GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput)
}
...
// Summary statistics about the replayed log entries.
func (o FolderReplayOutput) ResultsSummary() GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v *FolderReplay) GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
