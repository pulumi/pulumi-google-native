...
func LookupFolderReplay(ctx *pulumi.Context, args *LookupFolderReplayArgs, opts ...pulumi.InvokeOption) (*LookupFolderReplayResult, error) {
	...
	err := ctx.Invoke("google-native:policysimulator/v1beta:getFolderReplay", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The configuration used for the `Replay`.
func (o LookupFolderReplayResultOutput) Config() GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput {
	return o.ApplyT(func(v LookupFolderReplayResult) GoogleCloudPolicysimulatorV1betaReplayConfigResponse { return v.Config }).(GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput)
}
...
// Summary statistics about the replayed log entries.
func (o LookupFolderReplayResultOutput) ResultsSummary() GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v LookupFolderReplayResult) GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse {
