...
func LookupOrganizationReplay(ctx *pulumi.Context, args *LookupOrganizationReplayArgs, opts ...pulumi.InvokeOption) (*LookupOrganizationReplayResult, error) {
	...
	err := ctx.Invoke("google-native:policysimulator/v1beta:getOrganizationReplay", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The configuration used for the `Replay`.
func (o LookupOrganizationReplayResultOutput) Config() GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput {
	return o.ApplyT(func(v LookupOrganizationReplayResult) GoogleCloudPolicysimulatorV1betaReplayConfigResponse {
		return v.Config
...
// Summary statistics about the replayed log entries.
func (o LookupOrganizationReplayResultOutput) ResultsSummary() GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v LookupOrganizationReplayResult) GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse {
