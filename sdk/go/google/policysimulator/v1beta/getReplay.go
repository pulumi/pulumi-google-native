...
func LookupReplay(ctx *pulumi.Context, args *LookupReplayArgs, opts ...pulumi.InvokeOption) (*LookupReplayResult, error) {
	...
	err := ctx.Invoke("google-native:policysimulator/v1beta:getReplay", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The configuration used for the `Replay`.
func (o LookupReplayResultOutput) Config() GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput {
	return o.ApplyT(func(v LookupReplayResult) GoogleCloudPolicysimulatorV1betaReplayConfigResponse { return v.Config }).(GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput)
}
...
// Summary statistics about the replayed log entries.
func (o LookupReplayResultOutput) ResultsSummary() GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v LookupReplayResult) GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse {
		return v.ResultsSummary
	}).(GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput)
}
