...
type OrgPolicyViolationsPreview struct {
	...
	Overlay GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput `pulumi:"overlay"`
	// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
	ResourceCounts GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput `pulumi:"resourceCounts"`
...
func NewOrgPolicyViolationsPreview(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:policysimulator/v1beta:OrgPolicyViolationsPreview", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrgPolicyViolationsPreview(ctx *pulumi.Context,
	...
	var resource OrgPolicyViolationsPreview
	err := ctx.ReadResource("google-native:policysimulator/v1beta:OrgPolicyViolationsPreview", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type orgPolicyViolationsPreviewArgs struct {
	...
	// The proposed changes we are previewing violations for.
	Overlay GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay `pulumi:"overlay"`
}
...
type OrgPolicyViolationsPreviewArgs struct {
	...
	// The proposed changes we are previewing violations for.
	Overlay GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayInput
}
...
// The proposed changes we are previewing violations for.
func (o OrgPolicyViolationsPreviewOutput) Overlay() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput {
	return o.ApplyT(func(v *OrgPolicyViolationsPreview) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput {
		return v.Overlay
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput)
}

// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
func (o OrgPolicyViolationsPreviewOutput) ResourceCounts() GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput {
	return o.ApplyT(func(v *OrgPolicyViolationsPreview) GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput {
