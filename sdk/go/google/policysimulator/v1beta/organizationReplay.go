...
func NewOrganizationReplay(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:policysimulator/v1beta:OrganizationReplay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationReplay(ctx *pulumi.Context,
	...
	var resource OrganizationReplay
	err := ctx.ReadResource("google-native:policysimulator/v1beta:OrganizationReplay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The configuration used for the `Replay`.
func (o OrganizationReplayOutput) Config() GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput {
	return o.ApplyT(func(v *OrganizationReplay) GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput {
		return v.Config
	}).(GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput)
}
...
// Summary statistics about the replayed log entries.
func (o OrganizationReplayOutput) ResultsSummary() GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v *OrganizationReplay) GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
