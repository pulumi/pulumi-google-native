...
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay struct {
	...
	CustomConstraints []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay `pulumi:"customConstraints"`
	...
	Policies []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay `pulumi:"policies"`
}

// GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayInput is an input type that accepts GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs and GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput values.
// You can construct a concrete instance of `GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayInput` via:
//
//	GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs{...}
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayInput interface {
	pulumi.Input

	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput
	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutputWithContext(context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput
}

// The proposed changes to OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs struct {
	// Optional. The OrgPolicy CustomConstraint changes to preview violations for. Any existing CustomConstraints with the same name will be overridden in the simulation. That is, violations will be determined as if all custom constraints in the overlay were instantiated. Only a single custom_constraint is supported in the overlay at a time. For evaluating multiple constraints, multiple `GenerateOrgPolicyViolationsPreview` requests are made, where each request evaluates a single constraint.
	CustomConstraints GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayInput `pulumi:"customConstraints"`
	// Optional. The OrgPolicy changes to preview violations for. Any existing OrgPolicies with the same name will be overridden in the simulation. That is, violations will be determined as if all policies in the overlay were created or updated.
	Policies GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayInput `pulumi:"policies"`
}

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay)(nil)).Elem()
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput {
	return i.ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutputWithContext(context.Background())
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput)
}

// The proposed changes to OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput {
	return o
}

// Optional. The OrgPolicy CustomConstraint changes to preview violations for. Any existing CustomConstraints with the same name will be overridden in the simulation. That is, violations will be determined as if all custom constraints in the overlay were instantiated. Only a single custom_constraint is supported in the overlay at a time. For evaluating multiple constraints, multiple `GenerateOrgPolicyViolationsPreview` requests are made, where each request evaluates a single constraint.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput) CustomConstraints() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay) []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay {
		return v.CustomConstraints
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput)
}

// Optional. The OrgPolicy changes to preview violations for. Any existing OrgPolicies with the same name will be overridden in the simulation. That is, violations will be determined as if all policies in the overlay were created or updated.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput) Policies() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay) []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay {
		return v.Policies
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput)
}
...
// GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayInput is an input type that accepts GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs and GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput values.
// You can construct a concrete instance of `GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayInput` via:
//
//	GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs{...}
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayInput interface {
	pulumi.Input

	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput
	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutputWithContext(context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput
}

// A change to an OrgPolicy custom constraint.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs struct {
	// Optional. The new or updated custom constraint.
...
func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay)(nil)).Elem()
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput {
	return i.ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutputWithContext(context.Background())
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput)
}

// GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayInput is an input type that accepts GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArray and GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput values.
// You can construct a concrete instance of `GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayInput` via:
//
//	GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArray{ GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs{...} }
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayInput interface {
	pulumi.Input

	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput
	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutputWithContext(context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput
}

type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArray []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayInput

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay)(nil)).Elem()
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArray) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput {
	return i.ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutputWithContext(context.Background())
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArray) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput)
}

// A change to an OrgPolicy custom constraint.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput {
	return o
}

// Optional. The new or updated custom constraint.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput) CustomConstraint() GoogleCloudOrgpolicyV2CustomConstraintPtrOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay) *GoogleCloudOrgpolicyV2CustomConstraint {
		return v.CustomConstraint
	}).(GoogleCloudOrgpolicyV2CustomConstraintPtrOutput)
}

// Optional. Resource the constraint is attached to. Example: "organization/987654"
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput) CustomConstraintParent() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay) *string {
		return v.CustomConstraintParent
	}).(pulumi.StringPtrOutput)
}

type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput) Index(i pulumi.IntInput) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay {
		return vs[0].([]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlay)[vs[1].(int)]
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput)
}

// A change to an OrgPolicy custom constraint.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse struct {
	// Optional. The new or updated custom constraint.
...
// A change to an OrgPolicy custom constraint.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput {
	return o
}

// Optional. The new or updated custom constraint.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput) CustomConstraint() GoogleCloudOrgpolicyV2CustomConstraintResponseOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse) GoogleCloudOrgpolicyV2CustomConstraintResponse {
		return v.CustomConstraint
	}).(GoogleCloudOrgpolicyV2CustomConstraintResponseOutput)
}

// Optional. Resource the constraint is attached to. Example: "organization/987654"
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput) CustomConstraintParent() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse) string {
		return v.CustomConstraintParent
	}).(pulumi.StringOutput)
}

type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput) Index(i pulumi.IntInput) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse {
		return vs[0].([]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse)[vs[1].(int)]
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput)
}
...
// GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayInput is an input type that accepts GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs and GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput values.
// You can construct a concrete instance of `GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayInput` via:
//
//	GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs{...}
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayInput interface {
	pulumi.Input

	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput
	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutputWithContext(context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput
}

// A change to an OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs struct {
	// Optional. The new or updated OrgPolicy.
...
func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay)(nil)).Elem()
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput {
	return i.ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutputWithContext(context.Background())
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput)
}

// GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayInput is an input type that accepts GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArray and GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput values.
// You can construct a concrete instance of `GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayInput` via:
//
//	GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArray{ GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs{...} }
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayInput interface {
	pulumi.Input

	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput
	ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutputWithContext(context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput
}

type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArray []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayInput

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay)(nil)).Elem()
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArray) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput {
	return i.ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutputWithContext(context.Background())
}

func (i GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArray) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput)
}

// A change to an OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput {
	return o
}

// Optional. The new or updated OrgPolicy.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput) Policy() GoogleCloudOrgpolicyV2PolicyPtrOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay) *GoogleCloudOrgpolicyV2Policy {
		return v.Policy
	}).(GoogleCloudOrgpolicyV2PolicyPtrOutput)
}

// Optional. The parent of the policy we are attaching to. Example: "projects/123456"
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput) PolicyParent() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay) *string { return v.PolicyParent }).(pulumi.StringPtrOutput)
}

type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput) Index(i pulumi.IntInput) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay {
		return vs[0].([]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay)[vs[1].(int)]
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput)
}

// A change to an OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse struct {
	// Optional. The new or updated OrgPolicy.
...
// A change to an OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput {
	return o
}

// Optional. The new or updated OrgPolicy.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput) Policy() GoogleCloudOrgpolicyV2PolicyResponseOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse) GoogleCloudOrgpolicyV2PolicyResponse {
		return v.Policy
	}).(GoogleCloudOrgpolicyV2PolicyResponseOutput)
}

// Optional. The parent of the policy we are attaching to. Example: "projects/123456"
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput) PolicyParent() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse) string {
		return v.PolicyParent
	}).(pulumi.StringOutput)
}

type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput) Index(i pulumi.IntInput) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse {
		return vs[0].([]GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse)[vs[1].(int)]
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput)
}

// The proposed changes to OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponse struct {
	// Optional. The OrgPolicy CustomConstraint changes to preview violations for. Any existing CustomConstraints with the same name will be overridden in the simulation. That is, violations will be determined as if all custom constraints in the overlay were instantiated. Only a single custom_constraint is supported in the overlay at a time. For evaluating multiple constraints, multiple `GenerateOrgPolicyViolationsPreview` requests are made, where each request evaluates a single constraint.
	CustomConstraints []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse `pulumi:"customConstraints"`
	// Optional. The OrgPolicy changes to preview violations for. Any existing OrgPolicies with the same name will be overridden in the simulation. That is, violations will be determined as if all policies in the overlay were created or updated.
	Policies []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse `pulumi:"policies"`
}

// The proposed changes to OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponse)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput {
	return o
}

// Optional. The OrgPolicy CustomConstraint changes to preview violations for. Any existing CustomConstraints with the same name will be overridden in the simulation. That is, violations will be determined as if all custom constraints in the overlay were instantiated. Only a single custom_constraint is supported in the overlay at a time. For evaluating multiple constraints, multiple `GenerateOrgPolicyViolationsPreview` requests are made, where each request evaluates a single constraint.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput) CustomConstraints() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponse) []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponse {
		return v.CustomConstraints
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput)
}

// Optional. The OrgPolicy changes to preview violations for. Any existing OrgPolicies with the same name will be overridden in the simulation. That is, violations will be determined as if all policies in the overlay were created or updated.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput) Policies() GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponse) []GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponse {
		return v.Policies
	}).(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput)
}

// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponse struct {
...
// A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
type GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput struct{ *pulumi.OutputState }

func (GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponse)(nil)).Elem()
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput() GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput {
	return o
}

func (o GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput) ToGoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutputWithContext(ctx context.Context) GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput {
	return o
}

// Number of scanned resources with zero violations.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput) Compliant() pulumi.IntOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponse) int {
		return v.Compliant
	}).(pulumi.IntOutput)
}

// Number of resources that returned an error when scanned.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput) Errors() pulumi.IntOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponse) int {
		return v.Errors
	}).(pulumi.IntOutput)
}
...
// Number of scanned resources with at least one violation.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput) Noncompliant() pulumi.IntOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponse) int {
...
// Number of resources checked for compliance. Must equal: unenforced + noncompliant + compliant + error
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput) Scanned() pulumi.IntOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponse) int {
		return v.Scanned
	}).(pulumi.IntOutput)
}
...
// Number of resources where the constraint was not enforced, i.e. the Policy set `enforced: false` for that resource.
func (o GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput) Unenforced() pulumi.IntOutput {
	return o.ApplyT(func(v GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponse) int {
		return v.Unenforced
	}).(pulumi.IntOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayInput)(nil)).Elem(), GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayInput)(nil)).Elem(), GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayInput)(nil)).Elem(), GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayInput)(nil)).Elem(), GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayInput)(nil)).Elem(), GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArray{})
	...
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArrayOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayResponseArrayOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArrayOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayResponseArrayOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayResponseOutput{})
	pulumi.RegisterOutputType(GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCountsResponseOutput{})
