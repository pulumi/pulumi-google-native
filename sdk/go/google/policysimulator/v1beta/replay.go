...
func NewReplay(ctx *pulumi.Context,
	...
	var resource Replay
	err := ctx.RegisterResource("google-native:policysimulator/v1beta:Replay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReplay(ctx *pulumi.Context,
	...
	var resource Replay
	err := ctx.ReadResource("google-native:policysimulator/v1beta:Replay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type replayArgs struct {
	// The configuration used for the `Replay`.
	Config   GoogleCloudPolicysimulatorV1betaReplayConfig `pulumi:"config"`
...
// The configuration used for the `Replay`.
func (o ReplayOutput) Config() GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput {
	return o.ApplyT(func(v *Replay) GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput { return v.Config }).(GoogleCloudPolicysimulatorV1betaReplayConfigResponseOutput)
}
...
// Summary statistics about the replayed log entries.
func (o ReplayOutput) ResultsSummary() GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v *Replay) GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponseOutput {
