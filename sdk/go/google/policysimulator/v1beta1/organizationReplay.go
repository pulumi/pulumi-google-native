...
func NewOrganizationReplay(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:policysimulator/v1beta1:OrganizationReplay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationReplay(ctx *pulumi.Context,
	...
	var resource OrganizationReplay
	err := ctx.ReadResource("google-cloud:policysimulator/v1beta1:OrganizationReplay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
