...
func GetOrganizationReplay(ctx *pulumi.Context,
	...
	var resource OrganizationReplay
	err := ctx.ReadResource("google-native:policysimulator/v1beta1:OrganizationReplay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The configuration used for the `Replay`.
func (o OrganizationReplayOutput) Config() GoogleCloudPolicysimulatorV1beta1ReplayConfigResponseOutput {
	return o.ApplyT(func(v *OrganizationReplay) GoogleCloudPolicysimulatorV1beta1ReplayConfigResponseOutput {
		return v.Config
...
// Summary statistics about the replayed log entries.
func (o OrganizationReplayOutput) ResultsSummary() GoogleCloudPolicysimulatorV1beta1ReplayResultsSummaryResponseOutput {
	return o.ApplyT(func(v *OrganizationReplay) GoogleCloudPolicysimulatorV1beta1ReplayResultsSummaryResponseOutput {
