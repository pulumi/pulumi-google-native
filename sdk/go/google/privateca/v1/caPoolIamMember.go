...
func NewCaPoolIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:privateca/v1:CaPoolIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCaPoolIamMember(ctx *pulumi.Context,
	...
	var resource CaPoolIamMember
	err := ctx.ReadResource("google-native:privateca/v1:CaPoolIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *CaPoolIamMember) ToOutput(ctx context.Context) pulumix.Output[*CaPoolIamMember] {
	return pulumix.Output[*CaPoolIamMember]{
		OutputState: i.ToCaPoolIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o CaPoolIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*CaPoolIamMember] {
	return pulumix.Output[*CaPoolIamMember]{
...
func (o CaPoolIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *CaPoolIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
func (o CaPoolIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *CaPoolIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
