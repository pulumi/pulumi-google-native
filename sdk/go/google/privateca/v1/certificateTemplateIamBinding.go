...
func NewCertificateTemplateIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:privateca/v1:CertificateTemplateIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateTemplateIamBinding(ctx *pulumi.Context,
	...
	var resource CertificateTemplateIamBinding
	err := ctx.ReadResource("google-native:privateca/v1:CertificateTemplateIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o CertificateTemplateIamBindingOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *CertificateTemplateIamBinding) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
func (o CertificateTemplateIamBindingOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *CertificateTemplateIamBinding) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
