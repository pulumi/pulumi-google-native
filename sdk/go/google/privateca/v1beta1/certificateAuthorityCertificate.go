...
func NewCertificateAuthorityCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:privateca/v1beta1:CertificateAuthorityCertificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateAuthorityCertificate(ctx *pulumi.Context,
	...
	var resource CertificateAuthorityCertificate
	err := ctx.ReadResource("google-cloud:privateca/v1beta1:CertificateAuthorityCertificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type certificateAuthorityCertificateArgs struct {
	...
	RevocationDetails *RevocationDetails `pulumi:"revocationDetails"`
...
type CertificateAuthorityCertificateArgs struct {
	...
	// Output only. Details regarding the revocation of this Certificate. This Certificate is considered revoked if and only if this field is present.
	RevocationDetails RevocationDetailsPtrInput
	// Output only. The time at which this Certificate was updated.
