...
func (i *CertificateAuthorityCertificateRevocationListIamBinding) ToOutput(ctx context.Context) pulumix.Output[*CertificateAuthorityCertificateRevocationListIamBinding] {
	return pulumix.Output[*CertificateAuthorityCertificateRevocationListIamBinding]{
		OutputState: i.ToCertificateAuthorityCertificateRevocationListIamBindingOutputWithContext(ctx).OutputState,
	}
}
...
func (o CertificateAuthorityCertificateRevocationListIamBindingOutput) ToOutput(ctx context.Context) pulumix.Output[*CertificateAuthorityCertificateRevocationListIamBinding] {
	return pulumix.Output[*CertificateAuthorityCertificateRevocationListIamBinding]{
