...
func LookupCertificateAuthorityCertificateRevocationListIamPolicy(ctx *pulumi.Context, args *LookupCertificateAuthorityCertificateRevocationListIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupCertificateAuthorityCertificateRevocationListIamPolicyResult, error) {
	...
	var rv LookupCertificateAuthorityCertificateRevocationListIamPolicyResult
	err := ctx.Invoke("google-native:privateca/v1beta1:getCertificateAuthorityCertificateRevocationListIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCertificateAuthorityCertificateRevocationListIamPolicyArgs struct {
...
type LookupCertificateAuthorityCertificateRevocationListIamPolicyResult struct {
...
func LookupCertificateAuthorityCertificateRevocationListIamPolicyOutput(ctx *pulumi.Context, args LookupCertificateAuthorityCertificateRevocationListIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupCertificateAuthorityCertificateRevocationListIamPolicyResult, error) {
			args := v.(LookupCertificateAuthorityCertificateRevocationListIamPolicyArgs)
			r, err := LookupCertificateAuthorityCertificateRevocationListIamPolicy(ctx, &args, opts...)
			var s LookupCertificateAuthorityCertificateRevocationListIamPolicyResult
			if r != nil {
				s = *r
			}
			return s, err
		}).(LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput)
}

type LookupCertificateAuthorityCertificateRevocationListIamPolicyOutputArgs struct {
...
func (LookupCertificateAuthorityCertificateRevocationListIamPolicyOutputArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupCertificateAuthorityCertificateRevocationListIamPolicyArgs)(nil)).Elem()
}
...
func (LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupCertificateAuthorityCertificateRevocationListIamPolicyResult)(nil)).Elem()
}
...
func (o LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupCertificateAuthorityCertificateRevocationListIamPolicyResult] {
	return pulumix.Output[LookupCertificateAuthorityCertificateRevocationListIamPolicyResult]{
...
func (o LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput) AuditConfigs() AuditConfigResponseArrayOutput {
	return o.ApplyT(func(v LookupCertificateAuthorityCertificateRevocationListIamPolicyResult) []AuditConfigResponse {
...
func (o LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupCertificateAuthorityCertificateRevocationListIamPolicyResult) []BindingResponse {
		return v.Bindings
...
func (o LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCertificateAuthorityCertificateRevocationListIamPolicyResult) string { return v.Etag }).(pulumi.StringOutput)
}

// Specifies the format of the policy. Valid values are `0`, `1`, and `3`. Requests that specify an invalid value are rejected. Any operation that affects conditional role bindings must specify version `3`. This requirement applies to the following operations: * Getting a policy that includes a conditional role binding * Adding a conditional role binding to a policy * Changing a conditional role binding in a policy * Removing any role binding, with or without a condition, from a policy that includes conditions **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost. If a policy does not include any conditions, operations on that policy may specify any valid version or leave the field unset. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
func (o LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupCertificateAuthorityCertificateRevocationListIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}

func init() {
	pulumi.RegisterOutputType(LookupCertificateAuthorityCertificateRevocationListIamPolicyResultOutput{})
}
