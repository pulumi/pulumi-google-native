...
func (o LookupCertificateAuthorityIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupCertificateAuthorityIamPolicyResult] {
	return pulumix.Output[LookupCertificateAuthorityIamPolicyResult]{
