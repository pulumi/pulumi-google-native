...
func (i *SchemaIamMember) ToOutput(ctx context.Context) pulumix.Output[*SchemaIamMember] {
	return pulumix.Output[*SchemaIamMember]{
		OutputState: i.ToSchemaIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o SchemaIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*SchemaIamMember] {
	return pulumix.Output[*SchemaIamMember]{
