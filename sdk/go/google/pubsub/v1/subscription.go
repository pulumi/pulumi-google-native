...
func NewSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:pubsub/v1:Subscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscription(ctx *pulumi.Context,
	...
	var resource Subscription
	err := ctx.ReadResource("google-cloud:pubsub/v1:Subscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
