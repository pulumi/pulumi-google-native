...
func NewSubscriptionIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:pubsub/v1:SubscriptionIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionIamBinding(ctx *pulumi.Context,
	...
	var resource SubscriptionIamBinding
	err := ctx.ReadResource("google-native:pubsub/v1:SubscriptionIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
