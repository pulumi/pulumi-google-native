...
func NewSubscriptionIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:pubsub/v1:SubscriptionIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionIamMember(ctx *pulumi.Context,
	...
	var resource SubscriptionIamMember
	err := ctx.ReadResource("google-native:pubsub/v1:SubscriptionIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
