...
func NewSubscriptionIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:pubsub/v1:SubscriptionIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionIamPolicy(ctx *pulumi.Context,
	...
	var resource SubscriptionIamPolicy
	err := ctx.ReadResource("google-native:pubsub/v1:SubscriptionIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
