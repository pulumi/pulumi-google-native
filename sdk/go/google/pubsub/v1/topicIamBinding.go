...
func NewTopicIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:pubsub/v1:TopicIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicIamBinding(ctx *pulumi.Context,
	...
	var resource TopicIamBinding
	err := ctx.ReadResource("google-native:pubsub/v1:TopicIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
