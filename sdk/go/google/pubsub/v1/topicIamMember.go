...
func NewTopicIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:pubsub/v1:TopicIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicIamMember(ctx *pulumi.Context,
	...
	var resource TopicIamMember
	err := ctx.ReadResource("google-native:pubsub/v1:TopicIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// An IAM Condition for a given binding. See https://cloud.google.com/iam/docs/conditions-overview for additional details.
func (o TopicIamMemberOutput) Condition() iam.ConditionPtrOutput {
	return o.ApplyT(func(v *TopicIamMember) iam.ConditionPtrOutput { return v.Condition }).(iam.ConditionPtrOutput)
}
...
// The name of the resource to manage IAM policies for.
func (o TopicIamMemberOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TopicIamMember) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
