...
func NewTopicIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:pubsub/v1:TopicIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicIamPolicy(ctx *pulumi.Context,
	...
	var resource TopicIamPolicy
	err := ctx.ReadResource("google-cloud:pubsub/v1:TopicIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
