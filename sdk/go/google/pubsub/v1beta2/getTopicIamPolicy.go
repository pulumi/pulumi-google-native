...
func LookupTopicIamPolicy(ctx *pulumi.Context, args *LookupTopicIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupTopicIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:pubsub/v1beta2:getTopicIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupTopicIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTopicIamPolicyResult] {
	return pulumix.Output[LookupTopicIamPolicyResult]{
...
func (o LookupTopicIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupTopicIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupTopicIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupTopicIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
