...
func NewTopicIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:pubsub/v1beta2:TopicIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicIamMember(ctx *pulumi.Context,
	...
	var resource TopicIamMember
	err := ctx.ReadResource("google-native:pubsub/v1beta2:TopicIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
