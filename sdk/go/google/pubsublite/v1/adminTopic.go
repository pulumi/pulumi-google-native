...
func NewAdminTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:pubsublite/v1:AdminTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdminTopic(ctx *pulumi.Context,
	...
	var resource AdminTopic
	err := ctx.ReadResource("google-cloud:pubsublite/v1:AdminTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
