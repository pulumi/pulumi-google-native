...
// Required. Describes how this key is integrated with the website.
func (o GoogleCloudRecaptchaenterpriseV1WebKeySettingsOutput) IntegrationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GoogleCloudRecaptchaenterpriseV1WebKeySettings) *string { return v.IntegrationType }).(pulumi.StringPtrOutput)
}
