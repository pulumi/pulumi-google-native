...
type WeeklyMaintenanceWindowArgs struct {
	...
	// Required. Start time of the window in UTC time.
	StartTime TimeOfDayPtrInput `pulumi:"startTime"`
}
...
// Required. The day of week that maintenance updates occur.
func (o WeeklyMaintenanceWindowOutput) Day() pulumi.StringPtrOutput {
	return o.ApplyT(func(v WeeklyMaintenanceWindow) *string { return v.Day }).(pulumi.StringPtrOutput)
}

// Required. Start time of the window in UTC time.
func (o WeeklyMaintenanceWindowOutput) StartTime() TimeOfDayPtrOutput {
	return o.ApplyT(func(v WeeklyMaintenanceWindow) *TimeOfDay { return v.StartTime }).(TimeOfDayPtrOutput)
}
