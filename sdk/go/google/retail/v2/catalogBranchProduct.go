...
func NewCatalogBranchProduct(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:retail/v2:CatalogBranchProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCatalogBranchProduct(ctx *pulumi.Context,
	...
	var resource CatalogBranchProduct
	err := ctx.ReadResource("google-cloud:retail/v2:CatalogBranchProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
