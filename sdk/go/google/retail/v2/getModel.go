...
func LookupModel(ctx *pulumi.Context, args *LookupModelArgs, opts ...pulumi.InvokeOption) (*LookupModelResult, error) {
	...
	err := ctx.Invoke("google-native:retail/v2:getModel", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Optional. Additional model features config.
func (o LookupModelResultOutput) ModelFeaturesConfig() GoogleCloudRetailV2ModelModelFeaturesConfigResponseOutput {
	return o.ApplyT(func(v LookupModelResult) GoogleCloudRetailV2ModelModelFeaturesConfigResponse {
		return v.ModelFeaturesConfig
	}).(GoogleCloudRetailV2ModelModelFeaturesConfigResponseOutput)
}
...
// The list of valid serving configs associated with the PageOptimizationConfig.
func (o LookupModelResultOutput) ServingConfigLists() GoogleCloudRetailV2ModelServingConfigListResponseArrayOutput {
	return o.ApplyT(func(v LookupModelResult) []GoogleCloudRetailV2ModelServingConfigListResponse {
