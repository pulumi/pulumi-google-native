...
type Product struct {
	...
	Attributes GoogleCloudRetailV2CustomAttributeResponseOutput `pulumi:"attributes"`
...
type productArgs struct {
	// Highly encouraged. Extra product attributes to be included. For example, for products, this could include the store name, vendor, style, color, etc. These are very strong signals for recommendation model, thus we highly recommend providing the attributes here. Features that can take on one of a limited number of possible values. Two types of features can be set are: Textual features. some examples would be the brand/maker of a product, or country of a customer. Numerical features. Some examples would be the height/weight of a product, or age of a customer. For example: `{ "vendor": {"text": ["vendor123", "vendor456"]}, "lengths_cm": {"numbers":[2.3, 15.4]}, "heights_cm": {"numbers":[8.1, 6.4]} }`. This field needs to pass all below criteria, otherwise an INVALID_ARGUMENT error is returned: * Max entries count: 200. * The key must be a UTF-8 encoded string with a length limit of 128 characters. * For indexable attribute, the key must match the pattern: `a-zA-Z0-9*`. For example, `key0LikeThis` or `KEY_1_LIKE_THIS`. * For text attributes, at most 400 values are allowed. Empty values are not allowed. Each value must be a non-empty UTF-8 encoded string with a length limit of 256 characters. * For number attributes, at most 400 values are allowed.
	Attributes *GoogleCloudRetailV2CustomAttribute `pulumi:"attributes"`
	// The target group associated with a given audience (e.g. male, veterans, car owners, musicians, etc.) of the product.
...
type ProductArgs struct {
	// Highly encouraged. Extra product attributes to be included. For example, for products, this could include the store name, vendor, style, color, etc. These are very strong signals for recommendation model, thus we highly recommend providing the attributes here. Features that can take on one of a limited number of possible values. Two types of features can be set are: Textual features. some examples would be the brand/maker of a product, or country of a customer. Numerical features. Some examples would be the height/weight of a product, or age of a customer. For example: `{ "vendor": {"text": ["vendor123", "vendor456"]}, "lengths_cm": {"numbers":[2.3, 15.4]}, "heights_cm": {"numbers":[8.1, 6.4]} }`. This field needs to pass all below criteria, otherwise an INVALID_ARGUMENT error is returned: * Max entries count: 200. * The key must be a UTF-8 encoded string with a length limit of 128 characters. * For indexable attribute, the key must match the pattern: `a-zA-Z0-9*`. For example, `key0LikeThis` or `KEY_1_LIKE_THIS`. * For text attributes, at most 400 values are allowed. Empty values are not allowed. Each value must be a non-empty UTF-8 encoded string with a length limit of 256 characters. * For number attributes, at most 400 values are allowed.
	Attributes GoogleCloudRetailV2CustomAttributePtrInput
	// The target group associated with a given audience (e.g. male, veterans, car owners, musicians, etc.) of the product.
...
// Highly encouraged. Extra product attributes to be included. For example, for products, this could include the store name, vendor, style, color, etc. These are very strong signals for recommendation model, thus we highly recommend providing the attributes here. Features that can take on one of a limited number of possible values. Two types of features can be set are: Textual features. some examples would be the brand/maker of a product, or country of a customer. Numerical features. Some examples would be the height/weight of a product, or age of a customer. For example: `{ "vendor": {"text": ["vendor123", "vendor456"]}, "lengths_cm": {"numbers":[2.3, 15.4]}, "heights_cm": {"numbers":[8.1, 6.4]} }`. This field needs to pass all below criteria, otherwise an INVALID_ARGUMENT error is returned: * Max entries count: 200. * The key must be a UTF-8 encoded string with a length limit of 128 characters. * For indexable attribute, the key must match the pattern: `a-zA-Z0-9*`. For example, `key0LikeThis` or `KEY_1_LIKE_THIS`. * For text attributes, at most 400 values are allowed. Empty values are not allowed. Each value must be a non-empty UTF-8 encoded string with a length limit of 256 characters. * For number attributes, at most 400 values are allowed.
func (o ProductOutput) Attributes() GoogleCloudRetailV2CustomAttributeResponseOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2CustomAttributeResponseOutput { return v.Attributes }).(GoogleCloudRetailV2CustomAttributeResponseOutput)
}

// The target group associated with a given audience (e.g. male, veterans, car owners, musicians, etc.) of the product.
func (o ProductOutput) Audience() GoogleCloudRetailV2AudienceResponseOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2AudienceResponseOutput { return v.Audience }).(GoogleCloudRetailV2AudienceResponseOutput)
}
...
// The color of the product. Corresponding properties: Google Merchant Center property [color](https://support.google.com/merchants/answer/6324487). Schema.org property [Product.color](https://schema.org/color).
func (o ProductOutput) ColorInfo() GoogleCloudRetailV2ColorInfoResponseOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2ColorInfoResponseOutput { return v.ColorInfo }).(GoogleCloudRetailV2ColorInfoResponseOutput)
}
...
// Fulfillment information, such as the store IDs for in-store pickup or region IDs for different shipping methods. All the elements must have distinct FulfillmentInfo.type. Otherwise, an INVALID_ARGUMENT error is returned.
func (o ProductOutput) FulfillmentInfo() GoogleCloudRetailV2FulfillmentInfoResponseArrayOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2FulfillmentInfoResponseArrayOutput { return v.FulfillmentInfo }).(GoogleCloudRetailV2FulfillmentInfoResponseArrayOutput)
}
...
// Product images for the product. We highly recommend putting the main image first. A maximum of 300 images are allowed. Corresponding properties: Google Merchant Center property [image_link](https://support.google.com/merchants/answer/6324350). Schema.org property [Product.image](https://schema.org/image).
func (o ProductOutput) Images() GoogleCloudRetailV2ImageResponseArrayOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2ImageResponseArrayOutput { return v.Images }).(GoogleCloudRetailV2ImageResponseArrayOutput)
}
...
// A list of local inventories specific to different places. This field can be managed by ProductService.AddLocalInventories and ProductService.RemoveLocalInventories APIs if fine-grained, high-volume updates are necessary.
func (o ProductOutput) LocalInventories() GoogleCloudRetailV2LocalInventoryResponseArrayOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2LocalInventoryResponseArrayOutput { return v.LocalInventories }).(GoogleCloudRetailV2LocalInventoryResponseArrayOutput)
}
...
// Product price and cost information. Corresponding properties: Google Merchant Center property [price](https://support.google.com/merchants/answer/6324371).
func (o ProductOutput) PriceInfo() GoogleCloudRetailV2PriceInfoResponseOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2PriceInfoResponseOutput { return v.PriceInfo }).(GoogleCloudRetailV2PriceInfoResponseOutput)
}
...
// The promotions applied to the product. A maximum of 10 values are allowed per Product. Only Promotion.promotion_id will be used, other fields will be ignored if set.
func (o ProductOutput) Promotions() GoogleCloudRetailV2PromotionResponseArrayOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2PromotionResponseArrayOutput { return v.Promotions }).(GoogleCloudRetailV2PromotionResponseArrayOutput)
}
...
// The rating of this product.
func (o ProductOutput) Rating() GoogleCloudRetailV2RatingResponseOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2RatingResponseOutput { return v.Rating }).(GoogleCloudRetailV2RatingResponseOutput)
}
...
// Product variants grouped together on primary product which share similar product attributes. It's automatically grouped by primary_product_id for all the product variants. Only populated for Type.PRIMARY Products. Note: This field is OUTPUT_ONLY for ProductService.GetProduct. Do not set this field in API requests.
func (o ProductOutput) Variants() GoogleCloudRetailV2ProductResponseArrayOutput {
	return o.ApplyT(func(v *Product) GoogleCloudRetailV2ProductResponseArrayOutput { return v.Variants }).(GoogleCloudRetailV2ProductResponseArrayOutput)
}
