...
func (i GoogleCloudRetailV2CustomAttributeArgs) ToGoogleCloudRetailV2CustomAttributePtrOutput() GoogleCloudRetailV2CustomAttributePtrOutput {
	return i.ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(context.Background())
}

func (i GoogleCloudRetailV2CustomAttributeArgs) ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(ctx context.Context) GoogleCloudRetailV2CustomAttributePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleCloudRetailV2CustomAttributeOutput).ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(ctx)
}

// GoogleCloudRetailV2CustomAttributePtrInput is an input type that accepts GoogleCloudRetailV2CustomAttributeArgs, GoogleCloudRetailV2CustomAttributePtr and GoogleCloudRetailV2CustomAttributePtrOutput values.
// You can construct a concrete instance of `GoogleCloudRetailV2CustomAttributePtrInput` via:
//
//	        GoogleCloudRetailV2CustomAttributeArgs{...}
//
//	or:
//
//	        nil
type GoogleCloudRetailV2CustomAttributePtrInput interface {
	pulumi.Input

	ToGoogleCloudRetailV2CustomAttributePtrOutput() GoogleCloudRetailV2CustomAttributePtrOutput
	ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(context.Context) GoogleCloudRetailV2CustomAttributePtrOutput
}

type googleCloudRetailV2CustomAttributePtrType GoogleCloudRetailV2CustomAttributeArgs

func GoogleCloudRetailV2CustomAttributePtr(v *GoogleCloudRetailV2CustomAttributeArgs) GoogleCloudRetailV2CustomAttributePtrInput {
	return (*googleCloudRetailV2CustomAttributePtrType)(v)
}

func (*googleCloudRetailV2CustomAttributePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**GoogleCloudRetailV2CustomAttribute)(nil)).Elem()
}

func (i *googleCloudRetailV2CustomAttributePtrType) ToGoogleCloudRetailV2CustomAttributePtrOutput() GoogleCloudRetailV2CustomAttributePtrOutput {
	return i.ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(context.Background())
}

func (i *googleCloudRetailV2CustomAttributePtrType) ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(ctx context.Context) GoogleCloudRetailV2CustomAttributePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleCloudRetailV2CustomAttributePtrOutput)
}
...
func (o GoogleCloudRetailV2CustomAttributeOutput) ToGoogleCloudRetailV2CustomAttributePtrOutput() GoogleCloudRetailV2CustomAttributePtrOutput {
	return o.ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(context.Background())
}

func (o GoogleCloudRetailV2CustomAttributeOutput) ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(ctx context.Context) GoogleCloudRetailV2CustomAttributePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v GoogleCloudRetailV2CustomAttribute) *GoogleCloudRetailV2CustomAttribute {
		return &v
	}).(GoogleCloudRetailV2CustomAttributePtrOutput)
}
...
type GoogleCloudRetailV2CustomAttributePtrOutput struct{ *pulumi.OutputState }

func (GoogleCloudRetailV2CustomAttributePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**GoogleCloudRetailV2CustomAttribute)(nil)).Elem()
}

func (o GoogleCloudRetailV2CustomAttributePtrOutput) ToGoogleCloudRetailV2CustomAttributePtrOutput() GoogleCloudRetailV2CustomAttributePtrOutput {
	return o
}

func (o GoogleCloudRetailV2CustomAttributePtrOutput) ToGoogleCloudRetailV2CustomAttributePtrOutputWithContext(ctx context.Context) GoogleCloudRetailV2CustomAttributePtrOutput {
	return o
}

func (o GoogleCloudRetailV2CustomAttributePtrOutput) Elem() GoogleCloudRetailV2CustomAttributeOutput {
	return o.ApplyT(func(v *GoogleCloudRetailV2CustomAttribute) GoogleCloudRetailV2CustomAttribute {
		if v != nil {
			return *v
		}
		var ret GoogleCloudRetailV2CustomAttribute
		return ret
	}).(GoogleCloudRetailV2CustomAttributeOutput)
}

// This field is normally ignored unless AttributesConfig.attribute_config_level of the Catalog is set to the deprecated 'PRODUCT_LEVEL_ATTRIBUTE_CONFIG' mode. For information about product-level attribute configuration, see [Configuration modes](https://cloud.google.com/retail/docs/attribute-config#config-modes). If true, custom attribute values are indexed, so that they can be filtered, faceted or boosted in SearchService.Search. This field is ignored in a UserEvent. See SearchRequest.filter, SearchRequest.facet_specs and SearchRequest.boost_spec for more details.
func (o GoogleCloudRetailV2CustomAttributePtrOutput) Indexable() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *GoogleCloudRetailV2CustomAttribute) *bool {
		if v == nil {
			return nil
		}
		return v.Indexable
...
// The numerical values of this custom attribute. For example, `[2.3, 15.4]` when the key is "lengths_cm". Exactly one of text or numbers should be set. Otherwise, an INVALID_ARGUMENT error is returned.
func (o GoogleCloudRetailV2CustomAttributePtrOutput) Numbers() pulumi.Float64ArrayOutput {
	return o.ApplyT(func(v *GoogleCloudRetailV2CustomAttribute) []float64 {
		if v == nil {
			return nil
		}
		return v.Numbers
...
// This field is normally ignored unless AttributesConfig.attribute_config_level of the Catalog is set to the deprecated 'PRODUCT_LEVEL_ATTRIBUTE_CONFIG' mode. For information about product-level attribute configuration, see [Configuration modes](https://cloud.google.com/retail/docs/attribute-config#config-modes). If true, custom attribute values are searchable by text queries in SearchService.Search. This field is ignored in a UserEvent. Only set if type text is set. Otherwise, a INVALID_ARGUMENT error is returned.
func (o GoogleCloudRetailV2CustomAttributePtrOutput) Searchable() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *GoogleCloudRetailV2CustomAttribute) *bool {
		if v == nil {
			return nil
		}
...
// The textual values of this custom attribute. For example, `["yellow", "green"]` when the key is "color". Empty string is not allowed. Otherwise, an INVALID_ARGUMENT error is returned. Exactly one of text or numbers should be set. Otherwise, an INVALID_ARGUMENT error is returned.
func (o GoogleCloudRetailV2CustomAttributePtrOutput) Text() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *GoogleCloudRetailV2CustomAttribute) []string {
		if v == nil {
			return nil
		}
		return v.Text
...
type GoogleCloudRetailV2LocalInventoryResponse struct {
	...
	Attributes GoogleCloudRetailV2CustomAttributeResponse `pulumi:"attributes"`
...
// Additional local inventory attributes, for example, store name, promotion tags, etc. This field needs to pass all below criteria, otherwise an INVALID_ARGUMENT error is returned: * At most 30 attributes are allowed. * The key must be a UTF-8 encoded string with a length limit of 32 characters. * The key must match the pattern: `a-zA-Z0-9*`. For example, key0LikeThis or KEY_1_LIKE_THIS. * The attribute values must be of the same type (text or number). * Only 1 value is allowed for each attribute. * For text values, the length limit is 256 UTF-8 characters. * The attribute does not support search. The `searchable` field should be unset or set to false. * The max summed total bytes of custom attribute keys and values per product is 5MiB.
func (o GoogleCloudRetailV2LocalInventoryResponseOutput) Attributes() GoogleCloudRetailV2CustomAttributeResponseOutput {
	return o.ApplyT(func(v GoogleCloudRetailV2LocalInventoryResponse) GoogleCloudRetailV2CustomAttributeResponse {
		return v.Attributes
...
// Highly encouraged. Extra product attributes to be included. For example, for products, this could include the store name, vendor, style, color, etc. These are very strong signals for recommendation model, thus we highly recommend providing the attributes here. Features that can take on one of a limited number of possible values. Two types of features can be set are: Textual features. some examples would be the brand/maker of a product, or country of a customer. Numerical features. Some examples would be the height/weight of a product, or age of a customer. For example: `{ "vendor": {"text": ["vendor123", "vendor456"]}, "lengths_cm": {"numbers":[2.3, 15.4]}, "heights_cm": {"numbers":[8.1, 6.4]} }`. This field needs to pass all below criteria, otherwise an INVALID_ARGUMENT error is returned: * Max entries count: 200. * The key must be a UTF-8 encoded string with a length limit of 128 characters. * For indexable attribute, the key must match the pattern: `a-zA-Z0-9*`. For example, `key0LikeThis` or `KEY_1_LIKE_THIS`. * For text attributes, at most 400 values are allowed. Empty values are not allowed. Each value must be a non-empty UTF-8 encoded string with a length limit of 256 characters. * For number attributes, at most 400 values are allowed.
func (o GoogleCloudRetailV2ProductResponseOutput) Attributes() GoogleCloudRetailV2CustomAttributeResponseOutput {
	return o.ApplyT(func(v GoogleCloudRetailV2ProductResponse) GoogleCloudRetailV2CustomAttributeResponse {
		return v.Attributes
	}).(GoogleCloudRetailV2CustomAttributeResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GoogleCloudRetailV2CustomAttributePtrInput)(nil)).Elem(), GoogleCloudRetailV2CustomAttributeArgs{})
	...
	pulumi.RegisterOutputType(GoogleCloudRetailV2CustomAttributePtrOutput{})
