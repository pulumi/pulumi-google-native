...
// What kind of diversity to use - data driven or rule based.
func (o LookupServingConfigResultOutput) DiversityType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupServingConfigResult) string { return v.DiversityType }).(pulumi.StringOutput)
}
...
// The specification for personalization spec. Can only be set if solution_types is SOLUTION_TYPE_SEARCH. Notice that if both ServingConfig.personalization_spec and SearchRequest.personalization_spec are set. SearchRequest.personalization_spec will override ServingConfig.personalization_spec.
func (o LookupServingConfigResultOutput) PersonalizationSpec() GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponseOutput {
	return o.ApplyT(func(v LookupServingConfigResult) GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse {
		return v.PersonalizationSpec
	}).(GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponseOutput)
}
