...
type modelArgs struct {
	...
	// Optional. Additional model features config.
	ModelFeaturesConfig *GoogleCloudRetailV2alphaModelModelFeaturesConfig `pulumi:"modelFeaturesConfig"`
	// The fully qualified resource name of the model. Format: `projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/models/{model_id}` catalog_id has char limit of 50. recommendation_model_id has char limit of 40.
...
// Optional. Additional model features config.
func (o ModelOutput) ModelFeaturesConfig() GoogleCloudRetailV2alphaModelModelFeaturesConfigResponseOutput {
	return o.ApplyT(func(v *Model) GoogleCloudRetailV2alphaModelModelFeaturesConfigResponseOutput {
