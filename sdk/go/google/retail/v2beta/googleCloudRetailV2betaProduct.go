...
// NewGoogleCloudRetailV2betaProduct registers a new resource with the given unique name, arguments, and options.
func NewGoogleCloudRetailV2betaProduct(ctx *pulumi.Context,
	name string, args *GoogleCloudRetailV2betaProductArgs, opts ...pulumi.ResourceOption) (*GoogleCloudRetailV2betaProduct, error) {
	if args == nil {
	...
	var resource GoogleCloudRetailV2betaProduct
	err := ctx.RegisterResource("google-cloud:retail/v2beta:GoogleCloudRetailV2betaProduct", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetGoogleCloudRetailV2betaProduct gets an existing GoogleCloudRetailV2betaProduct resource's state with the given name, ID, and optional
// state properties that are used to uniquely qualify the lookup (nil if not required).
func GetGoogleCloudRetailV2betaProduct(ctx *pulumi.Context,
	name string, id pulumi.IDInput, state *GoogleCloudRetailV2betaProductState, opts ...pulumi.ResourceOption) (*GoogleCloudRetailV2betaProduct, error) {
	var resource GoogleCloudRetailV2betaProduct
	err := ctx.ReadResource("google-cloud:retail/v2beta:GoogleCloudRetailV2betaProduct", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering GoogleCloudRetailV2betaProduct resources.
type googleCloudRetailV2betaProductState struct {
}

type GoogleCloudRetailV2betaProductState struct {
}

func (GoogleCloudRetailV2betaProductState) ElementType() reflect.Type {
	return reflect.TypeOf((*googleCloudRetailV2betaProductState)(nil)).Elem()
}

type googleCloudRetailV2betaProductArgs struct {
...
// The set of arguments for constructing a GoogleCloudRetailV2betaProduct resource.
type GoogleCloudRetailV2betaProductArgs struct {
	// Highly encouraged. Extra product attributes to be included. For example, for products, this could include the store name, vendor, style, color, etc. These are very strong signals for recommendation model, thus we highly recommend providing the attributes here. Features that can take on one of a limited number of possible values. Two types of features can be set are: Textual features. some examples would be the brand/maker of a product, or country of a customer. Numerical features. Some examples would be the height/weight of a product, or age of a customer. For example: `{ "vendor": {"text": ["vendor123", "vendor456"]}, "lengths_cm": {"numbers":[2.3, 15.4]}, "heights_cm": {"numbers":[8.1, 6.4]} }`. This field needs to pass all below criteria, otherwise an INVALID_ARGUMENT error is returned: * Max entries count: 150 by default; 100 for Type.VARIANT. * The key must be a UTF-8 encoded string with a length limit of 128 characters.
...
func (GoogleCloudRetailV2betaProductArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*googleCloudRetailV2betaProductArgs)(nil)).Elem()
}

type GoogleCloudRetailV2betaProductInput interface {
	pulumi.Input

	ToGoogleCloudRetailV2betaProductOutput() GoogleCloudRetailV2betaProductOutput
	ToGoogleCloudRetailV2betaProductOutputWithContext(ctx context.Context) GoogleCloudRetailV2betaProductOutput
}

func (*GoogleCloudRetailV2betaProduct) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudRetailV2betaProduct)(nil))
}

func (i *GoogleCloudRetailV2betaProduct) ToGoogleCloudRetailV2betaProductOutput() GoogleCloudRetailV2betaProductOutput {
	return i.ToGoogleCloudRetailV2betaProductOutputWithContext(context.Background())
}

func (i *GoogleCloudRetailV2betaProduct) ToGoogleCloudRetailV2betaProductOutputWithContext(ctx context.Context) GoogleCloudRetailV2betaProductOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GoogleCloudRetailV2betaProductOutput)
}

type GoogleCloudRetailV2betaProductOutput struct {
	*pulumi.OutputState
}

func (GoogleCloudRetailV2betaProductOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudRetailV2betaProduct)(nil))
}

func (o GoogleCloudRetailV2betaProductOutput) ToGoogleCloudRetailV2betaProductOutput() GoogleCloudRetailV2betaProductOutput {
	return o
}

func (o GoogleCloudRetailV2betaProductOutput) ToGoogleCloudRetailV2betaProductOutputWithContext(ctx context.Context) GoogleCloudRetailV2betaProductOutput {
	return o
}

func init() {
	pulumi.RegisterOutputType(GoogleCloudRetailV2betaProductOutput{})
}
