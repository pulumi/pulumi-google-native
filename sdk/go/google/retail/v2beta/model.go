...
func NewModel(ctx *pulumi.Context,
	...
	var resource Model
	err := ctx.RegisterResource("google-native:retail/v2beta:Model", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModel(ctx *pulumi.Context,
	...
	var resource Model
	err := ctx.ReadResource("google-native:retail/v2beta:Model", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type modelArgs struct {
	...
	// Optional. Additional model features config.
	ModelFeaturesConfig *GoogleCloudRetailV2betaModelModelFeaturesConfig `pulumi:"modelFeaturesConfig"`
	// The fully qualified resource name of the model. Format: `projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/models/{model_id}` catalog_id has char limit of 50. recommendation_model_id has char limit of 40.
...
// Optional. Additional model features config.
func (o ModelOutput) ModelFeaturesConfig() GoogleCloudRetailV2betaModelModelFeaturesConfigResponseOutput {
	return o.ApplyT(func(v *Model) GoogleCloudRetailV2betaModelModelFeaturesConfigResponseOutput {
...
// The list of valid serving configs associated with the PageOptimizationConfig.
func (o ModelOutput) ServingConfigLists() GoogleCloudRetailV2betaModelServingConfigListResponseArrayOutput {
	return o.ApplyT(func(v *Model) GoogleCloudRetailV2betaModelServingConfigListResponseArrayOutput {
