...
func NewJobIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:run/v1:JobIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobIamMember(ctx *pulumi.Context,
	...
	var resource JobIamMember
	err := ctx.ReadResource("google-native:run/v1:JobIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
