...
func NewJobIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:run/v1:JobIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobIamPolicy(ctx *pulumi.Context,
	...
	var resource JobIamPolicy
	err := ctx.ReadResource("google-native:run/v1:JobIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
