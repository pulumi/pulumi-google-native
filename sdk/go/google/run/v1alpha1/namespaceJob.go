...
func NewNamespaceJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:run/v1alpha1:NamespaceJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceJob(ctx *pulumi.Context,
	...
	var resource NamespaceJob
	err := ctx.ReadResource("google-cloud:run/v1alpha1:NamespaceJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
