...
func NewNamespaceService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:run/v1alpha1:NamespaceService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceService(ctx *pulumi.Context,
	...
	var resource NamespaceService
	err := ctx.ReadResource("google-cloud:run/v1alpha1:NamespaceService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
