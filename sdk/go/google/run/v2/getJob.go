...
type LookupJobResult struct {
	...
	ContainerStatuses []GoogleCloudRunV2ContainerStatusResponse `pulumi:"containerStatuses"`
	// The creation time.
...
// Status information for each of the containers specified.
func (o LookupJobResultOutput) ContainerStatuses() GoogleCloudRunV2ContainerStatusResponseArrayOutput {
	return o.ApplyT(func(v LookupJobResult) []GoogleCloudRunV2ContainerStatusResponse { return v.ContainerStatuses }).(GoogleCloudRunV2ContainerStatusResponseArrayOutput)
}
