...
func NewJobIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:run/v2:JobIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetJobIamBinding(ctx *pulumi.Context,
	...
	var resource JobIamBinding
	err := ctx.ReadResource("google-native:run/v2:JobIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
