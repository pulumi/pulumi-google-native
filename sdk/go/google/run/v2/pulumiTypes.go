...
type GoogleCloudRunV2ContainerStatusResponse struct {
...
// ContainerStatus holds the information of container name and image digest value.
type GoogleCloudRunV2ContainerStatusResponseOutput struct{ *pulumi.OutputState }

func (GoogleCloudRunV2ContainerStatusResponseOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GoogleCloudRunV2ContainerStatusResponse)(nil)).Elem()
}

func (o GoogleCloudRunV2ContainerStatusResponseOutput) ToGoogleCloudRunV2ContainerStatusResponseOutput() GoogleCloudRunV2ContainerStatusResponseOutput {
	return o
}

func (o GoogleCloudRunV2ContainerStatusResponseOutput) ToGoogleCloudRunV2ContainerStatusResponseOutputWithContext(ctx context.Context) GoogleCloudRunV2ContainerStatusResponseOutput {
	return o
}

// ImageDigest holds the resolved digest for the image specified, regardless of whether a tag or digest was originally specified in the Container object.
func (o GoogleCloudRunV2ContainerStatusResponseOutput) ImageDigest() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleCloudRunV2ContainerStatusResponse) string { return v.ImageDigest }).(pulumi.StringOutput)
}

// The name of the container, if specified.
func (o GoogleCloudRunV2ContainerStatusResponseOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GoogleCloudRunV2ContainerStatusResponse) string { return v.Name }).(pulumi.StringOutput)
}

type GoogleCloudRunV2ContainerStatusResponseArrayOutput struct{ *pulumi.OutputState }

func (GoogleCloudRunV2ContainerStatusResponseArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GoogleCloudRunV2ContainerStatusResponse)(nil)).Elem()
}

func (o GoogleCloudRunV2ContainerStatusResponseArrayOutput) ToGoogleCloudRunV2ContainerStatusResponseArrayOutput() GoogleCloudRunV2ContainerStatusResponseArrayOutput {
	return o
}

func (o GoogleCloudRunV2ContainerStatusResponseArrayOutput) ToGoogleCloudRunV2ContainerStatusResponseArrayOutputWithContext(ctx context.Context) GoogleCloudRunV2ContainerStatusResponseArrayOutput {
	return o
}

func (o GoogleCloudRunV2ContainerStatusResponseArrayOutput) Index(i pulumi.IntInput) GoogleCloudRunV2ContainerStatusResponseOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GoogleCloudRunV2ContainerStatusResponse {
		return vs[0].([]GoogleCloudRunV2ContainerStatusResponse)[vs[1].(int)]
	}).(GoogleCloudRunV2ContainerStatusResponseOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(GoogleCloudRunV2ContainerStatusResponseOutput{})
	pulumi.RegisterOutputType(GoogleCloudRunV2ContainerStatusResponseArrayOutput{})
