...
// The header field value
func (o GoogleCloudRunV2HTTPHeaderOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GoogleCloudRunV2HTTPHeader) *string { return v.Value }).(pulumi.StringPtrOutput)
}
