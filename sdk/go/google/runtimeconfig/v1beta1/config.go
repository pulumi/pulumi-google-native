...
func NewConfig(ctx *pulumi.Context,
	...
	var resource Config
	err := ctx.RegisterResource("google-cloud:runtimeconfig/v1beta1:Config", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfig(ctx *pulumi.Context,
	...
	var resource Config
	err := ctx.ReadResource("google-cloud:runtimeconfig/v1beta1:Config", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
