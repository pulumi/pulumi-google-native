...
func LookupConfigIamPolicy(ctx *pulumi.Context, args *LookupConfigIamPolicyArgs, opts ...pulumi.InvokeOption) (*LookupConfigIamPolicyResult, error) {
	...
	err := ctx.Invoke("google-native:runtimeconfig/v1beta1:getConfigIamPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupConfigIamPolicyResultOutput) Bindings() BindingResponseArrayOutput {
	return o.ApplyT(func(v LookupConfigIamPolicyResult) []BindingResponse { return v.Bindings }).(BindingResponseArrayOutput)
}
...
func (o LookupConfigIamPolicyResultOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v LookupConfigIamPolicyResult) int { return v.Version }).(pulumi.IntOutput)
}
