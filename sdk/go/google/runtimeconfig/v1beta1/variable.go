...
func NewVariable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:runtimeconfig/v1beta1:Variable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVariable(ctx *pulumi.Context,
	...
	var resource Variable
	err := ctx.ReadResource("google-cloud:runtimeconfig/v1beta1:Variable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
