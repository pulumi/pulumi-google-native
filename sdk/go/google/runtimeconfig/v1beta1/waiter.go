...
func NewWaiter(ctx *pulumi.Context,
	...
	var resource Waiter
	err := ctx.RegisterResource("google-cloud:runtimeconfig/v1beta1:Waiter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWaiter(ctx *pulumi.Context,
	...
	var resource Waiter
	err := ctx.ReadResource("google-cloud:runtimeconfig/v1beta1:Waiter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
