...
func NewSecretIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:secretmanager/v1:SecretIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretIamMember(ctx *pulumi.Context,
	...
	var resource SecretIamMember
	err := ctx.ReadResource("google-native:secretmanager/v1:SecretIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
