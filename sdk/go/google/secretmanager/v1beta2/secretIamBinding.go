...
func NewSecretIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:secretmanager/v1beta2:SecretIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretIamBinding(ctx *pulumi.Context,
	...
	var resource SecretIamBinding
	err := ctx.ReadResource("google-native:secretmanager/v1beta2:SecretIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
