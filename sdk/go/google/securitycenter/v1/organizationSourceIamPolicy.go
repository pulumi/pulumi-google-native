...
func NewOrganizationSourceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:securitycenter/v1:OrganizationSourceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSourceIamPolicy(ctx *pulumi.Context,
	...
	var resource OrganizationSourceIamPolicy
	err := ctx.ReadResource("google-cloud:securitycenter/v1:OrganizationSourceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
