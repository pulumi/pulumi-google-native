...
func NewOrganizationSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:securitycenter/v1beta1:OrganizationSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationSource(ctx *pulumi.Context,
	...
	var resource OrganizationSource
	err := ctx.ReadResource("google-cloud:securitycenter/v1beta1:OrganizationSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
