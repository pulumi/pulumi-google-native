...
func NewSource(ctx *pulumi.Context,
	...
	var resource Source
	err := ctx.RegisterResource("google-cloud:securitycenter/v1beta1:Source", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSource(ctx *pulumi.Context,
	...
	var resource Source
	err := ctx.ReadResource("google-cloud:securitycenter/v1beta1:Source", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
