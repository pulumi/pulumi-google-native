...
func NewServiceConsumerQuotaMetricLimitProducerOverride(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:serviceconsumermanagement/v1beta1:ServiceConsumerQuotaMetricLimitProducerOverride", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceConsumerQuotaMetricLimitProducerOverride(ctx *pulumi.Context,
	...
	var resource ServiceConsumerQuotaMetricLimitProducerOverride
	err := ctx.ReadResource("google-cloud:serviceconsumermanagement/v1beta1:ServiceConsumerQuotaMetricLimitProducerOverride", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
