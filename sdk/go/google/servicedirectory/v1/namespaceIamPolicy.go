...
func NewNamespaceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:servicedirectory/v1:NamespaceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceIamPolicy(ctx *pulumi.Context,
	...
	var resource NamespaceIamPolicy
	err := ctx.ReadResource("google-cloud:servicedirectory/v1:NamespaceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
