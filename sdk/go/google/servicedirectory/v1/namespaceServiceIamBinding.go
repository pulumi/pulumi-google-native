...
func NewNamespaceServiceIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:servicedirectory/v1:NamespaceServiceIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceServiceIamBinding(ctx *pulumi.Context,
	...
	var resource NamespaceServiceIamBinding
	err := ctx.ReadResource("google-native:servicedirectory/v1:NamespaceServiceIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
