...
func NewNamespaceServiceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:servicedirectory/v1:NamespaceServiceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceServiceIamMember(ctx *pulumi.Context,
	...
	var resource NamespaceServiceIamMember
	err := ctx.ReadResource("google-native:servicedirectory/v1:NamespaceServiceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
