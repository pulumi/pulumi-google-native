...
func NewEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:servicedirectory/v1beta1:Endpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpoint(ctx *pulumi.Context,
	...
	var resource Endpoint
	err := ctx.ReadResource("google-cloud:servicedirectory/v1beta1:Endpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
