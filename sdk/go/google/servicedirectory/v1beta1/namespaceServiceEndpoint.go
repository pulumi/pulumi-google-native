...
func NewNamespaceServiceEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:servicedirectory/v1beta1:NamespaceServiceEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceServiceEndpoint(ctx *pulumi.Context,
	...
	var resource NamespaceServiceEndpoint
	err := ctx.ReadResource("google-cloud:servicedirectory/v1beta1:NamespaceServiceEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
