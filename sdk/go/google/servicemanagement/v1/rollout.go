...
func NewRollout(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:servicemanagement/v1:Rollout", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRollout(ctx *pulumi.Context,
	...
	var resource Rollout
	err := ctx.ReadResource("google-cloud:servicemanagement/v1:Rollout", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
