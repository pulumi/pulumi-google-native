...
func NewServiceConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:servicemanagement/v1:ServiceConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceConfig(ctx *pulumi.Context,
	...
	var resource ServiceConfig
	err := ctx.ReadResource("google-native:servicemanagement/v1:ServiceConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
