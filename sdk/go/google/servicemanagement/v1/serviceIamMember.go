...
func NewServiceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:servicemanagement/v1:ServiceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceIamMember(ctx *pulumi.Context,
	...
	var resource ServiceIamMember
	err := ctx.ReadResource("google-native:servicemanagement/v1:ServiceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
