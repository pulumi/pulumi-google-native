...
func NewConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:servicenetworking/v1:Connection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConnection(ctx *pulumi.Context,
	...
	var resource Connection
	err := ctx.ReadResource("google-cloud:servicenetworking/v1:Connection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
