...
func NewServiceConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:servicenetworking/v1:ServiceConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceConnection(ctx *pulumi.Context,
	...
	var resource ServiceConnection
	err := ctx.ReadResource("google-cloud:servicenetworking/v1:ServiceConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
