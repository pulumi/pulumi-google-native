...
func NewServiceNetworkPeeredDnsDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:servicenetworking/v1:ServiceNetworkPeeredDnsDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceNetworkPeeredDnsDomain(ctx *pulumi.Context,
	...
	var resource ServiceNetworkPeeredDnsDomain
	err := ctx.ReadResource("google-cloud:servicenetworking/v1:ServiceNetworkPeeredDnsDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
