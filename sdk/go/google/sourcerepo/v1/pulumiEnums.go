...
func (in *pubsubConfigMessageFormatPtr) ToOutput(ctx context.Context) pulumix.Output[*PubsubConfigMessageFormat] {
	return pulumix.Output[*PubsubConfigMessageFormat]{
		OutputState: in.ToPubsubConfigMessageFormatPtrOutputWithContext(ctx).OutputState,
	}
}
