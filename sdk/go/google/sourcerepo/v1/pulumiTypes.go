...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MirrorConfigResponseInput)(nil)).Elem(), MirrorConfigResponseArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MirrorConfigResponsePtrInput)(nil)).Elem(), MirrorConfigResponseArgs{})
