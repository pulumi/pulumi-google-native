...
func (i *RepoIamMember) ToOutput(ctx context.Context) pulumix.Output[*RepoIamMember] {
	return pulumix.Output[*RepoIamMember]{
		OutputState: i.ToRepoIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o RepoIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*RepoIamMember] {
	return pulumix.Output[*RepoIamMember]{
