...
func (i *RepoIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*RepoIamPolicy] {
	return pulumix.Output[*RepoIamPolicy]{
		OutputState: i.ToRepoIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (o RepoIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*RepoIamPolicy] {
	return pulumix.Output[*RepoIamPolicy]{
