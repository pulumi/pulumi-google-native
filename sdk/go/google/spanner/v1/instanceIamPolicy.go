...
func NewInstanceIamPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:spanner/v1:InstanceIamPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceIamPolicy(ctx *pulumi.Context,
	...
	var resource InstanceIamPolicy
	err := ctx.ReadResource("google-cloud:spanner/v1:InstanceIamPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
