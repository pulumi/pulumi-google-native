...
func NewPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.RegisterResource("google-cloud:spanner/v1:Policy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.ReadResource("google-cloud:spanner/v1:Policy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
