...
func NewInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:sqladmin/v1beta4:Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstance(ctx *pulumi.Context,
	...
	var resource Instance
	err := ctx.ReadResource("google-cloud:sqladmin/v1beta4:Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
