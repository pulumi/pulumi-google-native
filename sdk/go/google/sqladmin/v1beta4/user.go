...
func NewUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.RegisterResource("google-cloud:sqladmin/v1beta4:User", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.ReadResource("google-cloud:sqladmin/v1beta4:User", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
