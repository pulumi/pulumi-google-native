...
func NewBucket(ctx *pulumi.Context,
	...
	var resource Bucket
	err := ctx.RegisterResource("google-cloud:storage/v1:Bucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucket(ctx *pulumi.Context,
	...
	var resource Bucket
	err := ctx.ReadResource("google-cloud:storage/v1:Bucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
