...
func GetObject(ctx *pulumi.Context, args *GetObjectArgs, opts ...pulumi.InvokeOption) (*GetObjectResult, error) {
	...
	err := ctx.Invoke("google-native:storage/v1:getObject", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetObjectResult struct {
	...
	CustomerEncryption GetObjectCustomerEncryptionResponse `pulumi:"customerEncryption"`
	...
	Owner GetObjectOwnerResponse `pulumi:"owner"`
