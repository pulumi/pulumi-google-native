...
func (i *ObjectIamMember) ToOutput(ctx context.Context) pulumix.Output[*ObjectIamMember] {
	return pulumix.Output[*ObjectIamMember]{
		OutputState: i.ToObjectIamMemberOutputWithContext(ctx).OutputState,
	}
}
...
func (o ObjectIamMemberOutput) ToOutput(ctx context.Context) pulumix.Output[*ObjectIamMember] {
	return pulumix.Output[*ObjectIamMember]{
