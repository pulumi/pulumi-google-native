...
func NewTransferJob(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:storagetransfer/v1:TransferJob", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransferJob(ctx *pulumi.Context,
	...
	var resource TransferJob
	err := ctx.ReadResource("google-cloud:storagetransfer/v1:TransferJob", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
