...
type LookupTestMatrixResult struct {
	...
	ExtendedInvalidMatrixDetails []MatrixErrorDetailResponse `pulumi:"extendedInvalidMatrixDetails"`
...
// Details about why a matrix was deemed invalid. If multiple checks can be safely performed, they will be reported but no assumptions should be made about the length of this list.
func (o LookupTestMatrixResultOutput) ExtendedInvalidMatrixDetails() MatrixErrorDetailResponseArrayOutput {
	return o.ApplyT(func(v LookupTestMatrixResult) []MatrixErrorDetailResponse { return v.ExtendedInvalidMatrixDetails }).(MatrixErrorDetailResponseArrayOutput)
}
