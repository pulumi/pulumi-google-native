...
func NewHistoryExecution(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:toolresults/v1beta3:HistoryExecution", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHistoryExecution(ctx *pulumi.Context,
	...
	var resource HistoryExecution
	err := ctx.ReadResource("google-cloud:toolresults/v1beta3:HistoryExecution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
