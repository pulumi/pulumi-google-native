...
type HistoryExecutionStep struct {
...
// NewHistoryExecutionStep registers a new resource with the given unique name, arguments, and options.
func NewHistoryExecutionStep(ctx *pulumi.Context,
	name string, args *HistoryExecutionStepArgs, opts ...pulumi.ResourceOption) (*HistoryExecutionStep, error) {
	if args == nil {
	...
	err := ctx.RegisterResource("google-cloud:toolresults/v1beta3:HistoryExecutionStep", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetHistoryExecutionStep gets an existing HistoryExecutionStep resource's state with the given name, ID, and optional
// state properties that are used to uniquely qualify the lookup (nil if not required).
func GetHistoryExecutionStep(ctx *pulumi.Context,
	name string, id pulumi.IDInput, state *HistoryExecutionStepState, opts ...pulumi.ResourceOption) (*HistoryExecutionStep, error) {
	var resource HistoryExecutionStep
	err := ctx.ReadResource("google-cloud:toolresults/v1beta3:HistoryExecutionStep", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Input properties used for looking up and filtering HistoryExecutionStep resources.
type historyExecutionStepState struct {
	// The time when the step status was set to complete. This value will be set automatically when state transitions to COMPLETE. - In response: set if the execution state is COMPLETE. - In create/update request: never set
...
func (HistoryExecutionStepState) ElementType() reflect.Type {
	return reflect.TypeOf((*historyExecutionStepState)(nil)).Elem()
}

type historyExecutionStepArgs struct {
	// The time when the step status was set to complete. This value will be set automatically when state transitions to COMPLETE. - In response: set if the execution state is COMPLETE. - In create/update request: never set
...
func (HistoryExecutionStepArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*historyExecutionStepArgs)(nil)).Elem()
}

type HistoryExecutionStepInput interface {
	pulumi.Input

	ToHistoryExecutionStepOutput() HistoryExecutionStepOutput
	ToHistoryExecutionStepOutputWithContext(ctx context.Context) HistoryExecutionStepOutput
}

func (*HistoryExecutionStep) ElementType() reflect.Type {
	return reflect.TypeOf((*HistoryExecutionStep)(nil))
}

func (i *HistoryExecutionStep) ToHistoryExecutionStepOutput() HistoryExecutionStepOutput {
	return i.ToHistoryExecutionStepOutputWithContext(context.Background())
}

func (i *HistoryExecutionStep) ToHistoryExecutionStepOutputWithContext(ctx context.Context) HistoryExecutionStepOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HistoryExecutionStepOutput)
}

type HistoryExecutionStepOutput struct {
	*pulumi.OutputState
}

func (HistoryExecutionStepOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HistoryExecutionStep)(nil))
}

func (o HistoryExecutionStepOutput) ToHistoryExecutionStepOutput() HistoryExecutionStepOutput {
	return o
}

func (o HistoryExecutionStepOutput) ToHistoryExecutionStepOutputWithContext(ctx context.Context) HistoryExecutionStepOutput {
	return o
}

func init() {
	pulumi.RegisterOutputType(HistoryExecutionStepOutput{})
}
