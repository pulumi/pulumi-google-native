...
func NewPerfSampleSeries(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:toolresults/v1beta3:PerfSampleSeries", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPerfSampleSeries(ctx *pulumi.Context,
	...
	var resource PerfSampleSeries
	err := ctx.ReadResource("google-cloud:toolresults/v1beta3:PerfSampleSeries", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
