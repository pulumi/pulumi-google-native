...
func NewStep(ctx *pulumi.Context,
	...
	var resource Step
	err := ctx.RegisterResource("google-cloud:toolresults/v1beta3:Step", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStep(ctx *pulumi.Context,
	...
	var resource Step
	err := ctx.ReadResource("google-cloud:toolresults/v1beta3:Step", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
