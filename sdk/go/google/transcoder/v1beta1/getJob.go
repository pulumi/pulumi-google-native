...
// List of failure details. This property may contain additional information about the failure when `failure_reason` is present. *Note*: This feature is not yet available.
func (o LookupJobResultOutput) FailureDetails() FailureDetailResponseArrayOutput {
	return o.ApplyT(func(v LookupJobResult) []FailureDetailResponse { return v.FailureDetails }).(FailureDetailResponseArrayOutput)
}

// A description of the reason for the failure. This property is always present when `state` is `FAILED`.
func (o LookupJobResultOutput) FailureReason() pulumi.StringOutput {
	return o.ApplyT(func(v LookupJobResult) string { return v.FailureReason }).(pulumi.StringOutput)
}
...
// The origin URI. *Note*: This feature is not yet available.
func (o LookupJobResultOutput) OriginUri() OriginUriResponseOutput {
	return o.ApplyT(func(v LookupJobResult) OriginUriResponse { return v.OriginUri }).(OriginUriResponseOutput)
}
...
// Estimated fractional progress, from `0` to `1` for each step. *Note*: This feature is not yet available.
func (o LookupJobResultOutput) Progress() ProgressResponseOutput {
	return o.ApplyT(func(v LookupJobResult) ProgressResponse { return v.Progress }).(ProgressResponseOutput)
}
