...
func NewProductReferenceImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:vision/v1:ProductReferenceImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProductReferenceImage(ctx *pulumi.Context,
	...
	var resource ProductReferenceImage
	err := ctx.ReadResource("google-cloud:vision/v1:ProductReferenceImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
