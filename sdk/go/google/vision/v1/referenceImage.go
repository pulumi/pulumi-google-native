...
func NewReferenceImage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:vision/v1:ReferenceImage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReferenceImage(ctx *pulumi.Context,
	...
	var resource ReferenceImage
	err := ctx.ReadResource("google-cloud:vision/v1:ReferenceImage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
