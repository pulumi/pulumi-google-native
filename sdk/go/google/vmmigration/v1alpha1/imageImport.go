...
func NewImageImport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:vmmigration/v1alpha1:ImageImport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageImport(ctx *pulumi.Context,
	...
	var resource ImageImport
	err := ctx.ReadResource("google-native:vmmigration/v1alpha1:ImageImport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
