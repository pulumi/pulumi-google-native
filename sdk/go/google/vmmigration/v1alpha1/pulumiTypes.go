...
type PersistentDiskDefaultsArgs struct {
	...
	// The ordinal number of the source VM disk.
	SourceDiskNumber pulumi.IntPtrInput `pulumi:"sourceDiskNumber"`
}
...
// The ordinal number of the source VM disk.
func (o PersistentDiskDefaultsOutput) SourceDiskNumber() pulumi.IntPtrOutput {
	return o.ApplyT(func(v PersistentDiskDefaults) *int { return v.SourceDiskNumber }).(pulumi.IntPtrOutput)
}
