...
func NewScanConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:websecurityscanner/v1alpha:ScanConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScanConfig(ctx *pulumi.Context,
	...
	var resource ScanConfig
	err := ctx.ReadResource("google-cloud:websecurityscanner/v1alpha:ScanConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
