...
func NewScanConfig(ctx *pulumi.Context,
	...
	if args.ScanConfigsId == nil {
		return nil, errors.New("invalid value for required argument 'ScanConfigsId'")
	}
	var resource ScanConfig
	err := ctx.RegisterResource("google-cloud:websecurityscanner/v1beta:ScanConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScanConfig(ctx *pulumi.Context,
	...
	var resource ScanConfig
	err := ctx.ReadResource("google-cloud:websecurityscanner/v1beta:ScanConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type scanConfigArgs struct {
	...
	ScanConfigsId string  `pulumi:"scanConfigsId"`
...
type ScanConfigArgs struct {
	...
	ScanConfigsId pulumi.StringInput
	// The schedule of the ScanConfig.
