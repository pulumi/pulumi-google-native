...
func NewWorkflowExecution(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:workflowexecutions/v1beta:WorkflowExecution", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflowExecution(ctx *pulumi.Context,
	...
	var resource WorkflowExecution
	err := ctx.ReadResource("google-native:workflowexecutions/v1beta:WorkflowExecution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
