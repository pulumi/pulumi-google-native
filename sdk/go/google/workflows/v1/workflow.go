...
func NewWorkflow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-cloud:workflows/v1:Workflow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflow(ctx *pulumi.Context,
	...
	var resource Workflow
	err := ctx.ReadResource("google-cloud:workflows/v1:Workflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
