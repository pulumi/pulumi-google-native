...
func NewWorkstationCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("google-native:workstations/v1:WorkstationCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkstationCluster(ctx *pulumi.Context,
	...
	var resource WorkstationCluster
	err := ctx.ReadResource("google-native:workstations/v1:WorkstationCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
