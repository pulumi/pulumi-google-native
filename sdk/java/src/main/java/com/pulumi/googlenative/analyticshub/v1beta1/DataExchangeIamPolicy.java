...
import com.pulumi.googlenative.analyticshub.v1beta1.DataExchangeIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:analyticshub/v1beta1:DataExchangeIamPolicy")
public class DataExchangeIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public DataExchangeIamPolicy(String name, DataExchangeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:analyticshub/v1beta1:DataExchangeIamPolicy", name, args == null ? DataExchangeIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DataExchangeIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:analyticshub/v1beta1:DataExchangeIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DataExchangeIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
