...
import com.pulumi.googlenative.analyticshub.v1beta1.DataExchangeListingIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:analyticshub/v1beta1:DataExchangeListingIamPolicy")
public class DataExchangeListingIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public DataExchangeListingIamPolicy(String name) {
        this(name, DataExchangeListingIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DataExchangeListingIamPolicy(String name, DataExchangeListingIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DataExchangeListingIamPolicy(String name, DataExchangeListingIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:analyticshub/v1beta1:DataExchangeListingIamPolicy", name, args == null ? DataExchangeListingIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DataExchangeListingIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:analyticshub/v1beta1:DataExchangeListingIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DataExchangeListingIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new DataExchangeListingIamPolicy(name, id, options);
    }
}
