...
public class HostSecurityReport extends com.pulumi.resources.CustomResource {
    ...
    private HostSecurityReport(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HostSecurityReport get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
