...
import com.pulumi.googlenative.apigeeregistry.v1.ApiIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:apigeeregistry/v1:ApiIamPolicy")
public class ApiIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ApiIamPolicy(String name, ApiIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigeeregistry/v1:ApiIamPolicy", name, args == null ? ApiIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ApiIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigeeregistry/v1:ApiIamPolicy", name, null, makeResourceOptions(options, id));
    }
