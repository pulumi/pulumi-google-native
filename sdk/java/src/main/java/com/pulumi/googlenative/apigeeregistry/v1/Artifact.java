...
import com.pulumi.googlenative.apigeeregistry.v1.ArtifactArgs;
 ...
 * 
 */
@ResourceType(type="google-native:apigeeregistry/v1:Artifact")
public class Artifact extends com.pulumi.resources.CustomResource {
    ...
    public Artifact(String name, ArtifactArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigeeregistry/v1:Artifact", name, args == null ? ArtifactArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Artifact(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigeeregistry/v1:Artifact", name, null, makeResourceOptions(options, id));
    }
