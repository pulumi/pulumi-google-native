...
import com.pulumi.googlenative.appengine.v1beta.DomainMappingArgs;
 ...
 * 
 */
@ResourceType(type="google-native:appengine/v1beta:DomainMapping")
public class DomainMapping extends com.pulumi.resources.CustomResource {
    ...
    private DomainMapping(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:appengine/v1beta:DomainMapping", name, null, makeResourceOptions(options, id));
    }
