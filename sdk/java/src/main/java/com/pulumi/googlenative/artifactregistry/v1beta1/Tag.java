...
import com.pulumi.googlenative.artifactregistry.v1beta1.TagArgs;
...
public class Tag extends com.pulumi.resources.CustomResource {
    ...
    public Tag(String name, TagArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:artifactregistry/v1beta1:Tag", name, args == null ? TagArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
