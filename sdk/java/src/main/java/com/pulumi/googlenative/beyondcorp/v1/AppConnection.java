...
import com.pulumi.googlenative.beyondcorp.v1.AppConnectionArgs;
 ...
 * 
 */
@ResourceType(type="google-native:beyondcorp/v1:AppConnection")
public class AppConnection extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="applicationEndpoint", type=GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponse.class, parameters={})
    private Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponse> applicationEndpoint;

    /**
     * @return Address of the remote application endpoint for the BeyondCorp AppConnection.
     * 
     */
    public Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponse> applicationEndpoint() {
     ...
     * 
     */
    @Export(name="gateway", type=GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponse.class, parameters={})
    private Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponse> gateway;

    /**
     * @return Optional. Gateway used by the AppConnection.
     * 
     */
    public Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponse> gateway() {
        return this.gateway;
    }
    /**
    ...
    public AppConnection(String name, AppConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1:AppConnection", name, args == null ? AppConnectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AppConnection(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1:AppConnection", name, null, makeResourceOptions(options, id));
    }
