...
import com.pulumi.googlenative.beyondcorp.v1.enums.AppConnectionType;
import com.pulumi.googlenative.beyondcorp.v1.inputs.GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointArgs;
import com.pulumi.googlenative.beyondcorp.v1.inputs.GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayArgs;
...
public final class AppConnectionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointArgs> applicationEndpoint;

    /**
     * @return Address of the remote application endpoint for the BeyondCorp AppConnection.
     * 
     */
    public Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointArgs> applicationEndpoint() {
     ...
     */
    @Import(name="gateway")
    private @Nullable Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayArgs> gateway;

    /**
     * @return Optional. Gateway used by the AppConnection.
     * 
     */
    public Optional<Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayArgs>> gateway() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder applicationEndpoint(Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointArgs> applicationEndpoint) {
         ...
         * 
         */
        public Builder applicationEndpoint(GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointArgs applicationEndpoint) {
         ...
         * 
         */
        public Builder gateway(@Nullable Output<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayArgs> gateway) {
            $.gateway = gateway;
            return this;
        }
         ...
         * 
         */
        public Builder gateway(GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayArgs gateway) {
