...
import com.pulumi.googlenative.beyondcorp.v1.AppConnectorArgs;
 ...
 * 
 */
@ResourceType(type="google-native:beyondcorp/v1:AppConnector")
public class AppConnector extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="principalInfo", type=GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse.class, parameters={})
    private Output<GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse> principalInfo;

    /**
     * @return Principal information about the Identity of the AppConnector.
     * 
     */
    public Output<GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse> principalInfo() {
     ...
     * 
     */
    @Export(name="resourceInfo", type=GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse.class, parameters={})
    private Output<GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse> resourceInfo;

    /**
     * @return Optional. Resource info of the connector.
     * 
     */
    public Output<GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse> resourceInfo() {
    ...
    public AppConnector(String name, AppConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1:AppConnector", name, args == null ? AppConnectorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AppConnector(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1:AppConnector", name, null, makeResourceOptions(options, id));
    }
