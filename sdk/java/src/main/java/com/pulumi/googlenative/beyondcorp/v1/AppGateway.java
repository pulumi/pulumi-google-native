...
import com.pulumi.googlenative.beyondcorp.v1.AppGatewayArgs;
 ...
 * 
 */
@ResourceType(type="google-native:beyondcorp/v1:AppGateway")
public class AppGateway extends com.pulumi.resources.CustomResource {
    ...
    public AppGateway(String name, AppGatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1:AppGateway", name, args == null ? AppGatewayArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AppGateway(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1:AppGateway", name, null, makeResourceOptions(options, id));
    }
