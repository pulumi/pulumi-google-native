...
import com.pulumi.googlenative.beyondcorp.v1.ClientConnectorServiceArgs;
import com.pulumi.googlenative.beyondcorp.v1.outputs.EgressResponse;
import com.pulumi.googlenative.beyondcorp.v1.outputs.IngressResponse;
 ...
 * 
 */
@ResourceType(type="google-native:beyondcorp/v1:ClientConnectorService")
public class ClientConnectorService extends com.pulumi.resources.CustomResource {
    ...
    public ClientConnectorService(String name, ClientConnectorServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1:ClientConnectorService", name, args == null ? ClientConnectorServiceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ClientConnectorService(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1:ClientConnectorService", name, null, makeResourceOptions(options, id));
    }
