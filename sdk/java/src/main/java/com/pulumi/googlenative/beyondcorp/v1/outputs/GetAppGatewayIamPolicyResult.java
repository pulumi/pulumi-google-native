...
@CustomType
public final class GetAppGatewayIamPolicyResult {
    /**
    ...
    public static Builder builder(GetAppGatewayIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetAppGatewayIamPolicyResult defaults) {
        ...
        public GetAppGatewayIamPolicyResult build() {
            final var o = new GetAppGatewayIamPolicyResult();
