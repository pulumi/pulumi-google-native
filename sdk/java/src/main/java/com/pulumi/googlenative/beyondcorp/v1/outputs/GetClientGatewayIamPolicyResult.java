...
@CustomType
public final class GetClientGatewayIamPolicyResult {
    /**
    ...
    public static Builder builder(GetClientGatewayIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetClientGatewayIamPolicyResult defaults) {
        ...
        public GetClientGatewayIamPolicyResult build() {
            final var o = new GetClientGatewayIamPolicyResult();
