...
import com.pulumi.googlenative.beyondcorp.v1alpha.AppGatewayArgs;
 ...
 * 
 */
@ResourceType(type="google-native:beyondcorp/v1alpha:AppGateway")
public class AppGateway extends com.pulumi.resources.CustomResource {
    /**
     * A list of connections allocated for the Gateway
     * 
     */
    @Export(name="allocatedConnections", type=List.class, parameters={AllocatedConnectionResponse.class})
    private Output<List<AllocatedConnectionResponse>> allocatedConnections;

    /**
     * @return A list of connections allocated for the Gateway
     * 
     */
    public Output<List<AllocatedConnectionResponse>> allocatedConnections() {
     ...
     * 
     */
    @Export(name="appGatewayId", type=String.class, parameters={})
     ...
     */
    public AppGateway(String name, AppGatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1alpha:AppGateway", name, args == null ? AppGatewayArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AppGateway(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1alpha:AppGateway", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static AppGateway get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
