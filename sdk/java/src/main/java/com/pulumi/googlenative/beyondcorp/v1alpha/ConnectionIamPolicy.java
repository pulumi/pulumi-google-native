...
import com.pulumi.googlenative.beyondcorp.v1alpha.ConnectionIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:beyondcorp/v1alpha:ConnectionIamPolicy")
public class ConnectionIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ConnectionIamPolicy(String name, ConnectionIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1alpha:ConnectionIamPolicy", name, args == null ? ConnectionIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ConnectionIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:beyondcorp/v1alpha:ConnectionIamPolicy", name, null, makeResourceOptions(options, id));
    }
