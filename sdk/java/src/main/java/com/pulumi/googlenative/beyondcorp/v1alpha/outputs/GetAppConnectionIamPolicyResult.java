...
@CustomType
public final class GetAppConnectionIamPolicyResult {
    /**
    ...
    public static Builder builder(GetAppConnectionIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetAppConnectionIamPolicyResult defaults) {
        ...
        public GetAppConnectionIamPolicyResult build() {
            final var o = new GetAppConnectionIamPolicyResult();
