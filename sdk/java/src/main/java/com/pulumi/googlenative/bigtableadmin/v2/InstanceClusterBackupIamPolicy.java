...
import com.pulumi.googlenative.bigtableadmin.v2.InstanceClusterBackupIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:bigtableadmin/v2:InstanceClusterBackupIamPolicy")
public class InstanceClusterBackupIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public InstanceClusterBackupIamPolicy(String name) {
        this(name, InstanceClusterBackupIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InstanceClusterBackupIamPolicy(String name, InstanceClusterBackupIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InstanceClusterBackupIamPolicy(String name, InstanceClusterBackupIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private InstanceClusterBackupIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigtableadmin/v2:InstanceClusterBackupIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static InstanceClusterBackupIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
