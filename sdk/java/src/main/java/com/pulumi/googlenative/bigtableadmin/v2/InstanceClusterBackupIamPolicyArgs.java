...
import com.pulumi.googlenative.bigtableadmin.v2.inputs.AuditConfigArgs;
import com.pulumi.googlenative.bigtableadmin.v2.inputs.BindingArgs;
...
public final class InstanceClusterBackupIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceClusterBackupIamPolicyArgs(InstanceClusterBackupIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceClusterBackupIamPolicyArgs();
        }

        public Builder(InstanceClusterBackupIamPolicyArgs defaults) {
            $ = new InstanceClusterBackupIamPolicyArgs(Objects.requireNonNull(defaults));
        }
