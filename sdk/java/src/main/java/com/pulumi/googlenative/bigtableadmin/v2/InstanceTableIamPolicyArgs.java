...
public final class InstanceTableIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceTableIamPolicyArgs(InstanceTableIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceTableIamPolicyArgs();
        }

        public Builder(InstanceTableIamPolicyArgs defaults) {
            $ = new InstanceTableIamPolicyArgs(Objects.requireNonNull(defaults));
        }
