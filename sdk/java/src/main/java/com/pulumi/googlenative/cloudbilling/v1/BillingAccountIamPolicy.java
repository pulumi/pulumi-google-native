...
import com.pulumi.googlenative.cloudbilling.v1.BillingAccountIamPolicyArgs;
...
public class BillingAccountIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public BillingAccountIamPolicy(String name, BillingAccountIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private BillingAccountIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BillingAccountIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
