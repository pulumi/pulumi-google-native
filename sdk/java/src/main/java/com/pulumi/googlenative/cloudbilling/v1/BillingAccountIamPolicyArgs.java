...
import com.pulumi.googlenative.cloudbilling.v1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.cloudbilling.v1.inputs.BindingArgs;
...
public final class BillingAccountIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BillingAccountIamPolicyArgs(BillingAccountIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(BillingAccountIamPolicyArgs defaults) {
            $ = new BillingAccountIamPolicyArgs(Objects.requireNonNull(defaults));
        }
