...
import com.pulumi.googlenative.cloudfunctions.v2.FunctionArgs;
import com.pulumi.googlenative.cloudfunctions.v2.outputs.BuildConfigResponse;
import com.pulumi.googlenative.cloudfunctions.v2.outputs.EventTriggerResponse;
import com.pulumi.googlenative.cloudfunctions.v2.outputs.GoogleCloudFunctionsV2StateMessageResponse;
import com.pulumi.googlenative.cloudfunctions.v2.outputs.ServiceConfigResponse;
 ...
 * 
 */
@ResourceType(type="google-native:cloudfunctions/v2:Function")
public class Function extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="stateMessages", type=List.class, parameters={GoogleCloudFunctionsV2StateMessageResponse.class})
    private Output<List<GoogleCloudFunctionsV2StateMessageResponse>> stateMessages;

    /**
     * @return State Messages for this Cloud Function.
     * 
     */
    public Output<List<GoogleCloudFunctionsV2StateMessageResponse>> stateMessages() {
    ...
    public Function(String name, @Nullable FunctionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v2:Function", name, args == null ? FunctionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Function(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v2:Function", name, null, makeResourceOptions(options, id));
    }
