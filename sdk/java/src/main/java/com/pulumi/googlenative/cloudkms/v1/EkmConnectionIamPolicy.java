...
import com.pulumi.googlenative.cloudkms.v1.EkmConnectionIamPolicyArgs;
...
public class EkmConnectionIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public EkmConnectionIamPolicy(String name, EkmConnectionIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private EkmConnectionIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EkmConnectionIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
