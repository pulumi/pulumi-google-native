...
import com.pulumi.googlenative.cloudkms.v1.KeyRingIamPolicyArgs;
...
public class KeyRingIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private KeyRingIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static KeyRingIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
