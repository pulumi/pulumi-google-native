...
import com.pulumi.googlenative.cloudresourcemanager.v1.ProjectArgs;
...
public class Project extends com.pulumi.resources.CustomResource {
    ...
    public Project(String name, @Nullable ProjectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v1:Project", name, args == null ? ProjectArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
