...
import com.pulumi.googlenative.cloudresourcemanager.v1beta1.ProjectIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:cloudresourcemanager/v1beta1:ProjectIamPolicy")
public class ProjectIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public ProjectIamPolicy(String name, ProjectIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v1beta1:ProjectIamPolicy", name, args == null ? ProjectIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ProjectIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v1beta1:ProjectIamPolicy", name, null, makeResourceOptions(options, id));
    }
