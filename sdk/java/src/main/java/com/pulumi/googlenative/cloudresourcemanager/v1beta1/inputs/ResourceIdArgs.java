...
public final class ResourceIdArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Required field for the type-specific id. This should correspond to the id used in the type-specific API&#39;s.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param id Required field for the type-specific id. This should correspond to the id used in the type-specific API&#39;s.
         * 
         * @return builder
         * 
         */
