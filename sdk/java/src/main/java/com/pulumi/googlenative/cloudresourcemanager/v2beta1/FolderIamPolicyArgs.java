...
import com.pulumi.googlenative.cloudresourcemanager.v2beta1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.cloudresourcemanager.v2beta1.inputs.BindingArgs;
...
public final class FolderIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FolderIamPolicyArgs(FolderIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FolderIamPolicyArgs();
        }

        public Builder(FolderIamPolicyArgs defaults) {
            $ = new FolderIamPolicyArgs(Objects.requireNonNull(defaults));
        }
