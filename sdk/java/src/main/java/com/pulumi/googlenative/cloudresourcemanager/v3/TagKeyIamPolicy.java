...
import com.pulumi.googlenative.cloudresourcemanager.v3.TagKeyIamPolicyArgs;
...
public class TagKeyIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="tagKeyId", type=String.class, parameters={})
    ...
    private TagKeyIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TagKeyIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
