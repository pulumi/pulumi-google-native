...
import com.pulumi.googlenative.compute.alpha.AutoscalerArgs;
...
public class Autoscaler extends com.pulumi.resources.CustomResource {
    ...
    public Autoscaler(String name, @Nullable AutoscalerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Autoscaler", name, args == null ? AutoscalerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
