...
import com.pulumi.googlenative.compute.alpha.BackendServiceArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:BackendService")
public class BackendService extends com.pulumi.resources.CustomResource {
    ...
    private BackendService(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:BackendService", name, null, makeResourceOptions(options, id));
    }
