...
import com.pulumi.googlenative.compute.alpha.FirewallPolicyIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:FirewallPolicyIamPolicy")
public class FirewallPolicyIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    public FirewallPolicyIamPolicy(String name) {
        this(name, FirewallPolicyIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FirewallPolicyIamPolicy(String name, FirewallPolicyIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FirewallPolicyIamPolicy(String name, FirewallPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:FirewallPolicyIamPolicy", name, args == null ? FirewallPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FirewallPolicyIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:FirewallPolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static FirewallPolicyIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
