...
import com.pulumi.googlenative.compute.alpha.GlobalPublicDelegatedPrefixArgs;
import com.pulumi.googlenative.compute.alpha.outputs.PublicDelegatedPrefixPublicDelegatedSubPrefixResponse;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:GlobalPublicDelegatedPrefix")
public class GlobalPublicDelegatedPrefix extends com.pulumi.resources.CustomResource {
    ...
    public GlobalPublicDelegatedPrefix(String name, @Nullable GlobalPublicDelegatedPrefixArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:GlobalPublicDelegatedPrefix", name, args == null ? GlobalPublicDelegatedPrefixArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private GlobalPublicDelegatedPrefix(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:GlobalPublicDelegatedPrefix", name, null, makeResourceOptions(options, id));
    }
