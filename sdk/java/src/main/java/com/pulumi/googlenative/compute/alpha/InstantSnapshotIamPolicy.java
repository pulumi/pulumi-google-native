...
import com.pulumi.googlenative.compute.alpha.InstantSnapshotIamPolicyArgs;
...
public class InstantSnapshotIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public InstantSnapshotIamPolicy(String name) {
        this(name, InstantSnapshotIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InstantSnapshotIamPolicy(String name, InstantSnapshotIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
