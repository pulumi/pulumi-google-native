...
import com.pulumi.googlenative.compute.alpha.InterconnectArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:Interconnect")
public class Interconnect extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="macsec", type=InterconnectMacsecResponse.class, parameters={})
    private Output<InterconnectMacsecResponse> macsec;
     ...
     * 
     */
    public Output<InterconnectMacsecResponse> macsec() {
        return this.macsec;
    }
    /**
     ...
     * 
     */
    @Export(name="macsecEnabled", type=Boolean.class, parameters={})
    private Output<Boolean> macsecEnabled;
     ...
     * 
     */
    @Export(name="remoteLocation", type=String.class, parameters={})
    private Output<String> remoteLocation;
     ...
     * 
     */
    public Output<String> remoteLocation() {
    ...
    public Interconnect(String name, @Nullable InterconnectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Interconnect", name, args == null ? InterconnectArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Interconnect(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Interconnect", name, null, makeResourceOptions(options, id));
    }
