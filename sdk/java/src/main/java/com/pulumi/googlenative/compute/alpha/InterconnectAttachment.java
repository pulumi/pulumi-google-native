...
public class InterconnectAttachment extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="configurationConstraints", type=InterconnectAttachmentConfigurationConstraintsResponse.class, parameters={})
    private Output<InterconnectAttachmentConfigurationConstraintsResponse> configurationConstraints;

    /**
     * @return Constraints for this attachment, if any. The attachment does not work if these constraints are not met.
     * 
     */
    public Output<InterconnectAttachmentConfigurationConstraintsResponse> configurationConstraints() {
     ...
     * 
     */
    @Export(name="remoteService", type=String.class, parameters={})
    private Output<String> remoteService;
     ...
     * 
     */
    public Output<String> remoteService() {
     ...
     * 
     */
    @Export(name="subnetLength", type=Integer.class, parameters={})
    private Output<Integer> subnetLength;
     ...
     * 
     */
    public Output<Integer> subnetLength() {
