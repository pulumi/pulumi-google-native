...
import com.pulumi.googlenative.compute.alpha.MachineImageIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:MachineImageIamPolicy")
public class MachineImageIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public MachineImageIamPolicy(String name, MachineImageIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:MachineImageIamPolicy", name, args == null ? MachineImageIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MachineImageIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:MachineImageIamPolicy", name, null, makeResourceOptions(options, id));
    }
