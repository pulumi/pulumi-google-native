...
import com.pulumi.googlenative.compute.alpha.RegionInstanceGroupManagerArgs;
...
public class RegionInstanceGroupManager extends com.pulumi.resources.CustomResource {
    ...
    public RegionInstanceGroupManager(String name, RegionInstanceGroupManagerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionInstanceGroupManager", name, args == null ? RegionInstanceGroupManagerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionInstanceGroupManager(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RegionInstanceGroupManager get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
