...
import com.pulumi.googlenative.compute.alpha.RegionInstanceTemplateArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:RegionInstanceTemplate")
public class RegionInstanceTemplate extends com.pulumi.resources.CustomResource {
    ...
    public RegionInstanceTemplate(String name, RegionInstanceTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionInstanceTemplate", name, args == null ? RegionInstanceTemplateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionInstanceTemplate(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionInstanceTemplate", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionInstanceTemplate get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
