...
import com.pulumi.googlenative.compute.alpha.RegionTargetHttpsProxyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:RegionTargetHttpsProxy")
public class RegionTargetHttpsProxy extends com.pulumi.resources.CustomResource {
    ...
    public RegionTargetHttpsProxy(String name, RegionTargetHttpsProxyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionTargetHttpsProxy", name, args == null ? RegionTargetHttpsProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionTargetHttpsProxy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionTargetHttpsProxy", name, null, makeResourceOptions(options, id));
    }
