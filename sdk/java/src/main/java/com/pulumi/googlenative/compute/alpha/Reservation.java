...
import com.pulumi.googlenative.compute.alpha.ReservationArgs;
...
public class Reservation extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="resourcePolicies", type=Map.class, parameters={String.class, String.class})
    private Output<Map<String,String>> resourcePolicies;
     ...
     * 
     */
    public Output<Map<String,String>> resourcePolicies() {
