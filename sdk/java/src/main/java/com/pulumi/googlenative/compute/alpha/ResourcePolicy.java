...
import com.pulumi.googlenative.compute.alpha.ResourcePolicyArgs;
...
public class ResourcePolicy extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="diskConsistencyGroupPolicy", type=ResourcePolicyDiskConsistencyGroupPolicyResponse.class, parameters={})
    private Output<ResourcePolicyDiskConsistencyGroupPolicyResponse> diskConsistencyGroupPolicy;

    /**
     * @return Resource policy for disk consistency groups.
     * 
     */
    public Output<ResourcePolicyDiskConsistencyGroupPolicyResponse> diskConsistencyGroupPolicy() {
