...
import com.pulumi.googlenative.compute.alpha.SubnetworkIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:SubnetworkIamPolicy")
public class SubnetworkIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public SubnetworkIamPolicy(String name, SubnetworkIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SubnetworkIamPolicy", name, args == null ? SubnetworkIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SubnetworkIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SubnetworkIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static SubnetworkIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SubnetworkIamPolicy(name, id, options);
    }
}
