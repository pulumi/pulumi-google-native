...
import com.pulumi.googlenative.compute.alpha.TargetPoolArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:TargetPool")
public class TargetPool extends com.pulumi.resources.CustomResource {
    ...
    public TargetPool(String name, TargetPoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:TargetPool", name, args == null ? TargetPoolArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TargetPool(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:TargetPool", name, null, makeResourceOptions(options, id));
    }
