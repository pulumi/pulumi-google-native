...
import com.pulumi.googlenative.compute.alpha.VpnTunnelArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:VpnTunnel")
public class VpnTunnel extends com.pulumi.resources.CustomResource {
    ...
    public VpnTunnel(String name, VpnTunnelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:VpnTunnel", name, args == null ? VpnTunnelArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VpnTunnel(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:VpnTunnel", name, null, makeResourceOptions(options, id));
    }
