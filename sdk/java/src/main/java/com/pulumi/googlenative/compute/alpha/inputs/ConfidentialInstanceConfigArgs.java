...
import com.pulumi.googlenative.compute.alpha.enums.ConfidentialInstanceConfigConfidentialInstanceType;
...
public final class ConfidentialInstanceConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ConfidentialInstanceConfigConfidentialInstanceType> confidentialInstanceType;

    /**
     * @return Defines the type of technology used by the confidential instance.
     * 
     */
    public Optional<Output<ConfidentialInstanceConfigConfidentialInstanceType>> confidentialInstanceType() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder confidentialInstanceType(@Nullable Output<ConfidentialInstanceConfigConfidentialInstanceType> confidentialInstanceType) {
         ...
         * 
         */
        public Builder confidentialInstanceType(ConfidentialInstanceConfigConfidentialInstanceType confidentialInstanceType) {
