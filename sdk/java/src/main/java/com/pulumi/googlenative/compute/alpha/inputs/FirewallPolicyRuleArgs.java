...
import com.pulumi.googlenative.compute.alpha.enums.FirewallPolicyRuleDirection;
import com.pulumi.googlenative.compute.alpha.inputs.FirewallPolicyRuleMatcherArgs;
import com.pulumi.googlenative.compute.alpha.inputs.FirewallPolicyRuleSecureTagArgs;
...
public final class FirewallPolicyRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param securityProfileGroup A fully-qualified URL of a SecurityProfile resource instance. Example: https://networksecurity.googleapis.com/v1/projects/{project}/locations/{location}/securityProfileGroups/my-security-profile-group Must be specified if action = &#39;apply_profile_group&#39; and cannot be specified for other actions.
         * 
         * @return builder
         * 
         */
