...
import com.pulumi.googlenative.compute.alpha.outputs.BackendServiceIAPOAuth2ClientInfoResponse;
...
public final class BackendServiceIAPResponse {
    ...
    public static final class Builder {
        ...
        public BackendServiceIAPResponse build() {
            final var o = new BackendServiceIAPResponse();
            o.enabled = enabled;
            o.oauth2ClientId = oauth2ClientId;
            o.oauth2ClientInfo = oauth2ClientInfo;
