...
import com.pulumi.googlenative.compute.alpha.outputs.InterconnectAttachmentConfigurationConstraintsResponse;
import com.pulumi.googlenative.compute.alpha.outputs.InterconnectAttachmentPartnerMetadataResponse;
import com.pulumi.googlenative.compute.alpha.outputs.InterconnectAttachmentPrivateInfoResponse;
...
public final class GetInterconnectAttachmentResult {
    ...
    /**
     * @return Constraints for this attachment, if any. The attachment does not work if these constraints are not met.
     * 
     */
    private InterconnectAttachmentConfigurationConstraintsResponse configurationConstraints;
    /**
    ...
    /**
     * @return If the attachment is on a Cross-Cloud Interconnect connection, this field contains the interconnect&#39;s remote location service provider. Example values: &#34;Amazon Web Services&#34; &#34;Microsoft Azure&#34;. The field is set only for attachments on Cross-Cloud Interconnect connections. Its value is copied from the InterconnectRemoteLocation remoteService field.
     * 
     */
    ...
    /**
     * @return Length of the IPv4 subnet mask. Allowed values: - 29 (default) - 30 The default value is 29, except for Cross-Cloud Interconnect connections that use an InterconnectRemoteLocation with a constraints.subnetLengthRange.min equal to 30. For example, connections that use an Azure remote location fall into this category. In these cases, the default value is 30, and requesting 29 returns an error. Where both 29 and 30 are allowed, 29 is preferred, because it gives Google Cloud Support more debugging visibility.
     * 
     */
    private Integer subnetLength;
    /**
     ...
     * 
     */
    public InterconnectAttachmentConfigurationConstraintsResponse configurationConstraints() {
    ...
    public static final class Builder {
        ...
        public Builder(GetInterconnectAttachmentResult defaults) {
    	      ...
    	      this.configurationConstraints = defaults.configurationConstraints;
    	      ...
    	      this.remoteService = defaults.remoteService;
    	      ...
    	      this.subnetLength = defaults.subnetLength;
        ...
        @CustomType.Setter
        public Builder configurationConstraints(InterconnectAttachmentConfigurationConstraintsResponse configurationConstraints) {
            this.configurationConstraints = Objects.requireNonNull(configurationConstraints);
            return this;
        }
        @CustomType.Setter
        ...
        @CustomType.Setter
        public Builder remoteService(String remoteService) {
        ...
        public Builder subnetLength(Integer subnetLength) {
            this.subnetLength = Objects.requireNonNull(subnetLength);
            return this;
        }
        @CustomType.Setter
        ...
        public GetInterconnectAttachmentResult build() {
            ...
            o.configurationConstraints = configurationConstraints;
