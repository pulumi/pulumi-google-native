...
import com.pulumi.googlenative.compute.beta.BackendBucketIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:BackendBucketIamPolicy")
public class BackendBucketIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    public BackendBucketIamPolicy(String name, BackendBucketIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:BackendBucketIamPolicy", name, args == null ? BackendBucketIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private BackendBucketIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:BackendBucketIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static BackendBucketIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
