...
import com.pulumi.googlenative.compute.beta.NetworkFirewallPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:NetworkFirewallPolicy")
public class NetworkFirewallPolicy extends com.pulumi.resources.CustomResource {
    ...
    public NetworkFirewallPolicy(String name, @Nullable NetworkFirewallPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NetworkFirewallPolicy", name, args == null ? NetworkFirewallPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NetworkFirewallPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NetworkFirewallPolicy", name, null, makeResourceOptions(options, id));
    }
