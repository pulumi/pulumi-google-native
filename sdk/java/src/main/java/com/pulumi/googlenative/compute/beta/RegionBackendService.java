...
import com.pulumi.googlenative.compute.beta.RegionBackendServiceArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionBackendService")
public class RegionBackendService extends com.pulumi.resources.CustomResource {
    ...
    public RegionBackendService(String name, RegionBackendServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionBackendService", name, args == null ? RegionBackendServiceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionBackendService(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionBackendService", name, null, makeResourceOptions(options, id));
    }
