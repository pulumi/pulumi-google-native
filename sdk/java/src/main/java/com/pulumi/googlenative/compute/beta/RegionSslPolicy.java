...
import com.pulumi.googlenative.compute.beta.RegionSslPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionSslPolicy")
public class RegionSslPolicy extends com.pulumi.resources.CustomResource {
    ...
    public RegionSslPolicy(String name, RegionSslPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionSslPolicy", name, args == null ? RegionSslPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionSslPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionSslPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionSslPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
