...
import com.pulumi.googlenative.compute.beta.RegionTargetTcpProxyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionTargetTcpProxy")
public class RegionTargetTcpProxy extends com.pulumi.resources.CustomResource {
    ...
    public RegionTargetTcpProxy(String name, RegionTargetTcpProxyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionTargetTcpProxy", name, args == null ? RegionTargetTcpProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionTargetTcpProxy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionTargetTcpProxy", name, null, makeResourceOptions(options, id));
    }
