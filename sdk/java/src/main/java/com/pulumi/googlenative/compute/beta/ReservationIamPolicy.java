...
import com.pulumi.googlenative.compute.beta.ReservationIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:ReservationIamPolicy")
public class ReservationIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ReservationIamPolicy(String name, ReservationIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ReservationIamPolicy", name, args == null ? ReservationIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ReservationIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ReservationIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ReservationIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
