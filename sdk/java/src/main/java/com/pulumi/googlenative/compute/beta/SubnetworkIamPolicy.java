...
import com.pulumi.googlenative.compute.beta.SubnetworkIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:SubnetworkIamPolicy")
public class SubnetworkIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public SubnetworkIamPolicy(String name, SubnetworkIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:SubnetworkIamPolicy", name, args == null ? SubnetworkIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SubnetworkIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:SubnetworkIamPolicy", name, null, makeResourceOptions(options, id));
    }
