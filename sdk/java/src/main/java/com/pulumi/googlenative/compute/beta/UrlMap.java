...
import com.pulumi.googlenative.compute.beta.UrlMapArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:UrlMap")
public class UrlMap extends com.pulumi.resources.CustomResource {
    ...
    public UrlMap(String name, @Nullable UrlMapArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:UrlMap", name, args == null ? UrlMapArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private UrlMap(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:UrlMap", name, null, makeResourceOptions(options, id));
    }
