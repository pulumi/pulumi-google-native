...
public final class GetNodeGroupIamPolicyArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetNodeGroupIamPolicyArgs(GetNodeGroupIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodeGroupIamPolicyArgs();
        }

        public Builder(GetNodeGroupIamPolicyArgs defaults) {
            $ = new GetNodeGroupIamPolicyArgs(Objects.requireNonNull(defaults));
        }
