...
import com.pulumi.googlenative.compute.v1.DiskIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:DiskIamPolicy")
public class DiskIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public DiskIamPolicy(String name, DiskIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:DiskIamPolicy", name, args == null ? DiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DiskIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:DiskIamPolicy", name, null, makeResourceOptions(options, id));
    }
