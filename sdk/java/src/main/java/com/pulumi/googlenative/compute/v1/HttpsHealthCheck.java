...
import com.pulumi.googlenative.compute.v1.HttpsHealthCheckArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:HttpsHealthCheck")
public class HttpsHealthCheck extends com.pulumi.resources.CustomResource {
    ...
    public HttpsHealthCheck(String name, @Nullable HttpsHealthCheckArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:HttpsHealthCheck", name, args == null ? HttpsHealthCheckArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HttpsHealthCheck(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:HttpsHealthCheck", name, null, makeResourceOptions(options, id));
    }
