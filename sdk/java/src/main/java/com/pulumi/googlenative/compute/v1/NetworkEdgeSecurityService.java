...
import com.pulumi.googlenative.compute.v1.NetworkEdgeSecurityServiceArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:NetworkEdgeSecurityService")
public class NetworkEdgeSecurityService extends com.pulumi.resources.CustomResource {
    ...
    public NetworkEdgeSecurityService(String name, NetworkEdgeSecurityServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:NetworkEdgeSecurityService", name, args == null ? NetworkEdgeSecurityServiceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private NetworkEdgeSecurityService(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:NetworkEdgeSecurityService", name, null, makeResourceOptions(options, id));
    }
