...
import com.pulumi.googlenative.compute.v1.RegionDiskIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:RegionDiskIamPolicy")
public class RegionDiskIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public RegionDiskIamPolicy(String name, RegionDiskIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionDiskIamPolicy", name, args == null ? RegionDiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionDiskIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionDiskIamPolicy", name, null, makeResourceOptions(options, id));
    }
