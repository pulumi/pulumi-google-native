...
import com.pulumi.googlenative.compute.v1.ReservationIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:ReservationIamPolicy")
public class ReservationIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ReservationIamPolicy(String name, ReservationIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:ReservationIamPolicy", name, args == null ? ReservationIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ReservationIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:ReservationIamPolicy", name, null, makeResourceOptions(options, id));
    }
