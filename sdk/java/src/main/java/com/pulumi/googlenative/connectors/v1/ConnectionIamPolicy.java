...
import com.pulumi.googlenative.connectors.v1.ConnectionIamPolicyArgs;
import com.pulumi.googlenative.connectors.v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.connectors.v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:connectors/v1:ConnectionIamPolicy")
public class ConnectionIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ConnectionIamPolicy(String name, ConnectionIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:connectors/v1:ConnectionIamPolicy", name, args == null ? ConnectionIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ConnectionIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:connectors/v1:ConnectionIamPolicy", name, null, makeResourceOptions(options, id));
    }
