...
import com.pulumi.googlenative.connectors.v1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.connectors.v1.inputs.BindingArgs;
...
public final class ProviderIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProviderIamPolicyArgs Empty = new ProviderIamPolicyArgs();
    ...
    private ProviderIamPolicyArgs() {}

    private ProviderIamPolicyArgs(ProviderIamPolicyArgs $) {
    ...
    public static Builder builder(ProviderIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProviderIamPolicyArgs();
        }

        public Builder(ProviderIamPolicyArgs defaults) {
            $ = new ProviderIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProviderIamPolicyArgs build() {
