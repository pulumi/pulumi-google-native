...
import com.pulumi.googlenative.container.v1beta1.enums.LinuxNodeConfigCgroupMode;
...
public final class LinuxNodeConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<LinuxNodeConfigCgroupMode> cgroupMode;

    /**
     * @return cgroup_mode specifies the cgroup mode to be used on the node.
     * 
     */
    public Optional<Output<LinuxNodeConfigCgroupMode>> cgroupMode() {
    ...
    public static final class Builder {
        ...
        /**
         * @param cgroupMode cgroup_mode specifies the cgroup mode to be used on the node.
         * 
         * @return builder
         * 
         */
        public Builder cgroupMode(@Nullable Output<LinuxNodeConfigCgroupMode> cgroupMode) {
         ...
         * 
         */
        public Builder cgroupMode(LinuxNodeConfigCgroupMode cgroupMode) {
