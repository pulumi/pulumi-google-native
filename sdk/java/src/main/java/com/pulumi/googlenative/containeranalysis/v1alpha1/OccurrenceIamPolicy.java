...
import com.pulumi.googlenative.containeranalysis.v1alpha1.OccurrenceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:containeranalysis/v1alpha1:OccurrenceIamPolicy")
public class OccurrenceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="occurrenceId", type=String.class, parameters={})
    ...
    public OccurrenceIamPolicy(String name, OccurrenceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1alpha1:OccurrenceIamPolicy", name, args == null ? OccurrenceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OccurrenceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1alpha1:OccurrenceIamPolicy", name, null, makeResourceOptions(options, id));
    }
