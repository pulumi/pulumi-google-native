...
import com.pulumi.googlenative.containeranalysis.v1beta1.NoteIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:containeranalysis/v1beta1:NoteIamPolicy")
public class NoteIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public NoteIamPolicy(String name, NoteIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1beta1:NoteIamPolicy", name, args == null ? NoteIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NoteIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1beta1:NoteIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static NoteIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
