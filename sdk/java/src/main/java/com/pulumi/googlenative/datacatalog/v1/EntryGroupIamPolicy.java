...
import com.pulumi.googlenative.datacatalog.v1.EntryGroupIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:datacatalog/v1:EntryGroupIamPolicy")
public class EntryGroupIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public EntryGroupIamPolicy(String name, EntryGroupIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1:EntryGroupIamPolicy", name, args == null ? EntryGroupIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EntryGroupIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1:EntryGroupIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static EntryGroupIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
