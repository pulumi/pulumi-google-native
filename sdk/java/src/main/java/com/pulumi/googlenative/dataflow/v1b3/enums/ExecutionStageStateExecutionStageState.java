...
import java.util.StringJoiner;
     ...
     */
    @EnumType
    public enum ExecutionStageStateExecutionStageState {
        /**
        ...
        ExecutionStageStateExecutionStageState(String value) {
        ...
        public String toString() {
            return new StringJoiner(", ", "ExecutionStageStateExecutionStageState[", "]")
