...
import com.pulumi.googlenative.datamigration.v1.MigrationJobIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:datamigration/v1:MigrationJobIamPolicy")
public class MigrationJobIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public MigrationJobIamPolicy(String name, MigrationJobIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datamigration/v1:MigrationJobIamPolicy", name, args == null ? MigrationJobIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MigrationJobIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datamigration/v1:MigrationJobIamPolicy", name, null, makeResourceOptions(options, id));
    }
