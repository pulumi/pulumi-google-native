...
import com.pulumi.googlenative.dataplex.v1.LakeAssetIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:dataplex/v1:LakeAssetIamPolicy")
public class LakeAssetIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public LakeAssetIamPolicy(String name) {
        this(name, LakeAssetIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LakeAssetIamPolicy(String name, LakeAssetIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LakeAssetIamPolicy(String name, LakeAssetIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataplex/v1:LakeAssetIamPolicy", name, args == null ? LakeAssetIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LakeAssetIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataplex/v1:LakeAssetIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static LakeAssetIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LakeAssetIamPolicy(name, id, options);
    }
}
