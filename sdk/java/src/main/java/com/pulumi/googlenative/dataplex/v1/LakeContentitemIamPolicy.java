...
import com.pulumi.googlenative.dataplex.v1.LakeContentitemIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:dataplex/v1:LakeContentitemIamPolicy")
public class LakeContentitemIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentitemId", type=String.class, parameters={})
     ...
     */
    public LakeContentitemIamPolicy(String name) {
        this(name, LakeContentitemIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LakeContentitemIamPolicy(String name, LakeContentitemIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LakeContentitemIamPolicy(String name, LakeContentitemIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataplex/v1:LakeContentitemIamPolicy", name, args == null ? LakeContentitemIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LakeContentitemIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataplex/v1:LakeContentitemIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static LakeContentitemIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
