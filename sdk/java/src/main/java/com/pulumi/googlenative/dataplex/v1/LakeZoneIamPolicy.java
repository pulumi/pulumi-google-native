...
import com.pulumi.googlenative.dataplex.v1.LakeZoneIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:dataplex/v1:LakeZoneIamPolicy")
public class LakeZoneIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LakeZoneIamPolicy(String name) {
        this(name, LakeZoneIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LakeZoneIamPolicy(String name, LakeZoneIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LakeZoneIamPolicy(String name, LakeZoneIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataplex/v1:LakeZoneIamPolicy", name, args == null ? LakeZoneIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LakeZoneIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataplex/v1:LakeZoneIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static LakeZoneIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
