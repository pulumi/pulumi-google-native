...
public final class GetLakeAssetIamPolicyArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetLakeAssetIamPolicyArgs() {}

    private GetLakeAssetIamPolicyArgs(GetLakeAssetIamPolicyArgs $) {
    ...
    public static Builder builder(GetLakeAssetIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLakeAssetIamPolicyArgs();
        }

        public Builder(GetLakeAssetIamPolicyArgs defaults) {
