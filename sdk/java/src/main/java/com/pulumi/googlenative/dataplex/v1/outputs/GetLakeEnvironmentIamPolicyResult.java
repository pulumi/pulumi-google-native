...
@CustomType
public final class GetLakeEnvironmentIamPolicyResult {
    /**
    ...
    public static Builder builder(GetLakeEnvironmentIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetLakeEnvironmentIamPolicyResult defaults) {
        ...
        public GetLakeEnvironmentIamPolicyResult build() {
            final var o = new GetLakeEnvironmentIamPolicyResult();
