...
import com.pulumi.googlenative.dataproc.v1.WorkflowTemplateIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:dataproc/v1:WorkflowTemplateIamPolicy")
public class WorkflowTemplateIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="workflowTemplateId", type=String.class, parameters={})
    ...
    private WorkflowTemplateIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1:WorkflowTemplateIamPolicy", name, null, makeResourceOptions(options, id));
    }
