...
import com.pulumi.googlenative.dataproc.v1.inputs.AutoscalingConfigArgs;
import com.pulumi.googlenative.dataproc.v1.inputs.DataprocMetricConfigArgs;
import com.pulumi.googlenative.dataproc.v1.inputs.EncryptionConfigArgs;
import com.pulumi.googlenative.dataproc.v1.inputs.EndpointConfigArgs;
import com.pulumi.googlenative.dataproc.v1.inputs.GceClusterConfigArgs;
...
import com.pulumi.googlenative.dataproc.v1.inputs.LifecycleConfigArgs;
import com.pulumi.googlenative.dataproc.v1.inputs.MetastoreConfigArgs;
import com.pulumi.googlenative.dataproc.v1.inputs.NodeInitializationActionArgs;
import com.pulumi.googlenative.dataproc.v1.inputs.SecurityConfigArgs;
import com.pulumi.googlenative.dataproc.v1.inputs.SoftwareConfigArgs;
...
public final class ClusterConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param dataprocMetricConfig Optional. The config for Dataproc metrics.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param gkeClusterConfig Optional. BETA. The Kubernetes Engine config for Dataproc clusters deployed to The Kubernetes Engine config for Dataproc clusters deployed to Kubernetes. These config settings are mutually exclusive with Compute Engine-based options, such as gce_cluster_config, master_config, worker_config, secondary_worker_config, and autoscaling_config.
         * 
         * @return builder
         * 
         */
