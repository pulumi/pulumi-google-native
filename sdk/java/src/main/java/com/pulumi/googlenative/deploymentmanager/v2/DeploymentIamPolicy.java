...
import com.pulumi.googlenative.deploymentmanager.v2.DeploymentIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:deploymentmanager/v2:DeploymentIamPolicy")
public class DeploymentIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public DeploymentIamPolicy(String name, DeploymentIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:deploymentmanager/v2:DeploymentIamPolicy", name, args == null ? DeploymentIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DeploymentIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:deploymentmanager/v2:DeploymentIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DeploymentIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
