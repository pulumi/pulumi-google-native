...
import com.pulumi.googlenative.dialogflow.v2beta1.DocumentArgs;
...
public class Document extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="importGcsCustomMetadata", type=String.class, parameters={})
    private Output</* @Nullable */ String> importGcsCustomMetadata;
     ...
     * 
     */
    public Output<Optional<String>> importGcsCustomMetadata() {
        return Codegen.optional(this.importGcsCustomMetadata);
    }
