...
import com.pulumi.googlenative.dialogflow.v2beta1.enums.IntentDefaultResponsePlatformsItem;
import com.pulumi.googlenative.dialogflow.v2beta1.enums.IntentWebhookState;
import com.pulumi.googlenative.dialogflow.v2beta1.inputs.GoogleCloudDialogflowV2beta1ContextArgs;
import com.pulumi.googlenative.dialogflow.v2beta1.inputs.GoogleCloudDialogflowV2beta1IntentMessageArgs;
import com.pulumi.googlenative.dialogflow.v2beta1.inputs.GoogleCloudDialogflowV2beta1IntentParameterArgs;
import com.pulumi.googlenative.dialogflow.v2beta1.inputs.GoogleCloudDialogflowV2beta1IntentTrainingPhraseArgs;
...
public final class IntentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param inputContextNames Optional. The list of context names required for this intent to be triggered. Formats: - `projects//agent/sessions/-/contexts/` - `projects//locations//agent/sessions/-/contexts/`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param name Optional. The unique identifier of this intent. Required for Intents.UpdateIntent and Intents.BatchUpdateIntents methods. Supported formats: - `projects//agent/intents/` - `projects//locations//agent/intents/`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param parentFollowupIntentName Optional. The unique identifier of the parent intent in the chain of followup intents. You can set this field when creating an intent, for example with CreateIntent or BatchUpdateIntents, in order to make this intent a followup intent. It identifies the parent followup intent. Format: `projects//agent/intents/`.
         * 
         * @return builder
         * 
         */
