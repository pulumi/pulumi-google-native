...
import com.pulumi.googlenative.dialogflow.v3.inputs.GoogleCloudDialogflowCxV3EnvironmentTestCasesConfigArgs;
import com.pulumi.googlenative.dialogflow.v3.inputs.GoogleCloudDialogflowCxV3EnvironmentVersionConfigArgs;
import com.pulumi.googlenative.dialogflow.v3.inputs.GoogleCloudDialogflowCxV3EnvironmentWebhookConfigArgs;
...
public final class EnvironmentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GoogleCloudDialogflowCxV3EnvironmentWebhookConfigArgs> webhookConfig;

    /**
     * @return The webhook configuration for this environment.
     * 
     */
    public Optional<Output<GoogleCloudDialogflowCxV3EnvironmentWebhookConfigArgs>> webhookConfig() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder webhookConfig(@Nullable Output<GoogleCloudDialogflowCxV3EnvironmentWebhookConfigArgs> webhookConfig) {
         ...
         * 
         */
        public Builder webhookConfig(GoogleCloudDialogflowCxV3EnvironmentWebhookConfigArgs webhookConfig) {
