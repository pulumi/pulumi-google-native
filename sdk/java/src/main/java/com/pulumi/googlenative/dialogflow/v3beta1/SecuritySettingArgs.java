...
import com.pulumi.googlenative.dialogflow.v3beta1.enums.SecuritySettingPurgeDataTypesItem;
import com.pulumi.googlenative.dialogflow.v3beta1.enums.SecuritySettingRedactionScope;
import com.pulumi.googlenative.dialogflow.v3beta1.enums.SecuritySettingRedactionStrategy;
import com.pulumi.googlenative.dialogflow.v3beta1.inputs.GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettingsArgs;
import com.pulumi.googlenative.dialogflow.v3beta1.inputs.GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettingsArgs;
...
public final class SecuritySettingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettingsArgs> audioExportSettings;

    /**
     * @return Controls audio export settings for post-conversation analytics when ingesting audio to conversations via Participants.AnalyzeContent or Participants.StreamingAnalyzeContent. If retention_strategy is set to REMOVE_AFTER_CONVERSATION or audio_export_settings.gcs_bucket is empty, audio export is disabled. If audio export is enabled, audio is recorded and saved to audio_export_settings.gcs_bucket, subject to retention policy of audio_export_settings.gcs_bucket. This setting won&#39;t effect audio input for implicit sessions via Sessions.DetectIntent or Sessions.StreamingDetectIntent.
     * 
     */
    public Optional<Output<GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettingsArgs>> audioExportSettings() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder audioExportSettings(@Nullable Output<GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettingsArgs> audioExportSettings) {
         ...
         * 
         */
        public Builder audioExportSettings(GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettingsArgs audioExportSettings) {
