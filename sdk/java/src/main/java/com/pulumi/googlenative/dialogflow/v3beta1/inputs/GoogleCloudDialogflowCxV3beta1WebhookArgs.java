 ...
 * 
 */
public final class GoogleCloudDialogflowCxV3beta1WebhookArgs extends com.pulumi.resources.ResourceArgs {

    public static final GoogleCloudDialogflowCxV3beta1WebhookArgs Empty = new GoogleCloudDialogflowCxV3beta1WebhookArgs();
    ...
    private GoogleCloudDialogflowCxV3beta1WebhookArgs() {}

    private GoogleCloudDialogflowCxV3beta1WebhookArgs(GoogleCloudDialogflowCxV3beta1WebhookArgs $) {
    ...
    public static Builder builder(GoogleCloudDialogflowCxV3beta1WebhookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudDialogflowCxV3beta1WebhookArgs();
        }

        public Builder(GoogleCloudDialogflowCxV3beta1WebhookArgs defaults) {
            $ = new GoogleCloudDialogflowCxV3beta1WebhookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GoogleCloudDialogflowCxV3beta1WebhookArgs build() {
