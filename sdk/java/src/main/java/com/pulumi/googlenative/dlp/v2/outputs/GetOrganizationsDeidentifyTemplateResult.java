...
@CustomType
public final class GetOrganizationsDeidentifyTemplateResult {
    /**
    ...
    public static Builder builder(GetOrganizationsDeidentifyTemplateResult defaults) {
    ...
    public static final class Builder {
        ...
        private String updateTime;
        public Builder() {}
        public Builder(GetOrganizationsDeidentifyTemplateResult defaults) {
        ...
        public GetOrganizationsDeidentifyTemplateResult build() {
            final var o = new GetOrganizationsDeidentifyTemplateResult();
