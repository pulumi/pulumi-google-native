...
import com.pulumi.googlenative.dns.v1.inputs.GetChangeArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetChangePlainArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetManagedZoneArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetManagedZoneIamPolicyArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetManagedZoneIamPolicyPlainArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetManagedZonePlainArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetPolicyArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetPolicyPlainArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetResourceRecordSetArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetResourceRecordSetPlainArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetResponsePolicyArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetResponsePolicyPlainArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetResponsePolicyRuleArgs;
import com.pulumi.googlenative.dns.v1.inputs.GetResponsePolicyRulePlainArgs;
import com.pulumi.googlenative.dns.v1.outputs.GetChangeResult;
import com.pulumi.googlenative.dns.v1.outputs.GetManagedZoneIamPolicyResult;
import com.pulumi.googlenative.dns.v1.outputs.GetManagedZoneResult;
import com.pulumi.googlenative.dns.v1.outputs.GetPolicyResult;
import com.pulumi.googlenative.dns.v1.outputs.GetResourceRecordSetResult;
import com.pulumi.googlenative.dns.v1.outputs.GetResponsePolicyResult;
import com.pulumi.googlenative.dns.v1.outputs.GetResponsePolicyRuleResult;
...
public final class Dns_v1Functions {
    ...
    public static Output<GetManagedZoneIamPolicyResult> getManagedZoneIamPolicy(GetManagedZoneIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:dns/v1:getManagedZoneIamPolicy", TypeShape.of(GetManagedZoneIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
     * 
    ...
    public static CompletableFuture<GetManagedZoneIamPolicyResult> getManagedZoneIamPolicyPlain(GetManagedZoneIamPolicyPlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("google-native:dns/v1:getManagedZoneIamPolicy", TypeShape.of(GetManagedZoneIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
