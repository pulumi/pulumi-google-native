...
import com.pulumi.googlenative.essentialcontacts.v1.OrganizationContactArgs;
...
public class OrganizationContact extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public OrganizationContact(String name, OrganizationContactArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private OrganizationContact(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationContact get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
