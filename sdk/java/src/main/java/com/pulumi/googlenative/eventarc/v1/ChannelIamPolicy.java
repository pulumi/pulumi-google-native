...
import com.pulumi.googlenative.eventarc.v1.ChannelIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:eventarc/v1:ChannelIamPolicy")
public class ChannelIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ChannelIamPolicy(String name) {
        this(name, ChannelIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ChannelIamPolicy(String name, ChannelIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ChannelIamPolicy(String name, ChannelIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:eventarc/v1:ChannelIamPolicy", name, args == null ? ChannelIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ChannelIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:eventarc/v1:ChannelIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ChannelIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new ChannelIamPolicy(name, id, options);
    }
}
