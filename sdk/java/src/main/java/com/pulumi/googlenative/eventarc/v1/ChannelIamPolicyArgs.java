...
import com.pulumi.googlenative.eventarc.v1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.eventarc.v1.inputs.BindingArgs;
...
public final class ChannelIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final ChannelIamPolicyArgs Empty = new ChannelIamPolicyArgs();
    ...
    private ChannelIamPolicyArgs() {}

    private ChannelIamPolicyArgs(ChannelIamPolicyArgs $) {
    ...
    public static Builder builder(ChannelIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ChannelIamPolicyArgs();
        }

        public Builder(ChannelIamPolicyArgs defaults) {
            $ = new ChannelIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ChannelIamPolicyArgs build() {
