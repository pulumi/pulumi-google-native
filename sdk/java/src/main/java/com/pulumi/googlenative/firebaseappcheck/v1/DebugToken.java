...
import com.pulumi.googlenative.firebaseappcheck.v1.DebugTokenArgs;
 ...
 * 
 */
@ResourceType(type="google-native:firebaseappcheck/v1:DebugToken")
public class DebugToken extends com.pulumi.resources.CustomResource {
    ...
    public DebugToken(String name, DebugTokenArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:firebaseappcheck/v1:DebugToken", name, args == null ? DebugTokenArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DebugToken(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:firebaseappcheck/v1:DebugToken", name, null, makeResourceOptions(options, id));
    }
