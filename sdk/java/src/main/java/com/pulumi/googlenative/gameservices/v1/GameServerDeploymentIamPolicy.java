...
import com.pulumi.googlenative.gameservices.v1.GameServerDeploymentIamPolicyArgs;
...
public class GameServerDeploymentIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public GameServerDeploymentIamPolicy(String name, GameServerDeploymentIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private GameServerDeploymentIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static GameServerDeploymentIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
