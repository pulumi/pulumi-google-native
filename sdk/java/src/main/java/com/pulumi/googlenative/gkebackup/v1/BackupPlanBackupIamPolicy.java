...
import com.pulumi.googlenative.gkebackup.v1.BackupPlanBackupIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:gkebackup/v1:BackupPlanBackupIamPolicy")
public class BackupPlanBackupIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public BackupPlanBackupIamPolicy(String name) {
        this(name, BackupPlanBackupIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public BackupPlanBackupIamPolicy(String name, BackupPlanBackupIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BackupPlanBackupIamPolicy(String name, BackupPlanBackupIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkebackup/v1:BackupPlanBackupIamPolicy", name, args == null ? BackupPlanBackupIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private BackupPlanBackupIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkebackup/v1:BackupPlanBackupIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static BackupPlanBackupIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new BackupPlanBackupIamPolicy(name, id, options);
    }
}
