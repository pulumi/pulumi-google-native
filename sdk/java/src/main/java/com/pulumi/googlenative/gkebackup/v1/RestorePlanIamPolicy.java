...
import com.pulumi.googlenative.gkebackup.v1.RestorePlanIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:gkebackup/v1:RestorePlanIamPolicy")
public class RestorePlanIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public RestorePlanIamPolicy(String name, RestorePlanIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkebackup/v1:RestorePlanIamPolicy", name, args == null ? RestorePlanIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RestorePlanIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkebackup/v1:RestorePlanIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RestorePlanIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RestorePlanIamPolicy(name, id, options);
    }
}
