...
@CustomType
public final class GetBackupPlanBackupIamPolicyResult {
    /**
    ...
    public static Builder builder(GetBackupPlanBackupIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetBackupPlanBackupIamPolicyResult defaults) {
        ...
        public GetBackupPlanBackupIamPolicyResult build() {
            final var o = new GetBackupPlanBackupIamPolicyResult();
