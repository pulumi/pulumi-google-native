...
@CustomType
public final class GetBackupPlanIamPolicyResult {
    /**
    ...
    public static Builder builder(GetBackupPlanIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetBackupPlanIamPolicyResult defaults) {
        ...
        public GetBackupPlanIamPolicyResult build() {
            final var o = new GetBackupPlanIamPolicyResult();
