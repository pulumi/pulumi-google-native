...
@CustomType
public final class GetRestorePlanIamPolicyResult {
    /**
    ...
    public static Builder builder(GetRestorePlanIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetRestorePlanIamPolicyResult defaults) {
        ...
        public GetRestorePlanIamPolicyResult build() {
            final var o = new GetRestorePlanIamPolicyResult();
