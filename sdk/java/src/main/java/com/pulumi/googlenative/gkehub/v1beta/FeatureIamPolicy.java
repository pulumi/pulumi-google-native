...
import com.pulumi.googlenative.gkehub.v1beta.FeatureIamPolicyArgs;
import com.pulumi.googlenative.gkehub.v1beta.outputs.AuditConfigResponse;
import com.pulumi.googlenative.gkehub.v1beta.outputs.BindingResponse;
...
public class FeatureIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private FeatureIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static FeatureIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
