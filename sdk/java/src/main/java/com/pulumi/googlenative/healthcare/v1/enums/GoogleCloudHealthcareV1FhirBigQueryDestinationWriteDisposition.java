...
import java.util.StringJoiner;
    ...
    public enum GoogleCloudHealthcareV1FhirBigQueryDestinationWriteDisposition {
        ...
        GoogleCloudHealthcareV1FhirBigQueryDestinationWriteDisposition(String value) {
        ...
        public String toString() {
            return new StringJoiner(", ", "GoogleCloudHealthcareV1FhirBigQueryDestinationWriteDisposition[", "]")
