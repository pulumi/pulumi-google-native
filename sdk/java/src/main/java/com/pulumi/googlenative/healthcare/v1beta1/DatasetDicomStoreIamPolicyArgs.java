...
import com.pulumi.googlenative.healthcare.v1beta1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.healthcare.v1beta1.inputs.BindingArgs;
...
public final class DatasetDicomStoreIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DatasetDicomStoreIamPolicyArgs(DatasetDicomStoreIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetDicomStoreIamPolicyArgs();
        }

        public Builder(DatasetDicomStoreIamPolicyArgs defaults) {
            $ = new DatasetDicomStoreIamPolicyArgs(Objects.requireNonNull(defaults));
        }
