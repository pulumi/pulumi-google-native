...
public final class DatasetHl7V2StoreIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DatasetHl7V2StoreIamPolicyArgs(DatasetHl7V2StoreIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetHl7V2StoreIamPolicyArgs();
        }

        public Builder(DatasetHl7V2StoreIamPolicyArgs defaults) {
            $ = new DatasetHl7V2StoreIamPolicyArgs(Objects.requireNonNull(defaults));
        }
