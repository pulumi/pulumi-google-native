...
import com.pulumi.googlenative.healthcare.v1beta1.DatasetIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:healthcare/v1beta1:DatasetIamPolicy")
public class DatasetIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public DatasetIamPolicy(String name, DatasetIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:DatasetIamPolicy", name, args == null ? DatasetIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DatasetIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:DatasetIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DatasetIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
