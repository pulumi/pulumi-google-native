...
import com.pulumi.googlenative.healthcare.v1beta1.inputs.DeidentifiedStoreDestinationArgs;
...
public final class StreamConfigArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="deidentifiedStoreDestination")
    private @Nullable Output<DeidentifiedStoreDestinationArgs> deidentifiedStoreDestination;
     ...
     * 
     */
    public Optional<Output<DeidentifiedStoreDestinationArgs>> deidentifiedStoreDestination() {
        return Optional.ofNullable(this.deidentifiedStoreDestination);
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param deidentifiedStoreDestination The destination FHIR store for de-identified resources. After this field is added, all subsequent creates/updates/patches to the source store will be de-identified using the provided configuration and applied to the destination store. Importing resources to the source store will not trigger the streaming. If the source store already contains resources when this option is enabled, those resources will not be copied to the destination store unless they are subsequently updated. This may result in invalid references in the destination store. Before adding this config, you must grant the healthcare.fhirResources.update permission on the destination store to your project&#39;s **Cloud Healthcare Service Agent** [service account](https://cloud.google.com/healthcare/docs/how-tos/permissions-healthcare-api-gcp-products#the_cloud_healthcare_service_agent). The destination store must set enable_update_create to true. The destination store must have disable_referential_integrity set to true. If a resource cannot be de-identified, errors will be logged to Cloud Logging (see [Viewing error logs in Cloud Logging](https://cloud.google.com/healthcare/docs/how-tos/logging)).
         * 
         * @return builder
         * 
         */
        public Builder deidentifiedStoreDestination(@Nullable Output<DeidentifiedStoreDestinationArgs> deidentifiedStoreDestination) {
         ...
         * 
         */
        public Builder deidentifiedStoreDestination(DeidentifiedStoreDestinationArgs deidentifiedStoreDestination) {
            return deidentifiedStoreDestination(Output.of(deidentifiedStoreDestination));
        }
