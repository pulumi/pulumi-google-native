...
import com.pulumi.googlenative.iap.v1.inputs.BindingArgs;
...
public final class V1IamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private V1IamPolicyArgs(V1IamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(V1IamPolicyArgs defaults) {
            $ = new V1IamPolicyArgs(Objects.requireNonNull(defaults));
        }
