...
import com.pulumi.googlenative.logging.v2.BillingAccountBucketArgs;
 ...
 * 
 */
@ResourceType(type="google-native:logging/v2:BillingAccountBucket")
public class BillingAccountBucket extends com.pulumi.resources.CustomResource {
     ...
     */
    public BillingAccountBucket(String name) {
        this(name, BillingAccountBucketArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public BillingAccountBucket(String name, BillingAccountBucketArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:BillingAccountBucket", name, args == null ? BillingAccountBucketArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private BillingAccountBucket(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:BillingAccountBucket", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static BillingAccountBucket get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
