...
import com.pulumi.googlenative.logging.v2.FolderBucketArgs;
 ...
 * 
 */
@ResourceType(type="google-native:logging/v2:FolderBucket")
public class FolderBucket extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public FolderBucket(String name) {
        this(name, FolderBucketArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FolderBucket(String name, FolderBucketArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FolderBucket(String name, FolderBucketArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:FolderBucket", name, args == null ? FolderBucketArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FolderBucket(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:FolderBucket", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static FolderBucket get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
