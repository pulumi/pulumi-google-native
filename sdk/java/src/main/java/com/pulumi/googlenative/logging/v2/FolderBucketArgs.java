...
public final class FolderBucketArgs extends com.pulumi.resources.ResourceArgs {

    public static final FolderBucketArgs Empty = new FolderBucketArgs();
    ...
    private FolderBucketArgs() {}

    private FolderBucketArgs(FolderBucketArgs $) {
    ...
    public static Builder builder(FolderBucketArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FolderBucketArgs();
        }

        public Builder(FolderBucketArgs defaults) {
            $ = new FolderBucketArgs(Objects.requireNonNull(defaults));
        }
