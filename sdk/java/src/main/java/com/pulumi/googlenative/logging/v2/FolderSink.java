...
import com.pulumi.googlenative.logging.v2.FolderSinkArgs;
 ...
 * 
 */
@ResourceType(type="google-native:logging/v2:FolderSink")
public class FolderSink extends com.pulumi.resources.CustomResource {
    ...
    public FolderSink(String name, FolderSinkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:FolderSink", name, args == null ? FolderSinkArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FolderSink(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:FolderSink", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static FolderSink get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
