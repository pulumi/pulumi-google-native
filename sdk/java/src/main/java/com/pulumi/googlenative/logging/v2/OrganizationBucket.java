...
import com.pulumi.googlenative.logging.v2.OrganizationBucketArgs;
 ...
 * 
 */
@ResourceType(type="google-native:logging/v2:OrganizationBucket")
public class OrganizationBucket extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public OrganizationBucket(String name) {
        this(name, OrganizationBucketArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public OrganizationBucket(String name, OrganizationBucketArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:OrganizationBucket", name, args == null ? OrganizationBucketArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OrganizationBucket(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:OrganizationBucket", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static OrganizationBucket get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
