...
import com.pulumi.googlenative.logging.v2.OrganizationExclusionArgs;
 ...
 * 
 */
@ResourceType(type="google-native:logging/v2:OrganizationExclusion")
public class OrganizationExclusion extends com.pulumi.resources.CustomResource {
    ...
    public OrganizationExclusion(String name, OrganizationExclusionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:OrganizationExclusion", name, args == null ? OrganizationExclusionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OrganizationExclusion(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:OrganizationExclusion", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static OrganizationExclusion get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
