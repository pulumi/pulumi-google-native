...
import com.pulumi.googlenative.logging.v2.OrganizationSinkArgs;
 ...
 * 
 */
@ResourceType(type="google-native:logging/v2:OrganizationSink")
public class OrganizationSink extends com.pulumi.resources.CustomResource {
    ...
    public OrganizationSink(String name, OrganizationSinkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:OrganizationSink", name, args == null ? OrganizationSinkArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OrganizationSink(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:logging/v2:OrganizationSink", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static OrganizationSink get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
