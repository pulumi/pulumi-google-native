...
import com.pulumi.googlenative.managedidentities.v1.PeeringIamPolicyArgs;
...
public class PeeringIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public PeeringIamPolicy(String name, PeeringIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1:PeeringIamPolicy", name, args == null ? PeeringIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
