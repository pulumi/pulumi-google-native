...
import com.pulumi.googlenative.managedidentities.v1beta1.DomainBackupIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:managedidentities/v1beta1:DomainBackupIamPolicy")
public class DomainBackupIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public DomainBackupIamPolicy(String name, DomainBackupIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1beta1:DomainBackupIamPolicy", name, args == null ? DomainBackupIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DomainBackupIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1beta1:DomainBackupIamPolicy", name, null, makeResourceOptions(options, id));
    }
