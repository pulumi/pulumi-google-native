...
import com.pulumi.googlenative.managedidentities.v1beta1.PeeringIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:managedidentities/v1beta1:PeeringIamPolicy")
public class PeeringIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public PeeringIamPolicy(String name, PeeringIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1beta1:PeeringIamPolicy", name, args == null ? PeeringIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PeeringIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1beta1:PeeringIamPolicy", name, null, makeResourceOptions(options, id));
    }
