...
import com.pulumi.googlenative.metastore.v1alpha.FederationIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1alpha:FederationIamPolicy")
public class FederationIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public FederationIamPolicy(String name, FederationIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:FederationIamPolicy", name, args == null ? FederationIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FederationIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:FederationIamPolicy", name, null, makeResourceOptions(options, id));
    }
