...
public final class ServiceBackupIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceBackupIamPolicyArgs(ServiceBackupIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceBackupIamPolicyArgs();
        }

        public Builder(ServiceBackupIamPolicyArgs defaults) {
            $ = new ServiceBackupIamPolicyArgs(Objects.requireNonNull(defaults));
        }
