...
import com.pulumi.googlenative.metastore.v1alpha.ServiceDatabaseIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1alpha:ServiceDatabaseIamPolicy")
public class ServiceDatabaseIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    public ServiceDatabaseIamPolicy(String name) {
        this(name, ServiceDatabaseIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServiceDatabaseIamPolicy(String name, ServiceDatabaseIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServiceDatabaseIamPolicy(String name, ServiceDatabaseIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceDatabaseIamPolicy", name, args == null ? ServiceDatabaseIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceDatabaseIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceDatabaseIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceDatabaseIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new ServiceDatabaseIamPolicy(name, id, options);
    }
}
