...
import com.pulumi.googlenative.metastore.v1alpha.inputs.AuditConfigArgs;
import com.pulumi.googlenative.metastore.v1alpha.inputs.BindingArgs;
...
public final class ServiceDatabaseIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceDatabaseIamPolicyArgs Empty = new ServiceDatabaseIamPolicyArgs();
    ...
    private ServiceDatabaseIamPolicyArgs() {}

    private ServiceDatabaseIamPolicyArgs(ServiceDatabaseIamPolicyArgs $) {
    ...
    public static Builder builder(ServiceDatabaseIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceDatabaseIamPolicyArgs();
        }

        public Builder(ServiceDatabaseIamPolicyArgs defaults) {
            $ = new ServiceDatabaseIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceDatabaseIamPolicyArgs build() {
