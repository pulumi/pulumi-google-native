...
import com.pulumi.googlenative.metastore.v1beta.FederationArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1beta:Federation")
public class Federation extends com.pulumi.resources.CustomResource {
    ...
    public Federation(String name, FederationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:Federation", name, args == null ? FederationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Federation(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:Federation", name, null, makeResourceOptions(options, id));
    }
