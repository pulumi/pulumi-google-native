...
import com.pulumi.googlenative.metastore.v1beta.FederationIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1beta:FederationIamPolicy")
public class FederationIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public FederationIamPolicy(String name) {
        this(name, FederationIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederationIamPolicy(String name, FederationIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederationIamPolicy(String name, FederationIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:FederationIamPolicy", name, args == null ? FederationIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FederationIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:FederationIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static FederationIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
