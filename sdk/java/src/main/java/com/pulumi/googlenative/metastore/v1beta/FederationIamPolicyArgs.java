...
import com.pulumi.googlenative.metastore.v1beta.inputs.AuditConfigArgs;
import com.pulumi.googlenative.metastore.v1beta.inputs.BindingArgs;
...
public final class FederationIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederationIamPolicyArgs Empty = new FederationIamPolicyArgs();
    ...
    private FederationIamPolicyArgs() {}

    private FederationIamPolicyArgs(FederationIamPolicyArgs $) {
    ...
    public static Builder builder(FederationIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederationIamPolicyArgs();
        }

        public Builder(FederationIamPolicyArgs defaults) {
            $ = new FederationIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederationIamPolicyArgs build() {
