...
import com.pulumi.googlenative.metastore.v1beta.ServiceDatabaseIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1beta:ServiceDatabaseIamPolicy")
public class ServiceDatabaseIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ServiceDatabaseIamPolicy(String name, ServiceDatabaseIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:ServiceDatabaseIamPolicy", name, args == null ? ServiceDatabaseIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private ServiceDatabaseIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:ServiceDatabaseIamPolicy", name, null, makeResourceOptions(options, id));
    }
