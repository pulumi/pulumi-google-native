...
import com.pulumi.googlenative.networkconnectivity.v1.SpokeIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkconnectivity/v1:SpokeIamPolicy")
public class SpokeIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public SpokeIamPolicy(String name, SpokeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkconnectivity/v1:SpokeIamPolicy", name, args == null ? SpokeIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SpokeIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkconnectivity/v1:SpokeIamPolicy", name, null, makeResourceOptions(options, id));
    }
