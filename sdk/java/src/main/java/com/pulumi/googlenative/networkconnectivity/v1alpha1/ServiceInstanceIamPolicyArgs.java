...
import com.pulumi.googlenative.networkconnectivity.v1alpha1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.networkconnectivity.v1alpha1.inputs.BindingArgs;
...
public final class ServiceInstanceIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceInstanceIamPolicyArgs Empty = new ServiceInstanceIamPolicyArgs();
    ...
    private ServiceInstanceIamPolicyArgs() {}

    private ServiceInstanceIamPolicyArgs(ServiceInstanceIamPolicyArgs $) {
    ...
    public static Builder builder(ServiceInstanceIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceInstanceIamPolicyArgs();
        }

        public Builder(ServiceInstanceIamPolicyArgs defaults) {
            $ = new ServiceInstanceIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceInstanceIamPolicyArgs build() {
