...
import com.pulumi.googlenative.networksecurity.v1.AuthorizationPolicyArgs;
...
public class AuthorizationPolicy extends com.pulumi.resources.CustomResource {
    ...
    public AuthorizationPolicy(String name, AuthorizationPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networksecurity/v1:AuthorizationPolicy", name, args == null ? AuthorizationPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
