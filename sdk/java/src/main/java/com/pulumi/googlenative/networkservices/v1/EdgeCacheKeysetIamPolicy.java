...
import com.pulumi.googlenative.networkservices.v1.EdgeCacheKeysetIamPolicyArgs;
...
public class EdgeCacheKeysetIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="edgeCacheKeysetId", type=String.class, parameters={})
     ...
     */
    public EdgeCacheKeysetIamPolicy(String name) {
        this(name, EdgeCacheKeysetIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public EdgeCacheKeysetIamPolicy(String name, EdgeCacheKeysetIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
