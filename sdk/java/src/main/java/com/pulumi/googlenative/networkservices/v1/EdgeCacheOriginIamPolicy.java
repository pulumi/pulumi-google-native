...
import com.pulumi.googlenative.networkservices.v1.EdgeCacheOriginIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:EdgeCacheOriginIamPolicy")
public class EdgeCacheOriginIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="edgeCacheOriginId", type=String.class, parameters={})
     ...
     */
    public EdgeCacheOriginIamPolicy(String name) {
        this(name, EdgeCacheOriginIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public EdgeCacheOriginIamPolicy(String name, EdgeCacheOriginIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EdgeCacheOriginIamPolicy(String name, EdgeCacheOriginIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:EdgeCacheOriginIamPolicy", name, args == null ? EdgeCacheOriginIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EdgeCacheOriginIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:EdgeCacheOriginIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static EdgeCacheOriginIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new EdgeCacheOriginIamPolicy(name, id, options);
    }
}
