...
import com.pulumi.googlenative.networkservices.v1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.networkservices.v1.inputs.BindingArgs;
...
public final class EdgeCacheOriginIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final EdgeCacheOriginIamPolicyArgs Empty = new EdgeCacheOriginIamPolicyArgs();
    ...
    private EdgeCacheOriginIamPolicyArgs() {}

    private EdgeCacheOriginIamPolicyArgs(EdgeCacheOriginIamPolicyArgs $) {
    ...
    public static Builder builder(EdgeCacheOriginIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EdgeCacheOriginIamPolicyArgs();
        }

        public Builder(EdgeCacheOriginIamPolicyArgs defaults) {
            $ = new EdgeCacheOriginIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EdgeCacheOriginIamPolicyArgs build() {
