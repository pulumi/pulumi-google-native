...
import com.pulumi.googlenative.networkservices.v1.EndpointPolicyIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:EndpointPolicyIamPolicy")
public class EndpointPolicyIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public EndpointPolicyIamPolicy(String name, EndpointPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:EndpointPolicyIamPolicy", name, args == null ? EndpointPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EndpointPolicyIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:EndpointPolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
