...
import com.pulumi.googlenative.networkservices.v1.GatewayIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:GatewayIamPolicy")
public class GatewayIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public GatewayIamPolicy(String name, GatewayIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:GatewayIamPolicy", name, args == null ? GatewayIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GatewayIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:GatewayIamPolicy", name, null, makeResourceOptions(options, id));
    }
