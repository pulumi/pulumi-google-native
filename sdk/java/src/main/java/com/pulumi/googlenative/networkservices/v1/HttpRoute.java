...
import com.pulumi.googlenative.networkservices.v1.HttpRouteArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:HttpRoute")
public class HttpRoute extends com.pulumi.resources.CustomResource {
    ...
    public HttpRoute(String name, HttpRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:HttpRoute", name, args == null ? HttpRouteArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HttpRoute(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:HttpRoute", name, null, makeResourceOptions(options, id));
    }
