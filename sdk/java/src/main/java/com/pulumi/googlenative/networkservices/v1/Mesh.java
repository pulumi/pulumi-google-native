...
import com.pulumi.googlenative.networkservices.v1.MeshArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:Mesh")
public class Mesh extends com.pulumi.resources.CustomResource {
    ...
    public Mesh(String name, MeshArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:Mesh", name, args == null ? MeshArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Mesh(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:Mesh", name, null, makeResourceOptions(options, id));
    }
