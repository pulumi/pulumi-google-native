...
import com.pulumi.googlenative.networkservices.v1.MeshIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:MeshIamPolicy")
public class MeshIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public MeshIamPolicy(String name, MeshIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:MeshIamPolicy", name, args == null ? MeshIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MeshIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:MeshIamPolicy", name, null, makeResourceOptions(options, id));
    }
