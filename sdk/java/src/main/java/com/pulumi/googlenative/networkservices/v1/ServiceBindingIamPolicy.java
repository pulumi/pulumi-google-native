...
import com.pulumi.googlenative.networkservices.v1.ServiceBindingIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:ServiceBindingIamPolicy")
public class ServiceBindingIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ServiceBindingIamPolicy(String name, ServiceBindingIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:ServiceBindingIamPolicy", name, args == null ? ServiceBindingIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceBindingIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:ServiceBindingIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceBindingIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
