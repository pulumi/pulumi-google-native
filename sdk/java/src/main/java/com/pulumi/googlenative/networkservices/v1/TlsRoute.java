...
import com.pulumi.googlenative.networkservices.v1.TlsRouteArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:TlsRoute")
public class TlsRoute extends com.pulumi.resources.CustomResource {
    ...
    public TlsRoute(String name, TlsRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:TlsRoute", name, args == null ? TlsRouteArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TlsRoute(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:TlsRoute", name, null, makeResourceOptions(options, id));
    }
