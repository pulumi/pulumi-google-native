...
@CustomType
public final class GetEndpointPolicyIamPolicyResult {
    /**
    ...
    public static Builder builder(GetEndpointPolicyIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetEndpointPolicyIamPolicyResult defaults) {
        ...
        public GetEndpointPolicyIamPolicyResult build() {
            final var o = new GetEndpointPolicyIamPolicyResult();
