...
import com.pulumi.googlenative.networkservices.v1beta1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.networkservices.v1beta1.inputs.BindingArgs;
...
public final class ServiceBindingIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceBindingIamPolicyArgs Empty = new ServiceBindingIamPolicyArgs();
    ...
    private ServiceBindingIamPolicyArgs() {}

    private ServiceBindingIamPolicyArgs(ServiceBindingIamPolicyArgs $) {
    ...
    public static Builder builder(ServiceBindingIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceBindingIamPolicyArgs();
        }

        public Builder(ServiceBindingIamPolicyArgs defaults) {
            $ = new ServiceBindingIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceBindingIamPolicyArgs build() {
