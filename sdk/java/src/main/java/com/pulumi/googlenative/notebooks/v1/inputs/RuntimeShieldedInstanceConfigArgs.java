...
public final class RuntimeShieldedInstanceConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RuntimeShieldedInstanceConfigArgs(RuntimeShieldedInstanceConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuntimeShieldedInstanceConfigArgs();
        }

        public Builder(RuntimeShieldedInstanceConfigArgs defaults) {
            $ = new RuntimeShieldedInstanceConfigArgs(Objects.requireNonNull(defaults));
        }
