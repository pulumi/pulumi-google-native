 ...
 * 
 */
public final class ZypperRepositoryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return A one word, unique name for this repository. This is the `repo id` in the zypper config file and also the `display_name` if `display_name` is omitted. This id is also used as the unique identifier when checking for guest policy conflicts.
     * 
     */
    ...
    private ZypperRepositoryArgs() {}

    private ZypperRepositoryArgs(ZypperRepositoryArgs $) {
    ...
    public static Builder builder(ZypperRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZypperRepositoryArgs();
        }

        public Builder(ZypperRepositoryArgs defaults) {
            $ = new ZypperRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param id A one word, unique name for this repository. This is the `repo id` in the zypper config file and also the `display_name` if `display_name` is omitted. This id is also used as the unique identifier when checking for guest policy conflicts.
         * 
         * @return builder
         * 
         */
