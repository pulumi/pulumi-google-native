...
import com.pulumi.googlenative.privateca.v1beta1.CertificateAuthorityIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:privateca/v1beta1:CertificateAuthorityIamPolicy")
public class CertificateAuthorityIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    public CertificateAuthorityIamPolicy(String name) {
        this(name, CertificateAuthorityIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public CertificateAuthorityIamPolicy(String name, CertificateAuthorityIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CertificateAuthorityIamPolicy(String name, CertificateAuthorityIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1beta1:CertificateAuthorityIamPolicy", name, args == null ? CertificateAuthorityIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private CertificateAuthorityIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1beta1:CertificateAuthorityIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static CertificateAuthorityIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new CertificateAuthorityIamPolicy(name, id, options);
    }
}
