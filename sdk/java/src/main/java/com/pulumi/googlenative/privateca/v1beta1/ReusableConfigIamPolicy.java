...
import com.pulumi.googlenative.privateca.v1beta1.ReusableConfigIamPolicyArgs;
...
public class ReusableConfigIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="reusableConfigId", type=String.class, parameters={})
     ...
     */
    public ReusableConfigIamPolicy(String name, ReusableConfigIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1beta1:ReusableConfigIamPolicy", name, args == null ? ReusableConfigIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ReusableConfigIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ReusableConfigIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
