...
import com.pulumi.googlenative.pubsub.v1beta2.SubscriptionIamPolicyArgs;
...
public class SubscriptionIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private SubscriptionIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SubscriptionIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
