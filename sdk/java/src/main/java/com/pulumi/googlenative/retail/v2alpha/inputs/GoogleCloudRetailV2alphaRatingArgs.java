 ...
 * 
 */
public final class GoogleCloudRetailV2alphaRatingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleCloudRetailV2alphaRatingArgs(GoogleCloudRetailV2alphaRatingArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudRetailV2alphaRatingArgs();
        }

        public Builder(GoogleCloudRetailV2alphaRatingArgs defaults) {
            $ = new GoogleCloudRetailV2alphaRatingArgs(Objects.requireNonNull(defaults));
        }
