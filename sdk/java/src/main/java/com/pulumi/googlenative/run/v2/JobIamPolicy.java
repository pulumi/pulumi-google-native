...
import com.pulumi.googlenative.run.v2.JobIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:run/v2:JobIamPolicy")
public class JobIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public JobIamPolicy(String name, JobIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v2:JobIamPolicy", name, args == null ? JobIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private JobIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v2:JobIamPolicy", name, null, makeResourceOptions(options, id));
    }
