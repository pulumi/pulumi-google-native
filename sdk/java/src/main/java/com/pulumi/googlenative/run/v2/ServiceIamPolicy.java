...
import com.pulumi.googlenative.run.v2.ServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:run/v2:ServiceIamPolicy")
public class ServiceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ServiceIamPolicy(String name, ServiceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v2:ServiceIamPolicy", name, args == null ? ServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v2:ServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
