 ...
 * 
 */
public final class GoogleCloudRunV2SecretKeySelectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GoogleCloudRunV2SecretKeySelectorArgs Empty = new GoogleCloudRunV2SecretKeySelectorArgs();
    ...
    private GoogleCloudRunV2SecretKeySelectorArgs() {}

    private GoogleCloudRunV2SecretKeySelectorArgs(GoogleCloudRunV2SecretKeySelectorArgs $) {
        this.secret = $.secret;
    ...
    public static Builder builder(GoogleCloudRunV2SecretKeySelectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudRunV2SecretKeySelectorArgs();
        }

        public Builder(GoogleCloudRunV2SecretKeySelectorArgs defaults) {
            $ = new GoogleCloudRunV2SecretKeySelectorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GoogleCloudRunV2SecretKeySelectorArgs build() {
