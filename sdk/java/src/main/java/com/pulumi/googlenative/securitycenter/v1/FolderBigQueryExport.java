...
import com.pulumi.googlenative.securitycenter.v1.FolderBigQueryExportArgs;
 ...
 * 
 */
@ResourceType(type="google-native:securitycenter/v1:FolderBigQueryExport")
public class FolderBigQueryExport extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public FolderBigQueryExport(String name) {
        this(name, FolderBigQueryExportArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FolderBigQueryExport(String name, FolderBigQueryExportArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1:FolderBigQueryExport", name, args == null ? FolderBigQueryExportArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FolderBigQueryExport(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1:FolderBigQueryExport", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static FolderBigQueryExport get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new FolderBigQueryExport(name, id, options);
    }
}
