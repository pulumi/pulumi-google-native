...
import com.pulumi.googlenative.securitycenter.v1.ProjectBigQueryExportArgs;
 ...
 * 
 */
@ResourceType(type="google-native:securitycenter/v1:ProjectBigQueryExport")
public class ProjectBigQueryExport extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ProjectBigQueryExport(String name) {
        this(name, ProjectBigQueryExportArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProjectBigQueryExport(String name, ProjectBigQueryExportArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectBigQueryExport(String name, ProjectBigQueryExportArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1:ProjectBigQueryExport", name, args == null ? ProjectBigQueryExportArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ProjectBigQueryExport(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1:ProjectBigQueryExport", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ProjectBigQueryExport get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
