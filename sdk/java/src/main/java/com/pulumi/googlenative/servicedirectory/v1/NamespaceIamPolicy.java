...
import com.pulumi.googlenative.servicedirectory.v1.NamespaceIamPolicyArgs;
...
public class NamespaceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private NamespaceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NamespaceIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
