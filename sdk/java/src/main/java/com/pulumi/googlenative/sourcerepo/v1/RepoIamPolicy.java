...
import com.pulumi.googlenative.sourcerepo.v1.RepoIamPolicyArgs;
...
public class RepoIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public RepoIamPolicy(String name, RepoIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private RepoIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RepoIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
