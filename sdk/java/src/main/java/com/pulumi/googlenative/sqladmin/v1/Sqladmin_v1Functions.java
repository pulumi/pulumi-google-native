...
import com.pulumi.googlenative.sqladmin.v1.inputs.GetBackupRunArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetBackupRunPlainArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetDatabaseArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetDatabasePlainArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetInstanceArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetInstancePlainArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetSslCertArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetSslCertPlainArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetUserArgs;
import com.pulumi.googlenative.sqladmin.v1.inputs.GetUserPlainArgs;
import com.pulumi.googlenative.sqladmin.v1.outputs.GetBackupRunResult;
import com.pulumi.googlenative.sqladmin.v1.outputs.GetDatabaseResult;
import com.pulumi.googlenative.sqladmin.v1.outputs.GetInstanceResult;
import com.pulumi.googlenative.sqladmin.v1.outputs.GetSslCertResult;
import com.pulumi.googlenative.sqladmin.v1.outputs.GetUserResult;
...
public final class Sqladmin_v1Functions {
    ...
    public static Output<GetUserResult> getUser(GetUserArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:sqladmin/v1:getUser", TypeShape.of(GetUserResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Retrieves a resource containing information about a user.
     * 
    ...
    public static CompletableFuture<GetUserResult> getUserPlain(GetUserPlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("google-native:sqladmin/v1:getUser", TypeShape.of(GetUserResult.class), args, Utilities.withVersion(options));
    }
}
