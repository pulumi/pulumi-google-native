...
import com.pulumi.googlenative.sqladmin.v1beta4.UserArgs;
 ...
 * 
 */
@ResourceType(type="google-native:sqladmin/v1beta4:User")
public class User extends com.pulumi.resources.CustomResource {
    ...
    public User(String name, UserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:sqladmin/v1beta4:User", name, args == null ? UserArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private User(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:sqladmin/v1beta4:User", name, null, makeResourceOptions(options, id));
    }
