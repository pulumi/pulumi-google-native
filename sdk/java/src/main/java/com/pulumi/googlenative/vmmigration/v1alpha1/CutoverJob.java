...
import com.pulumi.googlenative.vmmigration.v1alpha1.CutoverJobArgs;
...
public class CutoverJob extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="steps", type=List.class, parameters={CutoverStepResponse.class})
    private Output<List<CutoverStepResponse>> steps;

    /**
     * @return The cutover steps list representing its progress.
     * 
     */
    public Output<List<CutoverStepResponse>> steps() {
        return this.steps;
    }
    /**
