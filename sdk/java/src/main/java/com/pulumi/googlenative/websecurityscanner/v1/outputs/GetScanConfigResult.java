...
public final class GetScanConfigResult {
    ...
    public static final class Builder {
        ...
        public GetScanConfigResult build() {
            ...
            o.exportToSecurityCommandCenter = exportToSecurityCommandCenter;
            o.ignoreHttpStatusErrors = ignoreHttpStatusErrors;
            o.managedScan = managedScan;
            o.maxQps = maxQps;
            o.name = name;
            o.riskLevel = riskLevel;
            o.schedule = schedule;
            o.startingUrls = startingUrls;
            o.staticIpScan = staticIpScan;
