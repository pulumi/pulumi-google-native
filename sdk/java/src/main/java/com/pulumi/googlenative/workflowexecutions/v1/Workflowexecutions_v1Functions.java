...
import com.pulumi.googlenative.workflowexecutions.v1.inputs.GetExecutionArgs;
import com.pulumi.googlenative.workflowexecutions.v1.inputs.GetExecutionPlainArgs;
import com.pulumi.googlenative.workflowexecutions.v1.outputs.GetExecutionResult;
...
public final class Workflowexecutions_v1Functions {
    ...
    public static Output<GetExecutionResult> getExecution(GetExecutionArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:workflowexecutions/v1:getExecution", TypeShape.of(GetExecutionResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Returns an execution of the given name.
     * 
