...
export class Endpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1:Endpoint';
     ...
     */
    public /*out*/ readonly deployedModels!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1DeployedModelResponse[]>;
    /**
     ...
     */
    public readonly predictRequestResponseLoggingConfig!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponse>;
    public readonly project!: pulumi.Output<string>;
    /**
     * A map from a DeployedModel's ID to the percentage of this Endpoint's traffic that should be forwarded to that DeployedModel. If a DeployedModel's ID is not listed in this map, then it receives no traffic. The traffic percentage values must add up to 100, or map must be empty if the Endpoint is to not accept any traffic at a moment.
     */
    public readonly trafficSplit!: pulumi.Output<{[key: string]: string}>;
    /**
...
export interface EndpointArgs {
     ...
     * Configures the request-response logging for online prediction.
     */
    predictRequestResponseLoggingConfig?: pulumi.Input<inputs.aiplatform.v1.GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigArgs>;
    project?: pulumi.Input<string>;
    /**
     * A map from a DeployedModel's ID to the percentage of this Endpoint's traffic that should be forwarded to that DeployedModel. If a DeployedModel's ID is not listed in this map, then it receives no traffic. The traffic percentage values must add up to 100, or map must be empty if the Endpoint is to not accept any traffic at a moment.
     */
    trafficSplit?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
}
