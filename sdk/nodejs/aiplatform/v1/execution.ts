...
export class Execution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1:Execution';
     ...
     */
    public readonly executionId!: pulumi.Output<string | undefined>;
    /**
...
export interface ExecutionArgs {
     ...
     * The state of this Execution. This is a property of the Execution, and does not imply or capture any ongoing process. This property is managed by clients (such as Vertex AI Pipelines) and the system does not prescribe or check the validity of state transitions.
     */
    state?: pulumi.Input<enums.aiplatform.v1.ExecutionState>;
}
