...
export function getDataLabelingJob(args: GetDataLabelingJobArgs, opts?: pulumi.InvokeOptions): Promise<GetDataLabelingJobResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1:getDataLabelingJob", {
...
export interface GetDataLabelingJobResult {
     ...
     */
    readonly activeLearningConfig: outputs.aiplatform.v1.GoogleCloudAiplatformV1ActiveLearningConfigResponse;
    /**
     ...
     */
    readonly currentSpend: outputs.aiplatform.v1.GoogleTypeMoneyResponse;
    /**
