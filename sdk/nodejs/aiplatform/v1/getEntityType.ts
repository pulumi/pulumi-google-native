...
export function getEntityType(args: GetEntityTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetEntityTypeResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1:getEntityType", {
...
export interface GetEntityTypeResult {
     ...
     */
    readonly monitoringConfig: outputs.aiplatform.v1.GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse;
    /**
