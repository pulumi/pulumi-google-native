...
export function getIndex(args: GetIndexArgs, opts?: pulumi.InvokeOptions): Promise<GetIndexResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1:getIndex", {
...
export interface GetIndexResult {
     ...
     */
    readonly deployedIndexes: outputs.aiplatform.v1.GoogleCloudAiplatformV1DeployedIndexRefResponse[];
    /**
     ...
     */
    readonly indexStats: outputs.aiplatform.v1.GoogleCloudAiplatformV1IndexStatsResponse;
    /**
