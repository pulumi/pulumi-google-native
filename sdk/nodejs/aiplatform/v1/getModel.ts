...
export function getModel(args: GetModelArgs, opts?: pulumi.InvokeOptions): Promise<GetModelResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1:getModel", {
...
export interface GetModelResult {
     ...
     */
    readonly baseModelSource: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelBaseModelSourceResponse;
    /**
     ...
     */
    readonly containerSpec: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelContainerSpecResponse;
    /**
     ...
     */
    readonly dataStats: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelDataStatsResponse;
    /**
     ...
     */
    readonly deployedModels: outputs.aiplatform.v1.GoogleCloudAiplatformV1DeployedModelRefResponse[];
    /**
     ...
     */
    readonly modelSourceInfo: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelSourceInfoResponse;
    /**
     ...
     */
    readonly originalModelInfo: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelOriginalModelInfoResponse;
    /**
     * Optional. This field is populated if the model is produced by a pipeline job.
     */
    readonly pipelineJob: string;
    /**
     * The schemata that describe formats of the Model's predictions and explanations as given and returned via PredictionService.Predict and PredictionService.Explain.
     */
    readonly predictSchemata: outputs.aiplatform.v1.GoogleCloudAiplatformV1PredictSchemataResponse;
    /**
     ...
     */
    readonly supportedExportFormats: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelExportFormatResponse[];
    /**
