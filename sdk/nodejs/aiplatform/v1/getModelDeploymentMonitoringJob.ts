...
export function getModelDeploymentMonitoringJob(args: GetModelDeploymentMonitoringJobArgs, opts?: pulumi.InvokeOptions): Promise<GetModelDeploymentMonitoringJobResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1:getModelDeploymentMonitoringJob", {
...
export interface GetModelDeploymentMonitoringJobResult {
     ...
     */
    readonly bigqueryTables: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse[];
    /**
     ...
     */
    readonly latestMonitoringPipelineMetadata: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse;
    /**
     ...
     */
    readonly loggingSamplingStrategy: outputs.aiplatform.v1.GoogleCloudAiplatformV1SamplingStrategyResponse;
    /**
     ...
     */
    readonly modelDeploymentMonitoringObjectiveConfigs: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse[];
    /**
     * Schedule config for running the monitoring job.
     */
    readonly modelDeploymentMonitoringScheduleConfig: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse;
    /**
     * Alert config for model monitoring.
     */
    readonly modelMonitoringAlertConfig: outputs.aiplatform.v1.GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse;
    /**
     ...
     */
    readonly statsAnomaliesBaseDirectory: outputs.aiplatform.v1.GoogleCloudAiplatformV1GcsDestinationResponse;
    /**
