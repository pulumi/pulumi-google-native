...
export function getNotebookRuntimeTemplate(args: GetNotebookRuntimeTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetNotebookRuntimeTemplateResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1:getNotebookRuntimeTemplate", {
...
export interface GetNotebookRuntimeTemplateResult {
     ...
     */
    readonly dataPersistentDiskSpec: outputs.aiplatform.v1.GoogleCloudAiplatformV1PersistentDiskSpecResponse;
    /**
     ...
     */
    readonly eucConfig: outputs.aiplatform.v1.GoogleCloudAiplatformV1NotebookEucConfigResponse;
    /**
     * The idle shutdown configuration of NotebookRuntimeTemplate. This config will only be set when idle shutdown is enabled.
     */
    readonly idleShutdownConfig: outputs.aiplatform.v1.GoogleCloudAiplatformV1NotebookIdleShutdownConfigResponse;
    /**
     ...
     */
    readonly machineSpec: outputs.aiplatform.v1.GoogleCloudAiplatformV1MachineSpecResponse;
    /**
