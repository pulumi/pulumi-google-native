...
export function getPipelineJob(args: GetPipelineJobArgs, opts?: pulumi.InvokeOptions): Promise<GetPipelineJobResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1:getPipelineJob", {
...
export interface GetPipelineJobResult {
     ...
     */
    readonly jobDetail: outputs.aiplatform.v1.GoogleCloudAiplatformV1PipelineJobDetailResponse;
    /**
     ...
     */
    readonly runtimeConfig: outputs.aiplatform.v1.GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse;
    /**
     ...
     */
    readonly templateMetadata: outputs.aiplatform.v1.GoogleCloudAiplatformV1PipelineTemplateMetadataResponse;
    /**
