...
export function getSchedule(args: GetScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduleResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1:getSchedule", {
...
export interface GetScheduleResult {
     ...
     */
    readonly createPipelineJobRequest: outputs.aiplatform.v1.GoogleCloudAiplatformV1CreatePipelineJobRequestResponse;
    /**
     ...
     */
    readonly lastScheduledRunResponse: outputs.aiplatform.v1.GoogleCloudAiplatformV1ScheduleRunResponseResponse;
    /**
