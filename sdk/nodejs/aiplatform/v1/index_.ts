...
export class Index extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1:Index';
     ...
     */
    public /*out*/ readonly deployedIndexes!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1DeployedIndexRefResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly indexStats!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1IndexStatsResponse>;
    /**
...
export interface IndexArgs {
     ...
     * Immutable. The update method to use with this Index. If not set, BATCH_UPDATE will be used by default.
     */
    indexUpdateMethod?: pulumi.Input<enums.aiplatform.v1.IndexIndexUpdateMethod>;
    /**
     * The labels with user-defined metadata to organize your Indexes. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels.
     */
