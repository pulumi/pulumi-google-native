...
export class MetadataStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1:MetadataStore';
     ...
     */
    public /*out*/ readonly state!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1MetadataStoreMetadataStoreStateResponse>;
    /**
