...
export class PipelineJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1:PipelineJob';
     ...
     */
    public /*out*/ readonly jobDetail!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1PipelineJobDetailResponse>;
    /**
     ...
     */
    public readonly runtimeConfig!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse>;
    /**
     ...
     */
    public /*out*/ readonly templateMetadata!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1PipelineTemplateMetadataResponse>;
    /**
...
export interface PipelineJobArgs {
     ...
     * Runtime config of the pipeline.
     */
    runtimeConfig?: pulumi.Input<inputs.aiplatform.v1.GoogleCloudAiplatformV1PipelineJobRuntimeConfigArgs>;
    /**
     * The service account that the pipeline workload runs as. If not specified, the Compute Engine default service account in the project will be used. See https://cloud.google.com/compute/docs/access/service-accounts#default_service_account Users starting the pipeline must have the `iam.serviceAccounts.actAs` permission on this service account.
     */
