...
export class TimeSeries extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1:TimeSeries';
     ...
     */
    public /*out*/ readonly metadata!: pulumi.Output<outputs.aiplatform.v1.GoogleCloudAiplatformV1TensorboardTimeSeriesMetadataResponse>;
    /**
...
export interface TimeSeriesArgs {
     ...
     * Immutable. Type of TensorboardTimeSeries value.
     */
    valueType: pulumi.Input<enums.aiplatform.v1.TimeSeriesValueType>;
}
