...
export class CustomJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1beta1:CustomJob';
     ...
     * Job spec.
     */
    public readonly jobSpec!: pulumi.Output<outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CustomJobSpecResponse>;
    /**
...
export interface CustomJobArgs {
     ...
     * Job spec.
     */
    jobSpec: pulumi.Input<inputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CustomJobSpecArgs>;
    /**
     * The labels with user-defined metadata to organize CustomJobs. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels.
     */
