...
export class Dataset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1beta1:Dataset';
     ...
     */
    public readonly savedQueries!: pulumi.Output<outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1SavedQueryResponse[]>;
    /**
...
export interface DatasetArgs {
     ...
     * All SavedQueries belong to the Dataset will be returned in List/Get Dataset response. The annotation_specs field will not be populated except for UI cases which will only use annotation_spec_count. In CreateDataset request, a SavedQuery is created together if this field is set, up to one SavedQuery can be set in CreateDatasetRequest. The SavedQuery should not contain any AnnotationSpec.
     */
    savedQueries?: pulumi.Input<pulumi.Input<inputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1SavedQueryArgs>[]>;
}
