...
export function getBatchPredictionJob(args: GetBatchPredictionJobArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchPredictionJobResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getBatchPredictionJob", {
...
export interface GetBatchPredictionJobResult {
     ...
     */
    readonly completionStats: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CompletionStatsResponse;
    /**
     ...
     */
    readonly dedicatedResources: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1BatchDedicatedResourcesResponse;
    /**
     ...
     */
    readonly inputConfig: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfigResponse;
    /**
     * Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
     */
    readonly instanceConfig: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse;
    /**
     ...
     */
    readonly manualBatchTuningParameters: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1ManualBatchTuningParametersResponse;
    /**
     ...
     */
    readonly modelMonitoringConfig: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse;
    /**
     * Get batch prediction job monitoring statistics.
     */
    readonly modelMonitoringStatsAnomalies: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesResponse[];
    /**
     * The running status of the model monitoring pipeline.
     */
    readonly modelMonitoringStatus: outputs.aiplatform.v1beta1.GoogleRpcStatusResponse;
    /**
     ...
     */
    readonly outputConfig: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse;
    /**
     * Information further describing the output of this job.
     */
    readonly outputInfo: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1BatchPredictionJobOutputInfoResponse;
    /**
     ...
     */
    readonly partialFailures: outputs.aiplatform.v1beta1.GoogleRpcStatusResponse[];
    /**
     ...
     */
    readonly resourcesConsumed: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1ResourcesConsumedResponse;
    /**
     ...
     */
    readonly unmanagedContainerModel: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1UnmanagedContainerModelResponse;
    /**
