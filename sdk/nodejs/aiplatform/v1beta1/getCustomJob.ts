...
export function getCustomJob(args: GetCustomJobArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomJobResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getCustomJob", {
...
export interface GetCustomJobResult {
     ...
     * Job spec.
     */
    readonly jobSpec: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CustomJobSpecResponse;
    /**
