...
export function getDataset(args: GetDatasetArgs, opts?: pulumi.InvokeOptions): Promise<GetDatasetResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getDataset", {
...
export interface GetDatasetResult {
     ...
     */
    readonly savedQueries: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1SavedQueryResponse[];
    /**
