...
export function getEndpoint(args: GetEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetEndpointResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getEndpoint", {
...
export interface GetEndpointResult {
     ...
     */
    readonly deployedModels: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1DeployedModelResponse[];
    /**
     ...
     */
    readonly predictRequestResponseLoggingConfig: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse;
    /**
