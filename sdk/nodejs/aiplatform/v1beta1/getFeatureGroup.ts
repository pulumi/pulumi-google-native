...
export function getFeatureGroup(args: GetFeatureGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFeatureGroupResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getFeatureGroup", {
...
export interface GetFeatureGroupResult {
     ...
     */
    readonly bigQuery: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1FeatureGroupBigQueryResponse;
    /**
