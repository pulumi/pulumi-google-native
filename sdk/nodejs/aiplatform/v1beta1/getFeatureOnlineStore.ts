...
export function getFeatureOnlineStore(args: GetFeatureOnlineStoreArgs, opts?: pulumi.InvokeOptions): Promise<GetFeatureOnlineStoreResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getFeatureOnlineStore", {
...
export interface GetFeatureOnlineStoreResult {
     ...
     */
    readonly bigtable: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableResponse;
    /**
     ...
     */
    readonly optimized: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1FeatureOnlineStoreOptimizedResponse;
    /**
