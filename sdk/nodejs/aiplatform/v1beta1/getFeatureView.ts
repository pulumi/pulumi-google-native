...
export function getFeatureView(args: GetFeatureViewArgs, opts?: pulumi.InvokeOptions): Promise<GetFeatureViewResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getFeatureView", {
...
export interface GetFeatureViewResult {
     ...
     */
    readonly bigQuerySource: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceResponse;
    /**
     ...
     */
    readonly syncConfig: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1FeatureViewSyncConfigResponse;
    /**
