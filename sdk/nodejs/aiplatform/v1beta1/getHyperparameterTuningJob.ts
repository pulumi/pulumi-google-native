...
export function getHyperparameterTuningJob(args: GetHyperparameterTuningJobArgs, opts?: pulumi.InvokeOptions): Promise<GetHyperparameterTuningJobResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getHyperparameterTuningJob", {
...
export interface GetHyperparameterTuningJobResult {
     ...
     */
    readonly trialJobSpec: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CustomJobSpecResponse;
    /**
     * Trials of the HyperparameterTuningJob.
     */
    readonly trials: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1TrialResponse[];
    /**
