...
export function getIndexEndpoint(args: GetIndexEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetIndexEndpointResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getIndexEndpoint", {
...
export interface GetIndexEndpointResult {
     ...
     */
    readonly deployedIndexes: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1DeployedIndexResponse[];
    /**
     ...
     */
    readonly privateServiceConnectConfig: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigResponse;
    /**
