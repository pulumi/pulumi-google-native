...
export function getMetadataStore(args: GetMetadataStoreArgs, opts?: pulumi.InvokeOptions): Promise<GetMetadataStoreResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getMetadataStore", {
...
export interface GetMetadataStoreResult {
     ...
     */
    readonly state: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1MetadataStoreMetadataStoreStateResponse;
    /**
