...
export function getNasJob(args: GetNasJobArgs, opts?: pulumi.InvokeOptions): Promise<GetNasJobResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getNasJob", {
...
export interface GetNasJobResult {
     ...
     */
    readonly nasJobOutput: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1NasJobOutputResponse;
    /**
     * The specification of a NasJob.
     */
    readonly nasJobSpec: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1NasJobSpecResponse;
    /**
