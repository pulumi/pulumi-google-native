...
export function getTimeSeries(args: GetTimeSeriesArgs, opts?: pulumi.InvokeOptions): Promise<GetTimeSeriesResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getTimeSeries", {
...
export interface GetTimeSeriesResult {
     ...
     */
    readonly metadata: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1TensorboardTimeSeriesMetadataResponse;
    /**
