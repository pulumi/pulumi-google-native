...
export function getTrainingPipeline(args: GetTrainingPipelineArgs, opts?: pulumi.InvokeOptions): Promise<GetTrainingPipelineResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getTrainingPipeline", {
...
export interface GetTrainingPipelineResult {
     ...
     */
    readonly inputDataConfig: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1InputDataConfigResponse;
    /**
     ...
     */
    readonly modelToUpload: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1ModelResponse;
    /**
