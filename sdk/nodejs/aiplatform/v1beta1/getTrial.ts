...
export function getTrial(args: GetTrialArgs, opts?: pulumi.InvokeOptions): Promise<GetTrialResult> {
    ...
    return pulumi.runtime.invoke("google-native:aiplatform/v1beta1:getTrial", {
...
export interface GetTrialResult {
     ...
     */
    readonly finalMeasurement: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1MeasurementResponse;
    /**
     ...
     */
    readonly measurements: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1MeasurementResponse[];
    /**
     ...
     */
    readonly parameters: outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1TrialParameterResponse[];
    /**
