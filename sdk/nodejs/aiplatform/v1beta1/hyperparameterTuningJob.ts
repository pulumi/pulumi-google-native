...
export class HyperparameterTuningJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1beta1:HyperparameterTuningJob';
     ...
     */
    public readonly studySpec!: pulumi.Output<outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1StudySpecResponse>;
    /**
     * The spec of a trial job. The same spec applies to the CustomJobs created in all the trials.
     */
    public readonly trialJobSpec!: pulumi.Output<outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CustomJobSpecResponse>;
    /**
     * Trials of the HyperparameterTuningJob.
     */
    public /*out*/ readonly trials!: pulumi.Output<outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1TrialResponse[]>;
    /**
...
export interface HyperparameterTuningJobArgs {
     ...
     * Study configuration of the HyperparameterTuningJob.
     */
    studySpec: pulumi.Input<inputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1StudySpecArgs>;
    /**
     * The spec of a trial job. The same spec applies to the CustomJobs created in all the trials.
     */
    trialJobSpec: pulumi.Input<inputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CustomJobSpecArgs>;
}
