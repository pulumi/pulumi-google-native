...
export class Schedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:aiplatform/v1beta1:Schedule';
     ...
     */
    public readonly createPipelineJobRequest!: pulumi.Output<outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CreatePipelineJobRequestResponse>;
    /**
     ...
     */
    public /*out*/ readonly lastScheduledRunResponse!: pulumi.Output<outputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1ScheduleRunResponseResponse>;
...
export interface ScheduleArgs {
     ...
     * Request for PipelineService.CreatePipelineJob. CreatePipelineJobRequest.parent field is required (format: projects/{project}/locations/{location}).
     */
    createPipelineJobRequest?: pulumi.Input<inputs.aiplatform.v1beta1.GoogleCloudAiplatformV1beta1CreatePipelineJobRequestArgs>;
    /**
     * Cron schedule (https://en.wikipedia.org/wiki/Cron) to launch scheduled runs. To explicitly set a timezone to the cron tab, apply a prefix in the cron tab: "CRON_TZ=${IANA_TIME_ZONE}" or "TZ=${IANA_TIME_ZONE}". The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, "CRON_TZ=America/New_York 1 * * * *", or "TZ=America/New_York 1 * * * *".
     */
