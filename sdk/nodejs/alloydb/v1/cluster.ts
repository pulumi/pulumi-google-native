...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:alloydb/v1:Cluster';
     ...
     */
    public readonly automatedBackupPolicy!: pulumi.Output<outputs.alloydb.v1.AutomatedBackupPolicyResponse>;
    /**
     * Cluster created from backup.
     */
    public /*out*/ readonly backupSource!: pulumi.Output<outputs.alloydb.v1.BackupSourceResponse>;
    /**
     ...
     */
    public readonly continuousBackupConfig!: pulumi.Output<outputs.alloydb.v1.ContinuousBackupConfigResponse>;
    /**
     * Continuous backup properties for this cluster.
     */
    public /*out*/ readonly continuousBackupInfo!: pulumi.Output<outputs.alloydb.v1.ContinuousBackupInfoResponse>;
    /**
     * Create time stamp
     */
     ...
     */
    public readonly initialUser!: pulumi.Output<outputs.alloydb.v1.UserPasswordResponse>;
    /**
     ...
     */
    public /*out*/ readonly migrationSource!: pulumi.Output<outputs.alloydb.v1.MigrationSourceResponse>;
    /**
    ...
    public readonly networkConfig!: pulumi.Output<outputs.alloydb.v1.NetworkConfigResponse>;
    /**
     * Cross Region replication config specific to PRIMARY cluster.
     */
    public /*out*/ readonly primaryConfig!: pulumi.Output<outputs.alloydb.v1.PrimaryConfigResponse>;
     ...
     */
    public readonly secondaryConfig!: pulumi.Output<outputs.alloydb.v1.SecondaryConfigResponse>;
    /**
     * SSL configuration for this AlloyDB cluster.
     */
    public readonly sslConfig!: pulumi.Output<outputs.alloydb.v1.SslConfigResponse>;
    /**
...
export interface ClusterArgs {
     ...
     * The automated backup policy for this cluster. If no policy is provided then the default policy will be used. If backups are supported for the cluster, the default policy takes one backup a day, has a backup window of 1 hour, and retains backups for 14 days. For more information on the defaults, consult the documentation for the message type.
     */
    automatedBackupPolicy?: pulumi.Input<inputs.alloydb.v1.AutomatedBackupPolicyArgs>;
    /**
     * Required. ID of the requesting object.
     */
     ...
     * Optional. Continuous backup configuration for this cluster.
     */
    continuousBackupConfig?: pulumi.Input<inputs.alloydb.v1.ContinuousBackupConfigArgs>;
    /**
     * Optional. The database engine major version. This is an optional field and it is populated at the Cluster creation time. If a database version is not supplied at cluster creation time, then a default database version will be used.
     */
    databaseVersion?: pulumi.Input<enums.alloydb.v1.ClusterDatabaseVersion>;
    /**
     * User-settable and human-readable display name for the Cluster.
     */
     ...
     * Input only. Initial user to setup during cluster creation. Required. If used in `RestoreCluster` this is ignored.
     */
    initialUser?: pulumi.Input<inputs.alloydb.v1.UserPasswordArgs>;
    /**
     * Labels as key value pairs
     */
    ...
    networkConfig?: pulumi.Input<inputs.alloydb.v1.NetworkConfigArgs>;
     ...
     * Cross Region replication config specific to SECONDARY cluster.
     */
    secondaryConfig?: pulumi.Input<inputs.alloydb.v1.SecondaryConfigArgs>;
    /**
     * SSL configuration for this AlloyDB cluster.
     */
    sslConfig?: pulumi.Input<inputs.alloydb.v1.SslConfigArgs>;
}
