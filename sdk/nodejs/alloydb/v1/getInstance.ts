...
export function getInstance(args: GetInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceResult> {
    ...
    return pulumi.runtime.invoke("google-native:alloydb/v1:getInstance", {
...
export interface GetInstanceResult {
     ...
     */
    readonly clientConnectionConfig: outputs.alloydb.v1.ClientConnectionConfigResponse;
    /**
     * Create time stamp
     */
     ...
     */
    readonly machineConfig: outputs.alloydb.v1.MachineConfigResponse;
    /**
     ...
     */
    readonly networkConfig: outputs.alloydb.v1.InstanceNetworkConfigResponse;
    /**
     * List of available read-only VMs in this instance, including the standby for a PRIMARY instance.
     */
    readonly nodes: outputs.alloydb.v1.NodeResponse[];
    /**
     ...
     */
    readonly queryInsightsConfig: outputs.alloydb.v1.QueryInsightsInstanceConfigResponse;
    /**
     * Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
     */
    readonly readPoolConfig: outputs.alloydb.v1.ReadPoolConfigResponse;
    /**
     ...
     */
    readonly writableNode: outputs.alloydb.v1.NodeResponse;
}
/**
 * Gets details of a single Instance.
 */
