...
// Export enums:
export * from "../../types/enums/alloydb/v1";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:alloydb/v1:Backup":
                return new Backup(name, <any>undefined, { urn })
            case "google-native:alloydb/v1:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "google-native:alloydb/v1:Instance":
                return new Instance(name, <any>undefined, { urn })
            case "google-native:alloydb/v1:User":
...
pulumi.runtime.registerResourceModule("google-native", "alloydb/v1", _module)
