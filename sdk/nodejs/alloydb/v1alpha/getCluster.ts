...
export function getCluster(args: GetClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterResult> {
    ...
    return pulumi.runtime.invoke("google-native:alloydb/v1alpha:getCluster", {
...
export interface GetClusterResult {
     ...
     */
    readonly automatedBackupPolicy: outputs.alloydb.v1alpha.AutomatedBackupPolicyResponse;
    /**
     * Cluster created from backup.
     */
    readonly backupSource: outputs.alloydb.v1alpha.BackupSourceResponse;
    /**
     ...
     */
    readonly continuousBackupConfig: outputs.alloydb.v1alpha.ContinuousBackupConfigResponse;
    /**
     * Continuous backup properties for this cluster.
     */
    readonly continuousBackupInfo: outputs.alloydb.v1alpha.ContinuousBackupInfoResponse;
    /**
     * Create time stamp
     */
     ...
     */
    readonly encryptionConfig: outputs.alloydb.v1alpha.EncryptionConfigResponse;
    /**
     * The encryption information for the cluster.
     */
    readonly encryptionInfo: outputs.alloydb.v1alpha.EncryptionInfoResponse;
    /**
     ...
     */
    readonly geminiConfig: outputs.alloydb.v1alpha.GeminiClusterConfigResponse;
    /**
     * Input only. Initial user to setup during cluster creation. Required. If used in `RestoreCluster` this is ignored.
     */
    readonly initialUser: outputs.alloydb.v1alpha.UserPasswordResponse;
    /**
     ...
     */
    readonly maintenanceSchedule: outputs.alloydb.v1alpha.MaintenanceScheduleResponse;
    /**
     * Optional. The maintenance update policy determines when to allow or deny updates.
     */
    readonly maintenanceUpdatePolicy: outputs.alloydb.v1alpha.MaintenanceUpdatePolicyResponse;
    /**
     * Cluster created via DMS migration.
     */
    readonly migrationSource: outputs.alloydb.v1alpha.MigrationSourceResponse;
    /**
    ...
    readonly networkConfig: outputs.alloydb.v1alpha.NetworkConfigResponse;
    /**
     * Cross Region replication config specific to PRIMARY cluster.
     */
    readonly primaryConfig: outputs.alloydb.v1alpha.PrimaryConfigResponse;
    /**
     * Optional. The configuration for Private Service Connect (PSC) for the cluster.
     */
    readonly pscConfig: outputs.alloydb.v1alpha.PscConfigResponse;
    /**
     ...
     */
    readonly secondaryConfig: outputs.alloydb.v1alpha.SecondaryConfigResponse;
    /**
     * SSL configuration for this AlloyDB cluster.
     */
    readonly sslConfig: outputs.alloydb.v1alpha.SslConfigResponse;
    /**
