...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:alloydb/v1beta:Cluster';
     ...
     */
    public readonly automatedBackupPolicy!: pulumi.Output<outputs.alloydb.v1beta.AutomatedBackupPolicyResponse>;
    /**
     * Cluster created from backup.
     */
    public /*out*/ readonly backupSource!: pulumi.Output<outputs.alloydb.v1beta.BackupSourceResponse>;
    /**
     ...
     */
    public readonly continuousBackupConfig!: pulumi.Output<outputs.alloydb.v1beta.ContinuousBackupConfigResponse>;
    /**
     * Continuous backup properties for this cluster.
     */
    public /*out*/ readonly continuousBackupInfo!: pulumi.Output<outputs.alloydb.v1beta.ContinuousBackupInfoResponse>;
    /**
     * Create time stamp
     */
     ...
     */
    public readonly secondaryConfig!: pulumi.Output<outputs.alloydb.v1beta.SecondaryConfigResponse>;
    /**
     * SSL configuration for this AlloyDB cluster.
     */
    public readonly sslConfig!: pulumi.Output<outputs.alloydb.v1beta.SslConfigResponse>;
    /**
...
export interface ClusterArgs {
     ...
     * The automated backup policy for this cluster. If no policy is provided then the default policy will be used. If backups are supported for the cluster, the default policy takes one backup a day, has a backup window of 1 hour, and retains backups for 14 days. For more information on the defaults, consult the documentation for the message type.
     */
    automatedBackupPolicy?: pulumi.Input<inputs.alloydb.v1beta.AutomatedBackupPolicyArgs>;
    /**
     * Required. ID of the requesting object.
     */
     ...
     * Optional. Continuous backup configuration for this cluster.
     */
    continuousBackupConfig?: pulumi.Input<inputs.alloydb.v1beta.ContinuousBackupConfigArgs>;
    /**
     * Optional. The database engine major version. This is an optional field and it is populated at the Cluster creation time. If a database version is not supplied at cluster creation time, then a default database version will be used.
     */
    databaseVersion?: pulumi.Input<enums.alloydb.v1beta.ClusterDatabaseVersion>;
    /**
     * User-settable and human-readable display name for the Cluster.
     */
     ...
     * Cross Region replication config specific to SECONDARY cluster.
     */
    secondaryConfig?: pulumi.Input<inputs.alloydb.v1beta.SecondaryConfigArgs>;
    /**
     * SSL configuration for this AlloyDB cluster.
     */
    sslConfig?: pulumi.Input<inputs.alloydb.v1beta.SslConfigArgs>;
}
