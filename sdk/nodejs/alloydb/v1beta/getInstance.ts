...
export function getInstance(args: GetInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceResult> {
    ...
    return pulumi.runtime.invoke("google-native:alloydb/v1beta:getInstance", {
...
export interface GetInstanceResult {
     ...
     */
    readonly clientConnectionConfig: outputs.alloydb.v1beta.ClientConnectionConfigResponse;
    /**
     * Create time stamp
     */
     ...
     */
    readonly machineConfig: outputs.alloydb.v1beta.MachineConfigResponse;
    /**
     ...
     */
    readonly queryInsightsConfig: outputs.alloydb.v1beta.QueryInsightsInstanceConfigResponse;
    /**
     * Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
     */
    readonly readPoolConfig: outputs.alloydb.v1beta.ReadPoolConfigResponse;
    /**
     ...
     */
    readonly updatePolicy: outputs.alloydb.v1beta.UpdatePolicyResponse;
    /**
     * Update time stamp
     */
     ...
     */
    readonly writableNode: outputs.alloydb.v1beta.NodeResponse;
}
/**
 * Gets details of a single Instance.
 */
