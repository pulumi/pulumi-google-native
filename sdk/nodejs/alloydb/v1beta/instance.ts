...
export class Instance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:alloydb/v1beta:Instance';
     ...
     */
    public readonly clientConnectionConfig!: pulumi.Output<outputs.alloydb.v1beta.ClientConnectionConfigResponse>;
     ...
     */
    public readonly machineConfig!: pulumi.Output<outputs.alloydb.v1beta.MachineConfigResponse>;
    /**
     ...
     */
    public readonly queryInsightsConfig!: pulumi.Output<outputs.alloydb.v1beta.QueryInsightsInstanceConfigResponse>;
    /**
     * Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
     */
    public readonly readPoolConfig!: pulumi.Output<outputs.alloydb.v1beta.ReadPoolConfigResponse>;
    /**
     ...
     */
    public readonly updatePolicy!: pulumi.Output<outputs.alloydb.v1beta.UpdatePolicyResponse>;
    /**
     * Update time stamp
     */
     ...
     */
    public /*out*/ readonly writableNode!: pulumi.Output<outputs.alloydb.v1beta.NodeResponse>;
...
export interface InstanceArgs {
     ...
     * Availability type of an Instance. If empty, defaults to REGIONAL for primary instances. For read pools, availability_type is always UNSPECIFIED. Instances in the read pools are evenly distributed across available zones within the region (i.e. read pools with more than one node will have a node in at least two zones).
     */
    availabilityType?: pulumi.Input<enums.alloydb.v1beta.InstanceAvailabilityType>;
    /**
     * Optional. Client connection specific configurations
     */
    clientConnectionConfig?: pulumi.Input<inputs.alloydb.v1beta.ClientConnectionConfigArgs>;
     ...
     * The type of the instance. Specified at creation time.
     */
    instanceType: pulumi.Input<enums.alloydb.v1beta.InstanceInstanceType>;
    /**
     * Labels as key value pairs
     */
     ...
     * Configuration for query insights.
     */
    queryInsightsConfig?: pulumi.Input<inputs.alloydb.v1beta.QueryInsightsInstanceConfigArgs>;
    /**
     * Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
     */
    readPoolConfig?: pulumi.Input<inputs.alloydb.v1beta.ReadPoolConfigArgs>;
    /**
     * Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     */
     ...
     * Update policy that will be applied during instance update. This field is not persisted when you update the instance. To use a non-default update policy, you must specify explicitly specify the value in each update request.
     */
    updatePolicy?: pulumi.Input<inputs.alloydb.v1beta.UpdatePolicyArgs>;
}
