 ...
 */
export function getAppGroupApp(args: GetAppGroupAppArgs, opts?: pulumi.InvokeOptions): Promise<GetAppGroupAppResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("google-native:apigee/v1:getAppGroupApp", {
        "appId": args.appId,
...
export interface GetAppGroupAppArgs {
    appId: string;
    appgroupId: string;
    organizationId: string;
}

export interface GetAppGroupAppResult {
    /**
 ...
 * Returns the details for an AppGroup app.
 */
export function getAppGroupAppOutput(args: GetAppGroupAppOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAppGroupAppResult> {
    return pulumi.output(args).apply((a: any) => getAppGroupApp(a, opts))
}

export interface GetAppGroupAppOutputArgs {
