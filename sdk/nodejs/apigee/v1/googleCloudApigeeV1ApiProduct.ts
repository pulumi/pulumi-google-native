 ...
 */
export class GoogleCloudApigeeV1ApiProduct extends pulumi.CustomResource {
    /**
     * Get an existing GoogleCloudApigeeV1ApiProduct resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudApigeeV1ApiProduct {
        return new GoogleCloudApigeeV1ApiProduct(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:apigee/v1:GoogleCloudApigeeV1ApiProduct';

    /**
     * Returns true if the given object is an instance of GoogleCloudApigeeV1ApiProduct.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudApigeeV1ApiProduct {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudApigeeV1ApiProduct.__pulumiType;
    }


    /**
     * Create a GoogleCloudApigeeV1ApiProduct resource with the given unique name, arguments, and options.
     *
 ...
 */
export interface GoogleCloudApigeeV1ApiProductArgs {
