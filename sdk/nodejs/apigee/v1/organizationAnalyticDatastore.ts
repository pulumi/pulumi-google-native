 ...
 */
export class OrganizationAnalyticDatastore extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationAnalyticDatastore {
        return new OrganizationAnalyticDatastore(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:apigee/v1:OrganizationAnalyticDatastore';
     ...
     */
    public static isInstance(obj: any): obj is OrganizationAnalyticDatastore {
     ...
     */
    constructor(name: string, args: OrganizationAnalyticDatastoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrganizationAnalyticDatastore.__pulumiType, name, inputs, opts);
    }
}
