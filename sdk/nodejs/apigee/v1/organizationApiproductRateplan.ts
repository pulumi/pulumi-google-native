 ...
 */
export class OrganizationApiproductRateplan extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationApiproductRateplan {
        return new OrganizationApiproductRateplan(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:apigee/v1:OrganizationApiproductRateplan';

    /**
     * Returns true if the given object is an instance of OrganizationApiproductRateplan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OrganizationApiproductRateplan {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OrganizationApiproductRateplan.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: OrganizationApiproductRateplanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrganizationApiproductRateplan.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface OrganizationApiproductRateplanArgs {
    /**
     * Name of the API product that the rate plan is associated with.
     */
