 ...
 */
export class OrganizationDeveloperApp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationDeveloperApp {
        return new OrganizationDeveloperApp(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:apigee/v1:OrganizationDeveloperApp';

    /**
     * Returns true if the given object is an instance of OrganizationDeveloperApp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OrganizationDeveloperApp {
     ...
     */
    constructor(name: string, args: OrganizationDeveloperAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrganizationDeveloperApp.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface OrganizationDeveloperAppArgs {
    /**
