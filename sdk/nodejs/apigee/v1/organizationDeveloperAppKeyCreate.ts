 ...
 */
export class OrganizationDeveloperAppKeyCreate extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationDeveloperAppKeyCreate {
        return new OrganizationDeveloperAppKeyCreate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:apigee/v1:OrganizationDeveloperAppKeyCreate';

    /**
     * Returns true if the given object is an instance of OrganizationDeveloperAppKeyCreate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OrganizationDeveloperAppKeyCreate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OrganizationDeveloperAppKeyCreate.__pulumiType;
    }


    /**
     * Create a OrganizationDeveloperAppKeyCreate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OrganizationDeveloperAppKeyCreateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrganizationDeveloperAppKeyCreate.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface OrganizationDeveloperAppKeyCreateArgs {
    /**
