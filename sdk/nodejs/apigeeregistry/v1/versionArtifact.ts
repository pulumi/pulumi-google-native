 ...
 */
export class VersionArtifact extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VersionArtifact {
        return new VersionArtifact(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:apigeeregistry/v1:VersionArtifact';

    /**
     * Returns true if the given object is an instance of VersionArtifact.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VersionArtifact {
     ...
     */
    constructor(name: string, args: VersionArtifactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["apiId", "artifactId", "location", "project", "versionId"] };
 ...
 */
export interface VersionArtifactArgs {
