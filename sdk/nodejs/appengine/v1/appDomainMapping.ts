...
export class AppDomainMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:appengine/v1:AppDomainMapping';
...
export interface AppDomainMappingArgs {
     ...
     * The resource records required to configure this domain mapping. These records must be added to the domain's DNS configuration in order to serve the application via this domain mapping.@OutputOnly
     */
    readonly resourceRecords?: pulumi.Input<pulumi.Input<inputs.appengine.v1.ResourceRecordArgs>[]>;
    /**
     * SSL configuration for this domain. If unconfigured, this domain will not serve with SSL.
     */
    readonly sslSettings?: pulumi.Input<inputs.appengine.v1.SslSettingsArgs>;
}
