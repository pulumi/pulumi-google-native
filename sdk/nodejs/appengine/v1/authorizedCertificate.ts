...
export class AuthorizedCertificate extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly authorizedCertificateId!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly managedCertificate!: pulumi.Output<outputs.appengine.v1.ManagedCertificateResponse>;
    /**
    ...
    constructor(name: string, args: AuthorizedCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["authorizedCertificateId"] = undefined /*out*/;
