...
export class AppAuthorizedCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:appengine/v1beta:AppAuthorizedCertificate';
...
export interface AppAuthorizedCertificateArgs {
     ...
     * The SSL certificate serving the AuthorizedCertificate resource. This must be obtained independently from a certificate authority.
     */
    readonly certificateRawData?: pulumi.Input<inputs.appengine.v1beta.CertificateRawDataArgs>;
    /**
     * The user-specified display name of the certificate. This is not guaranteed to be unique. Example: My Certificate.
     */
     ...
     * Only applicable if this certificate is managed by App Engine. Managed certificates are tied to the lifecycle of a DomainMapping and cannot be updated or deleted via the AuthorizedCertificates API. If this certificate is manually administered by the user, this field will be empty.@OutputOnly
     */
    readonly managedCertificate?: pulumi.Input<inputs.appengine.v1beta.ManagedCertificateArgs>;
    /**
     * Full path to the AuthorizedCertificate resource in the API. Example: apps/myapp/authorizedCertificates/12345.@OutputOnly
     */
