...
export class AppFirewallIngressRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:appengine/v1beta:AppFirewallIngressRule';
    ...
    constructor(name: string, args: AppFirewallIngressRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.ingressRulesId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'ingressRulesId'");
            }
            inputs["action"] = args ? args.action : undefined;
            inputs["appsId"] = args ? args.appsId : undefined;
            inputs["description"] = args ? args.description : undefined;
            inputs["ingressRulesId"] = args ? args.ingressRulesId : undefined;
...
export interface AppFirewallIngressRuleArgs {
    ...
    readonly ingressRulesId: pulumi.Input<string>;
    /**
     * A positive integer between 1, Int32.MaxValue-1 that defines the order of rule evaluation. Rules with the lowest priority are evaluated first.A default rule at priority Int32.MaxValue matches all IPv4 and IPv6 traffic when no previous rule matches. Only the action of this rule can be modified by the user.
     */
