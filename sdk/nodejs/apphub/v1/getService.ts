...
export function getService(args: GetServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceResult> {
    ...
    return pulumi.runtime.invoke("google-native:apphub/v1:getService", {
...
export interface GetServiceResult {
     ...
     */
    readonly serviceProperties: outputs.apphub.v1.ServicePropertiesResponse;
    /**
     * Reference to an underlying networking resource that can comprise a Service. These are immutable.
     */
    readonly serviceReference: outputs.apphub.v1.ServiceReferenceResponse;
    /**
     * Service state.
     */
