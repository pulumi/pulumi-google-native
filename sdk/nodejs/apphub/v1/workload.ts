...
export class Workload extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:apphub/v1:Workload';
     ...
     */
    public /*out*/ readonly workloadProperties!: pulumi.Output<outputs.apphub.v1.WorkloadPropertiesResponse>;
    /**
     * Reference of an underlying compute resource represented by the Workload. These are immutable.
     */
    public /*out*/ readonly workloadReference!: pulumi.Output<outputs.apphub.v1.WorkloadReferenceResponse>;
