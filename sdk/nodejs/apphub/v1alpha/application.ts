...
export class Application extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:apphub/v1alpha:Application';
     ...
     */
    public readonly scope!: pulumi.Output<outputs.apphub.v1alpha.ScopeResponse>;
    /**
     * Application state.
     */
...
export interface ApplicationArgs {
     ...
     * Immutable. Defines what data can be included into this Application. Limits which Services and Workloads can be registered.
     */
    scope: pulumi.Input<inputs.apphub.v1alpha.ScopeArgs>;
}
