...
// Export enums:
export * from "../../types/enums/apphub/v1alpha";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:apphub/v1alpha:Application":
                return new Application(name, <any>undefined, { urn })
            case "google-native:apphub/v1alpha:ApplicationIamBinding":
                return new ApplicationIamBinding(name, <any>undefined, { urn })
            case "google-native:apphub/v1alpha:ApplicationIamMember":
                return new ApplicationIamMember(name, <any>undefined, { urn })
            case "google-native:apphub/v1alpha:ApplicationIamPolicy":
                return new ApplicationIamPolicy(name, <any>undefined, { urn })
            case "google-native:apphub/v1alpha:Service":
                return new Service(name, <any>undefined, { urn })
            case "google-native:apphub/v1alpha:ServiceProjectAttachment":
                return new ServiceProjectAttachment(name, <any>undefined, { urn })
            case "google-native:apphub/v1alpha:Workload":
...
pulumi.runtime.registerResourceModule("google-native", "apphub/v1alpha", _module)
