...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-cloud:artifactregistry/v1beta1:Repository":
                return new Repository(name, <any>undefined, { urn })
            case "google-cloud:artifactregistry/v1beta1:RepositoryIamPolicy":
                return new RepositoryIamPolicy(name, <any>undefined, { urn })
            case "google-cloud:artifactregistry/v1beta1:RepositoryPackageTag":
...
pulumi.runtime.registerResourceModule("google-cloud", "artifactregistry/v1beta1", _module)
