...
export class RepositoryIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:artifactregistry/v1beta1:RepositoryIamPolicy';
     ...
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.artifactregistry.v1beta1.BindingResponse[]>;
    /**
