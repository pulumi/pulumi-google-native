...
export class RepositoryIamPolicy extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.artifactregistry.v1beta2.BindingResponse[]>;
    /**
...
export interface RepositoryIamPolicyArgs {
     ...
     */
    readonly policy?: pulumi.Input<inputs.artifactregistry.v1beta2.Policy>;
