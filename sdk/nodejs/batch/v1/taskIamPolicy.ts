...
export class TaskIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TaskIamPolicy {
        return new TaskIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:batch/v1:TaskIamPolicy';
    ...
    constructor(name: string, args: TaskIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["location", "project", "taskId"] };
