...
export class AppConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:beyondcorp/v1:AppConnection';
     ...
     */
    public readonly applicationEndpoint!: pulumi.Output<outputs.beyondcorp.v1.GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponse>;
    /**
     ...
     */
    public readonly gateway!: pulumi.Output<outputs.beyondcorp.v1.GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponse>;
    /**
...
export interface AppConnectionArgs {
     ...
     * Address of the remote application endpoint for the BeyondCorp AppConnection.
     */
    applicationEndpoint: pulumi.Input<inputs.beyondcorp.v1.GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointArgs>;
    /**
     * Optional. List of [google.cloud.beyondcorp.v1main.Connector.name] that are authorised to be associated with this AppConnection.
     */
     ...
     * Optional. Gateway used by the AppConnection.
     */
    gateway?: pulumi.Input<inputs.beyondcorp.v1.GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayArgs>;
    /**
     * Optional. Resource labels to represent user provided metadata.
     */
