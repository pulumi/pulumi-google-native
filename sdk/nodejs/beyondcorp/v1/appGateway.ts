...
export class AppGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppGateway {
        return new AppGateway(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:beyondcorp/v1:AppGateway';
     ...
     */
    public /*out*/ readonly allocatedConnections!: pulumi.Output<outputs.beyondcorp.v1.AllocatedConnectionResponse[]>;
    /**
...
export interface AppGatewayArgs {
     ...
     * The type of hosting used by the AppGateway.
     */
    hostType: pulumi.Input<enums.beyondcorp.v1.AppGatewayHostType>;
    /**
     * Optional. Resource labels to represent user provided metadata.
     */
