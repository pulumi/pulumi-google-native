...
export class ClientConnectorService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:beyondcorp/v1alpha:ClientConnectorService';
     ...
     */
    public readonly egress!: pulumi.Output<outputs.beyondcorp.v1alpha.EgressResponse>;
    /**
...
export interface ClientConnectorServiceArgs {
     ...
     * The details of the egress settings.
     */
    egress: pulumi.Input<inputs.beyondcorp.v1alpha.EgressArgs>;
    /**
     * The details of the ingress settings.
     */
    ingress: pulumi.Input<inputs.beyondcorp.v1alpha.IngressArgs>;
