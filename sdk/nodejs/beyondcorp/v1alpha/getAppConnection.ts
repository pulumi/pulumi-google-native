...
export function getAppConnection(args: GetAppConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetAppConnectionResult> {
    ...
    return pulumi.runtime.invoke("google-native:beyondcorp/v1alpha:getAppConnection", {
...
export interface GetAppConnectionResult {
     ...
     */
    readonly applicationEndpoint: outputs.beyondcorp.v1alpha.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponse;
    /**
     ...
     */
    readonly gateway: outputs.beyondcorp.v1alpha.GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse;
    /**
