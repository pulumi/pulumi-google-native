...
export function getAppConnector(args: GetAppConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetAppConnectorResult> {
    ...
    return pulumi.runtime.invoke("google-native:beyondcorp/v1alpha:getAppConnector", {
...
export interface GetAppConnectorResult {
     ...
     */
    readonly principalInfo: outputs.beyondcorp.v1alpha.GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfoResponse;
    /**
     * Optional. Resource info of the connector.
     */
    readonly resourceInfo: outputs.beyondcorp.v1alpha.GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse;
    /**
