...
export function getClientConnectorServiceIamPolicy(args: GetClientConnectorServiceIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetClientConnectorServiceIamPolicyResult> {
    ...
    return pulumi.runtime.invoke("google-native:beyondcorp/v1alpha:getClientConnectorServiceIamPolicy", {
...
export interface GetClientConnectorServiceIamPolicyArgs {
...
export interface GetClientConnectorServiceIamPolicyResult {
    /**
