...
export class ConnectionIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:bigqueryconnection/v1beta1:ConnectionIamPolicy';
     ...
     */
    public /*out*/ readonly auditConfigs!: pulumi.Output<outputs.bigqueryconnection.v1beta1.AuditConfigResponse[]>;
    /**
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.bigqueryconnection.v1beta1.BindingResponse[]>;
    /**
