...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:bigqueryreservation/v1:CapacityCommitment":
                return new CapacityCommitment(name, <any>undefined, { urn })
            case "google-native:bigqueryreservation/v1:Reservation":
...
pulumi.runtime.registerResourceModule("google-native", "bigqueryreservation/v1", _module)
