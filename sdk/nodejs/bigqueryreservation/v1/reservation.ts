...
export class Reservation extends pulumi.CustomResource {
     ...
     */
    public readonly originalPrimaryLocation!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly secondaryLocation!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args?: ReservationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["originalPrimaryLocation"] = args ? args.originalPrimaryLocation : undefined;
