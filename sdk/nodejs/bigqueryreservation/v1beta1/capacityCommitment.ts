...
export class CapacityCommitment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:bigqueryreservation/v1beta1:CapacityCommitment';
...
export interface CapacityCommitmentArgs {
     ...
     */
    readonly failureStatus?: pulumi.Input<inputs.bigqueryreservation.v1beta1.Status>;
