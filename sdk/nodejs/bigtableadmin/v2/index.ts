...
export { GetInstanceTableViewIamPolicyArgs, GetInstanceTableViewIamPolicyResult, GetInstanceTableViewIamPolicyOutputArgs } from "./getInstanceTableViewIamPolicy";
export const getInstanceTableViewIamPolicy: typeof import("./getInstanceTableViewIamPolicy").getInstanceTableViewIamPolicy = null as any;
export const getInstanceTableViewIamPolicyOutput: typeof import("./getInstanceTableViewIamPolicy").getInstanceTableViewIamPolicyOutput = null as any;
utilities.lazyLoad(exports, ["getInstanceTableViewIamPolicy","getInstanceTableViewIamPolicyOutput"], () => require("./getInstanceTableViewIamPolicy"));
...
export { InstanceTableViewIamBindingArgs } from "./instanceTableViewIamBinding";
export type InstanceTableViewIamBinding = import("./instanceTableViewIamBinding").InstanceTableViewIamBinding;
export const InstanceTableViewIamBinding: typeof import("./instanceTableViewIamBinding").InstanceTableViewIamBinding = null as any;
utilities.lazyLoad(exports, ["InstanceTableViewIamBinding"], () => require("./instanceTableViewIamBinding"));

export { InstanceTableViewIamMemberArgs } from "./instanceTableViewIamMember";
export type InstanceTableViewIamMember = import("./instanceTableViewIamMember").InstanceTableViewIamMember;
export const InstanceTableViewIamMember: typeof import("./instanceTableViewIamMember").InstanceTableViewIamMember = null as any;
utilities.lazyLoad(exports, ["InstanceTableViewIamMember"], () => require("./instanceTableViewIamMember"));

export { InstanceTableViewIamPolicyArgs } from "./instanceTableViewIamPolicy";
export type InstanceTableViewIamPolicy = import("./instanceTableViewIamPolicy").InstanceTableViewIamPolicy;
export const InstanceTableViewIamPolicy: typeof import("./instanceTableViewIamPolicy").InstanceTableViewIamPolicy = null as any;
utilities.lazyLoad(exports, ["InstanceTableViewIamPolicy"], () => require("./instanceTableViewIamPolicy"));
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "google-native:bigtableadmin/v2:InstanceTableViewIamBinding":
                return new InstanceTableViewIamBinding(name, <any>undefined, { urn })
            case "google-native:bigtableadmin/v2:InstanceTableViewIamMember":
                return new InstanceTableViewIamMember(name, <any>undefined, { urn })
            case "google-native:bigtableadmin/v2:InstanceTableViewIamPolicy":
                return new InstanceTableViewIamPolicy(name, <any>undefined, { urn })
