...
export class InstanceClusterBackupIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstanceClusterBackupIamPolicy {
        return new InstanceClusterBackupIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:bigtableadmin/v2:InstanceClusterBackupIamPolicy';

    /**
     * Returns true if the given object is an instance of InstanceClusterBackupIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InstanceClusterBackupIamPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === InstanceClusterBackupIamPolicy.__pulumiType;
    }

    /**
     * Specifies cloud audit logging configuration for this policy.
     */
    public /*out*/ readonly auditConfigs!: pulumi.Output<outputs.bigtableadmin.v2.AuditConfigResponse[]>;
    /**
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.bigtableadmin.v2.BindingResponse[]>;
    /**
     ...
     */
    constructor(name: string, args: InstanceClusterBackupIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstanceClusterBackupIamPolicy.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface InstanceClusterBackupIamPolicyArgs {
     ...
     */
    readonly policy?: pulumi.Input<inputs.bigtableadmin.v2.Policy>;
