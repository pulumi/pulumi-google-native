...
// Export enums:
export * from "../../types/enums/billingbudgets/v1";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:billingbudgets/v1:Budget":
...
pulumi.runtime.registerResourceModule("google-native", "billingbudgets/v1", _module)
