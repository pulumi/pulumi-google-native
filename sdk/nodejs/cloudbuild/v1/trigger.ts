...
export class Trigger extends pulumi.CustomResource {
     ...
     */
    public readonly repositoryEventConfig!: pulumi.Output<outputs.cloudbuild.v1.RepositoryEventConfigResponse>;
    /**
    ...
    constructor(name: string, args: TriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["repositoryEventConfig"] = undefined /*out*/;
...
export interface TriggerArgs {
     ...
     * The configuration of a trigger that creates a build whenever an event from Repo API is received.
     */
    repositoryEventConfig?: pulumi.Input<inputs.cloudbuild.v1.RepositoryEventConfigArgs>;
    /**
     * The `Trigger` name with format: `projects/{project}/locations/{location}/triggers/{trigger}`, where {trigger} is a unique identifier generated by the service.
     */
