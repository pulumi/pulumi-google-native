...
export class WorkerPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:cloudbuild/v1alpha1:WorkerPool';
...
export interface WorkerPoolArgs {
     ...
     */
    readonly workerConfig?: pulumi.Input<inputs.cloudbuild.v1alpha1.WorkerConfig>;
    /**
