 ...
 */
export class GoogleCloudChannelV1Customer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudChannelV1Customer {
        return new GoogleCloudChannelV1Customer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:cloudchannel/v1:GoogleCloudChannelV1Customer';

    /**
     * Returns true if the given object is an instance of GoogleCloudChannelV1Customer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudChannelV1Customer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudChannelV1Customer.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: GoogleCloudChannelV1CustomerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GoogleCloudChannelV1Customer.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface GoogleCloudChannelV1CustomerArgs {
    /**
