...
export class CustomTargetTypeIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomTargetTypeIamBinding {
        return new CustomTargetTypeIamBinding(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:clouddeploy/v1:CustomTargetTypeIamBinding';
