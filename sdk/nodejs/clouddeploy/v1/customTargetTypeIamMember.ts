 ...
 */
export class CustomTargetTypeIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomTargetTypeIamMember {
        return new CustomTargetTypeIamMember(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:clouddeploy/v1:CustomTargetTypeIamMember';
     ...
     */
    public static isInstance(obj: any): obj is CustomTargetTypeIamMember {
