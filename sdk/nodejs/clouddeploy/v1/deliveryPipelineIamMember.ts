...
export class DeliveryPipelineIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeliveryPipelineIamMember {
        return new DeliveryPipelineIamMember(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:clouddeploy/v1:DeliveryPipelineIamMember';
