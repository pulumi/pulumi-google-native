...
export class DeliveryPipelineIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:clouddeploy/v1:DeliveryPipelineIamPolicy';
    ...
    constructor(name: string, args: DeliveryPipelineIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DeliveryPipelineIamPolicy.__pulumiType, name, inputs, opts);
    }
}
