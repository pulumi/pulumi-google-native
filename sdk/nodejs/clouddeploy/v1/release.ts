...
export class Release extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly targetArtifacts!: pulumi.Output<outputs.clouddeploy.v1.TargetArtifactResponse>;
    /**
     * Map from target ID to details of the render operation for that target.
     */
    public /*out*/ readonly targetRenders!: pulumi.Output<outputs.clouddeploy.v1.TargetRenderResponse>;
    /**
