...
export class Function extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:cloudfunctions/v2:Function';
     ...
     */
    public readonly eventTrigger!: pulumi.Output<outputs.cloudfunctions.v2.EventTriggerResponse>;
    /**
     ...
     */
    public /*out*/ readonly stateMessages!: pulumi.Output<outputs.cloudfunctions.v2.GoogleCloudFunctionsV2StateMessageResponse[]>;
    /**
...
export interface FunctionArgs {
     ...
     * Describes the Build step of the function that builds a container from the given source.
     */
    buildConfig?: pulumi.Input<inputs.cloudfunctions.v2.BuildConfigArgs>;
    /**
     * User-provided description of a function.
     */
     ...
     * Describe whether the function is gen1 or gen2.
     */
    environment?: pulumi.Input<enums.cloudfunctions.v2.FunctionEnvironment>;
    /**
     * An Eventarc trigger managed by Google Cloud Functions that fires events in response to a condition in another service.
     */
    eventTrigger?: pulumi.Input<inputs.cloudfunctions.v2.EventTriggerArgs>;
    /**
     * The ID to use for the function, which will become the final component of the function's resource name. This value should be 4-63 characters, and valid characters are /a-z-/.
     */
     ...
     * Describes the Service being deployed. Currently deploys services to Cloud Run (fully managed).
     */
    serviceConfig?: pulumi.Input<inputs.cloudfunctions.v2.ServiceConfigArgs>;
}
