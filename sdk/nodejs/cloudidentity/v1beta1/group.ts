...
export class Group extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:cloudidentity/v1beta1:Group';
...
export interface GroupArgs {
     ...
     * Additional entity key aliases for a Group.
     */
    readonly additionalGroupKeys?: pulumi.Input<pulumi.Input<inputs.cloudidentity.v1beta1.EntityKey>[]>;
    /**
     * An extended description to help users determine the purpose of a `Group`. Must not be longer than 4,096 characters.
     */
     ...
     * Optional. Dynamic group metadata like queries and status.
     */
    readonly dynamicGroupMetadata?: pulumi.Input<inputs.cloudidentity.v1beta1.DynamicGroupMetadata>;
    /**
     * Required. Immutable. The `EntityKey` of the `Group`.
     */
    readonly groupKey?: pulumi.Input<inputs.cloudidentity.v1beta1.EntityKey>;
