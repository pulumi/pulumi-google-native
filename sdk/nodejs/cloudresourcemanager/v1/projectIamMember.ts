...
export class ProjectIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProjectIamMember {
        return new ProjectIamMember(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:cloudresourcemanager/v1:ProjectIamMember';
    ...
    constructor(name: string, args: ProjectIamMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
