...
export class OrganizationIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationIamMember {
        return new OrganizationIamMember(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:cloudresourcemanager/v3:OrganizationIamMember';
    ...
    constructor(name: string, args: OrganizationIamMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrganizationIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
