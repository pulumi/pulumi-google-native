...
export class TagKeyIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TagKeyIamPolicy {
        return new TagKeyIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:cloudresourcemanager/v3:TagKeyIamPolicy';
    ...
    public readonly tagKeyId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args: TagKeyIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["tagKeyId"] = args ? args.tagKeyId : undefined;
            ...
            resourceInputs["tagKeyId"] = undefined /*out*/;
