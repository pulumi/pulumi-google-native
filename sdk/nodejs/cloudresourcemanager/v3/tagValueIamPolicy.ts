...
export class TagValueIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:cloudresourcemanager/v3:TagValueIamPolicy';
     ...
     */
    public /*out*/ readonly auditConfigs!: pulumi.Output<outputs.cloudresourcemanager.v3.AuditConfigResponse[]>;
    /**
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.cloudresourcemanager.v3.BindingResponse[]>;
    /**
