...
export function getJob(args: GetJobArgs, opts?: pulumi.InvokeOptions): Promise<GetJobResult> {
    ...
    return pulumi.runtime.invoke("google-native:cloudscheduler/v1:getJob", {
        "jobId": args.jobId,
...
export interface GetJobResult {
     ...
     */
    readonly appEngineHttpTarget: outputs.cloudscheduler.v1.AppEngineHttpTargetResponse;
    /**
     ...
     * HTTP target.
     */
    readonly httpTarget: outputs.cloudscheduler.v1.HttpTargetResponse;
    /**
     ...
     * Pub/Sub target.
     */
    readonly pubsubTarget: outputs.cloudscheduler.v1.PubsubTargetResponse;
    /**
     * Settings that determine the retry behavior.
     */
    readonly retryConfig: outputs.cloudscheduler.v1.RetryConfigResponse;
    /**
     ...
     */
    readonly status: outputs.cloudscheduler.v1.StatusResponse;
    /**
