...
export class Case extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:cloudsupport/v2:Case';
     ...
     */
    public readonly classification!: pulumi.Output<outputs.cloudsupport.v2.CaseClassificationResponse>;
    /**
     ...
     */
    public readonly creator!: pulumi.Output<outputs.cloudsupport.v2.ActorResponse>;
    /**
    ...
    public readonly v2Id!: pulumi.Output<string>;
    public readonly v2Id1!: pulumi.Output<string>;
    ...
    constructor(name: string, args: CaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["v2Id"] = args ? args.v2Id : undefined;
            resourceInputs["v2Id1"] = args ? args.v2Id1 : undefined;
            ...
            resourceInputs["updateTime"] = undefined /*out*/;
            resourceInputs["v2Id"] = undefined /*out*/;
            resourceInputs["v2Id1"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        const replaceOnChanges = { replaceOnChanges: ["v2Id", "v2Id1"] };
...
export interface CaseArgs {
     ...
     * The issue classification applicable to this case.
     */
    classification?: pulumi.Input<inputs.cloudsupport.v2.CaseClassificationArgs>;
    /**
     * A user-supplied email address to send case update notifications for. This should only be used in BYOID flows, where we cannot infer the user's email address directly from their EUCs.
     */
     ...
     * The user who created the case. Note: The name and email will be obfuscated if the case was created by Google Support.
     */
    creator?: pulumi.Input<inputs.cloudsupport.v2.ActorArgs>;
    /**
     * A broad description of the issue.
     */
     ...
     * The priority of this case.
     */
    priority?: pulumi.Input<enums.cloudsupport.v2.CasePriority>;
    /**
     * The email addresses to receive updates on this case.
     */
    ...
    v2Id: pulumi.Input<string>;
    v2Id1: pulumi.Input<string>;
}
