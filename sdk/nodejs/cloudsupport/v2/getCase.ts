...
export function getCase(args: GetCaseArgs, opts?: pulumi.InvokeOptions): Promise<GetCaseResult> {
    ...
    return pulumi.runtime.invoke("google-native:cloudsupport/v2:getCase", {
        "caseId": args.caseId,
        "v2Id": args.v2Id,
        "v2Id1": args.v2Id1,
    }, opts);
...
export interface GetCaseResult {
     ...
     */
    readonly classification: outputs.cloudsupport.v2.CaseClassificationResponse;
    /**
     ...
     */
    readonly creator: outputs.cloudsupport.v2.ActorResponse;
    /**
