...
// Export enums:
export * from "../../types/enums/cloudsupport/v2";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:cloudsupport/v2:Case":
...
pulumi.runtime.registerResourceModule("google-native", "cloudsupport/v2", _module)
