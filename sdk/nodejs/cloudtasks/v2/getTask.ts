...
export interface GetTaskResult {
     ...
     */
    readonly appEngineHttpRequest: outputs.cloudtasks.v2.AppEngineHttpRequestResponse;
    /**
     ...
     */
    readonly firstAttempt: outputs.cloudtasks.v2.AttemptResponse;
    /**
     * HTTP request that is sent to the worker. An HTTP task is a task that has HttpRequest set.
     */
    readonly httpRequest: outputs.cloudtasks.v2.HttpRequestResponse;
    /**
     * The status of the task's last attempt.
     */
    readonly lastAttempt: outputs.cloudtasks.v2.AttemptResponse;
    /**
