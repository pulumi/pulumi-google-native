...
export function getQueue(args: GetQueueArgs, opts?: pulumi.InvokeOptions): Promise<GetQueueResult> {
    ...
    return pulumi.runtime.invoke("google-native:cloudtasks/v2beta2:getQueue", {
...
export interface GetQueueResult {
     ...
     */
    readonly appEngineHttpTarget: outputs.cloudtasks.v2beta2.AppEngineHttpTargetResponse;
    /**
     * An http_target is used to override the target values for HTTP tasks.
     */
    readonly httpTarget: outputs.cloudtasks.v2beta2.HttpTargetResponse;
    /**
     ...
     */
    readonly pullTarget: outputs.cloudtasks.v2beta2.PullTargetResponse;
    /**
     ...
     */
    readonly rateLimits: outputs.cloudtasks.v2beta2.RateLimitsResponse;
    /**
     * Settings that determine the retry behavior. * For tasks created using Cloud Tasks: the queue-level retry settings apply to all tasks in the queue that were created using Cloud Tasks. Retry settings cannot be set on individual tasks. * For tasks created using the App Engine SDK: the queue-level retry settings apply to all tasks in the queue which do not have retry settings explicitly set on the task and were created by the App Engine SDK. See [App Engine documentation](https://cloud.google.com/appengine/docs/standard/python/taskqueue/push/retrying-tasks).
     */
    readonly retryConfig: outputs.cloudtasks.v2beta2.RetryConfigResponse;
    /**
     ...
     */
    readonly stats: outputs.cloudtasks.v2beta2.QueueStatsResponse;
    /**
