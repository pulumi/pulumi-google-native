...
export class Environment extends pulumi.CustomResource {
     ...
     */
    public readonly storageConfig!: pulumi.Output<outputs.composer.v1beta1.StorageConfigResponse>;
    /**
...
export interface EnvironmentArgs {
     ...
     * Configuration parameters for this environment.
     */
    config?: pulumi.Input<inputs.composer.v1beta1.EnvironmentConfigArgs>;
    /**
     * Optional. User-defined labels for this environment. The labels map can contain no more than 64 entries. Entries of the labels map are UTF8 strings that comply with the following restrictions: * Keys must conform to regexp: \p{Ll}\p{Lo}{0,62} * Values must conform to regexp: [\p{Ll}\p{Lo}\p{N}_-]{0,63} * Both keys and values are additionally constrained to be <= 128 bytes in size.
     */
     ...
     * The current state of the environment.
     */
    state?: pulumi.Input<enums.composer.v1beta1.EnvironmentState>;
    /**
     * Optional. Storage configuration for this environment.
     */
    storageConfig?: pulumi.Input<inputs.composer.v1beta1.StorageConfigArgs>;
}
