...
export class Autoscaler extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:Autoscaler';
...
export interface AutoscalerArgs {
     ...
     */
    readonly autoscalingPolicy?: pulumi.Input<inputs.compute.alpha.AutoscalingPolicy>;
    /**
     ...
     */
    readonly statusDetails?: pulumi.Input<pulumi.Input<inputs.compute.alpha.AutoscalerStatusDetails>[]>;
    /**
