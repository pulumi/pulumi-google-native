...
export class BackendBucket extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:BackendBucket';
...
export interface BackendBucketArgs {
     ...
     * Cloud CDN configuration for this BackendBucket.
     */
    readonly cdnPolicy?: pulumi.Input<inputs.compute.alpha.BackendBucketCdnPolicy>;
    /**
     * [Output Only] Creation timestamp in RFC3339 text format.
     */
