...
export class ExternalVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/alpha:ExternalVpnGateway';
     ...
     */
    public readonly interfaces!: pulumi.Output<outputs.compute.alpha.ExternalVpnGatewayInterfaceResponse[]>;
    /**
...
export interface ExternalVpnGatewayArgs {
     ...
     * List of interfaces for this external VPN gateway.
     */
    interfaces?: pulumi.Input<pulumi.Input<inputs.compute.alpha.ExternalVpnGatewayInterfaceArgs>[]>;
    /**
     * Labels for this resource. These can only be added or modified by the setLabels method. Each label key/value pair must comply with RFC1035. Label values may be empty.
     */
     ...
     * Indicates the user-supplied redundancy type of this external VPN gateway.
     */
    redundancyType?: pulumi.Input<enums.compute.alpha.ExternalVpnGatewayRedundancyType>;
