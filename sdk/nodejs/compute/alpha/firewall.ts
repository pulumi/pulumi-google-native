...
export interface FirewallArgs {
     ...
     * The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.
     */
    readonly allowed?: pulumi.Input<pulumi.Input<inputs.compute.alpha.FirewallAllowedItemArgs>[]>;
    /**
     * [Output Only] Creation timestamp in RFC3339 text format.
     */
     ...
     * The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
     */
    readonly denied?: pulumi.Input<pulumi.Input<inputs.compute.alpha.FirewallDeniedItemArgs>[]>;
    /**
     * An optional description of this resource. Provide this field when you create the resource.
     */
     ...
     * This field denotes the logging options for a particular firewall rule. If logging is enabled, logs will be exported to Cloud Logging.
     */
    readonly logConfig?: pulumi.Input<inputs.compute.alpha.FirewallLogConfigArgs>;
    /**
     * Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?. The first character must be a lowercase letter, and all following characters (except for the last character) must be a dash, lowercase letter, or digit. The last character must be a lowercase letter or digit.
     */
