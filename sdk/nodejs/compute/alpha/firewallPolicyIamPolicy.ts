...
export class FirewallPolicyIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FirewallPolicyIamPolicy {
        return new FirewallPolicyIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/alpha:FirewallPolicyIamPolicy';
    ...
    constructor(name: string, args: FirewallPolicyIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FirewallPolicyIamPolicy.__pulumiType, name, inputs, opts);
    }
}
