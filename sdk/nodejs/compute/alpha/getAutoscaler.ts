...
export function getAutoscaler(args: GetAutoscalerArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoscalerResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/alpha:getAutoscaler", {
...
export interface GetAutoscalerResult {
     ...
     */
    readonly scalingScheduleStatus: {[key: string]: outputs.compute.alpha.ScalingScheduleStatusResponse};
    /**
