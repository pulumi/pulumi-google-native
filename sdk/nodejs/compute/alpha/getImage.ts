...
export function getImage(args: GetImageArgs, opts?: pulumi.InvokeOptions): Promise<GetImageResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/alpha:getImage", {
        "image": args.image,
...
export interface GetImageResult {
     ...
     */
    readonly deprecated: outputs.compute.alpha.DeprecationStatusResponse;
    /**
     ...
     */
    readonly shieldedInstanceInitialState: outputs.compute.alpha.InitialStateConfigResponse;
    /**
