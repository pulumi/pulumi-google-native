...
export interface GetInstanceResult {
     ...
     */
    readonly advancedMachineFeatures: outputs.compute.alpha.AdvancedMachineFeaturesResponse;
    /**
     * Allows this instance to send and receive packets with non-matching destination or source IPs. This is required if you plan to use this instance to forward routes. For more information, see Enabling IP Forwarding .
     */
    readonly canIpForward: boolean;
    readonly confidentialInstanceConfig: outputs.compute.alpha.ConfidentialInstanceConfigResponse;
    /**
     ...
     */
    readonly disks: outputs.compute.alpha.AttachedDiskResponse[];
    /**
     * Enables display device for the instance.
     */
    readonly displayDevice: outputs.compute.alpha.DisplayDeviceResponse;
    /**
     ...
     */
    readonly guestAccelerators: outputs.compute.alpha.AcceleratorConfigResponse[];
    /**
     ...
     */
    readonly metadata: outputs.compute.alpha.MetadataResponse;
    /**
     ...
     */
    readonly partnerMetadata: outputs.compute.alpha.StructuredEntriesResponse;
    /**
     ...
     */
    readonly reservationAffinity: outputs.compute.alpha.ReservationAffinityResponse;
    /**
     ...
     */
    readonly resourceStatus: outputs.compute.alpha.ResourceStatusResponse;
    /**
     ...
     */
    readonly scheduling: outputs.compute.alpha.SchedulingResponse;
    /**
     ...
     */
    readonly serviceAccounts: outputs.compute.alpha.ServiceAccountResponse[];
    /**
     ...
     */
    readonly serviceIntegrationSpecs: outputs.compute.alpha.ServiceIntegrationSpecResponse;
     ...
     */
    readonly shieldedVmConfig: outputs.compute.alpha.ShieldedVmConfigResponse;
    /**
     * Deprecating, please use shielded_instance_integrity_policy.
     */
    readonly shieldedVmIntegrityPolicy: outputs.compute.alpha.ShieldedVmIntegrityPolicyResponse;
    /**
     ...
     */
    readonly sourceMachineImageEncryptionKey: outputs.compute.alpha.CustomerEncryptionKeyResponse;
    /**
     ...
     */
    readonly tags: outputs.compute.alpha.TagsResponse;
    /**
     * Specifies upcoming maintenance for the instance.
     */
    readonly upcomingMaintenance: outputs.compute.alpha.UpcomingMaintenanceResponse;
    /**
