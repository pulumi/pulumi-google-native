...
export function getRegionBackendService(args: GetRegionBackendServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionBackendServiceResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/alpha:getRegionBackendService", {
...
export interface GetRegionBackendServiceResult {
     ...
     */
    readonly backends: outputs.compute.alpha.BackendResponse[];
    /**
     * Cloud CDN configuration for this BackendService. Only available for specified load balancer types.
     */
    readonly cdnPolicy: outputs.compute.alpha.BackendServiceCdnPolicyResponse;
    readonly circuitBreakers: outputs.compute.alpha.CircuitBreakersResponse;
    /**
     * Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
     */
    readonly compressionMode: string;
    readonly connectionDraining: outputs.compute.alpha.ConnectionDrainingResponse;
    /**
     ...
     */
    readonly connectionTrackingPolicy: outputs.compute.alpha.BackendServiceConnectionTrackingPolicyResponse;
    /**
     ...
     */
    readonly consistentHash: outputs.compute.alpha.ConsistentHashLoadBalancerSettingsResponse;
    /**
     ...
     */
    readonly failoverPolicy: outputs.compute.alpha.BackendServiceFailoverPolicyResponse;
    /**
     ...
     */
    readonly haPolicy: outputs.compute.alpha.BackendServiceHAPolicyResponse;
    /**
     ...
     */
    readonly iap: outputs.compute.alpha.BackendServiceIAPResponse;
    /**
     ...
     */
    readonly localityLbPolicies: outputs.compute.alpha.BackendServiceLocalityLoadBalancingPolicyConfigResponse[];
    /**
     ...
     */
    readonly logConfig: outputs.compute.alpha.BackendServiceLogConfigResponse;
    /**
     ...
     */
    readonly outlierDetection: outputs.compute.alpha.OutlierDetectionResponse;
    /**
    ...
    readonly subsetting: outputs.compute.alpha.SubsettingResponse;
    /**
     * The backend service timeout has a different meaning depending on the type of load balancer. For more information see, Backend service settings. The default is 30 seconds. The full range of timeout values allowed goes from 1 through 2,147,483,647 seconds. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. Instead, use maxStreamDuration.
     */
    readonly timeoutSec: number;
    readonly usedBy: outputs.compute.alpha.BackendServiceUsedByResponse[];
    /**
