 ...
 */
export function getRegionNetwork(args: GetRegionNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionNetworkResult> {
    if (!opts) {
        opts = {}
    }
...
export interface GetRegionNetworkArgs {
    network: string;
    project?: string;
    region: string;
}

export interface GetRegionNetworkResult {
    /**
...
export function getRegionNetworkOutput(args: GetRegionNetworkOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRegionNetworkResult> {
    return pulumi.output(args).apply(a => getRegionNetwork(a, opts))
}

export interface GetRegionNetworkOutputArgs {
