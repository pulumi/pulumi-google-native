 ...
 */
export function getRegionSnapshot(args: GetRegionSnapshotArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionSnapshotResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("google-native:compute/alpha:getRegionSnapshot", {
...
export interface GetRegionSnapshotArgs {
    project?: string;
    region: string;
    snapshot: string;
}

export interface GetRegionSnapshotResult {
    /**
 ...
 * Returns the specified Snapshot resource.
 */
export function getRegionSnapshotOutput(args: GetRegionSnapshotOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRegionSnapshotResult> {
    return pulumi.output(args).apply((a: any) => getRegionSnapshot(a, opts))
}

export interface GetRegionSnapshotOutputArgs {
