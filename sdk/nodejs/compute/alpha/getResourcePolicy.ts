...
export function getResourcePolicy(args: GetResourcePolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetResourcePolicyResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/alpha:getResourcePolicy", {
...
export interface GetResourcePolicyResult {
     ...
     */
    readonly diskConsistencyGroupPolicy: outputs.compute.alpha.ResourcePolicyDiskConsistencyGroupPolicyResponse;
    /**
     ...
     */
    readonly vmMaintenancePolicy: outputs.compute.alpha.ResourcePolicyVmMaintenancePolicyResponse;
}
