 ...
 */
export function getServiceAttachmentIamPolicy(args: GetServiceAttachmentIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceAttachmentIamPolicyResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("google-native:compute/alpha:getServiceAttachmentIamPolicy", {
...
export interface GetServiceAttachmentIamPolicyResult {
    /**
...
export function getServiceAttachmentIamPolicyOutput(args: GetServiceAttachmentIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetServiceAttachmentIamPolicyResult> {
    return pulumi.output(args).apply((a: any) => getServiceAttachmentIamPolicy(a, opts))
}
