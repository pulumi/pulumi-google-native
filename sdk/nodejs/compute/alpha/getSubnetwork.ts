...
export interface GetSubnetworkResult {
     ...
     */
    readonly logConfig: outputs.compute.alpha.SubnetworkLogConfigResponse;
    /**
     ...
     */
    readonly privateIpv6GoogleAccessServiceAccounts: string[];
    /**
     ...
     */
    readonly secondaryIpRanges: outputs.compute.alpha.SubnetworkSecondaryRangeResponse[];
    /**
