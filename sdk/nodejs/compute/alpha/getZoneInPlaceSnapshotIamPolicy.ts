 ...
 */
export function getZoneInPlaceSnapshotIamPolicy(args: GetZoneInPlaceSnapshotIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetZoneInPlaceSnapshotIamPolicyResult> {
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("google-native:compute/alpha:getZoneInPlaceSnapshotIamPolicy", {
...
export interface GetZoneInPlaceSnapshotIamPolicyArgs {
...
export interface GetZoneInPlaceSnapshotIamPolicyResult {
    /**
