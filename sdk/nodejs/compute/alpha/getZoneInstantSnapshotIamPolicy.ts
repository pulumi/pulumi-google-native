 ...
 */
export function getZoneInstantSnapshotIamPolicy(args: GetZoneInstantSnapshotIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetZoneInstantSnapshotIamPolicyResult> {
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("google-native:compute/alpha:getZoneInstantSnapshotIamPolicy", {
...
export interface GetZoneInstantSnapshotIamPolicyResult {
    /**
