...
export class GlobalForwardingRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:GlobalForwardingRule';
...
export interface GlobalForwardingRuleArgs {
     ...
     */
    readonly metadataFilters?: pulumi.Input<pulumi.Input<inputs.compute.alpha.MetadataFilter>[]>;
    /**
     ...
     */
    readonly serviceDirectoryRegistrations?: pulumi.Input<pulumi.Input<inputs.compute.alpha.ForwardingRuleServiceDirectoryRegistration>[]>;
    /**
