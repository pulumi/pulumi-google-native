...
export class GlobalPublicDelegatedPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/alpha:GlobalPublicDelegatedPrefix';
    ...
    constructor(name: string, args: GlobalPublicDelegatedPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GlobalPublicDelegatedPrefix.__pulumiType, name, inputs, opts);
    }
}
...
export interface GlobalPublicDelegatedPrefixArgs {
     ...
     * The list of sub public delegated prefixes that exist for this public delegated prefix.
     */
    readonly publicDelegatedSubPrefixs?: pulumi.Input<pulumi.Input<inputs.compute.alpha.PublicDelegatedPrefixPublicDelegatedSubPrefixArgs>[]>;
    /**
     * [Output Only] URL of the region where the public delegated prefix resides. This field applies only to the region resource. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.
     */
