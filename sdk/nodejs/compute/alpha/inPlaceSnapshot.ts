 ...
 */
export class InPlaceSnapshot extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InPlaceSnapshot {
        return new InPlaceSnapshot(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:InPlaceSnapshot';

    /**
     * Returns true if the given object is an instance of InPlaceSnapshot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InPlaceSnapshot {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === InPlaceSnapshot.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: InPlaceSnapshotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InPlaceSnapshot.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface InPlaceSnapshotArgs {
    /**
