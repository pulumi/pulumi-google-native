...
export class Interconnect extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:Interconnect';
     ...
     */
    public readonly circuitInfos!: pulumi.Output<outputs.compute.alpha.InterconnectCircuitInfoResponse[]>;
    /**
     ...
     */
    public readonly expectedOutages!: pulumi.Output<outputs.compute.alpha.InterconnectOutageNotificationResponse[]>;
    /**
     * [Output Only] IP address configured on the Google side of the Interconnect link. This can be used only for ping tests.
     */
    public readonly googleIpAddress!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly provisionedLinkCount!: pulumi.Output<number>;
    /**
...
export interface InterconnectArgs {
     ...
     * [Output Only] A list of CircuitInfo objects, that describe the individual circuits in this LAG.
     */
    readonly circuitInfos?: pulumi.Input<pulumi.Input<inputs.compute.alpha.InterconnectCircuitInfo>[]>;
    /**
     * [Output Only] Creation timestamp in RFC3339 text format.
     */
     ...
     * [Output Only] A list of outages expected for this Interconnect.
     */
    readonly expectedOutages?: pulumi.Input<pulumi.Input<inputs.compute.alpha.InterconnectOutageNotification>[]>;
    /**
     * [Output Only] IP address configured on the Google side of the Interconnect link. This can be used only for ping tests.
     */
