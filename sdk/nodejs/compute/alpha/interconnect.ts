...
export interface InterconnectArgs {
     ...
     * [Output Only] A list of CircuitInfo objects, that describe the individual circuits in this LAG.
     */
    circuitInfos?: pulumi.Input<pulumi.Input<inputs.compute.alpha.InterconnectCircuitInfoArgs>[]>;
    /**
     * [Output Only] Creation timestamp in RFC3339 text format.
     */
     ...
     * [Output Only] A list of outages expected for this Interconnect.
     */
    expectedOutages?: pulumi.Input<pulumi.Input<inputs.compute.alpha.InterconnectOutageNotificationArgs>[]>;
    /**
     * [Output Only] IP address configured on the Google side of the Interconnect link. This can be used only for ping tests.
     */
     ...
     * - OS_UNDER_MAINTENANCE: An Interconnect that is undergoing internal maintenance. No attachments may be provisioned or updated on this Interconnect.
     */
    operationalStatus?: pulumi.Input<enums.compute.alpha.InterconnectOperationalStatus>;
    /**
     * [Output Only] IP address configured on the customer side of the Interconnect link. The customer should configure this IP address during turnup when prompted by Google NOC. This can be used only for ping tests.
     */
     ...
     * - UNDER_MAINTENANCE: The Interconnect is undergoing internal maintenance. No attachments may be provisioned or updated on this Interconnect.
     */
    state?: pulumi.Input<enums.compute.alpha.InterconnectState>;
}
