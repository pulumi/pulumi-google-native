...
export class PacketMirroring extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/alpha:PacketMirroring';
     ...
     */
    public readonly mirroredResources!: pulumi.Output<outputs.compute.alpha.PacketMirroringMirroredResourceInfoResponse>;
    /**
     ...
     */
    public readonly network!: pulumi.Output<outputs.compute.alpha.PacketMirroringNetworkInfoResponse>;
    /**
...
export interface PacketMirroringArgs {
     ...
     * The Forwarding Rule resource of type loadBalancingScheme=INTERNAL that will be used as collector for mirrored traffic. The specified forwarding rule must have isMirroringCollector set to true.
     */
    readonly collectorIlb?: pulumi.Input<inputs.compute.alpha.PacketMirroringForwardingRuleInfoArgs>;
    /**
     * [Output Only] Creation timestamp in RFC3339 text format.
     */
     ...
     * Filter for mirrored traffic. If unspecified, all traffic is mirrored.
     */
    readonly filter?: pulumi.Input<inputs.compute.alpha.PacketMirroringFilterArgs>;
    /**
     ...
     * PacketMirroring mirroredResourceInfos. MirroredResourceInfo specifies a set of mirrored VM instances, subnetworks and/or tags for which traffic from/to all VM instances will be mirrored.
     */
    readonly mirroredResources?: pulumi.Input<inputs.compute.alpha.PacketMirroringMirroredResourceInfoArgs>;
    /**
     * Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
     */
