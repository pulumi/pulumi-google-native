...
export class PublicAdvertisedPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:PublicAdvertisedPrefix';
...
export interface PublicAdvertisedPrefixArgs {
     ...
     */
    readonly publicDelegatedPrefixs?: pulumi.Input<pulumi.Input<inputs.compute.alpha.PublicAdvertisedPrefixPublicDelegatedPrefix>[]>;
    /**
