 ...
 */
export class RegionNetworkIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegionNetworkIamPolicy {
        return new RegionNetworkIamPolicy(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is RegionNetworkIamPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RegionNetworkIamPolicy.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: RegionNetworkIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface RegionNetworkIamPolicyArgs {
    /**
     * Specifies cloud audit logging configuration for this policy.
     */
