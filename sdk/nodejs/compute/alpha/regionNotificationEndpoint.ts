...
export class RegionNotificationEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:RegionNotificationEndpoint';
...
export interface RegionNotificationEndpointArgs {
     ...
     * Settings of the gRPC notification endpoint including the endpoint URL and the retry duration.
     */
    readonly grpcSettings?: pulumi.Input<inputs.compute.alpha.NotificationEndpointGrpcSettings>;
    /**
