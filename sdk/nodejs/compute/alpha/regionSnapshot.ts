 ...
 */
export class RegionSnapshot extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegionSnapshot {
        return new RegionSnapshot(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/alpha:RegionSnapshot';

    /**
     * Returns true if the given object is an instance of RegionSnapshot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RegionSnapshot {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RegionSnapshot.__pulumiType;
    }
     ...
     */
    public readonly sourceInstantSnapshotEncryptionKey!: pulumi.Output<outputs.compute.alpha.CustomerEncryptionKeyResponse>;
    /**
     ...
     */
    constructor(name: string, args: RegionSnapshotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RegionSnapshot.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RegionSnapshotArgs {
    /**
     * Creates the new snapshot in the snapshot chain labeled with the specified name. The chain name must be 1-63 characters long and comply with RFC1035. This is an uncommon option only for advanced service owners who needs to create separate snapshot chains, for example, for chargeback tracking. When you describe your snapshot resource, this field is visible only if it has a non-empty value.
     */
     ...
     * Indicates the type of the snapshot.
     */
    snapshotType?: pulumi.Input<enums.compute.alpha.RegionSnapshotSnapshotType>;
    /**
     * The source disk used to create this snapshot.
     */
     ...
     * Customer provided encryption key when creating Snapshot from Instant Snapshot.
     */
    sourceInstantSnapshotEncryptionKey?: pulumi.Input<inputs.compute.alpha.CustomerEncryptionKeyArgs>;
    /**
     * Cloud Storage bucket storage location of the snapshot (regional or multi-regional).
     */
