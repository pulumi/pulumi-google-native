...
export class RegionUrlMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/alpha:RegionUrlMap';
     ...
     */
    public readonly defaultCustomErrorResponsePolicy!: pulumi.Output<outputs.compute.alpha.CustomErrorResponsePolicyResponse>;
    /**
    ...
    constructor(name: string, args: RegionUrlMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["creationTimestamp"] = undefined /*out*/;
            resourceInputs["defaultCustomErrorResponsePolicy"] = undefined /*out*/;
