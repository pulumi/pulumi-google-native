 ...
 */
export class ReservationIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReservationIamPolicy {
        return new ReservationIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/alpha:ReservationIamPolicy';

    /**
     * Returns true if the given object is an instance of ReservationIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ReservationIamPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ReservationIamPolicy.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ReservationIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ReservationIamPolicy.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface ReservationIamPolicyArgs {
    /**
     * Specifies cloud audit logging configuration for this policy.
     */
