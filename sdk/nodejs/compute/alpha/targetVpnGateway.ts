...
export class TargetVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:TargetVpnGateway';
...
export interface TargetVpnGatewayArgs {
     ...
     */
    readonly forwardingRules?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     ...
     */
    readonly tunnels?: pulumi.Input<pulumi.Input<string>[]>;
}
