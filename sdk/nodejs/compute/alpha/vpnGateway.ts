...
export class VpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/alpha:VpnGateway';
    ...
    constructor(name: string, args: VpnGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.vpnGateway === undefined) && !opts.urn) {
...
export interface VpnGatewayArgs {
     ...
     * A list of interfaces on this VPN gateway.
     */
    readonly vpnInterfaces?: pulumi.Input<pulumi.Input<inputs.compute.alpha.VpnGatewayVpnGatewayInterface>[]>;
}
