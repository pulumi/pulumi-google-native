 ...
 */
export class ZoneInPlaceSnapshot extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ZoneInPlaceSnapshot {
        return new ZoneInPlaceSnapshot(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/alpha:ZoneInPlaceSnapshot';

    /**
     * Returns true if the given object is an instance of ZoneInPlaceSnapshot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZoneInPlaceSnapshot {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZoneInPlaceSnapshot.__pulumiType;
    }
    ...
    constructor(name: string, args: ZoneInPlaceSnapshotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ZoneInPlaceSnapshot.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface ZoneInPlaceSnapshotArgs {
    /**
     * [Output Only] Creation timestamp in RFC3339 text format.
     */
