...
export class Autoscaler extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly scalingScheduleStatus!: pulumi.Output<{[key: string]: outputs.compute.beta.ScalingScheduleStatusResponse}>;
    /**
     ...
     */
    public /*out*/ readonly statusDetails!: pulumi.Output<outputs.compute.beta.AutoscalerStatusDetailsResponse[]>;
    /**
