...
export class BackendServiceIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackendServiceIamPolicy {
        return new BackendServiceIamPolicy(name, undefined as any, { ...opts, id: id });
    }
    ...
    constructor(name: string, args: BackendServiceIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BackendServiceIamPolicy.__pulumiType, name, inputs, opts);
    }
}
