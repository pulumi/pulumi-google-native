...
export interface GetRouterResult {
     ...
     */
    readonly bgp: outputs.compute.beta.RouterBgpResponse;
    /**
     * BGP information that must be configured into the routing stack to establish BGP peering. This information must specify the peer ASN and either the interface name, IP address, or peer IP address. Please refer to RFC4273.
     */
    readonly bgpPeers: outputs.compute.beta.RouterBgpPeerResponse[];
    /**
     ...
     */
    readonly md5AuthenticationKeys: outputs.compute.beta.RouterMd5AuthenticationKeyResponse[];
    /**
     ...
     */
    readonly nats: outputs.compute.beta.RouterNatResponse[];
    /**
