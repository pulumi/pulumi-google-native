...
export function getStoragePool(args: GetStoragePoolArgs, opts?: pulumi.InvokeOptions): Promise<GetStoragePoolResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/beta:getStoragePool", {
...
export interface GetStoragePoolResult {
     ...
     */
    readonly resourceStatus: outputs.compute.beta.StoragePoolResourceStatusResponse;
    /**
     ...
     * Status information for the storage pool resource.
     */
    readonly status: outputs.compute.beta.StoragePoolResourceStatusResponse;
    /**
