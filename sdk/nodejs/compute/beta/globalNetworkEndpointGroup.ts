...
export class GlobalNetworkEndpointGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/beta:GlobalNetworkEndpointGroup';
...
export interface GlobalNetworkEndpointGroupArgs {
     ...
     * Only valid when networkEndpointType is GCE_VM_IP_PORT and the NEG is regional.
     */
    clientPortMappingMode?: pulumi.Input<enums.compute.beta.GlobalNetworkEndpointGroupClientPortMappingMode>;
    /**
     * Only valid when networkEndpointType is SERVERLESS. Only one of cloudRun, appEngine or cloudFunction may be set.
     */
