...
export class InstanceGroupManager extends pulumi.CustomResource {
     ...
     */
    public readonly instanceLifecyclePolicy!: pulumi.Output<outputs.compute.beta.InstanceGroupManagerInstanceLifecyclePolicyResponse>;
    /**
...
export interface InstanceGroupManagerArgs {
     ...
     * Pagination behavior of the listManagedInstances API method for this managed instance group.
     */
    listManagedInstancesResults?: pulumi.Input<enums.compute.beta.InstanceGroupManagerListManagedInstancesResults>;
    /**
     * The name of the managed instance group. The name must be 1-63 characters long, and comply with RFC1035.
     */
