...
export class InterconnectAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/beta:InterconnectAttachment';
...
export interface InterconnectAttachmentArgs {
     ...
     * Informational metadata about Partner attachments from Partners to display to customers. Output only for for PARTNER type, mutable for PARTNER_PROVIDER, not available for DEDICATED.
     */
    readonly partnerMetadata?: pulumi.Input<inputs.compute.beta.InterconnectAttachmentPartnerMetadata>;
    /**
     * [Output Only] Information specific to an InterconnectAttachment. This property is populated if the interconnect that this is attached to is of type DEDICATED.
     */
    readonly privateInterconnectInfo?: pulumi.Input<inputs.compute.beta.InterconnectAttachmentPrivateInfo>;
