...
export class InterconnectAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/beta:InterconnectAttachment';
     ...
     */
    public /*out*/ readonly configurationConstraints!: pulumi.Output<outputs.compute.beta.InterconnectAttachmentConfigurationConstraintsResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateInterconnectInfo!: pulumi.Output<outputs.compute.beta.InterconnectAttachmentPrivateInfoResponse>;
...
export interface InterconnectAttachmentArgs {
     ...
     * The stack type for this interconnect attachment to identify whether the IPv6 feature is enabled or not. If not specified, IPV4_ONLY will be used. This field can be both set at interconnect attachments creation and update interconnect attachment operations.
     */
    stackType?: pulumi.Input<enums.compute.beta.InterconnectAttachmentStackType>;
    /**
     * Length of the IPv4 subnet mask. Allowed values: - 29 (default) - 30 The default value is 29, except for Cross-Cloud Interconnect connections that use an InterconnectRemoteLocation with a constraints.subnetLengthRange.min equal to 30. For example, connections that use an Azure remote location fall into this category. In these cases, the default value is 30, and requesting 29 returns an error. Where both 29 and 30 are allowed, 29 is preferred, because it gives Google Cloud Support more debugging visibility. 
     */
