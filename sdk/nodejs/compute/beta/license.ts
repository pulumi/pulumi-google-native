...
export class License extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/beta:License';
...
export interface LicenseArgs {
    ...
    readonly resourceRequirements?: pulumi.Input<inputs.compute.beta.LicenseResourceRequirementsArgs>;
    /**
     * [Output Only] Server-defined URL for the resource.
     */
