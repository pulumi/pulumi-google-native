...
export class NetworkAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/beta:NetworkAttachment';
     ...
     */
    public /*out*/ readonly connectionEndpoints!: pulumi.Output<outputs.compute.beta.NetworkAttachmentConnectedEndpointResponse[]>;
...
export interface NetworkAttachmentArgs {
    connectionPreference?: pulumi.Input<enums.compute.beta.NetworkAttachmentConnectionPreference>;
    /**
     * An optional description of this resource. Provide this property when you create the resource.
     */
