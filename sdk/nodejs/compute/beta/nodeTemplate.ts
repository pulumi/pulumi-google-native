...
export class NodeTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/beta:NodeTemplate';
...
export interface NodeTemplateArgs {
    readonly accelerators?: pulumi.Input<pulumi.Input<inputs.compute.beta.AcceleratorConfig>[]>;
    /**
     * CPU overcommit.
     */
    ...
    readonly disks?: pulumi.Input<pulumi.Input<inputs.compute.beta.LocalDisk>[]>;
    /**
     ...
     * This field is mutually exclusive with the node_type property; you can only define one or the other, but not both.
     */
    readonly nodeTypeFlexibility?: pulumi.Input<inputs.compute.beta.NodeTemplateNodeTypeFlexibility>;
     ...
     * See Sole-tenant node options for more information.
     */
    readonly serverBinding?: pulumi.Input<inputs.compute.beta.ServerBinding>;
    /**
     * [Output Only] The status of the node template. One of the following values: CREATING, READY, and DELETING.
     */
