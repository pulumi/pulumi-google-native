...
export interface NodeTemplateArgs {
    readonly accelerators?: pulumi.Input<pulumi.Input<inputs.compute.beta.AcceleratorConfigArgs>[]>;
    /**
     * CPU overcommit.
     */
    ...
    readonly disks?: pulumi.Input<pulumi.Input<inputs.compute.beta.LocalDiskArgs>[]>;
    /**
     ...
     * This field is mutually exclusive with the node_type property; you can only define one or the other, but not both.
     */
    readonly nodeTypeFlexibility?: pulumi.Input<inputs.compute.beta.NodeTemplateNodeTypeFlexibilityArgs>;
     ...
     * See Sole-tenant node options for more information.
     */
    readonly serverBinding?: pulumi.Input<inputs.compute.beta.ServerBindingArgs>;
    /**
     * [Output Only] The status of the node template. One of the following values: CREATING, READY, and DELETING.
     */
