...
export class PublicAdvertisedPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/beta:PublicAdvertisedPrefix';
...
export interface PublicAdvertisedPrefixArgs {
     ...
     */
    readonly publicDelegatedPrefixs?: pulumi.Input<pulumi.Input<inputs.compute.beta.PublicAdvertisedPrefixPublicDelegatedPrefix>[]>;
    /**
