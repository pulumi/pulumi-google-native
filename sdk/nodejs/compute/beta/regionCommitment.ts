...
export class RegionCommitment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/beta:RegionCommitment';
...
export interface RegionCommitmentArgs {
     ...
     */
    readonly licenseResource?: pulumi.Input<inputs.compute.beta.LicenseResourceCommitment>;
    /**
     ...
     */
    readonly reservations?: pulumi.Input<pulumi.Input<inputs.compute.beta.Reservation>[]>;
    /**
     * A list of commitment amounts for particular resources. Note that VCPU and MEMORY resource commitments must occur together.
     */
    readonly resources?: pulumi.Input<pulumi.Input<inputs.compute.beta.ResourceCommitment>[]>;
    /**
