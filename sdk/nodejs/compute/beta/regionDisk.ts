...
export class RegionDisk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/beta:RegionDisk';
...
export interface RegionDiskArgs {
     ...
     * If you do not provide an encryption key when creating the disk, then the disk will be encrypted using an automatically generated key and you do not need to provide a key to use the disk later.
     */
    readonly diskEncryptionKey?: pulumi.Input<inputs.compute.beta.CustomerEncryptionKey>;
    /**
     * Specifies whether the disk restored from a source snapshot should erase Windows specific VSS signature.
     */
