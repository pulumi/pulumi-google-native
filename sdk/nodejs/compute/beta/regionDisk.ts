...
export class RegionDisk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/beta:RegionDisk';
     ...
     */
    public readonly asyncPrimaryDisk!: pulumi.Output<outputs.compute.beta.DiskAsyncReplicationResponse>;
    /**
     * A list of disks this disk is asynchronously replicated to.
     */
    public /*out*/ readonly asyncSecondaryDisks!: pulumi.Output<outputs.compute.beta.DiskAsyncReplicationListResponse>;
    /**
     ...
     */
    public readonly params!: pulumi.Output<outputs.compute.beta.DiskParamsResponse>;
    /**
     ...
     */
    public /*out*/ readonly resourceStatus!: pulumi.Output<outputs.compute.beta.DiskResourceStatusResponse>;
    /**
...
export interface RegionDiskArgs {
     ...
     * Disk asynchronously replicated into this disk.
     */
    asyncPrimaryDisk?: pulumi.Input<inputs.compute.beta.DiskAsyncReplicationArgs>;
    /**
     * An optional description of this resource. Provide this property when you create the resource.
     */
     ...
     * Input only. [Input Only] Additional params passed with the request, but not persisted as part of resource payload.
     */
    params?: pulumi.Input<inputs.compute.beta.DiskParamsArgs>;
    /**
     * Physical block size of the persistent disk, in bytes. If not present in a request, a default value is used. The currently supported size is 4096, other sizes may be added in the future. If an unsupported value is requested, the error message will list the supported values for the caller's project.
     */
     ...
     * @deprecated [Deprecated] Storage type of the persistent disk.
     */
    storageType?: pulumi.Input<enums.compute.beta.RegionDiskStorageType>;
    /**
     * URL of the disk type resource describing which disk type to use to create the disk. Provide this when creating the disk. For example: projects/project /zones/zone/diskTypes/pd-ssd . See Persistent disk types.
     */
