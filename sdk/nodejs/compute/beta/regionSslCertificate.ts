...
export interface RegionSslCertificateArgs {
     ...
     * Configuration and status of a managed SSL certificate.
     */
    readonly managed?: pulumi.Input<inputs.compute.beta.SslCertificateManagedSslCertificateArgs>;
    /**
     * Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
     */
     ...
     * Configuration and status of a self-managed SSL certificate.
     */
    readonly selfManaged?: pulumi.Input<inputs.compute.beta.SslCertificateSelfManagedSslCertificateArgs>;
    /**
     * [Output Only] Domains associated with the certificate via Subject Alternative Name.
     */
