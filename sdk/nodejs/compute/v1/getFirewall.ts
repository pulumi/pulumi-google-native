...
export function getFirewall(args: GetFirewallArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/v1:getFirewall", {
...
export interface GetFirewallResult {
     ...
     */
    readonly allowed: outputs.compute.v1.GetFirewallAllowedItemResponse[];
    /**
     ...
     */
    readonly denied: outputs.compute.v1.GetFirewallDeniedItemResponse[];
    /**
     ...
     */
    readonly logConfig: outputs.compute.v1.FirewallLogConfigResponse;
    /**
