...
export function getGlobalForwardingRule(args: GetGlobalForwardingRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetGlobalForwardingRuleResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/v1:getGlobalForwardingRule", {
...
export interface GetGlobalForwardingRuleResult {
     ...
     */
    readonly metadataFilters: outputs.compute.v1.MetadataFilterResponse[];
    /**
     ...
     */
    readonly serviceDirectoryRegistrations: outputs.compute.v1.ForwardingRuleServiceDirectoryRegistrationResponse[];
    /**
