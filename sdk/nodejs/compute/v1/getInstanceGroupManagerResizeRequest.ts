...
export function getInstanceGroupManagerResizeRequest(args: GetInstanceGroupManagerResizeRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceGroupManagerResizeRequestResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/v1:getInstanceGroupManagerResizeRequest", {
...
export interface GetInstanceGroupManagerResizeRequestResult {
     ...
     */
    readonly requestedRunDuration: outputs.compute.v1.DurationResponse;
    /**
     ...
     */
    readonly status: outputs.compute.v1.InstanceGroupManagerResizeRequestStatusResponse;
    /**
