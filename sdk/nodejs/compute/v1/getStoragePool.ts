...
export function getStoragePool(args: GetStoragePoolArgs, opts?: pulumi.InvokeOptions): Promise<GetStoragePoolResult> {
    ...
    return pulumi.runtime.invoke("google-native:compute/v1:getStoragePool", {
...
export interface GetStoragePoolResult {
     ...
     */
    readonly resourceStatus: outputs.compute.v1.StoragePoolResourceStatusResponse;
    /**
     ...
     * Status information for the storage pool resource.
     */
    readonly status: outputs.compute.v1.StoragePoolResourceStatusResponse;
    /**
