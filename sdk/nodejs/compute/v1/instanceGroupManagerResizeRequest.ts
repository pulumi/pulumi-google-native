...
export class InstanceGroupManagerResizeRequest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/v1:InstanceGroupManagerResizeRequest';
     ...
     */
    public readonly requestedRunDuration!: pulumi.Output<outputs.compute.v1.DurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.compute.v1.InstanceGroupManagerResizeRequestStatusResponse>;
...
export interface InstanceGroupManagerResizeRequestArgs {
     ...
     * Requested run duration for instances that will be created by this request. At the end of the run duration instance will be deleted.
     */
    requestedRunDuration?: pulumi.Input<inputs.compute.v1.DurationArgs>;
    /**
     * The number of instances to be created by this resize request. The group's target size will be increased by this number.
     */
