...
export class InstanceTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/v1:InstanceTemplate';
...
export interface InstanceTemplateArgs {
     ...
     * The instance properties for this instance template.
     */
    readonly properties?: pulumi.Input<inputs.compute.v1.InstanceProperties>;
    /**
     * [Output Only] The URL for this instance template. The server defines this URL.
     */
     ...
     * The source instance params to use to create this instance template.
     */
    readonly sourceInstanceParams?: pulumi.Input<inputs.compute.v1.SourceInstanceParams>;
}
