...
export class InterconnectAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/v1:InterconnectAttachment';
...
export interface InterconnectAttachmentArgs {
     ...
     */
    readonly partnerMetadata?: pulumi.Input<inputs.compute.v1.InterconnectAttachmentPartnerMetadata>;
    /**
     * [Output Only] Information specific to an InterconnectAttachment. This property is populated if the interconnect that this is attached to is of type DEDICATED.
     */
    readonly privateInterconnectInfo?: pulumi.Input<inputs.compute.v1.InterconnectAttachmentPrivateInfo>;
    /**
