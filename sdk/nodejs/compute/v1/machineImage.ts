...
export class MachineImage extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly instanceProperties!: pulumi.Output<outputs.compute.v1.InstancePropertiesResponse>;
    /**
     ...
     */
    public readonly machineImageEncryptionKey!: pulumi.Output<outputs.compute.v1.CustomerEncryptionKeyResponse>;
    /**
     ...
     */
    public readonly savedDisks!: pulumi.Output<outputs.compute.v1.SavedDiskResponse[]>;
    /**
     ...
     */
    public readonly sourceDiskEncryptionKeys!: pulumi.Output<outputs.compute.v1.SourceDiskEncryptionKeyResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sourceInstanceProperties!: pulumi.Output<outputs.compute.v1.SourceInstancePropertiesResponse>;
    /**
...
export interface MachineImageArgs {
     ...
     * Encrypts the machine image using a customer-supplied encryption key. After you encrypt a machine image using a customer-supplied key, you must provide the same key if you use the machine image later. For example, you must provide the encryption key when you create an instance from the encrypted machine image in a future request. Customer-supplied encryption keys do not protect access to metadata of the machine image. If you do not provide an encryption key when creating the machine image, then the machine image will be encrypted using an automatically generated key and you do not need to provide a key to use the machine image later.
     */
    machineImageEncryptionKey?: pulumi.Input<inputs.compute.v1.CustomerEncryptionKeyArgs>;
    /**
     * Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
     */
     ...
     * An array of Machine Image specific properties for disks attached to the source instance
     */
    savedDisks?: pulumi.Input<pulumi.Input<inputs.compute.v1.SavedDiskArgs>[]>;
    /**
     * [Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.
     */
    sourceDiskEncryptionKeys?: pulumi.Input<pulumi.Input<inputs.compute.v1.SourceDiskEncryptionKeyArgs>[]>;
    /**
     * The source instance used to create the machine image. You can provide this as a partial or full URL to the resource. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone /instances/instance - projects/project/zones/zone/instances/instance 
     */
