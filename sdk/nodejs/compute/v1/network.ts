...
export class Network extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/v1:Network';
     ...
     */
    public readonly peerings!: pulumi.Output<outputs.compute.v1.NetworkPeeringResponse[]>;
    /**
...
export interface NetworkArgs {
     ...
     * [Output Only] A list of network peerings for the resource.
     */
    readonly peerings?: pulumi.Input<pulumi.Input<inputs.compute.v1.NetworkPeering>[]>;
    readonly project: pulumi.Input<string>;
    /**
     * The network-level routing configuration for this network. Used by Cloud Router to determine what type of network-wide routing behavior to enforce.
     */
    readonly routingConfig?: pulumi.Input<inputs.compute.v1.NetworkRoutingConfig>;
    /**
     * [Output Only] Server-defined URL for the resource.
     */
