...
export class NetworkAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/v1:NetworkAttachment';
     ...
     */
    public /*out*/ readonly connectionEndpoints!: pulumi.Output<outputs.compute.v1.NetworkAttachmentConnectedEndpointResponse[]>;
...
export interface NetworkAttachmentArgs {
    connectionPreference?: pulumi.Input<enums.compute.v1.NetworkAttachmentConnectionPreference>;
    /**
     * An optional description of this resource. Provide this property when you create the resource.
     */
