...
export class NodeTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/v1:NodeTemplate';
...
export interface NodeTemplateArgs {
    readonly accelerators?: pulumi.Input<pulumi.Input<inputs.compute.v1.AcceleratorConfig>[]>;
    /**
     * CPU overcommit.
     */
    ...
    readonly disks?: pulumi.Input<pulumi.Input<inputs.compute.v1.LocalDisk>[]>;
    /**
     ...
     * See Sole-tenant node options for more information.
     */
    readonly serverBinding?: pulumi.Input<inputs.compute.v1.ServerBinding>;
    /**
     * [Output Only] The status of the node template. One of the following values: CREATING, READY, and DELETING.
     */
