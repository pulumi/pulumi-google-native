...
export class PublicAdvertisedPrefix extends pulumi.CustomResource {
     ...
     */
    public readonly publicDelegatedPrefixs!: pulumi.Output<outputs.compute.v1.PublicAdvertisedPrefixPublicDelegatedPrefixResponse[]>;
    /**
...
export interface PublicAdvertisedPrefixArgs {
     ...
     * [Output Only] The list of public delegated prefixes that exist for this public advertised prefix.
     */
    publicDelegatedPrefixs?: pulumi.Input<pulumi.Input<inputs.compute.v1.PublicAdvertisedPrefixPublicDelegatedPrefixArgs>[]>;
