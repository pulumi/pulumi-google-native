...
export class PublicDelegatedPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/v1:PublicDelegatedPrefix';
...
export interface PublicDelegatedPrefixArgs {
     ...
     */
    readonly publicDelegatedSubPrefixs?: pulumi.Input<pulumi.Input<inputs.compute.v1.PublicDelegatedPrefixPublicDelegatedSubPrefix>[]>;
    /**
