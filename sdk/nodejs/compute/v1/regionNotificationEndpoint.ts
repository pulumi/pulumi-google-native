...
export class RegionNotificationEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/v1:RegionNotificationEndpoint';
     ...
     */
    public readonly grpcSettings!: pulumi.Output<outputs.compute.v1.NotificationEndpointGrpcSettingsResponse>;
    /**
    ...
    constructor(name: string, args: RegionNotificationEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if ((!args || args.notificationEndpoint === undefined) && !opts.urn) {
                throw new Error("Missing required property 'notificationEndpoint'");
            }
...
export interface RegionNotificationEndpointArgs {
    ...
    readonly notificationEndpoint: pulumi.Input<string>;
