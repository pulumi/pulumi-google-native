...
export class RegionTargetTcpProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/v1:RegionTargetTcpProxy';
...
export interface RegionTargetTcpProxyArgs {
     ...
     * Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
     */
    proxyHeader?: pulumi.Input<enums.compute.v1.RegionTargetTcpProxyProxyHeader>;
