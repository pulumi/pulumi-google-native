...
export class Reservation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/v1:Reservation';
     ...
     */
    public readonly aggregateReservation!: pulumi.Output<outputs.compute.v1.AllocationAggregateReservationResponse>;
    /**
     ...
     */
    public /*out*/ readonly resourceStatus!: pulumi.Output<outputs.compute.v1.AllocationResourceStatusResponse>;
    /**
...
export interface ReservationArgs {
     ...
     * Reservation for aggregated resources, providing shape flexibility.
     */
    aggregateReservation?: pulumi.Input<inputs.compute.v1.AllocationAggregateReservationArgs>;
    /**
     * An optional description of this resource. Provide this property when you create the resource.
     */
