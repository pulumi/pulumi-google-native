...
export class Reservation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:compute/v1:Reservation';
...
export interface ReservationArgs {
     ...
     * Reservation for instances with specific machine shapes.
     */
    readonly specificReservation?: pulumi.Input<inputs.compute.v1.AllocationSpecificSKUReservation>;
    /**
     * Indicates whether the reservation can be consumed by VMs with affinity for "any" reservation. If the field is set, then only VMs that target the reservation by name can consume from this reservation.
     */
