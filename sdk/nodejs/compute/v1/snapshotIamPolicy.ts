...
export class SnapshotIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SnapshotIamPolicy {
        return new SnapshotIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/v1:SnapshotIamPolicy';
    ...
    constructor(name: string, args: SnapshotIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SnapshotIamPolicy.__pulumiType, name, inputs, opts);
    }
}
