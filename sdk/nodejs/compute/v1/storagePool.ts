...
export class StoragePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:compute/v1:StoragePool';
     ...
     */
    public /*out*/ readonly resourceStatus!: pulumi.Output<outputs.compute.v1.StoragePoolResourceStatusResponse>;
    /**
     ...
     * Status information for the storage pool resource.
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.compute.v1.StoragePoolResourceStatusResponse>;
    /**
...
export interface StoragePoolArgs {
     ...
     * Provisioning type of the byte capacity of the pool.
     */
    capacityProvisioningType?: pulumi.Input<enums.compute.v1.StoragePoolCapacityProvisioningType>;
    /**
     * An optional description of this resource. Provide this property when you create the resource.
     */
     ...
     * Provisioning type of the performance-related parameters of the pool, such as throughput and IOPS.
     */
    performanceProvisioningType?: pulumi.Input<enums.compute.v1.StoragePoolPerformanceProvisioningType>;
    /**
     * Size, in GiB, of the storage pool.
     */
