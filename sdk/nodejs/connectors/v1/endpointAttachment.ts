...
export class EndpointAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:connectors/v1:EndpointAttachment';
    ...
    constructor(name: string, args: EndpointAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["endpointAttachmentId", "location", "project"] };
