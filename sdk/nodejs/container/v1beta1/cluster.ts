...
export class Cluster extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly addonsConfig!: pulumi.Output<outputs.container.v1beta1.AddonsConfigResponse>;
    /**
     * Configuration controlling RBAC group membership information.
     */
    public /*out*/ readonly authenticatorGroupsConfig!: pulumi.Output<outputs.container.v1beta1.AuthenticatorGroupsConfigResponse>;
    /**
     * Autopilot configuration for the cluster.
     */
    public /*out*/ readonly autopilot!: pulumi.Output<outputs.container.v1beta1.AutopilotResponse>;
    /**
     * Cluster-level autoscaling configuration.
     */
    public /*out*/ readonly autoscaling!: pulumi.Output<outputs.container.v1beta1.ClusterAutoscalingResponse>;
    /**
     * Configuration for Binary Authorization.
     */
    public /*out*/ readonly binaryAuthorization!: pulumi.Output<outputs.container.v1beta1.BinaryAuthorizationResponse>;
    /**
     * The IP address range of the container pods in this cluster, in [CIDR](http://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) notation (e.g. `10.96.0.0/14`). Leave blank to have one automatically chosen or specify a `/14` block in `10.0.0.0/8`.
     */
    public /*out*/ readonly clusterIpv4Cidr!: pulumi.Output<string>;
    /**
     * Telemetry integration for the cluster.
     */
    public /*out*/ readonly clusterTelemetry!: pulumi.Output<outputs.container.v1beta1.ClusterTelemetryResponse>;
    /**
     ...
     */
    public /*out*/ readonly confidentialNodes!: pulumi.Output<outputs.container.v1beta1.ConfidentialNodesResponse>;
    /**
     ...
     */
    public /*out*/ readonly databaseEncryption!: pulumi.Output<outputs.container.v1beta1.DatabaseEncryptionResponse>;
    /**
     * The default constraint on the maximum number of pods that can be run simultaneously on a node in the node pool of this cluster. Only honored if cluster created with IP Alias support.
     */
    public /*out*/ readonly defaultMaxPodsConstraint!: pulumi.Output<outputs.container.v1beta1.MaxPodsConstraintResponse>;
    /**
     ...
     */
    public /*out*/ readonly enableKubernetesAlpha!: pulumi.Output<boolean>;
    /**
     * Enable the ability to use Cloud TPUs in this cluster. This field is deprecated, use tpu_config.enabled instead.
     */
    public /*out*/ readonly enableTpu!: pulumi.Output<boolean>;
    /**
     ...
     */
    public /*out*/ readonly ipAllocationPolicy!: pulumi.Output<outputs.container.v1beta1.IPAllocationPolicyResponse>;
    /**
     ...
     */
    public /*out*/ readonly legacyAbac!: pulumi.Output<outputs.container.v1beta1.LegacyAbacResponse>;
    /**
     ...
     */
    public /*out*/ readonly loggingService!: pulumi.Output<string>;
    /**
     * Configure the maintenance policy for this cluster.
     */
    public /*out*/ readonly maintenancePolicy!: pulumi.Output<outputs.container.v1beta1.MaintenancePolicyResponse>;
    /**
     * Configuration for master components.
     */
    public /*out*/ readonly master!: pulumi.Output<outputs.container.v1beta1.MasterResponse>;
    /**
     * The authentication information for accessing the master endpoint. If unspecified, the defaults are used: For clusters before v1.12, if master_auth is unspecified, `username` will be set to "admin", a random password will be generated, and a client certificate will be issued.
     */
    public /*out*/ readonly masterAuth!: pulumi.Output<outputs.container.v1beta1.MasterAuthResponse>;
    /**
     * The configuration options for master authorized networks feature.
     */
    public /*out*/ readonly masterAuthorizedNetworksConfig!: pulumi.Output<outputs.container.v1beta1.MasterAuthorizedNetworksConfigResponse>;
    /**
     ...
     */
    public /*out*/ readonly masterIpv4CidrBlock!: pulumi.Output<string>;
    /**
     * The monitoring service the cluster should use to write metrics. Currently available options: * "monitoring.googleapis.com/kubernetes" - The Cloud Monitoring service with a Kubernetes-native resource model * `monitoring.googleapis.com` - The legacy Cloud Monitoring service (no longer available as of GKE 1.15). * `none` - No metrics will be exported from the cluster. If left as an empty string,`monitoring.googleapis.com/kubernetes` will be used for GKE 1.14+ or `monitoring.googleapis.com` for earlier versions.
     */
    public /*out*/ readonly monitoringService!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly networkConfig!: pulumi.Output<outputs.container.v1beta1.NetworkConfigResponse>;
    /**
     * Configuration options for the NetworkPolicy feature.
     */
    public /*out*/ readonly networkPolicy!: pulumi.Output<outputs.container.v1beta1.NetworkPolicyResponse>;
    /**
     * Parameters used in creating the cluster's nodes. For requests, this field should only be used in lieu of a "node_pool" object, since this configuration (along with the "initial_node_count") will be used to create a "NodePool" object with an auto-generated name. Do not use this and a node_pool at the same time. For responses, this field will be populated with the node configuration of the first node pool. (For configuration of each node pool, see `node_pool.config`) If unspecified, the defaults are used. This field is deprecated, use node_pool.config instead.
     */
    public /*out*/ readonly nodeConfig!: pulumi.Output<outputs.container.v1beta1.NodeConfigResponse>;
    /**
     ...
     */
    public /*out*/ readonly nodePools!: pulumi.Output<outputs.container.v1beta1.NodePoolResponse[]>;
    /**
     * Notification configuration of the cluster.
     */
    public /*out*/ readonly notificationConfig!: pulumi.Output<outputs.container.v1beta1.NotificationConfigResponse>;
    /**
     * Configuration for the PodSecurityPolicy feature.
     */
    public /*out*/ readonly podSecurityPolicyConfig!: pulumi.Output<outputs.container.v1beta1.PodSecurityPolicyConfigResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateCluster!: pulumi.Output<boolean>;
    /**
     * Configuration for private cluster.
     */
    public /*out*/ readonly privateClusterConfig!: pulumi.Output<outputs.container.v1beta1.PrivateClusterConfigResponse>;
    /**
     * Release channel configuration.
     */
    public /*out*/ readonly releaseChannel!: pulumi.Output<outputs.container.v1beta1.ReleaseChannelResponse>;
    /**
     * The resource labels for the cluster to use to annotate any related Google Compute Engine resources.
     */
    public /*out*/ readonly resourceLabels!: pulumi.Output<{[key: string]: string}>;
    /**
     * Configuration for exporting resource usages. Resource usage export is disabled when this config unspecified.
     */
    public /*out*/ readonly resourceUsageExportConfig!: pulumi.Output<outputs.container.v1beta1.ResourceUsageExportConfigResponse>;
    /**
     ...
     */
    public /*out*/ readonly shieldedNodes!: pulumi.Output<outputs.container.v1beta1.ShieldedNodesResponse>;
    /**
     ...
     */
    public /*out*/ readonly tpuConfig!: pulumi.Output<outputs.container.v1beta1.TpuConfigResponse>;
    /**
     ...
     */
    public /*out*/ readonly verticalPodAutoscaling!: pulumi.Output<outputs.container.v1beta1.VerticalPodAutoscalingResponse>;
    /**
     * Configuration for the use of Kubernetes Service Accounts in GCP IAM policies.
     */
    public /*out*/ readonly workloadIdentityConfig!: pulumi.Output<outputs.container.v1beta1.WorkloadIdentityConfigResponse>;
    /**
