...
export class ProviderNoteIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:containeranalysis/v1alpha1:ProviderNoteIamPolicy';
    ...
    constructor(name: string, args: ProviderNoteIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProviderNoteIamPolicy.__pulumiType, name, inputs, opts);
    }
}
