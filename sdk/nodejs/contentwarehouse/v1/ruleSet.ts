...
export class RuleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:contentwarehouse/v1:RuleSet';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.contentwarehouse.v1.GoogleCloudContentwarehouseV1RuleResponse[]>;
    /**
...
export interface RuleSetArgs {
     ...
     * List of rules given by the customer.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.contentwarehouse.v1.GoogleCloudContentwarehouseV1RuleArgs>[]>;
    /**
     * Source of the rules i.e., customer name.
     */
