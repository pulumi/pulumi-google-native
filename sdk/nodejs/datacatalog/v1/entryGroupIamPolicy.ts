...
export class EntryGroupIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:datacatalog/v1:EntryGroupIamPolicy';
     ...
     */
    public readonly bindings!: pulumi.Output<outputs.datacatalog.v1.BindingResponse[]>;
    /**
...
export interface EntryGroupIamPolicyArgs {
     ...
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    bindings?: pulumi.Input<pulumi.Input<inputs.datacatalog.v1.BindingArgs>[]>;
