 ...
 */
export class EntryGroupEntryTag extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EntryGroupEntryTag {
        return new EntryGroupEntryTag(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:datacatalog/v1beta1:EntryGroupEntryTag';

    /**
     * Returns true if the given object is an instance of EntryGroupEntryTag.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EntryGroupEntryTag {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EntryGroupEntryTag.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: EntryGroupEntryTagArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EntryGroupEntryTag.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface EntryGroupEntryTagArgs {
    /**
