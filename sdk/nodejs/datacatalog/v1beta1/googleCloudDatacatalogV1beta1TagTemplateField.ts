 ...
 */
export class GoogleCloudDatacatalogV1beta1TagTemplateField extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudDatacatalogV1beta1TagTemplateField {
        return new GoogleCloudDatacatalogV1beta1TagTemplateField(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:datacatalog/v1beta1:GoogleCloudDatacatalogV1beta1TagTemplateField';

    /**
     * Returns true if the given object is an instance of GoogleCloudDatacatalogV1beta1TagTemplateField.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudDatacatalogV1beta1TagTemplateField {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudDatacatalogV1beta1TagTemplateField.__pulumiType;
    }
    ...
    constructor(name: string, args: GoogleCloudDatacatalogV1beta1TagTemplateFieldArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["tagTemplateFieldId"] = args ? args.tagTemplateFieldId : undefined;
 ...
 */
export interface GoogleCloudDatacatalogV1beta1TagTemplateFieldArgs {
    /**
     ...
     */
    readonly tagTemplateFieldId?: pulumi.Input<string>;
    /**
