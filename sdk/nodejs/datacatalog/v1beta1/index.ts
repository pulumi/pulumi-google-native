...
export * from "./getEntryGroup";
export * from "./getEntryGroupIamPolicy";
export * from "./getPolicyTag";
export * from "./getTagTemplate";
export * from "./getTagTemplateIamPolicy";
export * from "./getTaxonomy";
export * from "./getTaxonomyIamPolicy";
export * from "./getTaxonomyPolicyTagIamPolicy";
