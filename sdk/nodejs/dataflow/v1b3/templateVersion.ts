...
export class TemplateVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dataflow/v1b3:TemplateVersion';
    ...
    constructor(name: string, args: TemplateVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TemplateVersion.__pulumiType, name, inputs, opts);
    }
}
...
export interface TemplateVersionArgs {
     ...
     */
    readonly templateVersion?: pulumi.Input<inputs.dataflow.v1b3.TemplateVersion>;
}
