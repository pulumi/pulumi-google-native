...
export function getInstanceIamPolicy(args: GetInstanceIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceIamPolicyResult> {
    ...
    return pulumi.runtime.invoke("google-native:datafusion/v1:getInstanceIamPolicy", {
...
export interface GetInstanceIamPolicyResult {
     ...
     */
    readonly auditConfigs: outputs.datafusion.v1.AuditConfigResponse[];
    /**
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    readonly bindings: outputs.datafusion.v1.BindingResponse[];
    /**
