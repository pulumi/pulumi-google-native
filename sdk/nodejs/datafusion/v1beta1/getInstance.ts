...
export function getInstance(args: GetInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceResult> {
    ...
    return pulumi.runtime.invoke("google-native:datafusion/v1beta1:getInstance", {
...
export interface GetInstanceResult {
     ...
     */
    readonly accelerators: outputs.datafusion.v1beta1.AcceleratorResponse[];
    /**
     ...
     */
    readonly availableVersion: outputs.datafusion.v1beta1.VersionResponse[];
    /**
     ...
     */
    readonly networkConfig: outputs.datafusion.v1beta1.NetworkConfigResponse;
    /**
