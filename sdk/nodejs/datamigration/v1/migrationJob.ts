...
export class MigrationJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:datamigration/v1:MigrationJob';
...
export interface MigrationJobArgs {
     ...
     */
    readonly destinationDatabase?: pulumi.Input<inputs.datamigration.v1.DatabaseType>;
    /**
     ...
     */
    readonly error?: pulumi.Input<inputs.datamigration.v1.Status>;
    /**
     ...
     */
    readonly reverseSshConnectivity?: pulumi.Input<inputs.datamigration.v1.ReverseSshConnectivity>;
    /**
     ...
     */
    readonly sourceDatabase?: pulumi.Input<inputs.datamigration.v1.DatabaseType>;
    /**
     ...
     */
    readonly staticIpConnectivity?: pulumi.Input<inputs.datamigration.v1.StaticIpConnectivity>;
    /**
     ...
     */
    readonly vpcPeeringConnectivity?: pulumi.Input<inputs.datamigration.v1.VpcPeeringConnectivity>;
}
