 ...
 */
export class RegionJob extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegionJob {
        return new RegionJob(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is RegionJob {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RegionJob.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: RegionJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RegionJob.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface RegionJobArgs {
    /**
     * Optional. Job is a Hadoop job.
     */
