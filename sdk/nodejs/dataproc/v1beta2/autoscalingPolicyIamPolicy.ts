...
export class AutoscalingPolicyIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:dataproc/v1beta2:AutoscalingPolicyIamPolicy';
    ...
    constructor(name: string, args: AutoscalingPolicyIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["autoscalingPolicyId", "location", "project"] };
