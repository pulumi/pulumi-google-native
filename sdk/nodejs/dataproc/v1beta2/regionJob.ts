...
export class RegionJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcp-native:dataproc/v1beta2:RegionJob';
...
export interface RegionJobArgs {
     ...
     * Optional. Job is a Hadoop job.
     */
    readonly hadoopJob?: pulumi.Input<inputs.dataproc.v1beta2.HadoopJob>;
    /**
     * Optional. Job is a Hive job.
     */
    readonly hiveJob?: pulumi.Input<inputs.dataproc.v1beta2.HiveJob>;
     ...
     * Optional. Job is a Pig job.
     */
    readonly pigJob?: pulumi.Input<inputs.dataproc.v1beta2.PigJob>;
    /**
     * Required. Job information, including how, when, and where to run the job.
     */
    readonly placement?: pulumi.Input<inputs.dataproc.v1beta2.JobPlacement>;
    /**
     * Optional. Job is a Presto job.
     */
    readonly prestoJob?: pulumi.Input<inputs.dataproc.v1beta2.PrestoJob>;
    readonly projectId: pulumi.Input<string>;
    /**
     * Optional. Job is a PySpark job.
     */
    readonly pysparkJob?: pulumi.Input<inputs.dataproc.v1beta2.PySparkJob>;
    /**
     * Optional. The fully qualified reference to the job, which can be used to obtain the equivalent REST path of the job resource. If this property is not specified when a job is created, the server generates a job_id.
     */
    readonly reference?: pulumi.Input<inputs.dataproc.v1beta2.JobReference>;
     ...
     * Optional. Job scheduling configuration.
     */
    readonly scheduling?: pulumi.Input<inputs.dataproc.v1beta2.JobScheduling>;
    /**
     * Optional. Job is a Spark job.
     */
    readonly sparkJob?: pulumi.Input<inputs.dataproc.v1beta2.SparkJob>;
    /**
     * Optional. Job is a SparkR job.
     */
    readonly sparkRJob?: pulumi.Input<inputs.dataproc.v1beta2.SparkRJob>;
    /**
     * Optional. Job is a SparkSql job.
     */
    readonly sparkSqlJob?: pulumi.Input<inputs.dataproc.v1beta2.SparkSqlJob>;
}
