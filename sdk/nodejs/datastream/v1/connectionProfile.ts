...
export class ConnectionProfile extends pulumi.CustomResource {
     ...
     */
    public readonly sqlServerProfile!: pulumi.Output<outputs.datastream.v1.SqlServerProfileResponse>;
    /**
    ...
    constructor(name: string, args: ConnectionProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sqlServerProfile"] = undefined /*out*/;
...
export interface ConnectionProfileArgs {
     ...
     * SQLServer Connection Profile configuration.
     */
    sqlServerProfile?: pulumi.Input<inputs.datastream.v1.SqlServerProfileArgs>;
    /**
     * Static Service IP connectivity.
     */
