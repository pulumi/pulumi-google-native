...
export class Deployment extends pulumi.CustomResource {
     ...
     */
    public readonly outputs!: pulumi.Output<outputs.deploymentmanager.alpha.DeploymentOutputEntryResponse[]>;
    /**
     ...
     */
    public readonly update!: pulumi.Output<outputs.deploymentmanager.alpha.DeploymentUpdateResponse>;
    /**
...
export interface DeploymentArgs {
     ...
     * List of outputs from the last manifest that deployed successfully.
     */
    outputs?: pulumi.Input<pulumi.Input<inputs.deploymentmanager.alpha.DeploymentOutputEntryArgs>[]>;
     ...
     * If Deployment Manager is currently updating or previewing an update to this deployment, the updated configuration appears here.
     */
    update?: pulumi.Input<inputs.deploymentmanager.alpha.DeploymentUpdateArgs>;
    /**
     * Update timestamp in RFC3339 text format.
     */
