...
export class TypeProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:deploymentmanager/alpha:TypeProvider';
...
export interface TypeProviderArgs {
     ...
     */
    readonly collectionOverrides?: pulumi.Input<pulumi.Input<inputs.deploymentmanager.alpha.CollectionOverride>[]>;
    /**
     ...
     */
    readonly labels?: pulumi.Input<pulumi.Input<inputs.deploymentmanager.alpha.TypeProviderLabelEntry>[]>;
    /**
