...
export class DeploymentIamPolicy extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly auditConfigs!: pulumi.Output<outputs.deploymentmanager.v2.AuditConfigResponse[]>;
    /**
...
export interface DeploymentIamPolicyArgs {
     ...
     */
    readonly policy?: pulumi.Input<inputs.deploymentmanager.v2.Policy>;
