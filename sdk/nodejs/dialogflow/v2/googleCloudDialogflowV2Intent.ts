 ...
 */
export class GoogleCloudDialogflowV2Intent extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudDialogflowV2Intent {
        return new GoogleCloudDialogflowV2Intent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dialogflow/v2:GoogleCloudDialogflowV2Intent';

    /**
     * Returns true if the given object is an instance of GoogleCloudDialogflowV2Intent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudDialogflowV2Intent {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudDialogflowV2Intent.__pulumiType;
    }
 ...
 */
export interface GoogleCloudDialogflowV2IntentArgs {
    /**
