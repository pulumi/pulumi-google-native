...
export class GoogleLongrunningOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dialogflow/v2:GoogleLongrunningOperation';
...
export interface GoogleLongrunningOperationArgs {
     ...
     */
    readonly latestReloadStatus?: pulumi.Input<inputs.dialogflow.v2.GoogleCloudDialogflowV2DocumentReloadStatus>;
    /**
