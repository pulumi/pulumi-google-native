 ...
 */
export class AgentEnvironmentUserSessionContext extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AgentEnvironmentUserSessionContext {
        return new AgentEnvironmentUserSessionContext(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:dialogflow/v2beta1:AgentEnvironmentUserSessionContext';

    /**
     * Returns true if the given object is an instance of AgentEnvironmentUserSessionContext.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AgentEnvironmentUserSessionContext {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AgentEnvironmentUserSessionContext.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AgentEnvironmentUserSessionContextArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AgentEnvironmentUserSessionContext.__pulumiType, name, inputs, opts);
    }
}
