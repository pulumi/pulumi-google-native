 ...
 */
export class AgentKnowledgeBaseDocument extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AgentKnowledgeBaseDocument {
        return new AgentKnowledgeBaseDocument(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:dialogflow/v2beta1:AgentKnowledgeBaseDocument';

    /**
     * Returns true if the given object is an instance of AgentKnowledgeBaseDocument.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AgentKnowledgeBaseDocument {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AgentKnowledgeBaseDocument.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AgentKnowledgeBaseDocumentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AgentKnowledgeBaseDocument.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface AgentKnowledgeBaseDocumentArgs {
    /**
     * The raw content of the document. This field is only permitted for EXTRACTIVE_QA and FAQ knowledge types. Note: This field is in the process of being deprecated, please use raw_content instead.
     */
