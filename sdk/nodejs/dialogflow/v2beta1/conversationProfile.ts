...
export class ConversationProfile extends pulumi.CustomResource {
     ...
     */
    public readonly ttsConfig!: pulumi.Output<outputs.dialogflow.v2beta1.GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse>;
    /**
...
export interface ConversationProfileArgs {
     ...
     * Configuration for Text-to-Speech synthesization. Used by Phone Gateway to specify synthesization options. If agent defines synthesization options as well, agent settings overrides the option here.
     */
    ttsConfig?: pulumi.Input<inputs.dialogflow.v2beta1.GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgs>;
}
