 ...
 */
export class GoogleCloudDialogflowV2beta1Conversation extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudDialogflowV2beta1Conversation {
        return new GoogleCloudDialogflowV2beta1Conversation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dialogflow/v2beta1:GoogleCloudDialogflowV2beta1Conversation';

    /**
     * Returns true if the given object is an instance of GoogleCloudDialogflowV2beta1Conversation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudDialogflowV2beta1Conversation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudDialogflowV2beta1Conversation.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: GoogleCloudDialogflowV2beta1ConversationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GoogleCloudDialogflowV2beta1Conversation.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface GoogleCloudDialogflowV2beta1ConversationArgs {
    /**
