...
export class Flow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:dialogflow/v3:Flow';
...
export interface FlowArgs {
     ...
     * NLU related settings of the flow.
     */
    nluSettings?: pulumi.Input<inputs.dialogflow.v3.GoogleCloudDialogflowCxV3NluSettingsArgs>;
