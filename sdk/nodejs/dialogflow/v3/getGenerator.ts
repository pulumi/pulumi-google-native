...
export function getGenerator(args: GetGeneratorArgs, opts?: pulumi.InvokeOptions): Promise<GetGeneratorResult> {
    ...
    return pulumi.runtime.invoke("google-native:dialogflow/v3:getGenerator", {
...
export interface GetGeneratorResult {
     ...
     */
    readonly placeholders: outputs.dialogflow.v3.GoogleCloudDialogflowCxV3GeneratorPlaceholderResponse[];
    /**
     * Prompt for the LLM model.
     */
    readonly promptText: outputs.dialogflow.v3.GoogleCloudDialogflowCxV3PhraseResponse;
}
/**
 * Retrieves the specified generator.
 */
