...
export function getSecuritySetting(args: GetSecuritySettingArgs, opts?: pulumi.InvokeOptions): Promise<GetSecuritySettingResult> {
    ...
    return pulumi.runtime.invoke("google-native:dialogflow/v3:getSecuritySetting", {
...
export interface GetSecuritySettingResult {
     ...
     */
    readonly audioExportSettings: outputs.dialogflow.v3.GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsResponse;
    /**
     ...
     */
    readonly insightsExportSettings: outputs.dialogflow.v3.GoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettingsResponse;
    /**
