 ...
 */
export class GoogleCloudDialogflowCxV3Agent extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudDialogflowCxV3Agent {
        return new GoogleCloudDialogflowCxV3Agent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Agent';

    /**
     * Returns true if the given object is an instance of GoogleCloudDialogflowCxV3Agent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudDialogflowCxV3Agent {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudDialogflowCxV3Agent.__pulumiType;
    }
 ...
 */
export interface GoogleCloudDialogflowCxV3AgentArgs {
    /**
