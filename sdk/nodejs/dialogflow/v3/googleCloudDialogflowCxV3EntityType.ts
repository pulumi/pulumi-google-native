 ...
 */
export class GoogleCloudDialogflowCxV3EntityType extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudDialogflowCxV3EntityType {
        return new GoogleCloudDialogflowCxV3EntityType(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3EntityType';

    /**
     * Returns true if the given object is an instance of GoogleCloudDialogflowCxV3EntityType.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudDialogflowCxV3EntityType {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudDialogflowCxV3EntityType.__pulumiType;
    }
 ...
 */
export interface GoogleCloudDialogflowCxV3EntityTypeArgs {
    /**
