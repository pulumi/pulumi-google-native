 ...
 */
export class GoogleCloudDialogflowCxV3Page extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudDialogflowCxV3Page {
        return new GoogleCloudDialogflowCxV3Page(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Page';

    /**
     * Returns true if the given object is an instance of GoogleCloudDialogflowCxV3Page.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudDialogflowCxV3Page {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudDialogflowCxV3Page.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: GoogleCloudDialogflowCxV3PageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GoogleCloudDialogflowCxV3Page.__pulumiType, name, inputs, opts);
    }
}
