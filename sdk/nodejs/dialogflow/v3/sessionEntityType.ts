...
export class SessionEntityType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:dialogflow/v3:SessionEntityType';
    ...
    constructor(name: string, args: SessionEntityTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["agentId", "environmentId", "location", "project", "sessionId"] };
