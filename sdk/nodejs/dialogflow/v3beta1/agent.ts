...
export class Agent extends pulumi.CustomResource {
     ...
     */
    public readonly textToSpeechSettings!: pulumi.Output<outputs.dialogflow.v3beta1.GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse>;
    /**
...
export interface AgentArgs {
     ...
     * Settings on instructing the speech synthesizer on how to generate the output audio content.
     */
    textToSpeechSettings?: pulumi.Input<inputs.dialogflow.v3beta1.GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsArgs>;
    /**
     * The time zone of the agent from the [time zone database](https://www.iana.org/time-zones), e.g., America/New_York, Europe/Paris.
     */
