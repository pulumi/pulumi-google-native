...
export class AgentFlow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:dialogflow/v3beta1:AgentFlow';
...
export interface AgentFlowArgs {
     ...
     * NLU related settings of the flow.
     */
    readonly nluSettings?: pulumi.Input<inputs.dialogflow.v3beta1.GoogleCloudDialogflowCxV3beta1NluSettingsArgs>;
