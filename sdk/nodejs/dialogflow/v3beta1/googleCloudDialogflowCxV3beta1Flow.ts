 ...
 */
export class GoogleCloudDialogflowCxV3beta1Flow extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudDialogflowCxV3beta1Flow {
        return new GoogleCloudDialogflowCxV3beta1Flow(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Flow';

    /**
     * Returns true if the given object is an instance of GoogleCloudDialogflowCxV3beta1Flow.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudDialogflowCxV3beta1Flow {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudDialogflowCxV3beta1Flow.__pulumiType;
    }


    /**
     * Create a GoogleCloudDialogflowCxV3beta1Flow resource with the given unique name, arguments, and options.
     *
 ...
 */
export interface GoogleCloudDialogflowCxV3beta1FlowArgs {
    /**
