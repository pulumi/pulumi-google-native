 ...
 */
export class GoogleCloudDialogflowCxV3beta1SecuritySettings extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudDialogflowCxV3beta1SecuritySettings {
        return new GoogleCloudDialogflowCxV3beta1SecuritySettings(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1SecuritySettings';

    /**
     * Returns true if the given object is an instance of GoogleCloudDialogflowCxV3beta1SecuritySettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudDialogflowCxV3beta1SecuritySettings {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudDialogflowCxV3beta1SecuritySettings.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: GoogleCloudDialogflowCxV3beta1SecuritySettingsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GoogleCloudDialogflowCxV3beta1SecuritySettings.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface GoogleCloudDialogflowCxV3beta1SecuritySettingsArgs {
    /**
