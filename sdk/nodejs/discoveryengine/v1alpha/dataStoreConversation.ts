 ...
 */
export class DataStoreConversation extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataStoreConversation {
        return new DataStoreConversation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:discoveryengine/v1alpha:DataStoreConversation';

    /**
     * Returns true if the given object is an instance of DataStoreConversation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataStoreConversation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DataStoreConversation.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DataStoreConversationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DataStoreConversation.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DataStoreConversationArgs {
     ...
     * The state of the Conversation.
     */
    state?: pulumi.Input<enums.discoveryengine.v1alpha.DataStoreConversationState>;
    /**
     * A unique identifier for tracking users.
     */
