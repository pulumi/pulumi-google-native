...
export class EngineConversation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:discoveryengine/v1alpha:EngineConversation';
...
export interface EngineConversationArgs {
     ...
     * The state of the Conversation.
     */
    state?: pulumi.Input<enums.discoveryengine.v1alpha.EngineConversationState>;
    /**
     * A unique identifier for tracking users.
     */
