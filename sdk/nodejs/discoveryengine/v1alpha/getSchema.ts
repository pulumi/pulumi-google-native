...
export function getSchema(args: GetSchemaArgs, opts?: pulumi.InvokeOptions): Promise<GetSchemaResult> {
    ...
    return pulumi.runtime.invoke("google-native:discoveryengine/v1alpha:getSchema", {
...
export interface GetSchemaResult {
     ...
     */
    readonly fieldConfigs: outputs.discoveryengine.v1alpha.GoogleCloudDiscoveryengineV1alphaFieldConfigResponse[];
    /**
