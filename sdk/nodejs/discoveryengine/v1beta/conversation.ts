...
export class Conversation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:discoveryengine/v1beta:Conversation';
...
export interface ConversationArgs {
     ...
     * The state of the Conversation.
     */
    state?: pulumi.Input<enums.discoveryengine.v1beta.ConversationState>;
    /**
     * A unique identifier for tracking users.
     */
