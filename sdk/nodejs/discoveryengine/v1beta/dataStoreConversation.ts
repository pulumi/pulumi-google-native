...
export class DataStoreConversation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:discoveryengine/v1beta:DataStoreConversation';
...
export interface DataStoreConversationArgs {
     ...
     * The state of the Conversation.
     */
    state?: pulumi.Input<enums.discoveryengine.v1beta.DataStoreConversationState>;
    /**
     * A unique identifier for tracking users.
     */
