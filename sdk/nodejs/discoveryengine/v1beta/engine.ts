...
export class Engine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:discoveryengine/v1beta:Engine';
     ...
     */
    public readonly chatEngineConfig!: pulumi.Output<outputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigResponse>;
    /**
     * Additional information of the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
     */
    public /*out*/ readonly chatEngineMetadata!: pulumi.Output<outputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadataResponse>;
    public readonly collectionId!: pulumi.Output<string>;
    /**
     * Common config spec that specifies the metadata of the engine.
     */
    public readonly commonConfig!: pulumi.Output<outputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaEngineCommonConfigResponse>;
    /**
     ...
     */
    public readonly searchEngineConfig!: pulumi.Output<outputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigResponse>;
    /**
...
export interface EngineArgs {
     ...
     * Configurations for the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
     */
    chatEngineConfig?: pulumi.Input<inputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigArgs>;
    collectionId: pulumi.Input<string>;
    /**
     * Common config spec that specifies the metadata of the engine.
     */
    commonConfig?: pulumi.Input<inputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaEngineCommonConfigArgs>;
    /**
     * The data stores associated with this engine. For SOLUTION_TYPE_SEARCH and SOLUTION_TYPE_RECOMMENDATION type of engines, they can only associate with at most one data store. If solution_type is SOLUTION_TYPE_CHAT, multiple DataStores in the same Collection can be associated here. Note that when used in CreateEngineRequest, one DataStore id must be provided as the system will use it for necessary initializations.
     */
     ...
     * The industry vertical that the engine registers. The restriction of the Engine industry vertical is based on DataStore: If unspecified, default to `GENERIC`. Vertical on Engine has to match vertical of the DataStore liniked to the engine.
     */
    industryVertical?: pulumi.Input<enums.discoveryengine.v1beta.EngineIndustryVertical>;
     ...
     * Configurations for the Search Engine. Only applicable if solution_type is SOLUTION_TYPE_SEARCH.
     */
    searchEngineConfig?: pulumi.Input<inputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigArgs>;
    /**
     * The solutions of the engine.
     */
    solutionType: pulumi.Input<enums.discoveryengine.v1beta.EngineSolutionType>;
}
