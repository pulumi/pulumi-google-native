...
export class TargetSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:discoveryengine/v1beta:TargetSite';
     ...
     * Failure reason.
     */
    public /*out*/ readonly failureReason!: pulumi.Output<outputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaTargetSiteFailureReasonResponse>;
    /**
     ...
     */
    public /*out*/ readonly siteVerificationInfo!: pulumi.Output<outputs.discoveryengine.v1beta.GoogleCloudDiscoveryengineV1betaSiteVerificationInfoResponse>;
    /**
...
export interface TargetSiteArgs {
     ...
     * The type of the target site, e.g., whether the site is to be included or excluded.
     */
    type?: pulumi.Input<enums.discoveryengine.v1beta.TargetSiteType>;
}
