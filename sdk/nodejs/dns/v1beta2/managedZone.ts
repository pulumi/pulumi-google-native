...
export class ManagedZone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:dns/v1beta2:ManagedZone';
...
export interface ManagedZoneArgs {
     ...
     */
    readonly dnssecConfig?: pulumi.Input<inputs.dns.v1beta2.ManagedZoneDnsSecConfig>;
    /**
     * The presence for this field indicates that outbound forwarding is enabled for this zone. The value of this field contains the set of destinations to forward to.
     */
    readonly forwardingConfig?: pulumi.Input<inputs.dns.v1beta2.ManagedZoneForwardingConfig>;
    /**
     ...
     */
    readonly peeringConfig?: pulumi.Input<inputs.dns.v1beta2.ManagedZonePeeringConfig>;
    /**
     * For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from.
     */
    readonly privateVisibilityConfig?: pulumi.Input<inputs.dns.v1beta2.ManagedZonePrivateVisibilityConfig>;
