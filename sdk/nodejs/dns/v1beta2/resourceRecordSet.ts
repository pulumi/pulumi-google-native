...
export class ResourceRecordSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:dns/v1beta2:ResourceRecordSet';
     ...
     */
    public readonly routingPolicy!: pulumi.Output<outputs.dns.v1beta2.RRSetRoutingPolicyResponse>;
    /**
    ...
    constructor(name: string, args: ResourceRecordSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["routingPolicy"] = undefined /*out*/;
