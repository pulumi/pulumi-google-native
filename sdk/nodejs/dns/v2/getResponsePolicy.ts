...
export function getResponsePolicy(args: GetResponsePolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetResponsePolicyResult> {
    ...
    return pulumi.runtime.invoke("google-native:dns/v2:getResponsePolicy", {
...
export interface GetResponsePolicyResult {
     ...
     */
    readonly gkeClusters: outputs.dns.v2.ResponsePolicyGKEClusterResponse[];
    /**
     ...
     */
    readonly networks: outputs.dns.v2.ResponsePolicyNetworkResponse[];
    /**
