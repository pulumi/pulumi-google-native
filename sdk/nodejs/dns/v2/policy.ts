...
export class Policy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:dns/v2:Policy';
...
export interface PolicyArgs {
     ...
     * Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name server that you choose. Names such as .internal are not available when an alternative name server is specified.
     */
    alternativeNameServerConfig?: pulumi.Input<inputs.dns.v2.PolicyAlternativeNameServerConfigArgs>;
    /**
     ...
     * List of network names specifying networks to which this policy is applied.
     */
    networks?: pulumi.Input<pulumi.Input<inputs.dns.v2.PolicyNetworkArgs>[]>;
