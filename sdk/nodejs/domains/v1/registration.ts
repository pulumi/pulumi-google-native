...
export class Registration extends pulumi.CustomResource {
     ...
     */
    public readonly contactSettings!: pulumi.Output<outputs.domains.v1.ContactSettingsResponse>;
    /**
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.domains.v1.DnsSettingsResponse>;
    /**
     ...
     */
    public readonly managementSettings!: pulumi.Output<outputs.domains.v1.ManagementSettingsResponse>;
    /**
...
export interface RegistrationArgs {
     ...
     */
    contactNotices?: pulumi.Input<pulumi.Input<enums.domains.v1.RegistrationContactNoticesItem>[]>;
    /**
     * Settings for contact information linked to the `Registration`. You cannot update these with the `UpdateRegistration` method. To update these settings, use the `ConfigureContactSettings` method.
     */
    contactSettings: pulumi.Input<inputs.domains.v1.ContactSettingsArgs>;
    /**
     * Settings controlling the DNS configuration of the `Registration`. You cannot update these with the `UpdateRegistration` method. To update these settings, use the `ConfigureDnsSettings` method.
     */
    dnsSettings?: pulumi.Input<inputs.domains.v1.DnsSettingsArgs>;
    /**
     * Immutable. The domain name. Unicode domain names must be expressed in Punycode format.
     */
     ...
     */
    domainNotices?: pulumi.Input<pulumi.Input<enums.domains.v1.RegistrationDomainNoticesItem>[]>;
    /**
     * Set of labels associated with the `Registration`.
     */
     ...
     * Settings for management of the `Registration`, including renewal, billing, and transfer. You cannot update these with the `UpdateRegistration` method. To update these settings, use the `ConfigureManagementSettings` method.
     */
    managementSettings?: pulumi.Input<inputs.domains.v1.ManagementSettingsArgs>;
     ...
     */
    yearlyPrice: pulumi.Input<inputs.domains.v1.MoneyArgs>;
}
