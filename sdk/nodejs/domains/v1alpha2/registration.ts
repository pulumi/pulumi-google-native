...
export class Registration extends pulumi.CustomResource {
     ...
     */
    public readonly managementSettings!: pulumi.Output<outputs.domains.v1alpha2.ManagementSettingsResponse>;
    /**
...
export interface RegistrationArgs {
     ...
     */
    domainNotices?: pulumi.Input<pulumi.Input<enums.domains.v1alpha2.RegistrationDomainNoticesItem>[]>;
    /**
     * Set of labels associated with the `Registration`.
     */
