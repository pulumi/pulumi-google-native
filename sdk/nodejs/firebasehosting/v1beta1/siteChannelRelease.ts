 ...
 */
export class SiteChannelRelease extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SiteChannelRelease {
        return new SiteChannelRelease(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:firebasehosting/v1beta1:SiteChannelRelease';

    /**
     * Returns true if the given object is an instance of SiteChannelRelease.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SiteChannelRelease {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SiteChannelRelease.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: SiteChannelReleaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SiteChannelRelease.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface SiteChannelReleaseArgs {
