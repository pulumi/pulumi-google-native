...
export class Ruleset extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RulesetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.rulesetsId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'rulesetsId'");
            }
            inputs["createTime"] = args ? args.createTime : undefined;
            inputs["metadata"] = args ? args.metadata : undefined;
            inputs["name"] = args ? args.name : undefined;
            inputs["projectsId"] = args ? args.projectsId : undefined;
            inputs["rulesetsId"] = args ? args.rulesetsId : undefined;
...
export interface RulesetArgs {
     ...
     * The metadata for this ruleset. Output only.
     */
    readonly metadata?: pulumi.Input<inputs.firebaserules.v1.MetadataArgs>;
    /**
     * Name of the `Ruleset`. The ruleset_id is auto generated by the service. Format: `projects/{project_id}/rulesets/{ruleset_id}` Output only.
     */
    readonly name?: pulumi.Input<string>;
    readonly projectsId: pulumi.Input<string>;
    readonly rulesetsId: pulumi.Input<string>;
    /**
     * `Source` for the `Ruleset`.
     */
    readonly source?: pulumi.Input<inputs.firebaserules.v1.SourceArgs>;
}
