...
export class DatabaseCollectionGroupIndex extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:firestore/v1beta2:DatabaseCollectionGroupIndex';
...
export interface DatabaseCollectionGroupIndexArgs {
     ...
     */
    readonly fields?: pulumi.Input<pulumi.Input<inputs.firestore.v1beta2.GoogleFirestoreAdminV1beta2IndexField>[]>;
