...
export function getGameServerCluster(args: GetGameServerClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetGameServerClusterResult> {
    ...
    return pulumi.runtime.invoke("google-native:gameservices/v1:getGameServerCluster", {
...
export interface GetGameServerClusterResult {
     ...
     */
    readonly connectionInfo: outputs.gameservices.v1.GameServerClusterConnectionInfoResponse;
    /**
     * The creation time.
     */
