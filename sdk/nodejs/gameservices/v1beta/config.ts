...
export interface ConfigArgs {
     ...
     * FleetConfig contains a list of Agones fleet specs. Only one FleetConfig is allowed.
     */
    fleetConfigs?: pulumi.Input<pulumi.Input<inputs.gameservices.v1beta.FleetConfigArgs>[]>;
     ...
     * The autoscaling settings.
     */
    scalingConfigs?: pulumi.Input<pulumi.Input<inputs.gameservices.v1beta.ScalingConfigArgs>[]>;
}
