...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:gkehub/v1:Binding';
     ...
     */
    public /*out*/ readonly state!: pulumi.Output<outputs.gkehub.v1.MembershipBindingLifecycleStateResponse>;
    /**
