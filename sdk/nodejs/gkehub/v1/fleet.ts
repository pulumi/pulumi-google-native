...
export class Fleet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:gkehub/v1:Fleet';
     ...
     */
    public readonly defaultClusterConfig!: pulumi.Output<outputs.gkehub.v1.DefaultClusterConfigResponse>;
    /**
     ...
     */
    public /*out*/ readonly state!: pulumi.Output<outputs.gkehub.v1.FleetLifecycleStateResponse>;
    /**
...
export interface FleetArgs {
     ...
     * Optional. The default cluster configurations to apply across the fleet.
     */
    defaultClusterConfig?: pulumi.Input<inputs.gkehub.v1.DefaultClusterConfigArgs>;
    /**
     * Optional. A user-assigned display name of the Fleet. When present, it must be between 4 to 30 characters. Allowed characters are: lowercase and uppercase letters, numbers, hyphen, single-quote, double-quote, space, and exclamation point. Example: `Production Fleet`
     */
