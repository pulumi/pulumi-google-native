...
export function getMembershipIamPolicy(args: GetMembershipIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetMembershipIamPolicyResult> {
    ...
    return pulumi.runtime.invoke("google-native:gkehub/v1:getMembershipIamPolicy", {
...
export interface GetMembershipIamPolicyResult {
     ...
     */
    readonly auditConfigs: outputs.gkehub.v1.AuditConfigResponse[];
    /**
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    readonly bindings: outputs.gkehub.v1.BindingResponse[];
    /**
