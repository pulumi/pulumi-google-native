...
export class Membership extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:gkehub/v1alpha:Membership';
     ...
     */
    public readonly monitoringConfig!: pulumi.Output<outputs.gkehub.v1alpha.MonitoringConfigResponse>;
    /**
...
export interface MembershipArgs {
     ...
     * Optional. The monitoring config information for this membership.
     */
    monitoringConfig?: pulumi.Input<inputs.gkehub.v1alpha.MonitoringConfigArgs>;
