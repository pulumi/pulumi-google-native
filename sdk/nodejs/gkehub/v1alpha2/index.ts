...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "gcp-native:gkehub/v1alpha2:Membership":
                return new Membership(name, <any>undefined, { urn })
            case "gcp-native:gkehub/v1alpha2:MembershipIamPolicy":
...
pulumi.runtime.registerResourceModule("gcp-native", "gkehub/v1alpha2", _module)
