...
export function getMembership(args: GetMembershipArgs, opts?: pulumi.InvokeOptions): Promise<GetMembershipResult> {
    ...
    return pulumi.runtime.invoke("google-native:gkehub/v1beta:getMembership", {
...
export interface GetMembershipResult {
     ...
     */
    readonly authority: outputs.gkehub.v1beta.AuthorityResponse;
    /**
     ...
     */
    readonly endpoint: outputs.gkehub.v1beta.MembershipEndpointResponse;
    /**
     ...
     */
    readonly monitoringConfig: outputs.gkehub.v1beta.MonitoringConfigResponse;
    /**
     ...
     */
    readonly state: outputs.gkehub.v1beta.MembershipStateResponse;
    /**
