...
export class Membership extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:gkehub/v1beta:Membership';
     ...
     */
    public readonly authority!: pulumi.Output<outputs.gkehub.v1beta.AuthorityResponse>;
    /**
     ...
     */
    public readonly endpoint!: pulumi.Output<outputs.gkehub.v1beta.MembershipEndpointResponse>;
    /**
     ...
     */
    public readonly monitoringConfig!: pulumi.Output<outputs.gkehub.v1beta.MonitoringConfigResponse>;
    /**
     ...
     */
    public /*out*/ readonly state!: pulumi.Output<outputs.gkehub.v1beta.MembershipStateResponse>;
    /**
...
export interface MembershipArgs {
     ...
     * Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
     */
    authority?: pulumi.Input<inputs.gkehub.v1beta.AuthorityArgs>;
    /**
     * Optional. Endpoint information to reach this member.
     */
    endpoint?: pulumi.Input<inputs.gkehub.v1beta.MembershipEndpointArgs>;
    /**
     * Optional. An externally-generated and managed ID for this Membership. This ID may be modified after creation, but this is not recommended. The ID must match the regex: `a-zA-Z0-9*` If this Membership represents a Kubernetes cluster, this value should be set to the UID of the `kube-system` namespace object.
     */
     ...
     * Optional. The monitoring config information for this membership.
     */
    monitoringConfig?: pulumi.Input<inputs.gkehub.v1beta.MonitoringConfigArgs>;
