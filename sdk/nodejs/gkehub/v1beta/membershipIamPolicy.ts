...
export class MembershipIamPolicy extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly auditConfigs!: pulumi.Output<outputs.gkehub.v1beta.AuditConfigResponse[]>;
    /**
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.gkehub.v1beta.BindingResponse[]>;
    /**
