...
export class Scope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:gkehub/v1beta:Scope';
     ...
     */
    public /*out*/ readonly state!: pulumi.Output<outputs.gkehub.v1beta.ScopeLifecycleStateResponse>;
    /**
