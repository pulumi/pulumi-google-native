...
export class AttributeDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:healthcare/v1:AttributeDefinition';
...
export interface AttributeDefinitionArgs {
     ...
     * The category of the attribute. The value of this field cannot be changed after creation.
     */
    category: pulumi.Input<enums.healthcare.v1.AttributeDefinitionCategory>;
    /**
     * Optional. Default values of the attribute in Consents. If no default values are specified, it defaults to an empty value.
     */
