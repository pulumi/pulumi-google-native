 ...
 */
export class DatasetConsentStoreConsent extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatasetConsentStoreConsent {
        return new DatasetConsentStoreConsent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:healthcare/v1:DatasetConsentStoreConsent';
     ...
     */
    public static isInstance(obj: any): obj is DatasetConsentStoreConsent {
     ...
     */
    constructor(name: string, args: DatasetConsentStoreConsentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatasetConsentStoreConsent.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface DatasetConsentStoreConsentArgs {
    /**
     * Required. The resource name of the Consent artifact that contains proof of the end user's consent, of the form `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/consentStores/{consent_store_id}/consentArtifacts/{consent_artifact_id}`.
     */
     ...
     * Optional. Represents a user's consent in terms of the resources that can be accessed and under what conditions.
     */
    readonly policies?: pulumi.Input<pulumi.Input<inputs.healthcare.v1.GoogleCloudHealthcareV1ConsentPolicyArgs>[]>;
