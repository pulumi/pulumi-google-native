...
export interface ConsentArtifactArgs {
     ...
     * Optional. Screenshots, PDFs, or other binary information documenting the user's consent.
     */
    readonly consentContentScreenshots?: pulumi.Input<pulumi.Input<inputs.healthcare.v1beta1.ImageArgs>[]>;
    /**
     * Optional. An string indicating the version of the consent information shown to the user.
     */
     ...
     * Optional. User's signature.
     */
    readonly userSignature?: pulumi.Input<inputs.healthcare.v1beta1.SignatureArgs>;
    /**
     * Optional. A signature from a witness.
     */
    readonly witnessSignature?: pulumi.Input<inputs.healthcare.v1beta1.SignatureArgs>;
}
