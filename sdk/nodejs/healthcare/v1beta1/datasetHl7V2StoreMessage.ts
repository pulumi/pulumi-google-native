...
export interface DatasetHl7V2StoreMessageArgs {
     ...
     * All patient IDs listed in the PID-2, PID-3, and PID-4 segments of this message.
     */
    readonly patientIds?: pulumi.Input<pulumi.Input<inputs.healthcare.v1beta1.PatientId>[]>;
    readonly projectsId: pulumi.Input<string>;
    /**
     * The parsed version of the raw message data schematized according to this store's schemas and type definitions.
     */
    readonly schematizedData?: pulumi.Input<inputs.healthcare.v1beta1.SchematizedData>;
    /**
     * The hospital that this message came from. MSH-4.
     */
