...
export function getDatasetDicomStoreIamPolicy(args: GetDatasetDicomStoreIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDatasetDicomStoreIamPolicyResult> {
    ...
    return pulumi.runtime.invoke("google-native:healthcare/v1beta1:getDatasetDicomStoreIamPolicy", {
...
export interface GetDatasetDicomStoreIamPolicyArgs {
    datasetId: string;
    dicomStoreId: string;
    location: string;
...
export interface GetDatasetDicomStoreIamPolicyResult {
    /**
