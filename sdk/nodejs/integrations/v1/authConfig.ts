...
export class AuthConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:integrations/v1:AuthConfig';
     ...
     */
    public readonly decryptedCredential!: pulumi.Output<outputs.integrations.v1.GoogleCloudIntegrationsV1alphaCredentialResponse>;
    /**
...
export interface AuthConfigArgs {
     ...
     * Credential type of the encrypted credential.
     */
    credentialType?: pulumi.Input<enums.integrations.v1.AuthConfigCredentialType>;
    /**
     * Raw auth credentials.
     */
    decryptedCredential?: pulumi.Input<inputs.integrations.v1.GoogleCloudIntegrationsV1alphaCredentialArgs>;
    /**
     * A description of the auth config.
     */
     ...
     * The status of the auth config.
     */
    state?: pulumi.Input<enums.integrations.v1.AuthConfigState>;
    /**
     * The time until the auth config is valid. Empty or max value is considered the auth config won't expire.
     */
     ...
     * The visibility of the auth config.
     */
    visibility?: pulumi.Input<enums.integrations.v1.AuthConfigVisibility>;
}
