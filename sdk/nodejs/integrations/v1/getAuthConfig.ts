...
export function getAuthConfig(args: GetAuthConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthConfigResult> {
    ...
    return pulumi.runtime.invoke("google-native:integrations/v1:getAuthConfig", {
...
export interface GetAuthConfigResult {
     ...
     */
    readonly decryptedCredential: outputs.integrations.v1.GoogleCloudIntegrationsV1alphaCredentialResponse;
    /**
