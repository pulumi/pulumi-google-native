...
export function getCertificate(args: GetCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetCertificateResult> {
    ...
    return pulumi.runtime.invoke("google-native:integrations/v1:getCertificate", {
...
export interface GetCertificateResult {
     ...
     */
    readonly rawCertificate: outputs.integrations.v1.GoogleCloudIntegrationsV1alphaClientCertificateResponse;
    /**
