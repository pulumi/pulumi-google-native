...
// Export enums:
export * from "../../types/enums/integrations/v1";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:integrations/v1:AuthConfig":
                return new AuthConfig(name, <any>undefined, { urn })
            case "google-native:integrations/v1:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "google-native:integrations/v1:SfdcChannel":
                return new SfdcChannel(name, <any>undefined, { urn })
            case "google-native:integrations/v1:SfdcInstance":
                return new SfdcInstance(name, <any>undefined, { urn })
            case "google-native:integrations/v1:Version":
...
pulumi.runtime.registerResourceModule("google-native", "integrations/v1", _module)
