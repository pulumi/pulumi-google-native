...
export class Company extends pulumi.CustomResource {
     ...
     */
    public readonly derivedInfo!: pulumi.Output<outputs.jobs.v3p1beta1.CompanyDerivedInfoResponse>;
    /**
...
export interface CompanyArgs {
     ...
     * Derived details about the company.
     */
    readonly derivedInfo?: pulumi.Input<inputs.jobs.v3p1beta1.CompanyDerivedInfo>;
    /**
     * Required. The display name of the company, for example, "Google LLC".
     */
