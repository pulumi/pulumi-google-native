...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:jobs/v3p1beta1:Job';
     ...
     */
    public readonly applicationInfo!: pulumi.Output<outputs.jobs.v3p1beta1.ApplicationInfoResponse>;
    /**
     ...
     */
    public readonly compensationInfo!: pulumi.Output<outputs.jobs.v3p1beta1.CompensationInfoResponse>;
    /**
     ...
     */
    public readonly derivedInfo!: pulumi.Output<outputs.jobs.v3p1beta1.JobDerivedInfoResponse>;
    /**
     ...
     */
    public readonly processingOptions!: pulumi.Output<outputs.jobs.v3p1beta1.ProcessingOptionsResponse>;
    /**
...
export interface JobArgs {
     ...
     * Required. At least one field within ApplicationInfo must be specified. Job application information.
     */
    readonly applicationInfo?: pulumi.Input<inputs.jobs.v3p1beta1.ApplicationInfo>;
    /**
     * Display name of the company listing the job.
     */
     ...
     * Optional. Job compensation information.
     */
    readonly compensationInfo?: pulumi.Input<inputs.jobs.v3p1beta1.CompensationInfo>;
    /**
     * Optional. A map of fields to hold both filterable and non-filterable custom job attributes that are not covered by the provided structured fields. The keys of the map are strings up to 64 bytes and must match the pattern: a-zA-Z*. For example, key0LikeThis or KEY_1_LIKE_THIS. At most 100 filterable and at most 100 unfilterable keys are supported. For filterable `string_values`, across all keys at most 200 values are allowed, with each string no more than 255 characters. For unfilterable `string_values`, the maximum total size of `string_values` across all keys is 50KB.
     */
     ...
     * Derived details about the job posting.
     */
    readonly derivedInfo?: pulumi.Input<inputs.jobs.v3p1beta1.JobDerivedInfo>;
    /**
     * Required. The description of the job, which typically includes a multi-paragraph description of the company and related information. Separate fields are provided on the job object for responsibilities, qualifications, and other job characteristics. Use of these separate job fields is recommended. This field accepts and sanitizes HTML input, and also accepts bold, italic, ordered list, and unordered list markup tags. The maximum number of allowed characters is 100,000.
     */
     ...
     * Optional. Options for job processing.
     */
    readonly processingOptions?: pulumi.Input<inputs.jobs.v3p1beta1.ProcessingOptions>;
