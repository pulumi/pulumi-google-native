...
export class TenantJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:jobs/v4:TenantJob';
...
export interface TenantJobArgs {
     ...
     */
    readonly companyDisplayName?: pulumi.Input<string>;
    /**
     ...
     */
    readonly derivedInfo?: pulumi.Input<inputs.jobs.v4.JobDerivedInfo>;
    /**
     ...
     */
    readonly postingCreateTime?: pulumi.Input<string>;
    /**
     ...
     */
    readonly postingUpdateTime?: pulumi.Input<string>;
    /**
