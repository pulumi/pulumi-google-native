 ...
 */
export class BillingAccountBucketLink extends pulumi.CustomResource {
    /**
     * Get an existing BillingAccountBucketLink resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BillingAccountBucketLink {
        return new BillingAccountBucketLink(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:logging/v2:BillingAccountBucketLink';

    /**
     * Returns true if the given object is an instance of BillingAccountBucketLink.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BillingAccountBucketLink {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === BillingAccountBucketLink.__pulumiType;
    }
    ...
    /**
     * Create a BillingAccountBucketLink resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: BillingAccountBucketLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["billingAccountId", "bucketId", "linkId", "location"] };
        opts = pulumi.mergeOptions(opts, replaceOnChanges);
        super(BillingAccountBucketLink.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface BillingAccountBucketLinkArgs {
    /**
     * Optional. The information of a BigQuery Dataset. When a link is created, a BigQuery dataset is created along with it, in the same project as the LogBucket it's linked to. This dataset will also have BigQuery Views corresponding to the LogViews in the bucket.
     */
