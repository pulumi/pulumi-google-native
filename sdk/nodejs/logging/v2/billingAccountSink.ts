...
export class BillingAccountSink extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BillingAccountSink {
        return new BillingAccountSink(name, undefined as any, { ...opts, id: id });
    }
