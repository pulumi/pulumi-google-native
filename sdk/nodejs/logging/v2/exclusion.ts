 ...
 */
export class Exclusion extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Exclusion {
        return new Exclusion(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:logging/v2:Exclusion';

    /**
     * Returns true if the given object is an instance of Exclusion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Exclusion {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Exclusion.__pulumiType;
    }
    ...
    constructor(name: string, args: ExclusionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Exclusion.__pulumiType, name, inputs, opts);
    }
}
