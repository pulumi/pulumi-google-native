...
export class LogView extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LogView {
        return new LogView(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:logging/v2:LogView';
    ...
    constructor(name: string, args: LogViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogView.__pulumiType, name, inputs, opts);
    }
}
