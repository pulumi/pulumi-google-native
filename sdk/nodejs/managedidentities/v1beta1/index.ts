...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "google-native:managedidentities/v1beta1:DomainBackupIamBinding":
                return new DomainBackupIamBinding(name, <any>undefined, { urn })
            case "google-native:managedidentities/v1beta1:DomainBackupIamMember":
            ...
            case "google-native:managedidentities/v1beta1:DomainIamBinding":
                return new DomainIamBinding(name, <any>undefined, { urn })
            case "google-native:managedidentities/v1beta1:DomainIamMember":
            ...
            case "google-native:managedidentities/v1beta1:PeeringIamBinding":
                return new PeeringIamBinding(name, <any>undefined, { urn })
            case "google-native:managedidentities/v1beta1:PeeringIamMember":
