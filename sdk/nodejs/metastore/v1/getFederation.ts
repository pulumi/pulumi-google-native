...
export function getFederation(args: GetFederationArgs, opts?: pulumi.InvokeOptions): Promise<GetFederationResult> {
    ...
    return pulumi.runtime.invoke("google-native:metastore/v1:getFederation", {
...
export interface GetFederationResult {
     ...
     */
    readonly backendMetastores: {[key: string]: outputs.metastore.v1.BackendMetastoreResponse};
    /**
