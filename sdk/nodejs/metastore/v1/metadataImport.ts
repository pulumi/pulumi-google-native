...
export class MetadataImport extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:metastore/v1:MetadataImport';
     ...
     */
    public readonly databaseDump!: pulumi.Output<outputs.metastore.v1.DatabaseDumpResponse>;
    /**
...
export interface MetadataImportArgs {
     ...
     * Immutable. A database dump from a pre-existing metastore's database.
     */
    databaseDump?: pulumi.Input<inputs.metastore.v1.DatabaseDumpArgs>;
    /**
     * The description of the metadata import.
     */
