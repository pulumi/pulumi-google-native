...
export class Service extends pulumi.CustomResource {
     ...
     */
    public readonly scalingConfig!: pulumi.Output<outputs.metastore.v1alpha.ScalingConfigResponse>;
    /**
     * Optional. The configuration of scheduled backup for the metastore service.
     */
    public readonly scheduledBackup!: pulumi.Output<outputs.metastore.v1alpha.ScheduledBackupResponse>;
    /**
...
export interface ServiceArgs {
     ...
     * Scaling configuration of the metastore service.
     */
    scalingConfig?: pulumi.Input<inputs.metastore.v1alpha.ScalingConfigArgs>;
    /**
     * Optional. The configuration of scheduled backup for the metastore service.
     */
    scheduledBackup?: pulumi.Input<inputs.metastore.v1alpha.ScheduledBackupArgs>;
    /**
     * Required. The ID of the metastore service, which is used as the final component of the metastore service's name.This value must be between 2 and 63 characters long inclusive, begin with a letter, end with a letter or number, and consist of alpha-numeric ASCII characters or hyphens.
     */
