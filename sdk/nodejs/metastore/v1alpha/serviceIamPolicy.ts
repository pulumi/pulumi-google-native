...
export class ServiceIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:metastore/v1alpha:ServiceIamPolicy';
     ...
     */
    public /*out*/ readonly auditConfigs!: pulumi.Output<outputs.metastore.v1alpha.AuditConfigResponse[]>;
    /**
     * Associates a list of members to a role. Optionally, may specify a condition that determines how and when the bindings are applied. Each of the bindings must contain at least one member.
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.metastore.v1alpha.BindingResponse[]>;
    /**
...
export interface ServiceIamPolicyArgs {
     ...
     */
    readonly policy?: pulumi.Input<inputs.metastore.v1alpha.Policy>;
