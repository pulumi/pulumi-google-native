...
export class DiscoveryClient extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:migrationcenter/v1:DiscoveryClient';
     ...
     */
    public /*out*/ readonly errors!: pulumi.Output<outputs.migrationcenter.v1.StatusResponse[]>;
    /**
