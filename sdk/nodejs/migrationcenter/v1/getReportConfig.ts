...
export function getReportConfig(args: GetReportConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetReportConfigResult> {
    ...
    return pulumi.runtime.invoke("google-native:migrationcenter/v1:getReportConfig", {
...
export interface GetReportConfigResult {
     ...
     */
    readonly groupPreferencesetAssignments: outputs.migrationcenter.v1.ReportConfigGroupPreferenceSetAssignmentResponse[];
    /**
     * Name of resource.
     */
