...
export class ReportConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:migrationcenter/v1:ReportConfig';
     ...
     */
    public readonly groupPreferencesetAssignments!: pulumi.Output<outputs.migrationcenter.v1.ReportConfigGroupPreferenceSetAssignmentResponse[]>;
...
export interface ReportConfigArgs {
     ...
     * Collection of combinations of groups and preference sets.
     */
    groupPreferencesetAssignments: pulumi.Input<pulumi.Input<inputs.migrationcenter.v1.ReportConfigGroupPreferenceSetAssignmentArgs>[]>;
