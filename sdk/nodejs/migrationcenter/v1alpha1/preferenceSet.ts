...
export class PreferenceSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:migrationcenter/v1alpha1:PreferenceSet';
    ...
    public readonly preferenceSetId!: pulumi.Output<string | undefined>;
     ...
     */
    public readonly virtualMachinePreferences!: pulumi.Output<outputs.migrationcenter.v1alpha1.VirtualMachinePreferencesResponse>;
...
export interface PreferenceSetArgs {
     ...
     * A set of preferences that applies to all virtual machines in the context.
     */
    virtualMachinePreferences?: pulumi.Input<inputs.migrationcenter.v1alpha1.VirtualMachinePreferencesArgs>;
}
