...
export class Report extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:migrationcenter/v1alpha1:Report';
     ...
     */
    public /*out*/ readonly summary!: pulumi.Output<outputs.migrationcenter.v1alpha1.ReportSummaryResponse>;
    /**
     * Report type.
     */
    ...
    constructor(name: string, args: ReportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["location", "project", "reportConfigId", "reportId"] };
...
export interface ReportArgs {
     ...
     * Report creation state.
     */
    state?: pulumi.Input<enums.migrationcenter.v1alpha1.ReportState>;
    /**
     * Report type.
     */
    type?: pulumi.Input<enums.migrationcenter.v1alpha1.ReportType>;
}
