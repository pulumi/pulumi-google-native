 ...
 */
export class GoogleCloudMlV1__Model extends pulumi.CustomResource {
    /**
     * Get an existing GoogleCloudMlV1__Model resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudMlV1__Model {
        return new GoogleCloudMlV1__Model(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:ml/v1:GoogleCloudMlV1__Model';

    /**
     * Returns true if the given object is an instance of GoogleCloudMlV1__Model.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudMlV1__Model {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudMlV1__Model.__pulumiType;
    }


    /**
     * Create a GoogleCloudMlV1__Model resource with the given unique name, arguments, and options.
     *
 ...
 */
export interface GoogleCloudMlV1__ModelArgs {
    /**
