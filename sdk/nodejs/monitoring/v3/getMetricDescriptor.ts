...
export interface GetMetricDescriptorArgs {
    metricDescriptorId: string;
    project?: string;
}

export interface GetMetricDescriptorResult {
    /**
     ...
     */
    readonly labels: outputs.monitoring.v3.LabelDescriptorResponse[];
    /**
     ...
     */
    readonly metadata: outputs.monitoring.v3.MetricDescriptorMetadataResponse;
    /**
