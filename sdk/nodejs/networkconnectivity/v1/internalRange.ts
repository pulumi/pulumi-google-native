...
export class InternalRange extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:networkconnectivity/v1:InternalRange';
...
export interface InternalRangeArgs {
     ...
     * The type of usage set for this InternalRange.
     */
    usage?: pulumi.Input<enums.networkconnectivity.v1.InternalRangeUsage>;
}
