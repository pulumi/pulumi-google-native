...
export class ConnectivityTest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:networkmanagement/v1beta1:ConnectivityTest';
    ...
    constructor(name: string, args: ConnectivityTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            inputs["probingDetails"] = args ? args.probingDetails : undefined;
...
export interface ConnectivityTestArgs {
     ...
     */
    readonly destination?: pulumi.Input<inputs.networkmanagement.v1beta1.Endpoint>;
    /**
     ...
     */
    readonly probingDetails?: pulumi.Input<inputs.networkmanagement.v1beta1.ProbingDetails>;
    /**
     ...
     */
    readonly reachabilityDetails?: pulumi.Input<inputs.networkmanagement.v1beta1.ReachabilityDetails>;
    /**
     ...
     */
    readonly source?: pulumi.Input<inputs.networkmanagement.v1beta1.Endpoint>;
    /**
