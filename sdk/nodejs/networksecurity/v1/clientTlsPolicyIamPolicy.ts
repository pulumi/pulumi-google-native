...
export class ClientTlsPolicyIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:networksecurity/v1:ClientTlsPolicyIamPolicy';
    ...
    constructor(name: string, args: ClientTlsPolicyIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClientTlsPolicyIamPolicy.__pulumiType, name, inputs, opts);
    }
}
