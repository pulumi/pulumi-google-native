...
export class AddressGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:networksecurity/v1beta1:AddressGroup';
...
export interface AddressGroupArgs {
     ...
     * The type of the Address Group. Possible values are "IPv4" or "IPV6".
     */
    type: pulumi.Input<enums.networksecurity.v1beta1.AddressGroupType>;
}
