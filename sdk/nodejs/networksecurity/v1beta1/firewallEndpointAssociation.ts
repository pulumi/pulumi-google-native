...
export class FirewallEndpointAssociation extends pulumi.CustomResource {
     ...
     */
    public readonly firewallEndpointAssociationId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args: FirewallEndpointAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.firewallEndpointAssociationId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'firewallEndpointAssociationId'");
            }
        ...
        const replaceOnChanges = { replaceOnChanges: ["firewallEndpointAssociationId", "location", "project"] };
