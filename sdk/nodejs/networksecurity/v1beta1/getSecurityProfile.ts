...
export function getSecurityProfile(args: GetSecurityProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityProfileResult> {
    ...
    return pulumi.runtime.invoke("google-native:networksecurity/v1beta1:getSecurityProfile", {
...
export interface GetSecurityProfileResult {
     ...
     */
    readonly threatPreventionProfile: outputs.networksecurity.v1beta1.ThreatPreventionProfileResponse;
    /**
