 ...
 */
export class ServerTlsPolicyIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerTlsPolicyIamPolicy {
        return new ServerTlsPolicyIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:networksecurity/v1beta1:ServerTlsPolicyIamPolicy';

    /**
     * Returns true if the given object is an instance of ServerTlsPolicyIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ServerTlsPolicyIamPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServerTlsPolicyIamPolicy.__pulumiType;
    }
    ...
    /**
     * Create a ServerTlsPolicyIamPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ServerTlsPolicyIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServerTlsPolicyIamPolicy.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface ServerTlsPolicyIamPolicyArgs {
    /**
     * Specifies cloud audit logging configuration for this policy.
     */
