 ...
 */
export function getLbTrafficExtension(args: GetLbTrafficExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetLbTrafficExtensionResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("google-native:networkservices/v1:getLbTrafficExtension", {
        "lbTrafficExtensionId": args.lbTrafficExtensionId,
        "location": args.location,
        "project": args.project,
    }, opts);
}

export interface GetLbTrafficExtensionArgs {
    lbTrafficExtensionId: string;
    location: string;
    project?: string;
}

export interface GetLbTrafficExtensionResult {
    /**
     ...
     */
    readonly extensionChains: outputs.networkservices.v1.ExtensionChainResponse[];
    /**
 ...
 * Gets details of the specified `LbTrafficExtension` resource.
 */
export function getLbTrafficExtensionOutput(args: GetLbTrafficExtensionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetLbTrafficExtensionResult> {
    return pulumi.output(args).apply((a: any) => getLbTrafficExtension(a, opts))
}

export interface GetLbTrafficExtensionOutputArgs {
