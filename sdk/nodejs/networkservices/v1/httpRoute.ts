...
export class HttpRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:networkservices/v1:HttpRoute';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.networkservices.v1.HttpRouteRouteRuleResponse[]>;
    /**
...
export interface HttpRouteArgs {
     ...
     * Rules that define how traffic is routed and handled. Rules will be matched sequentially based on the RouteMatch specified for the rule.
     */
    rules: pulumi.Input<pulumi.Input<inputs.networkservices.v1.HttpRouteRouteRuleArgs>[]>;
}
