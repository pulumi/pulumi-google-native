...
export class TcpRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:networkservices/v1:TcpRoute';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.networkservices.v1.TcpRouteRouteRuleResponse[]>;
    /**
...
export interface TcpRouteArgs {
     ...
     * Rules that define how traffic is routed and handled. At least one RouteRule must be supplied. If there are multiple rules then the action taken will be the first rule to match.
     */
    rules: pulumi.Input<pulumi.Input<inputs.networkservices.v1.TcpRouteRouteRuleArgs>[]>;
    /**
     * Required. Short name of the TcpRoute resource to be created. E.g. TODO(Add an example).
     */
