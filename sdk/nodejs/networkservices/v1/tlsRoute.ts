...
export class TlsRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:networkservices/v1:TlsRoute';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.networkservices.v1.TlsRouteRouteRuleResponse[]>;
    /**
...
export interface TlsRouteArgs {
     ...
     * Rules that define how traffic is routed and handled. At least one RouteRule must be supplied. If there are multiple rules then the action taken will be the first rule to match.
     */
    rules: pulumi.Input<pulumi.Input<inputs.networkservices.v1.TlsRouteRouteRuleArgs>[]>;
    /**
     * Required. Short name of the TlsRoute resource to be created. E.g. TODO(Add an example).
     */
