...
export class LbTrafficExtension extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LbTrafficExtension {
        return new LbTrafficExtension(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:networkservices/v1beta1:LbTrafficExtension';
     ...
     */
    public readonly lbTrafficExtensionId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args: LbTrafficExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.lbTrafficExtensionId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'lbTrafficExtensionId'");
            }
            ...
            resourceInputs["lbTrafficExtensionId"] = args ? args.lbTrafficExtensionId : undefined;
            ...
            resourceInputs["lbTrafficExtensionId"] = undefined /*out*/;
        ...
        const replaceOnChanges = { replaceOnChanges: ["lbTrafficExtensionId", "location", "project"] };
...
export interface LbTrafficExtensionArgs {
     ...
     * Required. User-provided ID of the `LbTrafficExtension` resource to be created.
     */
    lbTrafficExtensionId: pulumi.Input<string>;
    /**
     * All backend services and forwarding rules referenced by this extension must share the same load balancing scheme. Supported values: `INTERNAL_MANAGED`, `EXTERNAL_MANAGED`. For more information, refer to [Choosing a load balancer](https://cloud.google.com/load-balancing/docs/backend-service).
     */
    loadBalancingScheme: pulumi.Input<enums.networkservices.v1beta1.LbTrafficExtensionLoadBalancingScheme>;
