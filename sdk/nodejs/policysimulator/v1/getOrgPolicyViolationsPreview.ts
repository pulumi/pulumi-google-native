...
export function getOrgPolicyViolationsPreview(args: GetOrgPolicyViolationsPreviewArgs, opts?: pulumi.InvokeOptions): Promise<GetOrgPolicyViolationsPreviewResult> {
    ...
    return pulumi.runtime.invoke("google-native:policysimulator/v1:getOrgPolicyViolationsPreview", {
...
export interface GetOrgPolicyViolationsPreviewResult {
     ...
     */
    readonly overlay: outputs.policysimulator.v1.GoogleCloudPolicysimulatorV1OrgPolicyOverlayResponse;
    /**
     * A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
     */
    readonly resourceCounts: outputs.policysimulator.v1.GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreviewResourceCountsResponse;
    /**
