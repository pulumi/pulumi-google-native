...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-cloud:policysimulator/v1:FolderReplay":
                return new FolderReplay(name, <any>undefined, { urn })
            case "google-cloud:policysimulator/v1:OrganizationReplay":
                return new OrganizationReplay(name, <any>undefined, { urn })
            case "google-cloud:policysimulator/v1:Replay":
...
pulumi.runtime.registerResourceModule("google-cloud", "policysimulator/v1", _module)
