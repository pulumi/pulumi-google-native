...
export class FolderReplay extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:policysimulator/v1alpha:FolderReplay';
     ...
     */
    public readonly config!: pulumi.Output<outputs.policysimulator.v1alpha.GoogleCloudPolicysimulatorV1alphaReplayConfigResponse>;
     ...
     */
    public /*out*/ readonly resultsSummary!: pulumi.Output<outputs.policysimulator.v1alpha.GoogleCloudPolicysimulatorV1alphaReplayResultsSummaryResponse>;
    /**
...
export interface FolderReplayArgs {
     ...
     * The configuration used for the `Replay`.
     */
    config: pulumi.Input<inputs.policysimulator.v1alpha.GoogleCloudPolicysimulatorV1alphaReplayConfigArgs>;
