...
export function getFolderReplay(args: GetFolderReplayArgs, opts?: pulumi.InvokeOptions): Promise<GetFolderReplayResult> {
    ...
    return pulumi.runtime.invoke("google-native:policysimulator/v1alpha:getFolderReplay", {
...
export interface GetFolderReplayResult {
     ...
     */
    readonly config: outputs.policysimulator.v1alpha.GoogleCloudPolicysimulatorV1alphaReplayConfigResponse;
    /**
     ...
     */
    readonly resultsSummary: outputs.policysimulator.v1alpha.GoogleCloudPolicysimulatorV1alphaReplayResultsSummaryResponse;
    /**
...
export function getFolderReplayOutput(args: GetFolderReplayOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFolderReplayResult> {
    return pulumi.output(args).apply((a: any) => getFolderReplay(a, opts))
}
