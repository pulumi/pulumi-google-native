...
export class OrgPolicyViolationsPreview extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:policysimulator/v1alpha:OrgPolicyViolationsPreview';
     ...
     */
    public readonly overlay!: pulumi.Output<outputs.policysimulator.v1alpha.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponse>;
    /**
     * A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
     */
    public /*out*/ readonly resourceCounts!: pulumi.Output<outputs.policysimulator.v1alpha.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponse>;
    /**
...
export interface OrgPolicyViolationsPreviewArgs {
     ...
     * The proposed changes we are previewing violations for.
     */
    overlay: pulumi.Input<inputs.policysimulator.v1alpha.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayArgs>;
}
