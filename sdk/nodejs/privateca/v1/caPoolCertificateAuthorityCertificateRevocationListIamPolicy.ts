 ...
 */
export class CaPoolCertificateAuthorityCertificateRevocationListIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CaPoolCertificateAuthorityCertificateRevocationListIamPolicy {
        return new CaPoolCertificateAuthorityCertificateRevocationListIamPolicy(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is CaPoolCertificateAuthorityCertificateRevocationListIamPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CaPoolCertificateAuthorityCertificateRevocationListIamPolicy.__pulumiType;
    }

    /**
     * Specifies cloud audit logging configuration for this policy.
     */
    public readonly auditConfigs!: pulumi.Output<outputs.privateca.v1.AuditConfigResponse[]>;
    /**
     * Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
     */
    public readonly bindings!: pulumi.Output<outputs.privateca.v1.BindingResponse[]>;
    public readonly caPoolId!: pulumi.Output<string>;
    public readonly certificateAuthorityId!: pulumi.Output<string>;
    public readonly certificateRevocationListId!: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a CaPoolCertificateAuthorityCertificateRevocationListIamPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["certificateRevocationListId"] = undefined /*out*/;
 ...
 */
export interface CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs {
    /**
     * Specifies cloud audit logging configuration for this policy.
     */
    auditConfigs?: pulumi.Input<pulumi.Input<inputs.privateca.v1.AuditConfigArgs>[]>;
    /**
     * Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
     */
    bindings?: pulumi.Input<pulumi.Input<inputs.privateca.v1.BindingArgs>[]>;
