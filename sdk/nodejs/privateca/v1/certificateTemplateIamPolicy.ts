...
export class CertificateTemplateIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CertificateTemplateIamPolicy {
        return new CertificateTemplateIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:privateca/v1:CertificateTemplateIamPolicy';
    ...
    constructor(name: string, args: CertificateTemplateIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CertificateTemplateIamPolicy.__pulumiType, name, inputs, opts);
    }
}
