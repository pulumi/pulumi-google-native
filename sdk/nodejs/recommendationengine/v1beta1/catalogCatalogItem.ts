 ...
 */
export class CatalogCatalogItem extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CatalogCatalogItem {
        return new CatalogCatalogItem(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:recommendationengine/v1beta1:CatalogCatalogItem';

    /**
     * Returns true if the given object is an instance of CatalogCatalogItem.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CatalogCatalogItem {
     ...
     */
    constructor(name: string, args: CatalogCatalogItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CatalogCatalogItem.__pulumiType, name, inputs, opts);
    }
}
