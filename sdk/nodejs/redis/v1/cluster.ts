...
export class Cluster extends pulumi.CustomResource {
     ...
     */
    public readonly persistenceConfig!: pulumi.Output<outputs.redis.v1.ClusterPersistenceConfigResponse>;
    /**
...
export interface ClusterArgs {
     ...
     * Optional. The type of a redis node in the cluster. NodeType determines the underlying machine-type of a redis node.
     */
    nodeType?: pulumi.Input<enums.redis.v1.ClusterNodeType>;
    /**
     * Optional. Persistence config (RDB, AOF) for the cluster.
     */
    persistenceConfig?: pulumi.Input<inputs.redis.v1.ClusterPersistenceConfigArgs>;
