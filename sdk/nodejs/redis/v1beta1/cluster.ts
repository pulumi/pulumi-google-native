...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:redis/v1beta1:Cluster';
     ...
     */
    public /*out*/ readonly discoveryEndpoints!: pulumi.Output<outputs.redis.v1beta1.DiscoveryEndpointResponse[]>;
     ...
     */
    public readonly pscConfigs!: pulumi.Output<outputs.redis.v1beta1.PscConfigResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly stateInfo!: pulumi.Output<outputs.redis.v1beta1.StateInfoResponse>;
    /**
...
export interface ClusterArgs {
     ...
     * Optional. The authorization mode of the Redis cluster. If not provided, auth feature is disabled for the cluster.
     */
    authorizationMode?: pulumi.Input<enums.redis.v1beta1.ClusterAuthorizationMode>;
    /**
     * Required. The logical name of the Redis cluster in the customer project with the following restrictions: * Must contain only lowercase letters, numbers, and hyphens. * Must start with a letter. * Must be between 1-63 characters. * Must end with a number or a letter. * Must be unique within the customer project / location
     */
     ...
     * Optional. The in-transit encryption for the Redis cluster. If not provided, encryption is disabled for the cluster.
     */
    transitEncryptionMode?: pulumi.Input<enums.redis.v1beta1.ClusterTransitEncryptionMode>;
}
