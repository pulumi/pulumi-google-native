...
export class Control extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:retail/v2:Control';
     ...
     */
    public readonly rule!: pulumi.Output<outputs.retail.v2.GoogleCloudRetailV2RuleResponse>;
    /**
...
export interface ControlArgs {
     ...
     * A rule control - a condition-action pair. Enacts a set action when the condition is triggered. For example: Boost "gShoe" when query full matches "Running Shoes".
     */
    rule?: pulumi.Input<inputs.retail.v2.GoogleCloudRetailV2RuleArgs>;
    /**
     * Specifies the use case for the control. Affects what condition fields can be set. Only settable by search controls. Will default to SEARCH_SOLUTION_USE_CASE_SEARCH if not specified. Currently only allow one search_solution_use_case per control.
     */
    searchSolutionUseCase?: pulumi.Input<pulumi.Input<enums.retail.v2.ControlSearchSolutionUseCaseItem>[]>;
    /**
     * Immutable. The solution types that the control is used for. Currently we support setting only one type of solution at creation time. Only `SOLUTION_TYPE_SEARCH` value is supported at the moment. If no solution type is provided at creation time, will default to SOLUTION_TYPE_SEARCH.
     */
    solutionTypes: pulumi.Input<pulumi.Input<enums.retail.v2.ControlSolutionTypesItem>[]>;
}
