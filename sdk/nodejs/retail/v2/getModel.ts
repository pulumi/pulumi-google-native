...
export function getModel(args: GetModelArgs, opts?: pulumi.InvokeOptions): Promise<GetModelResult> {
    ...
    return pulumi.runtime.invoke("google-native:retail/v2:getModel", {
...
export interface GetModelResult {
     ...
     */
    readonly modelFeaturesConfig: outputs.retail.v2.GoogleCloudRetailV2ModelModelFeaturesConfigResponse;
    /**
     ...
     */
    readonly servingConfigLists: outputs.retail.v2.GoogleCloudRetailV2ModelServingConfigListResponse[];
    /**
