...
export interface GetProductResult {
     ...
     */
    readonly attributes: {[key: string]: outputs.retail.v2.GoogleCloudRetailV2CustomAttributeResponse};
    /**
     * The target group associated with a given audience (e.g. male, veterans, car owners, musicians, etc.) of the product.
     */
    readonly audience: outputs.retail.v2.GoogleCloudRetailV2AudienceResponse;
    /**
     ...
     */
    readonly colorInfo: outputs.retail.v2.GoogleCloudRetailV2ColorInfoResponse;
    /**
     ...
     */
    readonly fulfillmentInfo: outputs.retail.v2.GoogleCloudRetailV2FulfillmentInfoResponse[];
    /**
     ...
     */
    readonly localInventories: outputs.retail.v2.GoogleCloudRetailV2LocalInventoryResponse[];
    /**
     ...
     */
    readonly priceInfo: outputs.retail.v2.GoogleCloudRetailV2PriceInfoResponse;
    /**
     ...
     */
    readonly promotions: outputs.retail.v2.GoogleCloudRetailV2PromotionResponse[];
    /**
     ...
     */
    readonly rating: outputs.retail.v2.GoogleCloudRetailV2RatingResponse;
    /**
     ...
     */
    readonly variants: outputs.retail.v2.GoogleCloudRetailV2ProductResponse[];
}
/**
 * Gets a Product.
 */
