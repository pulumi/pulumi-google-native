 ...
 * Creates a Product.
 */
export class GoogleCloudRetailV2Product extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudRetailV2Product {
        return new GoogleCloudRetailV2Product(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:retail/v2:GoogleCloudRetailV2Product';

    /**
     * Returns true if the given object is an instance of GoogleCloudRetailV2Product.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudRetailV2Product {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudRetailV2Product.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: GoogleCloudRetailV2ProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GoogleCloudRetailV2Product.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface GoogleCloudRetailV2ProductArgs {
    /**
     ...
     */
    readonly images?: pulumi.Input<pulumi.Input<inputs.retail.v2.GoogleCloudRetailV2Image>[]>;
    /**
     ...
     */
    readonly priceInfo?: pulumi.Input<inputs.retail.v2.GoogleCloudRetailV2PriceInfo>;
    /**
