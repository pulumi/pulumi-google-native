 ...
 * Creates a Product.
 */
export class GoogleCloudRetailV2alphaProduct extends pulumi.CustomResource {
    /**
     * Get an existing GoogleCloudRetailV2alphaProduct resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudRetailV2alphaProduct {
        return new GoogleCloudRetailV2alphaProduct(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:retail/v2alpha:GoogleCloudRetailV2alphaProduct';

    /**
     * Returns true if the given object is an instance of GoogleCloudRetailV2alphaProduct.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudRetailV2alphaProduct {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudRetailV2alphaProduct.__pulumiType;
    }


    /**
     * Create a GoogleCloudRetailV2alphaProduct resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GoogleCloudRetailV2alphaProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GoogleCloudRetailV2alphaProduct.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface GoogleCloudRetailV2alphaProductArgs {
    /**
     ...
     */
    readonly images?: pulumi.Input<pulumi.Input<inputs.retail.v2alpha.GoogleCloudRetailV2alphaImage>[]>;
    /**
     ...
     */
    readonly priceInfo?: pulumi.Input<inputs.retail.v2alpha.GoogleCloudRetailV2alphaPriceInfo>;
    /**
