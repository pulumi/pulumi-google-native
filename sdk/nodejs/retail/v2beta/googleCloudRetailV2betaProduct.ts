 ...
 * Creates a Product.
 */
export class GoogleCloudRetailV2betaProduct extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GoogleCloudRetailV2betaProduct {
        return new GoogleCloudRetailV2betaProduct(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:retail/v2beta:GoogleCloudRetailV2betaProduct';

    /**
     * Returns true if the given object is an instance of GoogleCloudRetailV2betaProduct.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GoogleCloudRetailV2betaProduct {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GoogleCloudRetailV2betaProduct.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: GoogleCloudRetailV2betaProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GoogleCloudRetailV2betaProduct.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface GoogleCloudRetailV2betaProductArgs {
    /**
