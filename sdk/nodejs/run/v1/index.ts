...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "gcp-native:run/v1:Domainmapping":
                return new Domainmapping(name, <any>undefined, { urn })
            case "gcp-native:run/v1:NamespaceDomainmapping":
                return new NamespaceDomainmapping(name, <any>undefined, { urn })
            case "gcp-native:run/v1:NamespaceService":
                return new NamespaceService(name, <any>undefined, { urn })
            case "gcp-native:run/v1:Service":
                return new Service(name, <any>undefined, { urn })
            case "gcp-native:run/v1:ServiceIamPolicy":
...
pulumi.runtime.registerResourceModule("gcp-native", "run/v1", _module)
