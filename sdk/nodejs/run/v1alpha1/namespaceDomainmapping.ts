...
export class NamespaceDomainmapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:run/v1alpha1:NamespaceDomainmapping';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.run.v1alpha1.DomainMappingSpecResponse>;
    /**
     * The current status of the DomainMapping.
     */
    public readonly status!: pulumi.Output<outputs.run.v1alpha1.DomainMappingStatusResponse>;
