...
export class SecretIamPolicy extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly auditConfigs!: pulumi.Output<outputs.secretmanager.v1beta1.AuditConfigResponse[]>;
    /**
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.secretmanager.v1beta1.BindingResponse[]>;
    /**
...
export interface SecretIamPolicyArgs {
     ...
     */
    readonly policy?: pulumi.Input<inputs.secretmanager.v1beta1.Policy>;
