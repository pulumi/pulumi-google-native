...
export function getSecret(args: GetSecretArgs, opts?: pulumi.InvokeOptions): Promise<GetSecretResult> {
    ...
    return pulumi.runtime.invoke("google-native:secretmanager/v1beta2:getSecret", {
...
export interface GetSecretResult {
     ...
     */
    readonly customerManagedEncryption: outputs.secretmanager.v1beta2.CustomerManagedEncryptionResponse;
    /**
     ...
     */
    readonly replication: outputs.secretmanager.v1beta2.ReplicationResponse;
    /**
     * Optional. Rotation policy attached to the Secret. May be excluded if there is no rotation policy.
     */
    readonly rotation: outputs.secretmanager.v1beta2.RotationResponse;
    /**
     * Optional. A list of up to 10 Pub/Sub topics to which messages are published when control plane operations are called on the secret or its versions.
     */
    readonly topics: outputs.secretmanager.v1beta2.TopicResponse[];
    /**
