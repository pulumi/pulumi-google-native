...
// Export enums:
export * from "../../types/enums/secretmanager/v1beta2";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:secretmanager/v1beta2:Secret":
                return new Secret(name, <any>undefined, { urn })
            case "google-native:secretmanager/v1beta2:SecretIamBinding":
                return new SecretIamBinding(name, <any>undefined, { urn })
            case "google-native:secretmanager/v1beta2:SecretIamMember":
                return new SecretIamMember(name, <any>undefined, { urn })
            case "google-native:secretmanager/v1beta2:SecretIamPolicy":
...
pulumi.runtime.registerResourceModule("google-native", "secretmanager/v1beta2", _module)
