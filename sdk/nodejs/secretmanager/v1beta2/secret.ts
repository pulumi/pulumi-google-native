...
export class Secret extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:secretmanager/v1beta2:Secret';
     ...
     */
    public readonly customerManagedEncryption!: pulumi.Output<outputs.secretmanager.v1beta2.CustomerManagedEncryptionResponse>;
    /**
     ...
     */
    public readonly replication!: pulumi.Output<outputs.secretmanager.v1beta2.ReplicationResponse>;
    /**
     * Optional. Rotation policy attached to the Secret. May be excluded if there is no rotation policy.
     */
    public readonly rotation!: pulumi.Output<outputs.secretmanager.v1beta2.RotationResponse>;
    /**
     ...
     */
    public readonly topics!: pulumi.Output<outputs.secretmanager.v1beta2.TopicResponse[]>;
    /**
...
export interface SecretArgs {
     ...
     * Optional. The customer-managed encryption configuration of the Regionalised Secrets. If no configuration is provided, Google-managed default encryption is used. Updates to the Secret encryption configuration only apply to SecretVersions added afterwards. They do not apply retroactively to existing SecretVersions.
     */
    customerManagedEncryption?: pulumi.Input<inputs.secretmanager.v1beta2.CustomerManagedEncryptionArgs>;
    /**
     * Optional. Etag of the currently stored Secret.
     */
     ...
     * Optional. Immutable. The replication policy of the secret data attached to the Secret. The replication policy cannot be changed after the Secret has been created.
     */
    replication?: pulumi.Input<inputs.secretmanager.v1beta2.ReplicationArgs>;
    /**
     * Optional. Rotation policy attached to the Secret. May be excluded if there is no rotation policy.
     */
    rotation?: pulumi.Input<inputs.secretmanager.v1beta2.RotationArgs>;
    /**
     * Required. This must be unique within the project. A secret ID is a string with a maximum length of 255 characters and can contain uppercase and lowercase letters, numerals, and the hyphen (`-`) and underscore (`_`) characters.
     */
     ...
     * Optional. A list of up to 10 Pub/Sub topics to which messages are published when control plane operations are called on the secret or its versions.
     */
    topics?: pulumi.Input<pulumi.Input<inputs.secretmanager.v1beta2.TopicArgs>[]>;
    /**
     * Input only. The TTL for the Secret.
     */
