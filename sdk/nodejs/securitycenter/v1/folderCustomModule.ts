...
export class FolderCustomModule extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FolderCustomModule {
        return new FolderCustomModule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:securitycenter/v1:FolderCustomModule';
...
export interface FolderCustomModuleArgs {
     ...
     * The enablement state of the custom module.
     */
    enablementState?: pulumi.Input<enums.securitycenter.v1.FolderCustomModuleEnablementState>;
