...
export class OrganizationCustomModule extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationCustomModule {
        return new OrganizationCustomModule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:securitycenter/v1:OrganizationCustomModule';
...
export interface OrganizationCustomModuleArgs {
     ...
     * The enablement state of the custom module.
     */
    enablementState?: pulumi.Input<enums.securitycenter.v1.OrganizationCustomModuleEnablementState>;
    /**
     * Immutable. The resource name of the custom module. Its format is "organizations/{organization}/securityHealthAnalyticsSettings/customModules/{customModule}", or "folders/{folder}/securityHealthAnalyticsSettings/customModules/{customModule}", or "projects/{project}/securityHealthAnalyticsSettings/customModules/{customModule}" The id {customModule} is server-generated and is not user settable. It will be a numeric id containing 1-20 digits.
     */
