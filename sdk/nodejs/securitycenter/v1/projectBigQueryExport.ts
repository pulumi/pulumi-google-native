...
export class ProjectBigQueryExport extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProjectBigQueryExport {
        return new ProjectBigQueryExport(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is ProjectBigQueryExport {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProjectBigQueryExport.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ProjectBigQueryExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["bigQueryExportId", "project"] };
        opts = pulumi.mergeOptions(opts, replaceOnChanges);
        super(ProjectBigQueryExport.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ProjectBigQueryExportArgs {
    /**
     * Required. Unique identifier provided by the client within the parent scope. It must consist of lower case letters, numbers, and hyphen, with the first character a letter, the last a letter or a number, and a 63 character maximum.
     */
