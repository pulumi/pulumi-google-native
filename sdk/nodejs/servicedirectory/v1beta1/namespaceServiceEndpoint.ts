 ...
 */
export class NamespaceServiceEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamespaceServiceEndpoint {
        return new NamespaceServiceEndpoint(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:servicedirectory/v1beta1:NamespaceServiceEndpoint';

    /**
     * Returns true if the given object is an instance of NamespaceServiceEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NamespaceServiceEndpoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NamespaceServiceEndpoint.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: NamespaceServiceEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NamespaceServiceEndpoint.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface NamespaceServiceEndpointArgs {
    /**
     * Optional. An IPv4 or IPv6 address. Service Directory rejects bad addresses like: * `8.8.8` * `8.8.8.8:53` * `test:bad:address` * `[::1]` * `[::1]:8080` Limited to 45 characters.
     */
