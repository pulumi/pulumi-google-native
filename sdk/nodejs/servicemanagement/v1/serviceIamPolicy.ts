...
export class ServiceIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:servicemanagement/v1:ServiceIamPolicy';
     ...
     */
    public /*out*/ readonly auditConfigs!: pulumi.Output<outputs.servicemanagement.v1.AuditConfigResponse[]>;
    /**
     * Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
     */
    public /*out*/ readonly bindings!: pulumi.Output<outputs.servicemanagement.v1.BindingResponse[]>;
    /**
...
export interface ServiceIamPolicyArgs {
     ...
     */
    readonly policy?: pulumi.Input<inputs.servicemanagement.v1.Policy>;
