...
export class User extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:sqladmin/v1:User';
     ...
     */
    public readonly passwordPolicy!: pulumi.Output<outputs.sqladmin.v1.UserPasswordValidationPolicyResponse>;
    public readonly project!: pulumi.Output<string>;
    public readonly sqlserverUserDetails!: pulumi.Output<outputs.sqladmin.v1.SqlServerUserDetailsResponse>;
    /**
...
export interface UserArgs {
     ...
     * Dual password status for the user.
     */
    dualPasswordType?: pulumi.Input<enums.sqladmin.v1.UserDualPasswordType>;
    /**
     * This field is deprecated and will be removed from a future version of the API.
     *
     * @deprecated This field is deprecated and will be removed from a future version of the API.
     ...
     * User level password validation policy.
     */
    passwordPolicy?: pulumi.Input<inputs.sqladmin.v1.UserPasswordValidationPolicyArgs>;
    /**
     * The project ID of the project containing the Cloud SQL database. The Google apps domain is prefixed if applicable. Can be omitted for `update` because it is already specified on the URL.
     */
    project?: pulumi.Input<string>;
    sqlserverUserDetails?: pulumi.Input<inputs.sqladmin.v1.SqlServerUserDetailsArgs>;
    /**
     * The user type. It determines the method to authenticate the user during login. The default is the database's built-in user type.
     */
    type?: pulumi.Input<enums.sqladmin.v1.UserType>;
}
