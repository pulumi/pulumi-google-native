...
export class ManagedFolderIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedFolderIamPolicy {
        return new ManagedFolderIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-native:storage/v1:ManagedFolderIamPolicy';
     ...
     */
    public readonly bindings!: pulumi.Output<outputs.storage.v1.ManagedFolderIamPolicyBindingsItemResponse[]>;
    ...
    constructor(name: string, args: ManagedFolderIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["managedFolder"] = undefined /*out*/;
            resourceInputs["resourceId"] = undefined /*out*/;
            resourceInputs["userProject"] = undefined /*out*/;
            resourceInputs["version"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        const replaceOnChanges = { replaceOnChanges: ["bucket", "managedFolder"] };
...
export interface ManagedFolderIamPolicyArgs {
     ...
     * An association between a role, which comes with a set of permissions, and members who may assume that role.
     */
    bindings?: pulumi.Input<pulumi.Input<inputs.storage.v1.ManagedFolderIamPolicyBindingsItemArgs>[]>;
