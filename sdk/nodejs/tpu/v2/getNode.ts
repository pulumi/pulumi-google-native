...
export function getNode(args: GetNodeArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeResult> {
    ...
    return pulumi.runtime.invoke("google-native:tpu/v2:getNode", {
...
export interface GetNodeResult {
     ...
     */
    readonly dataDisks: outputs.tpu.v2.AttachedDiskResponse[];
    /**
     ...
     */
    readonly networkConfig: outputs.tpu.v2.NetworkConfigResponse;
    /**
     ...
     */
    readonly schedulingConfig: outputs.tpu.v2.SchedulingConfigResponse;
    /**
     * The Google Cloud Platform Service Account to be used by the TPU node VMs. If None is specified, the default compute service account will be used.
     */
    readonly serviceAccount: outputs.tpu.v2.ServiceAccountResponse;
    /**
     * Shielded Instance options.
     */
    readonly shieldedInstanceConfig: outputs.tpu.v2.ShieldedInstanceConfigResponse;
    /**
     ...
     */
    readonly symptoms: outputs.tpu.v2.SymptomResponse[];
    /**
