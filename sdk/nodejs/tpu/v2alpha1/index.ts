...
// Export enums:
export * from "../../types/enums/tpu/v2alpha1";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:tpu/v2alpha1:Node":
                return new Node(name, <any>undefined, { urn })
            case "google-native:tpu/v2alpha1:QueuedResource":
...
pulumi.runtime.registerResourceModule("google-native", "tpu/v2alpha1", _module)
