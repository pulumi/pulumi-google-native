 ...
 */
export interface ApigatewayApiConfigFileResponse {
    /**
 ...
 */
export interface ApigatewayApiConfigGrpcServiceDefinitionResponse {
    /**
     ...
     */
    fileDescriptorSet: outputs.apigateway.v1beta.ApigatewayApiConfigFileResponse;
    /**
     ...
     */
    source: outputs.apigateway.v1beta.ApigatewayApiConfigFileResponse[];
}

/**
 * An OpenAPI Specification Document describing an API.
 */
export interface ApigatewayApiConfigOpenApiDocumentResponse {
    /**
     * The OpenAPI Specification document file.
     */
    document: outputs.apigateway.v1beta.ApigatewayApiConfigFileResponse;
}
 ...
 */
export interface ApigatewayAuditConfigResponse {
    /**
     * The configuration for logging of each type of permission.
     */
    auditLogConfigs: outputs.apigateway.v1beta.ApigatewayAuditLogConfigResponse[];
    /**
 ...
 */
export interface ApigatewayAuditLogConfigResponse {
    /**
 ...
 */
export interface ApigatewayBackendConfigResponse {
    /**
 ...
 */
export interface ApigatewayBindingResponse {
    /**
     * The condition that is associated with this binding. If the condition evaluates to `true`, then this binding applies to the current request. If the condition evaluates to `false`, then this binding does not apply to the current request. However, a different role binding might grant the same role to one or more of the principals in this binding. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
     */
    condition: outputs.apigateway.v1beta.ApigatewayExprResponse;
    /**
 ...
 */
export interface ApigatewayExprResponse {
    /**
