...
export interface AutomaticScalingResponse {
     ...
     */
    cpuUtilization: outputs.appengine.v1beta.CpuUtilizationResponse;
    /**
     * Target scaling by user-provided metrics. Only applicable in the App Engine flexible environment.
     */
    customMetrics: outputs.appengine.v1beta.CustomMetricResponse[];
    /**
     * Target scaling by disk usage.
     */
    diskUtilization: outputs.appengine.v1beta.DiskUtilizationResponse;
    /**
     ...
     */
    networkUtilization: outputs.appengine.v1beta.NetworkUtilizationResponse;
    /**
     * Target scaling by request utilization.
     */
    requestUtilization: outputs.appengine.v1beta.RequestUtilizationResponse;
    /**
     * Scheduler settings for standard environment.
     */
    standardSchedulerSettings: outputs.appengine.v1beta.StandardSchedulerSettingsResponse;
}
...
export interface DeploymentResponse {
     ...
     */
    build: outputs.appengine.v1beta.BuildInfoResponse;
    /**
     * Options for any Google Cloud Build builds created as a part of this deployment.These options will only be used if a new build is created, such as when deploying to the App Engine flexible environment using files or zip.
     */
    cloudBuildOptions: outputs.appengine.v1beta.CloudBuildOptionsResponse;
    /**
     * The Docker image for the container that runs the version. Only applicable for instances running in the App Engine flexible environment.
     */
    container: outputs.appengine.v1beta.ContainerInfoResponse;
    /**
     ...
     */
    zip: outputs.appengine.v1beta.ZipInfoResponse;
}
...
export interface ResourcesResponse {
     ...
     */
    volumes: outputs.appengine.v1beta.VolumeResponse[];
}
...
export interface UrlMapResponse {
     ...
     */
    apiEndpoint: outputs.appengine.v1beta.ApiEndpointHandlerResponse;
    /**
     * Action to take when users access resources that require authentication. Defaults to redirect.
     */
    authFailAction: string;
     ...
     */
    script: outputs.appengine.v1beta.ScriptHandlerResponse;
    /**
     * Security (HTTPS) enforcement for this URL.
     */
    securityLevel: string;
     ...
     */
    staticFiles: outputs.appengine.v1beta.StaticFilesHandlerResponse;
    /**
