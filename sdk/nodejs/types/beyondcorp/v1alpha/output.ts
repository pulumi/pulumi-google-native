...
export interface ConfigResponse {
     ...
     */
    destinationRoutes: outputs.beyondcorp.v1alpha.DestinationRouteResponse[];
    /**
...
export interface EgressResponse {
     ...
     */
    peeredVpc: outputs.beyondcorp.v1alpha.PeeredVpcResponse;
}
 ...
 * ApplicationEndpoint represents a remote application endpoint.
 */
export interface GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponse {
    /**
     * Hostname or IP address of the remote application endpoint.
     */
    host: string;
 ...
 * Gateway represents a user facing component that serves as an entrance to enable connectivity.
 */
export interface GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse {
    /**
 ...
 */
export interface GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfoResponse {
    /**
     * A GCP service account.
     */
    serviceAccount: outputs.beyondcorp.v1alpha.GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfoServiceAccountResponse;
}

/**
 * ServiceAccount represents a GCP service account.
 */
export interface GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfoServiceAccountResponse {
    /**
 ...
 */
export interface GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse {
    /**
     ...
     */
    sub: outputs.beyondcorp.v1alpha.GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse[];
    /**
...
export interface GoogleIamV1AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.beyondcorp.v1alpha.GoogleIamV1AuditLogConfigResponse[];
    /**
...
export interface GoogleIamV1BindingResponse {
     ...
     */
    condition: outputs.beyondcorp.v1alpha.GoogleTypeExprResponse;
    /**
...
export interface IngressResponse {
     ...
     * The basic ingress config for ClientGateways.
     */
    config: outputs.beyondcorp.v1alpha.ConfigResponse;
}
 ...
 * PrincipalInfo represents an Identity oneof.
 */
export interface PrincipalInfoResponse {
    /**
     * A GCP service account.
     */
    serviceAccount: outputs.beyondcorp.v1alpha.ServiceAccountResponse;
}
...
export interface ResourceInfoResponse {
     ...
     * List of Info for the sub level resources.
     */
    sub: outputs.beyondcorp.v1alpha.ResourceInfoResponse[];
    /**
     * The timestamp to collect the info. It is suggested to be set by the topmost level resource only.
     */
    time: string;
