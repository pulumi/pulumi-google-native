 ...
 */
export interface GoogleCloudBillingBudgetsV1BudgetAmountResponse {
    /**
     * Use the last period's actual spend as the budget for the present period. LastPeriodAmount can only be set when the budget's time period is a Filter.calendar_period. It cannot be set in combination with Filter.custom_period.
     */
    lastPeriodAmount: outputs.billingbudgets.v1.GoogleCloudBillingBudgetsV1LastPeriodAmountResponse;
    /**
     * A specified amount to use as the budget. `currency_code` is optional. If specified when creating a budget, it must match the currency of the billing account. If specified when updating a budget, it must match the currency_code of the existing budget. The `currency_code` is provided on output.
     */
    specifiedAmount: outputs.billingbudgets.v1.GoogleTypeMoneyResponse;
}

/**
 * All date times begin at 12 AM US and Canadian Pacific Time (UTC-8).
 */
export interface GoogleCloudBillingBudgetsV1CustomPeriodResponse {
    /**
 ...
 */
export interface GoogleCloudBillingBudgetsV1NotificationsRuleResponse {
    /**
 ...
 */
export interface GoogleCloudBillingBudgetsV1ThresholdRuleResponse {
    /**
