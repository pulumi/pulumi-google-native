...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.cloudfunctions.v2.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.cloudfunctions.v2.ExprResponse;
    /**
...
export interface BuildConfigResponse {
     ...
     */
    source: outputs.cloudfunctions.v2.SourceResponse;
    /**
     * A permanent fixed identifier for source.
     */
    sourceProvenance: outputs.cloudfunctions.v2.SourceProvenanceResponse;
    /**
...
export interface EventTriggerResponse {
     ...
     */
    eventFilters: outputs.cloudfunctions.v2.EventFilterResponse[];
    /**
 ...
 */
export interface GoogleCloudFunctionsV2StateMessageResponse {
    /**
     * The message.
     */
    message: string;
...
export interface SecretVolumeResponse {
     ...
     */
    versions: outputs.cloudfunctions.v2.SecretVersionResponse[];
}
...
export interface ServiceConfigResponse {
     ...
     */
    secretEnvironmentVariables: outputs.cloudfunctions.v2.SecretEnvVarResponse[];
    /**
     * Secret volumes configuration.
     */
    secretVolumes: outputs.cloudfunctions.v2.SecretVolumeResponse[];
    /**
...
export interface SourceProvenanceResponse {
     ...
     */
    resolvedRepoSource: outputs.cloudfunctions.v2.RepoSourceResponse;
    /**
     * A copy of the build's `source.storage_source`, if exists, with any generations resolved.
     */
    resolvedStorageSource: outputs.cloudfunctions.v2.StorageSourceResponse;
}
...
export interface SourceResponse {
     ...
     */
    repoSource: outputs.cloudfunctions.v2.RepoSourceResponse;
    /**
     * If provided, get the source from this location in Google Cloud Storage.
     */
    storageSource: outputs.cloudfunctions.v2.StorageSourceResponse;
}
