...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.cloudfunctions.v2beta.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.cloudfunctions.v2beta.ExprResponse;
    /**
...
export interface BuildConfigResponse {
     ...
     */
    source: outputs.cloudfunctions.v2beta.SourceResponse;
    /**
     * A permanent fixed identifier for source.
     */
    sourceProvenance: outputs.cloudfunctions.v2beta.SourceProvenanceResponse;
    /**
...
export interface EventTriggerResponse {
     ...
     */
    eventFilters: outputs.cloudfunctions.v2beta.EventFilterResponse[];
    /**
 ...
 */
export interface GoogleCloudFunctionsV2betaStateMessageResponse {
    /**
     * The message.
     */
    message: string;
...
export interface SecretVolumeResponse {
     ...
     */
    versions: outputs.cloudfunctions.v2beta.SecretVersionResponse[];
}
...
export interface ServiceConfigResponse {
     ...
     */
    secretEnvironmentVariables: outputs.cloudfunctions.v2beta.SecretEnvVarResponse[];
    /**
     * Secret volumes configuration.
     */
    secretVolumes: outputs.cloudfunctions.v2beta.SecretVolumeResponse[];
    /**
...
export interface SourceProvenanceResponse {
     ...
     */
    resolvedRepoSource: outputs.cloudfunctions.v2beta.RepoSourceResponse;
    /**
     * A copy of the build's `source.storage_source`, if exists, with any generations resolved.
     */
    resolvedStorageSource: outputs.cloudfunctions.v2beta.StorageSourceResponse;
}
...
export interface SourceResponse {
     ...
     */
    repoSource: outputs.cloudfunctions.v2beta.RepoSourceResponse;
    /**
     * If provided, get the source from this location in Google Cloud Storage.
     */
    storageSource: outputs.cloudfunctions.v2beta.StorageSourceResponse;
}
