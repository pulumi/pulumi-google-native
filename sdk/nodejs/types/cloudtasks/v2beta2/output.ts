...
export interface AppEngineHttpRequestResponse {
     ...
     */
    appEngineRouting: outputs.cloudtasks.v2beta2.AppEngineRoutingResponse;
    /**
...
export interface AppEngineHttpTargetResponse {
     ...
     */
    appEngineRoutingOverride: outputs.cloudtasks.v2beta2.AppEngineRoutingResponse;
}
...
export interface AttemptStatusResponse {
     ...
     */
    responseStatus: outputs.cloudtasks.v2beta2.StatusResponse;
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.cloudtasks.v2beta2.ExprResponse;
    /**
 ...
 */
export interface HeaderOverrideResponse {
    /**
     * header embodying a key and a value.
     */
    header: outputs.cloudtasks.v2beta2.HeaderResponse;
}
...
export interface HttpRequestResponse {
     ...
     */
    oauthToken: outputs.cloudtasks.v2beta2.OAuthTokenResponse;
    /**
     * If specified, an [OIDC](https://developers.google.com/identity/protocols/OpenIDConnect) token will be generated and attached as an `Authorization` header in the HTTP request. This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself.
     */
    oidcToken: outputs.cloudtasks.v2beta2.OidcTokenResponse;
    /**
...
export interface HttpTargetResponse {
     ...
     */
    headerOverrides: outputs.cloudtasks.v2beta2.HeaderOverrideResponse[];
    /**
     ...
     */
    uriOverride: outputs.cloudtasks.v2beta2.UriOverrideResponse;
}
 ...
 * Pull target.
 */
export interface PullTargetResponse {
}
...
export interface TaskStatusResponse {
     ...
     */
    firstAttemptStatus: outputs.cloudtasks.v2beta2.AttemptStatusResponse;
    /**
 ...
 */
export interface UriOverrideResponse {
    /**
