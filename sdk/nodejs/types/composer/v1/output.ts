...
export interface EnvironmentConfigResponse {
     ...
     */
    maintenanceWindow: outputs.composer.v1.MaintenanceWindowResponse;
    /**
     * Optional. The configuration options for GKE cluster master authorized networks. By default master authorized networks feature is: - in case of private environment: enabled with no external networks allowlisted. - in case of public environment: disabled.
     */
    masterAuthorizedNetworksConfig: outputs.composer.v1.MasterAuthorizedNetworksConfigResponse;
    /**
     ...
     */
    privateEnvironmentConfig: outputs.composer.v1.PrivateEnvironmentConfigResponse;
    /**
     * The configuration settings for software inside the environment.
     */
    softwareConfig: outputs.composer.v1.SoftwareConfigResponse;
    /**
     ...
     */
    workloadsConfig: outputs.composer.v1.WorkloadsConfigResponse;
}
...
export interface MasterAuthorizedNetworksConfigResponse {
     ...
     */
    cidrBlocks: outputs.composer.v1.CidrBlockResponse[];
    /**
...
export interface PrivateEnvironmentConfigResponse {
     ...
     */
    networkingConfig: outputs.composer.v1.NetworkingConfigResponse;
    /**
...
export interface WebServerNetworkAccessControlResponse {
     ...
     */
    allowedIpRanges: outputs.composer.v1.AllowedIpRangeResponse[];
}
...
export interface WorkloadsConfigResponse {
     ...
     */
    scheduler: outputs.composer.v1.SchedulerResourceResponse;
    /**
     * Optional. Resources used by Airflow web server.
     */
    webServer: outputs.composer.v1.WebServerResourceResponse;
    /**
     * Optional. Resources used by Airflow workers.
     */
    worker: outputs.composer.v1.WorkerResourceResponse;
}
