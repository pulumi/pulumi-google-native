 ...
 */
export interface AllocationResourceStatusResponse {
    /**
     * Allocation Properties of this reservation.
     */
    specificSkuAllocation: outputs.compute.alpha.AllocationResourceStatusSpecificSKUAllocationResponse;
}

/**
 * Contains Properties set for the reservation.
 */
export interface AllocationResourceStatusSpecificSKUAllocationResponse {
    /**
...
export interface AllocationSpecificSKUAllocationReservedInstancePropertiesResponse {
     ...
     */
    guestAccelerators: outputs.compute.alpha.AcceleratorConfigResponse[];
    /**
     * Specifies amount of local ssd to reserve with each instance. The type of disk is local-ssd.
     */
    localSsds: outputs.compute.alpha.AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponse[];
    /**
...
export interface AllocationSpecificSKUReservationResponse {
     ...
     */
    instanceProperties: outputs.compute.alpha.AllocationSpecificSKUAllocationReservedInstancePropertiesResponse;
    /**
...
export interface AttachedDiskInitializeParamsResponse {
     ...
     */
    sourceImageEncryptionKey: outputs.compute.alpha.CustomerEncryptionKeyResponse;
    /**
     ...
     */
    sourceSnapshotEncryptionKey: outputs.compute.alpha.CustomerEncryptionKeyResponse;
}
...
export interface AttachedDiskResponse {
     ...
     */
    diskEncryptionKey: outputs.compute.alpha.CustomerEncryptionKeyResponse;
    /**
     ...
     */
    initializeParams: outputs.compute.alpha.AttachedDiskInitializeParamsResponse;
    /**
...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.compute.alpha.AuditLogConfigResponse[];
    /**
...
export interface AutoscalingPolicyResponse {
     ...
     */
    cpuUtilization: outputs.compute.alpha.AutoscalingPolicyCpuUtilizationResponse;
    /**
     * Configuration parameters of autoscaling based on a custom metric.
     */
    customMetricUtilizations: outputs.compute.alpha.AutoscalingPolicyCustomMetricUtilizationResponse[];
    /**
     * Configuration parameters of autoscaling based on load balancer.
     */
    loadBalancingUtilization: outputs.compute.alpha.AutoscalingPolicyLoadBalancingUtilizationResponse;
    /**
     ...
     */
    mode: string;
    scaleDownControl: outputs.compute.alpha.AutoscalingPolicyScaleDownControlResponse;
    scaleInControl: outputs.compute.alpha.AutoscalingPolicyScaleInControlResponse;
    /**
...
export interface AutoscalingPolicyScaleDownControlResponse {
     ...
     */
    maxScaledDownReplicas: outputs.compute.alpha.FixedOrPercentResponse;
    /**
...
export interface AutoscalingPolicyScaleInControlResponse {
     ...
     * Maximum allowed number (or %) of VMs that can be deducted from the peak recommendation during the window autoscaler looks at when computing recommendations. Possibly all these VMs can be deleted at once so user service needs to be prepared to lose that many VMs in one step.
     */
    maxScaledInReplicas: outputs.compute.alpha.FixedOrPercentResponse;
    /**
     * How far back autoscaling looks when computing recommendations to include directives regarding slower scale in, as described above.
     */
    timeWindowSec: number;
...
export interface BackendBucketCdnPolicyResponse {
     ...
     */
    bypassCacheOnRequestHeaders: outputs.compute.alpha.BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse[];
    /**
     * The CacheKeyPolicy for this CdnPolicy.
     */
    cacheKeyPolicy: outputs.compute.alpha.BackendBucketCdnPolicyCacheKeyPolicyResponse;
    /**
     ...
     */
    negativeCachingPolicy: outputs.compute.alpha.BackendBucketCdnPolicyNegativeCachingPolicyResponse[];
    /**
...
export interface BackendServiceCdnPolicyResponse {
     ...
     * Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
     */
    bypassCacheOnRequestHeaders: outputs.compute.alpha.BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse[];
    /**
     * The CacheKeyPolicy for this CdnPolicy.
     */
    cacheKeyPolicy: outputs.compute.alpha.CacheKeyPolicyResponse;
    /**
     * Specifies the cache setting for all responses from this backend. The possible values are: USE_ORIGIN_HEADERS Requires the origin to set valid caching headers to cache content. Responses without these headers will not be cached at Google's edge, and will require a full trip to the origin on every request, potentially impacting performance and increasing load on the origin server. FORCE_CACHE_ALL Cache all content, ignoring any "private", "no-store" or "no-cache" directives in Cache-Control response headers. Warning: this may result in Cloud CDN caching private, per-user (user identifiable) content. CACHE_ALL_STATIC Automatically cache static content, including common image formats, media (video and audio), and web assets (JavaScript and CSS). Requests and responses that are marked as uncacheable, as well as dynamic content (including HTML), will not be cached.
     */
    cacheMode: string;
     ...
     * Sets a cache TTL for the specified HTTP status code. negative_caching must be enabled to configure negative_caching_policy. Omitting the policy and leaving negative_caching enabled will use Cloud CDN's default cache TTLs. Note that when specifying an explicit negative_caching_policy, you should take care to specify a cache TTL for all response codes that you wish to cache. Cloud CDN will not apply any default negative caching when a policy exists.
     */
    negativeCachingPolicy: outputs.compute.alpha.BackendServiceCdnPolicyNegativeCachingPolicyResponse[];
    /**
     * If true then Cloud CDN will combine multiple concurrent cache fill requests into a small number of requests to the origin.
     */
    requestCoalescing: boolean;
...
export interface BackendServiceIAPOAuth2ClientInfoResponse {
    /**
...
export interface BackendServiceIAPResponse {
     ...
     */
    oauth2ClientInfo: outputs.compute.alpha.BackendServiceIAPOAuth2ClientInfoResponse;
    /**
...
export interface BackendServiceLocalityLoadBalancingPolicyConfigResponse {
    customPolicy: outputs.compute.alpha.BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponse;
    policy: outputs.compute.alpha.BackendServiceLocalityLoadBalancingPolicyConfigPolicyResponse;
}
...
export interface BindingResponse {
     ...
     */
    condition: outputs.compute.alpha.ExprResponse;
    /**
 ...
 */
export interface BulkInsertInstanceResourceResponse {
    /**
     ...
     */
    instance: outputs.compute.alpha.InstanceResponse;
    /**
     * The instance properties defining the VM instances to be created. Required if sourceInstanceTemplate is not provided.
     */
    instanceProperties: outputs.compute.alpha.InstancePropertiesResponse;
    /**
     * Policy for chosing target zone. For more information, see Create VMs in bulk .
     */
    locationPolicy: outputs.compute.alpha.LocationPolicyResponse;
    /**
...
export interface CallCredentialsResponse {
     ...
     */
    fromPlugin: outputs.compute.alpha.MetadataCredentialsFromPluginResponse;
}
...
export interface ChannelCredentialsResponse {
     ...
     */
    certificates: outputs.compute.alpha.TlsCertificatePathsResponse;
    /**
...
export interface CircuitBreakersResponse {
     ...
     */
    connectTimeout: outputs.compute.alpha.DurationResponse;
    /**
...
export interface ConsistentHashLoadBalancerSettingsHttpCookieResponse {
     ...
     */
    ttl: outputs.compute.alpha.DurationResponse;
}
...
export interface ConsistentHashLoadBalancerSettingsResponse {
     ...
     */
    httpCookie: outputs.compute.alpha.ConsistentHashLoadBalancerSettingsHttpCookieResponse;
    /**
 ...
 */
export interface CustomErrorResponsePolicyCustomErrorResponseRuleResponse {
    /**
 ...
 */
export interface CustomErrorResponsePolicyResponse {
    /**
     ...
     */
    errorResponseRules: outputs.compute.alpha.CustomErrorResponsePolicyCustomErrorResponseRuleResponse[];
    /**
...
export interface DiskAsyncReplicationResponse {
    /**
...
export interface DiskResourceStatusAsyncReplicationStatusResponse {
    state: string;
}

export interface DiskResourceStatusResponse {
    asyncPrimaryDisk: outputs.compute.alpha.DiskResourceStatusAsyncReplicationStatusResponse;
    /**
...
export interface FirewallPolicyRuleMatcherResponse {
     ...
     */
    srcSecureTags: outputs.compute.alpha.FirewallPolicyRuleSecureTagResponse[];
    /**
...
export interface FirewallPolicyRuleResponse {
     ...
     */
    match: outputs.compute.alpha.FirewallPolicyRuleMatcherResponse;
    /**
     ...
     */
    targetSecureTags: outputs.compute.alpha.FirewallPolicyRuleSecureTagResponse[];
    /**
...
export interface FutureReservationSpecificSKUPropertiesResponse {
    /**
 ...
 */
export interface FutureReservationStatusResponse {
    /**
    ...
    specificSkuProperties: outputs.compute.alpha.FutureReservationStatusSpecificSKUPropertiesResponse;
}

/**
 * Properties to be set for the Future Reservation.
 */
export interface FutureReservationStatusSpecificSKUPropertiesResponse {
    /**
...
export interface FutureReservationTimeWindowResponse {
    duration: outputs.compute.alpha.DurationResponse;
    endTime: string;
    /**
 ...
 */
export interface GrpcServiceConfigResponse {
    /**
     * The call credentials to access the SDS server.
     */
    callCredentials: outputs.compute.alpha.CallCredentialsResponse;
    /**
     * The channel credentials to access the SDS server.
     */
    channelCredentials: outputs.compute.alpha.ChannelCredentialsResponse;
    /**
 ...
 */
export interface HelpLinkResponse {
    /**
...
export interface HelpResponse {
     ...
     */
    links: outputs.compute.alpha.HelpLinkResponse[];
}
...
export interface HttpFaultDelayResponse {
     ...
     */
    fixedDelay: outputs.compute.alpha.DurationResponse;
    /**
...
export interface HttpFaultInjectionResponse {
     ...
     */
    abort: outputs.compute.alpha.HttpFaultAbortResponse;
    /**
     * The specification for how client requests are delayed as part of fault injection, before being sent to a backend service.
     */
    delay: outputs.compute.alpha.HttpFaultDelayResponse;
}
...
export interface HttpHeaderActionResponse {
     ...
     */
    requestHeadersToAdd: outputs.compute.alpha.HttpHeaderOptionResponse[];
    /**
     ...
     */
    responseHeadersToAdd: outputs.compute.alpha.HttpHeaderOptionResponse[];
    /**
...
export interface HttpHeaderMatchResponse {
     ...
     */
    rangeMatch: outputs.compute.alpha.Int64RangeMatchResponse;
    /**
...
export interface HttpRetryPolicyResponse {
     ...
     */
    perTryTimeout: outputs.compute.alpha.DurationResponse;
    /**
...
export interface HttpRouteActionResponse {
     ...
     */
    corsPolicy: outputs.compute.alpha.CorsPolicyResponse;
    /**
     ...
     */
    faultInjectionPolicy: outputs.compute.alpha.HttpFaultInjectionResponse;
    /**
     ...
     */
    maxStreamDuration: outputs.compute.alpha.DurationResponse;
    /**
     * Specifies the policy on how requests intended for the route's backends are shadowed to a separate mirrored backend service. The load balancer does not wait for responses from the shadow service. Before sending traffic to the shadow service, the host / authority header is suffixed with -shadow. Not supported when the URL map is bound to a target gRPC proxy that has the validateForProxyless field set to true.
     */
    requestMirrorPolicy: outputs.compute.alpha.RequestMirrorPolicyResponse;
    /**
     * Specifies the retry policy associated with this route.
     */
    retryPolicy: outputs.compute.alpha.HttpRetryPolicyResponse;
    /**
     * Specifies the timeout for the selected route. Timeout is computed from the time the request has been fully processed (known as *end-of-stream*) up until the response has been processed. Timeout includes all retries. If not specified, this field uses the largest timeout among all backend services associated with the route. Not supported when the URL map is bound to a target gRPC proxy that has validateForProxyless field set to true.
     */
    timeout: outputs.compute.alpha.DurationResponse;
    /**
     ...
     */
    urlRewrite: outputs.compute.alpha.UrlRewriteResponse;
    /**
     * A list of weighted backend services to send traffic to when a route match occurs. The weights determine the fraction of traffic that flows to their corresponding backend service. If all traffic needs to go to a single backend service, there must be one weightedBackendService with weight set to a non-zero number. After a backend service is identified and before forwarding the request to the backend service, advanced routing actions such as URL rewrites and header transformations are applied depending on additional settings specified in this HttpRouteAction.
     */
    weightedBackendServices: outputs.compute.alpha.WeightedBackendServiceResponse[];
}
...
export interface HttpRouteRuleMatchResponse {
     ...
     */
    metadataFilters: outputs.compute.alpha.MetadataFilterResponse[];
    /**
     ...
     */
    queryParameterMatches: outputs.compute.alpha.HttpQueryParameterMatchResponse[];
    /**
...
export interface HttpRouteRuleResponse {
     ...
     */
    customErrorResponsePolicy: outputs.compute.alpha.CustomErrorResponsePolicyResponse;
    /**
     ...
     */
    headerAction: outputs.compute.alpha.HttpHeaderActionResponse;
    /**
     ...
     */
    httpFilterConfigs: outputs.compute.alpha.HttpFilterConfigResponse[];
    /**
     ...
     */
    httpFilterMetadata: outputs.compute.alpha.HttpFilterConfigResponse[];
    /**
     * The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
     */
    matchRules: outputs.compute.alpha.HttpRouteRuleMatchResponse[];
    /**
     ...
     */
    routeAction: outputs.compute.alpha.HttpRouteActionResponse;
    /**
     ...
     */
    urlRedirect: outputs.compute.alpha.HttpRedirectActionResponse;
}
...
export interface InitialStateConfigResponse {
     ...
     * The Key Database (db).
     */
    dbs: outputs.compute.alpha.FileContentBufferResponse[];
    /**
     * The forbidden key database (dbx).
     */
    dbxs: outputs.compute.alpha.FileContentBufferResponse[];
    /**
     * The Key Exchange Key (KEK).
     */
    keks: outputs.compute.alpha.FileContentBufferResponse[];
    /**
     * The Platform Key (PK).
     */
    pk: outputs.compute.alpha.FileContentBufferResponse;
}
...
export interface InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersResponse {
    /**
...
export interface InstanceGroupManagerAutoHealingPolicyResponse {
     ...
     */
    autoHealingTriggers: outputs.compute.alpha.InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersResponse;
    /**
...
export interface InstanceGroupManagerResizeRequestStatusErrorErrorsItemErrorDetailsItemResponse {
    errorInfo: outputs.compute.alpha.ErrorInfoResponse;
    help: outputs.compute.alpha.HelpResponse;
    localizedMessage: outputs.compute.alpha.LocalizedMessageResponse;
    quotaInfo: outputs.compute.alpha.QuotaExceededInfoResponse;
}

export interface InstanceGroupManagerResizeRequestStatusErrorErrorsItemResponse {
    /**
     ...
     */
    errorDetails: outputs.compute.alpha.InstanceGroupManagerResizeRequestStatusErrorErrorsItemErrorDetailsItemResponse[];
    /**
 ...
 */
export interface InstanceGroupManagerResizeRequestStatusErrorResponse {
    /**
     * The array of errors encountered while processing this operation.
     */
    errors: outputs.compute.alpha.InstanceGroupManagerResizeRequestStatusErrorErrorsItemResponse[];
}

export interface InstanceGroupManagerResizeRequestStatusResponse {
    /**
     * Errors encountered during the queueing or provisioning phases of the ResizeRequest.
     */
    error: outputs.compute.alpha.InstanceGroupManagerResizeRequestStatusErrorResponse;
    /**
     * Constraints for the time when the instances start provisioning. Always exposed as absolute time.
     */
    queuingPolicy: outputs.compute.alpha.QueuingPolicyResponse;
}
...
export interface InstanceGroupManagerUpdatePolicyResponse {
     ...
     */
    maxSurge: outputs.compute.alpha.FixedOrPercentResponse;
    /**
...
export interface InstancePropertiesResponse {
     ...
     */
    advancedMachineFeatures: outputs.compute.alpha.AdvancedMachineFeaturesResponse;
    /**
     ...
     */
    confidentialInstanceConfig: outputs.compute.alpha.ConfidentialInstanceConfigResponse;
    /**
     ...
     */
    disks: outputs.compute.alpha.AttachedDiskResponse[];
    /**
     ...
     */
    displayDevice: outputs.compute.alpha.DisplayDeviceResponse;
    /**
     ...
     */
    metadata: outputs.compute.alpha.MetadataResponse;
    /**
     ...
     */
    reservationAffinity: outputs.compute.alpha.ReservationAffinityResponse;
    /**
     * Resource manager tags to be bound to the instance. Tag keys and values have the same definition as resource manager tags. Keys must be in the format `tagKeys/{tag_key_id}`, and values are in the format `tagValues/456`. The field is ignored (both PUT & PATCH) when empty.
     */
    resourceManagerTags: {[key: string]: string};
     ...
     */
    scheduling: outputs.compute.alpha.SchedulingResponse;
    /**
     ...
     */
    serviceAccounts: outputs.compute.alpha.ServiceAccountResponse[];
    /**
     * Note that for MachineImage, this is not supported yet.
     */
    shieldedInstanceConfig: outputs.compute.alpha.ShieldedInstanceConfigResponse;
    /**
     * Specifies the Shielded VM options for the instances that are created from these properties.
     */
    shieldedVmConfig: outputs.compute.alpha.ShieldedVmConfigResponse;
    /**
...
export interface InstanceResponse {
     ...
     */
    instanceEncryptionKey: outputs.compute.alpha.CustomerEncryptionKeyResponse;
    /**
     * KeyRevocationActionType of the instance. Supported options are "STOP" and "NONE". The default value is "NONE" if it is not specified.
     */
    keyRevocationActionType: string;
     ...
     */
    params: outputs.compute.alpha.InstanceParamsResponse;
    /**
     * PostKeyRevocationActionType of the instance.
     */
    postKeyRevocationActionType: string;
     ...
     */
    resourceStatus: outputs.compute.alpha.ResourceStatusResponse;
    /**
    ...
    serviceAccounts: outputs.compute.alpha.ServiceAccountResponse[];
    shieldedInstanceConfig: outputs.compute.alpha.ShieldedInstanceConfigResponse;
    shieldedInstanceIntegrityPolicy: outputs.compute.alpha.ShieldedInstanceIntegrityPolicyResponse;
    /**
     ...
     */
    shieldedVmIntegrityPolicy: outputs.compute.alpha.ShieldedVmIntegrityPolicyResponse;
    /**
     ...
     */
    sourceMachineImageEncryptionKey: outputs.compute.alpha.CustomerEncryptionKeyResponse;
    /**
...
export interface InstantSnapshotResourceStatusResponse {
    /**
...
export interface InterconnectAttachmentConfigurationConstraintsBgpPeerASNRangeResponse {
    max: number;
    min: number;
}

export interface InterconnectAttachmentConfigurationConstraintsResponse {
    /**
     ...
     */
    bgpPeerAsnRanges: outputs.compute.alpha.InterconnectAttachmentConfigurationConstraintsBgpPeerASNRangeResponse[];
    /**
     * Network Connectivity Center constraints, which can take one of the following values: NCC_UNCONSTRAINED, NCC_SPOKE_REQUIRED
     */
    networkConnectivityCenter: string;
}
 ...
 */
export interface LocalizedMessageResponse {
    /**
...
export interface LogConfigCloudAuditOptionsResponse {
     ...
     * This is deprecated and has no effect. Do not use.
     */
    authorizationLoggingOptions: outputs.compute.alpha.AuthorizationLoggingOptionsResponse;
    /**
     * This is deprecated and has no effect. Do not use.
     */
    logName: string;
...
export interface LogConfigCounterOptionsResponse {
     ...
     * This is deprecated and has no effect. Do not use.
     */
    customFields: outputs.compute.alpha.LogConfigCounterOptionsCustomFieldResponse[];
    /**
     * This is deprecated and has no effect. Do not use.
     */
    field: string;
...
export interface LogConfigResponse {
     ...
     * This is deprecated and has no effect. Do not use.
     */
    cloudAudit: outputs.compute.alpha.LogConfigCloudAuditOptionsResponse;
    /**
     * This is deprecated and has no effect. Do not use.
     */
    counter: outputs.compute.alpha.LogConfigCounterOptionsResponse;
    /**
     * This is deprecated and has no effect. Do not use.
     */
    dataAccess: outputs.compute.alpha.LogConfigDataAccessOptionsResponse;
}

/**
 * [Deprecated] Custom authenticator credentials. Custom authenticator credentials.
 */
export interface MetadataCredentialsFromPluginResponse {
    /**
     * Plugin name.
     */
    name: string;
...
export interface MetadataFilterResponse {
     ...
     */
    filterLabels: outputs.compute.alpha.MetadataFilterLabelMatchResponse[];
    /**
 ...
 */
export interface NetworkAttachmentConnectedEndpointResponse {
    /**
...
export interface NetworkInterfaceResponse {
     ...
     */
    accessConfigs: outputs.compute.alpha.AccessConfigResponse[];
    /**
     * An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
     */
    aliasIpRanges: outputs.compute.alpha.AliasIpRangeResponse[];
    /**
     ...
     */
    subinterfaces: outputs.compute.alpha.NetworkInterfaceSubInterfaceResponse[];
    /**
...
export interface NetworkInterfaceSubInterfaceResponse {
    /**
...
export interface NodeGroupMaintenanceWindowResponse {
     ...
     * [Output only] A predetermined duration for the window, automatically chosen to be the smallest possible in the given scenario.
     */
    maintenanceDuration: outputs.compute.alpha.DurationResponse;
    /**
...
export interface NotificationEndpointGrpcSettingsResponse {
     ...
     */
    resendInterval: outputs.compute.alpha.DurationResponse;
    /**
...
export interface OutlierDetectionResponse {
     ...
     */
    baseEjectionTime: outputs.compute.alpha.DurationResponse;
    /**
     ...
     */
    interval: outputs.compute.alpha.DurationResponse;
    /**
...
export interface PacketMirroringMirroredResourceInfoResponse {
     ...
     */
    instances: outputs.compute.alpha.PacketMirroringMirroredResourceInfoInstanceInfoResponse[];
    /**
     * A set of subnetworks for which traffic from/to all VM instances will be mirrored. They must live in the same region as this packetMirroring. You may specify a maximum of 5 subnetworks.
     */
    subnetworks: outputs.compute.alpha.PacketMirroringMirroredResourceInfoSubnetInfoResponse[];
    /**
...
export interface PathMatcherResponse {
     ...
     */
    defaultCustomErrorResponsePolicy: outputs.compute.alpha.CustomErrorResponsePolicyResponse;
    /**
     ...
     */
    defaultRouteAction: outputs.compute.alpha.HttpRouteActionResponse;
    /**
     ...
     */
    defaultUrlRedirect: outputs.compute.alpha.HttpRedirectActionResponse;
    /**
     * An optional description of this resource. Provide this property when you create the resource.
     */
    description: string;
     ...
     */
    pathRules: outputs.compute.alpha.PathRuleResponse[];
    /**
     * The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
     */
    routeRules: outputs.compute.alpha.HttpRouteRuleResponse[];
}
...
export interface QueuedResourceStatusFailedDataErrorErrorsItemErrorDetailsItemResponse {
    errorInfo: outputs.compute.alpha.ErrorInfoResponse;
    help: outputs.compute.alpha.HelpResponse;
    localizedMessage: outputs.compute.alpha.LocalizedMessageResponse;
    quotaInfo: outputs.compute.alpha.QuotaExceededInfoResponse;
...
export interface QueuedResourceStatusFailedDataErrorErrorsItemResponse {
    /**
     * The error type identifier for this error.
     */
    code: string;
     ...
     * An optional list of messages that contain the error details. There is a set of defined message types to use for providing details.The syntax depends on the error code. For example, QuotaExceededInfo will have details when the error code is QUOTA_EXCEEDED.
     */
    errorDetails: outputs.compute.alpha.QueuedResourceStatusFailedDataErrorErrorsItemErrorDetailsItemResponse[];
    /**
     * Indicates the field in the request that caused the error. This property is optional.
     */
    location: string;
 ...
 */
export interface QueuedResourceStatusFailedDataErrorResponse {
    /**
     * The array of errors encountered while processing this operation.
     */
    errors: outputs.compute.alpha.QueuedResourceStatusFailedDataErrorErrorsItemResponse[];
}

/**
 * Additional status detail for the FAILED state.
 */
export interface QueuedResourceStatusFailedDataResponse {
    /**
     * The error(s) that caused the QueuedResource to enter the FAILED state.
     */
    error: outputs.compute.alpha.QueuedResourceStatusFailedDataErrorResponse;
}

/**
 * [Output only] Result of queuing and provisioning based on deferred capacity.
 */
export interface QueuedResourceStatusResponse {
    /**
     * Additional status detail for the FAILED state.
     */
    failedData: outputs.compute.alpha.QueuedResourceStatusFailedDataResponse;
    /**
 ...
 */
export interface QueuingPolicyResponse {
    /**
     * Relative deadline for waiting for capacity.
     */
    validUntilDuration: outputs.compute.alpha.DurationResponse;
    /**
 ...
 */
export interface QuotaExceededInfoResponse {
    /**
...
export interface RegionSslPolicyWarningsItemResponse {
     ...
     */
    data: outputs.compute.alpha.RegionSslPolicyWarningsItemDataItemResponse[];
    /**
...
export interface ReservationResponse {
     ...
     */
    resourceStatus: outputs.compute.alpha.AllocationResourceStatusResponse;
    /**
     * Reserved for future use.
     */
    satisfiesPzs: boolean;
     ...
     */
    shareSettings: outputs.compute.alpha.ShareSettingsResponse;
    /**
     * Reservation for instances with specific machine shapes.
     */
    specificReservation: outputs.compute.alpha.AllocationSpecificSKUReservationResponse;
    /**
 ...
 */
export interface ResourcePolicyDiskConsistencyGroupPolicyResponse {
}
...
export interface ResourcePolicyInstanceSchedulePolicyResponse {
     ...
     */
    vmStartSchedule: outputs.compute.alpha.ResourcePolicyInstanceSchedulePolicyScheduleResponse;
    /**
     * Specifies the schedule for stopping instances.
     */
    vmStopSchedule: outputs.compute.alpha.ResourcePolicyInstanceSchedulePolicyScheduleResponse;
}
...
export interface ResourcePolicySnapshotSchedulePolicyResponse {
     ...
     */
    retentionPolicy: outputs.compute.alpha.ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponse;
    /**
     * A Vm Maintenance Policy specifies what kind of infrastructure maintenance we are allowed to perform on this VM and when. Schedule that is applied to disks covered by this policy.
     */
    schedule: outputs.compute.alpha.ResourcePolicySnapshotSchedulePolicyScheduleResponse;
    /**
     * Properties with which snapshots are created such as labels, encryption keys.
     */
    snapshotProperties: outputs.compute.alpha.ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponse;
}
...
export interface ResourcePolicySnapshotSchedulePolicyScheduleResponse {
    dailySchedule: outputs.compute.alpha.ResourcePolicyDailyCycleResponse;
    hourlySchedule: outputs.compute.alpha.ResourcePolicyHourlyCycleResponse;
    weeklySchedule: outputs.compute.alpha.ResourcePolicyWeeklyCycleResponse;
}
 ...
 */
export interface ResourcePolicyVmMaintenancePolicyConcurrencyControlResponse {
 ...
 */
export interface ResourcePolicyVmMaintenancePolicyMaintenanceWindowResponse {
    dailyMaintenanceWindow: outputs.compute.alpha.ResourcePolicyDailyCycleResponse;
}

export interface ResourcePolicyVmMaintenancePolicyResponse {
    concurrencyControlGroup: outputs.compute.alpha.ResourcePolicyVmMaintenancePolicyConcurrencyControlResponse;
    /**
     * Maintenance windows that are applied to VMs covered by this policy.
     */
    maintenanceWindow: outputs.compute.alpha.ResourcePolicyVmMaintenancePolicyMaintenanceWindowResponse;
}
...
export interface ResourcePolicyWeeklyCycleResponse {
     ...
     */
    dayOfWeeks: outputs.compute.alpha.ResourcePolicyWeeklyCycleDayOfWeekResponse[];
}
...
export interface ResourceStatusResponse {
     ...
     */
    physicalHost: string;
    scheduling: outputs.compute.alpha.ResourceStatusSchedulingResponse;
    upcomingMaintenance: outputs.compute.alpha.ResourceStatusUpcomingMaintenanceResponse;
}

export interface ResourceStatusSchedulingResponse {
    /**
...
export interface ResourceStatusUpcomingMaintenanceResponse {
    /**
...
export interface RouterBgpPeerResponse {
     ...
     */
    advertisedIpRanges: outputs.compute.alpha.RouterAdvertisedIpRangeResponse[];
    /**
...
export interface RouterNatResponse {
     ...
     */
    logConfig: outputs.compute.alpha.RouterNatLogConfigResponse;
    /**
     ...
     */
    rules: outputs.compute.alpha.RouterNatRuleResponse[];
    /**
     ...
     */
    subnetworks: outputs.compute.alpha.RouterNatSubnetworkToNatResponse[];
    /**
...
export interface RouterNatRuleResponse {
     ...
     */
    action: outputs.compute.alpha.RouterNatRuleActionResponse;
    /**
...
export interface RuleResponse {
     ...
     * This is deprecated and has no effect. Do not use.
     */
    conditions: outputs.compute.alpha.ConditionResponse[];
    /**
     * This is deprecated and has no effect. Do not use.
     */
    description: string;
     ...
     * This is deprecated and has no effect. Do not use.
     */
    logConfigs: outputs.compute.alpha.LogConfigResponse[];
    /**
     * This is deprecated and has no effect. Do not use.
     */
    notIns: string[];
...
export interface SchedulingResponse {
     ...
     */
    maxRunDuration: outputs.compute.alpha.DurationResponse;
    /**
     ...
     */
    nodeAffinities: outputs.compute.alpha.SchedulingNodeAffinityResponse[];
    /**
 ...
 */
export interface SdsConfigResponse {
    /**
     * The configuration to access the SDS server over GRPC.
     */
    grpcServiceConfig: outputs.compute.alpha.GrpcServiceConfigResponse;
}
...
export interface SecurityPolicyAdaptiveProtectionConfigResponse {
    autoDeployConfig: outputs.compute.alpha.SecurityPolicyAdaptiveProtectionConfigAutoDeployConfigResponse;
    /**
     * If set to true, enables Cloud Armor Machine Learning.
     */
    layer7DdosDefenseConfig: outputs.compute.alpha.SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponse;
}
...
export interface SecurityPolicyAdvancedOptionsConfigResponse {
     ...
     */
    jsonCustomConfig: outputs.compute.alpha.SecurityPolicyAdvancedOptionsConfigJsonCustomConfigResponse;
    jsonParsing: string;
    logLevel: string;
}
 ...
 */
export interface SecurityPolicyCloudArmorConfigResponse {
    /**
     * If set to true, enables Cloud Armor Machine Learning.
     */
    enableMl: boolean;
...
export interface SecurityPolicyRuleHttpHeaderActionResponse {
     ...
     */
    requestHeadersToAdds: outputs.compute.alpha.SecurityPolicyRuleHttpHeaderActionHttpHeaderOptionResponse[];
}

export interface SecurityPolicyRuleMatcherConfigDestinationPortResponse {
    /**
     * The IP protocol to which this rule applies. The protocol type is required when creating a firewall rule. This value can either be one of the following well known protocol strings (tcp, udp, icmp, esp, ah, ipip, sctp), or the IP protocol number.
     */
    ipProtocol: string;
...
export interface SecurityPolicyRuleMatcherConfigResponse {
     ...
     */
    destPorts: outputs.compute.alpha.SecurityPolicyRuleMatcherConfigDestinationPortResponse[];
    /**
     * Pairs of IP protocols and ports that the rule should match. This field may only be specified when versioned_expr is set to FIREWALL.
     */
    layer4Configs: outputs.compute.alpha.SecurityPolicyRuleMatcherConfigLayer4ConfigResponse[];
    /**
...
export interface SecurityPolicyRuleMatcherResponse {
     ...
     */
    config: outputs.compute.alpha.SecurityPolicyRuleMatcherConfigResponse;
    /**
     * User defined CEVAL expression. A CEVAL expression is used to specify match criteria such as origin.ip, source.region_code and contents in the request header.
     */
    expr: outputs.compute.alpha.ExprResponse;
    /**
 ...
 */
export interface SecurityPolicyRuleNetworkMatcherResponse {
    /**
     ...
     */
    userDefinedFields: outputs.compute.alpha.SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponse[];
}

export interface SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponse {
    /**
...
export interface SecurityPolicyRulePreconfiguredWafConfigExclusionResponse {
     ...
     */
    requestCookiesToExclude: outputs.compute.alpha.SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse[];
    /**
     * A list of request header names whose value will be excluded from inspection during preconfigured WAF evaluation.
     */
    requestHeadersToExclude: outputs.compute.alpha.SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse[];
    /**
     * A list of request query parameter names whose value will be excluded from inspection during preconfigured WAF evaluation. Note that the parameter can be in the query string or in the POST body.
     */
    requestQueryParamsToExclude: outputs.compute.alpha.SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse[];
    /**
     * A list of request URIs from the request line to be excluded from inspection during preconfigured WAF evaluation. When specifying this field, the query or fragment part should be excluded.
     */
    requestUrisToExclude: outputs.compute.alpha.SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse[];
    /**
...
export interface SecurityPolicyRulePreconfiguredWafConfigResponse {
     ...
     */
    exclusions: outputs.compute.alpha.SecurityPolicyRulePreconfiguredWafConfigExclusionResponse[];
}
...
export interface SecurityPolicyRuleRateLimitOptionsResponse {
     ...
     */
    exceedActionRpcStatus: outputs.compute.alpha.SecurityPolicyRuleRateLimitOptionsRpcStatusResponse;
    /**
     * Parameters defining the redirect action that is used as the exceed action. Cannot be specified if the exceed action is not redirect.
     */
    exceedRedirectOptions: outputs.compute.alpha.SecurityPolicyRuleRedirectOptionsResponse;
    /**
     * Threshold at which to begin ratelimiting.
     */
    rateLimitThreshold: outputs.compute.alpha.SecurityPolicyRuleRateLimitOptionsThresholdResponse;
}

/**
 * Simplified google.rpc.Status type (omitting details).
 */
export interface SecurityPolicyRuleRateLimitOptionsRpcStatusResponse {
    /**
...
export interface SecurityPolicyRuleResponse {
     ...
     * A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
     */
    match: outputs.compute.alpha.SecurityPolicyRuleMatcherResponse;
    /**
     ...
     */
    networkMatch: outputs.compute.alpha.SecurityPolicyRuleNetworkMatcherResponse;
    /**
     * Preconfigured WAF configuration to be applied for the rule. If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
     */
    preconfiguredWafConfig: outputs.compute.alpha.SecurityPolicyRulePreconfiguredWafConfigResponse;
    /**
     ...
     */
    rateLimitOptions: outputs.compute.alpha.SecurityPolicyRuleRateLimitOptionsResponse;
    /**
     * Parameters defining the redirect action. Cannot be specified for any other actions.
     */
    redirectOptions: outputs.compute.alpha.SecurityPolicyRuleRedirectOptionsResponse;
    /**
...
export interface SecurityPolicyUserDefinedFieldResponse {
    /**
 ...
 */
export interface ServerTlsSettingsResponse {
    /**
     * Configures the mechanism to obtain security certificates and identity information.
     */
    proxyTlsContext: outputs.compute.alpha.TlsContextResponse;
    /**
...
export interface SourceInstanceParamsResponse {
     ...
     */
    diskConfigs: outputs.compute.alpha.DiskInstantiationConfigResponse[];
}
...
export interface SourceInstancePropertiesResponse {
     ...
     */
    disks: outputs.compute.alpha.SavedAttachedDiskResponse[];
    /**
...
export interface StatefulPolicyResponse {
    preservedState: outputs.compute.alpha.StatefulPolicyPreservedStateResponse;
}
...
export interface TlsCertificateContextResponse {
     ...
     */
    sdsConfig: outputs.compute.alpha.SdsConfigResponse;
}
 ...
 */
export interface TlsCertificatePathsResponse {
    /**
 ...
 */
export interface TlsContextResponse {
    /**
     * Defines the mechanism to obtain the client or server certificate.
     */
    certificateContext: outputs.compute.alpha.TlsCertificateContextResponse;
    /**
     ...
     */
    validationContext: outputs.compute.alpha.TlsValidationContextResponse;
}
 ...
 */
export interface TlsValidationContextResponse {
    /**
...
export interface UDPHealthCheckResponse {
    /**
 ...
 */
export interface UpcomingMaintenanceTimeWindowResponse {
    earliest: string;
    latest: string;
}
...
export interface UrlMapTestResponse {
     ...
     */
    headers: outputs.compute.alpha.UrlMapTestHeaderResponse[];
    /**
