...
export interface AllocationSpecificSKUAllocationReservedInstancePropertiesResponse {
     ...
     */
    guestAccelerators: outputs.compute.v1.AcceleratorConfigResponse[];
    /**
     * Specifies amount of local ssd to reserve with each instance. The type of disk is local-ssd.
     */
    localSsds: outputs.compute.v1.AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponse[];
    /**
...
export interface AllocationSpecificSKUReservationResponse {
     ...
     */
    instanceProperties: outputs.compute.v1.AllocationSpecificSKUAllocationReservedInstancePropertiesResponse;
}
...
export interface AttachedDiskInitializeParamsResponse {
     ...
     */
    sourceImageEncryptionKey: outputs.compute.v1.CustomerEncryptionKeyResponse;
    /**
     ...
     */
    sourceSnapshotEncryptionKey: outputs.compute.v1.CustomerEncryptionKeyResponse;
}
...
export interface AttachedDiskResponse {
     ...
     */
    diskEncryptionKey: outputs.compute.v1.CustomerEncryptionKeyResponse;
    /**
     ...
     */
    initializeParams: outputs.compute.v1.AttachedDiskInitializeParamsResponse;
    /**
...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.compute.v1.AuditLogConfigResponse[];
    /**
...
export interface AutoscalingPolicyResponse {
     ...
     */
    cpuUtilization: outputs.compute.v1.AutoscalingPolicyCpuUtilizationResponse;
    /**
     * Configuration parameters of autoscaling based on a custom metric.
     */
    customMetricUtilizations: outputs.compute.v1.AutoscalingPolicyCustomMetricUtilizationResponse[];
    /**
     * Configuration parameters of autoscaling based on load balancer.
     */
    loadBalancingUtilization: outputs.compute.v1.AutoscalingPolicyLoadBalancingUtilizationResponse;
    /**
     ...
     */
    mode: string;
    scaleInControl: outputs.compute.v1.AutoscalingPolicyScaleInControlResponse;
    /**
...
export interface AutoscalingPolicyScaleInControlResponse {
     ...
     */
    maxScaledInReplicas: outputs.compute.v1.FixedOrPercentResponse;
    /**
...
export interface BackendBucketCdnPolicyResponse {
     ...
     */
    bypassCacheOnRequestHeaders: outputs.compute.v1.BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse[];
    /**
     * The CacheKeyPolicy for this CdnPolicy.
     */
    cacheKeyPolicy: outputs.compute.v1.BackendBucketCdnPolicyCacheKeyPolicyResponse;
    /**
     ...
     */
    negativeCachingPolicy: outputs.compute.v1.BackendBucketCdnPolicyNegativeCachingPolicyResponse[];
    /**
...
export interface BackendServiceCdnPolicyResponse {
     ...
     * Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
     */
    bypassCacheOnRequestHeaders: outputs.compute.v1.BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse[];
    /**
     * The CacheKeyPolicy for this CdnPolicy.
     */
    cacheKeyPolicy: outputs.compute.v1.CacheKeyPolicyResponse;
    /**
     * Specifies the cache setting for all responses from this backend. The possible values are: USE_ORIGIN_HEADERS Requires the origin to set valid caching headers to cache content. Responses without these headers will not be cached at Google's edge, and will require a full trip to the origin on every request, potentially impacting performance and increasing load on the origin server. FORCE_CACHE_ALL Cache all content, ignoring any "private", "no-store" or "no-cache" directives in Cache-Control response headers. Warning: this may result in Cloud CDN caching private, per-user (user identifiable) content. CACHE_ALL_STATIC Automatically cache static content, including common image formats, media (video and audio), and web assets (JavaScript and CSS). Requests and responses that are marked as uncacheable, as well as dynamic content (including HTML), will not be cached.
     */
    cacheMode: string;
     ...
     * Sets a cache TTL for the specified HTTP status code. negative_caching must be enabled to configure negative_caching_policy. Omitting the policy and leaving negative_caching enabled will use Cloud CDN's default cache TTLs. Note that when specifying an explicit negative_caching_policy, you should take care to specify a cache TTL for all response codes that you wish to cache. Cloud CDN will not apply any default negative caching when a policy exists.
     */
    negativeCachingPolicy: outputs.compute.v1.BackendServiceCdnPolicyNegativeCachingPolicyResponse[];
    /**
     * If true then Cloud CDN will combine multiple concurrent cache fill requests into a small number of requests to the origin.
     */
    requestCoalescing: boolean;
...
export interface BackendServiceLocalityLoadBalancingPolicyConfigResponse {
    customPolicy: outputs.compute.v1.BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponse;
    policy: outputs.compute.v1.BackendServiceLocalityLoadBalancingPolicyConfigPolicyResponse;
}
...
export interface BindingResponse {
     ...
     */
    condition: outputs.compute.v1.ExprResponse;
    /**
...
export interface ConsistentHashLoadBalancerSettingsHttpCookieResponse {
     ...
     */
    ttl: outputs.compute.v1.DurationResponse;
}
...
export interface ConsistentHashLoadBalancerSettingsResponse {
     ...
     */
    httpCookie: outputs.compute.v1.ConsistentHashLoadBalancerSettingsHttpCookieResponse;
    /**
...
export interface DistributionPolicyResponse {
     ...
     */
    zones: outputs.compute.v1.DistributionPolicyZoneConfigurationResponse[];
}
...
export interface FirewallPolicyRuleMatcherResponse {
     ...
     */
    srcSecureTags: outputs.compute.v1.FirewallPolicyRuleSecureTagResponse[];
}
...
export interface FirewallPolicyRuleResponse {
     ...
     */
    match: outputs.compute.v1.FirewallPolicyRuleMatcherResponse;
    /**
     ...
     */
    targetSecureTags: outputs.compute.v1.FirewallPolicyRuleSecureTagResponse[];
    /**
...
export interface HttpFaultDelayResponse {
     ...
     */
    fixedDelay: outputs.compute.v1.DurationResponse;
    /**
...
export interface HttpFaultInjectionResponse {
     ...
     */
    abort: outputs.compute.v1.HttpFaultAbortResponse;
    /**
     * The specification for how client requests are delayed as part of fault injection, before being sent to a backend service.
     */
    delay: outputs.compute.v1.HttpFaultDelayResponse;
}
...
export interface HttpHeaderActionResponse {
     ...
     */
    requestHeadersToAdd: outputs.compute.v1.HttpHeaderOptionResponse[];
    /**
     ...
     */
    responseHeadersToAdd: outputs.compute.v1.HttpHeaderOptionResponse[];
    /**
...
export interface HttpHeaderMatchResponse {
     ...
     */
    rangeMatch: outputs.compute.v1.Int64RangeMatchResponse;
    /**
...
export interface HttpRetryPolicyResponse {
     ...
     */
    perTryTimeout: outputs.compute.v1.DurationResponse;
    /**
...
export interface HttpRouteActionResponse {
     ...
     */
    corsPolicy: outputs.compute.v1.CorsPolicyResponse;
    /**
     ...
     */
    faultInjectionPolicy: outputs.compute.v1.HttpFaultInjectionResponse;
    /**
     ...
     */
    maxStreamDuration: outputs.compute.v1.DurationResponse;
    /**
     * Specifies the policy on how requests intended for the route's backends are shadowed to a separate mirrored backend service. The load balancer does not wait for responses from the shadow service. Before sending traffic to the shadow service, the host / authority header is suffixed with -shadow. Not supported when the URL map is bound to a target gRPC proxy that has the validateForProxyless field set to true.
     */
    requestMirrorPolicy: outputs.compute.v1.RequestMirrorPolicyResponse;
    /**
     * Specifies the retry policy associated with this route.
     */
    retryPolicy: outputs.compute.v1.HttpRetryPolicyResponse;
    /**
     * Specifies the timeout for the selected route. Timeout is computed from the time the request has been fully processed (known as *end-of-stream*) up until the response has been processed. Timeout includes all retries. If not specified, this field uses the largest timeout among all backend services associated with the route. Not supported when the URL map is bound to a target gRPC proxy that has validateForProxyless field set to true.
     */
    timeout: outputs.compute.v1.DurationResponse;
    /**
     ...
     */
    urlRewrite: outputs.compute.v1.UrlRewriteResponse;
    /**
     * A list of weighted backend services to send traffic to when a route match occurs. The weights determine the fraction of traffic that flows to their corresponding backend service. If all traffic needs to go to a single backend service, there must be one weightedBackendService with weight set to a non-zero number. After a backend service is identified and before forwarding the request to the backend service, advanced routing actions such as URL rewrites and header transformations are applied depending on additional settings specified in this HttpRouteAction.
     */
    weightedBackendServices: outputs.compute.v1.WeightedBackendServiceResponse[];
}
...
export interface HttpRouteRuleMatchResponse {
     ...
     */
    headerMatches: outputs.compute.v1.HttpHeaderMatchResponse[];
    /**
     ...
     */
    metadataFilters: outputs.compute.v1.MetadataFilterResponse[];
    /**
     ...
     */
    queryParameterMatches: outputs.compute.v1.HttpQueryParameterMatchResponse[];
    /**
...
export interface HttpRouteRuleResponse {
     ...
     */
    headerAction: outputs.compute.v1.HttpHeaderActionResponse;
    /**
     * The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
     */
    matchRules: outputs.compute.v1.HttpRouteRuleMatchResponse[];
    /**
     ...
     */
    routeAction: outputs.compute.v1.HttpRouteActionResponse;
    /**
     ...
     */
    urlRedirect: outputs.compute.v1.HttpRedirectActionResponse;
}
...
export interface InitialStateConfigResponse {
     ...
     * The Key Database (db).
     */
    dbs: outputs.compute.v1.FileContentBufferResponse[];
    /**
     * The forbidden key database (dbx).
     */
    dbxs: outputs.compute.v1.FileContentBufferResponse[];
    /**
     * The Key Exchange Key (KEK).
     */
    keks: outputs.compute.v1.FileContentBufferResponse[];
    /**
     * The Platform Key (PK).
     */
    pk: outputs.compute.v1.FileContentBufferResponse;
}
...
export interface InstanceGroupManagerUpdatePolicyResponse {
     ...
     */
    maxSurge: outputs.compute.v1.FixedOrPercentResponse;
    /**
     ...
     */
    maxUnavailable: outputs.compute.v1.FixedOrPercentResponse;
    /**
...
export interface InstancePropertiesResponse {
     ...
     */
    advancedMachineFeatures: outputs.compute.v1.AdvancedMachineFeaturesResponse;
    /**
     ...
     */
    confidentialInstanceConfig: outputs.compute.v1.ConfidentialInstanceConfigResponse;
    /**
     ...
     */
    disks: outputs.compute.v1.AttachedDiskResponse[];
    /**
     ...
     */
    metadata: outputs.compute.v1.MetadataResponse;
    /**
     ...
     */
    networkInterfaces: outputs.compute.v1.NetworkInterfaceResponse[];
    /**
     * Note that for MachineImage, this is not supported yet.
     */
    networkPerformanceConfig: outputs.compute.v1.NetworkPerformanceConfigResponse;
    /**
     ...
     */
    reservationAffinity: outputs.compute.v1.ReservationAffinityResponse;
    /**
     * Resource manager tags to be bound to the instance. Tag keys and values have the same definition as resource manager tags. Keys must be in the format `tagKeys/{tag_key_id}`, and values are in the format `tagValues/456`. The field is ignored (both PUT & PATCH) when empty.
     */
    resourceManagerTags: {[key: string]: string};
     ...
     */
    scheduling: outputs.compute.v1.SchedulingResponse;
    /**
     * A list of service accounts with specified scopes. Access tokens for these service accounts are available to the instances that are created from these properties. Use metadata queries to obtain the access tokens for these instances.
     */
    serviceAccounts: outputs.compute.v1.ServiceAccountResponse[];
    /**
     * Note that for MachineImage, this is not supported yet.
     */
    shieldedInstanceConfig: outputs.compute.v1.ShieldedInstanceConfigResponse;
    /**
...
export interface LogConfigCloudAuditOptionsResponse {
     ...
     * This is deprecated and has no effect. Do not use.
     */
    authorizationLoggingOptions: outputs.compute.v1.AuthorizationLoggingOptionsResponse;
    /**
     * This is deprecated and has no effect. Do not use.
     */
    logName: string;
...
export interface LogConfigCounterOptionsResponse {
     ...
     * This is deprecated and has no effect. Do not use.
     */
    customFields: outputs.compute.v1.LogConfigCounterOptionsCustomFieldResponse[];
    /**
     * This is deprecated and has no effect. Do not use.
     */
    field: string;
...
export interface LogConfigResponse {
     ...
     * This is deprecated and has no effect. Do not use.
     */
    cloudAudit: outputs.compute.v1.LogConfigCloudAuditOptionsResponse;
    /**
     * This is deprecated and has no effect. Do not use.
     */
    counter: outputs.compute.v1.LogConfigCounterOptionsResponse;
    /**
     * This is deprecated and has no effect. Do not use.
     */
    dataAccess: outputs.compute.v1.LogConfigDataAccessOptionsResponse;
}
...
export interface MetadataFilterResponse {
     ...
     */
    filterLabels: outputs.compute.v1.MetadataFilterLabelMatchResponse[];
    /**
...
export interface NetworkInterfaceResponse {
     ...
     */
    accessConfigs: outputs.compute.v1.AccessConfigResponse[];
    /**
     * An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
     */
    aliasIpRanges: outputs.compute.v1.AliasIpRangeResponse[];
    /**
     ...
     */
    ipv6AccessConfigs: outputs.compute.v1.AccessConfigResponse[];
    /**
...
export interface NodeGroupMaintenanceWindowResponse {
     ...
     */
    maintenanceDuration: outputs.compute.v1.DurationResponse;
    /**
...
export interface OutlierDetectionResponse {
     ...
     */
    baseEjectionTime: outputs.compute.v1.DurationResponse;
    /**
     ...
     */
    interval: outputs.compute.v1.DurationResponse;
    /**
...
export interface PacketMirroringMirroredResourceInfoResponse {
     ...
     */
    instances: outputs.compute.v1.PacketMirroringMirroredResourceInfoInstanceInfoResponse[];
    /**
     * A set of subnetworks for which traffic from/to all VM instances will be mirrored. They must live in the same region as this packetMirroring. You may specify a maximum of 5 subnetworks.
     */
    subnetworks: outputs.compute.v1.PacketMirroringMirroredResourceInfoSubnetInfoResponse[];
    /**
...
export interface PathMatcherResponse {
     ...
     */
    defaultRouteAction: outputs.compute.v1.HttpRouteActionResponse;
    /**
     ...
     */
    defaultUrlRedirect: outputs.compute.v1.HttpRedirectActionResponse;
    /**
     * An optional description of this resource. Provide this property when you create the resource.
     */
    description: string;
     ...
     */
    pathRules: outputs.compute.v1.PathRuleResponse[];
    /**
     * The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
     */
    routeRules: outputs.compute.v1.HttpRouteRuleResponse[];
}
...
export interface RegionSslPolicyWarningsItemResponse {
     ...
     */
    data: outputs.compute.v1.RegionSslPolicyWarningsItemDataItemResponse[];
    /**
...
export interface ReservationResponse {
     ...
     */
    shareSettings: outputs.compute.v1.ShareSettingsResponse;
    /**
     * Reservation for instances with specific machine shapes.
     */
    specificReservation: outputs.compute.v1.AllocationSpecificSKUReservationResponse;
    /**
...
export interface ResourcePolicyInstanceSchedulePolicyResponse {
     ...
     */
    vmStartSchedule: outputs.compute.v1.ResourcePolicyInstanceSchedulePolicyScheduleResponse;
    /**
     * Specifies the schedule for stopping instances.
     */
    vmStopSchedule: outputs.compute.v1.ResourcePolicyInstanceSchedulePolicyScheduleResponse;
}
...
export interface ResourcePolicySnapshotSchedulePolicyResponse {
     ...
     */
    retentionPolicy: outputs.compute.v1.ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponse;
    /**
     * A Vm Maintenance Policy specifies what kind of infrastructure maintenance we are allowed to perform on this VM and when. Schedule that is applied to disks covered by this policy.
     */
    schedule: outputs.compute.v1.ResourcePolicySnapshotSchedulePolicyScheduleResponse;
    /**
     * Properties with which snapshots are created such as labels, encryption keys.
     */
    snapshotProperties: outputs.compute.v1.ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponse;
}
...
export interface ResourcePolicySnapshotSchedulePolicyScheduleResponse {
    ...
    weeklySchedule: outputs.compute.v1.ResourcePolicyWeeklyCycleResponse;
}
...
export interface RouterBgpPeerResponse {
     ...
     */
    advertisedIpRanges: outputs.compute.v1.RouterAdvertisedIpRangeResponse[];
    /**
...
export interface RouterNatResponse {
     ...
     */
    logConfig: outputs.compute.v1.RouterNatLogConfigResponse;
    /**
     ...
     */
    subnetworks: outputs.compute.v1.RouterNatSubnetworkToNatResponse[];
    /**
...
export interface RuleResponse {
     ...
     * This is deprecated and has no effect. Do not use.
     */
    conditions: outputs.compute.v1.ConditionResponse[];
    /**
     * This is deprecated and has no effect. Do not use.
     */
    description: string;
     ...
     * This is deprecated and has no effect. Do not use.
     */
    logConfigs: outputs.compute.v1.LogConfigResponse[];
    /**
     * This is deprecated and has no effect. Do not use.
     */
    notIns: string[];
...
export interface SchedulingResponse {
     ...
     */
    nodeAffinities: outputs.compute.v1.SchedulingNodeAffinityResponse[];
    /**
...
export interface SecurityPolicyAdaptiveProtectionConfigResponse {
     ...
     */
    layer7DdosDefenseConfig: outputs.compute.v1.SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponse;
}
...
export interface SecurityPolicyAdvancedOptionsConfigResponse {
     ...
     */
    jsonCustomConfig: outputs.compute.v1.SecurityPolicyAdvancedOptionsConfigJsonCustomConfigResponse;
    jsonParsing: string;
    logLevel: string;
}
...
export interface SecurityPolicyRuleHttpHeaderActionResponse {
     ...
     */
    requestHeadersToAdds: outputs.compute.v1.SecurityPolicyRuleHttpHeaderActionHttpHeaderOptionResponse[];
}
...
export interface SecurityPolicyRuleMatcherResponse {
     ...
     */
    config: outputs.compute.v1.SecurityPolicyRuleMatcherConfigResponse;
    /**
     * User defined CEVAL expression. A CEVAL expression is used to specify match criteria such as origin.ip, source.region_code and contents in the request header.
     */
    expr: outputs.compute.v1.ExprResponse;
    /**
...
export interface SecurityPolicyRuleRateLimitOptionsResponse {
     ...
     */
    banThreshold: outputs.compute.v1.SecurityPolicyRuleRateLimitOptionsThresholdResponse;
    /**
     ...
     */
    exceedRedirectOptions: outputs.compute.v1.SecurityPolicyRuleRedirectOptionsResponse;
    /**
     * Threshold at which to begin ratelimiting.
     */
    rateLimitThreshold: outputs.compute.v1.SecurityPolicyRuleRateLimitOptionsThresholdResponse;
}
...
export interface SecurityPolicyRuleResponse {
     ...
     */
    headerAction: outputs.compute.v1.SecurityPolicyRuleHttpHeaderActionResponse;
    /**
     ...
     * A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
     */
    match: outputs.compute.v1.SecurityPolicyRuleMatcherResponse;
    /**
     ...
     */
    rateLimitOptions: outputs.compute.v1.SecurityPolicyRuleRateLimitOptionsResponse;
    /**
     * Parameters defining the redirect action. Cannot be specified for any other actions.
     */
    redirectOptions: outputs.compute.v1.SecurityPolicyRuleRedirectOptionsResponse;
}
...
export interface SourceInstanceParamsResponse {
     ...
     */
    diskConfigs: outputs.compute.v1.DiskInstantiationConfigResponse[];
}
...
export interface SourceInstancePropertiesResponse {
     ...
     */
    disks: outputs.compute.v1.SavedAttachedDiskResponse[];
    /**
...
export interface StatefulPolicyResponse {
    preservedState: outputs.compute.v1.StatefulPolicyPreservedStateResponse;
}
...
export interface UrlMapTestResponse {
     ...
     */
    headers: outputs.compute.v1.UrlMapTestHeaderResponse[];
    /**
