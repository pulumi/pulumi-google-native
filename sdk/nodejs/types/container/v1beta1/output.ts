...
export interface AcceleratorConfigResponse {
     ...
     */
    gpuSharingConfig: outputs.container.v1beta1.GPUSharingConfigResponse;
    /**
...
export interface AddonsConfigResponse {
     ...
     */
    cloudRunConfig: outputs.container.v1beta1.CloudRunConfigResponse;
    /**
     * Configuration for the ConfigConnector add-on, a Kubernetes extension to manage hosted GCP services through the Kubernetes API
     */
    configConnectorConfig: outputs.container.v1beta1.ConfigConnectorConfigResponse;
    /**
     * Configuration for NodeLocalDNS, a dns cache running on cluster nodes
     */
    dnsCacheConfig: outputs.container.v1beta1.DnsCacheConfigResponse;
    /**
     ...
     */
    gkeBackupAgentConfig: outputs.container.v1beta1.GkeBackupAgentConfigResponse;
    /**
     ...
     */
    httpLoadBalancing: outputs.container.v1beta1.HttpLoadBalancingResponse;
    /**
     * Configuration for Istio, an open platform to connect, manage, and secure microservices.
     */
    istioConfig: outputs.container.v1beta1.IstioConfigResponse;
    /**
     * Configuration for the KALM addon, which manages the lifecycle of k8s applications.
     */
    kalmConfig: outputs.container.v1beta1.KalmConfigResponse;
    /**
     * Configuration for the Kubernetes Dashboard. This addon is deprecated, and will be disabled in 1.15. It is recommended to use the Cloud Console to manage and monitor your Kubernetes clusters, workloads and applications. For more information, see: https://cloud.google.com/kubernetes-engine/docs/concepts/dashboards
     */
    kubernetesDashboard: outputs.container.v1beta1.KubernetesDashboardResponse;
    /**
     * Configuration for NetworkPolicy. This only tracks whether the addon is enabled or not on the Master, it does not track whether network policy is enabled for the nodes.
     */
    networkPolicyConfig: outputs.container.v1beta1.NetworkPolicyConfigResponse;
}
...
export interface AutoprovisioningNodePoolDefaultsResponse {
     ...
     */
    management: outputs.container.v1beta1.NodeManagementResponse;
    /**
 ...
 * Deprecated.
 */
export interface AvailableVersionResponse {
    /**
...
export interface BlueGreenSettingsResponse {
     ...
     */
    standardRolloutPolicy: outputs.container.v1beta1.StandardRolloutPolicyResponse;
}
...
export interface ClusterAutoscalingResponse {
     ...
     * AutoprovisioningNodePoolDefaults contains defaults for a node pool created by NAP.
     */
    autoprovisioningNodePoolDefaults: outputs.container.v1beta1.AutoprovisioningNodePoolDefaultsResponse;
    /**
     ...
     */
    resourceLimits: outputs.container.v1beta1.ResourceLimitResponse[];
}
 ...
 */
export interface EphemeralStorageConfigResponse {
    /**
 ...
 */
export interface KalmConfigResponse {
    /**
...
export interface MaintenancePolicyResponse {
     ...
     */
    window: outputs.container.v1beta1.MaintenanceWindowResponse;
}
...
export interface MaintenanceWindowResponse {
     ...
     */
    dailyMaintenanceWindow: outputs.container.v1beta1.DailyMaintenanceWindowResponse;
    /**
     ...
     */
    recurringWindow: outputs.container.v1beta1.RecurringTimeWindowResponse;
}
...
export interface MasterAuthResponse {
     ...
     */
    clientCertificateConfig: outputs.container.v1beta1.ClientCertificateConfigResponse;
    /**
...
export interface MasterAuthorizedNetworksConfigResponse {
     ...
     */
    cidrBlocks: outputs.container.v1beta1.CidrBlockResponse[];
    /**
...
export interface MonitoringConfigResponse {
     ...
     */
    managedPrometheusConfig: outputs.container.v1beta1.ManagedPrometheusConfigResponse;
}
...
export interface NetworkConfigResponse {
     ...
     */
    defaultSnatStatus: outputs.container.v1beta1.DefaultSnatStatusResponse;
    /**
     * DNSConfig contains clusterDNS config for this cluster.
     */
    dnsConfig: outputs.container.v1beta1.DNSConfigResponse;
    /**
     ...
     */
    serviceExternalIpsConfig: outputs.container.v1beta1.ServiceExternalIPsConfigResponse;
    /**
...
export interface NodeConfigDefaultsResponse {
     ...
     */
    gcfsConfig: outputs.container.v1beta1.GcfsConfigResponse;
    /**
     * Logging configuration for node pools.
     */
    loggingConfig: outputs.container.v1beta1.NodePoolLoggingConfigResponse;
}
...
export interface NodeConfigResponse {
     ...
     */
    accelerators: outputs.container.v1beta1.AcceleratorConfigResponse[];
    /**
     * Advanced features for the Compute Engine VM.
     */
    advancedMachineFeatures: outputs.container.v1beta1.AdvancedMachineFeaturesResponse;
    /**
     *  The Customer Managed Encryption Key used to encrypt the boot disk attached to each node in the node pool. This should be of the form projects/[KEY_PROJECT_ID]/locations/[LOCATION]/keyRings/[RING_NAME]/cryptoKeys/[KEY_NAME]. For more information about protecting resources with Cloud KMS Keys please see: https://cloud.google.com/compute/docs/disks/customer-managed-encryption
     */
    bootDiskKmsKey: string;
     ...
     */
    confidentialNodes: outputs.container.v1beta1.ConfidentialNodesResponse;
    /**
     * Size of the disk attached to each node, specified in GB. The smallest allowed disk size is 10GB. If unspecified, the default disk size is 100GB.
     */
    diskSizeGb: number;
     ...
     */
    kubeletConfig: outputs.container.v1beta1.NodeKubeletConfigResponse;
    /**
     ...
     * Parameters that can be configured on Linux nodes.
     */
    linuxNodeConfig: outputs.container.v1beta1.LinuxNodeConfigResponse;
    /**
     ...
     */
    reservationAffinity: outputs.container.v1beta1.ReservationAffinityResponse;
    /**
     * Sandbox configuration for this node.
     */
    sandboxConfig: outputs.container.v1beta1.SandboxConfigResponse;
    /**
     * The Google Cloud Platform Service Account to be used by the node VMs. Specify the email address of the Service Account; otherwise, if no Service Account is specified, the "default" service account is used.
     */
    serviceAccount: string;
     ...
     */
    taints: outputs.container.v1beta1.NodeTaintResponse[];
    /**
     * The workload metadata configuration for this node.
     */
    workloadMetadataConfig: outputs.container.v1beta1.WorkloadMetadataConfigResponse;
}
...
export interface NodeManagementResponse {
     ...
     */
    upgradeOptions: outputs.container.v1beta1.AutoUpgradeOptionsResponse;
}
...
export interface NodeNetworkConfigResponse {
     ...
     */
    networkPerformanceConfig: outputs.container.v1beta1.NetworkPerformanceConfigResponse;
    /**
...
export interface NodePoolAutoConfigResponse {
     ...
     */
    networkTags: outputs.container.v1beta1.NetworkTagsResponse;
}
...
export interface NodePoolDefaultsResponse {
     ...
     * Subset of NodeConfig message that has defaults.
     */
    nodeConfigDefaults: outputs.container.v1beta1.NodeConfigDefaultsResponse;
}
...
export interface NodePoolLoggingConfigResponse {
     ...
     */
    variantConfig: outputs.container.v1beta1.LoggingVariantConfigResponse;
}
...
export interface NodePoolResponse {
     ...
     */
    autoscaling: outputs.container.v1beta1.NodePoolAutoscalingResponse;
    /**
     * Which conditions caused the current node pool state.
     */
    conditions: outputs.container.v1beta1.StatusConditionResponse[];
    /**
     * The node configuration of the pool.
     */
    config: outputs.container.v1beta1.NodeConfigResponse;
    /**
     ...
     */
    maxPodsConstraint: outputs.container.v1beta1.MaxPodsConstraintResponse;
    /**
     ...
     */
    networkConfig: outputs.container.v1beta1.NodeNetworkConfigResponse;
    /**
     * Specifies the node placement policy.
     */
    placementPolicy: outputs.container.v1beta1.PlacementPolicyResponse;
    /**
     ...
     */
    updateInfo: outputs.container.v1beta1.UpdateInfoResponse;
    /**
     * Upgrade settings control disruption and speed of the upgrade.
     */
    upgradeSettings: outputs.container.v1beta1.UpgradeSettingsResponse;
...
export interface NotificationConfigResponse {
     ...
     */
    pubsub: outputs.container.v1beta1.PubSubResponse;
}
 ...
 */
export interface PodSecurityPolicyConfigResponse {
    /**
...
export interface PrivateClusterConfigResponse {
     ...
     */
    masterGlobalAccessConfig: outputs.container.v1beta1.PrivateClusterMasterGlobalAccessConfigResponse;
    /**
 ...
 */
export interface ProtectConfigResponse {
    /**
     * WorkloadConfig defines which actions are enabled for a cluster's workload configurations.
     */
    workloadConfig: outputs.container.v1beta1.WorkloadConfigResponse;
    /**
...
export interface PubSubResponse {
     ...
     */
    filter: outputs.container.v1beta1.FilterResponse;
    /**
...
export interface RecurringTimeWindowResponse {
     ...
     */
    window: outputs.container.v1beta1.TimeWindowResponse;
}
...
export interface ReleaseChannelConfigResponse {
     ...
     */
    availableVersions: outputs.container.v1beta1.AvailableVersionResponse[];
    /**
...
export interface ResourceUsageExportConfigResponse {
     ...
     */
    bigqueryDestination: outputs.container.v1beta1.BigQueryDestinationResponse;
    /**
     * Configuration to enable resource consumption metering.
     */
    consumptionMeteringConfig: outputs.container.v1beta1.ConsumptionMeteringConfigResponse;
    /**
...
export interface TimeWindowResponse {
     ...
     */
    maintenanceExclusionOptions: outputs.container.v1beta1.MaintenanceExclusionOptionsResponse;
    /**
 ...
 */
export interface TpuConfigResponse {
    /**
...
export interface UpdateInfoResponse {
     ...
     */
    blueGreenInfo: outputs.container.v1beta1.BlueGreenInfoResponse;
}
...
export interface UpgradeSettingsResponse {
     ...
     */
    blueGreenSettings: outputs.container.v1beta1.BlueGreenSettingsResponse;
    /**
 ...
 */
export interface WorkloadALTSConfigResponse {
    /**
 ...
 */
export interface WorkloadConfigResponse {
    /**
