 ...
 */
export interface AlloyDbConnectionProfileResponse {
    /**
     ...
     */
    settings: outputs.datamigration.v1.AlloyDbSettingsResponse;
}

/**
 * Settings for creating an AlloyDB cluster.
 */
export interface AlloyDbSettingsResponse {
    /**
     * Input only. Initial user to setup during cluster creation. Required.
     */
    initialUser: outputs.datamigration.v1.UserPasswordResponse;
    /**
     * Labels for the AlloyDB cluster created by DMS. An object containing a list of 'key', 'value' pairs.
     */
    labels: {[key: string]: string};
    primaryInstanceSettings: outputs.datamigration.v1.PrimaryInstanceSettingsResponse;
    /**
...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.datamigration.v1.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.datamigration.v1.ExprResponse;
    /**
...
export interface CloudSqlConnectionProfileResponse {
     ...
     */
    settings: outputs.datamigration.v1.CloudSqlSettingsResponse;
}
...
export interface CloudSqlSettingsResponse {
     ...
     */
    ipConfig: outputs.datamigration.v1.SqlIpConfigResponse;
    /**
 ...
 */
export interface DumpFlagResponse {
    /**
 ...
 */
export interface DumpFlagsResponse {
    /**
     * The flags for the initial dump.
     */
    dumpFlags: outputs.datamigration.v1.DumpFlagResponse[];
}
 ...
 */
export interface PostgreSqlConnectionProfileResponse {
    /**
     * If the source is a Cloud SQL database, use this field to provide the Cloud SQL instance ID of the source.
     */
    cloudSqlId: string;
 ...
 */
export interface PrimaryInstanceSettingsResponse {
    /**
     ...
     */
    machineConfig: outputs.datamigration.v1.MachineConfigResponse;
    /**
...
export interface SqlIpConfigResponse {
     ...
     */
    authorizedNetworks: outputs.datamigration.v1.SqlAclEntryResponse[];
    /**
