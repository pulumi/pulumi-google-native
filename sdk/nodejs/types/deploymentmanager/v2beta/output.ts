...
export interface AsyncOptionsResponse {
     ...
     */
    pollingOptions: outputs.deploymentmanager.v2beta.PollingOptionsResponse;
}
...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.deploymentmanager.v2beta.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.deploymentmanager.v2beta.ExprResponse;
    /**
...
export interface CredentialResponse {
     ...
     */
    basicAuth: outputs.deploymentmanager.v2beta.BasicAuthResponse;
    /**
     * Service Account Credential, only used by Deployment.
     */
    serviceAccount: outputs.deploymentmanager.v2beta.ServiceAccountResponse;
    /**
...
export interface DeploymentUpdateResponse {
     ...
     */
    labels: outputs.deploymentmanager.v2beta.DeploymentUpdateLabelEntryResponse[];
    /**
...
export interface OptionsResponse {
     ...
     */
    asyncOptions: outputs.deploymentmanager.v2beta.AsyncOptionsResponse[];
    /**
     * The mappings that apply for requests.
     */
    inputMappings: outputs.deploymentmanager.v2beta.InputMappingResponse[];
    /**
     * Options for how to validate and process properties on a resource.
     */
    validationOptions: outputs.deploymentmanager.v2beta.ValidationOptionsResponse;
    /**
...
export interface PollingOptionsResponse {
     ...
     */
    diagnostics: outputs.deploymentmanager.v2beta.DiagnosticResponse[];
    /**
...
export interface TargetConfigurationResponse {
     ...
     */
    config: outputs.deploymentmanager.v2beta.ConfigFileResponse;
    /**
     * Specifies any files to import for this configuration. This can be used to import templates or other files. For example, you might import a text file in order to use the file in a template.
     */
    imports: outputs.deploymentmanager.v2beta.ImportFileResponse[];
}
