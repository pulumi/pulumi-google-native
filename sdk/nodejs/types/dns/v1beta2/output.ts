...
export interface GoogleIamV1AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.dns.v1beta2.GoogleIamV1AuditLogConfigResponse[];
    /**
...
export interface GoogleIamV1BindingResponse {
     ...
     */
    condition: outputs.dns.v1beta2.ExprResponse;
    /**
...
export interface ManagedZoneDnsSecConfigResponse {
     ...
     */
    defaultKeySpecs: outputs.dns.v1beta2.DnsKeySpecResponse[];
    kind: string;
    /**
...
export interface ManagedZoneForwardingConfigResponse {
     ...
     */
    targetNameServers: outputs.dns.v1beta2.ManagedZoneForwardingConfigNameServerTargetResponse[];
}
...
export interface ManagedZonePeeringConfigResponse {
     ...
     */
    targetNetwork: outputs.dns.v1beta2.ManagedZonePeeringConfigTargetNetworkResponse;
}
...
export interface ManagedZonePrivateVisibilityConfigResponse {
     ...
     */
    gkeClusters: outputs.dns.v1beta2.ManagedZonePrivateVisibilityConfigGKEClusterResponse[];
    kind: string;
    /**
     * The list of VPC networks that can see this zone.
     */
    networks: outputs.dns.v1beta2.ManagedZonePrivateVisibilityConfigNetworkResponse[];
}
...
export interface ManagedZoneServiceDirectoryConfigResponse {
     ...
     */
    namespace: outputs.dns.v1beta2.ManagedZoneServiceDirectoryConfigNamespaceResponse;
}
...
export interface PolicyAlternativeNameServerConfigResponse {
     ...
     */
    targetNameServers: outputs.dns.v1beta2.PolicyAlternativeNameServerConfigTargetNameServerResponse[];
}
...
export interface RRSetRoutingPolicyGeoPolicyGeoPolicyItemResponse {
     ...
     */
    healthCheckedTargets: outputs.dns.v1beta2.RRSetRoutingPolicyHealthCheckTargetsResponse;
    kind: string;
    /**
...
export interface RRSetRoutingPolicyHealthCheckTargetsResponse {
    internalLoadBalancers: outputs.dns.v1beta2.RRSetRoutingPolicyLoadBalancerTargetResponse[];
}
...
export interface RRSetRoutingPolicyPrimaryBackupPolicyResponse {
     ...
     */
    backupGeoTargets: outputs.dns.v1beta2.RRSetRoutingPolicyGeoPolicyResponse;
    kind: string;
    primaryTargets: outputs.dns.v1beta2.RRSetRoutingPolicyHealthCheckTargetsResponse;
    /**
...
export interface RRSetRoutingPolicyResponse {
    ...
    kind: string;
    primaryBackup: outputs.dns.v1beta2.RRSetRoutingPolicyPrimaryBackupPolicyResponse;
...
export interface ResponsePolicyRuleLocalDataResponse {
     ...
     */
    localDatas: outputs.dns.v1beta2.ResourceRecordSetResponse[];
}
