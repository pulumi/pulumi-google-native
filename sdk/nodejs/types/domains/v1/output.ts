...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.domains.v1.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.domains.v1.ExprResponse;
    /**
...
export interface ContactResponse {
     ...
     */
    postalAddress: outputs.domains.v1.PostalAddressResponse;
}
...
export interface ContactSettingsResponse {
     ...
     */
    adminContact: outputs.domains.v1.ContactResponse;
    /**
     ...
     */
    registrantContact: outputs.domains.v1.ContactResponse;
    /**
     * The technical contact for the `Registration`.
     */
    technicalContact: outputs.domains.v1.ContactResponse;
}

/**
 * Configuration for an arbitrary DNS provider.
 */
export interface CustomDnsResponse {
    /**
     * The list of DS records for this domain, which are used to enable DNSSEC. The domain's DNS provider can provide the values to set here. If this field is empty, DNSSEC is disabled.
     */
    dsRecords: outputs.domains.v1.DsRecordResponse[];
    /**
...
export interface DnsSettingsResponse {
     ...
     */
    customDns: outputs.domains.v1.CustomDnsResponse;
    /**
     * The list of glue records for this `Registration`. Commonly empty.
     */
    glueRecords: outputs.domains.v1.GlueRecordResponse[];
    /**
     * The free DNS zone provided by [Google Domains](https://domains.google/).
     */
    googleDomainsDns: outputs.domains.v1.GoogleDomainsDnsResponse;
}
 ...
 */
export interface GoogleDomainsDnsResponse {
    /**
