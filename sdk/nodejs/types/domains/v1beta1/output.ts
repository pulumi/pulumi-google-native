...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.domains.v1beta1.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.domains.v1beta1.ExprResponse;
    /**
...
export interface DnsSettingsResponse {
     ...
     */
    customDns: outputs.domains.v1beta1.CustomDnsResponse;
    /**
     * The list of glue records for this `Registration`. Commonly empty.
     */
    glueRecords: outputs.domains.v1beta1.GlueRecordResponse[];
    /**
     * The free DNS zone provided by [Google Domains](https://domains.google/).
     */
    googleDomainsDns: outputs.domains.v1beta1.GoogleDomainsDnsResponse;
}
