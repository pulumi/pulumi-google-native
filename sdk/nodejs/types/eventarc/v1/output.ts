...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.eventarc.v1.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.eventarc.v1.ExprResponse;
    /**
...
export interface DestinationResponse {
     ...
     */
    cloudRun: outputs.eventarc.v1.CloudRunResponse;
    /**
     * A GKE service capable of receiving events. The service should be running in the same project as the trigger.
     */
    gke: outputs.eventarc.v1.GKEResponse;
    /**
