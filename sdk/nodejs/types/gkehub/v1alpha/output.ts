...
export interface AnthosObservabilityFeatureSpecResponse {
     ...
     */
    defaultMembershipSpec: outputs.gkehub.v1alpha.AnthosObservabilityMembershipSpecResponse;
}
...
export interface AppDevExperienceFeatureStateResponse {
     ...
     */
    networkingInstallSucceeded: outputs.gkehub.v1alpha.StatusResponse;
}
...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.gkehub.v1alpha.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.gkehub.v1alpha.ExprResponse;
    /**
 ...
 */
export interface CloudAuditLoggingFeatureSpecResponse {
    /**
...
export interface CommonFeatureSpecResponse {
     ...
     * Anthos Observability spec
     */
    anthosobservability: outputs.gkehub.v1alpha.AnthosObservabilityFeatureSpecResponse;
    /**
     * Appdevexperience specific spec.
     */
    appdevexperience: outputs.gkehub.v1alpha.AppDevExperienceFeatureSpecResponse;
    /**
     * Cloud Audit Logging-specific spec.
     */
    cloudauditlogging: outputs.gkehub.v1alpha.CloudAuditLoggingFeatureSpecResponse;
    /**
     * FleetObservability feature spec.
     */
    fleetobservability: outputs.gkehub.v1alpha.FleetObservabilityFeatureSpecResponse;
    /**
     * Multicluster Ingress-specific spec.
     */
    multiclusteringress: outputs.gkehub.v1alpha.MultiClusterIngressFeatureSpecResponse;
    /**
     * Workload Certificate spec.
     */
    workloadcertificate: outputs.gkehub.v1alpha.FeatureSpecResponse;
}
...
export interface CommonFeatureStateResponse {
     ...
     */
    appdevexperience: outputs.gkehub.v1alpha.AppDevExperienceFeatureStateResponse;
    /**
     * FleetObservability feature state.
     */
    fleetobservability: outputs.gkehub.v1alpha.FleetObservabilityFeatureStateResponse;
    /**
     * Service Mesh-specific state.
     */
    servicemesh: outputs.gkehub.v1alpha.ServiceMeshFeatureStateResponse;
    /**
     * The "running state" of the Feature in this Hub.
     */
    state: outputs.gkehub.v1alpha.FeatureStateResponse;
}
 ...
 */
export interface FleetLifecycleStateResponse {
    /**
...
export interface KubernetesResourceResponse {
     ...
     */
    connectResources: outputs.gkehub.v1alpha.ResourceManifestResponse[];
    /**
     ...
     */
    membershipResources: outputs.gkehub.v1alpha.ResourceManifestResponse[];
    /**
     * Optional. Options for Kubernetes resource generation.
     */
    resourceOptions: outputs.gkehub.v1alpha.ResourceOptionsResponse;
}
...
export interface MembershipEndpointResponse {
     ...
     */
    applianceCluster: outputs.gkehub.v1alpha.ApplianceClusterResponse;
    /**
     * Optional. Specific information for a Google Edge cluster.
     */
    edgeCluster: outputs.gkehub.v1alpha.EdgeClusterResponse;
    /**
     * Optional. Specific information for a GKE-on-GCP cluster.
     */
    gkeCluster: outputs.gkehub.v1alpha.GkeClusterResponse;
    /**
     * Useful Kubernetes-specific metadata.
     */
    kubernetesMetadata: outputs.gkehub.v1alpha.KubernetesMetadataResponse;
    /**
     * Optional. The in-cluster Kubernetes Resources that should be applied for a correctly registered cluster, in the steady state. These resources: * Ensure that the cluster is exclusively registered to one and only one Hub Membership. * Propagate Workload Pool Information available in the Membership Authority field. * Ensure proper initial configuration of default Hub Features.
     */
    kubernetesResource: outputs.gkehub.v1alpha.KubernetesResourceResponse;
    /**
     * Optional. Specific information for a GKE Multi-Cloud cluster.
     */
    multiCloudCluster: outputs.gkehub.v1alpha.MultiCloudClusterResponse;
    /**
     * Optional. Specific information for a GKE On-Prem cluster. An onprem user-cluster who has no resourceLink is not allowed to use this field, it should have a nil "type" instead.
     */
    onPremCluster: outputs.gkehub.v1alpha.OnPremClusterResponse;
}

/**
 * **Workload Certificate**: The membership-specific input for WorkloadCertificate feature.
 */
export interface MembershipSpecResponse {
    /**
 ...
 */
export interface ServiceMeshAnalysisMessageBaseResponse {
    /**
     ...
     */
    type: outputs.gkehub.v1alpha.ServiceMeshTypeResponse;
}

/**
 * AnalysisMessage is a single message produced by an analyzer, and it used to communicate to the end user about the state of their Service Mesh configuration.
 */
export interface ServiceMeshAnalysisMessageResponse {
    /**
     ...
     */
    messageBase: outputs.gkehub.v1alpha.ServiceMeshAnalysisMessageBaseResponse;
    /**
 ...
 */
export interface ServiceMeshFeatureStateResponse {
    /**
     * Results of running Service Mesh analyzers.
     */
    analysisMessages: outputs.gkehub.v1alpha.ServiceMeshAnalysisMessageResponse[];
}

/**
 * A unique identifier for the type of message. Display_name is intended to be human-readable, code is intended to be machine readable. There should be a one-to-one mapping between display_name and code. (i.e. do not re-use display_names or codes between message types.) See istio.analysis.v1alpha1.AnalysisMessageBase.Type
 */
export interface ServiceMeshTypeResponse {
    /**
