...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.gkehub.v1alpha2.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.gkehub.v1alpha2.ExprResponse;
    /**
...
export interface KubernetesResourceResponse {
     ...
     */
    connectResources: outputs.gkehub.v1alpha2.ResourceManifestResponse[];
    /**
     ...
     */
    membershipResources: outputs.gkehub.v1alpha2.ResourceManifestResponse[];
    /**
     * Optional. Options for Kubernetes resource generation.
     */
    resourceOptions: outputs.gkehub.v1alpha2.ResourceOptionsResponse;
}
...
export interface MembershipEndpointResponse {
     ...
     */
    applianceCluster: outputs.gkehub.v1alpha2.ApplianceClusterResponse;
    /**
     * Optional. Specific information for a Google Edge cluster.
     */
    edgeCluster: outputs.gkehub.v1alpha2.EdgeClusterResponse;
    /**
     ...
     */
    kubernetesMetadata: outputs.gkehub.v1alpha2.KubernetesMetadataResponse;
    /**
