 ...
 */
export interface AnthosObservabilityFeatureSpecResponse {
    /**
     * Default membership spec for unconfigured memberships
     */
    defaultMembershipSpec: outputs.gkehub.v1beta.AnthosObservabilityMembershipSpecResponse;
}

/**
 * **Anthosobservability**: Per-Membership Feature spec.
 */
export interface AnthosObservabilityMembershipSpecResponse {
    /**
...
export interface AppDevExperienceFeatureStateResponse {
     ...
     */
    networkingInstallSucceeded: outputs.gkehub.v1beta.StatusResponse;
}
...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.gkehub.v1beta.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.gkehub.v1beta.ExprResponse;
    /**
...
export interface CommonFeatureSpecResponse {
     ...
     * Anthos Observability spec
     */
    anthosobservability: outputs.gkehub.v1beta.AnthosObservabilityFeatureSpecResponse;
    /**
     * Appdevexperience specific spec.
     */
    appdevexperience: outputs.gkehub.v1beta.AppDevExperienceFeatureSpecResponse;
    /**
     * FleetObservability feature spec.
     */
    fleetobservability: outputs.gkehub.v1beta.FleetObservabilityFeatureSpecResponse;
    /**
     * Multicluster Ingress-specific spec.
     */
    multiclusteringress: outputs.gkehub.v1beta.MultiClusterIngressFeatureSpecResponse;
}
...
export interface CommonFeatureStateResponse {
     ...
     */
    appdevexperience: outputs.gkehub.v1beta.AppDevExperienceFeatureStateResponse;
    /**
     * FleetObservability feature state.
     */
    fleetobservability: outputs.gkehub.v1beta.FleetObservabilityFeatureStateResponse;
    /**
     * The "running state" of the Feature in this Hub.
     */
    state: outputs.gkehub.v1beta.FeatureStateResponse;
}
