...
export interface CompanyDerivedInfoResponse {
     ...
     */
    headquartersLocation: outputs.jobs.v3.LocationResponse;
}
...
export interface CompensationEntryResponse {
     ...
     */
    amount: outputs.jobs.v3.MoneyResponse;
    /**
     ...
     */
    range: outputs.jobs.v3.CompensationRangeResponse;
    /**
...
export interface CompensationInfoResponse {
     ...
     */
    annualizedBaseCompensationRange: outputs.jobs.v3.CompensationRangeResponse;
    /**
     ...
     */
    annualizedTotalCompensationRange: outputs.jobs.v3.CompensationRangeResponse;
    /**
     * Optional. Job compensation information. At most one entry can be of type CompensationInfo.CompensationType.BASE, which is referred as ** base compensation entry ** for the job.
     */
    entries: outputs.jobs.v3.CompensationEntryResponse[];
}
...
export interface CompensationRangeResponse {
     ...
     */
    maxCompensation: outputs.jobs.v3.MoneyResponse;
    /**
     ...
     */
    minCompensation: outputs.jobs.v3.MoneyResponse;
}
...
export interface JobDerivedInfoResponse {
     ...
     */
    locations: outputs.jobs.v3.LocationResponse[];
}
...
export interface LocationResponse {
     ...
     */
    latLng: outputs.jobs.v3.LatLngResponse;
    /**
     ...
     */
    postalAddress: outputs.jobs.v3.PostalAddressResponse;
    /**
