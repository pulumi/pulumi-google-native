...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.metastore.v1beta.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.metastore.v1beta.ExprResponse;
    /**
...
export interface HiveMetastoreConfigResponse {
     ...
     */
    kerberosConfig: outputs.metastore.v1beta.KerberosConfigResponse;
    /**
...
export interface KerberosConfigResponse {
     ...
     */
    keytab: outputs.metastore.v1beta.SecretResponse;
    /**
...
export interface MetadataManagementActivityResponse {
     ...
     */
    metadataExports: outputs.metastore.v1beta.MetadataExportResponse[];
    /**
     * The latest restores of the metastore service.
     */
    restores: outputs.metastore.v1beta.RestoreResponse[];
}
...
export interface NetworkConfigResponse {
     ...
     */
    consumers: outputs.metastore.v1beta.ConsumerResponse[];
}
...
export interface ServiceResponse {
     ...
     */
    encryptionConfig: outputs.metastore.v1beta.EncryptionConfigResponse;
    /**
     * The URI of the endpoint used to access the metastore service.
     */
    endpointUri: string;
     ...
     */
    hiveMetastoreConfig: outputs.metastore.v1beta.HiveMetastoreConfigResponse;
    /**
     ...
     */
    metadataIntegration: outputs.metastore.v1beta.MetadataIntegrationResponse;
    /**
     * The metadata management activities of the metastore service.
     */
    metadataManagementActivity: outputs.metastore.v1beta.MetadataManagementActivityResponse;
    /**
     ...
     */
    networkConfig: outputs.metastore.v1beta.NetworkConfigResponse;
    /**
     ...
     */
    telemetryConfig: outputs.metastore.v1beta.TelemetryConfigResponse;
    /**
