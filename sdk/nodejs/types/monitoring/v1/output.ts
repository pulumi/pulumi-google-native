 ...
 */
export interface AlertChartResponse {
    /**
 ...
 */
export interface CollapsibleGroupResponse {
    /**
...
export interface ColumnLayoutResponse {
     ...
     */
    columns: outputs.monitoring.v1.ColumnResponse[];
}
...
export interface ColumnResponse {
     ...
     */
    widgets: outputs.monitoring.v1.WidgetResponse[];
}
 ...
 */
export interface GaugeViewResponse {
    /**
 ...
 */
export interface LogsPanelResponse {
    /**
...
export interface MosaicLayoutResponse {
     ...
     */
    tiles: outputs.monitoring.v1.TileResponse[];
}

/**
 * Describes a ranking-based time series filter. Each input time series is ranked with an aligner. The filter will allow up to num_time_series time series to pass through it, selecting them based on the relative ranking.For example, if ranking_method is METHOD_MEAN,direction is BOTTOM, and num_time_series is 3, then the 3 times series with the lowest mean values will pass through the filter.
 */
export interface PickTimeSeriesFilterResponse {
    /**
 ...
 */
export interface RatioPartResponse {
    /**
 ...
 */
export interface RowLayoutResponse {
    /**
     * The rows of content to display.
     */
    rows: outputs.monitoring.v1.RowResponse[];
}
...
export interface ScorecardResponse {
     ...
     */
    gaugeView: outputs.monitoring.v1.GaugeViewResponse;
    /**
     * Will cause the scorecard to show a spark chart.
     */
    sparkChartView: outputs.monitoring.v1.SparkChartViewResponse;
    /**
 ...
 */
export interface SparkChartViewResponse {
    /**
...
export interface TileResponse {
     ...
     */
    widget: outputs.monitoring.v1.WidgetResponse;
    /**
 ...
 */
export interface TimeSeriesFilterRatioResponse {
    /**
     * The denominator of the ratio.
     */
    denominator: outputs.monitoring.v1.RatioPartResponse;
    /**
     * The numerator of the ratio.
     */
    numerator: outputs.monitoring.v1.RatioPartResponse;
    /**
     * Ranking based time series filter.
     */
    pickTimeSeriesFilter: outputs.monitoring.v1.PickTimeSeriesFilterResponse;
    /**
 ...
 */
export interface TimeSeriesFilterResponse {
    /**
     * By default, the raw time series data is returned. Use this field to combine multiple time series for different views of the data.
     */
    aggregation: outputs.monitoring.v1.AggregationResponse;
...
export interface TimeSeriesQueryResponse {
     ...
     */
    timeSeriesFilter: outputs.monitoring.v1.TimeSeriesFilterResponse;
    /**
     * Parameters to fetch a ratio between two time series filters.
     */
    timeSeriesFilterRatio: outputs.monitoring.v1.TimeSeriesFilterRatioResponse;
    /**
...
export interface WidgetResponse {
     ...
     */
    alertChart: outputs.monitoring.v1.AlertChartResponse;
    /**
     * A blank space.
     */
    blank: outputs.monitoring.v1.EmptyResponse;
    /**
     * A widget that groups the other widgets. All widgets that are within the area spanned by the grouping widget are considered member widgets.
     */
    collapsibleGroup: outputs.monitoring.v1.CollapsibleGroupResponse;
    /**
     * A widget that shows a stream of logs.
     */
    logsPanel: outputs.monitoring.v1.LogsPanelResponse;
    /**
     * A scorecard summarizing time series data.
     */
    scorecard: outputs.monitoring.v1.ScorecardResponse;
    /**
     ...
     */
    xyChart: outputs.monitoring.v1.XyChartResponse;
}

/**
 * A chart that displays data on a 2D (X and Y axes) plane.
 */
export interface XyChartResponse {
    /**
