...
export interface GrpcRouteFaultInjectionPolicyResponse {
     ...
     */
    abort: outputs.networkservices.v1.GrpcRouteFaultInjectionPolicyAbortResponse;
    /**
     * The specification for injecting delay to client requests.
     */
    delay: outputs.networkservices.v1.GrpcRouteFaultInjectionPolicyDelayResponse;
}
...
export interface GrpcRouteRouteActionResponse {
     ...
     */
    destinations: outputs.networkservices.v1.GrpcRouteDestinationResponse[];
    /**
     * Optional. The specification for fault injection introduced into traffic to test the resiliency of clients to destination service failure. As part of fault injection, when clients send requests to a destination, delays can be introduced on a percentage of requests before sending those requests to the destination service. Similarly requests from clients can be aborted by for a percentage of requests. timeout and retry_policy will be ignored by clients that are configured with a fault_injection_policy
     */
    faultInjectionPolicy: outputs.networkservices.v1.GrpcRouteFaultInjectionPolicyResponse;
    /**
     * Optional. Specifies the retry policy associated with this route.
     */
    retryPolicy: outputs.networkservices.v1.GrpcRouteRetryPolicyResponse;
    /**
...
export interface GrpcRouteRouteMatchResponse {
     ...
     */
    headers: outputs.networkservices.v1.GrpcRouteHeaderMatchResponse[];
    /**
     * Optional. A gRPC method to match against. If this field is empty or omitted, will match all methods.
     */
    method: outputs.networkservices.v1.GrpcRouteMethodMatchResponse;
}
...
export interface GrpcRouteRouteRuleResponse {
     ...
     */
    action: outputs.networkservices.v1.GrpcRouteRouteActionResponse;
    /**
     * Optional. Matches define conditions used for matching the rule against incoming gRPC requests. Each match is independent, i.e. this rule will be matched if ANY one of the matches is satisfied. If no matches field is specified, this rule will unconditionally match traffic.
     */
    matches: outputs.networkservices.v1.GrpcRouteRouteMatchResponse[];
}
...
export interface HttpRouteFaultInjectionPolicyResponse {
     ...
     * The specification for aborting to client requests.
     */
    abort: outputs.networkservices.v1.HttpRouteFaultInjectionPolicyAbortResponse;
    /**
     * The specification for injecting delay to client requests.
     */
    delay: outputs.networkservices.v1.HttpRouteFaultInjectionPolicyDelayResponse;
}
...
export interface HttpRouteHeaderMatchResponse {
     ...
     */
    rangeMatch: outputs.networkservices.v1.HttpRouteHeaderMatchIntegerRangeResponse;
    /**
...
export interface HttpRouteRequestMirrorPolicyResponse {
     ...
     */
    destination: outputs.networkservices.v1.HttpRouteDestinationResponse;
}
...
export interface HttpRouteRouteActionResponse {
     ...
     * The specification for allowing client side cross-origin requests.
     */
    corsPolicy: outputs.networkservices.v1.HttpRouteCorsPolicyResponse;
    /**
     * The destination to which traffic should be forwarded.
     */
    destinations: outputs.networkservices.v1.HttpRouteDestinationResponse[];
    /**
     * The specification for fault injection introduced into traffic to test the resiliency of clients to backend service failure. As part of fault injection, when clients send requests to a backend service, delays can be introduced on a percentage of requests before sending those requests to the backend service. Similarly requests from clients can be aborted for a percentage of requests. timeout and retry_policy will be ignored by clients that are configured with a fault_injection_policy
     */
    faultInjectionPolicy: outputs.networkservices.v1.HttpRouteFaultInjectionPolicyResponse;
    /**
     * If set, the request is directed as configured by this field.
     */
    redirect: outputs.networkservices.v1.HttpRouteRedirectResponse;
    /**
     * The specification for modifying the headers of a matching request prior to delivery of the request to the destination.
     */
    requestHeaderModifier: outputs.networkservices.v1.HttpRouteHeaderModifierResponse;
    /**
     * Specifies the policy on how requests intended for the routes destination are shadowed to a separate mirrored destination. Proxy will not wait for the shadow destination to respond before returning the response. Prior to sending traffic to the shadow service, the host/authority header is suffixed with -shadow.
     */
    requestMirrorPolicy: outputs.networkservices.v1.HttpRouteRequestMirrorPolicyResponse;
    /**
     * The specification for modifying the headers of a response prior to sending the response back to the client.
     */
    responseHeaderModifier: outputs.networkservices.v1.HttpRouteHeaderModifierResponse;
    /**
     * Specifies the retry policy associated with this route.
     */
    retryPolicy: outputs.networkservices.v1.HttpRouteRetryPolicyResponse;
    /**
     ...
     */
    urlRewrite: outputs.networkservices.v1.HttpRouteURLRewriteResponse;
}
...
export interface HttpRouteRouteMatchResponse {
     ...
     */
    headers: outputs.networkservices.v1.HttpRouteHeaderMatchResponse[];
    /**
     ...
     */
    queryParameters: outputs.networkservices.v1.HttpRouteQueryParameterMatchResponse[];
    /**
...
export interface HttpRouteRouteRuleResponse {
     ...
     */
    action: outputs.networkservices.v1.HttpRouteRouteActionResponse;
    /**
     * A list of matches define conditions used for matching the rule against incoming HTTP requests. Each match is independent, i.e. this rule will be matched if ANY one of the matches is satisfied. If no matches field is specified, this rule will unconditionally match traffic. If a default rule is desired to be configured, add a rule with no matches specified to the end of the rules list.
     */
    matches: outputs.networkservices.v1.HttpRouteRouteMatchResponse[];
}
...
export interface TcpRouteRouteActionResponse {
     ...
     */
    destinations: outputs.networkservices.v1.TcpRouteRouteDestinationResponse[];
    /**
...
export interface TcpRouteRouteRuleResponse {
     ...
     * The detailed rule defining how to route matched traffic.
     */
    action: outputs.networkservices.v1.TcpRouteRouteActionResponse;
    /**
     * Optional. RouteMatch defines the predicate used to match requests to a given action. Multiple match types are "OR"ed for evaluation. If no routeMatch field is specified, this rule will unconditionally match traffic.
     */
    matches: outputs.networkservices.v1.TcpRouteRouteMatchResponse[];
}
...
export interface TlsRouteRouteActionResponse {
     ...
     */
    destinations: outputs.networkservices.v1.TlsRouteRouteDestinationResponse[];
}
...
export interface TlsRouteRouteRuleResponse {
     ...
     * The detailed rule defining how to route matched traffic.
     */
    action: outputs.networkservices.v1.TlsRouteRouteActionResponse;
    /**
     * RouteMatch defines the predicate used to match requests to a given action. Multiple match types are "OR"ed for evaluation.
     */
    matches: outputs.networkservices.v1.TlsRouteRouteMatchResponse[];
}
