...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.secretmanager.v1.AuditLogConfigResponse[];
    /**
...
export interface AutomaticResponse {
     ...
     */
    customerManagedEncryption: outputs.secretmanager.v1.CustomerManagedEncryptionResponse;
}
...
export interface BindingResponse {
     ...
     */
    condition: outputs.secretmanager.v1.ExprResponse;
    /**
...
export interface ReplicationResponse {
     ...
     */
    automatic: outputs.secretmanager.v1.AutomaticResponse;
    /**
     * The Secret will only be replicated into the locations specified.
     */
    userManaged: outputs.secretmanager.v1.UserManagedResponse;
}
