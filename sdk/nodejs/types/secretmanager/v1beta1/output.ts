...
export interface AuditConfigResponse {
     ...
     */
    auditLogConfigs: outputs.secretmanager.v1beta1.AuditLogConfigResponse[];
    /**
...
export interface BindingResponse {
     ...
     */
    condition: outputs.secretmanager.v1beta1.ExprResponse;
    /**
...
export interface ReplicationResponse {
     ...
     */
    automatic: outputs.secretmanager.v1beta1.AutomaticResponse;
    /**
     * The Secret will only be replicated into the locations specified.
     */
    userManaged: outputs.secretmanager.v1beta1.UserManagedResponse;
}
