 ...
 */
export interface AdaptingOSStepResponse {
}
...
export interface AvailableUpdatesResponse {
     ...
     */
    inPlaceUpdate: outputs.vmmigration.v1alpha1.ApplianceVersionResponse;
    /**
     * The newest deployable version of the appliance. The current appliance can't be updated into this version, and the owner must manually deploy this OVA to a new appliance.
     */
    newDeployableAppliance: outputs.vmmigration.v1alpha1.ApplianceVersionResponse;
}
...
export interface CloneJobResponse {
     ...
     */
    computeEngineTargetDetails: outputs.vmmigration.v1alpha1.ComputeEngineTargetDetailsResponse;
    /**
     ...
     */
    computeEngineVmDetails: outputs.vmmigration.v1alpha1.TargetVMDetailsResponse;
    /**
     ...
     */
    error: outputs.vmmigration.v1alpha1.StatusResponse;
    /**
     ...
     */
    steps: outputs.vmmigration.v1alpha1.CloneStepResponse[];
    /**
     ...
     */
    targetDetails: outputs.vmmigration.v1alpha1.TargetVMDetailsResponse;
}

/**
 * CloneStep holds information about the clone step progress.
 */
export interface CloneStepResponse {
    /**
     * Adapting OS step.
     */
    adaptingOs: outputs.vmmigration.v1alpha1.AdaptingOSStepResponse;
    /**
     ...
     */
    instantiatingMigratedVm: outputs.vmmigration.v1alpha1.InstantiatingMigratedVMStepResponse;
    /**
     * Preparing VM disks step.
     */
    preparingVmDisks: outputs.vmmigration.v1alpha1.PreparingVMDisksStepResponse;
    /**
...
export interface ComputeEngineTargetDefaultsResponse {
     ...
     */
    appliedLicense: outputs.vmmigration.v1alpha1.AppliedLicenseResponse;
    /**
     ...
     */
    computeScheduling: outputs.vmmigration.v1alpha1.ComputeSchedulingResponse;
    /**
     ...
     */
    networkInterfaces: outputs.vmmigration.v1alpha1.NetworkInterfaceResponse[];
    /**
...
export interface ComputeSchedulingResponse {
     ...
     */
    nodeAffinities: outputs.vmmigration.v1alpha1.SchedulingNodeAffinityResponse[];
    /**
...
export interface CutoverJobResponse {
     ...
     */
    steps: outputs.vmmigration.v1alpha1.CutoverStepResponse[];
    /**
 ...
 */
export interface CutoverStepResponse {
    /**
     * The time the step has ended.
     */
    endTime: string;
     ...
     * Final sync step.
     */
    finalSync: outputs.vmmigration.v1alpha1.ReplicationCycleResponse;
    /**
     * Instantiating migrated VM step.
     */
    instantiatingMigratedVm: outputs.vmmigration.v1alpha1.InstantiatingMigratedVMStepResponse;
     ...
     */
    previousReplicationCycle: outputs.vmmigration.v1alpha1.ReplicationCycleResponse;
    /**
     * Shutting down VM step.
     */
    shuttingDownSourceVm: outputs.vmmigration.v1alpha1.ShuttingDownSourceVMStepResponse;
    /**
     * The time the step has started.
     */
    startTime: string;
 ...
 */
export interface CycleStepResponse {
    /**
     ...
     */
    initializingReplication: outputs.vmmigration.v1alpha1.InitializingReplicationStepResponse;
    /**
     * Post processing step.
     */
    postProcessing: outputs.vmmigration.v1alpha1.PostProcessingStepResponse;
    /**
     * Replicating step.
     */
    replicating: outputs.vmmigration.v1alpha1.ReplicatingStepResponse;
    /**
 ...
 */
export interface InitializingReplicationStepResponse {
}

/**
 * InstantiatingMigratedVMStep contains specific step details.
 */
export interface InstantiatingMigratedVMStepResponse {
}
 ...
 */
export interface PostProcessingStepResponse {
}

/**
 * PreparingVMDisksStep contains specific step details.
 */
export interface PreparingVMDisksStepResponse {
}

/**
 * ReplicatingStep contains specific step details.
 */
export interface ReplicatingStepResponse {
    /**
...
export interface ReplicationCycleResponse {
     ...
     */
    steps: outputs.vmmigration.v1alpha1.CycleStepResponse[];
    /**
 ...
 */
export interface ShuttingDownSourceVMStepResponse {
}
 ...
 */
export interface TargetVMDetailsResponse {
    /**
     * The OS license returned from the adaptation module report.
     */
    appliedLicense: outputs.vmmigration.v1alpha1.AppliedLicenseResponse;
...
export interface VmUtilizationInfoResponse {
     ...
     */
    utilization: outputs.vmmigration.v1alpha1.VmUtilizationMetricsResponse;
    /**
     ...
     */
    vmwareVmDetails: outputs.vmmigration.v1alpha1.VmwareVmDetailsResponse;
}
