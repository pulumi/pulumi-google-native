 ...
 */
export class ProductReferenceImage extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProductReferenceImage {
        return new ProductReferenceImage(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-cloud:vision/v1:ProductReferenceImage';

    /**
     * Returns true if the given object is an instance of ProductReferenceImage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProductReferenceImage {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProductReferenceImage.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ProductReferenceImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProductReferenceImage.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface ProductReferenceImageArgs {
    /**
