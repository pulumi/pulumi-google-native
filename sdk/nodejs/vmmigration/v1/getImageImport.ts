...
export function getImageImport(args: GetImageImportArgs, opts?: pulumi.InvokeOptions): Promise<GetImageImportResult> {
    ...
    return pulumi.runtime.invoke("google-native:vmmigration/v1:getImageImport", {
...
export interface GetImageImportResult {
     ...
     */
    readonly diskImageTargetDefaults: outputs.vmmigration.v1.DiskImageTargetDetailsResponse;
    /**
     ...
     */
    readonly recentImageImportJobs: outputs.vmmigration.v1.ImageImportJobResponse[];
}
/**
 * Gets details of a single ImageImport.
 */
