...
export class ImageImport extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:vmmigration/v1:ImageImport';
     ...
     */
    public readonly diskImageTargetDefaults!: pulumi.Output<outputs.vmmigration.v1.DiskImageTargetDetailsResponse>;
    /**
     ...
     */
    public /*out*/ readonly recentImageImportJobs!: pulumi.Output<outputs.vmmigration.v1.ImageImportJobResponse[]>;
    /**
...
export interface ImageImportArgs {
     ...
     * Immutable. Target details for importing a disk image, will be used by ImageImportJob.
     */
    diskImageTargetDefaults?: pulumi.Input<inputs.vmmigration.v1.DiskImageTargetDetailsArgs>;
    /**
     * Immutable. The encryption details used by the image import process during the image adaptation for Compute Engine.
     */
