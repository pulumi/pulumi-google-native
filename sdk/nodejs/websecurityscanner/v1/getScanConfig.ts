...
export function getScanConfig(args: GetScanConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetScanConfigResult> {
    ...
    return pulumi.runtime.invoke("google-native:websecurityscanner/v1:getScanConfig", {
...
export interface GetScanConfigResult {
     ...
     */
    readonly authentication: outputs.websecurityscanner.v1.AuthenticationResponse;
    /**
     ...
     */
    readonly schedule: outputs.websecurityscanner.v1.ScheduleResponse;
    /**
