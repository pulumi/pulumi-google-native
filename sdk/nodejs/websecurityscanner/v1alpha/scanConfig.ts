...
export class ScanConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-cloud:websecurityscanner/v1alpha:ScanConfig';
    ...
    constructor(name: string, args: ScanConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.scanConfigsId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'scanConfigsId'");
            }
            ...
            inputs["scanConfigsId"] = args ? args.scanConfigsId : undefined;
...
export interface ScanConfigArgs {
    ...
    readonly scanConfigsId: pulumi.Input<string>;
    /**
     * The schedule of the ScanConfig.
     */
