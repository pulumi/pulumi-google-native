...
export function getWorkstationConfig(args: GetWorkstationConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkstationConfigResult> {
    ...
    return pulumi.runtime.invoke("google-native:workstations/v1:getWorkstationConfig", {
...
export interface GetWorkstationConfigResult {
     ...
     */
    readonly container: outputs.workstations.v1.ContainerResponse;
    /**
     ...
     */
    readonly host: outputs.workstations.v1.HostResponse;
    /**
     ...
     */
    readonly persistentDirectories: outputs.workstations.v1.PersistentDirectoryResponse[];
    /**
     * Optional. Readiness checks to perform when starting a workstation using this workstation configuration. Mark a workstation as running only after all specified readiness checks return 200 status codes.
     */
    readonly readinessChecks: outputs.workstations.v1.ReadinessCheckResponse[];
    /**
