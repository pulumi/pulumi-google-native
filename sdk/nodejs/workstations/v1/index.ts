...
// Export enums:
export * from "../../types/enums/workstations/v1";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-native:workstations/v1:Workstation":
                return new Workstation(name, <any>undefined, { urn })
            case "google-native:workstations/v1:WorkstationCluster":
                return new WorkstationCluster(name, <any>undefined, { urn })
            case "google-native:workstations/v1:WorkstationClusterWorkstationConfigIamBinding":
                return new WorkstationClusterWorkstationConfigIamBinding(name, <any>undefined, { urn })
            case "google-native:workstations/v1:WorkstationClusterWorkstationConfigIamMember":
                return new WorkstationClusterWorkstationConfigIamMember(name, <any>undefined, { urn })
            case "google-native:workstations/v1:WorkstationClusterWorkstationConfigIamPolicy":
                return new WorkstationClusterWorkstationConfigIamPolicy(name, <any>undefined, { urn })
            case "google-native:workstations/v1:WorkstationClusterWorkstationConfigWorkstationIamBinding":
                return new WorkstationClusterWorkstationConfigWorkstationIamBinding(name, <any>undefined, { urn })
            case "google-native:workstations/v1:WorkstationClusterWorkstationConfigWorkstationIamMember":
                return new WorkstationClusterWorkstationConfigWorkstationIamMember(name, <any>undefined, { urn })
            case "google-native:workstations/v1:WorkstationClusterWorkstationConfigWorkstationIamPolicy":
                return new WorkstationClusterWorkstationConfigWorkstationIamPolicy(name, <any>undefined, { urn })
            case "google-native:workstations/v1:WorkstationConfig":
...
pulumi.runtime.registerResourceModule("google-native", "workstations/v1", _module)
