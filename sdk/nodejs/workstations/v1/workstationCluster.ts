...
export class WorkstationCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-native:workstations/v1:WorkstationCluster';
     ...
     */
    public /*out*/ readonly conditions!: pulumi.Output<outputs.workstations.v1.StatusResponse[]>;
    /**
     ...
     */
    public readonly privateClusterConfig!: pulumi.Output<outputs.workstations.v1.PrivateClusterConfigResponse>;
...
export interface WorkstationClusterArgs {
     ...
     * Optional. Configuration for private workstation cluster.
     */
    privateClusterConfig?: pulumi.Input<inputs.workstations.v1.PrivateClusterConfigArgs>;
