...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:apigateway/v1beta:Api":
                return Api(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigateway/v1beta:ApiConfig":
                return ApiConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigateway/v1beta:ApiConfigIamPolicy":
                return ApiConfigIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigateway/v1beta:ApiIamPolicy":
                return ApiIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigateway/v1beta:Gateway":
                return Gateway(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigateway/v1beta:GatewayIamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "apigateway/v1beta", _module_instance)
