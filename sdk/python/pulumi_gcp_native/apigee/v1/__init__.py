...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:apigee/v1:Organization":
                return Organization(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigee/v1:OrganizationAnalyticDatastore":
            ...
            elif typ == "gcp-native:apigee/v1:OrganizationDeveloper":
                return OrganizationDeveloper(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigee/v1:OrganizationDeveloperApp":
            ...
            elif typ == "gcp-native:apigee/v1:OrganizationEnvironment":
                return OrganizationEnvironment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigee/v1:OrganizationEnvironmentAnalyticExport":
                return OrganizationEnvironmentAnalyticExport(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigee/v1:OrganizationEnvironmentApiRevisionDebugsession":
                return OrganizationEnvironmentApiRevisionDebugsession(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigee/v1:OrganizationEnvironmentIamPolicy":
                return OrganizationEnvironmentIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:apigee/v1:OrganizationEnvironmentKeystore":
            ...
            elif typ == "gcp-native:apigee/v1:OrganizationSiteApicategory":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "apigee/v1", _module_instance)
