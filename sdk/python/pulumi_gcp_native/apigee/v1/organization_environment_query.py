...
__all__ = ['OrganizationEnvironmentQueryArgs', 'OrganizationEnvironmentQuery']
...
class OrganizationEnvironmentQuery(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OrganizationEnvironmentQueryArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Submit a query to be processed in the background. If the submission of the query succeeds, the API returns a 201 status and an ID that refer to the query. In addition to the HTTP status 201, the `state` of "enqueued" means that the request succeeded.

        :param str resource_name: The name of the resource.
        :param OrganizationEnvironmentQueryArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationEnvironmentQueryArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OrganizationEnvironmentQueryArgs.__new__(OrganizationEnvironmentQueryArgs)
