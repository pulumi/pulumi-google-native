...
__all__ = ['OrganizationEnvironmentResourcefileArgs', 'OrganizationEnvironmentResourcefile']
...
class OrganizationEnvironmentResourcefile(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OrganizationEnvironmentResourcefileArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a resource file. Specify the `Content-Type` as `application/octet-stream` or `multipart/form-data`. For more information about resource files, see [Resource files](https://cloud.google.com/apigee/docs/api-platform/develop/resource-files).

        :param str resource_name: The name of the resource.
        :param OrganizationEnvironmentResourcefileArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationEnvironmentResourcefileArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OrganizationEnvironmentResourcefileArgs.__new__(OrganizationEnvironmentResourcefileArgs)
        ...
        super(OrganizationEnvironmentResourcefile, __self__).__init__(
            'gcp-native:apigee/v1:OrganizationEnvironmentResourcefile',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OrganizationEnvironmentResourcefile':
        """
