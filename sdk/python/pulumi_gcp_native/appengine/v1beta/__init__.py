...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:appengine/v1beta:App":
                return App(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:appengine/v1beta:AppAuthorizedCertificate":
                return AppAuthorizedCertificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:appengine/v1beta:AppDomainMapping":
                return AppDomainMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:appengine/v1beta:AppFirewallIngressRule":
                return AppFirewallIngressRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:appengine/v1beta:AppServiceVersion":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "appengine/v1beta", _module_instance)
