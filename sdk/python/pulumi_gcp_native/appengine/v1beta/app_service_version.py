...
__all__ = ['AppServiceVersionArgs', 'AppServiceVersion']

@pulumi.input_type
class AppServiceVersionArgs:
...
class AppServiceVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AppServiceVersionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Deploys code and resource files to a new version.

        :param str resource_name: The name of the resource.
        :param AppServiceVersionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AppServiceVersionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AppServiceVersionArgs.__new__(AppServiceVersionArgs)
