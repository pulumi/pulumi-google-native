...
class AutomaticScalingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CpuUtilizationResponseArgs' cpu_utilization: Target scaling by CPU usage.
        :param Sequence['CustomMetricResponseArgs'] custom_metrics: Target scaling by user-provided metrics. Only applicable in the App Engine flexible environment.
        :param 'DiskUtilizationResponseArgs' disk_utilization: Target scaling by disk usage.
        ...
        :param 'NetworkUtilizationResponseArgs' network_utilization: Target scaling by network usage.
        :param 'RequestUtilizationResponseArgs' request_utilization: Target scaling by request utilization.
        :param 'StandardSchedulerSettingsResponseArgs' standard_scheduler_settings: Scheduler settings for standard environment.
        """
...
class DeploymentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Code and application artifacts used to deploy a version to App Engine.
        :param 'BuildInfoResponseArgs' build: Google Cloud Build build information. Only applicable for instances running in the App Engine flexible environment.
        :param 'CloudBuildOptionsResponseArgs' cloud_build_options: Options for any Google Cloud Build builds created as a part of this deployment.These options will only be used if a new build is created, such as when deploying to the App Engine flexible environment using files or zip.
        :param 'ContainerInfoResponseArgs' container: The Docker image for the container that runs the version. Only applicable for instances running in the App Engine flexible environment.
        ...
        :param 'ZipInfoResponseArgs' zip: The zip file for this deployment, if this is a zip deployment.
        """
...
class ResourcesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['VolumeResponseArgs'] volumes: User specified volumes.
        """
...
class UrlMapResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        URL pattern and description of how the URL should be handled. App Engine can handle URLs by executing application code or by serving static files uploaded with the version, such as images, CSS, or JavaScript.
        :param 'ApiEndpointHandlerResponseArgs' api_endpoint: Uses API Endpoints to handle requests.
        :param str auth_fail_action: Action to take when users access resources that require authentication. Defaults to redirect.
        ...
        :param 'ScriptHandlerResponseArgs' script: Executes a script to handle the requests that match this URL pattern. Only the auto value is supported for Node.js in the App Engine standard environment, for example "script": "auto".
        :param str security_level: Security (HTTPS) enforcement for this URL.
        :param 'StaticFilesHandlerResponseArgs' static_files: Returns the contents of a file, such as an image, as the response.
