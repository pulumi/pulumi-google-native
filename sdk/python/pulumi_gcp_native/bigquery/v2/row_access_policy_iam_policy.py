...
class RowAccessPolicyIamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RowAccessPolicyIamPolicy':
        """
        Get an existing RowAccessPolicyIamPolicy resource's state with the given name, id, and optional extra
