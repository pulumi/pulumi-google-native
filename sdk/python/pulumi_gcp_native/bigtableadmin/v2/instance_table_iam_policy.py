...
__all__ = ['InstanceTableIamPolicyArgs', 'InstanceTableIamPolicy']

@pulumi.input_type
class InstanceTableIamPolicyArgs:
...
class InstanceTableIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: InstanceTableIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on a Table resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param InstanceTableIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InstanceTableIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InstanceTableIamPolicyArgs.__new__(InstanceTableIamPolicyArgs)
        ...
        super(InstanceTableIamPolicy, __self__).__init__(
            'gcp-native:bigtableadmin/v2:InstanceTableIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InstanceTableIamPolicy':
        """
        Get an existing InstanceTableIamPolicy resource's state with the given name, id, and optional extra
        ...
        return InstanceTableIamPolicy(resource_name, opts=opts, __props__=__props__)
