...
__all__ = ['BillingAccountIamPolicyArgs', 'BillingAccountIamPolicy']
...
class BillingAccountIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param BillingAccountIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BillingAccountIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(BillingAccountIamPolicy, __self__).__init__(
            'gcp-native:cloudbilling/v1:BillingAccountIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BillingAccountIamPolicy':
        """
        Get an existing BillingAccountIamPolicy resource's state with the given name, id, and optional extra
        ...
        return BillingAccountIamPolicy(resource_name, opts=opts, __props__=__props__)
