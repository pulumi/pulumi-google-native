...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "gcp-native:cloudchannel/v1:AccountCustomer":
                return AccountCustomer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:cloudchannel/v1:AccountCustomerEntitlement":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "cloudchannel/v1", _module_instance)
