...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:cloudiot/v1:Registry":
                return Registry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:cloudiot/v1:RegistryDevice":
                return RegistryDevice(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:cloudiot/v1:RegistryGroupIamPolicy":
                return RegistryGroupIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:cloudiot/v1:RegistryIamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "cloudiot/v1", _module_instance)
