...
__all__ = ['RegistryGroupIamPolicyArgs', 'RegistryGroupIamPolicy']
...
class RegistryGroupIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RegistryGroupIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param RegistryGroupIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RegistryGroupIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RegistryGroupIamPolicyArgs.__new__(RegistryGroupIamPolicyArgs)
        ...
        super(RegistryGroupIamPolicy, __self__).__init__(
            'gcp-native:cloudiot/v1:RegistryGroupIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RegistryGroupIamPolicy':
        """
        Get an existing RegistryGroupIamPolicy resource's state with the given name, id, and optional extra
        ...
        return RegistryGroupIamPolicy(resource_name, opts=opts, __props__=__props__)
