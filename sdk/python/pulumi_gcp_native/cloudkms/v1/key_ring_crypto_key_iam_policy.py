...
__all__ = ['KeyRingCryptoKeyIamPolicyArgs', 'KeyRingCryptoKeyIamPolicy']
...
class KeyRingCryptoKeyIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: KeyRingCryptoKeyIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param KeyRingCryptoKeyIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KeyRingCryptoKeyIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KeyRingCryptoKeyIamPolicyArgs.__new__(KeyRingCryptoKeyIamPolicyArgs)
        ...
        super(KeyRingCryptoKeyIamPolicy, __self__).__init__(
            'gcp-native:cloudkms/v1:KeyRingCryptoKeyIamPolicy',
            resource_name,
            __props__,
            opts)
