...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:cloudsearch/v1:SettingDatasource":
                return SettingDatasource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:cloudsearch/v1:SettingSearchapplication":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "cloudsearch/v1", _module_instance)
