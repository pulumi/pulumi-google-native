...
__all__ = ['FirewallPolicyIamPolicyArgs', 'FirewallPolicyIamPolicy']
...
class FirewallPolicyIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FirewallPolicyIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param FirewallPolicyIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FirewallPolicyIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FirewallPolicyIamPolicyArgs.__new__(FirewallPolicyIamPolicyArgs)
        ...
        super(FirewallPolicyIamPolicy, __self__).__init__(
            'gcp-native:compute/alpha:FirewallPolicyIamPolicy',
            resource_name,
            __props__,
            opts)
