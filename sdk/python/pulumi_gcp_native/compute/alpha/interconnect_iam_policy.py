...
__all__ = ['InterconnectIamPolicyArgs', 'InterconnectIamPolicy']

@pulumi.input_type
class InterconnectIamPolicyArgs:
...
class InterconnectIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: InterconnectIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param InterconnectIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InterconnectIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InterconnectIamPolicyArgs.__new__(InterconnectIamPolicyArgs)
        ...
        super(InterconnectIamPolicy, __self__).__init__(
            'gcp-native:compute/alpha:InterconnectIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InterconnectIamPolicy':
        """
        ...
        return InterconnectIamPolicy(resource_name, opts=opts, __props__=__props__)
