...
__all__ = ['LicenseCodeIamPolicyArgs', 'LicenseCodeIamPolicy']
...
class LicenseCodeIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LicenseCodeIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.  Caution This resource is intended for use only by third-party partners who are creating Cloud Marketplace images.

        :param str resource_name: The name of the resource.
        :param LicenseCodeIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LicenseCodeIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LicenseCodeIamPolicyArgs.__new__(LicenseCodeIamPolicyArgs)
        ...
        super(LicenseCodeIamPolicy, __self__).__init__(
            'gcp-native:compute/alpha:LicenseCodeIamPolicy',
            resource_name,
            __props__,
            opts)
