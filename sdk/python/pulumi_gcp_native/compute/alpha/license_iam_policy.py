...
__all__ = ['LicenseIamPolicyArgs', 'LicenseIamPolicy']

@pulumi.input_type
class LicenseIamPolicyArgs:
...
class LicenseIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param LicenseIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LicenseIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LicenseIamPolicyArgs.__new__(LicenseIamPolicyArgs)
        ...
        super(LicenseIamPolicy, __self__).__init__(
            'gcp-native:compute/alpha:LicenseIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LicenseIamPolicy':
        """
        ...
        return LicenseIamPolicy(resource_name, opts=opts, __props__=__props__)
