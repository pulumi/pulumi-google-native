...
__all__ = ['NodeGroupIamPolicyArgs', 'NodeGroupIamPolicy']

@pulumi.input_type
class NodeGroupIamPolicyArgs:
...
class NodeGroupIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: NodeGroupIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param NodeGroupIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NodeGroupIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NodeGroupIamPolicyArgs.__new__(NodeGroupIamPolicyArgs)
        ...
        super(NodeGroupIamPolicy, __self__).__init__(
            'gcp-native:compute/alpha:NodeGroupIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NodeGroupIamPolicy':
        """
        ...
        return NodeGroupIamPolicy(resource_name, opts=opts, __props__=__props__)
