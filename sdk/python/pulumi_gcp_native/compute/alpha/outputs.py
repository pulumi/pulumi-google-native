...
__all__ = [
    ...
    'AllocationShareSettingsResponse',
...
class AccessConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An access configuration attached to an instance's network interface. Only one access config per instance is supported.
        :param str external_ipv6: [Output Only] The first IPv6 address of the external IPv6 range associated with this instance, prefix length is stored in externalIpv6PrefixLength in ipv6AccessConfig. The field is output only, an IPv6 address from a subnetwork associated with the instance will be allocated dynamically.
        :param int external_ipv6_prefix_length: [Output Only] The prefix length of the external IPv6 range.
        ...
        :param str public_dns_name: [Output Only] The public DNS domain name for the instance.
...
@pulumi.output_type
class AllocationShareSettingsResponse(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "shareType":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AllocationShareSettingsResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AllocationShareSettingsResponse.__key_warning(key)
        return super().__getitem__(key)
...
class AllocationSpecificSKUAllocationReservedInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of the SKU instances being reserved. Next ID: 9
        :param Sequence['AcceleratorConfigResponseArgs'] guest_accelerators: Specifies accelerator type and count.
        :param Sequence['AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponseArgs'] local_ssds: Specifies amount of local ssd to reserve with each instance. The type of disk is local-ssd.
        ...
        :param str maintenance_interval: Specifies whether this VM may be a stable fleet VM. Setting this to "Periodic" designates this VM as a Stable Fleet VM.
...
class AllocationSpecificSKUReservationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'AllocationSpecificSKUAllocationReservedInstancePropertiesResponseArgs' instance_properties: The instance properties for the reservation.
        """
...
class AttachedDiskInitializeParamsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str disk_type: Specifies the disk type to use to create the instance. If not specified, the default is pd-standard, specified using the full URL. For example:
        ...
        :param Sequence['GuestOsFeatureResponseArgs'] guest_os_features: A list of features to enable on the guest operating system. Applicable only for bootable images. Read  Enabling guest operating system features to see a list of available options.
        ...
        :param str provisioned_iops: Indicates how many IOPS must be provisioned for the disk.
        ...
        :param str source_image: The source image to create this disk. When creating a new instance, one of initializeParams.sourceImage or initializeParams.sourceSnapshot or disks.source is required except for local SSD.
        ...
        :param 'CustomerEncryptionKeyResponseArgs' source_image_encryption_key: The customer-supplied encryption key of the source image. Required if the source image is protected by a customer-supplied encryption key.
               
               Instance templates do not store customer-supplied encryption keys, so you cannot create disks for instances in a managed instance group if the source images are encrypted with your own keys.
        :param str source_snapshot: The source snapshot to create this disk. When creating a new instance, one of initializeParams.sourceSnapshot or initializeParams.sourceImage or disks.source is required except for local SSD.
        ...
        :param 'CustomerEncryptionKeyResponseArgs' source_snapshot_encryption_key: The customer-supplied encryption key of the source snapshot.
        """
...
class AttachedDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str device_name: Specifies a unique device name of your choice that is reflected into the /dev/disk/by-id/google-* tree of a Linux operating system running within the instance. This name can be used to reference the device for mounting, resizing, and so on, from within the instance.
        ...
        :param 'CustomerEncryptionKeyResponseArgs' disk_encryption_key: Encrypts or decrypts a disk using a customer-supplied encryption key.
        ...
        :param 'AttachedDiskInitializeParamsResponseArgs' initialize_params: [Input Only] Specifies the parameters for a new disk that will be created alongside the new instance. Use initialization parameters to create boot disks or local SSDs attached to the new instance.
        ...
        :param 'InitialStateConfigResponseArgs' shielded_instance_initial_state: [Output Only] shielded vm initial state stored on disk
        ...
        :param Sequence[str] user_licenses: [Output Only] A list of user provided licenses. It represents a list of URLs to the license resource. Unlike regular licenses, user provided licenses can be modified after the disk is created.
        """
...
class AuthenticationPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'TlsContextResponseArgs' server_tls_context: Configures the mechanism to obtain server-side security certificates and identity information.
        """
...
class AuthorizationConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] Authorization configuration provides service-level and method-level access control for a service. control for a service.
        :param Sequence['RbacPolicyResponseArgs'] policies: List of RbacPolicies.
        """
...
class AutoscalerStatusDetailsResponse(dict):
    def __init__(__self__, *,
        ...
        :param str type: The type of error, warning, or notice returned. Current set of possible values:  
...
class AutoscalingPolicyCpuUtilizationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float utilization_target: The target CPU utilization that the autoscaler maintains. Must be a float value in the range (0, 1]. If not specified, the default is 0.6.
...
class AutoscalingPolicyCustomMetricUtilizationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Custom utilization metric policy.
        :param str filter: A filter string, compatible with a Stackdriver Monitoring filter string for TimeSeries.list API call. This filter is used to select a specific TimeSeries for the purpose of autoscaling and to determine whether the metric is exporting per-instance or per-group data.
        ...
        :param str metric: The identifier (type) of the Stackdriver Monitoring metric. The metric cannot have negative values.
        ...
        :param float utilization_target: The target value of the metric that autoscaler maintains. This must be a positive value. A utilization metric scales number of virtual machines handling requests to increase or decrease proportionally to the metric.
...
class AutoscalingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'AutoscalingPolicyCpuUtilizationResponseArgs' cpu_utilization: Defines the CPU utilization policy that allows the autoscaler to scale based on the average CPU utilization of a managed instance group.
        :param Sequence['AutoscalingPolicyCustomMetricUtilizationResponseArgs'] custom_metric_utilizations: Configuration parameters of autoscaling based on a custom metric.
        :param 'AutoscalingPolicyLoadBalancingUtilizationResponseArgs' load_balancing_utilization: Configuration parameters of autoscaling based on load balancer.
...
class BackendBucketCdnPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Message containing Cloud CDN configuration for a backend bucket.
        :param Sequence['BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseArgs'] bypass_cache_on_request_headers: Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
        :param str cache_mode: Specifies the cache setting for all responses from this backend. The possible values are:
...
class BackendResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str group: The fully-qualified URL of an instance group or network endpoint group (NEG) resource. The type of backend that a backend service supports depends on the backend service's loadBalancingScheme.
        ...
        :param int max_connections: Defines a target maximum number of simultaneous connections. For usage guidelines, see Connection balancing mode and Utilization balancing mode. Not available if the backend's balancingMode is RATE. Not supported by:
               
               - Internal TCP/UDP Load Balancing - Network Load Balancing
        :param int max_connections_per_endpoint: Defines a target maximum number of simultaneous connections. For usage guidelines, see Connection balancing mode and Utilization balancing mode.
               
               Not available if the backend's balancingMode is RATE. Not supported by:
               
               - Internal TCP/UDP Load Balancing - Network Load Balancing.
        :param int max_connections_per_instance: Defines a target maximum number of simultaneous connections. For usage guidelines, see Connection balancing mode and Utilization balancing mode.
               
               Not available if the backend's balancingMode is RATE. Not supported by:
               
               - Internal TCP/UDP Load Balancing - Network Load Balancing.
        :param int max_rate: Defines a maximum number of HTTP requests per second (RPS). For usage guidelines, see Rate balancing mode and Utilization balancing mode.
               
               Not available if the backend's balancingMode is CONNECTION.
        :param float max_rate_per_endpoint: Defines a maximum target for requests per second (RPS). For usage guidelines, see Rate balancing mode and Utilization balancing mode.
               
               Not available if the backend's balancingMode is CONNECTION.
        :param float max_rate_per_instance: Defines a maximum target for requests per second (RPS). For usage guidelines, see Rate balancing mode and Utilization balancing mode.
...
class BackendServiceCdnPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Message containing Cloud CDN configuration for a backend service.
        :param Sequence['BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseArgs'] bypass_cache_on_request_headers: Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
        :param 'CacheKeyPolicyResponseArgs' cache_key_policy: The CacheKeyPolicy for this CdnPolicy.
        :param str cache_mode: Specifies the cache setting for all responses from this backend. The possible values are:
        ...
        :param int max_ttl: Specifies the maximum allowed TTL for cached content served by this origin. Cache directives that attempt to set a max-age or s-maxage higher than this, or an Expires header more than maxTTL seconds in the future will be capped at the value of maxTTL, as if it were the value of an s-maxage Cache-Control directive. Headers sent to the client will not be modified. Setting a TTL of "0" means "always revalidate". The maximum allowed value is 31,622,400s (1 year), noting that infrequently accessed objects may be evicted from the cache before the defined TTL.
        :param bool negative_caching: Negative caching allows per-status code TTLs to be set, in order to apply fine-grained caching for common errors or redirects. This can reduce the load on your origin and improve end-user experience by reducing response latency. When the cache mode is set to CACHE_ALL_STATIC or USE_ORIGIN_HEADERS, negative caching applies to responses with the specified response code that lack any Cache-Control, Expires, or Pragma: no-cache directives. When the cache mode is set to FORCE_CACHE_ALL, negative caching applies to all responses with the specified response code, and override any caching headers. By default, Cloud CDN will apply the following default TTLs to these status codes: HTTP 300 (Multiple Choice), 301, 308 (Permanent Redirects): 10m HTTP 404 (Not Found), 410 (Gone), 451 (Unavailable For Legal Reasons): 120s HTTP 405 (Method Not Found), 421 (Misdirected Request), 501 (Not Implemented): 60s. These defaults can be overridden in negative_caching_policy.
        :param Sequence['BackendServiceCdnPolicyNegativeCachingPolicyResponseArgs'] negative_caching_policy: Sets a cache TTL for the specified HTTP status code. negative_caching must be enabled to configure negative_caching_policy. Omitting the policy and leaving negative_caching enabled will use Cloud CDN's default cache TTLs. Note that when specifying an explicit negative_caching_policy, you should take care to specify a cache TTL for all response codes that you wish to cache. Cloud CDN will not apply any default negative caching when a policy exists.
        :param bool request_coalescing: If true then Cloud CDN will combine multiple concurrent cache fill requests into a small number of requests to the origin.
        :param int serve_while_stale: Serve existing content from the cache (if available) when revalidating content with the origin, or when an error is encountered when refreshing the cache. This setting defines the default "max-stale" duration for any cached responses that do not specify a max-stale directive. Stale responses that exceed the TTL configured here will not be served. The default limit (max-stale) is 86400s (1 day), which will allow stale content to be served up to this limit beyond the max-age (or s-max-age) of a cached response. The maximum allowed value is 604800 (1 week). Set this to zero (0) to disable serve-while-stale.
        :param str signed_url_cache_max_age_sec: Maximum number of seconds the response to a signed URL request will be considered fresh. After this time period, the response will be revalidated before being served. Defaults to 1hr (3600s). When serving responses to signed URL requests, Cloud CDN will internally behave as though all responses from this backend had a "Cache-Control: public, max-age=[TTL]" header, regardless of any existing Cache-Control header. The actual headers served in responses will not be altered.
        :param Sequence[str] signed_url_key_names: [Output Only] Names of the keys for signing request URLs.
...
class BackendServiceConnectionTrackingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Connection Tracking configuration for this BackendService.
        :param str connection_persistence_on_unhealthy_backends: Specifies connection persistence when backends are unhealthy. The default value is DEFAULT_FOR_PROTOCOL.
        ...
        :param int idle_timeout_sec: Specifies how long to keep a Connection Tracking entry while there is no matching traffic (in seconds).
...
class BackendServiceFailoverPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Applicable only to Failover for Internal TCP/UDP Load Balancing and Network Load Balancing. On failover or failback, this field indicates whether connection draining will be honored. GCP has a fixed connection draining timeout of 10 minutes. A setting of true terminates existing TCP connections to the active pool during failover and failback, immediately draining traffic. A setting of false allows existing TCP connections to persist, even on VMs no longer in the active pool, for up to the duration of the connection draining timeout (10 minutes).
        :param bool disable_connection_drain_on_failover: This can be set to true only if the protocol is TCP.
               
               The default is false.
        :param bool drop_traffic_if_unhealthy: Applicable only to Failover for Internal TCP/UDP Load Balancing and Network Load Balancing, If set to true, connections to the load balancer are dropped when all primary and all backup backend VMs are unhealthy.If set to false, connections are distributed among all primary VMs when all primary and all backup backend VMs are unhealthy. The default is false.
        :param float failover_ratio: Applicable only to Failover for Internal TCP/UDP Load Balancing and Network Load Balancing. The value of the field must be in the range [0, 1]. If the value is 0, the load balancer performs a failover when the number of healthy primary VMs equals zero. For all other values, the load balancer performs a failover when the total number of healthy primary VMs is less than this ratio.
        """
...
class BackendServiceIAPResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'BackendServiceIAPOAuth2ClientInfoResponseArgs' oauth2_client_info: [Input Only] OAuth client info required to generate client id to be used for IAP.
...
class BindingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Associates `members` with a `role`.
        :param 'ExprResponseArgs' condition: The condition that is associated with this binding.
        ...
        :param Sequence[str] members: Specifies the identities requesting access for a Cloud Platform resource. `members` can have the following values:
...
class CallCredentialsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'MetadataCredentialsFromPluginResponseArgs' from_plugin: Custom authenticator credentials. Valid if callCredentialType is FROM_PLUGIN.
        """
...
class ChannelCredentialsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] gRPC channel credentials to access the SDS server. gRPC channel credentials to access the SDS server.
        :param 'TlsCertificatePathsResponseArgs' certificates: The call credentials to access the SDS server.
...
class CircuitBreakersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Settings controlling the volume of connections to a backend service.
        :param 'DurationResponseArgs' connect_timeout: The timeout for new network connections to hosts.
        :param int max_connections: The maximum number of connections to the backend service. If not specified, there is no limit.
        :param int max_pending_requests: The maximum number of pending requests allowed to the backend service. If not specified, there is no limit.
        ...
        :param int max_requests_per_connection: Maximum requests for a single connection to the backend service. This parameter is respected by both the HTTP/1.1 and HTTP/2 implementations. If not specified, there is no limit. Setting this parameter to 1 will effectively disable keep alive.
        :param int max_retries: The maximum number of parallel retries allowed to the backend cluster. If not specified, the default is 1.
        """
...
class ClientTlsSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] The client side authentication settings for connection originating from the backend service. the backend service.
        :param 'TlsContextResponseArgs' client_tls_context: Configures the mechanism to obtain client-side security certificates and identity information. This field is only applicable when mode is set to MUTUAL.
...
class ConsistentHashLoadBalancerSettingsHttpCookieResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DurationResponseArgs' ttl: Lifetime of the cookie.
        """
        pulumi.set(__self__, "name", name)
...
class CorsPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The specification for allowing client side cross-origin requests. Please see W3C Recommendation for Cross Origin Resource Sharing
        :param bool allow_credentials: In response to a preflight request, setting this to true indicates that the actual request can include user credentials. This translates to the Access-Control-Allow-Credentials header.
               Default is false.
        ...
        :param Sequence[str] allow_origin_regexes: Specifies the regualar expression patterns that match allowed origins. For regular expression grammar please see github.com/google/re2/wiki/Syntax 
...
class CustomerEncryptionKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str rsa_encrypted_key: Specifies an RFC 4648 base64 encoded, RSA-wrapped 2048-bit customer-supplied encryption key to either encrypt or decrypt this resource.
...
class DeprecationStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'RolloutPolicyResponseArgs' state_override: The rollout policy of this deprecation. This policy is only enforced by image family views. The rollout policy restricts the zones where the associated resource is considered in a deprecated state. When the rollout policy does not include the user specified zone, or if the zone is rolled out, the associated resource is considered in a deprecated state.
        """
...
class DiskInstantiationConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str instantiate_from: Specifies whether to include the disk and what image to use. Possible values are:  
...
class DistributionPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['DistributionPolicyZoneConfigurationResponseArgs'] zones: Zones where the regional managed instance group will create and manage its instances.
        """
...
class FirewallPolicyRuleMatcherResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "srcSecureLabels":
            suggest = "src_secure_labels"
    ...
    def __init__(__self__, *,
                 ...
                 src_secure_labels: Sequence[str],
        ...
        :param Sequence['FirewallPolicyRuleMatcherLayer4ConfigResponseArgs'] layer4_configs: Pairs of IP protocols and ports that the rule should match.
        :param Sequence[str] src_ip_ranges: CIDR IP address range. Maximum number of source CIDR IP ranges allowed is 256.
        :param Sequence[str] src_secure_labels: List of firewall label values, which should be matched at the source of the traffic. Maximum number of source label values allowed is 256.
        :param Sequence['FirewallPolicyRuleSecureTagResponseArgs'] src_secure_tags: List of secure tag values, which should be matched at the source of the traffic. For INGRESS rule, if all the srcSecureTag are INEFFECTIVE, and there is no srcIpRange, this rule will be ignored. Maximum number of source tag values allowed is 256.
        """
    ...
    def src_secure_labels(self) -> Sequence[str]:
        """
...
class FirewallPolicyRuleResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "targetSecureLabels":
            suggest = "target_secure_labels"
    ...
    def __init__(__self__, *,
                 ...
                 target_secure_labels: Sequence[str],
        ...
        :param 'FirewallPolicyRuleMatcherResponseArgs' match: A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
    ...
    def target_secure_labels(self) -> Sequence[str]:
        """
        A list of secure labels that controls which instances the firewall rule applies to. If targetSecureLabel are specified, then the firewall rule applies only to instances in the VPC network that have one of those secure labels. targetSecureLabel may not be set at the same time as targetServiceAccounts. If neither targetServiceAccounts nor targetSecureLabel are specified, the firewall rule applies to all instances on the specified network. Maximum number of target label values allowed is 256.
        """
...
class GRPCHealthCheckResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str grpc_service_name: The gRPC service name for the health check. This field is optional. The value of grpc_service_name has the following meanings by convention:
        ...
        :param str port_specification: Specifies how port is selected for health checking, can be one of following values:
...
class GrpcServiceConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] gRPC config to access the SDS server. gRPC config to access the SDS server.
        :param 'CallCredentialsResponseArgs' call_credentials: The call credentials to access the SDS server.
        :param 'ChannelCredentialsResponseArgs' channel_credentials: The channel credentials to access the SDS server.
...
class HostRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        UrlMaps A host-matching rule for a URL. If matched, will use the named PathMatcher to select the BackendService.
        :param str description: An optional description of this resource. Provide this property when you create the resource.
        :param Sequence[str] hosts: The list of host patterns to match. They must be valid hostnames with optional port numbers in the format host:port. * matches any string of ([a-z0-9-.]*). In that case, * must be the first character and must be followed in the pattern by either - or ..
...
class HttpFaultDelayResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the delay introduced by Loadbalancer before forwarding the request to the backend service as part of fault injection.
        :param 'DurationResponseArgs' fixed_delay: Specifies the value of the fixed delay interval.
...
class HttpFaultInjectionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The specification for fault injection introduced into traffic to test the resiliency of clients to backend service failure. As part of fault injection, when clients send requests to a backend service, delays can be introduced by Loadbalancer on a percentage of requests before sending those request to the backend service. Similarly requests from clients can be aborted by the Loadbalancer for a percentage of requests.
        :param 'HttpFaultAbortResponseArgs' abort: The specification for how client requests are aborted as part of fault injection.
        :param 'HttpFaultDelayResponseArgs' delay: The specification for how client requests are delayed as part of fault injection, before being sent to a backend service.
        """
...
class HttpHeaderActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The request and response header transformations that take effect before the request is passed along to the selected backendService.
        :param Sequence['HttpHeaderOptionResponseArgs'] request_headers_to_add: Headers to add to a matching request prior to forwarding the request to the backendService.
        ...
        :param Sequence['HttpHeaderOptionResponseArgs'] response_headers_to_add: Headers to add the response prior to sending the response back to the client.
...
class HttpHeaderMatchResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        matchRule criteria for request header matches.
        :param str exact_match: The value should exactly match contents of exactMatch.
               Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set.
        :param str header_name: The name of the HTTP header to match.
        ...
        :param bool invert_match: If set to false, the headerMatch is considered a match if the match criteria above are met. If set to true, the headerMatch is considered a match if the match criteria above are NOT met.
        ...
        :param bool present_match: A header with the contents of headerName must exist. The match takes place whether or not the request's header has a value.
               Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set.
        :param 'Int64RangeMatchResponseArgs' range_match: The header value must be an integer and its value must be in the range specified in rangeMatch. If the header does not contain an integer, number or is empty, the match fails.
        ...
        :param str regex_match: The value of the header must match the regular expression specified in regexMatch. For regular expression grammar, please see:  github.com/google/re2/wiki/Syntax 
...
class HttpHeaderOptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool replace: If false, headerValue is appended to any values that already exist for the header. If true, headerValue is set for the header, discarding any values that were set for that header.
...
class HttpQueryParameterMatchResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool present_match: Specifies that the queryParameterMatch matches if the request contains the query parameter, irrespective of whether the parameter has a value or not.
               Only one of presentMatch, exactMatch or regexMatch must be set.
        :param str regex_match: The queryParameterMatch matches if the value of the parameter matches the regular expression specified by regexMatch. For the regular expression grammar, please see github.com/google/re2/wiki/Syntax 
               Only one of presentMatch, exactMatch or regexMatch must be set.
...
class HttpRedirectActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str prefix_redirect: The prefix that replaces the prefixMatch specified in the HttpRouteRuleMatch, retaining the remaining portion of the URL before redirecting the request.
...
class HttpRetryPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DurationResponseArgs' per_try_timeout: Specifies a non-zero timeout per retry attempt.
...
class HttpRouteActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'CorsPolicyResponseArgs' cors_policy: The specification for allowing client side cross-origin requests. Please see W3C Recommendation for Cross Origin Resource Sharing 
               Not supported when the URL map is bound to target gRPC proxy.
        :param 'HttpFaultInjectionResponseArgs' fault_injection_policy: The specification for fault injection introduced into traffic to test the resiliency of clients to backend service failure. As part of fault injection, when clients send requests to a backend service, delays can be introduced by Loadbalancer on a percentage of requests before sending those request to the backend service. Similarly requests from clients can be aborted by the Loadbalancer for a percentage of requests.
        ...
        :param 'RequestMirrorPolicyResponseArgs' request_mirror_policy: Specifies the policy on how requests intended for the route's backends are shadowed to a separate mirrored backend service. Loadbalancer does not wait for responses from the shadow service. Prior to sending traffic to the shadow service, the host / authority header is suffixed with -shadow.
               Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
        :param 'HttpRetryPolicyResponseArgs' retry_policy: Specifies the retry policy associated with this route.
               Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
        :param 'DurationResponseArgs' timeout: Specifies the timeout for the selected route. Timeout is computed from the time the request has been fully processed (i.e. end-of-stream) up until the response has been completely processed. Timeout includes all retries.
               If not specified, will use the largest timeout among all backend services associated with the route.
               Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
        :param 'UrlRewriteResponseArgs' url_rewrite: The spec to modify the URL of the request, prior to forwarding the request to the matched service.
               urlRewrite is the only action supported in UrlMaps for external HTTP(S) load balancers.
               Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
        :param Sequence['WeightedBackendServiceResponseArgs'] weighted_backend_services: A list of weighted backend services to send traffic to when a route match occurs. The weights determine the fraction of traffic that flows to their corresponding backend service. If all traffic needs to go to a single backend service, there must be one  weightedBackendService with weight set to a non-zero number.
...
class HttpRouteRuleMatchResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['HttpHeaderMatchResponseArgs'] header_matches: Specifies a list of header match criteria, all of which must match corresponding headers in the request.
        :param bool ignore_case: Specifies that prefixMatch and fullPathMatch matches are case sensitive.
               The default value is false.
               ignoreCase must not be used with regexMatch.
               Not supported when the URL map is bound to target gRPC proxy.
        :param Sequence['MetadataFilterResponseArgs'] metadata_filters: Opaque filter criteria used by Loadbalancer to restrict routing configuration to a limited set of xDS compliant clients. In their xDS requests to Loadbalancer, xDS clients present node metadata. When there is a match, the relevant routing configuration is made available to those proxies.
        ...
        :param str prefix_match: For satisfying the matchRule condition, the request's path must begin with the specified prefixMatch. prefixMatch must begin with a /.
               The value must be between 1 and 1024 characters.
               Only one of prefixMatch, fullPathMatch or regexMatch must be specified.
        :param Sequence['HttpQueryParameterMatchResponseArgs'] query_parameter_matches: Specifies a list of query parameter match criteria, all of which must match corresponding query parameters in the request.
               Not supported when the URL map is bound to target gRPC proxy.
        :param str regex_match: For satisfying the matchRule condition, the path of the request must satisfy the regular expression specified in regexMatch after removing any query parameters and anchor supplied with the original URL. For regular expression grammar please see github.com/google/re2/wiki/Syntax 
               Only one of prefixMatch, fullPathMatch or regexMatch must be specified.
               Note that regexMatch only applies to Loadbalancers that have their loadBalancingScheme set to INTERNAL_SELF_MANAGED.
        """
...
class HttpRouteRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An HttpRouteRule specifies how to match an HTTP request and the corresponding routing action that load balancing proxies will perform.
        :param str description: The short description conveying the intent of this routeRule.
               The description can have a maximum length of 1024 characters.
        :param 'HttpHeaderActionResponseArgs' header_action: Specifies changes to request and response headers that need to take effect for the selected backendService.
        ...
        :param 'HttpRouteActionResponseArgs' route_action: In response to a matching matchRule, the load balancer performs advanced routing actions like URL rewrites, header transformations, etc. prior to forwarding the request to the selected backend. If  routeAction specifies any  weightedBackendServices, service must not be set. Conversely if service is set, routeAction cannot contain any  weightedBackendServices.
        ...
        :param str service: The full or partial URL of the backend service resource to which traffic is directed if this rule is matched. If routeAction is additionally specified, advanced routing actions like URL Rewrites, etc. take effect prior to sending the request to the backend. However, if service is specified, routeAction cannot contain any weightedBackendService s. Conversely, if routeAction specifies any  weightedBackendServices, service must not be specified.
               Only one of urlRedirect, service or routeAction.weightedBackendService must be set.
        :param 'HttpRedirectActionResponseArgs' url_redirect: When this rule is matched, the request is redirected to a URL specified by urlRedirect.
...
class InitialStateConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Initial State for shielded instance, these are public keys which are safe to store in public
        :param Sequence['FileContentBufferResponseArgs'] dbs: The Key Database (db).
        :param Sequence['FileContentBufferResponseArgs'] dbxs: The forbidden key database (dbx).
        :param Sequence['FileContentBufferResponseArgs'] keks: The Key Exchange Key (KEK).
        :param 'FileContentBufferResponseArgs' pk: The Platform Key (PK).
        """
...
class InstanceGroupManagerActionsSummaryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int resuming: [Output Only] The number of instances in the managed instance group that are scheduled to be resumed or are currently being resumed.
        :param int starting: [Output Only] The number of instances in the managed instance group that are scheduled to be started or are currently being started.
        :param int stopping: [Output Only] The number of instances in the managed instance group that are scheduled to be stopped or are currently being stopped.
        :param int suspending: [Output Only] The number of instances in the managed instance group that are scheduled to be suspended or are currently being suspended.
...
class InstanceGroupManagerStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'InstanceGroupManagerStatusStatefulResponseArgs' stateful: [Output Only] Stateful status of the given Instance Group Manager.
        :param 'InstanceGroupManagerStatusVersionTargetResponseArgs' version_target: [Output Only] A status of consistency of Instances' versions with their target version specified by version field on Instance Group Manager.
        """
...
class InstanceGroupManagerStatusStatefulResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'InstanceGroupManagerStatusStatefulPerInstanceConfigsResponseArgs' per_instance_configs: [Output Only] Status of per-instance configs on the instance.
        """
...
class InstanceGroupManagerUpdatePolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: str):
        """
        :param str instance_redistribution_type: The  instance redistribution policy for regional managed instance groups. Valid values are:  
        ...
        :param 'FixedOrPercentResponseArgs' max_unavailable: The maximum number of instances that can be unavailable during the update process. An instance is considered available if all of the following conditions are satisfied:
...
class InstanceGroupManagerVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'FixedOrPercentResponseArgs' target_size: Specifies the intended number of instances to be created from the instanceTemplate. The final number of instances created from the template will be equal to:  
...
class InstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'AdvancedMachineFeaturesResponseArgs' advanced_machine_features: Controls for advanced machine-related behavior features.
        :param bool can_ip_forward: Enables instances created based on these properties to send packets with source IP addresses other than their own and receive packets with destination IP addresses other than their own. If these instances will be used as an IP gateway or it will be set as the next-hop in a Route resource, specify true. If unsure, leave this set to false. See the Enable IP forwarding documentation for more information.
        :param 'ConfidentialInstanceConfigResponseArgs' confidential_instance_config: Specifies the Confidential Instance options.
        :param str description: An optional text description for the instances that are created from these properties.
        :param Sequence['AttachedDiskResponseArgs'] disks: An array of disks that are associated with the instances that are created from these properties.
        :param 'DisplayDeviceResponseArgs' display_device: Display Device properties to enable support for remote display products like: Teradici, VNC and TeamViewer
        :param Sequence['AcceleratorConfigResponseArgs'] guest_accelerators: A list of guest accelerator cards' type and count to use for instances created from these properties.
        ...
        :param 'MetadataResponseArgs' metadata: The metadata key/value pairs to assign to instances that are created from these properties. These pairs can consist of custom metadata or predefined keys. See Project and instance metadata for more information.
        ...
        :param Sequence['NetworkInterfaceResponseArgs'] network_interfaces: An array of network access configurations for this interface.
        ...
        :param 'ReservationAffinityResponseArgs' reservation_affinity: Specifies the reservations that instances can consume from.
        :param Sequence[str] resource_policies: Resource policies (names, not ULRs) applied to instances created from these properties.
        :param 'SchedulingResponseArgs' scheduling: Specifies the scheduling options for the instances that are created from these properties.
        :param Sequence['ServiceAccountResponseArgs'] service_accounts: A list of service accounts with specified scopes. Access tokens for these service accounts are available to the instances that are created from these properties. Use metadata queries to obtain the access tokens for these instances.
        :param 'ShieldedVmConfigResponseArgs' shielded_vm_config: Specifies the Shielded VM options for the instances that are created from these properties.
        :param 'TagsResponseArgs' tags: A list of tags to apply to the instances that are created from these properties. The tags identify valid sources or targets for network firewalls. The setTags method can modify this list of tags. Each tag within the list must comply with RFC1035.
        """
...
class InterconnectOutageNotificationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str issue_type: Form this outage is expected to take, which can take one of the following values: 
        ...
        :param str source: The party that generated this notification, which can take the following value: 
        ...
        :param str state: State of this notification, which can take one of the following values: 
...
class JwtResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['JwtHeaderResponseArgs'] jwt_headers: jwt_headers and jwt_params define where to extract the JWT from an HTTP request. If no explicit location is specified, the following default locations are tried in order:
...
class LogConfigCounterOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Examples: counter { metric: "/debug_access_count" field: "iam_principal" } ==> increment counter /iam/policy/debug_access_count {iam_principal=[value of IAMContext.principal]}
        :param Sequence['LogConfigCounterOptionsCustomFieldResponseArgs'] custom_fields: Custom fields.
...
class LogConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies what kind of log the caller must write
        :param 'LogConfigCloudAuditOptionsResponseArgs' cloud_audit: Cloud audit options.
        :param 'LogConfigCounterOptionsResponseArgs' counter: Counter options.
        :param 'LogConfigDataAccessOptionsResponseArgs' data_access: Data access options.
        """
...
class MetadataFilterLabelMatchResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        MetadataFilter label name value pairs that are expected to match corresponding labels presented as metadata to the loadbalancer.
        :param str name: Name of metadata label.
               The name can have a maximum length of 1024 characters and must be at least 1 character long.
        :param str value: The value of the label must match the specified value.
...
class MetadataFilterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        For each metadataFilter in this list, if its filterMatchCriteria is set to MATCH_ANY, at least one of the filterLabels must match the corresponding label provided in the metadata. If its filterMatchCriteria is set to MATCH_ALL, then all of its filterLabels must match with corresponding labels provided in the metadata.
        An example for using metadataFilters would be: if loadbalancing involves  Envoys, they will only receive routing configuration when values in metadataFilters match values supplied in <a href="https://www.envoyproxy.io/docs/envoy/latest/api-v2/api/v2/core/base.proto#envoy-api-msg-core-node" Node metadata of their XDS requests to loadbalancers.
        :param Sequence['MetadataFilterLabelMatchResponseArgs'] filter_labels: The list of label value pairs that must match labels in the provided metadata based on filterMatchCriteria 
               This list must not be empty and can have at the most 64 entries.
        :param str filter_match_criteria: Specifies how individual filterLabel matches within the list of filterLabels contribute towards the overall metadataFilter match.
               Supported values are:  
...
class MetadataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[Mapping[str, str]] items: Array of key/value pairs. The total size of all keys and values must be less than 512 KB.
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence[Mapping[str, str]]:
        """
...
class NetworkEndpointGroupAppEngineResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str url_mask: A template to parse service and version fields from a request URL. URL mask allows for routing to multiple App Engine services without having to create multiple Network Endpoint Groups and backend services.
...
class NetworkEndpointGroupCloudFunctionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str function: A user-defined name of the Cloud Function.
               ...
               Example value: "func1".
        :param str url_mask: A template to parse function field from a request URL. URL mask allows for routing to multiple Cloud Functions without having to create multiple Network Endpoint Groups and backend services.
...
class NetworkEndpointGroupCloudRunResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str tag: Optional Cloud Run tag represents the "named-revision" to provide additional fine-grained traffic routing information.
               
               The tag must be 1-63 characters long, and comply with RFC1035.
               
               Example value: "revision-0010".
        :param str url_mask: A template to parse service and tag fields from a request URL. URL mask allows for routing to multiple Run services without having to create multiple network endpoint groups and backend services.
...
class NetworkEndpointGroupServerlessDeploymentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Note: The target backend service must be in the same project and located in the same region as the Serverless NEG.
        :param str platform: The platform of the backend target(s) of this NEG. Possible values include:
               ...
               - run.googleapis.com
        :param str resource: The user-defined name of the workload/instance. This value must be provided explicitly or in the urlMask. The resource identified by this value is platform-specific and is as follows:
        ...
        :param str version: The optional resource version. The version identified by this value is as platform-specific and is follows:
...
class NetworkInterfaceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A network interface resource attached to an instance.
        :param Sequence['AccessConfigResponseArgs'] access_configs: An array of configurations for this interface. Currently, only one access config, ONE_TO_ONE_NAT, is supported. If there are no accessConfigs specified, then this instance will have no external internet access.
        :param Sequence['AliasIpRangeResponseArgs'] alias_ip_ranges: An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
        ...
        :param int internal_ipv6_prefix_length: [Output Only] The prefix length of the primary internal IPv6 range.
        :param Sequence['AccessConfigResponseArgs'] ipv6_access_configs: An array of IPv6 access configurations for this interface. Currently, only one IPv6 access config, DIRECT_IPV6, is supported. If there is no ipv6AccessConfig specified, then this instance will have no external IPv6 Internet access.
        :param str ipv6_access_type: [Output Only] One of EXTERNAL, INTERNAL to indicate whether the IP can be accessed from the Internet. This field is always inherited from its subnetwork.
...
class NetworkInterfaceSubInterfaceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vlan: int):
        """
        :param str ip_address: An IPv4 internal IP address to assign to the instance for this subinterface.
...
class NodeGroupMaintenanceWindowResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DurationResponseArgs' maintenance_duration: [Output only] A predetermined duration for the window, automatically chosen to be the smallest possible in the given scenario.
...
class NotificationEndpointGrpcSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DurationResponseArgs' resend_interval: Optional. This field is used to configure how often to send a full update of all non-healthy backends. If unspecified, full updates are not sent. If specified, must be in the range between 600 seconds to 3600 seconds. Nanos are disallowed.
...
class OutlierDetectionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Settings controlling the eviction of unhealthy hosts from the load balancing pool for the backend service.
        :param 'DurationResponseArgs' base_ejection_time: The base time that a host is ejected for. The real ejection time is equal to the base ejection time multiplied by the number of times the host has been ejected. Defaults to 30000ms or 30s.
        ...
        :param 'DurationResponseArgs' interval: Time interval between ejection analysis sweeps. This can result in both new ejections as well as hosts being returned to service. Defaults to 1 second.
...
class PacketMirroringMirroredResourceInfoResponse(dict):
    def __init__(__self__, *,
                 ...
                 tags: Sequence[str]):
        """
        :param Sequence['PacketMirroringMirroredResourceInfoInstanceInfoResponseArgs'] instances: A set of virtual machine instances that are being mirrored. They must live in zones contained in the same region as this packetMirroring.
        ...
        :param Sequence['PacketMirroringMirroredResourceInfoSubnetInfoResponseArgs'] subnetworks: A set of subnetworks for which traffic from/to all VM instances will be mirrored. They must live in the same region as this packetMirroring.
...
class PathMatcherResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str default_service: The full or partial URL to the BackendService resource. This will be used if none of the pathRules or routeRules defined by this PathMatcher are matched. For example, the following are all valid URLs to a BackendService resource:  
        ...
        :param 'HttpRedirectActionResponseArgs' default_url_redirect: When none of the specified pathRules or routeRules match, the request is redirected to a URL specified by defaultUrlRedirect.
        ...
        :param Sequence['PathRuleResponseArgs'] path_rules: The list of path rules. Use this list instead of routeRules when routing based on simple path matching is all that's required. The order by which path rules are specified does not matter. Matches are always done on the longest-path-first basis.
        ...
        :param Sequence['HttpRouteRuleResponseArgs'] route_rules: The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number.
...
class PathRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str service: The full or partial URL of the backend service resource to which traffic is directed if this rule is matched. If routeAction is additionally specified, advanced routing actions like URL Rewrites, etc. take effect prior to sending the request to the backend. However, if service is specified, routeAction cannot contain any weightedBackendService s. Conversely, if routeAction specifies any  weightedBackendServices, service must not be specified.
               Only one of urlRedirect, service or routeAction.weightedBackendService must be set.
        :param 'HttpRedirectActionResponseArgs' url_redirect: When a path pattern is matched, the request is redirected to a URL specified by urlRedirect.
               If urlRedirect is specified, service or routeAction must not be set.
               Not supported when the URL map is bound to target gRPC proxy.
        """
...
class PeerAuthenticationMethodResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] Configuration for the peer authentication method. Configuration for the peer authentication method.
        :param 'MutualTlsResponseArgs' mtls: Set if mTLS is used for peer authentication.
        """
...
class PermissionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] All fields defined in a permission are ANDed.
        :param Sequence['PermissionConstraintResponseArgs'] constraints: Extra custom constraints. The constraints are ANDed together.
...
class RbacPolicyResponse(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['PermissionResponseArgs'] permissions: The list of permissions.
        :param Sequence['PrincipalResponseArgs'] principals: The list of principals.
        """
        pulumi.set(__self__, "name", name)
...
class ReservationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 share_settings: 'outputs.AllocationShareSettingsResponse',
        ...
        :param str self_link_with_id: [Output Only] Server-defined URL for this resource with the resource id.
        :param 'AllocationShareSettingsResponseArgs' share_settings: Share-settings for shared-reservation
        :param 'AllocationSpecificSKUReservationResponseArgs' specific_reservation: Reservation for instances with specific machine shapes.
...
class ResourcePolicyInstanceSchedulePolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ResourcePolicyInstanceSchedulePolicyScheduleResponseArgs' vm_start_schedule: Specifies the schedule for starting instances.
        :param 'ResourcePolicyInstanceSchedulePolicyScheduleResponseArgs' vm_stop_schedule: Specifies the schedule for stopping instances.
        """
...
class ResourcePolicyResourceStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains output only fields. Use this sub-message for all output fields set on ResourcePolicy. The internal structure of this "status" field should mimic the structure of ResourcePolicy proto specification.
        :param 'ResourcePolicyResourceStatusInstanceSchedulePolicyStatusResponseArgs' instance_schedule_policy: [Output Only] Specifies a set of output values reffering to the instance_schedule_policy system status. This field should have the same name as corresponding policy field.
        """
...
class ResourcePolicySnapshotSchedulePolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A snapshot schedule policy specifies when and how frequently snapshots are to be created for the target disk. Also specifies how many and how long these scheduled snapshots should be retained.
        :param 'ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponseArgs' retention_policy: Retention policy applied to snapshots created by this resource policy.
        :param 'ResourcePolicySnapshotSchedulePolicyScheduleResponseArgs' schedule: A Vm Maintenance Policy specifies what kind of infrastructure maintenance we are allowed to perform on this VM and when. Schedule that is applied to disks covered by this policy.
        :param 'ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponseArgs' snapshot_properties: Properties with which snapshots are created such as labels, encryption keys.
        """
...
class ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str on_policy_switch: TODO(b/165626794): Remove this field Specifies the behavior to apply to existing, scheduled snapshots snapshots if the policy is changed.
...
class ResourcePolicyVmMaintenancePolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'ResourcePolicyVmMaintenancePolicyMaintenanceWindowResponseArgs' maintenance_window: Maintenance windows that are applied to VMs covered by this policy.
        """
...
class ResourcePolicyWeeklyCycleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Time window specified for weekly operations.
        :param Sequence['ResourcePolicyWeeklyCycleDayOfWeekResponseArgs'] day_of_weeks: Up to 7 intervals/windows, one for each day of the week.
        """
...
class RolloutPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, str] location_rollout_policies: Location based rollout policies to apply to the resource.
...
class RouterBgpPeerBfdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param int min_receive_interval: The minimum interval, in milliseconds, between BFD control packets received from the peer router. The actual value is negotiated between the two routers and is equal to the greater of this value and the transmit interval of the other router.
               Not currently available publicly.
               If set, this value must be between 100 and 30000.
               The default is 300.
        :param int min_transmit_interval: The minimum interval, in milliseconds, between BFD control packets transmitted to the peer router. The actual value is negotiated between the two routers and is equal to the greater of this value and the corresponding receive interval of the other router.
               Not currently available publicly.
               If set, this value must be between 100 and 30000.
               The default is 300.
        ...
        :param int multiplier: The number of consecutive BFD packets that must be missed before BFD declares that a peer is unavailable.
               Not currently available publicly.
...
class RouterBgpPeerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] advertised_groups: User-specified list of prefix groups to advertise in custom mode, which can take one of the following options: 
               - ALL_SUBNETS: Advertises all available subnets, including peer VPC subnets. 
               - ALL_VPC_SUBNETS: Advertises the router's own VPC subnets. Note that this field can only be populated if advertise_mode is CUSTOM and overrides the list defined for the router (in the "bgp" message). These groups are advertised in addition to any specified prefixes. Leave this field blank to advertise no custom groups.
        :param Sequence['RouterAdvertisedIpRangeResponseArgs'] advertised_ip_ranges: User-specified list of individual IP ranges to advertise in custom mode. This field can only be populated if advertise_mode is CUSTOM and overrides the list defined for the router (in the "bgp" message). These IP ranges are advertised in addition to any specified groups. Leave this field blank to advertise no custom IP ranges.
        ...
        :param 'RouterBgpPeerBfdResponseArgs' bfd: BFD configuration for the BGP peering.
               Not currently available publicly.
        :param str enable: The status of the BGP peer connection.
               Not currently available publicly.
...
class RouterInterfaceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str subnetwork: The URL of the subnetwork resource that this interface belongs to, which must be in the same region as the Cloud Router. When you establish a BGP session to a VM instance using this interface, the VM instance must belong to the same subnetwork as the subnetwork specified here.
        """
        pulumi.set(__self__, "ip_range", ip_range)
...
class RouterNatLogConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str filter: Specify the desired filtering of logs on this NAT. If unspecified, logs are exported for all connections handled by this NAT. This option can take one of the following values: 
...
class RouterNatResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'RouterNatLogConfigResponseArgs' log_config: Configure logging on this NAT.
        ...
        :param str nat_ip_allocate_option: Specify the NatIpAllocateOption, which can take one of the following values: 
        ...
        :param Sequence['RouterNatRuleResponseArgs'] rules: A list of rules associated with this NAT.
        :param str source_subnetwork_ip_ranges_to_nat: Specify the Nat option, which can take one of the following values: 
               - ALL_SUBNETWORKS_ALL_IP_RANGES: All of the IP ranges in every Subnetwork are allowed to Nat. 
               - ALL_SUBNETWORKS_ALL_PRIMARY_IP_RANGES: All of the primary IP ranges in every Subnetwork are allowed to Nat. 
               - LIST_OF_SUBNETWORKS: A list of Subnetworks are allowed to Nat (specified in the field subnetwork below) The default is SUBNETWORK_IP_RANGE_TO_NAT_OPTION_UNSPECIFIED. Note that if this field contains ALL_SUBNETWORKS_ALL_IP_RANGES or ALL_SUBNETWORKS_ALL_PRIMARY_IP_RANGES, then there should not be any other Router.Nat section in any Router for this network in this region.
        :param Sequence['RouterNatSubnetworkToNatResponseArgs'] subnetworks: A list of Subnetwork resources whose traffic should be translated by NAT Gateway. It is used only when LIST_OF_SUBNETWORKS is selected for the SubnetworkIpRangeToNatOption above.
...
class RouterNatRuleActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[str] source_nat_active_ips: A list of URLs of the IP resources used for this NAT rule. These IP addresses must be valid static external IP addresses assigned to the project.
        :param Sequence[str] source_nat_drain_ips: A list of URLs of the IP resources to be drained. These IPs must be valid static external IPs that have been assigned to the NAT. These IPs should be used for updating/patching a NAT rule only.
        """
...
class RouterNatRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rule_number: int):
        """
        :param 'RouterNatRuleActionResponseArgs' action: The action to be enforced for traffic that matches this rule.
        :param str description: An optional description of this rule.
        :param str match: CEL expression that specifies the match condition that egress traffic from a VM is evaluated against. If it evaluates to true, the corresponding ?action? is enforced.
...
class RuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] ins: If one or more 'in' clauses are specified, the rule matches if the PRINCIPAL/AUTHORITY_SELECTOR is in at least one of these entries.
        :param Sequence['LogConfigResponseArgs'] log_configs: The config returned to callers of tech.iam.IAM.CheckPolicy for any entries that match the LOG action.
        :param Sequence[str] not_ins: If one or more 'not_in' clauses are specified, the rule matches if the PRINCIPAL/AUTHORITY_SELECTOR is in none of the entries.
...
class SavedAttachedDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CustomerEncryptionKeyResponseArgs' disk_encryption_key: The encryption key for the disk.
...
class SchedulingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Sets the scheduling options for an Instance. NextID: 20
        :param bool automatic_restart: Specifies whether the instance should be automatically restarted if it is terminated by Compute Engine (not terminated by a user). You can only set the automatic restart option for standard instances. Preemptible instances cannot be automatically restarted.
        ...
        :param int maintenance_freeze_duration_hours: Specifies the number of hours after instance creation where the instance won't be scheduled for maintenance.
        :param str maintenance_interval: Specifies whether this VM may be a stable fleet VM. Setting this to "Periodic" designates this VM as a Stable Fleet VM.
               
               See go/stable-fleet-ug for more details.
        :param int min_node_cpus: The minimum number of virtual CPUs this instance will consume when running on a sole-tenant node.
        :param Sequence['SchedulingNodeAffinityResponseArgs'] node_affinities: A set of node affinity and anti-affinity configurations. Refer to Configuring node affinity for more information. Overrides reservationAffinity.
...
class SdsConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] The configuration to access the SDS server. The configuration to access the SDS server.
        :param 'GrpcServiceConfigResponseArgs' grpc_service_config: The configuration to access the SDS server over GRPC.
        """
...
class SecurityPolicyAdaptiveProtectionConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration options for Cloud Armor Adaptive Protection (CAAP).
        :param 'SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponseArgs' layer7_ddos_defense_config: If set to true, enables Cloud Armor Machine Learning.
        """
...
class SecurityPolicyRuleHttpHeaderActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['SecurityPolicyRuleHttpHeaderActionHttpHeaderOptionResponseArgs'] request_headers_to_adds: The list of request headers to add or overwrite if they?re already present.
        """
...
class SecurityPolicyRuleMatcherConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 src_ip_ranges: Sequence[str]):
        """
        :param Sequence[str] dest_ip_ranges: CIDR IP address range.
               
               This field may only be specified when versioned_expr is set to FIREWALL.
        :param Sequence['SecurityPolicyRuleMatcherConfigDestinationPortResponseArgs'] dest_ports: Pairs of IP protocols and ports that the rule should match.
               
               This field may only be specified when versioned_expr is set to FIREWALL.
        :param Sequence['SecurityPolicyRuleMatcherConfigLayer4ConfigResponseArgs'] layer4_configs: Pairs of IP protocols and ports that the rule should match.
...
class SecurityPolicyRuleMatcherResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a match condition that incoming traffic is evaluated against. Exactly one field must be specified.
        :param 'SecurityPolicyRuleMatcherConfigResponseArgs' config: The configuration options available when specifying versioned_expr. This field must be specified if versioned_expr is specified and cannot be specified if versioned_expr is not specified.
        :param 'ExprResponseArgs' expr: User defined CEVAL expression. A CEVAL expression is used to specify match criteria such as origin.ip, source.region_code and contents in the request header.
...
class SecurityPolicyRuleRateLimitOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SecurityPolicyRuleRateLimitOptionsThresholdResponseArgs' ban_threshold: Can only be specified if the action for the rule is "rate_based_ban". If specified, the key will be banned for the configured 'ban_duration_sec' when the number of requests that exceed the 'rate_limit_threshold' also exceed this 'ban_threshold'.
        ...
        :param 'SecurityPolicyRuleRateLimitOptionsThresholdResponseArgs' rate_limit_threshold: Threshold at which to begin ratelimiting.
        """
...
class SecurityPolicyRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SecurityPolicyRuleHttpHeaderActionResponseArgs' header_action: Optional, additional actions that are performed on headers.
        :param str kind: [Output only] Type of the resource. Always compute#securityPolicyRule for security policy rules
        :param 'SecurityPolicyRuleMatcherResponseArgs' match: A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
        ...
        :param 'SecurityPolicyRuleRateLimitOptionsResponseArgs' rate_limit_options: Must be specified if the action is "rate_based_ban" or "throttle". Cannot be specified for any other actions.
...
class SecuritySettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'AuthenticationPolicyResponseArgs' authentication_policy: [Deprecated] Authentication policy defines what authentication methods can be accepted on backends, and if authenticated, which method/certificate will set the request principal. request principal.
        :param 'AuthorizationConfigResponseArgs' authorization_config: [Deprecated] Authorization config defines the Role Based Access Control (RBAC) config. Authorization config defines the Role Based Access Control (RBAC) config.
        ...
        :param 'ClientTlsSettingsResponseArgs' client_tls_settings: [Deprecated] TLS Settings for the backend service.
...
class ServerTlsSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The TLS settings for the server.
        :param 'TlsContextResponseArgs' proxy_tls_context: Configures the mechanism to obtain security certificates and identity information.
        ...
        :param str tls_mode: Indicates whether connections should be secured using TLS. The value of this field determines how TLS is enforced. This field can be set to one of the following:  
...
class ServiceAttachmentConsumerForwardingRuleResponse(dict):
    ...
    def __getitem__(self, key: str) -> Any:
        ServiceAttachmentConsumerForwardingRuleResponse.__key_warning(key)
        return super().__getitem__(key)
...
class SourceDiskEncryptionKeyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_disk: str):
        """
        :param 'CustomerEncryptionKeyResponseArgs' disk_encryption_key: The customer-supplied encryption key of the source disk. Required if the source disk is protected by a customer-supplied encryption key.
        :param str source_disk: URL of the disk attached to the source instance. This can be a full or valid partial URL. For example, the following are valid values:  
...
class SourceInstanceParamsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A specification of the parameters to use when creating the instance template from a source instance.
        :param Sequence['DiskInstantiationConfigResponseArgs'] disk_configs: Attached disks configuration. If not provided, defaults are applied: For boot disk and any other R/W disks, new custom images will be created from each disk. For read-only disks, they will be attached in read-only mode. Local SSD disks will be created as blank volumes.
        """
...
class SourceInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['SavedAttachedDiskResponseArgs'] disks: An array of disks that are associated with the instances that are created from this machine image.
        :param Sequence['AcceleratorConfigResponseArgs'] guest_accelerators: A list of guest accelerator cards' type and count to use for instances created from this machine image.
        ...
        :param 'MetadataResponseArgs' metadata: The metadata key/value pairs to assign to instances that are created from this machine image. These pairs can consist of custom metadata or predefined keys. See Project and instance metadata for more information.
        ...
        :param Sequence['NetworkInterfaceResponseArgs'] network_interfaces: An array of network access configurations for this interface.
        :param str post_key_revocation_action_type: PostKeyRevocationActionType of the instance.
        :param 'SchedulingResponseArgs' scheduling: Specifies the scheduling options for the instances that are created from this machine image.
        :param Sequence['ServiceAccountResponseArgs'] service_accounts: A list of service accounts with specified scopes. Access tokens for these service accounts are available to the instances that are created from this machine image. Use metadata queries to obtain the access tokens for these instances.
        :param 'TagsResponseArgs' tags: A list of tags to apply to the instances that are created from this machine image. The tags identify valid sources or targets for network firewalls. The setTags method can modify this list of tags. Each tag within the list must comply with RFC1035.
        """
        pulumi.set(__self__, "can_ip_forward", can_ip_forward)
...
class TlsCertificateContextResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] Defines the mechanism to obtain the client or server certificate. Defines the mechanism to obtain the client or server certificate.
        :param 'TlsCertificatePathsResponseArgs' certificate_paths: Specifies the certificate and private key paths. This field is applicable only if tlsCertificateSource is set to USE_PATH.
        :param str certificate_source: Defines how TLS certificates are obtained.
        :param 'SdsConfigResponseArgs' sds_config: Specifies the config to retrieve certificates through SDS. This field is applicable only if tlsCertificateSource is set to USE_SDS.
        """
...
class TlsContextResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        [Deprecated] The TLS settings for the client or server. The TLS settings for the client or server.
        :param 'TlsCertificateContextResponseArgs' certificate_context: Defines the mechanism to obtain the client or server certificate.
        :param 'TlsValidationContextResponseArgs' validation_context: Defines the mechanism to obtain the Certificate Authority certificate to validate the client/server certificate. If omitted, the proxy will not validate the server or client certificate.
        """
...
class UpcomingMaintenanceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Upcoming Maintenance notification information.
        :param str date: [Output Only] The date when the maintenance will take place. This value is in RFC3339 text format. DEPRECATED: Use start_time_window instead.
        :param 'UpcomingMaintenanceTimeWindowResponseArgs' start_time_window: [Output Only] The start time window of the maintenance disruption.
        :param str time: [Output Only] The time when the maintenance will take place. This value is in RFC3339 text format. DEPRECATED: Use start_time_window instead.
...
class UrlMapTestResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str expected_output_url: The expected output URL evaluated by load balancer containing the scheme, host, path and query parameters.
        ...
        :param int expected_redirect_response_code: For rules with urlRedirect, the test passes only if expectedRedirectResponseCode matches the HTTP status code in load balancer's redirect response.
        ...
        :param Sequence['UrlMapTestHeaderResponseArgs'] headers: HTTP headers for this request. If headers contains a host header, then host must also match the header value.
        ...
        :param str service: Expected BackendService or BackendBucket resource the given URL should be mapped to.
...
class UrlRewriteResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The spec for modifying the path before sending the request to the matched backend service.
        :param str host_rewrite: Prior to forwarding the request to the selected service, the request's host header is replaced with contents of hostRewrite.
               The value must be between 1 and 255 characters.
        :param str path_prefix_rewrite: Prior to forwarding the request to the selected backend service, the matching portion of the request's path is replaced by pathPrefixRewrite.
               The value must be between 1 and 1024 characters.
        """
...
class WeightedBackendServiceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'HttpHeaderActionResponseArgs' header_action: Specifies changes to request and response headers that need to take effect for the selected backendService.
               ...
               Note that headerAction is not supported for Loadbalancers that have their loadBalancingScheme set to EXTERNAL.
               Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
        :param int weight: Specifies the fraction of traffic sent to backendService, computed as weight / (sum of all weightedBackendService weights in routeAction) .
