...
__all__ = ['RegionNetworkFirewallPolicy']
...
class RegionNetworkFirewallPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(RegionNetworkFirewallPolicy, __self__).__init__(
            'gcp-native:compute/alpha:RegionNetworkFirewallPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RegionNetworkFirewallPolicy':
        """
