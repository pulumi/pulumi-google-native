...
__all__ = ['ZoneInstantSnapshotIamPolicyArgs', 'ZoneInstantSnapshotIamPolicy']

@pulumi.input_type
class ZoneInstantSnapshotIamPolicyArgs:
...
class ZoneInstantSnapshotIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ZoneInstantSnapshotIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param ZoneInstantSnapshotIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ZoneInstantSnapshotIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ZoneInstantSnapshotIamPolicyArgs.__new__(ZoneInstantSnapshotIamPolicyArgs)
        ...
        super(ZoneInstantSnapshotIamPolicy, __self__).__init__(
            'gcp-native:compute/alpha:ZoneInstantSnapshotIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ZoneInstantSnapshotIamPolicy':
        """
        ...
        return ZoneInstantSnapshotIamPolicy(resource_name, opts=opts, __props__=__props__)
