...
__all__ = ['ServiceAttachmentIamPolicyArgs', 'ServiceAttachmentIamPolicy']

@pulumi.input_type
class ServiceAttachmentIamPolicyArgs:
...
class ServiceAttachmentIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceAttachmentIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param ServiceAttachmentIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceAttachmentIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceAttachmentIamPolicyArgs.__new__(ServiceAttachmentIamPolicyArgs)
        ...
        super(ServiceAttachmentIamPolicy, __self__).__init__(
            'gcp-native:compute/beta:ServiceAttachmentIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServiceAttachmentIamPolicy':
        """
        ...
        return ServiceAttachmentIamPolicy(resource_name, opts=opts, __props__=__props__)
