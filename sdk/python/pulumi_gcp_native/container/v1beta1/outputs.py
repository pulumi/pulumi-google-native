...
class AddonsConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for the addons that can be automatically spun up in the cluster, enabling additional functionality.
        :param 'CloudRunConfigResponseArgs' cloud_run_config: Configuration for the Cloud Run addon. The `IstioConfig` addon must be enabled in order to enable Cloud Run addon. This option can only be enabled at cluster creation time.
        ...
        :param 'IstioConfigResponseArgs' istio_config: Configuration for Istio, an open platform to connect, manage, and secure microservices.
        :param 'KalmConfigResponseArgs' kalm_config: Configuration for the KALM addon, which manages the lifecycle of k8s applications.
    ...
    def istio_config(self) -> 'outputs.IstioConfigResponse':
        """
    ...
    def kalm_config(self) -> 'outputs.KalmConfigResponse':
        """
...
class BinaryAuthorizationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for Binary Authorization.
        :param bool enabled: Enable Binary Authorization for this cluster. If enabled, all container images will be validated by Google Binauthz.
        """
        pulumi.set(__self__, "enabled", enabled)
...
@pulumi.output_type
class ClusterTelemetryResponse(dict):
    """
...
class DailyMaintenanceWindowResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str start_time: Time within the maintenance window to start the maintenance operations. It must be in format "HH:MM", where HH : [00-23] and MM : [00-59] GMT.
        """
...
@pulumi.output_type
class EphemeralStorageConfigResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in EphemeralStorageConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        EphemeralStorageConfigResponse.__key_warning(key)
        return super().__getitem__(key)
...
class IPAllocationPolicyResponse(dict):
    ...
    def allow_route_overlap(self) -> bool:
        """
...
@pulumi.output_type
class IstioConfigResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration options for Istio addon.
        :param str auth: The specified Istio auth mode, either none, or mutual TLS.
        :param bool disabled: Whether Istio is enabled for this cluster.
        """
...
class KalmConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration options for the KALM addon.
        :param bool enabled: Whether KALM is enabled for this cluster.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class MasterAuthorizedNetworksConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration options for the master authorized networks feature. Enabled master authorized networks will disallow all external traffic to access Kubernetes master through HTTPS except traffic from the given CIDR blocks, Google Compute Engine Public IPs and Google Prod IPs.
        :param Sequence['CidrBlockResponseArgs'] cidr_blocks: cidr_blocks define up to 10 external networks that could access Kubernetes master through HTTPS.
...
class NodeConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int disk_size_gb: Size of the disk attached to each node, specified in GB. The smallest allowed disk size is 10GB. If unspecified, the default disk size is 100GB.
        :param str disk_type: Type of the disk attached to each node (e.g. 'pd-standard', 'pd-ssd' or 'pd-balanced') If unspecified, the default disk type is 'pd-standard'
        :param 'EphemeralStorageConfigResponseArgs' ephemeral_storage_config: Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk.
        ...
        :param Sequence[str] oauth_scopes: The set of Google API scopes to be made available on all of the node VMs under the "default" service account. The following scopes are recommended, but not required, and by default are not included: * `https://www.googleapis.com/auth/compute` is required for mounting persistent storage on your nodes. * `https://www.googleapis.com/auth/devstorage.read_only` is required for communicating with **gcr.io** (the [Google Container Registry](https://cloud.google.com/container-registry/)). If unspecified, no scopes are added, unless Cloud Logging or Cloud Monitoring are enabled, in which case their required scopes will be added.
        :param bool preemptible: Whether the nodes are created as preemptible VM instances. See: https://cloud.google.com/compute/docs/instances/preemptible for more inforamtion about preemptible VM instances.
    ...
    def ephemeral_storage_config(self) -> 'outputs.EphemeralStorageConfigResponse':
        """
...
class NodePoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'NodeNetworkConfigResponseArgs' network_config: Networking configuration for this NodePool. If specified, it overrides the cluster-level defaults.
...
@pulumi.output_type
class PodSecurityPolicyConfigResponse(dict):
    """
...
class SandboxConfigResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SandboxConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SandboxConfigResponse.__key_warning(key)
        return super().__getitem__(key)
...
class TpuConfigResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TpuConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TpuConfigResponse.__key_warning(key)
        return super().__getitem__(key)
...
class WorkloadIdentityConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for the use of Kubernetes Service Accounts in GCP IAM policies.
        :param str identity_namespace: IAM Identity Namespace to attach all Kubernetes Service Accounts to.
        :param str identity_provider: identity provider is the third party identity provider.
...
class WorkloadMetadataConfigResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in WorkloadMetadataConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        WorkloadMetadataConfigResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param str node_metadata: NodeMetadata is the configuration for how to expose metadata to the workloads running on the node.
        """
