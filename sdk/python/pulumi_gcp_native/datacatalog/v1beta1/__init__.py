...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:datacatalog/v1beta1:EntryGroup":
            ...
            elif typ == "gcp-native:datacatalog/v1beta1:TaxonomyIamPolicy":
                return TaxonomyIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:datacatalog/v1beta1:TaxonomyPolicyTag":
                return TaxonomyPolicyTag(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:datacatalog/v1beta1:TaxonomyPolicyTagIamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "datacatalog/v1beta1", _module_instance)
