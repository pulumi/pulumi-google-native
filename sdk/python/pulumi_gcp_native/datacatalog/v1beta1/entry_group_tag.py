...
__all__ = ['EntryGroupTag']


class EntryGroupTag(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(EntryGroupTag, __self__).__init__(
            'gcp-native:datacatalog/v1beta1:EntryGroupTag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'EntryGroupTag':
        """
        ...
        return EntryGroupTag(resource_name, opts=opts, __props__=__props__)
