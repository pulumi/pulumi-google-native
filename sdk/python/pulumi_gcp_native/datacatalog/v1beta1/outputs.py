...
class GoogleCloudDatacatalogV1beta1BigQueryTableSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDatacatalogV1beta1TableSpecResponseArgs' table_spec: Spec of a BigQuery table. This field should only be populated if `table_source_type` is `BIGQUERY_TABLE`.
        :param 'GoogleCloudDatacatalogV1beta1ViewSpecResponseArgs' view_spec: Table view specification. This field should only be populated if `table_source_type` is `BIGQUERY_VIEW`.
        """
...
class GoogleCloudDatacatalogV1beta1ColumnSchemaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudDatacatalogV1beta1ColumnSchemaResponseArgs'] subcolumns: Optional. Schema of sub-columns. A column can have zero or more sub-columns.
...
class GoogleCloudDatacatalogV1beta1GcsFileSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDatacatalogV1beta1SystemTimestampsResponseArgs' gcs_timestamps: Timestamps about the Cloud Storage file.
...
class GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudDatacatalogV1beta1GcsFileSpecResponseArgs'] sample_gcs_file_specs: Sample files contained in this fileset, not all files contained in this fileset are represented here.
        """
...
class GoogleCloudDatacatalogV1beta1SchemaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a schema (e.g. BigQuery, GoogleSQL, Avro schema).
        :param Sequence['GoogleCloudDatacatalogV1beta1ColumnSchemaResponseArgs'] columns: Required. Schema of columns. A maximum of 10,000 columns and sub-columns can be specified.
        """
