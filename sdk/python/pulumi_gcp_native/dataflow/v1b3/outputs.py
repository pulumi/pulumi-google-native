...
class EnvironmentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DebugOptionsResponseArgs' debug_options: Any debugging options to be supplied to the job.
        ...
        :param Sequence['WorkerPoolResponseArgs'] worker_pools: The worker pools. At least one "harness" worker pool must be specified in order for the job to have workers.
...
class JobMetadataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['PubSubIODetailsResponseArgs'] pubsub_details: Identification of a PubSub source used in the Dataflow job.
        :param 'SdkVersionResponseArgs' sdk_version: The SDK version used to run the job.
        :param Sequence['SpannerIODetailsResponseArgs'] spanner_details: Identification of a Spanner source used in the Dataflow job.
        """
...
class PipelineDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A descriptive representation of submitted pipeline as well as the executed form. This data is provided by the Dataflow service for ease of visualizing the pipeline and interpreting Dataflow provided metrics.
        :param Sequence['DisplayDataResponseArgs'] display_data: Pipeline level display data.
        :param Sequence['ExecutionStageSummaryResponseArgs'] execution_pipeline_stage: Description of each stage of execution of the pipeline.
        :param Sequence['TransformSummaryResponseArgs'] original_pipeline_transform: Description of each transform in the pipeline and collections between them.
        """
...
class RuntimeMetadataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        RuntimeMetadata describing a runtime environment.
        :param Sequence['ParameterMetadataResponseArgs'] parameters: The parameters for the template.
        :param 'SDKInfoResponseArgs' sdk_info: SDK Info for the template.
        """
...
class TaskRunnerSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'WorkerSettingsResponseArgs' parallel_worker_settings: The settings to pass to the parallel worker harness.
...
class TransformSummaryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Description of the type, names/ids, and input/outputs for a transform.
        :param Sequence['DisplayDataResponseArgs'] display_data: Transform-specific display data.
...
class WorkerPoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes one particular pool of Cloud Dataflow workers to be instantiated by the Cloud Dataflow service in order to perform the computations required by a job. Note that a workflow job may use multiple pools, in order to match the various computational requirements of the various stages of the job.
        :param 'AutoscalingSettingsResponseArgs' autoscaling_settings: Settings for autoscaling of this WorkerPool.
        :param Sequence['DiskResponseArgs'] data_disks: Data disks that are used by a VM in this workflow.
        ...
        :param 'TaskRunnerSettingsResponseArgs' taskrunner_settings: Settings passed through to Google Compute Engine workers when using the standard Dataflow task runner. Users should ignore this field.
