...
__all__ = ['InstanceNamespaceIamPolicyArgs', 'InstanceNamespaceIamPolicy']
...
class InstanceNamespaceIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: InstanceNamespaceIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param InstanceNamespaceIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InstanceNamespaceIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InstanceNamespaceIamPolicyArgs.__new__(InstanceNamespaceIamPolicyArgs)
        ...
        super(InstanceNamespaceIamPolicy, __self__).__init__(
            'gcp-native:datafusion/v1beta1:InstanceNamespaceIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InstanceNamespaceIamPolicy':
        """
        ...
        return InstanceNamespaceIamPolicy(resource_name, opts=opts, __props__=__props__)
