...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:datamigration/v1:ConnectionProfile":
                return ConnectionProfile(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:datamigration/v1:ConnectionProfileIamPolicy":
                return ConnectionProfileIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:datamigration/v1:MigrationJob":
                return MigrationJob(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:datamigration/v1:MigrationJobIamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "datamigration/v1", _module_instance)
