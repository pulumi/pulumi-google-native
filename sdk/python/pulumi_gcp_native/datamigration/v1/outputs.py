...
class CloudSqlConnectionProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CloudSqlSettingsResponseArgs' settings: Immutable. Metadata used to create the destination Cloud SQL database.
        """
...
class CloudSqlSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SqlIpConfigResponseArgs' ip_config: The settings for IP Management. This allows to enable or disable the instance IP and manage which external networks can connect to the instance. The IPv4 address cannot be disabled.
...
class MySqlConnectionProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SslConfigResponseArgs' ssl: SSL configuration for the destination to connect to the source database.
...
class SqlIpConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        IP Management configuration.
        :param Sequence['SqlAclEntryResponseArgs'] authorized_networks: The list of external networks that are allowed to connect to the instance using the IP. See https://en.wikipedia.org/wiki/CIDR_notation#CIDR_notation, also known as 'slash' notation (e.g. `192.168.100.0/24`).
