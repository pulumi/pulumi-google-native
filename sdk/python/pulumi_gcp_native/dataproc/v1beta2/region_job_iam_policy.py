...
__all__ = ['RegionJobIamPolicyArgs', 'RegionJobIamPolicy']

@pulumi.input_type
class RegionJobIamPolicyArgs:
...
class RegionJobIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RegionJobIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.

        :param str resource_name: The name of the resource.
        :param RegionJobIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RegionJobIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RegionJobIamPolicyArgs.__new__(RegionJobIamPolicyArgs)
        ...
        super(RegionJobIamPolicy, __self__).__init__(
            'gcp-native:dataproc/v1beta2:RegionJobIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RegionJobIamPolicy':
        """
        ...
        return RegionJobIamPolicy(resource_name, opts=opts, __props__=__props__)
