...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:dialogflow/v2beta1:AgentEntityType":
                return AgentEntityType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:AgentEnvironmentUserSessionContext":
                return AgentEnvironmentUserSessionContext(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:AgentEnvironmentUserSessionEntityType":
                return AgentEnvironmentUserSessionEntityType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:AgentIntent":
                return AgentIntent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:AgentKnowledgeBase":
                return AgentKnowledgeBase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:AgentKnowledgeBaseDocument":
                return AgentKnowledgeBaseDocument(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:AgentSessionContext":
                return AgentSessionContext(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:AgentSessionEntityType":
                return AgentSessionEntityType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:Conversation":
                return Conversation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:ConversationParticipant":
                return ConversationParticipant(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:ConversationProfile":
                return ConversationProfile(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:KnowledgeBase":
                return KnowledgeBase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v2beta1:KnowledgeBaseDocument":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "dialogflow/v2beta1", _module_instance)
