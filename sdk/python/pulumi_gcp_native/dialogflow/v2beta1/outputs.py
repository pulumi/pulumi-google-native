...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the Human Agent Assistant to connect to a conversation.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfigResponseArgs' end_user_suggestion_config: Configuration for agent assistance of end user participant. Currently, this feature is not general available, please contact Google to get access.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfigResponseArgs' human_agent_suggestion_config: Configuration for agent assistance of human agent participant.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigMessageAnalysisConfigResponseArgs' message_analysis_config: Configuration for message analysis.
        :param 'GoogleCloudDialogflowV2beta1NotificationConfigResponseArgs' notification_config: Pub/Sub topic on which to publish new agent assistant events.
        """
...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Detail human agent assistant config.
        :param Sequence['GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponseArgs'] feature_configs: Configuration of different suggestion features. One feature can have only one config.
...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Config for suggestion features.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationModelConfigResponseArgs' conversation_model_config: Configs of custom conversation model.
        ...
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigResponseArgs' query_config: Configs of query.
        :param 'GoogleCloudDialogflowV2beta1SuggestionFeatureResponseArgs' suggestion_feature: The suggestion feature.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionTriggerSettingsResponseArgs' suggestion_trigger_settings: Settings of suggestion trigger. Currently, only ARTICLE_SUGGESTION, FAQ, and DIALOGFLOW_ASSIST will use this field.
        """
...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettingsResponseArgs' context_filter_settings: Determines how recent conversation context is filtered when generating suggestions. If unspecified, no messages will be dropped.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceResponseArgs' dialogflow_query_source: Query from Dialogflow agent. It is used by DIALOGFLOW_ASSIST.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySourceResponseArgs' document_query_source: Query from knowledge base document. It is used by: SMART_REPLY, SMART_COMPOSE.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySourceResponseArgs' knowledge_base_query_source: Query from knowledgebase. It is used by: ARTICLE_SUGGESTION, FAQ.
...
class GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the hand off to a live agent, typically on which external agent service provider to connect to a conversation. Currently, this feature is not general available, please contact Google to get access.
        :param 'GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigLivePersonConfigResponseArgs' live_person_config: Uses LivePerson (https://www.liveperson.com).
        :param 'GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigSalesforceLiveAgentConfigResponseArgs' salesforce_live_agent_config: Uses Salesforce Live Agent.
        """
...
class GoogleCloudDialogflowV2beta1IntentMessageBasicCardButtonResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The button object that appears at the bottom of a card.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageBasicCardButtonOpenUriActionResponseArgs' open_uri_action: Required. Action to take when a user taps on the button.
...
class GoogleCloudDialogflowV2beta1IntentMessageBasicCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The basic card message. Useful for displaying information.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageBasicCardButtonResponseArgs'] buttons: Optional. The collection of card buttons.
        :param str formatted_text: Required, unless image is present. The body text of the card.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageImageResponseArgs' image: Optional. The image for the card.
...
class GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2beta1IntentMessageImageResponseArgs' image: Optional. Hero image for the carousel item.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItemOpenUrlActionResponseArgs' open_uri_action: Required. Action to present to the user.
...
class GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItemResponseArgs'] items: Required. List of items in the Browse Carousel Card. Minimum of two items, maximum of ten.
        """
...
class GoogleCloudDialogflowV2beta1IntentMessageCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The card response message.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageCardButtonResponseArgs'] buttons: Optional. The collection of card buttons.
...
class GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2beta1IntentMessageImageResponseArgs' image: Optional. The image to display.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfoResponseArgs' info: Required. Additional info about the option item.
...
class GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The card for presenting a carousel of options to select from.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItemResponseArgs'] items: Required. Carousel items.
        """
        pulumi.set(__self__, "items", items)
...
class GoogleCloudDialogflowV2beta1IntentMessageListSelectItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2beta1IntentMessageImageResponseArgs' image: Optional. The image to display.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfoResponseArgs' info: Required. Additional information about this option.
...
class GoogleCloudDialogflowV2beta1IntentMessageListSelectResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The card for presenting a list of options to select from.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageListSelectItemResponseArgs'] items: Required. List items.
...
class GoogleCloudDialogflowV2beta1IntentMessageMediaContentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The media content card for Actions on Google.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageMediaContentResponseMediaObjectResponseArgs'] media_objects: Required. List of media objects.
...
class GoogleCloudDialogflowV2beta1IntentMessageMediaContentResponseMediaObjectResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2beta1IntentMessageImageResponseArgs' icon: Optional. Icon to display above media content.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageImageResponseArgs' large_image: Optional. Image to display above media content.
...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaResponseArgs' media: Optional. However at least one of the title, description or media must be set. Media (image, GIF or a video) to include in the card.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestionResponseArgs'] suggestions: Optional. List of suggestions to include in the card.
...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Carousel Rich Business Messaging (RBM) rich card. Rich cards allow you to respond to users with more vivid content, e.g. with media and suggestions. If you want to show a single card with more control over the layout, please use RbmStandaloneCard instead.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponseArgs'] card_contents: Required. The cards in the carousel. A carousel must have at least 2 cards and at most 10.
...
class GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Standalone Rich Business Messaging (RBM) rich card. Rich cards allow you to respond to users with more vivid content, e.g. with media and suggestions. You can group multiple rich cards into one using RbmCarouselCard but carousel cards will give you less control over the card layout.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponseArgs' card_content: Required. Card content.
...
class GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Rich Business Messaging (RBM) suggested client-side action that the user can choose from the card.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionDialResponseArgs' dial: Suggested client side action: Dial a phone number
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionOpenUriResponseArgs' open_url: Suggested client side action: Open a URI on device
        ...
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionShareLocationResponseArgs' share_location: Suggested client side action: Share user location
...
class GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Rich Business Messaging (RBM) suggestion. Suggestions allow user to easily select/click a predefined response or perform an action (like opening a web uri).
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionResponseArgs' action: Predefined client side actions that user can choose
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedReplyResponseArgs' reply: Predefined replies for user to select instead of typing
        """
...
class GoogleCloudDialogflowV2beta1IntentMessageRbmTextResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Rich Business Messaging (RBM) text response with suggestions.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestionResponseArgs'] rbm_suggestion: Optional. One or more suggestions to show to the user.
...
class GoogleCloudDialogflowV2beta1IntentMessageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Corresponds to the `Response` field in the Dialogflow console.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageBasicCardResponseArgs' basic_card: Displays a basic card for Actions on Google.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardResponseArgs' browse_carousel_card: Browse carousel card for Actions on Google.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageCardResponseArgs' card: Displays a card.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectResponseArgs' carousel_select: Displays a carousel card for Actions on Google.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageImageResponseArgs' image: Displays an image.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageLinkOutSuggestionResponseArgs' link_out_suggestion: Displays a link out suggestion chip for Actions on Google.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageListSelectResponseArgs' list_select: Displays a list card for Actions on Google.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageMediaContentResponseArgs' media_content: The media content card for Actions on Google.
        ...
        :param 'GoogleCloudDialogflowV2beta1IntentMessageQuickRepliesResponseArgs' quick_replies: Displays quick replies.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponseArgs' rbm_carousel_rich_card: Rich Business Messaging (RBM) carousel rich card response.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCardResponseArgs' rbm_standalone_rich_card: Standalone Rich Business Messaging (RBM) rich card response.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageRbmTextResponseArgs' rbm_text: Rich Business Messaging (RBM) text response. RBM allows businesses to send enriched and branded versions of SMS. See https://jibe.google.com/business-messaging.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageSimpleResponsesResponseArgs' simple_responses: Returns a voice or text-only response for Actions on Google.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageSuggestionsResponseArgs' suggestions: Displays suggestion chips for Actions on Google.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageTableCardResponseArgs' table_card: Table card for Actions on Google.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageTelephonyPlayAudioResponseArgs' telephony_play_audio: Plays audio from a file in Telephony Gateway.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageTelephonySynthesizeSpeechResponseArgs' telephony_synthesize_speech: Synthesizes speech in Telephony Gateway.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageTelephonyTransferCallResponseArgs' telephony_transfer_call: Transfers the call in Telephony Gateway.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageTextResponseArgs' text: Returns a text response.
        """
...
class GoogleCloudDialogflowV2beta1IntentMessageSimpleResponsesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The collection of simple response candidates. This message in `QueryResult.fulfillment_messages` and `WebhookResponse.fulfillment_messages` should contain only one `SimpleResponse`.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageSimpleResponseResponseArgs'] simple_responses: Required. The list of simple responses.
        """
        pulumi.set(__self__, "simple_responses", simple_responses)
...
class GoogleCloudDialogflowV2beta1IntentMessageSuggestionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The collection of suggestions.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageSuggestionResponseArgs'] suggestions: Required. The list of suggested replies.
        """
        pulumi.set(__self__, "suggestions", suggestions)
...
class GoogleCloudDialogflowV2beta1IntentMessageTableCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Table card for Actions on Google.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageBasicCardButtonResponseArgs'] buttons: Optional. List of buttons for the card.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageColumnPropertiesResponseArgs'] column_properties: Optional. Display properties for the columns in this table.
        :param 'GoogleCloudDialogflowV2beta1IntentMessageImageResponseArgs' image: Optional. Image which should be displayed on the card.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageTableCardRowResponseArgs'] rows: Optional. Rows in this table of data.
...
class GoogleCloudDialogflowV2beta1IntentMessageTableCardRowResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Row of TableCard.
        :param Sequence['GoogleCloudDialogflowV2beta1IntentMessageTableCardCellResponseArgs'] cells: Optional. List of cells that make up this row.
