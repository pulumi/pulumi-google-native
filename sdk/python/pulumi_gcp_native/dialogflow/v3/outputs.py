...
class GoogleCloudDialogflowCxV3AudioInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3InputAudioConfigResponseArgs' config: Required. Instructs the speech recognizer how to process the speech audio.
        """
...
class GoogleCloudDialogflowCxV3ConversationTurnResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        One interaction between a human and virtual agent. The human provides some input and the virtual agent provides a response.
        :param 'GoogleCloudDialogflowCxV3ConversationTurnUserInputResponseArgs' user_input: The user input.
        :param 'GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutputResponseArgs' virtual_agent_output: The virtual agent output.
        """
...
class GoogleCloudDialogflowCxV3ConversationTurnUserInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3QueryInputResponseArgs' input: Supports text input, event input, dtmf input in the test case.
...
class GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The output from the virtual agent.
        :param 'GoogleCloudDialogflowCxV3PageResponseArgs' current_page: The Page on which the utterance was spoken. Only name and displayName will be set.
        :param Mapping[str, str] diagnostic_info: Required. Input only. The diagnostic info output for the turn.
        :param Sequence['GoogleCloudDialogflowCxV3TestRunDifferenceResponseArgs'] differences: If this is part of a result conversation turn, the list of differences between the original run and the replay for this output, if any.
        ...
        :param Sequence['GoogleCloudDialogflowCxV3ResponseMessageTextResponseArgs'] text_responses: The text responses from the agent for the turn.
        :param 'GoogleCloudDialogflowCxV3IntentResponseArgs' triggered_intent: The Intent that triggered the response. Only name and displayName will be set.
        """
...
class GoogleCloudDialogflowCxV3EventHandlerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3FulfillmentResponseArgs' trigger_fulfillment: The fulfillment to call when the event occurs. Handling webhook errors with a fulfillment enabled with webhook could cause infinite loop. It is invalid to specify such fulfillment for a handler handling webhooks.
        """
...
class GoogleCloudDialogflowCxV3ExperimentDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3VersionVariantsResponseArgs' version_variants: The flow versions as the variants of this experiment.
        """
...
class GoogleCloudDialogflowCxV3ExperimentResultMetricResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Metric and corresponding confidence intervals.
        :param 'GoogleCloudDialogflowCxV3ExperimentResultConfidenceIntervalResponseArgs' confidence_interval: The probability that the treatment is better than all other treatments in the experiment
...
class GoogleCloudDialogflowCxV3ExperimentResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudDialogflowCxV3ExperimentResultVersionMetricsResponseArgs'] version_metrics: Version variants and metrics.
        """
...
class GoogleCloudDialogflowCxV3ExperimentResultVersionMetricsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Version variant and associated metrics.
        :param Sequence['GoogleCloudDialogflowCxV3ExperimentResultMetricResponseArgs'] metrics: The metrics and corresponding confidence intervals in the inference result.
...
class GoogleCloudDialogflowCxV3FormParameterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3FormParameterFillBehaviorResponseArgs' fill_behavior: Required. Defines fill behavior for the parameter.
...
class GoogleCloudDialogflowCxV3FormResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A form is a data model that groups related parameters that can be collected from the user. The process in which the agent prompts the user and collects parameter values from the user is called form filling. A form can be added to a page. When form filling is done, the filled parameters will be written to the session.
        :param Sequence['GoogleCloudDialogflowCxV3FormParameterResponseArgs'] parameters: Parameters to collect from the user.
        """
...
class GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The list of messages or conditional cases to activate for this case.
        :param 'GoogleCloudDialogflowCxV3FulfillmentConditionalCasesResponseArgs' additional_cases: Additional cases to be evaluated.
        :param 'GoogleCloudDialogflowCxV3ResponseMessageResponseArgs' message: Returned message.
        """
...
class GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Each case has a Boolean condition. When it is evaluated to be True, the corresponding messages will be selected and evaluated recursively.
        :param Sequence['GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponseArgs'] case_content: A list of case content.
...
class GoogleCloudDialogflowCxV3FulfillmentConditionalCasesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A list of cascading if-else conditions. Cases are mutually exclusive. The first one with a matching condition is selected, all the rest ignored.
        :param Sequence['GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseResponseArgs'] cases: A list of cascading if-else conditions.
        """
...
class GoogleCloudDialogflowCxV3FulfillmentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A fulfillment can do one or more of the following actions at the same time: * Generate rich message responses. * Set parameter values. * Call the webhook. Fulfillments can be called at various stages in the Page or Form lifecycle. For example, when a DetectIntentRequest drives a session to enter a new page, the page's entry fulfillment can add a static response to the QueryResult in the returning DetectIntentResponse, call the webhook (for example, to load user data from a database), or both.
        :param Sequence['GoogleCloudDialogflowCxV3FulfillmentConditionalCasesResponseArgs'] conditional_cases: Conditional cases for this fulfillment.
        :param Sequence['GoogleCloudDialogflowCxV3ResponseMessageResponseArgs'] messages: The list of rich message responses to present to the user.
        :param Sequence['GoogleCloudDialogflowCxV3FulfillmentSetParameterActionResponseArgs'] set_parameter_actions: Set parameter values before executing the webhook.
...
class GoogleCloudDialogflowCxV3IntentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudDialogflowCxV3IntentParameterResponseArgs'] parameters: The collection of parameters associated with the intent.
        :param int priority: The priority of this intent. Higher numbers represent higher priorities. - If the supplied value is unspecified or 0, the service translates the value to 500,000, which corresponds to the `Normal` priority in the console. - If the supplied value is negative, the intent is ignored in runtime detect intent requests.
        :param Sequence['GoogleCloudDialogflowCxV3IntentTrainingPhraseResponseArgs'] training_phrases: The collection of training phrases the agent is trained on to identify the intent.
        """
...
class GoogleCloudDialogflowCxV3PageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3FulfillmentResponseArgs' entry_fulfillment: The fulfillment to call when the session is entering the page.
        :param Sequence['GoogleCloudDialogflowCxV3EventHandlerResponseArgs'] event_handlers: Handlers associated with the page to handle events such as webhook errors, no match or no input.
        :param 'GoogleCloudDialogflowCxV3FormResponseArgs' form: The form associated with the page, used for collecting parameters relevant to the page.
        ...
        :param Sequence['GoogleCloudDialogflowCxV3TransitionRouteResponseArgs'] transition_routes: A list of transitions for the transition rules of this page. They route the conversation to another page in the same flow, or another flow. When we are in a certain page, the TransitionRoutes are evalauted in the following order: * TransitionRoutes defined in the page with intent specified. * TransitionRoutes defined in the transition route groups with intent specified. * TransitionRoutes defined in flow with intent specified. * TransitionRoutes defined in the transition route groups with intent specified. * TransitionRoutes defined in the page with only condition specified. * TransitionRoutes defined in the transition route groups with only condition specified.
        """
        pulumi.set(__self__, "display_name", display_name)
...
class GoogleCloudDialogflowCxV3QueryInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents the query input. It can contain one of: 1. A conversational query in the form of text. 2. An intent query that specifies which intent to trigger. 3. Natural language speech audio to be processed. 4. An event to be triggered. 
        :param 'GoogleCloudDialogflowCxV3AudioInputResponseArgs' audio: The natural language speech audio to be processed.
        :param 'GoogleCloudDialogflowCxV3DtmfInputResponseArgs' dtmf: The DTMF event to be handled.
        :param 'GoogleCloudDialogflowCxV3EventInputResponseArgs' event: The event to be triggered.
        :param 'GoogleCloudDialogflowCxV3IntentInputResponseArgs' intent: The intent to be triggered.
        ...
        :param 'GoogleCloudDialogflowCxV3TextInputResponseArgs' text: The natural language text to be processed.
        """
        pulumi.set(__self__, "audio", audio)
...
class GoogleCloudDialogflowCxV3ResponseMessageMixedAudioResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents an audio message that is composed of both segments synthesized from the Dialogflow agent prompts and ones hosted externally at the specified URIs. The external URIs are specified via play_audio. This message is generated by Dialogflow only and not supposed to be defined by the user.
        :param Sequence['GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegmentResponseArgs'] segments: Segments this audio response is composed of.
        """
...
class GoogleCloudDialogflowCxV3ResponseMessageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a response message that can be returned by a conversational agent. Response messages are also used for output audio synthesis. The approach is as follows: * If at least one OutputAudioText response is present, then all OutputAudioText responses are linearly concatenated, and the result is used for output audio synthesis. * If the OutputAudioText responses are a mixture of text and SSML, then the concatenated result is treated as SSML; otherwise, the result is treated as either text or SSML as appropriate. The agent designer should ideally use either text or SSML consistently throughout the bot design. * Otherwise, all Text responses are linearly concatenated, and the result is used for output audio synthesis. This approach allows for more sophisticated user experience scenarios, where the text displayed to the user may differ from what is heard.
        :param 'GoogleCloudDialogflowCxV3ResponseMessageConversationSuccessResponseArgs' conversation_success: Indicates that the conversation succeeded.
        :param 'GoogleCloudDialogflowCxV3ResponseMessageEndInteractionResponseArgs' end_interaction: A signal that indicates the interaction with the Dialogflow agent has ended. This message is generated by Dialogflow only when the conversation reaches `END_SESSION` page. It is not supposed to be defined by the user. It's guaranteed that there is at most one such message in each response.
        :param 'GoogleCloudDialogflowCxV3ResponseMessageLiveAgentHandoffResponseArgs' live_agent_handoff: Hands off conversation to a human agent.
        :param 'GoogleCloudDialogflowCxV3ResponseMessageMixedAudioResponseArgs' mixed_audio: An audio response message composed of both the synthesized Dialogflow agent responses and responses defined via play_audio. This message is generated by Dialogflow only and not supposed to be defined by the user.
        :param 'GoogleCloudDialogflowCxV3ResponseMessageOutputAudioTextResponseArgs' output_audio_text: A text or ssml response that is preferentially used for TTS output audio synthesis, as described in the comment on the ResponseMessage message.
        :param Mapping[str, str] payload: Returns a response containing a custom, platform-specific payload.
        :param 'GoogleCloudDialogflowCxV3ResponseMessagePlayAudioResponseArgs' play_audio: Signal that the client should play an audio clip hosted at a client-specific URI. Dialogflow uses this to construct mixed_audio. However, Dialogflow itself does not try to read or process the URI in any way.
        :param 'GoogleCloudDialogflowCxV3ResponseMessageTextResponseArgs' text: Returns a text response.
        """
...
class GoogleCloudDialogflowCxV3TestCaseResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a result from running a test case in an agent environment.
        :param Sequence['GoogleCloudDialogflowCxV3ConversationTurnResponseArgs'] conversation_turns: The conversation turns uttered during the test case replay in chronological order.
...
class GoogleCloudDialogflowCxV3TransitionRouteResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str target_flow: The target flow to transition to. Format: `projects//locations//agents//flows/`.
        :param str target_page: The target page to transition to. Format: `projects//locations//agents//flows//pages/`.
        :param 'GoogleCloudDialogflowCxV3FulfillmentResponseArgs' trigger_fulfillment: The fulfillment to call when the condition is satisfied. At least one of `trigger_fulfillment` and `target` must be specified. When both are defined, `trigger_fulfillment` is executed first.
        """
        pulumi.set(__self__, "condition", condition)
        pulumi.set(__self__, "intent", intent)
        pulumi.set(__self__, "name", name)
...
class GoogleCloudDialogflowCxV3VariantsHistoryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3VersionVariantsResponseArgs' version_variants: The flow versions as the variants.
        """
...
class GoogleCloudDialogflowCxV3VersionVariantsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A list of flow version variants.
        :param Sequence['GoogleCloudDialogflowCxV3VersionVariantsVariantResponseArgs'] variants: A list of flow version variants.
        """
