...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:dialogflow/v3beta1:Agent":
                return Agent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentEntityType":
                return AgentEntityType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentEnvironment":
                return AgentEnvironment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentEnvironmentExperiment":
                return AgentEnvironmentExperiment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentEnvironmentSessionEntityType":
                return AgentEnvironmentSessionEntityType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentFlow":
                return AgentFlow(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentFlowPage":
                return AgentFlowPage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentFlowTransitionRouteGroup":
                return AgentFlowTransitionRouteGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentFlowVersion":
                return AgentFlowVersion(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentIntent":
                return AgentIntent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentSessionEntityType":
                return AgentSessionEntityType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentTestCase":
                return AgentTestCase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:AgentWebhook":
                return AgentWebhook(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:dialogflow/v3beta1:SecuritySetting":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "dialogflow/v3beta1", _module_instance)
