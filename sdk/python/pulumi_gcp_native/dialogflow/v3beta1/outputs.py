...
class GoogleCloudDialogflowCxV3beta1AudioInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3beta1InputAudioConfigResponseArgs' config: Required. Instructs the speech recognizer how to process the speech audio.
        """
...
class GoogleCloudDialogflowCxV3beta1ConversationTurnResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        One interaction between a human and virtual agent. The human provides some input and the virtual agent provides a response.
        :param 'GoogleCloudDialogflowCxV3beta1ConversationTurnUserInputResponseArgs' user_input: The user input.
        :param 'GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutputResponseArgs' virtual_agent_output: The virtual agent output.
        """
...
class GoogleCloudDialogflowCxV3beta1ConversationTurnUserInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3beta1QueryInputResponseArgs' input: Supports text input, event input, dtmf input in the test case.
...
class GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The output from the virtual agent.
        :param 'GoogleCloudDialogflowCxV3beta1PageResponseArgs' current_page: The Page on which the utterance was spoken. Only name and displayName will be set.
        :param Mapping[str, str] diagnostic_info: Required. Input only. The diagnostic info output for the turn.
        :param Sequence['GoogleCloudDialogflowCxV3beta1TestRunDifferenceResponseArgs'] differences: If this is part of a result conversation turn, the list of differences between the original run and the replay for this output, if any.
        :param Mapping[str, str] session_parameters: The session parameters available to the bot at this point.
        :param 'GoogleRpcStatusResponseArgs' status: Response error from the agent in the test result. If set, other output is empty.
        :param Sequence['GoogleCloudDialogflowCxV3beta1ResponseMessageTextResponseArgs'] text_responses: The text responses from the agent for the turn.
        :param 'GoogleCloudDialogflowCxV3beta1IntentResponseArgs' triggered_intent: The Intent that triggered the response. Only name and displayName will be set.
        """
...
class GoogleCloudDialogflowCxV3beta1EventHandlerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3beta1FulfillmentResponseArgs' trigger_fulfillment: The fulfillment to call when the event occurs. Handling webhook errors with a fulfillment enabled with webhook could cause infinite loop. It is invalid to specify such fulfillment for a handler handling webhooks.
        """
...
class GoogleCloudDialogflowCxV3beta1ExperimentDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3beta1VersionVariantsResponseArgs' version_variants: The flow versions as the variants of this experiment.
        """
...
class GoogleCloudDialogflowCxV3beta1ExperimentResultMetricResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Metric and corresponding confidence intervals.
        :param 'GoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceIntervalResponseArgs' confidence_interval: The probability that the treatment is better than all other treatments in the experiment
...
class GoogleCloudDialogflowCxV3beta1ExperimentResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudDialogflowCxV3beta1ExperimentResultVersionMetricsResponseArgs'] version_metrics: Version variants and metrics.
        """
...
class GoogleCloudDialogflowCxV3beta1ExperimentResultVersionMetricsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Version variant and associated metrics.
        :param Sequence['GoogleCloudDialogflowCxV3beta1ExperimentResultMetricResponseArgs'] metrics: The metrics and corresponding confidence intervals in the inference result.
...
class GoogleCloudDialogflowCxV3beta1FormParameterFillBehaviorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for how the filling of a parameter should be handled.
        :param 'GoogleCloudDialogflowCxV3beta1FulfillmentResponseArgs' initial_prompt_fulfillment: Required. The fulfillment to provide the initial prompt that the agent can present to the user in order to fill the parameter.
        :param Sequence['GoogleCloudDialogflowCxV3beta1EventHandlerResponseArgs'] reprompt_event_handlers: The handlers for parameter-level events, used to provide reprompt for the parameter or transition to a different page/flow. The supported events are: * `sys.no-match-`, where N can be from 1 to 6 * `sys.no-match-default` * `sys.no-input-`, where N can be from 1 to 6 * `sys.no-input-default` * `sys.invalid-parameter` `initial_prompt_fulfillment` provides the first prompt for the parameter. If the user's response does not fill the parameter, a no-match/no-input event will be triggered, and the fulfillment associated with the `sys.no-match-1`/`sys.no-input-1` handler (if defined) will be called to provide a prompt. The `sys.no-match-2`/`sys.no-input-2` handler (if defined) will respond to the next no-match/no-input event, and so on. A `sys.no-match-default` or `sys.no-input-default` handler will be used to handle all following no-match/no-input events after all numbered no-match/no-input handlers for the parameter are consumed. A `sys.invalid-parameter` handler can be defined to handle the case where the parameter values have been `invalidated` by webhook. For example, if the user's response fill the parameter, however the parameter was invalidated by webhook, the fulfillment associated with the `sys.invalid-parameter` handler (if defined) will be called to provide a prompt. If the event handler for the corresponding event can't be found on the parameter, `initial_prompt_fulfillment` will be re-prompted.
        """
...
class GoogleCloudDialogflowCxV3beta1FormParameterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3beta1FormParameterFillBehaviorResponseArgs' fill_behavior: Required. Defines fill behavior for the parameter.
...
class GoogleCloudDialogflowCxV3beta1FormResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A form is a data model that groups related parameters that can be collected from the user. The process in which the agent prompts the user and collects parameter values from the user is called form filling. A form can be added to a page. When form filling is done, the filled parameters will be written to the session.
        :param Sequence['GoogleCloudDialogflowCxV3beta1FormParameterResponseArgs'] parameters: Parameters to collect from the user.
        """
...
class GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The list of messages or conditional cases to activate for this case.
        :param 'GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesResponseArgs' additional_cases: Additional cases to be evaluated.
        :param 'GoogleCloudDialogflowCxV3beta1ResponseMessageResponseArgs' message: Returned message.
        """
...
class GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Each case has a Boolean condition. When it is evaluated to be True, the corresponding messages will be selected and evaluated recursively.
        :param Sequence['GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContentResponseArgs'] case_content: A list of case content.
...
class GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A list of cascading if-else conditions. Cases are mutually exclusive. The first one with a matching condition is selected, all the rest ignored.
        :param Sequence['GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseResponseArgs'] cases: A list of cascading if-else conditions.
        """
...
class GoogleCloudDialogflowCxV3beta1FulfillmentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A fulfillment can do one or more of the following actions at the same time: * Generate rich message responses. * Set parameter values. * Call the webhook. Fulfillments can be called at various stages in the Page or Form lifecycle. For example, when a DetectIntentRequest drives a session to enter a new page, the page's entry fulfillment can add a static response to the QueryResult in the returning DetectIntentResponse, call the webhook (for example, to load user data from a database), or both.
        :param Sequence['GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesResponseArgs'] conditional_cases: Conditional cases for this fulfillment.
        :param Sequence['GoogleCloudDialogflowCxV3beta1ResponseMessageResponseArgs'] messages: The list of rich message responses to present to the user.
        :param Sequence['GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterActionResponseArgs'] set_parameter_actions: Set parameter values before executing the webhook.
...
class GoogleCloudDialogflowCxV3beta1IntentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudDialogflowCxV3beta1IntentParameterResponseArgs'] parameters: The collection of parameters associated with the intent.
        :param int priority: The priority of this intent. Higher numbers represent higher priorities. - If the supplied value is unspecified or 0, the service translates the value to 500,000, which corresponds to the `Normal` priority in the console. - If the supplied value is negative, the intent is ignored in runtime detect intent requests.
        :param Sequence['GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponseArgs'] training_phrases: The collection of training phrases the agent is trained on to identify the intent.
        """
...
class GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents an example that the agent is trained on to identify the intent.
        :param Sequence['GoogleCloudDialogflowCxV3beta1IntentTrainingPhrasePartResponseArgs'] parts: Required. The ordered list of training phrase parts. The parts are concatenated in order to form the training phrase. Note: The API does not automatically annotate training phrases like the Dialogflow Console does. Note: Do not forget to include whitespace at part boundaries, so the training phrase is well formatted when the parts are concatenated. If the training phrase does not need to be annotated with parameters, you just need a single part with only the Part.text field set. If you want to annotate the training phrase, you must create multiple parts, where the fields of each part are populated in one of two ways: - `Part.text` is set to a part of the phrase that has no parameters. - `Part.text` is set to a part of the phrase that you want to annotate, and the `parameter_id` field is set.
...
class GoogleCloudDialogflowCxV3beta1PageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3beta1FulfillmentResponseArgs' entry_fulfillment: The fulfillment to call when the session is entering the page.
        :param Sequence['GoogleCloudDialogflowCxV3beta1EventHandlerResponseArgs'] event_handlers: Handlers associated with the page to handle events such as webhook errors, no match or no input.
        :param 'GoogleCloudDialogflowCxV3beta1FormResponseArgs' form: The form associated with the page, used for collecting parameters relevant to the page.
...
class GoogleCloudDialogflowCxV3beta1QueryInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents the query input. It can contain one of: 1. A conversational query in the form of text. 2. An intent query that specifies which intent to trigger. 3. Natural language speech audio to be processed. 4. An event to be triggered. 
        :param 'GoogleCloudDialogflowCxV3beta1AudioInputResponseArgs' audio: The natural language speech audio to be processed.
        :param 'GoogleCloudDialogflowCxV3beta1DtmfInputResponseArgs' dtmf: The DTMF event to be handled.
        :param 'GoogleCloudDialogflowCxV3beta1EventInputResponseArgs' event: The event to be triggered.
        :param 'GoogleCloudDialogflowCxV3beta1IntentInputResponseArgs' intent: The intent to be triggered.
        ...
        :param 'GoogleCloudDialogflowCxV3beta1TextInputResponseArgs' text: The natural language text to be processed.
        """
        pulumi.set(__self__, "audio", audio)
...
class GoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudioResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents an audio message that is composed of both segments synthesized from the Dialogflow agent prompts and ones hosted externally at the specified URIs. The external URIs are specified via play_audio. This message is generated by Dialogflow only and not supposed to be defined by the user.
        :param Sequence['GoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudioSegmentResponseArgs'] segments: Segments this audio response is composed of.
        """
...
class GoogleCloudDialogflowCxV3beta1ResponseMessageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a response message that can be returned by a conversational agent. Response messages are also used for output audio synthesis. The approach is as follows: * If at least one OutputAudioText response is present, then all OutputAudioText responses are linearly concatenated, and the result is used for output audio synthesis. * If the OutputAudioText responses are a mixture of text and SSML, then the concatenated result is treated as SSML; otherwise, the result is treated as either text or SSML as appropriate. The agent designer should ideally use either text or SSML consistently throughout the bot design. * Otherwise, all Text responses are linearly concatenated, and the result is used for output audio synthesis. This approach allows for more sophisticated user experience scenarios, where the text displayed to the user may differ from what is heard.
        :param 'GoogleCloudDialogflowCxV3beta1ResponseMessageConversationSuccessResponseArgs' conversation_success: Indicates that the conversation succeeded.
        :param 'GoogleCloudDialogflowCxV3beta1ResponseMessageEndInteractionResponseArgs' end_interaction: A signal that indicates the interaction with the Dialogflow agent has ended. This message is generated by Dialogflow only when the conversation reaches `END_SESSION` page. It is not supposed to be defined by the user. It's guaranteed that there is at most one such message in each response.
        :param 'GoogleCloudDialogflowCxV3beta1ResponseMessageLiveAgentHandoffResponseArgs' live_agent_handoff: Hands off conversation to a human agent.
        :param 'GoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudioResponseArgs' mixed_audio: An audio response message composed of both the synthesized Dialogflow agent responses and responses defined via play_audio. This message is generated by Dialogflow only and not supposed to be defined by the user.
        :param 'GoogleCloudDialogflowCxV3beta1ResponseMessageOutputAudioTextResponseArgs' output_audio_text: A text or ssml response that is preferentially used for TTS output audio synthesis, as described in the comment on the ResponseMessage message.
        :param Mapping[str, str] payload: Returns a response containing a custom, platform-specific payload.
        :param 'GoogleCloudDialogflowCxV3beta1ResponseMessagePlayAudioResponseArgs' play_audio: Signal that the client should play an audio clip hosted at a client-specific URI. Dialogflow uses this to construct mixed_audio. However, Dialogflow itself does not try to read or process the URI in any way.
        :param 'GoogleCloudDialogflowCxV3beta1ResponseMessageTextResponseArgs' text: Returns a text response.
        """
...
class GoogleCloudDialogflowCxV3beta1TestCaseResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a result from running a test case in an agent environment.
        :param Sequence['GoogleCloudDialogflowCxV3beta1ConversationTurnResponseArgs'] conversation_turns: The conversation turns uttered during the test case replay in chronological order.
...
class GoogleCloudDialogflowCxV3beta1TransitionRouteResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str target_flow: The target flow to transition to. Format: `projects//locations//agents//flows/`.
        :param str target_page: The target page to transition to. Format: `projects//locations//agents//flows//pages/`.
        :param 'GoogleCloudDialogflowCxV3beta1FulfillmentResponseArgs' trigger_fulfillment: The fulfillment to call when the condition is satisfied. At least one of `trigger_fulfillment` and `target` must be specified. When both are defined, `trigger_fulfillment` is executed first.
        """
        pulumi.set(__self__, "condition", condition)
        pulumi.set(__self__, "intent", intent)
        pulumi.set(__self__, "name", name)
...
class GoogleCloudDialogflowCxV3beta1VariantsHistoryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3beta1VersionVariantsResponseArgs' version_variants: The flow versions as the variants.
        """
...
class GoogleCloudDialogflowCxV3beta1VersionVariantsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A list of flow version variants.
        :param Sequence['GoogleCloudDialogflowCxV3beta1VersionVariantsVariantResponseArgs'] variants: A list of flow version variants.
        """
