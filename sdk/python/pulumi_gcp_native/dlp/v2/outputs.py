...
class GooglePrivacyDlpV2CryptoDeterministicConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2CryptoKeyResponseArgs' crypto_key: The key used by the encryption function. For deterministic encryption using AES-SIV, the provided key is internally expanded to 64 bytes prior to use.
