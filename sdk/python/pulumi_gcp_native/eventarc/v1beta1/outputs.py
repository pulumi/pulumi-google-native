...
class DestinationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a target of an invocation over HTTP.
        :param 'CloudRunServiceResponseArgs' cloud_run_service: Cloud Run fully-managed service that receives the events. The service should be running in the same project as the trigger.
        """
