...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:gameservices/v1beta:GameServerDeployment":
                return GameServerDeployment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:gameservices/v1beta:GameServerDeploymentConfig":
                return GameServerDeploymentConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:gameservices/v1beta:GameServerDeploymentIamPolicy":
                return GameServerDeploymentIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:gameservices/v1beta:Realm":
                return Realm(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:gameservices/v1beta:RealmGameServerCluster":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "gameservices/v1beta", _module_instance)
