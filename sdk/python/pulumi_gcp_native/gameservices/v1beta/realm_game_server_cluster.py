...
class RealmGameServerClusterArgs:
    ...
    def allocation_priority(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def allocation_priority(self, value: Optional[pulumi.Input[str]]):
...
class RealmGameServerCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(RealmGameServerCluster, __self__).__init__(
            'gcp-native:gameservices/v1beta:RealmGameServerCluster',
            resource_name,
            __props__,
            opts)
