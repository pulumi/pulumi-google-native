...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:gkehub/v1alpha:Feature":
                return Feature(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:gkehub/v1alpha:FeatureIamPolicy":
                return FeatureIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:gkehub/v1alpha:MembershipIamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "gkehub/v1alpha", _module_instance)
