...
__all__ = ['DatasetHl7V2StoreIamPolicyArgs', 'DatasetHl7V2StoreIamPolicy']
...
class DatasetHl7V2StoreIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatasetHl7V2StoreIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param DatasetHl7V2StoreIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatasetHl7V2StoreIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatasetHl7V2StoreIamPolicyArgs.__new__(DatasetHl7V2StoreIamPolicyArgs)
        ...
        super(DatasetHl7V2StoreIamPolicy, __self__).__init__(
            'gcp-native:healthcare/v1beta1:DatasetHl7V2StoreIamPolicy',
            resource_name,
            __props__,
            opts)
