...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:iap/v1:Brand":
                return Brand(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:iap/v1:BrandIdentityAwareProxyClient":
                return BrandIdentityAwareProxyClient(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:iap/v1:V1IamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "iap/v1", _module_instance)
