...
__all__ = ['V1beta1IamPolicyArgs', 'V1beta1IamPolicy']

@pulumi.input_type
class V1beta1IamPolicyArgs:
    def __init__(__self__, *,
                 v1beta1_id: pulumi.Input[str],
        ...
        """
        pulumi.set(__self__, "v1beta1_id", v1beta1_id)
    ...
    @property
    @pulumi.getter(name="v1beta1Id")
    def v1beta1_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "v1beta1_id")

    @v1beta1_id.setter
    def v1beta1_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "v1beta1_id", value)
...
class V1beta1IamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: V1beta1IamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy for an Identity-Aware Proxy protected resource. Replaces any existing policy. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api

        :param str resource_name: The name of the resource.
        :param V1beta1IamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(V1beta1IamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = V1beta1IamPolicyArgs.__new__(V1beta1IamPolicyArgs)
        ...
        super(V1beta1IamPolicy, __self__).__init__(
            'gcp-native:iap/v1beta1:V1beta1IamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'V1beta1IamPolicy':
        """
        ...
        return V1beta1IamPolicy(resource_name, opts=opts, __props__=__props__)
