...
__all__ = ['BillingAccountBucketView']


class BillingAccountBucketView(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(BillingAccountBucketView, __self__).__init__(
            'gcp-native:logging/v2:BillingAccountBucketView',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BillingAccountBucketView':
        """
        ...
        return BillingAccountBucketView(resource_name, opts=opts, __props__=__props__)
