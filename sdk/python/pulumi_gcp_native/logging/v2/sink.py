...
class SinkArgs:
    def __init__(__self__, *,
                 ...
                 v2_id: pulumi.Input[str],
                 v2_id1: pulumi.Input[str],
        ...
        pulumi.set(__self__, "v2_id", v2_id)
        pulumi.set(__self__, "v2_id1", v2_id1)
    ...
    @property
    @pulumi.getter(name="v2Id")
    def v2_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "v2_id")

    @v2_id.setter
    def v2_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "v2_id", value)

    @property
    @pulumi.getter(name="v2Id1")
    def v2_id1(self) -> pulumi.Input[str]:
        return pulumi.get(self, "v2_id1")

    @v2_id1.setter
    def v2_id1(self, value: pulumi.Input[str]):
        pulumi.set(self, "v2_id1", value)
