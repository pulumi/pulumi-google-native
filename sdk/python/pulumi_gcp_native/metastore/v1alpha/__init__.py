...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:metastore/v1alpha:Service":
                return Service(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:metastore/v1alpha:ServiceBackup":
                return ServiceBackup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:metastore/v1alpha:ServiceIamPolicy":
                return ServiceIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:metastore/v1alpha:ServiceMetadataImport":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "metastore/v1alpha", _module_instance)
