...
class ColumnLayoutResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A simplified layout that divides the available space into vertical columns and arranges a set of widgets vertically in each column.
        :param Sequence['ColumnResponseArgs'] columns: The columns of content to display.
        """
...
class ColumnResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['WidgetResponseArgs'] widgets: The display widgets arranged vertically in this column.
        """
...
class DataSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'TimeSeriesQueryResponseArgs' time_series_query: Required. Fields for querying time series data from the Stackdriver metrics API.
        """
...
class GridLayoutResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['WidgetResponseArgs'] widgets: The informational elements that are arranged into the columns row-first.
        """
        pulumi.set(__self__, "columns", columns)
        pulumi.set(__self__, "widgets", widgets)
...
class MosaicLayoutResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['TileResponseArgs'] tiles: The tiles to display.
        """
        pulumi.set(__self__, "columns", columns)
...
class RatioPartResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a query to build the numerator or denominator of a TimeSeriesFilterRatio.
        :param 'AggregationResponseArgs' aggregation: By default, the raw time series data is returned. Use this field to combine multiple time series for different views of the data.
...
class RowLayoutResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A simplified layout that divides the available space into rows and arranges a set of widgets horizontally in each row.
        :param Sequence['RowResponseArgs'] rows: The rows of content to display.
        """
...
class RowResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['WidgetResponseArgs'] widgets: The display widgets arranged horizontally in this row.
        """
        pulumi.set(__self__, "weight", weight)
        pulumi.set(__self__, "widgets", widgets)
...
class ScorecardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A widget showing the latest value of a metric, and how this value relates to one or more thresholds.
        :param 'GaugeViewResponseArgs' gauge_view: Will cause the scorecard to show a gauge chart.
        :param 'SparkChartViewResponseArgs' spark_chart_view: Will cause the scorecard to show a spark chart.
        :param Sequence['ThresholdResponseArgs'] thresholds: The thresholds used to determine the state of the scorecard given the time series' current value. For an actual value x, the scorecard is in a danger state if x is less than or equal to a danger threshold that triggers below, or greater than or equal to a danger threshold that triggers above. Similarly, if x is above/below a warning threshold that triggers above/below, then the scorecard is in a warning state - unless x also puts it in a danger state. (Danger trumps warning.)As an example, consider a scorecard with the following four thresholds: { value: 90, category: 'DANGER', trigger: 'ABOVE', }, { value: 70, category: 'WARNING', trigger: 'ABOVE', }, { value: 10, category: 'DANGER', trigger: 'BELOW', }, { value: 20, category: 'WARNING', trigger: 'BELOW', }Then: values less than or equal to 10 would put the scorecard in a DANGER state, values greater than 10 but less than or equal to 20 a WARNING state, values strictly between 20 and 70 an OK state, values greater than or equal to 70 but less than 90 a WARNING state, and values greater than or equal to 90 a DANGER state.
        :param 'TimeSeriesQueryResponseArgs' time_series_query: Required. Fields for querying time series data from the Stackdriver metrics API.
        """
...
class TileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'WidgetResponseArgs' widget: The informational widget contained in the tile. For example an XyChart.
...
class TimeSeriesFilterRatioResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A pair of time series filters that define a ratio computation. The output time series is the pair-wise division of each aligned element from the numerator and denominator time series.
        :param 'RatioPartResponseArgs' denominator: The denominator of the ratio.
        :param 'RatioPartResponseArgs' numerator: The numerator of the ratio.
        :param 'PickTimeSeriesFilterResponseArgs' pick_time_series_filter: Ranking based time series filter.
        :param 'AggregationResponseArgs' secondary_aggregation: Apply a second aggregation after the ratio is computed.
        :param 'StatisticalTimeSeriesFilterResponseArgs' statistical_time_series_filter: Statistics based time series filter. Note: This field is deprecated and completely ignored by the API.
        """
...
class TimeSeriesFilterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str filter: Required. The monitoring filter (https://cloud.google.com/monitoring/api/v3/filters) that identifies the metric types, resources, and projects to query.
        :param 'PickTimeSeriesFilterResponseArgs' pick_time_series_filter: Ranking based time series filter.
        :param 'AggregationResponseArgs' secondary_aggregation: Apply a second aggregation after aggregation is applied.
        :param 'StatisticalTimeSeriesFilterResponseArgs' statistical_time_series_filter: Statistics based time series filter. Note: This field is deprecated and completely ignored by the API.
        """
        pulumi.set(__self__, "aggregation", aggregation)
        pulumi.set(__self__, "filter", filter)
...
class TimeSeriesQueryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        TimeSeriesQuery collects the set of supported methods for querying time series data from the Stackdriver metrics API.
        :param 'TimeSeriesFilterResponseArgs' time_series_filter: Filter parameters to fetch time series.
        :param 'TimeSeriesFilterRatioResponseArgs' time_series_filter_ratio: Parameters to fetch a ratio between two time series filters.
...
class WidgetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Widget contains a single dashboard component and configuration of how to present the component in the dashboard.
        :param 'EmptyResponseArgs' blank: A blank space.
        :param 'ScorecardResponseArgs' scorecard: A scorecard summarizing time series data.
        :param 'TextResponseArgs' text: A raw string or markdown displaying textual content.
        :param str title: Optional. The title of the widget.
        :param 'XyChartResponseArgs' xy_chart: A chart of time series data.
        """
...
class XyChartResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A chart that displays data on a 2D (X and Y axes) plane.
        :param 'ChartOptionsResponseArgs' chart_options: Display options for the chart.
        :param Sequence['DataSetResponseArgs'] data_sets: Required. The data displayed in this chart.
        :param Sequence['ThresholdResponseArgs'] thresholds: Threshold lines drawn horizontally across the chart.
        ...
        :param 'AxisResponseArgs' x_axis: The properties applied to the X axis.
        :param 'AxisResponseArgs' y_axis: The properties applied to the Y axis.
        """
