...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:networkconnectivity/v1alpha1:Hub":
                return Hub(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:networkconnectivity/v1alpha1:HubIamPolicy":
                return HubIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:networkconnectivity/v1alpha1:InternalRangeIamPolicy":
                return InternalRangeIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:networkconnectivity/v1alpha1:PolicyBasedRouteIamPolicy":
                return PolicyBasedRouteIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:networkconnectivity/v1alpha1:Spoke":
                return Spoke(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:networkconnectivity/v1alpha1:SpokeIamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "networkconnectivity/v1alpha1", _module_instance)
