...
__all__ = ['InternalRangeIamPolicyArgs', 'InternalRangeIamPolicy']

@pulumi.input_type
class InternalRangeIamPolicyArgs:
    def __init__(__self__, *,
                 internal_ranges_id: pulumi.Input[str],
        ...
        """
        pulumi.set(__self__, "internal_ranges_id", internal_ranges_id)
    ...
    @property
    @pulumi.getter(name="internalRangesId")
    def internal_ranges_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "internal_ranges_id")

    @internal_ranges_id.setter
    def internal_ranges_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "internal_ranges_id", value)
...
class InternalRangeIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 etag: Optional[pulumi.Input[str]] = None,
                 internal_ranges_id: Optional[pulumi.Input[str]] = None,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: InternalRangeIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param InternalRangeIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InternalRangeIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InternalRangeIamPolicyArgs.__new__(InternalRangeIamPolicyArgs)

            __props__.__dict__["audit_configs"] = audit_configs
            __props__.__dict__["bindings"] = bindings
            __props__.__dict__["etag"] = etag
            if internal_ranges_id is None and not opts.urn:
                raise TypeError("Missing required property 'internal_ranges_id'")
            __props__.__dict__["internal_ranges_id"] = internal_ranges_id
        ...
        super(InternalRangeIamPolicy, __self__).__init__(
            'gcp-native:networkconnectivity/v1alpha1:InternalRangeIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InternalRangeIamPolicy':
        """
        Get an existing InternalRangeIamPolicy resource's state with the given name, id, and optional extra
        ...
        return InternalRangeIamPolicy(resource_name, opts=opts, __props__=__props__)
