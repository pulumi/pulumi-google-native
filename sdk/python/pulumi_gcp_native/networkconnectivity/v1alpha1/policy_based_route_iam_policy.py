...
class PolicyBasedRouteIamPolicyArgs:
    def __init__(__self__, *,
                 policy_based_routes_id: pulumi.Input[str],
        ...
        """
        pulumi.set(__self__, "policy_based_routes_id", policy_based_routes_id)
    ...
    @property
    @pulumi.getter(name="policyBasedRoutesId")
    def policy_based_routes_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "policy_based_routes_id")

    @policy_based_routes_id.setter
    def policy_based_routes_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "policy_based_routes_id", value)
...
class PolicyBasedRouteIamPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["policy_based_routes_id"] = policy_based_routes_id
        ...
        super(PolicyBasedRouteIamPolicy, __self__).__init__(
            'gcp-native:networkconnectivity/v1alpha1:PolicyBasedRouteIamPolicy',
            resource_name,
            __props__,
            opts)
