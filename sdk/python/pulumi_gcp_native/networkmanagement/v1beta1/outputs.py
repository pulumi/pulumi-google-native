...
class LatencyDistributionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes measured latency distribution.
        :param Sequence['LatencyPercentileResponseArgs'] latency_percentiles: Representative latency percentiles.
        """
...
class ProbingDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'EndpointInfoResponseArgs' endpoint_info: The source and destination endpoints derived from the test input and used for active probing.
        :param 'StatusResponseArgs' error: Details about an internal failure or the cancellation of active probing.
        :param 'LatencyDistributionResponseArgs' probing_latency: Latency as measured by active probing in one direction: from the source to the destination endpoint.
...
class StepResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CloudSQLInstanceInfoResponseArgs' cloud_sql_instance: Display info of a Cloud SQL instance.
        ...
        :param 'GKEMasterInfoResponseArgs' gke_master: Display info of a Google Kubernetes Engine cluster master.
