...
class SchemaIamPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(SchemaIamPolicy, __self__).__init__(
            'gcp-native:pubsub/v1:SchemaIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SchemaIamPolicy':
        """
        ...
        return SchemaIamPolicy(resource_name, opts=opts, __props__=__props__)
