...
class AutomaticResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AutomaticResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AutomaticResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 customer_managed_encryption: 'outputs.CustomerManagedEncryptionResponse'):
        """
        A replication policy that replicates the Secret payload without any restrictions.
        :param 'CustomerManagedEncryptionResponseArgs' customer_managed_encryption: Optional. The customer-managed encryption configuration of the Secret. If no configuration is provided, Google-managed default encryption is used. Updates to the Secret encryption configuration only apply to SecretVersions added afterwards. They do not apply retroactively to existing SecretVersions.
        """
...
@pulumi.output_type
class CustomerManagedEncryptionResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CustomerManagedEncryptionResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CustomerManagedEncryptionResponse.__key_warning(key)
        return super().__getitem__(key)
...
class ReplicationResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ReplicationResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ReplicationResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 automatic: 'outputs.AutomaticResponse',
                 user_managed: 'outputs.UserManagedResponse'):
        """
        A policy that defines the replication and encryption configuration of data.
        :param 'AutomaticResponseArgs' automatic: The Secret will automatically be replicated without any restrictions.
        :param 'UserManagedResponseArgs' user_managed: The Secret will only be replicated into the locations specified.
        """
    ...
    @property
    @pulumi.getter
    def automatic(self) -> 'outputs.AutomaticResponse':
        """
    ...
    def user_managed(self) -> 'outputs.UserManagedResponse':
        """
...
class RotationResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RotationResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RotationResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        The rotation time and period for a Secret. At next_rotation_time, Secret Manager will send a Pub/Sub notification to the topics configured on the Secret. Secret.topics must be set to configure rotation.
        :param str next_rotation_time: Optional. Timestamp in UTC at which the Secret is scheduled to rotate. next_rotation_time MUST be set if rotation_period is set.
        :param str rotation_period: Input only. The Duration between rotation notifications. Must be in seconds and at least 3600s (1h) and at most 3153600000s (100 years). If rotation_period is set, next_rotation_time must be set. next_rotation_time will be advanced by this period when the service automatically sends rotation notifications.
        """
...
@pulumi.output_type
class UserManagedResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        A replication policy that replicates the Secret payload into the locations specified in Secret.replication.user_managed.replicas
        :param Sequence['ReplicaResponseArgs'] replicas: Required. The list of Replicas for this Secret. Cannot be empty.
        """
