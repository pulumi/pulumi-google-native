...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:securitycenter/v1:OrganizationNotificationConfig":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "securitycenter/v1", _module_instance)
