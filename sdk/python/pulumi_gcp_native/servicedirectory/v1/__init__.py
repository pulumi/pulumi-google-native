...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:servicedirectory/v1:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:servicedirectory/v1:NamespaceIamPolicy":
                return NamespaceIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:servicedirectory/v1:NamespaceService":
                return NamespaceService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:servicedirectory/v1:NamespaceServiceEndpoint":
                return NamespaceServiceEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:servicedirectory/v1:NamespaceServiceIamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "servicedirectory/v1", _module_instance)
