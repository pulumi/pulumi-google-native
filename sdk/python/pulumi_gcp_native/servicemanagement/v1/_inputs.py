...
class DocumentationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] summary: A short summary of what the service does. Can only be provided by plain text.
        """
...
class EndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] aliases: DEPRECATED: This field is no longer supported. Instead of using aliases, please specify multiple google.api.Endpoint for each of the intended aliases. Additional names that this endpoint will be hosted on.
...
class PageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] content: The Markdown content of the page. You can use (== include {path} ==) to include content from a Markdown file.
