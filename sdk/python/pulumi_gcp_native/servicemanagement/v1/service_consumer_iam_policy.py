...
__all__ = ['ServiceConsumerIamPolicyArgs', 'ServiceConsumerIamPolicy']

@pulumi.input_type
class ServiceConsumerIamPolicyArgs:
    def __init__(__self__, *,
                 consumers_id: pulumi.Input[str],
        ...
        """
        pulumi.set(__self__, "consumers_id", consumers_id)
    ...
    @property
    @pulumi.getter(name="consumersId")
    def consumers_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "consumers_id")

    @consumers_id.setter
    def consumers_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "consumers_id", value)
...
class ServiceConsumerIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 consumers_id: Optional[pulumi.Input[str]] = None,
                 etag: Optional[pulumi.Input[str]] = None,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceConsumerIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param ServiceConsumerIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceConsumerIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceConsumerIamPolicyArgs.__new__(ServiceConsumerIamPolicyArgs)

            __props__.__dict__["audit_configs"] = audit_configs
            __props__.__dict__["bindings"] = bindings
            if consumers_id is None and not opts.urn:
                raise TypeError("Missing required property 'consumers_id'")
            __props__.__dict__["consumers_id"] = consumers_id
        ...
        super(ServiceConsumerIamPolicy, __self__).__init__(
            'gcp-native:servicemanagement/v1:ServiceConsumerIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServiceConsumerIamPolicy':
        """
        ...
        return ServiceConsumerIamPolicy(resource_name, opts=opts, __props__=__props__)
