...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:serviceusage/v1beta1:ServiceConsumerQuotaMetricLimitAdminOverride":
                return ServiceConsumerQuotaMetricLimitAdminOverride(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:serviceusage/v1beta1:ServiceConsumerQuotaMetricLimitConsumerOverride":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "serviceusage/v1beta1", _module_instance)
