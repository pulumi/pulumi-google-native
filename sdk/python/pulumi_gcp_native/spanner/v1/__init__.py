...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:spanner/v1:Instance":
                return Instance(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:spanner/v1:InstanceBackup":
                return InstanceBackup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:spanner/v1:InstanceBackupIamPolicy":
                return InstanceBackupIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:spanner/v1:InstanceDatabase":
                return InstanceDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:spanner/v1:InstanceDatabaseIamPolicy":
                return InstanceDatabaseIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:spanner/v1:InstanceDatabaseSession":
                return InstanceDatabaseSession(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:spanner/v1:InstanceIamPolicy":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "spanner/v1", _module_instance)
