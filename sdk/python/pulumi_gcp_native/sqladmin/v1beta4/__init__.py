...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "gcp-native:sqladmin/v1beta4:BackupRun":
                return BackupRun(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:sqladmin/v1beta4:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "gcp-native:sqladmin/v1beta4:Instance":
    ...
    pulumi.runtime.register_resource_module("gcp-native", "sqladmin/v1beta4", _module_instance)
