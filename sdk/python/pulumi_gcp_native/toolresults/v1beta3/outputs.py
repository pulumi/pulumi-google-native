...
class AndroidTestResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An Android mobile test specification.
        :param 'AndroidAppInfoResponseArgs' android_app_info: Information about the application under test.
        ...
        :param 'AndroidTestLoopResponseArgs' android_test_loop: An Android test loop.
        :param 'DurationResponseArgs' test_timeout: Max time a test is allowed to run before it is automatically cancelled.
        """
...
class IndividualOutcomeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DurationResponseArgs' run_duration: How long it took for this step to run.
        """
...
class IosTestResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A iOS mobile test specification
        :param 'IosAppInfoResponseArgs' ios_app_info: Information about the application under test.
        :param 'IosRoboTestResponseArgs' ios_robo_test: An iOS Robo test.
        :param 'IosTestLoopResponseArgs' ios_test_loop: An iOS test loop.
        :param 'IosXcTestResponseArgs' ios_xc_test: An iOS XCTest.
        :param 'DurationResponseArgs' test_timeout: Max time a test is allowed to run before it is automatically cancelled.
        """
...
class MultiStepResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Details when multiple steps are run with the same configuration as a group.
        :param int multistep_number: Unique int given to each step. Ranges from 0(inclusive) to total number of steps(exclusive). The primary step is 0.
        :param 'PrimaryStepResponseArgs' primary_step: Present if it is a primary (original) step.
...
class OutcomeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Interprets a result so that humans and machines can act on it.
        :param 'FailureDetailResponseArgs' failure_detail: More information about a FAILURE outcome. Returns INVALID_ARGUMENT if this field is set but the summary is not FAILURE. Optional
        :param 'InconclusiveDetailResponseArgs' inconclusive_detail: More information about an INCONCLUSIVE outcome. Returns INVALID_ARGUMENT if this field is set but the summary is not INCONCLUSIVE. Optional
        :param 'SkippedDetailResponseArgs' skipped_detail: More information about a SKIPPED outcome. Returns INVALID_ARGUMENT if this field is set but the summary is not SKIPPED. Optional
        :param 'SuccessDetailResponseArgs' success_detail: More information about a SUCCESS outcome. Returns INVALID_ARGUMENT if this field is set but the summary is not SUCCESS. Optional
...
class PrimaryStepResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Stores rollup test status of multiple steps that were run as a group and outcome of each individual step.
        :param Sequence['IndividualOutcomeResponseArgs'] individual_outcome: Step Id and outcome of each individual step.
...
class SpecificationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The details about how to run the execution.
        :param 'AndroidTestResponseArgs' android_test: An Android mobile test execution specification.
        :param 'IosTestResponseArgs' ios_test: An iOS mobile test execution specification.
        """
...
class TestExecutionStepResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A step that represents running tests. It accepts ant-junit xml files which will be parsed into structured test results by the service. Xml file paths are updated in order to append more files, however they can't be deleted. Users can also add test results manually by using the test_result field.
        :param Sequence['TestIssueResponseArgs'] test_issues: Issues observed during the test execution. For example, if the mobile app under test crashed during the test, the error message and the stack trace content can be recorded here to assist debugging. - In response: present if set by create or update - In create/update request: optional
        :param Sequence['TestSuiteOverviewResponseArgs'] test_suite_overviews: List of test suite overview contents. This could be parsed from xUnit XML log by server, or uploaded directly by user. This references should only be called when test suites are fully parsed or uploaded. The maximum allowed number of test suite overviews per step is 1000. - In response: always set - In create request: optional - In update request: never (use publishXunitXmlFiles custom method instead)
        :param 'TestTimingResponseArgs' test_timing: The timing break down of the test execution. - In response: present if set by create or update - In create/update request: optional
        :param 'ToolExecutionResponseArgs' tool_execution: Represents the execution of the test runner. The exit code of this tool will be used to determine if the test passed. - In response: always set - In create/update request: optional
        """
...
class TestIssueResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'StackTraceResponseArgs' stack_trace: Deprecated in favor of stack trace fields inside specific warnings.
        :param str type: Type of issue. Required.
        :param 'AnyResponseArgs' warning: Warning message with additional details of the issue. Should always be a message from com.google.devtools.toolresults.v1.warnings
        """
...
class TestSuiteOverviewResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A summary of a test suite result either parsed from XML or uploaded directly by a user. Note: the API related comments are for StepService only. This message is also being used in ExecutionService in a read only mode for the corresponding step.
        :param 'DurationResponseArgs' elapsed_time: Elapsed time of test suite.
...
class TestTimingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Testing timing break down to know phases.
        :param 'DurationResponseArgs' test_process_duration: How long it took to run the test process. - In response: present if previously set. - In create/update request: optional
        """
...
class ToolExecutionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ToolExitCodeResponseArgs' exit_code: Tool execution exit code. This field will be set once the tool has exited. - In response: present if set by create/update request - In create request: optional - In update request: optional, a FAILED_PRECONDITION error will be returned if an exit_code is already set.
        :param Sequence['FileReferenceResponseArgs'] tool_logs: References to any plain text logs output the tool execution. This field can be set before the tool has exited in order to be able to have access to a live view of the logs while the tool is running. The maximum allowed number of tool logs per step is 1000. - In response: present if set by create/update request - In create request: optional - In update request: optional, any value provided will be appended to the existing list
        :param Sequence['ToolOutputReferenceResponseArgs'] tool_outputs: References to opaque files of any format output by the tool execution. The maximum allowed number of tool outputs per step is 1000. - In response: present if set by create/update request - In create request: optional - In update request: optional, any value provided will be appended to the existing list
        """
...
class ToolExecutionStepResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Generic tool step to be used for binaries we do not explicitly support. For example: running cp to copy artifacts from one location to another.
        :param 'ToolExecutionResponseArgs' tool_execution: A Tool execution. - In response: present if set by create/update request - In create/update request: optional
        """
        pulumi.set(__self__, "tool_execution", tool_execution)
...
class ToolOutputReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A reference to a ToolExecution output file.
        :param 'TimestampResponseArgs' creation_time: The creation time of the file. - In response: present if set by create/update request - In create/update request: optional
        :param 'FileReferenceResponseArgs' output: A FileReference to an output file. - In response: always set - In create/update request: always set
        :param 'TestCaseReferenceResponseArgs' test_case: The test case to which this output file belongs. - In response: present if set by create/update request - In create/update request: optional
        """
