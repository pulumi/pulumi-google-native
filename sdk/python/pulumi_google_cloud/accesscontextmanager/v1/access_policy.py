...
class AccessPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] etag: Output only. An opaque identifier for the current version of the `AccessPolicy`. This will always be a strongly validated etag, meaning that two Access Polices will be identical if and only if their etags are identical. Clients should not expect this to be in any specific format.
        ...
        super(AccessPolicy, __self__).__init__(
            'google-cloud:accesscontextmanager/v1:AccessPolicy',
            resource_name,
            __props__,
            opts)
