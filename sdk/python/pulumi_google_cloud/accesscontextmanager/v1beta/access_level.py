...
class AccessLevel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. Resource name for the access policy which owns this Access Level. Format: `accessPolicies/{policy_id}`
        ...
        super(AccessLevel, __self__).__init__(
            'google-cloud:accesscontextmanager/v1beta:AccessLevel',
            resource_name,
            __props__,
            opts)
