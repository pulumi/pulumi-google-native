...
__all__ = ['ApigatewayPolicy']


class ApigatewayPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(ApigatewayPolicy, __self__).__init__(
            'google-cloud:apigateway/v1beta:ApigatewayPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ApigatewayPolicy':
        """
        ...
        return ApigatewayPolicy(resource_name, opts=opts, __props__=__props__)
