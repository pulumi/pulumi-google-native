...
__all__ = ['GoogleCloudApigeeV1ApiProduct']


class GoogleCloudApigeeV1ApiProduct(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. Name of the organization in which the API product will be created. Use the following structure in your request: `organizations/{org}`
        ...
        if opts.id is None:
            ...
            __props__['api_resources'] = api_resources
            __props__['approval_type'] = approval_type
            ...
            __props__['quota_interval'] = quota_interval
            __props__['quota_time_unit'] = quota_time_unit
            __props__['scopes'] = scopes
        super(GoogleCloudApigeeV1ApiProduct, __self__).__init__(
            'google-cloud:apigee/v1:GoogleCloudApigeeV1ApiProduct',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudApigeeV1ApiProduct':
        """
        ...
        return GoogleCloudApigeeV1ApiProduct(resource_name, opts=opts, __props__=__props__)
