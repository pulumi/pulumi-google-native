...
__all__ = ['GoogleCloudApigeeV1AsyncQuery']


class GoogleCloudApigeeV1AsyncQuery(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudApigeeV1AsyncQuery, __self__).__init__(
            'google-cloud:apigee/v1:GoogleCloudApigeeV1AsyncQuery',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudApigeeV1AsyncQuery':
        """
        ...
        return GoogleCloudApigeeV1AsyncQuery(resource_name, opts=opts, __props__=__props__)
