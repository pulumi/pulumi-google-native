...
__all__ = ['GoogleCloudApigeeV1DebugSession']


class GoogleCloudApigeeV1DebugSession(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The resource name of the API Proxy revision deployment for which to create the DebugSession. Must be of the form `organizations/{organization}/environments/{environment}/apis/{api}/revisions/{revision}`.
        ...
        super(GoogleCloudApigeeV1DebugSession, __self__).__init__(
            'google-cloud:apigee/v1:GoogleCloudApigeeV1DebugSession',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudApigeeV1DebugSession':
        """
        ...
        return GoogleCloudApigeeV1DebugSession(resource_name, opts=opts, __props__=__props__)
