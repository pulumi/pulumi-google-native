...
__all__ = ['GoogleCloudApigeeV1Developer']


class GoogleCloudApigeeV1Developer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. Name of the Apigee organization in which the developer is created. Use the following structure in your request: `organizations/{org}`.
        ...
        super(GoogleCloudApigeeV1Developer, __self__).__init__(
            'google-cloud:apigee/v1:GoogleCloudApigeeV1Developer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudApigeeV1Developer':
        """
        ...
        return GoogleCloudApigeeV1Developer(resource_name, opts=opts, __props__=__props__)
