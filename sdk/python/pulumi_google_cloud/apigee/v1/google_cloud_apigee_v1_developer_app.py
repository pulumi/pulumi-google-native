...
__all__ = ['GoogleCloudApigeeV1DeveloperApp']


class GoogleCloudApigeeV1DeveloperApp(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. Name of the developer. Use the following structure in your request: `organizations/{org}/developers/{developer_email}`
        ...
        super(GoogleCloudApigeeV1DeveloperApp, __self__).__init__(
            'google-cloud:apigee/v1:GoogleCloudApigeeV1DeveloperApp',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudApigeeV1DeveloperApp':
        """
        ...
        return GoogleCloudApigeeV1DeveloperApp(resource_name, opts=opts, __props__=__props__)
