...
__all__ = ['GoogleCloudApigeeV1DeveloperAppKey']


class GoogleCloudApigeeV1DeveloperAppKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudApigeeV1DeveloperAppKey, __self__).__init__(
            'google-cloud:apigee/v1:GoogleCloudApigeeV1DeveloperAppKey',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudApigeeV1DeveloperAppKey':
        """
        ...
        return GoogleCloudApigeeV1DeveloperAppKey(resource_name, opts=opts, __props__=__props__)
