...
__all__ = ['GoogleCloudApigeeV1TargetServer']


class GoogleCloudApigeeV1TargetServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The parent environment name under which the TargetServer will be created. Must be of the form `organizations/{org}/environments/{env}`.
        ...
        super(GoogleCloudApigeeV1TargetServer, __self__).__init__(
            'google-cloud:apigee/v1:GoogleCloudApigeeV1TargetServer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudApigeeV1TargetServer':
        """
        ...
        return GoogleCloudApigeeV1TargetServer(resource_name, opts=opts, __props__=__props__)
