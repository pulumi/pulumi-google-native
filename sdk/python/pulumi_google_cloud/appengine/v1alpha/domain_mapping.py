...
class DomainMapping(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] apps_id: Part of `parent`. Name of the parent Application resource. Example: apps/myapp.
        ...
        if opts.id is None:
            ...
            __props__['id'] = id
            __props__['name'] = name
            __props__['no_managed_certificate'] = no_managed_certificate
        ...
        super(DomainMapping, __self__).__init__(
            'google-cloud:appengine/v1alpha:DomainMapping',
            resource_name,
            __props__,
            opts)
