...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] apps_id: Part of `parent`. Name of the parent Firewall collection in which to create a new rule. Example: apps/myapp/firewall/ingressRules.
        ...
        super(FirewallRule, __self__).__init__(
            'google-cloud:appengine/v1beta:FirewallRule',
            resource_name,
            __props__,
            opts)
