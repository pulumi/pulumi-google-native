...
class ArgumentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'StandardSqlDataTypeResponseArgs' data_type: Required unless argument_kind = ANY_TYPE.
...
class BigtableColumnFamilyResponse(dict):
    def __init__(__self__, *,
                 ...
                 type: str):
        """
        :param Sequence['BigtableColumnResponseArgs'] columns: [Optional] Lists of columns that should be exposed as individual fields as opposed to a list of (column name, value) pairs. All columns whose qualifier matches a qualifier in this list can be accessed as .. Other columns can be accessed as a list through .Column field.
...
class ExplainQueryStageResponse(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['ExplainQueryStepResponseArgs'] steps: List of operations within the stage in dependency order (approximately chronological).
...
class ExternalDataConfigurationResponse(dict):
    def __init__(__self__, *,
        ...
        :param 'BigtableOptionsResponseArgs' bigtable_options: [Optional] Additional options if sourceFormat is set to BIGTABLE.
        ...
        :param 'CsvOptionsResponseArgs' csv_options: Additional properties to set if sourceFormat is set to CSV.
        :param 'GoogleSheetsOptionsResponseArgs' google_sheets_options: [Optional] Additional options if sourceFormat is set to GOOGLE_SHEETS.
        :param 'HivePartitioningOptionsResponseArgs' hive_partitioning_options: [Optional] Options to configure hive partitioning support.
        ...
        :param 'ParquetOptionsResponseArgs' parquet_options: Additional properties to set if sourceFormat is set to Parquet.
        :param 'TableSchemaResponseArgs' schema: [Optional] The schema for the data. Schema is required for CSV and JSON formats. Schema is disallowed for Google Cloud Bigtable, Cloud Datastore backups, and Avro formats.
...
class JobConfigurationExtractResponse(dict):
    def __init__(__self__, *,
        ...
        :param 'ModelReferenceResponseArgs' source_model: A reference to the model being exported.
        :param 'TableReferenceResponseArgs' source_table: A reference to the table being exported.
...
class JobConfigurationLoadResponse(dict):
    def __init__(__self__, *,
        ...
        :param 'ClusteringResponseArgs' clustering: [Beta] Clustering specification for the destination table. Must be specified with time-based partitioning, data in the table will be first partitioned and subsequently clustered.
        ...
        :param 'EncryptionConfigurationResponseArgs' destination_encryption_configuration: Custom encryption configuration (e.g., Cloud KMS keys).
        :param 'TableReferenceResponseArgs' destination_table: [Required] The destination table to load the data into.
        :param 'DestinationTablePropertiesResponseArgs' destination_table_properties: [Beta] [Optional] Properties with which to create the destination table if it is new.
        :param str encoding: [Optional] The character encoding of the data. The supported values are UTF-8 or ISO-8859-1. The default value is UTF-8. BigQuery decodes the data after the raw, binary data has been split using the values of the quote and fieldDelimiter properties.
        ...
        :param 'ParquetOptionsResponseArgs' parquet_options: [Optional] Options to configure parquet support.
        ...
        :param str quote: [Optional] The value that is used to quote data sections in a CSV file. BigQuery converts the string to ISO-8859-1 encoding, and then uses the first byte of the encoded string to split the data in its raw, binary state. The default value is a double-quote ('"'). If your data does not contain quoted sections, set the property value to an empty string. If your data contains quoted newline characters, you must also set the allowQuotedNewlines property to true.
        :param 'RangePartitioningResponseArgs' range_partitioning: [TrustedTester] Range partitioning specification for this table. Only one of timePartitioning and rangePartitioning should be specified.
        :param 'TableSchemaResponseArgs' schema: [Optional] The schema for the destination table. The schema can be omitted if the destination table already exists, or if you're loading data from Google Cloud Datastore.
        ...
        :param Sequence[str] source_uris: [Required] The fully-qualified URIs that point to your data in Google Cloud. For Google Cloud Storage URIs: Each URI can contain one '*' wildcard character and it must come after the 'bucket' name. Size limits related to load jobs apply to external data sources. For Google Cloud Bigtable URIs: Exactly one URI can be specified and it has be a fully specified and valid HTTPS URL for a Google Cloud Bigtable table. For Google Cloud Datastore backups: Exactly one URI can be specified. Also, the '*' wildcard character is not allowed.
        :param 'TimePartitioningResponseArgs' time_partitioning: Time-based partitioning specification for the destination table. Only one of timePartitioning and rangePartitioning should be specified.
...
class JobConfigurationQueryResponse(dict):
    def __init__(__self__, *,
        ...
        :param 'ClusteringResponseArgs' clustering: [Beta] Clustering specification for the destination table. Must be specified with time-based partitioning, data in the table will be first partitioned and subsequently clustered.
        :param Sequence['ConnectionPropertyResponseArgs'] connection_properties: Connection properties.
        :param str create_disposition: [Optional] Specifies whether the job is allowed to create new tables. The following values are supported: CREATE_IF_NEEDED: If the table does not exist, BigQuery creates the table. CREATE_NEVER: The table must already exist. If it does not, a 'notFound' error is returned in the job result. The default value is CREATE_IF_NEEDED. Creation, truncation and append actions occur as one atomic update upon job completion.
        ...
        :param 'DatasetReferenceResponseArgs' default_dataset: [Optional] Specifies the default dataset to use for unqualified table names in the query. Note that this does not alter behavior of unqualified dataset names.
        :param 'EncryptionConfigurationResponseArgs' destination_encryption_configuration: Custom encryption configuration (e.g., Cloud KMS keys).
        :param 'TableReferenceResponseArgs' destination_table: [Optional] Describes the table where the query results should be stored. If not present, a new table will be created to store the results. This property must be set for large results that exceed the maximum response size.
        ...
        :param Sequence['QueryParameterResponseArgs'] query_parameters: Query parameters for standard SQL queries.
        :param 'RangePartitioningResponseArgs' range_partitioning: [TrustedTester] Range partitioning specification for this table. Only one of timePartitioning and rangePartitioning should be specified.
        ...
        :param Sequence['UserDefinedFunctionResourceResponseArgs'] user_defined_function_resources: Describes user-defined function resources used in the query.
...
class JobConfigurationResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param 'JobConfigurationTableCopyResponseArgs' copy: [Pick one] Copies a table.
        ...
        :param 'JobConfigurationExtractResponseArgs' extract: [Pick one] Configures an extract job.
        ...
        :param 'JobConfigurationLoadResponseArgs' load: [Pick one] Configures a load job.
        :param 'JobConfigurationQueryResponseArgs' query: [Pick one] Configures a query job.
        """
...
class JobConfigurationTableCopyResponse(dict):
    def __init__(__self__, *,
        ...
        :param 'TableReferenceResponseArgs' destination_table: [Required] The destination table
        :param str operation_type: [Optional] Supported operation types in table copy job.
        :param 'TableReferenceResponseArgs' source_table: [Pick one] Source table to copy.
        :param Sequence['TableReferenceResponseArgs'] source_tables: [Pick one] Source tables to copy.
        :param str write_disposition: [Optional] Specifies the action that occurs if the destination table already exists. The following values are supported: WRITE_TRUNCATE: If the table already exists, BigQuery overwrites the table data. WRITE_APPEND: If the table already exists, BigQuery appends the data to the table. WRITE_EMPTY: If the table already exists and contains data, a 'duplicate' error is returned in the job result. The default value is WRITE_EMPTY. Each action is atomic and only occurs if BigQuery is able to complete the job successfully. Creation, truncation and append actions occur as one atomic update upon job completion.
        """
        pulumi.set(__self__, "create_disposition", create_disposition)
        pulumi.set(__self__, "destination_encryption_configuration", destination_encryption_configuration)
...
class JobStatistics2Response(dict):
    def __init__(__self__, *,
                 ...
                 reservation_usage: Sequence[Mapping[str, str]],
                 schema: 'outputs.TableSchemaResponse',
                 statement_type: str,
        ...
        :param 'DatasetReferenceResponseArgs' ddl_target_dataset: [Output-only] The DDL target dataset. Present only for CREATE/ALTER/DROP SCHEMA queries.
        :param 'RoutineReferenceResponseArgs' ddl_target_routine: The DDL target routine. Present only for CREATE/DROP FUNCTION/PROCEDURE queries.
        :param 'RowAccessPolicyReferenceResponseArgs' ddl_target_row_access_policy: [Output-only] [Preview] The DDL target row access policy. Present only for CREATE/DROP ROW ACCESS POLICY queries.
        :param 'TableReferenceResponseArgs' ddl_target_table: [Output-only] The DDL target table. Present only for CREATE/DROP TABLE/VIEW and DROP ALL ROW ACCESS POLICIES queries.
        :param str estimated_bytes_processed: [Output-only] The original estimate of bytes processed for the job.
        :param 'BigQueryModelTrainingResponseArgs' model_training: [Output-only, Beta] Information about create model query job progress.
        ...
        :param Sequence['ExplainQueryStageResponseArgs'] query_plan: [Output-only] Describes execution plan for the query.
        :param Sequence['RoutineReferenceResponseArgs'] referenced_routines: [Output-only] Referenced routines (persistent user-defined functions and stored procedures) for the job.
        :param Sequence['TableReferenceResponseArgs'] referenced_tables: [Output-only] Referenced tables for the job. Queries that reference more than 50 tables will not have a complete list.
        :param Sequence[Mapping[str, str]] reservation_usage: [Output-only] Job resource usage breakdown by reservation.
        :param 'TableSchemaResponseArgs' schema: [Output-only] The schema of the results. Present only for successful dry run of non-legacy SQL queries.
        ...
        :param Sequence['QueryTimelineSampleResponseArgs'] timeline: [Output-only] [Beta] Describes a timeline of job execution.
        ...
        :param Sequence['QueryParameterResponseArgs'] undeclared_query_parameters: Standard SQL only: list of undeclared query parameters detected during a dry run validation.
        """
    ...
    def reservation_usage(self) -> Sequence[Mapping[str, str]]:
        """
...
class JobStatisticsResponse(dict):
    def __init__(__self__, *,
        ...
        :param 'JobStatistics4ResponseArgs' extract: [Output-only] Statistics for an extract job.
        :param 'JobStatistics3ResponseArgs' load: [Output-only] Statistics for a load job.
        ...
        :param 'JobStatistics2ResponseArgs' query: [Output-only] Statistics for a query job.
        ...
        :param 'RowLevelSecurityStatisticsResponseArgs' row_level_security_statistics: [Output-only] [Preview] Statistics for row-level security. Present only for query and extract jobs.
        :param 'ScriptStatisticsResponseArgs' script_statistics: [Output-only] Statistics for a child job of a script.
        :param 'SessionInfoResponseArgs' session_info_template: [Output-only] [Preview] Information of the session if this job is part of one.
        ...
        :param str total_slot_ms: [Output-only] Slot-milliseconds for the job.
        :param 'TransactionInfoResponseArgs' transaction_info_template: [Output-only] [Alpha] Information of the multi-statement transaction if this job is part of one.
        """
...
class JobStatusResponse(dict):
    def __init__(__self__, *,
                 ...
                 state: str):
        """
        :param 'ErrorProtoResponseArgs' error_result: [Output-only] Final error result of the job. If present, indicates that the job has completed and was unsuccessful.
        :param Sequence['ErrorProtoResponseArgs'] errors: [Output-only] The first errors encountered during the running of the job. The final message includes the number of errors that caused the process to stop. Errors here do not necessarily mean that the job has completed or was unsuccessful.
...
class QueryParameterResponse(dict):
    def __init__(__self__, *,
        ...
        :param 'QueryParameterTypeResponseArgs' parameter_type: [Required] The type of this parameter.
        :param 'QueryParameterValueResponseArgs' parameter_value: [Required] The value of this parameter.
        """
        pulumi.set(__self__, "name", name)
...
class QueryParameterTypeResponse(dict):
    def __init__(__self__, *,
                 ...
                 struct_types: Sequence[Mapping[str, str]],
                 type: str):
        """
        :param 'QueryParameterTypeResponseArgs' array_type: [Optional] The type of the array's elements, if this is an array.
        :param Sequence[Mapping[str, str]] struct_types: [Optional] The types of the fields of this struct, in order, if this is a struct.
    ...
    def struct_types(self) -> Sequence[Mapping[str, str]]:
        """
...
class QueryParameterValueResponse(dict):
    def __init__(__self__, *,
                 ...
                 value: str):
        """
        :param Sequence['QueryParameterValueResponseArgs'] array_values: [Optional] The array values, if this is an array type.
...
class RangePartitioningResponse(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, str] range: [TrustedTester] [Required] Defines the ranges for range partitioning.
        """
    ...
    @property
    @pulumi.getter
    def range(self) -> Mapping[str, str]:
        """
...
class ScriptStatisticsResponse(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['ScriptStackFrameResponseArgs'] stack_frames: Stack trace showing the line/column/procedure name of each frame on the stack at the point where the current evaluation happened. The leaf frame is first, the primary script is last. Never empty.
        """
...
class SnapshotDefinitionResponse(dict):
    def __init__(__self__, *,
                 ...
                 snapshot_time: str):
        """
        :param 'TableReferenceResponseArgs' base_table_reference: [Required] Reference describing the ID of the table that is snapshotted.
...
class StandardSqlDataTypeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The type of a variable, e.g., a function argument. Examples: INT64: {type_kind="INT64"} ARRAY: {type_kind="ARRAY", array_element_type="STRING"} STRUCT>: {type_kind="STRUCT", struct_type={fields=[ {name="x", type={type_kind="STRING"}}, {name="y", type={type_kind="ARRAY", array_element_type="DATE"}} ]}}
        :param 'StandardSqlDataTypeResponseArgs' array_element_type: The type of the array's elements, if type_kind = "ARRAY".
        :param 'StandardSqlStructTypeResponseArgs' struct_type: The fields of this struct, in order, if type_kind = "STRUCT".
...
class StandardSqlFieldResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'StandardSqlDataTypeResponseArgs' type: Optional. The type of this parameter. Absent if not explicitly specified (e.g., CREATE FUNCTION statement can omit the return type; in this case the output parameter does not have this "type" field).
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class StandardSqlTableTypeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A table type
        :param Sequence['StandardSqlFieldResponseArgs'] columns: The columns in this table type
        """
        pulumi.set(__self__, "columns", columns)
...
class TableSchemaResponse(dict):
    def __init__(__self__, *,
                 fields: Sequence['outputs.TableFieldSchemaResponse']):
        """
        :param Sequence['TableFieldSchemaResponseArgs'] fields: Describes the fields in a table.
        """
        pulumi.set(__self__, "fields", fields)
