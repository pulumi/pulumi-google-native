...
class TransferConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        __props__["data_refresh_window_days"] = None
        __props__["data_source_id"] = None
        __props__["dataset_region"] = None
        __props__["destination_dataset_id"] = None
        __props__["disabled"] = None
        __props__["display_name"] = None
        __props__["email_preferences"] = None
        __props__["name"] = None
        __props__["next_run_time"] = None
        __props__["notification_pubsub_topic"] = None
        __props__["params"] = None
        __props__["schedule"] = None
        __props__["schedule_options"] = None
        __props__["state"] = None
        __props__["update_time"] = None
