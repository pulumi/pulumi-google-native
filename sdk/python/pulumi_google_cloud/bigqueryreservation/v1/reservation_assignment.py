...
class ReservationAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['assignee'] = assignee
            if assignments_id is None and not opts.urn:
                raise TypeError("Missing required property 'assignments_id'")
            __props__['assignments_id'] = assignments_id
        ...
        super(ReservationAssignment, __self__).__init__(
            'google-cloud:bigqueryreservation/v1:ReservationAssignment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ReservationAssignment':
        """
