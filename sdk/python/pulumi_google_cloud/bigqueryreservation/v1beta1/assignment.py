...
class Assignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The parent resource name of the assignment E.g. `projects/myproject/locations/US/reservations/team1-prod`
        ...
        super(Assignment, __self__).__init__(
            'google-cloud:bigqueryreservation/v1beta1:Assignment',
            resource_name,
            __props__,
            opts)
