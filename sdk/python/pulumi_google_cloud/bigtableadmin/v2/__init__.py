...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "google-cloud:bigtableadmin/v2:Instance":
                return Instance(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:bigtableadmin/v2:InstanceAppProfile":
                return InstanceAppProfile(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:bigtableadmin/v2:InstanceCluster":
                return InstanceCluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:bigtableadmin/v2:InstanceClusterBackup":
                return InstanceClusterBackup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:bigtableadmin/v2:InstanceClusterBackupIamPolicy":
                return InstanceClusterBackupIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:bigtableadmin/v2:InstanceIamPolicy":
                return InstanceIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:bigtableadmin/v2:InstanceTable":
                return InstanceTable(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:bigtableadmin/v2:InstanceTableIamPolicy":
    ...
    pulumi.runtime.register_resource_module("google-cloud", "bigtableadmin/v2", _module_instance)
