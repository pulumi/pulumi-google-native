...
class AppProfile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The unique name of the instance in which to create the new app profile. Values are of the form `projects/{project}/instances/{instance}`.
        ...
        super(AppProfile, __self__).__init__(
            'google-cloud:bigtableadmin/v2:AppProfile',
            resource_name,
            __props__,
            opts)
