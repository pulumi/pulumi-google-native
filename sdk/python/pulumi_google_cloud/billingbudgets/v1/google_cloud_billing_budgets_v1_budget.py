...
__all__ = ['GoogleCloudBillingBudgetsV1Budget']


class GoogleCloudBillingBudgetsV1Budget(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudBillingBudgetsV1Budget, __self__).__init__(
            'google-cloud:billingbudgets/v1:GoogleCloudBillingBudgetsV1Budget',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudBillingBudgetsV1Budget':
        """
        ...
        return GoogleCloudBillingBudgetsV1Budget(resource_name, opts=opts, __props__=__props__)
