...
class BuildArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SecretArgs']]] secrets: Secrets to decrypt using Cloud Key Management Service.
...
class RepoSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] repo_name: Required. Name of the Cloud Source Repository.
