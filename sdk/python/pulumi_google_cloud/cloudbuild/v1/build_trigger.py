...
__all__ = ['BuildTrigger']


class BuildTrigger(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(BuildTrigger, __self__).__init__(
            'google-cloud:cloudbuild/v1:BuildTrigger',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BuildTrigger':
        """
        ...
        return BuildTrigger(resource_name, opts=opts, __props__=__props__)
