...
__all__ = ['GoogleCloudChannelV1Customer']


class GoogleCloudChannelV1Customer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The resource name of reseller account in which to create the customer. Parent uses the format: accounts/{account_id}
        ...
        super(GoogleCloudChannelV1Customer, __self__).__init__(
            'google-cloud:cloudchannel/v1:GoogleCloudChannelV1Customer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudChannelV1Customer':
        """
        ...
        return GoogleCloudChannelV1Customer(resource_name, opts=opts, __props__=__props__)
