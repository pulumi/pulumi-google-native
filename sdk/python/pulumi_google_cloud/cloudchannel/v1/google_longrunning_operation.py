...
class GoogleLongrunningOperation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The resource name of the reseller's customer account in which to create the entitlement. Parent uses the format: accounts/{account_id}/customers/{customer_id}
        ...
        super(GoogleLongrunningOperation, __self__).__init__(
            'google-cloud:cloudchannel/v1:GoogleLongrunningOperation',
            resource_name,
            __props__,
            opts)
