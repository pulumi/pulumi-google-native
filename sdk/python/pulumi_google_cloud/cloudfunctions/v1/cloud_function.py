...
__all__ = ['CloudFunction']


class CloudFunction(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] build_id: Output only. The Cloud Build ID of the latest successful deployment of the function.
        ...
        :param pulumi.Input[str] location: Required. The project and location in which the function should be created, specified in the format `projects/*/locations/*`
        ...
        :param pulumi.Input[str] status: Output only. Status of the function deployment.
        ...
        :param pulumi.Input[str] update_time: Output only. The last update timestamp of a Cloud Function.
        :param pulumi.Input[str] version_id: Output only. The version identifier of the Cloud Function. Each deployment attempt results in a new version of a function being created.
        ...
        if opts.id is None:
            ...
            __props__['build_worker_pool'] = build_worker_pool
            ...
            __props__['https_trigger'] = https_trigger
            ...
            __props__['source_archive_url'] = source_archive_url
            __props__['source_repository'] = source_repository
            __props__['source_token'] = source_token
            __props__['source_upload_url'] = source_upload_url
        ...
        super(CloudFunction, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CloudFunction':
        """
        ...
        return CloudFunction(resource_name, opts=opts, __props__=__props__)
