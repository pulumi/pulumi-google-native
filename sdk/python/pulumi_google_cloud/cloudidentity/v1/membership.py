...
class Membership(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The parent `Group` resource under which to create the `Membership`. Must be of the form `groups/{group_id}`.
        ...
        super(Membership, __self__).__init__(
            'google-cloud:cloudidentity/v1:Membership',
            resource_name,
            __props__,
            opts)
