...
class Device(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The name of the device registry where this device should be created. For example, `projects/example-project/locations/us-central1/registries/my-registry`.
        ...
        super(Device, __self__).__init__(
            'google-cloud:cloudiot/v1:Device',
            resource_name,
            __props__,
            opts)
