...
class DeviceRegistry(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The project and cloud region where this device registry must be created. For example, `projects/example-project/locations/us-central1`.
        ...
        super(DeviceRegistry, __self__).__init__(
            'google-cloud:cloudiot/v1:DeviceRegistry',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DeviceRegistry':
        """
        ...
        return DeviceRegistry(resource_name, opts=opts, __props__=__props__)
