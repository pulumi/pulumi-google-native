...
class TagValue(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] namespaced_name: Output only. Namespaced name of the TagValue. Must be in the format `{organization_id}/{tag_key_short_name}/{short_name}`.
