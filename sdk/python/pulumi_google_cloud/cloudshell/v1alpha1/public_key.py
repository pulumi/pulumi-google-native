...
class PublicKey(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 key: Optional[pulumi.Input[pulumi.InputType['PublicKeyArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PublicKeyArgs']] key: Key that should be added to the environment.
        :param pulumi.Input[str] parent: Parent resource name, e.g. `users/me/environments/default`.
        """
        ...
        super(PublicKey, __self__).__init__(
            'google-cloud:cloudshell/v1alpha1:PublicKey',
            resource_name,
            __props__,
            opts)
