...
class FirewallPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] display_name: User-provided name of the Organization firewall plicy. The name should be unique in the organization in which the firewall policy is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
        ...
        super(FirewallPolicy, __self__).__init__(
            'google-cloud:compute/alpha:FirewallPolicy',
            resource_name,
            __props__,
            opts)
