...
__all__ = ['InPlaceSnapshot']


class InPlaceSnapshot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['zone'] = zone
        super(InPlaceSnapshot, __self__).__init__(
            'google-cloud:compute/alpha:InPlaceSnapshot',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InPlaceSnapshot':
        """
        ...
        return InPlaceSnapshot(resource_name, opts=opts, __props__=__props__)
