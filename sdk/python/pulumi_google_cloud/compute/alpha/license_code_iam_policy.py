...
__all__ = ['LicenseCodeIamPolicy']


class LicenseCodeIamPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(LicenseCodeIamPolicy, __self__).__init__(
            'google-cloud:compute/alpha:LicenseCodeIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LicenseCodeIamPolicy':
        """
        Get an existing LicenseCodeIamPolicy resource's state with the given name, id, and optional extra
        ...
        __props__["rules"] = None
        __props__["version"] = None
        return LicenseCodeIamPolicy(resource_name, opts=opts, __props__=__props__)
