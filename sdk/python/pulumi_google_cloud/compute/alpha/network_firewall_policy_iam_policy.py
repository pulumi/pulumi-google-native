...
__all__ = ['NetworkFirewallPolicyIamPolicy']


class NetworkFirewallPolicyIamPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(NetworkFirewallPolicyIamPolicy, __self__).__init__(
            'google-cloud:compute/alpha:NetworkFirewallPolicyIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NetworkFirewallPolicyIamPolicy':
        """
        ...
        __props__["rules"] = None
        __props__["version"] = None
        return NetworkFirewallPolicyIamPolicy(resource_name, opts=opts, __props__=__props__)
