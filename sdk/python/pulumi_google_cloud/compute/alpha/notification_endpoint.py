...
__all__ = ['NotificationEndpoint']


class NotificationEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(NotificationEndpoint, __self__).__init__(
            'google-cloud:compute/alpha:NotificationEndpoint',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NotificationEndpoint':
        """
        ...
        return NotificationEndpoint(resource_name, opts=opts, __props__=__props__)
