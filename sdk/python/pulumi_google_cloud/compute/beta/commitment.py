...
class Commitment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
        super(Commitment, __self__).__init__(
            'google-cloud:compute/beta:Commitment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Commitment':
        """
        ...
        return Commitment(resource_name, opts=opts, __props__=__props__)
