...
__all__ = ['FirewallPolicyIamPolicy']


class FirewallPolicyIamPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(FirewallPolicyIamPolicy, __self__).__init__(
            'google-cloud:compute/beta:FirewallPolicyIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FirewallPolicyIamPolicy':
        """
        ...
        return FirewallPolicyIamPolicy(resource_name, opts=opts, __props__=__props__)
