...
class HealthCheckService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(HealthCheckService, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'HealthCheckService':
        """
        ...
        return HealthCheckService(resource_name, opts=opts, __props__=__props__)
