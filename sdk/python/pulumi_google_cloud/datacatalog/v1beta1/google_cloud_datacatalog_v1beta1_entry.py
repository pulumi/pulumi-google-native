...
__all__ = ['GoogleCloudDatacatalogV1beta1Entry']


class GoogleCloudDatacatalogV1beta1Entry(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 source_system_timestamps: Optional[pulumi.Input[pulumi.InputType['GoogleCloudDatacatalogV1beta1SystemTimestampsArgs']]] = None,
        ...
        :param pulumi.Input[str] integrated_system: Output only. This field indicates the entry's source system that Data Catalog integrates with, such as BigQuery or Pub/Sub.
        ...
        :param pulumi.Input[str] name: Output only. The Data Catalog resource name of the entry in URL format. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}/entries/{entry_id} Note that this Entry and its child resources may not actually be stored in the location in this name.
        :param pulumi.Input[str] parent: Required. The name of the entry group this entry is in. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id} Note that this Entry and its child resources may not actually be stored in the location in this name.
        ...
        if opts.id is None:
            ...
            __props__['source_system_timestamps'] = source_system_timestamps
            __props__['type'] = type
            __props__['user_specified_system'] = user_specified_system
            __props__['user_specified_type'] = user_specified_type
        super(GoogleCloudDatacatalogV1beta1Entry, __self__).__init__(
            'google-cloud:datacatalog/v1beta1:GoogleCloudDatacatalogV1beta1Entry',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDatacatalogV1beta1Entry':
        """
        ...
        return GoogleCloudDatacatalogV1beta1Entry(resource_name, opts=opts, __props__=__props__)
