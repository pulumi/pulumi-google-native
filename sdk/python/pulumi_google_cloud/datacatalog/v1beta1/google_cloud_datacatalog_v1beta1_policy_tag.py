...
__all__ = ['GoogleCloudDatacatalogV1beta1PolicyTag']


class GoogleCloudDatacatalogV1beta1PolicyTag(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. Resource name of the taxonomy that the policy tag will belong to.
        ...
        super(GoogleCloudDatacatalogV1beta1PolicyTag, __self__).__init__(
            'google-cloud:datacatalog/v1beta1:GoogleCloudDatacatalogV1beta1PolicyTag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDatacatalogV1beta1PolicyTag':
        """
        ...
        return GoogleCloudDatacatalogV1beta1PolicyTag(resource_name, opts=opts, __props__=__props__)
