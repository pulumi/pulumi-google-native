...
__all__ = ['GoogleCloudDatacatalogV1beta1Tag']


class GoogleCloudDatacatalogV1beta1Tag(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDatacatalogV1beta1Tag, __self__).__init__(
            'google-cloud:datacatalog/v1beta1:GoogleCloudDatacatalogV1beta1Tag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDatacatalogV1beta1Tag':
        """
        ...
        return GoogleCloudDatacatalogV1beta1Tag(resource_name, opts=opts, __props__=__props__)
