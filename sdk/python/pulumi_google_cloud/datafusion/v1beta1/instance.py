...
class Instance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] instance_id: The name of the instance to create.
        ...
        :param pulumi.Input[str] parent: The instance's project and location in the format projects/{project}/locations/{location}.
