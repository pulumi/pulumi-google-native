...
@pulumi.input_type
class GoogleCloudDatalabelingV1beta1AnnotationSpecSetArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudDatalabelingV1beta1DatasetArgs:
    def __init__(__self__, *,
                 blocking_resources: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
...
@pulumi.input_type
class GoogleCloudDatalabelingV1beta1EvaluationJobArgs:
    def __init__(__self__, *,
                 annotation_spec_set: Optional[pulumi.Input[str]] = None,
