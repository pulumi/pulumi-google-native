...
__all__ = ['ConnectionProfileIamPolicy']


class ConnectionProfileIamPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(ConnectionProfileIamPolicy, __self__).__init__(
            'google-cloud:datamigration/v1:ConnectionProfileIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ConnectionProfileIamPolicy':
        """
        ...
        return ConnectionProfileIamPolicy(resource_name, opts=opts, __props__=__props__)
