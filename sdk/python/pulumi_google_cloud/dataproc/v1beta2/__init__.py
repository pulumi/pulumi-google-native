...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "google-cloud:dataproc/v1beta2:AutoscalingPolicy":
                return AutoscalingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:AutoscalingPolicyIamPolicy":
                return AutoscalingPolicyIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:RegionAutoscalingPolicy":
                return RegionAutoscalingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:RegionAutoscalingPolicyIamPolicy":
                return RegionAutoscalingPolicyIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:RegionCluster":
                return RegionCluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:RegionClusterIamPolicy":
                return RegionClusterIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:RegionJobIamPolicy":
                return RegionJobIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:RegionOperationIamPolicy":
                return RegionOperationIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:RegionWorkflowTemplate":
                return RegionWorkflowTemplate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:RegionWorkflowTemplateIamPolicy":
                return RegionWorkflowTemplateIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:WorkflowTemplate":
                return WorkflowTemplate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dataproc/v1beta2:WorkflowTemplateIamPolicy":
    ...
    pulumi.runtime.register_resource_module("google-cloud", "dataproc/v1beta2", _module_instance)
