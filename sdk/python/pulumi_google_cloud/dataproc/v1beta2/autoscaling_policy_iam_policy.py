...
__all__ = ['AutoscalingPolicyIamPolicy']
...
class AutoscalingPolicyIamPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(AutoscalingPolicyIamPolicy, __self__).__init__(
            'google-cloud:dataproc/v1beta2:AutoscalingPolicyIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AutoscalingPolicyIamPolicy':
        """
