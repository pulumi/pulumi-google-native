...
class Deployment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] manifest: Output only. URL of the manifest representing the last manifest that was successfully deployed. If no manifest has been successfully deployed, this field will be absent.
        :param pulumi.Input[str] name: Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
        :param pulumi.Input[pulumi.InputType['OperationArgs']] operation: Output only. The Operation that most recently ran, or is currently running, on this deployment.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DeploymentOutputEntryArgs']]]] outputs: Output only. List of outputs from the last manifest that deployed successfully.
        ...
        :param pulumi.Input[pulumi.InputType['DeploymentUpdateArgs']] update: Output only. If Deployment Manager is currently updating or previewing an update to this deployment, the updated configuration appears here.
        :param pulumi.Input[str] update_time: Output only. Update timestamp in RFC3339 text format.
        """
        ...
        super(Deployment, __self__).__init__(
            'google-cloud:deploymentmanager/alpha:Deployment',
            resource_name,
            __props__,
            opts)
