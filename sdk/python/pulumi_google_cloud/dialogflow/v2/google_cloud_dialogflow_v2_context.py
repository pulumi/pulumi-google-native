...
__all__ = ['GoogleCloudDialogflowV2Context']


class GoogleCloudDialogflowV2Context(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The session to create a context for. Format: `projects//agent/sessions/` or `projects//agent/environments//users//sessions/`. If `Environment ID` is not specified, we assume default 'draft' environment. If `User ID` is not specified, we assume default '-' user.
        """
        ...
        super(GoogleCloudDialogflowV2Context, __self__).__init__(
            'google-cloud:dialogflow/v2:GoogleCloudDialogflowV2Context',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2Context':
        """
        ...
        return GoogleCloudDialogflowV2Context(resource_name, opts=opts, __props__=__props__)
