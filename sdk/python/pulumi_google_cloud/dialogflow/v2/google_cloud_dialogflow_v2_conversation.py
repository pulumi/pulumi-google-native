...
__all__ = ['GoogleCloudDialogflowV2Conversation']


class GoogleCloudDialogflowV2Conversation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowV2Conversation, __self__).__init__(
            'google-cloud:dialogflow/v2:GoogleCloudDialogflowV2Conversation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2Conversation':
        """
        ...
        return GoogleCloudDialogflowV2Conversation(resource_name, opts=opts, __props__=__props__)
