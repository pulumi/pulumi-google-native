...
__all__ = ['GoogleCloudDialogflowV2EntityType']


class GoogleCloudDialogflowV2EntityType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The agent to create a entity type for. Format: `projects//agent`.
        """
        ...
        super(GoogleCloudDialogflowV2EntityType, __self__).__init__(
            'google-cloud:dialogflow/v2:GoogleCloudDialogflowV2EntityType',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2EntityType':
        """
        ...
        return GoogleCloudDialogflowV2EntityType(resource_name, opts=opts, __props__=__props__)
