...
__all__ = ['GoogleCloudDialogflowV2Intent']


class GoogleCloudDialogflowV2Intent(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The agent to create a intent for. Format: `projects//agent`.
        ...
        super(GoogleCloudDialogflowV2Intent, __self__).__init__(
            'google-cloud:dialogflow/v2:GoogleCloudDialogflowV2Intent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2Intent':
        """
        Get an existing GoogleCloudDialogflowV2Intent resource's state with the given name, id, and optional extra
        ...
        return GoogleCloudDialogflowV2Intent(resource_name, opts=opts, __props__=__props__)
