...
__all__ = ['GoogleCloudDialogflowV2KnowledgeBase']


class GoogleCloudDialogflowV2KnowledgeBase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowV2KnowledgeBase, __self__).__init__(
            'google-cloud:dialogflow/v2:GoogleCloudDialogflowV2KnowledgeBase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2KnowledgeBase':
        """
        ...
        return GoogleCloudDialogflowV2KnowledgeBase(resource_name, opts=opts, __props__=__props__)
