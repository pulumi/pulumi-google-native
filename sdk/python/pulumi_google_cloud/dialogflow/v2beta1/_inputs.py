...
@pulumi.input_type
class GoogleCloudDialogflowV2beta1DocumentReloadStatusArgs:
    def __init__(__self__, *,
                 status: Optional[pulumi.Input['GoogleRpcStatusArgs']] = None,
                 time: Optional[pulumi.Input[str]] = None):
        """
        The status of a reload attempt.
        :param pulumi.Input['GoogleRpcStatusArgs'] status: Output only. The status of a reload attempt or the initial load.
        :param pulumi.Input[str] time: Output only. The time of a reload attempt. This reload may have been triggered automatically or manually and may not have succeeded.
        """
...
@pulumi.input_type
class GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoArgs:
    def __init__(__self__, *,
