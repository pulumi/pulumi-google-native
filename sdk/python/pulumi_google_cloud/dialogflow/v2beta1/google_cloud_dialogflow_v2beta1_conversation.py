...
__all__ = ['GoogleCloudDialogflowV2beta1Conversation']


class GoogleCloudDialogflowV2beta1Conversation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. Resource identifier of the project creating the conversation. Format: `projects//locations/`.
        ...
        if opts.id is None:
            ...
            __props__['conversation_id'] = conversation_id
        ...
        super(GoogleCloudDialogflowV2beta1Conversation, __self__).__init__(
            'google-cloud:dialogflow/v2beta1:GoogleCloudDialogflowV2beta1Conversation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2beta1Conversation':
        """
        ...
        return GoogleCloudDialogflowV2beta1Conversation(resource_name, opts=opts, __props__=__props__)
