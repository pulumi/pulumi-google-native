...
__all__ = ['GoogleCloudDialogflowV2beta1ConversationProfile']


class GoogleCloudDialogflowV2beta1ConversationProfile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowV2beta1ConversationProfile, __self__).__init__(
            'google-cloud:dialogflow/v2beta1:GoogleCloudDialogflowV2beta1ConversationProfile',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2beta1ConversationProfile':
        """
        ...
        return GoogleCloudDialogflowV2beta1ConversationProfile(resource_name, opts=opts, __props__=__props__)
