...
__all__ = ['GoogleCloudDialogflowV2beta1EntityType']


class GoogleCloudDialogflowV2beta1EntityType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The agent to create a entity type for. Supported formats: - `projects//agent` - `projects//locations//agent`
        """
        ...
        super(GoogleCloudDialogflowV2beta1EntityType, __self__).__init__(
            'google-cloud:dialogflow/v2beta1:GoogleCloudDialogflowV2beta1EntityType',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2beta1EntityType':
        """
        ...
        return GoogleCloudDialogflowV2beta1EntityType(resource_name, opts=opts, __props__=__props__)
