...
__all__ = ['GoogleCloudDialogflowV2beta1KnowledgeBase']


class GoogleCloudDialogflowV2beta1KnowledgeBase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The project to create a knowledge base for. Format: `projects//locations/`.
        """
        ...
        super(GoogleCloudDialogflowV2beta1KnowledgeBase, __self__).__init__(
            'google-cloud:dialogflow/v2beta1:GoogleCloudDialogflowV2beta1KnowledgeBase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowV2beta1KnowledgeBase':
        """
        ...
        return GoogleCloudDialogflowV2beta1KnowledgeBase(resource_name, opts=opts, __props__=__props__)
