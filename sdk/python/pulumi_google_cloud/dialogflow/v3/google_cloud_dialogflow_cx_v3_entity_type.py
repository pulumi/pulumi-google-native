...
__all__ = ['GoogleCloudDialogflowCxV3EntityType']


class GoogleCloudDialogflowCxV3EntityType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3EntityType, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3EntityType',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3EntityType':
        """
        Get an existing GoogleCloudDialogflowCxV3EntityType resource's state with the given name, id, and optional extra
        ...
        return GoogleCloudDialogflowCxV3EntityType(resource_name, opts=opts, __props__=__props__)
