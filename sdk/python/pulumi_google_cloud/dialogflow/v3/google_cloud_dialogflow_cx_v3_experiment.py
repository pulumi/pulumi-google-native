...
__all__ = ['GoogleCloudDialogflowCxV3Experiment']


class GoogleCloudDialogflowCxV3Experiment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3Experiment, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Experiment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3Experiment':
        """
        ...
        return GoogleCloudDialogflowCxV3Experiment(resource_name, opts=opts, __props__=__props__)
