...
__all__ = ['GoogleCloudDialogflowCxV3Flow']


class GoogleCloudDialogflowCxV3Flow(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3Flow, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Flow',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3Flow':
        """
        ...
        return GoogleCloudDialogflowCxV3Flow(resource_name, opts=opts, __props__=__props__)
