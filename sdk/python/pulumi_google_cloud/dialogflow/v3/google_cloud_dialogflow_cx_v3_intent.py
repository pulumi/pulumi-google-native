...
__all__ = ['GoogleCloudDialogflowCxV3Intent']


class GoogleCloudDialogflowCxV3Intent(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3Intent, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Intent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3Intent':
        """
        ...
        return GoogleCloudDialogflowCxV3Intent(resource_name, opts=opts, __props__=__props__)
