...
__all__ = ['GoogleCloudDialogflowCxV3Page']


class GoogleCloudDialogflowCxV3Page(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3Page, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3Page',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3Page':
        """
        ...
        return GoogleCloudDialogflowCxV3Page(resource_name, opts=opts, __props__=__props__)
