...
__all__ = ['GoogleCloudDialogflowCxV3SecuritySettings']


class GoogleCloudDialogflowCxV3SecuritySettings(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The location to create an SecuritySettings for. Format: `projects//locations/`.
        ...
        super(GoogleCloudDialogflowCxV3SecuritySettings, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3SecuritySettings',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3SecuritySettings':
        """
        ...
        return GoogleCloudDialogflowCxV3SecuritySettings(resource_name, opts=opts, __props__=__props__)
