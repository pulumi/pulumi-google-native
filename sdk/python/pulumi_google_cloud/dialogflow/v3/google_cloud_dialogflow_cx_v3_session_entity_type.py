...
__all__ = ['GoogleCloudDialogflowCxV3SessionEntityType']


class GoogleCloudDialogflowCxV3SessionEntityType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3SessionEntityType, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3SessionEntityType',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3SessionEntityType':
        """
        ...
        return GoogleCloudDialogflowCxV3SessionEntityType(resource_name, opts=opts, __props__=__props__)
