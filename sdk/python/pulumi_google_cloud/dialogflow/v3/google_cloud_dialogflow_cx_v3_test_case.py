...
__all__ = ['GoogleCloudDialogflowCxV3TestCase']


class GoogleCloudDialogflowCxV3TestCase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3TestCase, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3TestCase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3TestCase':
        """
        ...
        return GoogleCloudDialogflowCxV3TestCase(resource_name, opts=opts, __props__=__props__)
