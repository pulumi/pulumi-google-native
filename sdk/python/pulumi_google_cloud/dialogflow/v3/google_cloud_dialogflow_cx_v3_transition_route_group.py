...
__all__ = ['GoogleCloudDialogflowCxV3TransitionRouteGroup']


class GoogleCloudDialogflowCxV3TransitionRouteGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GoogleCloudDialogflowCxV3TransitionRouteArgs']]]] transition_routes: Transition routes associated with the TransitionRouteGroup. Duplicate transition routes (i.e. using the same `intent`) are not allowed. Note that the `name` field is not used in the transition route group scope.
        """
        ...
        super(GoogleCloudDialogflowCxV3TransitionRouteGroup, __self__).__init__(
            'google-cloud:dialogflow/v3:GoogleCloudDialogflowCxV3TransitionRouteGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3TransitionRouteGroup':
        """
        ...
        return GoogleCloudDialogflowCxV3TransitionRouteGroup(resource_name, opts=opts, __props__=__props__)
