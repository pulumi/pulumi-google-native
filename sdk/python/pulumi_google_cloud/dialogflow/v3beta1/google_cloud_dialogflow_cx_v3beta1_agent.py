...
__all__ = ['GoogleCloudDialogflowCxV3beta1Agent']


class GoogleCloudDialogflowCxV3beta1Agent(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3beta1Agent, __self__).__init__(
            'google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Agent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3beta1Agent':
        """
        Get an existing GoogleCloudDialogflowCxV3beta1Agent resource's state with the given name, id, and optional extra
        ...
        return GoogleCloudDialogflowCxV3beta1Agent(resource_name, opts=opts, __props__=__props__)
