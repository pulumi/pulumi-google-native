...
__all__ = ['GoogleCloudDialogflowCxV3beta1EntityType']


class GoogleCloudDialogflowCxV3beta1EntityType(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3beta1EntityType':
        """
        ...
        return GoogleCloudDialogflowCxV3beta1EntityType(resource_name, opts=opts, __props__=__props__)
