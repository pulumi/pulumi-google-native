...
__all__ = ['GoogleCloudDialogflowCxV3beta1TestCase']


class GoogleCloudDialogflowCxV3beta1TestCase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The agent to create the test case for. Format: `projects//locations//agents/`.
        ...
        super(GoogleCloudDialogflowCxV3beta1TestCase, __self__).__init__(
            'google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1TestCase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3beta1TestCase':
        """
        ...
        return GoogleCloudDialogflowCxV3beta1TestCase(resource_name, opts=opts, __props__=__props__)
