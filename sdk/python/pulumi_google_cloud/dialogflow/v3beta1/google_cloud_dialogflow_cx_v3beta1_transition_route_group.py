...
__all__ = ['GoogleCloudDialogflowCxV3beta1TransitionRouteGroup']


class GoogleCloudDialogflowCxV3beta1TransitionRouteGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3beta1TransitionRouteGroup, __self__).__init__(
            'google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1TransitionRouteGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3beta1TransitionRouteGroup':
        """
        ...
        return GoogleCloudDialogflowCxV3beta1TransitionRouteGroup(resource_name, opts=opts, __props__=__props__)
