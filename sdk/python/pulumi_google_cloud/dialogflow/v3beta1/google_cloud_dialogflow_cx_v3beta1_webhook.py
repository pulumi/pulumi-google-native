...
__all__ = ['GoogleCloudDialogflowCxV3beta1Webhook']


class GoogleCloudDialogflowCxV3beta1Webhook(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudDialogflowCxV3beta1Webhook, __self__).__init__(
            'google-cloud:dialogflow/v3beta1:GoogleCloudDialogflowCxV3beta1Webhook',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudDialogflowCxV3beta1Webhook':
        """
        ...
        return GoogleCloudDialogflowCxV3beta1Webhook(resource_name, opts=opts, __props__=__props__)
