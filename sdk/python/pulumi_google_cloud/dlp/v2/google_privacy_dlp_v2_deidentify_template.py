...
__all__ = ['GooglePrivacyDlpV2DeidentifyTemplate']


class GooglePrivacyDlpV2DeidentifyTemplate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GooglePrivacyDlpV2DeidentifyTemplate, __self__).__init__(
            'google-cloud:dlp/v2:GooglePrivacyDlpV2DeidentifyTemplate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GooglePrivacyDlpV2DeidentifyTemplate':
        """
        ...
        return GooglePrivacyDlpV2DeidentifyTemplate(resource_name, opts=opts, __props__=__props__)
