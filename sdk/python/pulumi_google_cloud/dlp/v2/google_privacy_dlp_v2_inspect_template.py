...
__all__ = ['GooglePrivacyDlpV2InspectTemplate']


class GooglePrivacyDlpV2InspectTemplate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GooglePrivacyDlpV2InspectTemplate, __self__).__init__(
            'google-cloud:dlp/v2:GooglePrivacyDlpV2InspectTemplate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GooglePrivacyDlpV2InspectTemplate':
        """
        ...
        return GooglePrivacyDlpV2InspectTemplate(resource_name, opts=opts, __props__=__props__)
