...
__all__ = ['GooglePrivacyDlpV2StoredInfoType']


class GooglePrivacyDlpV2StoredInfoType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GooglePrivacyDlpV2StoredInfoType, __self__).__init__(
            'google-cloud:dlp/v2:GooglePrivacyDlpV2StoredInfoType',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GooglePrivacyDlpV2StoredInfoType':
        """
        ...
        return GooglePrivacyDlpV2StoredInfoType(resource_name, opts=opts, __props__=__props__)
