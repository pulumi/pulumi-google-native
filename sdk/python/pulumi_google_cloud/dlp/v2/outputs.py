...
class GooglePrivacyDlpV2ActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A task to execute on the completion of a job. See https://cloud.google.com/dlp/docs/concepts-actions to learn more.
        :param 'GooglePrivacyDlpV2JobNotificationEmailsResponseArgs' job_notification_emails: Enable email notification for project owners and editors on job's completion/failure.
        :param 'GooglePrivacyDlpV2PublishToPubSubResponseArgs' pub_sub: Publish a notification to a pubsub topic.
        :param 'GooglePrivacyDlpV2PublishFindingsToCloudDataCatalogResponseArgs' publish_findings_to_cloud_data_catalog: Publish findings to Cloud Datahub.
        :param 'GooglePrivacyDlpV2PublishSummaryToCsccResponseArgs' publish_summary_to_cscc: Publish summary to Cloud Security Command Center (Alpha).
        :param 'GooglePrivacyDlpV2PublishToStackdriverResponseArgs' publish_to_stackdriver: Enable Stackdriver metric dlp.googleapis.com/finding_count.
        :param 'GooglePrivacyDlpV2SaveFindingsResponseArgs' save_findings: Save resulting findings in a provided location.
        """
...
class GooglePrivacyDlpV2AnalyzeDataSourceRiskDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Result of a risk analysis operation request.
        :param 'GooglePrivacyDlpV2CategoricalStatsResultResponseArgs' categorical_stats_result: Categorical stats result
        :param 'GooglePrivacyDlpV2DeltaPresenceEstimationResultResponseArgs' delta_presence_estimation_result: Delta-presence result
        :param 'GooglePrivacyDlpV2KAnonymityResultResponseArgs' k_anonymity_result: K-anonymity result
        :param 'GooglePrivacyDlpV2KMapEstimationResultResponseArgs' k_map_estimation_result: K-map result
        :param 'GooglePrivacyDlpV2LDiversityResultResponseArgs' l_diversity_result: L-divesity result
        :param 'GooglePrivacyDlpV2NumericalStatsResultResponseArgs' numerical_stats_result: Numerical stats result
        :param 'GooglePrivacyDlpV2RequestedRiskAnalysisOptionsResponseArgs' requested_options: The configuration used for this job.
        :param 'GooglePrivacyDlpV2PrivacyMetricResponseArgs' requested_privacy_metric: Privacy metric to compute.
        :param 'GooglePrivacyDlpV2BigQueryTableResponseArgs' requested_source_table: Input dataset to compute metrics over.
        """
...
class GooglePrivacyDlpV2AuxiliaryTableResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An auxiliary table contains statistical information on the relative frequency of different quasi-identifiers values. It has one or several quasi-identifiers columns, and one column that indicates the relative frequency of each quasi-identifier tuple. If a tuple is present in the data but not in the auxiliary table, the corresponding relative frequency is assumed to be zero (and thus, the tuple is highly reidentifiable).
        :param Sequence['GooglePrivacyDlpV2QuasiIdFieldResponseArgs'] quasi_ids: Required. Quasi-identifier columns.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' relative_frequency: Required. The relative frequency column must contain a floating-point number between 0 and 1 (inclusive). Null values are assumed to be zero.
        :param 'GooglePrivacyDlpV2BigQueryTableResponseArgs' table: Required. Auxiliary table location.
        """
...
class GooglePrivacyDlpV2BigQueryFieldResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Message defining a field of a BigQuery table.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' field: Designated field in the BigQuery table.
        :param 'GooglePrivacyDlpV2BigQueryTableResponseArgs' table: Source table of the field.
        """
...
class GooglePrivacyDlpV2BigQueryOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Options defining BigQuery table and row identifiers.
        :param Sequence['GooglePrivacyDlpV2FieldIdResponseArgs'] excluded_fields: References to fields excluded from scanning. This allows you to skip inspection of entire columns which you know have no findings.
        :param Sequence['GooglePrivacyDlpV2FieldIdResponseArgs'] identifying_fields: Table fields that may uniquely identify a row within the table. When `actions.saveFindings.outputConfig.table` is specified, the values of columns specified here are available in the output table under `location.content_locations.record_location.record_key.id_values`. Nested fields such as `person.birthdate.year` are allowed.
        ...
        :param 'GooglePrivacyDlpV2BigQueryTableResponseArgs' table_reference: Complete BigQuery table reference.
        """
...
class GooglePrivacyDlpV2BucketResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Bucket is represented as a range, along with replacement values.
        :param 'GooglePrivacyDlpV2ValueResponseArgs' max: Upper bound of the range, exclusive; type must match min.
        :param 'GooglePrivacyDlpV2ValueResponseArgs' min: Lower bound of the range, inclusive. Type should be the same as max if used.
        :param 'GooglePrivacyDlpV2ValueResponseArgs' replacement_value: Required. Replacement value for this bucket.
        """
...
class GooglePrivacyDlpV2BucketingConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Generalization function that buckets values based on ranges. The ranges and replacement values are dynamically provided by the user for custom behavior, such as 1-30 -> LOW 31-65 -> MEDIUM 66-100 -> HIGH This can be used on data of type: number, long, string, timestamp. If the bound `Value` type differs from the type of data being transformed, we will first attempt converting the type of the data to be transformed to match the type of the bound before comparing. See https://cloud.google.com/dlp/docs/concepts-bucketing to learn more.
        :param Sequence['GooglePrivacyDlpV2BucketResponseArgs'] buckets: Set of buckets. Ranges must be non-overlapping.
        """
...
class GooglePrivacyDlpV2CategoricalStatsConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Compute numerical stats over an individual column, including number of distinct values and value count distribution.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' field: Field to compute categorical stats on. All column types are supported except for arrays and structs. However, it may be more informative to use NumericalStats when the field type is supported, depending on the data.
        """
        pulumi.set(__self__, "field", field)
...
class GooglePrivacyDlpV2CategoricalStatsHistogramBucketResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GooglePrivacyDlpV2ValueFrequencyResponseArgs'] bucket_values: Sample of value frequencies in this bucket. The total number of values returned per bucket is capped at 20.
...
class GooglePrivacyDlpV2CategoricalStatsResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Result of the categorical stats computation.
        :param Sequence['GooglePrivacyDlpV2CategoricalStatsHistogramBucketResponseArgs'] value_frequency_histogram_buckets: Histogram of value frequencies in the column.
        """
...
class GooglePrivacyDlpV2CharacterMaskConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Partially mask a string by replacing a given number of characters with a fixed character. Masking can start from the beginning or end of the string. This can be used on data of any type (numbers, longs, and so on) and when de-identifying structured data we'll attempt to preserve the original data's type. (This allows you to take a long like 123 and modify it to a string like **3.
        :param Sequence['GooglePrivacyDlpV2CharsToIgnoreResponseArgs'] characters_to_ignore: When masking a string, items in this list will be skipped when replacing characters. For example, if the input string is `555-555-5555` and you instruct Cloud DLP to skip `-` and mask 5 characters with `*`, Cloud DLP returns `***-**5-5555`.
...
class GooglePrivacyDlpV2CloudStorageOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2FileSetResponseArgs' file_set: The set of one or more files to scan.
...
class GooglePrivacyDlpV2ConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The field type of `value` and `field` do not need to match to be considered equal, but not all comparisons are possible. EQUAL_TO and NOT_EQUAL_TO attempt to compare even with incompatible types, but all other comparisons are invalid with incompatible types. A `value` of type: - `string` can be compared against all other types - `boolean` can only be compared against other booleans - `integer` can be compared against doubles or a string if the string value can be parsed as an integer. - `double` can be compared against integers or a string if the string can be parsed as a double. - `Timestamp` can be compared against strings in RFC 3339 date string format. - `TimeOfDay` can be compared against timestamps and strings in the format of 'HH:mm:ss'. If we fail to compare do to type mismatch, a warning will be given and the condition will evaluate to false.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' field: Required. Field within the record this condition is evaluated against.
        :param str operator: Required. Operator used to compare the field or infoType to the value.
        :param 'GooglePrivacyDlpV2ValueResponseArgs' value: Value to compare against. [Mandatory, except for `EXISTS` tests.]
        """
        pulumi.set(__self__, "field", field)
...
class GooglePrivacyDlpV2ConditionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A collection of conditions.
        :param Sequence['GooglePrivacyDlpV2ConditionResponseArgs'] conditions: A collection of conditions.
        """
...
class GooglePrivacyDlpV2CryptoHashConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Pseudonymization method that generates surrogates via cryptographic hashing. Uses SHA-256. The key size must be either 32 or 64 bytes. Outputs a base64 encoded representation of the hashed output (for example, L7k0BHmF1ha5U3NfGykjro4xWi1MPVQPjhMAZbSV9mM=). Currently, only string and integer values can be hashed. See https://cloud.google.com/dlp/docs/pseudonymization to learn more.
        :param 'GooglePrivacyDlpV2CryptoKeyResponseArgs' crypto_key: The key used by the hash function.
        """
        pulumi.set(__self__, "crypto_key", crypto_key)
...
class GooglePrivacyDlpV2CryptoKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        This is a data encryption key (DEK) (as opposed to a key encryption key (KEK) stored by KMS). When using KMS to wrap/unwrap DEKs, be sure to set an appropriate IAM policy on the KMS CryptoKey (KEK) to ensure an attacker cannot unwrap the data crypto key.
        :param 'GooglePrivacyDlpV2KmsWrappedCryptoKeyResponseArgs' kms_wrapped: Kms wrapped key
        :param 'GooglePrivacyDlpV2TransientCryptoKeyResponseArgs' transient: Transient crypto key
        :param 'GooglePrivacyDlpV2UnwrappedCryptoKeyResponseArgs' unwrapped: Unwrapped crypto key
        """
...
class GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' context: The 'tweak', a context may be used for higher security since the same identifier in two different contexts won't be given the same surrogate. If the context is not set, a default tweak will be used. If the context is set but: 1. there is no record present when transforming a given value or 1. the field is not present when transforming a given value, a default tweak will be used. Note that case (1) is expected when an `InfoTypeTransformation` is applied to both structured and non-structured `ContentItem`s. Currently, the referenced field may be of value type integer or string. The tweak is constructed as a sequence of bytes in big endian byte order such that: - a 64 bit integer is encoded followed by a single byte of value 1 - a string is encoded in UTF-8 format followed by a single byte of value 2
        :param 'GooglePrivacyDlpV2CryptoKeyResponseArgs' crypto_key: Required. The key used by the encryption algorithm.
        ...
        :param 'GooglePrivacyDlpV2InfoTypeResponseArgs' surrogate_info_type: The custom infoType to annotate the surrogate with. This annotation will be applied to the surrogate by prefixing it with the name of the custom infoType followed by the number of characters comprising the surrogate. The following scheme defines the format: info_type_name(surrogate_character_count):surrogate For example, if the name of custom infoType is 'MY_TOKEN_INFO_TYPE' and the surrogate is 'abc', the full replacement value will be: 'MY_TOKEN_INFO_TYPE(3):abc' This annotation identifies the surrogate when inspecting content using the custom infoType [`SurrogateType`](https://cloud.google.com/dlp/docs/reference/rest/v2/InspectConfig#surrogatetype). This facilitates reversal of the surrogate when it occurs in free text. In order for inspection to work properly, the name of this infoType must not occur naturally anywhere in your data; otherwise, inspection may find a surrogate that does not correspond to an actual identifier. Therefore, choose your custom infoType name carefully after considering what your data looks like. One way to select a name that has a high chance of yielding reliable detection is to include one or more unicode characters that are highly improbable to exist in your data. For example, assuming your data is entered from a regular ASCII keyboard, the symbol with the hex code point 29DD might be used like so: ⧝MY_TOKEN_TYPE
        """
...
class GooglePrivacyDlpV2CustomInfoTypeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Custom information type provided by the user. Used to find domain-specific sensitive information configurable to the data in question.
        :param Sequence['GooglePrivacyDlpV2DetectionRuleResponseArgs'] detection_rules: Set of detection rules to apply to all findings of this CustomInfoType. Rules are applied in order that they are specified. Not supported for the `surrogate_type` CustomInfoType.
        :param 'GooglePrivacyDlpV2DictionaryResponseArgs' dictionary: A list of phrases to detect as a CustomInfoType.
        ...
        :param 'GooglePrivacyDlpV2InfoTypeResponseArgs' info_type: CustomInfoType can either be a new infoType, or an extension of built-in infoType, when the name matches one of existing infoTypes and that infoType is specified in `InspectContent.info_types` field. Specifying the latter adds findings to the one detected by the system. If built-in info type is not specified in `InspectContent.info_types` list then the name is treated as a custom info type.
        ...
        :param 'GooglePrivacyDlpV2RegexResponseArgs' regex: Regular expression based CustomInfoType.
        :param 'GooglePrivacyDlpV2StoredTypeResponseArgs' stored_type: Load an existing `StoredInfoType` resource for use in `InspectDataSource`. Not currently supported in `InspectContent`.
        :param 'GooglePrivacyDlpV2SurrogateTypeResponseArgs' surrogate_type: Message for detecting output from deidentification transformations that support reversing.
        """
...
class GooglePrivacyDlpV2DatastoreOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Options defining a data set within Google Cloud Datastore.
        :param 'GooglePrivacyDlpV2KindExpressionResponseArgs' kind: The kind to process.
        :param 'GooglePrivacyDlpV2PartitionIdResponseArgs' partition_id: A partition ID identifies a grouping of entities. The grouping is always by project and namespace, however the namespace ID may be empty.
        """
...
class GooglePrivacyDlpV2DateShiftConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Shifts dates by random number of days, with option to be consistent for the same context. See https://cloud.google.com/dlp/docs/concepts-date-shifting to learn more.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' context: Points to the field that contains the context, for example, an entity id. If set, must also set cryptoKey. If set, shift will be consistent for the given context.
        :param 'GooglePrivacyDlpV2CryptoKeyResponseArgs' crypto_key: Causes the shift to be computed based on this key and the context. This results in the same shift for the same context and crypto_key. If set, must also set context. Can only be applied to table items.
...
class GooglePrivacyDlpV2DeidentifyConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration that controls how the data will change.
        :param 'GooglePrivacyDlpV2InfoTypeTransformationsResponseArgs' info_type_transformations: Treat the dataset as free-form text and apply the same free text transformation everywhere.
        :param 'GooglePrivacyDlpV2RecordTransformationsResponseArgs' record_transformations: Treat the dataset as structured. Transformations can be applied to specific locations within structured datasets, such as transforming a column within a table.
        :param 'GooglePrivacyDlpV2TransformationErrorHandlingResponseArgs' transformation_error_handling: Mode for handling transformation errors. If left unspecified, the default mode is `TransformationErrorHandling.ThrowError`.
        """
...
class GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        δ-presence metric, used to estimate how likely it is for an attacker to figure out that one given individual appears in a de-identified dataset. Similarly to the k-map metric, we cannot compute δ-presence exactly without knowing the attack dataset, so we use a statistical model instead.
        :param Sequence['GooglePrivacyDlpV2StatisticalTableResponseArgs'] auxiliary_tables: Several auxiliary tables can be used in the analysis. Each custom_tag used to tag a quasi-identifiers field must appear in exactly one field of one auxiliary table.
        :param Sequence['GooglePrivacyDlpV2QuasiIdResponseArgs'] quasi_ids: Required. Fields considered to be quasi-identifiers. No two fields can have the same tag.
...
class GooglePrivacyDlpV2DeltaPresenceEstimationHistogramBucketResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GooglePrivacyDlpV2DeltaPresenceEstimationQuasiIdValuesResponseArgs'] bucket_values: Sample of quasi-identifier tuple values in this bucket. The total number of classes returned per bucket is capped at 20.
...
class GooglePrivacyDlpV2DeltaPresenceEstimationQuasiIdValuesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GooglePrivacyDlpV2ValueResponseArgs'] quasi_ids_values: The quasi-identifier values.
        """
...
class GooglePrivacyDlpV2DeltaPresenceEstimationResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Result of the δ-presence computation. Note that these results are an estimation, not exact values.
        :param Sequence['GooglePrivacyDlpV2DeltaPresenceEstimationHistogramBucketResponseArgs'] delta_presence_estimation_histogram: The intervals [min_probability, max_probability) do not overlap. If a value doesn't correspond to any such interval, the associated frequency is zero. For example, the following records: {min_probability: 0, max_probability: 0.1, frequency: 17} {min_probability: 0.2, max_probability: 0.3, frequency: 42} {min_probability: 0.3, max_probability: 0.4, frequency: 99} mean that there are no record with an estimated probability in [0.1, 0.2) nor larger or equal to 0.4.
        """
...
class GooglePrivacyDlpV2DetectionRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Deprecated; use `InspectionRuleSet` instead. Rule for modifying a `CustomInfoType` to alter behavior under certain circumstances, depending on the specific details of the rule. Not supported for the `surrogate_type` custom infoType.
        :param 'GooglePrivacyDlpV2HotwordRuleResponseArgs' hotword_rule: Hotword-based detection rule.
        """
...
class GooglePrivacyDlpV2DictionaryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Custom information type based on a dictionary of words or phrases. This can be used to match sensitive information specific to the data, such as a list of employee IDs or job titles. Dictionary words are case-insensitive and all characters other than letters and digits in the unicode [Basic Multilingual Plane](https://en.wikipedia.org/wiki/Plane_%28Unicode%29#Basic_Multilingual_Plane) will be replaced with whitespace when scanning for matches, so the dictionary phrase "Sam Johnson" will match all three phrases "sam johnson", "Sam, Johnson", and "Sam (Johnson)". Additionally, the characters surrounding any match must be of a different type than the adjacent characters within the word, so letters must be next to non-letters and digits next to non-digits. For example, the dictionary word "jen" will match the first three letters of the text "jen123" but will return no matches for "jennifer". Dictionary words containing a large number of characters that are not letters or digits may result in unexpected findings because such characters are treated as whitespace. The [limits](https://cloud.google.com/dlp/limits) page contains details about the size limits of dictionaries. For dictionaries that do not fit within these constraints, consider using `LargeCustomDictionaryConfig` in the `StoredInfoType` API.
        :param 'GooglePrivacyDlpV2CloudStoragePathResponseArgs' cloud_storage_path: Newline-delimited file of words in Cloud Storage. Only a single file is accepted.
        :param 'GooglePrivacyDlpV2WordListResponseArgs' word_list: List of words or phrases to search for.
        """
...
class GooglePrivacyDlpV2EntityIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An entity in a dataset is a field or set of fields that correspond to a single person. For example, in medical records the `EntityId` might be a patient identifier, or for financial records it might be an account identifier. This message is used when generalizations or analysis must take into account that multiple rows correspond to the same entity.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' field: Composite key indicating which field contains the entity identifier.
        """
        pulumi.set(__self__, "field", field)
...
class GooglePrivacyDlpV2ErrorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details information about an error encountered during job execution or the results of an unsuccessful activation of the JobTrigger.
        :param 'GoogleRpcStatusResponseArgs' details: Detailed error codes and messages.
...
class GooglePrivacyDlpV2ExcludeInfoTypesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        List of exclude infoTypes.
        :param Sequence['GooglePrivacyDlpV2InfoTypeResponseArgs'] info_types: InfoType list in ExclusionRule rule drops a finding when it overlaps or contained within with a finding of an infoType from this list. For example, for `InspectionRuleSet.info_types` containing "PHONE_NUMBER"` and `exclusion_rule` containing `exclude_info_types.info_types` with "EMAIL_ADDRESS" the phone number findings are dropped if they overlap with EMAIL_ADDRESS finding. That leads to "555-222-2222@example.org" to generate only a single finding, namely email address.
        """
...
class GooglePrivacyDlpV2ExclusionRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The rule that specifies conditions when findings of infoTypes specified in `InspectionRuleSet` are removed from results.
        :param 'GooglePrivacyDlpV2DictionaryResponseArgs' dictionary: Dictionary which defines the rule.
        :param 'GooglePrivacyDlpV2ExcludeInfoTypesResponseArgs' exclude_info_types: Set of infoTypes for which findings would affect this rule.
        :param str matching_type: How the rule is applied, see MatchingType documentation for details.
        :param 'GooglePrivacyDlpV2RegexResponseArgs' regex: Regular expression which defines the rule.
        """
        pulumi.set(__self__, "dictionary", dictionary)
...
class GooglePrivacyDlpV2ExpressionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An expression, consisting or an operator and conditions.
        :param 'GooglePrivacyDlpV2ConditionsResponseArgs' conditions: Conditions to apply to the expression.
...
class GooglePrivacyDlpV2FieldTransformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The transformation to apply to the field.
        :param 'GooglePrivacyDlpV2RecordConditionResponseArgs' condition: Only apply the transformation if the condition evaluates to true for the given `RecordCondition`. The conditions are allowed to reference fields that are not used in the actual transformation. Example Use Cases: - Apply a different bucket transformation to an age column if the zip code column for the same record is within a specific range. - Redact a field if the date of birth field is greater than 85.
        :param Sequence['GooglePrivacyDlpV2FieldIdResponseArgs'] fields: Required. Input field(s) to apply the transformation to.
        :param 'GooglePrivacyDlpV2InfoTypeTransformationsResponseArgs' info_type_transformations: Treat the contents of the field as free text, and selectively transform content that matches an `InfoType`.
        :param 'GooglePrivacyDlpV2PrimitiveTransformationResponseArgs' primitive_transformation: Apply the transformation to the entire field.
        """
...
class GooglePrivacyDlpV2FileSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Set of files to scan.
        :param 'GooglePrivacyDlpV2CloudStorageRegexFileSetResponseArgs' regex_file_set: The regex-filtered set of files to scan. Exactly one of `url` or `regex_file_set` must be set.
...
class GooglePrivacyDlpV2FindingLimitsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration to control the number of findings returned. Cannot be set if de-identification is requested.
        :param Sequence['GooglePrivacyDlpV2InfoTypeLimitResponseArgs'] max_findings_per_info_type: Configuration of findings limit given for specified infoTypes.
...
class GooglePrivacyDlpV2FixedSizeBucketingConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2ValueResponseArgs' lower_bound: Required. Lower bound value of buckets. All values less than `lower_bound` are grouped together into a single bucket; for example if `lower_bound` = 10, then all values less than 10 are replaced with the value "-10".
        :param 'GooglePrivacyDlpV2ValueResponseArgs' upper_bound: Required. Upper bound value of buckets. All values greater than upper_bound are grouped together into a single bucket; for example if `upper_bound` = 89, then all values greater than 89 are replaced with the value "89+".
        """
        pulumi.set(__self__, "bucket_size", bucket_size)
...
class GooglePrivacyDlpV2HotwordRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The rule that adjusts the likelihood of findings within a certain proximity of hotwords.
        :param 'GooglePrivacyDlpV2RegexResponseArgs' hotword_regex: Regular expression pattern defining what qualifies as a hotword.
        :param 'GooglePrivacyDlpV2LikelihoodAdjustmentResponseArgs' likelihood_adjustment: Likelihood adjustment to apply to all matching findings.
        :param 'GooglePrivacyDlpV2ProximityResponseArgs' proximity: Proximity of the finding within which the entire hotword must reside. The total length of the window cannot exceed 1000 characters. Note that the finding itself will be included in the window, so that hotwords may be used to match substrings of the finding itself. For example, the certainty of a phone number regex "\(\d{3}\) \d{3}-\d{4}" could be adjusted upwards if the area code is known to be the local area code of a company office using the hotword regex "\(xxx\)", where "xxx" is the area code in question.
        """
...
class GooglePrivacyDlpV2HybridOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2TableOptionsResponseArgs' table_options: If the container is a table, additional information to make findings meaningful such as the columns that are primary keys.
        """
...
class GooglePrivacyDlpV2InfoTypeStatsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2InfoTypeResponseArgs' info_type: The type of finding this stat is for.
        """
...
class GooglePrivacyDlpV2InfoTypeTransformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A transformation to apply to text that is identified as a specific info_type.
        :param Sequence['GooglePrivacyDlpV2InfoTypeResponseArgs'] info_types: InfoTypes to apply the transformation to. An empty list will cause this transformation to apply to all findings that correspond to infoTypes that were requested in `InspectConfig`.
        :param 'GooglePrivacyDlpV2PrimitiveTransformationResponseArgs' primitive_transformation: Required. Primitive transformation to apply to the infoType.
        """
        pulumi.set(__self__, "info_types", info_types)
        pulumi.set(__self__, "primitive_transformation", primitive_transformation)
...
class GooglePrivacyDlpV2InfoTypeTransformationsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A type of transformation that will scan unstructured text and apply various `PrimitiveTransformation`s to each finding, where the transformation is applied to only values that were identified as a specific info_type.
        :param Sequence['GooglePrivacyDlpV2InfoTypeTransformationResponseArgs'] transformations: Required. Transformation for each infoType. Cannot specify more than one for a given infoType.
        """
...
class GooglePrivacyDlpV2InspectConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GooglePrivacyDlpV2CustomInfoTypeResponseArgs'] custom_info_types: CustomInfoTypes provided by the user. See https://cloud.google.com/dlp/docs/creating-custom-infotypes to learn more.
        ...
        :param Sequence['GooglePrivacyDlpV2InfoTypeResponseArgs'] info_types: Restricts what info_types to look for. The values must correspond to InfoType values returned by ListInfoTypes or listed at https://cloud.google.com/dlp/docs/infotypes-reference. When no InfoTypes or CustomInfoTypes are specified in a request, the system may automatically choose what detectors to run. By default this may be all types, but may change over time as detectors are updated. If you need precise control and predictability as to what detectors are run you should specify specific InfoTypes listed in the reference, otherwise a default list will be used, which may change over time.
        :param 'GooglePrivacyDlpV2FindingLimitsResponseArgs' limits: Configuration to control the number of findings returned.
        ...
        :param Sequence['GooglePrivacyDlpV2InspectionRuleSetResponseArgs'] rule_set: Set of rules to apply to the findings for this InspectConfig. Exclusion rules, contained in the set are executed in the end, other rules are executed in the order they are specified for each info type.
        """
...
class GooglePrivacyDlpV2InspectDataSourceDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The results of an inspect DataSource job.
        :param 'GooglePrivacyDlpV2RequestedOptionsResponseArgs' requested_options: The configuration used for this job.
        :param 'GooglePrivacyDlpV2ResultResponseArgs' result: A summary of the outcome of this inspection job.
        """
        pulumi.set(__self__, "requested_options", requested_options)
...
class GooglePrivacyDlpV2InspectJobConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Controls what and how to inspect for findings.
        :param Sequence['GooglePrivacyDlpV2ActionResponseArgs'] actions: Actions to execute at the completion of the job.
        :param 'GooglePrivacyDlpV2InspectConfigResponseArgs' inspect_config: How and what to scan for.
        ...
        :param 'GooglePrivacyDlpV2StorageConfigResponseArgs' storage_config: The data to scan.
        """
...
class GooglePrivacyDlpV2InspectTemplateResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2InspectConfigResponseArgs' inspect_config: The core content of the template. Configuration of the scanning process.
...
class GooglePrivacyDlpV2InspectionRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A single inspection rule to be applied to infoTypes, specified in `InspectionRuleSet`.
        :param 'GooglePrivacyDlpV2ExclusionRuleResponseArgs' exclusion_rule: Exclusion rule.
        :param 'GooglePrivacyDlpV2HotwordRuleResponseArgs' hotword_rule: Hotword-based detection rule.
        """
...
class GooglePrivacyDlpV2InspectionRuleSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Rule set for modifying a set of infoTypes to alter behavior under certain circumstances, depending on the specific details of the rules within the set.
        :param Sequence['GooglePrivacyDlpV2InfoTypeResponseArgs'] info_types: List of infoTypes this rule set is applied to.
        :param Sequence['GooglePrivacyDlpV2InspectionRuleResponseArgs'] rules: Set of rules to be applied to infoTypes. The rules are applied in order.
        """
        pulumi.set(__self__, "info_types", info_types)
...
class GooglePrivacyDlpV2KAnonymityConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        k-anonymity metric, used for analysis of reidentification risk.
        :param 'GooglePrivacyDlpV2EntityIdResponseArgs' entity_id: Message indicating that multiple rows might be associated to a single individual. If the same entity_id is associated to multiple quasi-identifier tuples over distinct rows, we consider the entire collection of tuples as the composite quasi-identifier. This collection is a multiset: the order in which the different tuples appear in the dataset is ignored, but their frequency is taken into account. Important note: a maximum of 1000 rows can be associated to a single entity ID. If more rows are associated with the same entity ID, some might be ignored.
        :param Sequence['GooglePrivacyDlpV2FieldIdResponseArgs'] quasi_ids: Set of fields to compute k-anonymity over. When multiple fields are specified, they are considered a single composite key. Structs and repeated data types are not supported; however, nested fields are supported so long as they are not structs themselves or nested within a repeated field.
        """
...
class GooglePrivacyDlpV2KAnonymityEquivalenceClassResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GooglePrivacyDlpV2ValueResponseArgs'] quasi_ids_values: Set of values defining the equivalence class. One value per quasi-identifier column in the original KAnonymity metric message. The order is always the same as the original request.
        """
...
class GooglePrivacyDlpV2KAnonymityHistogramBucketResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GooglePrivacyDlpV2KAnonymityEquivalenceClassResponseArgs'] bucket_values: Sample of equivalence classes in this bucket. The total number of classes returned per bucket is capped at 20.
...
class GooglePrivacyDlpV2KAnonymityResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Result of the k-anonymity computation.
        :param Sequence['GooglePrivacyDlpV2KAnonymityHistogramBucketResponseArgs'] equivalence_class_histogram_buckets: Histogram of k-anonymity equivalence classes.
        """
...
class GooglePrivacyDlpV2KMapEstimationConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reidentifiability metric. This corresponds to a risk model similar to what is called "journalist risk" in the literature, except the attack dataset is statistically modeled instead of being perfectly known. This can be done using publicly available data (like the US Census), or using a custom statistical model (indicated as one or several BigQuery tables), or by extrapolating from the distribution of values in the input dataset.
        :param Sequence['GooglePrivacyDlpV2AuxiliaryTableResponseArgs'] auxiliary_tables: Several auxiliary tables can be used in the analysis. Each custom_tag used to tag a quasi-identifiers column must appear in exactly one column of one auxiliary table.
        :param Sequence['GooglePrivacyDlpV2TaggedFieldResponseArgs'] quasi_ids: Required. Fields considered to be quasi-identifiers. No two columns can have the same tag.
        :param str region_code: ISO 3166-1 alpha-2 region code to use in the statistical modeling. Set if no column is tagged with a region-specific InfoType (like US_ZIP_5) or a region code.
        """
        pulumi.set(__self__, "auxiliary_tables", auxiliary_tables)
        pulumi.set(__self__, "quasi_ids", quasi_ids)
...
class GooglePrivacyDlpV2KMapEstimationHistogramBucketResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str bucket_value_count: Total number of distinct quasi-identifier tuple values in this bucket.
        :param Sequence['GooglePrivacyDlpV2KMapEstimationQuasiIdValuesResponseArgs'] bucket_values: Sample of quasi-identifier tuple values in this bucket. The total number of classes returned per bucket is capped at 20.
...
class GooglePrivacyDlpV2KMapEstimationResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Result of the reidentifiability analysis. Note that these results are an estimation, not exact values.
        :param Sequence['GooglePrivacyDlpV2KMapEstimationHistogramBucketResponseArgs'] k_map_estimation_histogram: The intervals [min_anonymity, max_anonymity] do not overlap. If a value doesn't correspond to any such interval, the associated frequency is zero. For example, the following records: {min_anonymity: 1, max_anonymity: 1, frequency: 17} {min_anonymity: 2, max_anonymity: 3, frequency: 42} {min_anonymity: 5, max_anonymity: 10, frequency: 99} mean that there are no record with an estimated anonymity of 4, 5, or larger than 10.
        """
...
class GooglePrivacyDlpV2LDiversityConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        l-diversity metric, used for analysis of reidentification risk.
        :param Sequence['GooglePrivacyDlpV2FieldIdResponseArgs'] quasi_ids: Set of quasi-identifiers indicating how equivalence classes are defined for the l-diversity computation. When multiple fields are specified, they are considered a single composite key.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' sensitive_attribute: Sensitive field for computing the l-value.
        """
        pulumi.set(__self__, "quasi_ids", quasi_ids)
...
class GooglePrivacyDlpV2LDiversityEquivalenceClassResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GooglePrivacyDlpV2ValueResponseArgs'] quasi_ids_values: Quasi-identifier values defining the k-anonymity equivalence class. The order is always the same as the original request.
        :param Sequence['GooglePrivacyDlpV2ValueFrequencyResponseArgs'] top_sensitive_values: Estimated frequencies of top sensitive values.
        """
        pulumi.set(__self__, "equivalence_class_size", equivalence_class_size)
...
class GooglePrivacyDlpV2LDiversityHistogramBucketResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str bucket_size: Total number of equivalence classes in this bucket.
        :param str bucket_value_count: Total number of distinct equivalence classes in this bucket.
        :param Sequence['GooglePrivacyDlpV2LDiversityEquivalenceClassResponseArgs'] bucket_values: Sample of equivalence classes in this bucket. The total number of classes returned per bucket is capped at 20.
...
class GooglePrivacyDlpV2LDiversityResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Result of the l-diversity computation.
        :param Sequence['GooglePrivacyDlpV2LDiversityHistogramBucketResponseArgs'] sensitive_value_frequency_histogram_buckets: Histogram of l-diversity equivalence class sensitive value frequencies.
        """
...
class GooglePrivacyDlpV2LargeCustomDictionaryConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for a custom dictionary created from a data source of any size up to the maximum size defined in the [limits](https://cloud.google.com/dlp/limits) page. The artifacts of dictionary creation are stored in the specified Google Cloud Storage location. Consider using `CustomInfoType.Dictionary` for smaller dictionaries that satisfy the size requirements.
        :param 'GooglePrivacyDlpV2BigQueryFieldResponseArgs' big_query_field: Field in a BigQuery table where each cell represents a dictionary phrase.
        :param 'GooglePrivacyDlpV2CloudStorageFileSetResponseArgs' cloud_storage_file_set: Set of files containing newline-delimited lists of dictionary phrases.
        :param 'GooglePrivacyDlpV2CloudStoragePathResponseArgs' output_path: Location to store dictionary artifacts in Google Cloud Storage. These files will only be accessible by project owners and the DLP API. If any of these artifacts are modified, the dictionary is considered invalid and can no longer be used.
        """
...
class GooglePrivacyDlpV2NumericalStatsConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Compute numerical stats over an individual column, including min, max, and quantiles.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' field: Field to compute numerical stats on. Supported types are integer, float, date, datetime, timestamp, time.
        """
        pulumi.set(__self__, "field", field)
...
class GooglePrivacyDlpV2NumericalStatsResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Result of the numerical stats computation.
        :param 'GooglePrivacyDlpV2ValueResponseArgs' max_value: Maximum value appearing in the column.
        :param 'GooglePrivacyDlpV2ValueResponseArgs' min_value: Minimum value appearing in the column.
        :param Sequence['GooglePrivacyDlpV2ValueResponseArgs'] quantile_values: List of 99 values that partition the set of field values into 100 equal sized buckets.
        """
...
class GooglePrivacyDlpV2OutputStorageConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2BigQueryTableResponseArgs' table: Store findings in an existing table or a new table in an existing dataset. If table_id is not set a new one will be generated for you with the following format: dlp_googleapis_yyyy_mm_dd_[dlp_job_id]. Pacific timezone will be used for generating the date details. For Inspect, each column in an existing output table must have the same name, type, and mode of a field in the `Finding` object. For Risk, an existing output table should be the output of a previous Risk analysis job run on the same source table, with the same privacy metric and quasi-identifiers. Risk jobs that analyze the same table but compute a different privacy metric, or use different sets of quasi-identifiers, cannot store their results in the same table.
        """
...
class GooglePrivacyDlpV2PrimitiveTransformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A rule for transforming a value.
        :param 'GooglePrivacyDlpV2BucketingConfigResponseArgs' bucketing_config: Bucketing
        :param 'GooglePrivacyDlpV2CharacterMaskConfigResponseArgs' character_mask_config: Mask
        :param 'GooglePrivacyDlpV2CryptoDeterministicConfigResponseArgs' crypto_deterministic_config: Deterministic Crypto
        :param 'GooglePrivacyDlpV2CryptoHashConfigResponseArgs' crypto_hash_config: Crypto
        :param 'GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponseArgs' crypto_replace_ffx_fpe_config: Ffx-Fpe
        :param 'GooglePrivacyDlpV2DateShiftConfigResponseArgs' date_shift_config: Date Shift
        :param 'GooglePrivacyDlpV2FixedSizeBucketingConfigResponseArgs' fixed_size_bucketing_config: Fixed size bucketing
        :param 'GooglePrivacyDlpV2RedactConfigResponseArgs' redact_config: Redact
        :param 'GooglePrivacyDlpV2ReplaceValueConfigResponseArgs' replace_config: Replace
        :param 'GooglePrivacyDlpV2ReplaceWithInfoTypeConfigResponseArgs' replace_with_info_type_config: Replace with infotype
        :param 'GooglePrivacyDlpV2TimePartConfigResponseArgs' time_part_config: Time extraction
        """
...
class GooglePrivacyDlpV2PrivacyMetricResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Privacy metric to compute for reidentification risk analysis.
        :param 'GooglePrivacyDlpV2CategoricalStatsConfigResponseArgs' categorical_stats_config: Categorical stats
        :param 'GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponseArgs' delta_presence_estimation_config: delta-presence
        :param 'GooglePrivacyDlpV2KAnonymityConfigResponseArgs' k_anonymity_config: K-anonymity
        :param 'GooglePrivacyDlpV2KMapEstimationConfigResponseArgs' k_map_estimation_config: k-map
        :param 'GooglePrivacyDlpV2LDiversityConfigResponseArgs' l_diversity_config: l-diversity
        :param 'GooglePrivacyDlpV2NumericalStatsConfigResponseArgs' numerical_stats_config: Numerical stats
        """
...
class GooglePrivacyDlpV2QuasiIdFieldResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' field: Identifies the column.
        """
...
class GooglePrivacyDlpV2QuasiIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' field: Required. Identifies the column.
        :param 'GoogleProtobufEmptyResponseArgs' inferred: If no semantic tag is indicated, we infer the statistical model from the distribution of values in the input data
        :param 'GooglePrivacyDlpV2InfoTypeResponseArgs' info_type: A column can be tagged with a InfoType to use the relevant public dataset as a statistical model of population, if available. We currently support US ZIP codes, region codes, ages and genders. To programmatically obtain the list of supported InfoTypes, use ListInfoTypes with the supported_by=RISK_ANALYSIS filter.
        """
        pulumi.set(__self__, "custom_tag", custom_tag)
        pulumi.set(__self__, "field", field)
...
class GooglePrivacyDlpV2RecordConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A condition for determining whether a transformation should be applied to a field.
        :param 'GooglePrivacyDlpV2ExpressionsResponseArgs' expressions: An expression.
        """
...
class GooglePrivacyDlpV2RecordSuppressionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration to suppress records whose suppression conditions evaluate to true.
        :param 'GooglePrivacyDlpV2RecordConditionResponseArgs' condition: A condition that when it evaluates to true will result in the record being evaluated to be suppressed from the transformed content.
        """
        pulumi.set(__self__, "condition", condition)
...
class GooglePrivacyDlpV2RecordTransformationsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A type of transformation that is applied over structured data such as a table.
        :param Sequence['GooglePrivacyDlpV2FieldTransformationResponseArgs'] field_transformations: Transform the record by applying various field transformations.
        :param Sequence['GooglePrivacyDlpV2RecordSuppressionResponseArgs'] record_suppressions: Configuration defining which records get suppressed entirely. Records that match any suppression rule are omitted from the output.
        """
...
class GooglePrivacyDlpV2ReplaceValueConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Replace each input value with a given `Value`.
        :param 'GooglePrivacyDlpV2ValueResponseArgs' new_value: Value to replace it with.
        """
...
class GooglePrivacyDlpV2RequestedOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Snapshot of the inspection configuration.
        :param 'GooglePrivacyDlpV2InspectJobConfigResponseArgs' job_config: Inspect config.
        :param 'GooglePrivacyDlpV2InspectTemplateResponseArgs' snapshot_inspect_template: If run with an InspectTemplate, a snapshot of its state at the time of this run.
        """
...
class GooglePrivacyDlpV2RequestedRiskAnalysisOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Risk analysis options.
        :param 'GooglePrivacyDlpV2RiskAnalysisJobConfigResponseArgs' job_config: The job config for the risk job.
        """
        pulumi.set(__self__, "job_config", job_config)
...
class GooglePrivacyDlpV2ResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        All result fields mentioned below are updated while the job is processing.
        :param 'GooglePrivacyDlpV2HybridInspectStatisticsResponseArgs' hybrid_stats: Statistics related to the processing of hybrid inspect.
        :param Sequence['GooglePrivacyDlpV2InfoTypeStatsResponseArgs'] info_type_stats: Statistics of how many instances of each info type were found during inspect job.
...
class GooglePrivacyDlpV2RiskAnalysisJobConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for a risk analysis job. See https://cloud.google.com/dlp/docs/concepts-risk-analysis to learn more.
        :param Sequence['GooglePrivacyDlpV2ActionResponseArgs'] actions: Actions to execute at the completion of the job. Are executed in the order provided.
        :param 'GooglePrivacyDlpV2PrivacyMetricResponseArgs' privacy_metric: Privacy metric to compute.
        :param 'GooglePrivacyDlpV2BigQueryTableResponseArgs' source_table: Input dataset to compute metrics over.
        """
        pulumi.set(__self__, "actions", actions)
...
class GooglePrivacyDlpV2SaveFindingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        If set, the detailed findings will be persisted to the specified OutputStorageConfig. Only a single instance of this action can be specified. Compatible with: Inspect, Risk
        :param 'GooglePrivacyDlpV2OutputStorageConfigResponseArgs' output_config: Location to store findings outside of DLP.
        """
...
class GooglePrivacyDlpV2StatisticalTableResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An auxiliary table containing statistical information on the relative frequency of different quasi-identifiers values. It has one or several quasi-identifiers columns, and one column that indicates the relative frequency of each quasi-identifier tuple. If a tuple is present in the data but not in the auxiliary table, the corresponding relative frequency is assumed to be zero (and thus, the tuple is highly reidentifiable).
        :param Sequence['GooglePrivacyDlpV2QuasiIdentifierFieldResponseArgs'] quasi_ids: Required. Quasi-identifier columns.
        :param 'GooglePrivacyDlpV2FieldIdResponseArgs' relative_frequency: Required. The relative frequency column must contain a floating-point number between 0 and 1 (inclusive). Null values are assumed to be zero.
        :param 'GooglePrivacyDlpV2BigQueryTableResponseArgs' table: Required. Auxiliary table location.
        """
        pulumi.set(__self__, "quasi_ids", quasi_ids)
...
class GooglePrivacyDlpV2StorageConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Shared message indicating Cloud storage type.
        :param 'GooglePrivacyDlpV2BigQueryOptionsResponseArgs' big_query_options: BigQuery options.
        :param 'GooglePrivacyDlpV2CloudStorageOptionsResponseArgs' cloud_storage_options: Google Cloud Storage options.
        :param 'GooglePrivacyDlpV2DatastoreOptionsResponseArgs' datastore_options: Google Cloud Datastore options.
        :param 'GooglePrivacyDlpV2HybridOptionsResponseArgs' hybrid_options: Hybrid inspection options.
        """
...
class GooglePrivacyDlpV2StoredInfoTypeConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2DictionaryResponseArgs' dictionary: Store dictionary-based CustomInfoType.
        :param str display_name: Display name of the StoredInfoType (max 256 characters).
        :param 'GooglePrivacyDlpV2LargeCustomDictionaryConfigResponseArgs' large_custom_dictionary: StoredInfoType where findings are defined by a dictionary of phrases.
        :param 'GooglePrivacyDlpV2RegexResponseArgs' regex: Store regular expression-based StoredInfoType.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "dictionary", dictionary)
        pulumi.set(__self__, "display_name", display_name)
...
class GooglePrivacyDlpV2StoredInfoTypeStatsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Statistics for a StoredInfoType.
        :param 'GooglePrivacyDlpV2LargeCustomDictionaryStatsResponseArgs' large_custom_dictionary: StoredInfoType where findings are defined by a dictionary of phrases.
        """
        pulumi.set(__self__, "large_custom_dictionary", large_custom_dictionary)
...
class GooglePrivacyDlpV2StoredInfoTypeVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Version of a StoredInfoType, including the configuration used to build it, create timestamp, and current state.
        :param 'GooglePrivacyDlpV2StoredInfoTypeConfigResponseArgs' config: StoredInfoType configuration.
        :param str create_time: Create timestamp of the version. Read-only, determined by the system when the version is created.
        :param Sequence['GooglePrivacyDlpV2ErrorResponseArgs'] errors: Errors that occurred when creating this storedInfoType version, or anomalies detected in the storedInfoType data that render it unusable. Only the five most recent errors will be displayed, with the most recent error appearing first. For example, some of the data for stored custom dictionaries is put in the user's Google Cloud Storage bucket, and if this data is modified or deleted by the user or another system, the dictionary becomes invalid. If any errors occur, fix the problem indicated by the error message and use the UpdateStoredInfoType API method to create another version of the storedInfoType to continue using it, reusing the same `config` if it was not the source of the error.
        :param str state: Stored info type version state. Read-only, updated by the system during dictionary creation.
        :param 'GooglePrivacyDlpV2StoredInfoTypeStatsResponseArgs' stats: Statistics about this storedInfoType version.
        """
...
class GooglePrivacyDlpV2TransformationErrorHandlingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        How to handle transformation errors during de-identification. A transformation error occurs when the requested transformation is incompatible with the data. For example, trying to de-identify an IP address using a `DateShift` transformation would result in a transformation error, since date info cannot be extracted from an IP address. Information about any incompatible transformations, and how they were handled, is returned in the response as part of the `TransformationOverviews`.
        :param 'GooglePrivacyDlpV2LeaveUntransformedResponseArgs' leave_untransformed: Ignore errors
        :param 'GooglePrivacyDlpV2ThrowErrorResponseArgs' throw_error: Throw an error
        """
...
class GooglePrivacyDlpV2TriggerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        What event needs to occur for a new job to be started.
        :param 'GooglePrivacyDlpV2ManualResponseArgs' manual: For use with hybrid jobs. Jobs must be manually created and finished.
        :param 'GooglePrivacyDlpV2ScheduleResponseArgs' schedule: Create a job on a repeating basis based on the elapse of time.
        """
...
class GooglePrivacyDlpV2ValueFrequencyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GooglePrivacyDlpV2ValueResponseArgs' value: A value contained in the field in question.
        """
        pulumi.set(__self__, "count", count)
        pulumi.set(__self__, "value", value)
...
class GooglePrivacyDlpV2ValueResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleTypeDateResponseArgs' date_value: date
        ...
        :param 'GoogleTypeTimeOfDayResponseArgs' time_value: time of day
