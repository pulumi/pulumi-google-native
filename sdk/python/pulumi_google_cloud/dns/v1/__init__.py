...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "google-cloud:dns/v1:Change":
                return Change(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dns/v1:ManagedZone":
                return ManagedZone(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:dns/v1:ManagedZoneRrset":
    ...
    pulumi.runtime.register_resource_module("google-cloud", "dns/v1", _module_instance)
