...
class ShortLink(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(ShortLink, __self__).__init__(
            'google-cloud:firebasedynamiclinks/v1:ShortLink',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ShortLink':
        """
        ...
        return ShortLink(resource_name, opts=opts, __props__=__props__)
