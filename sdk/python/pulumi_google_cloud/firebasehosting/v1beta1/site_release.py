...
class SiteRelease(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(SiteRelease, __self__).__init__(
            'google-cloud:firebasehosting/v1beta1:SiteRelease',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SiteRelease':
        """
        ...
        return SiteRelease(resource_name, opts=opts, __props__=__props__)
