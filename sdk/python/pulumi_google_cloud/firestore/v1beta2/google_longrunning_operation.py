...
class GoogleLongrunningOperation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: A parent name of the form `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}`
        ...
        super(GoogleLongrunningOperation, __self__).__init__(
            'google-cloud:firestore/v1beta2:GoogleLongrunningOperation',
            resource_name,
            __props__,
            opts)
