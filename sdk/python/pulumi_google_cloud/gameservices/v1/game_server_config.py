...
class GameServerConfig(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] config_id: Required. The ID of the game server config resource to be created.
        ...
        :param pulumi.Input[str] parent: Required. The parent resource name, in the following form: `projects/{project}/locations/{location}/gameServerDeployments/{deployment}/`.
        ...
        super(GameServerConfig, __self__).__init__(
            'google-cloud:gameservices/v1:GameServerConfig',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GameServerConfig':
        """
