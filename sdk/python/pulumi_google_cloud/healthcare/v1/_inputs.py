...
class GoogleCloudHealthcareV1FhirBigQueryDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] force: If this flag is `TRUE`, all tables are deleted from the dataset before the new exported tables are written. If the flag is not set and the destination dataset contains tables, the export call returns an error.
...
class ParserConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] segment_terminator: Byte(s) to use as the segment terminator. If this is unset, '\r' is used as segment terminator.
        """
