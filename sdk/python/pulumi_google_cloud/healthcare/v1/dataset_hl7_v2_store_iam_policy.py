...
__all__ = ['DatasetHl7V2StoreIamPolicy']


class DatasetHl7V2StoreIamPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(DatasetHl7V2StoreIamPolicy, __self__).__init__(
            'google-cloud:healthcare/v1:DatasetHl7V2StoreIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DatasetHl7V2StoreIamPolicy':
        """
        Get an existing DatasetHl7V2StoreIamPolicy resource's state with the given name, id, and optional extra
        ...
        return DatasetHl7V2StoreIamPolicy(resource_name, opts=opts, __props__=__props__)
