...
class AttributeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] attribute_definition_id: Indicates the name of an attribute defined at the consent store.
...
class GoogleCloudHealthcareV1beta1ConsentPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AttributeArgs']]] resource_attributes: The data resources that this policy applies to. A data resource is a match if it matches all the attributes listed here.
        """
...
class GoogleCloudHealthcareV1beta1DicomBigQueryDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] write_disposition: Determines whether the existing table in the destination is to be overwritten or appended to. If a write_disposition is specified, the `force` parameter is ignored.
        """
...
class ParserConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] version: Immutable. Determines the version of the unschematized parser to be used when `schema` is not given. This field is immutable after store creation.
        """
...
class SchemaPackageArgs:
    def __init__(__self__, *,
                 ...
                 unexpected_segment_handling: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[str] unexpected_segment_handling: Determines how unexpected segments (segments not matched to the schema) are handled.
        """
    ...
    def unexpected_segment_handling(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def unexpected_segment_handling(self, value: Optional[pulumi.Input[str]]):
...
class SignatureArgs:
    def __init__(__self__, *,
        ...
        """
        User signature.
        :param pulumi.Input['ImageArgs'] image: An image of the user's signature.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] metadata: Metadata associated with the user's signature. For example, the user's name or the user's title.
        :param pulumi.Input[str] signature_time: Timestamp of the signature.
