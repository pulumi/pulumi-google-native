...
class FhirStore(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['default_search_handling_strict'] = default_search_handling_strict
            ...
            __props__['validation_config'] = validation_config
            __props__['version'] = version
        super(FhirStore, __self__).__init__(
            'google-cloud:healthcare/v1beta1:FhirStore',
            resource_name,
            __props__,
            opts)
