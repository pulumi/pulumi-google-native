...
class CompanyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CompanyDerivedInfoArgs'] derived_info: Output only. Derived details about the company.
        ...
        :param pulumi.Input[bool] suspended: Output only. Indicates whether a company is flagged to be suspended from public availability by the service when job content appears suspicious, abusive, or spammy.
...
class CompensationInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CompensationRangeArgs'] annualized_base_compensation_range: Output only. Annualized base compensation range. Computed as base compensation entry's CompensationEntry.compensation times CompensationEntry.expected_units_per_year. See CompensationEntry for explanation on compensation annualization.
...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['JobDerivedInfoArgs'] derived_info: Output only. Derived details about the job posting.
