...
class Company(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['CompanyDerivedInfoArgs']] derived_info: Output only. Derived details about the company.
        ...
        :param pulumi.Input[str] parent: Required. Resource name of the tenant under which the company is created. The format is "projects/{project_id}/tenants/{tenant_id}", for example, "projects/foo/tenants/bar".
