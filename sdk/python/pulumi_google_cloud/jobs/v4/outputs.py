...
class CompanyDerivedInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Derived details about the company.
        :param 'LocationResponseArgs' headquarters_location: A structured headquarters location of the company, resolved from Company.headquarters_address if provided.
        """
...
class CompensationEntryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A compensation entry that represents one component of compensation, such as base pay, bonus, or other compensation type. Annualization: One compensation entry can be annualized if - it contains valid amount or range. - and its expected_units_per_year is set or can be derived. Its annualized range is determined as (amount or range) times expected_units_per_year.
        :param 'MoneyResponseArgs' amount: Compensation amount.
        ...
        :param 'CompensationRangeResponseArgs' range: Compensation range.
...
class CompensationInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Job compensation details.
        :param 'CompensationRangeResponseArgs' annualized_base_compensation_range: Annualized base compensation range. Computed as base compensation entry's CompensationEntry.amount times CompensationEntry.expected_units_per_year. See CompensationEntry for explanation on compensation annualization.
        :param 'CompensationRangeResponseArgs' annualized_total_compensation_range: Annualized total compensation range. Computed as all compensation entries' CompensationEntry.amount times CompensationEntry.expected_units_per_year. See CompensationEntry for explanation on compensation annualization.
        :param Sequence['CompensationEntryResponseArgs'] entries: Job compensation information. At most one entry can be of type CompensationInfo.CompensationType.BASE, which is referred as **base compensation entry** for the job.
        """
...
class CompensationRangeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Compensation range.
        :param 'MoneyResponseArgs' max_compensation: The maximum amount of compensation. If left empty, the value is set to a maximal compensation value and the currency code is set to match the currency code of min_compensation.
        :param 'MoneyResponseArgs' min_compensation: The minimum amount of compensation. If left empty, the value is set to zero and the currency code is set to match the currency code of max_compensation.
        """
