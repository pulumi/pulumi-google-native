...
class TenantJob(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(TenantJob, __self__).__init__(
            'google-cloud:jobs/v4:TenantJob',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TenantJob':
        """
        ...
        return TenantJob(resource_name, opts=opts, __props__=__props__)
