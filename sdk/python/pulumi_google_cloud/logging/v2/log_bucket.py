...
class LogBucket(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(LogBucket, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LogBucket':
        """
        ...
        return LogBucket(resource_name, opts=opts, __props__=__props__)
