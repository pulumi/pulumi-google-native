...
class Metric(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['metrics_id'] = metrics_id
            __props__['name'] = name
        ...
        super(Metric, __self__).__init__(
            'google-cloud:logging/v2:Metric',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__["bucket_options"] = None
        __props__["create_time"] = None
        __props__["description"] = None
        __props__["filter"] = None
        __props__["label_extractors"] = None
        __props__["metric_descriptor"] = None
        __props__["name"] = None
        __props__["update_time"] = None
        __props__["value_extractor"] = None
