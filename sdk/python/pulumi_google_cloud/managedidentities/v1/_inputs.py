...
class TrustArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] selective_authentication: Optional. The trust authentication type, which decides whether the trusted side has forest/domain wide access or selective access to an approved set of resources.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] target_dns_ip_addresses: Required. The target DNS server IP addresses which can resolve the remote domain involved in the trust.
        :param pulumi.Input[str] target_domain_name: Required. The fully qualified target domain name which will be in trust with the current domain.
        :param pulumi.Input[str] trust_direction: Required. The trust direction, which decides if the current domain is trusted, trusting, or both.
        :param pulumi.Input[str] trust_handshake_secret: Required. The trust secret used for the handshake with the target domain. This will not be stored.
        :param pulumi.Input[str] trust_type: Required. The type of trust represented by the trust resource.
