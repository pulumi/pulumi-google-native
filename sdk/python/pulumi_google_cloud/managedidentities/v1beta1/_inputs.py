...
class TrustArgs:
    def __init__(__self__, *,
                 ...
                 last_trust_heartbeat_time: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] last_trust_heartbeat_time: Output only. The last heartbeat time when the trust was known to be connected.
        :param pulumi.Input[bool] selective_authentication: The trust authentication type, which decides whether the trusted side has forest/domain wide access or selective access to an approved set of resources.
        :param pulumi.Input[str] state: Output only. The current state of the trust.
        :param pulumi.Input[str] state_description: Output only. Additional information about the current state of the trust, if available.
        ...
        :param pulumi.Input[str] trust_handshake_secret: Input only. The trust secret used for the handshake with the target domain. It will not be stored.
        ...
        if last_trust_heartbeat_time is not None:
    ...
    def last_trust_heartbeat_time(self) -> Optional[pulumi.Input[str]]:
        """
        Output only. The last heartbeat time when the trust was known to be connected.
        """
        return pulumi.get(self, "last_trust_heartbeat_time")

    @last_trust_heartbeat_time.setter
    def last_trust_heartbeat_time(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "last_trust_heartbeat_time", value)
