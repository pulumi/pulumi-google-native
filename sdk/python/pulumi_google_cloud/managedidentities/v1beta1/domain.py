...
class Domain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: Output only. The unique name of the domain using the form: `projects/{project_id}/locations/global/domains/{domain_name}`.
        :param pulumi.Input[str] parent: Required. The resource project name and location using the form: `projects/{project_id}/locations/global`
