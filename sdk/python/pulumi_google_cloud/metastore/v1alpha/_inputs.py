...
class MetadataExportArgs:
    ...
    def destination_gcs_uri(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def destination_gcs_uri(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "destination_gcs_uri", value)
...
class MetadataManagementActivityArgs:
    ...
    def metadata_exports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MetadataExportArgs']]]]:
        """
...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 metadata_management_activity: Optional[pulumi.Input['MetadataManagementActivityArgs']] = None,
        ...
        :param pulumi.Input['MetadataManagementActivityArgs'] metadata_management_activity: Output only. The metadata management activities of the metastore service.
        ...
        if metadata_management_activity is not None:
    ...
    def metadata_management_activity(self) -> Optional[pulumi.Input['MetadataManagementActivityArgs']]:
        """
    ...
    def metadata_management_activity(self, value: Optional[pulumi.Input['MetadataManagementActivityArgs']]):
        pulumi.set(self, "metadata_management_activity", value)
