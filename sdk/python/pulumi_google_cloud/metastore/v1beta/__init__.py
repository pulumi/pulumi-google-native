...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "google-cloud:metastore/v1beta:Service":
                return Service(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:metastore/v1beta:ServiceBackup":
                return ServiceBackup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:metastore/v1beta:ServiceIamPolicy":
                return ServiceIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:metastore/v1beta:ServiceMetadataImport":
    ...
    pulumi.runtime.register_resource_module("google-cloud", "metastore/v1beta", _module_instance)
