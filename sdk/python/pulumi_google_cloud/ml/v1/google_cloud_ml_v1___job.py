...
__all__ = ['GoogleCloudMlV1__Job']


class GoogleCloudMlV1__Job(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudMlV1__Job, __self__).__init__(
            'google-cloud:ml/v1:GoogleCloudMlV1__Job',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudMlV1__Job':
        """
        ...
        return GoogleCloudMlV1__Job(resource_name, opts=opts, __props__=__props__)
