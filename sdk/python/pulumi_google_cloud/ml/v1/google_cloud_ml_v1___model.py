...
__all__ = ['GoogleCloudMlV1__Model']


class GoogleCloudMlV1__Model(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudMlV1__Model, __self__).__init__(
            'google-cloud:ml/v1:GoogleCloudMlV1__Model',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudMlV1__Model':
        """
        ...
        return GoogleCloudMlV1__Model(resource_name, opts=opts, __props__=__props__)
