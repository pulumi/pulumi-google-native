...
__all__ = ['GoogleLongrunning__Operation']


class GoogleLongrunning__Operation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The name of the model.
        ...
        if opts.id is None:
            ...
            __props__['auto_scaling'] = auto_scaling
            __props__['container'] = container
            __props__['create_time'] = create_time
            __props__['deployment_uri'] = deployment_uri
            __props__['description'] = description
            __props__['error_message'] = error_message
            __props__['etag'] = etag
            __props__['explanation_config'] = explanation_config
            ...
            __props__['name'] = name
            __props__['package_uris'] = package_uris
            if parent is None and not opts.urn:
                raise TypeError("Missing required property 'parent'")
            __props__['parent'] = parent
            __props__['prediction_class'] = prediction_class
            __props__['python_version'] = python_version
            __props__['request_logging_config'] = request_logging_config
            __props__['routes'] = routes
            __props__['runtime_version'] = runtime_version
            __props__['service_account'] = service_account
            __props__['state'] = state
        super(GoogleLongrunning__Operation, __self__).__init__(
            'google-cloud:ml/v1:GoogleLongrunning__Operation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleLongrunning__Operation':
        """
        ...
        return GoogleLongrunning__Operation(resource_name, opts=opts, __props__=__props__)
