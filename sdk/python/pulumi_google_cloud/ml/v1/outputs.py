...
class GoogleCloudMlV1_StudyConfig_ParameterSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a single parameter to optimize.
        :param 'GoogleCloudMlV1_StudyConfigParameterSpec_CategoricalValueSpecResponseArgs' categorical_value_spec: The value spec for a 'CATEGORICAL' parameter.
        :param Sequence['GoogleCloudMlV1_StudyConfig_ParameterSpecResponseArgs'] child_parameter_specs: A child node is active if the parameter's value matches the child node's matching_parent_values. If two items in child_parameter_specs have the same name, they must have disjoint matching_parent_values.
        :param 'GoogleCloudMlV1_StudyConfigParameterSpec_DiscreteValueSpecResponseArgs' discrete_value_spec: The value spec for a 'DISCRETE' parameter.
        :param 'GoogleCloudMlV1_StudyConfigParameterSpec_DoubleValueSpecResponseArgs' double_value_spec: The value spec for a 'DOUBLE' parameter.
        :param 'GoogleCloudMlV1_StudyConfigParameterSpec_IntegerValueSpecResponseArgs' integer_value_spec: The value spec for an 'INTEGER' parameter.
...
class GoogleCloudMlV1__AutoScalingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudMlV1__MetricSpecResponseArgs'] metrics: MetricSpec contains the specifications to use to calculate the desired nodes count.
...
class GoogleCloudMlV1__ContainerSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudMlV1__EnvVarResponseArgs'] env: Immutable. List of environment variables to set in the container. After the container starts running, code running in the container can read these environment variables. Additionally, the command and args fields can reference these variables. Later entries in this list can also reference earlier entries. For example, the following example sets the variable `VAR_2` to have the value `foo bar`: ```json [ { "name": "VAR_1", "value": "foo" }, { "name": "VAR_2", "value": "$(VAR_1) bar" } ] ``` If you switch the order of the variables in the example, then the expansion does not occur. This field corresponds to the `env` field of the [Kubernetes Containers v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#container-v1-core).
...
class GoogleCloudMlV1__ExplanationConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Message holding configuration options for explaining model predictions. There are three feature attribution methods supported for TensorFlow models: integrated gradients, sampled Shapley, and XRAI. [Learn more about feature attributions.](/ai-platform/prediction/docs/ai-explanations/overview)
        :param 'GoogleCloudMlV1__IntegratedGradientsAttributionResponseArgs' integrated_gradients_attribution: Attributes credit by computing the Aumann-Shapley value taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365
        :param 'GoogleCloudMlV1__SampledShapleyAttributionResponseArgs' sampled_shapley_attribution: An attribution method that approximates Shapley values for features that contribute to the label being predicted. A sampling strategy is used to approximate the value rather than considering all subsets of features.
        :param 'GoogleCloudMlV1__XraiAttributionResponseArgs' xrai_attribution: Attributes credit by computing the XRAI taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1906.02825 Currently only implemented for models with natural image inputs.
        """
...
class GoogleCloudMlV1__HyperparameterOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents the result of a single hyperparameter tuning trial from a training job. The TrainingOutput object that is returned on successful completion of a training job with hyperparameter tuning includes a list of HyperparameterOutput objects, one for each successful trial.
        :param Sequence['GoogleCloudMlV1_HyperparameterOutput_HyperparameterMetricResponseArgs'] all_metrics: All recorded object metrics for this trial. This field is not currently populated.
        :param 'GoogleCloudMlV1__BuiltInAlgorithmOutputResponseArgs' built_in_algorithm_output: Details related to built-in algorithms jobs. Only set for trials of built-in algorithms jobs that have succeeded.
        :param str end_time: End time for the trial.
        :param 'GoogleCloudMlV1_HyperparameterOutput_HyperparameterMetricResponseArgs' final_metric: The final objective metric seen for this trial.
...
class GoogleCloudMlV1__HyperparameterSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudMlV1__ParameterSpecResponseArgs'] params: Required. The set of parameters to tune.
...
class GoogleCloudMlV1__MeasurementResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudMlV1_Measurement_MetricResponseArgs'] metrics: Provides a list of metrics that act as inputs into the objective function.
...
class GoogleCloudMlV1__ReplicaConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents the configuration for a replica in a cluster.
        :param 'GoogleCloudMlV1__AcceleratorConfigResponseArgs' accelerator_config: Represents the type and number of accelerators used by the replica. [Learn about restrictions on accelerator configurations for training.](/ai-platform/training/docs/using-gpus#compute-engine-machine-types-with-gpu)
        ...
        :param 'GoogleCloudMlV1__DiskConfigResponseArgs' disk_config: Represents the configuration of disk options.
...
class GoogleCloudMlV1__StudyConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudMlV1__AutomatedStoppingConfigResponseArgs' automated_stopping_config: Configuration for automated stopping of unpromising Trials.
        :param Sequence['GoogleCloudMlV1_StudyConfig_MetricSpecResponseArgs'] metrics: Metric specs for the study.
        :param Sequence['GoogleCloudMlV1_StudyConfig_ParameterSpecResponseArgs'] parameters: Required. The set of parameters to tune.
        """
        pulumi.set(__self__, "algorithm", algorithm)
...
class GoogleCloudMlV1__TrainingInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudMlV1__HyperparameterSpecResponseArgs' hyperparameters: Optional. The set of Hyperparameters to tune.
        ...
        :param 'GoogleCloudMlV1__ReplicaConfigResponseArgs' parameter_server_config: Optional. The configuration for parameter servers. You should only set `parameterServerConfig.acceleratorConfig` if `parameterServerType` is set to a Compute Engine machine type. [Learn about restrictions on accelerator configurations for training.](/ai-platform/training/docs/using-gpus#compute-engine-machine-types-with-gpu) Set `parameterServerConfig.imageUri` only if you build a custom image for your parameter server. If `parameterServerConfig.imageUri` has not been set, AI Platform uses the value of `masterConfig.imageUri`. Learn more about [configuring custom containers](/ai-platform/training/docs/distributed-training-containers).
        ...
        :param 'GoogleCloudMlV1__SchedulingResponseArgs' scheduling: Optional. Scheduling options for a training job.
        ...
        :param 'GoogleCloudMlV1__ReplicaConfigResponseArgs' worker_config: Optional. The configuration for workers. You should only set `workerConfig.acceleratorConfig` if `workerType` is set to a Compute Engine machine type. [Learn about restrictions on accelerator configurations for training.](/ai-platform/training/docs/using-gpus#compute-engine-machine-types-with-gpu) Set `workerConfig.imageUri` only if you build a custom image for your worker. If `workerConfig.imageUri` has not been set, AI Platform uses the value of `masterConfig.imageUri`. Learn more about [configuring custom containers](/ai-platform/training/docs/distributed-training-containers).
...
class GoogleCloudMlV1__TrainingOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents results of a training job. Output only.
        :param 'GoogleCloudMlV1__BuiltInAlgorithmOutputResponseArgs' built_in_algorithm_output: Details related to built-in algorithms jobs. Only set for built-in algorithms jobs.
        ...
        :param Sequence['GoogleCloudMlV1__HyperparameterOutputResponseArgs'] trials: Results for individual Hyperparameter trials. Only set for hyperparameter tuning jobs.
        """
        pulumi.set(__self__, "built_in_algorithm_output", built_in_algorithm_output)
...
class GoogleCloudMlV1__VersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudMlV1__ExplanationConfigResponseArgs' explanation_config: Optional. Configures explainability features on the model's version. Some explanation features require additional metadata to be loaded as part of the model payload.
        ...
        :param 'GoogleCloudMlV1__ManualScalingResponseArgs' manual_scaling: Manually select the number of nodes to use for serving the model. You should generally use `auto_scaling` with an appropriate `min_nodes` instead, but this option is available if you want more predictable billing. Beware that latency and error rates will increase if the traffic exceeds that capability of the system to serve it based on the selected number of nodes.
        ...
        :param 'GoogleCloudMlV1__RequestLoggingConfigResponseArgs' request_logging_config: Optional. *Only* specify this field in a projects.models.versions.patch request. Specifying it in a projects.models.versions.create request has no effect. Configures the request-response pair logging on predictions from this Version.
        :param 'GoogleCloudMlV1__RouteMapResponseArgs' routes: Optional. Specifies paths on a custom container's HTTP server where AI Platform Prediction sends certain requests. If you specify this field, then you must also specify the `container` field. If you specify the `container` field and do not specify this field, it defaults to the following: ```json { "predict": "/v1/models/MODEL/versions/VERSION:predict", "health": "/v1/models/MODEL/versions/VERSION" } ``` See RouteMap for more details about these default values.
...
class GoogleIamV1__AuditConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the audit configuration for a service. The configuration determines which permission types are logged, and what identities, if any, are exempted from logging. An AuditConfig must have one or more AuditLogConfigs. If there are AuditConfigs for both `allServices` and a specific service, the union of the two AuditConfigs is used for that service: the log_types specified in each AuditConfig are enabled, and the exempted_members in each AuditLogConfig are exempted. Example Policy with multiple AuditConfigs: { "audit_configs": [ { "service": "allServices", "audit_log_configs": [ { "log_type": "DATA_READ", "exempted_members": [ "user:jose@example.com" ] }, { "log_type": "DATA_WRITE" }, { "log_type": "ADMIN_READ" } ] }, { "service": "sampleservice.googleapis.com", "audit_log_configs": [ { "log_type": "DATA_READ" }, { "log_type": "DATA_WRITE", "exempted_members": [ "user:aliya@example.com" ] } ] } ] } For sampleservice, this policy enables DATA_READ, DATA_WRITE and ADMIN_READ logging. It also exempts jose@example.com from DATA_READ logging, and aliya@example.com from DATA_WRITE logging.
        :param Sequence['GoogleIamV1__AuditLogConfigResponseArgs'] audit_log_configs: The configuration for logging of each type of permission.
