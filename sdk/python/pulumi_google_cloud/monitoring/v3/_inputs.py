...
class TimeSeriesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MonitoredResourceArgs'] resource: The associated monitored resource. Custom metrics can use only certain monitored resource types in their time series data.
