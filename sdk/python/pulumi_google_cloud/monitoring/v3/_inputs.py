...
class CollectdPayloadArgs:
    def __init__(__self__, *,
                 ...
                 type_instance: Optional[pulumi.Input[str]] = None,
                 values: Optional[pulumi.Input[Sequence[pulumi.Input['CollectdValueArgs']]]] = None):
        """
        A collection of data points sent from a collectd-based plugin. See the collectd documentation for more information.
        :param pulumi.Input[str] end_time: The end time of the interval.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] metadata: The measurement metadata. Example: "process_id" -> 12345
        :param pulumi.Input[str] plugin: The name of the plugin. Example: "disk".
        :param pulumi.Input[str] plugin_instance: The instance name of the plugin Example: "hdcl".
        :param pulumi.Input[str] start_time: The start time of the interval.
        :param pulumi.Input[str] type: The measurement type. Example: "memory".
        :param pulumi.Input[str] type_instance: The measurement type instance. Example: "used".
        :param pulumi.Input[Sequence[pulumi.Input['CollectdValueArgs']]] values: The measured values during this time interval. Each value must have a different data_source_name.
        """
        ...
        if type_instance is not None:
            pulumi.set(__self__, "type_instance", type_instance)
    ...
    def plugin_instance(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def plugin_instance(self, value: Optional[pulumi.Input[str]]):
    ...
    @property
    @pulumi.getter(name="typeInstance")
    def type_instance(self) -> Optional[pulumi.Input[str]]:
        """
        The measurement type instance. Example: "used".
        """
        return pulumi.get(self, "type_instance")

    @type_instance.setter
    def type_instance(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "type_instance", value)

    @property
    @pulumi.getter
    def values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CollectdValueArgs']]]]:
        """
    ...
    @values.setter
    def values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CollectdValueArgs']]]]):
        pulumi.set(self, "values", value)


@pulumi.input_type
class CollectdValueArgs:
    def __init__(__self__, *,
                 data_source_name: Optional[pulumi.Input[str]] = None,
                 data_source_type: Optional[pulumi.Input[str]] = None,
                 value: Optional[pulumi.Input['TypedValueArgs']] = None):
        """
        A single data point from a collectd-based plugin.
        :param pulumi.Input[str] data_source_name: The data source for the collectd value. For example, there are two data sources for network measurements: "rx" and "tx".
        :param pulumi.Input[str] data_source_type: The type of measurement.
        :param pulumi.Input['TypedValueArgs'] value: The measurement value.
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[pulumi.Input['TypedValueArgs']]:
        """
    ...
    @value.setter
    def value(self, value: Optional[pulumi.Input['TypedValueArgs']]):
...
class DistributionArgs:
    def __init__(__self__, *,
                 bucket_counts: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 bucket_options: Optional[pulumi.Input['BucketOptionsArgs']] = None,
                 count: Optional[pulumi.Input[str]] = None,
                 exemplars: Optional[pulumi.Input[Sequence[pulumi.Input['ExemplarArgs']]]] = None,
                 mean: Optional[pulumi.Input[float]] = None,
                 range: Optional[pulumi.Input['RangeArgs']] = None,
                 sum_of_squared_deviation: Optional[pulumi.Input[float]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] bucket_counts: Required in the Cloud Monitoring API v3. The values for each bucket specified in bucket_options. The sum of the values in bucketCounts must equal the value in the count field of the Distribution object. The order of the bucket counts follows the numbering schemes described for the three bucket types. The underflow bucket has number 0; the finite buckets, if any, have numbers 1 through N-2; and the overflow bucket has number N-1. The size of bucket_counts must not be greater than N. If the size is less than N, then the remaining buckets are assigned values of zero.
        :param pulumi.Input['BucketOptionsArgs'] bucket_options: Required in the Cloud Monitoring API v3. Defines the histogram bucket boundaries.
        :param pulumi.Input[str] count: The number of values in the population. Must be non-negative. This value must equal the sum of the values in bucket_counts if a histogram is provided.
        :param pulumi.Input[Sequence[pulumi.Input['ExemplarArgs']]] exemplars: Must be in increasing order of value field.
        :param pulumi.Input[float] mean: The arithmetic mean of the values in the population. If count is zero then this field must be zero.
        :param pulumi.Input['RangeArgs'] range: If specified, contains the range of the population values. The field must not be present if the count is zero. This field is presently ignored by the Cloud Monitoring API v3.
        :param pulumi.Input[float] sum_of_squared_deviation: The sum of squared deviations from the mean of the values in the population. For values x_i this is: Sum[i=1..n]((x_i - mean)^2) Knuth, "The Art of Computer Programming", Vol. 2, page 232, 3rd edition describes Welford's method for accumulating this sum in one pass.If count is zero then this field must be zero.
        """
        if bucket_counts is not None:
            pulumi.set(__self__, "bucket_counts", bucket_counts)
        if bucket_options is not None:
            pulumi.set(__self__, "bucket_options", bucket_options)
        if count is not None:
            pulumi.set(__self__, "count", count)
        if exemplars is not None:
            pulumi.set(__self__, "exemplars", exemplars)
        if mean is not None:
            pulumi.set(__self__, "mean", mean)
        if range is not None:
            pulumi.set(__self__, "range", range)
        if sum_of_squared_deviation is not None:
            pulumi.set(__self__, "sum_of_squared_deviation", sum_of_squared_deviation)

    @property
    @pulumi.getter(name="bucketCounts")
    def bucket_counts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        Required in the Cloud Monitoring API v3. The values for each bucket specified in bucket_options. The sum of the values in bucketCounts must equal the value in the count field of the Distribution object. The order of the bucket counts follows the numbering schemes described for the three bucket types. The underflow bucket has number 0; the finite buckets, if any, have numbers 1 through N-2; and the overflow bucket has number N-1. The size of bucket_counts must not be greater than N. If the size is less than N, then the remaining buckets are assigned values of zero.
        """
        return pulumi.get(self, "bucket_counts")

    @bucket_counts.setter
    def bucket_counts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "bucket_counts", value)
    ...
    @property
    @pulumi.getter
    def exemplars(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ExemplarArgs']]]]:
        """
        Must be in increasing order of value field.
        """
        return pulumi.get(self, "exemplars")

    @exemplars.setter
    def exemplars(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ExemplarArgs']]]]):
        pulumi.set(self, "exemplars", value)
    ...
    @property
    @pulumi.getter
    def range(self) -> Optional[pulumi.Input['RangeArgs']]:
        """
    ...
    @range.setter
    def range(self, value: Optional[pulumi.Input['RangeArgs']]):
        pulumi.set(self, "range", value)

    @property
    @pulumi.getter(name="sumOfSquaredDeviation")
    def sum_of_squared_deviation(self) -> Optional[pulumi.Input[float]]:
        """
        ...
        """
        return pulumi.get(self, "sum_of_squared_deviation")

    @sum_of_squared_deviation.setter
    def sum_of_squared_deviation(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "sum_of_squared_deviation", value)
...
class ExemplarArgs:
    def __init__(__self__, *,
                 attachments: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[str]]]]]] = None,
                 timestamp: Optional[pulumi.Input[str]] = None,
                 value: Optional[pulumi.Input[float]] = None):
        """
        Exemplars are example points that may be used to annotate aggregated distribution values. They are metadata that gives information about a particular value added to a Distribution bucket, such as a trace ID that was active when a value was added. They may contain further information, such as a example values and timestamps, origin, etc.
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[str]]]]] attachments: Contextual information about the example value. Examples are:Trace: type.googleapis.com/google.monitoring.v3.SpanContextLiteral string: type.googleapis.com/google.protobuf.StringValueLabels dropped during aggregation: type.googleapis.com/google.monitoring.v3.DroppedLabelsThere may be only a single attachment of any given message type in a single exemplar, and this is enforced by the system.
        :param pulumi.Input[str] timestamp: The observation (sampling) time of the above value.
        :param pulumi.Input[float] value: Value of the exemplar point. This value determines to which bucket the exemplar belongs.
        """
    ...
    @property
    @pulumi.getter
    def attachments(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[str]]]]]]:
        """
    ...
    @attachments.setter
    def attachments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[str]]]]]]):
...
class MetricArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: The set of label values that uniquely identify this metric. All labels listed in the MetricDescriptor must be assigned values.
        :param pulumi.Input[str] type: An existing metric type, see google.api.MetricDescriptor. For example, custom.googleapis.com/invoice/paid/amount.
        """
...
@pulumi.input_type
class MonitoredResourceMetadataArgs:
    def __init__(__self__, *,
...
class PointArgs:
    def __init__(__self__, *,
                 interval: Optional[pulumi.Input['TimeIntervalArgs']] = None,
                 value: Optional[pulumi.Input['TypedValueArgs']] = None):
        """
        A single data point in a time series.
        :param pulumi.Input['TimeIntervalArgs'] interval: The time interval to which the data point applies. For GAUGE metrics, the start time is optional, but if it is supplied, it must equal the end time. For DELTA metrics, the start and end time should specify a non-zero interval, with subsequent points specifying contiguous and non-overlapping intervals. For CUMULATIVE metrics, the start and end time should specify a non-zero interval, with subsequent points specifying the same start time and increasing end times, until an event resets the cumulative value to zero and sets a new start time for the following points.
        :param pulumi.Input['TypedValueArgs'] value: The value of the data point.
        """
    ...
    @property
    @pulumi.getter
    def interval(self) -> Optional[pulumi.Input['TimeIntervalArgs']]:
        """
    ...
    @interval.setter
    def interval(self, value: Optional[pulumi.Input['TimeIntervalArgs']]):
...
class RangeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] max: The maximum of the population values.
        :param pulumi.Input[float] min: The minimum of the population values.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class TimeIntervalArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] end_time: Required. The end of the time interval.
...
class TimeSeriesArgs:
    def __init__(__self__, *,
                 metadata: Optional[pulumi.Input['MonitoredResourceMetadataArgs']] = None,
                 metric: Optional[pulumi.Input['MetricArgs']] = None,
                 metric_kind: Optional[pulumi.Input[str]] = None,
                 points: Optional[pulumi.Input[Sequence[pulumi.Input['PointArgs']]]] = None,
                 resource: Optional[pulumi.Input['MonitoredResourceArgs']] = None,
        ...
        :param pulumi.Input['MonitoredResourceArgs'] resource: The associated monitored resource. Custom metrics can use only certain monitored resource types in their time series data. For more information, see Monitored resources for custom metrics (https://cloud.google.com/monitoring/custom-metrics/creating-metrics#custom-metric-resources).
        :param pulumi.Input[str] unit: The units in which the metric value is reported. It is only applicable if the value_type is INT64, DOUBLE, or DISTRIBUTION. The unit defines the representation of the stored metric values.
        :param pulumi.Input[str] value_type: The value type of the time series. When listing time series, this value type might be different from the value type of the associated metric if this time series is an alignment or reduction of other time series.When creating a time series, this field is optional. If present, it must be the same as the type of the data in the points field.
        """
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)
    ...
    @metadata.setter
    def metadata(self, value: Optional[pulumi.Input['MonitoredResourceMetadataArgs']]):
        pulumi.set(self, "metadata", value)

    @property
    @pulumi.getter
    def metric(self) -> Optional[pulumi.Input['MetricArgs']]:
        """
    ...
    @metric.setter
    def metric(self, value: Optional[pulumi.Input['MetricArgs']]):
    ...
    @property
    @pulumi.getter
    def points(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['PointArgs']]]]:
        """
        The data points of this time series. When listing time series, points are returned in reverse time order.When creating a time series, this field must contain exactly one point and the point's type must be the same as the value type of the associated metric. If the associated metric's descriptor must be auto-created, then the value type of the descriptor is determined by the point's type, which must be BOOL, INT64, DOUBLE, or DISTRIBUTION.
        """
    ...
    @points.setter
    def points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['PointArgs']]]]):
        pulumi.set(self, "points", value)

    @property
    @pulumi.getter
    def resource(self) -> Optional[pulumi.Input['MonitoredResourceArgs']]:
        """
    ...
    @resource.setter
    def resource(self, value: Optional[pulumi.Input['MonitoredResourceArgs']]):
...
@pulumi.input_type
class TypedValueArgs:
    def __init__(__self__, *,
                 bool_value: Optional[pulumi.Input[bool]] = None,
                 distribution_value: Optional[pulumi.Input['DistributionArgs']] = None,
                 double_value: Optional[pulumi.Input[float]] = None,
                 int64_value: Optional[pulumi.Input[str]] = None,
                 string_value: Optional[pulumi.Input[str]] = None):
        """
        A single strongly-typed value.
        :param pulumi.Input[bool] bool_value: A Boolean value: true or false.
        :param pulumi.Input['DistributionArgs'] distribution_value: A distribution value.
        :param pulumi.Input[float] double_value: A 64-bit double-precision floating-point number. Its magnitude is approximately ±10±300 and it has 16 significant digits of precision.
        :param pulumi.Input[str] int64_value: A 64-bit integer. Its range is approximately ±9.2x1018.
        :param pulumi.Input[str] string_value: A variable-length string value.
        """
        if bool_value is not None:
            pulumi.set(__self__, "bool_value", bool_value)
        if distribution_value is not None:
            pulumi.set(__self__, "distribution_value", distribution_value)
    ...
    @property
    @pulumi.getter(name="distributionValue")
    def distribution_value(self) -> Optional[pulumi.Input['DistributionArgs']]:
        """
        A distribution value.
        """
        return pulumi.get(self, "distribution_value")

    @distribution_value.setter
    def distribution_value(self, value: Optional[pulumi.Input['DistributionArgs']]):
        pulumi.set(self, "distribution_value", value)
