...
__all__ = ['CreateCollectdTimeSeriesResponse']


class CreateCollectdTimeSeriesResponse(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: The project in which to create the time series. The format is: projects/[PROJECT_ID_OR_NUMBER] 
        ...
        super(CreateCollectdTimeSeriesResponse, __self__).__init__(
            'google-cloud:monitoring/v3:CreateCollectdTimeSeriesResponse',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CreateCollectdTimeSeriesResponse':
        """
        ...
        return CreateCollectdTimeSeriesResponse(resource_name, opts=opts, __props__=__props__)
