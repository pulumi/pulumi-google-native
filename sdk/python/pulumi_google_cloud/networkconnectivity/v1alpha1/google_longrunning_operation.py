...
class GoogleLongrunningOperation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The parent's resource name of the Spoke.
        ...
        if opts.id is None:
            ...
            __props__['spoke_id'] = spoke_id
            __props__['state'] = state
            __props__['unique_id'] = unique_id
            __props__['update_time'] = update_time
        super(GoogleLongrunningOperation, __self__).__init__(
            'google-cloud:networkconnectivity/v1alpha1:GoogleLongrunningOperation',
            resource_name,
            __props__,
            opts)
