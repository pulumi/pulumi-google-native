...
__all__ = [
    ...
    'GKEMasterInfoArgs',
    'InstanceInfoArgs',
    'LatencyDistributionArgs',
    'LatencyPercentileArgs',
...
@pulumi.input_type
class CloudSQLInstanceInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] display_name: Name of a Cloud SQL instance.
        :param pulumi.Input[str] external_ip: External IP address of Cloud SQL instance.
        :param pulumi.Input[str] internal_ip: Internal IP address of Cloud SQL instance.
        :param pulumi.Input[str] network_uri: URI of a Cloud SQL instance network or empty string if instance does not have one.
        :param pulumi.Input[str] region: Region in which the Cloud SQL instance is running.
        :param pulumi.Input[str] uri: URI of a Cloud SQL instance.
        """
...
@pulumi.input_type
class GKEMasterInfoArgs:
    def __init__(__self__, *,
                 cluster_network_uri: Optional[pulumi.Input[str]] = None,
                 cluster_uri: Optional[pulumi.Input[str]] = None,
                 external_ip: Optional[pulumi.Input[str]] = None,
                 internal_ip: Optional[pulumi.Input[str]] = None):
        """
        For display only. Metadata associated with a Google Kubernetes Engine cluster master.
        :param pulumi.Input[str] cluster_network_uri: URI of a Google Kubernetes Engine cluster network.
        :param pulumi.Input[str] cluster_uri: URI of a Google Kubernetes Engine cluster.
        :param pulumi.Input[str] external_ip: External IP address of a Google Kubernetes Engine cluster master.
        :param pulumi.Input[str] internal_ip: Internal IP address of a Google Kubernetes Engine cluster master.
        """
        if cluster_network_uri is not None:
            pulumi.set(__self__, "cluster_network_uri", cluster_network_uri)
        if cluster_uri is not None:
    ...
    def cluster_network_uri(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def cluster_network_uri(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "cluster_network_uri", value)

    @property
    @pulumi.getter(name="clusterUri")
    def cluster_uri(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @cluster_uri.setter
    def cluster_uri(self, value: Optional[pulumi.Input[str]]):
...
@pulumi.input_type
class LatencyDistributionArgs:
    def __init__(__self__, *,
                 latency_percentiles: Optional[pulumi.Input[Sequence[pulumi.Input['LatencyPercentileArgs']]]] = None):
        """
        Describes measured latency distribution.
        :param pulumi.Input[Sequence[pulumi.Input['LatencyPercentileArgs']]] latency_percentiles: Representative latency percentiles.
        """
    ...
    def latency_percentiles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['LatencyPercentileArgs']]]]:
        """
    ...
    def latency_percentiles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['LatencyPercentileArgs']]]]):
        pulumi.set(self, "latency_percentiles", value)


@pulumi.input_type
class LatencyPercentileArgs:
    def __init__(__self__, *,
                 latency_micros: Optional[pulumi.Input[str]] = None,
                 percent: Optional[pulumi.Input[int]] = None):
        """
        Latency percentile rank and value.
        :param pulumi.Input[str] latency_micros: percent-th percentile of latency observed, in microseconds. Fraction of percent/100 of samples have latency lower or equal to the value of this field.
        :param pulumi.Input[int] percent: Percentage of samples this data point applies to.
        """
    ...
    def latency_micros(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def latency_micros(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "latency_micros", value)
...
@pulumi.input_type
class ProbingDetailsArgs:
    def __init__(__self__, *,
                 abort_cause: Optional[pulumi.Input[str]] = None,
                 endpoint_info: Optional[pulumi.Input['EndpointInfoArgs']] = None,
                 error: Optional[pulumi.Input['StatusArgs']] = None,
                 probing_latency: Optional[pulumi.Input['LatencyDistributionArgs']] = None,
                 result: Optional[pulumi.Input[str]] = None,
                 sent_probe_count: Optional[pulumi.Input[int]] = None,
    ...
    @abort_cause.setter
    def abort_cause(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "abort_cause", value)
    ...
    def probing_latency(self, value: Optional[pulumi.Input['LatencyDistributionArgs']]):
        pulumi.set(self, "probing_latency", value)
    ...
    def sent_probe_count(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def sent_probe_count(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "sent_probe_count", value)
    ...
    def successful_probe_count(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "successful_probe_count", value)
...
class StepArgs:
    def __init__(__self__, *,
                 ...
                 cloud_sql_instance: Optional[pulumi.Input['CloudSQLInstanceInfoArgs']] = None,
                 ...
                 gke_master: Optional[pulumi.Input['GKEMasterInfoArgs']] = None,
        ...
        :param pulumi.Input['CloudSQLInstanceInfoArgs'] cloud_sql_instance: Display info of a Cloud SQL instance.
        ...
        :param pulumi.Input['GKEMasterInfoArgs'] gke_master: Display info of a Google Kubernetes Engine cluster master.
    ...
    @property
    @pulumi.getter(name="cloudSqlInstance")
    def cloud_sql_instance(self) -> Optional[pulumi.Input['CloudSQLInstanceInfoArgs']]:
        """
    ...
    @cloud_sql_instance.setter
    def cloud_sql_instance(self, value: Optional[pulumi.Input['CloudSQLInstanceInfoArgs']]):
        pulumi.set(self, "cloud_sql_instance", value)
    ...
    def gke_master(self) -> Optional[pulumi.Input['GKEMasterInfoArgs']]:
        """
    ...
    @gke_master.setter
    def gke_master(self, value: Optional[pulumi.Input['GKEMasterInfoArgs']]):
        pulumi.set(self, "gke_master", value)
