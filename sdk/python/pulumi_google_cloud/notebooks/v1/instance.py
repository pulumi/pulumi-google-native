...
class Instance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] create_time: Output only. Instance creation time.
        ...
        :param pulumi.Input[str] name: Output only. The name of this notebook instance. Format: `projects/{project_id}/locations/{location}/instances/{instance_id}`
