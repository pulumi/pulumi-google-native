...
__all__ = ['GoogleCloudOrgpolicyV2Policy']


class GoogleCloudOrgpolicyV2Policy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The Cloud resource that will parent the new Policy. Must be in one of the following forms: * `projects/{project_number}` * `projects/{project_id}` * `folders/{folder_id}` * `organizations/{organization_id}`
        ...
        if opts.id is None:
            ...
            __props__['spec'] = spec
        super(GoogleCloudOrgpolicyV2Policy, __self__).__init__(
            'google-cloud:orgpolicy/v2:GoogleCloudOrgpolicyV2Policy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudOrgpolicyV2Policy':
        """
        ...
        return GoogleCloudOrgpolicyV2Policy(resource_name, opts=opts, __props__=__props__)
