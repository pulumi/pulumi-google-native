...
class GoogleLongrunningOperation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 results_summary: Optional[pulumi.Input[pulumi.InputType['GoogleCloudPolicysimulatorV1beta1ReplayResultsSummaryArgs']]] = None,
        ...
        :param pulumi.Input[str] parent: Required. The parent resource where this Replay will be created. This resource must be a project, folder, or organization with a location. Example: `projects/my-example-project/locations/global`
        :param pulumi.Input[pulumi.InputType['GoogleCloudPolicysimulatorV1beta1ReplayResultsSummaryArgs']] results_summary: Output only. Summary statistics about the replayed log entries.
        ...
        super(GoogleLongrunningOperation, __self__).__init__(
            'google-cloud:policysimulator/v1beta1:GoogleLongrunningOperation',
            resource_name,
            __props__,
            opts)
