...
__all__ = ['CertificateAuthorityCertificateRevocationListIamPolicy']
...
class CertificateAuthorityCertificateRevocationListIamPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['certificate_revocation_lists_id'] = certificate_revocation_lists_id
        ...
        super(CertificateAuthorityCertificateRevocationListIamPolicy, __self__).__init__(
            'google-cloud:privateca/v1beta1:CertificateAuthorityCertificateRevocationListIamPolicy',
            resource_name,
            __props__,
            opts)
