...
__all__ = ['GoogleCloudRecommendationengineV1beta1CatalogItem']


class GoogleCloudRecommendationengineV1beta1CatalogItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. The parent catalog resource name, such as "projects/*/locations/global/catalogs/default_catalog".
        ...
        super(GoogleCloudRecommendationengineV1beta1CatalogItem, __self__).__init__(
            'google-cloud:recommendationengine/v1beta1:GoogleCloudRecommendationengineV1beta1CatalogItem',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudRecommendationengineV1beta1CatalogItem':
        """
        ...
        return GoogleCloudRecommendationengineV1beta1CatalogItem(resource_name, opts=opts, __props__=__props__)
