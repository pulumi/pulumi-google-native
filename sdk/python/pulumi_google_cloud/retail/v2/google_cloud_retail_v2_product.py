...
__all__ = ['GoogleCloudRetailV2Product']


class GoogleCloudRetailV2Product(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
            __props__['uri'] = uri
        super(GoogleCloudRetailV2Product, __self__).__init__(
            'google-cloud:retail/v2:GoogleCloudRetailV2Product',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudRetailV2Product':
        """
        ...
        return GoogleCloudRetailV2Product(resource_name, opts=opts, __props__=__props__)
