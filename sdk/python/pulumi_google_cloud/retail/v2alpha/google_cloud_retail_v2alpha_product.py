...
__all__ = ['GoogleCloudRetailV2alphaProduct']


class GoogleCloudRetailV2alphaProduct(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] type: Immutable. The type of the product. This field is output-only.
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
            __props__['uri'] = uri
        super(GoogleCloudRetailV2alphaProduct, __self__).__init__(
            'google-cloud:retail/v2alpha:GoogleCloudRetailV2alphaProduct',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudRetailV2alphaProduct':
        """
        ...
        return GoogleCloudRetailV2alphaProduct(resource_name, opts=opts, __props__=__props__)
