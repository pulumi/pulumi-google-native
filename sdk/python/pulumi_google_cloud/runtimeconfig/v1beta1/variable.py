...
class Variable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: The path to the RutimeConfig resource that this variable should belong to. The configuration must exist beforehand; the path must be in the format: `projects/[PROJECT_ID]/configs/[CONFIG_NAME]`
        ...
        :param pulumi.Input[str] state: Output only. The current state of the variable. The variable state indicates the outcome of the `variables().watch` call and is visible through the `get` and `list` calls.
        ...
        :param pulumi.Input[str] update_time: Output only. The time of the last variable update. Timestamp will be UTC timestamp.
