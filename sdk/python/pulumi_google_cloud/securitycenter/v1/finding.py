...
class Finding(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(Finding, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Finding':
        """
        ...
        return Finding(resource_name, opts=opts, __props__=__props__)
