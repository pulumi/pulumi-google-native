...
__all__ = ['GoogleCloudSecuritycenterV1beta1Finding']


class GoogleCloudSecuritycenterV1beta1Finding(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 finding_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 parent: Optional[pulumi.Input[str]] = None,
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 security_marks: Optional[pulumi.Input[pulumi.InputType['GoogleCloudSecuritycenterV1beta1SecurityMarksArgs']]] = None,
        ...
        :param pulumi.Input[str] finding_id: Required. Unique identifier provided by the client within the parent scope. It must be alphanumeric and less than or equal to 32 characters and greater than 0 characters in length.
        ...
        :param pulumi.Input[str] parent: Immutable. The relative resource name of the source the finding belongs to. See: https://cloud.google.com/apis/design/resource_names#relative_resource_name This field is immutable after creation time. For example: "organizations/{organization_id}/sources/{source_id}"
        ...
        :param pulumi.Input[pulumi.InputType['GoogleCloudSecuritycenterV1beta1SecurityMarksArgs']] security_marks: Output only. User specified security marks. These marks are entirely managed by the user and come from the SecurityMarks resource that belongs to the finding.
        ...
        if opts.id is None:
            ...
            __props__['finding_id'] = finding_id
            __props__['name'] = name
        ...
        super(GoogleCloudSecuritycenterV1beta1Finding, __self__).__init__(
            'google-cloud:securitycenter/v1beta1:GoogleCloudSecuritycenterV1beta1Finding',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudSecuritycenterV1beta1Finding':
        """
        Get an existing GoogleCloudSecuritycenterV1beta1Finding resource's state with the given name, id, and optional extra
        ...
        return GoogleCloudSecuritycenterV1beta1Finding(resource_name, opts=opts, __props__=__props__)
