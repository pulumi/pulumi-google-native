...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "google-cloud:servicedirectory/v1beta1:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:servicedirectory/v1beta1:NamespaceIamPolicy":
                return NamespaceIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:servicedirectory/v1beta1:NamespaceService":
                return NamespaceService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:servicedirectory/v1beta1:NamespaceServiceEndpoint":
                return NamespaceServiceEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-cloud:servicedirectory/v1beta1:NamespaceServiceIamPolicy":
    ...
    pulumi.runtime.register_resource_module("google-cloud", "servicedirectory/v1beta1", _module_instance)
