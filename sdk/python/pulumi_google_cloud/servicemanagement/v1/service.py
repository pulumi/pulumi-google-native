...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[int] config_version: This field is obsolete. Its value must be set to `3`.
        ...
        :param pulumi.Input[str] service_name: Required. The name of the service. See the [overview](/service-management/overview) for naming requirements. For example: `example.googleapis.com`.
        ...
        super(Service, __self__).__init__(
            'google-cloud:servicemanagement/v1:Service',
            resource_name,
            __props__,
            opts)
