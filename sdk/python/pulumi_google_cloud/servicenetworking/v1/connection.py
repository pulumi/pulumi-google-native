...
class Connection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: The service that is managing peering connectivity for a service producer's organization. For Google services that support this functionality, this value is `services/servicenetworking.googleapis.com`.
        ...
        super(Connection, __self__).__init__(
            'google-cloud:servicenetworking/v1:Connection',
            resource_name,
            __props__,
            opts)
