...
__all__ = ['GoogleCloudServicenetworkingV1betaConnection']


class GoogleCloudServicenetworkingV1betaConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(GoogleCloudServicenetworkingV1betaConnection, __self__).__init__(
            'google-cloud:servicenetworking/v1beta:GoogleCloudServicenetworkingV1betaConnection',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GoogleCloudServicenetworkingV1betaConnection':
        """
        ...
        return GoogleCloudServicenetworkingV1betaConnection(resource_name, opts=opts, __props__=__props__)
