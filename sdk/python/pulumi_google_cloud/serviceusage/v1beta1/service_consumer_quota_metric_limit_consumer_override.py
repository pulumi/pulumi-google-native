...
__all__ = ['ServiceConsumerQuotaMetricLimitConsumerOverride']


class ServiceConsumerQuotaMetricLimitConsumerOverride(pulumi.CustomResource):
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 admin_override_ancestor: Optional[pulumi.Input[str]] = None,
                 consumer_overrides_id: Optional[pulumi.Input[str]] = None,
        ...
        if opts.id is None:
            ...
            if consumer_overrides_id is None and not opts.urn:
                raise TypeError("Missing required property 'consumer_overrides_id'")
            __props__['consumer_overrides_id'] = consumer_overrides_id
        ...
        super(ServiceConsumerQuotaMetricLimitConsumerOverride, __self__).__init__(
            'google-cloud:serviceusage/v1beta1:ServiceConsumerQuotaMetricLimitConsumerOverride',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServiceConsumerQuotaMetricLimitConsumerOverride':
        """
        ...
        return ServiceConsumerQuotaMetricLimitConsumerOverride(resource_name, opts=opts, __props__=__props__)
