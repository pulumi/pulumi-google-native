...
__all__ = ['PerfMetricsSummary']


class PerfMetricsSummary(pulumi.CustomResource):
    def __init__(__self__,
        ...
        super(PerfMetricsSummary, __self__).__init__(
            'google-cloud:toolresults/v1beta3:PerfMetricsSummary',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PerfMetricsSummary':
        """
        ...
        return PerfMetricsSummary(resource_name, opts=opts, __props__=__props__)
