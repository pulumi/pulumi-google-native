...
class Step(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] execution_id: Required. An Execution id.
        ...
        :param pulumi.Input[str] history_id: Required. A History id.
        ...
        :param pulumi.Input[str] project_id: Required. A Project id.
        ...
        super(Step, __self__).__init__(
            'google-cloud:toolresults/v1beta3:Step',
            resource_name,
            __props__,
            opts)
