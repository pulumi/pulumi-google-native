...
class ReferenceImage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. Resource name of the product in which to create the reference image. Format is `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID`.
        ...
        if opts.id is None:
            ...
            __props__['reference_image_id'] = reference_image_id
            __props__['uri'] = uri
