...
class Execution(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] parent: Required. Name of the workflow for which an execution should be created. Format: projects/{project}/locations/{location}/workflows/{workflow} The latest revision of the workflow will be used.
        ...
        super(Execution, __self__).__init__(
            'google-cloud:workflowexecutions/v1:Execution',
            resource_name,
            __props__,
            opts)
