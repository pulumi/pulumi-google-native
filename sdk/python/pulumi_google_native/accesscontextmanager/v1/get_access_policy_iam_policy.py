...
def get_access_policy_iam_policy(access_policy_id: Optional[str] = None,
...
def get_access_policy_iam_policy_output(access_policy_id: Optional[pulumi.Input[str]] = None,
