...
__all__ = ['OrganizationGcpUserAccessBindingArgs', 'OrganizationGcpUserAccessBinding']
...
class OrganizationGcpUserAccessBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OrganizationGcpUserAccessBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a GcpUserAccessBinding. If the client specifies a name, the server will ignore it. Fails if a resource already exists with the same group_key. Completion of this long-running operation does not necessarily signify that the new binding is deployed onto all affected users, which may take more time.

        :param str resource_name: The name of the resource.
        :param OrganizationGcpUserAccessBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationGcpUserAccessBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
