...
class EgressFromResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the conditions under which an EgressPolicy matches a request. Conditions based on information about the source of the request. Note that if the destination of the request is also protected by a ServicePerimeter, then that ServicePerimeter must have an IngressPolicy which allows access in order for this request to succeed.
        :param Sequence[str] identities: A list of identities that are allowed access through this [EgressPolicy], in the format of `user:{email_id}` or `serviceAccount:{email_id}`.
...
class IngressFromResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the conditions under which an IngressPolicy matches a request. Conditions are based on information about the source of the request. The request must satisfy what is defined in `sources` AND identity related fields in order to match.
        :param Sequence[str] identities: A list of identities that are allowed access through this ingress policy, in the format of `user:{email_id}` or `serviceAccount:{email_id}`.
...
class MethodSelectorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An allowed method or permission of a service specified in ApiOperation.
        :param str method: A valid method name for the corresponding `service_name` in ApiOperation. If `*` is used as the value for the `method`, then ALL methods and permissions are allowed.
        :param str permission: A valid Cloud IAM permission for the corresponding `service_name` in ApiOperation.
        """
