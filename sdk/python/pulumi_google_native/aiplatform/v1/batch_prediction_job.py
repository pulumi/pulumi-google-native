...
class BatchPredictionJobArgs:
    def __init__(__self__, *,
                 ...
                 input_config: pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobInputConfigArgs'],
                 output_config: pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobOutputConfigArgs'],
                 dedicated_resources: Optional[pulumi.Input['GoogleCloudAiplatformV1BatchDedicatedResourcesArgs']] = None,
                 ...
                 instance_config: Optional[pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigArgs']] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 manual_batch_tuning_parameters: Optional[pulumi.Input['GoogleCloudAiplatformV1ManualBatchTuningParametersArgs']] = None,
                 model: Optional[pulumi.Input[str]] = None,
                 model_parameters: Optional[Any] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 service_account: Optional[pulumi.Input[str]] = None,
                 unmanaged_container_model: Optional[pulumi.Input['GoogleCloudAiplatformV1UnmanagedContainerModelArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobInputConfigArgs'] input_config: Input configuration of the instances on which predictions are performed. The schema of any single instance may be specified via the Model's PredictSchemata's instance_schema_uri.
        :param pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobOutputConfigArgs'] output_config: The Configuration specifying where output predictions should be written. The schema of any single prediction may be specified as a concatenation of Model's PredictSchemata's instance_schema_uri and prediction_schema_uri.
        :param pulumi.Input['GoogleCloudAiplatformV1BatchDedicatedResourcesArgs'] dedicated_resources: The config of resources used by the Model during the batch prediction. If the Model supports DEDICATED_RESOURCES this config may be provided (and the job will use these resources), if the Model doesn't support AUTOMATIC_RESOURCES, this config must be provided.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1EncryptionSpecArgs'] encryption_spec: Customer-managed encryption key options for a BatchPredictionJob. If this is set, then all resources created by the BatchPredictionJob will be encrypted with the provided encryption key.
        :param pulumi.Input['GoogleCloudAiplatformV1ExplanationSpecArgs'] explanation_spec: Explanation configuration for this BatchPredictionJob. Can be specified only if generate_explanation is set to `true`. This value overrides the value of Model.explanation_spec. All fields of explanation_spec are optional in the request. If a field of the explanation_spec object is not populated, the corresponding field of the Model.explanation_spec object is inherited.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigArgs'] instance_config: Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1ManualBatchTuningParametersArgs'] manual_batch_tuning_parameters: Immutable. Parameters configuring the batch behavior. Currently only applicable when dedicated_resources are used (in other cases Vertex AI does the tuning itself).
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1UnmanagedContainerModelArgs'] unmanaged_container_model: Contains model information necessary to perform batch prediction without requiring uploading to model registry. Exactly one of model and unmanaged_container_model must be set.
        """
    ...
    def input_config(self) -> pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobInputConfigArgs']:
        """
    ...
    @input_config.setter
    def input_config(self, value: pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobInputConfigArgs']):
        pulumi.set(self, "input_config", value)

    @property
    @pulumi.getter(name="outputConfig")
    def output_config(self) -> pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobOutputConfigArgs']:
        """
    ...
    def output_config(self, value: pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobOutputConfigArgs']):
        pulumi.set(self, "output_config", value)

    @property
    @pulumi.getter(name="dedicatedResources")
    def dedicated_resources(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1BatchDedicatedResourcesArgs']]:
        """
    ...
    def dedicated_resources(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1BatchDedicatedResourcesArgs']]):
    ...
    def instance_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigArgs']]:
        """
    ...
    def instance_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigArgs']]):
    ...
    def manual_batch_tuning_parameters(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1ManualBatchTuningParametersArgs']]:
        """
    ...
    def manual_batch_tuning_parameters(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1ManualBatchTuningParametersArgs']]):
    ...
    def unmanaged_container_model(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1UnmanagedContainerModelArgs']]:
        """
    ...
    def unmanaged_container_model(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1UnmanagedContainerModelArgs']]):
...
class BatchPredictionJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dedicated_resources: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1BatchDedicatedResourcesArgs']]] = None,
                 disable_container_logging: Optional[pulumi.Input[bool]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 encryption_spec: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1EncryptionSpecArgs']]] = None,
                 explanation_spec: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ExplanationSpecArgs']]] = None,
                 generate_explanation: Optional[pulumi.Input[bool]] = None,
                 input_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1BatchPredictionJobInputConfigArgs']]] = None,
                 instance_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigArgs']]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 manual_batch_tuning_parameters: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ManualBatchTuningParametersArgs']]] = None,
                 model: Optional[pulumi.Input[str]] = None,
                 model_parameters: Optional[Any] = None,
                 output_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1BatchPredictionJobOutputConfigArgs']]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 service_account: Optional[pulumi.Input[str]] = None,
                 unmanaged_container_model: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1UnmanagedContainerModelArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1BatchDedicatedResourcesArgs']] dedicated_resources: The config of resources used by the Model during the batch prediction. If the Model supports DEDICATED_RESOURCES this config may be provided (and the job will use these resources), if the Model doesn't support AUTOMATIC_RESOURCES, this config must be provided.
        :param pulumi.Input[bool] disable_container_logging: For custom-trained Models and AutoML Tabular Models, the container of the DeployedModel instances will send `stderr` and `stdout` streams to Cloud Logging by default. Please note that the logs incur cost, which are subject to [Cloud Logging pricing](https://cloud.google.com/logging/pricing). User can disable container logging by setting this flag to true.
        :param pulumi.Input[str] display_name: The user-defined name of this BatchPredictionJob.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1EncryptionSpecArgs']] encryption_spec: Customer-managed encryption key options for a BatchPredictionJob. If this is set, then all resources created by the BatchPredictionJob will be encrypted with the provided encryption key.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ExplanationSpecArgs']] explanation_spec: Explanation configuration for this BatchPredictionJob. Can be specified only if generate_explanation is set to `true`. This value overrides the value of Model.explanation_spec. All fields of explanation_spec are optional in the request. If a field of the explanation_spec object is not populated, the corresponding field of the Model.explanation_spec object is inherited.
        :param pulumi.Input[bool] generate_explanation: Generate explanation with the batch prediction results. When set to `true`, the batch prediction output changes based on the `predictions_format` field of the BatchPredictionJob.output_config object: * `bigquery`: output includes a column named `explanation`. The value is a struct that conforms to the Explanation object. * `jsonl`: The JSON objects on each line include an additional entry keyed `explanation`. The value of the entry is a JSON object that conforms to the Explanation object. * `csv`: Generating explanations for CSV format is not supported. If this field is set to true, either the Model.explanation_spec or explanation_spec must be populated.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1BatchPredictionJobInputConfigArgs']] input_config: Input configuration of the instances on which predictions are performed. The schema of any single instance may be specified via the Model's PredictSchemata's instance_schema_uri.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigArgs']] instance_config: Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: The labels with user-defined metadata to organize BatchPredictionJobs. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ManualBatchTuningParametersArgs']] manual_batch_tuning_parameters: Immutable. Parameters configuring the batch behavior. Currently only applicable when dedicated_resources are used (in other cases Vertex AI does the tuning itself).
        :param pulumi.Input[str] model: The name of the Model resource that produces the predictions via this job, must share the same ancestor Location. Starting this job has no impact on any existing deployments of the Model and their resources. Exactly one of model and unmanaged_container_model must be set. The model resource name may contain version id or version alias to specify the version. Example: `projects/{project}/locations/{location}/models/{model}@2` or `projects/{project}/locations/{location}/models/{model}@golden` if no version is specified, the default version will be deployed. The model resource could also be a publisher model. Example: `publishers/{publisher}/models/{model}` or `projects/{project}/locations/{location}/publishers/{publisher}/models/{model}`
        :param Any model_parameters: The parameters that govern the predictions. The schema of the parameters may be specified via the Model's PredictSchemata's parameters_schema_uri.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1BatchPredictionJobOutputConfigArgs']] output_config: The Configuration specifying where output predictions should be written. The schema of any single prediction may be specified as a concatenation of Model's PredictSchemata's instance_schema_uri and prediction_schema_uri.
        :param pulumi.Input[str] service_account: The service account that the DeployedModel's container runs as. If not specified, a system generated one will be used, which has minimal permissions and the custom container, if used, may not have enough permission to access other Google Cloud resources. Users deploying the Model must have the `iam.serviceAccounts.actAs` permission on this service account.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1UnmanagedContainerModelArgs']] unmanaged_container_model: Contains model information necessary to perform batch prediction without requiring uploading to model registry. Exactly one of model and unmanaged_container_model must be set.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def completion_stats(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1CompletionStatsResponse']:
        """
    ...
    @property
    @pulumi.getter(name="dedicatedResources")
    def dedicated_resources(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1BatchDedicatedResourcesResponse']:
        """
        The config of resources used by the Model during the batch prediction. If the Model supports DEDICATED_RESOURCES this config may be provided (and the job will use these resources), if the Model doesn't support AUTOMATIC_RESOURCES, this config must be provided.
        """
        return pulumi.get(self, "dedicated_resources")
    ...
    @property
    @pulumi.getter(name="explanationSpec")
    def explanation_spec(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ExplanationSpecResponse']:
        """
        Explanation configuration for this BatchPredictionJob. Can be specified only if generate_explanation is set to `true`. This value overrides the value of Model.explanation_spec. All fields of explanation_spec are optional in the request. If a field of the explanation_spec object is not populated, the corresponding field of the Model.explanation_spec object is inherited.
        """
        return pulumi.get(self, "explanation_spec")
    ...
    @property
    @pulumi.getter(name="inputConfig")
    def input_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse']:
        """
        Input configuration of the instances on which predictions are performed. The schema of any single instance may be specified via the Model's PredictSchemata's instance_schema_uri.
        """
        return pulumi.get(self, "input_config")
    ...
    @property
    @pulumi.getter(name="instanceConfig")
    def instance_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse']:
        """
        Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
        """
        return pulumi.get(self, "instance_config")
    ...
    @property
    @pulumi.getter(name="manualBatchTuningParameters")
    def manual_batch_tuning_parameters(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ManualBatchTuningParametersResponse']:
        """
        Immutable. Parameters configuring the batch behavior. Currently only applicable when dedicated_resources are used (in other cases Vertex AI does the tuning itself).
        """
        return pulumi.get(self, "manual_batch_tuning_parameters")
    ...
    @property
    @pulumi.getter(name="outputConfig")
    def output_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse']:
        """
        The Configuration specifying where output predictions should be written. The schema of any single prediction may be specified as a concatenation of Model's PredictSchemata's instance_schema_uri and prediction_schema_uri.
        """
        return pulumi.get(self, "output_config")
    ...
    def output_info(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1BatchPredictionJobOutputInfoResponse']:
        """
    ...
    def resources_consumed(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ResourcesConsumedResponse']:
        """
    ...
    @property
    @pulumi.getter(name="unmanagedContainerModel")
    def unmanaged_container_model(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1UnmanagedContainerModelResponse']:
        """
        Contains model information necessary to perform batch prediction without requiring uploading to model registry. Exactly one of model and unmanaged_container_model must be set.
        """
        return pulumi.get(self, "unmanaged_container_model")
