...
class CustomJobArgs:
    def __init__(__self__, *,
                 ...
                 job_spec: pulumi.Input['GoogleCloudAiplatformV1CustomJobSpecArgs'],
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1CustomJobSpecArgs'] job_spec: Job spec.
        :param pulumi.Input['GoogleCloudAiplatformV1EncryptionSpecArgs'] encryption_spec: Customer-managed encryption key options for a CustomJob. If this is set, then all resources created by the CustomJob will be encrypted with the provided encryption key.
    ...
    def job_spec(self) -> pulumi.Input['GoogleCloudAiplatformV1CustomJobSpecArgs']:
        """
        Job spec.
        """
    ...
    @job_spec.setter
    def job_spec(self, value: pulumi.Input['GoogleCloudAiplatformV1CustomJobSpecArgs']):
...
class CustomJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 job_spec: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1CustomJobSpecArgs', 'GoogleCloudAiplatformV1CustomJobSpecArgsDict']]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[str] display_name: The display name of the CustomJob. The name can be up to 128 characters long and can consist of any UTF-8 characters.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1EncryptionSpecArgs', 'GoogleCloudAiplatformV1EncryptionSpecArgsDict']] encryption_spec: Customer-managed encryption key options for a CustomJob. If this is set, then all resources created by the CustomJob will be encrypted with the provided encryption key.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1CustomJobSpecArgs', 'GoogleCloudAiplatformV1CustomJobSpecArgsDict']] job_spec: Job spec.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: The labels with user-defined metadata to organize CustomJobs. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if job_spec is None and not opts.urn:
                raise TypeError("Missing required property 'job_spec'")
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CustomJob':
        """
        ...
        __props__.__dict__["end_time"] = None
        __props__.__dict__["error"] = None
        __props__.__dict__["job_spec"] = None
    ...
    @property
    @pulumi.getter(name="jobSpec")
    def job_spec(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1CustomJobSpecResponse']:
        """
        Job spec.
        """
        return pulumi.get(self, "job_spec")
