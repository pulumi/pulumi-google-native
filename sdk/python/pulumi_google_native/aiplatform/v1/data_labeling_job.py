...
class DataLabelingJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 active_learning_config: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1ActiveLearningConfigArgs', 'GoogleCloudAiplatformV1ActiveLearningConfigArgsDict']]] = None,
                 annotation_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
