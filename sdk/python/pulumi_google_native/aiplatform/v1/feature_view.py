...
class FeatureView(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 big_query_source: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1FeatureViewBigQuerySourceArgs']]] = None,
                 etag: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1FeatureViewBigQuerySourceArgs']] big_query_source: Optional. Configures how data is supposed to be extracted from a BigQuery source to be loaded onto the FeatureOnlineStore.
        :param pulumi.Input[str] etag: Optional. Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens.
