...
class FeatureViewArgs:
    ...
    def big_query_source(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1FeatureViewBigQuerySourceArgs']]:
        """
    ...
    def big_query_source(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1FeatureViewBigQuerySourceArgs']]):
    ...
    def feature_registry_source(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceArgs']]:
        """
    ...
    def feature_registry_source(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceArgs']]):
    ...
    def sync_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1FeatureViewSyncConfigArgs']]:
        """
    ...
    @sync_config.setter
    def sync_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1FeatureViewSyncConfigArgs']]):
...
class FeatureView(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 big_query_source: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1FeatureViewBigQuerySourceArgs', 'GoogleCloudAiplatformV1FeatureViewBigQuerySourceArgsDict']]] = None,
                 etag: Optional[pulumi.Input[str]] = None,
                 feature_online_store_id: Optional[pulumi.Input[str]] = None,
                 feature_registry_source: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceArgs', 'GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceArgsDict']]] = None,
                 feature_view_id: Optional[pulumi.Input[str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 run_sync_immediately: Optional[pulumi.Input[bool]] = None,
                 sync_config: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1FeatureViewSyncConfigArgs', 'GoogleCloudAiplatformV1FeatureViewSyncConfigArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['GoogleCloudAiplatformV1FeatureViewBigQuerySourceArgs', 'GoogleCloudAiplatformV1FeatureViewBigQuerySourceArgsDict']] big_query_source: Optional. Configures how data is supposed to be extracted from a BigQuery source to be loaded onto the FeatureOnlineStore.
        :param pulumi.Input[str] etag: Optional. Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceArgs', 'GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceArgsDict']] feature_registry_source: Optional. Configures the features from a Feature Registry source that need to be loaded onto the FeatureOnlineStore.
        :param pulumi.Input[str] feature_view_id: Required. The ID to use for the FeatureView, which will become the final component of the FeatureView's resource name. This value may be up to 60 characters, and valid characters are `[a-z0-9_]`. The first character cannot be a number. The value must be unique within a FeatureOnlineStore.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: Optional. The labels with user-defined metadata to organize your FeatureViews. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information on and examples of labels. No more than 64 user labels can be associated with one FeatureOnlineStore(System labels are excluded)." System reserved label keys are prefixed with "aiplatform.googleapis.com/" and are immutable.
        :param pulumi.Input[bool] run_sync_immediately: Immutable. If set to true, one on demand sync will be run immediately, regardless whether the FeatureView.sync_config is configured or not.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1FeatureViewSyncConfigArgs', 'GoogleCloudAiplatformV1FeatureViewSyncConfigArgsDict']] sync_config: Configures when data is to be synced/updated for this FeatureView. At the end of the sync the latest featureValues for each entityId of this FeatureView are made ready for online serving.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="bigQuerySource")
    def big_query_source(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1FeatureViewBigQuerySourceResponse']:
        """
        Optional. Configures how data is supposed to be extracted from a BigQuery source to be loaded onto the FeatureOnlineStore.
        """
        return pulumi.get(self, "big_query_source")
    ...
    @property
    @pulumi.getter(name="featureRegistrySource")
    def feature_registry_source(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceResponse']:
        """
        Optional. Configures the features from a Feature Registry source that need to be loaded onto the FeatureOnlineStore.
        """
        return pulumi.get(self, "feature_registry_source")
    ...
    @property
    @pulumi.getter(name="syncConfig")
    def sync_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1FeatureViewSyncConfigResponse']:
        """
        Configures when data is to be synced/updated for this FeatureView. At the end of the sync the latest featureValues for each entityId of this FeatureView are made ready for online serving.
        """
        return pulumi.get(self, "sync_config")
