...
class GetCustomJobResult:
    ...
    def job_spec(self) -> 'outputs.GoogleCloudAiplatformV1CustomJobSpecResponse':
        """
        Job spec.
        """
...
def get_custom_job(custom_job_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getCustomJob', __args__, opts=opts, typ=GetCustomJobResult).value
