...
class GetDataLabelingJobResult:
    ...
    def active_learning_config(self) -> 'outputs.GoogleCloudAiplatformV1ActiveLearningConfigResponse':
        """
...
def get_data_labeling_job(data_labeling_job_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getDataLabelingJob', __args__, opts=opts, typ=GetDataLabelingJobResult).value
