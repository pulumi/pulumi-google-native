...
class GetDatasetResult:
    ...
    def saved_queries(self) -> Sequence['outputs.GoogleCloudAiplatformV1SavedQueryResponse']:
        """
...
def get_dataset(dataset_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getDataset', __args__, opts=opts, typ=GetDatasetResult).value
