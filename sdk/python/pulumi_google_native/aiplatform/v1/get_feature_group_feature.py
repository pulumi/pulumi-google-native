...
class GetFeatureGroupFeatureResult:
    def __init__(__self__, create_time=None, description=None, disable_monitoring=None, etag=None, labels=None, monitoring_stats_anomalies=None, name=None, point_of_contact=None, update_time=None, value_type=None, version_column_name=None):
...
def get_feature_group_feature(feature_group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getFeatureGroupFeature', __args__, opts=opts, typ=GetFeatureGroupFeatureResult).value
