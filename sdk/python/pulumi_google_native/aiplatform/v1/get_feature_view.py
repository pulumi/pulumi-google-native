...
class GetFeatureViewResult:
    ...
    def big_query_source(self) -> 'outputs.GoogleCloudAiplatformV1FeatureViewBigQuerySourceResponse':
        """
    ...
    def feature_registry_source(self) -> 'outputs.GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceResponse':
        """
    ...
    def sync_config(self) -> 'outputs.GoogleCloudAiplatformV1FeatureViewSyncConfigResponse':
        """
...
def get_feature_view(feature_online_store_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getFeatureView', __args__, opts=opts, typ=GetFeatureViewResult).value
