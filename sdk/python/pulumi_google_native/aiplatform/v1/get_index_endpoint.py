...
class GetIndexEndpointResult:
    ...
    def deployed_indexes(self) -> Sequence['outputs.GoogleCloudAiplatformV1DeployedIndexResponse']:
        """
    ...
    def private_service_connect_config(self) -> 'outputs.GoogleCloudAiplatformV1PrivateServiceConnectConfigResponse':
        """
...
def get_index_endpoint(index_endpoint_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getIndexEndpoint', __args__, opts=opts, typ=GetIndexEndpointResult).value
