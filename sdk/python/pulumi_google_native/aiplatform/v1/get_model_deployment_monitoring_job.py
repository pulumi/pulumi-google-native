...
class GetModelDeploymentMonitoringJobResult:
    ...
    def bigquery_tables(self) -> Sequence['outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse']:
        """
    ...
    def latest_monitoring_pipeline_metadata(self) -> 'outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse':
        """
    ...
    def model_deployment_monitoring_objective_configs(self) -> Sequence['outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse']:
        """
    ...
    def model_deployment_monitoring_schedule_config(self) -> 'outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse':
        """
    ...
    def model_monitoring_alert_config(self) -> 'outputs.GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse':
        """
    ...
    def stats_anomalies_base_directory(self) -> 'outputs.GoogleCloudAiplatformV1GcsDestinationResponse':
        """
...
def get_model_deployment_monitoring_job(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getModelDeploymentMonitoringJob', __args__, opts=opts, typ=GetModelDeploymentMonitoringJobResult).value
