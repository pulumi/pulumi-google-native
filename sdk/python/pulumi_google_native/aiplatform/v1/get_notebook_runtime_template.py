...
class GetNotebookRuntimeTemplateResult:
    ...
    def data_persistent_disk_spec(self) -> 'outputs.GoogleCloudAiplatformV1PersistentDiskSpecResponse':
        """
    ...
    def euc_config(self) -> 'outputs.GoogleCloudAiplatformV1NotebookEucConfigResponse':
        """
    ...
    def idle_shutdown_config(self) -> 'outputs.GoogleCloudAiplatformV1NotebookIdleShutdownConfigResponse':
        """
    ...
    def network_spec(self) -> 'outputs.GoogleCloudAiplatformV1NetworkSpecResponse':
        """
    ...
    def reservation_affinity(self) -> 'outputs.GoogleCloudAiplatformV1NotebookReservationAffinityResponse':
        """
    ...
    def shielded_vm_config(self) -> 'outputs.GoogleCloudAiplatformV1ShieldedVmConfigResponse':
        """
...
def get_notebook_runtime_template(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getNotebookRuntimeTemplate', __args__, opts=opts, typ=GetNotebookRuntimeTemplateResult).value
