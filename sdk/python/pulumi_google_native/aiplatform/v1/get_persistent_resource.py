...
class GetPersistentResourceResult:
    ...
    def resource_pools(self) -> Sequence['outputs.GoogleCloudAiplatformV1ResourcePoolResponse']:
        """
    ...
    def resource_runtime(self) -> 'outputs.GoogleCloudAiplatformV1ResourceRuntimeResponse':
        """
    ...
    def resource_runtime_spec(self) -> 'outputs.GoogleCloudAiplatformV1ResourceRuntimeSpecResponse':
        """
...
def get_persistent_resource(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1:getPersistentResource', __args__, opts=opts, typ=GetPersistentResourceResult).value
