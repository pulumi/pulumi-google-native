...
class Model(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 artifact_uri: Optional[pulumi.Input[str]] = None,
                 base_model_source: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ModelBaseModelSourceArgs']]] = None,
                 container_spec: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ModelContainerSpecArgs']]] = None,
                 data_stats: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ModelDataStatsArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 ...
                 parent_model: Optional[pulumi.Input[str]] = None,
                 pipeline_job: Optional[pulumi.Input[str]] = None,
                 predict_schemata: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1PredictSchemataArgs']]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 service_account: Optional[pulumi.Input[str]] = None,
                 version_aliases: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 version_description: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] artifact_uri: Immutable. The path to the directory containing the Model artifact and any of its supporting files. Not required for AutoML Models.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ModelBaseModelSourceArgs']] base_model_source: Optional. User input field to specify the base model source. Currently it only supports specifing the Model Garden models and Genie models.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ModelContainerSpecArgs']] container_spec: Input only. The specification of the container that is to be used when deploying this Model. The specification is ingested upon ModelService.UploadModel, and all binaries it contains are copied and stored internally by Vertex AI. Not required for AutoML Models.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ModelDataStatsArgs']] data_stats: Stats of data used for training or evaluating the Model. Only populated when the Model is trained by a TrainingPipeline with data_input_config.
        :param pulumi.Input[str] description: The description of the Model.
        :param pulumi.Input[str] display_name: The display name of the Model. The name can be up to 128 characters long and can consist of any UTF-8 characters.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1EncryptionSpecArgs']] encryption_spec: Customer-managed encryption key spec for a Model. If set, this Model and all sub-resources of this Model will be secured by this key.
        :param pulumi.Input[str] etag: Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens.
        ...
        :param pulumi.Input[str] parent_model: Optional. The resource name of the model into which to upload the version. Only specify this field when uploading a new version.
        :param pulumi.Input[str] pipeline_job: Optional. This field is populated if the model is produced by a pipeline job.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1PredictSchemataArgs']] predict_schemata: The schemata that describe formats of the Model's predictions and explanations as given and returned via PredictionService.Predict and PredictionService.Explain.
        :param pulumi.Input[str] service_account: Optional. The user-provided custom service account to use to do the model upload. If empty, [Vertex AI Service Agent](https://cloud.google.com/vertex-ai/docs/general/access-control#service-agents) will be used to access resources needed to upload the model. This account must belong to the target project where the model is uploaded to, i.e., the project specified in the `parent` field of this request and have necessary read permissions (to Google Cloud Storage, Artifact Registry, etc.).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] version_aliases: User provided version aliases so that a model version can be referenced via alias (i.e. `projects/{project}/locations/{location}/models/{model_id}@{version_alias}` instead of auto-generated version id (i.e. `projects/{project}/locations/{location}/models/{model_id}@{version_id})`. The format is a-z{0,126}[a-z0-9] to distinguish from version_id. A default version alias will be created for the first version of the model, and there must be exactly one default version alias for a model.
        :param pulumi.Input[str] version_description: The description of this version.
        """
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["data_stats"] = data_stats
            ...
            __props__.__dict__["pipeline_job"] = pipeline_job
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["create_time"] = None
        __props__.__dict__["data_stats"] = None
        __props__.__dict__["deployed_models"] = None
        ...
        __props__.__dict__["original_model_info"] = None
        __props__.__dict__["pipeline_job"] = None
    ...
    @property
    @pulumi.getter(name="baseModelSource")
    def base_model_source(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ModelBaseModelSourceResponse']:
        """
        Optional. User input field to specify the base model source. Currently it only supports specifing the Model Garden models and Genie models.
        """
        return pulumi.get(self, "base_model_source")
    ...
    @property
    @pulumi.getter(name="containerSpec")
    def container_spec(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ModelContainerSpecResponse']:
        """
        Input only. The specification of the container that is to be used when deploying this Model. The specification is ingested upon ModelService.UploadModel, and all binaries it contains are copied and stored internally by Vertex AI. Not required for AutoML Models.
        """
        return pulumi.get(self, "container_spec")
    ...
    @property
    @pulumi.getter(name="dataStats")
    def data_stats(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ModelDataStatsResponse']:
        """
        Stats of data used for training or evaluating the Model. Only populated when the Model is trained by a TrainingPipeline with data_input_config.
        """
        return pulumi.get(self, "data_stats")
    ...
    def deployed_models(self) -> pulumi.Output[Sequence['outputs.GoogleCloudAiplatformV1DeployedModelRefResponse']]:
        """
    ...
    def model_source_info(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ModelSourceInfoResponse']:
        """
    ...
    def original_model_info(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ModelOriginalModelInfoResponse']:
        """
    ...
    @property
    @pulumi.getter(name="pipelineJob")
    def pipeline_job(self) -> pulumi.Output[str]:
        """
        Optional. This field is populated if the model is produced by a pipeline job.
        """
        return pulumi.get(self, "pipeline_job")
    ...
    @property
    @pulumi.getter(name="predictSchemata")
    def predict_schemata(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1PredictSchemataResponse']:
        """
        The schemata that describe formats of the Model's predictions and explanations as given and returned via PredictionService.Predict and PredictionService.Explain.
        """
        return pulumi.get(self, "predict_schemata")
    ...
    def supported_export_formats(self) -> pulumi.Output[Sequence['outputs.GoogleCloudAiplatformV1ModelExportFormatResponse']]:
        """
