...
class ModelDeploymentMonitoringJobArgs:
    def __init__(__self__, *,
                 ...
                 logging_sampling_strategy: pulumi.Input['GoogleCloudAiplatformV1SamplingStrategyArgs'],
                 model_deployment_monitoring_objective_configs: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs']]],
                 model_deployment_monitoring_schedule_config: pulumi.Input['GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgs'],
                 ...
                 model_monitoring_alert_config: Optional[pulumi.Input['GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgs']] = None,
                 predict_instance_schema_uri: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 sample_predict_instance: Optional[Any] = None,
                 stats_anomalies_base_directory: Optional[pulumi.Input['GoogleCloudAiplatformV1GcsDestinationArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1SamplingStrategyArgs'] logging_sampling_strategy: Sample Strategy for logging.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs']]] model_deployment_monitoring_objective_configs: The config for monitoring objectives. This is a per DeployedModel config. Each DeployedModel needs to be configured separately.
        :param pulumi.Input['GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgs'] model_deployment_monitoring_schedule_config: Schedule config for running the monitoring job.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1EncryptionSpecArgs'] encryption_spec: Customer-managed encryption key spec for a ModelDeploymentMonitoringJob. If set, this ModelDeploymentMonitoringJob and all sub-resources of this ModelDeploymentMonitoringJob will be secured by this key.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgs'] model_monitoring_alert_config: Alert config for model monitoring.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1GcsDestinationArgs'] stats_anomalies_base_directory: Stats anomalies base folder path.
        """
    ...
    def logging_sampling_strategy(self) -> pulumi.Input['GoogleCloudAiplatformV1SamplingStrategyArgs']:
        """
    ...
    def logging_sampling_strategy(self, value: pulumi.Input['GoogleCloudAiplatformV1SamplingStrategyArgs']):
        pulumi.set(self, "logging_sampling_strategy", value)

    @property
    @pulumi.getter(name="modelDeploymentMonitoringObjectiveConfigs")
    def model_deployment_monitoring_objective_configs(self) -> pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs']]]:
        """
    ...
    def model_deployment_monitoring_objective_configs(self, value: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs']]]):
    ...
    def model_deployment_monitoring_schedule_config(self) -> pulumi.Input['GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgs']:
        """
    ...
    def model_deployment_monitoring_schedule_config(self, value: pulumi.Input['GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgs']):
    ...
    def model_monitoring_alert_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgs']]:
        """
    ...
    def model_monitoring_alert_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgs']]):
    ...
    def stats_anomalies_base_directory(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1GcsDestinationArgs']]:
        """
    ...
    def stats_anomalies_base_directory(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1GcsDestinationArgs']]):
...
class ModelDeploymentMonitoringJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 log_ttl: Optional[pulumi.Input[str]] = None,
                 logging_sampling_strategy: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1SamplingStrategyArgs', 'GoogleCloudAiplatformV1SamplingStrategyArgsDict']]] = None,
                 model_deployment_monitoring_objective_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs', 'GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgsDict']]]]] = None,
                 model_deployment_monitoring_schedule_config: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgs', 'GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgsDict']]] = None,
                 model_monitoring_alert_config: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgs', 'GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgsDict']]] = None,
                 predict_instance_schema_uri: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 sample_predict_instance: Optional[Any] = None,
                 stats_anomalies_base_directory: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1GcsDestinationArgs', 'GoogleCloudAiplatformV1GcsDestinationArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: The labels with user-defined metadata to organize your ModelDeploymentMonitoringJob. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels.
        :param pulumi.Input[str] log_ttl: The TTL of BigQuery tables in user projects which stores logs. A day is the basic unit of the TTL and we take the ceil of TTL/86400(a day). e.g. { second: 3600} indicates ttl = 1 day.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1SamplingStrategyArgs', 'GoogleCloudAiplatformV1SamplingStrategyArgsDict']] logging_sampling_strategy: Sample Strategy for logging.
        :param pulumi.Input[Sequence[pulumi.Input[Union['GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgs', 'GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigArgsDict']]]] model_deployment_monitoring_objective_configs: The config for monitoring objectives. This is a per DeployedModel config. Each DeployedModel needs to be configured separately.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgs', 'GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigArgsDict']] model_deployment_monitoring_schedule_config: Schedule config for running the monitoring job.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgs', 'GoogleCloudAiplatformV1ModelMonitoringAlertConfigArgsDict']] model_monitoring_alert_config: Alert config for model monitoring.
        :param pulumi.Input[str] predict_instance_schema_uri: YAML schema file uri describing the format of a single instance, which are given to format this Endpoint's prediction (and explanation). If not set, we will generate predict schema from collected predict requests.
        :param Any sample_predict_instance: Sample Predict instance, same format as PredictRequest.instances, this can be set as a replacement of ModelDeploymentMonitoringJob.predict_instance_schema_uri. If not set, we will generate predict schema from collected predict requests.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1GcsDestinationArgs', 'GoogleCloudAiplatformV1GcsDestinationArgsDict']] stats_anomalies_base_directory: Stats anomalies base folder path.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def bigquery_tables(self) -> pulumi.Output[Sequence['outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse']]:
        """
    ...
    def latest_monitoring_pipeline_metadata(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse']:
        """
    ...
    @property
    @pulumi.getter(name="loggingSamplingStrategy")
    def logging_sampling_strategy(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1SamplingStrategyResponse']:
        """
        Sample Strategy for logging.
        """
        return pulumi.get(self, "logging_sampling_strategy")
    ...
    @property
    @pulumi.getter(name="modelDeploymentMonitoringObjectiveConfigs")
    def model_deployment_monitoring_objective_configs(self) -> pulumi.Output[Sequence['outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse']]:
        """
        The config for monitoring objectives. This is a per DeployedModel config. Each DeployedModel needs to be configured separately.
        """
        return pulumi.get(self, "model_deployment_monitoring_objective_configs")
    ...
    @property
    @pulumi.getter(name="modelDeploymentMonitoringScheduleConfig")
    def model_deployment_monitoring_schedule_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse']:
        """
        Schedule config for running the monitoring job.
        """
        return pulumi.get(self, "model_deployment_monitoring_schedule_config")
    ...
    @property
    @pulumi.getter(name="modelMonitoringAlertConfig")
    def model_monitoring_alert_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse']:
        """
        Alert config for model monitoring.
        """
        return pulumi.get(self, "model_monitoring_alert_config")
    ...
    @property
    @pulumi.getter(name="statsAnomaliesBaseDirectory")
    def stats_anomalies_base_directory(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1GcsDestinationResponse']:
        """
        Stats anomalies base folder path.
        """
        return pulumi.get(self, "stats_anomalies_base_directory")
