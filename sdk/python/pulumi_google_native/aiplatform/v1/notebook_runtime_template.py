...
class NotebookRuntimeTemplateArgs:
    def __init__(__self__, *,
                 ...
                 data_persistent_disk_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1PersistentDiskSpecArgs']] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 etag: Optional[pulumi.Input[str]] = None,
                 euc_config: Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookEucConfigArgs']] = None,
                 idle_shutdown_config: Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookIdleShutdownConfigArgs']] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 machine_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1MachineSpecArgs']] = None,
                 network_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1NetworkSpecArgs']] = None,
                 ...
                 reservation_affinity: Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookReservationAffinityArgs']] = None,
                 service_account: Optional[pulumi.Input[str]] = None,
                 shielded_vm_config: Optional[pulumi.Input['GoogleCloudAiplatformV1ShieldedVmConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1PersistentDiskSpecArgs'] data_persistent_disk_spec: Optional. The specification of persistent disk attached to the runtime as data disk storage.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1NotebookEucConfigArgs'] euc_config: EUC configuration of the NotebookRuntimeTemplate.
        :param pulumi.Input['GoogleCloudAiplatformV1NotebookIdleShutdownConfigArgs'] idle_shutdown_config: The idle shutdown configuration of NotebookRuntimeTemplate. This config will only be set when idle shutdown is enabled.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1MachineSpecArgs'] machine_spec: Optional. Immutable. The specification of a single machine for the template.
        :param pulumi.Input['GoogleCloudAiplatformV1NetworkSpecArgs'] network_spec: Optional. Network spec.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1NotebookReservationAffinityArgs'] reservation_affinity: Optional. Reservation Affinity of the notebook runtime template.
        :param pulumi.Input[str] service_account: The service account that the runtime workload runs as. You can use any service account within the same project, but you must have the service account user permission to use the instance. If not specified, the [Compute Engine default service account](https://cloud.google.com/compute/docs/access/service-accounts#default_service_account) is used.
        :param pulumi.Input['GoogleCloudAiplatformV1ShieldedVmConfigArgs'] shielded_vm_config: Optional. Immutable. Runtime Shielded VM spec.
        """
    ...
    def data_persistent_disk_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1PersistentDiskSpecArgs']]:
        """
    ...
    def data_persistent_disk_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1PersistentDiskSpecArgs']]):
    ...
    def euc_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookEucConfigArgs']]:
        """
    ...
    @euc_config.setter
    def euc_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookEucConfigArgs']]):
        pulumi.set(self, "euc_config", value)

    @property
    @pulumi.getter(name="idleShutdownConfig")
    def idle_shutdown_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookIdleShutdownConfigArgs']]:
        """
    ...
    def idle_shutdown_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookIdleShutdownConfigArgs']]):
    ...
    def network_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1NetworkSpecArgs']]:
        """
    ...
    @network_spec.setter
    def network_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1NetworkSpecArgs']]):
    ...
    def reservation_affinity(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookReservationAffinityArgs']]:
        """
    ...
    def reservation_affinity(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1NotebookReservationAffinityArgs']]):
    ...
    def shielded_vm_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1ShieldedVmConfigArgs']]:
        """
    ...
    def shielded_vm_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1ShieldedVmConfigArgs']]):
...
class NotebookRuntimeTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_persistent_disk_spec: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1PersistentDiskSpecArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 etag: Optional[pulumi.Input[str]] = None,
                 euc_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1NotebookEucConfigArgs']]] = None,
                 idle_shutdown_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1NotebookIdleShutdownConfigArgs']]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 machine_spec: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1MachineSpecArgs']]] = None,
                 network_spec: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1NetworkSpecArgs']]] = None,
                 network_tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 notebook_runtime_template_id: Optional[pulumi.Input[str]] = None,
                 notebook_runtime_type: Optional[pulumi.Input['NotebookRuntimeTemplateNotebookRuntimeType']] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 reservation_affinity: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1NotebookReservationAffinityArgs']]] = None,
                 service_account: Optional[pulumi.Input[str]] = None,
                 shielded_vm_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ShieldedVmConfigArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1PersistentDiskSpecArgs']] data_persistent_disk_spec: Optional. The specification of persistent disk attached to the runtime as data disk storage.
        :param pulumi.Input[str] description: The description of the NotebookRuntimeTemplate.
        :param pulumi.Input[str] display_name: The display name of the NotebookRuntimeTemplate. The name can be up to 128 characters long and can consist of any UTF-8 characters.
        :param pulumi.Input[str] etag: Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1NotebookEucConfigArgs']] euc_config: EUC configuration of the NotebookRuntimeTemplate.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1NotebookIdleShutdownConfigArgs']] idle_shutdown_config: The idle shutdown configuration of NotebookRuntimeTemplate. This config will only be set when idle shutdown is enabled.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: The labels with user-defined metadata to organize the NotebookRuntimeTemplates. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1MachineSpecArgs']] machine_spec: Optional. Immutable. The specification of a single machine for the template.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1NetworkSpecArgs']] network_spec: Optional. Network spec.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] network_tags: Optional. The Compute Engine tags to add to runtime (see [Tagging instances](https://cloud.google.com/vpc/docs/add-remove-network-tags)).
        :param pulumi.Input[str] notebook_runtime_template_id: Optional. User specified ID for the notebook runtime template.
        :param pulumi.Input['NotebookRuntimeTemplateNotebookRuntimeType'] notebook_runtime_type: Optional. Immutable. The type of the notebook runtime template.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1NotebookReservationAffinityArgs']] reservation_affinity: Optional. Reservation Affinity of the notebook runtime template.
        :param pulumi.Input[str] service_account: The service account that the runtime workload runs as. You can use any service account within the same project, but you must have the service account user permission to use the instance. If not specified, the [Compute Engine default service account](https://cloud.google.com/compute/docs/access/service-accounts#default_service_account) is used.
        :param pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1ShieldedVmConfigArgs']] shielded_vm_config: Optional. Immutable. Runtime Shielded VM spec.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="dataPersistentDiskSpec")
    def data_persistent_disk_spec(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1PersistentDiskSpecResponse']:
        """
        Optional. The specification of persistent disk attached to the runtime as data disk storage.
        """
        return pulumi.get(self, "data_persistent_disk_spec")
    ...
    @property
    @pulumi.getter(name="eucConfig")
    def euc_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1NotebookEucConfigResponse']:
        """
        EUC configuration of the NotebookRuntimeTemplate.
        """
        return pulumi.get(self, "euc_config")
    ...
    @property
    @pulumi.getter(name="idleShutdownConfig")
    def idle_shutdown_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1NotebookIdleShutdownConfigResponse']:
        """
        The idle shutdown configuration of NotebookRuntimeTemplate. This config will only be set when idle shutdown is enabled.
        """
        return pulumi.get(self, "idle_shutdown_config")
    ...
    @property
    @pulumi.getter(name="machineSpec")
    def machine_spec(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1MachineSpecResponse']:
        """
        Optional. Immutable. The specification of a single machine for the template.
        """
        return pulumi.get(self, "machine_spec")
    ...
    @property
    @pulumi.getter(name="networkSpec")
    def network_spec(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1NetworkSpecResponse']:
        """
        Optional. Network spec.
        """
        return pulumi.get(self, "network_spec")
    ...
    @property
    @pulumi.getter(name="reservationAffinity")
    def reservation_affinity(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1NotebookReservationAffinityResponse']:
        """
        Optional. Reservation Affinity of the notebook runtime template.
        """
        return pulumi.get(self, "reservation_affinity")
    ...
    @property
    @pulumi.getter(name="shieldedVmConfig")
    def shielded_vm_config(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1ShieldedVmConfigResponse']:
        """
        Optional. Immutable. Runtime Shielded VM spec.
        """
        return pulumi.get(self, "shielded_vm_config")
