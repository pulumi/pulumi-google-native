...
class Trial(pulumi.CustomResource):
    ...
    def final_measurement(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1MeasurementResponse']:
        """
    ...
    @property
    @pulumi.getter
    def measurements(self) -> pulumi.Output[Sequence['outputs.GoogleCloudAiplatformV1MeasurementResponse']]:
        """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output[Sequence['outputs.GoogleCloudAiplatformV1TrialParameterResponse']]:
        """
