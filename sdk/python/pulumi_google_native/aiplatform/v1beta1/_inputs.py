...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ActiveLearningConfigArgs:
    def __init__(__self__, *,
                 max_data_item_count: Optional[pulumi.Input[str]] = None,
                 max_data_item_percentage: Optional[pulumi.Input[int]] = None,
                 sample_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampleConfigArgs']] = None,
                 training_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1TrainingConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1SampleConfigArgs'] sample_config: Active learning data sampling config. For every active learning labeling iteration, it will select a batch of data based on the sampling strategy.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1TrainingConfigArgs'] training_config: CMLE training config. For every active learning labeling iteration, system will train a machine learning model on CMLE. The trained model will be used by data sampling algorithm to select DataItems.
        """
    ...
    def sample_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampleConfigArgs']]:
        """
    ...
    def sample_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampleConfigArgs']]):
        pulumi.set(self, "sample_config", value)

    @property
    @pulumi.getter(name="trainingConfig")
    def training_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1TrainingConfigArgs']]:
        """
    ...
    def training_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1TrainingConfigArgs']]):
        pulumi.set(self, "training_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1AutoscalingMetricSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1BatchDedicatedResourcesArgs:
    def __init__(__self__, *,
                 machine_spec: pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs'],
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs'] machine_spec: Immutable. The specification of a single machine.
    ...
    def machine_spec(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs']:
        """
    ...
    @machine_spec.setter
    def machine_spec(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs']):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfigArgs:
    def __init__(__self__, *,
                 instances_format: pulumi.Input[str],
                 bigquery_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs']] = None,
                 gcs_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs'] bigquery_source: The BigQuery location of the input table. The schema of the table should be in the format described by the given context OpenAPI Schema, if one is provided. The table may contain additional columns that are not described by the schema, and they will be ignored.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs'] gcs_source: The Cloud Storage location for the input instances.
        """
    ...
    def bigquery_source(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs']]:
        """
    ...
    def bigquery_source(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs']]):
        pulumi.set(self, "bigquery_source", value)

    @property
    @pulumi.getter(name="gcsSource")
    def gcs_source(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs']]:
        """
    ...
    @gcs_source.setter
    def gcs_source(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs']]):
        pulumi.set(self, "gcs_source", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] excluded_fields: Fields that will be excluded in the prediction instance that is sent to the Model. Excluded will be attached to the batch prediction output if key_field is not specified. When excluded_fields is populated, included_fields must be empty. The input must be JSONL with objects at each line, BigQuery or TfRecord.
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigArgs:
    def __init__(__self__, *,
                 predictions_format: pulumi.Input[str],
                 bigquery_destination: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs']] = None,
                 gcs_destination: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']] = None):
        """
    ...
    def bigquery_destination(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs']]:
        """
    ...
    def bigquery_destination(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs']]):
        pulumi.set(self, "bigquery_destination", value)

    @property
    @pulumi.getter(name="gcsDestination")
    def gcs_destination(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']]:
        """
        The Cloud Storage location of the directory where the output is to be written to. In the given directory a new directory is created. Its name is `prediction--`, where timestamp is in YYYY-MM-DDThh:mm:ss.sssZ ISO-8601 format. Inside of it files `predictions_0001.`, `predictions_0002.`, ..., `predictions_N.` are created where `` depends on chosen predictions_format, and N may equal 0001 and depends on the total number of successfully predicted instances. If the Model has both instance and prediction schemata defined then each such file contains predictions as per the predictions_format. If prediction for any instance failed (partially or completely), then an additional `errors_0001.`, `errors_0002.`,..., `errors_N.` files are created (N depends on total number of failed predictions). These files contain the failed instances, as per their schema, followed by an additional `error` field which as value has google.rpc.Status containing only `code` and `message` fields.
        """
    ...
    def gcs_destination(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']]):
        pulumi.set(self, "gcs_destination", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1BigQueryDestinationArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1BigQuerySourceArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1BlurBaselineConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ContainerSpecArgs:
    def __init__(__self__, *,
                 image_uri: pulumi.Input[str],
                 args: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 command: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 env: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1EnvVarArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1EnvVarArgs']]] env: Environment variables to be passed to the container. Maximum limit is 100.
        """
    ...
    @property
    @pulumi.getter
    def env(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1EnvVarArgs']]]]:
        """
    ...
    @env.setter
    def env(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1EnvVarArgs']]]]):
        pulumi.set(self, "env", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1CreatePipelineJobRequestArgs:
    def __init__(__self__, *,
                 parent: pulumi.Input[str],
                 pipeline_job: pulumi.Input['GoogleCloudAiplatformV1beta1PipelineJobArgs'],
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1PipelineJobArgs'] pipeline_job: The PipelineJob to create.
    ...
    def pipeline_job(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1PipelineJobArgs']:
        """
    ...
    @pipeline_job.setter
    def pipeline_job(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1PipelineJobArgs']):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1CustomJobSpecArgs:
    def __init__(__self__, *,
                 worker_pool_specs: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1WorkerPoolSpecArgs']]],
                 base_output_directory: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']] = None,
                 ...
                 scheduling: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SchedulingArgs']] = None,
                 service_account: Optional[pulumi.Input[str]] = None,
                 tensorboard: Optional[pulumi.Input[str]] = None):
        """
        Represents the spec of a CustomJob.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1WorkerPoolSpecArgs']]] worker_pool_specs: The spec of the worker pools including machine type and Docker image. All worker pools except the first one are optional and can be skipped by providing an empty value.
        ...
        :param pulumi.Input[str] persistent_resource_id: Optional. The ID of the PersistentResource in the same Project and Location which to run If this is specified, the job will be run on existing machines held by the PersistentResource instead of on-demand short-live machines. The network and CMEK configs on the job should be consistent with those on the PersistentResource, otherwise, the job will be rejected.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1SchedulingArgs'] scheduling: Scheduling options for a CustomJob.
    ...
    def worker_pool_specs(self) -> pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1WorkerPoolSpecArgs']]]:
        """
    ...
    def worker_pool_specs(self, value: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1WorkerPoolSpecArgs']]]):
        pulumi.set(self, "worker_pool_specs", value)

    @property
    @pulumi.getter(name="baseOutputDirectory")
    def base_output_directory(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']]:
        """
        The Cloud Storage location to store the output of this CustomJob or HyperparameterTuningJob. For HyperparameterTuningJob, the baseOutputDirectory of each child CustomJob backing a Trial is set to a subdirectory of name id under its parent HyperparameterTuningJob's baseOutputDirectory. The following Vertex AI environment variables will be passed to containers or python modules when this field is set: For CustomJob: * AIP_MODEL_DIR = `/model/` * AIP_CHECKPOINT_DIR = `/checkpoints/` * AIP_TENSORBOARD_LOG_DIR = `/logs/` For CustomJob backing a Trial of HyperparameterTuningJob: * AIP_MODEL_DIR = `//model/` * AIP_CHECKPOINT_DIR = `//checkpoints/` * AIP_TENSORBOARD_LOG_DIR = `//logs/`
        """
    ...
    def base_output_directory(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']]):
    ...
    @property
    @pulumi.getter
    def models(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    @models.setter
    def models(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def persistent_resource_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def persistent_resource_id(self, value: Optional[pulumi.Input[str]]):
    ...
    @property
    @pulumi.getter
    def scheduling(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SchedulingArgs']]:
        """
    ...
    @scheduling.setter
    def scheduling(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SchedulingArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1DedicatedResourcesArgs:
    def __init__(__self__, *,
                 machine_spec: pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs'],
                 min_replica_count: pulumi.Input[int],
                 autoscaling_metric_specs: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1AutoscalingMetricSpecArgs']]]] = None,
                 max_replica_count: Optional[pulumi.Input[int]] = None):
        """
        A description of resources that are dedicated to a DeployedModel, and that need a higher degree of manual configuration.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs'] machine_spec: Immutable. The specification of a single machine used by the prediction.
    ...
    def autoscaling_metric_specs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1AutoscalingMetricSpecArgs']]]]:
        """
    ...
    def autoscaling_metric_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1AutoscalingMetricSpecArgs']]]]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1DiskSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1EncryptionSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1EnvVarArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceArgs:
    def __init__(__self__, *,
                 data_format: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceDataFormat']] = None,
                 gcs_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs']] = None):
        """
        The Cloud Storage input instances.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceDataFormat'] data_format: The format in which instances are given, if not specified, assume it's JSONL format. Currently only JSONL format is supported.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs'] gcs_source: The Cloud Storage location for the input instances.
        """
    ...
    def data_format(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceDataFormat']]:
        """
    ...
    @data_format.setter
    def data_format(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceDataFormat']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ExamplesArgs:
    def __init__(__self__, *,
                 example_gcs_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceArgs']] = None,
                 gcs_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs']] = None,
                 nearest_neighbor_search_config: Optional[Any] = None,
                 neighbor_count: Optional[pulumi.Input[int]] = None,
                 presets: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsArgs']] = None):
        """
        Example-based explainability that returns the nearest neighbors from the provided dataset.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceArgs'] example_gcs_source: The Cloud Storage input instances.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs'] gcs_source: The Cloud Storage locations that contain the instances to be indexed for approximate nearest neighbor search.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1PresetsArgs'] presets: Simplified preset configuration, which automatically sets configuration values based on the desired query speed-precision trade-off and modality.
        """
    ...
    def example_gcs_source(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceArgs']]:
        """
        The Cloud Storage input instances.
        """
    ...
    def example_gcs_source(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceArgs']]):
    ...
    @property
    @pulumi.getter
    def presets(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsArgs']]:
        """
    ...
    @presets.setter
    def presets(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ExplanationParametersArgs:
    def __init__(__self__, *,
                 examples: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesArgs']] = None,
                 integrated_gradients_attribution: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1IntegratedGradientsAttributionArgs']] = None,
                 output_indices: Optional[pulumi.Input[Sequence[Any]]] = None,
                 sampled_shapley_attribution: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampledShapleyAttributionArgs']] = None,
                 top_k: Optional[pulumi.Input[int]] = None,
                 xrai_attribution: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1XraiAttributionArgs']] = None):
        """
        Parameters to configure explaining for Model's predictions.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesArgs'] examples: Example-based explanations that returns the nearest neighbors from the provided dataset.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1IntegratedGradientsAttributionArgs'] integrated_gradients_attribution: An attribution method that computes Aumann-Shapley values taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1SampledShapleyAttributionArgs'] sampled_shapley_attribution: An attribution method that approximates Shapley values for features that contribute to the label being predicted. A sampling strategy is used to approximate the value rather than considering all subsets of features. Refer to this paper for model details: https://arxiv.org/abs/1306.4265.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1XraiAttributionArgs'] xrai_attribution: An attribution method that redistributes Integrated Gradients attribution to segmented regions, taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1906.02825 XRAI currently performs better on natural images, like a picture of a house or an animal. If the images are taken in artificial environments, like a lab or manufacturing line, or from diagnostic equipment, like x-rays or quality-control cameras, use Integrated Gradients instead.
        """
    ...
    @property
    @pulumi.getter
    def examples(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesArgs']]:
        """
    ...
    @examples.setter
    def examples(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExamplesArgs']]):
        pulumi.set(self, "examples", value)

    @property
    @pulumi.getter(name="integratedGradientsAttribution")
    def integrated_gradients_attribution(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1IntegratedGradientsAttributionArgs']]:
        """
    ...
    def integrated_gradients_attribution(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1IntegratedGradientsAttributionArgs']]):
    ...
    def sampled_shapley_attribution(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampledShapleyAttributionArgs']]:
        """
    ...
    def sampled_shapley_attribution(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampledShapleyAttributionArgs']]):
    ...
    def xrai_attribution(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1XraiAttributionArgs']]:
        """
    ...
    def xrai_attribution(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1XraiAttributionArgs']]):
        pulumi.set(self, "xrai_attribution", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ExplanationSpecArgs:
    def __init__(__self__, *,
                 parameters: pulumi.Input['GoogleCloudAiplatformV1beta1ExplanationParametersArgs'],
                 metadata: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExplanationMetadataArgs']] = None):
        """
        Specification of Model explanation.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ExplanationParametersArgs'] parameters: Parameters that configure explaining of the Model's predictions.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ExplanationMetadataArgs'] metadata: Optional. Metadata describing the Model's input and output for explanation.
        """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1ExplanationParametersArgs']:
        """
    ...
    @parameters.setter
    def parameters(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1ExplanationParametersArgs']):
        pulumi.set(self, "parameters", value)

    @property
    @pulumi.getter
    def metadata(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExplanationMetadataArgs']]:
        """
    ...
    @metadata.setter
    def metadata(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ExplanationMetadataArgs']]):
        pulumi.set(self, "metadata", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs:
    def __init__(__self__, *,
                 big_query_source: pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs'],
                 entity_id_columns: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        Input source type for BigQuery Tables and Views.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs'] big_query_source: Immutable. The BigQuery source URI that points to either a BigQuery Table or View.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] entity_id_columns: Optional. Columns to construct entity_id / row keys. If not provided defaults to `entity_id`.
        """
    ...
    @property
    @pulumi.getter(name="bigQuerySource")
    def big_query_source(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs']:
        """
    ...
    def big_query_source(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs']):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureNoiseSigmaArgs:
    def __init__(__self__, *,
                 noise_sigma: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureArgs']]]] = None):
        """
        Noise sigma by features. Noise sigma represents the standard deviation of the gaussian kernel that will be used to add noise to interpolated inputs prior to computing gradients.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureArgs']]] noise_sigma: Noise sigma per feature. No noise is added to features that are not set.
        """
    ...
    def noise_sigma(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureArgs']]]]:
        """
    ...
    @noise_sigma.setter
    def noise_sigma(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureArgs']]]]):
        pulumi.set(self, "noise_sigma", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableAutoScalingArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableArgs:
    def __init__(__self__, *,
                 auto_scaling: pulumi.Input['GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableAutoScalingArgs']):
        """
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableAutoScalingArgs'] auto_scaling: Autoscaling config applied to Bigtable Instance.
        """
        pulumi.set(__self__, "auto_scaling", auto_scaling)

    @property
    @pulumi.getter(name="autoScaling")
    def auto_scaling(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableAutoScalingArgs']:
        """
    ...
    @auto_scaling.setter
    def auto_scaling(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableAutoScalingArgs']):
        pulumi.set(self, "auto_scaling", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureOnlineStoreDedicatedServingEndpointArgs:
    def __init__(__self__, *,
                 private_service_connect_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigArgs']] = None):
        """
        The dedicated serving endpoint for this FeatureOnlineStore. Only need to set when you choose Optimized storage type. Public endpoint is provisioned by default.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigArgs'] private_service_connect_config: Optional. Private service connect config. The private service connection is available only for Optimized storage type, not for embedding management now. If PrivateServiceConnectConfig.enable_private_service_connect set to true, customers will use private service connection to send request. Otherwise, the connection will set to public endpoint.
        """
    ...
    def private_service_connect_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigArgs']]:
        """
    ...
    def private_service_connect_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigArgs']]):
        pulumi.set(self, "private_service_connect_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureOnlineStoreEmbeddingManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: Optional. Immutable. Whether to enable embedding management in this FeatureOnlineStore. It's immutable after creation to ensure the FeatureOnlineStore availability.
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureOnlineStoreOptimizedArgs:
    def __init__(__self__):
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs:
    def __init__(__self__, *,
                 anomaly_detection_threshold: Optional[pulumi.Input[float]] = None,
                 anomaly_uri: Optional[pulumi.Input[str]] = None,
                 distribution_deviation: Optional[pulumi.Input[float]] = None,
                 end_time: Optional[pulumi.Input[str]] = None,
                 score: Optional[pulumi.Input[float]] = None,
                 start_time: Optional[pulumi.Input[str]] = None,
                 stats_uri: Optional[pulumi.Input[str]] = None):
        """
        Stats and Anomaly generated at specific timestamp for specific Feature. The start_time and end_time are used to define the time range of the dataset that current stats belongs to, e.g. prediction traffic is bucketed into prediction datasets by time window. If the Dataset is not defined by time window, start_time = end_time. Timestamp of the stats and anomalies always refers to end_time. Raw stats and anomalies are stored in stats_uri or anomaly_uri in the tensorflow defined protos. Field data_stats contains almost identical information with the raw stats in Vertex AI defined proto, for UI to display.
        :param pulumi.Input[float] anomaly_detection_threshold: This is the threshold used when detecting anomalies. The threshold can be changed by user, so this one might be different from ThresholdConfig.value.
        :param pulumi.Input[str] anomaly_uri: Path of the anomaly file for current feature values in Cloud Storage bucket. Format: gs:////anomalies. Example: gs://monitoring_bucket/feature_name/anomalies. Stats are stored as binary format with Protobuf message Anoamlies are stored as binary format with Protobuf message [tensorflow.metadata.v0.AnomalyInfo] (https://github.com/tensorflow/metadata/blob/master/tensorflow_metadata/proto/v0/anomalies.proto).
        :param pulumi.Input[float] distribution_deviation: Deviation from the current stats to baseline stats. 1. For categorical feature, the distribution distance is calculated by L-inifinity norm. 2. For numerical feature, the distribution distance is calculated by Jensen–Shannon divergence.
        :param pulumi.Input[str] end_time: The end timestamp of window where stats were generated. For objectives where time window doesn't make sense (e.g. Featurestore Snapshot Monitoring), end_time indicates the timestamp of the data used to generate stats (e.g. timestamp we take snapshots for feature values).
        :param pulumi.Input[float] score: Feature importance score, only populated when cross-feature monitoring is enabled. For now only used to represent feature attribution score within range [0, 1] for ModelDeploymentMonitoringObjectiveType.FEATURE_ATTRIBUTION_SKEW and ModelDeploymentMonitoringObjectiveType.FEATURE_ATTRIBUTION_DRIFT.
        :param pulumi.Input[str] start_time: The start timestamp of window where stats were generated. For objectives where time window doesn't make sense (e.g. Featurestore Snapshot Monitoring), start_time is only used to indicate the monitoring intervals, so it always equals to (end_time - monitoring_interval).
        :param pulumi.Input[str] stats_uri: Path of the stats file for current feature values in Cloud Storage bucket. Format: gs:////stats. Example: gs://monitoring_bucket/feature_name/stats. Stats are stored as binary format with Protobuf message [tensorflow.metadata.v0.FeatureNameStatistics](https://github.com/tensorflow/metadata/blob/master/tensorflow_metadata/proto/v0/statistics.proto).
        """
        if anomaly_detection_threshold is not None:
            pulumi.set(__self__, "anomaly_detection_threshold", anomaly_detection_threshold)
        if anomaly_uri is not None:
            pulumi.set(__self__, "anomaly_uri", anomaly_uri)
        if distribution_deviation is not None:
    ...
    def anomaly_detection_threshold(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def anomaly_detection_threshold(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "anomaly_detection_threshold", value)

    @property
    @pulumi.getter(name="anomalyUri")
    def anomaly_uri(self) -> Optional[pulumi.Input[str]]:
        """
        Path of the anomaly file for current feature values in Cloud Storage bucket. Format: gs:////anomalies. Example: gs://monitoring_bucket/feature_name/anomalies. Stats are stored as binary format with Protobuf message Anoamlies are stored as binary format with Protobuf message [tensorflow.metadata.v0.AnomalyInfo] (https://github.com/tensorflow/metadata/blob/master/tensorflow_metadata/proto/v0/anomalies.proto).
        """
    ...
    @anomaly_uri.setter
    def anomaly_uri(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "anomaly_uri", value)

    @property
    @pulumi.getter(name="distributionDeviation")
    def distribution_deviation(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def distribution_deviation(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "distribution_deviation", value)
    ...
    def stats_uri(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @stats_uri.setter
    def stats_uri(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "stats_uri", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceArgs:
    def __init__(__self__, *,
                 entity_id_columns: pulumi.Input[Sequence[pulumi.Input[str]]],
                 uri: pulumi.Input[str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[str]]] entity_id_columns: Columns to construct entity_id / row keys.
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceFeatureGroupArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceArgs:
    def __init__(__self__, *,
                 feature_groups: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceFeatureGroupArgs']]],
                 project_number: Optional[pulumi.Input[str]] = None):
        """
        A Feature Registry source for features that need to be synced to Online Store.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceFeatureGroupArgs']]] feature_groups: List of features that need to be synced to Online Store.
        :param pulumi.Input[str] project_number: Optional. The project number of the parent project of the Feature Groups.
        """
    ...
    def feature_groups(self) -> pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceFeatureGroupArgs']]]:
        """
    ...
    def feature_groups(self, value: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceFeatureGroupArgs']]]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewIndexConfigBruteForceConfigArgs:
    def __init__(__self__):
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewIndexConfigTreeAHConfigArgs:
    def __init__(__self__, *,
                 leaf_node_embedding_count: Optional[pulumi.Input[str]] = None):
        """
        Configuration options for the tree-AH algorithm.
        :param pulumi.Input[str] leaf_node_embedding_count: Optional. Number of embeddings on each leaf node. The default value is 1000 if not set.
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewIndexConfigArgs:
    def __init__(__self__, *,
                 brute_force_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigBruteForceConfigArgs']] = None,
                 crowding_column: Optional[pulumi.Input[str]] = None,
                 distance_measure_type: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigDistanceMeasureType']] = None,
                 embedding_column: Optional[pulumi.Input[str]] = None,
                 embedding_dimension: Optional[pulumi.Input[int]] = None,
                 filter_columns: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 tree_ah_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigTreeAHConfigArgs']] = None):
        """
        Configuration for vector indexing.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigBruteForceConfigArgs'] brute_force_config: Optional. Configuration options for using brute force search, which simply implements the standard linear search in the database for each query. It is primarily meant for benchmarking and to generate the ground truth for approximate search.
        :param pulumi.Input[str] crowding_column: Optional. Column of crowding. This column contains crowding attribute which is a constraint on a neighbor list produced by FeatureOnlineStoreService.SearchNearestEntities to diversify search results. If NearestNeighborQuery.per_crowding_attribute_neighbor_count is set to K in SearchNearestEntitiesRequest, it's guaranteed that no more than K entities of the same crowding attribute are returned in the response.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigDistanceMeasureType'] distance_measure_type: Optional. The distance measure used in nearest neighbor search.
        :param pulumi.Input[str] embedding_column: Optional. Column of embedding. This column contains the source data to create index for vector search. embedding_column must be set when using vector search.
        :param pulumi.Input[int] embedding_dimension: Optional. The number of dimensions of the input embedding.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] filter_columns: Optional. Columns of features that're used to filter vector search results.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigTreeAHConfigArgs'] tree_ah_config: Optional. Configuration options for the tree-AH algorithm (Shallow tree + Asymmetric Hashing). Please refer to this paper for more details: https://arxiv.org/abs/1908.10396
        """
    ...
    def brute_force_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigBruteForceConfigArgs']]:
        """
    ...
    def brute_force_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigBruteForceConfigArgs']]):
    ...
    def distance_measure_type(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigDistanceMeasureType']]:
        """
    ...
    def distance_measure_type(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigDistanceMeasureType']]):
        pulumi.set(self, "distance_measure_type", value)

    @property
    @pulumi.getter(name="embeddingColumn")
    def embedding_column(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def embedding_column(self, value: Optional[pulumi.Input[str]]):
    ...
    def tree_ah_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigTreeAHConfigArgs']]:
        """
    ...
    def tree_ah_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewIndexConfigTreeAHConfigArgs']]):
        pulumi.set(self, "tree_ah_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewSyncConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigBruteForceConfigArgs:
    def __init__(__self__):
        pass


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigTreeAHConfigArgs:
    def __init__(__self__, *,
                 leaf_node_embedding_count: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] leaf_node_embedding_count: Optional. Number of embeddings on each leaf node. The default value is 1000 if not set.
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigArgs:
    def __init__(__self__, *,
                 brute_force_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigBruteForceConfigArgs']] = None,
                 crowding_column: Optional[pulumi.Input[str]] = None,
                 distance_measure_type: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigDistanceMeasureType']] = None,
                 embedding_column: Optional[pulumi.Input[str]] = None,
                 embedding_dimension: Optional[pulumi.Input[int]] = None,
                 filter_columns: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 tree_ah_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigTreeAHConfigArgs']] = None):
        """
        Deprecated. Use IndexConfig instead.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigBruteForceConfigArgs'] brute_force_config: Optional. Configuration options for using brute force search, which simply implements the standard linear search in the database for each query. It is primarily meant for benchmarking and to generate the ground truth for approximate search.
        :param pulumi.Input[str] crowding_column: Optional. Column of crowding. This column contains crowding attribute which is a constraint on a neighbor list produced by FeatureOnlineStoreService.SearchNearestEntities to diversify search results. If NearestNeighborQuery.per_crowding_attribute_neighbor_count is set to K in SearchNearestEntitiesRequest, it's guaranteed that no more than K entities of the same crowding attribute are returned in the response.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigDistanceMeasureType'] distance_measure_type: Optional. The distance measure used in nearest neighbor search.
        :param pulumi.Input[str] embedding_column: Optional. Column of embedding. This column contains the source data to create index for vector search. embedding_column must be set when using vector search.
        :param pulumi.Input[int] embedding_dimension: Optional. The number of dimensions of the input embedding.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] filter_columns: Optional. Columns of features that're used to filter vector search results.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigTreeAHConfigArgs'] tree_ah_config: Optional. Configuration options for the tree-AH algorithm (Shallow tree + Asymmetric Hashing). Please refer to this paper for more details: https://arxiv.org/abs/1908.10396
        """
        if brute_force_config is not None:
            pulumi.set(__self__, "brute_force_config", brute_force_config)
        if crowding_column is not None:
    ...
    @property
    @pulumi.getter(name="bruteForceConfig")
    def brute_force_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigBruteForceConfigArgs']]:
        """
        Optional. Configuration options for using brute force search, which simply implements the standard linear search in the database for each query. It is primarily meant for benchmarking and to generate the ground truth for approximate search.
        """
        return pulumi.get(self, "brute_force_config")
    ...
    @brute_force_config.setter
    def brute_force_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigBruteForceConfigArgs']]):
        pulumi.set(self, "brute_force_config", value)
    ...
    @property
    @pulumi.getter(name="distanceMeasureType")
    def distance_measure_type(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigDistanceMeasureType']]:
        """
        Optional. The distance measure used in nearest neighbor search.
        """
        return pulumi.get(self, "distance_measure_type")
    ...
    @distance_measure_type.setter
    def distance_measure_type(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigDistanceMeasureType']]):
        pulumi.set(self, "distance_measure_type", value)
    ...
    @property
    @pulumi.getter(name="treeAhConfig")
    def tree_ah_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigTreeAHConfigArgs']]:
        """
        Optional. Configuration options for the tree-AH algorithm (Shallow tree + Asymmetric Hashing). Please refer to this paper for more details: https://arxiv.org/abs/1908.10396
        """
        return pulumi.get(self, "tree_ah_config")
    ...
    @tree_ah_config.setter
    def tree_ah_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigTreeAHConfigArgs']]):
        pulumi.set(self, "tree_ah_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisArgs:
    def __init__(__self__, *,
                 anomaly_detection_baseline: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisAnomalyDetectionBaseline']] = None,
                 state: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisState']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisAnomalyDetectionBaseline'] anomaly_detection_baseline: The baseline used to do anomaly detection for the statistics generated by import features analysis.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisState'] state: Whether to enable / disable / inherite default hebavior for import features analysis.
        """
    ...
    def anomaly_detection_baseline(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisAnomalyDetectionBaseline']]:
        """
    ...
    def anomaly_detection_baseline(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisAnomalyDetectionBaseline']]):
        pulumi.set(self, "anomaly_detection_baseline", value)

    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisState']]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisState']]):
        pulumi.set(self, "state", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigSnapshotAnalysisArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigArgs:
    def __init__(__self__, *,
                 categorical_threshold_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs']] = None,
                 import_features_analysis: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisArgs']] = None,
                 numerical_threshold_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs']] = None,
                 snapshot_analysis: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigSnapshotAnalysisArgs']] = None):
        """
        Configuration of how features in Featurestore are monitored.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs'] categorical_threshold_config: Threshold for categorical features of anomaly detection. This is shared by all types of Featurestore Monitoring for categorical features (i.e. Features with type (Feature.ValueType) BOOL or STRING).
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisArgs'] import_features_analysis: The config for ImportFeatures Analysis Based Feature Monitoring.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs'] numerical_threshold_config: Threshold for numerical features of anomaly detection. This is shared by all objectives of Featurestore Monitoring for numerical features (i.e. Features with type (Feature.ValueType) DOUBLE or INT64).
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigSnapshotAnalysisArgs'] snapshot_analysis: The config for Snapshot Analysis Based Feature Monitoring.
        """
    ...
    def categorical_threshold_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs']]:
        """
    ...
    def categorical_threshold_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs']]):
        pulumi.set(self, "categorical_threshold_config", value)

    @property
    @pulumi.getter(name="importFeaturesAnalysis")
    def import_features_analysis(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisArgs']]:
        """
    ...
    def import_features_analysis(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysisArgs']]):
        pulumi.set(self, "import_features_analysis", value)

    @property
    @pulumi.getter(name="numericalThresholdConfig")
    def numerical_threshold_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs']]:
        """
    ...
    def numerical_threshold_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfigArgs']]):
        pulumi.set(self, "numerical_threshold_config", value)

    @property
    @pulumi.getter(name="snapshotAnalysis")
    def snapshot_analysis(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigSnapshotAnalysisArgs']]:
        """
    ...
    def snapshot_analysis(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigSnapshotAnalysisArgs']]):
        pulumi.set(self, "snapshot_analysis", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScalingArgs:
    def __init__(__self__, *,
                 min_node_count: pulumi.Input[int],
                 cpu_utilization_target: Optional[pulumi.Input[int]] = None,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigArgs:
    def __init__(__self__, *,
                 fixed_node_count: Optional[pulumi.Input[int]] = None,
                 scaling: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScalingArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScalingArgs'] scaling: Online serving scaling configuration. Only one of `fixed_node_count` and `scaling` can be set. Setting one will reset the other.
        """
    ...
    @property
    @pulumi.getter
    def scaling(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScalingArgs']]:
        """
    ...
    @scaling.setter
    def scaling(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScalingArgs']]):
        pulumi.set(self, "scaling", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1FilterSplitArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1FractionSplitArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1GcsDestinationArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1GcsSourceArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1GenieSourceArgs:
    def __init__(__self__, *,
                 base_model_uri: pulumi.Input[str]):
        """
        Contains information about the source of the models generated from Generative AI Studio.
        :param pulumi.Input[str] base_model_uri: The public base model URI.
        """
        pulumi.set(__self__, "base_model_uri", base_model_uri)

    @property
    @pulumi.getter(name="baseModelUri")
    def base_model_uri(self) -> pulumi.Input[str]:
        """
    ...
    def base_model_uri(self, value: pulumi.Input[str]):
        pulumi.set(self, "base_model_uri", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1InputDataConfigArgs:
    def __init__(__self__, *,
                 dataset_id: pulumi.Input[str],
                 annotation_schema_uri: Optional[pulumi.Input[str]] = None,
                 annotations_filter: Optional[pulumi.Input[str]] = None,
                 bigquery_destination: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs']] = None,
                 filter_split: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FilterSplitArgs']] = None,
                 fraction_split: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FractionSplitArgs']] = None,
                 gcs_destination: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']] = None,
                 persist_ml_use_assignment: Optional[pulumi.Input[bool]] = None,
                 predefined_split: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PredefinedSplitArgs']] = None,
                 saved_query_id: Optional[pulumi.Input[str]] = None,
                 stratified_split: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StratifiedSplitArgs']] = None,
                 timestamp_split: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1TimestampSplitArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs'] bigquery_destination: Only applicable to custom training with tabular Dataset with BigQuery source. The BigQuery project location where the training data is to be written to. In the given project a new dataset is created with name `dataset___` where timestamp is in YYYY_MM_DDThh_mm_ss_sssZ format. All training input data is written into that dataset. In the dataset three tables are created, `training`, `validation` and `test`. * AIP_DATA_FORMAT = "bigquery". * AIP_TRAINING_DATA_URI = "bigquery_destination.dataset___.training" * AIP_VALIDATION_DATA_URI = "bigquery_destination.dataset___.validation" * AIP_TEST_DATA_URI = "bigquery_destination.dataset___.test"
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FilterSplitArgs'] filter_split: Split based on the provided filters for each set.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FractionSplitArgs'] fraction_split: Split based on fractions defining the size of each set.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1PredefinedSplitArgs'] predefined_split: Supported only for tabular Datasets. Split based on a predefined key.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StratifiedSplitArgs'] stratified_split: Supported only for tabular Datasets. Split based on the distribution of the specified column.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1TimestampSplitArgs'] timestamp_split: Supported only for tabular Datasets. Split based on the timestamp of the input data pieces.
        """
    ...
    def filter_split(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FilterSplitArgs']]:
        """
    ...
    @filter_split.setter
    def filter_split(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FilterSplitArgs']]):
        pulumi.set(self, "filter_split", value)

    @property
    @pulumi.getter(name="fractionSplit")
    def fraction_split(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FractionSplitArgs']]:
        """
    ...
    def fraction_split(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FractionSplitArgs']]):
    ...
    def predefined_split(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PredefinedSplitArgs']]:
        """
    ...
    def predefined_split(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PredefinedSplitArgs']]):
    ...
    def stratified_split(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StratifiedSplitArgs']]:
        """
    ...
    def stratified_split(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StratifiedSplitArgs']]):
        pulumi.set(self, "stratified_split", value)

    @property
    @pulumi.getter(name="timestampSplit")
    def timestamp_split(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1TimestampSplitArgs']]:
        """
    ...
    def timestamp_split(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1TimestampSplitArgs']]):
        pulumi.set(self, "timestamp_split", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1IntegratedGradientsAttributionArgs:
    def __init__(__self__, *,
                 step_count: pulumi.Input[int],
                 blur_baseline_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BlurBaselineConfigArgs']] = None,
                 smooth_grad_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SmoothGradConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1BlurBaselineConfigArgs'] blur_baseline_config: Config for IG with blur baseline. When enabled, a linear path from the maximally blurred image to the input image is created. Using a blurred baseline instead of zero (black image) is motivated by the BlurIG approach explained here: https://arxiv.org/abs/2004.03383
        :param pulumi.Input['GoogleCloudAiplatformV1beta1SmoothGradConfigArgs'] smooth_grad_config: Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
        """
    ...
    def blur_baseline_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BlurBaselineConfigArgs']]:
        """
    ...
    def blur_baseline_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BlurBaselineConfigArgs']]):
        pulumi.set(self, "blur_baseline_config", value)

    @property
    @pulumi.getter(name="smoothGradConfig")
    def smooth_grad_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SmoothGradConfigArgs']]:
        """
    ...
    def smooth_grad_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SmoothGradConfigArgs']]):
        pulumi.set(self, "smooth_grad_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1MachineSpecArgs:
    def __init__(__self__, *,
                 accelerator_count: Optional[pulumi.Input[int]] = None,
                 accelerator_type: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecAcceleratorType']] = None,
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecAcceleratorType'] accelerator_type: Immutable. The type of accelerator(s) that may be attached to the machine as per accelerator_count.
    ...
    def accelerator_type(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecAcceleratorType']]:
        """
    ...
    def accelerator_type(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecAcceleratorType']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ManualBatchTuningParametersArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelBaseModelSourceArgs:
    def __init__(__self__, *,
                 genie_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GenieSourceArgs']] = None,
                 model_garden_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelGardenSourceArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1GenieSourceArgs'] genie_source: Information about the base model of Genie models.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelGardenSourceArgs'] model_garden_source: Source information of Model Garden models.
        """
        if genie_source is not None:
            pulumi.set(__self__, "genie_source", genie_source)
        if model_garden_source is not None:
            pulumi.set(__self__, "model_garden_source", model_garden_source)

    @property
    @pulumi.getter(name="genieSource")
    def genie_source(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GenieSourceArgs']]:
        """
    ...
    @genie_source.setter
    def genie_source(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GenieSourceArgs']]):
        pulumi.set(self, "genie_source", value)

    @property
    @pulumi.getter(name="modelGardenSource")
    def model_garden_source(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelGardenSourceArgs']]:
        """
    ...
    def model_garden_source(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelGardenSourceArgs']]):
        pulumi.set(self, "model_garden_source", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelContainerSpecArgs:
    def __init__(__self__, *,
                 image_uri: pulumi.Input[str],
                 args: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 command: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 env: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1EnvVarArgs']]]] = None,
                 grpc_ports: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1PortArgs']]]] = None,
                 health_probe: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeArgs']] = None,
                 health_route: Optional[pulumi.Input[str]] = None,
                 ports: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1PortArgs']]]] = None,
                 predict_route: Optional[pulumi.Input[str]] = None,
                 shared_memory_size_mb: Optional[pulumi.Input[str]] = None,
                 startup_probe: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeArgs']] = None):
        """
        ...
        :param pulumi.Input[str] deployment_timeout: Immutable. Deployment timeout. Limit for deployment timeout is 2 hours.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1EnvVarArgs']]] env: Immutable. List of environment variables to set in the container. After the container starts running, code running in the container can read these environment variables. Additionally, the command and args fields can reference these variables. Later entries in this list can also reference earlier entries. For example, the following example sets the variable `VAR_2` to have the value `foo bar`: ```json [ { "name": "VAR_1", "value": "foo" }, { "name": "VAR_2", "value": "$(VAR_1) bar" } ] ``` If you switch the order of the variables in the example, then the expansion does not occur. This field corresponds to the `env` field of the Kubernetes Containers [v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core).
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1PortArgs']]] grpc_ports: Immutable. List of ports to expose from the container. Vertex AI sends gRPC prediction requests that it receives to the first port on this list. Vertex AI also sends liveness and health checks to this port. If you do not specify this field, gRPC requests to the container will be disabled. Vertex AI does not use ports other than the first one listed. This field corresponds to the `ports` field of the Kubernetes Containers v1 core API.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ProbeArgs'] health_probe: Immutable. Specification for Kubernetes readiness probe.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1PortArgs']]] ports: Immutable. List of ports to expose from the container. Vertex AI sends any prediction requests that it receives to the first port on this list. Vertex AI also sends [liveness and health checks](https://cloud.google.com/vertex-ai/docs/predictions/custom-container-requirements#liveness) to this port. If you do not specify this field, it defaults to following value: ```json [ { "containerPort": 8080 } ] ``` Vertex AI does not use ports other than the first one listed. This field corresponds to the `ports` field of the Kubernetes Containers [v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core).
        ...
        :param pulumi.Input[str] shared_memory_size_mb: Immutable. The amount of the VM memory to reserve as the shared memory for the model in megabytes.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ProbeArgs'] startup_probe: Immutable. Specification for Kubernetes startup probe.
        """
        pulumi.set(__self__, "image_uri", image_uri)
        if args is not None:
            pulumi.set(__self__, "args", args)
    ...
    def grpc_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1PortArgs']]]]:
        """
    ...
    @grpc_ports.setter
    def grpc_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1PortArgs']]]]):
        pulumi.set(self, "grpc_ports", value)

    @property
    @pulumi.getter(name="healthProbe")
    def health_probe(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeArgs']]:
        """
    ...
    @health_probe.setter
    def health_probe(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeArgs']]):
    ...
    @property
    @pulumi.getter
    def ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1PortArgs']]]]:
        """
        Immutable. List of ports to expose from the container. Vertex AI sends any prediction requests that it receives to the first port on this list. Vertex AI also sends [liveness and health checks](https://cloud.google.com/vertex-ai/docs/predictions/custom-container-requirements#liveness) to this port. If you do not specify this field, it defaults to following value: ```json [ { "containerPort": 8080 } ] ``` Vertex AI does not use ports other than the first one listed. This field corresponds to the `ports` field of the Kubernetes Containers [v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core).
        """
    ...
    @ports.setter
    def ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1PortArgs']]]]):
    ...
    def startup_probe(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeArgs']]:
        """
    ...
    def startup_probe(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeArgs']]):
        pulumi.set(self, "startup_probe", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigArgs:
    def __init__(__self__, *,
                 deployed_model_id: Optional[pulumi.Input[str]] = None,
                 objective_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs']] = None):
        """
        ModelDeploymentMonitoringObjectiveConfig contains the pair of deployed_model_id to ModelMonitoringObjectiveConfig.
        :param pulumi.Input[str] deployed_model_id: The DeployedModel ID of the objective config.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs'] objective_config: The objective config of for the modelmonitoring job of this deployed model.
        """
    ...
    def objective_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs']]:
        """
    ...
    def objective_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs']]):
        pulumi.set(self, "objective_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelGardenSourceArgs:
    def __init__(__self__, *,
                 public_model_name: pulumi.Input[str]):
        """
        Contains information about the source of the models generated from Model Garden.
        :param pulumi.Input[str] public_model_name: The model garden source model resource name.
        """
        pulumi.set(__self__, "public_model_name", public_model_name)

    @property
    @pulumi.getter(name="publicModelName")
    def public_model_name(self) -> pulumi.Input[str]:
        """
    ...
    def public_model_name(self, value: pulumi.Input[str]):
        pulumi.set(self, "public_model_name", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigArgs:
    def __init__(__self__, *,
                 email_alert_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigArgs']] = None,
                 enable_logging: Optional[pulumi.Input[bool]] = None,
                 notification_channels: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        The alert config for model monitoring.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigArgs'] email_alert_config: Email alert config.
    ...
    def email_alert_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigArgs']]:
        """
        Email alert config.
        """
    ...
    def email_alert_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringConfigArgs:
    def __init__(__self__, *,
                 alert_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigArgs']] = None,
                 analysis_instance_schema_uri: Optional[pulumi.Input[str]] = None,
                 objective_configs: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs']]]] = None,
                 stats_anomalies_base_directory: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']] = None):
        """
        The model monitoring configuration used for Batch Prediction Job.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigArgs'] alert_config: Model monitoring alert config.
        :param pulumi.Input[str] analysis_instance_schema_uri: YAML schema file uri in Cloud Storage describing the format of a single instance that you want Tensorflow Data Validation (TFDV) to analyze. If there are any data type differences between predict instance and TFDV instance, this field can be used to override the schema. For models trained with Vertex AI, this field must be set as all the fields in predict instance formatted as string.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs']]] objective_configs: Model monitoring objective config.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs'] stats_anomalies_base_directory: A Google Cloud Storage location for batch prediction model monitoring to dump statistics and anomalies. If not provided, a folder will be created in customer project to hold statistics and anomalies.
        """
        ...
        if objective_configs is not None:
            pulumi.set(__self__, "objective_configs", objective_configs)
    ...
    def alert_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigArgs']]:
        """
    ...
    @alert_config.setter
    def alert_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigArgs']]):
    ...
    @property
    @pulumi.getter(name="objectiveConfigs")
    def objective_configs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs']]]]:
        """
        Model monitoring objective config.
        """
        return pulumi.get(self, "objective_configs")

    @objective_configs.setter
    def objective_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs']]]]):
        pulumi.set(self, "objective_configs", value)
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineArgs:
    def __init__(__self__, *,
                 bigquery: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs']] = None,
                 gcs: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']] = None,
                 prediction_format: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselinePredictionFormat']] = None):
        """
        Output from BatchPredictionJob for Model Monitoring baseline dataset, which can be used to generate baseline attribution scores.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs'] bigquery: BigQuery location for BatchExplain output.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs'] gcs: Cloud Storage location for BatchExplain output.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselinePredictionFormat'] prediction_format: The storage format of the predictions generated BatchPrediction job.
        """
    ...
    @property
    @pulumi.getter
    def bigquery(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs']]:
        """
    ...
    @bigquery.setter
    def bigquery(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs']]):
        pulumi.set(self, "bigquery", value)

    @property
    @pulumi.getter
    def gcs(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']]:
        """
    ...
    @gcs.setter
    def gcs(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsDestinationArgs']]):
        pulumi.set(self, "gcs", value)

    @property
    @pulumi.getter(name="predictionFormat")
    def prediction_format(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselinePredictionFormat']]:
        """
    ...
    def prediction_format(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselinePredictionFormat']]):
        pulumi.set(self, "prediction_format", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigArgs:
    def __init__(__self__, *,
                 enable_feature_attributes: Optional[pulumi.Input[bool]] = None,
                 explanation_baseline: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineArgs'] explanation_baseline: Predictions generated by the BatchPredictionJob using baseline dataset.
        """
    ...
    def explanation_baseline(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineArgs']]:
        """
    ...
    def explanation_baseline(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineArgs']]):
...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigArgs:
    ...
    def default_drift_threshold(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ThresholdConfigArgs']]:
        """
    ...
    def default_drift_threshold(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ThresholdConfigArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingDatasetArgs:
    def __init__(__self__, *,
                 bigquery_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs']] = None,
                 data_format: Optional[pulumi.Input[str]] = None,
                 dataset: Optional[pulumi.Input[str]] = None,
                 gcs_source: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs']] = None,
                 logging_sampling_strategy: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SamplingStrategyArgs']] = None,
                 target_field: Optional[pulumi.Input[str]] = None):
        """
        Training Dataset information.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1BigQuerySourceArgs'] bigquery_source: The BigQuery table of the unmanaged Dataset used to train this Model.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1GcsSourceArgs'] gcs_source: The Google Cloud Storage uri of the unmanaged Dataset used to train this Model.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1SamplingStrategyArgs'] logging_sampling_strategy: Strategy to sample data from Training Dataset. If not set, we process the whole dataset.
    ...
    def logging_sampling_strategy(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SamplingStrategyArgs']]:
        """
    ...
    def logging_sampling_strategy(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SamplingStrategyArgs']]):
...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigArgs:
    ...
    def default_skew_threshold(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ThresholdConfigArgs']]:
        """
    ...
    def default_skew_threshold(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ThresholdConfigArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigArgs:
    def __init__(__self__, *,
                 explanation_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigArgs']] = None,
                 prediction_drift_detection_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigArgs']] = None,
                 training_dataset: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingDatasetArgs']] = None,
                 training_prediction_skew_detection_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigArgs']] = None):
        """
        The objective configuration for model monitoring, including the information needed to detect anomalies for one particular model.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigArgs'] explanation_config: The config for integrating with Vertex Explainable AI.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigArgs'] prediction_drift_detection_config: The config for drift of prediction data.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingDatasetArgs'] training_dataset: Training dataset for models. This field has to be set only if TrainingPredictionSkewDetectionConfig is specified.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigArgs'] training_prediction_skew_detection_config: The config for skew between training data and prediction data.
        """
    ...
    def explanation_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigArgs']]:
        """
    ...
    def explanation_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfigArgs']]):
        pulumi.set(self, "explanation_config", value)

    @property
    @pulumi.getter(name="predictionDriftDetectionConfig")
    def prediction_drift_detection_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigArgs']]:
        """
    ...
    def prediction_drift_detection_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigArgs']]):
        pulumi.set(self, "prediction_drift_detection_config", value)

    @property
    @pulumi.getter(name="trainingDataset")
    def training_dataset(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingDatasetArgs']]:
        """
    ...
    def training_dataset(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingDatasetArgs']]):
        pulumi.set(self, "training_dataset", value)

    @property
    @pulumi.getter(name="trainingPredictionSkewDetectionConfig")
    def training_prediction_skew_detection_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigArgs']]:
        """
    ...
    def training_prediction_skew_detection_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigArgs']]):
        pulumi.set(self, "training_prediction_skew_detection_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomaliesArgs:
    def __init__(__self__, *,
                 feature_display_name: Optional[pulumi.Input[str]] = None,
                 prediction_stats: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs']]]] = None,
                 threshold: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ThresholdConfigArgs']] = None,
                 training_stats: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs']] = None):
        """
        Historical Stats (and Anomalies) for a specific Feature.
        :param pulumi.Input[str] feature_display_name: Display Name of the Feature.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs']]] prediction_stats: A list of historical stats generated by different time window's Prediction Dataset.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ThresholdConfigArgs'] threshold: Threshold for anomaly detection.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs'] training_stats: Stats calculated for the Training Dataset.
        """
        if feature_display_name is not None:
            pulumi.set(__self__, "feature_display_name", feature_display_name)
        if prediction_stats is not None:
            pulumi.set(__self__, "prediction_stats", prediction_stats)
    ...
    @property
    @pulumi.getter(name="featureDisplayName")
    def feature_display_name(self) -> Optional[pulumi.Input[str]]:
        """
        Display Name of the Feature.
        """
        return pulumi.get(self, "feature_display_name")

    @feature_display_name.setter
    def feature_display_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "feature_display_name", value)

    @property
    @pulumi.getter(name="predictionStats")
    def prediction_stats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs']]]]:
        """
        A list of historical stats generated by different time window's Prediction Dataset.
        """
        return pulumi.get(self, "prediction_stats")

    @prediction_stats.setter
    def prediction_stats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs']]]]):
        pulumi.set(self, "prediction_stats", value)

    @property
    @pulumi.getter
    def threshold(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ThresholdConfigArgs']]:
        """
    ...
    @threshold.setter
    def threshold(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ThresholdConfigArgs']]):
        pulumi.set(self, "threshold", value)

    @property
    @pulumi.getter(name="trainingStats")
    def training_stats(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs']]:
        """
    ...
    def training_stats(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureStatsAnomalyArgs']]):
        pulumi.set(self, "training_stats", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesArgs:
    def __init__(__self__, *,
                 anomaly_count: Optional[pulumi.Input[int]] = None,
                 deployed_model_id: Optional[pulumi.Input[str]] = None,
                 feature_stats: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomaliesArgs']]]] = None,
                 objective: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesObjective']] = None):
        """
        Statistics and anomalies generated by Model Monitoring.
        :param pulumi.Input[int] anomaly_count: Number of anomalies within all stats.
        :param pulumi.Input[str] deployed_model_id: Deployed Model ID.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomaliesArgs']]] feature_stats: A list of historical Stats and Anomalies generated for all Features.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesObjective'] objective: Model Monitoring Objective those stats and anomalies belonging to.
        """
        if anomaly_count is not None:
            pulumi.set(__self__, "anomaly_count", anomaly_count)
        if deployed_model_id is not None:
            pulumi.set(__self__, "deployed_model_id", deployed_model_id)
        if feature_stats is not None:
            pulumi.set(__self__, "feature_stats", feature_stats)
        if objective is not None:
            pulumi.set(__self__, "objective", objective)

    @property
    @pulumi.getter(name="anomalyCount")
    def anomaly_count(self) -> Optional[pulumi.Input[int]]:
        """
        Number of anomalies within all stats.
        """
        return pulumi.get(self, "anomaly_count")

    @anomaly_count.setter
    def anomaly_count(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "anomaly_count", value)
    ...
    @property
    @pulumi.getter(name="featureStats")
    def feature_stats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomaliesArgs']]]]:
        """
        A list of historical Stats and Anomalies generated for all Features.
        """
        return pulumi.get(self, "feature_stats")

    @feature_stats.setter
    def feature_stats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomaliesArgs']]]]):
        pulumi.set(self, "feature_stats", value)

    @property
    @pulumi.getter
    def objective(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesObjective']]:
        """
    ...
    @objective.setter
    def objective(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesObjective']]):
        pulumi.set(self, "objective", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ModelArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecArgs:
    def __init__(__self__, *,
                 goal: pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecGoal'],
                 metric_id: pulumi.Input[str]):
        """
        Represents a metric to optimize.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecGoal'] goal: The optimization goal of the metric.
    ...
    @property
    @pulumi.getter
    def goal(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecGoal']:
        """
    ...
    @goal.setter
    def goal(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecGoal']):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecArgs:
    def __init__(__self__, *,
                 max_parallel_trial_count: pulumi.Input[int],
                 max_trial_count: pulumi.Input[int],
                 search_trial_job_spec: pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs'],
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs'] search_trial_job_spec: The spec of a search trial job. The same spec applies to all search trials.
    ...
    def search_trial_job_spec(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs']:
        """
    ...
    def search_trial_job_spec(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs']):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecArgs:
    def __init__(__self__, *,
                 frequency: pulumi.Input[int],
                 max_parallel_trial_count: pulumi.Input[int],
                 train_trial_job_spec: pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs']):
        """
        ...
        :param pulumi.Input[int] max_parallel_trial_count: The maximum number of trials to run in parallel.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs'] train_trial_job_spec: The spec of a train trial job. The same spec applies to all train trials.
        """
    ...
    def train_trial_job_spec(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs']:
        """
    ...
    def train_trial_job_spec(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs']):
        pulumi.set(self, "train_trial_job_spec", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecArgs:
    def __init__(__self__, *,
                 search_trial_spec: pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecArgs'],
                 metric: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecArgs']] = None,
                 multi_trial_algorithm: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm']] = None,
                 train_trial_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecArgs']] = None):
        """
        The spec of multi-trial Neural Architecture Search (NAS).
        :param pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecArgs'] search_trial_spec: Spec for search trials.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecArgs'] metric: Metric specs for the NAS job. Validation for this field is done at `multi_trial_algorithm_spec` field.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm'] multi_trial_algorithm: The multi-trial Neural Architecture Search (NAS) algorithm type. Defaults to `REINFORCEMENT_LEARNING`.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecArgs'] train_trial_spec: Spec for train trials. Top N [TrainTrialSpec.max_parallel_trial_count] search trials will be trained for every M [TrainTrialSpec.frequency] trials searched.
        """
    ...
    def search_trial_spec(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecArgs']:
        """
    ...
    def search_trial_spec(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecArgs']):
        pulumi.set(self, "search_trial_spec", value)

    @property
    @pulumi.getter
    def metric(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecArgs']]:
        """
    ...
    @metric.setter
    def metric(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecArgs']]):
        pulumi.set(self, "metric", value)

    @property
    @pulumi.getter(name="multiTrialAlgorithm")
    def multi_trial_algorithm(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm']]:
        """
    ...
    def multi_trial_algorithm(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm']]):
        pulumi.set(self, "multi_trial_algorithm", value)

    @property
    @pulumi.getter(name="trainTrialSpec")
    def train_trial_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecArgs']]:
        """
    ...
    def train_trial_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecArgs']]):
        pulumi.set(self, "train_trial_spec", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1NasJobSpecArgs:
    def __init__(__self__, *,
                 multi_trial_algorithm_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecArgs']] = None,
                 resume_nas_job_id: Optional[pulumi.Input[str]] = None,
                 search_space_spec: Optional[pulumi.Input[str]] = None):
        """
        Represents the spec of a NasJob.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecArgs'] multi_trial_algorithm_spec: The spec of multi-trial algorithms.
    ...
    def multi_trial_algorithm_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecArgs']]:
        """
    ...
    def multi_trial_algorithm_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1NetworkSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1NfsMountArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1NotebookEucConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1NotebookReservationAffinityArgs:
    def __init__(__self__, *,
                 consume_reservation_type: pulumi.Input['GoogleCloudAiplatformV1beta1NotebookReservationAffinityConsumeReservationType'],
                 key: Optional[pulumi.Input[str]] = None,
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        Notebook Reservation Affinity for consuming Zonal reservation.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1NotebookReservationAffinityConsumeReservationType'] consume_reservation_type: Specifies the type of reservation from which this instance can consume resources: RESERVATION_ANY (default), RESERVATION_SPECIFIC, or RESERVATION_NONE. See Consuming reserved instances for examples.
        :param pulumi.Input[str] key: Optional. Corresponds to the label key of a reservation resource. To target a RESERVATION_SPECIFIC by name, use compute.googleapis.com/reservation-name as the key and specify the name of your reservation as its value.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] values: Optional. Corresponds to the label values of a reservation resource. This must be the full path name of Reservation.
        """
    ...
    def consume_reservation_type(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1NotebookReservationAffinityConsumeReservationType']:
        """
    ...
    def consume_reservation_type(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1NotebookReservationAffinityConsumeReservationType']):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1PersistentDiskSpecArgs:
    def __init__(__self__, *,
...
class GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigArgs:
    ...
    def failure_policy(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigFailurePolicy']]:
        """
    ...
    def failure_policy(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigFailurePolicy']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1PipelineJobArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1PortArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1PredefinedSplitArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigArgs:
    def __init__(__self__, *,
                 bigquery_destination: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BigQueryDestinationArgs']] = None,
                 enabled: Optional[pulumi.Input[bool]] = None,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1PredictSchemataArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1PresetsArgs:
    def __init__(__self__, *,
                 modality: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsModality']] = None,
                 query: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsQuery']] = None):
        """
        Preset configuration for example-based explanations
        :param pulumi.Input['GoogleCloudAiplatformV1beta1PresetsModality'] modality: The modality of the uploaded model, which automatically configures the distance measurement and feature normalization for the underlying example index and queries. If your model does not precisely fit one of these types, it is okay to choose the closest type.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1PresetsQuery'] query: Preset option controlling parameters for speed-precision trade-off when querying for examples. If omitted, defaults to `PRECISE`.
        """
    ...
    @property
    @pulumi.getter
    def modality(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsModality']]:
        """
    ...
    @modality.setter
    def modality(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsModality']]):
        pulumi.set(self, "modality", value)

    @property
    @pulumi.getter
    def query(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsQuery']]:
        """
    ...
    @query.setter
    def query(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PresetsQuery']]):
        pulumi.set(self, "query", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ProbeExecActionArgs:
    def __init__(__self__, *,
                 command: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ProbeArgs:
    def __init__(__self__, *,
                 exec_: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeExecActionArgs']] = None,
                 period_seconds: Optional[pulumi.Input[int]] = None,
                 timeout_seconds: Optional[pulumi.Input[int]] = None):
        """
        Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ProbeExecActionArgs'] exec_: Exec specifies the action to take.
    ...
    def exec_(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeExecActionArgs']]:
        """
    ...
    @exec_.setter
    def exec_(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ProbeExecActionArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1PythonPackageSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1EnvVarArgs']]] env: Environment variables to be passed to the python module. Maximum limit is 100.
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1RayMetricSpecArgs:
    def __init__(__self__, *,
                 disabled: Optional[pulumi.Input[bool]] = None):
        """
        Configuration for the Ray metrics.
        :param pulumi.Input[bool] disabled: Optional. Flag to disable the Ray metrics collection.
        """
        if disabled is not None:
            pulumi.set(__self__, "disabled", disabled)
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1RaySpecArgs:
    def __init__(__self__, *,
                 head_node_resource_pool_id: Optional[pulumi.Input[str]] = None,
                 image_uri: Optional[pulumi.Input[str]] = None,
                 ray_metric_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1RayMetricSpecArgs']] = None,
                 resource_pool_images: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None):
        """
        Configuration information for the Ray cluster. For experimental launch, Ray cluster creation and Persistent cluster creation are 1:1 mapping: We will provision all the nodes within the Persistent cluster as Ray nodes.
        :param pulumi.Input[str] head_node_resource_pool_id: Optional. This will be used to indicate which resource pool will serve as the Ray head node(the first node within that pool). Will use the machine from the first workerpool as the head node by default if this field isn't set.
        :param pulumi.Input[str] image_uri: Optional. Default image for user to choose a preferred ML framework (for example, TensorFlow or Pytorch) by choosing from [Vertex prebuilt images](https://cloud.google.com/vertex-ai/docs/training/pre-built-containers). Either this or the resource_pool_images is required. Use this field if you need all the resource pools to have the same Ray image. Otherwise, use the {@code resource_pool_images} field.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1RayMetricSpecArgs'] ray_metric_spec: Optional. Ray metrics configurations.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] resource_pool_images: Optional. Required if image_uri isn't set. A map of resource_pool_id to prebuild Ray image if user need to use different images for different head/worker pools. This map needs to cover all the resource pool ids. Example: { "ray_head_node_pool": "head image" "ray_worker_node_pool1": "worker image" "ray_worker_node_pool2": "another worker image" }
        """
        if head_node_resource_pool_id is not None:
            pulumi.set(__self__, "head_node_resource_pool_id", head_node_resource_pool_id)
        if image_uri is not None:
            pulumi.set(__self__, "image_uri", image_uri)
        if ray_metric_spec is not None:
            pulumi.set(__self__, "ray_metric_spec", ray_metric_spec)
        if resource_pool_images is not None:
            pulumi.set(__self__, "resource_pool_images", resource_pool_images)

    @property
    @pulumi.getter(name="headNodeResourcePoolId")
    def head_node_resource_pool_id(self) -> Optional[pulumi.Input[str]]:
        """
        ...
        """
        return pulumi.get(self, "head_node_resource_pool_id")

    @head_node_resource_pool_id.setter
    def head_node_resource_pool_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "head_node_resource_pool_id", value)
    ...
    def ray_metric_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1RayMetricSpecArgs']]:
        """
    ...
    def ray_metric_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1RayMetricSpecArgs']]):
        pulumi.set(self, "ray_metric_spec", value)

    @property
    @pulumi.getter(name="resourcePoolImages")
    def resource_pool_images(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
        Optional. Required if image_uri isn't set. A map of resource_pool_id to prebuild Ray image if user need to use different images for different head/worker pools. This map needs to cover all the resource pool ids. Example: { "ray_head_node_pool": "head image" "ray_worker_node_pool1": "worker image" "ray_worker_node_pool2": "another worker image" }
        """
    ...
    def resource_pool_images(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
        pulumi.set(self, "resource_pool_images", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ReasoningEngineSpecPackageSpecArgs:
    def __init__(__self__, *,
                 dependency_files_gcs_uri: Optional[pulumi.Input[str]] = None,
                 pickle_object_gcs_uri: Optional[pulumi.Input[str]] = None,
                 python_version: Optional[pulumi.Input[str]] = None,
                 requirements_gcs_uri: Optional[pulumi.Input[str]] = None):
        """
        User provided package spec like pickled object and package requirements.
        :param pulumi.Input[str] dependency_files_gcs_uri: Optional. The Cloud Storage URI of the dependency files in tar.gz format.
        :param pulumi.Input[str] pickle_object_gcs_uri: Optional. The Cloud Storage URI of the pickled python object.
        :param pulumi.Input[str] python_version: Optional. The Python version. Currently support 3.8, 3.9, 3.10, 3.11. If not specified, default value is 3.10.
        :param pulumi.Input[str] requirements_gcs_uri: Optional. The Cloud Storage URI of the `requirements.txt` file
        """
    ...
    def dependency_files_gcs_uri(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def dependency_files_gcs_uri(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "dependency_files_gcs_uri", value)

    @property
    @pulumi.getter(name="pickleObjectGcsUri")
    def pickle_object_gcs_uri(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def pickle_object_gcs_uri(self, value: Optional[pulumi.Input[str]]):
    ...
    def requirements_gcs_uri(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def requirements_gcs_uri(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "requirements_gcs_uri", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ReasoningEngineSpecArgs:
    def __init__(__self__, *,
                 package_spec: pulumi.Input['GoogleCloudAiplatformV1beta1ReasoningEngineSpecPackageSpecArgs'],
                 class_methods: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[str]]]]]] = None):
        """
        ReasoningEngine configurations
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ReasoningEngineSpecPackageSpecArgs'] package_spec: User provided package spec of the ReasoningEngine.
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[str]]]]] class_methods: Optional. Declarations for object class methods.
        """
    ...
    def package_spec(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1ReasoningEngineSpecPackageSpecArgs']:
        """
    ...
    @package_spec.setter
    def package_spec(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1ReasoningEngineSpecPackageSpecArgs']):
        pulumi.set(self, "package_spec", value)

    @property
    @pulumi.getter(name="classMethods")
    def class_methods(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[str]]]]]]:
        """
    ...
    def class_methods(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[str]]]]]]):
        pulumi.set(self, "class_methods", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ResourcePoolAutoscalingSpecArgs:
    def __init__(__self__, *,
                 max_replica_count: Optional[pulumi.Input[str]] = None,
                 min_replica_count: Optional[pulumi.Input[str]] = None):
        """
        The min/max number of replicas allowed if enabling autoscaling
        :param pulumi.Input[str] max_replica_count: Optional. max replicas in the node pool, must be ≥ replica_count and > min_replica_count or will throw error
        :param pulumi.Input[str] min_replica_count: Optional. min replicas in the node pool, must be ≤ replica_count and < max_replica_count or will throw error
        """
        if max_replica_count is not None:
            pulumi.set(__self__, "max_replica_count", max_replica_count)
    ...
    @property
    @pulumi.getter(name="maxReplicaCount")
    def max_replica_count(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @max_replica_count.setter
    def max_replica_count(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "max_replica_count", value)

    @property
    @pulumi.getter(name="minReplicaCount")
    def min_replica_count(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @min_replica_count.setter
    def min_replica_count(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "min_replica_count", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1ResourcePoolArgs:
    def __init__(__self__, *,
                 machine_spec: pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs'],
                 autoscaling_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ResourcePoolAutoscalingSpecArgs']] = None,
                 disk_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1DiskSpecArgs']] = None,
                 id: Optional[pulumi.Input[str]] = None,
                 replica_count: Optional[pulumi.Input[str]] = None):
        """
        Represents the spec of a group of resources of the same type, for example machine type, disk, and accelerators, in a PersistentResource.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs'] machine_spec: Immutable. The specification of a single machine.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ResourcePoolAutoscalingSpecArgs'] autoscaling_spec: Optional. Optional spec to configure GKE autoscaling
        :param pulumi.Input['GoogleCloudAiplatformV1beta1DiskSpecArgs'] disk_spec: Optional. Disk spec for the machine in this node pool.
        :param pulumi.Input[str] id: Immutable. The unique ID in a PersistentResource for referring to this resource pool. User can specify it if necessary. Otherwise, it's generated automatically.
        :param pulumi.Input[str] replica_count: Optional. The total number of machines to use for this resource pool.
        """
        pulumi.set(__self__, "machine_spec", machine_spec)
    ...
    def autoscaling_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ResourcePoolAutoscalingSpecArgs']]:
        """
    ...
    def autoscaling_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ResourcePoolAutoscalingSpecArgs']]):
        pulumi.set(self, "autoscaling_spec", value)

    @property
    @pulumi.getter(name="diskSpec")
    def disk_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1DiskSpecArgs']]:
        """
    ...
    @disk_spec.setter
    def disk_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1DiskSpecArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ResourceRuntimeSpecArgs:
    def __init__(__self__, *,
                 ray_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1RaySpecArgs']] = None,
                 service_account_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ServiceAccountSpecArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1RaySpecArgs'] ray_spec: Optional. Ray cluster configuration. Required when creating a dedicated RayCluster on the PersistentResource.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ServiceAccountSpecArgs'] service_account_spec: Optional. Configure the use of workload identity on the PersistentResource
        """
        if ray_spec is not None:
            pulumi.set(__self__, "ray_spec", ray_spec)
        if service_account_spec is not None:
            pulumi.set(__self__, "service_account_spec", service_account_spec)

    @property
    @pulumi.getter(name="raySpec")
    def ray_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1RaySpecArgs']]:
        """
        Optional. Ray cluster configuration. Required when creating a dedicated RayCluster on the PersistentResource.
        """
        return pulumi.get(self, "ray_spec")

    @ray_spec.setter
    def ray_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1RaySpecArgs']]):
        pulumi.set(self, "ray_spec", value)

    @property
    @pulumi.getter(name="serviceAccountSpec")
    def service_account_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ServiceAccountSpecArgs']]:
        """
    ...
    def service_account_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ServiceAccountSpecArgs']]):
        pulumi.set(self, "service_account_spec", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1SampleConfigArgs:
    def __init__(__self__, *,
                 ...
                 sample_strategy: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampleConfigSampleStrategy']] = None):
        """
        Active learning data sampling config. For every active learning labeling iteration, it will select a batch of data based on the sampling strategy.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1SampleConfigSampleStrategy'] sample_strategy: Field to choose sampling strategy. Sampling strategy will decide which data should be selected for human labeling in every batch.
        """
    ...
    def sample_strategy(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampleConfigSampleStrategy']]:
        """
    ...
    def sample_strategy(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SampleConfigSampleStrategy']]):
        pulumi.set(self, "sample_strategy", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1SampledShapleyAttributionArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1SamplingStrategyRandomSampleConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1SamplingStrategyArgs:
    def __init__(__self__, *,
                 random_sample_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SamplingStrategyRandomSampleConfigArgs']] = None):
        """
        Sampling Strategy for logging, can be for both training and prediction dataset.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1SamplingStrategyRandomSampleConfigArgs'] random_sample_config: Random sample config. Will support more sampling strategies later.
        """
    ...
    def random_sample_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SamplingStrategyRandomSampleConfigArgs']]:
        """
    ...
    def random_sample_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SamplingStrategyRandomSampleConfigArgs']]):
        pulumi.set(self, "random_sample_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1SavedQueryArgs:
    def __init__(__self__, *,
                 display_name: pulumi.Input[str],
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1SchedulingArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ServiceAccountSpecArgs:
    def __init__(__self__, *,
                 enable_custom_service_account: pulumi.Input[bool],
                 service_account: Optional[pulumi.Input[str]] = None):
        """
        Configuration for the use of custom service account to run the workloads.
        :param pulumi.Input[bool] enable_custom_service_account: If true, custom user-managed service account is enforced to run any workloads (for example, Vertex Jobs) on the resource. Otherwise, uses the [Vertex AI Custom Code Service Agent](https://cloud.google.com/vertex-ai/docs/general/access-control#service-agents).
    ...
    def enable_custom_service_account(self) -> pulumi.Input[bool]:
        """
    ...
    def enable_custom_service_account(self, value: pulumi.Input[bool]):
        pulumi.set(self, "enable_custom_service_account", value)
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ShieldedVmConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1SmoothGradConfigArgs:
    def __init__(__self__, *,
                 feature_noise_sigma: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureNoiseSigmaArgs']] = None,
                 noise_sigma: Optional[pulumi.Input[float]] = None,
                 noisy_sample_count: Optional[pulumi.Input[int]] = None):
        """
        Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureNoiseSigmaArgs'] feature_noise_sigma: This is similar to noise_sigma, but provides additional flexibility. A separate noise sigma can be provided for each feature, which is useful if their distributions are different. No noise is added to features that are not set. If this field is unset, noise_sigma will be used for all features.
    ...
    def feature_noise_sigma(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureNoiseSigmaArgs']]:
        """
    ...
    def feature_noise_sigma(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureNoiseSigmaArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StratifiedSplitArgs:
    def __init__(__self__, *,
                 key: pulumi.Input[str],
                 test_fraction: Optional[pulumi.Input[float]] = None,
                 training_fraction: Optional[pulumi.Input[float]] = None,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigArgs:
    def __init__(__self__, *,
                 autoregressive_order: Optional[pulumi.Input[str]] = None,
                 learning_rate_parameter_name: Optional[pulumi.Input[str]] = None,
                 max_num_steps: Optional[pulumi.Input[str]] = None,
                 min_num_steps: Optional[pulumi.Input[str]] = None,
                 use_seconds: Optional[pulumi.Input[bool]] = None):
        """
        Configuration for ConvexStopPolicy.
        :param pulumi.Input[str] autoregressive_order: The number of Trial measurements used in autoregressive model for value prediction. A trial won't be considered early stopping if has fewer measurement points.
        :param pulumi.Input[str] learning_rate_parameter_name: The hyper-parameter name used in the tuning job that stands for learning rate. Leave it blank if learning rate is not in a parameter in tuning. The learning_rate is used to estimate the objective value of the ongoing trial.
        :param pulumi.Input[str] max_num_steps: Steps used in predicting the final objective for early stopped trials. In general, it's set to be the same as the defined steps in training / tuning. When use_steps is false, this field is set to the maximum elapsed seconds.
        :param pulumi.Input[str] min_num_steps: Minimum number of steps for a trial to complete. Trials which do not have a measurement with num_steps > min_num_steps won't be considered for early stopping. It's ok to set it to 0, and a trial can be early stopped at any stage. By default, min_num_steps is set to be one-tenth of the max_num_steps. When use_steps is false, this field is set to the minimum elapsed seconds.
        :param pulumi.Input[bool] use_seconds: This bool determines whether or not the rule is applied based on elapsed_secs or steps. If use_seconds==false, the early stopping decision is made according to the predicted objective values according to the target steps. If use_seconds==true, elapsed_secs is used instead of steps. Also, in this case, the parameters max_num_steps and min_num_steps are overloaded to contain max_elapsed_seconds and min_elapsed_seconds.
        """
        if autoregressive_order is not None:
            pulumi.set(__self__, "autoregressive_order", autoregressive_order)
        if learning_rate_parameter_name is not None:
            pulumi.set(__self__, "learning_rate_parameter_name", learning_rate_parameter_name)
        if max_num_steps is not None:
            pulumi.set(__self__, "max_num_steps", max_num_steps)
        if min_num_steps is not None:
            pulumi.set(__self__, "min_num_steps", min_num_steps)
        if use_seconds is not None:
            pulumi.set(__self__, "use_seconds", use_seconds)

    @property
    @pulumi.getter(name="autoregressiveOrder")
    def autoregressive_order(self) -> Optional[pulumi.Input[str]]:
        """
        ...
        """
        return pulumi.get(self, "autoregressive_order")

    @autoregressive_order.setter
    def autoregressive_order(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "autoregressive_order", value)
    ...
    @property
    @pulumi.getter(name="maxNumSteps")
    def max_num_steps(self) -> Optional[pulumi.Input[str]]:
        """
        ...
        """
        return pulumi.get(self, "max_num_steps")

    @max_num_steps.setter
    def max_num_steps(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "max_num_steps", value)

    @property
    @pulumi.getter(name="minNumSteps")
    def min_num_steps(self) -> Optional[pulumi.Input[str]]:
        """
        Minimum number of steps for a trial to complete. Trials which do not have a measurement with num_steps > min_num_steps won't be considered for early stopping. It's ok to set it to 0, and a trial can be early stopped at any stage. By default, min_num_steps is set to be one-tenth of the max_num_steps. When use_steps is false, this field is set to the minimum elapsed seconds.
        """
        return pulumi.get(self, "min_num_steps")

    @min_num_steps.setter
    def min_num_steps(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "min_num_steps", value)

    @property
    @pulumi.getter(name="useSeconds")
    def use_seconds(self) -> Optional[pulumi.Input[bool]]:
        """
        This bool determines whether or not the rule is applied based on elapsed_secs or steps. If use_seconds==false, the early stopping decision is made according to the predicted objective values according to the target steps. If use_seconds==true, elapsed_secs is used instead of steps. Also, in this case, the parameters max_num_steps and min_num_steps are overloaded to contain max_elapsed_seconds and min_elapsed_seconds.
        """
        return pulumi.get(self, "use_seconds")

    @use_seconds.setter
    def use_seconds(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "use_seconds", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecArgs:
    def __init__(__self__, *,
                 use_elapsed_duration: Optional[pulumi.Input[bool]] = None):
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecArgs:
    def __init__(__self__, *,
                 use_elapsed_duration: Optional[pulumi.Input[bool]] = None):
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecMetricSpecArgs:
    def __init__(__self__, *,
                 goal: pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecGoal'],
                 metric_id: pulumi.Input[str],
                 safety_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfigArgs']] = None):
        """
        Represents a metric to optimize.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecGoal'] goal: The optimization goal of the metric.
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfigArgs'] safety_config: Used for safe search. In the case, the metric will be a safety metric. You must provide a separate metric for objective metric.
        """
        pulumi.set(__self__, "goal", goal)
        pulumi.set(__self__, "metric_id", metric_id)
    ...
    @property
    @pulumi.getter
    def goal(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecGoal']:
        """
        The optimization goal of the metric.
        """
        return pulumi.get(self, "goal")
    ...
    @goal.setter
    def goal(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecGoal']):
        pulumi.set(self, "goal", value)
    ...
    def safety_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfigArgs']]:
        """
    ...
    def safety_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfigArgs']]):
        pulumi.set(self, "safety_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecCategoricalValueSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecCategoricalValueConditionArgs:
    def __init__(__self__, *,
                 values: pulumi.Input[Sequence[pulumi.Input[str]]]):
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecDiscreteValueConditionArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecIntValueConditionArgs:
    def __init__(__self__, *,
                 values: pulumi.Input[Sequence[pulumi.Input[str]]]):
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecArgs:
    def __init__(__self__, *,
                 parameter_spec: pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs'],
                 parent_categorical_values: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecCategoricalValueConditionArgs']] = None,
                 parent_discrete_values: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecDiscreteValueConditionArgs']] = None,
                 parent_int_values: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecIntValueConditionArgs']] = None):
        """
        Represents a parameter spec with condition from its parent parameter.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs'] parameter_spec: The spec for a conditional parameter.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecCategoricalValueConditionArgs'] parent_categorical_values: The spec for matching values from a parent parameter of `CATEGORICAL` type.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecDiscreteValueConditionArgs'] parent_discrete_values: The spec for matching values from a parent parameter of `DISCRETE` type.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecIntValueConditionArgs'] parent_int_values: The spec for matching values from a parent parameter of `INTEGER` type.
        """
    ...
    def parameter_spec(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs']:
        """
    ...
    def parameter_spec(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs']):
        pulumi.set(self, "parameter_spec", value)

    @property
    @pulumi.getter(name="parentCategoricalValues")
    def parent_categorical_values(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecCategoricalValueConditionArgs']]:
        """
    ...
    def parent_categorical_values(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecCategoricalValueConditionArgs']]):
        pulumi.set(self, "parent_categorical_values", value)

    @property
    @pulumi.getter(name="parentDiscreteValues")
    def parent_discrete_values(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecDiscreteValueConditionArgs']]:
        """
    ...
    def parent_discrete_values(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecDiscreteValueConditionArgs']]):
        pulumi.set(self, "parent_discrete_values", value)

    @property
    @pulumi.getter(name="parentIntValues")
    def parent_int_values(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecIntValueConditionArgs']]:
        """
    ...
    def parent_int_values(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecIntValueConditionArgs']]):
        pulumi.set(self, "parent_int_values", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecArgs:
    def __init__(__self__, *,
                 values: pulumi.Input[Sequence[pulumi.Input[float]]],
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecDoubleValueSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecIntegerValueSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs:
    def __init__(__self__, *,
                 parameter_id: pulumi.Input[str],
                 categorical_value_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecCategoricalValueSpecArgs']] = None,
                 conditional_parameter_specs: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecArgs']]]] = None,
                 discrete_value_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecArgs']] = None,
                 double_value_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecDoubleValueSpecArgs']] = None,
                 integer_value_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecIntegerValueSpecArgs']] = None,
                 scale_type: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecScaleType']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecCategoricalValueSpecArgs'] categorical_value_spec: The value spec for a 'CATEGORICAL' parameter.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecArgs']]] conditional_parameter_specs: A conditional parameter node is active if the parameter's value matches the conditional node's parent_value_condition. If two items in conditional_parameter_specs have the same name, they must have disjoint parent_value_condition.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecArgs'] discrete_value_spec: The value spec for a 'DISCRETE' parameter.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecDoubleValueSpecArgs'] double_value_spec: The value spec for a 'DOUBLE' parameter.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecIntegerValueSpecArgs'] integer_value_spec: The value spec for an 'INTEGER' parameter.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecScaleType'] scale_type: How the parameter should be scaled. Leave unset for `CATEGORICAL` parameters.
        """
    ...
    def categorical_value_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecCategoricalValueSpecArgs']]:
        """
    ...
    def categorical_value_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecCategoricalValueSpecArgs']]):
        pulumi.set(self, "categorical_value_spec", value)

    @property
    @pulumi.getter(name="conditionalParameterSpecs")
    def conditional_parameter_specs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecArgs']]]]:
        """
    ...
    def conditional_parameter_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecArgs']]]]):
        pulumi.set(self, "conditional_parameter_specs", value)

    @property
    @pulumi.getter(name="discreteValueSpec")
    def discrete_value_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecArgs']]:
        """
    ...
    def discrete_value_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecArgs']]):
        pulumi.set(self, "discrete_value_spec", value)

    @property
    @pulumi.getter(name="doubleValueSpec")
    def double_value_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecDoubleValueSpecArgs']]:
        """
    ...
    def double_value_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecDoubleValueSpecArgs']]):
        pulumi.set(self, "double_value_spec", value)

    @property
    @pulumi.getter(name="integerValueSpec")
    def integer_value_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecIntegerValueSpecArgs']]:
        """
    ...
    def integer_value_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecIntegerValueSpecArgs']]):
        pulumi.set(self, "integer_value_spec", value)

    @property
    @pulumi.getter(name="scaleType")
    def scale_type(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecScaleType']]:
        """
    ...
    @scale_type.setter
    def scale_type(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecScaleType']]):
        pulumi.set(self, "scale_type", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigArgs:
    def __init__(__self__, *,
                 ...
                 maximum_runtime_constraint: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs']] = None,
                 min_num_trials: Optional[pulumi.Input[int]] = None,
                 minimum_runtime_constraint: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs']] = None,
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs'] maximum_runtime_constraint: If the specified time or duration has passed, stop the study.
        :param pulumi.Input[int] min_num_trials: If there are fewer than this many COMPLETED trials, do not stop the study.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs'] minimum_runtime_constraint: Each "stopping rule" in this proto specifies an "if" condition. Before Vizier would generate a new suggestion, it first checks each specified stopping rule, from top to bottom in this list. Note that the first few rules (e.g. minimum_runtime_constraint, min_num_trials) will prevent other stopping rules from being evaluated until they are met. For example, setting `min_num_trials=5` and `always_stop_after= 1 hour` means that the Study will ONLY stop after it has 5 COMPLETED trials, even if more than an hour has passed since its creation. It follows the first applicable rule (whose "if" condition is satisfied) to make a stopping decision. If none of the specified rules are applicable, then Vizier decides that the study should not stop. If Vizier decides that the study should stop, the study enters STOPPING state (or STOPPING_ASAP if should_stop_asap = true). IMPORTANT: The automatic study state transition happens precisely as described above; that is, deleting trials or updating StudyConfig NEVER automatically moves the study state back to ACTIVE. If you want to _resume_ a Study that was stopped, 1) change the stopping conditions if necessary, 2) activate the study, and then 3) ask for suggestions. If the specified time or duration has not passed, do not stop the study.
    ...
    def maximum_runtime_constraint(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs']]:
        """
    ...
    def maximum_runtime_constraint(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs']]):
    ...
    def minimum_runtime_constraint(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs']]:
        """
    ...
    def minimum_runtime_constraint(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigArgs:
    def __init__(__self__, *,
                 disable_transfer_learning: Optional[pulumi.Input[bool]] = None):
        """
        ...
        :param pulumi.Input[bool] disable_transfer_learning: Flag to to manually prevent vizier from using transfer learning on a new study. Otherwise, vizier will automatically determine whether or not to use transfer learning.
        """
        if disable_transfer_learning is not None:
            pulumi.set(__self__, "disable_transfer_learning", disable_transfer_learning)

    @property
    @pulumi.getter(name="disableTransferLearning")
    def disable_transfer_learning(self) -> Optional[pulumi.Input[bool]]:
        """
        ...
        """
        return pulumi.get(self, "disable_transfer_learning")

    @disable_transfer_learning.setter
    def disable_transfer_learning(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "disable_transfer_learning", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudySpecArgs:
    def __init__(__self__, *,
                 metrics: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecArgs']]],
                 parameters: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs']]],
                 algorithm: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecAlgorithm']] = None,
                 convex_automated_stopping_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecArgs']] = None,
                 convex_stop_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigArgs']] = None,
                 decay_curve_stopping_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecArgs']] = None,
                 measurement_selection_type: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMeasurementSelectionType']] = None,
                 median_automated_stopping_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecArgs']] = None,
                 observation_noise: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecObservationNoise']] = None,
                 study_stopping_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigArgs']] = None,
                 transfer_learning_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigArgs']] = None):
        """
        Represents specification of a Study.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecArgs']]] metrics: Metric specs for the Study.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs']]] parameters: The set of parameters to tune.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecAlgorithm'] algorithm: The search algorithm specified for the Study.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecArgs'] convex_automated_stopping_spec: The automated early stopping spec using convex stopping rule.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigArgs'] convex_stop_config: Deprecated. The automated early stopping using convex stopping rule.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecArgs'] decay_curve_stopping_spec: The automated early stopping spec using decay curve rule.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMeasurementSelectionType'] measurement_selection_type: Describe which measurement selection type will be used
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecArgs'] median_automated_stopping_spec: The automated early stopping spec using median rule.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecObservationNoise'] observation_noise: The observation noise level of the study. Currently only supported by the Vertex AI Vizier service. Not supported by HyperparameterTuningJob or TrainingPipeline.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigArgs'] study_stopping_config: Conditions for automated stopping of a Study. Enable automated stopping by configuring at least one condition.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigArgs'] transfer_learning_config: The configuration info/options for transfer learning. Currently supported for Vertex AI Vizier service, not HyperParameterTuningJob
        """
        ...
        if convex_stop_config is not None:
            warnings.warn("""Deprecated. The automated early stopping using convex stopping rule.""", DeprecationWarning)
            pulumi.log.warn("""convex_stop_config is deprecated: Deprecated. The automated early stopping using convex stopping rule.""")
        if convex_stop_config is not None:
            pulumi.set(__self__, "convex_stop_config", convex_stop_config)
        ...
        if transfer_learning_config is not None:
            pulumi.set(__self__, "transfer_learning_config", transfer_learning_config)

    @property
    @pulumi.getter
    def metrics(self) -> pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecArgs']]]:
        """
    ...
    @metrics.setter
    def metrics(self, value: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMetricSpecArgs']]]):
        pulumi.set(self, "metrics", value)

    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs']]]:
        """
    ...
    @parameters.setter
    def parameters(self, value: pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecParameterSpecArgs']]]):
        pulumi.set(self, "parameters", value)

    @property
    @pulumi.getter
    def algorithm(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecAlgorithm']]:
        """
    ...
    @algorithm.setter
    def algorithm(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecAlgorithm']]):
        pulumi.set(self, "algorithm", value)

    @property
    @pulumi.getter(name="convexAutomatedStoppingSpec")
    def convex_automated_stopping_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecArgs']]:
        """
    ...
    def convex_automated_stopping_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecArgs']]):
        pulumi.set(self, "convex_automated_stopping_spec", value)

    @property
    @pulumi.getter(name="convexStopConfig")
    def convex_stop_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigArgs']]:
        """
        ...
        return pulumi.get(self, "convex_stop_config")

    @convex_stop_config.setter
    def convex_stop_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigArgs']]):
        pulumi.set(self, "convex_stop_config", value)

    @property
    @pulumi.getter(name="decayCurveStoppingSpec")
    def decay_curve_stopping_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecArgs']]:
        """
    ...
    def decay_curve_stopping_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecArgs']]):
        pulumi.set(self, "decay_curve_stopping_spec", value)

    @property
    @pulumi.getter(name="measurementSelectionType")
    def measurement_selection_type(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMeasurementSelectionType']]:
        """
    ...
    def measurement_selection_type(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMeasurementSelectionType']]):
        pulumi.set(self, "measurement_selection_type", value)

    @property
    @pulumi.getter(name="medianAutomatedStoppingSpec")
    def median_automated_stopping_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecArgs']]:
        """
    ...
    def median_automated_stopping_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecArgs']]):
        pulumi.set(self, "median_automated_stopping_spec", value)

    @property
    @pulumi.getter(name="observationNoise")
    def observation_noise(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecObservationNoise']]:
        """
    ...
    def observation_noise(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecObservationNoise']]):
        pulumi.set(self, "observation_noise", value)

    @property
    @pulumi.getter(name="studyStoppingConfig")
    def study_stopping_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigArgs']]:
        """
    ...
    def study_stopping_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigArgs']]):
        pulumi.set(self, "study_stopping_config", value)

    @property
    @pulumi.getter(name="transferLearningConfig")
    def transfer_learning_config(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigArgs']]:
        """
        ...
        """
        return pulumi.get(self, "transfer_learning_config")

    @transfer_learning_config.setter
    def transfer_learning_config(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigArgs']]):
        pulumi.set(self, "transfer_learning_config", value)


@pulumi.input_type
class GoogleCloudAiplatformV1beta1StudyTimeConstraintArgs:
    def __init__(__self__, *,
                 end_time: Optional[pulumi.Input[str]] = None,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1ThresholdConfigArgs:
    def __init__(__self__, *,
                 value: Optional[pulumi.Input[float]] = None):
        """
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1TimestampSplitArgs:
    def __init__(__self__, *,
                 key: pulumi.Input[str],
                 test_fraction: Optional[pulumi.Input[float]] = None,
                 training_fraction: Optional[pulumi.Input[float]] = None,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1TrainingConfigArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1UnmanagedContainerModelArgs:
    def __init__(__self__, *,
                 artifact_uri: Optional[pulumi.Input[str]] = None,
                 container_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ModelContainerSpecArgs']] = None,
                 predict_schemata: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PredictSchemataArgs']] = None):
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ModelContainerSpecArgs'] container_spec: Input only. The specification of the container that is to be used when deploying this Model.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1PredictSchemataArgs'] predict_schemata: Contains the schemata used in Model's predictions and explanations
        """
        if artifact_uri is not None:
            pulumi.set(__self__, "artifact_uri", artifact_uri)
        if container_spec is not None:
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1WorkerPoolSpecArgs:
    def __init__(__self__, *,
                 container_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ContainerSpecArgs']] = None,
                 disk_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1DiskSpecArgs']] = None,
                 machine_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs']] = None,
                 nfs_mounts: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1NfsMountArgs']]]] = None,
                 python_package_spec: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PythonPackageSpecArgs']] = None,
                 replica_count: Optional[pulumi.Input[str]] = None):
        """
        Represents the spec of a worker pool in a job.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1ContainerSpecArgs'] container_spec: The custom container task.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1DiskSpecArgs'] disk_spec: Disk spec.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1MachineSpecArgs'] machine_spec: Optional. Immutable. The specification of a single machine.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1NfsMountArgs']]] nfs_mounts: Optional. List of NFS mount spec.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1PythonPackageSpecArgs'] python_package_spec: The Python packaged task.
    ...
    @property
    @pulumi.getter(name="containerSpec")
    def container_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ContainerSpecArgs']]:
        """
    ...
    @container_spec.setter
    def container_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1ContainerSpecArgs']]):
        pulumi.set(self, "container_spec", value)
    ...
    def nfs_mounts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1NfsMountArgs']]]]:
        """
    ...
    @nfs_mounts.setter
    def nfs_mounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudAiplatformV1beta1NfsMountArgs']]]]):
        pulumi.set(self, "nfs_mounts", value)

    @property
    @pulumi.getter(name="pythonPackageSpec")
    def python_package_spec(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PythonPackageSpecArgs']]:
        """
    ...
    def python_package_spec(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1PythonPackageSpecArgs']]):
...
@pulumi.input_type
class GoogleCloudAiplatformV1beta1XraiAttributionArgs:
    def __init__(__self__, *,
                 step_count: pulumi.Input[int],
                 blur_baseline_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1BlurBaselineConfigArgs']] = None,
                 smooth_grad_config: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1SmoothGradConfigArgs']] = None):
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1BlurBaselineConfigArgs'] blur_baseline_config: Config for XRAI with blur baseline. When enabled, a linear path from the maximally blurred image to the input image is created. Using a blurred baseline instead of zero (black image) is motivated by the BlurIG approach explained here: https://arxiv.org/abs/2004.03383
        :param pulumi.Input['GoogleCloudAiplatformV1beta1SmoothGradConfigArgs'] smooth_grad_config: Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
        """
        pulumi.set(__self__, "step_count", step_count)
        if blur_baseline_config is not None:
