...
class CustomJobArgs:
    def __init__(__self__, *,
                 ...
                 job_spec: pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs'],
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs'] job_spec: Job spec.
        :param pulumi.Input['GoogleCloudAiplatformV1beta1EncryptionSpecArgs'] encryption_spec: Customer-managed encryption key options for a CustomJob. If this is set, then all resources created by the CustomJob will be encrypted with the provided encryption key.
    ...
    def job_spec(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs']:
        """
        Job spec.
        """
    ...
    @job_spec.setter
    def job_spec(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1CustomJobSpecArgs']):
...
class CustomJob(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="jobSpec")
    def job_spec(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1beta1CustomJobSpecResponse']:
        """
        Job spec.
        """
        return pulumi.get(self, "job_spec")
