...
class DeploymentResourcePoolArgs:
    def __init__(__self__, *,
                 dedicated_resources: pulumi.Input['GoogleCloudAiplatformV1beta1DedicatedResourcesArgs'],
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1DedicatedResourcesArgs'] dedicated_resources: The underlying DedicatedResources that the DeploymentResourcePool uses.
    ...
    def dedicated_resources(self) -> pulumi.Input['GoogleCloudAiplatformV1beta1DedicatedResourcesArgs']:
        """
    ...
    def dedicated_resources(self, value: pulumi.Input['GoogleCloudAiplatformV1beta1DedicatedResourcesArgs']):
...
class DeploymentResourcePool(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dedicatedResources")
    def dedicated_resources(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1beta1DedicatedResourcesResponse']:
        """
        The underlying DedicatedResources that the DeploymentResourcePool uses.
        """
        return pulumi.get(self, "dedicated_resources")
