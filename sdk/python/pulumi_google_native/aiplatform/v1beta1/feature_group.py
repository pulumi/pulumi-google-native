...
class FeatureGroupArgs:
    def __init__(__self__, *,
                 ...
                 big_query: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs']] = None,
        ...
        :param pulumi.Input['GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs'] big_query: Indicates that features for this group come from BigQuery Table/View. By default treats the source as a sparse time series source, which is required to have an entity_id and a feature_timestamp column in the source.
        ...
        :param pulumi.Input[str] name: Identifier. Name of the FeatureGroup. Format: `projects/{project}/locations/{location}/featureGroups/{featureGroup}`
        """
    ...
    def big_query(self) -> Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs']]:
        """
    ...
    @big_query.setter
    def big_query(self, value: Optional[pulumi.Input['GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs']]):
...
class FeatureGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 big_query: Optional[pulumi.Input[pulumi.InputType['GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 etag: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter(name="bigQuery")
    def big_query(self) -> pulumi.Output['outputs.GoogleCloudAiplatformV1beta1FeatureGroupBigQueryResponse']:
        """
        Indicates that features for this group come from BigQuery Table/View. By default treats the source as a sparse time series source, which is required to have an entity_id and a feature_timestamp column in the source.
        """
        return pulumi.get(self, "big_query")
