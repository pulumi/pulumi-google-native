...
class FeatureGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 big_query: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgs', 'GoogleCloudAiplatformV1beta1FeatureGroupBigQueryArgsDict']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 etag: Optional[pulumi.Input[str]] = None,
