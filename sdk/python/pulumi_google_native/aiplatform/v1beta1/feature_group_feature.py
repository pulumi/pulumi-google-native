...
__all__ = ['FeatureGroupFeatureArgs', 'FeatureGroupFeature']
...
class FeatureGroupFeatureArgs:
    ...
    def value_type(self) -> Optional[pulumi.Input['FeatureGroupFeatureValueType']]:
        """
    ...
    @value_type.setter
    def value_type(self, value: Optional[pulumi.Input['FeatureGroupFeatureValueType']]):
...
class FeatureGroupFeature(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FeatureGroupFeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FeatureGroupFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FeatureGroupFeatureArgs.__new__(FeatureGroupFeatureArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["feature_group_id", "feature_id", "location", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(FeatureGroupFeature, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FeatureGroupFeature':
        """
        ...
        return FeatureGroupFeature(resource_name, opts=opts, __props__=__props__)
