...
__all__ = ['FeatureOnlineStoreIamPolicyArgs', 'FeatureOnlineStoreIamPolicy']

@pulumi.input_type
class FeatureOnlineStoreIamPolicyArgs:
...
class FeatureOnlineStoreIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FeatureOnlineStoreIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param FeatureOnlineStoreIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FeatureOnlineStoreIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FeatureOnlineStoreIamPolicyArgs.__new__(FeatureOnlineStoreIamPolicyArgs)
        ...
        super(FeatureOnlineStoreIamPolicy, __self__).__init__(
            'google-native:aiplatform/v1beta1:FeatureOnlineStoreIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FeatureOnlineStoreIamPolicy':
        """
        ...
        return FeatureOnlineStoreIamPolicy(resource_name, opts=opts, __props__=__props__)
