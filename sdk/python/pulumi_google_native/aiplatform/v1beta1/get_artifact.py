...
class GetArtifactResult:
    def __init__(__self__, create_time=None, description=None, display_name=None, etag=None, labels=None, metadata=None, name=None, schema_title=None, schema_version=None, state=None, update_time=None, uri=None):
...
def get_artifact(artifact_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1beta1:getArtifact', __args__, opts=opts, typ=GetArtifactResult).value
