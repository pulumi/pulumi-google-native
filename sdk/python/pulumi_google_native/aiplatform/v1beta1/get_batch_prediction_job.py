...
class GetBatchPredictionJobResult:
    def __init__(__self__, completion_stats=None, create_time=None, dedicated_resources=None, disable_container_logging=None, display_name=None, encryption_spec=None, end_time=None, error=None, explanation_spec=None, generate_explanation=None, input_config=None, instance_config=None, labels=None, manual_batch_tuning_parameters=None, model=None, model_monitoring_config=None, model_monitoring_stats_anomalies=None, model_monitoring_status=None, model_parameters=None, model_version_id=None, name=None, output_config=None, output_info=None, partial_failures=None, resources_consumed=None, service_account=None, start_time=None, state=None, unmanaged_container_model=None, update_time=None):
        ...
        if model_monitoring_config and not isinstance(model_monitoring_config, dict):
            raise TypeError("Expected argument 'model_monitoring_config' to be a dict")
        pulumi.set(__self__, "model_monitoring_config", model_monitoring_config)
        if model_monitoring_stats_anomalies and not isinstance(model_monitoring_stats_anomalies, list):
            raise TypeError("Expected argument 'model_monitoring_stats_anomalies' to be a list")
        pulumi.set(__self__, "model_monitoring_stats_anomalies", model_monitoring_stats_anomalies)
        if model_monitoring_status and not isinstance(model_monitoring_status, dict):
            raise TypeError("Expected argument 'model_monitoring_status' to be a dict")
        pulumi.set(__self__, "model_monitoring_status", model_monitoring_status)
    ...
    def completion_stats(self) -> 'outputs.GoogleCloudAiplatformV1beta1CompletionStatsResponse':
        """
    ...
    def dedicated_resources(self) -> 'outputs.GoogleCloudAiplatformV1beta1BatchDedicatedResourcesResponse':
        """
    ...
    def explanation_spec(self) -> 'outputs.GoogleCloudAiplatformV1beta1ExplanationSpecResponse':
        """
    ...
    def input_config(self) -> 'outputs.GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfigResponse':
        """
    ...
    def instance_config(self) -> 'outputs.GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse':
        """
    ...
    def manual_batch_tuning_parameters(self) -> 'outputs.GoogleCloudAiplatformV1beta1ManualBatchTuningParametersResponse':
        """
    ...
    def model_monitoring_config(self) -> 'outputs.GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse':
        """
    ...
    def model_monitoring_stats_anomalies(self) -> Sequence['outputs.GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesResponse']:
        """
    ...
    def model_monitoring_status(self) -> 'outputs.GoogleRpcStatusResponse':
        """
    ...
    def output_config(self) -> 'outputs.GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse':
        """
    ...
    def output_info(self) -> 'outputs.GoogleCloudAiplatformV1beta1BatchPredictionJobOutputInfoResponse':
        """
    ...
    def resources_consumed(self) -> 'outputs.GoogleCloudAiplatformV1beta1ResourcesConsumedResponse':
        """
    ...
    def unmanaged_container_model(self) -> 'outputs.GoogleCloudAiplatformV1beta1UnmanagedContainerModelResponse':
        """
...
class AwaitableGetBatchPredictionJobResult(GetBatchPredictionJobResult):
    ...
    def __await__(self):
        ...
        return GetBatchPredictionJobResult(
            ...
            model=self.model,
            model_monitoring_config=self.model_monitoring_config,
            model_monitoring_stats_anomalies=self.model_monitoring_stats_anomalies,
            model_monitoring_status=self.model_monitoring_status,
...
def get_batch_prediction_job(batch_prediction_job_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1beta1:getBatchPredictionJob', __args__, opts=opts, typ=GetBatchPredictionJobResult).value
    ...
    return AwaitableGetBatchPredictionJobResult(
        ...
        model_monitoring_config=pulumi.get(__ret__, 'model_monitoring_config'),
        model_monitoring_stats_anomalies=pulumi.get(__ret__, 'model_monitoring_stats_anomalies'),
        model_monitoring_status=pulumi.get(__ret__, 'model_monitoring_status'),
