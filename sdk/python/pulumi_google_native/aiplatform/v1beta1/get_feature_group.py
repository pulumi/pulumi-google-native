...
class GetFeatureGroupResult:
    ...
    def big_query(self) -> 'outputs.GoogleCloudAiplatformV1beta1FeatureGroupBigQueryResponse':
        """
...
def get_feature_group(feature_group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1beta1:getFeatureGroup', __args__, opts=opts, typ=GetFeatureGroupResult).value
