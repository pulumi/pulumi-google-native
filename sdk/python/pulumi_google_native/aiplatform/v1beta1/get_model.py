...
class GetModelResult:
    def __init__(__self__, artifact_uri=None, base_model_source=None, container_spec=None, create_time=None, deployed_models=None, description=None, display_name=None, encryption_spec=None, etag=None, explanation_spec=None, labels=None, metadata=None, metadata_artifact=None, metadata_schema_uri=None, model_source_info=None, name=None, original_model_info=None, predict_schemata=None, supported_deployment_resources_types=None, supported_export_formats=None, supported_input_storage_formats=None, supported_output_storage_formats=None, training_pipeline=None, update_time=None, version_aliases=None, version_create_time=None, version_description=None, version_id=None, version_update_time=None):
    ...
    def deployed_models(self) -> Sequence['outputs.GoogleCloudAiplatformV1beta1DeployedModelRefResponse']:
        """
    ...
    def original_model_info(self) -> 'outputs.GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse':
        """
    ...
    def predict_schemata(self) -> 'outputs.GoogleCloudAiplatformV1beta1PredictSchemataResponse':
        """
    ...
    def supported_export_formats(self) -> Sequence['outputs.GoogleCloudAiplatformV1beta1ModelExportFormatResponse']:
        """
...
def get_model(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1beta1:getModel', __args__, opts=opts, typ=GetModelResult).value
