...
class GetNasJobResult:
    ...
    def nas_job_output(self) -> 'outputs.GoogleCloudAiplatformV1beta1NasJobOutputResponse':
        """
    ...
    def nas_job_spec(self) -> 'outputs.GoogleCloudAiplatformV1beta1NasJobSpecResponse':
        """
...
def get_nas_job(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:aiplatform/v1beta1:getNasJob', __args__, opts=opts, typ=GetNasJobResult).value
