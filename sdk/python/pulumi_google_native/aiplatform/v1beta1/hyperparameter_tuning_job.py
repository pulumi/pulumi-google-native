...
class HyperparameterTuningJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 project: Optional[pulumi.Input[str]] = None,
                 study_spec: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1beta1StudySpecArgs', 'GoogleCloudAiplatformV1beta1StudySpecArgsDict']]] = None,
                 trial_job_spec: Optional[pulumi.Input[Union['GoogleCloudAiplatformV1beta1CustomJobSpecArgs', 'GoogleCloudAiplatformV1beta1CustomJobSpecArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[int] max_trial_count: The desired total number of Trials.
        :param pulumi.Input[int] parallel_trial_count: The desired number of Trials to run in parallel.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1beta1StudySpecArgs', 'GoogleCloudAiplatformV1beta1StudySpecArgsDict']] study_spec: Study configuration of the HyperparameterTuningJob.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1beta1CustomJobSpecArgs', 'GoogleCloudAiplatformV1beta1CustomJobSpecArgsDict']] trial_job_spec: The spec of a trial job. The same spec applies to the CustomJobs created in all the trials.
        """
        ...
    @overload
    def __init__(__self__,
