...
__all__ = ['NotebookRuntimeTemplateIamPolicyArgs', 'NotebookRuntimeTemplateIamPolicy']

@pulumi.input_type
class NotebookRuntimeTemplateIamPolicyArgs:
    def __init__(__self__, *,
                 notebook_runtime_template_id: pulumi.Input[str],
    ...
    def notebook_runtime_template_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "notebook_runtime_template_id")

    @notebook_runtime_template_id.setter
    def notebook_runtime_template_id(self, value: pulumi.Input[str]):
...
class NotebookRuntimeTemplateIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: NotebookRuntimeTemplateIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param NotebookRuntimeTemplateIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NotebookRuntimeTemplateIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NotebookRuntimeTemplateIamPolicyArgs.__new__(NotebookRuntimeTemplateIamPolicyArgs)

            __props__.__dict__["bindings"] = bindings
            __props__.__dict__["etag"] = etag
            __props__.__dict__["location"] = location
            if notebook_runtime_template_id is None and not opts.urn:
                raise TypeError("Missing required property 'notebook_runtime_template_id'")
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NotebookRuntimeTemplateIamPolicy':
        """
        ...
        return NotebookRuntimeTemplateIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="notebookRuntimeTemplateId")
    def notebook_runtime_template_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "notebook_runtime_template_id")
