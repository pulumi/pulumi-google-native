...
class Study(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] display_name: Describes the Study, default value is empty string.
        :param pulumi.Input[Union['GoogleCloudAiplatformV1beta1StudySpecArgs', 'GoogleCloudAiplatformV1beta1StudySpecArgsDict']] study_spec: Configuration of the Study.
        """
        ...
    @overload
    def __init__(__self__,
