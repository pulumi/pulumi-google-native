...
def get_cluster(cluster_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:alloydb/v1alpha:getCluster', __args__, opts=opts, typ=GetClusterResult).value
