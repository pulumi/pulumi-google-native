...
@pulumi.input_type
class BigQueryDatasetSourceArgs:
    def __init__(__self__, *,
                 dataset: Optional[pulumi.Input[str]] = None,
                 selected_resources: Optional[pulumi.Input[Sequence[pulumi.Input['SelectedResourceArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SelectedResourceArgs']]] selected_resources: Optional. Resources in this dataset that are selectively shared. If this field is empty, then the entire dataset (all resources) are shared. This field is only valid for data clean room exchanges.
        """
    ...
    def selected_resources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SelectedResourceArgs']]]]:
        """
    ...
    def selected_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SelectedResourceArgs']]]]):
...
class DataProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Optional. Name of the data provider.
        :param pulumi.Input[str] primary_contact: Optional. Email or URL of the data provider. Max Length: 1000 bytes.
        """
        if name is not None:
...
class PublisherArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Optional. Name of the listing publisher.
        :param pulumi.Input[str] primary_contact: Optional. Email or URL of the listing publisher. Max Length: 1000 bytes.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if primary_contact is not None:
...
class SelectedResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] table: Optional. Format: For table: `projects/{projectId}/datasets/{datasetId}/tables/{tableId}` Example:"projects/test_project/datasets/test_dataset/tables/test_table"
        """
