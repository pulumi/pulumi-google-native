...
def get_listing(data_exchange_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:analyticshub/v1:getListing', __args__, opts=opts, typ=GetListingResult).value
    ...
    return AwaitableGetListingResult(
        ...
        restricted_export_config=__ret__.restricted_export_config,
        state=__ret__.state)
