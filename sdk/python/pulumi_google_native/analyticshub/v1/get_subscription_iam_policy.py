...
def get_subscription_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:analyticshub/v1:getSubscriptionIamPolicy', __args__, opts=opts, typ=GetSubscriptionIamPolicyResult).value
...
def get_subscription_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
