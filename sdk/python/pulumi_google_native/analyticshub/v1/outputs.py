...
class BigQueryDatasetSourceResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BigQueryDatasetSourceResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BigQueryDatasetSourceResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 dataset: str,
                 selected_resources: Sequence['outputs.SelectedResourceResponse']):
        """
        A reference to a shared dataset. It is an existing BigQuery dataset with a collection of objects such as tables and views that you want to share with subscribers. When subscriber's subscribe to a listing, Analytics Hub creates a linked dataset in the subscriber's project. A Linked dataset is an opaque, read-only BigQuery dataset that serves as a _symbolic link_ to a shared dataset.
        :param str dataset: Resource name of the dataset source for this listing. e.g. `projects/myproject/datasets/123`
        :param Sequence['SelectedResourceResponse'] selected_resources: Optional. Resources in this dataset that are selectively shared. If this field is empty, then the entire dataset (all resources) are shared. This field is only valid for data clean room exchanges.
        """
    ...
    def selected_resources(self) -> Sequence['outputs.SelectedResourceResponse']:
        """
...
class DcrExchangeConfigResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "singleLinkedDatasetPerCleanroom":
            suggest = "single_linked_dataset_per_cleanroom"
        elif key == "singleSelectedResourceSharingRestriction":
            suggest = "single_selected_resource_sharing_restriction"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DcrExchangeConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DcrExchangeConfigResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Data Clean Room (DCR), used for privacy-safe and secured data sharing.
        :param bool single_linked_dataset_per_cleanroom: If True, when subscribing to this DCR, it will create only one linked dataset containing all resources shared within the cleanroom. If False, when subscribing to this DCR, it will create 1 linked dataset per listing. This is not configurable, and by default, all new DCRs will have the restriction set to True.
        :param bool single_selected_resource_sharing_restriction: If True, this DCR restricts the contributors to sharing only a single resource in a Listing. And no two resources should have the same IDs. So if a contributor adds a view with a conflicting name, the CreateListing API will reject the request. if False, the data contributor can publish an entire dataset (as before). This is not configurable, and by default, all new DCRs will have the restriction set to True.
        """
        pulumi.set(__self__, "single_linked_dataset_per_cleanroom", single_linked_dataset_per_cleanroom)
        pulumi.set(__self__, "single_selected_resource_sharing_restriction", single_selected_resource_sharing_restriction)

    @property
    @pulumi.getter(name="singleLinkedDatasetPerCleanroom")
    def single_linked_dataset_per_cleanroom(self) -> bool:
        """
        If True, when subscribing to this DCR, it will create only one linked dataset containing all resources shared within the cleanroom. If False, when subscribing to this DCR, it will create 1 linked dataset per listing. This is not configurable, and by default, all new DCRs will have the restriction set to True.
        """
        return pulumi.get(self, "single_linked_dataset_per_cleanroom")

    @property
    @pulumi.getter(name="singleSelectedResourceSharingRestriction")
    def single_selected_resource_sharing_restriction(self) -> bool:
        """
        ...
        """
        return pulumi.get(self, "single_selected_resource_sharing_restriction")
...
class SelectedResourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Resource in this dataset that are selectively shared.
        :param str table: Optional. Format: For table: `projects/{projectId}/datasets/{datasetId}/tables/{tableId}` Example:"projects/test_project/datasets/test_dataset/tables/test_table"
        """
