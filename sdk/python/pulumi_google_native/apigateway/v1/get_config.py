...
class GetConfigResult:
    def __init__(__self__, create_time=None, display_name=None, gateway_service_account=None, grpc_services=None, labels=None, managed_service_configs=None, name=None, openapi_documents=None, service_config_id=None, state=None, update_time=None):
