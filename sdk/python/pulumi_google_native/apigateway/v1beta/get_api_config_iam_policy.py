...
def get_api_config_iam_policy(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:apigateway/v1beta:getApiConfigIamPolicy', __args__, opts=opts, typ=GetApiConfigIamPolicyResult).value
...
def get_api_config_iam_policy_output(api_id: Optional[pulumi.Input[str]] = None,
