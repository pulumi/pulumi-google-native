...
def get_api_iam_policy(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:apigateway/v1beta:getApiIamPolicy', __args__, opts=opts, typ=GetApiIamPolicyResult).value
...
def get_api_iam_policy_output(api_id: Optional[pulumi.Input[str]] = None,
