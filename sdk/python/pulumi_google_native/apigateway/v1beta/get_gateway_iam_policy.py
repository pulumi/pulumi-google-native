...
class GetGatewayIamPolicyResult:
    ...
    def audit_configs(self) -> Sequence['outputs.ApigatewayAuditConfigResponse']:
        """
    ...
    @property
    @pulumi.getter
    def bindings(self) -> Sequence['outputs.ApigatewayBindingResponse']:
        """
...
def get_gateway_iam_policy(gateway_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:apigateway/v1beta:getGatewayIamPolicy', __args__, opts=opts, typ=GetGatewayIamPolicyResult).value
...
def get_gateway_iam_policy_output(gateway_id: Optional[pulumi.Input[str]] = None,
