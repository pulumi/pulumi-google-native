...
__all__ = [
    ...
    'AwaitableGetDeveloperAppKeyResult',
    'get_developer_app_key',
    'get_developer_app_key_output',
]
...
class AwaitableGetDeveloperAppKeyResult(GetDeveloperAppKeyResult):
...
def get_developer_app_key(app_id: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDeveloperAppKeyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:apigee/v1:getDeveloperAppKey', __args__, opts=opts, typ=GetDeveloperAppKeyResult).value

    return AwaitableGetDeveloperAppKeyResult(
...
@_utilities.lift_output_func(get_developer_app_key)
def get_developer_app_key_output(app_id: Optional[pulumi.Input[str]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDeveloperAppKeyResult]:
    """
    Gets details for a consumer key for a developer app, including the key and secret value, associated API products, and other information.
    """
    ...
