...
__all__ = ['OrganizationEnvironmentArgs', 'OrganizationEnvironment']
...
class OrganizationEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OrganizationEnvironmentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates an environment in an organization.

        :param str resource_name: The name of the resource.
        :param OrganizationEnvironmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationEnvironmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OrganizationEnvironmentArgs.__new__(OrganizationEnvironmentArgs)
        ...
        super(OrganizationEnvironment, __self__).__init__(
            'google-native:apigee/v1:OrganizationEnvironment',
            resource_name,
            __props__,
            opts)
