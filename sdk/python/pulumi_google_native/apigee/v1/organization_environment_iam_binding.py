...
__all__ = ['OrganizationEnvironmentIamBindingArgs', 'OrganizationEnvironmentIamBinding']
...
class OrganizationEnvironmentIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OrganizationEnvironmentIamBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the IAM policy on an environment, if the policy already exists it will be replaced. For more information, see [Manage users, roles, and permissions using the API](https://cloud.google.com/apigee/docs/api-platform/system-administration/manage-users-roles). You must have the `apigee.environments.setIamPolicy` permission to call this API.

        :param str resource_name: The name of the resource.
        :param OrganizationEnvironmentIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationEnvironmentIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OrganizationEnvironmentIamBindingArgs.__new__(OrganizationEnvironmentIamBindingArgs)
        ...
        super(OrganizationEnvironmentIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OrganizationEnvironmentIamBinding':
        """
        ...
        return OrganizationEnvironmentIamBinding(resource_name, opts=opts, __props__=__props__)
