...
class ConfigArgs:
    def __init__(__self__, *,
                 cmek_key_name: pulumi.Input[str]):
        """
        Available configurations to provision an Instance.
        :param pulumi.Input[str] cmek_key_name: The Customer Managed Encryption Key (CMEK) used for data encryption. The CMEK name should follow the format of `projects/([^/]+)/locations/([^/]+)/keyRings/([^/]+)/cryptoKeys/([^/]+)`, where the `location` must match InstanceConfig.location.
        """
        pulumi.set(__self__, "cmek_key_name", cmek_key_name)

    @property
    @pulumi.getter(name="cmekKeyName")
    def cmek_key_name(self) -> pulumi.Input[str]:
        """
    ...
    def cmek_key_name(self, value: pulumi.Input[str]):
