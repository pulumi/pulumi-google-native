...
__all__ = ['ApiVersionSpecArtifactIamPolicyArgs', 'ApiVersionSpecArtifactIamPolicy']

@pulumi.input_type
class ApiVersionSpecArtifactIamPolicyArgs:
    def __init__(__self__, *,
                 api_id: pulumi.Input[str],
                 artifact_id: pulumi.Input[str],
                 spec_id: pulumi.Input[str],
    ...
    def spec_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "spec_id")

    @spec_id.setter
    def spec_id(self, value: pulumi.Input[str]):
...
class ApiVersionSpecArtifactIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ApiVersionSpecArtifactIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param ApiVersionSpecArtifactIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApiVersionSpecArtifactIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApiVersionSpecArtifactIamPolicyArgs.__new__(ApiVersionSpecArtifactIamPolicyArgs)
            ...
            if spec_id is None and not opts.urn:
                raise TypeError("Missing required property 'spec_id'")
            __props__.__dict__["spec_id"] = spec_id
            __props__.__dict__["version"] = version
            if version_id is None and not opts.urn:
                raise TypeError("Missing required property 'version_id'")
            __props__.__dict__["version_id"] = version_id
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["apiId", "artifactId", "location", "project", "specId", "versionId"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ApiVersionSpecArtifactIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ApiVersionSpecArtifactIamPolicy':
        """
        Get an existing ApiVersionSpecArtifactIamPolicy resource's state with the given name, id, and optional extra
        ...
        return ApiVersionSpecArtifactIamPolicy(resource_name, opts=opts, __props__=__props__)
