...
__all__ = [
    ...
    'AwaitableGetApiArtifactIamPolicyResult',
    'get_api_artifact_iam_policy',
    'get_api_artifact_iam_policy_output',
]

@pulumi.output_type
class GetApiArtifactIamPolicyResult:
...
class AwaitableGetApiArtifactIamPolicyResult(GetApiArtifactIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApiArtifactIamPolicyResult(
...
def get_api_artifact_iam_policy(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:apigeeregistry/v1:getApiArtifactIamPolicy', __args__, opts=opts, typ=GetApiArtifactIamPolicyResult).value

    return AwaitableGetApiArtifactIamPolicyResult(
        bindings=__ret__.bindings,
        etag=__ret__.etag,
        version=__ret__.version)


@_utilities.lift_output_func(get_api_artifact_iam_policy)
