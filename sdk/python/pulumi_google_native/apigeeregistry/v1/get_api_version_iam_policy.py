...
__all__ = [
    ...
    'AwaitableGetApiVersionIamPolicyResult',
    'get_api_version_iam_policy',
    'get_api_version_iam_policy_output',
]

@pulumi.output_type
class GetApiVersionIamPolicyResult:
...
class AwaitableGetApiVersionIamPolicyResult(GetApiVersionIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApiVersionIamPolicyResult(
...
def get_api_version_iam_policy(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:apigeeregistry/v1:getApiVersionIamPolicy', __args__, opts=opts, typ=GetApiVersionIamPolicyResult).value

    return AwaitableGetApiVersionIamPolicyResult(
