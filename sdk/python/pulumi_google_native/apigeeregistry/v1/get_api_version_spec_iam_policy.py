...
__all__ = [
    ...
    'AwaitableGetApiVersionSpecIamPolicyResult',
    'get_api_version_spec_iam_policy',
    'get_api_version_spec_iam_policy_output',
]

@pulumi.output_type
class GetApiVersionSpecIamPolicyResult:
...
class AwaitableGetApiVersionSpecIamPolicyResult(GetApiVersionSpecIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApiVersionSpecIamPolicyResult(
            bindings=self.bindings,
            etag=self.etag,
            version=self.version)


def get_api_version_spec_iam_policy(api_id: Optional[str] = None,
                                    location: Optional[str] = None,
                                    options_requested_policy_version: Optional[int] = None,
                                    project: Optional[str] = None,
                                    spec_id: Optional[str] = None,
                                    version_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApiVersionSpecIamPolicyResult:
    """
...
def get_api_version_spec_iam_policy_output(api_id: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetApiVersionSpecIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
