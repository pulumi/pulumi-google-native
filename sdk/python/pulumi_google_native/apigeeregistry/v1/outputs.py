...
class BuildResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Build information of the Instance if it's in `ACTIVE` state.
        :param str commit_id: Commit ID of the latest commit in the build.
        :param str commit_time: Commit time of the latest commit in the build.
        :param str repo: Path of the open source repository: github.com/apigee/registry.
        """
...
class ConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Available configurations to provision an Instance.
        :param str cmek_key_name: The Customer Managed Encryption Key (CMEK) used for data encryption. The CMEK name should follow the format of `projects/([^/]+)/locations/([^/]+)/keyRings/([^/]+)/cryptoKeys/([^/]+)`, where the `location` must match InstanceConfig.location.
        :param str location: The GCP location where the Instance resides.
        """
