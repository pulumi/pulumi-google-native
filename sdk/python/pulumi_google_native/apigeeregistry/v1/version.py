...
class VersionArgs:
    def __init__(__self__, *,
                 ...
                 api_version_id: pulumi.Input[str],
        ...
        :param pulumi.Input[str] api_version_id: Required. The ID to use for the version, which will become the final component of the version's resource name. This value should be 1-63 characters, and valid characters are /a-z-/. Following AIP-162, IDs must not have the form of a UUID.
        ...
        pulumi.set(__self__, "api_version_id", api_version_id)
    ...
    def api_version_id(self) -> pulumi.Input[str]:
        """
    ...
    @api_version_id.setter
    def api_version_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "api_version_id", value)
...
class Version(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version_id: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if api_version_id is None and not opts.urn:
                raise TypeError("Missing required property 'api_version_id'")
            __props__.__dict__["api_version_id"] = api_version_id
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["api_id", "api_version_id", "location", "project"])
