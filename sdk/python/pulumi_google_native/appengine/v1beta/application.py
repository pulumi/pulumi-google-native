...
class ApplicationArgs:
    def __init__(__self__, *,
                 ...
                 database_type: Optional[pulumi.Input['ApplicationDatabaseType']] = None,
                 ...
                 serving_status: Optional[pulumi.Input['ApplicationServingStatus']] = None):
        """
        ...
        :param pulumi.Input['ApplicationDatabaseType'] database_type: The type of the Cloud Firestore or Cloud Datastore database associated with this application.
        ...
        :param pulumi.Input['ApplicationServingStatus'] serving_status: Serving status of this application.
        """
    ...
    def database_type(self) -> Optional[pulumi.Input['ApplicationDatabaseType']]:
        """
    ...
    def database_type(self, value: Optional[pulumi.Input['ApplicationDatabaseType']]):
    ...
    def serving_status(self) -> Optional[pulumi.Input['ApplicationServingStatus']]:
        """
    ...
    def serving_status(self, value: Optional[pulumi.Input['ApplicationServingStatus']]):
...
class Application(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Application, __self__).__init__(
            'google-native:appengine/v1beta:Application',
            resource_name,
            __props__,
            opts)
