...
class GetAuthorizedCertificateResult:
    def __init__(__self__, certificate_raw_data=None, display_name=None, domain_mappings_count=None, domain_names=None, expire_time=None, id=None, managed_certificate=None, name=None, visible_domain_mappings=None):
