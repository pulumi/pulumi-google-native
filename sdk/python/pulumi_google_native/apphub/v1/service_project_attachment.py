...
class ServiceProjectAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] service_project: Immutable. Service project name in the format: "projects/abc" or "projects/123". As input, project name with either project id or number are accepted. As output, this field will contain project number.
        :param pulumi.Input[str] service_project_attachment_id: Required. The service project attachment identifier must contain the project id of the service project specified in the service_project_attachment.service_project field.
...
class ServiceProjectAttachment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "project", "service_project_attachment_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ServiceProjectAttachment, __self__).__init__(
            'google-native:apphub/v1:ServiceProjectAttachment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServiceProjectAttachment':
        """
        ...
        __props__.__dict__["service_project"] = None
        __props__.__dict__["service_project_attachment_id"] = None
        __props__.__dict__["state"] = None
        __props__.__dict__["uid"] = None
