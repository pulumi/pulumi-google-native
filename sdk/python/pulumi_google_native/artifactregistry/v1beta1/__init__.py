...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "google-native:artifactregistry/v1beta1:Repository":
    ...
    pulumi.runtime.register_resource_module("google-native", "artifactregistry/v1beta1", _module_instance)
