...
def get_workload(location: Optional[str] = None,
    ...
    return AwaitableGetWorkloadResult(
        ...
        cjis_settings=__ret__.cjis_settings,
        ...
        etag=__ret__.etag,
        fedramp_high_settings=__ret__.fedramp_high_settings,
        fedramp_moderate_settings=__ret__.fedramp_moderate_settings,
        il4_settings=__ret__.il4_settings,
