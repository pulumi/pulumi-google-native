...
class GetWorkloadResult:
    def __init__(__self__, billing_account=None, cjis_settings=None, compliance_regime=None, compliance_status=None, compliant_but_disallowed_services=None, controls=None, create_time=None, display_name=None, ekm_provisioning_response=None, enable_sovereign_controls=None, etag=None, fedramp_high_settings=None, fedramp_moderate_settings=None, il4_settings=None, kaj_enrollment_state=None, kms_settings=None, labels=None, name=None, partner=None, partner_permissions=None, provisioned_resources_parent=None, resource_settings=None, resources=None, saa_enrollment_response=None, violation_notifications_enabled=None):
        ...
        if cjis_settings and not isinstance(cjis_settings, dict):
            raise TypeError("Expected argument 'cjis_settings' to be a dict")
        ...
        if controls and not isinstance(controls, dict):
            raise TypeError("Expected argument 'controls' to be a dict")
        ...
        if fedramp_high_settings and not isinstance(fedramp_high_settings, dict):
            raise TypeError("Expected argument 'fedramp_high_settings' to be a dict")
        pulumi.set(__self__, "fedramp_high_settings", fedramp_high_settings)
        if fedramp_moderate_settings and not isinstance(fedramp_moderate_settings, dict):
            raise TypeError("Expected argument 'fedramp_moderate_settings' to be a dict")
        pulumi.set(__self__, "fedramp_moderate_settings", fedramp_moderate_settings)
        if il4_settings and not isinstance(il4_settings, dict):
            raise TypeError("Expected argument 'il4_settings' to be a dict")
    ...
    def cjis_settings(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsResponse':
        """
    ...
    def compliance_status(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatusResponse':
        """
    ...
    @property
    @pulumi.getter
    def controls(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceControlsResponse':
        """
    ...
    def ekm_provisioning_response(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadEkmProvisioningResponseResponse':
        """
    ...
    def fedramp_high_settings(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsResponse':
        """
    ...
    def fedramp_moderate_settings(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettingsResponse':
        """
    ...
    def il4_settings(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadIL4SettingsResponse':
        """
    ...
    def partner_permissions(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissionsResponse':
        """
    ...
    def resource_settings(self) -> Sequence['outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResponse']:
        """
    ...
    @property
    @pulumi.getter
    def resources(self) -> Sequence['outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfoResponse']:
        """
    ...
    def saa_enrollment_response(self) -> 'outputs.GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseResponse':
        """
...
class AwaitableGetWorkloadResult(GetWorkloadResult):
    ...
    def __await__(self):
        ...
        return GetWorkloadResult(
            ...
            cjis_settings=self.cjis_settings,
            ...
            etag=self.etag,
            fedramp_high_settings=self.fedramp_high_settings,
            fedramp_moderate_settings=self.fedramp_moderate_settings,
            il4_settings=self.il4_settings,
...
def get_workload(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:assuredworkloads/v1beta1:getWorkload', __args__, opts=opts, typ=GetWorkloadResult).value

    return AwaitableGetWorkloadResult(
        billing_account=pulumi.get(__ret__, 'billing_account'),
        cjis_settings=pulumi.get(__ret__, 'cjis_settings'),
        ...
        fedramp_high_settings=pulumi.get(__ret__, 'fedramp_high_settings'),
        fedramp_moderate_settings=pulumi.get(__ret__, 'fedramp_moderate_settings'),
        il4_settings=pulumi.get(__ret__, 'il4_settings'),
