...
class Workload(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cjisSettings")
    def cjis_settings(self) -> pulumi.Output['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettingsResponse']:
        """
        Input only. Immutable. Settings specific to resources needed for CJIS.
        """
        return pulumi.get(self, "cjis_settings")
    ...
    def compliance_status(self) -> pulumi.Output['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatusResponse']:
        """
    ...
    @property
    @pulumi.getter(name="fedrampHighSettings")
    def fedramp_high_settings(self) -> pulumi.Output['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettingsResponse']:
        """
        Input only. Immutable. Settings specific to resources needed for FedRAMP High.
        """
        return pulumi.get(self, "fedramp_high_settings")
    ...
    @property
    @pulumi.getter(name="fedrampModerateSettings")
    def fedramp_moderate_settings(self) -> pulumi.Output['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettingsResponse']:
        """
        Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
        """
        return pulumi.get(self, "fedramp_moderate_settings")
    ...
    @property
    @pulumi.getter(name="il4Settings")
    def il4_settings(self) -> pulumi.Output['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4SettingsResponse']:
        """
        Input only. Immutable. Settings specific to resources needed for IL4.
        """
        return pulumi.get(self, "il4_settings")
    ...
    @property
    @pulumi.getter(name="kmsSettings")
    def kms_settings(self) -> pulumi.Output['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettingsResponse']:
        """
        Input only. Settings used to create a CMEK crypto key. When set, a project with a KMS CMEK key is provisioned. This field is deprecated as of Feb 28, 2022. In order to create a Keyring, callers should specify, ENCRYPTION_KEYS_PROJECT or KEYRING in ResourceSettings.resource_type field.
        """
        return pulumi.get(self, "kms_settings")
    ...
    @property
    @pulumi.getter(name="resourceSettings")
    def resource_settings(self) -> pulumi.Output[Sequence['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettingsResponse']]:
        """
        Input only. Resource properties that are used to customize workload resources. These properties (such as custom project id) will be used to create workload resources if possible. This field is optional.
        """
        return pulumi.get(self, "resource_settings")
    ...
    @property
    @pulumi.getter
    def resources(self) -> pulumi.Output[Sequence['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfoResponse']]:
        """
    ...
    def saa_enrollment_response(self) -> pulumi.Output['outputs.GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponseResponse']:
        """
