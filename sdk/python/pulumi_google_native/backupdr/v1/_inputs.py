...
class NetworkConfigArgs:
    def __init__(__self__, *,
                 ...
                 peering_mode: Optional[pulumi.Input['NetworkConfigPeeringMode']] = None):
        """
        Network configuration for ManagementServer instance.
        :param pulumi.Input[str] network: Optional. The resource name of the Google Compute Engine VPC network to which the ManagementServer instance is connected.
        :param pulumi.Input['NetworkConfigPeeringMode'] peering_mode: Optional. The network connect mode of the ManagementServer instance. For this version, only PRIVATE_SERVICE_ACCESS is supported.
        """
    ...
    def peering_mode(self) -> Optional[pulumi.Input['NetworkConfigPeeringMode']]:
        """
    ...
    @peering_mode.setter
    def peering_mode(self, value: Optional[pulumi.Input['NetworkConfigPeeringMode']]):
