...
__all__ = [
    ...
    'AwaitableGetManagementServerIamPolicyResult',
    'get_management_server_iam_policy',
    'get_management_server_iam_policy_output',
]
...
class AwaitableGetManagementServerIamPolicyResult(GetManagementServerIamPolicyResult):
...
def get_management_server_iam_policy(location: Optional[str] = None,
                                     management_server_id: Optional[str] = None,
                                     options_requested_policy_version: Optional[int] = None,
                                     project: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetManagementServerIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:backupdr/v1:getManagementServerIamPolicy', __args__, opts=opts, typ=GetManagementServerIamPolicyResult).value

    return AwaitableGetManagementServerIamPolicyResult(
...
@_utilities.lift_output_func(get_management_server_iam_policy)
def get_management_server_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                            ...
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetManagementServerIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
