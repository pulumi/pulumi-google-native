...
class GetNfsShareResult:
    def __init__(__self__, allowed_clients=None, id=None, labels=None, name=None, nfs_share_id=None, requested_size_gib=None, state=None, storage_type=None, volume=None):
    ...
    def id(self) -> str:
        """
        An identifier for the NFS share, generated by the backend. This is the same value as nfs_share_id and will replace it in the future.
        """
