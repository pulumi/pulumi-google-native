...
__all__ = [
    'GetNodeIamPolicyResult',
    'AwaitableGetNodeIamPolicyResult',
    'get_node_iam_policy',
    'get_node_iam_policy_output',
]

@pulumi.output_type
class GetNodeIamPolicyResult:
...
class AwaitableGetNodeIamPolicyResult(GetNodeIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNodeIamPolicyResult(
...
def get_node_iam_policy(location: Optional[str] = None,
                        node_id: Optional[str] = None,
                        options_requested_policy_version: Optional[int] = None,
                        project: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNodeIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:batch/v1:getNodeIamPolicy', __args__, opts=opts, typ=GetNodeIamPolicyResult).value

    return AwaitableGetNodeIamPolicyResult(
...
@_utilities.lift_output_func(get_node_iam_policy)
def get_node_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                               node_id: Optional[pulumi.Input[str]] = None,
                               options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                               project: Optional[pulumi.Input[Optional[str]]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNodeIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
