...
def get_task_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:batch/v1:getTaskIamPolicy', __args__, opts=opts, typ=GetTaskIamPolicyResult).value
...
def get_task_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
