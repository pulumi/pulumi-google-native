...
__all__ = ['NodeIamPolicyArgs', 'NodeIamPolicy']

@pulumi.input_type
class NodeIamPolicyArgs:
...
class NodeIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param NodeIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NodeIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NodeIamPolicyArgs.__new__(NodeIamPolicyArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "node_id", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(NodeIamPolicy, __self__).__init__(
            'google-native:batch/v1:NodeIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NodeIamPolicy':
        """
        ...
        return NodeIamPolicy(resource_name, opts=opts, __props__=__props__)
