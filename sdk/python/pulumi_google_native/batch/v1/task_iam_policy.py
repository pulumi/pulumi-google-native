...
class TaskIamPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "project", "task_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(TaskIamPolicy, __self__).__init__(
            'google-native:batch/v1:TaskIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TaskIamPolicy':
        """
        ...
        return TaskIamPolicy(resource_name, opts=opts, __props__=__props__)
