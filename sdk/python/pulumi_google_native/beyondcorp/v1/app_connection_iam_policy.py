...
__all__ = ['AppConnectionIamPolicyArgs', 'AppConnectionIamPolicy']

@pulumi.input_type
class AppConnectionIamPolicyArgs:
    def __init__(__self__, *,
                 app_connection_id: pulumi.Input[str],
    ...
    def app_connection_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "app_connection_id")

    @app_connection_id.setter
    def app_connection_id(self, value: pulumi.Input[str]):
...
class AppConnectionIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AppConnectionIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param AppConnectionIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AppConnectionIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AppConnectionIamPolicyArgs.__new__(AppConnectionIamPolicyArgs)

            if app_connection_id is None and not opts.urn:
                raise TypeError("Missing required property 'app_connection_id'")
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["app_connection_id", "location", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(AppConnectionIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AppConnectionIamPolicy':
        """
        ...
        return AppConnectionIamPolicy(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="appConnectionId")
    def app_connection_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "app_connection_id")
