...
class AppConnectorArgs:
    def __init__(__self__, *,
                 principal_info: pulumi.Input['GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoArgs'],
    ...
    def principal_info(self) -> pulumi.Input['GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoArgs']:
        """
    ...
    def principal_info(self, value: pulumi.Input['GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoArgs']):
    ...
    def resource_info(self) -> Optional[pulumi.Input['GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoArgs']]:
        """
...
class AppConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 principal_info: Optional[pulumi.Input[Union['GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoArgs', 'GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoArgsDict']]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 request_id: Optional[pulumi.Input[str]] = None,
                 resource_info: Optional[pulumi.Input[Union['GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoArgs', 'GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: Optional. Resource labels to represent user provided metadata.
        :param pulumi.Input[str] name: Unique resource name of the AppConnector. The name is ignored when creating a AppConnector.
        :param pulumi.Input[Union['GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoArgs', 'GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoArgsDict']] principal_info: Principal information about the Identity of the AppConnector.
        :param pulumi.Input[str] request_id: Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
        :param pulumi.Input[Union['GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoArgs', 'GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoArgsDict']] resource_info: Optional. Resource info of the connector.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="principalInfo")
    def principal_info(self) -> pulumi.Output['outputs.GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse']:
        """
        Principal information about the Identity of the AppConnector.
        """
        return pulumi.get(self, "principal_info")
    ...
    @property
    @pulumi.getter(name="resourceInfo")
    def resource_info(self) -> pulumi.Output['outputs.GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse']:
        """
        Optional. Resource info of the connector.
        """
        return pulumi.get(self, "resource_info")
