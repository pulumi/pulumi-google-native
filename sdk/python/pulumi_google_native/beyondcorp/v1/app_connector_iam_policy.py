...
__all__ = ['AppConnectorIamPolicyArgs', 'AppConnectorIamPolicy']

@pulumi.input_type
class AppConnectorIamPolicyArgs:
    def __init__(__self__, *,
                 app_connector_id: pulumi.Input[str],
    ...
    def app_connector_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "app_connector_id")

    @app_connector_id.setter
    def app_connector_id(self, value: pulumi.Input[str]):
...
class AppConnectorIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AppConnectorIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param AppConnectorIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AppConnectorIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AppConnectorIamPolicyArgs.__new__(AppConnectorIamPolicyArgs)

            if app_connector_id is None and not opts.urn:
                raise TypeError("Missing required property 'app_connector_id'")
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["app_connector_id", "location", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(AppConnectorIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AppConnectorIamPolicy':
        """
        ...
        return AppConnectorIamPolicy(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="appConnectorId")
    def app_connector_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "app_connector_id")
