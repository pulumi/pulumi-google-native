...
__all__ = ['AppGatewayIamPolicyArgs', 'AppGatewayIamPolicy']

@pulumi.input_type
class AppGatewayIamPolicyArgs:
    def __init__(__self__, *,
                 app_gateway_id: pulumi.Input[str],
    ...
    def app_gateway_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "app_gateway_id")

    @app_gateway_id.setter
    def app_gateway_id(self, value: pulumi.Input[str]):
...
class AppGatewayIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param AppGatewayIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AppGatewayIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AppGatewayIamPolicyArgs.__new__(AppGatewayIamPolicyArgs)

            if app_gateway_id is None and not opts.urn:
                raise TypeError("Missing required property 'app_gateway_id'")
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AppGatewayIamPolicy':
        """
        ...
        return AppGatewayIamPolicy(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="appGatewayId")
    def app_gateway_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "app_gateway_id")
