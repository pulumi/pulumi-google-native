...
__all__ = [
    'GetAppConnectionIamPolicyResult',
    'AwaitableGetAppConnectionIamPolicyResult',
    'get_app_connection_iam_policy',
    'get_app_connection_iam_policy_output',
]
...
class AwaitableGetAppConnectionIamPolicyResult(GetAppConnectionIamPolicyResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetAppConnectionIamPolicyResult(
...
def get_app_connection_iam_policy(app_connection_id: Optional[str] = None,
                                  location: Optional[str] = None,
                                  options_requested_policy_version: Optional[str] = None,
                                  project: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAppConnectionIamPolicyResult:
    """
    ...
    return AwaitableGetAppConnectionIamPolicyResult(
...
def get_app_connection_iam_policy_output(app_connection_id: Optional[pulumi.Input[str]] = None,
                                         location: Optional[pulumi.Input[str]] = None,
                                         options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
                                         project: Optional[pulumi.Input[Optional[str]]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAppConnectionIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
