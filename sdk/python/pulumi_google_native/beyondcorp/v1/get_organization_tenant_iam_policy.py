...
__all__ = [
    'GetOrganizationTenantIamPolicyResult',
    'AwaitableGetOrganizationTenantIamPolicyResult',
    'get_organization_tenant_iam_policy',
    'get_organization_tenant_iam_policy_output',
]

@pulumi.output_type
class GetOrganizationTenantIamPolicyResult:
...
class AwaitableGetOrganizationTenantIamPolicyResult(GetOrganizationTenantIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrganizationTenantIamPolicyResult(
...
def get_organization_tenant_iam_policy(options_requested_policy_version: Optional[int] = None,
                                       organization_id: Optional[str] = None,
                                       tenant_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrganizationTenantIamPolicyResult:
    """
...
def get_organization_tenant_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                              organization_id: Optional[pulumi.Input[str]] = None,
                                              tenant_id: Optional[pulumi.Input[str]] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOrganizationTenantIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
