...
__all__ = ['OrganizationTenantProxyConfigIamPolicyArgs', 'OrganizationTenantProxyConfigIamPolicy']

@pulumi.input_type
class OrganizationTenantProxyConfigIamPolicyArgs:
    def __init__(__self__, *,
                 organization_id: pulumi.Input[str],
                 proxy_config_id: pulumi.Input[str],
        ...
        pulumi.set(__self__, "proxy_config_id", proxy_config_id)
    ...
    @property
    @pulumi.getter(name="proxyConfigId")
    def proxy_config_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "proxy_config_id")

    @proxy_config_id.setter
    def proxy_config_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "proxy_config_id", value)
...
class OrganizationTenantProxyConfigIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OrganizationTenantProxyConfigIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param OrganizationTenantProxyConfigIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationTenantProxyConfigIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OrganizationTenantProxyConfigIamPolicyArgs.__new__(OrganizationTenantProxyConfigIamPolicyArgs)
            ...
            if proxy_config_id is None and not opts.urn:
                raise TypeError("Missing required property 'proxy_config_id'")
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["organization_id", "proxy_config_id", "tenant_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(OrganizationTenantProxyConfigIamPolicy, __self__).__init__(
            'google-native:beyondcorp/v1:OrganizationTenantProxyConfigIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OrganizationTenantProxyConfigIamPolicy':
        """
        Get an existing OrganizationTenantProxyConfigIamPolicy resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["proxy_config_id"] = None
        __props__.__dict__["tenant_id"] = None
        __props__.__dict__["version"] = None
        return OrganizationTenantProxyConfigIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="proxyConfigId")
    def proxy_config_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "proxy_config_id")
