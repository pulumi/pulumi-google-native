...
__all__ = ['ClientConnectorServiceIamPolicyArgs', 'ClientConnectorServiceIamPolicy']

@pulumi.input_type
class ClientConnectorServiceIamPolicyArgs:
    def __init__(__self__, *,
                 client_connector_service_id: pulumi.Input[str],
    ...
    def client_connector_service_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "client_connector_service_id")

    @client_connector_service_id.setter
    def client_connector_service_id(self, value: pulumi.Input[str]):
...
class ClientConnectorServiceIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ClientConnectorServiceIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param ClientConnectorServiceIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ClientConnectorServiceIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ClientConnectorServiceIamPolicyArgs.__new__(ClientConnectorServiceIamPolicyArgs)

            __props__.__dict__["audit_configs"] = audit_configs
            __props__.__dict__["bindings"] = bindings
            if client_connector_service_id is None and not opts.urn:
                raise TypeError("Missing required property 'client_connector_service_id'")
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["client_connector_service_id", "location", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ClientConnectorServiceIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ClientConnectorServiceIamPolicy':
        """
        ...
        return ClientConnectorServiceIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="clientConnectorServiceId")
    def client_connector_service_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "client_connector_service_id")
