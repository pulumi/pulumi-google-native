...
def get_application_iam_policy(application_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:beyondcorp/v1alpha:getApplicationIamPolicy', __args__, opts=opts, typ=GetApplicationIamPolicyResult).value
...
@_utilities.lift_output_func(get_application_iam_policy)
def get_application_iam_policy_output(application_id: Optional[pulumi.Input[str]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetApplicationIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
