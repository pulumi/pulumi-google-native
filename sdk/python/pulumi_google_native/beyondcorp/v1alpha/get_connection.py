...
class GetConnectionResult:
    ...
    def application_endpoint(self) -> 'outputs.ApplicationEndpointResponse':
        """
    ...
    @property
    @pulumi.getter
    def gateway(self) -> 'outputs.GatewayResponse':
        """
...
def get_connection(connection_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:beyondcorp/v1alpha:getConnection', __args__, opts=opts, typ=GetConnectionResult).value
