...
class GetConnectorResult:
    ...
    def principal_info(self) -> 'outputs.PrincipalInfoResponse':
        """
    ...
    def resource_info(self) -> 'outputs.ResourceInfoResponse':
        """
...
def get_connector(connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:beyondcorp/v1alpha:getConnector', __args__, opts=opts, typ=GetConnectorResult).value
