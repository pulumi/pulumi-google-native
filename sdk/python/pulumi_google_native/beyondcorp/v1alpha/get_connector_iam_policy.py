...
__all__ = [
    ...
    'AwaitableGetConnectorIamPolicyResult',
    'get_connector_iam_policy',
    'get_connector_iam_policy_output',
]
...
class AwaitableGetConnectorIamPolicyResult(GetConnectorIamPolicyResult):
...
def get_connector_iam_policy(connector_id: Optional[str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectorIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:beyondcorp/v1alpha:getConnectorIamPolicy', __args__, opts=opts, typ=GetConnectorIamPolicyResult).value

    return AwaitableGetConnectorIamPolicyResult(
...
@_utilities.lift_output_func(get_connector_iam_policy)
def get_connector_iam_policy_output(connector_id: Optional[pulumi.Input[str]] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetConnectorIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
