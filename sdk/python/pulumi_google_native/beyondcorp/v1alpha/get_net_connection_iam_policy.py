...
__all__ = [
    ...
    'AwaitableGetNetConnectionIamPolicyResult',
    'get_net_connection_iam_policy',
    'get_net_connection_iam_policy_output',
]
...
class AwaitableGetNetConnectionIamPolicyResult(GetNetConnectionIamPolicyResult):
...
def get_net_connection_iam_policy(location: Optional[str] = None,
                                  net_connection_id: Optional[str] = None,
                                  options_requested_policy_version: Optional[int] = None,
                                  project: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetConnectionIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:beyondcorp/v1alpha:getNetConnectionIamPolicy', __args__, opts=opts, typ=GetNetConnectionIamPolicyResult).value

    return AwaitableGetNetConnectionIamPolicyResult(
...
@_utilities.lift_output_func(get_net_connection_iam_policy)
def get_net_connection_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNetConnectionIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
