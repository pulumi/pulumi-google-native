...
class PartnerTenantArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] google_group_email: Optional. Google group email to which the PartnerTenant is enabled.
        :param pulumi.Input[str] google_group_id: Optional. Google group ID to which the PartnerTenant is enabled.
