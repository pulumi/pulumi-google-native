...
class SecurityGatewayArgs:
    def __init__(__self__, *,
                 ...
                 region_configs: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudBeyondcorpSecuritygatewaysV1alphaRegionConfigArgs']]]] = None,
        ...
        :param pulumi.Input[str] display_name: Optional. An arbitrary user-provided name for the SecurityGateway. Cannot exceed 64 characters.
        :param pulumi.Input[str] name: Identifier. Name of the resource.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudBeyondcorpSecuritygatewaysV1alphaRegionConfigArgs']]] region_configs: Optional. List of regions where the egress connectivity is required.
        :param pulumi.Input[str] request_id: Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request.
        :param pulumi.Input[str] security_gateway_id: Optional. User-settable SecurityGateway resource ID. * Must start with a letter. * Must contain between 4-63 characters from `/a-z-/`. * Must end with a number or letter.
        """
    ...
    def region_configs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudBeyondcorpSecuritygatewaysV1alphaRegionConfigArgs']]]]:
        """
    ...
    def region_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudBeyondcorpSecuritygatewaysV1alphaRegionConfigArgs']]]]):
...
class SecurityGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 region_configs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GoogleCloudBeyondcorpSecuritygatewaysV1alphaRegionConfigArgs']]]]] = None,
                 request_id: Optional[pulumi.Input[str]] = None,
                 security_gateway_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] display_name: Optional. An arbitrary user-provided name for the SecurityGateway. Cannot exceed 64 characters.
        :param pulumi.Input[str] name: Identifier. Name of the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GoogleCloudBeyondcorpSecuritygatewaysV1alphaRegionConfigArgs']]]] region_configs: Optional. List of regions where the egress connectivity is required.
        :param pulumi.Input[str] request_id: Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request.
        :param pulumi.Input[str] security_gateway_id: Optional. User-settable SecurityGateway resource ID. * Must start with a letter. * Must contain between 4-63 characters from `/a-z-/`. * Must end with a number or letter.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SecurityGatewayArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a new SecurityGateway in a given project and location.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["region_configs"] = region_configs
        ...
        super(SecurityGateway, __self__).__init__(
            'google-native:beyondcorp/v1alpha:SecurityGateway',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SecurityGateway':
        """
        ...
        __props__.__dict__["region_configs"] = None
        __props__.__dict__["request_id"] = None
        __props__.__dict__["security_gateway_id"] = None
        __props__.__dict__["state"] = None
        __props__.__dict__["update_time"] = None
    ...
    @property
    @pulumi.getter(name="regionConfigs")
    def region_configs(self) -> pulumi.Output[Sequence['outputs.GoogleCloudBeyondcorpSecuritygatewaysV1alphaRegionConfigResponse']]:
        """
        Optional. List of regions where the egress connectivity is required.
        """
        return pulumi.get(self, "region_configs")
    ...
    @property
    @pulumi.getter(name="securityGatewayId")
    def security_gateway_id(self) -> pulumi.Output[Optional[str]]:
        """
        Optional. User-settable SecurityGateway resource ID. * Must start with a letter. * Must contain between 4-63 characters from `/a-z-/`. * Must end with a number or letter.
        """
        return pulumi.get(self, "security_gateway_id")
