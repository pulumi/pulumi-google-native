...
@pulumi.input_type
class BigQueryModelTrainingArgs:
    def __init__(__self__, *,
                 current_iteration: Optional[pulumi.Input[int]] = None,
                 expected_total_iterations: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[int] current_iteration: [Output-only, Beta] Index of current ML training iteration. Updated during create model query job to show job progress.
        :param pulumi.Input[str] expected_total_iterations: [Output-only, Beta] Expected number of iterations for the create model query job specified as num_iterations in the input query. The actual total number of iterations may be less than this number due to early stop.
        """
    ...
    def current_iteration(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def current_iteration(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "current_iteration", value)

    @property
    @pulumi.getter(name="expectedTotalIterations")
    def expected_total_iterations(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def expected_total_iterations(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "expected_total_iterations", value)
...
class DestinationTablePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, str]] labels: [Optional] The labels associated with this table. You can use these to organize and group your tables. This will only be used if the destination table is newly created. If the table already exists and labels are different than the current labels are provided, the job will fail.
        """
...
class ErrorProtoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] debug_info: Debugging information. This property is internal to Google and should not be used.
...
@pulumi.input_type
class ExplainQueryStageArgs:
    def __init__(__self__, *,
                 completed_parallel_inputs: Optional[pulumi.Input[str]] = None,
                 compute_ms_avg: Optional[pulumi.Input[str]] = None,
                 compute_ms_max: Optional[pulumi.Input[str]] = None,
                 compute_ratio_avg: Optional[pulumi.Input[float]] = None,
                 compute_ratio_max: Optional[pulumi.Input[float]] = None,
                 end_ms: Optional[pulumi.Input[str]] = None,
                 id: Optional[pulumi.Input[str]] = None,
                 input_stages: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 parallel_inputs: Optional[pulumi.Input[str]] = None,
                 read_ms_avg: Optional[pulumi.Input[str]] = None,
                 read_ms_max: Optional[pulumi.Input[str]] = None,
                 read_ratio_avg: Optional[pulumi.Input[float]] = None,
                 read_ratio_max: Optional[pulumi.Input[float]] = None,
                 records_read: Optional[pulumi.Input[str]] = None,
                 records_written: Optional[pulumi.Input[str]] = None,
                 shuffle_output_bytes: Optional[pulumi.Input[str]] = None,
                 shuffle_output_bytes_spilled: Optional[pulumi.Input[str]] = None,
                 slot_ms: Optional[pulumi.Input[str]] = None,
                 start_ms: Optional[pulumi.Input[str]] = None,
                 status: Optional[pulumi.Input[str]] = None,
                 steps: Optional[pulumi.Input[Sequence[pulumi.Input['ExplainQueryStepArgs']]]] = None,
                 wait_ms_avg: Optional[pulumi.Input[str]] = None,
                 wait_ms_max: Optional[pulumi.Input[str]] = None,
                 wait_ratio_avg: Optional[pulumi.Input[float]] = None,
                 wait_ratio_max: Optional[pulumi.Input[float]] = None,
                 write_ms_avg: Optional[pulumi.Input[str]] = None,
                 write_ms_max: Optional[pulumi.Input[str]] = None,
                 write_ratio_avg: Optional[pulumi.Input[float]] = None,
                 write_ratio_max: Optional[pulumi.Input[float]] = None):
        """
        :param pulumi.Input[str] completed_parallel_inputs: Number of parallel input segments completed.
        :param pulumi.Input[str] compute_ms_avg: Milliseconds the average shard spent on CPU-bound tasks.
        :param pulumi.Input[str] compute_ms_max: Milliseconds the slowest shard spent on CPU-bound tasks.
        :param pulumi.Input[float] compute_ratio_avg: Relative amount of time the average shard spent on CPU-bound tasks.
        :param pulumi.Input[float] compute_ratio_max: Relative amount of time the slowest shard spent on CPU-bound tasks.
        :param pulumi.Input[str] end_ms: Stage end time represented as milliseconds since epoch.
        :param pulumi.Input[str] id: Unique ID for stage within plan.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] input_stages: IDs for stages that are inputs to this stage.
        :param pulumi.Input[str] name: Human-readable name for stage.
        :param pulumi.Input[str] parallel_inputs: Number of parallel input segments to be processed.
        :param pulumi.Input[str] read_ms_avg: Milliseconds the average shard spent reading input.
        :param pulumi.Input[str] read_ms_max: Milliseconds the slowest shard spent reading input.
        :param pulumi.Input[float] read_ratio_avg: Relative amount of time the average shard spent reading input.
        :param pulumi.Input[float] read_ratio_max: Relative amount of time the slowest shard spent reading input.
        :param pulumi.Input[str] records_read: Number of records read into the stage.
        :param pulumi.Input[str] records_written: Number of records written by the stage.
        :param pulumi.Input[str] shuffle_output_bytes: Total number of bytes written to shuffle.
        :param pulumi.Input[str] shuffle_output_bytes_spilled: Total number of bytes written to shuffle and spilled to disk.
        :param pulumi.Input[str] slot_ms: Slot-milliseconds used by the stage.
        :param pulumi.Input[str] start_ms: Stage start time represented as milliseconds since epoch.
        :param pulumi.Input[str] status: Current status for the stage.
        :param pulumi.Input[Sequence[pulumi.Input['ExplainQueryStepArgs']]] steps: List of operations within the stage in dependency order (approximately chronological).
        :param pulumi.Input[str] wait_ms_avg: Milliseconds the average shard spent waiting to be scheduled.
        :param pulumi.Input[str] wait_ms_max: Milliseconds the slowest shard spent waiting to be scheduled.
        :param pulumi.Input[float] wait_ratio_avg: Relative amount of time the average shard spent waiting to be scheduled.
        :param pulumi.Input[float] wait_ratio_max: Relative amount of time the slowest shard spent waiting to be scheduled.
        :param pulumi.Input[str] write_ms_avg: Milliseconds the average shard spent on writing output.
        :param pulumi.Input[str] write_ms_max: Milliseconds the slowest shard spent on writing output.
        :param pulumi.Input[float] write_ratio_avg: Relative amount of time the average shard spent on writing output.
        :param pulumi.Input[float] write_ratio_max: Relative amount of time the slowest shard spent on writing output.
        """
        if completed_parallel_inputs is not None:
            pulumi.set(__self__, "completed_parallel_inputs", completed_parallel_inputs)
        if compute_ms_avg is not None:
            pulumi.set(__self__, "compute_ms_avg", compute_ms_avg)
        if compute_ms_max is not None:
            pulumi.set(__self__, "compute_ms_max", compute_ms_max)
        if compute_ratio_avg is not None:
            pulumi.set(__self__, "compute_ratio_avg", compute_ratio_avg)
        if compute_ratio_max is not None:
        ...
        if shuffle_output_bytes is not None:
            pulumi.set(__self__, "shuffle_output_bytes", shuffle_output_bytes)
        if shuffle_output_bytes_spilled is not None:
    ...
    def completed_parallel_inputs(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "completed_parallel_inputs", value)

    @property
    @pulumi.getter(name="computeMsAvg")
    def compute_ms_avg(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def compute_ms_avg(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "compute_ms_avg", value)

    @property
    @pulumi.getter(name="computeMsMax")
    def compute_ms_max(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def compute_ms_max(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "compute_ms_max", value)

    @property
    @pulumi.getter(name="computeRatioAvg")
    def compute_ratio_avg(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def compute_ratio_avg(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "compute_ratio_avg", value)

    @property
    @pulumi.getter(name="computeRatioMax")
    def compute_ratio_max(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def compute_ratio_max(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "compute_ratio_max", value)

    @property
    @pulumi.getter(name="endMs")
    def end_ms(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @end_ms.setter
    def end_ms(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "end_ms", value)
    ...
    def input_stages(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    @input_stages.setter
    def input_stages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "input_stages", value)
    ...
    def parallel_inputs(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def parallel_inputs(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "parallel_inputs", value)

    @property
    @pulumi.getter(name="readMsAvg")
    def read_ms_avg(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @read_ms_avg.setter
    def read_ms_avg(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "read_ms_avg", value)

    @property
    @pulumi.getter(name="readMsMax")
    def read_ms_max(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @read_ms_max.setter
    def read_ms_max(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "read_ms_max", value)

    @property
    @pulumi.getter(name="readRatioAvg")
    def read_ratio_avg(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def read_ratio_avg(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "read_ratio_avg", value)

    @property
    @pulumi.getter(name="readRatioMax")
    def read_ratio_max(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def read_ratio_max(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "read_ratio_max", value)

    @property
    @pulumi.getter(name="recordsRead")
    def records_read(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @records_read.setter
    def records_read(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "records_read", value)

    @property
    @pulumi.getter(name="recordsWritten")
    def records_written(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def records_written(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "records_written", value)

    @property
    @pulumi.getter(name="shuffleOutputBytes")
    def shuffle_output_bytes(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def shuffle_output_bytes(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "shuffle_output_bytes", value)

    @property
    @pulumi.getter(name="shuffleOutputBytesSpilled")
    def shuffle_output_bytes_spilled(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def shuffle_output_bytes_spilled(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "shuffle_output_bytes_spilled", value)
    ...
    def start_ms(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @start_ms.setter
    def start_ms(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "start_ms", value)
    ...
    @property
    @pulumi.getter
    def steps(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ExplainQueryStepArgs']]]]:
        """
    ...
    @steps.setter
    def steps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ExplainQueryStepArgs']]]]):
        pulumi.set(self, "steps", value)

    @property
    @pulumi.getter(name="waitMsAvg")
    def wait_ms_avg(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @wait_ms_avg.setter
    def wait_ms_avg(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "wait_ms_avg", value)

    @property
    @pulumi.getter(name="waitMsMax")
    def wait_ms_max(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @wait_ms_max.setter
    def wait_ms_max(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "wait_ms_max", value)

    @property
    @pulumi.getter(name="waitRatioAvg")
    def wait_ratio_avg(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def wait_ratio_avg(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "wait_ratio_avg", value)

    @property
    @pulumi.getter(name="waitRatioMax")
    def wait_ratio_max(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def wait_ratio_max(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "wait_ratio_max", value)

    @property
    @pulumi.getter(name="writeMsAvg")
    def write_ms_avg(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @write_ms_avg.setter
    def write_ms_avg(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "write_ms_avg", value)

    @property
    @pulumi.getter(name="writeMsMax")
    def write_ms_max(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @write_ms_max.setter
    def write_ms_max(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "write_ms_max", value)

    @property
    @pulumi.getter(name="writeRatioAvg")
    def write_ratio_avg(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def write_ratio_avg(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "write_ratio_avg", value)

    @property
    @pulumi.getter(name="writeRatioMax")
    def write_ratio_max(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def write_ratio_max(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "write_ratio_max", value)


@pulumi.input_type
class ExplainQueryStepArgs:
    def __init__(__self__, *,
                 kind: Optional[pulumi.Input[str]] = None,
                 substeps: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        :param pulumi.Input[str] kind: Machine-readable operation type.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] substeps: Human-readable stage descriptions.
        """
        if kind is not None:
    ...
    @property
    @pulumi.getter
    def substeps(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    @substeps.setter
    def substeps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "substeps", value)
...
class JobConfigurationQueryArgs:
    def __init__(__self__, *,
                 ...
                 range_partitioning: Optional[pulumi.Input['RangePartitioningArgs']] = None,
                 schema_update_options: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 table_definitions: Optional[pulumi.Input[Mapping[str, str]]] = None,
                 time_partitioning: Optional[pulumi.Input['TimePartitioningArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, str]] table_definitions: [Optional] If querying an external data source outside of BigQuery, describes the data format, location and other properties of the data source. By defining these properties, the data source can then be queried as if it were a standard BigQuery table.
        :param pulumi.Input['TimePartitioningArgs'] time_partitioning: Time-based partitioning specification for the destination table. Only one of timePartitioning and rangePartitioning should be specified.
    ...
    def table_definitions(self) -> Optional[pulumi.Input[Mapping[str, str]]]:
        """
    ...
    def table_definitions(self, value: Optional[pulumi.Input[Mapping[str, str]]]):
...
class JobConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] job_type: [Output-only] The type of the job. Can be QUERY, LOAD, EXTRACT, COPY or UNKNOWN.
        :param pulumi.Input[Mapping[str, str]] labels: The labels associated with this job. You can use these to organize and group your jobs. Label keys and values can be no longer than 63 characters, can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. Label values are optional. Label keys must start with a letter and each label in the list must have a different key.
...
class JobStatistics2Args:
    def __init__(__self__, *,
                 ...
                 total_bytes_billed: Optional[pulumi.Input[str]] = None,
                 total_bytes_processed: Optional[pulumi.Input[str]] = None,
                 total_bytes_processed_accuracy: Optional[pulumi.Input[str]] = None,
                 total_partitions_processed: Optional[pulumi.Input[str]] = None,
                 total_slot_ms: Optional[pulumi.Input[str]] = None,
                 undeclared_query_parameters: Optional[pulumi.Input[Sequence[pulumi.Input['QueryParameterArgs']]]] = None):
        """
        ...
        :param pulumi.Input[str] total_bytes_billed: [Output-only] Total bytes billed for the job.
        :param pulumi.Input[str] total_bytes_processed: [Output-only] Total bytes processed for the job.
        :param pulumi.Input[str] total_bytes_processed_accuracy: [Output-only] For dry-run jobs, totalBytesProcessed is an estimate and this field specifies the accuracy of the estimate. Possible values can be: UNKNOWN: accuracy of the estimate is unknown. PRECISE: estimate is precise. LOWER_BOUND: estimate is lower bound of what the query would cost. UPPER_BOUND: estimate is upper bound of what the query would cost.
        :param pulumi.Input[str] total_partitions_processed: [Output-only] Total number of partitions processed from all partitioned tables referenced in the job.
        :param pulumi.Input[str] total_slot_ms: [Output-only] Slot-milliseconds for the job.
        :param pulumi.Input[Sequence[pulumi.Input['QueryParameterArgs']]] undeclared_query_parameters: Standard SQL only: list of undeclared query parameters detected during a dry run validation.
        """
        ...
        if ddl_target_routine is not None:
            pulumi.set(__self__, "ddl_target_routine", ddl_target_routine)
        if ddl_target_row_access_policy is not None:
        ...
        if referenced_routines is not None:
        ...
        if reservation_usage is not None:
        ...
        if total_bytes_processed_accuracy is not None:
            pulumi.set(__self__, "total_bytes_processed_accuracy", total_bytes_processed_accuracy)
        if total_partitions_processed is not None:
    ...
    @billing_tier.setter
    def billing_tier(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "billing_tier", value)

    @property
    @pulumi.getter(name="cacheHit")
    def cache_hit(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    @cache_hit.setter
    def cache_hit(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "cache_hit", value)

    @property
    @pulumi.getter(name="ddlAffectedRowAccessPolicyCount")
    def ddl_affected_row_access_policy_count(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def ddl_affected_row_access_policy_count(self, value: Optional[pulumi.Input[str]]):
    ...
    def ddl_operation_performed(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "ddl_operation_performed", value)

    @property
    @pulumi.getter(name="ddlTargetDataset")
    def ddl_target_dataset(self) -> Optional[pulumi.Input['DatasetReferenceArgs']]:
        """
    ...
    def ddl_target_dataset(self, value: Optional[pulumi.Input['DatasetReferenceArgs']]):
        pulumi.set(self, "ddl_target_dataset", value)

    @property
    @pulumi.getter(name="ddlTargetRoutine")
    def ddl_target_routine(self) -> Optional[pulumi.Input['RoutineReferenceArgs']]:
        """
    ...
    def ddl_target_routine(self, value: Optional[pulumi.Input['RoutineReferenceArgs']]):
        pulumi.set(self, "ddl_target_routine", value)

    @property
    @pulumi.getter(name="ddlTargetRowAccessPolicy")
    def ddl_target_row_access_policy(self) -> Optional[pulumi.Input['RowAccessPolicyReferenceArgs']]:
        """
    ...
    def ddl_target_row_access_policy(self, value: Optional[pulumi.Input['RowAccessPolicyReferenceArgs']]):
        pulumi.set(self, "ddl_target_row_access_policy", value)

    @property
    @pulumi.getter(name="ddlTargetTable")
    def ddl_target_table(self) -> Optional[pulumi.Input['TableReferenceArgs']]:
        """
    ...
    def estimated_bytes_processed(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def estimated_bytes_processed(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "estimated_bytes_processed", value)

    @property
    @pulumi.getter(name="modelTraining")
    def model_training(self) -> Optional[pulumi.Input['BigQueryModelTrainingArgs']]:
        """
    ...
    def num_dml_affected_rows(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def num_dml_affected_rows(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "num_dml_affected_rows", value)

    @property
    @pulumi.getter(name="queryPlan")
    def query_plan(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ExplainQueryStageArgs']]]]:
        """
    ...
    @query_plan.setter
    def query_plan(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ExplainQueryStageArgs']]]]):
        pulumi.set(self, "query_plan", value)

    @property
    @pulumi.getter(name="referencedRoutines")
    def referenced_routines(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RoutineReferenceArgs']]]]:
        """
    ...
    def referenced_routines(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RoutineReferenceArgs']]]]):
        pulumi.set(self, "referenced_routines", value)

    @property
    @pulumi.getter(name="referencedTables")
    def referenced_tables(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['TableReferenceArgs']]]]:
        """
    ...
    def referenced_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['TableReferenceArgs']]]]):
    ...
    def statement_type(self) -> Optional[pulumi.Input[str]]:
        """
        The type of query statement, if valid. Possible values (new values might be added in the future): "SELECT": SELECT query. "INSERT": INSERT query; see https://cloud.google.com/bigquery/docs/reference/standard-sql/data-manipulation-language. "UPDATE": UPDATE query; see https://cloud.google.com/bigquery/docs/reference/standard-sql/data-manipulation-language. "DELETE": DELETE query; see https://cloud.google.com/bigquery/docs/reference/standard-sql/data-manipulation-language. "MERGE": MERGE query; see https://cloud.google.com/bigquery/docs/reference/standard-sql/data-manipulation-language. "ALTER_TABLE": ALTER TABLE query. "ALTER_VIEW": ALTER VIEW query. "ASSERT": ASSERT condition AS 'description'. "CREATE_FUNCTION": CREATE FUNCTION query. "CREATE_MODEL": CREATE [OR REPLACE] MODEL ... AS SELECT ... . "CREATE_PROCEDURE": CREATE PROCEDURE query. "CREATE_TABLE": CREATE [OR REPLACE] TABLE without AS SELECT. "CREATE_TABLE_AS_SELECT": CREATE [OR REPLACE] TABLE ... AS SELECT ... . "CREATE_VIEW": CREATE [OR REPLACE] VIEW ... AS SELECT ... . "DROP_FUNCTION" : DROP FUNCTION query. "DROP_PROCEDURE": DROP PROCEDURE query. "DROP_TABLE": DROP TABLE query. "DROP_VIEW": DROP VIEW query.
        """
    ...
    def statement_type(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "statement_type", value)

    @property
    @pulumi.getter
    def timeline(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['QueryTimelineSampleArgs']]]]:
        """
    ...
    @timeline.setter
    def timeline(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['QueryTimelineSampleArgs']]]]):
        pulumi.set(self, "timeline", value)

    @property
    @pulumi.getter(name="totalBytesBilled")
    def total_bytes_billed(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def total_bytes_billed(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "total_bytes_billed", value)
    ...
    def total_bytes_processed_accuracy(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def total_bytes_processed_accuracy(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "total_bytes_processed_accuracy", value)

    @property
    @pulumi.getter(name="totalPartitionsProcessed")
    def total_partitions_processed(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def total_partitions_processed(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "total_partitions_processed", value)
    ...
    def total_slot_ms(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "total_slot_ms", value)

    @property
    @pulumi.getter(name="undeclaredQueryParameters")
    def undeclared_query_parameters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['QueryParameterArgs']]]]:
        """
...
@pulumi.input_type
class JobStatistics3Args:
    def __init__(__self__, *,
                 bad_records: Optional[pulumi.Input[str]] = None,
                 input_file_bytes: Optional[pulumi.Input[str]] = None,
                 input_files: Optional[pulumi.Input[str]] = None,
                 output_bytes: Optional[pulumi.Input[str]] = None,
                 output_rows: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] bad_records: [Output-only] The number of bad records encountered. Note that if the job has failed because of more bad records encountered than the maximum allowed in the load job configuration, then this number can be less than the total number of bad records present in the input data.
        :param pulumi.Input[str] input_file_bytes: [Output-only] Number of bytes of source data in a load job.
        :param pulumi.Input[str] input_files: [Output-only] Number of source files in a load job.
        :param pulumi.Input[str] output_bytes: [Output-only] Size of the loaded data in bytes. Note that while a load job is in the running state, this value may change.
        :param pulumi.Input[str] output_rows: [Output-only] Number of rows imported in a load job. Note that while an import job is in the running state, this value may change.
        """
    ...
    def bad_records(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @bad_records.setter
    def bad_records(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "bad_records", value)

    @property
    @pulumi.getter(name="inputFileBytes")
    def input_file_bytes(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def input_file_bytes(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "input_file_bytes", value)

    @property
    @pulumi.getter(name="inputFiles")
    def input_files(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @input_files.setter
    def input_files(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "input_files", value)

    @property
    @pulumi.getter(name="outputBytes")
    def output_bytes(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @output_bytes.setter
    def output_bytes(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "output_bytes", value)

    @property
    @pulumi.getter(name="outputRows")
    def output_rows(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @output_rows.setter
    def output_rows(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "output_rows", value)


@pulumi.input_type
class JobStatistics4Args:
    def __init__(__self__, *,
                 destination_uri_file_counts: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 input_bytes: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destination_uri_file_counts: [Output-only] Number of files per destination URI or URI pattern specified in the extract configuration. These values will be in the same order as the URIs specified in the 'destinationUris' field.
        :param pulumi.Input[str] input_bytes: [Output-only] Number of user bytes extracted into the result. This is the byte count as computed by BigQuery for billing purposes.
        """
        if destination_uri_file_counts is not None:
    ...
    def destination_uri_file_counts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def destination_uri_file_counts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "destination_uri_file_counts", value)

    @property
    @pulumi.getter(name="inputBytes")
    def input_bytes(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @input_bytes.setter
    def input_bytes(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "input_bytes", value)
...
class JobStatisticsArgs:
    def __init__(__self__, *,
                 ...
                 extract: Optional[pulumi.Input['JobStatistics4Args']] = None,
                 load: Optional[pulumi.Input['JobStatistics3Args']] = None,
                 num_child_jobs: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] end_time: [Output-only] End time of this job, in milliseconds since the epoch. This field will be present whenever a job is in the DONE state.
        :param pulumi.Input['JobStatistics4Args'] extract: [Output-only] Statistics for an extract job.
        :param pulumi.Input['JobStatistics3Args'] load: [Output-only] Statistics for a load job.
        :param pulumi.Input[str] num_child_jobs: [Output-only] Number of child jobs executed.
    ...
    def completion_ratio(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def completion_ratio(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "completion_ratio", value)
    ...
    @property
    @pulumi.getter
    def extract(self) -> Optional[pulumi.Input['JobStatistics4Args']]:
        """
    ...
    @extract.setter
    def extract(self, value: Optional[pulumi.Input['JobStatistics4Args']]):
        pulumi.set(self, "extract", value)

    @property
    @pulumi.getter
    def load(self) -> Optional[pulumi.Input['JobStatistics3Args']]:
        """
    ...
    @load.setter
    def load(self, value: Optional[pulumi.Input['JobStatistics3Args']]):
        pulumi.set(self, "load", value)

    @property
    @pulumi.getter(name="numChildJobs")
    def num_child_jobs(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def num_child_jobs(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "num_child_jobs", value)

    @property
    @pulumi.getter(name="parentJobId")
    def parent_job_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def parent_job_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "parent_job_id", value)

    @property
    @pulumi.getter
    def query(self) -> Optional[pulumi.Input['JobStatistics2Args']]:
        """
    ...
    @query.setter
    def query(self, value: Optional[pulumi.Input['JobStatistics2Args']]):
        pulumi.set(self, "query", value)

    @property
    @pulumi.getter(name="quotaDeferments")
    def quota_deferments(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def quota_deferments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "quota_deferments", value)
    ...
    def row_level_security_statistics(self) -> Optional[pulumi.Input['RowLevelSecurityStatisticsArgs']]:
        """
    ...
    def row_level_security_statistics(self, value: Optional[pulumi.Input['RowLevelSecurityStatisticsArgs']]):
        pulumi.set(self, "row_level_security_statistics", value)

    @property
    @pulumi.getter(name="scriptStatistics")
    def script_statistics(self) -> Optional[pulumi.Input['ScriptStatisticsArgs']]:
        """
...
class JobStatusArgs:
    def __init__(__self__, *,
                 ...
                 errors: Optional[pulumi.Input[Sequence[pulumi.Input['ErrorProtoArgs']]]] = None,
                 state: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input['ErrorProtoArgs'] error_result: [Output-only] Final error result of the job. If present, indicates that the job has completed and was unsuccessful.
        :param pulumi.Input[Sequence[pulumi.Input['ErrorProtoArgs']]] errors: [Output-only] The first errors encountered during the running of the job. The final message includes the number of errors that caused the process to stop. Errors here do not necessarily mean that the job has completed or was unsuccessful.
        :param pulumi.Input[str] state: [Output-only] Running state of the job.
        """
    ...
    def error_result(self) -> Optional[pulumi.Input['ErrorProtoArgs']]:
        """
    ...
    @error_result.setter
    def error_result(self, value: Optional[pulumi.Input['ErrorProtoArgs']]):
        pulumi.set(self, "error_result", value)

    @property
    @pulumi.getter
    def errors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ErrorProtoArgs']]]]:
        """
    ...
    @errors.setter
    def errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ErrorProtoArgs']]]]):
...
class MaterializedViewDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 last_refresh_time: Optional[pulumi.Input[str]] = None,
                 query: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] last_refresh_time: [Output-only] [TrustedTester] The time when this materialized view was last modified, in milliseconds since the epoch.
    ...
    def last_refresh_time(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def last_refresh_time(self, value: Optional[pulumi.Input[str]]):
...
class QueryParameterValueArgs:
    def __init__(__self__, *,
                 ...
                 struct_values: Optional[pulumi.Input[Mapping[str, str]]] = None,
                 value: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, str]] struct_values: [Optional] The struct field values, in order of the struct type's declaration.
    ...
    def struct_values(self) -> Optional[pulumi.Input[Mapping[str, str]]]:
        """
    ...
    def struct_values(self, value: Optional[pulumi.Input[Mapping[str, str]]]):
...
@pulumi.input_type
class QueryTimelineSampleArgs:
    def __init__(__self__, *,
                 active_units: Optional[pulumi.Input[str]] = None,
                 completed_units: Optional[pulumi.Input[str]] = None,
                 elapsed_ms: Optional[pulumi.Input[str]] = None,
                 pending_units: Optional[pulumi.Input[str]] = None,
                 total_slot_ms: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] active_units: Total number of units currently being processed by workers. This does not correspond directly to slot usage. This is the largest value observed since the last sample.
        :param pulumi.Input[str] completed_units: Total parallel units of work completed by this query.
        :param pulumi.Input[str] elapsed_ms: Milliseconds elapsed since the start of query execution.
        :param pulumi.Input[str] pending_units: Total parallel units of work remaining for the active stages.
        :param pulumi.Input[str] total_slot_ms: Cumulative slot-ms consumed by the query.
        """
    ...
    def active_units(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @active_units.setter
    def active_units(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "active_units", value)

    @property
    @pulumi.getter(name="completedUnits")
    def completed_units(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def completed_units(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "completed_units", value)

    @property
    @pulumi.getter(name="elapsedMs")
    def elapsed_ms(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @elapsed_ms.setter
    def elapsed_ms(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "elapsed_ms", value)

    @property
    @pulumi.getter(name="pendingUnits")
    def pending_units(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def pending_units(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "pending_units", value)
...
@pulumi.input_type
class RowAccessPolicyReferenceArgs:
    def __init__(__self__, *,
                 dataset_id: Optional[pulumi.Input[str]] = None,
...
@pulumi.input_type
class RowLevelSecurityStatisticsArgs:
    def __init__(__self__, *,
                 row_level_security_applied: Optional[pulumi.Input[bool]] = None):
        """
        :param pulumi.Input[bool] row_level_security_applied: [Output-only] [Preview] Whether any accessed data was protected by row access policies.
        """
        if row_level_security_applied is not None:
            pulumi.set(__self__, "row_level_security_applied", row_level_security_applied)

    @property
    @pulumi.getter(name="rowLevelSecurityApplied")
    def row_level_security_applied(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def row_level_security_applied(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "row_level_security_applied", value)


@pulumi.input_type
class ScriptStackFrameArgs:
    def __init__(__self__, *,
                 end_column: Optional[pulumi.Input[int]] = None,
                 end_line: Optional[pulumi.Input[int]] = None,
                 procedure_id: Optional[pulumi.Input[str]] = None,
                 start_column: Optional[pulumi.Input[int]] = None,
                 start_line: Optional[pulumi.Input[int]] = None,
                 text: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[int] end_column: [Output-only] One-based end column.
        :param pulumi.Input[int] end_line: [Output-only] One-based end line.
        :param pulumi.Input[str] procedure_id: [Output-only] Name of the active procedure, empty if in a top-level script.
        :param pulumi.Input[int] start_column: [Output-only] One-based start column.
        :param pulumi.Input[int] start_line: [Output-only] One-based start line.
        :param pulumi.Input[str] text: [Output-only] Text of the current statement/expression.
        """
    ...
    def procedure_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @procedure_id.setter
    def procedure_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "procedure_id", value)
...
@pulumi.input_type
class ScriptStatisticsArgs:
    def __init__(__self__, *,
                 evaluation_kind: Optional[pulumi.Input[str]] = None,
                 stack_frames: Optional[pulumi.Input[Sequence[pulumi.Input['ScriptStackFrameArgs']]]] = None):
        """
        :param pulumi.Input[str] evaluation_kind: [Output-only] Whether this child job was a statement or expression.
        :param pulumi.Input[Sequence[pulumi.Input['ScriptStackFrameArgs']]] stack_frames: Stack trace showing the line/column/procedure name of each frame on the stack at the point where the current evaluation happened. The leaf frame is first, the primary script is last. Never empty.
        """
    ...
    def evaluation_kind(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def evaluation_kind(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "evaluation_kind", value)

    @property
    @pulumi.getter(name="stackFrames")
    def stack_frames(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ScriptStackFrameArgs']]]]:
        """
    ...
    @stack_frames.setter
    def stack_frames(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ScriptStackFrameArgs']]]]):
        pulumi.set(self, "stack_frames", value)
...
class SnapshotDefinitionArgs:
    ...
    def base_table_reference(self, value: Optional[pulumi.Input['TableReferenceArgs']]):
        pulumi.set(self, "base_table_reference", value)
...
@pulumi.input_type
class StreamingbufferArgs:
    def __init__(__self__, *,
                 estimated_bytes: Optional[pulumi.Input[str]] = None,
                 estimated_rows: Optional[pulumi.Input[str]] = None,
                 oldest_entry_time: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] estimated_bytes: [Output-only] A lower-bound estimate of the number of bytes currently in the streaming buffer.
        :param pulumi.Input[str] estimated_rows: [Output-only] A lower-bound estimate of the number of rows currently in the streaming buffer.
        :param pulumi.Input[str] oldest_entry_time: [Output-only] Contains the timestamp of the oldest entry in the streaming buffer, in milliseconds since the epoch, if the streaming buffer is available.
        """
        if estimated_bytes is not None:
            pulumi.set(__self__, "estimated_bytes", estimated_bytes)
        if estimated_rows is not None:
            pulumi.set(__self__, "estimated_rows", estimated_rows)
        if oldest_entry_time is not None:
            pulumi.set(__self__, "oldest_entry_time", oldest_entry_time)

    @property
    @pulumi.getter(name="estimatedBytes")
    def estimated_bytes(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def estimated_bytes(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "estimated_bytes", value)

    @property
    @pulumi.getter(name="estimatedRows")
    def estimated_rows(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def estimated_rows(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "estimated_rows", value)

    @property
    @pulumi.getter(name="oldestEntryTime")
    def oldest_entry_time(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def oldest_entry_time(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "oldest_entry_time", value)
...
@pulumi.input_type
class TransactionInfoArgs:
    def __init__(__self__, *,
                 transaction_id: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] transaction_id: [Output-only] // [Alpha] Id of the transaction.
        """
    ...
    def transaction_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def transaction_id(self, value: Optional[pulumi.Input[str]]):
