...
@pulumi.output_type
class GetRowAccessPolicyIamPolicyResult:
...
class AwaitableGetRowAccessPolicyIamPolicyResult(GetRowAccessPolicyIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRowAccessPolicyIamPolicyResult(
...
def get_row_access_policy_iam_policy(dataset_id: Optional[str] = None,
                                     project: Optional[str] = None,
                                     row_access_policy_id: Optional[str] = None,
                                     table_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRowAccessPolicyIamPolicyResult:
    """
    ...
    __args__['rowAccessPolicyId'] = row_access_policy_id
    __args__['tableId'] = table_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('google-native:bigquery/v2:getRowAccessPolicyIamPolicy', __args__, opts=opts, typ=GetRowAccessPolicyIamPolicyResult).value

    return AwaitableGetRowAccessPolicyIamPolicyResult(
