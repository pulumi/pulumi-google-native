...
class RowAccessPolicyIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RowAccessPolicyIamBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
    ...
    def _internal_init(__self__,
        ...
        super(RowAccessPolicyIamBinding, __self__).__init__(
            'google-native:bigquery/v2:RowAccessPolicyIamBinding',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RowAccessPolicyIamBinding':
        """
