...
def get_connection_iam_policy(connection_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:bigqueryconnection/v1beta1:getConnectionIamPolicy', __args__, opts=opts, typ=GetConnectionIamPolicyResult).value
