...
class DataMaskingPolicyArgs:
    def __init__(__self__, *,
                 predefined_expression: Optional[pulumi.Input['DataMaskingPolicyPredefinedExpression']] = None,
                 routine: Optional[pulumi.Input[str]] = None):
        """
        The data masking policy that is used to specify data masking rule.
        :param pulumi.Input['DataMaskingPolicyPredefinedExpression'] predefined_expression: A predefined masking expression.
        :param pulumi.Input[str] routine: The name of the BigQuery routine that contains the custom masking routine, in the format of `projects/{project_number}/datasets/{dataset_id}/routines/{routine_id}`.
        """
    ...
    def predefined_expression(self) -> Optional[pulumi.Input['DataMaskingPolicyPredefinedExpression']]:
        """
    ...
    def predefined_expression(self, value: Optional[pulumi.Input['DataMaskingPolicyPredefinedExpression']]):
