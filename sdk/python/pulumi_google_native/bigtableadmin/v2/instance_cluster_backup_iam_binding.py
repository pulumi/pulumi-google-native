...
__all__ = ['InstanceClusterBackupIamBindingArgs', 'InstanceClusterBackupIamBinding']

@pulumi.input_type
class InstanceClusterBackupIamBindingArgs:
...
class InstanceClusterBackupIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: InstanceClusterBackupIamBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on a Table or Backup resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param InstanceClusterBackupIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InstanceClusterBackupIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InstanceClusterBackupIamBindingArgs.__new__(InstanceClusterBackupIamBindingArgs)
        ...
        super(InstanceClusterBackupIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InstanceClusterBackupIamBinding':
        """
        ...
        return InstanceClusterBackupIamBinding(resource_name, opts=opts, __props__=__props__)
