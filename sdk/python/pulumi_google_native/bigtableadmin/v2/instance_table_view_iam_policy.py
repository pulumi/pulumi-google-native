...
__all__ = ['InstanceTableViewIamPolicyArgs', 'InstanceTableViewIamPolicy']

@pulumi.input_type
class InstanceTableViewIamPolicyArgs:
...
class InstanceTableViewIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: InstanceTableViewIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on a Table resource. Replaces any existing policy.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param InstanceTableViewIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InstanceTableViewIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InstanceTableViewIamPolicyArgs.__new__(InstanceTableViewIamPolicyArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["instance_id", "project", "table_id", "view_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(InstanceTableViewIamPolicy, __self__).__init__(
            'google-native:bigtableadmin/v2:InstanceTableViewIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InstanceTableViewIamPolicy':
        """
        ...
        return InstanceTableViewIamPolicy(resource_name, opts=opts, __props__=__props__)
