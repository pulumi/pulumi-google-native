...
class GoogleCloudBillingBudgetsV1beta1FilterCalendarPeriod(str, Enum):
    """
...
class GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment(str, Enum):
    """
...
class GoogleCloudBillingBudgetsV1beta1ThresholdRuleSpendBasis(str, Enum):
    """
