...
@pulumi.input_type
class GoogleCloudBillingBudgetsV1beta1AllUpdatesRuleArgs:
...
@pulumi.input_type
class GoogleCloudBillingBudgetsV1beta1BudgetAmountArgs:
    def __init__(__self__, *,
                 last_period_amount: Optional[pulumi.Input['GoogleCloudBillingBudgetsV1beta1LastPeriodAmountArgs']] = None,
    ...
    def last_period_amount(self, value: Optional[pulumi.Input['GoogleCloudBillingBudgetsV1beta1LastPeriodAmountArgs']]):
...
class GoogleCloudBillingBudgetsV1beta1FilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, Any]] labels: Optional. A single label and value pair specifying that usage from only this set of labeled resources should be included in the budget. If omitted, the report will include all labeled and unlabeled usage. An object containing a single `"key": value` pair. Example: `{ "name": "wrench" }`. _Currently, multiple entries or multiple values per entry are not allowed._
