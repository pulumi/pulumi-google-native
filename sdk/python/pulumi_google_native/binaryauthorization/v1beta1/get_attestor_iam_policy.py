...
def get_attestor_iam_policy(attestor_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:binaryauthorization/v1beta1:getAttestorIamPolicy', __args__, opts=opts, typ=GetAttestorIamPolicyResult).value
