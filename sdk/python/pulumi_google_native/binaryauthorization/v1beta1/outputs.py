...
class AttestorPublicKeyResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "attestorPublicKeyId":
            suggest = "attestor_public_key_id"
    ...
    def __init__(__self__, *,
        ...
        :param str attestor_public_key_id: The ID of this public key. Signatures verified by BinAuthz must include the ID of the public key that can be used to verify them, and that ID must match the contents of this field exactly. Additional restrictions on this field can be imposed based on which public key type is encapsulated. See the documentation on `public_key` cases below for details.
    ...
    def attestor_public_key_id(self) -> str:
        """
