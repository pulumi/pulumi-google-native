...
class GetBlockchainNodeResult:
    def __init__(__self__, blockchain_type=None, connection_info=None, create_time=None, ethereum_details=None, labels=None, name=None, state=None, update_time=None):
...
def get_blockchain_node(blockchain_node_id: Optional[str] = None,
    ...
    return AwaitableGetBlockchainNodeResult(
        blockchain_type=__ret__.blockchain_type,
        connection_info=__ret__.connection_info,
        create_time=__ret__.create_time,
        ethereum_details=__ret__.ethereum_details,
