...
class InlineSecretArgs:
    def __init__(__self__, *,
                 env_map: Optional[pulumi.Input[Mapping[str, str]]] = None,
                 kms_key_name: Optional[pulumi.Input[str]] = None):
        """
        Pairs a set of secret environment variables mapped to encrypted values with the Cloud KMS key to use to decrypt the value.
        :param pulumi.Input[Mapping[str, str]] env_map: Map of environment variable name to its encrypted value. Secret environment variables must be unique across all of a build's secrets, and must be used by at least one build step. Values can be at most 64 KB in size. There can be at most 100 secret values across all of a build's secrets.
    ...
    def env_map(self) -> Optional[pulumi.Input[Mapping[str, str]]]:
        """
    ...
    @env_map.setter
    def env_map(self, value: Optional[pulumi.Input[Mapping[str, str]]]):
...
class RepoSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, str]] substitutions: Substitutions to use in a triggered build. Should only be used with RunBuildTrigger
...
class SecretArgs:
    def __init__(__self__, *,
                 kms_key_name: Optional[pulumi.Input[str]] = None,
                 secret_env: Optional[pulumi.Input[Mapping[str, str]]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, str]] secret_env: Map of environment variable name to its encrypted value. Secret environment variables must be unique across all of a build's secrets, and must be used by at least one build step. Values can be at most 64 KB in size. There can be at most 100 secret values across all of a build's secrets.
        """
        if kms_key_name is not None:
            pulumi.set(__self__, "kms_key_name", kms_key_name)
        if secret_env is not None:
    ...
    @property
    @pulumi.getter(name="secretEnv")
    def secret_env(self) -> Optional[pulumi.Input[Mapping[str, str]]]:
        """
        Map of environment variable name to its encrypted value. Secret environment variables must be unique across all of a build's secrets, and must be used by at least one build step. Values can be at most 64 KB in size. There can be at most 100 secret values across all of a build's secrets.
        """
        return pulumi.get(self, "secret_env")
    ...
    @secret_env.setter
    def secret_env(self, value: Optional[pulumi.Input[Mapping[str, str]]]):
        pulumi.set(self, "secret_env", value)
