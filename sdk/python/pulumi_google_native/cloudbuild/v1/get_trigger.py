...
class GetTriggerResult:
    def __init__(__self__, approval_config=None, autodetect=None, bitbucket_server_trigger_config=None, build=None, create_time=None, description=None, disabled=None, event_type=None, filename=None, filter=None, git_file_source=None, github=None, gitlab_enterprise_events_config=None, ignored_files=None, include_build_logs=None, included_files=None, name=None, pubsub_config=None, repository_event_config=None, resource_name=None, service_account=None, source_to_build=None, substitutions=None, tags=None, trigger_template=None, webhook_config=None):
        ...
        if gitlab_enterprise_events_config and not isinstance(gitlab_enterprise_events_config, dict):
            raise TypeError("Expected argument 'gitlab_enterprise_events_config' to be a dict")
    ...
    def gitlab_enterprise_events_config(self) -> 'outputs.GitLabEventsConfigResponse':
        """
...
class AwaitableGetTriggerResult(GetTriggerResult):
    ...
    def __await__(self):
        ...
        return GetTriggerResult(
            ...
            github=self.github,
            gitlab_enterprise_events_config=self.gitlab_enterprise_events_config,
...
def get_trigger(location: Optional[str] = None,
    ...
    return AwaitableGetTriggerResult(
        approval_config=pulumi.get(__ret__, 'approval_config'),
        autodetect=pulumi.get(__ret__, 'autodetect'),
        bitbucket_server_trigger_config=pulumi.get(__ret__, 'bitbucket_server_trigger_config'),
        ...
        git_file_source=pulumi.get(__ret__, 'git_file_source'),
        github=pulumi.get(__ret__, 'github'),
        gitlab_enterprise_events_config=pulumi.get(__ret__, 'gitlab_enterprise_events_config'),
        ...
        pubsub_config=pulumi.get(__ret__, 'pubsub_config'),
        repository_event_config=pulumi.get(__ret__, 'repository_event_config'),
        resource_name=pulumi.get(__ret__, 'resource_name'),
        service_account=pulumi.get(__ret__, 'service_account'),
        source_to_build=pulumi.get(__ret__, 'source_to_build'),
        substitutions=pulumi.get(__ret__, 'substitutions'),
        tags=pulumi.get(__ret__, 'tags'),
        trigger_template=pulumi.get(__ret__, 'trigger_template'),
