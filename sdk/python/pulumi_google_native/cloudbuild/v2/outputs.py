...
__all__ = [
    ...
    'BindingResponse',
    'BitbucketCloudConfigResponse',
    'BitbucketDataCenterConfigResponse',
    'ExprResponse',
...
@pulumi.output_type
class BitbucketCloudConfigResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BitbucketCloudConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BitbucketCloudConfigResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for connections to Bitbucket Cloud.
        :param 'UserCredentialResponse' authorizer_credential: An access token with the `webhook`, `repository`, `repository:admin` and `pullrequest` scope access. It can be either a workspace, project or repository access token. It's recommended to use a system account to generate these credentials.
        :param 'UserCredentialResponse' read_authorizer_credential: An access token with the `repository` access. It can be either a workspace, project or repository access token. It's recommended to use a system account to generate the credentials.
        :param str webhook_secret_secret_version: SecretManager resource containing the webhook secret used to verify webhook events, formatted as `projects/*/secrets/*/versions/*`.
...
@pulumi.output_type
class BitbucketDataCenterConfigResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BitbucketDataCenterConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BitbucketDataCenterConfigResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for connections to Bitbucket Data Center.
        :param 'UserCredentialResponse' authorizer_credential: A http access token with the `REPO_ADMIN` scope access.
        :param str host_uri: The URI of the Bitbucket Data Center instance or cluster this connection is for.
        :param 'UserCredentialResponse' read_authorizer_credential: A http access token with the `REPO_READ` access.
        :param str server_version: Version of the Bitbucket Data Center running on the `host_uri`.
        ...
        :param str ssl_ca: Optional. SSL certificate to use for requests to the Bitbucket Data Center.
        :param str webhook_secret_secret_version: Immutable. SecretManager resource containing the webhook secret used to verify webhook events, formatted as `projects/*/secrets/*/versions/*`.
        """
        pulumi.set(__self__, "authorizer_credential", authorizer_credential)
