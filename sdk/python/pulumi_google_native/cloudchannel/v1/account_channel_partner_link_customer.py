...
__all__ = ['AccountChannelPartnerLinkCustomerArgs', 'AccountChannelPartnerLinkCustomer']

@pulumi.input_type
class AccountChannelPartnerLinkCustomerArgs:
...
class AccountChannelPartnerLinkCustomer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AccountChannelPartnerLinkCustomerArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a new Customer resource under the reseller or distributor account. Possible error codes: * PERMISSION_DENIED: The reseller account making the request is different from the reseller account in the API request. * INVALID_ARGUMENT: * Required request parameters are missing or invalid. * Domain field value doesn't match the primary email domain. Return value: The newly created Customer resource.

        :param str resource_name: The name of the resource.
        :param AccountChannelPartnerLinkCustomerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AccountChannelPartnerLinkCustomerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AccountChannelPartnerLinkCustomerArgs.__new__(AccountChannelPartnerLinkCustomerArgs)
        ...
        super(AccountChannelPartnerLinkCustomer, __self__).__init__(
            'google-native:cloudchannel/v1:AccountChannelPartnerLinkCustomer',
            resource_name,
            __props__,
            opts)
