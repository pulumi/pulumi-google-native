...
class ChannelPartnerRepricingConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 repricing_config: Optional[pulumi.Input[Union['GoogleCloudChannelV1RepricingConfigArgs', 'GoogleCloudChannelV1RepricingConfigArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['GoogleCloudChannelV1RepricingConfigArgs', 'GoogleCloudChannelV1RepricingConfigArgsDict']] repricing_config: The configuration for bill modifications made by a reseller before sending it to ChannelPartner.
        """
        ...
    @overload
    def __init__(__self__,
