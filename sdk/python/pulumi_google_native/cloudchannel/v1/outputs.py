...
class GoogleCloudChannelV1RenewalSettingsResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "scheduledRenewalOffer":
            suggest = "scheduled_renewal_offer"
    ...
    def __init__(__self__, *,
        ...
        :param str scheduled_renewal_offer: The renewal offer resource name for which the entitlement is to be renewed. Takes the form: accounts/{account_id}/offers/{offer_id}.
        """
        ...
        pulumi.set(__self__, "scheduled_renewal_offer", scheduled_renewal_offer)
    ...
    @property
    @pulumi.getter(name="scheduledRenewalOffer")
    def scheduled_renewal_offer(self) -> str:
        """
        ...
        """
        return pulumi.get(self, "scheduled_renewal_offer")
