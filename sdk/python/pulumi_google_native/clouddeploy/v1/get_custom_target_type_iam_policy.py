...
def get_custom_target_type_iam_policy(custom_target_type_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:clouddeploy/v1:getCustomTargetTypeIamPolicy', __args__, opts=opts, typ=GetCustomTargetTypeIamPolicyResult).value
...
def get_custom_target_type_iam_policy_output(custom_target_type_id: Optional[pulumi.Input[str]] = None,
