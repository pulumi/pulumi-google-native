...
def get_target_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:clouddeploy/v1:getTargetIamPolicy', __args__, opts=opts, typ=GetTargetIamPolicyResult).value
...
def get_target_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
