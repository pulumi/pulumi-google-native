...
def get_function_iam_policy(function_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudfunctions/v2alpha:getFunctionIamPolicy', __args__, opts=opts, typ=GetFunctionIamPolicyResult).value
...
def get_function_iam_policy_output(function_id: Optional[pulumi.Input[str]] = None,
