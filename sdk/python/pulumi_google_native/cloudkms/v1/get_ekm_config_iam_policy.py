...
__all__ = [
    ...
    'AwaitableGetEkmConfigIamPolicyResult',
    'get_ekm_config_iam_policy',
    'get_ekm_config_iam_policy_output',
]
...
class AwaitableGetEkmConfigIamPolicyResult(GetEkmConfigIamPolicyResult):
...
def get_ekm_config_iam_policy(location: Optional[str] = None,
                              options_requested_policy_version: Optional[int] = None,
                              project: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEkmConfigIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudkms/v1:getEkmConfigIamPolicy', __args__, opts=opts, typ=GetEkmConfigIamPolicyResult).value

    return AwaitableGetEkmConfigIamPolicyResult(
...
@_utilities.lift_output_func(get_ekm_config_iam_policy)
def get_ekm_config_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                     options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                     project: Optional[pulumi.Input[Optional[str]]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetEkmConfigIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
