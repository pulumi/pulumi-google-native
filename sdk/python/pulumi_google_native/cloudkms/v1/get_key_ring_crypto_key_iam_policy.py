...
__all__ = [
    ...
    'AwaitableGetKeyRingCryptoKeyIamPolicyResult',
    'get_key_ring_crypto_key_iam_policy',
    'get_key_ring_crypto_key_iam_policy_output',
]

@pulumi.output_type
class GetKeyRingCryptoKeyIamPolicyResult:
...
class AwaitableGetKeyRingCryptoKeyIamPolicyResult(GetKeyRingCryptoKeyIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKeyRingCryptoKeyIamPolicyResult(
...
def get_key_ring_crypto_key_iam_policy(crypto_key_id: Optional[str] = None,
                                       key_ring_id: Optional[str] = None,
                                       location: Optional[str] = None,
                                       options_requested_policy_version: Optional[int] = None,
                                       project: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKeyRingCryptoKeyIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudkms/v1:getKeyRingCryptoKeyIamPolicy', __args__, opts=opts, typ=GetKeyRingCryptoKeyIamPolicyResult).value

    return AwaitableGetKeyRingCryptoKeyIamPolicyResult(
...
@_utilities.lift_output_func(get_key_ring_crypto_key_iam_policy)
def get_key_ring_crypto_key_iam_policy_output(crypto_key_id: Optional[pulumi.Input[str]] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetKeyRingCryptoKeyIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
