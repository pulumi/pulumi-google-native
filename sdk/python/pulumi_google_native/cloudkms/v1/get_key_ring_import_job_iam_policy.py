...
__all__ = [
    ...
    'AwaitableGetKeyRingImportJobIamPolicyResult',
    'get_key_ring_import_job_iam_policy',
    'get_key_ring_import_job_iam_policy_output',
]
...
class AwaitableGetKeyRingImportJobIamPolicyResult(GetKeyRingImportJobIamPolicyResult):
...
def get_key_ring_import_job_iam_policy(import_job_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudkms/v1:getKeyRingImportJobIamPolicy', __args__, opts=opts, typ=GetKeyRingImportJobIamPolicyResult).value

    return AwaitableGetKeyRingImportJobIamPolicyResult(
...
@_utilities.lift_output_func(get_key_ring_import_job_iam_policy)
