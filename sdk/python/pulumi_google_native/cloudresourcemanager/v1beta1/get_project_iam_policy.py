...
def get_project_iam_policy(resource: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudresourcemanager/v1beta1:getProjectIamPolicy', __args__, opts=opts, typ=GetProjectIamPolicyResult).value
