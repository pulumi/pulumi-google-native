...
__all__ = ['FolderIamMemberArgs', 'FolderIamMember']
...
class FolderIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FolderIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FolderIamMemberArgs.__new__(FolderIamMemberArgs)
        ...
        super(FolderIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FolderIamMember':
        """
        ...
        return FolderIamMember(resource_name, opts=opts, __props__=__props__)
