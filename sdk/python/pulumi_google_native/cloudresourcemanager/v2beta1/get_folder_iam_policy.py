...
class AwaitableGetFolderIamPolicyResult(GetFolderIamPolicyResult):
...
def get_folder_iam_policy(folder_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFolderIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudresourcemanager/v2beta1:getFolderIamPolicy', __args__, opts=opts, typ=GetFolderIamPolicyResult).value

    return AwaitableGetFolderIamPolicyResult(
