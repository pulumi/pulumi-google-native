...
def get_organization_iam_policy(organization_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudresourcemanager/v3:getOrganizationIamPolicy', __args__, opts=opts, typ=GetOrganizationIamPolicyResult).value
