...
@pulumi.output_type
class GetProjectIamPolicyResult:
...
class AwaitableGetProjectIamPolicyResult(GetProjectIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetProjectIamPolicyResult(
...
def get_project_iam_policy(project: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudresourcemanager/v3:getProjectIamPolicy', __args__, opts=opts, typ=GetProjectIamPolicyResult).value

    return AwaitableGetProjectIamPolicyResult(
