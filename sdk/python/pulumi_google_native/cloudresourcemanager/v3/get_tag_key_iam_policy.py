...
def get_tag_key_iam_policy(tag_key_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:cloudresourcemanager/v3:getTagKeyIamPolicy', __args__, opts=opts, typ=GetTagKeyIamPolicyResult).value
