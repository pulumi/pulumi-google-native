...
class TagKeyArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "tag_key_id", tag_key_id)
    ...
    @property
    @pulumi.getter(name="tagKeyId")
    def tag_key_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "tag_key_id")

    @tag_key_id.setter
    def tag_key_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "tag_key_id", value)
...
class TagKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 parent: Optional[pulumi.Input[str]] = None,
                 short_name: Optional[pulumi.Input[str]] = None,
                 tag_key_id: Optional[pulumi.Input[str]] = None,
                 validate_only: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if tag_key_id is None and not opts.urn:
                raise TypeError("Missing required property 'tag_key_id'")
            __props__.__dict__["tag_key_id"] = tag_key_id
