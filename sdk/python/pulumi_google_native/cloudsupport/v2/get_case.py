...
@pulumi.output_type
class GetCaseResult:
    def __init__(__self__, classification=None, contact_email=None, create_time=None, creator=None, description=None, display_name=None, escalated=None, language_code=None, name=None, priority=None, state=None, subscriber_email_addresses=None, test_case=None, time_zone=None, update_time=None):
...
def get_case(case_id: Optional[str] = None,
    ...
    __args__['v2Id'] = v2_id
    __args__['v2Id1'] = v2_id1
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('google-native:cloudsupport/v2:getCase', __args__, opts=opts, typ=GetCaseResult).value
