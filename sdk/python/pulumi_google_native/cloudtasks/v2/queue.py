...
class QueueArgs:
    def __init__(__self__, *,
                 ...
                 state: Optional[pulumi.Input['QueueState']] = None):
        """
        ...
        :param pulumi.Input['QueueState'] state: The state of the queue. `state` can only be changed by calling PauseQueue, ResumeQueue, or uploading [queue.yaml/xml](https://cloud.google.com/appengine/docs/python/config/queueref). UpdateQueue cannot be used to change `state`.
        """
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input['QueueState']]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input['QueueState']]):
