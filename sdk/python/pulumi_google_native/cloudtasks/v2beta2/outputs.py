...
class HeaderOverrideResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Wraps the Header object.
        :param 'HeaderResponse' header: Header embodying a key and a value. Do not put business sensitive or personally identifying data in the HTTP Header Override Configuration or other similar fields in accordance with Section 12 (Resource Fields) of the [Service Specific Terms](https://cloud.google.com/terms/service-terms).
        """
