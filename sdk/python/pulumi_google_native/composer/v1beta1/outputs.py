...
class DataRetentionConfigResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "airflowDatabaseRetentionDays":
            suggest = "airflow_database_retention_days"
        elif key == "airflowMetadataRetentionConfig":
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration setting for Airflow database data retention mechanism.
        :param int airflow_database_retention_days: Optional. The number of days describing for how long to store event-based records in airflow database. If the retention mechanism is enabled this value must be a positive integer otherwise, value should be set to 0.
    ...
    def airflow_database_retention_days(self) -> int:
        """
