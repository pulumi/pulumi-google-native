...
__all__ = [
    ...
    'ResourceStatusUpcomingMaintenanceArgs',
    'RolloutPolicyArgs',
...
class BackendArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] max_connections: Defines a target maximum number of simultaneous connections. For usage guidelines, see Connection balancing mode and Utilization balancing mode. Not available if the backend's balancingMode is RATE. Not supported by: - Internal TCP/UDP Load Balancing - Network Load Balancing
        :param pulumi.Input[int] max_connections_per_endpoint: Defines a target maximum number of simultaneous connections. For usage guidelines, see Connection balancing mode and Utilization balancing mode. Not available if the backend's balancingMode is RATE. Not supported by: - Internal TCP/UDP Load Balancing - Network Load Balancing.
        :param pulumi.Input[int] max_connections_per_instance: Defines a target maximum number of simultaneous connections. For usage guidelines, see Connection balancing mode and Utilization balancing mode. Not available if the backend's balancingMode is RATE. Not supported by: - Internal TCP/UDP Load Balancing - Network Load Balancing.
...
class FutureReservationStatusArgs:
    def __init__(__self__, *,
                 auto_created_reservations: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 fulfilled_count: Optional[pulumi.Input[str]] = None,
                 lock_time: Optional[pulumi.Input[str]] = None,
                 procurement_status: Optional[pulumi.Input['FutureReservationStatusProcurementStatus']] = None):
        """
        [Output only] Represents status related to the future reservation.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] auto_created_reservations: Fully qualified urls of the automatically created reservations at start_time.
        :param pulumi.Input[str] fulfilled_count: This count indicates the fulfilled capacity so far. This is set during "PROVISIONING" state. This count also includes capacity delivered as part of existing matching reservations.
        :param pulumi.Input[str] lock_time: Time when Future Reservation would become LOCKED, after which no modifications to Future Reservation will be allowed. Applicable only after the Future Reservation is in the APPROVED state. The lock_time is an RFC3339 string. The procurement_status will transition to PROCURING state at this time.
        :param pulumi.Input['FutureReservationStatusProcurementStatus'] procurement_status: Current state of this Future Reservation
        """
    ...
    def auto_created_reservations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def auto_created_reservations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "auto_created_reservations", value)

    @property
    @pulumi.getter(name="fulfilledCount")
    def fulfilled_count(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def fulfilled_count(self, value: Optional[pulumi.Input[str]]):
    ...
    def procurement_status(self) -> Optional[pulumi.Input['FutureReservationStatusProcurementStatus']]:
        """
    ...
    def procurement_status(self, value: Optional[pulumi.Input['FutureReservationStatusProcurementStatus']]):
...
class InstanceGroupManagerActionsSummaryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] creating: [Output Only] The number of instances in the managed instance group that are scheduled to be created or are currently being created. If the group fails to create any of these instances, it tries again until it creates the instance successfully. If you have disabled creation retries, this field will not be populated; instead, the creatingWithoutRetries field will be populated.
...
class InterconnectOutageNotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InterconnectOutageNotificationIssueType'] issue_type: Form this outage is expected to take, which can take one of the following values: - OUTAGE: The Interconnect may be completely out of service for some or all of the specified window. - PARTIAL_OUTAGE: Some circuits comprising the Interconnect as a whole should remain up, but with reduced bandwidth. Note that the versions of this enum prefixed with "IT_" have been deprecated in favor of the unprefixed values.
        :param pulumi.Input[str] name: Unique identifier for this outage notification.
        :param pulumi.Input['InterconnectOutageNotificationSource'] source: The party that generated this notification, which can take the following value: - GOOGLE: this notification as generated by Google. Note that the value of NSRC_GOOGLE has been deprecated in favor of GOOGLE.
        :param pulumi.Input[str] start_time: Scheduled start time for the outage (milliseconds since Unix epoch).
        :param pulumi.Input['InterconnectOutageNotificationState'] state: State of this notification, which can take one of the following values: - ACTIVE: This outage notification is active. The event could be in the past, present, or future. See start_time and end_time for scheduling. - CANCELLED: The outage associated with this notification was cancelled before the outage was due to start. - COMPLETED: The outage associated with this notification is complete. Note that the versions of this enum prefixed with "NS_" have been deprecated in favor of the unprefixed values.
        """
...
class NetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['NetworkInterfaceIpv6AccessType'] ipv6_access_type: [Output Only] One of EXTERNAL, INTERNAL to indicate whether the IP can be accessed from the Internet. This field is always inherited from its subnetwork. Valid only if stackType is IPV4_IPV6.
...
class ResourceStatusArgs:
    def __init__(__self__, *,
                 ...
                 upcoming_maintenance: Optional[pulumi.Input['ResourceStatusUpcomingMaintenanceArgs']] = None):
        """
    ...
    def upcoming_maintenance(self) -> Optional[pulumi.Input['ResourceStatusUpcomingMaintenanceArgs']]:
        return pulumi.get(self, "upcoming_maintenance")

    @upcoming_maintenance.setter
    def upcoming_maintenance(self, value: Optional[pulumi.Input['ResourceStatusUpcomingMaintenanceArgs']]):
...
@pulumi.input_type
class ResourceStatusUpcomingMaintenanceArgs:
    def __init__(__self__, *,
                 can_reschedule: Optional[pulumi.Input[bool]] = None):
        """
        :param pulumi.Input[bool] can_reschedule: Indicates if the maintenance can be customer triggered. See go/sf-ctm-design for more details
        """
...
class RouteWarningsItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouteWarningsItemDataItemArgs']]] data: [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" } 
...
class RouterBgpPeerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RouterBgpPeerManagementType'] management_type: [Output Only] The resource that configures and manages this BGP peer. - MANAGED_BY_USER is the default value and can be managed by you or other users - MANAGED_BY_ATTACHMENT is a BGP peer that is configured and managed by Cloud Interconnect, specifically by an InterconnectAttachment of type PARTNER. Google automatically creates, updates, and deletes this type of BGP peer when the PARTNER InterconnectAttachment is created, updated, or deleted. 
...
class RouterInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RouterInterfaceManagementType'] management_type: [Output Only] The resource that configures and manages this interface. - MANAGED_BY_USER is the default value and can be managed directly by users. - MANAGED_BY_ATTACHMENT is an interface that is configured and managed by Cloud Interconnect, specifically, by an InterconnectAttachment of type PARTNER. Google automatically creates, updates, and deletes this type of interface when the PARTNER InterconnectAttachment is created, updated, or deleted. 
...
class SslPolicyWarningsItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SslPolicyWarningsItemDataItemArgs']]] data: [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" } 
        :param pulumi.Input[str] message: [Output Only] A human-readable description of the warning code.
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
...
class VpnGatewayVpnGatewayInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] id: [Output Only] Numeric identifier for this VPN interface associated with the VPN gateway.
