...
class BackendBucketIamMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(BackendBucketIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BackendBucketIamMember':
        """
        ...
        return BackendBucketIamMember(resource_name, opts=opts, __props__=__props__)
