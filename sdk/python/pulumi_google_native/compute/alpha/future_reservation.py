...
class FutureReservationArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input['FutureReservationStatusArgs']] = None,
        ...
        :param pulumi.Input[str] zone: [Output Only] URL of the Zone where this future reservation resides.
        :param pulumi.Input[str] creation_timestamp: [Output Only] The creation timestamp for this future reservation in RFC3339 text format.
        ...
        :param pulumi.Input[str] id: [Output Only] A unique identifier for this future reservation. The server defines this identifier.
        ...
        :param pulumi.Input['FutureReservationStatusArgs'] status: [Output only] Status of the Future Reservation
    ...
    @property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input['FutureReservationStatusArgs']]:
        """
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input['FutureReservationStatusArgs']]):
...
class FutureReservation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 status: Optional[pulumi.Input[pulumi.InputType['FutureReservationStatusArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['FutureReservationStatusArgs']] status: [Output only] Status of the Future Reservation
