...
class GetAutoscalerResult:
    def __init__(__self__, autoscaling_policy=None, creation_timestamp=None, description=None, id=None, kind=None, name=None, recommended_size=None, region=None, scaling_schedule_status=None, self_link=None, self_link_with_id=None, status=None, status_details=None, target=None, zone=None):
...
def get_autoscaler(autoscaler: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getAutoscaler', __args__, opts=opts, typ=GetAutoscalerResult).value
