...
def get_backend_service_iam_policy(options_requested_policy_version: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getBackendServiceIamPolicy', __args__, opts=opts, typ=GetBackendServiceIamPolicyResult).value
...
def get_backend_service_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
