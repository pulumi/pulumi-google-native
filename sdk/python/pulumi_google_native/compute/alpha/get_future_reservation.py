...
def get_future_reservation(future_reservation: Optional[str] = None,
    ...
    return AwaitableGetFutureReservationResult(
        auto_created_reservations_delete_time=__ret__.auto_created_reservations_delete_time,
        auto_created_reservations_duration=__ret__.auto_created_reservations_duration,
        auto_delete_auto_created_reservations=__ret__.auto_delete_auto_created_reservations,
