...
def get_global_network_endpoint_group(network_endpoint_group: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getGlobalNetworkEndpointGroup', __args__, opts=opts, typ=GetGlobalNetworkEndpointGroupResult).value
