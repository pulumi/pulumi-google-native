...
class GetInstanceGroupResult:
    def __init__(__self__, creation_timestamp=None, description=None, fingerprint=None, id=None, kind=None, name=None, named_ports=None, network=None, region=None, self_link=None, self_link_with_id=None, size=None, subnetwork=None, zone=None):
