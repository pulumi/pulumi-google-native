...
def get_instance_iam_policy(options_requested_policy_version: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getInstanceIamPolicy', __args__, opts=opts, typ=GetInstanceIamPolicyResult).value
...
def get_instance_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
