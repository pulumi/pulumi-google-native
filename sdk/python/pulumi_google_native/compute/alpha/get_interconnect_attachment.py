...
def get_interconnect_attachment(interconnect_attachment: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getInterconnectAttachment', __args__, opts=opts, typ=GetInterconnectAttachmentResult).value
