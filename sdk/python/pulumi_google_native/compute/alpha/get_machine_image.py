...
class GetMachineImageResult:
    def __init__(__self__, creation_timestamp=None, description=None, guest_flush=None, id=None, instance_properties=None, kind=None, machine_image_encryption_key=None, name=None, satisfies_pzs=None, saved_disks=None, self_link=None, self_link_with_id=None, source_disk_encryption_keys=None, source_instance=None, source_instance_properties=None, status=None, storage_locations=None, total_storage_bytes=None):
