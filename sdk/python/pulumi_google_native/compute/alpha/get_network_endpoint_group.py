...
class GetNetworkEndpointGroupResult:
    def __init__(__self__, annotations=None, app_engine=None, cloud_function=None, cloud_run=None, creation_timestamp=None, default_port=None, description=None, id=None, kind=None, load_balancer=None, name=None, network=None, network_endpoint_type=None, psc_target_service=None, region=None, self_link=None, self_link_with_id=None, serverless_deployment=None, size=None, subnetwork=None, type=None, zone=None):
