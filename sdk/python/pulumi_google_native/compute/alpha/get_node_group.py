...
class GetNodeGroupResult:
    def __init__(__self__, autoscaling_policy=None, creation_timestamp=None, description=None, fingerprint=None, id=None, kind=None, location_hint=None, maintenance_policy=None, maintenance_window=None, name=None, node_template=None, self_link=None, self_link_with_id=None, share_settings=None, size=None, status=None, zone=None):
