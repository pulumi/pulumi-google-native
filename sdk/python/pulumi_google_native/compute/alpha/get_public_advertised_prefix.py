...
class GetPublicAdvertisedPrefixResult:
    def __init__(__self__, creation_timestamp=None, description=None, dns_verification_ip=None, fingerprint=None, id=None, ip_cidr_range=None, kind=None, name=None, pdp_scope=None, public_delegated_prefixs=None, self_link=None, self_link_with_id=None, shared_secret=None, status=None):
