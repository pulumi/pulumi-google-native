...
class GetPublicDelegatedPrefixResult:
    def __init__(__self__, creation_timestamp=None, description=None, fingerprint=None, id=None, ip_cidr_range=None, is_live_migration=None, kind=None, name=None, parent_prefix=None, public_delegated_sub_prefixs=None, region=None, self_link=None, self_link_with_id=None, status=None):
...
def get_public_delegated_prefix(project: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getPublicDelegatedPrefix', __args__, opts=opts, typ=GetPublicDelegatedPrefixResult).value
