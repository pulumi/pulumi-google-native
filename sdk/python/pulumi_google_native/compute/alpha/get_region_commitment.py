...
class GetRegionCommitmentResult:
    def __init__(__self__, category=None, creation_timestamp=None, description=None, end_timestamp=None, kind=None, license_resource=None, name=None, plan=None, region=None, reservations=None, resources=None, self_link=None, self_link_with_id=None, start_timestamp=None, status=None, status_message=None, type=None):
