...
def get_region_health_check(health_check: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getRegionHealthCheck', __args__, opts=opts, typ=GetRegionHealthCheckResult).value
    ...
    return AwaitableGetRegionHealthCheckResult(
        ...
        udp_health_check=pulumi.get(__ret__, 'udp_health_check'),
