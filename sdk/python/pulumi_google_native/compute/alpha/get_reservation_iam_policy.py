...
__all__ = [
    ...
    'get_reservation_iam_policy_output',
]
...
def get_reservation_iam_policy(options_requested_policy_version: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getReservationIamPolicy', __args__, opts=opts, typ=GetReservationIamPolicyResult).value
...
def get_reservation_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetReservationIamPolicyResult]:
    """
    Gets the access control policy for a resource. May be empty if no such policy or resource exists.
    """
    ...
