...
class GetRouterResult:
    def __init__(__self__, bgp=None, bgp_peers=None, creation_timestamp=None, description=None, encrypted_interconnect_router=None, id=None, interfaces=None, kind=None, md5_authentication_keys=None, name=None, nats=None, network=None, region=None, self_link=None, self_link_with_id=None):
