...
__all__ = [
    'GetServiceAttachmentIamPolicyResult',
    'AwaitableGetServiceAttachmentIamPolicyResult',
    'get_service_attachment_iam_policy',
    'get_service_attachment_iam_policy_output',
]

@pulumi.output_type
class GetServiceAttachmentIamPolicyResult:
...
class AwaitableGetServiceAttachmentIamPolicyResult(GetServiceAttachmentIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceAttachmentIamPolicyResult(
...
def get_service_attachment_iam_policy(options_requested_policy_version: Optional[int] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceAttachmentIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getServiceAttachmentIamPolicy', __args__, opts=opts, typ=GetServiceAttachmentIamPolicyResult).value

    return AwaitableGetServiceAttachmentIamPolicyResult(
...
def get_service_attachment_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceAttachmentIamPolicyResult]:
    """
    Gets the access control policy for a resource. May be empty if no such policy or resource exists.
    """
    ...
