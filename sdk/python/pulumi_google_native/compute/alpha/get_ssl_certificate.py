...
class GetSslCertificateResult:
    def __init__(__self__, certificate=None, creation_timestamp=None, description=None, expire_time=None, id=None, kind=None, managed=None, name=None, private_key=None, region=None, self_link=None, self_link_with_id=None, self_managed=None, subject_alternative_names=None, type=None):
