...
class GetSslPolicyResult:
    def __init__(__self__, creation_timestamp=None, custom_features=None, description=None, enabled_features=None, fingerprint=None, kind=None, min_tls_version=None, name=None, profile=None, self_link=None, self_link_with_id=None, tls_settings=None, warnings=None):
