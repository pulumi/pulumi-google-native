...
class GetStoragePoolResult:
    def __init__(__self__, creation_timestamp=None, description=None, kind=None, label_fingerprint=None, labels=None, name=None, provisioned_iops=None, provisioned_throughput=None, resource_status=None, self_link=None, self_link_with_id=None, size_gb=None, state=None, status=None, storage_pool_type=None, type=None, zone=None):
...
def get_storage_pool(project: Optional[str] = None,
    ...
    return AwaitableGetStoragePoolResult(
        ...
        storage_pool_type=__ret__.storage_pool_type,
        type=__ret__.type,
        zone=__ret__.zone)
