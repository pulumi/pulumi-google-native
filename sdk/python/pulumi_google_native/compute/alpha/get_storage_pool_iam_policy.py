...
def get_storage_pool_iam_policy(options_requested_policy_version: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getStoragePoolIamPolicy', __args__, opts=opts, typ=GetStoragePoolIamPolicyResult).value
...
@_utilities.lift_output_func(get_storage_pool_iam_policy)
def get_storage_pool_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                       project: Optional[pulumi.Input[Optional[str]]] = None,
                                       resource: Optional[pulumi.Input[str]] = None,
                                       zone: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetStoragePoolIamPolicyResult]:
    """
    Gets the access control policy for a resource. May be empty if no such policy or resource exists.
    """
    ...
