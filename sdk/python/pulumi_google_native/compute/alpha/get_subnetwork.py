...
class GetSubnetworkResult:
    def __init__(__self__, aggregation_interval=None, allow_subnet_cidr_routes_overlap=None, creation_timestamp=None, description=None, enable_flow_logs=None, enable_l2=None, enable_private_v6_access=None, external_ipv6_prefix=None, fingerprint=None, flow_sampling=None, gateway_address=None, id=None, internal_ipv6_prefix=None, ip_cidr_range=None, ipv6_access_type=None, ipv6_cidr_range=None, kind=None, log_config=None, metadata=None, name=None, network=None, private_ip_google_access=None, private_ipv6_google_access=None, purpose=None, region=None, reserved_internal_range=None, role=None, secondary_ip_ranges=None, self_link=None, self_link_with_id=None, stack_type=None, state=None, vlans=None):
        ...
        if flow_sampling and not isinstance(flow_sampling, float):
            raise TypeError("Expected argument 'flow_sampling' to be a float")
