...
def get_subnetwork_iam_policy(options_requested_policy_version: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getSubnetworkIamPolicy', __args__, opts=opts, typ=GetSubnetworkIamPolicyResult).value
...
def get_subnetwork_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
