...
def get_url_map(project: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getUrlMap', __args__, opts=opts, typ=GetUrlMapResult).value
