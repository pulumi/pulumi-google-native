...
class GetVpnGatewayResult:
    def __init__(__self__, creation_timestamp=None, description=None, id=None, kind=None, label_fingerprint=None, labels=None, name=None, network=None, region=None, self_link=None, stack_type=None, vpn_interfaces=None):
