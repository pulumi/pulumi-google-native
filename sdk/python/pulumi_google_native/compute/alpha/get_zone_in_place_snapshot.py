...
__all__ = [
    'GetZoneInPlaceSnapshotResult',
    'AwaitableGetZoneInPlaceSnapshotResult',
    'get_zone_in_place_snapshot',
    'get_zone_in_place_snapshot_output',
]

@pulumi.output_type
class GetZoneInPlaceSnapshotResult:
...
class AwaitableGetZoneInPlaceSnapshotResult(GetZoneInPlaceSnapshotResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZoneInPlaceSnapshotResult(
...
def get_zone_in_place_snapshot(in_place_snapshot: Optional[str] = None,
                               project: Optional[str] = None,
                               zone: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZoneInPlaceSnapshotResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/alpha:getZoneInPlaceSnapshot', __args__, opts=opts, typ=GetZoneInPlaceSnapshotResult).value

    return AwaitableGetZoneInPlaceSnapshotResult(
...
@_utilities.lift_output_func(get_zone_in_place_snapshot)
def get_zone_in_place_snapshot_output(in_place_snapshot: Optional[pulumi.Input[str]] = None,
                                      project: Optional[pulumi.Input[Optional[str]]] = None,
                                      zone: Optional[pulumi.Input[str]] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZoneInPlaceSnapshotResult]:
    """
    Returns the specified InPlaceSnapshot resource in the specified zone.
    """
    ...
