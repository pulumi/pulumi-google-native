...
class GlobalAddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GlobalAddressIpv6EndpointType'] ipv6_endpoint_type: The endpoint type of this address, which should be VM. This is used for deciding which endpoint this address will be assigned to during the IPv6 external IP address reservation.
