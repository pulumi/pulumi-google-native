...
class NetworkEdgeSecurityServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] region: [Output Only] URL of the region where the resource resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.
