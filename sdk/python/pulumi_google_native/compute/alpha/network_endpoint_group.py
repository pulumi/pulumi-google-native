...
class NetworkEndpointGroupArgs:
    def __init__(__self__, *,
                 ...
                 client_port_mapping_mode: Optional[pulumi.Input['NetworkEndpointGroupClientPortMappingMode']] = None,
        ...
        :param pulumi.Input['NetworkEndpointGroupClientPortMappingMode'] client_port_mapping_mode: Only valid when networkEndpointType is "GCE_VM_IP_PORT" and the NEG is regional.
    ...
    def client_port_mapping_mode(self) -> Optional[pulumi.Input['NetworkEndpointGroupClientPortMappingMode']]:
        """
    ...
    def client_port_mapping_mode(self, value: Optional[pulumi.Input['NetworkEndpointGroupClientPortMappingMode']]):
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input['NetworkEndpointGroupType']]:
        """
