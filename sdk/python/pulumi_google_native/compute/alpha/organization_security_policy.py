...
class OrganizationSecurityPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["organization_security_policy_id"] = None
    ...
    @property
    @pulumi.getter(name="organizationSecurityPolicyId")
    def organization_security_policy_id(self) -> pulumi.Output[str]:
        """
        The unique identifier for the resource. This identifier is defined by the server.
        """
        return pulumi.get(self, "organization_security_policy_id")
