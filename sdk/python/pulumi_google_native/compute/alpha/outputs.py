...
class RouterNatResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] endpoint_types: List of Natted endpoint types supported by the Nat Gateway. If the list is empty, then it will be equivalent to include ENDPOINT_TYPE_VM
