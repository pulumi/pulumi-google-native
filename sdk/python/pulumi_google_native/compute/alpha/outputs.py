...
class InstanceGroupManagerAutoHealingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'FixedOrPercentResponse' max_unavailable: Maximum number of instances that can be unavailable when autohealing. When 'percent' is used, the value is rounded UP. The instance is considered available if all of the following conditions are satisfied: 1. Instance's status is RUNNING. 2. Instance's currentAction is NONE (in particular its liveness health check result was observed to be HEALTHY at least once as it passed VERIFYING). 3. There is no outgoing action on an instance triggered by IGM.
...
class JwtResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['JwtHeaderResponse'] jwt_headers: jwt_headers and jwt_params define where to extract the JWT from an HTTP request. If no explicit location is specified, the following default locations are tried in order:
...
class ReservationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'AllocationShareSettingsResponse' share_settings: Share-settings for shared-reservation
...
class SecurityPolicyRuleMatcherConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] dest_ip_ranges: CIDR IP address range.
               ...
               This field may only be specified when versioned_expr is set to FIREWALL.
        :param Sequence['SecurityPolicyRuleMatcherConfigDestinationPortResponse'] dest_ports: Pairs of IP protocols and ports that the rule should match.
