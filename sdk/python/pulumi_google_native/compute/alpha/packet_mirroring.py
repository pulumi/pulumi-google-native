...
class PacketMirroring(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 collector_ilb: Optional[pulumi.Input[Union['PacketMirroringForwardingRuleInfoArgs', 'PacketMirroringForwardingRuleInfoArgsDict']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 enable: Optional[pulumi.Input['PacketMirroringEnable']] = None,
                 filter: Optional[pulumi.Input[Union['PacketMirroringFilterArgs', 'PacketMirroringFilterArgsDict']]] = None,
                 mirrored_resources: Optional[pulumi.Input[Union['PacketMirroringMirroredResourceInfoArgs', 'PacketMirroringMirroredResourceInfoArgsDict']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 network: Optional[pulumi.Input[Union['PacketMirroringNetworkInfoArgs', 'PacketMirroringNetworkInfoArgsDict']]] = None,
                 priority: Optional[pulumi.Input[int]] = None,
                 project: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union['PacketMirroringForwardingRuleInfoArgs', 'PacketMirroringForwardingRuleInfoArgsDict']] collector_ilb: The Forwarding Rule resource of type loadBalancingScheme=INTERNAL that will be used as collector for mirrored traffic. The specified forwarding rule must have isMirroringCollector set to true.
        :param pulumi.Input[str] description: An optional description of this resource. Provide this property when you create the resource.
        :param pulumi.Input['PacketMirroringEnable'] enable: Indicates whether or not this packet mirroring takes effect. If set to FALSE, this packet mirroring policy will not be enforced on the network. The default is TRUE.
        :param pulumi.Input[Union['PacketMirroringFilterArgs', 'PacketMirroringFilterArgsDict']] filter: Filter for mirrored traffic. If unspecified, all traffic is mirrored.
        :param pulumi.Input[Union['PacketMirroringMirroredResourceInfoArgs', 'PacketMirroringMirroredResourceInfoArgsDict']] mirrored_resources: PacketMirroring mirroredResourceInfos. MirroredResourceInfo specifies a set of mirrored VM instances, subnetworks and/or tags for which traffic from/to all VM instances will be mirrored.
        :param pulumi.Input[str] name: Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
        :param pulumi.Input[Union['PacketMirroringNetworkInfoArgs', 'PacketMirroringNetworkInfoArgsDict']] network: Specifies the mirrored VPC network. Only packets in this network will be mirrored. All mirrored VMs should have a NIC in the given network. All mirrored subnetworks should belong to the given network.
        :param pulumi.Input[int] priority: The priority of applying this configuration. Priority is used to break ties in cases where there is more than one matching rule. In the case of two rules that apply for a given Instance, the one with the lowest-numbered priority value wins. Default value is 1000. Valid range is 0 through 65535.
        :param pulumi.Input[str] request_id: An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
        """
        ...
