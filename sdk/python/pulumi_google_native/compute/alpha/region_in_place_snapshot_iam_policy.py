...
__all__ = ['RegionInPlaceSnapshotIamPolicyArgs', 'RegionInPlaceSnapshotIamPolicy']

@pulumi.input_type
class RegionInPlaceSnapshotIamPolicyArgs:
...
class RegionInPlaceSnapshotIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RegionInPlaceSnapshotIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param RegionInPlaceSnapshotIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RegionInPlaceSnapshotIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RegionInPlaceSnapshotIamPolicyArgs.__new__(RegionInPlaceSnapshotIamPolicyArgs)
        ...
        super(RegionInPlaceSnapshotIamPolicy, __self__).__init__(
            'google-native:compute/alpha:RegionInPlaceSnapshotIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RegionInPlaceSnapshotIamPolicy':
        """
        ...
        return RegionInPlaceSnapshotIamPolicy(resource_name, opts=opts, __props__=__props__)
