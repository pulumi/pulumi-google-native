...
class RegionSecurityPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RegionSecurityPolicyType'] type: The type indicates the intended use of the security policy. CLOUD_ARMOR policies apply to backend services. FIREWALL policies apply to organizations.
        """
