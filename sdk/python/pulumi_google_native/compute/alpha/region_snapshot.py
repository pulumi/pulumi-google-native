...
__all__ = ['RegionSnapshotArgs', 'RegionSnapshot']
...
class RegionSnapshotArgs:
    def __init__(__self__, *,
                 ...
                 snapshot_type: Optional[pulumi.Input['RegionSnapshotSnapshotType']] = None,
        ...
        :param pulumi.Input['RegionSnapshotSnapshotType'] snapshot_type: Indicates the type of the snapshot.
    ...
    def snapshot_type(self) -> Optional[pulumi.Input['RegionSnapshotSnapshotType']]:
        """
    ...
    def snapshot_type(self, value: Optional[pulumi.Input['RegionSnapshotSnapshotType']]):
...
class RegionSnapshot(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RegionSnapshotArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a snapshot in the specified region using the data included in the request.

        :param str resource_name: The name of the resource.
        :param RegionSnapshotArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RegionSnapshotArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RegionSnapshotArgs.__new__(RegionSnapshotArgs)
        ...
        super(RegionSnapshot, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RegionSnapshot':
        """
        ...
        __props__.__dict__["user_licenses"] = None
        return RegionSnapshot(resource_name, opts=opts, __props__=__props__)
