...
class SnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, str]] labels: Labels to apply to this snapshot. These can be later modified by the setLabels method. Label values may be empty.
