...
@pulumi.input_type
class AllocationAggregateReservationReservedResourceInfoAcceleratorArgs:
    def __init__(__self__, *,
                 accelerator_count: Optional[pulumi.Input[int]] = None,
                 accelerator_type: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[int] accelerator_count: Number of accelerators of specified type.
        :param pulumi.Input[str] accelerator_type: Full or partial URL to accelerator type. e.g. "projects/{PROJECT}/zones/{ZONE}/acceleratorTypes/ct4l"
        """
        if accelerator_count is not None:
            pulumi.set(__self__, "accelerator_count", accelerator_count)
        if accelerator_type is not None:
...
@pulumi.input_type
class AllocationAggregateReservationReservedResourceInfoArgs:
    def __init__(__self__, *,
                 accelerator: Optional[pulumi.Input['AllocationAggregateReservationReservedResourceInfoAcceleratorArgs']] = None):
        """
        :param pulumi.Input['AllocationAggregateReservationReservedResourceInfoAcceleratorArgs'] accelerator: Properties of accelerator resources in this reservation.
        """
    ...
    @property
    @pulumi.getter
    def accelerator(self) -> Optional[pulumi.Input['AllocationAggregateReservationReservedResourceInfoAcceleratorArgs']]:
        """
    ...
    @accelerator.setter
    def accelerator(self, value: Optional[pulumi.Input['AllocationAggregateReservationReservedResourceInfoAcceleratorArgs']]):
        pulumi.set(self, "accelerator", value)


@pulumi.input_type
class AllocationAggregateReservationArgs:
    def __init__(__self__, *,
                 reserved_resources: Optional[pulumi.Input[Sequence[pulumi.Input['AllocationAggregateReservationReservedResourceInfoArgs']]]] = None,
                 vm_family: Optional[pulumi.Input['AllocationAggregateReservationVmFamily']] = None,
                 workload_type: Optional[pulumi.Input['AllocationAggregateReservationWorkloadType']] = None):
        """
        This reservation type is specified by total resource amounts (e.g. total count of CPUs) and can account for multiple instance SKUs. In other words, one can create instances of varying shapes against this reservation.
        :param pulumi.Input[Sequence[pulumi.Input['AllocationAggregateReservationReservedResourceInfoArgs']]] reserved_resources: List of reserved resources (CPUs, memory, accelerators).
        :param pulumi.Input['AllocationAggregateReservationVmFamily'] vm_family: The VM family that all instances scheduled against this reservation must belong to.
        :param pulumi.Input['AllocationAggregateReservationWorkloadType'] workload_type: The workload type of the instances that will target this reservation.
        """
    ...
    def reserved_resources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AllocationAggregateReservationReservedResourceInfoArgs']]]]:
        """
    ...
    def reserved_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AllocationAggregateReservationReservedResourceInfoArgs']]]]):
        pulumi.set(self, "reserved_resources", value)

    @property
    @pulumi.getter(name="vmFamily")
    def vm_family(self) -> Optional[pulumi.Input['AllocationAggregateReservationVmFamily']]:
        """
    ...
    @vm_family.setter
    def vm_family(self, value: Optional[pulumi.Input['AllocationAggregateReservationVmFamily']]):
        pulumi.set(self, "vm_family", value)

    @property
    @pulumi.getter(name="workloadType")
    def workload_type(self) -> Optional[pulumi.Input['AllocationAggregateReservationWorkloadType']]:
        """
    ...
    def workload_type(self, value: Optional[pulumi.Input['AllocationAggregateReservationWorkloadType']]):
...
class AttachedDiskInitializeParamsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] replica_zones: Required for each regional disk associated with the instance. Specify the URLs of the zones where the disk should be replicated to. You must provide exactly two replica zones, and one zone must be the same as the instance zone.
...
@pulumi.input_type
class AutoscalingPolicyScalingScheduleArgs:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[bool] disabled: A boolean value that specifies whether a scaling schedule can influence autoscaler recommendations. If set to true, then a scaling schedule has no effect. This field is optional, and its value is false by default.
        :param pulumi.Input[int] duration_sec: The duration of time intervals, in seconds, for which this scaling schedule is to run. The minimum allowed value is 300. This field is required.
        :param pulumi.Input[int] min_required_replicas: The minimum number of VM instances that the autoscaler will recommend in time intervals starting according to schedule. This field is required.
        :param pulumi.Input[str] schedule: The start timestamps of time intervals when this scaling schedule is to provide a scaling signal. This field uses the extended cron format (with an optional year field). The expression can describe a single timestamp if the optional year is set, in which case the scaling schedule runs once. The schedule is interpreted with respect to time_zone. This field is required. Note: These timestamps only describe when autoscaler starts providing the scaling signal. The VMs need additional time to become serving.
        :param pulumi.Input[str] time_zone: The time zone to use when interpreting the schedule. The value of this field must be a time zone name from the tz database: https://en.wikipedia.org/wiki/Tz_database. This field is assigned a default value of "UTC" if left empty.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        ...
        if min_required_replicas is not None:
    ...
    def duration_sec(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    @duration_sec.setter
    def duration_sec(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "duration_sec", value)

    @property
    @pulumi.getter(name="minRequiredReplicas")
    def min_required_replicas(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def min_required_replicas(self, value: Optional[pulumi.Input[int]]):
...
class BackendBucketCdnPolicyCacheKeyPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] query_string_whitelist: Names of query string parameters to include in cache keys. Default parameters are always included. '&' and '=' will be percent encoded and not treated as delimiters.
        """
...
@pulumi.input_type
class BackendServiceUsedByArgs:
    def __init__(__self__, *,
...
class BackendArgs:
    def __init__(__self__, *,
                 ...
                 preference: Optional[pulumi.Input['BackendPreference']] = None):
        """
        ...
        :param pulumi.Input['BackendPreference'] preference: This field indicates whether this backend should be fully utilized before sending traffic to backends with default preference. The possible values are: - PREFERRED: Backends with this preference level will be filled up to their capacity limits first, based on RTT. - DEFAULT: If preferred backends don't have enough capacity, backends in this layer would be used and traffic would be assigned based on the load balancing algorithm you use. This is the default 
        """
    ...
    @property
    @pulumi.getter
    def preference(self) -> Optional[pulumi.Input['BackendPreference']]:
        """
    ...
    @preference.setter
    def preference(self, value: Optional[pulumi.Input['BackendPreference']]):
...
class CircuitBreakersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] max_connections: The maximum number of connections to the backend service. If not specified, there is no limit. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
        :param pulumi.Input[int] max_pending_requests: The maximum number of pending requests allowed to the backend service. If not specified, there is no limit. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
        ...
        :param pulumi.Input[int] max_requests_per_connection: Maximum requests for a single connection to the backend service. This parameter is respected by both the HTTP/1.1 and HTTP/2 implementations. If not specified, there is no limit. Setting this parameter to 1 will effectively disable keep alive. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
        :param pulumi.Input[int] max_retries: The maximum number of parallel retries allowed to the backend cluster. If not specified, the default is 1. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
        """
...
class ConfidentialInstanceConfigArgs:
    def __init__(__self__, *,
                 confidential_instance_type: Optional[pulumi.Input['ConfidentialInstanceConfigConfidentialInstanceType']] = None,
                 enable_confidential_compute: Optional[pulumi.Input[bool]] = None):
        """
        A set of Confidential Instance options.
        :param pulumi.Input['ConfidentialInstanceConfigConfidentialInstanceType'] confidential_instance_type: Defines the type of technology used by the confidential instance.
    ...
    def confidential_instance_type(self) -> Optional[pulumi.Input['ConfidentialInstanceConfigConfidentialInstanceType']]:
        """
    ...
    def confidential_instance_type(self, value: Optional[pulumi.Input['ConfidentialInstanceConfigConfidentialInstanceType']]):
...
class CorsPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allow_origin_regexes: Specifies a regular expression that matches allowed origins. For more information about the regular expression syntax, see Syntax. An origin is allowed if it matches either an item in allowOrigins or an item in allowOriginRegexes. Regular expressions can only be used when the loadBalancingScheme is set to INTERNAL_SELF_MANAGED.
...
class DiskAsyncReplicationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] disk: The other disk asynchronously replicated to or from the current disk. You can provide this as a partial or full URL to the resource. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone /disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk 
        """
        if disk is not None:
...
class ExternalVpnGatewayInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ipv6_address: IPv6 address of the interface in the external VPN gateway. This IPv6 address can be either from your on-premise gateway or another Cloud provider's VPN gateway, it cannot be an IP address from Google Compute Engine. Must specify an IPv6 address (not IPV4-mapped) using any format described in RFC 4291 (e.g. 2001:db8:0:0:2d9:51:0:0). The output format is RFC 5952 format (e.g. 2001:db8::2d9:51:0:0).
        """
        if id is not None:
...
class FirewallPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] tls_inspect: Boolean flag indicating if the traffic should be TLS decrypted. Can be set only if action = 'apply_security_profile_group' and cannot be set for other actions.
        """
...
class HTTP2HealthCheckArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] host: The value of the host header in the HTTP/2 health check request. If left empty (default value), the host header is set to the destination IP address to which health check packets are sent. The destination IP address depends on the type of load balancer. For details, see: https://cloud.google.com/load-balancing/docs/health-check-concepts#hc-packet-dest
        :param pulumi.Input[int] port: The TCP port number to which the health check prober sends packets. The default value is 443. Valid values are 1 through 65535.
        :param pulumi.Input[str] port_name: Not supported.
...
class HTTPHealthCheckArgs:
    def __init__(__self__, *,
                 ...
                 response: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] host: The value of the host header in the HTTP health check request. If left empty (default value), the host header is set to the destination IP address to which health check packets are sent. The destination IP address depends on the type of load balancer. For details, see: https://cloud.google.com/load-balancing/docs/health-check-concepts#hc-packet-dest
        :param pulumi.Input[int] port: The TCP port number to which the health check prober sends packets. The default value is 80. Valid values are 1 through 65535.
        :param pulumi.Input[str] port_name: Not supported.
        :param pulumi.Input['HTTPHealthCheckPortSpecification'] port_specification: Specifies how a port is selected for health checking. Can be one of the following values: USE_FIXED_PORT: Specifies a port number explicitly using the port field in the health check. Supported by backend services for pass-through load balancers and backend services for proxy load balancers. Also supported in legacy HTTP health checks for target pools. The health check supports all backends supported by the backend service provided the backend can be health checked. For example, GCE_VM_IP network endpoint groups, GCE_VM_IP_PORT network endpoint groups, and instance group backends. USE_NAMED_PORT: Not supported. USE_SERVING_PORT: Provides an indirect method of specifying the health check port by referring to the backend service. Only supported by backend services for proxy load balancers. Not supported by target pools. Not supported by backend services for pass-through load balancers. Supports all backends that can be health checked; for example, GCE_VM_IP_PORT network endpoint groups and instance group backends. For GCE_VM_IP_PORT network endpoint group backends, the health check uses the port number specified for each endpoint in the network endpoint group. For instance group backends, the health check uses the port number determined by looking up the backend service's named port in the instance group's list of named ports.
...
class HTTPSHealthCheckArgs:
    def __init__(__self__, *,
                 ...
                 response: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] host: The value of the host header in the HTTPS health check request. If left empty (default value), the host header is set to the destination IP address to which health check packets are sent. The destination IP address depends on the type of load balancer. For details, see: https://cloud.google.com/load-balancing/docs/health-check-concepts#hc-packet-dest
        :param pulumi.Input[int] port: The TCP port number to which the health check prober sends packets. The default value is 443. Valid values are 1 through 65535.
        :param pulumi.Input[str] port_name: Not supported.
        :param pulumi.Input['HTTPSHealthCheckPortSpecification'] port_specification: Specifies how a port is selected for health checking. Can be one of the following values: USE_FIXED_PORT: Specifies a port number explicitly using the port field in the health check. Supported by backend services for pass-through load balancers and backend services for proxy load balancers. Not supported by target pools. The health check supports all backends supported by the backend service provided the backend can be health checked. For example, GCE_VM_IP network endpoint groups, GCE_VM_IP_PORT network endpoint groups, and instance group backends. USE_NAMED_PORT: Not supported. USE_SERVING_PORT: Provides an indirect method of specifying the health check port by referring to the backend service. Only supported by backend services for proxy load balancers. Not supported by target pools. Not supported by backend services for pass-through load balancers. Supports all backends that can be health checked; for example, GCE_VM_IP_PORT network endpoint groups and instance group backends. For GCE_VM_IP_PORT network endpoint group backends, the health check uses the port number specified for each endpoint in the network endpoint group. For instance group backends, the health check uses the port number determined by looking up the backend service's named port in the instance group's list of named ports.
...
class InstanceGroupManagerAutoHealingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] initial_delay_sec: The initial delay is the number of seconds that a new VM takes to initialize and run its startup script. During a VM's initial delay period, the MIG ignores unsuccessful health checks because the VM might be in the startup process. This prevents the MIG from prematurely recreating a VM. If the health check receives a healthy response during the initial delay, it indicates that the startup process is complete and the VM is ready. The value of initial delay must be between 0 and 3600 seconds. The default value is 0.
        """
...
@pulumi.input_type
class InstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionArgs:
    def __init__(__self__, *,
...
class InstanceGroupManagerInstanceLifecyclePolicyArgs:
    ...
    def default_action_on_failure(self) -> Optional[pulumi.Input['InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure']]:
        """
        The action that a MIG performs on a failed or an unhealthy VM. A VM is marked as unhealthy when the application running on that VM fails a health check. Valid values are - REPAIR (default): MIG automatically repairs a failed or an unhealthy VM by recreating it. For more information, see About repairing VMs in a MIG. - DO_NOTHING: MIG does not repair a failed or an unhealthy VM. 
        """
    ...
    def default_action_on_failure(self, value: Optional[pulumi.Input['InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure']]):
...
class InstanceGroupManagerStandbyPolicyArgs:
    def __init__(__self__, *,
                 initial_delay_sec: Optional[pulumi.Input[int]] = None,
                 mode: Optional[pulumi.Input['InstanceGroupManagerStandbyPolicyMode']] = None):
        """
        :param pulumi.Input['InstanceGroupManagerStandbyPolicyMode'] mode: Defines behaviour of using instances from standby pool to resize MIG.
        """
        if initial_delay_sec is not None:
            pulumi.set(__self__, "initial_delay_sec", initial_delay_sec)
        if mode is not None:
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional[pulumi.Input['InstanceGroupManagerStandbyPolicyMode']]:
        """
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input['InstanceGroupManagerStandbyPolicyMode']]):
        pulumi.set(self, "mode", value)
...
class InstanceGroupManagerUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InstanceGroupManagerUpdatePolicyType'] type: The type of update process. You can specify either PROACTIVE so that the MIG automatically updates VMs to the latest configurations or OPPORTUNISTIC so that you can select the VMs that you want to update.
        """
...
class InterconnectMacsecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InterconnectMacsecPreSharedKeyArgs']]] pre_shared_keys: A keychain placeholder describing a set of named key objects along with their start times. A MACsec CKN/CAK is generated for each key in the key chain. Google router automatically picks the key with the most recent startTime when establishing or re-establishing a MACsec secure link.
...
class OutlierDetectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DurationArgs'] base_ejection_time: The base time that a backend endpoint is ejected for. Defaults to 30000ms or 30s. After a backend endpoint is returned back to the load balancing pool, it can be ejected again in another ejection analysis. Thus, the total ejection time is equal to the base ejection time multiplied by the number of times the backend endpoint has been ejected. Defaults to 30000ms or 30s.
        :param pulumi.Input[int] consecutive_errors: Number of consecutive errors before a backend endpoint is ejected from the load balancing pool. When the backend endpoint is accessed over HTTP, a 5xx return code qualifies as an error. Defaults to 5.
        ...
        :param pulumi.Input[int] enforcing_consecutive_errors: The percentage chance that a backend endpoint will be ejected when an outlier status is detected through consecutive 5xx. This setting can be used to disable ejection or to ramp it up slowly. Defaults to 0.
        :param pulumi.Input[int] enforcing_consecutive_gateway_failure: The percentage chance that a backend endpoint will be ejected when an outlier status is detected through consecutive gateway failures. This setting can be used to disable ejection or to ramp it up slowly. Defaults to 100.
        :param pulumi.Input[int] enforcing_success_rate: The percentage chance that a backend endpoint will be ejected when an outlier status is detected through success rate statistics. This setting can be used to disable ejection or to ramp it up slowly. Defaults to 100. Not supported when the backend service uses Serverless NEG.
        :param pulumi.Input['DurationArgs'] interval: Time interval between ejection analysis sweeps. This can result in both new ejections and backend endpoints being returned to service. The interval is equal to the number of seconds as defined in outlierDetection.interval.seconds plus the number of nanoseconds as defined in outlierDetection.interval.nanos. Defaults to 1 second.
        :param pulumi.Input[int] max_ejection_percent: Maximum percentage of backend endpoints in the load balancing pool for the backend service that can be ejected if the ejection conditions are met. Defaults to 50%.
        :param pulumi.Input[int] success_rate_minimum_hosts: The number of backend endpoints in the load balancing pool that must have enough request volume to detect success rate outliers. If the number of backend endpoints is fewer than this setting, outlier detection via success rate statistics is not performed for any backend endpoint in the load balancing pool. Defaults to 5. Not supported when the backend service uses Serverless NEG.
...
class PublicDelegatedPrefixPublicDelegatedSubPrefixArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: An optional description of this resource. Provide this property when you create the resource.
        :param pulumi.Input[str] ip_cidr_range: The IP address range, in CIDR format, represented by this sub public delegated prefix.
...
class RequestMirrorPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] backend_service: The full or partial URL to the BackendService resource being mirrored to. The backend service configured for a mirroring policy must reference backends that are of the same type as the original backend service matched in the URL map. Serverless NEG backends are not currently supported as a mirrored backend service. 
        """
...
class ResourcePolicyDailyCycleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] days_in_cycle: Defines a schedule with units measured in days. The value determines how many days pass between the start of each cycle.
        :param pulumi.Input[str] start_time: Start time of the window. This must be in UTC format that resolves to one of 00:00, 04:00, 08:00, 12:00, 16:00, or 20:00. For example, both 13:00-5 and 08:00 are valid.
        """
...
class ResourcePolicyGroupPlacementPolicyArgs:
    def __init__(__self__, *,
                 ...
                 slice_count: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[int] slice_count: Specifies the number of slices in a multislice workload.
        :param pulumi.Input[str] tpu_topology: Specifies the shape of the TPU slice
    ...
    def slice_count(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    @slice_count.setter
    def slice_count(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "slice_count", value)
...
@pulumi.input_type
class RouterBgpPeerCustomLearnedIpRangeArgs:
    def __init__(__self__, *,
                 range: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] range: The custom learned route IP address range. Must be a valid CIDR-formatted prefix. If an IP address is provided without a subnet mask, it is interpreted as, for IPv4, a `/32` singular IP address range, and, for IPv6, `/128`.
        """
        if range is not None:
            pulumi.set(__self__, "range", range)
...
class RouterBgpPeerArgs:
    def __init__(__self__, *,
                 ...
                 custom_learned_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input['RouterBgpPeerCustomLearnedIpRangeArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouterBgpPeerCustomLearnedIpRangeArgs']]] custom_learned_ip_ranges: A list of user-defined custom learned route IP address ranges for a BGP session.
        :param pulumi.Input[int] custom_learned_route_priority: The user-defined custom learned route priority for a BGP session. This value is applied to all custom learned route ranges for the session. You can choose a value from `0` to `65335`. If you don't provide a value, Google Cloud assigns a priority of `100` to the ranges.
    ...
    def custom_learned_ip_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RouterBgpPeerCustomLearnedIpRangeArgs']]]]:
        """
    ...
    def custom_learned_ip_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RouterBgpPeerCustomLearnedIpRangeArgs']]]]):
...
class RouterInterfaceArgs:
    def __init__(__self__, *,
                 ...
                 ip_version: Optional[pulumi.Input['RouterInterfaceIpVersion']] = None,
        ...
        :param pulumi.Input['RouterInterfaceIpVersion'] ip_version: IP version of this interface.
        :param pulumi.Input[str] linked_interconnect_attachment: URI of the linked Interconnect attachment. It must be in the same region as the router. Each interface can have one linked resource, which can be a VPN tunnel, an Interconnect attachment, or a subnetwork.
        :param pulumi.Input[str] linked_vpn_tunnel: URI of the linked VPN tunnel, which must be in the same region as the router. Each interface can have one linked resource, which can be a VPN tunnel, an Interconnect attachment, or a subnetwork.
    ...
    def ip_version(self) -> Optional[pulumi.Input['RouterInterfaceIpVersion']]:
        """
    ...
    @ip_version.setter
    def ip_version(self, value: Optional[pulumi.Input['RouterInterfaceIpVersion']]):
...
class RouterMd5AuthenticationKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Name used to identify the key. Must be unique within a router. Must be referenced by exactly one bgpPeer. Must comply with RFC1035.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if name is not None:
...
class RouterNatArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RouterNatAutoNetworkTier'] auto_network_tier: The network tier to use when automatically reserving NAT IP addresses. Must be one of: PREMIUM, STANDARD. If not specified, then the current project-level default tier is used.
...
class SSLHealthCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] request: Instructs the health check prober to send this exact ASCII string, up to 1024 bytes in length, after establishing the TCP connection and SSL handshake.
...
class SchedulingArgs:
    def __init__(__self__, *,
                 ...
                 local_ssd_recovery_timeout: Optional[pulumi.Input['DurationArgs']] = None,
                 location_hint: Optional[pulumi.Input[str]] = None,
                 maintenance_freeze_duration_hours: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input['DurationArgs'] local_ssd_recovery_timeout: Specifies the maximum amount of time a Local Ssd Vm should wait while recovery of the Local Ssd state is attempted. Its value should be in between 0 and 168 hours with hour granularity and the default value being 1 hour.
    ...
    def local_ssd_recovery_timeout(self) -> Optional[pulumi.Input['DurationArgs']]:
        """
    ...
    def local_ssd_recovery_timeout(self, value: Optional[pulumi.Input['DurationArgs']]):
...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] name: The name must be 1-63 characters long, and comply with RFC1035. The name must be unique within the security policy.
        """
...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enable: If set to true, enables CAAP for L7 DDoS detection. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
        :param pulumi.Input['SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigRuleVisibility'] rule_visibility: Rule visibility can be one of the following: STANDARD - opaque rules. (default) PREMIUM - transparent rules. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
...
class SecurityPolicyAdvancedOptionsConfigArgs:
    ...
    def user_ip_request_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class SecurityPolicyRecaptchaOptionsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] redirect_site_key: An optional field to supply a reCAPTCHA site key to be used for all the rules using the redirect action with the type of GOOGLE_RECAPTCHA under the security policy. The specified site key needs to be created from the reCAPTCHA API. The user is responsible for the validity of the specified site key. If not specified, a Google-managed site key is used. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
        """
...
@pulumi.input_type
class SecurityPolicyRuleMatcherExprOptionsRecaptchaOptionsArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class SecurityPolicyRuleMatcherExprOptionsArgs:
    def __init__(__self__, *,
                 recaptcha_options: Optional[pulumi.Input['SecurityPolicyRuleMatcherExprOptionsRecaptchaOptionsArgs']] = None):
        """
        :param pulumi.Input['SecurityPolicyRuleMatcherExprOptionsRecaptchaOptionsArgs'] recaptcha_options: reCAPTCHA configuration options to be applied for the rule. If the rule does not evaluate reCAPTCHA tokens, this field will have no effect.
        """
        if recaptcha_options is not None:
            pulumi.set(__self__, "recaptcha_options", recaptcha_options)

    @property
    @pulumi.getter(name="recaptchaOptions")
    def recaptcha_options(self) -> Optional[pulumi.Input['SecurityPolicyRuleMatcherExprOptionsRecaptchaOptionsArgs']]:
        """
    ...
    def recaptcha_options(self, value: Optional[pulumi.Input['SecurityPolicyRuleMatcherExprOptionsRecaptchaOptionsArgs']]):
...
class SecurityPolicyRuleMatcherArgs:
    def __init__(__self__, *,
                 ...
                 expr_options: Optional[pulumi.Input['SecurityPolicyRuleMatcherExprOptionsArgs']] = None,
        ...
        :param pulumi.Input['ExprArgs'] expr: User defined CEVAL expression. A CEVAL expression is used to specify match criteria such as origin.ip, source.region_code and contents in the request header. Expressions containing `evaluateThreatIntelligence` require Cloud Armor Managed Protection Plus tier and are not supported in Edge Policies nor in Regional Policies. Expressions containing `evaluatePreconfiguredExpr('sourceiplist-*')` require Cloud Armor Managed Protection Plus tier and are only supported in Global Security Policies.
        :param pulumi.Input['SecurityPolicyRuleMatcherExprOptionsArgs'] expr_options: The configuration options available when specifying a user defined CEVAL expression (i.e., 'expr').
    ...
    def expr_options(self) -> Optional[pulumi.Input['SecurityPolicyRuleMatcherExprOptionsArgs']]:
        """
    ...
    @expr_options.setter
    def expr_options(self, value: Optional[pulumi.Input['SecurityPolicyRuleMatcherExprOptionsArgs']]):
...
@pulumi.input_type
class SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchArgs:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[str]] = None,
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        :param pulumi.Input[str] name: Name of the user-defined field, as given in the definition.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] values: Matching values of the field. Each element can be a 32-bit unsigned decimal or hexadecimal (starting with "0x") number (e.g. "64") or range (e.g. "0x400-0x7ff").
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if values is not None:
...
@pulumi.input_type
class SecurityPolicyRuleNetworkMatcherArgs:
    def __init__(__self__, *,
                 dest_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 src_region_codes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 user_defined_fields: Optional[pulumi.Input[Sequence[pulumi.Input['SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchArgs']]] user_defined_fields: User-defined fields. Each element names a defined field and lists the matching values for that field.
        """
        if dest_ip_ranges is not None:
            pulumi.set(__self__, "dest_ip_ranges", dest_ip_ranges)
    ...
    def src_asns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[int]]]]:
        """
    ...
    @src_asns.setter
    def src_asns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]]):
        pulumi.set(self, "src_asns", value)
    ...
    def src_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    @src_ports.setter
    def src_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def user_defined_fields(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchArgs']]]]:
        """
    ...
    def user_defined_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchArgs']]]]):
...
class SecurityPolicyRuleRateLimitOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SecurityPolicyRuleRedirectOptionsArgs'] exceed_redirect_options: Parameters defining the redirect action that is used as the exceed action. Cannot be specified if the exceed action is not redirect. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
...
class SecurityPolicyRuleArgs:
    def __init__(__self__, *,
                 ...
                 network_match: Optional[pulumi.Input['SecurityPolicyRuleNetworkMatcherArgs']] = None,
        ...
        :param pulumi.Input['SecurityPolicyRuleHttpHeaderActionArgs'] header_action: Optional, additional actions that are performed on headers. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
    ...
    def network_match(self) -> Optional[pulumi.Input['SecurityPolicyRuleNetworkMatcherArgs']]:
        """
        A match condition that incoming packets are evaluated against for CLOUD_ARMOR_NETWORK security policies. If it matches, the corresponding 'action' is enforced. The match criteria for a rule consists of built-in match fields (like 'srcIpRanges') and potentially multiple user-defined match fields ('userDefinedFields'). Field values may be extracted directly from the packet or derived from it (e.g. 'srcRegionCodes'). Some fields may not be present in every packet (e.g. 'srcPorts'). A user-defined field is only present if the base header is found in the packet and the entire field is in bounds. Each match field may specify which values can match it, listing one or more ranges, prefixes, or exact values that are considered a match for the field. A field value must be present in order to match a specified match field. If no match values are specified for a match field, then any field value is considered to match it, and it's not required to be present. For strings specifying '*' is also equivalent to match all. For a packet to match a rule, all specified match fields must match the corresponding field values derived from the packet. Example: networkMatch: srcIpRanges: - "192.0.2.0/24" - "198.51.100.0/24" userDefinedFields: - name: "ipv4_fragment_offset" values: - "1-0x1fff" The above match condition matches packets with a source IP in 192.0.2.0/24 or 198.51.100.0/24 and a user-defined field named "ipv4_fragment_offset" with a value between 1 and 0x1fff inclusive.
        """
    ...
    def network_match(self, value: Optional[pulumi.Input['SecurityPolicyRuleNetworkMatcherArgs']]):
...
@pulumi.input_type
class SecurityPolicyUserDefinedFieldArgs:
    def __init__(__self__, *,
                 base: Optional[pulumi.Input['SecurityPolicyUserDefinedFieldBase']] = None,
                 mask: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 offset: Optional[pulumi.Input[int]] = None,
                 size: Optional[pulumi.Input[int]] = None):
        """
        :param pulumi.Input['SecurityPolicyUserDefinedFieldBase'] base: The base relative to which 'offset' is measured. Possible values are: - IPV4: Points to the beginning of the IPv4 header. - IPV6: Points to the beginning of the IPv6 header. - TCP: Points to the beginning of the TCP header, skipping over any IPv4 options or IPv6 extension headers. Not present for non-first fragments. - UDP: Points to the beginning of the UDP header, skipping over any IPv4 options or IPv6 extension headers. Not present for non-first fragments. required
        :param pulumi.Input[str] mask: If specified, apply this mask (bitwise AND) to the field to ignore bits before matching. Encoded as a hexadecimal number (starting with "0x"). The last byte of the field (in network byte order) corresponds to the least significant byte of the mask.
    ...
    @property
    @pulumi.getter
    def base(self) -> Optional[pulumi.Input['SecurityPolicyUserDefinedFieldBase']]:
        """
    ...
    @base.setter
    def base(self, value: Optional[pulumi.Input['SecurityPolicyUserDefinedFieldBase']]):
...
class ServiceAttachmentTunnelingConfigArgs:
    def __init__(__self__, *,
                 encapsulation_profile: Optional[pulumi.Input['ServiceAttachmentTunnelingConfigEncapsulationProfile']] = None,
                 routing_mode: Optional[pulumi.Input['ServiceAttachmentTunnelingConfigRoutingMode']] = None):
        """
        ...
        :param pulumi.Input['ServiceAttachmentTunnelingConfigEncapsulationProfile'] encapsulation_profile: Specify the encapsulation protocol and what metadata to include in incoming encapsulated packet headers.
        :param pulumi.Input['ServiceAttachmentTunnelingConfigRoutingMode'] routing_mode: How this Service Attachment will treat traffic sent to the tunnel_ip, destined for the consumer network.
        """
    ...
    def encapsulation_profile(self) -> Optional[pulumi.Input['ServiceAttachmentTunnelingConfigEncapsulationProfile']]:
        """
    ...
    def encapsulation_profile(self, value: Optional[pulumi.Input['ServiceAttachmentTunnelingConfigEncapsulationProfile']]):
        pulumi.set(self, "encapsulation_profile", value)

    @property
    @pulumi.getter(name="routingMode")
    def routing_mode(self) -> Optional[pulumi.Input['ServiceAttachmentTunnelingConfigRoutingMode']]:
        """
    ...
    @routing_mode.setter
    def routing_mode(self, value: Optional[pulumi.Input['ServiceAttachmentTunnelingConfigRoutingMode']]):
        pulumi.set(self, "routing_mode", value)


@pulumi.input_type
class ShareSettingsProjectConfigArgs:
    def __init__(__self__, *,
                 project: Optional[pulumi.Input[str]] = None):
        """
        Config for each project in the share settings.
        :param pulumi.Input[str] project: The project ID, should be same as the key of this project config in the parent map.
        """
...
@pulumi.input_type
class StatefulPolicyPreservedStateDiskDeviceArgs:
    def __init__(__self__, *,
                 auto_delete: Optional[pulumi.Input['StatefulPolicyPreservedStateDiskDeviceAutoDelete']] = None):
        """
        :param pulumi.Input['StatefulPolicyPreservedStateDiskDeviceAutoDelete'] auto_delete: These stateful disks will never be deleted during autohealing, update or VM instance recreate operations. This flag is used to configure if the disk should be deleted after it is no longer used by the group, e.g. when the given instance or the whole group is deleted. Note: disks attached in READ_ONLY mode cannot be auto-deleted.
        """
        if auto_delete is not None:
            pulumi.set(__self__, "auto_delete", auto_delete)
    ...
    @property
    @pulumi.getter(name="autoDelete")
    def auto_delete(self) -> Optional[pulumi.Input['StatefulPolicyPreservedStateDiskDeviceAutoDelete']]:
        """
    ...
    @auto_delete.setter
    def auto_delete(self, value: Optional[pulumi.Input['StatefulPolicyPreservedStateDiskDeviceAutoDelete']]):
        pulumi.set(self, "auto_delete", value)


@pulumi.input_type
class StatefulPolicyPreservedStateNetworkIpArgs:
    def __init__(__self__, *,
                 auto_delete: Optional[pulumi.Input['StatefulPolicyPreservedStateNetworkIpAutoDelete']] = None):
        """
        :param pulumi.Input['StatefulPolicyPreservedStateNetworkIpAutoDelete'] auto_delete: These stateful IPs will never be released during autohealing, update or VM instance recreate operations. This flag is used to configure if the IP reservation should be deleted after it is no longer used by the group, e.g. when the given instance or the whole group is deleted.
        """
        if auto_delete is not None:
            pulumi.set(__self__, "auto_delete", auto_delete)
    ...
    @property
    @pulumi.getter(name="autoDelete")
    def auto_delete(self) -> Optional[pulumi.Input['StatefulPolicyPreservedStateNetworkIpAutoDelete']]:
        """
    ...
    @auto_delete.setter
    def auto_delete(self, value: Optional[pulumi.Input['StatefulPolicyPreservedStateNetworkIpAutoDelete']]):
        pulumi.set(self, "auto_delete", value)
...
class SubnetworkLogConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] filter_expr: Can only be specified if VPC flow logs for this subnetwork is enabled. The filter expression is used to define which VPC flow logs should be exported to Cloud Logging.
...
class TCPHealthCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] port: The TCP port number to which the health check prober sends packets. The default value is 80. Valid values are 1 through 65535.
        :param pulumi.Input[str] port_name: Not supported.
        :param pulumi.Input['TCPHealthCheckPortSpecification'] port_specification: Specifies how a port is selected for health checking. Can be one of the following values: USE_FIXED_PORT: Specifies a port number explicitly using the port field in the health check. Supported by backend services for pass-through load balancers and backend services for proxy load balancers. Not supported by target pools. The health check supports all backends supported by the backend service provided the backend can be health checked. For example, GCE_VM_IP network endpoint groups, GCE_VM_IP_PORT network endpoint groups, and instance group backends. USE_NAMED_PORT: Not supported. USE_SERVING_PORT: Provides an indirect method of specifying the health check port by referring to the backend service. Only supported by backend services for proxy load balancers. Not supported by target pools. Not supported by backend services for pass-through load balancers. Supports all backends that can be health checked; for example, GCE_VM_IP_PORT network endpoint groups and instance group backends. For GCE_VM_IP_PORT network endpoint group backends, the health check uses the port number specified for each endpoint in the network endpoint group. For instance group backends, the health check uses the port number determined by looking up the backend service's named port in the instance group's list of named ports.
        ...
        :param pulumi.Input[str] request: Instructs the health check prober to send this exact ASCII string, up to 1024 bytes in length, after establishing the TCP connection.
