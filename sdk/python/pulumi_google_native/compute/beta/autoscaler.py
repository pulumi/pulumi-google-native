...
class AutoscalerArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input['AutoscalerStatus']] = None,
        ...
        :param pulumi.Input['AutoscalerStatus'] status: [Output Only] The status of the autoscaler configuration. Current set of possible values: - PENDING: Autoscaler backend hasn't read new/updated configuration. - DELETING: Configuration is being deleted. - ACTIVE: Configuration is acknowledged to be effective. Some warnings might be present in the statusDetails field. - ERROR: Configuration has errors. Actionable for users. Details are present in the statusDetails field. New values might be added in the future.
    ...
    @property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input['AutoscalerStatus']]:
        """
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input['AutoscalerStatus']]):
