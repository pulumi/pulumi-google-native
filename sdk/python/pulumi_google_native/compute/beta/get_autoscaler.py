...
class GetAutoscalerResult:
    ...
    def scaling_schedule_status(self) -> 'outputs.ScalingScheduleStatusResponse':
        """
...
def get_autoscaler(autoscaler: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getAutoscaler', __args__, opts=opts, typ=GetAutoscalerResult).value
