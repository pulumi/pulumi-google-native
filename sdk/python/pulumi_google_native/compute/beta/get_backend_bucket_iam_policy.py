...
def get_backend_bucket_iam_policy(options_requested_policy_version: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getBackendBucketIamPolicy', __args__, opts=opts, typ=GetBackendBucketIamPolicyResult).value
...
def get_backend_bucket_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
