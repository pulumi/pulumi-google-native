...
class GetFirewallPolicyResult:
    def __init__(__self__, associations=None, creation_timestamp=None, description=None, display_name=None, fingerprint=None, kind=None, name=None, parent=None, rule_tuple_count=None, rules=None, self_link=None, self_link_with_id=None, short_name=None):
...
def get_firewall_policy(firewall_policy: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getFirewallPolicy', __args__, opts=opts, typ=GetFirewallPolicyResult).value
