...
class GetInstanceGroupResult:
    def __init__(__self__, creation_timestamp=None, description=None, fingerprint=None, id=None, kind=None, name=None, named_ports=None, network=None, region=None, self_link=None, size=None, subnetwork=None, zone=None):
...
def get_instance_group(instance_group: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getInstanceGroup', __args__, opts=opts, typ=GetInstanceGroupResult).value
