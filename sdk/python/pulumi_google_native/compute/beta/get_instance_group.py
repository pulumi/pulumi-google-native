...
class GetInstanceGroupResult:
    def __init__(__self__, creation_timestamp=None, description=None, fingerprint=None, kind=None, name=None, named_ports=None, network=None, region=None, self_link=None, size=None, subnetwork=None, zone=None):
