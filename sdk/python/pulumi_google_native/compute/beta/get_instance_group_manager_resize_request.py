...
class GetInstanceGroupManagerResizeRequestResult:
    def __init__(__self__, count=None, creation_timestamp=None, description=None, kind=None, name=None, requested_run_duration=None, resize_by=None, self_link=None, self_link_with_id=None, state=None, status=None, zone=None):
...
def get_instance_group_manager_resize_request(instance_group_manager: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getInstanceGroupManagerResizeRequest', __args__, opts=opts, typ=GetInstanceGroupManagerResizeRequestResult).value
