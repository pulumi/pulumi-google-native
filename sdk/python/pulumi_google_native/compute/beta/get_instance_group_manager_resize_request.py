...
class GetInstanceGroupManagerResizeRequestResult:
    def __init__(__self__, count=None, creation_timestamp=None, description=None, kind=None, name=None, self_link=None, self_link_with_id=None, state=None, status=None, zone=None):
