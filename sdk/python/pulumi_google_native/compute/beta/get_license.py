...
class GetLicenseResult:
    def __init__(__self__, charges_use_fee=None, creation_timestamp=None, description=None, id=None, kind=None, license_code=None, name=None, resource_requirements=None, self_link=None, transferable=None):
