...
class GetMachineImageResult:
    def __init__(__self__, creation_timestamp=None, description=None, guest_flush=None, instance_properties=None, kind=None, machine_image_encryption_key=None, name=None, satisfies_pzi=None, satisfies_pzs=None, saved_disks=None, self_link=None, source_disk_encryption_keys=None, source_instance=None, source_instance_properties=None, status=None, storage_locations=None, total_storage_bytes=None):
...
def get_machine_image(machine_image: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getMachineImage', __args__, opts=opts, typ=GetMachineImageResult).value
