...
__all__ = [
    'GetNodeGroupIamPolicyResult',
    'AwaitableGetNodeGroupIamPolicyResult',
    'get_node_group_iam_policy',
    'get_node_group_iam_policy_output',
]

@pulumi.output_type
class GetNodeGroupIamPolicyResult:
...
class AwaitableGetNodeGroupIamPolicyResult(GetNodeGroupIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNodeGroupIamPolicyResult(
...
def get_node_group_iam_policy(options_requested_policy_version: Optional[str] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNodeGroupIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getNodeGroupIamPolicy', __args__, opts=opts, typ=GetNodeGroupIamPolicyResult).value

    return AwaitableGetNodeGroupIamPolicyResult(
...
def get_node_group_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNodeGroupIamPolicyResult]:
    """
    Gets the access control policy for a resource. May be empty if no such policy or resource exists.
    """
    ...
