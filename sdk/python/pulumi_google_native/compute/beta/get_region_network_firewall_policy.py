...
class GetRegionNetworkFirewallPolicyResult:
    def __init__(__self__, associations=None, creation_timestamp=None, description=None, display_name=None, fingerprint=None, id=None, kind=None, name=None, parent=None, region=None, rule_tuple_count=None, rules=None, self_link=None, self_link_with_id=None, short_name=None):
