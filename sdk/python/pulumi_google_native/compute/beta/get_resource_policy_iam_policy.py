...
def get_resource_policy_iam_policy(options_requested_policy_version: Optional[str] = None,
...
def get_resource_policy_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
