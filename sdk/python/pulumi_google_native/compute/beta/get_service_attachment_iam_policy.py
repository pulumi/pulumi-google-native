...
def get_service_attachment_iam_policy(options_requested_policy_version: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getServiceAttachmentIamPolicy', __args__, opts=opts, typ=GetServiceAttachmentIamPolicyResult).value
