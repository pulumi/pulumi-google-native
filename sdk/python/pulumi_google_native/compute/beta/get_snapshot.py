...
class GetSnapshotResult:
    def __init__(__self__, architecture=None, auto_created=None, chain_name=None, creation_size_bytes=None, creation_timestamp=None, description=None, disk_size_gb=None, download_bytes=None, enable_confidential_compute=None, guest_flush=None, guest_os_features=None, kind=None, label_fingerprint=None, labels=None, license_codes=None, licenses=None, location_hint=None, name=None, satisfies_pzs=None, self_link=None, snapshot_encryption_key=None, snapshot_type=None, source_disk=None, source_disk_encryption_key=None, source_disk_id=None, source_instant_snapshot=None, source_instant_snapshot_encryption_key=None, source_instant_snapshot_id=None, source_snapshot_schedule_policy=None, source_snapshot_schedule_policy_id=None, status=None, storage_bytes=None, storage_bytes_status=None, storage_locations=None, user_licenses=None):
...
def get_snapshot(project: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult).value
    ...
    return AwaitableGetSnapshotResult(
        ...
        source_instant_snapshot_encryption_key=__ret__.source_instant_snapshot_encryption_key,
