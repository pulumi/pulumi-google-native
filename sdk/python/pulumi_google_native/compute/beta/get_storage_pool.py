...
def get_storage_pool(project: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getStoragePool', __args__, opts=opts, typ=GetStoragePoolResult).value
