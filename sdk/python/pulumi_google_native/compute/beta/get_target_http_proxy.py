...
class GetTargetHttpProxyResult:
    def __init__(__self__, creation_timestamp=None, description=None, fingerprint=None, http_filters=None, id=None, kind=None, name=None, proxy_bind=None, region=None, self_link=None, url_map=None):
...
def get_target_http_proxy(project: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/beta:getTargetHttpProxy', __args__, opts=opts, typ=GetTargetHttpProxyResult).value
