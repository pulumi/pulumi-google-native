...
__all__ = ['NetworkAttachmentIamBindingArgs', 'NetworkAttachmentIamBinding']

@pulumi.input_type
class NetworkAttachmentIamBindingArgs:
...
class NetworkAttachmentIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: NetworkAttachmentIamBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param NetworkAttachmentIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NetworkAttachmentIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NetworkAttachmentIamBindingArgs.__new__(NetworkAttachmentIamBindingArgs)
        ...
        super(NetworkAttachmentIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NetworkAttachmentIamBinding':
        """
        ...
        return NetworkAttachmentIamBinding(resource_name, opts=opts, __props__=__props__)
