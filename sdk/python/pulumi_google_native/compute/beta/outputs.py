...
class NetworkInterfaceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str ipv6_address: An IPv6 internal network address for this network interface. To use a static internal IP address, it must be unused and in the same region as the instance's zone. If not specified, GCP will automatically assign an internal IPv6 address from the instance's subnetwork.
