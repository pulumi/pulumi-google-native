...
class RegionDiskArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input['RegionDiskStatus']] = None,
        ...
        :param pulumi.Input['RegionDiskStatus'] status: [Output Only] The status of disk creation. - CREATING: Disk is provisioning. - RESTORING: Source data is being copied into the disk. - FAILED: Disk creation failed. - READY: Disk is ready for use. - DELETING: Disk is deleting. 
    ...
    @property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input['RegionDiskStatus']]:
        """
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input['RegionDiskStatus']]):
