...
__all__ = ['ReservationIamBindingArgs', 'ReservationIamBinding']

@pulumi.input_type
class ReservationIamBindingArgs:
...
class ReservationIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ReservationIamBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.

        :param str resource_name: The name of the resource.
        :param ReservationIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ReservationIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ReservationIamBindingArgs.__new__(ReservationIamBindingArgs)
        ...
        super(ReservationIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ReservationIamBinding':
        """
        Get an existing ReservationIamBinding resource's state with the given name, id, and optional extra
        ...
        return ReservationIamBinding(resource_name, opts=opts, __props__=__props__)
