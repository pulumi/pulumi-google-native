...
__all__ = ['SnapshotIamMemberArgs', 'SnapshotIamMember']

@pulumi.input_type
class SnapshotIamMemberArgs:
...
class SnapshotIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SnapshotIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SnapshotIamMemberArgs.__new__(SnapshotIamMemberArgs)
        ...
        super(SnapshotIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SnapshotIamMember':
        """
        ...
        return SnapshotIamMember(resource_name, opts=opts, __props__=__props__)
