...
class VpnGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 request_id: Optional[pulumi.Input[str]] = None,
                 stack_type: Optional[pulumi.Input['VpnGatewayStackType']] = None,
                 vpn_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VpnGatewayVpnGatewayInterfaceArgs', 'VpnGatewayVpnGatewayInterfaceArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] request_id: An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
        :param pulumi.Input['VpnGatewayStackType'] stack_type: The stack type for this VPN gateway to identify the IP protocols that are enabled. Possible values are: IPV4_ONLY, IPV4_IPV6. If not specified, IPV4_ONLY will be used.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpnGatewayVpnGatewayInterfaceArgs', 'VpnGatewayVpnGatewayInterfaceArgsDict']]]] vpn_interfaces: The list of VPN interfaces associated with this VPN gateway.
        """
        ...
    @overload
    def __init__(__self__,
