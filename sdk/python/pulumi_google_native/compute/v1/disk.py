...
class DiskArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input['DiskStatus']] = None,
        ...
        :param pulumi.Input['DiskStatus'] status: [Output Only] The status of disk creation. - CREATING: Disk is provisioning. - RESTORING: Source data is being copied into the disk. - FAILED: Disk creation failed. - READY: Disk is ready for use. - DELETING: Disk is deleting. 
    ...
    @property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input['DiskStatus']]:
        """
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input['DiskStatus']]):
