...
class GetAddressResult:
    def __init__(__self__, address=None, address_type=None, creation_timestamp=None, description=None, id=None, ip_version=None, kind=None, name=None, network=None, network_tier=None, prefix_length=None, purpose=None, region=None, self_link=None, status=None, subnetwork=None, users=None):
