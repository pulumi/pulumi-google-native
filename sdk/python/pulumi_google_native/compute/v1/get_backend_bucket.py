...
class GetBackendBucketResult:
    def __init__(__self__, bucket_name=None, cdn_policy=None, creation_timestamp=None, custom_response_headers=None, description=None, edge_security_policy=None, enable_cdn=None, id=None, kind=None, name=None, self_link=None):
