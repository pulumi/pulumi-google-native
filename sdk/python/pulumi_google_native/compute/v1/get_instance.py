...
def get_instance(instance: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/v1:getInstance', __args__, opts=opts, typ=GetInstanceResult).value
