...
def get_instant_snapshot_iam_policy(options_requested_policy_version: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/v1:getInstantSnapshotIamPolicy', __args__, opts=opts, typ=GetInstantSnapshotIamPolicyResult).value
...
def get_instant_snapshot_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
