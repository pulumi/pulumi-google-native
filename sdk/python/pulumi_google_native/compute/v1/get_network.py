...
class GetNetworkResult:
    def __init__(__self__, auto_create_subnetworks=None, creation_timestamp=None, description=None, enable_ula_internal_ipv6=None, gateway_i_pv4=None, id=None, internal_ipv6_range=None, ipv4_range=None, kind=None, mtu=None, name=None, network_firewall_policy_enforcement_order=None, peerings=None, routing_config=None, self_link=None, self_link_with_id=None, subnetworks=None):
