...
class GetNetworkEdgeSecurityServiceResult:
    def __init__(__self__, creation_timestamp=None, description=None, fingerprint=None, id=None, kind=None, name=None, region=None, security_policy=None, self_link=None, self_link_with_id=None):
