...
class GetNodeTemplateResult:
    def __init__(__self__, accelerators=None, cpu_overcommit_type=None, creation_timestamp=None, description=None, disks=None, id=None, kind=None, name=None, node_affinity_labels=None, node_type=None, node_type_flexibility=None, region=None, self_link=None, server_binding=None, status=None, status_message=None):
