...
class GetPacketMirroringResult:
    def __init__(__self__, collector_ilb=None, creation_timestamp=None, description=None, enable=None, filter=None, id=None, kind=None, mirrored_resources=None, name=None, network=None, priority=None, region=None, self_link=None):
...
def get_packet_mirroring(packet_mirroring: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/v1:getPacketMirroring', __args__, opts=opts, typ=GetPacketMirroringResult).value
