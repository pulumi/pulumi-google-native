...
def get_region_backend_service_iam_policy(options_requested_policy_version: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/v1:getRegionBackendServiceIamPolicy', __args__, opts=opts, typ=GetRegionBackendServiceIamPolicyResult).value
...
def get_region_backend_service_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
