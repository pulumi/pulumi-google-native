...
class AwaitableGetRegionInstantSnapshotResult(GetRegionInstantSnapshotResult):
...
def get_region_instant_snapshot(instant_snapshot: Optional[str] = None,
                                project: Optional[str] = None,
                                region: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRegionInstantSnapshotResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/v1:getRegionInstantSnapshot', __args__, opts=opts, typ=GetRegionInstantSnapshotResult).value
