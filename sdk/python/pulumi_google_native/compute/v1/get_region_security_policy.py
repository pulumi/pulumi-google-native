...
class GetRegionSecurityPolicyResult:
    def __init__(__self__, adaptive_protection_config=None, advanced_options_config=None, creation_timestamp=None, ddos_protection_config=None, description=None, fingerprint=None, id=None, kind=None, name=None, recaptcha_options_config=None, region=None, rules=None, self_link=None, type=None):
