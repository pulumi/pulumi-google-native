...
class GetRouteResult:
    def __init__(__self__, as_paths=None, creation_timestamp=None, description=None, dest_range=None, id=None, kind=None, name=None, network=None, next_hop_gateway=None, next_hop_ilb=None, next_hop_instance=None, next_hop_ip=None, next_hop_network=None, next_hop_peering=None, next_hop_vpn_tunnel=None, priority=None, route_status=None, route_type=None, self_link=None, tags=None, warnings=None):
...
def get_route(project: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/v1:getRoute', __args__, opts=opts, typ=GetRouteResult).value
