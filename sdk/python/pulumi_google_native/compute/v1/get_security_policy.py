...
class GetSecurityPolicyResult:
    def __init__(__self__, advanced_options_config=None, creation_timestamp=None, description=None, fingerprint=None, kind=None, name=None, rules=None, self_link=None):
