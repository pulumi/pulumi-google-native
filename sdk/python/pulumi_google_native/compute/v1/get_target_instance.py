...
class GetTargetInstanceResult:
    def __init__(__self__, creation_timestamp=None, description=None, id=None, instance=None, kind=None, name=None, nat_policy=None, network=None, self_link=None, zone=None):
