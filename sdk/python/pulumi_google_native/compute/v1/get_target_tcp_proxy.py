...
class GetTargetTcpProxyResult:
    def __init__(__self__, creation_timestamp=None, description=None, id=None, kind=None, name=None, proxy_bind=None, proxy_header=None, self_link=None, service=None):
...
def get_target_tcp_proxy(project: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:compute/v1:getTargetTcpProxy', __args__, opts=opts, typ=GetTargetTcpProxyResult).value
