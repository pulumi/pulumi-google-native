...
class GetTargetVpnGatewayResult:
    def __init__(__self__, creation_timestamp=None, description=None, forwarding_rules=None, id=None, kind=None, name=None, network=None, region=None, self_link=None, status=None, tunnels=None):
