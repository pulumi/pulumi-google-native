...
class GlobalForwardingRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["global_forwarding_rule_id"] = None
    ...
    @property
    @pulumi.getter(name="globalForwardingRuleId")
    def global_forwarding_rule_id(self) -> pulumi.Output[str]:
        """
        The unique identifier for the resource. This identifier is defined by the server.
        """
        return pulumi.get(self, "global_forwarding_rule_id")
