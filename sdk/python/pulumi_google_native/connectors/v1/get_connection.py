...
def get_connection(connection_id: Optional[str] = None,
    ...
    return AwaitableGetConnectionResult(
        ...
        connection_revision=__ret__.connection_revision,
        connector_version=__ret__.connector_version,
        connector_version_infra_config=__ret__.connector_version_infra_config,
        connector_version_launch_stage=__ret__.connector_version_launch_stage,
        create_time=__ret__.create_time,
        description=__ret__.description,
        destination_configs=__ret__.destination_configs,
        envoy_image_location=__ret__.envoy_image_location,
        eventing_config=__ret__.eventing_config,
        eventing_enablement_type=__ret__.eventing_enablement_type,
        eventing_runtime_data=__ret__.eventing_runtime_data,
