...
class GetEventSubscriptionResult:
    def __init__(__self__, create_time=None, destinations=None, event_type_id=None, name=None, status=None, subscriber=None, subscriber_link=None, update_time=None):
...
def get_event_subscription(connection_id: Optional[str] = None,
    ...
    return AwaitableGetEventSubscriptionResult(
        ...
        subscriber=__ret__.subscriber,
        subscriber_link=__ret__.subscriber_link,
