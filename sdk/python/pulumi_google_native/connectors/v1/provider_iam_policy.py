...
__all__ = ['ProviderIamPolicyArgs', 'ProviderIamPolicy']

@pulumi.input_type
class ProviderIamPolicyArgs:
...
class ProviderIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ProviderIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProviderIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProviderIamPolicyArgs.__new__(ProviderIamPolicyArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "project", "provider_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ProviderIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ProviderIamPolicy':
        """
        ...
        return ProviderIamPolicy(resource_name, opts=opts, __props__=__props__)
