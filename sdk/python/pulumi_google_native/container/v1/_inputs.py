...
class DailyMaintenanceWindowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] duration: [Output only] Duration of the time window, automatically chosen to be smallest possible in the given scenario. Duration will be in [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) format "PTnHnMnS".
...
class MasterAuthArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cluster_ca_certificate: [Output only] Base64-encoded public certificate that is the root of trust for the cluster.
