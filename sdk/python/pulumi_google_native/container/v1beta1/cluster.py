...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cluster_ipv4_cidr: Optional[pulumi.Input[str]] = None,
                 cluster_telemetry: Optional[pulumi.Input[Union['ClusterTelemetryArgs', 'ClusterTelemetryArgsDict']]] = None,
                 ...
                 master: Optional[pulumi.Input[Union['MasterArgs', 'MasterArgsDict']]] = None,
                 ...
                 pod_security_policy_config: Optional[pulumi.Input[Union['PodSecurityPolicyConfigArgs', 'PodSecurityPolicyConfigArgsDict']]] = None,
                 private_cluster: Optional[pulumi.Input[bool]] = None,
                 private_cluster_config: Optional[pulumi.Input[Union['PrivateClusterConfigArgs', 'PrivateClusterConfigArgsDict']]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 protect_config: Optional[pulumi.Input[Union['ProtectConfigArgs', 'ProtectConfigArgsDict']]] = None,
                 ...
                 subnetwork: Optional[pulumi.Input[str]] = None,
                 tpu_config: Optional[pulumi.Input[Union['TpuConfigArgs', 'TpuConfigArgsDict']]] = None,
                 vertical_pod_autoscaling: Optional[pulumi.Input[Union['VerticalPodAutoscalingArgs', 'VerticalPodAutoscalingArgsDict']]] = None,
                 workload_alts_config: Optional[pulumi.Input[Union['WorkloadALTSConfigArgs', 'WorkloadALTSConfigArgsDict']]] = None,
                 workload_certificates: Optional[pulumi.Input[Union['WorkloadCertificatesArgs', 'WorkloadCertificatesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] cluster_ipv4_cidr: The IP address range of the container pods in this cluster, in [CIDR](http://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) notation (e.g. `10.96.0.0/14`). Leave blank to have one automatically chosen or specify a `/14` block in `10.0.0.0/8`.
        :param pulumi.Input[Union['ClusterTelemetryArgs', 'ClusterTelemetryArgsDict']] cluster_telemetry: Telemetry integration for the cluster.
        ...
        :param pulumi.Input[str] description: An optional description of this cluster.
        :param pulumi.Input[Union['K8sBetaAPIConfigArgs', 'K8sBetaAPIConfigArgsDict']] enable_k8s_beta_apis: Kubernetes open source beta apis enabled on the cluster. Only beta apis.
        :param pulumi.Input[bool] enable_kubernetes_alpha: Kubernetes alpha features are enabled on this cluster. This includes alpha API groups (e.g. v1beta1) and features that may not be production ready in the kubernetes version of the master and nodes. The cluster has no SLA for uptime and master/node upgrades are disabled. Alpha enabled clusters are automatically deleted thirty days after creation.
        :param pulumi.Input[bool] enable_tpu: Enable the ability to use Cloud TPUs in this cluster. This field is deprecated, use tpu_config.enabled instead.
        ...
        :param pulumi.Input[Union['MasterArgs', 'MasterArgsDict']] master: Configuration for master components.
        ...
        :param pulumi.Input[Union['PodSecurityPolicyConfigArgs', 'PodSecurityPolicyConfigArgsDict']] pod_security_policy_config: Configuration for the PodSecurityPolicy feature.
        :param pulumi.Input[bool] private_cluster: If this is a private cluster setup. Private clusters are clusters that, by default have no external IP addresses on the nodes and where nodes and the master communicate over private IP addresses. This field is deprecated, use private_cluster_config.enable_private_nodes instead.
        ...
        :param pulumi.Input[str] project: Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
        :param pulumi.Input[Union['ProtectConfigArgs', 'ProtectConfigArgsDict']] protect_config: Deprecated: Use SecurityPostureConfig instead. Enable/Disable Protect API features for the cluster.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] resource_labels: The resource labels for the cluster to use to annotate any related Google Compute Engine resources.
        :param pulumi.Input[Union['ResourceUsageExportConfigArgs', 'ResourceUsageExportConfigArgsDict']] resource_usage_export_config: Configuration for exporting resource usages. Resource usage export is disabled when this config unspecified.
        ...
        :param pulumi.Input[str] subnetwork: The name of the Google Compute Engine [subnetwork](https://cloud.google.com/compute/docs/subnetworks) to which the cluster is connected. On output this shows the subnetwork ID instead of the name.
        :param pulumi.Input[Union['TpuConfigArgs', 'TpuConfigArgsDict']] tpu_config: Configuration for Cloud TPU support;
        ...
        :param pulumi.Input[Union['WorkloadALTSConfigArgs', 'WorkloadALTSConfigArgsDict']] workload_alts_config: Configuration for direct-path (via ALTS) with workload identity.
        :param pulumi.Input[Union['WorkloadCertificatesArgs', 'WorkloadCertificatesArgsDict']] workload_certificates: Configuration for issuance of mTLS keys and certificates to Kubernetes pods.
