...
class GetServerConfigResult:
    def __init__(__self__, channels=None, default_cluster_version=None, default_image_type=None, valid_image_types=None, valid_master_versions=None, valid_node_versions=None, windows_version_maps=None):
        ...
        if windows_version_maps and not isinstance(windows_version_maps, dict):
            raise TypeError("Expected argument 'windows_version_maps' to be a dict")
        pulumi.set(__self__, "windows_version_maps", windows_version_maps)
    ...
    def windows_version_maps(self) -> 'outputs.WindowsVersionsResponse':
        """
        Maps of Kubernetes version and supported Windows server versions.
        """
        return pulumi.get(self, "windows_version_maps")
...
class AwaitableGetServerConfigResult(GetServerConfigResult):
    ...
    def __await__(self):
        ...
        return GetServerConfigResult(
            ...
            windows_version_maps=self.windows_version_maps)
...
def get_server_config(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:container/v1beta1:getServerConfig', __args__, opts=opts, typ=GetServerConfigResult).value
    ...
    return AwaitableGetServerConfigResult(
        ...
        windows_version_maps=pulumi.get(__ret__, 'windows_version_maps'))
