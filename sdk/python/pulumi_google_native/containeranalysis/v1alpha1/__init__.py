...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "google-native:containeranalysis/v1alpha1:Note":
                return Note(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-native:containeranalysis/v1alpha1:NoteIamPolicy":
                return NoteIamPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "google-native:containeranalysis/v1alpha1:Occurrence":
    ...
    pulumi.runtime.register_resource_module("google-native", "containeranalysis/v1alpha1", _module_instance)
