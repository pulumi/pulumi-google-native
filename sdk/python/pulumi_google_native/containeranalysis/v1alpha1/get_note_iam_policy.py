...
def get_note_iam_policy(note_id: Optional[str] = None,
                        project: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNoteIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:containeranalysis/v1alpha1:getNoteIamPolicy', __args__, opts=opts, typ=GetNoteIamPolicyResult).value
