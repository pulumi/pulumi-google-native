...
@pulumi.output_type
class GetOccurrenceIamPolicyResult:
...
class AwaitableGetOccurrenceIamPolicyResult(GetOccurrenceIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOccurrenceIamPolicyResult(
            bindings=self.bindings,
            etag=self.etag,
            version=self.version)


def get_occurrence_iam_policy(occurrence_id: Optional[str] = None,
                              project: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOccurrenceIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:containeranalysis/v1alpha1:getOccurrenceIamPolicy', __args__, opts=opts, typ=GetOccurrenceIamPolicyResult).value

    return AwaitableGetOccurrenceIamPolicyResult(
