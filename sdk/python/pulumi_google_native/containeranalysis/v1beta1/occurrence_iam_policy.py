...
class OccurrenceIamPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["occurrenceId", "project"])
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["occurrence_id"] = None
    ...
    @property
    @pulumi.getter(name="occurrenceId")
    def occurrence_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "occurrence_id")
