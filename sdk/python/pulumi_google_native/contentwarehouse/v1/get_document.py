...
class GetDocumentResult:
    def __init__(__self__, cloud_ai_document=None, content_category=None, create_time=None, creator=None, display_name=None, display_uri=None, document_schema_name=None, inline_raw_document=None, name=None, plain_text=None, properties=None, raw_document_file_type=None, raw_document_path=None, reference_id=None, structured_content_uri=None, text_extraction_disabled=None, text_extraction_enabled=None, title=None, update_time=None, updater=None):
