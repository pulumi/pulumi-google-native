...
class GoogleCloudDatacatalogV1ColumnSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] column: Required. Name of the column. Must be a UTF-8 string without dots (.). The maximum size is 64 bytes.
        ...
        :param pulumi.Input[str] type: Required. Type of the column. Must be a UTF-8 string with the maximum size of 128 bytes.
        """
