...
class EntryGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] entry_group_id: Required. The ID of the entry group to create. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and must start with a letter or underscore. The maximum size is 64 bytes when encoded in UTF-8.
        ...
        :param pulumi.Input[str] name: Identifier. The resource name of the entry group in URL format. Note: The entry group itself and its child resources might not be stored in the location specified in its name.
        """
...
class EntryGroup(pulumi.CustomResource):
    ...
    def data_catalog_timestamps(self) -> pulumi.Output['outputs.GoogleCloudDatacatalogV1SystemTimestampsResponse']:
        """
