...
class GetEntryResult:
    def __init__(__self__, bigquery_date_sharded_spec=None, bigquery_table_spec=None, data_source=None, database_table_spec=None, description=None, display_name=None, fully_qualified_name=None, gcs_fileset_spec=None, integrated_system=None, linked_resource=None, name=None, schema=None, source_system_timestamps=None, type=None, usage_signal=None, user_specified_system=None, user_specified_type=None):
