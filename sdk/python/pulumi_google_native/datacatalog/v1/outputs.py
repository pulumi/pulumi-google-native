...
__all__ = [
    ...
    'GoogleCloudDatacatalogV1ColumnSchemaFieldElementTypeResponse',
    ...
    'GoogleCloudDatacatalogV1FeatureOnlineStoreSpecResponse',
...
@pulumi.output_type
class GoogleCloudDatacatalogV1ColumnSchemaFieldElementTypeResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Represents the type of a field element.
        :param str type: The type of a field element. See ColumnSchema.type.
        """
        pulumi.set(__self__, "type", type)
...
class GoogleCloudDatacatalogV1ColumnSchemaResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 range_element_type: 'outputs.GoogleCloudDatacatalogV1ColumnSchemaFieldElementTypeResponse',
        ...
        :param 'GoogleCloudDatacatalogV1ColumnSchemaFieldElementTypeResponse' range_element_type: Optional. The subtype of the RANGE, if the type of this field is RANGE. If the type is RANGE, this field is required. Possible values for the field element type of a RANGE include: * DATE * DATETIME * TIMESTAMP
    ...
    def range_element_type(self) -> 'outputs.GoogleCloudDatacatalogV1ColumnSchemaFieldElementTypeResponse':
        """
...
@pulumi.output_type
class GoogleCloudDatacatalogV1FeatureOnlineStoreSpecResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudDatacatalogV1FeatureOnlineStoreSpecResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudDatacatalogV1FeatureOnlineStoreSpecResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Detail description of the source information of a Vertex Feature Online Store.
        :param str storage_type: Type of underelaying storage for the FeatureOnlineStore.
        """
