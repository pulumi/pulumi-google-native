...
class GoogleCloudDatacatalogV1ColumnSchemaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A column within a schema. Columns can be nested inside other columns.
        :param str column: Required. Name of the column. Must be a UTF-8 string without dots (.). The maximum size is 64 bytes.
        ...
        :param str type: Required. Type of the column. Must be a UTF-8 string with the maximum size of 128 bytes.
        """
...
class GoogleCloudDatacatalogV1GcsFileSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specification of a single file in Cloud Storage.
        :param str file_path: Required. Full file path. Example: `gs://bucket_name/a/b.txt`.
