...
class TaxonomyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] display_name: Required. User-defined name of this taxonomy. The name can't start or end with spaces, must contain only Unicode letters, numbers, underscores, dashes, and spaces, and be at most 200 bytes long when encoded in UTF-8.
        """
