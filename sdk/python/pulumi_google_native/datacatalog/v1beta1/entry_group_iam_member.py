...
class EntryGroupIamMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(EntryGroupIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'EntryGroupIamMember':
        """
        ...
        return EntryGroupIamMember(resource_name, opts=opts, __props__=__props__)
