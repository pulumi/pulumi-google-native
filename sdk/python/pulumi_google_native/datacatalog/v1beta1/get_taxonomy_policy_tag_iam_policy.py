...
@pulumi.output_type
class GetTaxonomyPolicyTagIamPolicyResult:
...
class AwaitableGetTaxonomyPolicyTagIamPolicyResult(GetTaxonomyPolicyTagIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTaxonomyPolicyTagIamPolicyResult(
            bindings=self.bindings,
            etag=self.etag,
            version=self.version)


def get_taxonomy_policy_tag_iam_policy(location: Optional[str] = None,
                                       policy_tag_id: Optional[str] = None,
                                       project: Optional[str] = None,
                                       taxonomy_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTaxonomyPolicyTagIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:datacatalog/v1beta1:getTaxonomyPolicyTagIamPolicy', __args__, opts=opts, typ=GetTaxonomyPolicyTagIamPolicyResult).value

    return AwaitableGetTaxonomyPolicyTagIamPolicyResult(
