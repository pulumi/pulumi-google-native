...
__all__ = ['TaxonomyIamMemberArgs', 'TaxonomyIamMember']

@pulumi.input_type
class TaxonomyIamMemberArgs:
...
class TaxonomyIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TaxonomyIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TaxonomyIamMemberArgs.__new__(TaxonomyIamMemberArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TaxonomyIamMember':
        """
