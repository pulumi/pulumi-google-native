...
__all__ = ['TaxonomyPolicyTagIamPolicyArgs', 'TaxonomyPolicyTagIamPolicy']
...
class TaxonomyPolicyTagIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: TaxonomyPolicyTagIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the IAM policy for a taxonomy or a policy tag.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param TaxonomyPolicyTagIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TaxonomyPolicyTagIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TaxonomyPolicyTagIamPolicyArgs.__new__(TaxonomyPolicyTagIamPolicyArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "policy_tag_id", "project", "taxonomy_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(TaxonomyPolicyTagIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TaxonomyPolicyTagIamPolicy':
        """
        ...
        __props__.__dict__["policy_tag_id"] = None
        __props__.__dict__["project"] = None
        __props__.__dict__["taxonomy_id"] = None
        __props__.__dict__["version"] = None
        return TaxonomyPolicyTagIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="policyTagId")
    def policy_tag_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "policy_tag_id")
