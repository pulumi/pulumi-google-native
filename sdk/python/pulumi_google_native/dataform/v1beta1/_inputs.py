...
class InvocationConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] fully_refresh_incremental_tables_enabled: Immutable. When set to true, any incremental tables will be fully refreshed.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] included_tags: Immutable. The set of tags to include.
        :param pulumi.Input[Sequence[pulumi.Input['TargetArgs']]] included_targets: Immutable. The set of action identifiers to include.
        :param pulumi.Input[bool] transitive_dependencies_included: Immutable. When set to true, transitive dependencies of included actions will be executed.
        :param pulumi.Input[bool] transitive_dependents_included: Immutable. When set to true, transitive dependents of included actions will be executed.
        """
