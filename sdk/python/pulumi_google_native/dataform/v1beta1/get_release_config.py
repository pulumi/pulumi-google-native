...
class GetReleaseConfigResult:
    def __init__(__self__, code_compilation_config=None, cron_schedule=None, git_commitish=None, name=None, recent_scheduled_release_records=None, release_compilation_result=None):
