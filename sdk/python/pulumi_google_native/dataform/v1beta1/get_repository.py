...
class GetRepositoryResult:
    def __init__(__self__, git_remote_settings=None, name=None, npmrc_environment_variables_secret_version=None, service_account=None, workspace_compilation_overrides=None):
