...
class InvocationConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Includes various configuration options for this workflow invocation. If both `included_targets` and `included_tags` are unset, all actions will be included.
        :param bool fully_refresh_incremental_tables_enabled: Immutable. When set to true, any incremental tables will be fully refreshed.
        :param Sequence[str] included_tags: Immutable. The set of tags to include.
        :param Sequence['TargetResponse'] included_targets: Immutable. The set of action identifiers to include.
        :param bool transitive_dependencies_included: Immutable. When set to true, transitive dependencies of included actions will be executed.
        :param bool transitive_dependents_included: Immutable. When set to true, transitive dependents of included actions will be executed.
        """
