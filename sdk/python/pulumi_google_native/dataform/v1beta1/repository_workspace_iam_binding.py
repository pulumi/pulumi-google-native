...
__all__ = ['RepositoryWorkspaceIamBindingArgs', 'RepositoryWorkspaceIamBinding']

@pulumi.input_type
class RepositoryWorkspaceIamBindingArgs:
...
class RepositoryWorkspaceIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RepositoryWorkspaceIamBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param RepositoryWorkspaceIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RepositoryWorkspaceIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RepositoryWorkspaceIamBindingArgs.__new__(RepositoryWorkspaceIamBindingArgs)
        ...
        super(RepositoryWorkspaceIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RepositoryWorkspaceIamBinding':
        """
        Get an existing RepositoryWorkspaceIamBinding resource's state with the given name, id, and optional extra
        ...
        return RepositoryWorkspaceIamBinding(resource_name, opts=opts, __props__=__props__)
