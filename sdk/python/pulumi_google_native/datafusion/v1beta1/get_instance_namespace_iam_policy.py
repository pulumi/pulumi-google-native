...
__all__ = [
    'GetInstanceNamespaceIamPolicyResult',
    'AwaitableGetInstanceNamespaceIamPolicyResult',
    'get_instance_namespace_iam_policy',
    'get_instance_namespace_iam_policy_output',
]

@pulumi.output_type
class GetInstanceNamespaceIamPolicyResult:
...
class AwaitableGetInstanceNamespaceIamPolicyResult(GetInstanceNamespaceIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInstanceNamespaceIamPolicyResult(
...
def get_instance_namespace_iam_policy(instance_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:datafusion/v1beta1:getInstanceNamespaceIamPolicy', __args__, opts=opts, typ=GetInstanceNamespaceIamPolicyResult).value

    return AwaitableGetInstanceNamespaceIamPolicyResult(
...
@_utilities.lift_output_func(get_instance_namespace_iam_policy)
