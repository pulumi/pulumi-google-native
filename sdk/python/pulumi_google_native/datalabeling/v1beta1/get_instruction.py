...
class GetInstructionResult:
    def __init__(__self__, blocking_resources=None, create_time=None, data_type=None, description=None, display_name=None, name=None, pdf_instruction=None, update_time=None):
