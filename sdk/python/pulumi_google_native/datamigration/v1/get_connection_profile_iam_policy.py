...
@pulumi.output_type
class GetConnectionProfileIamPolicyResult:
...
class AwaitableGetConnectionProfileIamPolicyResult(GetConnectionProfileIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetConnectionProfileIamPolicyResult(
...
def get_connection_profile_iam_policy(connection_profile_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:datamigration/v1:getConnectionProfileIamPolicy', __args__, opts=opts, typ=GetConnectionProfileIamPolicyResult).value
