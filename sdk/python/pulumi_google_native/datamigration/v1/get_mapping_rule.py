...
def get_mapping_rule(conversion_workspace_id: Optional[str] = None,
    ...
    return AwaitableGetMappingRuleResult(
        conditional_column_set_value=__ret__.conditional_column_set_value,
        convert_rowid_column=__ret__.convert_rowid_column,
        display_name=__ret__.display_name,
        entity_move=__ret__.entity_move,
        filter=__ret__.filter,
        filter_table_columns=__ret__.filter_table_columns,
        multi_column_data_type_change=__ret__.multi_column_data_type_change,
        multi_entity_rename=__ret__.multi_entity_rename,
        name=__ret__.name,
        revision_create_time=__ret__.revision_create_time,
        revision_id=__ret__.revision_id,
        rule_order=__ret__.rule_order,
        rule_scope=__ret__.rule_scope,
        set_table_primary_key=__ret__.set_table_primary_key,
        single_column_change=__ret__.single_column_change,
        single_entity_rename=__ret__.single_entity_rename,
        single_package_change=__ret__.single_package_change,
        source_sql_change=__ret__.source_sql_change,
        state=__ret__.state)
