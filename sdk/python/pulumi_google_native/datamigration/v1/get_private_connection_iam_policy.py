...
__all__ = [
    ...
    'AwaitableGetPrivateConnectionIamPolicyResult',
    'get_private_connection_iam_policy',
    'get_private_connection_iam_policy_output',
]
...
class AwaitableGetPrivateConnectionIamPolicyResult(GetPrivateConnectionIamPolicyResult):
...
def get_private_connection_iam_policy(location: Optional[str] = None,
                                      options_requested_policy_version: Optional[int] = None,
                                      private_connection_id: Optional[str] = None,
                                      project: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPrivateConnectionIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:datamigration/v1:getPrivateConnectionIamPolicy', __args__, opts=opts, typ=GetPrivateConnectionIamPolicyResult).value

    return AwaitableGetPrivateConnectionIamPolicyResult(
...
@_utilities.lift_output_func(get_private_connection_iam_policy)
def get_private_connection_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPrivateConnectionIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
