...
class PrimaryInstanceSettingsResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "primaryInstanceSettingsId":
            suggest = "primary_instance_settings_id"
        elif key == "privateIp":
            suggest = "private_ip"
    ...
    def __init__(__self__, *,
                 ...
                 primary_instance_settings_id: str,
                 private_ip: str):
        """
        Settings for the cluster's primary instance
        ...
        :param str primary_instance_settings_id: The ID of the AlloyDB primary instance. The ID must satisfy the regex expression "[a-z0-9-]+".
    ...
    def primary_instance_settings_id(self) -> str:
        """
