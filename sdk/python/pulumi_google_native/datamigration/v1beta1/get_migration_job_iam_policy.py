...
__all__ = [
    ...
    'AwaitableGetMigrationJobIamPolicyResult',
    'get_migration_job_iam_policy',
    'get_migration_job_iam_policy_output',
]
...
class AwaitableGetMigrationJobIamPolicyResult(GetMigrationJobIamPolicyResult):
...
def get_migration_job_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:datamigration/v1beta1:getMigrationJobIamPolicy', __args__, opts=opts, typ=GetMigrationJobIamPolicyResult).value

    return AwaitableGetMigrationJobIamPolicyResult(
