...
class GoogleCloudDataplexV1DataQualityRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] threshold: Optional. The minimum ratio of passing_rows / total_rows required to pass this rule, with a range of 0.0, 1.00 indicates default value (i.e. 1.0)
...
class GoogleCloudDataplexV1DataScanExecutionSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] field: Immutable. The unnested field (Date or Timestamp) that contains values that monotonically increase over time.
...
class GoogleCloudDataplexV1DataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] entity: Immutable. The dataplex entity that contains the data for DataScan, of the form: projects/{project_number}/locations/{location_id}/lakes/{lake_id}/zones/{zone_id}/entities/{entity_id}.
        """
...
class GoogleCloudDataplexV1TriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GoogleCloudDataplexV1TriggerOnDemandArgs'] on_demand: The scan runs one-time shortly after DataScan Creation.
