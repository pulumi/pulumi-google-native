...
class GoogleCloudDataplexV1DataQualityRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GoogleCloudDataplexV1DataQualityRuleUniquenessExpectationArgs'] uniqueness_expectation: Aggregate rule which evaluates whether the column has duplicates.
        """
