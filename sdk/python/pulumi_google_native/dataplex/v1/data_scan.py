...
class DataScanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GoogleCloudDataplexV1DataScanExecutionSpecArgs'] execution_spec: Optional. DataScan execution settings. If not specified, the fields under it will use their default values.
...
class DataScan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] description: Optional. Description of the scan. * Must be between 1-1024 characters.
        :param pulumi.Input[str] display_name: Optional. User friendly display name. * Must be between 1-256 characters.
        :param pulumi.Input[pulumi.InputType['GoogleCloudDataplexV1DataScanExecutionSpecArgs']] execution_spec: Optional. DataScan execution settings. If not specified, the fields under it will use their default values.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: Optional. User-defined labels for the scan.
        """
        ...
    @overload
