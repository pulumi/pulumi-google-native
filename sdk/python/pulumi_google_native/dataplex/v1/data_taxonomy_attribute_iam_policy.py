...
__all__ = ['DataTaxonomyAttributeIamPolicyArgs', 'DataTaxonomyAttributeIamPolicy']

@pulumi.input_type
class DataTaxonomyAttributeIamPolicyArgs:
    def __init__(__self__, *,
                 attribute_id: pulumi.Input[str],
    ...
    def attribute_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "attribute_id")

    @attribute_id.setter
    def attribute_id(self, value: pulumi.Input[str]):
...
class DataTaxonomyAttributeIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 attribute_id: Optional[pulumi.Input[str]] = None,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DataTaxonomyAttributeIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param DataTaxonomyAttributeIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataTaxonomyAttributeIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataTaxonomyAttributeIamPolicyArgs.__new__(DataTaxonomyAttributeIamPolicyArgs)

            if attribute_id is None and not opts.urn:
                raise TypeError("Missing required property 'attribute_id'")
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DataTaxonomyAttributeIamPolicy':
        """
        ...
        return DataTaxonomyAttributeIamPolicy(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="attributeId")
    def attribute_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "attribute_id")
