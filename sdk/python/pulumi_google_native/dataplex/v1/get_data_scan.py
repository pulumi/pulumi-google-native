...
class GetDataScanResult:
    def __init__(__self__, create_time=None, data=None, data_profile_result=None, data_profile_spec=None, data_quality_result=None, data_quality_spec=None, description=None, display_name=None, execution_spec=None, labels=None, name=None, state=None, type=None, uid=None, update_time=None):
