...
__all__ = [
    ...
    'AwaitableGetDataScanIamPolicyResult',
    'get_data_scan_iam_policy',
    'get_data_scan_iam_policy_output',
]
...
def get_data_scan_iam_policy(data_scan_id: Optional[str] = None,
                             location: Optional[str] = None,
                             options_requested_policy_version: Optional[int] = None,
                             project: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataScanIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getDataScanIamPolicy', __args__, opts=opts, typ=GetDataScanIamPolicyResult).value
...
@_utilities.lift_output_func(get_data_scan_iam_policy)
def get_data_scan_iam_policy_output(data_scan_id: Optional[pulumi.Input[str]] = None,
