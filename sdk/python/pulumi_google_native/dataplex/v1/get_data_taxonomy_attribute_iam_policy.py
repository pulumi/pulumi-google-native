...
__all__ = [
    ...
    'AwaitableGetDataTaxonomyAttributeIamPolicyResult',
    'get_data_taxonomy_attribute_iam_policy',
    'get_data_taxonomy_attribute_iam_policy_output',
]
...
class AwaitableGetDataTaxonomyAttributeIamPolicyResult(GetDataTaxonomyAttributeIamPolicyResult):
...
def get_data_taxonomy_attribute_iam_policy(attribute_id: Optional[str] = None,
                                           data_taxonomy_id: Optional[str] = None,
                                           location: Optional[str] = None,
                                           options_requested_policy_version: Optional[int] = None,
                                           project: Optional[str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataTaxonomyAttributeIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getDataTaxonomyAttributeIamPolicy', __args__, opts=opts, typ=GetDataTaxonomyAttributeIamPolicyResult).value

    return AwaitableGetDataTaxonomyAttributeIamPolicyResult(
...
@_utilities.lift_output_func(get_data_taxonomy_attribute_iam_policy)
def get_data_taxonomy_attribute_iam_policy_output(attribute_id: Optional[pulumi.Input[str]] = None,
                                                  ...
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDataTaxonomyAttributeIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
