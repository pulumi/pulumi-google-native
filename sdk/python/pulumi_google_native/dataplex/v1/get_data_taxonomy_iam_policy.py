...
__all__ = [
    ...
    'AwaitableGetDataTaxonomyIamPolicyResult',
    'get_data_taxonomy_iam_policy',
    'get_data_taxonomy_iam_policy_output',
]
...
class AwaitableGetDataTaxonomyIamPolicyResult(GetDataTaxonomyIamPolicyResult):
...
def get_data_taxonomy_iam_policy(data_taxonomy_id: Optional[str] = None,
                                 location: Optional[str] = None,
                                 options_requested_policy_version: Optional[int] = None,
                                 project: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataTaxonomyIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getDataTaxonomyIamPolicy', __args__, opts=opts, typ=GetDataTaxonomyIamPolicyResult).value

    return AwaitableGetDataTaxonomyIamPolicyResult(
...
@_utilities.lift_output_func(get_data_taxonomy_iam_policy)
def get_data_taxonomy_iam_policy_output(data_taxonomy_id: Optional[pulumi.Input[str]] = None,
                                        location: Optional[pulumi.Input[str]] = None,
                                        options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                        project: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDataTaxonomyIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
