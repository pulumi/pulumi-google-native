...
class GetEntityResult:
    def __init__(__self__, access=None, asset=None, catalog_entry=None, compatibility=None, create_time=None, data_path=None, data_path_pattern=None, description=None, display_name=None, etag=None, format=None, name=None, schema=None, system=None, type=None, update_time=None):
