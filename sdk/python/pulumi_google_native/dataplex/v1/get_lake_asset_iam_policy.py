...
__all__ = [
    ...
    'AwaitableGetLakeAssetIamPolicyResult',
    'get_lake_asset_iam_policy',
    'get_lake_asset_iam_policy_output',
]

@pulumi.output_type
class GetLakeAssetIamPolicyResult:
...
class AwaitableGetLakeAssetIamPolicyResult(GetLakeAssetIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLakeAssetIamPolicyResult(
...
def get_lake_asset_iam_policy(asset_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getLakeAssetIamPolicy', __args__, opts=opts, typ=GetLakeAssetIamPolicyResult).value

    return AwaitableGetLakeAssetIamPolicyResult(
...
@_utilities.lift_output_func(get_lake_asset_iam_policy)
