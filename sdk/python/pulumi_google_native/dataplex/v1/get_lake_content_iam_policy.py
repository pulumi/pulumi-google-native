...
__all__ = [
    ...
    'AwaitableGetLakeContentIamPolicyResult',
    'get_lake_content_iam_policy',
    'get_lake_content_iam_policy_output',
]
...
class AwaitableGetLakeContentIamPolicyResult(GetLakeContentIamPolicyResult):
...
def get_lake_content_iam_policy(content_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getLakeContentIamPolicy', __args__, opts=opts, typ=GetLakeContentIamPolicyResult).value

    return AwaitableGetLakeContentIamPolicyResult(
...
@_utilities.lift_output_func(get_lake_content_iam_policy)
