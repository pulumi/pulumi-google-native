...
__all__ = [
    ...
    'AwaitableGetLakeContentitemIamPolicyResult',
    'get_lake_contentitem_iam_policy',
    'get_lake_contentitem_iam_policy_output',
]

@pulumi.output_type
class GetLakeContentitemIamPolicyResult:
...
class AwaitableGetLakeContentitemIamPolicyResult(GetLakeContentitemIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLakeContentitemIamPolicyResult(
...
def get_lake_contentitem_iam_policy(contentitem_id: Optional[str] = None,
                                    lake_id: Optional[str] = None,
                                    location: Optional[str] = None,
                                    options_requested_policy_version: Optional[int] = None,
                                    project: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLakeContentitemIamPolicyResult:
    """
    ...
    """
    __args__ = dict()
    __args__['contentitemId'] = contentitem_id
    __args__['lakeId'] = lake_id
    __args__['location'] = location
    __args__['optionsRequestedPolicyVersion'] = options_requested_policy_version
    __args__['project'] = project
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getLakeContentitemIamPolicy', __args__, opts=opts, typ=GetLakeContentitemIamPolicyResult).value

    return AwaitableGetLakeContentitemIamPolicyResult(
...
@_utilities.lift_output_func(get_lake_contentitem_iam_policy)
def get_lake_contentitem_iam_policy_output(contentitem_id: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetLakeContentitemIamPolicyResult]:
    """
    Gets the access control policy for a contentitem resource. A NOT_FOUND error is returned if the resource does not exist. An empty policy is returned if the resource exists but does not have a policy set on it.Caller must have Google IAM dataplex.content.getIamPolicy permission on the resource.
    """
    ...
