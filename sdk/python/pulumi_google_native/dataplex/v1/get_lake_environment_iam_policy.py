...
__all__ = [
    ...
    'AwaitableGetLakeEnvironmentIamPolicyResult',
    'get_lake_environment_iam_policy',
    'get_lake_environment_iam_policy_output',
]
...
class AwaitableGetLakeEnvironmentIamPolicyResult(GetLakeEnvironmentIamPolicyResult):
...
def get_lake_environment_iam_policy(environment_id: Optional[str] = None,
                                    lake_id: Optional[str] = None,
                                    location: Optional[str] = None,
                                    options_requested_policy_version: Optional[str] = None,
                                    project: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLakeEnvironmentIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getLakeEnvironmentIamPolicy', __args__, opts=opts, typ=GetLakeEnvironmentIamPolicyResult).value

    return AwaitableGetLakeEnvironmentIamPolicyResult(
...
@_utilities.lift_output_func(get_lake_environment_iam_policy)
def get_lake_environment_iam_policy_output(environment_id: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetLakeEnvironmentIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
