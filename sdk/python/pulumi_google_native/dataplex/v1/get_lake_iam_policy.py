...
def get_lake_iam_policy(lake_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getLakeIamPolicy', __args__, opts=opts, typ=GetLakeIamPolicyResult).value
...
def get_lake_iam_policy_output(lake_id: Optional[pulumi.Input[str]] = None,
