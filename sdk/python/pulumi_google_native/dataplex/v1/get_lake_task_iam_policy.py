...
__all__ = [
    ...
    'AwaitableGetLakeTaskIamPolicyResult',
    'get_lake_task_iam_policy',
    'get_lake_task_iam_policy_output',
]
...
class AwaitableGetLakeTaskIamPolicyResult(GetLakeTaskIamPolicyResult):
...
def get_lake_task_iam_policy(lake_id: Optional[str] = None,
                             location: Optional[str] = None,
                             options_requested_policy_version: Optional[str] = None,
                             project: Optional[str] = None,
                             task_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLakeTaskIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getLakeTaskIamPolicy', __args__, opts=opts, typ=GetLakeTaskIamPolicyResult).value

    return AwaitableGetLakeTaskIamPolicyResult(
...
@_utilities.lift_output_func(get_lake_task_iam_policy)
def get_lake_task_iam_policy_output(lake_id: Optional[pulumi.Input[str]] = None,
                                    location: Optional[pulumi.Input[str]] = None,
                                    options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
                                    project: Optional[pulumi.Input[Optional[str]]] = None,
                                    task_id: Optional[pulumi.Input[str]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetLakeTaskIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
