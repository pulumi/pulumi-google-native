...
__all__ = [
    ...
    'AwaitableGetLakeZoneIamPolicyResult',
    'get_lake_zone_iam_policy',
    'get_lake_zone_iam_policy_output',
]
...
class AwaitableGetLakeZoneIamPolicyResult(GetLakeZoneIamPolicyResult):
...
def get_lake_zone_iam_policy(lake_id: Optional[str] = None,
                             location: Optional[str] = None,
                             options_requested_policy_version: Optional[int] = None,
                             project: Optional[str] = None,
                             zone: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLakeZoneIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataplex/v1:getLakeZoneIamPolicy', __args__, opts=opts, typ=GetLakeZoneIamPolicyResult).value

    return AwaitableGetLakeZoneIamPolicyResult(
...
@_utilities.lift_output_func(get_lake_zone_iam_policy)
def get_lake_zone_iam_policy_output(lake_id: Optional[pulumi.Input[str]] = None,
                                    location: Optional[pulumi.Input[str]] = None,
                                    options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                    project: Optional[pulumi.Input[Optional[str]]] = None,
                                    zone: Optional[pulumi.Input[str]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetLakeZoneIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
