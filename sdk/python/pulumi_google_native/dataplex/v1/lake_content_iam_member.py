...
__all__ = ['LakeContentIamMemberArgs', 'LakeContentIamMember']

@pulumi.input_type
class LakeContentIamMemberArgs:
...
class LakeContentIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LakeContentIamMemberArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified contentitem resource. Replaces any existing policy.Caller must have Google IAM dataplex.content.setIamPolicy permission on the resource.

        :param str resource_name: The name of the resource.
        :param LakeContentIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LakeContentIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LakeContentIamMemberArgs.__new__(LakeContentIamMemberArgs)
        ...
        super(LakeContentIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LakeContentIamMember':
        """
        ...
        return LakeContentIamMember(resource_name, opts=opts, __props__=__props__)
