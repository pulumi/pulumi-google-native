...
class GoogleCloudDataplexV1DataQualityRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDataplexV1DataQualityRuleUniquenessExpectationResponse' uniqueness_expectation: Aggregate rule which evaluates whether the column has duplicates.
        """
