...
class GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoDoubleFieldInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        DoubleFieldInfo defines output for any double type field.
        :param float average: The average of non-null values of double field in the sampled data. Return NaN, if the field has a NaN. Optional if zero non-null rows.
        :param float max: The maximum value of a double field in the sampled data. Return NaN, if the field has a NaN. Optional if zero non-null rows.
        :param float min: The minimum value of a double field in the sampled data. Return NaN, if the field has a NaN. Optional if zero non-null rows.
        :param Sequence[float] quartiles: A quartile divide the numebr of data points into four parts, or quarters, of more-or-less equal size. Three main quartiles used are: The first quartile (Q1) splits off the lowest 25% of data from the highest 75%. It is also known as the lower or 25th empirical quartile, as 25% of the data is below this point. The second quartile (Q2) is the median of a data set. So, 50% of the data lies below this point. The third quartile (Q3) splits off the highest 25% of data from the lowest 75%. It is known as the upper or 75th empirical quartile, as 75% of the data lies below this point. So, here the quartiles is provided as an ordered list of quartile values, occurring in order Q1, median, Q3.
        :param float standard_deviation: The standard deviation of non-null of double field in the sampled data. Return NaN, if the field has a NaN. Optional if zero non-null rows.
        """
...
class GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoIntegerFieldInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        IntegerFieldInfo defines output for any integer type field.
        :param float average: The average of non-null values of integer field in the sampled data. Return NaN, if the field has a NaN. Optional if zero non-null rows.
        :param str max: The maximum value of an integer field in the sampled data. Return NaN, if the field has a NaN. Optional if zero non-null rows.
        :param str min: The minimum value of an integer field in the sampled data. Return NaN, if the field has a NaN. Optional if zero non-null rows.
        :param Sequence[str] quartiles: A quartile divide the number of data points into four parts, or quarters, of more-or-less equal size. Three main quartiles used are: The first quartile (Q1) splits off the lowest 25% of data from the highest 75%. It is also known as the lower or 25th empirical quartile, as 25% of the data is below this point. The second quartile (Q2) is the median of a data set. So, 50% of the data lies below this point. The third quartile (Q3) splits off the highest 25% of data from the lowest 75%. It is known as the upper or 75th empirical quartile, as 75% of the data lies below this point. So, here the quartiles is provided as an ordered list of quartile values, occurring in order Q1, median, Q3.
        :param float standard_deviation: The standard deviation of non-null of integer field in the sampled data. Return NaN, if the field has a NaN. Optional if zero non-null rows.
        """
        pulumi.set(__self__, "average", average)
        pulumi.set(__self__, "max", max)
        pulumi.set(__self__, "min", min)
...
class GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ProfileInfo defines the profile information for each schema field type.
        :param float distinct_ratio: The ratio of rows that are distinct against the rows in the sampled data.
        :param 'GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoDoubleFieldInfoResponse' double_profile: The corresponding double field profile.
        :param 'GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoIntegerFieldInfoResponse' integer_profile: The corresponding integer field profile.
        :param float null_ratio: The ratio of null rows against the rows in the sampled data.
        :param 'GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoStringFieldInfoResponse' string_profile: The corresponding string field profile.
        :param Sequence['GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoTopNValueResponse'] top_n_values: The array of top N values of the field in the sampled data. Currently N is set as 10 or equal to distinct values in the field, whichever is smaller. This will be optional for complex non-groupable data-types such as JSON, ARRAY, JSON, STRUCT.
        """
...
class GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoStringFieldInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        StringFieldInfo defines output info for any string type field.
        :param float average_length: The average length of a string field in the sampled data. Optional if zero non-null rows.
        :param str max_length: The maximum length of a string field in the sampled data. Optional if zero non-null rows.
        :param str min_length: The minimum length of the string field in the sampled data. Optional if zero non-null rows.
        """
...
class GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoTopNValueResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The TopNValue defines the structure of output of top N values of a field.
        :param str count: The frequency count of the corresponding value in the field.
        :param str value: The value is the string value of the actual value from the field.
        """
...
class GoogleCloudDataplexV1DataProfileResultProfileFieldResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a column field within a table schema.
        :param str mode: The mode of the field. Its value will be: REQUIRED, if it is a required field. NULLABLE, if it is an optional field. REPEATED, if it is a repeated field.
        :param str name: The name of the field.
        :param 'GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoResponse' profile: The profile information for the corresponding field.
...
class GoogleCloudDataplexV1DataProfileResultProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Profile information describing the structure and layout of the data and contains the profile info.
        :param Sequence['GoogleCloudDataplexV1DataProfileResultProfileFieldResponse'] fields: The sequence of fields describing data in table entities.
        """
...
class GoogleCloudDataplexV1DataProfileResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        DataProfileResult defines the output of DataProfileScan. Each field of the table will have field type specific profile result.
        :param 'GoogleCloudDataplexV1DataProfileResultProfileResponse' profile: This represents the profile information per field.
        :param str row_count: The count of all rows in the sampled data. Return 0, if zero rows.
        :param 'GoogleCloudDataplexV1ScannedDataResponse' scanned_data: The data scanned for this profile.
        """
        pulumi.set(__self__, "profile", profile)
...
class GoogleCloudDataplexV1DataQualityRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float threshold: Optional. The minimum ratio of passing_rows / total_rows required to pass this rule, with a range of 0.0, 1.00 indicates default value (i.e. 1.0)
...
class GoogleCloudDataplexV1DataScanExecutionSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        DataScan execution settings.
        :param str field: Immutable. The unnested field (Date or Timestamp) that contains values that monotonically increase over time.
...
class GoogleCloudDataplexV1DataSourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The data source for DataScan.
        :param str entity: Immutable. The dataplex entity that contains the data for DataScan, of the form: projects/{project_number}/locations/{location_id}/lakes/{lake_id}/zones/{zone_id}/entities/{entity_id}.
        """
...
class GoogleCloudDataplexV1ScannedDataIncrementalFieldResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str field: The field that contains values which monotonically increases over time (e.g. timestamp).
...
class GoogleCloudDataplexV1TriggerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        DataScan scheduling and trigger settings.
        :param 'GoogleCloudDataplexV1TriggerOnDemandResponse' on_demand: The scan runs one-time shortly after DataScan Creation.
