...
class GetWorkflowTemplateResult:
    def __init__(__self__, create_time=None, dag_timeout=None, encryption_config=None, jobs=None, labels=None, name=None, parameters=None, placement=None, update_time=None, version=None):
