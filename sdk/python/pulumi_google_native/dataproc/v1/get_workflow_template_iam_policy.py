...
@pulumi.output_type
class GetWorkflowTemplateIamPolicyResult:
...
class AwaitableGetWorkflowTemplateIamPolicyResult(GetWorkflowTemplateIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWorkflowTemplateIamPolicyResult(
            bindings=self.bindings,
            etag=self.etag,
            version=self.version)


def get_workflow_template_iam_policy(location: Optional[str] = None,
                                     project: Optional[str] = None,
                                     workflow_template_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWorkflowTemplateIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dataproc/v1:getWorkflowTemplateIamPolicy', __args__, opts=opts, typ=GetWorkflowTemplateIamPolicyResult).value
