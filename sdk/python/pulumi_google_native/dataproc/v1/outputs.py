...
class ClusterConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GkeClusterConfigResponse' gke_cluster_config: Optional. BETA. The Kubernetes Engine config for Dataproc clusters deployed to The Kubernetes Engine config for Dataproc clusters deployed to Kubernetes. These config settings are mutually exclusive with Compute Engine-based options, such as gce_cluster_config, master_config, worker_config, secondary_worker_config, and autoscaling_config.
...
class ClusterMetricsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, str] yarn_metrics: YARN metrics.
        """
...
class DataprocMetricConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Dataproc metric config.
        :param Sequence['MetricResponse'] metrics: Metrics sources to enable.
        """
...
class DiskConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int num_local_ssds: Optional. Number of attached SSDs, from 0 to 8 (default is 0). If SSDs are not attached, the boot disk is used to store runtime logs and HDFS (https://hadoop.apache.org/docs/r1.2.1/hdfs_user_guide.html) data. If one or more SSDs are attached, this runtime bulk data is spread across them, and the boot disk contains only basic config and installed binaries.Note: Local SSD options may vary by machine type and number of vCPUs selected.
        """
...
class GceClusterConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str network_uri: Optional. The Compute Engine network to be used for machine communications. Cannot be specified with subnetwork_uri. If neither network_uri nor subnetwork_uri is specified, the "default" network of the project is used, if it exists. Cannot be a "Custom Subnet Network" (see Using Subnetworks (https://cloud.google.com/compute/docs/subnetworks) for more information).A full URL, partial URI, or short name are valid. Examples: https://www.googleapis.com/compute/v1/projects/[project_id]/regions/[region]/default projects/[project_id]/regions/[region]/default default
        ...
        :param str subnetwork_uri: Optional. The Compute Engine subnetwork to be used for machine communications. Cannot be specified with network_uri.A full URL, partial URI, or short name are valid. Examples: https://www.googleapis.com/compute/v1/projects/[project_id]/regions/[region]/subnetworks/sub0 projects/[project_id]/regions/[region]/subnetworks/sub0 sub0
        ...
        :param str zone_uri: Optional. The Compute Engine zone where the Dataproc cluster will be located. If omitted, the service will pick a zone in the cluster's Compute Engine region. On a get request, zone will always be present.A full URL, partial URI, or short name are valid. Examples: https://www.googleapis.com/compute/v1/projects/[project_id]/zones/[zone] projects/[project_id]/zones/[zone] [zone]
        """
...
class GkeClusterConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GkeNodePoolTargetResponse'] node_pool_target: Optional. GKE node pools where workloads will be scheduled. At least one node pool must be assigned the DEFAULT GkeNodePoolTarget.Role. If a GkeNodePoolTarget is not specified, Dataproc constructs a DEFAULT GkeNodePoolTarget. Each role can be given to only one GkeNodePoolTarget. All node pools must have the same location settings.
        """
...
class GkeNodePoolAutoscalingConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        GkeNodePoolAutoscaling contains information the cluster autoscaler needs to adjust the size of the node pool to the current cluster usage.
        :param int max_node_count: The maximum number of nodes in the node pool. Must be >= min_node_count, and must be > 0. Note: Quota must be sufficient to scale up the cluster.
        :param int min_node_count: The minimum number of nodes in the node pool. Must be >= 0 and <= max_node_count.
        """
...
class GkeNodePoolConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration of a GKE node pool used by a Dataproc-on-GKE cluster (https://cloud.google.com/dataproc/docs/concepts/jobs/dataproc-gke#create-a-dataproc-on-gke-cluster).
        :param 'GkeNodePoolAutoscalingConfigResponse' autoscaling: Optional. The autoscaler configuration for this node pool. The autoscaler is enabled only when a valid configuration is present.
        :param 'GkeNodeConfigResponse' config: Optional. The node pool configuration.
        :param Sequence[str] locations: Optional. The list of Compute Engine zones (https://cloud.google.com/compute/docs/zones#available) where node pool nodes associated with a Dataproc on GKE virtual cluster will be located.Note: All node pools associated with a virtual cluster must be located in the same region as the virtual cluster, and they must be located in the same zone within that region.If a location is not specified during node pool creation, Dataproc on GKE will choose the zone.
        """
...
class GkeNodePoolTargetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        GKE node pools that Dataproc workloads run on.
        :param str node_pool: The target GKE node pool. Format: 'projects/{project}/locations/{location}/clusters/{cluster}/nodePools/{node_pool}'
        :param 'GkeNodePoolConfigResponse' node_pool_config: Input only. The configuration for the GKE node pool.If specified, Dataproc attempts to create a node pool with the specified shape. If one with the same name already exists, it is verified against all specified fields. If a field differs, the virtual cluster creation will fail.If omitted, any node pool with the specified name is used. If a node pool with the specified name does not exist, Dataproc create a node pool with default values.This is an input only field. It will not be returned by the API.
...
class TrinoJobResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TrinoJobResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TrinoJobResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        A Dataproc job for running Trino (https://trino.io/) queries. IMPORTANT: The Dataproc Trino Optional Component (https://cloud.google.com/dataproc/docs/concepts/components/trino) must be enabled when the cluster is created to submit a Trino job to the cluster.
        :param Sequence[str] client_tags: Optional. Trino client tags to attach to this query
        :param bool continue_on_failure: Optional. Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries.
        :param 'LoggingConfigResponse' logging_config: Optional. The runtime log config for job execution.
        :param str output_format: Optional. The format in which query output will be displayed. See the Trino documentation for supported output formats
        :param Mapping[str, str] properties: Optional. A mapping of property names to values. Used to set Trino session properties (https://trino.io/docs/current/sql/set-session.html) Equivalent to using the --session flag in the Trino CLI
        :param str query_file_uri: The HCFS URI of the script that contains SQL queries.
        :param 'QueryListResponse' query_list: A list of queries.
        """
        pulumi.set(__self__, "client_tags", client_tags)
