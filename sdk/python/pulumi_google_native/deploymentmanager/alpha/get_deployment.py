...
class GetDeploymentResult:
    def __init__(__self__, credential=None, description=None, fingerprint=None, id=None, insert_time=None, labels=None, manifest=None, name=None, operation=None, outputs=None, self_link=None, target=None, update=None, update_time=None):
