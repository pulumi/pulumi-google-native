...
__all__ = [
    ...
    'CompositeTypeDataItemResponse',
    'CompositeTypeErrorResponse',
    'CompositeTypeErrorsItemResponse',
    'CompositeTypeLabelEntryResponse',
    'CompositeTypeWarningsItemResponse',
    'ConfigFileResponse',
    'CredentialResponse',
...
class CollectionOverrideResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'MethodMapResponse' method_map: Custom verb method mappings to support unordered list API mappings.
...
@pulumi.output_type
class CompositeTypeDataItemResponse(dict):
    def __init__(__self__, *,
                 key: str,
                 value: str):
        """
...
@pulumi.output_type
class CompositeTypeErrorResponse(dict):
    """
    [Output Only] If errors are generated during processing of the operation, this field will be populated.
    """
    def __init__(__self__, *,
                 errors: Sequence['outputs.CompositeTypeErrorsItemResponse']):
        """
        [Output Only] If errors are generated during processing of the operation, this field will be populated.
        :param Sequence['CompositeTypeErrorsItemResponse'] errors: [Output Only] The array of errors encountered while processing this operation.
        """
        pulumi.set(__self__, "errors", errors)

    @property
    @pulumi.getter
    def errors(self) -> Sequence['outputs.CompositeTypeErrorsItemResponse']:
        """
...
@pulumi.output_type
class CompositeTypeErrorsItemResponse(dict):
    def __init__(__self__, *,
                 code: str,
                 location: str,
                 message: str):
...
@pulumi.output_type
class CompositeTypeWarningsItemResponse(dict):
    def __init__(__self__, *,
                 code: str,
                 data: Sequence['outputs.CompositeTypeDataItemResponse'],
                 message: str):
        """
        ...
        :param Sequence['CompositeTypeDataItemResponse'] data: [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" } 
    ...
    @property
    @pulumi.getter
    def data(self) -> Sequence['outputs.CompositeTypeDataItemResponse']:
        """
...
class DeploymentUpdateResponse(dict):
    def __init__(__self__, *,
                 ...
                 manifest: str):
        """
        :param 'CredentialResponse' credential: The user-provided default credential to use when deploying this preview.
...
class OperationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_link: str,
                 user: str,
                 warnings: Sequence['outputs.CompositeTypeWarningsItemResponse'],
                 zone: str):
        """
        Represents an Operation resource. Google Compute Engine has three Operation resources: * [Global](/compute/docs/reference/rest/{$api_version}/globalOperations) * [Regional](/compute/docs/reference/rest/{$api_version}/regionOperations) * [Zonal](/compute/docs/reference/rest/{$api_version}/zoneOperations) You can use an operation resource to manage asynchronous API requests. For more information, read Handling API responses. Operations can be global, regional or zonal. - For global operations, use the `globalOperations` resource. - For regional operations, use the `regionOperations` resource. - For zonal operations, use the `zonalOperations` resource. For more information, read Global, Regional, and Zonal Resources.
        ...
        :param Sequence['CompositeTypeWarningsItemResponse'] warnings: [Output Only] If warning messages are generated during processing of the operation, this field will be populated.
    ...
    @property
    @pulumi.getter
    def error(self) -> 'outputs.CompositeTypeErrorResponse':
        """
        [Output Only] If errors are generated during processing of the operation, this field will be populated.
        """
    ...
    @property
    @pulumi.getter
    def warnings(self) -> Sequence['outputs.CompositeTypeWarningsItemResponse']:
        """
