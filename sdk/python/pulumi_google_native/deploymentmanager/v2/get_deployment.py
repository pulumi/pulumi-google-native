...
class GetDeploymentResult:
    def __init__(__self__, description=None, fingerprint=None, id=None, insert_time=None, labels=None, manifest=None, name=None, operation=None, self_link=None, target=None, update=None, update_time=None):
