...
__all__ = ['AgentKnowledgeBaseDocumentArgs', 'AgentKnowledgeBaseDocument']
...
class AgentKnowledgeBaseDocument(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AgentKnowledgeBaseDocumentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a new document. Operation

        :param str resource_name: The name of the resource.
        :param AgentKnowledgeBaseDocumentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AgentKnowledgeBaseDocumentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AgentKnowledgeBaseDocumentArgs.__new__(AgentKnowledgeBaseDocumentArgs)
        ...
        super(AgentKnowledgeBaseDocument, __self__).__init__(
            'google-native:dialogflow/v2:AgentKnowledgeBaseDocument',
            resource_name,
            __props__,
            opts)
