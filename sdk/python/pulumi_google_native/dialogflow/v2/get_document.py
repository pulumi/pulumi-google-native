...
class GetDocumentResult:
    ...
    def latest_reload_status(self) -> 'outputs.GoogleCloudDialogflowV2DocumentReloadStatusResponse':
        """
...
def get_document(document_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dialogflow/v2:getDocument', __args__, opts=opts, typ=GetDocumentResult).value
