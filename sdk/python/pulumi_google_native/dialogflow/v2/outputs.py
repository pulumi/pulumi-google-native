...
class GoogleCloudDialogflowV2AutomatedAgentConfigResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudDialogflowV2AutomatedAgentConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudDialogflowV2AutomatedAgentConfigResponse.__key_warning(key)
        return super().__getitem__(key)
...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfigResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfigResponse.__key_warning(key)
        return super().__getitem__(key)
...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the Human Agent Assist to connect to a conversation.
        :param 'GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse' end_user_suggestion_config: Configuration for agent assistance of end user participant. Currently, this feature is not general available, please contact Google to get access.
        :param 'GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse' human_agent_suggestion_config: Configuration for agent assistance of human agent participant.
        :param 'GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfigResponse' message_analysis_config: Configuration for message analysis.
        :param 'GoogleCloudDialogflowV2NotificationConfigResponse' notification_config: Pub/Sub topic on which to publish new agent assistant events.
        """
...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Detail human agent assistant config.
        :param Sequence['GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse'] feature_configs: Configuration of different suggestion features. One feature can have only one config.
...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool enable_event_based_suggestion: Automatically iterates all participants and tries to compile suggestions. Supported features: ARTICLE_SUGGESTION, FAQ, DIALOGFLOW_ASSIST, KNOWLEDGE_ASSIST.
...
@pulumi.output_type
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfigResponse(dict):
    """
...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 agent: str,
                 human_agent_side_config: 'outputs.GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfigResponse'):
        """
        Dialogflow source setting. Supported feature: DIALOGFLOW_ASSIST.
        ...
        :param 'GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfigResponse' human_agent_side_config: Optional. The Dialogflow assist configuration for human agent.
        """
        pulumi.set(__self__, "agent", agent)
    ...
    def human_agent_side_config(self) -> 'outputs.GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfigResponse':
        """
...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Document source settings. Supported features: SMART_REPLY, SMART_COMPOSE.
        :param Sequence[str] documents: Knowledge documents to query from. Format: `projects//locations//knowledgeBases//documents/`. Currently, at most 5 documents are supported.
        """
...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Knowledge base source settings. Supported features: ARTICLE_SUGGESTION, FAQ.
        :param Sequence[str] knowledge_bases: Knowledge bases to query. Format: `projects//locations//knowledgeBases/`. Currently, at most 5 knowledge bases are supported.
        """
...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettingsResponse' context_filter_settings: Determines how recent conversation context is filtered when generating suggestions. If unspecified, no messages will be dropped.
        :param 'GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceResponse' dialogflow_query_source: Query from Dialogflow agent. It is used by DIALOGFLOW_ASSIST.
...
class GoogleCloudDialogflowV2HumanAgentHandoffConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the hand off to a live agent, typically on which external agent service provider to connect to a conversation. Currently, this feature is not general available, please contact Google to get access.
        :param 'GoogleCloudDialogflowV2HumanAgentHandoffConfigLivePersonConfigResponse' live_person_config: Uses LivePerson (https://www.liveperson.com).
        :param 'GoogleCloudDialogflowV2HumanAgentHandoffConfigSalesforceLiveAgentConfigResponse' salesforce_live_agent_config: Uses Salesforce Live Agent.
        """
...
class GoogleCloudDialogflowV2IntentMessageBasicCardButtonResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The button object that appears at the bottom of a card.
        :param 'GoogleCloudDialogflowV2IntentMessageBasicCardButtonOpenUriActionResponse' open_uri_action: Action to take when a user taps on the button.
...
class GoogleCloudDialogflowV2IntentMessageBasicCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The basic card message. Useful for displaying information.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageBasicCardButtonResponse'] buttons: Optional. The collection of card buttons.
        :param str formatted_text: Required, unless image is present. The body text of the card.
        :param 'GoogleCloudDialogflowV2IntentMessageImageResponse' image: Optional. The image for the card.
...
class GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2IntentMessageImageResponse' image: Optional. Hero image for the carousel item.
        :param 'GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItemOpenUrlActionResponse' open_uri_action: Action to present to the user.
...
class GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItemResponse'] items: List of items in the Browse Carousel Card. Minimum of two items, maximum of ten.
        """
...
class GoogleCloudDialogflowV2IntentMessageCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The card response message.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageCardButtonResponse'] buttons: Optional. The collection of card buttons.
...
class GoogleCloudDialogflowV2IntentMessageCarouselSelectItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2IntentMessageImageResponse' image: Optional. The image to display.
        :param 'GoogleCloudDialogflowV2IntentMessageSelectItemInfoResponse' info: Additional info about the option item.
...
class GoogleCloudDialogflowV2IntentMessageCarouselSelectResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The card for presenting a carousel of options to select from.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageCarouselSelectItemResponse'] items: Carousel items.
        """
        pulumi.set(__self__, "items", items)
...
class GoogleCloudDialogflowV2IntentMessageListSelectItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2IntentMessageImageResponse' image: Optional. The image to display.
        :param 'GoogleCloudDialogflowV2IntentMessageSelectItemInfoResponse' info: Additional information about this option.
...
class GoogleCloudDialogflowV2IntentMessageListSelectResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The card for presenting a list of options to select from.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageListSelectItemResponse'] items: List items.
...
class GoogleCloudDialogflowV2IntentMessageMediaContentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The media content card for Actions on Google.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageMediaContentResponseMediaObjectResponse'] media_objects: List of media objects.
...
class GoogleCloudDialogflowV2IntentMessageMediaContentResponseMediaObjectResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowV2IntentMessageImageResponse' icon: Optional. Icon to display above media content.
        :param 'GoogleCloudDialogflowV2IntentMessageImageResponse' large_image: Optional. Image to display above media content.
...
class GoogleCloudDialogflowV2IntentMessageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A rich response message. Corresponds to the intent `Response` field in the Dialogflow console. For more information, see [Rich response messages](https://cloud.google.com/dialogflow/docs/intents-rich-messages).
        :param 'GoogleCloudDialogflowV2IntentMessageBasicCardResponse' basic_card: The basic card response for Actions on Google.
        :param 'GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardResponse' browse_carousel_card: Browse carousel card for Actions on Google.
        :param 'GoogleCloudDialogflowV2IntentMessageCardResponse' card: The card response.
        :param 'GoogleCloudDialogflowV2IntentMessageCarouselSelectResponse' carousel_select: The carousel card response for Actions on Google.
        :param 'GoogleCloudDialogflowV2IntentMessageImageResponse' image: The image response.
        ...
        :param 'GoogleCloudDialogflowV2IntentMessageSuggestionsResponse' suggestions: The suggestion chips for Actions on Google.
        :param 'GoogleCloudDialogflowV2IntentMessageTableCardResponse' table_card: Table card for Actions on Google.
        :param 'GoogleCloudDialogflowV2IntentMessageTextResponse' text: The text response.
        """
...
class GoogleCloudDialogflowV2IntentMessageSimpleResponsesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The collection of simple response candidates. This message in `QueryResult.fulfillment_messages` and `WebhookResponse.fulfillment_messages` should contain only one `SimpleResponse`.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageSimpleResponseResponse'] simple_responses: The list of simple responses.
        """
        pulumi.set(__self__, "simple_responses", simple_responses)
...
class GoogleCloudDialogflowV2IntentMessageSuggestionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The collection of suggestions.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageSuggestionResponse'] suggestions: The list of suggested replies.
        """
        pulumi.set(__self__, "suggestions", suggestions)
...
class GoogleCloudDialogflowV2IntentMessageTableCardResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Table card for Actions on Google.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageBasicCardButtonResponse'] buttons: Optional. List of buttons for the card.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageColumnPropertiesResponse'] column_properties: Optional. Display properties for the columns in this table.
        :param 'GoogleCloudDialogflowV2IntentMessageImageResponse' image: Optional. Image which should be displayed on the card.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageTableCardRowResponse'] rows: Optional. Rows in this table of data.
...
class GoogleCloudDialogflowV2IntentMessageTableCardRowResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Row of TableCard.
        :param Sequence['GoogleCloudDialogflowV2IntentMessageTableCardCellResponse'] cells: Optional. List of cells that make up this row.
...
@pulumi.output_type
class GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 pitch: float,
                 speaking_rate: float,
                 voice: 'outputs.GoogleCloudDialogflowV2VoiceSelectionParamsResponse',
        ...
        :param 'GoogleCloudDialogflowV2VoiceSelectionParamsResponse' voice: Optional. The desired voice of the synthesized audio.
    ...
    @property
    @pulumi.getter
    def voice(self) -> 'outputs.GoogleCloudDialogflowV2VoiceSelectionParamsResponse':
        """
...
@pulumi.output_type
class GoogleCloudDialogflowV2VoiceSelectionParamsResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudDialogflowV2VoiceSelectionParamsResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudDialogflowV2VoiceSelectionParamsResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Description of which voice to use for speech synthesis.
        :param str name: Optional. The name of the voice. If not set, the service will choose a voice based on the other parameters such as language_code and ssml_gender.
