...
class GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgs:
    def __init__(__self__, *,
                 ...
                 synthesize_speech_configs: Optional[pulumi.Input['GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgs'] synthesize_speech_configs: Optional. Configuration of how speech should be synthesized, mapping from language (https://cloud.google.com/dialogflow/docs/reference/language) to SynthesizeSpeechConfig.
        """
    ...
    def synthesize_speech_configs(self) -> Optional[pulumi.Input['GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgs']]:
        """
    ...
    def synthesize_speech_configs(self, value: Optional[pulumi.Input['GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgs']]):
