...
class ConversationProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 automated_agent_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1AutomatedAgentConfigArgs', 'GoogleCloudDialogflowV2beta1AutomatedAgentConfigArgsDict']]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 human_agent_assistant_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigArgs', 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigArgsDict']]] = None,
                 human_agent_handoff_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigArgs', 'GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigArgsDict']]] = None,
                 language_code: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 logging_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1LoggingConfigArgs', 'GoogleCloudDialogflowV2beta1LoggingConfigArgsDict']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 new_message_event_notification_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1NotificationConfigArgs', 'GoogleCloudDialogflowV2beta1NotificationConfigArgsDict']]] = None,
                 notification_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1NotificationConfigArgs', 'GoogleCloudDialogflowV2beta1NotificationConfigArgsDict']]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 security_settings: Optional[pulumi.Input[str]] = None,
                 stt_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1SpeechToTextConfigArgs', 'GoogleCloudDialogflowV2beta1SpeechToTextConfigArgsDict']]] = None,
                 time_zone: Optional[pulumi.Input[str]] = None,
                 tts_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgs', 'GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1AutomatedAgentConfigArgs', 'GoogleCloudDialogflowV2beta1AutomatedAgentConfigArgsDict']] automated_agent_config: Configuration for an automated agent to use with this profile.
        :param pulumi.Input[str] display_name: Human readable name for this profile. Max length 1024 bytes.
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigArgs', 'GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigArgsDict']] human_agent_assistant_config: Configuration for agent assistance to use with this profile.
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigArgs', 'GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigArgsDict']] human_agent_handoff_config: Configuration for connecting to a live agent. Currently, this feature is not general available, please contact Google to get access.
        :param pulumi.Input[str] language_code: Language code for the conversation profile. If not specified, the language is en-US. Language at ConversationProfile should be set for all non en-us languages. This should be a [BCP-47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt) language tag. Example: "en-US".
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1LoggingConfigArgs', 'GoogleCloudDialogflowV2beta1LoggingConfigArgsDict']] logging_config: Configuration for logging conversation lifecycle events.
        :param pulumi.Input[str] name: The unique identifier of this conversation profile. Format: `projects//locations//conversationProfiles/`.
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1NotificationConfigArgs', 'GoogleCloudDialogflowV2beta1NotificationConfigArgsDict']] new_message_event_notification_config: Configuration for publishing new message events. Event will be sent in format of ConversationEvent
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1NotificationConfigArgs', 'GoogleCloudDialogflowV2beta1NotificationConfigArgsDict']] notification_config: Configuration for publishing conversation lifecycle events.
        :param pulumi.Input[str] security_settings: Name of the CX SecuritySettings reference for the agent. Format: `projects//locations//securitySettings/`.
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1SpeechToTextConfigArgs', 'GoogleCloudDialogflowV2beta1SpeechToTextConfigArgsDict']] stt_config: Settings for speech transcription.
        :param pulumi.Input[str] time_zone: The time zone of this conversational profile from the [time zone database](https://www.iana.org/time-zones), e.g., America/New_York, Europe/Paris. Defaults to America/New_York.
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgs', 'GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigArgsDict']] tts_config: Configuration for Text-to-Speech synthesization. Used by Phone Gateway to specify synthesization options. If agent defines synthesization options as well, agent settings overrides the option here.
        """
        ...
    @overload
    def __init__(__self__,
