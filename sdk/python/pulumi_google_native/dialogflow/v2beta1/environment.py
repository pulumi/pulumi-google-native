...
class Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 fulfillment: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1FulfillmentArgs', 'GoogleCloudDialogflowV2beta1FulfillmentArgsDict']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 text_to_speech_settings: Optional[pulumi.Input[Union['GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgs', 'GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] description: Optional. The developer-provided description for this environment. The maximum length is 500 characters. If exceeded, the request is rejected.
        :param pulumi.Input[str] environment_id: Required. The unique id of the new environment.
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1FulfillmentArgs', 'GoogleCloudDialogflowV2beta1FulfillmentArgsDict']] fulfillment: Optional. The fulfillment settings to use for this environment.
        :param pulumi.Input[Union['GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgs', 'GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgsDict']] text_to_speech_settings: Optional. Text to speech settings for this environment.
        """
        ...
    @overload
    def __init__(__self__,
