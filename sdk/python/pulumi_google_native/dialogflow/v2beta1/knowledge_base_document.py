...
__all__ = ['KnowledgeBaseDocumentArgs', 'KnowledgeBaseDocument']
...
class KnowledgeBaseDocument(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: KnowledgeBaseDocumentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a new document. Note: The `projects.agent.knowledgeBases.documents` resource is deprecated; only use `projects.knowledgeBases.documents`.

        :param str resource_name: The name of the resource.
        :param KnowledgeBaseDocumentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KnowledgeBaseDocumentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KnowledgeBaseDocumentArgs.__new__(KnowledgeBaseDocumentArgs)
        ...
        super(KnowledgeBaseDocument, __self__).__init__(
            'google-native:dialogflow/v2beta1:KnowledgeBaseDocument',
            resource_name,
            __props__,
            opts)
