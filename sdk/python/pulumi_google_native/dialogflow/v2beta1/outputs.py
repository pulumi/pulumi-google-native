...
class GoogleCloudDialogflowV2beta1TextToSpeechSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 synthesize_speech_configs: 'outputs.GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse'):
        """
        Instructs the speech synthesizer on how to generate the output audio content.
        ...
        :param 'GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse' synthesize_speech_configs: Optional. Configuration of how speech should be synthesized, mapping from language (https://cloud.google.com/dialogflow/docs/reference/language) to SynthesizeSpeechConfig.
        """
    ...
    def synthesize_speech_configs(self) -> 'outputs.GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse':
        """
