...
class GoogleCloudDialogflowCxV3InputAudioConfigArgs:
    def __init__(__self__, *,
                 audio_encoding: Optional[pulumi.Input['GoogleCloudDialogflowCxV3InputAudioConfigAudioEncoding']] = None,
        ...
        :param pulumi.Input['GoogleCloudDialogflowCxV3InputAudioConfigAudioEncoding'] audio_encoding: Required. Audio encoding of the audio content to process.
    ...
    def audio_encoding(self) -> Optional[pulumi.Input['GoogleCloudDialogflowCxV3InputAudioConfigAudioEncoding']]:
        """
    ...
    def audio_encoding(self, value: Optional[pulumi.Input['GoogleCloudDialogflowCxV3InputAudioConfigAudioEncoding']]):
...
class GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] service: Required. The name of [Service Directory](https://cloud.google.com/service-directory) service. Format: `projects//locations//namespaces//services/`. `Location ID` of the service directory must be the same as the location of the agent.
        """
