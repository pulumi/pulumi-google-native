...
class GetExperimentResult:
    ...
    @property
    @pulumi.getter
    def definition(self) -> 'outputs.GoogleCloudDialogflowCxV3ExperimentDefinitionResponse':
        """
    ...
    @property
    @pulumi.getter
    def result(self) -> 'outputs.GoogleCloudDialogflowCxV3ExperimentResultResponse':
        """
    ...
    def variants_history(self) -> Sequence['outputs.GoogleCloudDialogflowCxV3VariantsHistoryResponse']:
        """
...
def get_experiment(agent_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dialogflow/v3:getExperiment', __args__, opts=opts, typ=GetExperimentResult).value
