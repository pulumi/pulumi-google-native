...
class GetGeneratorResult:
    ...
    @property
    @pulumi.getter
    def placeholders(self) -> Sequence['outputs.GoogleCloudDialogflowCxV3GeneratorPlaceholderResponse']:
        """
    ...
    def prompt_text(self) -> 'outputs.GoogleCloudDialogflowCxV3PhraseResponse':
        """
...
def get_generator(agent_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:dialogflow/v3:getGenerator', __args__, opts=opts, typ=GetGeneratorResult).value
