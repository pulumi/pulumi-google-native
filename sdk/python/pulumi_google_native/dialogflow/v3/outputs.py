...
class GoogleCloudDialogflowCxV3AudioInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3InputAudioConfigResponse' config: Required. Instructs the speech recognizer how to process the speech audio.
        """
...
class GoogleCloudDialogflowCxV3FormParameterFillBehaviorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for how the filling of a parameter should be handled.
        :param 'GoogleCloudDialogflowCxV3FulfillmentResponse' initial_prompt_fulfillment: Required. The fulfillment to provide the initial prompt that the agent can present to the user in order to fill the parameter.
...
class GoogleCloudDialogflowCxV3FormParameterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudDialogflowCxV3FormParameterFillBehaviorResponse' fill_behavior: Required. Defines fill behavior for the parameter.
...
class GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents an example that the agent is trained on to identify the intent.
        :param Sequence['GoogleCloudDialogflowCxV3IntentTrainingPhrasePartResponse'] parts: Required. The ordered list of training phrase parts. The parts are concatenated in order to form the training phrase. Note: The API does not automatically annotate training phrases like the Dialogflow Console does. Note: Do not forget to include whitespace at part boundaries, so the training phrase is well formatted when the parts are concatenated. If the training phrase does not need to be annotated with parameters, you just need a single part with only the Part.text field set. If you want to annotate the training phrase, you must create multiple parts, where the fields of each part are populated in one of two ways: - `Part.text` is set to a part of the phrase that has no parameters. - `Part.text` is set to a part of the phrase that you want to annotate, and the `parameter_id` field is set.
...
class GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str service: Required. The name of [Service Directory](https://cloud.google.com/service-directory) service. Format: `projects//locations//namespaces//services/`. `Location ID` of the service directory must be the same as the location of the agent.
        """
