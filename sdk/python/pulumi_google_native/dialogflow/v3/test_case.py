...
class TestCase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 last_test_result: Optional[pulumi.Input[Union['GoogleCloudDialogflowCxV3TestCaseResultArgs', 'GoogleCloudDialogflowCxV3TestCaseResultArgsDict']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 notes: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 test_case_conversation_turns: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GoogleCloudDialogflowCxV3ConversationTurnArgs', 'GoogleCloudDialogflowCxV3ConversationTurnArgsDict']]]]] = None,
                 test_config: Optional[pulumi.Input[Union['GoogleCloudDialogflowCxV3TestConfigArgs', 'GoogleCloudDialogflowCxV3TestConfigArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] display_name: The human-readable name of the test case, unique within the agent. Limit of 200 characters.
        :param pulumi.Input[Union['GoogleCloudDialogflowCxV3TestCaseResultArgs', 'GoogleCloudDialogflowCxV3TestCaseResultArgsDict']] last_test_result: The latest test result.
        :param pulumi.Input[str] name: The unique identifier of the test case. TestCases.CreateTestCase will populate the name automatically. Otherwise use format: `projects//locations//agents/ /testCases/`.
        :param pulumi.Input[str] notes: Additional freeform notes about the test case. Limit of 400 characters.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: Tags are short descriptions that users may apply to test cases for organizational and filtering purposes. Each tag should start with "#" and has a limit of 30 characters.
        :param pulumi.Input[Sequence[pulumi.Input[Union['GoogleCloudDialogflowCxV3ConversationTurnArgs', 'GoogleCloudDialogflowCxV3ConversationTurnArgsDict']]]] test_case_conversation_turns: The conversation turns uttered when the test case was created, in chronological order. These include the canonical set of agent utterances that should occur when the agent is working properly.
        :param pulumi.Input[Union['GoogleCloudDialogflowCxV3TestConfigArgs', 'GoogleCloudDialogflowCxV3TestConfigArgsDict']] test_config: Config for the test case.
        """
        ...
    @overload
    def __init__(__self__,
