...
class AgentArgs:
    def __init__(__self__, *,
                 ...
                 personalization_settings: Optional[pulumi.Input['GoogleCloudDialogflowCxV3beta1AgentPersonalizationSettingsArgs']] = None,
        ...
        :param pulumi.Input['GoogleCloudDialogflowCxV3beta1AgentPersonalizationSettingsArgs'] personalization_settings: Optional. Settings for end user personalization.
    ...
    def personalization_settings(self) -> Optional[pulumi.Input['GoogleCloudDialogflowCxV3beta1AgentPersonalizationSettingsArgs']]:
        """
    ...
    def personalization_settings(self, value: Optional[pulumi.Input['GoogleCloudDialogflowCxV3beta1AgentPersonalizationSettingsArgs']]):
...
class Agent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 locked: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 personalization_settings: Optional[pulumi.Input[pulumi.InputType['GoogleCloudDialogflowCxV3beta1AgentPersonalizationSettingsArgs']]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 security_settings: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[bool] locked: Indicates whether the agent is locked for changes. If the agent is locked, modifications to the agent will be rejected except for RestoreAgent.
        :param pulumi.Input[str] name: The unique identifier of the agent. Required for the Agents.UpdateAgent method. Agents.CreateAgent populates the name automatically. Format: `projects//locations//agents/`.
        :param pulumi.Input[pulumi.InputType['GoogleCloudDialogflowCxV3beta1AgentPersonalizationSettingsArgs']] personalization_settings: Optional. Settings for end user personalization.
        :param pulumi.Input[str] security_settings: Name of the SecuritySettings reference for the agent. Format: `projects//locations//securitySettings/`.
    ...
    @property
    @pulumi.getter(name="personalizationSettings")
    def personalization_settings(self) -> pulumi.Output['outputs.GoogleCloudDialogflowCxV3beta1AgentPersonalizationSettingsResponse']:
        """
        Optional. Settings for end user personalization.
        """
        return pulumi.get(self, "personalization_settings")
