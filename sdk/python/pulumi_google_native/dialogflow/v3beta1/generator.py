...
class GeneratorArgs:
    def __init__(__self__, *,
                 ...
                 prompt_text: pulumi.Input['GoogleCloudDialogflowCxV3beta1PhraseArgs'],
                 language_code: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 placeholders: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs']]]] = None,
        ...
        :param pulumi.Input['GoogleCloudDialogflowCxV3beta1PhraseArgs'] prompt_text: Prompt for the LLM model.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs']]] placeholders: Optional. List of custom placeholders in the prompt text.
        """
    ...
    def prompt_text(self) -> pulumi.Input['GoogleCloudDialogflowCxV3beta1PhraseArgs']:
        """
    ...
    @prompt_text.setter
    def prompt_text(self, value: pulumi.Input['GoogleCloudDialogflowCxV3beta1PhraseArgs']):
    ...
    @property
    @pulumi.getter
    def placeholders(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs']]]]:
        """
    ...
    @placeholders.setter
    def placeholders(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs']]]]):
...
class Generator(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 placeholders: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs']]]]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 prompt_text: Optional[pulumi.Input[pulumi.InputType['GoogleCloudDialogflowCxV3beta1PhraseArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] language_code: The language to create generators for the following fields: * `Generator.prompt_text.text` If not specified, the agent's default language is used.
        :param pulumi.Input[str] name: The unique identifier of the generator. Must be set for the Generators.UpdateGenerator method. Generators.CreateGenerate populates the name automatically. Format: `projects//locations//agents//generators/`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderArgs']]]] placeholders: Optional. List of custom placeholders in the prompt text.
        :param pulumi.Input[pulumi.InputType['GoogleCloudDialogflowCxV3beta1PhraseArgs']] prompt_text: Prompt for the LLM model.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        super(Generator, __self__).__init__(
            'google-native:dialogflow/v3beta1:Generator',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def placeholders(self) -> pulumi.Output[Sequence['outputs.GoogleCloudDialogflowCxV3beta1GeneratorPlaceholderResponse']]:
        """
        Optional. List of custom placeholders in the prompt text.
        """
        return pulumi.get(self, "placeholders")
    ...
    @property
    @pulumi.getter(name="promptText")
    def prompt_text(self) -> pulumi.Output['outputs.GoogleCloudDialogflowCxV3beta1PhraseResponse']:
        """
        Prompt for the LLM model.
        """
        return pulumi.get(self, "prompt_text")
