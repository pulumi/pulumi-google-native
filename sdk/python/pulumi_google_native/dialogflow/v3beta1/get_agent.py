...
class GetAgentResult:
    ...
    def speech_to_text_settings(self) -> 'outputs.GoogleCloudDialogflowCxV3beta1SpeechToTextSettingsResponse':
        """
    ...
    def text_to_speech_settings(self) -> 'outputs.GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse':
        """
...
def get_agent(agent_id: Optional[str] = None,
    ...
    return AwaitableGetAgentResult(
        ...
        git_integration_settings=__ret__.git_integration_settings,
