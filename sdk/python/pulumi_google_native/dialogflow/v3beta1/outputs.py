...
class GoogleCloudDialogflowCxV3beta1IntentParameterResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "entityType":
            suggest = "entity_type"
        elif key == "googleCloudDialogflowCxV3beta1IntentParameterId":
            suggest = "google_cloud_dialogflow_cx_v3beta1_intent_parameter_id"
        elif key == "isList":
            suggest = "is_list"
    ...
    def __init__(__self__, *,
                 entity_type: str,
                 google_cloud_dialogflow_cx_v3beta1_intent_parameter_id: str,
                 is_list: bool,
                 redact: bool):
        """
        Represents an intent parameter.
        :param str entity_type: The entity type of the parameter. Format: `projects/-/locations/-/agents/-/entityTypes/` for system entity types (for example, `projects/-/locations/-/agents/-/entityTypes/sys.date`), or `projects//locations//agents//entityTypes/` for developer entity types.
        :param str google_cloud_dialogflow_cx_v3beta1_intent_parameter_id: The unique identifier of the parameter. This field is used by training phrases to annotate their parts.
        :param bool is_list: Indicates whether the parameter represents a list of values.
        :param bool redact: Indicates whether the parameter content should be redacted in log. If redaction is enabled, the parameter content will be replaced by parameter name during logging. Note: the parameter content is subject to redaction if either parameter level redaction or entity type level redaction is enabled.
        """
        pulumi.set(__self__, "entity_type", entity_type)
    ...
    def google_cloud_dialogflow_cx_v3beta1_intent_parameter_id(self) -> str:
        """
...
class GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "googleCloudDialogflowCxV3beta1IntentTrainingPhraseId":
            suggest = "google_cloud_dialogflow_cx_v3beta1_intent_training_phrase_id"
    ...
    def __init__(__self__, *,
                 google_cloud_dialogflow_cx_v3beta1_intent_training_phrase_id: str,
                 parts: Sequence['outputs.GoogleCloudDialogflowCxV3beta1IntentTrainingPhrasePartResponse'],
                 repeat_count: int):
        """
        Represents an example that the agent is trained on to identify the intent.
        :param str google_cloud_dialogflow_cx_v3beta1_intent_training_phrase_id: The unique identifier of the training phrase.
        ...
        """
        pulumi.set(__self__, "google_cloud_dialogflow_cx_v3beta1_intent_training_phrase_id", google_cloud_dialogflow_cx_v3beta1_intent_training_phrase_id)
        pulumi.set(__self__, "parts", parts)
        pulumi.set(__self__, "repeat_count", repeat_count)

    @property
    @pulumi.getter(name="googleCloudDialogflowCxV3beta1IntentTrainingPhraseId")
    def google_cloud_dialogflow_cx_v3beta1_intent_training_phrase_id(self) -> str:
        """
        The unique identifier of the training phrase.
        """
        return pulumi.get(self, "google_cloud_dialogflow_cx_v3beta1_intent_training_phrase_id")
