...
class Webhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 generic_web_service: Optional[pulumi.Input[Union['GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceArgs', 'GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceArgsDict']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 service_directory: Optional[pulumi.Input[Union['GoogleCloudDialogflowCxV3beta1WebhookServiceDirectoryConfigArgs', 'GoogleCloudDialogflowCxV3beta1WebhookServiceDirectoryConfigArgsDict']]] = None,
                 timeout: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[bool] disabled: Indicates whether the webhook is disabled.
        :param pulumi.Input[str] display_name: The human-readable name of the webhook, unique within the agent.
        :param pulumi.Input[Union['GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceArgs', 'GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceArgsDict']] generic_web_service: Configuration for a generic web service.
        :param pulumi.Input[str] name: The unique identifier of the webhook. Required for the Webhooks.UpdateWebhook method. Webhooks.CreateWebhook populates the name automatically. Format: `projects//locations//agents//webhooks/`.
        :param pulumi.Input[Union['GoogleCloudDialogflowCxV3beta1WebhookServiceDirectoryConfigArgs', 'GoogleCloudDialogflowCxV3beta1WebhookServiceDirectoryConfigArgsDict']] service_directory: Configuration for a [Service Directory](https://cloud.google.com/service-directory) service.
        :param pulumi.Input[str] timeout: Webhook execution timeout. Execution is considered failed if Dialogflow doesn't receive a response from webhook at the end of the timeout period. Defaults to 5 seconds, maximum allowed timeout is 30 seconds.
        """
        ...
    @overload
