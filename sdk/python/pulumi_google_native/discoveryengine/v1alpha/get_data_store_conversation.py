...
__all__ = [
    'GetDataStoreConversationResult',
    'AwaitableGetDataStoreConversationResult',
    'get_data_store_conversation',
    'get_data_store_conversation_output',
]

@pulumi.output_type
class GetDataStoreConversationResult:
    ...
    @property
    @pulumi.getter
    def messages(self) -> Sequence['outputs.GoogleCloudDiscoveryengineV1alphaConversationMessageResponse']:
        """
...
class AwaitableGetDataStoreConversationResult(GetDataStoreConversationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataStoreConversationResult(
...
def get_data_store_conversation(collection_id: Optional[str] = None,
                                conversation_id: Optional[str] = None,
                                data_store_id: Optional[str] = None,
                                location: Optional[str] = None,
                                project: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataStoreConversationResult:
    """
    Gets a Conversation.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('google-native:discoveryengine/v1alpha:getDataStoreConversation', __args__, opts=opts, typ=GetDataStoreConversationResult).value

    return AwaitableGetDataStoreConversationResult(
...
@_utilities.lift_output_func(get_data_store_conversation)
def get_data_store_conversation_output(collection_id: Optional[pulumi.Input[str]] = None,
                                       conversation_id: Optional[pulumi.Input[str]] = None,
                                       data_store_id: Optional[pulumi.Input[str]] = None,
                                       location: Optional[pulumi.Input[str]] = None,
                                       project: Optional[pulumi.Input[Optional[str]]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDataStoreConversationResult]:
    """
    Gets a Conversation.
    """
    ...
