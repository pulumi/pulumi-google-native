...
__all__ = [
    'GetEngineConversationResult',
    'AwaitableGetEngineConversationResult',
    'get_engine_conversation',
    'get_engine_conversation_output',
]

@pulumi.output_type
class GetEngineConversationResult:
...
class AwaitableGetEngineConversationResult(GetEngineConversationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEngineConversationResult(
...
def get_engine_conversation(collection_id: Optional[str] = None,
                            conversation_id: Optional[str] = None,
                            engine_id: Optional[str] = None,
                            location: Optional[str] = None,
                            project: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEngineConversationResult:
    """
    Gets a Conversation.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('google-native:discoveryengine/v1alpha:getEngineConversation', __args__, opts=opts, typ=GetEngineConversationResult).value

    return AwaitableGetEngineConversationResult(
...
@_utilities.lift_output_func(get_engine_conversation)
def get_engine_conversation_output(collection_id: Optional[pulumi.Input[str]] = None,
                                   conversation_id: Optional[pulumi.Input[str]] = None,
                                   engine_id: Optional[pulumi.Input[str]] = None,
                                   location: Optional[pulumi.Input[str]] = None,
                                   project: Optional[pulumi.Input[Optional[str]]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetEngineConversationResult]:
    """
    Gets a Conversation.
    """
    ...
