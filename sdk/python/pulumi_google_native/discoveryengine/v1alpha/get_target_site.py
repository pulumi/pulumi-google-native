...
class GetTargetSiteResult:
    ...
    def failure_reason(self) -> 'outputs.GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReasonResponse':
        """
        Failure reason.
        """
    ...
    def site_verification_info(self) -> 'outputs.GoogleCloudDiscoveryengineV1alphaSiteVerificationInfoResponse':
        """
...
def get_target_site(collection_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:discoveryengine/v1alpha:getTargetSite', __args__, opts=opts, typ=GetTargetSiteResult).value
