...
class DataStoreArgs:
    def __init__(__self__, *,
                 ...
                 document_processing_config: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigArgs']] = None,
                 ...
                 starting_schema: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaSchemaArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigArgs'] document_processing_config: Configuration for Document understanding and enrichment.
    ...
    def document_processing_config(self) -> Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigArgs']]:
        """
    ...
    def document_processing_config(self, value: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigArgs']]):
    ...
    def starting_schema(self) -> Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaSchemaArgs']]:
        """
    ...
    def starting_schema(self, value: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaSchemaArgs']]):
...
class DataStore(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 document_processing_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigArgs']]] = None,
                 industry_vertical: Optional[pulumi.Input['DataStoreIndustryVertical']] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 solution_types: Optional[pulumi.Input[Sequence[pulumi.Input['DataStoreSolutionTypesItem']]]] = None,
                 starting_schema: Optional[pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaSchemaArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] data_store_id: Required. The ID to use for the DataStore, which will become the final component of the DataStore's resource name. This field must conform to [RFC-1034](https://tools.ietf.org/html/rfc1034) standard with a length limit of 63 characters. Otherwise, an INVALID_ARGUMENT error is returned.
        :param pulumi.Input[str] display_name: The data store display name. This field must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID_ARGUMENT error is returned.
        :param pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigArgs']] document_processing_config: Configuration for Document understanding and enrichment.
        :param pulumi.Input['DataStoreIndustryVertical'] industry_vertical: Immutable. The industry vertical that the data store registers.
        :param pulumi.Input[str] name: Immutable. The full resource name of the data store. Format: `projects/{project}/locations/{location}/collections/{collection_id}/dataStores/{data_store_id}`. This field must be a UTF-8 encoded string with a length limit of 1024 characters.
        :param pulumi.Input[Sequence[pulumi.Input['DataStoreSolutionTypesItem']]] solution_types: The solutions that the data store enrolls. Available solutions for each industry_vertical: * `MEDIA`: `SOLUTION_TYPE_RECOMMENDATION` and `SOLUTION_TYPE_SEARCH`. * `SITE_SEARCH`: `SOLUTION_TYPE_SEARCH` is automatically enrolled. Other solutions cannot be enrolled.
        :param pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaSchemaArgs']] starting_schema: The start schema to use for this DataStore when provisioning it. If unset, a default vertical specialized schema will be used. This field is only used by CreateDataStore API, and will be ignored if used in other APIs. This field will be omitted from all API responses including CreateDataStore API. To retrieve a schema of a DataStore, use SchemaService.GetSchema API instead. The provided schema will be validated against certain rules on schema. Learn more from [this doc](https://cloud.google.com/generative-ai-app-builder/docs/provide-schema).
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        super(DataStore, __self__).__init__(
            'google-native:discoveryengine/v1beta:DataStore',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="documentProcessingConfig")
    def document_processing_config(self) -> pulumi.Output['outputs.GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigResponse']:
        """
        Configuration for Document understanding and enrichment.
        """
        return pulumi.get(self, "document_processing_config")
    ...
    @property
    @pulumi.getter(name="startingSchema")
    def starting_schema(self) -> pulumi.Output['outputs.GoogleCloudDiscoveryengineV1betaSchemaResponse']:
        """
        The start schema to use for this DataStore when provisioning it. If unset, a default vertical specialized schema will be used. This field is only used by CreateDataStore API, and will be ignored if used in other APIs. This field will be omitted from all API responses including CreateDataStore API. To retrieve a schema of a DataStore, use SchemaService.GetSchema API instead. The provided schema will be validated against certain rules on schema. Learn more from [this doc](https://cloud.google.com/generative-ai-app-builder/docs/provide-schema).
        """
        return pulumi.get(self, "starting_schema")
