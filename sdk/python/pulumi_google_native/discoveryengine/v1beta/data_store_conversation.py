...
__all__ = ['DataStoreConversationArgs', 'DataStoreConversation']

@pulumi.input_type
class DataStoreConversationArgs:
    def __init__(__self__, *,
                 ...
                 state: Optional[pulumi.Input['DataStoreConversationState']] = None,
        ...
        :param pulumi.Input['DataStoreConversationState'] state: The state of the Conversation.
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input['DataStoreConversationState']]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input['DataStoreConversationState']]):
...
class DataStoreConversation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DataStoreConversationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a Conversation. If the Conversation to create already exists, an ALREADY_EXISTS error is returned.
        Auto-naming is currently not supported for this resource.
        ...
        :param str resource_name: The name of the resource.
        :param DataStoreConversationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataStoreConversationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataStoreConversationArgs.__new__(DataStoreConversationArgs)
        ...
        super(DataStoreConversation, __self__).__init__(
            'google-native:discoveryengine/v1beta:DataStoreConversation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DataStoreConversation':
        """
        ...
        return DataStoreConversation(resource_name, opts=opts, __props__=__props__)
