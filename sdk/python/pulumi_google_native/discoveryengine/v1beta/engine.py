...
class EngineArgs:
    def __init__(__self__, *,
                 ...
                 chat_engine_config: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigArgs']] = None,
                 common_config: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineCommonConfigArgs']] = None,
                 ...
                 search_engine_config: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigArgs'] chat_engine_config: Configurations for the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
        :param pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineCommonConfigArgs'] common_config: Common config spec that specifies the metadata of the engine.
        ...
        :param pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigArgs'] search_engine_config: Configurations for the Search Engine. Only applicable if solution_type is SOLUTION_TYPE_SEARCH.
        """
    ...
    def chat_engine_config(self) -> Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigArgs']]:
        """
    ...
    def chat_engine_config(self, value: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigArgs']]):
        pulumi.set(self, "chat_engine_config", value)

    @property
    @pulumi.getter(name="commonConfig")
    def common_config(self) -> Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineCommonConfigArgs']]:
        """
    ...
    def common_config(self, value: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineCommonConfigArgs']]):
    ...
    def search_engine_config(self) -> Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigArgs']]:
        """
    ...
    def search_engine_config(self, value: Optional[pulumi.Input['GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigArgs']]):
...
class Engine(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 chat_engine_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigArgs']]] = None,
                 collection_id: Optional[pulumi.Input[str]] = None,
                 common_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaEngineCommonConfigArgs']]] = None,
                 data_store_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 search_engine_config: Optional[pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigArgs']] chat_engine_config: Configurations for the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
        :param pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaEngineCommonConfigArgs']] common_config: Common config spec that specifies the metadata of the engine.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] data_store_ids: The data stores associated with this engine. For SOLUTION_TYPE_SEARCH and SOLUTION_TYPE_RECOMMENDATION type of engines, they can only associate with at most one data store. If solution_type is SOLUTION_TYPE_CHAT, multiple DataStores in the same Collection can be associated here. Note that when used in CreateEngineRequest, one DataStore id must be provided as the system will use it for necessary initializations.
        :param pulumi.Input[str] display_name: The display name of the engine. Should be human readable. UTF-8 encoded string with limit of 1024 characters.
        :param pulumi.Input[str] engine_id: Required. The ID to use for the Engine, which will become the final component of the Engine's resource name. This field must conform to [RFC-1034](https://tools.ietf.org/html/rfc1034) standard with a length limit of 63 characters. Otherwise, an INVALID_ARGUMENT error is returned.
        :param pulumi.Input['EngineIndustryVertical'] industry_vertical: The industry vertical that the engine registers. The restriction of the Engine industry vertical is based on DataStore: If unspecified, default to `GENERIC`. Vertical on Engine has to match vertical of the DataStore liniked to the engine.
        :param pulumi.Input[str] name: Immutable. The fully qualified resource name of the engine. This field must be a UTF-8 encoded string with a length limit of 1024 characters. Format: `projects/{project_number}/locations/{location}/collections/{collection}/engines/{engine}` engine should be 1-63 characters, and valid characters are /a-z0-9*/. Otherwise, an INVALID_ARGUMENT error is returned.
        :param pulumi.Input[pulumi.InputType['GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigArgs']] search_engine_config: Configurations for the Search Engine. Only applicable if solution_type is SOLUTION_TYPE_SEARCH.
        :param pulumi.Input['EngineSolutionType'] solution_type: The solutions of the engine.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        super(Engine, __self__).__init__(
            'google-native:discoveryengine/v1beta:Engine',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="chatEngineConfig")
    def chat_engine_config(self) -> pulumi.Output['outputs.GoogleCloudDiscoveryengineV1betaEngineChatEngineConfigResponse']:
        """
        Configurations for the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
        """
        return pulumi.get(self, "chat_engine_config")
    ...
    def chat_engine_metadata(self) -> pulumi.Output['outputs.GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadataResponse']:
        """
    ...
    @property
    @pulumi.getter(name="commonConfig")
    def common_config(self) -> pulumi.Output['outputs.GoogleCloudDiscoveryengineV1betaEngineCommonConfigResponse']:
        """
        Common config spec that specifies the metadata of the engine.
        """
        return pulumi.get(self, "common_config")
    ...
    @property
    @pulumi.getter(name="searchEngineConfig")
    def search_engine_config(self) -> pulumi.Output['outputs.GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfigResponse']:
        """
        Configurations for the Search Engine. Only applicable if solution_type is SOLUTION_TYPE_SEARCH.
        """
        return pulumi.get(self, "search_engine_config")
