...
class GetDataStoreResult:
    def __init__(__self__, content_config=None, create_time=None, default_schema_id=None, display_name=None, document_processing_config=None, industry_vertical=None, name=None, solution_types=None, starting_schema=None):
    ...
    def document_processing_config(self) -> 'outputs.GoogleCloudDiscoveryengineV1betaDocumentProcessingConfigResponse':
        """
    ...
    def starting_schema(self) -> 'outputs.GoogleCloudDiscoveryengineV1betaSchemaResponse':
        """
...
def get_data_store(collection_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:discoveryengine/v1beta:getDataStore', __args__, opts=opts, typ=GetDataStoreResult).value
