...
def get_data_store_conversation(collection_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:discoveryengine/v1beta:getDataStoreConversation', __args__, opts=opts, typ=GetDataStoreConversationResult).value
