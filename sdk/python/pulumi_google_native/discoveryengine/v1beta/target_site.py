...
class TargetSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(TargetSite, __self__).__init__(
            'google-native:discoveryengine/v1beta:TargetSite',
            resource_name,
            __props__,
            opts)
    ...
    def failure_reason(self) -> pulumi.Output['outputs.GoogleCloudDiscoveryengineV1betaTargetSiteFailureReasonResponse']:
        """
        Failure reason.
        """
    ...
    def site_verification_info(self) -> pulumi.Output['outputs.GoogleCloudDiscoveryengineV1betaSiteVerificationInfoResponse']:
        """
