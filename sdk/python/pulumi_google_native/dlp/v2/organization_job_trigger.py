...
class OrganizationJobTriggerArgs:
    def __init__(__self__, *,
                 ...
                 status: pulumi.Input['OrganizationJobTriggerStatus'],
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Input['OrganizationJobTriggerStatus']:
        """
    ...
    @status.setter
    def status(self, value: pulumi.Input['OrganizationJobTriggerStatus']):
