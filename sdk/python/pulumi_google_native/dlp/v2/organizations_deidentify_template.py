...
__all__ = ['OrganizationsDeidentifyTemplateArgs', 'OrganizationsDeidentifyTemplate']
...
class OrganizationsDeidentifyTemplate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OrganizationsDeidentifyTemplateArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a DeidentifyTemplate for reusing frequently used configuration for de-identifying content, images, and storage. See https://cloud.google.com/dlp/docs/creating-templates-deid to learn more.
        Auto-naming is currently not supported for this resource.
        ...
        :param str resource_name: The name of the resource.
        :param OrganizationsDeidentifyTemplateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationsDeidentifyTemplateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OrganizationsDeidentifyTemplateArgs.__new__(OrganizationsDeidentifyTemplateArgs)
        ...
        super(OrganizationsDeidentifyTemplate, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OrganizationsDeidentifyTemplate':
        """
        ...
        __props__.__dict__["update_time"] = None
        return OrganizationsDeidentifyTemplate(resource_name, opts=opts, __props__=__props__)
