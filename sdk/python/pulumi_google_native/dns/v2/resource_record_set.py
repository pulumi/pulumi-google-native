...
__all__ = ['ResourceRecordSetArgs', 'ResourceRecordSet']
...
class ResourceRecordSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ResourceRecordSetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceRecordSetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "managed_zone", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ResourceRecordSet, __self__).__init__(
            'google-native:dns/v2:ResourceRecordSet',
            resource_name,
            __props__,
            opts)
