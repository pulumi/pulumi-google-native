...
@pulumi.output_type
class GoogleCloudDocumentaiV1beta3ProcessorVersionAliasResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudDocumentaiV1beta3ProcessorVersionAliasResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudDocumentaiV1beta3ProcessorVersionAliasResponse.__key_warning(key)
