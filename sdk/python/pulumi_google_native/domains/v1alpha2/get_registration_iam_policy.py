...
__all__ = [
    'GetRegistrationIamPolicyResult',
    'AwaitableGetRegistrationIamPolicyResult',
    'get_registration_iam_policy',
    'get_registration_iam_policy_output',
]

@pulumi.output_type
class GetRegistrationIamPolicyResult:
...
class AwaitableGetRegistrationIamPolicyResult(GetRegistrationIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRegistrationIamPolicyResult(
...
def get_registration_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:domains/v1alpha2:getRegistrationIamPolicy', __args__, opts=opts, typ=GetRegistrationIamPolicyResult).value

    return AwaitableGetRegistrationIamPolicyResult(
