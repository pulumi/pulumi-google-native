...
__all__ = [
    ...
    'AwaitableGetChannelIamPolicyResult',
    'get_channel_iam_policy',
    'get_channel_iam_policy_output',
]
...
class AwaitableGetChannelIamPolicyResult(GetChannelIamPolicyResult):
...
def get_channel_iam_policy(channel_id: Optional[str] = None,
                           location: Optional[str] = None,
                           options_requested_policy_version: Optional[int] = None,
                           project: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetChannelIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:eventarc/v1:getChannelIamPolicy', __args__, opts=opts, typ=GetChannelIamPolicyResult).value

    return AwaitableGetChannelIamPolicyResult(
...
@_utilities.lift_output_func(get_channel_iam_policy)
def get_channel_iam_policy_output(channel_id: Optional[pulumi.Input[str]] = None,
                                  location: Optional[pulumi.Input[str]] = None,
                                  options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                  project: Optional[pulumi.Input[Optional[str]]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetChannelIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
