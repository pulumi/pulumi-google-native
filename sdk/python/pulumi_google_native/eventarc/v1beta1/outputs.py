...
@pulumi.output_type
class CloudRunServiceResponse(dict):
    """
...
class DestinationResponse(dict):
    ...
    def __init__(__self__, *,
                 cloud_run_service: 'outputs.CloudRunServiceResponse'):
        """
        Represents a target of an invocation over HTTP.
        :param 'CloudRunServiceResponse' cloud_run_service: Cloud Run fully-managed service that receives the events. The service should be running in the same project as the trigger.
        """
        pulumi.set(__self__, "cloud_run_service", cloud_run_service)

    @property
    @pulumi.getter(name="cloudRunService")
    def cloud_run_service(self) -> 'outputs.CloudRunServiceResponse':
        """
...
@pulumi.output_type
class MatchingCriteriaResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Matches events based on exact matches on the CloudEvents attributes.
        :param str attribute: The name of a CloudEvents attribute. Currently, only a subset of attributes can be specified. All triggers MUST provide a matching criteria for the 'type' attribute.
