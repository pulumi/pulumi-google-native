...
class GameServerDeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, str]] labels: The labels associated with this game server deployment. Each label is a key-value pair.
...
class GameServerDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(GameServerDeployment, __self__).__init__(
            'google-native:gameservices/v1:GameServerDeployment',
            resource_name,
            __props__,
            opts)
