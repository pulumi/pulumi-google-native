...
class GameServerClusterConnectionInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GkeHubClusterReferenceResponse' gke_hub_cluster_reference: Reference to a Kubernetes cluster registered through GKE Hub. See https://cloud.google.com/anthos/multicluster-management/ for more information about registering Kubernetes clusters.
    ...
    def gke_hub_cluster_reference(self) -> 'outputs.GkeHubClusterReferenceResponse':
        """
...
@pulumi.output_type
class GkeHubClusterReferenceResponse(dict):
    """
