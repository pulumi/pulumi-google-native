...
class Pipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 docker: Optional[pulumi.Input[Union['DockerExecutorArgs', 'DockerExecutorArgsDict']]] = None,
                 input_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PipelineParameterArgs', 'PipelineParameterArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 output_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PipelineParameterArgs', 'PipelineParameterArgsDict']]]]] = None,
                 pipeline_id: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] description: User-specified description.
        :param pulumi.Input[Union['DockerExecutorArgs', 'DockerExecutorArgsDict']] docker: Specifies the docker run information.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PipelineParameterArgs', 'PipelineParameterArgsDict']]]] input_parameters: Input parameters of the pipeline.
        :param pulumi.Input[str] name: A user specified pipeline name that does not have to be unique. This name can be used for filtering Pipelines in ListPipelines.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PipelineParameterArgs', 'PipelineParameterArgsDict']]]] output_parameters: Output parameters of the pipeline.
        :param pulumi.Input[str] pipeline_id: Unique pipeline id that is generated by the service when CreatePipeline is called. Cannot be specified in the Pipeline used in the CreatePipelineRequest, and will be populated in the response to CreatePipeline and all subsequent Get and List calls. Indicates that the service has registered this pipeline.
        :param pulumi.Input[str] project: The project in which to create the pipeline. The caller must have WRITE access.
        :param pulumi.Input[Union['PipelineResourcesArgs', 'PipelineResourcesArgsDict']] resources: Specifies resource requirements for the pipeline run. Required fields: * minimumCpuCores * minimumRamGb
        """
        ...
    @overload
    def __init__(__self__,
