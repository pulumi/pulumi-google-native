...
class ClusterResourceRestoreScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] all_group_kinds: If True, all valid cluster-scoped resources will be restored. Mutually exclusive to any other field in the message.
        :param pulumi.Input[Sequence[pulumi.Input['GroupKindArgs']]] excluded_group_kinds: A list of cluster-scoped resource group kinds to NOT restore from the backup. If specified, all valid cluster-scoped resources will be restored except for those specified in the list. Mutually exclusive to any other field in the message.
        :param pulumi.Input[bool] no_group_kinds: If True, no cluster-scoped resources will be restored. This has the same restore scope as if the message is not defined. Mutually exclusive to any other field in the message.
...
class RestoreConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TransformationRuleArgs']]] transformation_rules: A list of transformation rules to be applied against Kubernetes resources as they are selected for restoration from a Backup. Rules are executed in order defined - this order matters, as changes made by a rule may impact the filtering logic of subsequent rules. An empty list means no transformation will occur.
...
class TransformationRuleActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] from_path: A string containing a JSON Pointer value that references the location in the target document to move the value from.
        :param pulumi.Input[str] path: A string containing a JSON-Pointer value that references a location within the target document where the operation is performed.
        :param pulumi.Input[str] value: A string that specifies the desired value in string format to use for transformation.
        """
...
class TransformationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: The description is a user specified string description of the transformation rule.
        :param pulumi.Input['ResourceFilterArgs'] resource_filter: This field is used to specify a set of fields that should be used to determine which resources in backup should be acted upon by the supplied transformation rule actions, and this will ensure that only specific resources are affected by transformation rule actions.
        """
