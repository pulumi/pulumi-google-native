...
__all__ = ['BackupPlanBackupVolumeBackupIamPolicyArgs', 'BackupPlanBackupVolumeBackupIamPolicy']
...
class BackupPlanBackupVolumeBackupIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: BackupPlanBackupVolumeBackupIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param BackupPlanBackupVolumeBackupIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BackupPlanBackupVolumeBackupIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BackupPlanBackupVolumeBackupIamPolicyArgs.__new__(BackupPlanBackupVolumeBackupIamPolicyArgs)
            ...
            if volume_backup_id is None and not opts.urn:
                raise TypeError("Missing required property 'volume_backup_id'")
            __props__.__dict__["volume_backup_id"] = volume_backup_id
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["backup_id", "backup_plan_id", "location", "project", "volume_backup_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(BackupPlanBackupVolumeBackupIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BackupPlanBackupVolumeBackupIamPolicy':
        """
        ...
        return BackupPlanBackupVolumeBackupIamPolicy(resource_name, opts=opts, __props__=__props__)
