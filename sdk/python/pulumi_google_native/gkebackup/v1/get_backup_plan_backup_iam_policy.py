...
__all__ = [
    ...
    'AwaitableGetBackupPlanBackupIamPolicyResult',
    'get_backup_plan_backup_iam_policy',
    'get_backup_plan_backup_iam_policy_output',
]
...
class AwaitableGetBackupPlanBackupIamPolicyResult(GetBackupPlanBackupIamPolicyResult):
...
def get_backup_plan_backup_iam_policy(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkebackup/v1:getBackupPlanBackupIamPolicy', __args__, opts=opts, typ=GetBackupPlanBackupIamPolicyResult).value

    return AwaitableGetBackupPlanBackupIamPolicyResult(
...
@_utilities.lift_output_func(get_backup_plan_backup_iam_policy)
