...
__all__ = [
    ...
    'AwaitableGetBackupPlanBackupVolumeBackupIamPolicyResult',
    'get_backup_plan_backup_volume_backup_iam_policy',
    'get_backup_plan_backup_volume_backup_iam_policy_output',
]

@pulumi.output_type
class GetBackupPlanBackupVolumeBackupIamPolicyResult:
...
class AwaitableGetBackupPlanBackupVolumeBackupIamPolicyResult(GetBackupPlanBackupVolumeBackupIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBackupPlanBackupVolumeBackupIamPolicyResult(
...
def get_backup_plan_backup_volume_backup_iam_policy(backup_id: Optional[str] = None,
                                                    ...
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBackupPlanBackupVolumeBackupIamPolicyResult:
    """
...
@_utilities.lift_output_func(get_backup_plan_backup_volume_backup_iam_policy)
def get_backup_plan_backup_volume_backup_iam_policy_output(backup_id: Optional[pulumi.Input[str]] = None,
                                                           ...
                                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetBackupPlanBackupVolumeBackupIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
