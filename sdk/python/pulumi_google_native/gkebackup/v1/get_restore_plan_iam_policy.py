...
def get_restore_plan_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkebackup/v1:getRestorePlanIamPolicy', __args__, opts=opts, typ=GetRestorePlanIamPolicyResult).value
...
def get_restore_plan_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
