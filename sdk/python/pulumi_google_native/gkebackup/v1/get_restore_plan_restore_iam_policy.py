...
__all__ = [
    ...
    'AwaitableGetRestorePlanRestoreIamPolicyResult',
    'get_restore_plan_restore_iam_policy',
    'get_restore_plan_restore_iam_policy_output',
]
...
class AwaitableGetRestorePlanRestoreIamPolicyResult(GetRestorePlanRestoreIamPolicyResult):
...
def get_restore_plan_restore_iam_policy(location: Optional[str] = None,
                                        options_requested_policy_version: Optional[str] = None,
                                        project: Optional[str] = None,
                                        restore_id: Optional[str] = None,
                                        restore_plan_id: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRestorePlanRestoreIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkebackup/v1:getRestorePlanRestoreIamPolicy', __args__, opts=opts, typ=GetRestorePlanRestoreIamPolicyResult).value

    return AwaitableGetRestorePlanRestoreIamPolicyResult(
...
@_utilities.lift_output_func(get_restore_plan_restore_iam_policy)
def get_restore_plan_restore_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRestorePlanRestoreIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
