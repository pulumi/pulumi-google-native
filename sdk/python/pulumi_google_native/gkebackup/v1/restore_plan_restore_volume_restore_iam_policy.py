...
__all__ = ['RestorePlanRestoreVolumeRestoreIamPolicyArgs', 'RestorePlanRestoreVolumeRestoreIamPolicy']
...
class RestorePlanRestoreVolumeRestoreIamPolicyArgs:
    def __init__(__self__, *,
                 ...
                 volume_restore_id: pulumi.Input[str],
        ...
        pulumi.set(__self__, "volume_restore_id", volume_restore_id)
    ...
    @property
    @pulumi.getter(name="volumeRestoreId")
    def volume_restore_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "volume_restore_id")

    @volume_restore_id.setter
    def volume_restore_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "volume_restore_id", value)
...
class RestorePlanRestoreVolumeRestoreIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RestorePlanRestoreVolumeRestoreIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param RestorePlanRestoreVolumeRestoreIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RestorePlanRestoreVolumeRestoreIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RestorePlanRestoreVolumeRestoreIamPolicyArgs.__new__(RestorePlanRestoreVolumeRestoreIamPolicyArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RestorePlanRestoreVolumeRestoreIamPolicy':
        """
        ...
        __props__.__dict__["volume_restore_id"] = None
        return RestorePlanRestoreVolumeRestoreIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="volumeRestoreId")
    def volume_restore_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "volume_restore_id")
