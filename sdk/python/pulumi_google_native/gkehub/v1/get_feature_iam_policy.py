...
__all__ = [
    ...
    'AwaitableGetFeatureIamPolicyResult',
    'get_feature_iam_policy',
    'get_feature_iam_policy_output',
]
...
class AwaitableGetFeatureIamPolicyResult(GetFeatureIamPolicyResult):
...
def get_feature_iam_policy(feature_id: Optional[str] = None,
                           location: Optional[str] = None,
                           options_requested_policy_version: Optional[str] = None,
                           project: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFeatureIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkehub/v1:getFeatureIamPolicy', __args__, opts=opts, typ=GetFeatureIamPolicyResult).value
...
def get_feature_iam_policy_output(feature_id: Optional[pulumi.Input[str]] = None,
