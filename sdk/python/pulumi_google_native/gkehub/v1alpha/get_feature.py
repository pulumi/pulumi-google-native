...
class GetFeatureResult:
    ...
    def membership_specs(self) -> 'outputs.MembershipFeatureSpecResponse':
        """
    ...
    def membership_states(self) -> 'outputs.MembershipFeatureStateResponse':
        """
    ...
    def scope_specs(self) -> 'outputs.ScopeFeatureSpecResponse':
        """
    ...
    def scope_states(self) -> 'outputs.ScopeFeatureStateResponse':
        """
...
def get_feature(feature_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkehub/v1alpha:getFeature', __args__, opts=opts, typ=GetFeatureResult).value
