...
def get_scope_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkehub/v1alpha:getScopeIamPolicy', __args__, opts=opts, typ=GetScopeIamPolicyResult).value
...
def get_scope_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
