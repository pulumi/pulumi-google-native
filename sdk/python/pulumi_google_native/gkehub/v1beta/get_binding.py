...
class GetBindingResult:
    def __init__(__self__, create_time=None, delete_time=None, fleet=None, labels=None, name=None, scope=None, state=None, uid=None, update_time=None):
...
def get_binding(binding_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkehub/v1beta:getBinding', __args__, opts=opts, typ=GetBindingResult).value
