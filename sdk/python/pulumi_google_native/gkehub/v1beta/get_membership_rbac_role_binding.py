...
def get_membership_rbac_role_binding(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkehub/v1beta:getMembershipRbacRoleBinding', __args__, opts=opts, typ=GetMembershipRbacRoleBindingResult).value
