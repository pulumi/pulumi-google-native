...
__all__ = [
    ...
    'get_rbacrolebinding',
    'get_rbacrolebinding_output',
]

@pulumi.output_type
class GetRbacrolebindingResult:
    def __init__(__self__, create_time=None, delete_time=None, group=None, name=None, role=None, state=None, uid=None, update_time=None, user=None):
...
class AwaitableGetRbacrolebindingResult(GetRbacrolebindingResult):
...
def get_rbacrolebinding(location: Optional[str] = None,
                        namespace_id: Optional[str] = None,
                        project: Optional[str] = None,
                        rbacrolebinding_id: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRbacrolebindingResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkehub/v1beta:getRbacrolebinding', __args__, opts=opts, typ=GetRbacrolebindingResult).value
...
def get_rbacrolebinding_output(location: Optional[pulumi.Input[str]] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRbacrolebindingResult]:
    """
    Returns the details of a RBACRoleBinding.
    """
    ...
