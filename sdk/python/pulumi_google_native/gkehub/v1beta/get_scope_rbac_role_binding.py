...
__all__ = [
    ...
    'AwaitableGetScopeRbacRoleBindingResult',
    'get_scope_rbac_role_binding',
    'get_scope_rbac_role_binding_output',
]
...
class AwaitableGetScopeRbacRoleBindingResult(GetScopeRbacRoleBindingResult):
...
def get_scope_rbac_role_binding(location: Optional[str] = None,
                                project: Optional[str] = None,
                                rbacrolebinding_id: Optional[str] = None,
                                scope_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetScopeRbacRoleBindingResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:gkehub/v1beta:getScopeRbacRoleBinding', __args__, opts=opts, typ=GetScopeRbacRoleBindingResult).value

    return AwaitableGetScopeRbacRoleBindingResult(
...
@_utilities.lift_output_func(get_scope_rbac_role_binding)
def get_scope_rbac_role_binding_output(location: Optional[pulumi.Input[str]] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetScopeRbacRoleBindingResult]:
    """
    Returns the details of a Scope RBACRoleBinding.
    """
    ...
