...
class VmwareDataplaneV2ConfigArgs:
    def __init__(__self__, *,
                 ...
                 forward_mode: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] forward_mode: Configure ForwardMode for Dataplane v2.
    ...
    def forward_mode(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @forward_mode.setter
    def forward_mode(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "forward_mode", value)
...
class VmwareNodeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] image_type: The OS image to be used for each node in a node pool. Currently `cos`, `cos_cgv2`, `ubuntu`, `ubuntu_cgv2`, `ubuntu_containerd` and `windows` are supported.
