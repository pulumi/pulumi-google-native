...
class BareMetalParallelUpgradeConfigArgs:
    def __init__(__self__, *,
                 concurrent_nodes: pulumi.Input[int],
        ...
        :param pulumi.Input[int] concurrent_nodes: The maximum number of nodes that can be upgraded at once. Defaults to 1.
    ...
    def concurrent_nodes(self) -> pulumi.Input[int]:
        """
    ...
    def concurrent_nodes(self, value: pulumi.Input[int]):
