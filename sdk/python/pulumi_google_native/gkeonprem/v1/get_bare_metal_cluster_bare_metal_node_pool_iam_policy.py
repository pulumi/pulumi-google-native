...
__all__ = [
    ...
    'AwaitableGetBareMetalClusterBareMetalNodePoolIamPolicyResult',
    'get_bare_metal_cluster_bare_metal_node_pool_iam_policy',
    'get_bare_metal_cluster_bare_metal_node_pool_iam_policy_output',
]
...
class AwaitableGetBareMetalClusterBareMetalNodePoolIamPolicyResult(GetBareMetalClusterBareMetalNodePoolIamPolicyResult):
...
def get_bare_metal_cluster_bare_metal_node_pool_iam_policy(bare_metal_cluster_id: Optional[str] = None,
                                                           bare_metal_node_pool_id: Optional[str] = None,
                                                           location: Optional[str] = None,
                                                           options_requested_policy_version: Optional[int] = None,
                                                           project: Optional[str] = None,
                                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBareMetalClusterBareMetalNodePoolIamPolicyResult:
    """
...
def get_bare_metal_cluster_bare_metal_node_pool_iam_policy_output(bare_metal_cluster_id: Optional[pulumi.Input[str]] = None,
                                                                  ...
                                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetBareMetalClusterBareMetalNodePoolIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
