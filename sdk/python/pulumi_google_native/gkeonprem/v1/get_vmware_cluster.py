...
def get_vmware_cluster(location: Optional[str] = None,
    ...
    return AwaitableGetVmwareClusterResult(
        ...
        anti_affinity_groups=__ret__.anti_affinity_groups,
        authorization=__ret__.authorization,
        auto_repair_config=__ret__.auto_repair_config,
        control_plane_node=__ret__.control_plane_node,
        create_time=__ret__.create_time,
        dataplane_v2=__ret__.dataplane_v2,
        delete_time=__ret__.delete_time,
        description=__ret__.description,
        enable_control_plane_v2=__ret__.enable_control_plane_v2,
        ...
        vcenter=__ret__.vcenter,
        vm_tracking_enabled=__ret__.vm_tracking_enabled)
