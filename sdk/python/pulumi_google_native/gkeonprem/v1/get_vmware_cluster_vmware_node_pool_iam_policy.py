...
__all__ = [
    ...
    'AwaitableGetVmwareClusterVmwareNodePoolIamPolicyResult',
    'get_vmware_cluster_vmware_node_pool_iam_policy',
    'get_vmware_cluster_vmware_node_pool_iam_policy_output',
]
...
class AwaitableGetVmwareClusterVmwareNodePoolIamPolicyResult(GetVmwareClusterVmwareNodePoolIamPolicyResult):
...
def get_vmware_cluster_vmware_node_pool_iam_policy(location: Optional[str] = None,
                                                   ...
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVmwareClusterVmwareNodePoolIamPolicyResult:
    """
...
def get_vmware_cluster_vmware_node_pool_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                                          ...
                                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetVmwareClusterVmwareNodePoolIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
