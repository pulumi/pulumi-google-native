...
class VmwareDataplaneV2ConfigResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "forwardMode":
            suggest = "forward_mode"
    ...
    def __init__(__self__, *,
        ...
        :param str forward_mode: Configure ForwardMode for Dataplane v2.
        ...
        pulumi.set(__self__, "forward_mode", forward_mode)
    ...
    @property
    @pulumi.getter(name="forwardMode")
    def forward_mode(self) -> str:
        """
        Configure ForwardMode for Dataplane v2.
        """
        return pulumi.get(self, "forward_mode")
...
class VmwareNodeConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str image_type: The OS image to be used for each node in a node pool. Currently `cos`, `cos_cgv2`, `ubuntu`, `ubuntu_cgv2`, `ubuntu_containerd` and `windows` are supported.
