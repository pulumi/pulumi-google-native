...
__all__ = ['VmwareAdminClusterIamMemberArgs', 'VmwareAdminClusterIamMember']

@pulumi.input_type
class VmwareAdminClusterIamMemberArgs:
...
class VmwareAdminClusterIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: VmwareAdminClusterIamMemberArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param VmwareAdminClusterIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VmwareAdminClusterIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VmwareAdminClusterIamMemberArgs.__new__(VmwareAdminClusterIamMemberArgs)
        ...
        super(VmwareAdminClusterIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'VmwareAdminClusterIamMember':
        """
        ...
        return VmwareAdminClusterIamMember(resource_name, opts=opts, __props__=__props__)
