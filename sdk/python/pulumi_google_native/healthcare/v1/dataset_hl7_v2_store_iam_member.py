...
__all__ = ['DatasetHl7V2StoreIamMemberArgs', 'DatasetHl7V2StoreIamMember']

@pulumi.input_type
class DatasetHl7V2StoreIamMemberArgs:
...
class DatasetHl7V2StoreIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatasetHl7V2StoreIamMemberArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param DatasetHl7V2StoreIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatasetHl7V2StoreIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatasetHl7V2StoreIamMemberArgs.__new__(DatasetHl7V2StoreIamMemberArgs)
        ...
        super(DatasetHl7V2StoreIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DatasetHl7V2StoreIamMember':
        """
        ...
        return DatasetHl7V2StoreIamMember(resource_name, opts=opts, __props__=__props__)
