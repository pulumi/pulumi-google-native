...
__all__ = [
    ...
    'AwaitableGetDatasetConsentStoreIamPolicyResult',
    'get_dataset_consent_store_iam_policy',
    'get_dataset_consent_store_iam_policy_output',
]
...
class AwaitableGetDatasetConsentStoreIamPolicyResult(GetDatasetConsentStoreIamPolicyResult):
...
def get_dataset_consent_store_iam_policy(consent_store_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:healthcare/v1:getDatasetConsentStoreIamPolicy', __args__, opts=opts, typ=GetDatasetConsentStoreIamPolicyResult).value

    return AwaitableGetDatasetConsentStoreIamPolicyResult(
...
@_utilities.lift_output_func(get_dataset_consent_store_iam_policy)
