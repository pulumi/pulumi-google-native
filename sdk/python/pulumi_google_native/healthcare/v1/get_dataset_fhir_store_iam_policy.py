...
def get_dataset_fhir_store_iam_policy(dataset_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:healthcare/v1:getDatasetFhirStoreIamPolicy', __args__, opts=opts, typ=GetDatasetFhirStoreIamPolicyResult).value
