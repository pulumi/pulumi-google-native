...
__all__ = [
    'GetDatasetHl7V2StoreIamPolicyResult',
    'AwaitableGetDatasetHl7V2StoreIamPolicyResult',
    'get_dataset_hl7_v2_store_iam_policy',
    'get_dataset_hl7_v2_store_iam_policy_output',
]
...
class AwaitableGetDatasetHl7V2StoreIamPolicyResult(GetDatasetHl7V2StoreIamPolicyResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetDatasetHl7V2StoreIamPolicyResult(
...
def get_dataset_hl7_v2_store_iam_policy(dataset_id: Optional[str] = None,
                                        hl7_v2_store_id: Optional[str] = None,
                                        location: Optional[str] = None,
                                        options_requested_policy_version: Optional[str] = None,
                                        project: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatasetHl7V2StoreIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:healthcare/v1:getDatasetHl7V2StoreIamPolicy', __args__, opts=opts, typ=GetDatasetHl7V2StoreIamPolicyResult).value

    return AwaitableGetDatasetHl7V2StoreIamPolicyResult(
...
def get_dataset_hl7_v2_store_iam_policy_output(dataset_id: Optional[pulumi.Input[str]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDatasetHl7V2StoreIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
