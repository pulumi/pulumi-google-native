...
__all__ = ['DatasetDataMapperWorkspaceIamPolicyArgs', 'DatasetDataMapperWorkspaceIamPolicy']

@pulumi.input_type
class DatasetDataMapperWorkspaceIamPolicyArgs:
    def __init__(__self__, *,
                 data_mapper_workspace_id: pulumi.Input[str],
        ...
        """
        pulumi.set(__self__, "data_mapper_workspace_id", data_mapper_workspace_id)
    ...
    @property
    @pulumi.getter(name="dataMapperWorkspaceId")
    def data_mapper_workspace_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "data_mapper_workspace_id")

    @data_mapper_workspace_id.setter
    def data_mapper_workspace_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "data_mapper_workspace_id", value)
...
class DatasetDataMapperWorkspaceIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 data_mapper_workspace_id: Optional[pulumi.Input[str]] = None,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatasetDataMapperWorkspaceIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param DatasetDataMapperWorkspaceIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatasetDataMapperWorkspaceIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatasetDataMapperWorkspaceIamPolicyArgs.__new__(DatasetDataMapperWorkspaceIamPolicyArgs)

            __props__.__dict__["audit_configs"] = audit_configs
            __props__.__dict__["bindings"] = bindings
            if data_mapper_workspace_id is None and not opts.urn:
                raise TypeError("Missing required property 'data_mapper_workspace_id'")
            __props__.__dict__["data_mapper_workspace_id"] = data_mapper_workspace_id
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["data_mapper_workspace_id", "dataset_id", "location", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(DatasetDataMapperWorkspaceIamPolicy, __self__).__init__(
            'google-native:healthcare/v1beta1:DatasetDataMapperWorkspaceIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DatasetDataMapperWorkspaceIamPolicy':
        """
        ...
        __props__.__dict__["data_mapper_workspace_id"] = None
        __props__.__dict__["dataset_id"] = None
        __props__.__dict__["etag"] = None
        __props__.__dict__["location"] = None
        __props__.__dict__["project"] = None
        __props__.__dict__["version"] = None
        return DatasetDataMapperWorkspaceIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dataMapperWorkspaceId")
    def data_mapper_workspace_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "data_mapper_workspace_id")
