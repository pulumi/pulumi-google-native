...
class DicomStore(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 project: Optional[pulumi.Input[str]] = None,
                 stream_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GoogleCloudHealthcareV1beta1DicomStreamConfigArgs', 'GoogleCloudHealthcareV1beta1DicomStreamConfigArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['GoogleCloudHealthcareV1beta1DicomStreamConfigArgs', 'GoogleCloudHealthcareV1beta1DicomStreamConfigArgsDict']]]] stream_configs: Optional. A list of streaming configs used to configure the destination of streaming exports for every DICOM instance insertion in this DICOM store. After a new config is added to `stream_configs`, DICOM instance insertions are streamed to the new destination. When a config is removed from `stream_configs`, the server stops streaming to that destination. Each config must contain a unique destination.
        """
        ...
    @overload
    def __init__(__self__,
