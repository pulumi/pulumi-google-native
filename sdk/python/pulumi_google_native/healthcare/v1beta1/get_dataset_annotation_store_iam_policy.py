...
__all__ = [
    ...
    'AwaitableGetDatasetAnnotationStoreIamPolicyResult',
    'get_dataset_annotation_store_iam_policy',
    'get_dataset_annotation_store_iam_policy_output',
]
...
class AwaitableGetDatasetAnnotationStoreIamPolicyResult(GetDatasetAnnotationStoreIamPolicyResult):
...
def get_dataset_annotation_store_iam_policy(annotation_store_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:healthcare/v1beta1:getDatasetAnnotationStoreIamPolicy', __args__, opts=opts, typ=GetDatasetAnnotationStoreIamPolicyResult).value

    return AwaitableGetDatasetAnnotationStoreIamPolicyResult(
...
@_utilities.lift_output_func(get_dataset_annotation_store_iam_policy)
