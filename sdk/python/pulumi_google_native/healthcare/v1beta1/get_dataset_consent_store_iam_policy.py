...
def get_dataset_consent_store_iam_policy(consent_store_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:healthcare/v1beta1:getDatasetConsentStoreIamPolicy', __args__, opts=opts, typ=GetDatasetConsentStoreIamPolicyResult).value
