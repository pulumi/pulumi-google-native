...
def get_workforce_pool_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:iam/v1:getWorkforcePoolIamPolicy', __args__, opts=opts, typ=GetWorkforcePoolIamPolicyResult).value
...
@_utilities.lift_output_func(get_workforce_pool_iam_policy)
def get_workforce_pool_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWorkforcePoolIamPolicyResult]:
    """
    Gets IAM policies on a WorkforcePool.
    """
    ...
