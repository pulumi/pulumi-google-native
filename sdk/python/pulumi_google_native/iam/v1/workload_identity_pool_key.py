...
__all__ = ['WorkloadIdentityPoolKeyArgs', 'WorkloadIdentityPoolKey']
...
class WorkloadIdentityPoolKeyArgs:
    ...
    @property
    @pulumi.getter(name="workloadIdentityPoolProviderKeyId")
    def workload_identity_pool_provider_key_id(self) -> pulumi.Input[str]:
        """
        ...
        """
        return pulumi.get(self, "workload_identity_pool_provider_key_id")

    @workload_identity_pool_provider_key_id.setter
    def workload_identity_pool_provider_key_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "workload_identity_pool_provider_key_id", value)
...
class WorkloadIdentityPoolKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 workload_identity_pool_provider_key_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkloadIdentityPoolKeyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkloadIdentityPoolKeyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkloadIdentityPoolKeyArgs.__new__(WorkloadIdentityPoolKeyArgs)
            ...
            if workload_identity_pool_provider_key_id is None and not opts.urn:
                raise TypeError("Missing required property 'workload_identity_pool_provider_key_id'")
            __props__.__dict__["workload_identity_pool_provider_key_id"] = workload_identity_pool_provider_key_id
            __props__.__dict__["expire_time"] = None
            __props__.__dict__["name"] = None
            __props__.__dict__["state"] = None
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "project", "provider_id", "workload_identity_pool_id", "workload_identity_pool_provider_key_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(WorkloadIdentityPoolKey, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WorkloadIdentityPoolKey':
        """
        ...
        __props__.__dict__["workload_identity_pool_provider_key_id"] = None
        return WorkloadIdentityPoolKey(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="workloadIdentityPoolProviderKeyId")
    def workload_identity_pool_provider_key_id(self) -> pulumi.Output[str]:
        """
        Required. The ID to use for the key, which becomes the final component of the resource name. This value should be 4-32 characters, and may contain the characters [a-z0-9-].
        """
        return pulumi.get(self, "workload_identity_pool_provider_key_id")
