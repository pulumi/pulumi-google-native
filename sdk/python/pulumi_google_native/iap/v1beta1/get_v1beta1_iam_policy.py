...
@pulumi.output_type
class GetV1beta1IamPolicyResult:
...
class AwaitableGetV1beta1IamPolicyResult(GetV1beta1IamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetV1beta1IamPolicyResult(
            bindings=self.bindings,
            etag=self.etag,
            version=self.version)


def get_v1beta1_iam_policy(v1beta1_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetV1beta1IamPolicyResult:
    """
