...
__all__ = [
    ...
    'GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyArgs',
...
class GoogleCloudIdentitytoolkitAdminV2RecaptchaConfigArgs:
    def __init__(__self__, *,
                 ...
                 recaptcha_keys: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyArgs']]] recaptcha_keys: The reCAPTCHA keys.
    ...
    def recaptcha_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyArgs']]]]:
        """
        The reCAPTCHA keys.
        """
    ...
    def recaptcha_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyArgs']]]]):
        pulumi.set(self, "recaptcha_keys", value)
...
@pulumi.input_type
class GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyArgs:
    def __init__(__self__, *,
                 key: Optional[pulumi.Input[str]] = None,
                 type: Optional[pulumi.Input['GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyType']] = None):
        """
        The reCAPTCHA key config. reCAPTCHA Enterprise offers different keys for different client platforms.
        :param pulumi.Input[str] key: The reCAPTCHA Enterprise key resource name, e.g. "projects/{project}/keys/{key}"
        :param pulumi.Input['GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyType'] type: The client's platform type.
        """
        if key is not None:
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input['GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyType']]:
        """
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input['GoogleCloudIdentitytoolkitAdminV2RecaptchaKeyType']]):
