...
class GetTenantResult:
    def __init__(__self__, allow_password_signup=None, autodelete_anonymous_users=None, disable_auth=None, display_name=None, enable_anonymous_user=None, enable_email_link_signin=None, hash_config=None, inheritance=None, mfa_config=None, name=None, test_phone_numbers=None):
