...
__all__ = [
    ...
    'AwaitableGetTenantIamPolicyResult',
    'get_tenant_iam_policy',
    'get_tenant_iam_policy_output',
]
...
class AwaitableGetTenantIamPolicyResult(GetTenantIamPolicyResult):
...
def get_tenant_iam_policy(project: Optional[str] = None,
                          tenant_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTenantIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:identitytoolkit/v2:getTenantIamPolicy', __args__, opts=opts, typ=GetTenantIamPolicyResult).value

    return AwaitableGetTenantIamPolicyResult(
...
@_utilities.lift_output_func(get_tenant_iam_policy)
def get_tenant_iam_policy_output(project: Optional[pulumi.Input[Optional[str]]] = None,
                                 tenant_id: Optional[pulumi.Input[str]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetTenantIamPolicyResult]:
    """
    Gets the access control policy for a resource. An error is returned if the resource does not exist. An empty policy is returned if the resource exists but does not have a policy set on it. Caller must have the right Google IAM permission on the resource.
    """
    ...
