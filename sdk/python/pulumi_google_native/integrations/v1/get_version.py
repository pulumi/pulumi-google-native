...
def get_version(integration_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:integrations/v1:getVersion', __args__, opts=opts, typ=GetVersionResult).value
    ...
    return AwaitableGetVersionResult(
        ...
        lock_holder=__ret__.lock_holder,
        name=__ret__.name,
        ...
        task_configs_internal=__ret__.task_configs_internal,
        teardown=__ret__.teardown,
        trigger_configs=__ret__.trigger_configs,
        trigger_configs_internal=__ret__.trigger_configs_internal,
