...
__all__ = [
    ...
    'AwaitableGetBillingAccountBucketResult',
    'get_billing_account_bucket',
    'get_billing_account_bucket_output',
]
...
class AwaitableGetBillingAccountBucketResult(GetBillingAccountBucketResult):
...
def get_billing_account_bucket(billing_account_id: Optional[str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBillingAccountBucketResult:
    """
    Gets a log bucket.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('google-native:logging/v2:getBillingAccountBucket', __args__, opts=opts, typ=GetBillingAccountBucketResult).value

    return AwaitableGetBillingAccountBucketResult(
...
@_utilities.lift_output_func(get_billing_account_bucket)
def get_billing_account_bucket_output(billing_account_id: Optional[pulumi.Input[str]] = None,
                                      bucket_id: Optional[pulumi.Input[str]] = None,
                                      location: Optional[pulumi.Input[str]] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetBillingAccountBucketResult]:
    """
    Gets a log bucket.
    """
    ...
