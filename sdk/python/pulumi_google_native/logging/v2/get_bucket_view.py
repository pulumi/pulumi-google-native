...
__all__ = [
    'GetBucketViewResult',
    'AwaitableGetBucketViewResult',
    'get_bucket_view',
    'get_bucket_view_output',
]
...
class AwaitableGetBucketViewResult(GetBucketViewResult):
...
def get_bucket_view(bucket_id: Optional[str] = None,
                    location: Optional[str] = None,
                    project: Optional[str] = None,
                    view_id: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBucketViewResult:
    """
...
def get_bucket_view_output(bucket_id: Optional[pulumi.Input[str]] = None,
                           location: Optional[pulumi.Input[str]] = None,
                           project: Optional[pulumi.Input[Optional[str]]] = None,
                           view_id: Optional[pulumi.Input[str]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetBucketViewResult]:
    """
    Gets a view on a log bucket..
    """
    ...
