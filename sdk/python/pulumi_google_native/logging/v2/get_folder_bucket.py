...
__all__ = [
    ...
    'AwaitableGetFolderBucketResult',
    'get_folder_bucket',
    'get_folder_bucket_output',
]
...
class AwaitableGetFolderBucketResult(GetFolderBucketResult):
...
def get_folder_bucket(bucket_id: Optional[str] = None,
                      folder_id: Optional[str] = None,
                      location: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFolderBucketResult:
    """
    Gets a log bucket.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('google-native:logging/v2:getFolderBucket', __args__, opts=opts, typ=GetFolderBucketResult).value

    return AwaitableGetFolderBucketResult(
...
@_utilities.lift_output_func(get_folder_bucket)
def get_folder_bucket_output(bucket_id: Optional[pulumi.Input[str]] = None,
                             folder_id: Optional[pulumi.Input[str]] = None,
                             location: Optional[pulumi.Input[str]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFolderBucketResult]:
    """
    Gets a log bucket.
    """
    ...
