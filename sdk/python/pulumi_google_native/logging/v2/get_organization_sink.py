...
__all__ = [
    'GetOrganizationSinkResult',
    'AwaitableGetOrganizationSinkResult',
    'get_organization_sink',
    'get_organization_sink_output',
]

@pulumi.output_type
class GetOrganizationSinkResult:
...
class AwaitableGetOrganizationSinkResult(GetOrganizationSinkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrganizationSinkResult(
...
def get_organization_sink(organization_id: Optional[str] = None,
                          sink_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrganizationSinkResult:
    """
    Gets a sink.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('google-native:logging/v2:getOrganizationSink', __args__, opts=opts, typ=GetOrganizationSinkResult).value

    return AwaitableGetOrganizationSinkResult(
...
@_utilities.lift_output_func(get_organization_sink)
def get_organization_sink_output(organization_id: Optional[pulumi.Input[str]] = None,
                                 sink_id: Optional[pulumi.Input[str]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOrganizationSinkResult]:
    """
    Gets a sink.
    """
    ...
