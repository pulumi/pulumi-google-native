...
__all__ = ['OrganizationBucketLinkArgs', 'OrganizationBucketLink']
...
class OrganizationBucketLink(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param OrganizationBucketLinkArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationBucketLinkArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OrganizationBucketLinkArgs.__new__(OrganizationBucketLinkArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OrganizationBucketLink':
        """
        ...
        return OrganizationBucketLink(resource_name, opts=opts, __props__=__props__)
