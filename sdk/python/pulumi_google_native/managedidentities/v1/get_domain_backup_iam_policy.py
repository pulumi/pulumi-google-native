...
__all__ = [
    ...
    'AwaitableGetDomainBackupIamPolicyResult',
    'get_domain_backup_iam_policy',
    'get_domain_backup_iam_policy_output',
]
...
class AwaitableGetDomainBackupIamPolicyResult(GetDomainBackupIamPolicyResult):
...
def get_domain_backup_iam_policy(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:managedidentities/v1:getDomainBackupIamPolicy', __args__, opts=opts, typ=GetDomainBackupIamPolicyResult).value
