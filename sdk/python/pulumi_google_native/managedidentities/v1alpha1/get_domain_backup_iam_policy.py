...
def get_domain_backup_iam_policy(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:managedidentities/v1alpha1:getDomainBackupIamPolicy', __args__, opts=opts, typ=GetDomainBackupIamPolicyResult).value
