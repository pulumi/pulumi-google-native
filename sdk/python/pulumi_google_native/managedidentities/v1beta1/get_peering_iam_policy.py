...
__all__ = [
    ...
    'AwaitableGetPeeringIamPolicyResult',
    'get_peering_iam_policy',
    'get_peering_iam_policy_output',
]
...
class AwaitableGetPeeringIamPolicyResult(GetPeeringIamPolicyResult):
...
def get_peering_iam_policy(options_requested_policy_version: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:managedidentities/v1beta1:getPeeringIamPolicy', __args__, opts=opts, typ=GetPeeringIamPolicyResult).value
