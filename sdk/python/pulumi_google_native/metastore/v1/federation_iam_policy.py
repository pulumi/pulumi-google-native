...
__all__ = ['FederationIamPolicyArgs', 'FederationIamPolicy']

@pulumi.input_type
class FederationIamPolicyArgs:
...
class FederationIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FederationIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FederationIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FederationIamPolicyArgs.__new__(FederationIamPolicyArgs)
        ...
        super(FederationIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FederationIamPolicy':
        """
        Get an existing FederationIamPolicy resource's state with the given name, id, and optional extra
        ...
        return FederationIamPolicy(resource_name, opts=opts, __props__=__props__)
