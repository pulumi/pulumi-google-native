...
__all__ = [
    'GetFederationIamPolicyResult',
    'AwaitableGetFederationIamPolicyResult',
    'get_federation_iam_policy',
    'get_federation_iam_policy_output',
]

@pulumi.output_type
class GetFederationIamPolicyResult:
...
class AwaitableGetFederationIamPolicyResult(GetFederationIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederationIamPolicyResult(
...
def get_federation_iam_policy(federation_id: Optional[str] = None,
                              location: Optional[str] = None,
                              options_requested_policy_version: Optional[int] = None,
                              project: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederationIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:metastore/v1:getFederationIamPolicy', __args__, opts=opts, typ=GetFederationIamPolicyResult).value

    return AwaitableGetFederationIamPolicyResult(
...
@_utilities.lift_output_func(get_federation_iam_policy)
def get_federation_iam_policy_output(federation_id: Optional[pulumi.Input[str]] = None,
                                     location: Optional[pulumi.Input[str]] = None,
                                     options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                     project: Optional[pulumi.Input[Optional[str]]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFederationIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
