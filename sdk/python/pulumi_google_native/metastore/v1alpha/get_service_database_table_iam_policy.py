...
__all__ = [
    'GetServiceDatabaseTableIamPolicyResult',
    'AwaitableGetServiceDatabaseTableIamPolicyResult',
    'get_service_database_table_iam_policy',
    'get_service_database_table_iam_policy_output',
]

@pulumi.output_type
class GetServiceDatabaseTableIamPolicyResult:
...
class AwaitableGetServiceDatabaseTableIamPolicyResult(GetServiceDatabaseTableIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceDatabaseTableIamPolicyResult(
...
def get_service_database_table_iam_policy(database_id: Optional[str] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceDatabaseTableIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:metastore/v1alpha:getServiceDatabaseTableIamPolicy', __args__, opts=opts, typ=GetServiceDatabaseTableIamPolicyResult).value
...
def get_service_database_table_iam_policy_output(database_id: Optional[pulumi.Input[str]] = None,
                                                 ...
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceDatabaseTableIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
