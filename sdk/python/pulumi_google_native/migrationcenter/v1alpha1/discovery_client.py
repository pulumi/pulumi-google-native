...
class DiscoveryClientArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] source: Full name of the source object associated with this discovery client.
...
class DiscoveryClient(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(DiscoveryClient, __self__).__init__(
            'google-native:migrationcenter/v1alpha1:DiscoveryClient',
            resource_name,
            __props__,
            opts)
