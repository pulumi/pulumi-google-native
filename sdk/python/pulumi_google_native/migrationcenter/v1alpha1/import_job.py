...
class ImportJobArgs:
    def __init__(__self__, *,
                 ...
                 gcs_payload: Optional[pulumi.Input['GCSPayloadInfoArgs']] = None,
                 inline_payload: Optional[pulumi.Input['InlinePayloadInfoArgs']] = None,
        ...
        :param pulumi.Input['GCSPayloadInfoArgs'] gcs_payload: The payload is in Google Cloud Storage.
        :param pulumi.Input['InlinePayloadInfoArgs'] inline_payload: The payload is included in the request, mainly used for small import jobs.
    ...
    def gcs_payload(self) -> Optional[pulumi.Input['GCSPayloadInfoArgs']]:
        """
    ...
    @gcs_payload.setter
    def gcs_payload(self, value: Optional[pulumi.Input['GCSPayloadInfoArgs']]):
        pulumi.set(self, "gcs_payload", value)

    @property
    @pulumi.getter(name="inlinePayload")
    def inline_payload(self) -> Optional[pulumi.Input['InlinePayloadInfoArgs']]:
        """
    ...
    def inline_payload(self, value: Optional[pulumi.Input['InlinePayloadInfoArgs']]):
...
class ImportJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["gcs_payload"] = gcs_payload
            ...
            __props__.__dict__["inline_payload"] = inline_payload
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["execution_report"] = None
        __props__.__dict__["gcs_payload"] = None
        __props__.__dict__["import_job_id"] = None
        __props__.__dict__["inline_payload"] = None
    ...
    @property
    @pulumi.getter(name="gcsPayload")
    def gcs_payload(self) -> pulumi.Output['outputs.GCSPayloadInfoResponse']:
        """
        The payload is in Google Cloud Storage.
        """
        return pulumi.get(self, "gcs_payload")
    ...
    @property
    @pulumi.getter(name="inlinePayload")
    def inline_payload(self) -> pulumi.Output['outputs.InlinePayloadInfoResponse']:
        """
        The payload is included in the request, mainly used for small import jobs.
        """
        return pulumi.get(self, "inline_payload")
