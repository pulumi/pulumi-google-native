...
class ReportArgs:
    def __init__(__self__, *,
                 report_config_id: pulumi.Input[str],
                 ...
                 state: Optional[pulumi.Input['ReportState']] = None,
                 type: Optional[pulumi.Input['ReportType']] = None):
        """
        The set of arguments for constructing a Report resource.
        :param pulumi.Input[str] report_id: Required. User specified id for the report. It will become the last component of the report name. The id must be unique within the project, must conform with RFC-1034, is restricted to lower-cased letters, and has a maximum length of 63 characters. The id must match the regular expression: [a-z]([a-z0-9-]{0,61}[a-z0-9])?.
        ...
        :param pulumi.Input['ReportState'] state: Report creation state.
        :param pulumi.Input['ReportType'] type: Report type.
        """
    ...
    def report_config_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "report_config_id")

    @report_config_id.setter
    def report_config_id(self, value: pulumi.Input[str]):
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input['ReportState']]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input['ReportState']]):
        pulumi.set(self, "state", value)

    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input['ReportType']]:
        """
        Report type.
        """
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input['ReportType']]):
...
class Report(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "project", "report_config_id", "report_id"])
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["report_config_id"] = None
    ...
    @property
    @pulumi.getter(name="reportConfigId")
    def report_config_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "report_config_id")
    ...
    @property
    @pulumi.getter
    def summary(self) -> pulumi.Output['outputs.ReportSummaryResponse']:
        """
