...
class PrometheusQueryLanguageConditionArgs:
    def __init__(__self__, *,
                 evaluation_interval: pulumi.Input[str],
        ...
        :param pulumi.Input[str] duration: Optional. Alerts are considered firing once their PromQL expression was evaluated to be "true" for this long. Alerts whose PromQL expression was not evaluated to be "true" for long enough are considered pending. The default value is zero. Must be zero or positive.
    ...
    def evaluation_interval(self) -> pulumi.Input[str]:
        """
    ...
    def evaluation_interval(self, value: pulumi.Input[str]):
