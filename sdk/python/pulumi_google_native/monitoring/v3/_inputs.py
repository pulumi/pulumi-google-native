...
class MetricThresholdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MetricThresholdEvaluationMissingData'] evaluation_missing_data: A condition control that determines how metric-threshold conditions are evaluated when data stops arriving. To use this control, the value of the duration field must be greater than or equal to 60 seconds.
