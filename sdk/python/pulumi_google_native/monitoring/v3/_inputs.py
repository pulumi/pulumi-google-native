...
class DocumentationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] content: The body of the notification, interpreted according to mime_type. The content may not exceed 8,192 Unicode characters and may not exceed more than 10,240 bytes when encoded in UTF-8 format, whichever is smaller. This text can be templatized by using variables (https://cloud.google.com/monitoring/alerts/doc-variables).
        ...
        :param pulumi.Input[str] subject: A public comment for an internal field, because the linter insists that all fields must have a comment. Sigh.
        """
        if content is not None:
            pulumi.set(__self__, "content", content)
