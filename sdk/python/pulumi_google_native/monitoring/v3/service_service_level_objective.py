...
__all__ = ['ServiceServiceLevelObjectiveArgs', 'ServiceServiceLevelObjective']
...
class ServiceServiceLevelObjective(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceServiceLevelObjectiveArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ServiceLevelObjective for the given Service.

        :param str resource_name: The name of the resource.
        :param ServiceServiceLevelObjectiveArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceServiceLevelObjectiveArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceServiceLevelObjectiveArgs.__new__(ServiceServiceLevelObjectiveArgs)
        ...
        super(ServiceServiceLevelObjective, __self__).__init__(
            'google-native:monitoring/v3:ServiceServiceLevelObjective',
            resource_name,
            __props__,
            opts)
