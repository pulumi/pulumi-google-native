...
class Snooze(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 criteria: Optional[pulumi.Input[Union['CriteriaArgs', 'CriteriaArgsDict']]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 interval: Optional[pulumi.Input[Union['TimeIntervalArgs', 'TimeIntervalArgsDict']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['CriteriaArgs', 'CriteriaArgsDict']] criteria: This defines the criteria for applying the Snooze. See Criteria for more information.
        :param pulumi.Input[str] display_name: A display name for the Snooze. This can be, at most, 512 unicode characters.
        :param pulumi.Input[Union['TimeIntervalArgs', 'TimeIntervalArgsDict']] interval: The Snooze will be active from interval.start_time through interval.end_time. interval.start_time cannot be in the past. There is a 15 second clock skew to account for the time it takes for a request to reach the API from the UI.
        :param pulumi.Input[str] name: The name of the Snooze. The format is: projects/[PROJECT_ID_OR_NUMBER]/snoozes/[SNOOZE_ID] The ID of the Snooze will be generated by the system.
        """
        ...
    @overload
