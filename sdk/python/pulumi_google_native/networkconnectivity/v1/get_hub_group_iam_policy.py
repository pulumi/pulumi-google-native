...
__all__ = [
    'GetHubGroupIamPolicyResult',
    'AwaitableGetHubGroupIamPolicyResult',
    'get_hub_group_iam_policy',
    'get_hub_group_iam_policy_output',
]

@pulumi.output_type
class GetHubGroupIamPolicyResult:
...
class AwaitableGetHubGroupIamPolicyResult(GetHubGroupIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetHubGroupIamPolicyResult(
...
def get_hub_group_iam_policy(group_id: Optional[str] = None,
                             hub_id: Optional[str] = None,
                             options_requested_policy_version: Optional[int] = None,
                             project: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHubGroupIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkconnectivity/v1:getHubGroupIamPolicy', __args__, opts=opts, typ=GetHubGroupIamPolicyResult).value

    return AwaitableGetHubGroupIamPolicyResult(
...
@_utilities.lift_output_func(get_hub_group_iam_policy)
def get_hub_group_iam_policy_output(group_id: Optional[pulumi.Input[str]] = None,
                                    hub_id: Optional[pulumi.Input[str]] = None,
                                    options_requested_policy_version: Optional[pulumi.Input[Optional[int]]] = None,
                                    project: Optional[pulumi.Input[Optional[str]]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetHubGroupIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
