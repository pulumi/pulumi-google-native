...
__all__ = [
    'GetServiceClassIamPolicyResult',
    'AwaitableGetServiceClassIamPolicyResult',
    'get_service_class_iam_policy',
    'get_service_class_iam_policy_output',
]

@pulumi.output_type
class GetServiceClassIamPolicyResult:
...
class AwaitableGetServiceClassIamPolicyResult(GetServiceClassIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceClassIamPolicyResult(
...
def get_service_class_iam_policy(location: Optional[str] = None,
                                 options_requested_policy_version: Optional[int] = None,
                                 project: Optional[str] = None,
                                 service_class_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceClassIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkconnectivity/v1:getServiceClassIamPolicy', __args__, opts=opts, typ=GetServiceClassIamPolicyResult).value

    return AwaitableGetServiceClassIamPolicyResult(
...
@_utilities.lift_output_func(get_service_class_iam_policy)
def get_service_class_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceClassIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
