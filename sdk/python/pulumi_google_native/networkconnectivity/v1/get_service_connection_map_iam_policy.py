...
def get_service_connection_map_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkconnectivity/v1:getServiceConnectionMapIamPolicy', __args__, opts=opts, typ=GetServiceConnectionMapIamPolicyResult).value
