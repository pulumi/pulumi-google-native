...
class GetSpokeResult:
    def __init__(__self__, create_time=None, description=None, hub=None, labels=None, linked_interconnect_attachments=None, linked_router_appliance_instances=None, linked_vpc_network=None, linked_vpn_tunnels=None, name=None, reasons=None, spoke_type=None, state=None, unique_id=None, update_time=None):
...
def get_spoke(location: Optional[str] = None,
    ...
    return AwaitableGetSpokeResult(
        ...
        linked_vpc_network=__ret__.linked_vpc_network,
        linked_vpn_tunnels=__ret__.linked_vpn_tunnels,
        name=__ret__.name,
        reasons=__ret__.reasons,
        spoke_type=__ret__.spoke_type,
        state=__ret__.state,
