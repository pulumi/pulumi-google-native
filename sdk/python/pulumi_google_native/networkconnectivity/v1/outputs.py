...
class ConsumerPscConnectionResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "selectedSubnetwork":
            suggest = "selected_subnetwork"
    ...
    def __init__(__self__, *,
        ...
        :param str selected_subnetwork: The URI of the selected subnetwork selected to allocate IP address for this connection.
        ...
        pulumi.set(__self__, "selected_subnetwork", selected_subnetwork)
    ...
    @property
    @pulumi.getter(name="selectedSubnetwork")
    def selected_subnetwork(self) -> str:
        """
        The URI of the selected subnetwork selected to allocate IP address for this connection.
        """
        return pulumi.get(self, "selected_subnetwork")
...
class PscConnectionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str selected_subnetwork: The URI of the subnetwork selected to allocate IP address for this connection.
