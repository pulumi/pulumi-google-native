...
__all__ = ['ServiceConnectionPolicyIamPolicyArgs', 'ServiceConnectionPolicyIamPolicy']

@pulumi.input_type
class ServiceConnectionPolicyIamPolicyArgs:
    def __init__(__self__, *,
                 service_connection_policy_id: pulumi.Input[str],
    ...
    def service_connection_policy_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "service_connection_policy_id")

    @service_connection_policy_id.setter
    def service_connection_policy_id(self, value: pulumi.Input[str]):
...
class ServiceConnectionPolicyIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceConnectionPolicyIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param ServiceConnectionPolicyIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceConnectionPolicyIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceConnectionPolicyIamPolicyArgs.__new__(ServiceConnectionPolicyIamPolicyArgs)
            ...
            if service_connection_policy_id is None and not opts.urn:
                raise TypeError("Missing required property 'service_connection_policy_id'")
            __props__.__dict__["service_connection_policy_id"] = service_connection_policy_id
            __props__.__dict__["update_mask"] = update_mask
            __props__.__dict__["version"] = version
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "project", "service_connection_policy_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ServiceConnectionPolicyIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServiceConnectionPolicyIamPolicy':
        """
        ...
        return ServiceConnectionPolicyIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="serviceConnectionPolicyId")
    def service_connection_policy_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "service_connection_policy_id")
