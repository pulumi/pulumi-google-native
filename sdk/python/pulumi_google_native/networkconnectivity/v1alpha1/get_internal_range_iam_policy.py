...
class AwaitableGetInternalRangeIamPolicyResult(GetInternalRangeIamPolicyResult):
...
def get_internal_range_iam_policy(internal_range_id: Optional[str] = None,
                                  location: Optional[str] = None,
                                  options_requested_policy_version: Optional[str] = None,
                                  project: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInternalRangeIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkconnectivity/v1alpha1:getInternalRangeIamPolicy', __args__, opts=opts, typ=GetInternalRangeIamPolicyResult).value

    return AwaitableGetInternalRangeIamPolicyResult(
