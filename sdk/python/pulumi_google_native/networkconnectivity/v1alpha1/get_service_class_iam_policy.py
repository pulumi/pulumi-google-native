...
def get_service_class_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkconnectivity/v1alpha1:getServiceClassIamPolicy', __args__, opts=opts, typ=GetServiceClassIamPolicyResult).value
