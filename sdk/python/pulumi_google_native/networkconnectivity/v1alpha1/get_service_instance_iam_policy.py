...
__all__ = [
    'GetServiceInstanceIamPolicyResult',
    'AwaitableGetServiceInstanceIamPolicyResult',
    'get_service_instance_iam_policy',
    'get_service_instance_iam_policy_output',
]

@pulumi.output_type
class GetServiceInstanceIamPolicyResult:
...
class AwaitableGetServiceInstanceIamPolicyResult(GetServiceInstanceIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceInstanceIamPolicyResult(
...
def get_service_instance_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkconnectivity/v1alpha1:getServiceInstanceIamPolicy', __args__, opts=opts, typ=GetServiceInstanceIamPolicyResult).value

    return AwaitableGetServiceInstanceIamPolicyResult(
