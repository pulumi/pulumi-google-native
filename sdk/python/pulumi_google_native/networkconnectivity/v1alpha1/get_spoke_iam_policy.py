...
__all__ = [
    ...
    'AwaitableGetSpokeIamPolicyResult',
    'get_spoke_iam_policy',
    'get_spoke_iam_policy_output',
]
...
class AwaitableGetSpokeIamPolicyResult(GetSpokeIamPolicyResult):
...
def get_spoke_iam_policy(location: Optional[str] = None,
                         options_requested_policy_version: Optional[str] = None,
                         project: Optional[str] = None,
                         spoke_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSpokeIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkconnectivity/v1alpha1:getSpokeIamPolicy', __args__, opts=opts, typ=GetSpokeIamPolicyResult).value
...
@_utilities.lift_output_func(get_spoke_iam_policy)
def get_spoke_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
                                project: Optional[pulumi.Input[Optional[str]]] = None,
                                spoke_id: Optional[pulumi.Input[str]] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSpokeIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
