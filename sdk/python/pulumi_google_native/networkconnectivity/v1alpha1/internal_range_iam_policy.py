...
class InternalRangeIamPolicyArgs:
    def __init__(__self__, *,
                 internal_range_id: pulumi.Input[str],
    ...
    def internal_range_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "internal_range_id")

    @internal_range_id.setter
    def internal_range_id(self, value: pulumi.Input[str]):
...
class InternalRangeIamPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if internal_range_id is None and not opts.urn:
                raise TypeError("Missing required property 'internal_range_id'")
    ...
    @property
    @pulumi.getter(name="internalRangeId")
    def internal_range_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "internal_range_id")
