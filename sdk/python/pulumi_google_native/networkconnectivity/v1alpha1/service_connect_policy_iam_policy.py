...
__all__ = ['ServiceConnectPolicyIamPolicyArgs', 'ServiceConnectPolicyIamPolicy']

@pulumi.input_type
class ServiceConnectPolicyIamPolicyArgs:
    def __init__(__self__, *,
                 service_connect_policy_id: pulumi.Input[str],
        ...
        """
        pulumi.set(__self__, "service_connect_policy_id", service_connect_policy_id)
    ...
    @property
    @pulumi.getter(name="serviceConnectPolicyId")
    def service_connect_policy_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "service_connect_policy_id")

    @service_connect_policy_id.setter
    def service_connect_policy_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "service_connect_policy_id", value)
...
class ServiceConnectPolicyIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceConnectPolicyIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param ServiceConnectPolicyIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceConnectPolicyIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceConnectPolicyIamPolicyArgs.__new__(ServiceConnectPolicyIamPolicyArgs)
            ...
            if service_connect_policy_id is None and not opts.urn:
                raise TypeError("Missing required property 'service_connect_policy_id'")
            __props__.__dict__["service_connect_policy_id"] = service_connect_policy_id
            __props__.__dict__["update_mask"] = update_mask
            __props__.__dict__["version"] = version
        super(ServiceConnectPolicyIamPolicy, __self__).__init__(
            'google-native:networkconnectivity/v1alpha1:ServiceConnectPolicyIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServiceConnectPolicyIamPolicy':
        """
        ...
        return ServiceConnectPolicyIamPolicy(resource_name, opts=opts, __props__=__props__)
