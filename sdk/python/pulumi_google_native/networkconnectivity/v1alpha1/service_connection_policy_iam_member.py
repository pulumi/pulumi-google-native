...
__all__ = ['ServiceConnectionPolicyIamMemberArgs', 'ServiceConnectionPolicyIamMember']

@pulumi.input_type
class ServiceConnectionPolicyIamMemberArgs:
...
class ServiceConnectionPolicyIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceConnectionPolicyIamMemberArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

        :param str resource_name: The name of the resource.
        :param ServiceConnectionPolicyIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceConnectionPolicyIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceConnectionPolicyIamMemberArgs.__new__(ServiceConnectionPolicyIamMemberArgs)
        ...
        super(ServiceConnectionPolicyIamMember, __self__).__init__(
            'google-native:networkconnectivity/v1alpha1:ServiceConnectionPolicyIamMember',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServiceConnectionPolicyIamMember':
        """
        ...
        return ServiceConnectionPolicyIamMember(resource_name, opts=opts, __props__=__props__)
