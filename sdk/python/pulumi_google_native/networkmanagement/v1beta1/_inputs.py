...
@pulumi.input_type
class CloudFunctionEndpointArgs:
    def __init__(__self__, *,
                 uri: Optional[pulumi.Input[str]] = None):
        """
        Wrapper for Cloud Function attributes.
        :param pulumi.Input[str] uri: A [Cloud Function](https://cloud.google.com/functions) name.
        """
        if uri is not None:
            pulumi.set(__self__, "uri", uri)
...
class EndpointArgs:
    def __init__(__self__, *,
                 ...
                 network_type: Optional[pulumi.Input['EndpointNetworkType']] = None,
        ...
        :param pulumi.Input[str] forwarding_rule: Forwarding rule URI. Forwarding rules are frontends for load balancers, PSC endpoints and Protocol Forwarding. Format: projects/{project}/global/forwardingRules/{id} or projects/{project}/regions/{region}/forwardingRules/{id}
    ...
    def network_type(self) -> Optional[pulumi.Input['EndpointNetworkType']]:
        """
    ...
    @network_type.setter
    def network_type(self, value: Optional[pulumi.Input['EndpointNetworkType']]):
