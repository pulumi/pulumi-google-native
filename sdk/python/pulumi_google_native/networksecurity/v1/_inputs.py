...
@pulumi.input_type
class GoogleCloudNetworksecurityV1CertificateProviderArgs:
    def __init__(__self__, *,
                 certificate_provider_instance: Optional[pulumi.Input['CertificateProviderInstanceArgs']] = None,
                 grpc_endpoint: Optional[pulumi.Input['GoogleCloudNetworksecurityV1GrpcEndpointArgs']] = None):
        """
        ...
        :param pulumi.Input['GoogleCloudNetworksecurityV1GrpcEndpointArgs'] grpc_endpoint: gRPC specific configuration to access the gRPC server to obtain the cert and private key.
        """
    ...
    def grpc_endpoint(self) -> Optional[pulumi.Input['GoogleCloudNetworksecurityV1GrpcEndpointArgs']]:
        """
    ...
    def grpc_endpoint(self, value: Optional[pulumi.Input['GoogleCloudNetworksecurityV1GrpcEndpointArgs']]):
        pulumi.set(self, "grpc_endpoint", value)


@pulumi.input_type
class GoogleCloudNetworksecurityV1GrpcEndpointArgs:
    def __init__(__self__, *,
...
class ValidationCAArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CertificateProviderInstanceArgs'] certificate_provider_instance: The certificate provider instance specification that will be passed to the data plane, which will be used to load necessary credential information.
        :param pulumi.Input['GoogleCloudNetworksecurityV1GrpcEndpointArgs'] grpc_endpoint: gRPC specific configuration to access the gRPC server to obtain the CA certificate.
        """
        if certificate_provider_instance is not None:
            pulumi.set(__self__, "certificate_provider_instance", certificate_provider_instance)
        if grpc_endpoint is not None:
