...
__all__ = ['AddressGroupIamMemberArgs', 'AddressGroupIamMember']
...
class AddressGroupIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AddressGroupIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AddressGroupIamMemberArgs.__new__(AddressGroupIamMemberArgs)
        ...
        super(AddressGroupIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AddressGroupIamMember':
        """
        ...
        return AddressGroupIamMember(resource_name, opts=opts, __props__=__props__)
