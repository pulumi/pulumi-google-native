...
def get_firewall_endpoint_association(firewall_endpoint_association_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networksecurity/v1:getFirewallEndpointAssociation', __args__, opts=opts, typ=GetFirewallEndpointAssociationResult).value
