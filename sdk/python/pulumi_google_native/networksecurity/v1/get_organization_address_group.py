...
def get_organization_address_group(address_group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networksecurity/v1:getOrganizationAddressGroup', __args__, opts=opts, typ=GetOrganizationAddressGroupResult).value
