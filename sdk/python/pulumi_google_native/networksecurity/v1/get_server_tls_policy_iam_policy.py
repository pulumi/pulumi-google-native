...
__all__ = [
    'GetServerTlsPolicyIamPolicyResult',
    'AwaitableGetServerTlsPolicyIamPolicyResult',
    'get_server_tls_policy_iam_policy',
    'get_server_tls_policy_iam_policy_output',
]

@pulumi.output_type
class GetServerTlsPolicyIamPolicyResult:
...
class AwaitableGetServerTlsPolicyIamPolicyResult(GetServerTlsPolicyIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServerTlsPolicyIamPolicyResult(
...
def get_server_tls_policy_iam_policy(location: Optional[str] = None,
                                     options_requested_policy_version: Optional[str] = None,
                                     project: Optional[str] = None,
                                     server_tls_policy_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServerTlsPolicyIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networksecurity/v1:getServerTlsPolicyIamPolicy', __args__, opts=opts, typ=GetServerTlsPolicyIamPolicyResult).value

    return AwaitableGetServerTlsPolicyIamPolicyResult(
...
@_utilities.lift_output_func(get_server_tls_policy_iam_policy)
def get_server_tls_policy_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                            ...
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServerTlsPolicyIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
