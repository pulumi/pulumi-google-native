...
class SecurityProfileArgs:
    def __init__(__self__, *,
                 ...
                 threat_prevention_profile: Optional[pulumi.Input['ThreatPreventionProfileArgs']] = None,
        ...
        :param pulumi.Input[str] description: Optional. An optional description of the profile. Max length 512 characters.
        ...
        :param pulumi.Input['ThreatPreventionProfileArgs'] threat_prevention_profile: The threat prevention configuration for the SecurityProfile.
    ...
    def threat_prevention_profile(self) -> Optional[pulumi.Input['ThreatPreventionProfileArgs']]:
        """
    ...
    def threat_prevention_profile(self, value: Optional[pulumi.Input['ThreatPreventionProfileArgs']]):
        pulumi.set(self, "threat_prevention_profile", value)

    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input['SecurityProfileType']]:
        """
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input['SecurityProfileType']]):
...
class SecurityProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "organization_id", "security_profile_id"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(SecurityProfile, __self__).__init__(
            'google-native:networksecurity/v1:SecurityProfile',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="threatPreventionProfile")
    def threat_prevention_profile(self) -> pulumi.Output['outputs.ThreatPreventionProfileResponse']:
        """
        The threat prevention configuration for the SecurityProfile.
        """
        return pulumi.get(self, "threat_prevention_profile")
