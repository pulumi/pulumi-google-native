...
class FirewallEndpointAssociationArgs:
    def __init__(__self__, *,
                 ...
                 firewall_endpoint_association_id: pulumi.Input[str],
        ...
        :param pulumi.Input[str] firewall_endpoint_association_id: Required. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpoint_association_id from the method_signature of Create RPC.
    ...
    def firewall_endpoint_association_id(self) -> pulumi.Input[str]:
        """
    ...
    def firewall_endpoint_association_id(self, value: pulumi.Input[str]):
...
class FirewallEndpointAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if firewall_endpoint_association_id is None and not opts.urn:
                raise TypeError("Missing required property 'firewall_endpoint_association_id'")
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["firewall_endpoint_association_id", "location", "project"])
    ...
    @property
    @pulumi.getter(name="firewallEndpointAssociationId")
    def firewall_endpoint_association_id(self) -> pulumi.Output[str]:
        """
        Required. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpoint_association_id from the method_signature of Create RPC.
        """
        return pulumi.get(self, "firewall_endpoint_association_id")
