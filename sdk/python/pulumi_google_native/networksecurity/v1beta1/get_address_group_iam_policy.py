...
def get_address_group_iam_policy(address_group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networksecurity/v1beta1:getAddressGroupIamPolicy', __args__, opts=opts, typ=GetAddressGroupIamPolicyResult).value
...
def get_address_group_iam_policy_output(address_group_id: Optional[pulumi.Input[str]] = None,
