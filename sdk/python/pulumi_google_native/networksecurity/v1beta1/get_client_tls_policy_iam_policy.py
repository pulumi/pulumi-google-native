...
def get_client_tls_policy_iam_policy(client_tls_policy_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networksecurity/v1beta1:getClientTlsPolicyIamPolicy', __args__, opts=opts, typ=GetClientTlsPolicyIamPolicyResult).value
