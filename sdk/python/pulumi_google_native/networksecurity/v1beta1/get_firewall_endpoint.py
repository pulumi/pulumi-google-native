...
class GetFirewallEndpointResult:
    def __init__(__self__, associated_networks=None, create_time=None, labels=None, name=None, reconciling=None, state=None, update_time=None):
...
def get_firewall_endpoint(firewall_endpoint_id: Optional[str] = None,
    ...
    return AwaitableGetFirewallEndpointResult(
        associated_networks=__ret__.associated_networks,
