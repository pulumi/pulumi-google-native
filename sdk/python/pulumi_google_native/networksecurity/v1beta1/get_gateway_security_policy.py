...
def get_gateway_security_policy(gateway_security_policy_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networksecurity/v1beta1:getGatewaySecurityPolicy', __args__, opts=opts, typ=GetGatewaySecurityPolicyResult).value
