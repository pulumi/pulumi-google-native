...
def get_server_tls_policy_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networksecurity/v1beta1:getServerTlsPolicyIamPolicy', __args__, opts=opts, typ=GetServerTlsPolicyIamPolicyResult).value
