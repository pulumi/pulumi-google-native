...
def get_tls_inspection_policy(location: Optional[str] = None,
    ...
    return AwaitableGetTlsInspectionPolicyResult(
        ...
        custom_tls_features=__ret__.custom_tls_features,
        description=__ret__.description,
        exclude_public_ca_set=__ret__.exclude_public_ca_set,
        min_tls_version=__ret__.min_tls_version,
        name=__ret__.name,
        tls_feature_profile=__ret__.tls_feature_profile,
        trust_config=__ret__.trust_config,
