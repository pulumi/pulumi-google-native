...
__all__ = [
    ...
    'DestinationResponse',
    'ExprResponse',
    'FirewallEndpointAssociationReferenceResponse',
...
@pulumi.output_type
class FirewallEndpointAssociationReferenceResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        This is a subset of the FirewallEndpointAssociation message, containing fields to be used by the consumer.
        :param str name: The resource name of the FirewallEndpointAssociation. Format: projects/{project}/locations/{location}/firewallEndpointAssociations/{id}
        :param str network: The VPC network associated. Format: projects/{project}/global/networks/{name}.
        """
