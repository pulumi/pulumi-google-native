...
__all__ = [
    'GetEdgeCacheServiceIamPolicyResult',
    'AwaitableGetEdgeCacheServiceIamPolicyResult',
    'get_edge_cache_service_iam_policy',
    'get_edge_cache_service_iam_policy_output',
]

@pulumi.output_type
class GetEdgeCacheServiceIamPolicyResult:
...
class AwaitableGetEdgeCacheServiceIamPolicyResult(GetEdgeCacheServiceIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEdgeCacheServiceIamPolicyResult(
...
def get_edge_cache_service_iam_policy(edge_cache_service_id: Optional[str] = None,
                                      location: Optional[str] = None,
                                      options_requested_policy_version: Optional[str] = None,
                                      project: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEdgeCacheServiceIamPolicyResult:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    __args__ = dict()
    __args__['edgeCacheServiceId'] = edge_cache_service_id
...
@_utilities.lift_output_func(get_edge_cache_service_iam_policy)
def get_edge_cache_service_iam_policy_output(edge_cache_service_id: Optional[pulumi.Input[str]] = None,
                                             location: Optional[pulumi.Input[str]] = None,
                                             options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
                                             project: Optional[pulumi.Input[Optional[str]]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetEdgeCacheServiceIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
