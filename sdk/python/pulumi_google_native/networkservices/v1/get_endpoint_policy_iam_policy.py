...
def get_endpoint_policy_iam_policy(endpoint_policy_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkservices/v1:getEndpointPolicyIamPolicy', __args__, opts=opts, typ=GetEndpointPolicyIamPolicyResult).value
