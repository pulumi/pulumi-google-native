...
__all__ = [
    'GetServiceBindingIamPolicyResult',
    'AwaitableGetServiceBindingIamPolicyResult',
    'get_service_binding_iam_policy',
    'get_service_binding_iam_policy_output',
]

@pulumi.output_type
class GetServiceBindingIamPolicyResult:
...
class AwaitableGetServiceBindingIamPolicyResult(GetServiceBindingIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceBindingIamPolicyResult(
...
def get_service_binding_iam_policy(location: Optional[str] = None,
                                   options_requested_policy_version: Optional[str] = None,
                                   project: Optional[str] = None,
                                   service_binding_id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceBindingIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkservices/v1:getServiceBindingIamPolicy', __args__, opts=opts, typ=GetServiceBindingIamPolicyResult).value

    return AwaitableGetServiceBindingIamPolicyResult(
...
@_utilities.lift_output_func(get_service_binding_iam_policy)
def get_service_binding_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceBindingIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
