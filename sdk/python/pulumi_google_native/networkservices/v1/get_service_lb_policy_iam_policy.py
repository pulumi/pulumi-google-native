...
def get_service_lb_policy_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkservices/v1:getServiceLbPolicyIamPolicy', __args__, opts=opts, typ=GetServiceLbPolicyIamPolicyResult).value
