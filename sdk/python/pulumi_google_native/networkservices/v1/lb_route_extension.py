...
class LbRouteExtensionArgs:
    def __init__(__self__, *,
                 ...
                 lb_route_extension_id: pulumi.Input[str],
                 load_balancing_scheme: pulumi.Input['LbRouteExtensionLoadBalancingScheme'],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] forwarding_rules: A list of references to the forwarding rules to which this service extension is attached to. At least one forwarding rule is required. There can be only one `LbRouteExtension` resource per forwarding rule.
        :param pulumi.Input[str] lb_route_extension_id: Required. User-provided ID of the `LbRouteExtension` resource to be created.
        :param pulumi.Input['LbRouteExtensionLoadBalancingScheme'] load_balancing_scheme: All backend services and forwarding rules referenced by this extension must share the same load balancing scheme. Supported values: `INTERNAL_MANAGED`, `EXTERNAL_MANAGED`. For more information, refer to [Choosing a load balancer](https://cloud.google.com/load-balancing/docs/backend-service).
        :param pulumi.Input[str] description: Optional. A human-readable description of the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: Optional. Set of labels associated with the `LbRouteExtension` resource. The format must comply with [the requirements for labels](https://cloud.google.com/compute/docs/labeling-resources#requirements) for Google Cloud resources.
        :param pulumi.Input[str] name: Identifier. Name of the `LbRouteExtension` resource in the following format: `projects/{project}/locations/{location}/lbRouteExtensions/{lb_route_extension}`.
        ...
        pulumi.set(__self__, "lb_route_extension_id", lb_route_extension_id)
    ...
    @property
    @pulumi.getter(name="lbRouteExtensionId")
    def lb_route_extension_id(self) -> pulumi.Input[str]:
        """
        Required. User-provided ID of the `LbRouteExtension` resource to be created.
        """
        return pulumi.get(self, "lb_route_extension_id")

    @lb_route_extension_id.setter
    def lb_route_extension_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "lb_route_extension_id", value)

    @property
    @pulumi.getter(name="loadBalancingScheme")
    def load_balancing_scheme(self) -> pulumi.Input['LbRouteExtensionLoadBalancingScheme']:
        """
    ...
    def load_balancing_scheme(self, value: pulumi.Input['LbRouteExtensionLoadBalancingScheme']):
...
class LbRouteExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 lb_route_extension_id: Optional[pulumi.Input[str]] = None,
                 load_balancing_scheme: Optional[pulumi.Input['LbRouteExtensionLoadBalancingScheme']] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 request_id: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if lb_route_extension_id is None and not opts.urn:
                raise TypeError("Missing required property 'lb_route_extension_id'")
            __props__.__dict__["lb_route_extension_id"] = lb_route_extension_id
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["lb_route_extension_id", "location", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(LbRouteExtension, __self__).__init__(
            'google-native:networkservices/v1:LbRouteExtension',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LbRouteExtension':
        """
        ...
        __props__.__dict__["lb_route_extension_id"] = None
    ...
    @property
    @pulumi.getter(name="lbRouteExtensionId")
    def lb_route_extension_id(self) -> pulumi.Output[str]:
        """
        Required. User-provided ID of the `LbRouteExtension` resource to be created.
        """
        return pulumi.get(self, "lb_route_extension_id")
