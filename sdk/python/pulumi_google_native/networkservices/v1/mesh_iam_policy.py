...
__all__ = ['MeshIamPolicyArgs', 'MeshIamPolicy']

@pulumi.input_type
class MeshIamPolicyArgs:
...
class MeshIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param MeshIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MeshIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MeshIamPolicyArgs.__new__(MeshIamPolicyArgs)
        ...
        super(MeshIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MeshIamPolicy':
        """
        Get an existing MeshIamPolicy resource's state with the given name, id, and optional extra
        ...
        return MeshIamPolicy(resource_name, opts=opts, __props__=__props__)
