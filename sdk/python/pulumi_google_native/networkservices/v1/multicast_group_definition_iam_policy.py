...
__all__ = ['MulticastGroupDefinitionIamPolicyArgs', 'MulticastGroupDefinitionIamPolicy']

@pulumi.input_type
class MulticastGroupDefinitionIamPolicyArgs:
    def __init__(__self__, *,
                 multicast_group_definition_id: pulumi.Input[str],
        ...
        """
        pulumi.set(__self__, "multicast_group_definition_id", multicast_group_definition_id)
    ...
    @property
    @pulumi.getter(name="multicastGroupDefinitionId")
    def multicast_group_definition_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "multicast_group_definition_id")

    @multicast_group_definition_id.setter
    def multicast_group_definition_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "multicast_group_definition_id", value)
...
class MulticastGroupDefinitionIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: MulticastGroupDefinitionIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param MulticastGroupDefinitionIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MulticastGroupDefinitionIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MulticastGroupDefinitionIamPolicyArgs.__new__(MulticastGroupDefinitionIamPolicyArgs)

            __props__.__dict__["audit_configs"] = audit_configs
            __props__.__dict__["bindings"] = bindings
            __props__.__dict__["etag"] = etag
            __props__.__dict__["location"] = location
            if multicast_group_definition_id is None and not opts.urn:
                raise TypeError("Missing required property 'multicast_group_definition_id'")
            __props__.__dict__["multicast_group_definition_id"] = multicast_group_definition_id
            __props__.__dict__["project"] = project
            __props__.__dict__["update_mask"] = update_mask
            __props__.__dict__["version"] = version
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "multicast_group_definition_id", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(MulticastGroupDefinitionIamPolicy, __self__).__init__(
            'google-native:networkservices/v1:MulticastGroupDefinitionIamPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MulticastGroupDefinitionIamPolicy':
        """
        ...
        __props__.__dict__["multicast_group_definition_id"] = None
        __props__.__dict__["project"] = None
        __props__.__dict__["version"] = None
        return MulticastGroupDefinitionIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="multicastGroupDefinitionId")
    def multicast_group_definition_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "multicast_group_definition_id")
