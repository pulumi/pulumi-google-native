...
__all__ = [
    ...
    'AwaitableGetLbTrafficExtensionResult',
    'get_lb_traffic_extension',
    'get_lb_traffic_extension_output',
]
...
class AwaitableGetLbTrafficExtensionResult(GetLbTrafficExtensionResult):
...
def get_lb_traffic_extension(lb_traffic_extension_id: Optional[str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLbTrafficExtensionResult:
    """
    Gets details of the specified `LbTrafficExtension` resource.
    """
    __args__ = dict()
    __args__['lbTrafficExtensionId'] = lb_traffic_extension_id
    __args__['location'] = location
    __args__['project'] = project
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('google-native:networkservices/v1beta1:getLbTrafficExtension', __args__, opts=opts, typ=GetLbTrafficExtensionResult).value

    return AwaitableGetLbTrafficExtensionResult(
...
@_utilities.lift_output_func(get_lb_traffic_extension)
def get_lb_traffic_extension_output(lb_traffic_extension_id: Optional[pulumi.Input[str]] = None,
                                    location: Optional[pulumi.Input[str]] = None,
                                    project: Optional[pulumi.Input[Optional[str]]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetLbTrafficExtensionResult]:
    """
    Gets details of the specified `LbTrafficExtension` resource.
    """
    ...
