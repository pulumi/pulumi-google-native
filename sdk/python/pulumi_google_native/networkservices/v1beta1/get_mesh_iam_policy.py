...
__all__ = [
    ...
    'AwaitableGetMeshIamPolicyResult',
    'get_mesh_iam_policy',
    'get_mesh_iam_policy_output',
]
...
class AwaitableGetMeshIamPolicyResult(GetMeshIamPolicyResult):
...
def get_mesh_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkservices/v1beta1:getMeshIamPolicy', __args__, opts=opts, typ=GetMeshIamPolicyResult).value

    return AwaitableGetMeshIamPolicyResult(
