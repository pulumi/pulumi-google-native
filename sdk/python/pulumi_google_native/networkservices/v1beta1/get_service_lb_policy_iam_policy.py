...
__all__ = [
    'GetServiceLbPolicyIamPolicyResult',
    'AwaitableGetServiceLbPolicyIamPolicyResult',
    'get_service_lb_policy_iam_policy',
    'get_service_lb_policy_iam_policy_output',
]

@pulumi.output_type
class GetServiceLbPolicyIamPolicyResult:
...
class AwaitableGetServiceLbPolicyIamPolicyResult(GetServiceLbPolicyIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceLbPolicyIamPolicyResult(
...
def get_service_lb_policy_iam_policy(location: Optional[str] = None,
                                     options_requested_policy_version: Optional[int] = None,
                                     project: Optional[str] = None,
                                     service_lb_policy_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceLbPolicyIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:networkservices/v1beta1:getServiceLbPolicyIamPolicy', __args__, opts=opts, typ=GetServiceLbPolicyIamPolicyResult).value

    return AwaitableGetServiceLbPolicyIamPolicyResult(
...
@_utilities.lift_output_func(get_service_lb_policy_iam_policy)
def get_service_lb_policy_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                            ...
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceLbPolicyIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
