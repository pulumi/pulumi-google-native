...
class GetRuntimeResult:
    def __init__(__self__, access_config=None, create_time=None, health_state=None, labels=None, metrics=None, migrated=None, name=None, software_config=None, state=None, update_time=None, virtual_machine=None):
