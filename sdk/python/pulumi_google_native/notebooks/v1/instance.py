...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["pre_migration_check"] = None
    ...
    @property
    @pulumi.getter(name="preMigrationCheck")
    def pre_migration_check(self) -> pulumi.Output['outputs.PreMigrationCheckResponse']:
        """
        Check how possible a migration from UmN to WbI is.
        """
        return pulumi.get(self, "pre_migration_check")
