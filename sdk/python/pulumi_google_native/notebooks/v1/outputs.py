...
@pulumi.output_type
class PreMigrationCheckResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        PreMigrationCheck checks how feasible a migration from UmN is.
        :param str message: Message provides a summary or workaround.
        :param str result: Result returns the result of the check.
        """
