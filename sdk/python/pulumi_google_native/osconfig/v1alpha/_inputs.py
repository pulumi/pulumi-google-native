...
class OSPolicyArgs:
    def __init__(__self__, *,
                 ...
                 mode: Optional[pulumi.Input['OSPolicyMode']] = None,
                 resource_groups: Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyResourceGroupArgs']]]] = None):
        """
        ...
        :param pulumi.Input['OSPolicyMode'] mode: Required. Policy mode
        :param pulumi.Input[Sequence[pulumi.Input['OSPolicyResourceGroupArgs']]] resource_groups: Required. List of resource groups for the policy. For a particular VM, resource groups are evaluated in the order specified and the first resource group that is applicable is selected and the rest are ignored. If none of the resource groups are applicable for a VM, the VM is considered to be non-compliant w.r.t this policy. This behavior can be toggled by the flag `allow_no_resource_group_match`
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional[pulumi.Input['OSPolicyMode']]:
        """
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input['OSPolicyMode']]):
        pulumi.set(self, "mode", value)

    @property
    @pulumi.getter(name="resourceGroups")
    def resource_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyResourceGroupArgs']]]]:
        """
    ...
    def resource_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyResourceGroupArgs']]]]):
...
class OSPolicyAssignmentRolloutArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FixedOrPercentArgs'] disruption_budget: Required. The maximum number (or percentage) of VMs per zone to disrupt at any given moment.
        ...
        if min_wait_duration is not None:
    ...
    def min_wait_duration(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def min_wait_duration(self, value: Optional[pulumi.Input[str]]):
...
class OSPolicyResourceExecResourceArgs:
    def __init__(__self__, *,
                 ...
                 validate: Optional[pulumi.Input['OSPolicyResourceExecResourceExecArgs']] = None):
        """
        ...
        :param pulumi.Input['OSPolicyResourceExecResourceExecArgs'] validate: Required. What to run to validate this resource is in the desired state. An exit code of 100 indicates "in desired state", and exit code of 101 indicates "not in desired state". Any other exit code indicates a failure running validate.
        """
    ...
    @property
    @pulumi.getter
    def validate(self) -> Optional[pulumi.Input['OSPolicyResourceExecResourceExecArgs']]:
        """
    ...
    @validate.setter
    def validate(self, value: Optional[pulumi.Input['OSPolicyResourceExecResourceExecArgs']]):
...
class OSPolicyResourceExecResourceExecArgs:
    def __init__(__self__, *,
                 ...
                 interpreter: Optional[pulumi.Input['OSPolicyResourceExecResourceExecInterpreter']] = None,
        ...
        :param pulumi.Input['OSPolicyResourceExecResourceExecInterpreter'] interpreter: Required. The script interpreter to use.
    ...
    @property
    @pulumi.getter
    def interpreter(self) -> Optional[pulumi.Input['OSPolicyResourceExecResourceExecInterpreter']]:
        """
    ...
    @interpreter.setter
    def interpreter(self, value: Optional[pulumi.Input['OSPolicyResourceExecResourceExecInterpreter']]):
...
class OSPolicyResourceFileResourceArgs:
    def __init__(__self__, *,
                 ...
                 state: Optional[pulumi.Input['OSPolicyResourceFileResourceState']] = None):
        """
        ...
        :param pulumi.Input['OSPolicyResourceFileResourceState'] state: Required. Desired state of the file.
        """
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input['OSPolicyResourceFileResourceState']]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input['OSPolicyResourceFileResourceState']]):
...
class OSPolicyResourceGroupArgs:
    def __init__(__self__, *,
                 ...
                 resources: Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyResourceArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OSPolicyResourceArgs']]] resources: Required. List of resources configured for this resource group. The resources are executed in the exact order specified here.
        """
    ...
    @property
    @pulumi.getter
    def resources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyResourceArgs']]]]:
        """
    ...
    @resources.setter
    def resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyResourceArgs']]]]):
...
class OSPolicyResourcePackageResourceArgs:
    def __init__(__self__, *,
                 ...
                 desired_state: Optional[pulumi.Input['OSPolicyResourcePackageResourceDesiredState']] = None,
        ...
        :param pulumi.Input['OSPolicyResourcePackageResourceDesiredState'] desired_state: Required. The desired state the agent should maintain for this package.
    ...
    def desired_state(self) -> Optional[pulumi.Input['OSPolicyResourcePackageResourceDesiredState']]:
        """
    ...
    def desired_state(self, value: Optional[pulumi.Input['OSPolicyResourcePackageResourceDesiredState']]):
...
class OSPolicyResourcePackageResourceDebArgs:
    def __init__(__self__, *,
                 ...
                 source: Optional[pulumi.Input['OSPolicyResourceFileArgs']] = None):
        """
        ...
        :param pulumi.Input['OSPolicyResourceFileArgs'] source: Required. A deb package.
        """
    ...
    @property
    @pulumi.getter
    def source(self) -> Optional[pulumi.Input['OSPolicyResourceFileArgs']]:
        """
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input['OSPolicyResourceFileArgs']]):
...
class OSPolicyResourcePackageResourceMSIArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['OSPolicyResourceFileArgs'] source: Required. The MSI package.
        """
...
class OSPolicyResourcePackageResourceRPMArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['OSPolicyResourceFileArgs'] source: Required. An rpm package.
        """
        if pull_deps is not None:
            pulumi.set(__self__, "pull_deps", pull_deps)
        if source is not None:
...
class OSPolicyResourceRepositoryResourceAptRepositoryArgs:
    def __init__(__self__, *,
                 archive_type: Optional[pulumi.Input['OSPolicyResourceRepositoryResourceAptRepositoryArchiveType']] = None,
        ...
        :param pulumi.Input['OSPolicyResourceRepositoryResourceAptRepositoryArchiveType'] archive_type: Required. Type of archive files in this repository.
    ...
    def archive_type(self) -> Optional[pulumi.Input['OSPolicyResourceRepositoryResourceAptRepositoryArchiveType']]:
        """
    ...
    @archive_type.setter
    def archive_type(self, value: Optional[pulumi.Input['OSPolicyResourceRepositoryResourceAptRepositoryArchiveType']]):
