...
class OsPolicyAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 os_policies: Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OSPolicyArgs']]] os_policies: Required. List of OS policies to be applied to the VMs.
    ...
    def os_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyArgs']]]]:
        """
    ...
    @os_policies.setter
    def os_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OSPolicyArgs']]]]):
...
class OsPolicyAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: Resource name. Format: `projects/{project_number}/locations/{location}/osPolicyAssignments/{os_policy_assignment_id}` This field is ignored when you create an OS policy assignment.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OSPolicyArgs']]]] os_policies: Required. List of OS policies to be applied to the VMs.
