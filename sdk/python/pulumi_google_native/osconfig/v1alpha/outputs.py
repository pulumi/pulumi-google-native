...
class OSPolicyAssignmentInstanceFilterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['OSPolicyAssignmentLabelSetResponse'] exclusion_labels: List of label sets used for VM exclusion. If the list has more than one label set, the VM is excluded if any of the label sets are applicable for the VM. This filter is applied last in the filtering chain and therefore a VM is guaranteed to be excluded if it satisfies one of the below label sets.
        ...
        :param Sequence[str] os_short_names: A VM is included if it's OS short name matches with any of the values provided in this list.
        """
...
class OSPolicyAssignmentRolloutResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Message to configure the rollout at the zonal level for the OS policy assignment.
        :param 'FixedOrPercentResponse' disruption_budget: Required. The maximum number (or percentage) of VMs per zone to disrupt at any given moment.
...
class OSPolicyResourceExecResourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'OSPolicyResourceExecResourceExecResponse' validate: Required. What to run to validate this resource is in the desired state. An exit code of 100 indicates "in desired state", and exit code of 101 indicates "not in desired state". Any other exit code indicates a failure running validate.
        """
...
class OSPolicyResourceGroupResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['OSPolicyResourceResponse'] resources: Required. List of resources configured for this resource group. The resources are executed in the exact order specified here.
        """
...
class OSPolicyResourcePackageResourceDebResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'OSPolicyResourceFileResponse' source: Required. A deb package.
        """
...
class OSPolicyResourcePackageResourceMSIResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'OSPolicyResourceFileResponse' source: Required. The MSI package.
        """
...
class OSPolicyResourcePackageResourceRPMResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'OSPolicyResourceFileResponse' source: Required. An rpm package.
        """
        pulumi.set(__self__, "pull_deps", pull_deps)
        pulumi.set(__self__, "source", source)
