...
@pulumi.input_type
class GoogleCloudPolicysimulatorV1OrgPolicyOverlayCustomConstraintOverlayArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlayArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudPolicysimulatorV1OrgPolicyOverlayArgs:
    def __init__(__self__, *,
                 custom_constraints: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayCustomConstraintOverlayArgs']]]] = None,
                 policies: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlayArgs']]]] = None):
        """
        The proposed changes to OrgPolicy.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayCustomConstraintOverlayArgs']]] custom_constraints: Optional. The OrgPolicy CustomConstraint changes to preview violations for. Any existing CustomConstraints with the same name will be overridden in the simulation. That is, violations will be determined as if all custom constraints in the overlay were instantiated. Only a single custom_constraint is supported in the overlay at a time. For evaluating multiple constraints, multiple `GenerateOrgPolicyViolationsPreview` requests are made, where each request evaluates a single constraint.
        :param pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlayArgs']]] policies: Optional. The OrgPolicy changes to preview violations for. Any existing OrgPolicies with the same name will be overridden in the simulation. That is, violations will be determined as if all policies in the overlay were created or updated.
        """
    ...
    def custom_constraints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayCustomConstraintOverlayArgs']]]]:
        """
    ...
    def custom_constraints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayCustomConstraintOverlayArgs']]]]):
        pulumi.set(self, "custom_constraints", value)

    @property
    @pulumi.getter
    def policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlayArgs']]]]:
        """
    ...
    @policies.setter
    def policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlayArgs']]]]):
