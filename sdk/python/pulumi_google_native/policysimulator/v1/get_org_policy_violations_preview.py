...
class GetOrgPolicyViolationsPreviewResult:
    ...
    @property
    @pulumi.getter
    def overlay(self) -> 'outputs.GoogleCloudPolicysimulatorV1OrgPolicyOverlayResponse':
        """
    ...
    def resource_counts(self) -> 'outputs.GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreviewResourceCountsResponse':
        """
...
def get_org_policy_violations_preview(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:policysimulator/v1:getOrgPolicyViolationsPreview', __args__, opts=opts, typ=GetOrgPolicyViolationsPreviewResult).value
