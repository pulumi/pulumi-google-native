...
class OrgPolicyViolationsPreviewArgs:
    def __init__(__self__, *,
                 ...
                 overlay: pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayArgs'],
        ...
        :param pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayArgs'] overlay: The proposed changes we are previewing violations for.
    ...
    @property
    @pulumi.getter
    def overlay(self) -> pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayArgs']:
        """
    ...
    @overlay.setter
    def overlay(self, value: pulumi.Input['GoogleCloudPolicysimulatorV1OrgPolicyOverlayArgs']):
...
class OrgPolicyViolationsPreview(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 overlay: Optional[pulumi.Input[pulumi.InputType['GoogleCloudPolicysimulatorV1OrgPolicyOverlayArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] org_policy_violations_preview_id: Optional. An optional user-specified ID for the OrgPolicyViolationsPreview. If not provided, a random ID will be generated.
        :param pulumi.Input[pulumi.InputType['GoogleCloudPolicysimulatorV1OrgPolicyOverlayArgs']] overlay: The proposed changes we are previewing violations for.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        super(OrgPolicyViolationsPreview, __self__).__init__(
            'google-native:policysimulator/v1:OrgPolicyViolationsPreview',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def overlay(self) -> pulumi.Output['outputs.GoogleCloudPolicysimulatorV1OrgPolicyOverlayResponse']:
        """
        The proposed changes we are previewing violations for.
        """
        return pulumi.get(self, "overlay")
    ...
    def resource_counts(self) -> pulumi.Output['outputs.GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreviewResourceCountsResponse']:
        """
