...
class GetOrgPolicyViolationsPreviewResult:
    ...
    @property
    @pulumi.getter
    def overlay(self) -> 'outputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayResponse':
        """
    ...
    def resource_counts(self) -> 'outputs.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreviewResourceCountsResponse':
        """
...
def get_org_policy_violations_preview(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:policysimulator/v1alpha:getOrgPolicyViolationsPreview', __args__, opts=opts, typ=GetOrgPolicyViolationsPreviewResult).value
