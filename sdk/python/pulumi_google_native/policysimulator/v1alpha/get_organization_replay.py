...
class GetOrganizationReplayResult:
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GoogleCloudPolicysimulatorV1alphaReplayConfigResponse':
        """
    ...
    def results_summary(self) -> 'outputs.GoogleCloudPolicysimulatorV1alphaReplayResultsSummaryResponse':
        """
...
def get_organization_replay(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:policysimulator/v1alpha:getOrganizationReplay', __args__, opts=opts, typ=GetOrganizationReplayResult).value
