...
class ReplayArgs:
    def __init__(__self__, *,
                 config: pulumi.Input['GoogleCloudPolicysimulatorV1alphaReplayConfigArgs'],
                 location: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a Replay resource.
        :param pulumi.Input['GoogleCloudPolicysimulatorV1alphaReplayConfigArgs'] config: The configuration used for the `Replay`.
        """
    ...
    @property
    @pulumi.getter
    def config(self) -> pulumi.Input['GoogleCloudPolicysimulatorV1alphaReplayConfigArgs']:
        """
    ...
    @config.setter
    def config(self, value: pulumi.Input['GoogleCloudPolicysimulatorV1alphaReplayConfigArgs']):
...
class Replay(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def config(self) -> pulumi.Output['outputs.GoogleCloudPolicysimulatorV1alphaReplayConfigResponse']:
        """
        The configuration used for the `Replay`.
        """
        return pulumi.get(self, "config")
    ...
    def results_summary(self) -> pulumi.Output['outputs.GoogleCloudPolicysimulatorV1alphaReplayResultsSummaryResponse']:
        """
