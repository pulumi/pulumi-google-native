...
@pulumi.input_type
class GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs:
    def __init__(__self__, *,
...
class GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayArgs:
    ...
    def custom_constraints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs']]]]:
        """
    ...
    def custom_constraints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayCustomConstraintOverlayArgs']]]]):
        pulumi.set(self, "custom_constraints", value)

    @property
    @pulumi.getter
    def policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs']]]]:
        """
    ...
    @policies.setter
    def policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlayArgs']]]]):
