...
class FolderReplayArgs:
    def __init__(__self__, *,
                 config: pulumi.Input['GoogleCloudPolicysimulatorV1betaReplayConfigArgs'],
                 folder_id: pulumi.Input[str],
                 location: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a FolderReplay resource.
        :param pulumi.Input['GoogleCloudPolicysimulatorV1betaReplayConfigArgs'] config: The configuration used for the `Replay`.
        """
    ...
    @property
    @pulumi.getter
    def config(self) -> pulumi.Input['GoogleCloudPolicysimulatorV1betaReplayConfigArgs']:
        """
    ...
    @config.setter
    def config(self, value: pulumi.Input['GoogleCloudPolicysimulatorV1betaReplayConfigArgs']):
...
class FolderReplay(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 config: Optional[pulumi.Input[Union['GoogleCloudPolicysimulatorV1betaReplayConfigArgs', 'GoogleCloudPolicysimulatorV1betaReplayConfigArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['GoogleCloudPolicysimulatorV1betaReplayConfigArgs', 'GoogleCloudPolicysimulatorV1betaReplayConfigArgsDict']] config: The configuration used for the `Replay`.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter
    def config(self) -> pulumi.Output['outputs.GoogleCloudPolicysimulatorV1betaReplayConfigResponse']:
        """
        The configuration used for the `Replay`.
        """
        return pulumi.get(self, "config")
    ...
    def results_summary(self) -> pulumi.Output['outputs.GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse']:
        """
