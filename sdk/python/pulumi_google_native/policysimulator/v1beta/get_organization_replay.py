...
class GetOrganizationReplayResult:
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GoogleCloudPolicysimulatorV1betaReplayConfigResponse':
        """
    ...
    def results_summary(self) -> 'outputs.GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse':
        """
...
def get_organization_replay(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:policysimulator/v1beta:getOrganizationReplay', __args__, opts=opts, typ=GetOrganizationReplayResult).value
