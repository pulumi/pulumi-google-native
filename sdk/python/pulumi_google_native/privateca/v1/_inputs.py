...
class CertificateConfigArgs:
    def __init__(__self__, *,
                 ...
                 x509_config: Optional[pulumi.Input['X509ParametersArgs']] = None):
        """
        ...
        :param pulumi.Input['X509ParametersArgs'] x509_config: Required. Describes how some of the technical X.509 fields in a certificate should be populated.
        """
    ...
    def x509_config(self) -> Optional[pulumi.Input['X509ParametersArgs']]:
        """
    ...
    @x509_config.setter
    def x509_config(self, value: Optional[pulumi.Input['X509ParametersArgs']]):
...
class CertificateIdentityConstraintsArgs:
    ...
    def allow_subject_alt_names_passthrough(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def allow_subject_alt_names_passthrough(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "allow_subject_alt_names_passthrough", value)

    @property
    @pulumi.getter(name="allowSubjectPassthrough")
    def allow_subject_passthrough(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def allow_subject_passthrough(self, value: Optional[pulumi.Input[bool]]):
...
class PublicKeyArgs:
    def __init__(__self__, *,
                 format: Optional[pulumi.Input['PublicKeyFormat']] = None,
                 key: Optional[pulumi.Input[str]] = None):
        """
        A PublicKey describes a public key.
        :param pulumi.Input['PublicKeyFormat'] format: Required. The format of the public key.
        :param pulumi.Input[str] key: Required. A public key. The padding and encoding must match with the `KeyFormat` value specified for the `format` field.
        """
    ...
    @property
    @pulumi.getter
    def format(self) -> Optional[pulumi.Input['PublicKeyFormat']]:
        """
    ...
    @format.setter
    def format(self, value: Optional[pulumi.Input['PublicKeyFormat']]):
...
class SubjectConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SubjectArgs'] subject: Required. Contains distinguished name fields such as the common name, location and organization.
