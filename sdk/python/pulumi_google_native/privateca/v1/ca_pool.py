...
class CaPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CaPoolTier'] tier: Required. Immutable. The Tier of this CaPool.
        """
    ...
    @property
    @pulumi.getter
    def tier(self) -> Optional[pulumi.Input['CaPoolTier']]:
        """
    ...
    @tier.setter
    def tier(self, value: Optional[pulumi.Input['CaPoolTier']]):
