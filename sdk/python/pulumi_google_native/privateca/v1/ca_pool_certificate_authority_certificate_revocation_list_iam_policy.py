...
__all__ = ['CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs', 'CaPoolCertificateAuthorityCertificateRevocationListIamPolicy']

@pulumi.input_type
class CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs:
    def __init__(__self__, *,
                 ca_pool_id: pulumi.Input[str],
                 certificate_authority_id: pulumi.Input[str],
                 certificate_revocation_list_id: pulumi.Input[str],
        ...
        pulumi.set(__self__, "certificate_revocation_list_id", certificate_revocation_list_id)
    ...
    @property
    @pulumi.getter(name="certificateRevocationListId")
    def certificate_revocation_list_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "certificate_revocation_list_id")

    @certificate_revocation_list_id.setter
    def certificate_revocation_list_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "certificate_revocation_list_id", value)
...
class CaPoolCertificateAuthorityCertificateRevocationListIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 audit_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AuditConfigArgs', 'AuditConfigArgsDict']]]]] = None,
                 bindings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['BindingArgs', 'BindingArgsDict']]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AuditConfigArgs', 'AuditConfigArgsDict']]]] audit_configs: Specifies cloud audit logging configuration for this policy.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BindingArgs', 'BindingArgsDict']]]] bindings: Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
        :param pulumi.Input[str] etag: `etag` is used for optimistic concurrency control as a way to help prevent simultaneous updates of a policy from overwriting each other. It is strongly suggested that systems make use of the `etag` in the read-modify-write cycle to perform policy updates in order to avoid race conditions: An `etag` is returned in the response to `getIamPolicy`, and systems are expected to put that etag in the request to `setIamPolicy` to ensure that their change will be applied to the same version of the policy. **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost.
        :param pulumi.Input[str] update_mask: OPTIONAL: A FieldMask specifying which fields of the policy to modify. Only the fields in the mask will be modified. If no mask is provided, the following default mask is used: `paths: "bindings, etag"`
        :param pulumi.Input[int] version: Specifies the format of the policy. Valid values are `0`, `1`, and `3`. Requests that specify an invalid value are rejected. Any operation that affects conditional role bindings must specify version `3`. This requirement applies to the following operations: * Getting a policy that includes a conditional role binding * Adding a conditional role binding to a policy * Changing a conditional role binding in a policy * Removing any role binding, with or without a condition, from a policy that includes conditions **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost. If a policy does not include any conditions, operations on that policy may specify any valid version or leave the field unset. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs.__new__(CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs)
            ...
            if certificate_revocation_list_id is None and not opts.urn:
                raise TypeError("Missing required property 'certificate_revocation_list_id'")
            __props__.__dict__["certificate_revocation_list_id"] = certificate_revocation_list_id
            __props__.__dict__["etag"] = etag
            __props__.__dict__["location"] = location
            __props__.__dict__["project"] = project
            __props__.__dict__["update_mask"] = update_mask
            __props__.__dict__["version"] = version
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["caPoolId", "certificateAuthorityId", "certificateRevocationListId", "location", "project"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(CaPoolCertificateAuthorityCertificateRevocationListIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CaPoolCertificateAuthorityCertificateRevocationListIamPolicy':
        """
        Get an existing CaPoolCertificateAuthorityCertificateRevocationListIamPolicy resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["certificate_revocation_list_id"] = None
        __props__.__dict__["etag"] = None
        __props__.__dict__["location"] = None
        __props__.__dict__["project"] = None
        __props__.__dict__["version"] = None
        return CaPoolCertificateAuthorityCertificateRevocationListIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="certificateRevocationListId")
    def certificate_revocation_list_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "certificate_revocation_list_id")
