...
class AwaitableGetCaPoolCertificateAuthorityCertificateRevocationListIamPolicyResult(GetCaPoolCertificateAuthorityCertificateRevocationListIamPolicyResult):
...
def get_ca_pool_certificate_authority_certificate_revocation_list_iam_policy(ca_pool_id: Optional[str] = None,
                                                                             ...
                                                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCaPoolCertificateAuthorityCertificateRevocationListIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:privateca/v1:getCaPoolCertificateAuthorityCertificateRevocationListIamPolicy', __args__, opts=opts, typ=GetCaPoolCertificateAuthorityCertificateRevocationListIamPolicyResult).value

    return AwaitableGetCaPoolCertificateAuthorityCertificateRevocationListIamPolicyResult(
