...
def get_certificate_template_iam_policy(certificate_template_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:privateca/v1:getCertificateTemplateIamPolicy', __args__, opts=opts, typ=GetCertificateTemplateIamPolicyResult).value
...
def get_certificate_template_iam_policy_output(certificate_template_id: Optional[pulumi.Input[str]] = None,
