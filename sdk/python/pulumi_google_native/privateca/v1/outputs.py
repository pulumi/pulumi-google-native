...
__all__ = [
    ...
    'BindingResponse',
    'CaOptionsResponse',
    'CertificateConfigKeyIdResponse',
...
@pulumi.output_type
class CertificateConfigKeyIdResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CertificateConfigKeyIdResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CertificateConfigKeyIdResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        A KeyId identifies a specific public key, usually by hashing the public key.
        :param str key_id: The value of this KeyId encoded in lowercase hexadecimal. This is most likely the 160 bit SHA-1 hash of the public key.
        """
...
class CertificateConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subject_key_id: 'outputs.CertificateConfigKeyIdResponse',
    ...
    def subject_key_id(self) -> 'outputs.CertificateConfigKeyIdResponse':
        """
