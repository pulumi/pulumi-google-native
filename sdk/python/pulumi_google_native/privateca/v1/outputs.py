...
class CertificateConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'X509ParametersResponse' x509_config: Required. Describes how some of the technical X.509 fields in a certificate should be populated.
        """
...
class PublicKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A PublicKey describes a public key.
        :param str format: Required. The format of the public key.
        :param str key: Required. A public key. The padding and encoding must match with the `KeyFormat` value specified for the `format` field.
        """
...
class SubjectConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        These values are used to create the distinguished name and subject alternative name fields in an X.509 certificate.
        :param 'SubjectResponse' subject: Required. Contains distinguished name fields such as the common name, location and organization.
...
class SubordinateConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a subordinate CA's issuers. This is either a resource name to a known issuing CertificateAuthority, or a PEM issuer certificate chain.
        :param str certificate_authority: Required. This can refer to a CertificateAuthority in the same project that was used to create a subordinate CertificateAuthority. This field is used for information and usability purposes only. The resource name is in the format `projects/*/locations/*/caPools/*/certificateAuthorities/*`.
