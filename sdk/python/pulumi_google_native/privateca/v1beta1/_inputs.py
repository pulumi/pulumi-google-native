...
class PublicKeyArgs:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input['PublicKeyType']]):
...
class SubordinateConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] certificate_authority: This can refer to a CertificateAuthority that was used to create a subordinate CertificateAuthority. This field is used for information and usability purposes only. The resource name is in the format `projects/*/locations/*/certificateAuthorities/*`.
