...
__all__ = [
    ...
    'AwaitableGetCertificateAuthorityCertificateRevocationListIamPolicyResult',
    'get_certificate_authority_certificate_revocation_list_iam_policy',
    'get_certificate_authority_certificate_revocation_list_iam_policy_output',
]
...
class AwaitableGetCertificateAuthorityCertificateRevocationListIamPolicyResult(GetCertificateAuthorityCertificateRevocationListIamPolicyResult):
...
def get_certificate_authority_certificate_revocation_list_iam_policy(certificate_authority_id: Optional[str] = None,
    ...
    __args__['certificateRevocationListId'] = certificate_revocation_list_id
...
@_utilities.lift_output_func(get_certificate_authority_certificate_revocation_list_iam_policy)
