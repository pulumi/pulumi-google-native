...
@pulumi.output_type
class GetCertificateAuthorityIamPolicyResult:
...
class AwaitableGetCertificateAuthorityIamPolicyResult(GetCertificateAuthorityIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCertificateAuthorityIamPolicyResult(
...
def get_certificate_authority_iam_policy(certificate_authority_id: Optional[str] = None,
                                         location: Optional[str] = None,
                                         options_requested_policy_version: Optional[str] = None,
                                         project: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCertificateAuthorityIamPolicyResult:
    """
