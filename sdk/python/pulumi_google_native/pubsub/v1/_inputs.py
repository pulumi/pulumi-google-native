...
class AwsKinesisArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] aws_role_arn: AWS role ARN to be used for Federated Identity authentication with Kinesis. Check the Pub/Sub docs for how to set up this role and the required permissions that need to be attached to it.
        :param pulumi.Input[str] consumer_arn: The Kinesis consumer ARN to used for ingestion in Enhanced Fan-Out mode. The consumer must be already created and ready to be used.
        :param pulumi.Input[str] gcp_service_account: The GCP service account to be used for Federated Identity authentication with Kinesis (via a `AssumeRoleWithWebIdentity` call for the provided role). The `aws_role_arn` must be set up with `accounts.google.com:sub` equals to this service account number.
...
class BigQueryConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] use_table_schema: Optional. When true, use the BigQuery table's schema as the columns to write to in BigQuery. `use_table_schema` and `use_topic_schema` cannot be enabled at the same time.
        :param pulumi.Input[bool] use_topic_schema: Optional. When true, use the topic's schema as the columns to write to in BigQuery, if it exists. `use_topic_schema` and `use_table_schema` cannot be enabled at the same time.
...
class CloudStorageConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] filename_datetime_format: Optional. User-provided format string specifying how to represent datetimes in Cloud Storage filenames. See the [datetime format guidance](https://cloud.google.com/pubsub/docs/create-cloudstorage-subscription#file_names).
...
@pulumi.input_type
class IngestionDataSourceSettingsArgs:
    def __init__(__self__, *,
                 aws_kinesis: Optional[pulumi.Input['AwsKinesisArgs']] = None):
        """
        Settings for an ingestion data source on a topic.
        :param pulumi.Input['AwsKinesisArgs'] aws_kinesis: Optional. Amazon Kinesis Data Streams.
        """
    ...
    def aws_kinesis(self) -> Optional[pulumi.Input['AwsKinesisArgs']]:
        """
    ...
    @aws_kinesis.setter
    def aws_kinesis(self, value: Optional[pulumi.Input['AwsKinesisArgs']]):
