...
class AvroConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] write_metadata: Optional. When true, write the subscription name, message_id, publish_time, attributes, and ordering_key as additional fields in the output.
        """
...
class MessageStoragePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allowed_persistence_regions: Optional. A list of IDs of GCP regions where messages that are published to the topic may be persisted in storage. Messages published by publishers running in non-allowed GCP regions (or running outside of GCP altogether) will be routed for storage in one of the allowed regions. An empty list means that no regions are allowed, and is not a valid configuration.
        """
