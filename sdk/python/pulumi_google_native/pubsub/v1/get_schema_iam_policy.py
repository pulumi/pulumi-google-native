...
def get_schema_iam_policy(options_requested_policy_version: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:pubsub/v1:getSchemaIamPolicy', __args__, opts=opts, typ=GetSchemaIamPolicyResult).value

    return AwaitableGetSchemaIamPolicyResult(
