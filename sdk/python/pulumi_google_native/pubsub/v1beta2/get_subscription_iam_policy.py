...
def get_subscription_iam_policy(options_requested_policy_version: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:pubsub/v1beta2:getSubscriptionIamPolicy', __args__, opts=opts, typ=GetSubscriptionIamPolicyResult).value
...
def get_subscription_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
