...
def get_topic_iam_policy(options_requested_policy_version: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:pubsub/v1beta2:getTopicIamPolicy', __args__, opts=opts, typ=GetTopicIamPolicyResult).value
...
def get_topic_iam_policy_output(options_requested_policy_version: Optional[pulumi.Input[Optional[str]]] = None,
