...
class GoogleCloudRecaptchaenterpriseV1WebKeySettingsArgs:
    def __init__(__self__, *,
                 ...
                 integration_type: Optional[pulumi.Input['GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType']] = None):
        """
        Settings specific to keys that can be used by websites.
        :param pulumi.Input[bool] allow_all_domains: If set to true, it means allowed_domains will not be enforced.
        :param pulumi.Input[bool] allow_amp_traffic: Required. Whether this key can be used on AMP (Accelerated Mobile Pages) websites. This can only be set for the SCORE integration type.
        ...
        :param pulumi.Input['GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType'] integration_type: Required. Describes how this key is integrated with the website.
        """
    ...
    def integration_type(self) -> Optional[pulumi.Input['GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType']]:
        """
    ...
    def integration_type(self, value: Optional[pulumi.Input['GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType']]):
