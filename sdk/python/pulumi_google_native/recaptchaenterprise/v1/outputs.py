...
class GoogleCloudRecaptchaenterpriseV1WebKeySettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool allow_amp_traffic: Required. Whether this key can be used on AMP (Accelerated Mobile Pages) websites. This can only be set for the SCORE integration type.
        ...
        :param str integration_type: Required. Describes how this key is integrated with the website.
        """
