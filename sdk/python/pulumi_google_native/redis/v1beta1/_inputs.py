...
class WeeklyMaintenanceWindowArgs:
    def __init__(__self__, *,
                 day: Optional[pulumi.Input['WeeklyMaintenanceWindowDay']] = None,
                 start_time: Optional[pulumi.Input['TimeOfDayArgs']] = None):
        """
        Time window in which disruptive maintenance updates occur. Non-disruptive updates can occur inside or outside this window.
        :param pulumi.Input['WeeklyMaintenanceWindowDay'] day: Required. The day of week that maintenance updates occur.
        :param pulumi.Input['TimeOfDayArgs'] start_time: Required. Start time of the window in UTC time.
        """
        if day is not None:
    ...
    @property
    @pulumi.getter
    def day(self) -> Optional[pulumi.Input['WeeklyMaintenanceWindowDay']]:
        """
    ...
    @day.setter
    def day(self, value: Optional[pulumi.Input['WeeklyMaintenanceWindowDay']]):
        pulumi.set(self, "day", value)

    @property
    @pulumi.getter(name="startTime")
    def start_time(self) -> Optional[pulumi.Input['TimeOfDayArgs']]:
        """
    ...
    @start_time.setter
    def start_time(self, value: Optional[pulumi.Input['TimeOfDayArgs']]):
