...
class GetControlResult:
    def __init__(__self__, associated_serving_config_ids=None, display_name=None, name=None, rule=None, search_solution_use_case=None, solution_types=None):
    ...
    @property
    @pulumi.getter
    def rule(self) -> 'outputs.GoogleCloudRetailV2RuleResponse':
        """
...
def get_control(catalog_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:retail/v2:getControl', __args__, opts=opts, typ=GetControlResult).value
