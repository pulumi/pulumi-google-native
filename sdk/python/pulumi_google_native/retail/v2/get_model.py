...
class GetModelResult:
    ...
    def model_features_config(self) -> 'outputs.GoogleCloudRetailV2ModelModelFeaturesConfigResponse':
        """
    ...
    def serving_config_lists(self) -> Sequence['outputs.GoogleCloudRetailV2ModelServingConfigListResponse']:
        """
...
def get_model(catalog_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:retail/v2:getModel', __args__, opts=opts, typ=GetModelResult).value
