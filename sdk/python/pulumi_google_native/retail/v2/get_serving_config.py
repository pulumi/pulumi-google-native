...
class GetServingConfigResult:
    ...
    def dynamic_facet_spec(self) -> 'outputs.GoogleCloudRetailV2SearchRequestDynamicFacetSpecResponse':
        """
    ...
    def personalization_spec(self) -> 'outputs.GoogleCloudRetailV2SearchRequestPersonalizationSpecResponse':
        """
...
def get_serving_config(catalog_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:retail/v2:getServingConfig', __args__, opts=opts, typ=GetServingConfigResult).value
