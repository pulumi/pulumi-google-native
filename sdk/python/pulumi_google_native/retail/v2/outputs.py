...
class GoogleCloudRetailV2ProductResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudRetailV2ImageResponse'] images: Product images for the product.Highly recommended to put the main image to the first. A maximum of 300 images are allowed. Corresponding properties: Google Merchant Center property [image_link](https://support.google.com/merchants/answer/6324350). Schema.org property [Product.image](https://schema.org/image).
