...
class GoogleCloudRetailV2ProductResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "googleCloudRetailV2ProductId":
            suggest = "google_cloud_retail_v2_product_id"
    ...
    def __init__(__self__, *,
                 ...
                 google_cloud_retail_v2_product_id: str,
                 gtin: str,
        ...
        :param str google_cloud_retail_v2_product_id: Immutable. Product identifier, which is the final component of name. For example, this field is "id_1", if name is `projects/*/locations/global/catalogs/default_catalog/branches/default_branch/products/id_1`. This field must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID_ARGUMENT error is returned. Corresponding properties: Google Merchant Center property [id](https://support.google.com/merchants/answer/6324405). Schema.org property [Product.sku](https://schema.org/sku).
        ...
        pulumi.set(__self__, "google_cloud_retail_v2_product_id", google_cloud_retail_v2_product_id)
    ...
    @property
    @pulumi.getter(name="googleCloudRetailV2ProductId")
    def google_cloud_retail_v2_product_id(self) -> str:
        """
        ...
        """
        return pulumi.get(self, "google_cloud_retail_v2_product_id")
