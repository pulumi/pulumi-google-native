...
__all__ = ['CatalogBranchProductArgs', 'CatalogBranchProduct']
...
class CatalogBranchProduct(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CatalogBranchProductArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a Product.

        :param str resource_name: The name of the resource.
        :param CatalogBranchProductArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CatalogBranchProductArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CatalogBranchProductArgs.__new__(CatalogBranchProductArgs)
        ...
        super(CatalogBranchProduct, __self__).__init__(
            'google-native:retail/v2alpha:CatalogBranchProduct',
            resource_name,
            __props__,
            opts)
