...
class GetModelResult:
    def __init__(__self__, create_time=None, data_state=None, display_name=None, filtering_option=None, last_tune_time=None, name=None, optimization_objective=None, page_optimization_config=None, periodic_tuning_state=None, serving_config_lists=None, serving_state=None, training_state=None, tuning_operation=None, type=None, update_time=None):
