...
class GoogleCloudRetailV2alphaLocalInventoryResponse(dict):
    ...
    def __init__(__self__, *,
                 attributes: Mapping[str, 'outputs.GoogleCloudRetailV2alphaCustomAttributeResponse'],
    ...
    @property
    @pulumi.getter
    def attributes(self) -> Mapping[str, 'outputs.GoogleCloudRetailV2alphaCustomAttributeResponse']:
        """
