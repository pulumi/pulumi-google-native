...
@pulumi.output_type
class GoogleCloudRetailV2alphaCustomAttributeResponse(dict):
    """
...
class GoogleCloudRetailV2alphaLocalInventoryResponse(dict):
    ...
    @property
    @pulumi.getter
    def attributes(self) -> 'outputs.GoogleCloudRetailV2alphaCustomAttributeResponse':
        """
...
@pulumi.output_type
class GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "servingConfigId":
            suggest = "serving_config_id"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        A candidate to consider for a given panel. Currently only ServingConfig are valid candidates.
        :param str serving_config_id: This has to be a valid ServingConfig identifier. For example, for a ServingConfig with full name: `projects/*/locations/global/catalogs/default_catalog/servingConfigs/my_candidate_config`, this would be `my_candidate_config`.
        """
        pulumi.set(__self__, "serving_config_id", serving_config_id)

    @property
    @pulumi.getter(name="servingConfigId")
    def serving_config_id(self) -> str:
        """
...
@pulumi.output_type
class GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "defaultCandidate":
            suggest = "default_candidate"
        elif key == "displayName":
            suggest = "display_name"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 candidates: Sequence['outputs.GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse'],
                 default_candidate: 'outputs.GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse',
                 display_name: str):
        """
        An individual panel with a list of ServingConfigs to consider for it.
        :param Sequence['GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse'] candidates: The candidates to consider on the panel.
        :param 'GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse' default_candidate: The default candidate. If the model fails at serving time, we fall back to the default.
        :param str display_name: Optional. The name to display for the panel.
        """
    ...
    @property
    @pulumi.getter
    def candidates(self) -> Sequence['outputs.GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse']:
        """
    ...
    def default_candidate(self) -> 'outputs.GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse':
        """
...
@pulumi.output_type
class GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "pageOptimizationEventType":
            suggest = "page_optimization_event_type"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 panels: Sequence['outputs.GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse'],
                 restriction: str):
        """
        The PageOptimizationConfig for model training. This determines how many panels to optimize for, and which serving configs to consider for each panel. The purpose of this model is to optimize which ServingConfig to show on which panels in way that optimizes the visitors shopping journey.
        :param str page_optimization_event_type: The type of UserEvent this page optimization is shown for. Each page has an associated event type - this will be the corresponding event type for the page that the page optimization model is used on. Supported types: * `add-to-cart`: Products being added to cart. * `detail-page-view`: Products detail page viewed. * `home-page-view`: Homepage viewed * `category-page-view`: Homepage viewed * `shopping-cart-page-view`: User viewing a shopping cart. `home-page-view` only allows models with type `recommended-for-you`. All other page_optimization_event_type allow all Model.types.
        :param Sequence['GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse'] panels: A list of panel configurations. Limit = 5.
        :param str restriction: Optional. How to restrict results across panels e.g. can the same ServingConfig be shown on multiple panels at once. If unspecified, default to `UNIQUE_MODEL_RESTRICTION`.
        """
    ...
    def page_optimization_event_type(self) -> str:
        """
    ...
    @property
    @pulumi.getter
    def panels(self) -> Sequence['outputs.GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse']:
        """
...
@pulumi.output_type
class GoogleCloudRetailV2alphaModelServingConfigListResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudRetailV2alphaModelServingConfigListResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudRetailV2alphaModelServingConfigListResponse.__key_warning(key)
        return super().__getitem__(key)
...
class GoogleCloudRetailV2alphaProductResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['GoogleCloudRetailV2alphaLocalInventoryResponse'] local_inventories: A list of local inventories specific to different places. This field can be managed by ProductService.AddLocalInventories and ProductService.RemoveLocalInventories APIs if fine-grained, high-volume updates are necessary.
