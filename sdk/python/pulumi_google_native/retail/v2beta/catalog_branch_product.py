...
class CatalogBranchProductArgs:
    def __init__(__self__, *,
                 ...
                 images: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudRetailV2betaImageArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def images(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudRetailV2betaImageArgs']]]]:
        """
    ...
    @images.setter
    def images(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GoogleCloudRetailV2betaImageArgs']]]]):
    ...
    def price_info(self) -> Optional[pulumi.Input['GoogleCloudRetailV2betaPriceInfoArgs']]:
        """
    ...
    @price_info.setter
    def price_info(self, value: Optional[pulumi.Input['GoogleCloudRetailV2betaPriceInfoArgs']]):
...
class CatalogBranchProduct(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(CatalogBranchProduct, __self__).__init__(
            'google-native:retail/v2beta:CatalogBranchProduct',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def images(self) -> pulumi.Output[Sequence['outputs.GoogleCloudRetailV2betaImageResponse']]:
        """
        Product images for the product.Highly recommended to put the main image to the first. A maximum of 300 images are allowed. Google Merchant Center property [image_link](https://support.google.com/merchants/answer/6324350). Schema.org property [Product.image](https://schema.org/image).
        """
        return pulumi.get(self, "images")
    ...
    @property
    @pulumi.getter(name="priceInfo")
    def price_info(self) -> pulumi.Output['outputs.GoogleCloudRetailV2betaPriceInfoResponse']:
        """
        Product price and cost information. Google Merchant Center property [price](https://support.google.com/merchants/answer/6324371).
        """
        return pulumi.get(self, "price_info")
