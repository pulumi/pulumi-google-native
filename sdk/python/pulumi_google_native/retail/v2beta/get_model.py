...
class GetModelResult:
    ...
    def serving_config_lists(self) -> Sequence['outputs.GoogleCloudRetailV2betaModelServingConfigListResponse']:
        """
...
def get_model(catalog_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:retail/v2beta:getModel', __args__, opts=opts, typ=GetModelResult).value
