...
class GoogleCloudRetailV2betaProductResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GoogleCloudRetailV2betaColorInfoResponse' color_info: The color of the product. Google Merchant Center property [color](https://support.google.com/merchants/answer/6324487). Schema.org property [Product.color](https://schema.org/color).
        ...
        :param Sequence['GoogleCloudRetailV2betaImageResponse'] images: Product images for the product.Highly recommended to put the main image to the first. A maximum of 300 images are allowed. Google Merchant Center property [image_link](https://support.google.com/merchants/answer/6324350). Schema.org property [Product.image](https://schema.org/image).
        ...
        :param Sequence['GoogleCloudRetailV2betaPromotionResponse'] promotions: The promotions applied to the product. A maximum of 10 values are allowed per Product.
