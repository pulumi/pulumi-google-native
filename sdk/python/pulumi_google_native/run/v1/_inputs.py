...
class CSIVolumeSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] driver: name of the CSI driver for the requested storage system. Cloud Run supports the following drivers: * gcsfuse.run.googleapis.com : Mount a Cloud Storage Bucket as a volume.
        :param pulumi.Input[bool] read_only: If true, mount the volume as read only. Defaults to false.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] volume_attributes: stores driver specific attributes. For Google Cloud Storage volumes, the following attributes are supported: * bucketName: the name of the Cloud Storage bucket to mount. The Cloud Run Service identity must have access to this bucket.
        """
...
class ContainerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EnvVarArgs']]] env: List of environment variables to set in the container. EnvVar with duplicate names are generally allowed; if referencing a secret, the name must be unique for the container. For non-secret EnvVar names, the Container will only get the last-declared one.
        :param pulumi.Input[Sequence[pulumi.Input['EnvFromSourceArgs']]] env_from: Not supported by Cloud Run.
        :param pulumi.Input[str] image_pull_policy: Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise.
        :param pulumi.Input['ProbeArgs'] liveness_probe: Periodic probe of container liveness. Container will be restarted if the probe fails.
        ...
        :param pulumi.Input['ResourceRequirementsArgs'] resources: Compute Resources required by this container.
        :param pulumi.Input['SecurityContextArgs'] security_context: Not supported by Cloud Run.
        :param pulumi.Input['ProbeArgs'] startup_probe: Startup probe of application within the container. All other probes are disabled if a startup probe is provided, until it succeeds. Container will not receive traffic if the probe fails. If not provided, a default startup probe with TCP socket action is used.
        :param pulumi.Input[str] termination_message_path: Path at which the file to which the container's termination message will be written is mounted into the container's filesystem. Message written is intended to be brief final status, such as an assertion failure message. Will be truncated by the node if greater than 4096 bytes. The total message length across all containers will be limited to 12kb. Defaults to /dev/termination-log.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VolumeMountArgs']]] volume_mounts: Volume to mount into the container's filesystem. Only supports SecretVolumeSources. Pod volumes to mount into the container's filesystem.
...
class EmptyDirVolumeSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] medium: The medium on which the data is stored. The default is "" which means to use the node's default medium. Must be an empty string (default) or Memory. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir
...
class GRPCActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] service: Service is the name of the service to place in the gRPC HealthCheckRequest. If this is not specified, the default behavior is defined by gRPC.
        """
        if port is not None:
...
class KeyToPathArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key: The Cloud Secret Manager secret version. Can be 'latest' for the latest value, or an integer or a secret alias for a specific version. The key to project.
...
class NFSVolumeSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] read_only: If true, mount the NFS volume as read only. Defaults to false.
...
class ObjectMetaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name of the resource. Name is required when creating top-level resources (Service, Job), must be unique within a Cloud Run project/region, and cannot be changed once created.
        :param pulumi.Input[str] namespace: Defines the space within each name must be unique within a Cloud Run region. In Cloud Run, it must be project ID or number.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] annotations: Unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. In Cloud Run, annotations with 'run.googleapis.com/' and 'autoscaling.knative.dev' are restricted, and the accepted annotations will be different depending on the resource type. * `autoscaling.knative.dev/maxScale`: Revision. * `autoscaling.knative.dev/minScale`: Revision. * `run.googleapis.com/binary-authorization-breakglass`: Service, Job, * `run.googleapis.com/binary-authorization`: Service, Job, Execution. * `run.googleapis.com/client-name`: All resources. * `run.googleapis.com/cloudsql-instances`: Revision, Execution. * `run.googleapis.com/container-dependencies`: Revision . * `run.googleapis.com/cpu-throttling`: Revision. * `run.googleapis.com/custom-audiences`: Service. * `run.googleapis.com/default-url-disabled`: Service. * `run.googleapis.com/description`: Service. * `run.googleapis.com/encryption-key-shutdown-hours`: Revision * `run.googleapis.com/encryption-key`: Revision, Execution. * `run.googleapis.com/execution-environment`: Revision, Execution. * `run.googleapis.com/gc-traffic-tags`: Service. * `run.googleapis.com/ingress`: Service. * `run.googleapis.com/launch-stage`: Service, Job. * `run.googleapis.com/minScale`: Service (ALPHA) * `run.googleapis.com/network-interfaces`: Revision, Execution. * `run.googleapis.com/post-key-revocation-action-type`: Revision. * `run.googleapis.com/secrets`: Revision, Execution. * `run.googleapis.com/secure-session-agent`: Revision. * `run.googleapis.com/sessionAffinity`: Revision. * `run.googleapis.com/startup-cpu-boost`: Revision. * `run.googleapis.com/vpc-access-connector`: Revision, Execution. * `run.googleapis.com/vpc-access-egress`: Revision, Execution.
        :param pulumi.Input[str] cluster_name: Not supported by Cloud Run
        :param pulumi.Input[str] creation_timestamp: UTC timestamp representing the server time when this object was created.
        :param pulumi.Input[int] deletion_grace_period_seconds: Not supported by Cloud Run
        :param pulumi.Input[str] deletion_timestamp: The read-only soft deletion timestamp for this resource. In Cloud Run, users are not able to set this field. Instead, they must call the corresponding Delete API.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] finalizers: Not supported by Cloud Run
        :param pulumi.Input[str] generate_name: Not supported by Cloud Run
        :param pulumi.Input[int] generation: A system-provided sequence number representing a specific generation of the desired state.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and routes.
        :param pulumi.Input[Sequence[pulumi.Input['OwnerReferenceArgs']]] owner_references: Not supported by Cloud Run
        :param pulumi.Input[str] resource_version: Opaque, system-generated value that represents the internal version of this object that can be used by clients to determine when objects have changed. May be used for optimistic concurrency, change detection, and the watch operation on a resource or set of resources. Clients must treat these values as opaque and passed unmodified back to the server or omit the value to disable conflict-detection.
        :param pulumi.Input[str] self_link: URL representing this object.
        :param pulumi.Input[str] uid: Unique, system-generated identifier for this resource.
        """
        pulumi.set(__self__, "name", name)
...
class OwnerReferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] api_version: This is not supported or used by Cloud Run.
        :param pulumi.Input[bool] block_owner_deletion: This is not supported or used by Cloud Run.
        :param pulumi.Input[bool] controller: This is not supported or used by Cloud Run.
        :param pulumi.Input[str] kind: This is not supported or used by Cloud Run.
        :param pulumi.Input[str] name: This is not supported or used by Cloud Run.
        :param pulumi.Input[str] uid: This is not supported or used by Cloud Run.
        """
...
class ProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ExecActionArgs'] exec_: Not supported by Cloud Run.
        ...
        :param pulumi.Input['GRPCActionArgs'] grpc: GRPCAction specifies an action involving a GRPC port.
        ...
        :param pulumi.Input[int] success_threshold: Minimum consecutive successes for the probe to be considered successful after having failed. Must be 1 if set.
        :param pulumi.Input['TCPSocketActionArgs'] tcp_socket: TCPSocket specifies an action involving a TCP port.
        :param pulumi.Input[int] timeout_seconds: Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. Maximum value is 3600. Must be smaller than period_seconds; if period_seconds is not set, must be less or equal than 10.
        """
...
class RevisionSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] timeout_seconds: TimeoutSeconds holds the max duration the instance is allowed for responding to a request. Cloud Run: defaults to 300 seconds (5 minutes). Maximum allowed value is 3600 seconds (1 hour).
        """
...
class SecretKeySelectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key: A Cloud Secret Manager secret version. Must be 'latest' for the latest version, an integer for a specific version, or a version alias. The key of the secret to select from. Must be a valid secret key.
        :param pulumi.Input['LocalObjectReferenceArgs'] local_object_reference: This field should not be used directly as it is meant to be inlined directly into the message. Use the "name" field instead.
...
class SecretVolumeSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] default_mode: Integer representation of mode bits to use on created files by default. Must be a value between 01 and 0777 (octal). If 0 or not set, it will default to 0444. Directories within the path are not affected by this setting. Notes * Internally, a umask of 0222 will be applied to any non-zero value. * This is an integer representation of the mode bits. So, the octal integer value should look exactly as the chmod numeric notation with a leading zero. Some examples: for chmod 777 (a=rwx), set to 0777 (octal) or 511 (base-10). For chmod 640 (u=rw,g=r), set to 0640 (octal) or 416 (base-10). For chmod 755 (u=rwx,g=rx,o=rx), set to 0755 (octal) or 493 (base-10). * This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.
        :param pulumi.Input[Sequence[pulumi.Input['KeyToPathArgs']]] items: A list of secret versions to mount in the volume. If no items are specified, the volume will expose a file with the same name as the secret name. The contents of the file will be the data in the latest version of the secret. If items are specified, the key will be used as the version to fetch from Cloud Secret Manager and the path will be the name of the file exposed in the volume. When items are defined, they must specify both a key and a path.
        :param pulumi.Input[bool] optional: Not supported by Cloud Run.
...
class ServiceSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RevisionTemplateArgs'] template: Holds the latest specification for the Revision to be stamped out.
        :param pulumi.Input[Sequence[pulumi.Input['TrafficTargetArgs']]] traffic: Specifies how to distribute traffic over a collection of Knative Revisions and Configurations to the Service's main URL.
        """
...
class TrafficTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] configuration_name: [Deprecated] Not supported in Cloud Run. It must be empty.
        ...
        :param pulumi.Input[str] revision_name: Points this traffic target to a specific Revision. This field is mutually exclusive with latest_revision.
        :param pulumi.Input[str] tag: Tag is used to expose a dedicated url for referencing this target exclusively.
        """
...
class VolumeMountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] read_only: Sets the mount to be read-only or read-write. Not used by Cloud Run.
...
class VolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CSIVolumeSourceArgs'] csi: Volume specified by the Container Storage Interface driver
