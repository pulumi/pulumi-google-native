...
@pulumi.output_type
class GetJobResult:
    def __init__(__self__, annotations=None, binary_authorization=None, client=None, client_version=None, conditions=None, container_statuses=None, create_time=None, creator=None, delete_time=None, etag=None, execution_count=None, expire_time=None, generation=None, labels=None, last_modifier=None, latest_created_execution=None, launch_stage=None, name=None, observed_generation=None, reconciling=None, template=None, terminal_condition=None, uid=None, update_time=None):
        ...
        if container_statuses and not isinstance(container_statuses, list):
            raise TypeError("Expected argument 'container_statuses' to be a list")
    ...
    def container_statuses(self) -> Sequence['outputs.GoogleCloudRunV2ContainerStatusResponse']:
        """
...
def get_job(job_id: Optional[str] = None,
    ...
    return AwaitableGetJobResult(
        ...
        container_statuses=__ret__.container_statuses,
