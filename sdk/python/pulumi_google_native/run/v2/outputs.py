...
class GoogleCloudRunOpV2CloudSqlInstanceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a specific Cloud SQL instance.
        :param Sequence[str] connections: The Cloud SQL instance connection names, as can be found in https://console.cloud.google.com/sql/instances. Visit https://cloud.google.com/sql/docs/mysql/connect-run for more information on how to connect Cloud SQL and Cloud Run. Format: {project}:{location}:{instance}
        """
        pulumi.set(__self__, "connections", connections)

    @property
    @pulumi.getter
    def connections(self) -> Sequence[str]:
        """
...
class GoogleCloudRunOpV2TrafficTargetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Holds a single traffic routing entry for the Service. Allocations can be done to a specific Revision name, or pointing to the latest Ready Revision.
        :param int percent: Specifies percent of the traffic to this Revision. This defaults to zero if unspecified. Cloud Run currently requires 100 percent for a single TrafficTarget entry.
