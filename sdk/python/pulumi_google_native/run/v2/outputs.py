...
__all__ = [
    ...
    'GoogleCloudRunV2ContainerStatusResponse',
...
@pulumi.output_type
class GoogleCloudRunV2ContainerStatusResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleCloudRunV2ContainerStatusResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleCloudRunV2ContainerStatusResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        ContainerStatus holds the information of container name and image digest value.
        :param str image_digest: ImageDigest holds the resolved digest for the image specified, regardless of whether a tag or digest was originally specified in the Container object.
        :param str name: The name of the container, if specified.
        """
