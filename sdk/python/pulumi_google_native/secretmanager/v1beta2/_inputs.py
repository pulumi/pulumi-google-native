...
class ReplicationArgs:
    def __init__(__self__, *,
                 ...
                 user_managed: Optional[pulumi.Input['UserManagedArgs']] = None):
        """
        A policy that defines the replication and encryption configuration of data.
        :param pulumi.Input['AutomaticArgs'] automatic: The Secret will automatically be replicated without any restrictions.
        :param pulumi.Input['UserManagedArgs'] user_managed: The Secret will only be replicated into the locations specified.
        """
    ...
    @property
    @pulumi.getter
    def automatic(self) -> Optional[pulumi.Input['AutomaticArgs']]:
        """
    ...
    @automatic.setter
    def automatic(self, value: Optional[pulumi.Input['AutomaticArgs']]):
        pulumi.set(self, "automatic", value)

    @property
    @pulumi.getter(name="userManaged")
    def user_managed(self) -> Optional[pulumi.Input['UserManagedArgs']]:
        """
...
class RotationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] next_rotation_time: Optional. Timestamp in UTC at which the Secret is scheduled to rotate. Cannot be set to less than 300s (5 min) in the future and at most 3153600000s (100 years). next_rotation_time MUST be set if rotation_period is set.
