...
class ReplicationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A policy that defines the replication and encryption configuration of data.
        :param 'AutomaticResponse' automatic: The Secret will automatically be replicated without any restrictions.
        :param 'UserManagedResponse' user_managed: The Secret will only be replicated into the locations specified.
        """
...
class RotationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The rotation time and period for a Secret. At next_rotation_time, Secret Manager will send a Pub/Sub notification to the topics configured on the Secret. Secret.topics must be set to configure rotation.
        :param str next_rotation_time: Optional. Timestamp in UTC at which the Secret is scheduled to rotate. Cannot be set to less than 300s (5 min) in the future and at most 3153600000s (100 years). next_rotation_time MUST be set if rotation_period is set.
