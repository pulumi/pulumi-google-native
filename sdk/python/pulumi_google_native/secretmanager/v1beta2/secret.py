...
class SecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ReplicationArgs'] replication: Optional. Immutable. The replication policy of the secret data attached to the Secret. The replication policy cannot be changed after the Secret has been created.
...
class Secret(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 customer_managed_encryption: Optional[pulumi.Input[pulumi.InputType['CustomerManagedEncryptionArgs']]] = None,
                 etag: Optional[pulumi.Input[str]] = None,
                 expire_time: Optional[pulumi.Input[str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] annotations: Optional. Custom metadata about the secret. Annotations are distinct from various forms of labels. Annotations exist to allow client tools to store their own state information without requiring a database. Annotation keys must be between 1 and 63 characters long, have a UTF-8 encoding of maximum 128 bytes, begin and end with an alphanumeric character ([a-z0-9A-Z]), and may have dashes (-), underscores (_), dots (.), and alphanumerics in between these symbols. The total size of annotation keys and values must be less than 16KiB.
        :param pulumi.Input[pulumi.InputType['CustomerManagedEncryptionArgs']] customer_managed_encryption: Optional. The customer-managed encryption configuration of the Regionalised Secrets. If no configuration is provided, Google-managed default encryption is used. Updates to the Secret encryption configuration only apply to SecretVersions added afterwards. They do not apply retroactively to existing SecretVersions.
        :param pulumi.Input[str] etag: Optional. Etag of the currently stored Secret.
        :param pulumi.Input[str] expire_time: Optional. Timestamp in UTC when the Secret is scheduled to expire. This is always provided on output, regardless of what was sent on input.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: The labels assigned to this Secret. Label keys must be between 1 and 63 characters long, have a UTF-8 encoding of maximum 128 bytes, and must conform to the following PCRE regular expression: `\\p{Ll}\\p{Lo}{0,62}` Label values must be between 0 and 63 characters long, have a UTF-8 encoding of maximum 128 bytes, and must conform to the following PCRE regular expression: `[\\p{Ll}\\p{Lo}\\p{N}_-]{0,63}` No more than 64 labels can be assigned to a given resource.
        :param pulumi.Input[pulumi.InputType['ReplicationArgs']] replication: Optional. Immutable. The replication policy of the secret data attached to the Secret. The replication policy cannot be changed after the Secret has been created.
    ...
    def _internal_init(__self__,
        ...
        super(Secret, __self__).__init__(
            'google-native:secretmanager/v1beta2:Secret',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["create_time"] = None
        __props__.__dict__["customer_managed_encryption"] = None
        ...
        __props__.__dict__["version_destroy_ttl"] = None
    ...
    @property
    @pulumi.getter(name="customerManagedEncryption")
    def customer_managed_encryption(self) -> pulumi.Output['outputs.CustomerManagedEncryptionResponse']:
        """
        Optional. The customer-managed encryption configuration of the Regionalised Secrets. If no configuration is provided, Google-managed default encryption is used. Updates to the Secret encryption configuration only apply to SecretVersions added afterwards. They do not apply retroactively to existing SecretVersions.
        """
        return pulumi.get(self, "customer_managed_encryption")
    ...
    @property
    @pulumi.getter(name="versionDestroyTtl")
    def version_destroy_ttl(self) -> pulumi.Output[str]:
        """
        Optional. Secret Version TTL after destruction request This is a part of the Delayed secret version destroy feature. For secret with TTL>0, version destruction doesn't happen immediately on calling destroy instead the version goes to a disabled state and destruction happens after the TTL expires.
        """
        return pulumi.get(self, "version_destroy_ttl")
