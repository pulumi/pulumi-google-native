...
__all__ = ['CustomModuleArgs', 'CustomModule']

@pulumi.input_type
class CustomModuleArgs:
    def __init__(__self__, *,
                 custom_config: Optional[pulumi.Input['GoogleCloudSecuritycenterV1CustomConfigArgs']] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 enablement_state: Optional[pulumi.Input['CustomModuleEnablementState']] = None,
        ...
        :param pulumi.Input['CustomModuleEnablementState'] enablement_state: The enablement state of the custom module.
    ...
    def enablement_state(self) -> Optional[pulumi.Input['CustomModuleEnablementState']]:
        """
    ...
    def enablement_state(self, value: Optional[pulumi.Input['CustomModuleEnablementState']]):
...
class CustomModule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CustomModuleArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a resident SecurityHealthAnalyticsCustomModule at the scope of the given CRM parent, and also creates inherited SecurityHealthAnalyticsCustomModules for all CRM descendants of the given parent. These modules are enabled by default.
        Auto-naming is currently not supported for this resource.
        ...
        :param str resource_name: The name of the resource.
        :param CustomModuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CustomModuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CustomModuleArgs.__new__(CustomModuleArgs)
        ...
        super(CustomModule, __self__).__init__(
            'google-native:securitycenter/v1:CustomModule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CustomModule':
        """
        ...
        __props__.__dict__["update_time"] = None
        return CustomModule(resource_name, opts=opts, __props__=__props__)
