...
__all__ = ['FolderEventThreatDetectionSettingCustomModuleArgs', 'FolderEventThreatDetectionSettingCustomModule']

@pulumi.input_type
class FolderEventThreatDetectionSettingCustomModuleArgs:
    def __init__(__self__, *,
                 folder_id: pulumi.Input[str],
                 config: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 enablement_state: Optional[pulumi.Input['FolderEventThreatDetectionSettingCustomModuleEnablementState']] = None,
        ...
        :param pulumi.Input['FolderEventThreatDetectionSettingCustomModuleEnablementState'] enablement_state: The state of enablement for the module at the given level of the hierarchy.
    ...
    def enablement_state(self) -> Optional[pulumi.Input['FolderEventThreatDetectionSettingCustomModuleEnablementState']]:
        """
    ...
    def enablement_state(self, value: Optional[pulumi.Input['FolderEventThreatDetectionSettingCustomModuleEnablementState']]):
...
class FolderEventThreatDetectionSettingCustomModule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FolderEventThreatDetectionSettingCustomModuleArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a resident Event Threat Detection custom module at the scope of the given Resource Manager parent, and also creates inherited custom modules for all descendants of the given parent. These modules are enabled by default.
        Auto-naming is currently not supported for this resource.
        ...
        :param str resource_name: The name of the resource.
        :param FolderEventThreatDetectionSettingCustomModuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FolderEventThreatDetectionSettingCustomModuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FolderEventThreatDetectionSettingCustomModuleArgs.__new__(FolderEventThreatDetectionSettingCustomModuleArgs)
        ...
        super(FolderEventThreatDetectionSettingCustomModule, __self__).__init__(
            'google-native:securitycenter/v1:FolderEventThreatDetectionSettingCustomModule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FolderEventThreatDetectionSettingCustomModule':
        """
        ...
        __props__.__dict__["update_time"] = None
        return FolderEventThreatDetectionSettingCustomModule(resource_name, opts=opts, __props__=__props__)
