...
__all__ = [
    'GetCustomModuleResult',
    'AwaitableGetCustomModuleResult',
    'get_custom_module',
    'get_custom_module_output',
]

@pulumi.output_type
class GetCustomModuleResult:
...
class AwaitableGetCustomModuleResult(GetCustomModuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCustomModuleResult(
...
def get_custom_module(custom_module_id: Optional[str] = None,
                      project: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCustomModuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:securitycenter/v1:getCustomModule', __args__, opts=opts, typ=GetCustomModuleResult).value

    return AwaitableGetCustomModuleResult(
...
@_utilities.lift_output_func(get_custom_module)
def get_custom_module_output(custom_module_id: Optional[pulumi.Input[str]] = None,
                             project: Optional[pulumi.Input[Optional[str]]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCustomModuleResult]:
    """
    Retrieves a SecurityHealthAnalyticsCustomModule.
    """
    ...
