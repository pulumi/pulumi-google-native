...
__all__ = [
    ...
    'AwaitableGetFolderCustomModuleResult',
    'get_folder_custom_module',
    'get_folder_custom_module_output',
]

@pulumi.output_type
class GetFolderCustomModuleResult:
...
class AwaitableGetFolderCustomModuleResult(GetFolderCustomModuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFolderCustomModuleResult(
...
def get_folder_custom_module(custom_module_id: Optional[str] = None,
                             folder_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFolderCustomModuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:securitycenter/v1:getFolderCustomModule', __args__, opts=opts, typ=GetFolderCustomModuleResult).value

    return AwaitableGetFolderCustomModuleResult(
...
@_utilities.lift_output_func(get_folder_custom_module)
def get_folder_custom_module_output(custom_module_id: Optional[pulumi.Input[str]] = None,
                                    folder_id: Optional[pulumi.Input[str]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFolderCustomModuleResult]:
    """
    Retrieves a SecurityHealthAnalyticsCustomModule.
    """
    ...
