...
__all__ = [
    'GetFolderEventThreatDetectionSettingCustomModuleResult',
    'AwaitableGetFolderEventThreatDetectionSettingCustomModuleResult',
    'get_folder_event_threat_detection_setting_custom_module',
    'get_folder_event_threat_detection_setting_custom_module_output',
]

@pulumi.output_type
class GetFolderEventThreatDetectionSettingCustomModuleResult:
...
class AwaitableGetFolderEventThreatDetectionSettingCustomModuleResult(GetFolderEventThreatDetectionSettingCustomModuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFolderEventThreatDetectionSettingCustomModuleResult(
...
def get_folder_event_threat_detection_setting_custom_module(custom_module_id: Optional[str] = None,
                                                            folder_id: Optional[str] = None,
                                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFolderEventThreatDetectionSettingCustomModuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:securitycenter/v1:getFolderEventThreatDetectionSettingCustomModule', __args__, opts=opts, typ=GetFolderEventThreatDetectionSettingCustomModuleResult).value

    return AwaitableGetFolderEventThreatDetectionSettingCustomModuleResult(
...
@_utilities.lift_output_func(get_folder_event_threat_detection_setting_custom_module)
def get_folder_event_threat_detection_setting_custom_module_output(custom_module_id: Optional[pulumi.Input[str]] = None,
                                                                   folder_id: Optional[pulumi.Input[str]] = None,
                                                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFolderEventThreatDetectionSettingCustomModuleResult]:
    """
    Gets an Event Threat Detection custom module.
    """
    ...
