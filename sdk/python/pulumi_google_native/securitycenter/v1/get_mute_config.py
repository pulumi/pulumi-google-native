...
__all__ = [
    'GetMuteConfigResult',
    'AwaitableGetMuteConfigResult',
    'get_mute_config',
    'get_mute_config_output',
]
...
class AwaitableGetMuteConfigResult(GetMuteConfigResult):
...
def get_mute_config(mute_config_id: Optional[str] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMuteConfigResult:
    """
    Gets a mute config.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('google-native:securitycenter/v1:getMuteConfig', __args__, opts=opts, typ=GetMuteConfigResult).value

    return AwaitableGetMuteConfigResult(
...
@_utilities.lift_output_func(get_mute_config)
def get_mute_config_output(mute_config_id: Optional[pulumi.Input[str]] = None,
                           project: Optional[pulumi.Input[Optional[str]]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetMuteConfigResult]:
    """
    Gets a mute config.
    """
    ...
