...
__all__ = [
    ...
    'AwaitableGetOrganizationNotificationConfigResult',
    'get_organization_notification_config',
    'get_organization_notification_config_output',
]
...
class AwaitableGetOrganizationNotificationConfigResult(GetOrganizationNotificationConfigResult):
...
def get_organization_notification_config(notification_config_id: Optional[str] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrganizationNotificationConfigResult:
    """
...
def get_organization_notification_config_output(notification_config_id: Optional[pulumi.Input[str]] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOrganizationNotificationConfigResult]:
    """
    Gets a notification config.
    """
    ...
