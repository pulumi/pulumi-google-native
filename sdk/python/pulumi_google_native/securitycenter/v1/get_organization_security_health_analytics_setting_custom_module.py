...
__all__ = [
    ...
    'AwaitableGetOrganizationSecurityHealthAnalyticsSettingCustomModuleResult',
    'get_organization_security_health_analytics_setting_custom_module',
    'get_organization_security_health_analytics_setting_custom_module_output',
]
...
class AwaitableGetOrganizationSecurityHealthAnalyticsSettingCustomModuleResult(GetOrganizationSecurityHealthAnalyticsSettingCustomModuleResult):
...
def get_organization_security_health_analytics_setting_custom_module(custom_module_id: Optional[str] = None,
                                                                     ...
                                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrganizationSecurityHealthAnalyticsSettingCustomModuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:securitycenter/v1:getOrganizationSecurityHealthAnalyticsSettingCustomModule', __args__, opts=opts, typ=GetOrganizationSecurityHealthAnalyticsSettingCustomModuleResult).value

    return AwaitableGetOrganizationSecurityHealthAnalyticsSettingCustomModuleResult(
...
@_utilities.lift_output_func(get_organization_security_health_analytics_setting_custom_module)
def get_organization_security_health_analytics_setting_custom_module_output(custom_module_id: Optional[pulumi.Input[str]] = None,
                                                                            ...
                                                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOrganizationSecurityHealthAnalyticsSettingCustomModuleResult]:
    """
    Retrieves a SecurityHealthAnalyticsCustomModule.
    """
    ...
