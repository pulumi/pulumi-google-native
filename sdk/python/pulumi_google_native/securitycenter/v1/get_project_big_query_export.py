...
__all__ = [
    ...
    'AwaitableGetProjectBigQueryExportResult',
    'get_project_big_query_export',
    'get_project_big_query_export_output',
]
...
class AwaitableGetProjectBigQueryExportResult(GetProjectBigQueryExportResult):
...
def get_project_big_query_export(big_query_export_id: Optional[str] = None,
                                 project: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProjectBigQueryExportResult:
    """
...
def get_project_big_query_export_output(big_query_export_id: Optional[pulumi.Input[str]] = None,
                                        project: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetProjectBigQueryExportResult]:
    """
    Gets a big query export.
    """
    ...
