...
__all__ = [
    'GetProjectEventThreatDetectionSettingCustomModuleResult',
    'AwaitableGetProjectEventThreatDetectionSettingCustomModuleResult',
    'get_project_event_threat_detection_setting_custom_module',
    'get_project_event_threat_detection_setting_custom_module_output',
]

@pulumi.output_type
class GetProjectEventThreatDetectionSettingCustomModuleResult:
...
class AwaitableGetProjectEventThreatDetectionSettingCustomModuleResult(GetProjectEventThreatDetectionSettingCustomModuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetProjectEventThreatDetectionSettingCustomModuleResult(
...
def get_project_event_threat_detection_setting_custom_module(custom_module_id: Optional[str] = None,
                                                             project: Optional[str] = None,
                                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProjectEventThreatDetectionSettingCustomModuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:securitycenter/v1:getProjectEventThreatDetectionSettingCustomModule', __args__, opts=opts, typ=GetProjectEventThreatDetectionSettingCustomModuleResult).value

    return AwaitableGetProjectEventThreatDetectionSettingCustomModuleResult(
...
@_utilities.lift_output_func(get_project_event_threat_detection_setting_custom_module)
def get_project_event_threat_detection_setting_custom_module_output(custom_module_id: Optional[pulumi.Input[str]] = None,
                                                                    project: Optional[pulumi.Input[Optional[str]]] = None,
                                                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetProjectEventThreatDetectionSettingCustomModuleResult]:
    """
    Gets an Event Threat Detection custom module.
    """
    ...
