...
__all__ = ['OrganizationSourceIamPolicyArgs', 'OrganizationSourceIamPolicy']

@pulumi.input_type
class OrganizationSourceIamPolicyArgs:
...
class OrganizationSourceIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OrganizationSourceIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on the specified Source.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param OrganizationSourceIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationSourceIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OrganizationSourceIamPolicyArgs.__new__(OrganizationSourceIamPolicyArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OrganizationSourceIamPolicy':
        """
        ...
        return OrganizationSourceIamPolicy(resource_name, opts=opts, __props__=__props__)
