...
@pulumi.output_type
class GetOrganizationSourceIamPolicyResult:
...
class AwaitableGetOrganizationSourceIamPolicyResult(GetOrganizationSourceIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrganizationSourceIamPolicyResult(
...
def get_organization_source_iam_policy(organization_id: Optional[str] = None,
                                       source_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrganizationSourceIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:securitycenter/v1beta1:getOrganizationSourceIamPolicy', __args__, opts=opts, typ=GetOrganizationSourceIamPolicyResult).value

    return AwaitableGetOrganizationSourceIamPolicyResult(
