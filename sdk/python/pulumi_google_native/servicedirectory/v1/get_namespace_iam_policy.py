...
def get_namespace_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:servicedirectory/v1:getNamespaceIamPolicy', __args__, opts=opts, typ=GetNamespaceIamPolicyResult).value
