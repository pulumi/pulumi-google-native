...
__all__ = ['NamespaceServiceWorkloadIamPolicyArgs', 'NamespaceServiceWorkloadIamPolicy']

@pulumi.input_type
class NamespaceServiceWorkloadIamPolicyArgs:
    def __init__(__self__, *,
                 namespace_id: pulumi.Input[str],
                 service_workload_id: pulumi.Input[str],
        ...
        pulumi.set(__self__, "service_workload_id", service_workload_id)
    ...
    @property
    @pulumi.getter(name="serviceWorkloadId")
    def service_workload_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "service_workload_id")

    @service_workload_id.setter
    def service_workload_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "service_workload_id", value)
...
class NamespaceServiceWorkloadIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: NamespaceServiceWorkloadIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the IAM Policy for a resource
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param NamespaceServiceWorkloadIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NamespaceServiceWorkloadIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NamespaceServiceWorkloadIamPolicyArgs.__new__(NamespaceServiceWorkloadIamPolicyArgs)
            ...
            if service_workload_id is None and not opts.urn:
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NamespaceServiceWorkloadIamPolicy':
        """
        ...
        __props__.__dict__["service_workload_id"] = None
        __props__.__dict__["version"] = None
        return NamespaceServiceWorkloadIamPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="serviceWorkloadId")
    def service_workload_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "service_workload_id")
