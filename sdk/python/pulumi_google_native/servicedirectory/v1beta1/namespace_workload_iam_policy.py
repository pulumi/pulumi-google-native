...
__all__ = ['NamespaceWorkloadIamPolicyArgs', 'NamespaceWorkloadIamPolicy']

@pulumi.input_type
class NamespaceWorkloadIamPolicyArgs:
...
class NamespaceWorkloadIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: NamespaceWorkloadIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the IAM Policy for a resource
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param NamespaceWorkloadIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NamespaceWorkloadIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NamespaceWorkloadIamPolicyArgs.__new__(NamespaceWorkloadIamPolicyArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["location", "namespaceId", "project", "workloadId"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(NamespaceWorkloadIamPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NamespaceWorkloadIamPolicy':
        """
        ...
        return NamespaceWorkloadIamPolicy(resource_name, opts=opts, __props__=__props__)
