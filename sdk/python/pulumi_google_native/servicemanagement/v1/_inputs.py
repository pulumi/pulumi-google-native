...
class MonitoredResourceDescriptorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: The monitored resource type. For example, the type `"cloudsql_database"` represents databases in Google Cloud SQL. For a list of types, see [Monitored resource types](https://cloud.google.com/monitoring/api/resources) and [Logging resource types](https://cloud.google.com/logging/docs/api/v2/resource-list).
...
class PublishingArgs:
    def __init__(__self__, *,
                 ...
                 rest_reference_documentation_uri: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[str] rest_reference_documentation_uri: Optional link to REST reference documentation. Example: https://cloud.google.com/pubsub/lite/docs/reference/rest
        """
        ...
        if rest_reference_documentation_uri is not None:
    ...
    def rest_reference_documentation_uri(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def rest_reference_documentation_uri(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "rest_reference_documentation_uri", value)
