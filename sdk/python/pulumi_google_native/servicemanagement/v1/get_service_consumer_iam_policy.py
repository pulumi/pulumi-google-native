...
@pulumi.output_type
class GetServiceConsumerIamPolicyResult:
...
class AwaitableGetServiceConsumerIamPolicyResult(GetServiceConsumerIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceConsumerIamPolicyResult(
...
def get_service_consumer_iam_policy(consumer_id: Optional[str] = None,
                                    service_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceConsumerIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:servicemanagement/v1:getServiceConsumerIamPolicy', __args__, opts=opts, typ=GetServiceConsumerIamPolicyResult).value

    return AwaitableGetServiceConsumerIamPolicyResult(
