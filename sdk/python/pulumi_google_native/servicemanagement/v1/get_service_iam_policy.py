...
def get_service_iam_policy(service_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:servicemanagement/v1:getServiceIamPolicy', __args__, opts=opts, typ=GetServiceIamPolicyResult).value
...
def get_service_iam_policy_output(service_id: Optional[pulumi.Input[str]] = None,
