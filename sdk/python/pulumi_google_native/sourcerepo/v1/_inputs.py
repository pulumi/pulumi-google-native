...
@pulumi.input_type
class MirrorConfigArgs:
    def __init__(__self__, *,
                 deploy_key_id: Optional[pulumi.Input[str]] = None,
                 url: Optional[pulumi.Input[str]] = None,
                 webhook_id: Optional[pulumi.Input[str]] = None):
        """
        Configuration to automatically mirror a repository from another hosting service, for example GitHub or Bitbucket.
        :param pulumi.Input[str] deploy_key_id: ID of the SSH deploy key at the other hosting service. Removing this key from the other service would deauthorize Google Cloud Source Repositories from mirroring.
        :param pulumi.Input[str] url: URL of the main repository at the other hosting service.
        :param pulumi.Input[str] webhook_id: ID of the webhook listening to updates to trigger mirroring. Removing this webhook from the other hosting service will stop Google Cloud Source Repositories from receiving notifications, and thereby disabling mirroring.
        """
    ...
    def deploy_key_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def deploy_key_id(self, value: Optional[pulumi.Input[str]]):
