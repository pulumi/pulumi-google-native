...
__all__ = [
    ...
    'AwaitableGetRepoIamPolicyResult',
    'get_repo_iam_policy',
    'get_repo_iam_policy_output',
]
...
class AwaitableGetRepoIamPolicyResult(GetRepoIamPolicyResult):
...
def get_repo_iam_policy(options_requested_policy_version: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:sourcerepo/v1:getRepoIamPolicy', __args__, opts=opts, typ=GetRepoIamPolicyResult).value

    return AwaitableGetRepoIamPolicyResult(
