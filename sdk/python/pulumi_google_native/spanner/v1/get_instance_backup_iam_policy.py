...
@pulumi.output_type
class GetInstanceBackupIamPolicyResult:
...
class AwaitableGetInstanceBackupIamPolicyResult(GetInstanceBackupIamPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInstanceBackupIamPolicyResult(
            bindings=self.bindings,
            etag=self.etag,
            version=self.version)


def get_instance_backup_iam_policy(backup_id: Optional[str] = None,
                                   instance_id: Optional[str] = None,
                                   project: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInstanceBackupIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:spanner/v1:getInstanceBackupIamPolicy', __args__, opts=opts, typ=GetInstanceBackupIamPolicyResult).value

    return AwaitableGetInstanceBackupIamPolicyResult(
