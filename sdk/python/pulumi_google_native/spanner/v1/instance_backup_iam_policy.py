...
__all__ = ['InstanceBackupIamPolicyArgs', 'InstanceBackupIamPolicy']

@pulumi.input_type
class InstanceBackupIamPolicyArgs:
...
class InstanceBackupIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: InstanceBackupIamPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on a database or backup resource. Replaces any existing policy. Authorization requires `spanner.databases.setIamPolicy` permission on resource. For backups, authorization requires `spanner.backups.setIamPolicy` permission on resource.
        Note - this resource's API doesn't support deletion. When deleted, the resource will persist
        ...
        :param str resource_name: The name of the resource.
        :param InstanceBackupIamPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InstanceBackupIamPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InstanceBackupIamPolicyArgs.__new__(InstanceBackupIamPolicyArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["backupId", "instanceId", "project"])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InstanceBackupIamPolicy':
        """
        Get an existing InstanceBackupIamPolicy resource's state with the given name, id, and optional extra
        ...
        return InstanceBackupIamPolicy(resource_name, opts=opts, __props__=__props__)
