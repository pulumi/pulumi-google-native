...
__all__ = ['InstanceDatabaseIamBindingArgs', 'InstanceDatabaseIamBinding']
...
class InstanceDatabaseIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: InstanceDatabaseIamBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Sets the access control policy on a database or backup resource. Replaces any existing policy. Authorization requires `spanner.databases.setIamPolicy` permission on resource. For backups, authorization requires `spanner.backups.setIamPolicy` permission on resource.

        :param str resource_name: The name of the resource.
        :param InstanceDatabaseIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InstanceDatabaseIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InstanceDatabaseIamBindingArgs.__new__(InstanceDatabaseIamBindingArgs)
        ...
        super(InstanceDatabaseIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InstanceDatabaseIamBinding':
        """
        ...
        return InstanceDatabaseIamBinding(resource_name, opts=opts, __props__=__props__)
