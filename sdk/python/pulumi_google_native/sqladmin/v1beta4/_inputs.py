...
class InsightsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] query_plans_per_minute: Number of query plans generated by Insights per minute. Default is 5. Changing this will restart the database.
