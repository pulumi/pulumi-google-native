...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 replication_cluster: Optional[pulumi.Input['ReplicationClusterArgs']] = None,
        ...
        :param pulumi.Input['GeminiInstanceConfigArgs'] gemini_config: Gemini instance configuration.
        ...
        :param pulumi.Input[str] region: The geographical region of the Cloud SQL instance. It can be one of the [regions](https://cloud.google.com/sql/docs/mysql/locations#location-r) where Cloud SQL operates: For example, `asia-east1`, `europe-west1`, and `us-central1`. The default value is `us-central1`.
        ...
        :param pulumi.Input['ReplicationClusterArgs'] replication_cluster: The pair of a primary instance and disaster recovery (DR) replica. A DR replica is a cross-region replica that you designate for failover in the event that the primary instance has regional failure.
        ...
        :param pulumi.Input['InstanceSqlNetworkArchitecture'] sql_network_architecture: The SQL network architecture for the instance.
    ...
    def replication_cluster(self) -> Optional[pulumi.Input['ReplicationClusterArgs']]:
        """
    ...
    def replication_cluster(self, value: Optional[pulumi.Input['ReplicationClusterArgs']]):
...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 replica_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 replication_cluster: Optional[pulumi.Input[pulumi.InputType['ReplicationClusterArgs']]] = None,
                 root_password: Optional[pulumi.Input[str]] = None,
                 satisfies_pzs: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[str] gce_zone: The Compute Engine zone that the instance is currently serving from. This value could be different from the zone that was specified when the instance was created if the instance has failed over to its secondary zone. WARNING: Changing this might restart the instance.
        :param pulumi.Input[pulumi.InputType['GeminiInstanceConfigArgs']] gemini_config: Gemini instance configuration.
        :param pulumi.Input['InstanceInstanceType'] instance_type: The instance type.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] replica_names: The replicas of the instance.
        :param pulumi.Input[pulumi.InputType['ReplicationClusterArgs']] replication_cluster: The pair of a primary instance and disaster recovery (DR) replica. A DR replica is a cross-region replica that you designate for failover in the event that the primary instance has regional failure.
        :param pulumi.Input[str] root_password: Initial root password. Use only on creation. You must set root passwords before you can connect to PostgreSQL instances.
        :param pulumi.Input[bool] satisfies_pzs: The status indicating if instance satisfiesPzs. Reserved for future use.
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["replication_cluster"] = None
    ...
    @property
    @pulumi.getter(name="replicationCluster")
    def replication_cluster(self) -> pulumi.Output['outputs.ReplicationClusterResponse']:
        """
        The pair of a primary instance and disaster recovery (DR) replica. A DR replica is a cross-region replica that you designate for failover in the event that the primary instance has regional failure.
        """
        return pulumi.get(self, "replication_cluster")
