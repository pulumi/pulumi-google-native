...
class NodeSpecArgs:
    def __init__(__self__, *,
                 ...
                 multislice_params: Optional[pulumi.Input['MultisliceParamsArgs']] = None,
        ...
        :param pulumi.Input['MultisliceParamsArgs'] multislice_params: Optional. Fields to specify in case of multislice request.
        :param pulumi.Input[str] node_id: Optional. The unqualified resource name. Should follow the `^[A-Za-z0-9_.~+%-]+$` regex format. This is only specified when requesting a single node. In case of multislice requests, multislice_params must be populated instead.
        """
        pulumi.set(__self__, "node", node)
        pulumi.set(__self__, "parent", parent)
        if multislice_params is not None:
    ...
    def multislice_params(self) -> Optional[pulumi.Input['MultisliceParamsArgs']]:
        """
    ...
    def multislice_params(self, value: Optional[pulumi.Input['MultisliceParamsArgs']]):
        pulumi.set(self, "multislice_params", value)
...
class QueueingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] valid_after_duration: Optional. A relative time after which resources may be created.
        :param pulumi.Input[str] valid_after_time: Optional. An absolute time after which resources may be created.
        :param pulumi.Input['IntervalArgs'] valid_interval: Optional. An absolute time interval within which resources may be created.
        :param pulumi.Input[str] valid_until_duration: Optional. A relative time after which resources should not be created. If the request cannot be fulfilled by this time the request will be failed.
        :param pulumi.Input[str] valid_until_time: Optional. An absolute time after which resources should not be created. If the request cannot be fulfilled by this time the request will be failed.
        """
...
class TpuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NodeSpecArgs']]] node_spec: Optional. The TPU node(s) being requested.
        """
