...
class GetQueuedResourceResult:
    def __init__(__self__, create_time=None, guaranteed=None, name=None, queueing_policy=None, reservation_name=None, spot=None, state=None, tpu=None):
...
def get_queued_resource(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('google-native:tpu/v2:getQueuedResource', __args__, opts=opts, typ=GetQueuedResourceResult).value
