...
class QueuedResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GuaranteedArgs'] guaranteed: Optional. The Guaranteed tier
        :param pulumi.Input[str] queued_resource_id: Optional. The unqualified resource name. Should follow the `^[A-Za-z0-9_.~+%-]+$` regex format.
        :param pulumi.Input['QueueingPolicyArgs'] queueing_policy: Optional. The queueing policy of the QueuedRequest.
        :param pulumi.Input[str] request_id: Optional. Idempotent request UUID.
        :param pulumi.Input[str] reservation_name: Optional. Name of the reservation in which the resource should be provisioned. Format: projects/{project}/locations/{zone}/reservations/{reservation}
        :param pulumi.Input['SpotArgs'] spot: Optional. The Spot tier.
        :param pulumi.Input['TpuArgs'] tpu: Optional. Defines a TPU resource.
        """
...
class QueuedResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['GuaranteedArgs']] guaranteed: Optional. The Guaranteed tier
        :param pulumi.Input[str] queued_resource_id: Optional. The unqualified resource name. Should follow the `^[A-Za-z0-9_.~+%-]+$` regex format.
        :param pulumi.Input[pulumi.InputType['QueueingPolicyArgs']] queueing_policy: Optional. The queueing policy of the QueuedRequest.
        :param pulumi.Input[str] request_id: Optional. Idempotent request UUID.
        :param pulumi.Input[str] reservation_name: Optional. Name of the reservation in which the resource should be provisioned. Format: projects/{project}/locations/{zone}/reservations/{reservation}
        :param pulumi.Input[pulumi.InputType['SpotArgs']] spot: Optional. The Spot tier.
        :param pulumi.Input[pulumi.InputType['TpuArgs']] tpu: Optional. Defines a TPU resource.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        super(QueuedResource, __self__).__init__(
            'google-native:tpu/v2:QueuedResource',
            resource_name,
            __props__,
            opts)
