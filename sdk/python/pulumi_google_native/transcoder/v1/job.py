...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] batch_mode_priority: The processing priority of a batch job. This field can only be set for batch mode jobs, and the default value is 0. This value cannot be negative. Higher values correspond to higher priorities for the job.
