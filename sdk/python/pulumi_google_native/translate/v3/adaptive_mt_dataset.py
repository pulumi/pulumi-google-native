...
__all__ = ['AdaptiveMtDatasetArgs', 'AdaptiveMtDataset']

@pulumi.input_type
class AdaptiveMtDatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] example_count: The number of examples in the dataset.
        :param pulumi.Input[str] name: The resource name of the dataset, in form of `projects/{project-number-or-id}/locations/{location_id}/adaptiveMtDatasets/{dataset_id}`
...
class AdaptiveMtDataset(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AdaptiveMtDatasetArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates an Adaptive MT dataset.

        :param str resource_name: The name of the resource.
        :param AdaptiveMtDatasetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AdaptiveMtDatasetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AdaptiveMtDatasetArgs.__new__(AdaptiveMtDatasetArgs)

            __props__.__dict__["display_name"] = display_name
            __props__.__dict__["example_count"] = example_count
        ...
        super(AdaptiveMtDataset, __self__).__init__(
            'google-native:translate/v3:AdaptiveMtDataset',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AdaptiveMtDataset':
        """
        ...
        __props__.__dict__["update_time"] = None
        return AdaptiveMtDataset(resource_name, opts=opts, __props__=__props__)
