...
class ModelArgs:
    def __init__(__self__, *,
                 container_spec: pulumi.Input['ModelContainerSpecArgs'],
                 display_name: pulumi.Input[str],
                 location: pulumi.Input[str],
                 project: pulumi.Input[str],
                 artifact_uri: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 encryption_spec: Optional[pulumi.Input['ModelEncryptionSpecArgs']] = None,
                 labels: Optional[pulumi.Input['LabelsArgs']] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 version_description: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a Model resource.
        :param pulumi.Input['ModelContainerSpecArgs'] container_spec: The specification of the container that is to be used when deploying this Model. The specification is ingested upon ModelService.UploadModel, and all binaries it contains are copied and stored internally by Vertex AI. Not present for AutoML Models.
        :param pulumi.Input[str] display_name: Required. The display name of the Model. The name can be up to 128 characters long and can be consist of any UTF-8 characters.
        :param pulumi.Input[str] location: The location for the resource
        :param pulumi.Input[str] project: The project for the resource
        :param pulumi.Input[str] artifact_uri: Immutable. The path to the directory containing the Model artifact and any of its supporting files. Not present for AutoML Models.
        :param pulumi.Input[str] description: The description of the Model.
        :param pulumi.Input['ModelEncryptionSpecArgs'] encryption_spec: Customer-managed encryption key spec for a Model. If set, this Model and all sub-resources of this Model will be secured by this key.
    ...
    def container_spec(self) -> pulumi.Input['ModelContainerSpecArgs']:
        """
    ...
    def container_spec(self, value: pulumi.Input['ModelContainerSpecArgs']):
    ...
    def encryption_spec(self) -> Optional[pulumi.Input['ModelEncryptionSpecArgs']]:
        """
    ...
    def encryption_spec(self, value: Optional[pulumi.Input['ModelEncryptionSpecArgs']]):
...
class Model(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 artifact_uri: Optional[pulumi.Input[str]] = None,
                 container_spec: Optional[pulumi.Input[pulumi.InputType['ModelContainerSpecArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 encryption_spec: Optional[pulumi.Input[pulumi.InputType['ModelEncryptionSpecArgs']]] = None,
        ...
        :param pulumi.Input[str] artifact_uri: Immutable. The path to the directory containing the Model artifact and any of its supporting files. Not present for AutoML Models.
        :param pulumi.Input[pulumi.InputType['ModelContainerSpecArgs']] container_spec: The specification of the container that is to be used when deploying this Model. The specification is ingested upon ModelService.UploadModel, and all binaries it contains are copied and stored internally by Vertex AI. Not present for AutoML Models.
        :param pulumi.Input[str] description: The description of the Model.
        :param pulumi.Input[str] display_name: Required. The display name of the Model. The name can be up to 128 characters long and can be consist of any UTF-8 characters.
        :param pulumi.Input[pulumi.InputType['ModelEncryptionSpecArgs']] encryption_spec: Customer-managed encryption key spec for a Model. If set, this Model and all sub-resources of this Model will be secured by this key.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if container_spec is None and not opts.urn:
                raise TypeError("Missing required property 'container_spec'")
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["artifact_uri", "container_spec", "create_time", "deployed_models[*]", "encryption_spec", "etag", "location", "name", "original_model_info", "project", "supported_deployment_resources_types[*]", "supported_export_formats[*]", "supported_input_storage_formats[*]", "supported_output_storage_formats[*]", "training_pipeline", "update_time", "version_create_time", "version_description", "version_id", "version_update_time"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(Model, __self__).__init__(
            'google-native:vertexai/v1:Model',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="artifactUri")
    def artifact_uri(self) -> pulumi.Output[Optional[str]]:
        """
        Immutable. The path to the directory containing the Model artifact and any of its supporting files. Not present for AutoML Models.
        """
        return pulumi.get(self, "artifact_uri")
    ...
    @property
    @pulumi.getter(name="containerSpec")
    def container_spec(self) -> pulumi.Output[Optional['outputs.ModelContainerSpec']]:
        """
        The specification of the container that is to be used when deploying this Model. The specification is ingested upon ModelService.UploadModel, and all binaries it contains are copied and stored internally by Vertex AI. Not present for AutoML Models.
        """
        return pulumi.get(self, "container_spec")
    ...
    def deployed_models(self) -> pulumi.Output[Optional[Sequence['outputs.ModelDeployedModels']]]:
        """
    ...
    @property
    @pulumi.getter(name="encryptionSpec")
    def encryption_spec(self) -> pulumi.Output[Optional['outputs.ModelEncryptionSpec']]:
        """
        Customer-managed encryption key spec for a Model. If set, this Model and all sub-resources of this Model will be secured by this key.
        """
        return pulumi.get(self, "encryption_spec")
    ...
    def original_model_info(self) -> pulumi.Output[Optional['outputs.ModelOriginalModelInfo']]:
        """
    ...
    def supported_deployment_resources_types(self) -> pulumi.Output[Optional[Sequence['ModelSupportedDeploymentResourcesTypesEnum']]]:
        """
    ...
    def supported_export_formats(self) -> pulumi.Output[Optional[Sequence['outputs.ModelSupportedExportFormats']]]:
        """
    ...
    def supported_input_storage_formats(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
    ...
    def supported_output_storage_formats(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
    ...
    def training_pipeline(self) -> pulumi.Output[Optional[str]]:
        """
    ...
    def version_create_time(self) -> pulumi.Output[Optional[str]]:
        """
    ...
    def version_update_time(self) -> pulumi.Output[Optional[str]]:
        """
