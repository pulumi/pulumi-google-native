...
class UtilizationReport(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 vms: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VmUtilizationInfoArgs', 'VmUtilizationInfoArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input['UtilizationReportTimeFrame'] time_frame: Time frame of the report.
        :param pulumi.Input[str] utilization_report_id: Required. The ID to use for the report, which will become the final component of the reports's resource name. This value maximum length is 63 characters, and valid characters are /a-z-/. It must start with an english letter and must not end with a hyphen.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VmUtilizationInfoArgs', 'VmUtilizationInfoArgsDict']]]] vms: List of utilization information per VM. When sent as part of the request, the "vm_id" field is used in order to specify which VMs to include in the report. In that case all other fields are ignored.
        """
        ...
    @overload
    def __init__(__self__,
