...
class PersistentDiskDefaultsArgs:
    def __init__(__self__, *,
                 ...
                 source_disk_number: Optional[pulumi.Input[int]] = None):
        """
        ...
        if disk_type is not None:
            pulumi.set(__self__, "disk_type", disk_type)
        if source_disk_number is not None:
    ...
    def source_disk_number(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def source_disk_number(self, value: Optional[pulumi.Input[int]]):
