...
class AwsSourceDetailsArgs:
    def __init__(__self__, *,
                 ...
                 inventory_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] inventory_tags: Deprecated: AWS resource tags to limit the scope of the source inventory. Use inventory_tag_list instead.
        ...
        if inventory_tags is not None:
            warnings.warn("""Deprecated: AWS resource tags to limit the scope of the source inventory. Use inventory_tag_list instead.""", DeprecationWarning)
            pulumi.log.warn("""inventory_tags is deprecated: Deprecated: AWS resource tags to limit the scope of the source inventory. Use inventory_tag_list instead.""")
        if inventory_tags is not None:
    ...
    def inventory_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
    ...
    @inventory_tags.setter
    def inventory_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
        pulumi.set(self, "inventory_tags", value)
