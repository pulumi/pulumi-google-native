...
class GetMigratingVmResult:
    def __init__(__self__, aws_source_vm_details=None, compute_engine_disks_target_defaults=None, compute_engine_target_defaults=None, compute_engine_vm_defaults=None, create_time=None, current_sync_info=None, cutover_forecast=None, description=None, display_name=None, error=None, group=None, labels=None, last_replication_cycle=None, last_sync=None, name=None, policy=None, recent_clone_jobs=None, recent_cutover_jobs=None, source_vm_id=None, state=None, state_time=None, target_defaults=None, update_time=None):
...
def get_migrating_vm(location: Optional[str] = None,
    ...
    return AwaitableGetMigratingVmResult(
        ...
        compute_engine_disks_target_defaults=__ret__.compute_engine_disks_target_defaults,
