...
class AwsSourceDetailsResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "inventoryTags":
            suggest = "inventory_tags"
    ...
    def __init__(__self__, *,
                 ...
                 inventory_tags: Mapping[str, str],
        ...
        :param Mapping[str, str] inventory_tags: Deprecated: AWS resource tags to limit the scope of the source inventory. Use inventory_tag_list instead.
        ...
        pulumi.set(__self__, "inventory_tags", inventory_tags)
    ...
    @property
    @pulumi.getter(name="inventoryTags")
    def inventory_tags(self) -> Mapping[str, str]:
        """
        Deprecated: AWS resource tags to limit the scope of the source inventory. Use inventory_tag_list instead.
        """
        return pulumi.get(self, "inventory_tags")
