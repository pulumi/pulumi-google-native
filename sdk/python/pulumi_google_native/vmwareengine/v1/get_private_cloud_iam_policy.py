...
__all__ = [
    ...
    'AwaitableGetPrivateCloudIamPolicyResult',
    'get_private_cloud_iam_policy',
    'get_private_cloud_iam_policy_output',
]
...
class AwaitableGetPrivateCloudIamPolicyResult(GetPrivateCloudIamPolicyResult):
...
def get_private_cloud_iam_policy(location: Optional[str] = None,
                                 options_requested_policy_version: Optional[int] = None,
                                 private_cloud_id: Optional[str] = None,
                                 project: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPrivateCloudIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:vmwareengine/v1:getPrivateCloudIamPolicy', __args__, opts=opts, typ=GetPrivateCloudIamPolicyResult).value

    return AwaitableGetPrivateCloudIamPolicyResult(
...
@_utilities.lift_output_func(get_private_cloud_iam_policy)
def get_private_cloud_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPrivateCloudIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
