...
class GetExecutionResult:
    def __init__(__self__, argument=None, call_log_level=None, duration=None, end_time=None, error=None, name=None, result=None, start_time=None, state=None, status=None, workflow_revision_id=None):
