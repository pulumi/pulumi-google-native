...
__all__ = [
    ...
    'AwaitableGetWorkstationClusterWorkstationConfigIamPolicyResult',
    'get_workstation_cluster_workstation_config_iam_policy',
    'get_workstation_cluster_workstation_config_iam_policy_output',
]
...
class AwaitableGetWorkstationClusterWorkstationConfigIamPolicyResult(GetWorkstationClusterWorkstationConfigIamPolicyResult):
...
def get_workstation_cluster_workstation_config_iam_policy(location: Optional[str] = None,
                                                          ...
                                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWorkstationClusterWorkstationConfigIamPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('google-native:workstations/v1:getWorkstationClusterWorkstationConfigIamPolicy', __args__, opts=opts, typ=GetWorkstationClusterWorkstationConfigIamPolicyResult).value
...
def get_workstation_cluster_workstation_config_iam_policy_output(location: Optional[pulumi.Input[str]] = None,
                                                                 ...
                                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWorkstationClusterWorkstationConfigIamPolicyResult]:
    """
    Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
    """
    ...
