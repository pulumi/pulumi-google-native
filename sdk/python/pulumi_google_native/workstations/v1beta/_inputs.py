...
class GceInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GceConfidentialInstanceConfigArgs'] confidential_instance_config: A set of Confidential Google Compute Engine Instance option.
        ...
        :param pulumi.Input['GceShieldedInstanceConfigArgs'] shielded_instance_config: A set of Shielded Google Compute Engine Instance options.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: Network tags to add to the Google Compute Engine machines backing the Workstations.
        """
...
class HostArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GceInstanceArgs'] gce_instance: Specifies a Google Compute Engine Instance as the host.
        """
