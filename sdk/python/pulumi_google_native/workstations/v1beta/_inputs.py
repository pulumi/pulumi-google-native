...
class BoostConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AcceleratorArgs']]] accelerators: Optional. A list of the type and count of accelerator cards attached to the boost instance. Defaults to `none`.
        :param pulumi.Input[str] id: Optional. Required. The id to be used for the boost config.
        :param pulumi.Input[str] machine_type: Optional. The type of machine that boosted VM instances will use—for example, `e2-standard-4`. For more information about machine types that Cloud Workstations supports, see the list of [available machine types](https://cloud.google.com/workstations/docs/available-machine-types). Defaults to `e2-standard-4`.
        :param pulumi.Input[int] pool_size: Optional. The number of boost VMs that the system should keep idle so that workstations can be boosted quickly. Defaults to `0`.
        """
...
class GceInstanceArgs:
    def __init__(__self__, *,
                 accelerators: Optional[pulumi.Input[Sequence[pulumi.Input['AcceleratorArgs']]]] = None,
                 boost_configs: Optional[pulumi.Input[Sequence[pulumi.Input['BoostConfigArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BoostConfigArgs']]] boost_configs: Optional. A list of the boost configurations that workstations created using this workstation configuration are allowed to use.
        ...
        :param pulumi.Input[bool] disable_ssh: Optional. Whether to disable SSH access to the VM.
    ...
    def boost_configs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BoostConfigArgs']]]]:
        """
    ...
    def boost_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BoostConfigArgs']]]]):
