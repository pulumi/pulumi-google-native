...
class GetWorkstationResult:
    def __init__(__self__, annotations=None, create_time=None, delete_time=None, display_name=None, etag=None, host=None, name=None, reconciling=None, state=None, uid=None, update_time=None):
