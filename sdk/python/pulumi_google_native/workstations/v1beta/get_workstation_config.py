...
class GetWorkstationConfigResult:
    def __init__(__self__, annotations=None, conditions=None, container=None, create_time=None, degraded=None, delete_time=None, display_name=None, etag=None, host=None, idle_timeout=None, name=None, persistent_directories=None, reconciling=None, running_timeout=None, uid=None, update_time=None):
