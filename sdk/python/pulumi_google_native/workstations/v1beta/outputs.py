...
class GceInstanceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GceConfidentialInstanceConfigResponse' confidential_instance_config: A set of Confidential Google Compute Engine Instance option.
        ...
        :param 'GceShieldedInstanceConfigResponse' shielded_instance_config: A set of Shielded Google Compute Engine Instance options.
        :param Sequence[str] tags: Network tags to add to the Google Compute Engine machines backing the Workstations.
        """
...
class HostResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The system will attempt to keep enough computational resources on standby Runtime host for a Workstation.
        :param 'GceInstanceResponse' gce_instance: Specifies a Google Compute Engine Instance as the host.
        """
