...
class WorkstationClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] network: Name of the Compute Engine network in which instances associated with this cluster will be created.
        :param pulumi.Input['PrivateClusterConfigArgs'] private_cluster_config: Configuration for private cluster.
        :param pulumi.Input[str] subnetwork: Name of the Compute Engine subnetwork in which instances associated with this cluster will be created. Must be part of the subnetwork specified for this cluster.
