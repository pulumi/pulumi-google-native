...
class WorkstationConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ContainerArgs'] container: Container that will be run for each Workstation using this config when that Workstation is started.
...
class WorkstationConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] annotations: Client-specified annotations.
        :param pulumi.Input[pulumi.InputType['ContainerArgs']] container: Container that will be run for each Workstation using this config when that Workstation is started.
        :param pulumi.Input[str] display_name: Human-readable name for this resource.
        :param pulumi.Input[str] etag: Checksum computed by the server. May be sent on update and delete requests to ensure that the client has an up-to-date value before proceeding.
